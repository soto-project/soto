...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/swift-aws/aws-sdk-swift-core.git", .upToNextMajor(from: "5.0.0-alpha.6"))
    ],
    targets: [
        ...
        .target(name: "AWSBraket", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Braket"),
