...
let package = Package(
    ...
    products: [
        ...
        .library(name: "SotoCognitoIdentity", targets: ["SotoCognitoIdentity", "SotoCognitoIdentityExtension"]),
        ...
        .library(name: "SotoDynamoDB", targets: ["SotoDynamoDB", "SotoDynamoDBExtension"]),
        ...
        .library(name: "SotoS3", targets: ["SotoS3", "SotoS3Extension"]),
        ...
        .library(name: "SotoSTS", targets: ["SotoSTS", "SotoSTSExtension"]),
    ...
    targets: [
        ...
        .target(name: "SotoCognitoIdentity", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/CognitoIdentity", swiftSettings: swiftSettings),
        ...
        .target(name: "SotoDynamoDB", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/DynamoDB", swiftSettings: swiftSettings),
        ...
        .target(name: "SotoS3", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/S3", swiftSettings: swiftSettings),
        ...
        .target(name: "SotoSTS", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/STS", swiftSettings: swiftSettings),
        ...
        // Service extensions
        .target(name: "SotoCognitoIdentityExtension", dependencies: ["SotoCognitoIdentity"], path: "./Sources/Soto/Extensions/CognitoIdentity", swiftSettings: swiftSettings),
        .target(name: "SotoDynamoDBExtension", dependencies: ["SotoDynamoDB"], path: "./Sources/Soto/Extensions/DynamoDB", swiftSettings: swiftSettings),
        .target(name: "SotoS3Extension", dependencies: ["SotoS3"], path: "./Sources/Soto/Extensions/S3", swiftSettings: swiftSettings),
        .target(name: "SotoSTSExtension", dependencies: ["SotoSTS"], path: "./Sources/Soto/Extensions/STS", swiftSettings: swiftSettings),
        .testTarget(
            name: "SotoTests",
            dependencies: [
                "SotoACM",
                ...
                "SotoCloudFront",
                "SotoCloudTrail",
                "SotoCognitoIdentityExtension",
                "SotoDynamoDB",
                "SotoDynamoDBExtension",
                "SotoEC2",
                "SotoGlacier",
                "SotoIAM",
                "SotoLambda",
