...
let package = Package(
    ...
    products: [
        ...
        .library(name: "SotoCloudControlApi", targets: ["SotoCloudControlApi"]),
        ...
        .library(name: "SotoConnectWisdomService", targets: ["SotoConnectWisdomService"]),
        ...
        .library(name: "SotoManagedGrafana", targets: ["SotoManagedGrafana"]),
    ...
    dependencies: [
        .package(url: "https://github.com/soto-project/soto-core.git", .branch("smithy"))
    ],
    targets: [
        ...
        .target(name: "SotoCloudControlApi", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/CloudControlApi"),
        ...
        .target(name: "SotoConnectWisdomService", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/ConnectWisdomService"),
        ...
        .target(name: "SotoManagedGrafana", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/ManagedGrafana"),
