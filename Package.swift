...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "_SotoCognitoIdentityService", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/CognitoIdentity", swiftSettings: swiftSettings),
        ...
        .target(name: "_SotoDynamoDBService", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/DynamoDB", swiftSettings: swiftSettings),
        ...
        .target(name: "_SotoS3Service", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/S3", swiftSettings: swiftSettings),
        ...
        .target(name: "_SotoSTSService", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/STS", swiftSettings: swiftSettings),
        ...
        // Service extensions
        .target(name: "SotoCognitoIdentity", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoCognitoIdentityService"], path: "./Sources/Soto/Extensions/CognitoIdentity", swiftSettings: swiftSettings),
        .target(name: "SotoDynamoDB", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoDynamoDBService"], path: "./Sources/Soto/Extensions/DynamoDB", swiftSettings: swiftSettings),
        .target(name: "SotoS3", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoS3Service"], path: "./Sources/Soto/Extensions/S3", swiftSettings: swiftSettings),
        .target(name: "SotoSTS", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoSTSService"], path: "./Sources/Soto/Extensions/STS", swiftSettings: swiftSettings),
