...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "SotoGameSparks", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/GameSparks", swiftSettings: swiftSettings),
        ...
        .target(name: "SotoIoTRoboRunner", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/IoTRoboRunner", swiftSettings: swiftSettings),
        ...
        .target(name: "SotoMacie", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/Macie", swiftSettings: swiftSettings),
