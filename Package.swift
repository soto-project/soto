...
let package = Package(
    ...
    products: [
        .library(name: "AWSSDKSwift", targets: ["AWSACM","AWSACMPCA","AWSAPIGateway","AWSAWSBackup","AWSAWSDirectoryService","AWSAccessAnalyzer","AWSAlexaForBusiness","AWSAmplify","AWSApiGatewayManagementApi","AWSApiGatewayV2","AWSAppConfig","AWSAppMesh","AWSAppStream","AWSAppSync","AWSApplicationAutoScaling","AWSApplicationDiscoveryService","AWSApplicationInsights","AWSAthena","AWSAugmentedAIRuntime","AWSAutoScaling","AWSAutoScalingPlans","AWSBatch","AWSBudgets","AWSChime","AWSCloud9","AWSCloudDirectory","AWSCloudFormation","AWSCloudFront","AWSCloudHSM","AWSCloudHSMV2","AWSCloudSearch","AWSCloudSearchDomain","AWSCloudTrail","AWSCloudWatch","AWSCloudWatchEvents","AWSCloudWatchLogs","AWSCodeBuild","AWSCodeCommit","AWSCodeDeploy","AWSCodeGuruProfiler","AWSCodeGuruReviewer","AWSCodePipeline","AWSCodeStar","AWSCodeStarNotifications","AWSCodeStarconnections","AWSCognitoIdentity","AWSCognitoIdentityProvider","AWSCognitoSync","AWSComprehend","AWSComprehendMedical","AWSComputeOptimizer","AWSConfigService","AWSConnect","AWSConnectParticipant","AWSCostExplorer","AWSCostandUsageReportService","AWSDAX","AWSDLM","AWSDataExchange","AWSDataPipeline","AWSDataSync","AWSDatabaseMigrationService","AWSDetective","AWSDeviceFarm","AWSDirectConnect","AWSDocDB","AWSDynamoDB","AWSDynamoDBStreams","AWSEBS","AWSEC2","AWSEC2InstanceConnect","AWSECR","AWSECS","AWSEFS","AWSEKS","AWSELB","AWSELBV2","AWSEMR","AWSElastiCache","AWSElasticBeanstalk","AWSElasticInference","AWSElasticTranscoder","AWSElasticsearchService","AWSEventBridge","AWSFMS","AWSFSx","AWSFirehose","AWSForecastQueryService","AWSForecastService","AWSFraudDetector","AWSGameLift","AWSGlacier","AWSGlacierMiddleware","AWSGlobalAccelerator","AWSGlue","AWSGreengrass","AWSGroundStation","AWSGuardDuty","AWSHealth","AWSIAM","AWSImagebuilder","AWSImportExport","AWSInspector","AWSIoT","AWSIoT1ClickDevicesService","AWSIoT1ClickProjects","AWSIoTAnalytics","AWSIoTDataPlane","AWSIoTEvents","AWSIoTEventsData","AWSIoTJobsDataPlane","AWSIoTSecureTunneling","AWSIoTThingsGraph","AWSKMS","AWSKafka","AWSKendra","AWSKinesis","AWSKinesisAnalytics","AWSKinesisAnalyticsV2","AWSKinesisVideo","AWSKinesisVideoArchivedMedia","AWSKinesisVideoMedia","AWSKinesisVideoSignalingChannels","AWSLakeFormation","AWSLambda","AWSLexModelBuildingService","AWSLexRuntimeService","AWSLicenseManager","AWSLightsail","AWSMQ","AWSMTurk","AWSMachineLearning","AWSMacie","AWSManagedBlockchain","AWSMarketplaceCatalog","AWSMarketplaceCommerceAnalytics","AWSMarketplaceEntitlementService","AWSMarketplaceMetering","AWSMediaConnect","AWSMediaConvert","AWSMediaLive","AWSMediaPackage","AWSMediaPackageVod","AWSMediaStore","AWSMediaStoreData","AWSMediaTailor","AWSMigrationHub","AWSMigrationHubConfig","AWSMobile","AWSMobileAnalytics","AWSNeptune","AWSNetworkManager","AWSOpsWorks","AWSOpsWorksCM","AWSOrganizations","AWSOutposts","AWSPI","AWSPersonalize","AWSPersonalizeEvents","AWSPersonalizeRuntime","AWSPinpoint","AWSPinpointEmail","AWSPinpointSMSVoice","AWSPolly","AWSPricing","AWSQLDB","AWSQLDBSession","AWSQuickSight","AWSRAM","AWSRDS","AWSRDSDataService","AWSRedshift","AWSRekognition","AWSResourceGroups","AWSResourceGroupsTaggingAPI","AWSRoboMaker","AWSRoute53","AWSRoute53Domains","AWSRoute53Resolver","AWSS3","AWSS3Control","AWSS3Middleware","AWSSES","AWSSESV2","AWSSFN","AWSSMS","AWSSNS","AWSSQS","AWSSSM","AWSSSO","AWSSSOOIDC","AWSSTS","AWSSWF","AWSSageMaker","AWSSageMakerRuntime","AWSSavingsPlans","AWSSchemas","AWSSecretsManager","AWSSecurityHub","AWSServerlessApplicationRepository","AWSServiceCatalog","AWSServiceDiscovery","AWSServiceQuotas","AWSShield","AWSSigner","AWSSimpleDB","AWSSnowball","AWSStorageGateway","AWSSupport","AWSTextract","AWSTranscribeService","AWSTranscribeStreamingService","AWSTransfer","AWSTranslate","AWSWAF","AWSWAFRegional","AWSWAFV2","AWSWorkDocs","AWSWorkLink","AWSWorkMail","AWSWorkMailMessageFlow","AWSWorkSpaces","AWSXRay"]),
        ...
        .library(name: "AWSAWSBackup", targets: ["AWSAWSBackup"]),
        .library(name: "AWSAWSDirectoryService", targets: ["AWSAWSDirectoryService"]),
    ...
    targets: [
        ...
        .target(name: "AWSAWSBackup", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/AWSBackup"),
        .target(name: "AWSAWSDirectoryService", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/AWSDirectoryService"),
