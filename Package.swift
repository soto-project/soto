...
let package = Package(
    ...
    products: [
        .library(name: "AWSSDKSwift", targets: ["ACM","ACMPCA","APIGateway","APIGatewayMiddleware","AWSBackup","AWSDirectoryService","AccessAnalyzer","AlexaForBusiness","Amplify","ApiGatewayManagementApi","ApiGatewayV2","AppConfig","AppMesh","AppStream","AppSync","Appflow","ApplicationAutoScaling","ApplicationDiscoveryService","ApplicationInsights","Athena","AugmentedAIRuntime","AutoScaling","AutoScalingPlans","Batch","Braket","Budgets","Chime","Cloud9","CloudDirectory","CloudFormation","CloudFront","CloudHSM","CloudHSMV2","CloudSearch","CloudSearchDomain","CloudTrail","CloudWatch","CloudWatchEvents","CloudWatchLogs","CodeArtifact","CodeBuild","CodeCommit","CodeDeploy","CodeGuruProfiler","CodeGuruReviewer","CodePipeline","CodeStar","CodeStarNotifications","CodeStarconnections","CognitoIdentity","CognitoIdentityProvider","CognitoSync","Comprehend","ComprehendMedical","ComputeOptimizer","ConfigService","Connect","ConnectParticipant","CostExplorer","CostandUsageReportService","DAX","DLM","DataExchange","DataPipeline","DataSync","DatabaseMigrationService","Detective","DeviceFarm","DirectConnect","DocDB","DynamoDB","DynamoDBStreams","EBS","EC2","EC2InstanceConnect","ECR","ECS","EFS","EKS","ELB","ELBV2","EMR","ElastiCache","ElasticBeanstalk","ElasticInference","ElasticTranscoder","ElasticsearchService","EventBridge","FMS","FSx","Firehose","ForecastQueryService","ForecastService","FraudDetector","GameLift","Glacier","GlacierMiddleware","GlobalAccelerator","Glue","Greengrass","GroundStation","GuardDuty","Health","Honeycode","IAM","IVS","IdentityStore","Imagebuilder","ImportExport","Inspector","IoT","IoT1ClickDevicesService","IoT1ClickProjects","IoTAnalytics","IoTDataPlane","IoTEvents","IoTEventsData","IoTJobsDataPlane","IoTSecureTunneling","IoTSiteWise","IoTThingsGraph","KMS","Kafka","Kendra","Kinesis","KinesisAnalytics","KinesisAnalyticsV2","KinesisVideo","KinesisVideoArchivedMedia","KinesisVideoMedia","KinesisVideoSignalingChannels","LakeFormation","Lambda","LexModelBuildingService","LexRuntimeService","LicenseManager","Lightsail","MQ","MTurk","MachineLearning","Macie","Macie2","ManagedBlockchain","MarketplaceCatalog","MarketplaceCommerceAnalytics","MarketplaceEntitlementService","MarketplaceMetering","MediaConnect","MediaConvert","MediaLive","MediaPackage","MediaPackageVod","MediaStore","MediaStoreData","MediaTailor","MigrationHub","MigrationHubConfig","Mobile","MobileAnalytics","Neptune","NetworkManager","OpsWorks","OpsWorksCM","Organizations","Outposts","PI","Personalize","PersonalizeEvents","PersonalizeRuntime","Pinpoint","PinpointEmail","PinpointSMSVoice","Polly","Pricing","QLDB","QLDBSession","QuickSight","RAM","RDS","RDSDataService","Redshift","RedshiftDataAPIService","Rekognition","ResourceGroups","ResourceGroupsTaggingAPI","RoboMaker","Route53","Route53Domains","Route53Resolver","S3","S3Control","S3ControlMiddleware","S3Middleware","SES","SESV2","SFN","SMS","SNS","SQS","SSM","SSO","SSOAdmin","SSOOIDC","STS","SWF","SageMaker","SageMakerRuntime","SavingsPlans","Schemas","SecretsManager","SecurityHub","ServerlessApplicationRepository","ServiceCatalog","ServiceDiscovery","ServiceQuotas","Shield","Signer","SimpleDB","Snowball","StorageGateway","Support","Synthetics","Textract","TranscribeService","TranscribeStreamingService","Transfer","Translate","WAF","WAFRegional","WAFV2","WorkDocs","WorkLink","WorkMail","WorkMailMessageFlow","WorkSpaces","XRay"]),
        ...
        .library(name: "AugmentedAIRuntime", targets: ["AugmentedAIRuntime"]),
        ...
        .library(name: "KinesisVideoSignalingChannels", targets: ["KinesisVideoSignalingChannels"]),
        ...
        .library(name: "RedshiftDataAPIService", targets: ["RedshiftDataAPIService"]),
        ...
        .library(name: "TranscribeStreamingService", targets: ["TranscribeStreamingService"]),
    ...
    targets: [
        ...
        .target(name: "AppConfig", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/AppConfig"),
        ...
        .target(name: "Appflow", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Appflow"),
        ...
        .target(name: "AugmentedAIRuntime", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/AugmentedAIRuntime"),
        ...
        .target(name: "Braket", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Braket"),
        ...
        .target(name: "CodeArtifact", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/CodeArtifact"),
        ...
        .target(name: "CodeGuruProfiler", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/CodeGuruProfiler"),
        .target(name: "CodeGuruReviewer", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/CodeGuruReviewer"),
        ...
        .target(name: "CodeStarconnections", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/CodeStarconnections"),
        ...
        .target(name: "ComputeOptimizer", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/ComputeOptimizer"),
        ...
        .target(name: "ConnectParticipant", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/ConnectParticipant"),
        ...
        .target(name: "DataExchange", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/DataExchange"),
        ...
        .target(name: "Detective", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Detective"),
        ...
        .target(name: "EBS", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/EBS"),
        ...
        .target(name: "ElasticInference", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/ElasticInference"),
        ...
        .target(name: "FraudDetector", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/FraudDetector"),
        ...
        .target(name: "Honeycode", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Honeycode"),
        .target(name: "IAM", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/IAM"),
        .target(name: "IVS", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/IVS"),
        .target(name: "IdentityStore", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/IdentityStore"),
        .target(name: "Imagebuilder", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Imagebuilder"),
        ...
        .target(name: "IoTSecureTunneling", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/IoTSecureTunneling"),
        .target(name: "IoTSiteWise", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/IoTSiteWise"),
        ...
        .target(name: "Kendra", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Kendra"),
        ...
        .target(name: "KinesisVideoSignalingChannels", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/KinesisVideoSignalingChannels"),
        ...
        .target(name: "Macie2", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Macie2"),
        .target(name: "ManagedBlockchain", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/ManagedBlockchain"),
        .target(name: "MarketplaceCatalog", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/MarketplaceCatalog"),
        ...
        .target(name: "MigrationHubConfig", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/MigrationHubConfig"),
        ...
        .target(name: "NetworkManager", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/NetworkManager"),
        ...
        .target(name: "Outposts", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Outposts"),
        ...
        .target(name: "RedshiftDataAPIService", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/RedshiftDataAPIService"),
        ...
        .target(name: "SSOAdmin", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/SSOAdmin"),
        ...
        .target(name: "Schemas", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Schemas"),
        ...
        .target(name: "Synthetics", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/Synthetics"),
        ...
        .target(name: "TranscribeStreamingService", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/TranscribeStreamingService"),
        ...
        .target(name: "WAFV2", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/WAFV2"),
