...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/soto-project/soto-core.git", branch: "s3-arn-accesspoint")
    ],
    targets: [
        ...
        .target(name: "_SotoCognitoIdentityGenerated", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/CognitoIdentity", swiftSettings: swiftSettings),
        ...
        .target(name: "_SotoDynamoDBGenerated", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/DynamoDB", swiftSettings: swiftSettings),
        ...
        .target(name: "_SotoSTSGenerated", dependencies: [.product(name: "SotoCore", package: "soto-core")], path: "./Sources/Soto/Services/STS", swiftSettings: swiftSettings),
        ...
        // Service extensions
        .target(name: "SotoCognitoIdentity", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoCognitoIdentityGenerated"], path: "./Sources/Soto/Extensions/CognitoIdentity", swiftSettings: swiftSettings),
        .target(name: "SotoDynamoDB", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoDynamoDBGenerated"], path: "./Sources/Soto/Extensions/DynamoDB", swiftSettings: swiftSettings),
        .target(name: "SotoS3", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoS3Generated"], path: "./Sources/Soto/Extensions/S3", swiftSettings: swiftSettings),
        .target(name: "SotoSTS", dependencies: [.product(name: "SotoCore", package: "soto-core"), "_SotoSTSGenerated"], path: "./Sources/Soto/Extensions/STS", swiftSettings: swiftSettings),
