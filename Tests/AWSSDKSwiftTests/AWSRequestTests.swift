...
class AWSRequestTests: XCTestCase {
    ...
    func testAWSShapeRequest<Input: AWSEncodableShape>(
        ...
        do {
            let awsRequest = try AWSRequest(operation: operation, path: path, httpMethod: httpMethod, input: input, configuration: context)
            var expected2 = expected

            // If XML remove whitespace from expected by converting to XMLNode and back
            if case .restxml = context.serviceProtocol {
    ...
    func testAWSValidationFail<Input: AWSEncodableShape>(
        ...
        do {
            _ = try AWSRequest(operation: operation, path: path, httpMethod: httpMethod, input: input, configuration: context)
            XCTFail()
    ...
    func testSNSCreateTopic() {
        ...
        self.testAWSShapeRequest(context: sns.context, operation: "CreateTopic", path: "/", httpMethod: .POST, input: request, expected: expectedResult)
    }
    ...
    func testEC2CreateImage() {
        ...
        self.testAWSShapeRequest(context: ec2.context, operation: "CreateImage", path: "/", httpMethod: .POST, input: request, expected: expectedResult)
    }
    ...
    func testIAMSimulateCustomPolicy() {
        ...
        self.testAWSShapeRequest(context: iam.context, operation: "SimulateCustomPolicy", input: request, expected: expectedResult)
    }
    ...
    func testRoute53ChangeResourceRecordSetsRequest() {
        ...
        self.testAWSShapeRequest(context: route53.context, operation: "ChangeResourceRecordSets", input: request, expected: expectedResult)
    }
    ...
    func testSESSendEmail() {
        ...
        self.testAWSShapeRequest(context: ses.context, operation: "SendEmail", input: request, expected: expectedResult)
    }
    ...
    func testS3GetObjectAclValidate() {
        ...
        self.testAWSValidationFail(context: s3.context, operation: "GetObjectAcl", input: request)
    }
    ...
    func testIAMAttachGroupPolicyValidate() {
        ...
        self.testAWSValidationFail(context: iam.context, operation: "AttachGroupPolicy", input: request)
        // string length
        let request2 = IAM.AttachGroupPolicyRequest(groupName: "MYGROUP", policyArn: "arn:tooshort")
        self.testAWSValidationFail(context: iam.context, operation: "AttachGroupPolicy", input: request2)
        ...
        self.testAWSValidationSuccess(config: iam.context, operation: "AttachGroupPolicy", input: request3)
    }
    ...
    func testCloudFrontListTagsForResourceValidate() {
        ...
        self.testAWSValidationFail(context: cloudFront.context, operation: "ListTagsForResource", input: request)
        let request2 = CloudFront.ListTagsForResourceRequest(resource: "arn:aws::58979345:test")
        self.testAWSValidationFail(context: cloudFront.context, operation: "ListTagsForResource", input: request2)
        let request3 = CloudFront.ListTagsForResourceRequest(resource: "arn:aws:cloudfront::58979345")
        self.testAWSValidationFail(context: cloudFront.context, operation: "ListTagsForResource", input: request3)
        let successRequest = CloudFront.ListTagsForResourceRequest(resource: "arn:aws:cloudfront::58979345:test")
        self.testAWSValidationSuccess(config: cloudFront.context, operation: "ListTagsForResource", input: successRequest)
    }
    ...
    func testACMAddTagsToCertificateValidate() {
        ...
        self.testAWSValidationFail(context: acm.context, operation: "AddTagsToCertificate", input: request)
    }
    ...
    func testCloudFrontCreateDistributionValidate() {
        ...
        let cloudFront = CloudFront(client: Self.client)
        let request = CloudFront.CreateDistributionRequest(distributionConfig: distribution)
        self.testAWSValidationFail(context: cloudFront.context, operation: "CreateDistribution", input: request)
    }
}
