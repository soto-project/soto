...
public struct LocationService: AWSService {
    ...
    public func associateTrackerConsumer(_ input: AssociateTrackerConsumerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateTrackerConsumerResponse> {
        return self.client.execute(operation: "AssociateTrackerConsumer", path: "/tracking/v0/trackers/{TrackerName}/consumers", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }

    /// Deletes the position history of one or more devices from a tracker resource.
    public func batchDeleteDevicePositionHistory(_ input: BatchDeleteDevicePositionHistoryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchDeleteDevicePositionHistoryResponse> {
        return self.client.execute(operation: "BatchDeleteDevicePositionHistory", path: "/tracking/v0/trackers/{TrackerName}/delete-positions", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func batchDeleteGeofence(_ input: BatchDeleteGeofenceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchDeleteGeofenceResponse> {
        return self.client.execute(operation: "BatchDeleteGeofence", path: "/geofencing/v0/collections/{CollectionName}/delete-geofences", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func batchEvaluateGeofences(_ input: BatchEvaluateGeofencesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchEvaluateGeofencesResponse> {
        return self.client.execute(operation: "BatchEvaluateGeofences", path: "/geofencing/v0/collections/{CollectionName}/positions", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func batchGetDevicePosition(_ input: BatchGetDevicePositionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchGetDevicePositionResponse> {
        return self.client.execute(operation: "BatchGetDevicePosition", path: "/tracking/v0/trackers/{TrackerName}/get-positions", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func batchPutGeofence(_ input: BatchPutGeofenceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchPutGeofenceResponse> {
        return self.client.execute(operation: "BatchPutGeofence", path: "/geofencing/v0/collections/{CollectionName}/put-geofences", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func batchUpdateDevicePosition(_ input: BatchUpdateDevicePositionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchUpdateDevicePositionResponse> {
        return self.client.execute(operation: "BatchUpdateDevicePosition", path: "/tracking/v0/trackers/{TrackerName}/positions", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func calculateRoute(_ input: CalculateRouteRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CalculateRouteResponse> {
        return self.client.execute(operation: "CalculateRoute", path: "/routes/v0/calculators/{CalculatorName}/calculate/route", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "routes.", context: context, on: eventLoop)
    }
    ...
    public func createGeofenceCollection(_ input: CreateGeofenceCollectionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGeofenceCollectionResponse> {
        return self.client.execute(operation: "CreateGeofenceCollection", path: "/geofencing/v0/collections", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func createMap(_ input: CreateMapRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateMapResponse> {
        return self.client.execute(operation: "CreateMap", path: "/maps/v0/maps", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func createPlaceIndex(_ input: CreatePlaceIndexRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePlaceIndexResponse> {
        return self.client.execute(operation: "CreatePlaceIndex", path: "/places/v0/indexes", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "places.", context: context, on: eventLoop)
    }
    ...
    public func createRouteCalculator(_ input: CreateRouteCalculatorRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateRouteCalculatorResponse> {
        return self.client.execute(operation: "CreateRouteCalculator", path: "/routes/v0/calculators", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "routes.", context: context, on: eventLoop)
    }
    ...
    public func createTracker(_ input: CreateTrackerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrackerResponse> {
        return self.client.execute(operation: "CreateTracker", path: "/tracking/v0/trackers", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func deleteGeofenceCollection(_ input: DeleteGeofenceCollectionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteGeofenceCollectionResponse> {
        return self.client.execute(operation: "DeleteGeofenceCollection", path: "/geofencing/v0/collections/{CollectionName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func deleteMap(_ input: DeleteMapRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMapResponse> {
        return self.client.execute(operation: "DeleteMap", path: "/maps/v0/maps/{MapName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func deletePlaceIndex(_ input: DeletePlaceIndexRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeletePlaceIndexResponse> {
        return self.client.execute(operation: "DeletePlaceIndex", path: "/places/v0/indexes/{IndexName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "places.", context: context, on: eventLoop)
    }

    /// Deletes a route calculator resource from your AWS account.  This operation deletes the resource permanently.
    public func deleteRouteCalculator(_ input: DeleteRouteCalculatorRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteRouteCalculatorResponse> {
        return self.client.execute(operation: "DeleteRouteCalculator", path: "/routes/v0/calculators/{CalculatorName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "routes.", context: context, on: eventLoop)
    }
    ...
    public func deleteTracker(_ input: DeleteTrackerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTrackerResponse> {
        return self.client.execute(operation: "DeleteTracker", path: "/tracking/v0/trackers/{TrackerName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func describeGeofenceCollection(_ input: DescribeGeofenceCollectionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGeofenceCollectionResponse> {
        return self.client.execute(operation: "DescribeGeofenceCollection", path: "/geofencing/v0/collections/{CollectionName}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func describeMap(_ input: DescribeMapRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeMapResponse> {
        return self.client.execute(operation: "DescribeMap", path: "/maps/v0/maps/{MapName}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func describePlaceIndex(_ input: DescribePlaceIndexRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribePlaceIndexResponse> {
        return self.client.execute(operation: "DescribePlaceIndex", path: "/places/v0/indexes/{IndexName}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "places.", context: context, on: eventLoop)
    }

    /// Retrieves the route calculator resource details.
    public func describeRouteCalculator(_ input: DescribeRouteCalculatorRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRouteCalculatorResponse> {
        return self.client.execute(operation: "DescribeRouteCalculator", path: "/routes/v0/calculators/{CalculatorName}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "routes.", context: context, on: eventLoop)
    }
    ...
    public func describeTracker(_ input: DescribeTrackerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTrackerResponse> {
        return self.client.execute(operation: "DescribeTracker", path: "/tracking/v0/trackers/{TrackerName}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func disassociateTrackerConsumer(_ input: DisassociateTrackerConsumerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateTrackerConsumerResponse> {
        return self.client.execute(operation: "DisassociateTrackerConsumer", path: "/tracking/v0/trackers/{TrackerName}/consumers/{ConsumerArn}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func getDevicePosition(_ input: GetDevicePositionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDevicePositionResponse> {
        return self.client.execute(operation: "GetDevicePosition", path: "/tracking/v0/trackers/{TrackerName}/devices/{DeviceId}/positions/latest", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func getDevicePositionHistory(_ input: GetDevicePositionHistoryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDevicePositionHistoryResponse> {
        return self.client.execute(operation: "GetDevicePositionHistory", path: "/tracking/v0/trackers/{TrackerName}/devices/{DeviceId}/list-positions", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func getGeofence(_ input: GetGeofenceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetGeofenceResponse> {
        return self.client.execute(operation: "GetGeofence", path: "/geofencing/v0/collections/{CollectionName}/geofences/{GeofenceId}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func getMapGlyphs(_ input: GetMapGlyphsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMapGlyphsResponse> {
        return self.client.execute(operation: "GetMapGlyphs", path: "/maps/v0/maps/{MapName}/glyphs/{FontStack}/{FontUnicodeRange}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func getMapSprites(_ input: GetMapSpritesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMapSpritesResponse> {
        return self.client.execute(operation: "GetMapSprites", path: "/maps/v0/maps/{MapName}/sprites/{FileName}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func getMapStyleDescriptor(_ input: GetMapStyleDescriptorRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMapStyleDescriptorResponse> {
        return self.client.execute(operation: "GetMapStyleDescriptor", path: "/maps/v0/maps/{MapName}/style-descriptor", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func getMapTile(_ input: GetMapTileRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMapTileResponse> {
        return self.client.execute(operation: "GetMapTile", path: "/maps/v0/maps/{MapName}/tiles/{Z}/{X}/{Y}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }

    /// Lists the latest device positions for requested devices.
    public func listDevicePositions(_ input: ListDevicePositionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDevicePositionsResponse> {
        return self.client.execute(operation: "ListDevicePositions", path: "/tracking/v0/trackers/{TrackerName}/list-positions", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func listGeofenceCollections(_ input: ListGeofenceCollectionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGeofenceCollectionsResponse> {
        return self.client.execute(operation: "ListGeofenceCollections", path: "/geofencing/v0/list-collections", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func listGeofences(_ input: ListGeofencesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGeofencesResponse> {
        return self.client.execute(operation: "ListGeofences", path: "/geofencing/v0/collections/{CollectionName}/list-geofences", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func listMaps(_ input: ListMapsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMapsResponse> {
        return self.client.execute(operation: "ListMaps", path: "/maps/v0/list-maps", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "maps.", context: context, on: eventLoop)
    }
    ...
    public func listPlaceIndexes(_ input: ListPlaceIndexesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPlaceIndexesResponse> {
        return self.client.execute(operation: "ListPlaceIndexes", path: "/places/v0/list-indexes", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "places.", context: context, on: eventLoop)
    }

    /// Lists route calculator resources in your AWS account.
    public func listRouteCalculators(_ input: ListRouteCalculatorsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListRouteCalculatorsResponse> {
        return self.client.execute(operation: "ListRouteCalculators", path: "/routes/v0/list-calculators", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "routes.", context: context, on: eventLoop)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForResourceResponse> {
        return self.client.execute(operation: "ListTagsForResource", path: "/tags/{ResourceArn}", httpMethod: .GET, serviceConfig: self.config, input: input, hostPrefix: "metadata.", context: context, on: eventLoop)
    }
    ...
    public func listTrackerConsumers(_ input: ListTrackerConsumersRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrackerConsumersResponse> {
        return self.client.execute(operation: "ListTrackerConsumers", path: "/tracking/v0/trackers/{TrackerName}/list-consumers", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func listTrackers(_ input: ListTrackersRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrackersResponse> {
        return self.client.execute(operation: "ListTrackers", path: "/tracking/v0/list-trackers", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "tracking.", context: context, on: eventLoop)
    }
    ...
    public func putGeofence(_ input: PutGeofenceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutGeofenceResponse> {
        return self.client.execute(operation: "PutGeofence", path: "/geofencing/v0/collections/{CollectionName}/geofences/{GeofenceId}", httpMethod: .PUT, serviceConfig: self.config, input: input, hostPrefix: "geofencing.", context: context, on: eventLoop)
    }
    ...
    public func searchPlaceIndexForPosition(_ input: SearchPlaceIndexForPositionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchPlaceIndexForPositionResponse> {
        return self.client.execute(operation: "SearchPlaceIndexForPosition", path: "/places/v0/indexes/{IndexName}/search/position", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "places.", context: context, on: eventLoop)
    }
    ...
    public func searchPlaceIndexForText(_ input: SearchPlaceIndexForTextRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchPlaceIndexForTextResponse> {
        return self.client.execute(operation: "SearchPlaceIndexForText", path: "/places/v0/indexes/{IndexName}/search/text", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "places.", context: context, on: eventLoop)
    }
    ...
    public func tagResource(_ input: TagResourceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagResourceResponse> {
        return self.client.execute(operation: "TagResource", path: "/tags/{ResourceArn}", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "metadata.", context: context, on: eventLoop)
    }
    ...
    public func untagResource(_ input: UntagResourceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagResourceResponse> {
        return self.client.execute(operation: "UntagResource", path: "/tags/{ResourceArn}", httpMethod: .DELETE, serviceConfig: self.config, input: input, hostPrefix: "metadata.", context: context, on: eventLoop)
    }
}
