...
extension MigrationHubRefactorSpaces {
    ...
    public enum ApiGatewayEndpointType: String, CustomStringConvertible, Codable {
    ...
    public enum ErrorResourceType: String, CustomStringConvertible, Codable {
    ...
    public enum NetworkFabricType: String, CustomStringConvertible, Codable {
        case transitGateway = "TRANSIT_GATEWAY"
        public var description: String { return self.rawValue }
    }

    public enum ProxyType: String, CustomStringConvertible, Codable {
        case apiGateway = "API_GATEWAY"
        public var description: String { return self.rawValue }
    }

    public enum RouteActivationState: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
        public var description: String { return self.rawValue }
    }
    ...
    public enum ServiceEndpointType: String, CustomStringConvertible, Codable {
        case lambda = "LAMBDA"
        case url = "URL"
        public var description: String { return self.rawValue }
    }
    ...
    public struct CreateApplicationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "environmentIdentifier", location: .uri(locationName: "EnvironmentIdentifier"))
        ]
    ...
    public struct CreateRouteRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationIdentifier", location: .uri(locationName: "ApplicationIdentifier")),
            AWSMemberEncoding(label: "environmentIdentifier", location: .uri(locationName: "EnvironmentIdentifier"))
        ]
    ...
    public struct DeleteRouteRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationIdentifier", location: .uri(locationName: "ApplicationIdentifier")),
            AWSMemberEncoding(label: "environmentIdentifier", location: .uri(locationName: "EnvironmentIdentifier")),
            AWSMemberEncoding(label: "routeIdentifier", location: .uri(locationName: "RouteIdentifier"))
        ]
    ...
    public struct DeleteServiceRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationIdentifier", location: .uri(locationName: "ApplicationIdentifier")),
            AWSMemberEncoding(label: "environmentIdentifier", location: .uri(locationName: "EnvironmentIdentifier")),
            AWSMemberEncoding(label: "serviceIdentifier", location: .uri(locationName: "ServiceIdentifier"))
        ]
    ...
    public struct UriPathRouteInput: AWSEncodableShape & AWSDecodableShape {
        ...
        public init(activationState: RouteActivationState, includeChildPaths: Bool? = nil, methods: [HttpMethod]? = nil, sourcePath: String) {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.sourcePath, name: "sourcePath", parent: name, pattern: "^(/[a-zA-Z0-9._-]+)+$")
        }
