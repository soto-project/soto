...
public struct IVS: AWSService {
    ...
    public func batchStartViewerSessionRevocation(_ input: BatchStartViewerSessionRevocationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchStartViewerSessionRevocationResponse> {
        return self.client.execute(operation: "BatchStartViewerSessionRevocation", path: "/BatchStartViewerSessionRevocation", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getStreamSession(_ input: GetStreamSessionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetStreamSessionResponse> {
        return self.client.execute(operation: "GetStreamSession", path: "/GetStreamSession", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listStreamSessions(_ input: ListStreamSessionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStreamSessionsResponse> {
        return self.client.execute(operation: "ListStreamSessions", path: "/ListStreamSessions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func startViewerSessionRevocation(_ input: StartViewerSessionRevocationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartViewerSessionRevocationResponse> {
        return self.client.execute(operation: "StartViewerSessionRevocation", path: "/StartViewerSessionRevocation", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
