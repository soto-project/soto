...
public struct MediaConnect: AWSService {
    ...
    public func addFlowMediaStreams(_ input: AddFlowMediaStreamsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddFlowMediaStreamsResponse> {
        return self.client.execute(operation: "AddFlowMediaStreams", path: "/v1/flows/{flowArn}/mediaStreams", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func removeFlowMediaStream(_ input: RemoveFlowMediaStreamRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveFlowMediaStreamResponse> {
        return self.client.execute(operation: "RemoveFlowMediaStream", path: "/v1/flows/{flowArn}/mediaStreams/{mediaStreamName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateFlowMediaStream(_ input: UpdateFlowMediaStreamRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFlowMediaStreamResponse> {
        return self.client.execute(operation: "UpdateFlowMediaStream", path: "/v1/flows/{flowArn}/mediaStreams/{mediaStreamName}", httpMethod: .PUT, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
