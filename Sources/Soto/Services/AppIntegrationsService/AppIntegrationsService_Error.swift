...
/// Error enum for AppIntegrationsService
public struct AppIntegrationsServiceErrorType: AWSErrorType {
    enum Code: String {
    ...
    /// initialize AppIntegrationsService
...
extension AppIntegrationsServiceErrorType: Equatable {
    public static func == (lhs: AppIntegrationsServiceErrorType, rhs: AppIntegrationsServiceErrorType) -> Bool {
        lhs.error == rhs.error
    }
}

extension AppIntegrationsServiceErrorType: CustomStringConvertible {
