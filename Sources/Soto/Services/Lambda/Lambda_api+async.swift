...
extension Lambda {
    ...
    public func invokeWithResponseStream(_ input: InvokeWithResponseStreamRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> InvokeWithResponseStreamResponse {
        return try await self.client.execute(operation: "InvokeWithResponseStream", path: "/2021-11-15/functions/{FunctionName}/response-streaming-invocations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
