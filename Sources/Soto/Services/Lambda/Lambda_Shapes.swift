...
extension Lambda {
    ...
    public struct FunctionCode: AWSEncodableShape {
        ...
        public init(imageUri: String? = nil, s3Bucket: String? = nil, s3Key: String? = nil, s3ObjectVersion: String? = nil, zipFile: AWSBlob? = nil) {
    ...
    public struct LayerVersionContentInput: AWSEncodableShape {
        ...
        public init(s3Bucket: String? = nil, s3Key: String? = nil, s3ObjectVersion: String? = nil, zipFile: AWSBlob? = nil) {
            self.s3Bucket = s3Bucket
            self.s3Key = s3Key
            self.s3ObjectVersion = s3ObjectVersion
            self.zipFile = zipFile
    ...
    public struct UpdateFunctionCodeRequest: AWSEncodableShape {
        ...
        public init(architectures: [Architecture]? = nil, dryRun: Bool? = nil, functionName: String, imageUri: String? = nil, publish: Bool? = nil, revisionId: String? = nil, s3Bucket: String? = nil, s3Key: String? = nil, s3ObjectVersion: String? = nil, zipFile: AWSBlob? = nil) {
            self.architectures = architectures
            self.dryRun = dryRun
            self.functionName = functionName
            self.imageUri = imageUri
