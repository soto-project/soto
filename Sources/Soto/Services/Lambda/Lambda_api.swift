...
public struct Lambda: AWSService {
    ...
    public func getRuntimeManagementConfig(_ input: GetRuntimeManagementConfigRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRuntimeManagementConfigResponse> {
        return self.client.execute(operation: "GetRuntimeManagementConfig", path: "/2021-07-20/functions/{FunctionName}/runtime-management-config", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func invokeWithResponseStream(_ input: InvokeWithResponseStreamRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InvokeWithResponseStreamResponse> {
        return self.client.execute(operation: "InvokeWithResponseStream", path: "/2021-11-15/functions/{FunctionName}/response-streaming-invocations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putRuntimeManagementConfig(_ input: PutRuntimeManagementConfigRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRuntimeManagementConfigResponse> {
        return self.client.execute(operation: "PutRuntimeManagementConfig", path: "/2021-07-20/functions/{FunctionName}/runtime-management-config", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
