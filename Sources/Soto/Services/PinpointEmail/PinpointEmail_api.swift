...
public struct PinpointEmail: AWSService {
    ...
    public func createConfigurationSet(_ input: CreateConfigurationSetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateConfigurationSetResponse {
        return try await self.client.execute(operation: "CreateConfigurationSet", path: "/v1/email/configuration-sets", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createConfigurationSetEventDestination(_ input: CreateConfigurationSetEventDestinationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateConfigurationSetEventDestinationResponse {
        return try await self.client.execute(operation: "CreateConfigurationSetEventDestination", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createDedicatedIpPool(_ input: CreateDedicatedIpPoolRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateDedicatedIpPoolResponse {
        return try await self.client.execute(operation: "CreateDedicatedIpPool", path: "/v1/email/dedicated-ip-pools", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createDeliverabilityTestReport(_ input: CreateDeliverabilityTestReportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateDeliverabilityTestReportResponse {
        return try await self.client.execute(operation: "CreateDeliverabilityTestReport", path: "/v1/email/deliverability-dashboard/test", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createEmailIdentity(_ input: CreateEmailIdentityRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateEmailIdentityResponse {
        return try await self.client.execute(operation: "CreateEmailIdentity", path: "/v1/email/identities", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteConfigurationSet(_ input: DeleteConfigurationSetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteConfigurationSetResponse {
        return try await self.client.execute(operation: "DeleteConfigurationSet", path: "/v1/email/configuration-sets/{ConfigurationSetName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteConfigurationSetEventDestination(_ input: DeleteConfigurationSetEventDestinationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteConfigurationSetEventDestinationResponse {
        return try await self.client.execute(operation: "DeleteConfigurationSetEventDestination", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteDedicatedIpPool(_ input: DeleteDedicatedIpPoolRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteDedicatedIpPoolResponse {
        return try await self.client.execute(operation: "DeleteDedicatedIpPool", path: "/v1/email/dedicated-ip-pools/{PoolName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteEmailIdentity(_ input: DeleteEmailIdentityRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteEmailIdentityResponse {
        return try await self.client.execute(operation: "DeleteEmailIdentity", path: "/v1/email/identities/{EmailIdentity}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getAccount(_ input: GetAccountRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetAccountResponse {
        return try await self.client.execute(operation: "GetAccount", path: "/v1/email/account", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBlacklistReports(_ input: GetBlacklistReportsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBlacklistReportsResponse {
        return try await self.client.execute(operation: "GetBlacklistReports", path: "/v1/email/deliverability-dashboard/blacklist-report", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getConfigurationSet(_ input: GetConfigurationSetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetConfigurationSetResponse {
        return try await self.client.execute(operation: "GetConfigurationSet", path: "/v1/email/configuration-sets/{ConfigurationSetName}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getConfigurationSetEventDestinations(_ input: GetConfigurationSetEventDestinationsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetConfigurationSetEventDestinationsResponse {
        return try await self.client.execute(operation: "GetConfigurationSetEventDestinations", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDedicatedIp(_ input: GetDedicatedIpRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDedicatedIpResponse {
        return try await self.client.execute(operation: "GetDedicatedIp", path: "/v1/email/dedicated-ips/{Ip}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDedicatedIps(_ input: GetDedicatedIpsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDedicatedIpsResponse {
        return try await self.client.execute(operation: "GetDedicatedIps", path: "/v1/email/dedicated-ips", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDeliverabilityDashboardOptions(_ input: GetDeliverabilityDashboardOptionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDeliverabilityDashboardOptionsResponse {
        return try await self.client.execute(operation: "GetDeliverabilityDashboardOptions", path: "/v1/email/deliverability-dashboard", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDeliverabilityTestReport(_ input: GetDeliverabilityTestReportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDeliverabilityTestReportResponse {
        return try await self.client.execute(operation: "GetDeliverabilityTestReport", path: "/v1/email/deliverability-dashboard/test-reports/{ReportId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDomainDeliverabilityCampaign(_ input: GetDomainDeliverabilityCampaignRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDomainDeliverabilityCampaignResponse {
        return try await self.client.execute(operation: "GetDomainDeliverabilityCampaign", path: "/v1/email/deliverability-dashboard/campaigns/{CampaignId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDomainStatisticsReport(_ input: GetDomainStatisticsReportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDomainStatisticsReportResponse {
        return try await self.client.execute(operation: "GetDomainStatisticsReport", path: "/v1/email/deliverability-dashboard/statistics-report/{Domain}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getEmailIdentity(_ input: GetEmailIdentityRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetEmailIdentityResponse {
        return try await self.client.execute(operation: "GetEmailIdentity", path: "/v1/email/identities/{EmailIdentity}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listConfigurationSets(_ input: ListConfigurationSetsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListConfigurationSetsResponse {
        return try await self.client.execute(operation: "ListConfigurationSets", path: "/v1/email/configuration-sets", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listDedicatedIpPools(_ input: ListDedicatedIpPoolsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListDedicatedIpPoolsResponse {
        return try await self.client.execute(operation: "ListDedicatedIpPools", path: "/v1/email/dedicated-ip-pools", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listDeliverabilityTestReports(_ input: ListDeliverabilityTestReportsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListDeliverabilityTestReportsResponse {
        return try await self.client.execute(operation: "ListDeliverabilityTestReports", path: "/v1/email/deliverability-dashboard/test-reports", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listDomainDeliverabilityCampaigns(_ input: ListDomainDeliverabilityCampaignsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListDomainDeliverabilityCampaignsResponse {
        return try await self.client.execute(operation: "ListDomainDeliverabilityCampaigns", path: "/v1/email/deliverability-dashboard/domains/{SubscribedDomain}/campaigns", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listEmailIdentities(_ input: ListEmailIdentitiesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListEmailIdentitiesResponse {
        return try await self.client.execute(operation: "ListEmailIdentities", path: "/v1/email/identities", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTagsForResourceResponse {
        return try await self.client.execute(operation: "ListTagsForResource", path: "/v1/email/tags", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putAccountDedicatedIpWarmupAttributes(_ input: PutAccountDedicatedIpWarmupAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutAccountDedicatedIpWarmupAttributesResponse {
        return try await self.client.execute(operation: "PutAccountDedicatedIpWarmupAttributes", path: "/v1/email/account/dedicated-ips/warmup", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putAccountSendingAttributes(_ input: PutAccountSendingAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutAccountSendingAttributesResponse {
        return try await self.client.execute(operation: "PutAccountSendingAttributes", path: "/v1/email/account/sending", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putConfigurationSetDeliveryOptions(_ input: PutConfigurationSetDeliveryOptionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutConfigurationSetDeliveryOptionsResponse {
        return try await self.client.execute(operation: "PutConfigurationSetDeliveryOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/delivery-options", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putConfigurationSetReputationOptions(_ input: PutConfigurationSetReputationOptionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutConfigurationSetReputationOptionsResponse {
        return try await self.client.execute(operation: "PutConfigurationSetReputationOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/reputation-options", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putConfigurationSetSendingOptions(_ input: PutConfigurationSetSendingOptionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutConfigurationSetSendingOptionsResponse {
        return try await self.client.execute(operation: "PutConfigurationSetSendingOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/sending", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putConfigurationSetTrackingOptions(_ input: PutConfigurationSetTrackingOptionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutConfigurationSetTrackingOptionsResponse {
        return try await self.client.execute(operation: "PutConfigurationSetTrackingOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/tracking-options", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putDedicatedIpInPool(_ input: PutDedicatedIpInPoolRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutDedicatedIpInPoolResponse {
        return try await self.client.execute(operation: "PutDedicatedIpInPool", path: "/v1/email/dedicated-ips/{Ip}/pool", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putDedicatedIpWarmupAttributes(_ input: PutDedicatedIpWarmupAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutDedicatedIpWarmupAttributesResponse {
        return try await self.client.execute(operation: "PutDedicatedIpWarmupAttributes", path: "/v1/email/dedicated-ips/{Ip}/warmup", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putDeliverabilityDashboardOption(_ input: PutDeliverabilityDashboardOptionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutDeliverabilityDashboardOptionResponse {
        return try await self.client.execute(operation: "PutDeliverabilityDashboardOption", path: "/v1/email/deliverability-dashboard", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putEmailIdentityDkimAttributes(_ input: PutEmailIdentityDkimAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutEmailIdentityDkimAttributesResponse {
        return try await self.client.execute(operation: "PutEmailIdentityDkimAttributes", path: "/v1/email/identities/{EmailIdentity}/dkim", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putEmailIdentityFeedbackAttributes(_ input: PutEmailIdentityFeedbackAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutEmailIdentityFeedbackAttributesResponse {
        return try await self.client.execute(operation: "PutEmailIdentityFeedbackAttributes", path: "/v1/email/identities/{EmailIdentity}/feedback", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putEmailIdentityMailFromAttributes(_ input: PutEmailIdentityMailFromAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutEmailIdentityMailFromAttributesResponse {
        return try await self.client.execute(operation: "PutEmailIdentityMailFromAttributes", path: "/v1/email/identities/{EmailIdentity}/mail-from", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func sendEmail(_ input: SendEmailRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SendEmailResponse {
        return try await self.client.execute(operation: "SendEmail", path: "/v1/email/outbound-emails", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func tagResource(_ input: TagResourceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> TagResourceResponse {
        return try await self.client.execute(operation: "TagResource", path: "/v1/email/tags", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }

    /// Remove one or more tags (keys and values) from a specified resource.
    @Sendable
    public func untagResource(_ input: UntagResourceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UntagResourceResponse {
        return try await self.client.execute(operation: "UntagResource", path: "/v1/email/tags", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateConfigurationSetEventDestination(_ input: UpdateConfigurationSetEventDestinationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateConfigurationSetEventDestinationResponse {
        return try await self.client.execute(operation: "UpdateConfigurationSetEventDestination", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
}
