...
extension MediaPackageV2 {
    ...
    public struct CreateChannelGroupResponse: AWSDecodableShape {
        ...
        public init(arn: String, channelGroupName: String, createdAt: Date, description: String? = nil, egressDomain: String, modifiedAt: Date, tags: [String: String]? = nil) {
            self.arn = arn
            self.channelGroupName = channelGroupName
            self.createdAt = createdAt
            self.description = description
    ...
    public struct CreateChannelResponse: AWSDecodableShape {
        ...
        public init(arn: String, channelGroupName: String, channelName: String, createdAt: Date, description: String? = nil, ingestEndpoints: [IngestEndpoint]? = nil, modifiedAt: Date, tags: [String: String]? = nil) {
            self.arn = arn
            self.channelGroupName = channelGroupName
            self.channelName = channelName
            self.createdAt = createdAt
    ...
    public struct UpdateChannelRequest: AWSEncodableShape {
        ...
        public init(channelGroupName: String, channelName: String, description: String? = nil) {
            self.channelGroupName = channelGroupName
            self.channelName = channelName
            self.description = description
        }
    ...
    public struct UpdateOriginEndpointRequest: AWSEncodableShape {
        ...
        public init(channelGroupName: String, channelName: String, containerType: ContainerType, description: String? = nil, hlsManifests: [CreateHlsManifestConfiguration]? = nil, lowLatencyHlsManifests: [CreateLowLatencyHlsManifestConfiguration]? = nil, originEndpointName: String, segment: Segment? = nil, startoverWindowSeconds: Int? = nil) {
            self.channelGroupName = channelGroupName
            self.channelName = channelName
            self.containerType = containerType
            self.description = description
