...
extension RedshiftDataAPIService {
    ...
    public struct DescribeStatementResponse: AWSDecodableShape {
        ...
        public init(clusterIdentifier: String? = nil, createdAt: Date? = nil, database: String? = nil, dbUser: String? = nil, duration: Int64? = nil, error: String? = nil, id: String, queryString: String? = nil, redshiftPid: Int64? = nil, redshiftQueryId: Int64? = nil, resultRows: Int64? = nil, resultSize: Int64? = nil, secretArn: String? = nil, status: StatusString? = nil, updatedAt: Date? = nil) {
