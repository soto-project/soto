...
extension RedshiftDataAPIService {
    ...
    public enum StatementStatusString: String, CustomStringConvertible, Codable {
    ...
    public struct BatchExecuteStatementInput: AWSEncodableShape {
        ...
        public init(clusterIdentifier: String, database: String, dbUser: String? = nil, secretArn: String? = nil, sqls: [String], statementName: String? = nil, withEvent: Bool? = nil) {
    ...
    public struct ExecuteStatementInput: AWSEncodableShape {
        ...
        public init(clusterIdentifier: String, database: String, dbUser: String? = nil, parameters: [SqlParameter]? = nil, secretArn: String? = nil, sql: String, statementName: String? = nil, withEvent: Bool? = nil) {
            self.clusterIdentifier = clusterIdentifier
            self.database = database
            self.dbUser = dbUser
    ...
    public struct ListDatabasesRequest: AWSEncodableShape {
        ...
        public init(clusterIdentifier: String, database: String, dbUser: String? = nil, maxResults: Int? = nil, nextToken: String? = nil, secretArn: String? = nil) {
            self.clusterIdentifier = clusterIdentifier
            self.database = database
            self.dbUser = dbUser
            self.maxResults = maxResults
