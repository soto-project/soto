...
public struct EventBridge: AWSService {
    ...
    ///   - name: The name of the global endpoint. For example, "Name":"us-east-2-custom_bus_A-endpoint".
    ...
    public func createEndpoint(
        ...
        name: String,
        replicationConfig: ReplicationConfig? = nil,
        roleArn: String? = nil,
    ...
    ///   - logConfig: The logging configuration settings for the event bus. For more information, see Configuring logs for event buses in the EventBridge User Guide.
    ...
    ///
    /// Parameters:
    ///   - name: The name of the endpoint you want to delete. For example, "Name":"us-east-2-custom_bus_A-endpoint"..
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - name: The name of the endpoint you want to get information about. For example, "Name":"us-east-2-custom_bus_A-endpoint".
    ///   - logger: Logger use during operation
    @inlinable
    ...
    public func updateEndpoint(
        description: String? = nil,
        eventBuses: [EndpointEventBus]? = nil,
        name: String,
        replicationConfig: ReplicationConfig? = nil,
        roleArn: String? = nil,
        routingConfig: RoutingConfig? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    @Sendable
    @inlinable
    public func updateEventBus(_ input: UpdateEventBusRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateEventBusResponse {
        try await self.client.execute(
    ...
    public func updateEventBus(
        ...
        name: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UpdateEventBusResponse {
        let input = UpdateEventBusRequest(
            deadLetterConfig: deadLetterConfig, 
            description: description, 
            kmsKeyIdentifier: kmsKeyIdentifier, 
            logConfig: logConfig, 
        ...
        return try await self.updateEventBus(input, logger: logger)
    }
}
