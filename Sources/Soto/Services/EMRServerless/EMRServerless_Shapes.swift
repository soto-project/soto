...
extension EMRServerless {
    ...
    public struct AutoStopConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.idleTimeoutMinutes, name: "idleTimeoutMinutes", parent: name, max: 10080)
            try self.validate(self.idleTimeoutMinutes, name: "idleTimeoutMinutes", parent: name, min: 1)
        }
    ...
    public struct CancelJobRunRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "jobRunId", location: .uri(locationName: "jobRunId"))
        ]
    ...
    public class Configuration: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.configurations, name: "configurations", parent: name, min: 0)
    ...
    public struct ConfigurationOverrides: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.applicationConfiguration, name: "applicationConfiguration", parent: name, min: 0)
    ...
    public struct CreateApplicationRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.autoStopConfiguration?.validate(name: "\(name).autoStopConfiguration")
    ...
    public struct JobDriver: AWSEncodableShape & AWSDecodableShape {
        ...
        public let sparkSubmit: SparkSubmit?

        public init(hive: Hive? = nil, sparkSubmit: SparkSubmit? = nil) {
            self.hive = hive
            self.sparkSubmit = sparkSubmit
        }

        public func validate(name: String) throws {
            try self.hive?.validate(name: "\(name).hive")
            try self.sparkSubmit?.validate(name: "\(name).sparkSubmit")
        }
    ...
    public struct ListJobRunsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationId", location: .uri(locationName: "applicationId")),
            AWSMemberEncoding(label: "createdAtAfter", location: .querystring(locationName: "createdAtAfter")),
            AWSMemberEncoding(label: "createdAtBefore", location: .querystring(locationName: "createdAtBefore")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "states", location: .querystring(locationName: "states"))
        ]
