...
extension Batch {
    ...
    public struct CancelJobsErrorDetail: AWSDecodableShape {
        ...
        @inlinable
        public init(code: String? = nil, job: String? = nil, message: String? = nil) {
            self.code = code
            self.job = job
    ...
    public struct CancelJobsRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(jobs: [String]? = nil, reason: String? = nil) {
            self.jobs = jobs
            self.reason = reason
        }
    ...
    public struct CancelJobsResponse: AWSDecodableShape {
        ...
        public let errors: [CancelJobsErrorDetail]?
        /// A list of the job IDs whose cancellation request was accepted.
        public let successful: [String]?

        @inlinable
        public init(errors: [CancelJobsErrorDetail]? = nil, successful: [String]? = nil) {
            self.errors = errors
    ...
    public struct JobSummary: AWSDecodableShape {
        ...
        @inlinable
        public init(arrayProperties: ArrayPropertiesSummary? = nil, capacityUsage: [JobCapacityUsageSummary]? = nil, container: ContainerSummary? = nil, createdAt: Int64? = nil, isCancelled: Bool? = nil, isTerminated: Bool? = nil, jobArn: String? = nil, jobDefinition: String? = nil, jobId: String? = nil, jobName: String? = nil, nodeProperties: NodePropertiesSummary? = nil, scheduledAt: Int64? = nil, shareIdentifier: String? = nil, startedAt: Int64? = nil, status: JobStatus? = nil, statusReason: String? = nil, stoppedAt: Int64? = nil) {
            self.arrayProperties = arrayProperties
            self.capacityUsage = capacityUsage
            self.container = container
            self.createdAt = createdAt
    ...
    public struct ServiceJobSummary: AWSDecodableShape {
        ...
        @inlinable
        public init(capacityUsage: [ServiceJobCapacityUsageSummary]? = nil, createdAt: Int64? = nil, isTerminated: Bool? = nil, jobArn: String? = nil, jobId: String? = nil, jobName: String? = nil, latestAttempt: LatestServiceJobAttempt? = nil, quotaShareName: String? = nil, scheduledAt: Int64? = nil, serviceJobType: ServiceJobType? = nil, shareIdentifier: String? = nil, startedAt: Int64? = nil, status: ServiceJobStatus? = nil, statusReason: String? = nil, stoppedAt: Int64? = nil) {
            self.capacityUsage = capacityUsage
            self.createdAt = createdAt
            self.isTerminated = isTerminated
            self.jobArn = jobArn
    ...
    public struct TerminateJobsErrorDetail: AWSDecodableShape {
        /// An error code that identifies the reason the job couldn't be terminated. Valid values are:    ValidationException – A job identifier in the request is malformed or isn't valid.    ClientException – The request failed because of a client error.    ThrottlingException – The request was throttled. Retry the request.    ServerException – An internal error occurred. Retry the request.    AccessDenied – The caller isn't authorized to perform the action on the specified job.
        public let code: String?
    ...
    public struct TerminateJobsRequest: AWSEncodableShape {
    ...
    public struct TerminateJobsResponse: AWSDecodableShape {
        ...
        public let errors: [TerminateJobsErrorDetail]?
        /// A list of the job IDs whose termination request was accepted.
        public let successful: [String]?

        @inlinable
        public init(errors: [TerminateJobsErrorDetail]? = nil, successful: [String]? = nil) {
            self.errors = errors
            self.successful = successful
        }
    ...
    public struct TerminateServiceJobsErrorDetail: AWSDecodableShape {
        /// An error code that identifies the reason the service job couldn't be terminated. Valid values are:    ValidationException – A service job identifier in the request is malformed or isn't valid.    ClientException – The request failed because of a client error.    ThrottlingException – The request was throttled. Retry the request.    ServerException – An internal error occurred. Retry the request.    AccessDenied – The caller isn't authorized to perform the action on the specified service job.
        public let code: String?
    ...
    public struct TerminateServiceJobsRequest: AWSEncodableShape {
    ...
    public struct TerminateServiceJobsResponse: AWSDecodableShape {
        ...
        public let errors: [TerminateServiceJobsErrorDetail]?
        /// A list of the service job IDs whose termination request was accepted.
        public let successful: [String]?

        @inlinable
        public init(errors: [TerminateServiceJobsErrorDetail]? = nil, successful: [String]? = nil) {
            self.errors = errors
            self.successful = successful
        }
