...
public struct Batch: AWSService {
    ...
    ///
    /// Parameters:
    ///   - filters: The filter to apply to the query. Only one filter can be used at a time. When the
    ///   - jobQueue: The name or ARN of the job queue with which to list service jobs.
    ///   - jobStatus: The job status used to filter service jobs in the specified queue. If the filters
