...
public struct SNS: AWSService {
    ...
    public func checkIfPhoneNumberIsOptedOut(_ input: CheckIfPhoneNumberIsOptedOutInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CheckIfPhoneNumberIsOptedOutResponse> {
        return self.client.execute(operation: "CheckIfPhoneNumberIsOptedOut", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Verifies an endpoint owner's intent to receive messages by validating the token sent to the endpoint by an earlier Subscribe action. If the token is valid, the action creates a new subscription and returns its Amazon Resource Name (ARN). This call requires an AWS signature only when the AuthenticateOnUnsubscribe flag is set to "true".
    public func confirmSubscription(_ input: ConfirmSubscriptionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfirmSubscriptionResponse> {
        return self.client.execute(operation: "ConfirmSubscription", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createPlatformApplication(_ input: CreatePlatformApplicationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePlatformApplicationResponse> {
        return self.client.execute(operation: "CreatePlatformApplication", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createPlatformEndpoint(_ input: CreatePlatformEndpointInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateEndpointResponse> {
    ...
    @discardableResult public func deleteEndpoint(_ input: DeleteEndpointInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteEndpoint", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteTopic(_ input: DeleteTopicInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteTopic", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves the endpoint attributes for a device on one of the supported push notification services, such as GCM (Firebase Cloud Messaging) and APNS. For more information, see Using Amazon SNS Mobile Push Notifications.
    public func getEndpointAttributes(_ input: GetEndpointAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetEndpointAttributesResponse> {
        return self.client.execute(operation: "GetEndpointAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves the attributes of the platform application object for the supported push notification services, such as APNS and GCM (Firebase Cloud Messaging). For more information, see Using Amazon SNS Mobile Push Notifications.
    public func getPlatformApplicationAttributes(_ input: GetPlatformApplicationAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPlatformApplicationAttributesResponse> {
        return self.client.execute(operation: "GetPlatformApplicationAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns the settings for sending SMS messages from your account. These settings are set with the SetSMSAttributes action.
    public func getSMSAttributes(_ input: GetSMSAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSMSAttributesResponse> {
    ...
    public func getTopicAttributes(_ input: GetTopicAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTopicAttributesResponse> {
        return self.client.execute(operation: "GetTopicAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listEndpointsByPlatformApplication(_ input: ListEndpointsByPlatformApplicationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListEndpointsByPlatformApplicationResponse> {
    ...
    public func listSubscriptions(_ input: ListSubscriptionsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSubscriptionsResponse> {
        return self.client.execute(operation: "ListSubscriptions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listSubscriptionsByTopic(_ input: ListSubscriptionsByTopicInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSubscriptionsByTopicResponse> {
        return self.client.execute(operation: "ListSubscriptionsByTopic", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTopics(_ input: ListTopicsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTopicsResponse> {
        return self.client.execute(operation: "ListTopics", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func optInPhoneNumber(_ input: OptInPhoneNumberInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<OptInPhoneNumberResponse> {
    ...
    @discardableResult public func removePermission(_ input: RemovePermissionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func setEndpointAttributes(_ input: SetEndpointAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "SetEndpointAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Sets the attributes of the platform application object for the supported push notification services, such as APNS and GCM (Firebase Cloud Messaging). For more information, see Using Amazon SNS Mobile Push Notifications. For information on configuring attributes for message delivery status, see Using Amazon SNS Application Attributes for Message Delivery Status.
    @discardableResult public func setPlatformApplicationAttributes(_ input: SetPlatformApplicationAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "SetPlatformApplicationAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func setSMSAttributes(_ input: SetSMSAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SetSMSAttributesResponse> {
        return self.client.execute(operation: "SetSMSAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Allows a subscription owner to set an attribute of the subscription to a new value.
    @discardableResult public func setSubscriptionAttributes(_ input: SetSubscriptionAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "SetSubscriptionAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Allows a topic owner to set an attribute of the topic to a new value.
    @discardableResult public func setTopicAttributes(_ input: SetTopicAttributesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
