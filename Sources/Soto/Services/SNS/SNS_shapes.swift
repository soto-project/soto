...
extension SNS {
    ...
    public struct CreateTopicInput: AWSEncodableShape {
        ...
        /// Amazon SNS message data protection availability change.  The body of the policy document you want to use for this topic. You can only add one policy per topic. The policy must be in JSON string format. Length Constraints: Maximum length of 30,720.
