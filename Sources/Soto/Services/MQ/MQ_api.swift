...
public struct MQ: AWSService {
    ...
    public func promote(_ input: PromoteRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PromoteResponse> {
        return self.client.execute(operation: "Promote", path: "/v1/brokers/{BrokerId}/promote", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
