...
public struct FSx: AWSService {
    ...
    public func cancelDataRepositoryTask(_ input: CancelDataRepositoryTaskRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CancelDataRepositoryTaskResponse> {
        return self.client.execute(operation: "CancelDataRepositoryTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createDataRepositoryTask(_ input: CreateDataRepositoryTaskRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateDataRepositoryTaskResponse> {
        return self.client.execute(operation: "CreateDataRepositoryTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateFileSystemResponse> {
        return self.client.execute(operation: "CreateFileSystem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createFileSystemFromBackup(_ input: CreateFileSystemFromBackupRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateFileSystemFromBackupResponse> {
        return self.client.execute(operation: "CreateFileSystemFromBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteFileSystem(_ input: DeleteFileSystemRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteFileSystemResponse> {
        return self.client.execute(operation: "DeleteFileSystem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeDataRepositoryTasks(_ input: DescribeDataRepositoryTasksRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeDataRepositoryTasksResponse> {
        return self.client.execute(operation: "DescribeDataRepositoryTasks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeFileSystems(_ input: DescribeFileSystemsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeFileSystemsResponse> {
        return self.client.execute(operation: "DescribeFileSystems", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateFileSystem(_ input: UpdateFileSystemRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateFileSystemResponse> {
        return self.client.execute(operation: "UpdateFileSystem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
}
