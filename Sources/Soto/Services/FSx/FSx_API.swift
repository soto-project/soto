...
public struct FSx: AWSService {
    ...
    public func associateFileSystemAliases(_ input: AssociateFileSystemAliasesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateFileSystemAliasesResponse> {
        return self.client.execute(operation: "AssociateFileSystemAliases", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func cancelDataRepositoryTask(_ input: CancelDataRepositoryTaskRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelDataRepositoryTaskResponse> {
        return self.client.execute(operation: "CancelDataRepositoryTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func copyBackup(_ input: CopyBackupRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyBackupResponse> {
        return self.client.execute(operation: "CopyBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createDataRepositoryTask(_ input: CreateDataRepositoryTaskRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDataRepositoryTaskResponse> {
        return self.client.execute(operation: "CreateDataRepositoryTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFileSystemResponse> {
        return self.client.execute(operation: "CreateFileSystem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createFileSystemFromBackup(_ input: CreateFileSystemFromBackupRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFileSystemFromBackupResponse> {
        return self.client.execute(operation: "CreateFileSystemFromBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteFileSystem(_ input: DeleteFileSystemRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFileSystemResponse> {
        return self.client.execute(operation: "DeleteFileSystem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeDataRepositoryTasks(_ input: DescribeDataRepositoryTasksRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDataRepositoryTasksResponse> {
        return self.client.execute(operation: "DescribeDataRepositoryTasks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns the DNS aliases that are associated with the specified Amazon FSx for Windows File Server file system. A history of all DNS aliases that have been associated with and disassociated from the file system is available in the list of AdministrativeAction provided in the DescribeFileSystems operation response.
    public func describeFileSystemAliases(_ input: DescribeFileSystemAliasesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFileSystemAliasesResponse> {
        return self.client.execute(operation: "DescribeFileSystemAliases", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeFileSystems(_ input: DescribeFileSystemsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFileSystemsResponse> {
        return self.client.execute(operation: "DescribeFileSystems", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func disassociateFileSystemAliases(_ input: DisassociateFileSystemAliasesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateFileSystemAliasesResponse> {
        return self.client.execute(operation: "DisassociateFileSystemAliases", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
