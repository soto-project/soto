...
extension Ivschat {
    ...
    public enum ChatTokenCapability: String, CustomStringConvertible, Codable {
    ...
    public enum FallbackResult: String, CustomStringConvertible, Codable {
        case allow = "ALLOW"
        case deny = "DENY"
        public var description: String { return self.rawValue }
    }
    ...
    public struct ListRoomsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.messageReviewHandlerUri, name: "messageReviewHandlerUri", parent: name, min: 0)
    ...
    public struct MessageReviewHandler: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.uri, name: "uri", parent: name, min: 0)
