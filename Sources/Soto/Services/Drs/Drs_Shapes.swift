...
extension Drs {
    ...
    public enum EC2InstanceState: String, CustomStringConvertible, Codable {
    ...
    public enum ExtensionStatus: String, CustomStringConvertible, Codable {
    ...
    public enum FailbackReplicationError: String, CustomStringConvertible, Codable {
        case agentNotSeen = "AGENT_NOT_SEEN"
    ...
    public enum FailbackState: String, CustomStringConvertible, Codable {
    ...
    public enum LastLaunchResult: String, CustomStringConvertible, Codable {
        case failed = "FAILED"
        case notStarted = "NOT_STARTED"
        case pending = "PENDING"
        case succeeded = "SUCCEEDED"
    ...
    public enum LastLaunchType: String, CustomStringConvertible, Codable {
        case drill = "DRILL"
    ...
    public enum PITPolicyRuleUnits: String, CustomStringConvertible, Codable {
        case day = "DAY"
        case hour = "HOUR"
        case minute = "MINUTE"
        public var description: String { return self.rawValue }
    ...
    public enum RecoveryInstanceDataReplicationInitiationStepName: String, CustomStringConvertible, Codable {
    ...
    public enum RecoveryInstanceDataReplicationInitiationStepStatus: String, CustomStringConvertible, Codable {
        case failed = "FAILED"
        case inProgress = "IN_PROGRESS"
        case notStarted = "NOT_STARTED"
        case skipped = "SKIPPED"
    ...
    public enum RecoveryInstanceDataReplicationState: String, CustomStringConvertible, Codable {
        case backlog = "BACKLOG"
        case continuous = "CONTINUOUS"
        case creatingSnapshot = "CREATING_SNAPSHOT"
        case disconnected = "DISCONNECTED"
    ...
    public enum RecoverySnapshotsOrder: String, CustomStringConvertible, Codable {
        case asc = "ASC"
        case desc = "DESC"
        public var description: String { return self.rawValue }
    }
    ...
    public struct DescribeRecoveryInstancesRequestFilters: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.recoveryInstanceIDs, name: "recoveryInstanceIDs", parent: name, min: 0)
    ...
    public struct DescribeSourceServersRequestFilters: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.hardwareId, name: "hardwareId", parent: name, min: 0)
            try self.sourceServerIDs?.forEach {
                try validate($0, name: "sourceServerIDs[]", parent: name, max: 19)
                try validate($0, name: "sourceServerIDs[]", parent: name, min: 19)
                try validate($0, name: "sourceServerIDs[]", parent: name, pattern: "^s-[0-9a-zA-Z]{17}$")
            ...
            try self.validate(self.stagingAccountIDs, name: "stagingAccountIDs", parent: name, min: 0)
        }
