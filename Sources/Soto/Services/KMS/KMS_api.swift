...
public struct KMS: AWSService {
    ...
    /// combines the convenience and extensive integration of KMS with the isolation and control of a
    /// single-tenant key store.  Cross-account use: No. You cannot perform this operation on a custom key store in a different Amazon Web Services account.
    ...
    /// properties.  This operation is part of the custom key store feature feature in KMS, which
    /// combines the convenience and extensive integration of KMS with the isolation and control of a
    /// single-tenant key store.  Cross-account use: No. You cannot perform this operation on a custom key store in a different Amazon Web Services account.   Required permissions: kms:UpdateCustomKeyStore (IAM policy)  Related operations:     ConnectCustomKeyStore     CreateCustomKeyStore     DeleteCustomKeyStore     DescribeCustomKeyStores     DisconnectCustomKeyStore
