...
public struct KMS: AWSService {
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.  Required permissions: kms:CancelKeyDeletion (key policy)  Related operations: ScheduleKeyDeletion   Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    public func cancelKeyDeletion(_ input: CancelKeyDeletionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CancelKeyDeletionResponse {
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies the KMS key whose deletion is being canceled. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - logger: Logger use during operation
    @inlinable
    public func cancelKeyDeletion(
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CancelKeyDeletionResponse {
        let input = CancelKeyDeletionRequest(
            keyId: keyId
        )
        return try await self.cancelKeyDeletion(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func connectCustomKeyStore(_ input: ConnectCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ConnectCustomKeyStoreResponse {
        try await self.client.execute(
    ...
    @Sendable
    @inlinable
    public func createCustomKeyStore(_ input: CreateCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateCustomKeyStoreResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - cloudHsmClusterId: Identifies the CloudHSM cluster for an CloudHSM key store. This parameter is required for custom key stores with CustomKeyStoreType of AWS_CLOUDHSM. Enter the cluster ID of any active CloudHSM cluster that is not already associated with a custom key store. To find the cluster ID, use the DescribeClusters operation.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func createCustomKeyStore(
        cloudHsmClusterId: String? = nil,
        customKeyStoreName: String,
        customKeyStoreType: CustomKeyStoreType? = nil,
        keyStorePassword: String? = nil,
        trustAnchorCertificate: String? = nil,
        xksProxyAuthenticationCredential: XksProxyAuthenticationCredentialType? = nil,
        xksProxyConnectivity: XksProxyConnectivityType? = nil,
        xksProxyUriEndpoint: String? = nil,
        xksProxyUriPath: String? = nil,
        xksProxyVpcEndpointServiceName: String? = nil,
        xksProxyVpcEndpointServiceOwner: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateCustomKeyStoreResponse {
        let input = CreateCustomKeyStoreRequest(
        ...
        return try await self.createCustomKeyStore(input, logger: logger)
    }
    ...
    ///   - keyId: Identifies the KMS key for the grant. The grant gives principals permission to use this KMS key. Specify the key ID or key ARN of the KMS key. To specify a KMS key in a
    ...
    ///   - operations: A list of operations that the grant permits.  This list must include only operations that are permitted in a grant. Also, the operation must be supported on the KMS key. For example, you cannot create a grant for a symmetric encryption KMS key that allows the Sign operation, or a grant for an asymmetric KMS key that allows the GenerateDataKey operation. If you try, KMS returns a ValidationError exception. For details, see Grant operations in the Key Management Service Developer Guide.
    ...
    ///   - retiringServicePrincipal: The Amazon Web Services service principal that has permission to use the RetireGrant operation to retire the grant. You can specify either RetiringPrincipal or RetiringServicePrincipal, but not both.
    ///   - logger: Logger use during operation
    @inlinable
    public func createGrant(
        ...
        granteeServicePrincipal: String? = nil,
        grantTokens: [String]? = nil,
        keyId: String,
        name: String? = nil,
        operations: [GrantOperation],
        retiringPrincipal: String? = nil,
        retiringServicePrincipal: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///
    /// Parameters:
    ///   - ciphertextBlob: Ciphertext to be decrypted. The blob includes metadata. This parameter is required in all cases except when DryRun is true and DryRunModifiers is set to IGNORE_CIPHERTEXT.
    ///   - dryRun: Checks if your request will succeed. DryRun is an optional parameter.  To learn more about how to use this parameter, see Testing your permissions in the Key Management Service Developer Guide.
    ...
    @inlinable
    public func decrypt(
        ciphertextBlob: AWSBase64Data? = nil,
        dryRun: Bool? = nil,
        dryRunModifiers: [DryRunModifierType]? = nil,
        ...
        return try await self.decrypt(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func deleteCustomKeyStore(_ input: DeleteCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteCustomKeyStoreResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteCustomKeyStore(
        customKeyStoreId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteCustomKeyStoreResponse {
        let input = DeleteCustomKeyStoreRequest(
            customKeyStoreId: customKeyStoreId
        )
        return try await self.deleteCustomKeyStore(input, logger: logger)
    }

    /// Deletes key material that was previously imported. This operation makes the specified KMS key temporarily unusable. To restore the usability of the KMS key, reimport the same key material. For more information about importing key material into KMS, see Importing Key Material in the Key Management Service Developer Guide. When the specified KMS key is in the PendingDeletion state, this operation does not change the KMS key's state. Otherwise, it changes the KMS key's state to PendingImport.  Considerations for multi-Region symmetric encryption keys    When you delete the key material of a primary Region key that is in PENDING_ROTATION or PENDING_MULTI_REGION_IMPORT_AND_ROTATIONstate, you'll also be deleting the key materials for the replica Region keys.   If you delete any key material of a replica Region key, the primary Region key and other replica Region keys remain unchanged.   The KMS key that you use for this operation must be in a compatible key state. For
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.  Required permissions: kms:DeleteImportedKeyMaterial (key policy)  Related operations:     GetParametersForImport     ListKeyRotations     ImportKeyMaterial     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    public func deleteImportedKeyMaterial(_ input: DeleteImportedKeyMaterialRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteImportedKeyMaterialResponse {
        try await self.client.execute(
    ...
    @Sendable
    @inlinable
    public func deriveSharedSecret(_ input: DeriveSharedSecretRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeriveSharedSecretResponse {
        try await self.client.execute(
    ...
    ///   - dryRun: Checks if your request will succeed. DryRun is an optional parameter.  To learn more about how to use this parameter, see Testing your permissions in the Key Management Service Developer Guide.
    ///   - grantTokens: A list of grant tokens. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see Grant token and Using a grant token in the Key Management Service Developer Guide.
    ///   - keyAgreementAlgorithm: Specifies the key agreement algorithm used to derive the shared secret. The only valid value is ECDH.
    ...
    public func deriveSharedSecret(
        ...
        keyId: String,
        publicKey: AWSBase64Data,
        recipient: RecipientInfo? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeriveSharedSecretResponse {
        let input = DeriveSharedSecretRequest(
            dryRun: dryRun, 
            grantTokens: grantTokens, 
        ...
        return try await self.deriveSharedSecret(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func describeCustomKeyStores(_ input: DescribeCustomKeyStoresRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeCustomKeyStoresResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeCustomKeyStores(
        customKeyStoreId: String? = nil,
        customKeyStoreName: String? = nil,
        limit: Int? = nil,
        marker: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeCustomKeyStoresResponse {
        let input = DescribeCustomKeyStoresRequest(
            customKeyStoreId: customKeyStoreId, 
            customKeyStoreName: customKeyStoreName, 
            limit: limit, 
            marker: marker
        )
        return try await self.describeCustomKeyStores(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func disableKey(_ input: DisableKeyRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies the KMS key to disable. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - logger: Logger use during operation
    @inlinable
    public func disableKey(
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DisableKeyRequest(
            keyId: keyId
        )
        return try await self.disableKey(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies a symmetric encryption KMS key. You cannot enable or disable automatic rotation of asymmetric KMS keys, HMAC KMS keys, KMS keys with imported key material, or KMS keys in a custom key store. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - logger: Logger use during operation
    @inlinable
    public func disableKeyRotation(
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DisableKeyRotationRequest(
            keyId: keyId
        )
        return try await self.disableKeyRotation(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func disconnectCustomKeyStore(_ input: DisconnectCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DisconnectCustomKeyStoreResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func disconnectCustomKeyStore(
        customKeyStoreId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DisconnectCustomKeyStoreResponse {
        let input = DisconnectCustomKeyStoreRequest(
            customKeyStoreId: customKeyStoreId
        )
        return try await self.disconnectCustomKeyStore(input, logger: logger)
    }
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.  Required permissions: kms:EnableKey (key policy)  Related operations: DisableKey   Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    public func enableKey(_ input: EnableKeyRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
            operation: "EnableKey", 
            path: "/", 
            httpMethod: .POST, 
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies the KMS key to enable. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - logger: Logger use during operation
    @inlinable
    public func enableKey(
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = EnableKeyRequest(
            keyId: keyId
        )
        return try await self.enableKey(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func encrypt(_ input: EncryptRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> EncryptResponse {
        try await self.client.execute(
            operation: "Encrypt", 
            path: "/", 
            httpMethod: .POST, 
    ...
    public func encrypt(
        ...
        grantTokens: [String]? = nil,
        keyId: String,
        plaintext: AWSBase64Data,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> EncryptResponse {
        let input = EncryptRequest(
            dryRun: dryRun, 
            encryptionAlgorithm: encryptionAlgorithm, 
            encryptionContext: encryptionContext, 
            grantTokens: grantTokens, 
        ...
        return try await self.encrypt(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func generateDataKey(_ input: GenerateDataKeyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateDataKeyResponse {
        try await self.client.execute(
    ...
    public func generateDataKey(
        ...
        recipient: RecipientInfo? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GenerateDataKeyResponse {
        let input = GenerateDataKeyRequest(
            dryRun: dryRun, 
            encryptionContext: encryptionContext, 
            grantTokens: grantTokens, 
            keyId: keyId, 
        ...
        return try await self.generateDataKey(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func generateDataKeyPair(_ input: GenerateDataKeyPairRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateDataKeyPairResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func generateDataKeyPair(
        dryRun: Bool? = nil,
        encryptionContext: [String: String]? = nil,
        grantTokens: [String]? = nil,
        keyId: String,
        ...
        recipient: RecipientInfo? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GenerateDataKeyPairResponse {
        let input = GenerateDataKeyPairRequest(
            dryRun: dryRun, 
            encryptionContext: encryptionContext, 
            grantTokens: grantTokens, 
            keyId: keyId, 
        ...
        return try await self.generateDataKeyPair(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func generateDataKeyPairWithoutPlaintext(_ input: GenerateDataKeyPairWithoutPlaintextRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateDataKeyPairWithoutPlaintextResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func generateDataKeyPairWithoutPlaintext(
        dryRun: Bool? = nil,
        encryptionContext: [String: String]? = nil,
        grantTokens: [String]? = nil,
        keyId: String,
        keyPairSpec: DataKeyPairSpec,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GenerateDataKeyPairWithoutPlaintextResponse {
        let input = GenerateDataKeyPairWithoutPlaintextRequest(
            dryRun: dryRun, 
            encryptionContext: encryptionContext, 
            grantTokens: grantTokens, 
            keyId: keyId, 
        ...
        return try await self.generateDataKeyPairWithoutPlaintext(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func generateDataKeyWithoutPlaintext(_ input: GenerateDataKeyWithoutPlaintextRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateDataKeyWithoutPlaintextResponse {
        try await self.client.execute(
    ...
    public func generateDataKeyWithoutPlaintext(
        ...
        numberOfBytes: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GenerateDataKeyWithoutPlaintextResponse {
        let input = GenerateDataKeyWithoutPlaintextRequest(
            dryRun: dryRun, 
            encryptionContext: encryptionContext, 
            grantTokens: grantTokens, 
            keyId: keyId, 
        ...
        return try await self.generateDataKeyWithoutPlaintext(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func generateMac(_ input: GenerateMacRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateMacResponse {
        try await self.client.execute(
    ...
    ///   - dryRun: Checks if your request will succeed. DryRun is an optional parameter.  To learn more about how to use this parameter, see Testing your permissions in the Key Management Service Developer Guide.
    ///   - grantTokens: A list of grant tokens. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see Grant token and Using a grant token in the Key Management Service Developer Guide.
    ///   - keyId: The HMAC KMS key to use in the operation. The MAC algorithm computes the HMAC for the message and the key as described in RFC 2104. To identify an HMAC KMS key, use the DescribeKey operation and see the KeySpec field in the response.
    ///   - macAlgorithm: The MAC algorithm used in the operation. The algorithm must be compatible with the HMAC KMS key that you specify. To find the MAC algorithms that your HMAC KMS key supports, use the DescribeKey operation and see the MacAlgorithms field in the DescribeKey response.
    ///   - message: The message to be hashed. Specify a message of up to 4,096 bytes.   GenerateMac and VerifyMac do not provide special handling for message digests. If you generate an HMAC for a hash digest of a message, you must verify the HMAC of the same hash digest.
    ///   - logger: Logger use during operation
    @inlinable
    public func generateMac(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GenerateMacResponse {
        let input = GenerateMacRequest(
            dryRun: dryRun, 
            grantTokens: grantTokens, 
            keyId: keyId, 
    ...
    @Sendable
    @inlinable
    public func generateRandom(_ input: GenerateRandomRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateRandomResponse {
        try await self.client.execute(
    ...
    public func generateRandom(
        ...
        recipient: RecipientInfo? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GenerateRandomResponse {
        let input = GenerateRandomRequest(
            customKeyStoreId: customKeyStoreId, 
            numberOfBytes: numberOfBytes, 
            recipient: recipient
        )
        return try await self.generateRandom(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getKeyLastUsage(_ input: GetKeyLastUsageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetKeyLastUsageResponse {
        try await self.client.execute(
            operation: "GetKeyLastUsage", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies the KMS key to get usage information for. To specify a KMS key, use its key ID or key ARN. Alias names are not supported. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - logger: Logger use during operation
    @inlinable
    public func getKeyLastUsage(
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetKeyLastUsageResponse {
        let input = GetKeyLastUsageRequest(
            keyId: keyId
        )
        return try await self.getKeyLastUsage(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getKeyPolicy(_ input: GetKeyPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetKeyPolicyResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - keyId: Gets the key policy for the specified KMS key. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - policyName: Specifies the name of the key policy. If no policy name is specified, the default value is default. The only valid name is default. To get the names of key policies, use ListKeyPolicies.
    ///   - logger: Logger use during operation
    @inlinable
    public func getKeyPolicy(
        keyId: String,
        policyName: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetKeyPolicyResponse {
        let input = GetKeyPolicyRequest(
            keyId: keyId, 
            policyName: policyName
        )
        return try await self.getKeyPolicy(input, logger: logger)
    }
    ...
    public func getParametersForImport(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetParametersForImportResponse {
        let input = GetParametersForImportRequest(
            keyId: keyId, 
    ...
    ///
    /// Parameters:
    ///   - encryptedKeyMaterial: The encrypted key material to import. The key material must be encrypted under the public wrapping key that GetParametersForImport returned, using the wrapping algorithm that you specified in the same GetParametersForImport request.
    ///   - expirationModel: Specifies whether the key material expires. The default is KEY_MATERIAL_EXPIRES. For help with this choice, see Setting an expiration time in the Key Management Service Developer Guide. When the value of ExpirationModel is KEY_MATERIAL_EXPIRES, you must specify a value for the ValidTo parameter. When value is KEY_MATERIAL_DOES_NOT_EXPIRE, you must omit the ValidTo parameter. You cannot change the ExpirationModel or ValidTo values for the current import after the request completes. To change either value, you must reimport the key material.
    ...
    ///   - importType: Indicates whether the key material being imported is previously associated with this KMS key or not. This parameter is optional and only usable with symmetric encryption keys. If no key material has ever been imported into the KMS key, and this parameter is omitted, the parameter defaults to NEW_KEY_MATERIAL. After the first key material is imported, if this parameter is omitted then the parameter defaults to EXISTING_KEY_MATERIAL. For multi-Region keys, you must first import new key material into
    ///   - keyId: The identifier of the KMS key that will be associated with the imported key material. This must be the same KMS key specified in the KeyID parameter of the corresponding GetParametersForImport request. The Origin of the KMS key must be EXTERNAL and its KeyState must be PendingImport.  The KMS key can be a symmetric encryption KMS key, HMAC KMS key, asymmetric encryption KMS key, or asymmetric signing KMS key, including a multi-Region key of any supported type. You cannot perform this operation on a KMS key in a custom key store, or on a KMS key in a different Amazon Web Services account. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - keyMaterialDescription: Description for the key material being imported. This parameter is optional and only usable with symmetric encryption keys. If you do not specify a key material description, KMS retains the value you specified when you last imported the same key material into this KMS key.
    ///   - keyMaterialId: Identifies the key material being imported. This parameter is optional and only usable with symmetric encryption keys. You cannot specify a key material ID with ImportType set to NEW_KEY_MATERIAL. Whenever you import key material into a symmetric encryption key, KMS assigns a unique identifier to the key material based on the KMS key ID and the imported key material. When you re-import key material with a specified key material ID, KMS:   Computes the identifier for the key material   Matches the computed identifier against the specified key material ID   Verifies that the key material ID is already associated with the KMS key   To get the list of key material IDs associated with a KMS key, use ListKeyRotations.
    ///   - validTo: The date and time when the imported key material expires. This parameter is required when the value of the ExpirationModel parameter is KEY_MATERIAL_EXPIRES. Otherwise it is not valid. The value of this parameter must be a future date and time. The maximum value is 365 days from the request date. When the key material expires, KMS deletes the key material from the KMS key. Without its key material, the KMS key is unusable. To use the KMS key in cryptographic operations, you must reimport the same key material. You cannot change the ExpirationModel or ValidTo values for the current import after the request completes. To change either value, you must delete (DeleteImportedKeyMaterial) and reimport the key material.
    ///   - logger: Logger use during operation
    @inlinable
    public func importKeyMaterial(
        encryptedKeyMaterial: AWSBase64Data,
        expirationModel: ExpirationModelType? = nil,
        importToken: AWSBase64Data,
        importType: ImportType? = nil,
        keyId: String,
        keyMaterialDescription: String? = nil,
        keyMaterialId: String? = nil,
        validTo: Date? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ImportKeyMaterialResponse {
        let input = ImportKeyMaterialRequest(
        ...
        return try await self.importKeyMaterial(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - keyId: Lists only aliases that are associated with the specified KMS key. Enter a KMS key in your Amazon Web Services account.  This parameter is optional. If you omit it, ListAliases returns all aliases in the account and Region. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ...
    /// 	      response always includes a GranteeServicePrincipal that indicates the grantee is actually an Amazon Web Services service principal.   Cross-account use: Yes. To perform this operation on a KMS key in a different Amazon Web Services account, specify the key ARN in the value of the KeyId parameter.  Required permissions: kms:ListGrants (key policy)  Related operations:     CreateGrant     ListRetirableGrants     RetireGrant     RevokeGrant     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    public func listGrants(_ input: ListGrantsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGrantsResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - granteePrincipal: Returns only grants where the specified principal is the grantee principal for the grant. You can specify either GranteePrincipal or GranteeServicePrincipal, but not both.
    ///   - granteeServicePrincipal: Returns only grants where the specified Amazon Web Services service principal is the grantee service principal for the grant. This filter is only usable by callers in a service principal. You can specify either GranteePrincipal or GranteeServicePrincipal, but not both.
    ///   - grantId: Returns only the grant with the specified grant ID. The grant ID uniquely identifies the grant.
    ///   - keyId: Returns only grants for the specified KMS key. This parameter is required. Specify the key ID or key ARN of the KMS key. To specify a KMS key in a
    ///   - limit: Use this parameter to specify the maximum number of items to return. When this value is present, KMS does not return more than the specified number of items, but it might return fewer. This value is optional. If you include a value, it must be between 1 and 100, inclusive. If you do not include a value, it defaults to 50.
    ///   - marker: Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextMarker from the truncated response you just received.
    ///   - logger: Logger use during operation
    @inlinable
    public func listGrants(
        ...
        marker: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListGrantsResponse {
        let input = ListGrantsRequest(
            granteePrincipal: granteePrincipal, 
            granteeServicePrincipal: granteeServicePrincipal, 
            grantId: grantId, 
            keyId: keyId, 
        ...
        return try await self.listGrants(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - keyId: Gets the names of key policies for the specified KMS key. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - limit: Use this parameter to specify the maximum number of items to return. When this value is present, KMS does not return more than the specified number of items, but it might return fewer. This value is optional. If you include a value, it must be between 1 and 1000, inclusive. If you do not include a value, it defaults to 100. Only one policy can be attached to a key.
    ///   - marker: Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextMarker from the truncated response you just received.
    ///   - logger: Logger use during operation
    @inlinable
    public func listKeyPolicies(
        keyId: String,
        limit: Int? = nil,
        marker: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListKeyPoliciesResponse {
        let input = ListKeyPoliciesRequest(
            keyId: keyId, 
            limit: limit, 
            marker: marker
        )
        return try await self.listKeyPolicies(input, logger: logger)
    }
    ...
    ///   - keyId: Gets the key rotations for the specified KMS key. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - limit: Use this parameter to specify the maximum number of items to return. When this value is present, KMS does not return more than the specified number of items, but it might return fewer. This value is optional. If you include a value, it must be between 1 and 1000, inclusive. If you do not include a value, it defaults to 100.
    ///   - marker: Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextMarker from the truncated response you just received.
    ///   - logger: Logger use during operation
    @inlinable
    public func listKeyRotations(
        includeKeyMaterial: IncludeKeyMaterial? = nil,
        keyId: String,
        limit: Int? = nil,
        marker: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListKeyRotationsResponse {
        let input = ListKeyRotationsRequest(
            includeKeyMaterial: includeKeyMaterial, 
            keyId: keyId, 
            limit: limit, 
            marker: marker
        )
        return try await self.listKeyRotations(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func listResourceTags(_ input: ListResourceTagsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListResourceTagsResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - keyId: Gets tags on the specified KMS key. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func listResourceTags(
        keyId: String,
        limit: Int? = nil,
        marker: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListResourceTagsResponse {
        let input = ListResourceTagsRequest(
            keyId: keyId, 
            limit: limit, 
            marker: marker
        )
        return try await self.listResourceTags(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func listRetirableGrants(_ input: ListRetirableGrantsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGrantsResponse {
        try await self.client.execute(
    ...
    ///   - retiringServicePrincipal: The retiring service principal for which to list grants. This filter is only usable by callers in a service principal. You must specify either RetiringPrincipal or RetiringServicePrincipal, but not both.
    ///   - logger: Logger use during operation
    @inlinable
    public func listRetirableGrants(
        limit: Int? = nil,
        marker: String? = nil,
        retiringPrincipal: String? = nil,
        retiringServicePrincipal: String? = nil,
        ...
        let input = ListRetirableGrantsRequest(
            limit: limit, 
            marker: marker, 
            retiringPrincipal: retiringPrincipal, 
            retiringServicePrincipal: retiringServicePrincipal
        )
        return try await self.listRetirableGrants(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func putKeyPolicy(_ input: PutKeyPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    public func putKeyPolicy(
        ...
        let input = PutKeyPolicyRequest(
            bypassPolicyLockoutSafetyCheck: bypassPolicyLockoutSafetyCheck, 
            keyId: keyId, 
            policy: policy, 
            policyName: policyName
        )
        return try await self.putKeyPolicy(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - ciphertextBlob: Ciphertext of the data to reencrypt. This parameter is required in all cases except when DryRun is true and DryRunModifiers is set to IGNORE_CIPHERTEXT.
    ...
    ///   - sourceEncryptionContext: Specifies the encryption context to use to decrypt the ciphertext. Enter the same encryption context that was used to encrypt the ciphertext. An encryption context is a collection of non-secret key-value pairs that represent additional authenticated data.
    ...
    public func reEncrypt(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ReEncryptResponse {
        let input = ReEncryptRequest(
            ciphertextBlob: ciphertextBlob, 
        ...
        return try await self.reEncrypt(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func replicateKey(_ input: ReplicateKeyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ReplicateKeyResponse {
        try await self.client.execute(
    ...
    public func replicateKey(
        ...
        tags: [Tag]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ReplicateKeyResponse {
        let input = ReplicateKeyRequest(
            bypassPolicyLockoutSafetyCheck: bypassPolicyLockoutSafetyCheck, 
            description: description, 
            keyId: keyId, 
            policy: policy, 
        ...
        return try await self.replicateKey(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func retireGrant(_ input: RetireGrantRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///   - grantToken: Identifies the grant to be retired. You can use a grant token to identify a new grant even before it has achieved eventual consistency. Only the CreateGrant operation returns a grant token. For details, see Grant token and Eventual consistency in the Key Management Service Developer Guide.
    ///   - keyId: The key ARN KMS key associated with the grant. To find the key ARN, use the ListKeys operation. For example: arn:aws:kms:us-east-2:444455556666:key/1234abcd-12ab-34cd-56ef-1234567890ab
    ///   - logger: Logger use during operation
    @inlinable
    public func retireGrant(
        dryRun: Bool? = nil,
        grantId: String? = nil,
        ...
        let input = RetireGrantRequest(
            dryRun: dryRun, 
            grantId: grantId, 
            grantToken: grantToken, 
            keyId: keyId
        )
        return try await self.retireGrant(input, logger: logger)
    }
    ...
    ///   - keyId: A unique identifier for the KMS key associated with the grant. To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey. Specify the key ID or key ARN of the KMS key. To specify a KMS key in a
    ///   - logger: Logger use during operation
    @inlinable
    public func revokeGrant(
        ...
        let input = RevokeGrantRequest(
            dryRun: dryRun, 
            grantId: grantId, 
            keyId: keyId
        )
        return try await self.revokeGrant(input, logger: logger)
    }
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.  Required permissions: kms:RotateKeyOnDemand (key policy)  Related operations:     EnableKeyRotation     DisableKeyRotation     GetKeyRotationStatus     ImportKeyMaterial     ListKeyRotations     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func rotateKeyOnDemand(
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> RotateKeyOnDemandResponse {
        let input = RotateKeyOnDemandRequest(
            keyId: keyId
        )
        return try await self.rotateKeyOnDemand(input, logger: logger)
    }
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.  Required permissions: kms:ScheduleKeyDeletion (key policy)  Related operations     CancelKeyDeletion     DisableKey     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    public func scheduleKeyDeletion(_ input: ScheduleKeyDeletionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ScheduleKeyDeletionResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - keyId: The unique identifier of the KMS key to delete. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - pendingWindowInDays: The waiting period, specified in number of days. After the waiting period ends, KMS deletes the KMS key. If the KMS key is a multi-Region primary key with replica keys, the waiting period begins when the last of its replica keys is deleted. Otherwise, the waiting period begins immediately. This value is optional. If you include a value, it must be between 7 and 30, inclusive. If you do not include a value, it defaults to 30. You can use the  kms:ScheduleKeyDeletionPendingWindowInDays condition key to further constrain the values that principals can specify in the PendingWindowInDays parameter.
    ///   - logger: Logger use during operation
    @inlinable
    public func scheduleKeyDeletion(
        keyId: String,
        pendingWindowInDays: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ScheduleKeyDeletionResponse {
        let input = ScheduleKeyDeletionRequest(
            keyId: keyId, 
            pendingWindowInDays: pendingWindowInDays
        )
        return try await self.scheduleKeyDeletion(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func sign(_ input: SignRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SignResponse {
        try await self.client.execute(
            operation: "Sign", 
            path: "/", 
            httpMethod: .POST, 
    ...
    public func sign(
        ...
        return try await self.sign(input, logger: logger)
    }
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.   Required permissions: kms:TagResource (key policy)  Related operations     CreateKey     ListResourceTags     ReplicateKey     UntagResource     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies a customer managed key in the account and Region. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - tags: One or more tags. Each tag consists of a tag key and a tag value. The tag value can be an empty (null) string.   Do not include confidential or sensitive information in this field. This field may be displayed in plaintext in CloudTrail logs and other output.  You cannot have more than one tag on a KMS key with the same tag key. If you specify an existing tag key with a different tag value, KMS replaces the current tag value with the specified one.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.  Required permissions: kms:UntagResource (key policy)  Related operations     CreateKey     ListResourceTags     ReplicateKey     TagResource     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies the KMS key from which you are removing tags. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ...
    @Sendable
    @inlinable
    public func updateAlias(_ input: UpdateAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    @Sendable
    @inlinable
    public func updateCustomKeyStore(_ input: UpdateCustomKeyStoreRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateCustomKeyStoreResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func updateCustomKeyStore(
        cloudHsmClusterId: String? = nil,
        customKeyStoreId: String,
        keyStorePassword: String? = nil,
        ...
        xksProxyVpcEndpointServiceOwner: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UpdateCustomKeyStoreResponse {
        let input = UpdateCustomKeyStoreRequest(
            cloudHsmClusterId: cloudHsmClusterId, 
            customKeyStoreId: customKeyStoreId, 
            keyStorePassword: keyStorePassword, 
        ...
        return try await self.updateCustomKeyStore(input, logger: logger)
    }
    ...
    /// details, see Key states of KMS keys in the Key Management Service Developer Guide.  Cross-account use: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.   Required permissions: kms:UpdateKeyDescription (key policy)  Related operations     CreateKey     DescribeKey     Eventual consistency: The KMS API follows an eventual consistency model.  For more information, see KMS eventual consistency.
    @Sendable
    @inlinable
    public func updateKeyDescription(_ input: UpdateKeyDescriptionRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///   - keyId: Updates the description of the specified KMS key. Specify the key ID or key ARN of the KMS key. For example:   Key ID: 1234abcd-12ab-34cd-56ef-1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - logger: Logger use during operation
    @inlinable
    public func updateKeyDescription(
        description: String,
        keyId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = UpdateKeyDescriptionRequest(
            description: description, 
            keyId: keyId
        )
        return try await self.updateKeyDescription(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func updatePrimaryRegion(_ input: UpdatePrimaryRegionRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - keyId: Identifies the current primary key. When the operation completes, this KMS key will be a replica key. Specify the key ID or key ARN of a multi-Region primary key. For example:   Key ID: mrk-1234abcd12ab34cd56ef1234567890ab    Key ARN: arn:aws:kms:us-east-2:111122223333:key/mrk-1234abcd12ab34cd56ef1234567890ab    To get the key ID and key ARN for a KMS key, use ListKeys or DescribeKey.
    ///   - primaryRegion: The Amazon Web Services Region of the new primary key. Enter the Region ID, such as us-east-1 or ap-southeast-2. There must be an existing replica key in this Region.  When the operation completes, the multi-Region key in this Region will be the primary key.
    ///   - logger: Logger use during operation
    @inlinable
    public func updatePrimaryRegion(
        keyId: String,
        primaryRegion: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = UpdatePrimaryRegionRequest(
            keyId: keyId, 
            primaryRegion: primaryRegion
        )
        return try await self.updatePrimaryRegion(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func verify(_ input: VerifyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> VerifyResponse {
        try await self.client.execute(
            operation: "Verify", 
            path: "/", 
            httpMethod: .POST, 
    ...
    public func verify(
        ...
        return try await self.verify(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func verifyMac(_ input: VerifyMacRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> VerifyMacResponse {
        try await self.client.execute(
            operation: "VerifyMac", 
            path: "/", 
            httpMethod: .POST, 
    ...
    ///   - dryRun: Checks if your request will succeed. DryRun is an optional parameter.  To learn more about how to use this parameter, see Testing your permissions in the Key Management Service Developer Guide.
    ///   - grantTokens: A list of grant tokens. Use a grant token when your permission to call this operation comes from a new grant that has not yet achieved eventual consistency. For more information, see Grant token and Using a grant token in the Key Management Service Developer Guide.
    ///   - keyId: The KMS key that will be used in the verification. Enter a key ID of the KMS key that was used to generate the HMAC. If you identify a different KMS key, the VerifyMac operation fails.
    ...
    ///   - message: The message that will be used in the verification. Enter the same message that was used to generate the HMAC.  GenerateMac and VerifyMac do not provide special handling for message digests. If you generated an HMAC for a hash digest of a message, you must verify the HMAC for the same hash digest.
    ///   - logger: Logger use during operation
    @inlinable
    public func verifyMac(
        ...
        message: AWSBase64Data,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> VerifyMacResponse {
        let input = VerifyMacRequest(
            dryRun: dryRun, 
            grantTokens: grantTokens, 
            keyId: keyId, 
            mac: mac, 
...
extension KMS {
    /// Return PaginatorSequence for operation ``describeCustomKeyStores(_:logger:)``.
    ///
    /// - Parameters:
    ...
    public func describeCustomKeyStoresPaginator(
        ...
        return self.describeCustomKeyStoresPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``listGrants(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listGrantsPaginator(
        ...
        return self.listGrantsPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listKeyPolicies(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listKeyPoliciesPaginator(
        ...
        return self.listKeyPoliciesPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listKeyRotations(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listKeyRotationsPaginator(
        ...
        return self.listKeyRotationsPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``listResourceTags(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listResourceTagsPaginator(
        ...
        return self.listResourceTagsPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listRetirableGrants(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listRetirableGrantsPaginator(
        ...
        return self.listRetirableGrantsPaginator(input, logger: logger)
    }
}
