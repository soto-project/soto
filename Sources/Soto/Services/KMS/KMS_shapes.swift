...
extension KMS {
    ...
    public enum CustomKeyStoreType: String, CustomStringConvertible, Codable, _SotoSendable {
    ...
    public enum XksProxyConnectivityType: String, CustomStringConvertible, Codable, _SotoSendable {
    ...
    public struct DecryptRequest: AWSEncodableShape {
        ...
        public init(ciphertextBlob: AWSBase64Data, encryptionAlgorithm: EncryptionAlgorithmSpec? = nil, encryptionContext: [String: String]? = nil, grantTokens: [String]? = nil, keyId: String? = nil) {
    ...
    public struct DecryptResponse: AWSDecodableShape {
        ...
        public init(encryptionAlgorithm: EncryptionAlgorithmSpec? = nil, keyId: String? = nil, plaintext: AWSBase64Data? = nil) {
            self.encryptionAlgorithm = encryptionAlgorithm
            self.keyId = keyId
    ...
    public struct GenerateDataKeyPairResponse: AWSDecodableShape {
        ...
        public init(keyId: String? = nil, keyPairSpec: DataKeyPairSpec? = nil, privateKeyCiphertextBlob: AWSBase64Data? = nil, privateKeyPlaintext: AWSBase64Data? = nil, publicKey: AWSBase64Data? = nil) {
            self.keyId = keyId
            self.keyPairSpec = keyPairSpec
    ...
    public struct GenerateDataKeyResponse: AWSDecodableShape {
        ...
        public init(ciphertextBlob: AWSBase64Data? = nil, keyId: String? = nil, plaintext: AWSBase64Data? = nil) {
            self.ciphertextBlob = ciphertextBlob
            self.keyId = keyId
            self.plaintext = plaintext
        }
    ...
    public struct GenerateRandomResponse: AWSDecodableShape {
        ...
        public init(plaintext: AWSBase64Data? = nil) {
            self.plaintext = plaintext
        }
