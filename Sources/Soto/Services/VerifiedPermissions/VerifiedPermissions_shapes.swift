...
extension VerifiedPermissions {
    ...
    public struct CognitoUserPoolConfiguration: AWSEncodableShape {
        ...
        public init(clientIds: [String]? = nil, userPoolArn: String) {
    ...
    public struct GetIdentitySourceOutput: AWSDecodableShape {
        ...
        public init(createdDate: Date, details: IdentitySourceDetails, identitySourceId: String, lastUpdatedDate: Date, policyStoreId: String, principalEntityType: String) {
            self.createdDate = createdDate
    ...
    public struct IdentitySourceItem: AWSDecodableShape {
        ...
        public init(createdDate: Date, details: IdentitySourceItemDetails, identitySourceId: String, lastUpdatedDate: Date, policyStoreId: String, principalEntityType: String) {
            self.createdDate = createdDate
            self.details = details
            self.identitySourceId = identitySourceId
            self.lastUpdatedDate = lastUpdatedDate
