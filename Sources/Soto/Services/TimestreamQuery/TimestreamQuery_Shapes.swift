...
extension TimestreamQuery {
    ...
    public enum ScalarMeasureValueType: String, CustomStringConvertible, Codable {
        case bigint = "BIGINT"
        case boolean = "BOOLEAN"
        case double = "DOUBLE"
        case varchar = "VARCHAR"
    ...
    public enum ScheduledQueryRunStatus: String, CustomStringConvertible, Codable {
    ...
    public enum ScheduledQueryState: String, CustomStringConvertible, Codable {
