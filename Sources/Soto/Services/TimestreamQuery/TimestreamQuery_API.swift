...
public struct TimestreamQuery: AWSService {
    ...
    public func cancelQuery(_ input: CancelQueryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelQueryResponse> {
        return self.client.execute(operation: "CancelQuery", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func query(_ input: QueryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<QueryResponse> {
