...
public struct IAM: AWSService {
    ...
    ///
    /// Parameters:
    ///   - credentialAgeDays: The number of days until the service specific credential expires. This field is only valid for Bedrock API keys and must be a positive integer. When not specified, the credential will not expire.
