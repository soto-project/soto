...
/// Service object for interacting with AWS CloudWatchEvidently service.
///
...
public struct CloudWatchEvidently: AWSService {
    ...
    /// Initialize the CloudWatchEvidently client
    /// - parameters:
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            errorType: CloudWatchEvidentlyErrorType.self,
            timeout: timeout,
...
extension CloudWatchEvidently {
    ...
    public init(from: CloudWatchEvidently, patch: AWSServiceConfig.Patch) {
