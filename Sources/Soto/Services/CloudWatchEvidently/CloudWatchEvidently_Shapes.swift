...
extension CloudWatchEvidently {
    ...
    public enum ChangeDirectionEnum: String, CustomStringConvertible, Codable {
    ...
    public enum ExperimentBaseStat: String, CustomStringConvertible, Codable {
        case mean = "Mean"
        public var description: String { return self.rawValue }
    }

    public enum ExperimentReportName: String, CustomStringConvertible, Codable {
        case bayesianinference = "BayesianInference"
        public var description: String { return self.rawValue }
    }

    public enum ExperimentResultRequestType: String, CustomStringConvertible, Codable {
    ...
    public enum ExperimentResultResponseType: String, CustomStringConvertible, Codable {
    ...
    public enum ExperimentStopDesiredState: String, CustomStringConvertible, Codable {
        case cancelled = "CANCELLED"
        case completed = "COMPLETED"
        public var description: String { return self.rawValue }
    }

    public enum ExperimentType: String, CustomStringConvertible, Codable {
        case awsEvidentlyOnlineab = "aws.evidently.onlineab"
        public var description: String { return self.rawValue }
    }

    public enum FeatureEvaluationStrategy: String, CustomStringConvertible, Codable {
        case allRules = "ALL_RULES"
        case defaultVariation = "DEFAULT_VARIATION"
        public var description: String { return self.rawValue }
    }

    public enum FeatureStatus: String, CustomStringConvertible, Codable {
    ...
    public enum LaunchStopDesiredState: String, CustomStringConvertible, Codable {
        case cancelled = "CANCELLED"
        case completed = "COMPLETED"
        public var description: String { return self.rawValue }
    }
    ...
    public enum VariationValueType: String, CustomStringConvertible, Codable {
    ...
    public struct CreateExperimentRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.randomizationSalt, name: "randomizationSalt", parent: name, min: 0)
            ...
            try self.validate(self.treatments, name: "treatments", parent: name, min: 0)
        }
    ...
    public struct DeleteExperimentRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "experiment", location: .uri(locationName: "experiment")),
            AWSMemberEncoding(label: "project", location: .uri(locationName: "project"))
        ]
    ...
    public struct DeleteFeatureRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "feature", location: .uri(locationName: "feature")),
            AWSMemberEncoding(label: "project", location: .uri(locationName: "project"))
        ]
    ...
    public struct DeleteLaunchRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "launch", location: .uri(locationName: "launch")),
            AWSMemberEncoding(label: "project", location: .uri(locationName: "project"))
        ]
    ...
    public struct GetExperimentResultsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.reportNames, name: "reportNames", parent: name, min: 0)
            try self.validate(self.resultStats, name: "resultStats", parent: name, max: 5)
            try self.validate(self.resultStats, name: "resultStats", parent: name, min: 0)
    ...
    public struct MetricDefinitionConfig: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.eventPattern, name: "eventPattern", parent: name, max: 1024)
            try self.validate(self.eventPattern, name: "eventPattern", parent: name, min: 0)
    ...
    public struct PutProjectEventsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.events, name: "events", parent: name, min: 0)
            try self.validate(self.project, name: "project", parent: name, max: 2048)
            try self.validate(self.project, name: "project", parent: name, min: 0)
            try self.validate(self.project, name: "project", parent: name, pattern: "([-a-zA-Z0-9._]*)|(arn:[^:]*:[^:]*:[^:]*:[^:]*:project/[-a-zA-Z0-9._]*)")
        }
    ...
    public struct StopExperimentRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.reason, name: "reason", parent: name, min: 0)
    ...
    public struct VariableValue: AWSEncodableShape & AWSDecodableShape {
        ...
        public init(boolValue: Bool? = nil, doubleValue: Double? = nil, longValue: Int64? = nil, stringValue: String? = nil) {
        ...
        public func validate(name: String) throws {
            try self.validate(self.longValue, name: "longValue", parent: name, max: 9_007_199_254_740_991)
            try self.validate(self.longValue, name: "longValue", parent: name, min: -9_007_199_254_740_991)
            try self.validate(self.stringValue, name: "stringValue", parent: name, max: 512)
