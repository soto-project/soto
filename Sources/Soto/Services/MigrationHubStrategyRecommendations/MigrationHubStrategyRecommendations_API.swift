...
/// Service object for interacting with AWS MigrationHubStrategyRecommendations service.
///
/// Migration Hub Strategy Recommendations  &lt;p&gt;This API reference provides descriptions, syntax, and other details about each of the actions and data types for Migration Hub Strategy Recommendations (Strategy Recommendations). The topic for each action shows the API request parameters and the response. Alternatively, you can use one of the AWS SDKs to access an API that is tailored to the programming language or platform that you're using. For more information, see &lt;a href=&quot;http://aws.amazon.com/tools/#SDKs&quot;&gt;AWS SDKs&lt;/a&gt;.&lt;/p&gt;
public struct MigrationHubStrategyRecommendations: AWSService {
    ...
    /// Initialize the MigrationHubStrategyRecommendations client
    /// - parameters:
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            endpoint: endpoint,
            errorType: MigrationHubStrategyRecommendationsErrorType.self,
            timeout: timeout,
...
extension MigrationHubStrategyRecommendations {
    ...
    public init(from: MigrationHubStrategyRecommendations, patch: AWSServiceConfig.Patch) {
