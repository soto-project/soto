...
extension MigrationHubStrategyRecommendations {
    ...
    public struct DatabaseMigrationPreference: AWSEncodableShape & AWSDecodableShape {
        ///  Indicates whether you are interested in moving from one type of database to another. For example, from SQL Server to Amazon Aurora MySQL-Compatible Edition.
        public let heterogeneous: Heterogeneous?
        ///  Indicates whether you are interested in moving to the same type of database into AWS. For example, from SQL Server in your environment to SQL Server on AWS.
        public let homogeneous: Homogeneous?
        ///  Indicated that you do not prefer heterogeneous or homogeneous.
        public let noPreference: NoDatabaseMigrationPreference?

        public init(heterogeneous: Heterogeneous? = nil, homogeneous: Homogeneous? = nil, noPreference: NoDatabaseMigrationPreference? = nil) {
        ...
        public func validate(name: String) throws {
            try self.heterogeneous?.validate(name: "\(name).heterogeneous")
            try self.homogeneous?.validate(name: "\(name).homogeneous")
            try self.noPreference?.validate(name: "\(name).noPreference")
        }
    ...
    public struct GetApplicationComponentDetailsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationComponentId", location: .uri(locationName: "applicationComponentId"))
        ]
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.applicationComponentId, name: "applicationComponentId", parent: name, min: 0)
    ...
    public struct GetServerDetailsRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "serverId", location: .uri(locationName: "serverId"))
        ]
    ...
    public struct Homogeneous: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.targetDatabaseEngine, name: "targetDatabaseEngine", parent: name, max: 1)
            try self.validate(self.targetDatabaseEngine, name: "targetDatabaseEngine", parent: name, min: 0)
        }
    ...
    public struct ListApplicationComponentsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.filterValue, name: "filterValue", parent: name, max: 256)
            try self.validate(self.filterValue, name: "filterValue", parent: name, min: 0)
    ...
    public struct ManagementPreference: AWSEncodableShape & AWSDecodableShape {
        ///  Indicates interest in solutions that are managed by AWS.
        public let awsManagedResources: AwsManagedResources?
        ///  No specific preference.
        public let noPreference: NoManagementPreference?
        ///  Indicates interest in managing your own resources on AWS.
        public let selfManageResources: SelfManageResources?

        public init(awsManagedResources: AwsManagedResources? = nil, noPreference: NoManagementPreference? = nil, selfManageResources: SelfManageResources? = nil) {
        ...
        public func validate(name: String) throws {
            try self.awsManagedResources?.validate(name: "\(name).awsManagedResources")
            try self.noPreference?.validate(name: "\(name).noPreference")
            try self.selfManageResources?.validate(name: "\(name).selfManageResources")
        }
    ...
    public struct StartAssessmentRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.s3bucketForAnalysisData, name: "s3bucketForAnalysisData", parent: name, max: 63)
            try self.validate(self.s3bucketForAnalysisData, name: "s3bucketForAnalysisData", parent: name, min: 0)
            try self.validate(self.s3bucketForAnalysisData, name: "s3bucketForAnalysisData", parent: name, pattern: "[0-9a-z]+[0-9a-z\\.\\-]*[0-9a-z]+")
            try self.validate(self.s3bucketForReportData, name: "s3bucketForReportData", parent: name, max: 63)
            try self.validate(self.s3bucketForReportData, name: "s3bucketForReportData", parent: name, min: 0)
            try self.validate(self.s3bucketForReportData, name: "s3bucketForReportData", parent: name, pattern: "[0-9a-z]+[0-9a-z\\.\\-]*[0-9a-z]+")
        }
    ...
    public struct StartImportFileTaskRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.s3Bucket, name: "s3Bucket", parent: name, min: 0)
            ...
            try self.validate(self.s3key, name: "s3key", parent: name, min: 0)
    ...
    public struct StopAssessmentRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.assessmentId, name: "assessmentId", parent: name, min: 0)
