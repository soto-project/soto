...
extension ServiceCatalog {
    ...
    public struct ProvisioningArtifactProperties: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.info, name: "info", parent: name, max: 100)
            try self.validate(self.info, name: "info", parent: name, min: 1)
    ...
    public struct UpdateProvisionedProductPropertiesInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.provisionedProductProperties, name: "provisionedProductProperties", parent: name, max: 100)
            try self.validate(self.provisionedProductProperties, name: "provisionedProductProperties", parent: name, min: 1)
        }
