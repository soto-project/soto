...
public struct ServiceCatalog: AWSService {
    ...
    public func getProvisionedProductOutputs(_ input: GetProvisionedProductOutputsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetProvisionedProductOutputsOutput> {
        return self.client.execute(operation: "GetProvisionedProductOutputs", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
