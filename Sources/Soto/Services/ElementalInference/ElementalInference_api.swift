...
public struct ElementalInference: AWSService {
    ...
    @Sendable
    @inlinable
    public func deleteFeedPolicy(_ input: DeleteFeedPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
            operation: "DeleteFeedPolicy", 
            path: "/v1/feed/{id}/policy", 
            httpMethod: .DELETE, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    ///
    /// Parameters:
    ///   - id: The ID of the feed whose policy you want to delete.
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteFeedPolicy(
        id: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteFeedPolicyRequest(
            id: id
        )
        return try await self.deleteFeedPolicy(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getFeedPolicy(_ input: GetFeedPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetFeedPolicyResponse {
        try await self.client.execute(
            operation: "GetFeedPolicy", 
            path: "/v1/feed/{id}/policy", 
            httpMethod: .GET, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - id: The ID of the feed whose policy you want to retrieve.
    ///   - logger: Logger use during operation
    @inlinable
    public func getFeedPolicy(
        id: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetFeedPolicyResponse {
        let input = GetFeedPolicyRequest(
            id: id
        )
        return try await self.getFeedPolicy(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func putFeedPolicy(_ input: PutFeedPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutFeedPolicyResponse {
        try await self.client.execute(
            operation: "PutFeedPolicy", 
            path: "/v1/feed/{id}/policy", 
            httpMethod: .PUT, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - id: The ID of the feed to attach the policy to.
    ///   - policy: The resource-based policy document to attach to the feed.
    ///   - logger: Logger use during operation
    @inlinable
    public func putFeedPolicy(
        id: String,
        policy: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> PutFeedPolicyResponse {
        let input = PutFeedPolicyRequest(
            id: id, 
            policy: policy
        )
        return try await self.putFeedPolicy(input, logger: logger)
    }
