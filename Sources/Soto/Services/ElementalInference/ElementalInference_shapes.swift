...
extension ElementalInference {
    ...
    public enum SummaryGenerationMode: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case disabled = "DISABLED"
        case enabled = "ENABLED"
        public var description: String { return self.rawValue }
    }
    ...
    public enum OutputConfig: AWSEncodableShape & AWSDecodableShape, Sendable {
        ...
        case contextualMetadata(ContextualMetadataConfig)
        ...
        public init(from decoder: Decoder) throws {
            ...
            case .contextualMetadata:
                let value = try container.decode(ContextualMetadataConfig.self, forKey: .contextualMetadata)
                self = .contextualMetadata(value)
            case .cropping:
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .contextualMetadata(let value):
                try container.encode(value, forKey: .contextualMetadata)
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case contextualMetadata = "contextualMetadata"
    ...
    public struct ContextualMetadataConfig: AWSEncodableShape & AWSDecodableShape {
        /// Specifies whether Elemental Inference generates a descriptive summary of the media content for this output.  Valid values:   ENABLED (default) – Elemental Inference generates a descriptive summary along with IAB taxonomy and GARM suitability classifications.    DISABLED – No descriptive summary is generated.
        public let summaryGeneration: SummaryGenerationMode?

        @inlinable
        public init(summaryGeneration: SummaryGenerationMode? = nil) {
            self.summaryGeneration = summaryGeneration
        }

        private enum CodingKeys: String, CodingKey {
            case summaryGeneration = "summaryGeneration"
        }
    }
    ...
    public struct DeleteFeedPolicyRequest: AWSEncodableShape {
    ...
    public struct GetFeedPolicyRequest: AWSEncodableShape {
    ...
    public struct GetFeedPolicyResponse: AWSDecodableShape {
    ...
    public struct PutFeedPolicyRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(id: String, policy: String) {
            self.id = id
            self.policy = policy
        }
    ...
    public struct PutFeedPolicyResponse: AWSDecodableShape {
        public init() {}
    }
