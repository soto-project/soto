...
extension Route53 {
    ...
    public func changeCidrCollection(_ input: ChangeCidrCollectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ChangeCidrCollectionResponse {
        return try await self.client.execute(operation: "ChangeCidrCollection", path: "/2013-04-01/cidrcollection/{CidrCollectionId}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteCidrCollection(_ input: DeleteCidrCollectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteCidrCollectionResponse {
        return try await self.client.execute(operation: "DeleteCidrCollection", path: "/2013-04-01/cidrcollection/{CidrCollectionId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listCidrBlocks(_ input: ListCidrBlocksRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListCidrBlocksResponse {
        return try await self.client.execute(operation: "ListCidrBlocks", path: "/2013-04-01/cidrcollection/{CidrCollectionId}/cidrblocks", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listCidrLocations(_ input: ListCidrLocationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListCidrLocationsResponse {
        return try await self.client.execute(operation: "ListCidrLocations", path: "/2013-04-01/cidrcollection/{CidrCollectionId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
