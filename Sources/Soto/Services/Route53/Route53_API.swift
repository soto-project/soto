...
public struct Route53: AWSService {
    ...
    public func changeCidrCollection(_ input: ChangeCidrCollectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeCidrCollectionResponse> {
        return self.client.execute(operation: "ChangeCidrCollection", path: "/2013-04-01/cidrcollection/{CidrCollectionId}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteCidrCollection(_ input: DeleteCidrCollectionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCidrCollectionResponse> {
        return self.client.execute(operation: "DeleteCidrCollection", path: "/2013-04-01/cidrcollection/{CidrCollectionId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listCidrBlocks(_ input: ListCidrBlocksRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListCidrBlocksResponse> {
        return self.client.execute(operation: "ListCidrBlocks", path: "/2013-04-01/cidrcollection/{CidrCollectionId}/cidrblocks", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listCidrLocations(_ input: ListCidrLocationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListCidrLocationsResponse> {
        return self.client.execute(operation: "ListCidrLocations", path: "/2013-04-01/cidrcollection/{CidrCollectionId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
