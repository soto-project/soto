...
public struct Route53: AWSService {
    ...
    public func activateKeySigningKey(_ input: ActivateKeySigningKeyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ActivateKeySigningKeyResponse> {
        return self.client.execute(operation: "ActivateKeySigningKey", path: "/2013-04-01/keysigningkey/{HostedZoneId}/{Name}/activate", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func associateVPCWithHostedZone(_ input: AssociateVPCWithHostedZoneRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateVPCWithHostedZoneResponse> {
        return self.client.execute(operation: "AssociateVPCWithHostedZone", path: "/2013-04-01/hostedzone/{Id}/associatevpc", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func changeResourceRecordSets(_ input: ChangeResourceRecordSetsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeResourceRecordSetsResponse> {
        return self.client.execute(operation: "ChangeResourceRecordSets", path: "/2013-04-01/hostedzone/{Id}/rrset/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func changeTagsForResource(_ input: ChangeTagsForResourceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeTagsForResourceResponse> {
        return self.client.execute(operation: "ChangeTagsForResource", path: "/2013-04-01/tags/{ResourceType}/{ResourceId}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createHealthCheck(_ input: CreateHealthCheckRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateHealthCheckResponse> {
        return self.client.execute(operation: "CreateHealthCheck", path: "/2013-04-01/healthcheck", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createHostedZone(_ input: CreateHostedZoneRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateHostedZoneResponse> {
        return self.client.execute(operation: "CreateHostedZone", path: "/2013-04-01/hostedzone", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Creates a new key-signing key (KSK) associated with a hosted zone. You can only have two KSKs per hosted zone.
    public func createKeySigningKey(_ input: CreateKeySigningKeyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateKeySigningKeyResponse> {
        return self.client.execute(operation: "CreateKeySigningKey", path: "/2013-04-01/keysigningkey", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createQueryLoggingConfig(_ input: CreateQueryLoggingConfigRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateQueryLoggingConfigResponse> {
        return self.client.execute(operation: "CreateQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createReusableDelegationSet(_ input: CreateReusableDelegationSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateReusableDelegationSetResponse> {
        return self.client.execute(operation: "CreateReusableDelegationSet", path: "/2013-04-01/delegationset", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Creates a traffic policy, which you use to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com).
    public func createTrafficPolicy(_ input: CreateTrafficPolicyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrafficPolicyResponse> {
        return self.client.execute(operation: "CreateTrafficPolicy", path: "/2013-04-01/trafficpolicy", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Creates resource record sets in a specified hosted zone based on the settings in a specified traffic policy version. In addition, CreateTrafficPolicyInstance associates the resource record sets with a specified domain name (such as example.com) or subdomain name (such as www.example.com). Amazon Route 53 responds to DNS queries for the domain or subdomain name by using the resource record sets that CreateTrafficPolicyInstance created.
    public func createTrafficPolicyInstance(_ input: CreateTrafficPolicyInstanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "CreateTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Creates a new version of an existing traffic policy. When you create a new version of a traffic policy, you specify the ID of the traffic policy that you want to update and a JSON-formatted document that describes the new version. You use traffic policies to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com). You can create a maximum of 1000 versions of a traffic policy. If you reach the limit and need to create another version, you'll need to start a new traffic policy.
    public func createTrafficPolicyVersion(_ input: CreateTrafficPolicyVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrafficPolicyVersionResponse> {
        return self.client.execute(operation: "CreateTrafficPolicyVersion", path: "/2013-04-01/trafficpolicy/{Id}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createVPCAssociationAuthorization(_ input: CreateVPCAssociationAuthorizationRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateVPCAssociationAuthorizationResponse> {
        return self.client.execute(operation: "CreateVPCAssociationAuthorization", path: "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Deactivates a key-signing key (KSK) so that it will not be used for signing by DNSSEC. This operation changes the KSK status to INACTIVE.
    public func deactivateKeySigningKey(_ input: DeactivateKeySigningKeyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeactivateKeySigningKeyResponse> {
        return self.client.execute(operation: "DeactivateKeySigningKey", path: "/2013-04-01/keysigningkey/{HostedZoneId}/{Name}/deactivate", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteHealthCheck(_ input: DeleteHealthCheckRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteHealthCheckResponse> {
        return self.client.execute(operation: "DeleteHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteHostedZone(_ input: DeleteHostedZoneRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteHostedZoneResponse> {
        return self.client.execute(operation: "DeleteHostedZone", path: "/2013-04-01/hostedzone/{Id}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteKeySigningKey(_ input: DeleteKeySigningKeyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteKeySigningKeyResponse> {
        return self.client.execute(operation: "DeleteKeySigningKey", path: "/2013-04-01/keysigningkey/{HostedZoneId}/{Name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteQueryLoggingConfig(_ input: DeleteQueryLoggingConfigRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteQueryLoggingConfigResponse> {
        return self.client.execute(operation: "DeleteQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig/{Id}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteReusableDelegationSet(_ input: DeleteReusableDelegationSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteReusableDelegationSetResponse> {
        return self.client.execute(operation: "DeleteReusableDelegationSet", path: "/2013-04-01/delegationset/{Id}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteTrafficPolicy(_ input: DeleteTrafficPolicyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTrafficPolicyResponse> {
        return self.client.execute(operation: "DeleteTrafficPolicy", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteTrafficPolicyInstance(_ input: DeleteTrafficPolicyInstanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "DeleteTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteVPCAssociationAuthorization(_ input: DeleteVPCAssociationAuthorizationRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteVPCAssociationAuthorizationResponse> {
        return self.client.execute(operation: "DeleteVPCAssociationAuthorization", path: "/2013-04-01/hostedzone/{Id}/deauthorizevpcassociation", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Disables DNSSEC signing in a specific hosted zone. This action does not deactivate any key-signing keys (KSKs) that are active in the hosted zone.
    public func disableHostedZoneDNSSEC(_ input: DisableHostedZoneDNSSECRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisableHostedZoneDNSSECResponse> {
        return self.client.execute(operation: "DisableHostedZoneDNSSEC", path: "/2013-04-01/hostedzone/{Id}/disable-dnssec", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func disassociateVPCFromHostedZone(_ input: DisassociateVPCFromHostedZoneRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateVPCFromHostedZoneResponse> {
        return self.client.execute(operation: "DisassociateVPCFromHostedZone", path: "/2013-04-01/hostedzone/{Id}/disassociatevpc", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Enables DNSSEC signing in a specific hosted zone.
    public func enableHostedZoneDNSSEC(_ input: EnableHostedZoneDNSSECRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EnableHostedZoneDNSSECResponse> {
        return self.client.execute(operation: "EnableHostedZoneDNSSEC", path: "/2013-04-01/hostedzone/{Id}/enable-dnssec", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getAccountLimit(_ input: GetAccountLimitRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAccountLimitResponse> {
        return self.client.execute(operation: "GetAccountLimit", path: "/2013-04-01/accountlimit/{Type}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getChange(_ input: GetChangeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetChangeResponse> {
        return self.client.execute(operation: "GetChange", path: "/2013-04-01/change/{Id}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getCheckerIpRanges(_ input: GetCheckerIpRangesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCheckerIpRangesResponse> {
        return self.client.execute(operation: "GetCheckerIpRanges", path: "/2013-04-01/checkeripranges", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns information about DNSSEC for a specific hosted zone, including the key-signing keys (KSKs) in the hosted zone.
    public func getDNSSEC(_ input: GetDNSSECRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDNSSECResponse> {
        return self.client.execute(operation: "GetDNSSEC", path: "/2013-04-01/hostedzone/{Id}/dnssec", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getGeoLocation(_ input: GetGeoLocationRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetGeoLocationResponse> {
        return self.client.execute(operation: "GetGeoLocation", path: "/2013-04-01/geolocation", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gets information about a specified health check.
    public func getHealthCheck(_ input: GetHealthCheckRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckResponse> {
        return self.client.execute(operation: "GetHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves the number of health checks that are associated with the current AWS account.
    public func getHealthCheckCount(_ input: GetHealthCheckCountRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckCountResponse> {
        return self.client.execute(operation: "GetHealthCheckCount", path: "/2013-04-01/healthcheckcount", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gets the reason that a specified health check failed most recently.
    public func getHealthCheckLastFailureReason(_ input: GetHealthCheckLastFailureReasonRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckLastFailureReasonResponse> {
        return self.client.execute(operation: "GetHealthCheckLastFailureReason", path: "/2013-04-01/healthcheck/{HealthCheckId}/lastfailurereason", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gets status of a specified health check.
    public func getHealthCheckStatus(_ input: GetHealthCheckStatusRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckStatusResponse> {
        return self.client.execute(operation: "GetHealthCheckStatus", path: "/2013-04-01/healthcheck/{HealthCheckId}/status", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gets information about a specified hosted zone including the four name servers assigned to the hosted zone.
    public func getHostedZone(_ input: GetHostedZoneRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostedZoneResponse> {
        return self.client.execute(operation: "GetHostedZone", path: "/2013-04-01/hostedzone/{Id}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves the number of hosted zones that are associated with the current AWS account.
    public func getHostedZoneCount(_ input: GetHostedZoneCountRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostedZoneCountResponse> {
        return self.client.execute(operation: "GetHostedZoneCount", path: "/2013-04-01/hostedzonecount", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getHostedZoneLimit(_ input: GetHostedZoneLimitRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostedZoneLimitResponse> {
        return self.client.execute(operation: "GetHostedZoneLimit", path: "/2013-04-01/hostedzonelimit/{Id}/{Type}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getQueryLoggingConfig(_ input: GetQueryLoggingConfigRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetQueryLoggingConfigResponse> {
        return self.client.execute(operation: "GetQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig/{Id}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves information about a specified reusable delegation set, including the four name servers that are assigned to the delegation set.
    public func getReusableDelegationSet(_ input: GetReusableDelegationSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetReusableDelegationSetResponse> {
        return self.client.execute(operation: "GetReusableDelegationSet", path: "/2013-04-01/delegationset/{Id}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getReusableDelegationSetLimit(_ input: GetReusableDelegationSetLimitRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetReusableDelegationSetLimitResponse> {
        return self.client.execute(operation: "GetReusableDelegationSetLimit", path: "/2013-04-01/reusabledelegationsetlimit/{Id}/{Type}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getTrafficPolicy(_ input: GetTrafficPolicyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTrafficPolicyResponse> {
        return self.client.execute(operation: "GetTrafficPolicy", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getTrafficPolicyInstance(_ input: GetTrafficPolicyInstanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "GetTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gets the number of traffic policy instances that are associated with the current AWS account.
    public func getTrafficPolicyInstanceCount(_ input: GetTrafficPolicyInstanceCountRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTrafficPolicyInstanceCountResponse> {
        return self.client.execute(operation: "GetTrafficPolicyInstanceCount", path: "/2013-04-01/trafficpolicyinstancecount", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listGeoLocations(_ input: ListGeoLocationsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGeoLocationsResponse> {
        return self.client.execute(operation: "ListGeoLocations", path: "/2013-04-01/geolocations", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieve a list of the health checks that are associated with the current AWS account.
    public func listHealthChecks(_ input: ListHealthChecksRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHealthChecksResponse> {
        return self.client.execute(operation: "ListHealthChecks", path: "/2013-04-01/healthcheck", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listHostedZones(_ input: ListHostedZonesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostedZonesResponse> {
        return self.client.execute(operation: "ListHostedZones", path: "/2013-04-01/hostedzone", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listHostedZonesByName(_ input: ListHostedZonesByNameRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostedZonesByNameResponse> {
        return self.client.execute(operation: "ListHostedZonesByName", path: "/2013-04-01/hostedzonesbyname", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listHostedZonesByVPC(_ input: ListHostedZonesByVPCRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostedZonesByVPCResponse> {
        return self.client.execute(operation: "ListHostedZonesByVPC", path: "/2013-04-01/hostedzonesbyvpc", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listQueryLoggingConfigs(_ input: ListQueryLoggingConfigsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListQueryLoggingConfigsResponse> {
        return self.client.execute(operation: "ListQueryLoggingConfigs", path: "/2013-04-01/queryloggingconfig", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listResourceRecordSets(_ input: ListResourceRecordSetsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListResourceRecordSetsResponse> {
        return self.client.execute(operation: "ListResourceRecordSets", path: "/2013-04-01/hostedzone/{Id}/rrset", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves a list of the reusable delegation sets that are associated with the current AWS account.
    public func listReusableDelegationSets(_ input: ListReusableDelegationSetsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListReusableDelegationSetsResponse> {
        return self.client.execute(operation: "ListReusableDelegationSets", path: "/2013-04-01/delegationset", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForResourceResponse> {
        return self.client.execute(operation: "ListTagsForResource", path: "/2013-04-01/tags/{ResourceType}/{ResourceId}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTagsForResources(_ input: ListTagsForResourcesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForResourcesResponse> {
        return self.client.execute(operation: "ListTagsForResources", path: "/2013-04-01/tags/{ResourceType}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTrafficPolicies(_ input: ListTrafficPoliciesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPoliciesResponse> {
        return self.client.execute(operation: "ListTrafficPolicies", path: "/2013-04-01/trafficpolicies", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTrafficPolicyInstances(_ input: ListTrafficPolicyInstancesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyInstancesResponse> {
        return self.client.execute(operation: "ListTrafficPolicyInstances", path: "/2013-04-01/trafficpolicyinstances", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTrafficPolicyInstancesByHostedZone(_ input: ListTrafficPolicyInstancesByHostedZoneRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyInstancesByHostedZoneResponse> {
        return self.client.execute(operation: "ListTrafficPolicyInstancesByHostedZone", path: "/2013-04-01/trafficpolicyinstances/hostedzone", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTrafficPolicyInstancesByPolicy(_ input: ListTrafficPolicyInstancesByPolicyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyInstancesByPolicyResponse> {
        return self.client.execute(operation: "ListTrafficPolicyInstancesByPolicy", path: "/2013-04-01/trafficpolicyinstances/trafficpolicy", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTrafficPolicyVersions(_ input: ListTrafficPolicyVersionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyVersionsResponse> {
        return self.client.execute(operation: "ListTrafficPolicyVersions", path: "/2013-04-01/trafficpolicies/{Id}/versions", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listVPCAssociationAuthorizations(_ input: ListVPCAssociationAuthorizationsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListVPCAssociationAuthorizationsResponse> {
        return self.client.execute(operation: "ListVPCAssociationAuthorizations", path: "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func testDNSAnswer(_ input: TestDNSAnswerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TestDNSAnswerResponse> {
        return self.client.execute(operation: "TestDNSAnswer", path: "/2013-04-01/testdnsanswer", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateHealthCheck(_ input: UpdateHealthCheckRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateHealthCheckResponse> {
        return self.client.execute(operation: "UpdateHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Updates the comment for a specified hosted zone.
    public func updateHostedZoneComment(_ input: UpdateHostedZoneCommentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateHostedZoneCommentResponse> {
        return self.client.execute(operation: "UpdateHostedZoneComment", path: "/2013-04-01/hostedzone/{Id}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Updates the comment for a specified traffic policy version.
    public func updateTrafficPolicyComment(_ input: UpdateTrafficPolicyCommentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTrafficPolicyCommentResponse> {
        return self.client.execute(operation: "UpdateTrafficPolicyComment", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateTrafficPolicyInstance(_ input: UpdateTrafficPolicyInstanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "UpdateTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
