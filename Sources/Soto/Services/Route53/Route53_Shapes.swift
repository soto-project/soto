...
extension Route53 {
    ...
    public struct AccountLimit: AWSDecodableShape {
        ...
        /// 				using the current account.    MAX_HOSTED_ZONES_BY_OWNER: The maximum number of hosted zones that you can create
        /// 				using the current account.    MAX_REUSABLE_DELEGATION_SETS_BY_OWNER: The maximum number of reusable delegation sets
        /// 				that you can create using the current account.    MAX_TRAFFIC_POLICIES_BY_OWNER: The maximum number of traffic policies
        /// 				that you can create using the current account.    MAX_TRAFFIC_POLICY_INSTANCES_BY_OWNER: The maximum number of traffic policy instances
    ...
    public struct AlarmIdentifier: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 					in the Amazon CloudWatch User Guide.   Statistics: Average, Minimum, Maximum, Sum, and SampleCount. Extended statistics aren't supported.
        ///
        public let name: String
    ...
    public struct AliasTarget: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 		        Amazon API Gateway custom regional APIs and edge-optimized APIs  Specify the applicable domain name for your API. You can get the applicable value using the CLI command
        /// 					get-domain-names:
        /// 					            For regional APIs, specify the value of regionalDomainName.   For edge-optimized APIs, specify the value of distributionDomainName. This is the name of the
        ...
        /// 							api.example.com.
        ///
        /// 				         Amazon Virtual Private Cloud interface VPC endpoint  Enter the API endpoint for the interface endpoint, such as
        ...
        ///
        /// 				         ELB load balancer  Specify the DNS name that is associated with the load balancer. Get the DNS name by using the Amazon Web Services Management Console,
        ...
        /// 							DescribeAccelerator.    CLI: To get the DNS name, use
        ...
        /// 					in the Amazon Route 53 Developer Guide.   Another Route 53 resource record set  Specify the value of the Name element for a resource record set in the current hosted zone.
        ...
        /// 		       Note the following:
        /// 		        CloudFront distributions  You can't set EvaluateTargetHealth to true when the alias target is a
        /// 					CloudFront distribution.  Elastic Beanstalk environments that have regionalized subdomains  If you specify an Elastic Beanstalk environment in DNSName and the environment contains an ELB load balancer,
        ...
        /// 							load balancer itself is unhealthy, Route 53 routes queries to other resources.    Application and Network Load Balancers: If you specify an ELB
        ...
        /// 									unhealthy, and Route 53 routes queries to other resources.   A target group that has no registered targets is considered unhealthy.
        ///
        ...
        /// 				         S3 buckets  There are no special requirements for setting EvaluateTargetHealth to true
        /// 					when the alias target is an S3 bucket.  Other records in the same hosted zone  If the Amazon Web Services resource that you specify in DNSName is a record or a group of records
        ...
        /// 		        Amazon API Gateway custom regional APIs and edge-optimized APIs  Specify the hosted zone ID for your API. You can get the applicable value using the CLI command
        /// 					get-domain-names:
        /// 					            For regional APIs, specify the value of regionalHostedZoneId.   For edge-optimized APIs, specify the value of distributionHostedZoneId.
        /// 				         Amazon Virtual Private Cloud interface VPC endpoint  Specify the hosted zone ID for your interface endpoint. You can get the value of HostedZoneId
        ...
        /// 									DescribeLoadBalancers
        /// 									to get the value of CanonicalHostedZoneNameId.   Application and Network Load Balancers: Use
        /// 									DescribeLoadBalancers
        ...
        /// 									to get the value of CanonicalHostedZoneId.
        ///
        /// 				         Global Accelerator accelerator  Specify Z2BJ6XQ5FK7U4H.  An Amazon S3 bucket configured as a static website
    ...
    public struct ChangeTagsForResourceRequest: AWSEncodableShape {
        ...
        /// 		         The resource type for health checks is healthcheck.   The resource type for hosted zones is hostedzone.
    ...
    public struct CreateHealthCheckRequest: AWSEncodableShape {
        ...
        /// 				Route 53 returns the settings for the existing health check.   If you send a CreateHealthCheck request with the same CallerReference as a deleted health check,
        /// 				regardless of the settings, Route 53 returns a HealthCheckAlreadyExists error.   If you send a CreateHealthCheck request with the same CallerReference as an existing health check
        /// 				but with different settings, Route 53 returns a HealthCheckAlreadyExists error.   If you send a CreateHealthCheck request with a unique CallerReference but settings identical to
    ...
    public struct CreateHostedZoneRequest: AWSEncodableShape {
        ...
        /// 		         For public and private hosted zones, an optional comment   For private hosted zones, an optional PrivateZone element
    ...
    public struct GetHostedZoneLimitRequest: AWSEncodableShape {
        ...
        /// 				in the specified hosted zone.    MAX_VPCS_ASSOCIATED_BY_ZONE: The maximum number of Amazon VPCs that you can
    ...
    public struct HealthCheckConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 				Route 53 stops submitting requests to your application, server, or other resource.    Calculated health checks:
        /// 				Route 53 stops aggregating the status of the referenced health checks.    Health checks that monitor CloudWatch alarms:
        ...
        /// 				for example, 192.0.2.44.    IPv6 address: eight groups of four hexadecimal values, separated by colons (:),
    ...
    public struct ListResourceRecordSetsRequest: AWSEncodableShape {
        ...
        /// 		          API Gateway custom regional API or edge-optimized API: A    CloudFront distribution: A or AAAA    Elastic Beanstalk environment that has a regionalized subdomain: A    Elastic Load Balancing load balancer: A | AAAA    S3 bucket: A    VPC interface VPC endpoint: A    Another resource record set in this hosted zone: The type of the resource record set
    ...
    public struct ResourceRecordSet: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 		          How
        /// 				Amazon Route 53 Determines Whether an Endpoint Is Healthy     Route 53 Health Checks and DNS Failover     Configuring Failover in a Private Hosted Zone
        ///
        ...
        /// 						www.example.com with a type of A).    You configure the alias resource record set to route traffic to a non-alias resource record set
        /// 						in the same hosted zone.   You specify a health check ID for the non-alias resource record set.
        ...
        /// 					resource record set.   Associate that health check with the resource record set.
        ///
        public let healthCheckId: String?
        ...
        /// 				with the corresponding IP address only when the health check is healthy.   If you don't associate a health check with a multivalue answer record, Route 53 always considers the record
        /// 				to be healthy.   Route 53 responds to DNS queries with up to eight healthy records; if you have eight or fewer healthy records,
        /// 				Route 53 responds to all DNS queries with all the healthy records.   If you have more than eight healthy records, Route 53 responds to different DNS resolvers with different combinations of
        /// 				healthy records.   When all records are unhealthy, Route 53 responds to DNS queries with up to eight unhealthy records.   If a resource becomes unavailable after a resolver caches a response, client software typically tries another
    ...
    public struct TrafficPolicyInstance: AWSDecodableShape {
        ...
        /// 		        Applied  Amazon Route 53 has finished creating resource record sets, and changes have propagated to all Route 53 edge locations.  Creating  Route 53 is creating the resource record sets. Use GetTrafficPolicyInstance to confirm that the
        /// 					CreateTrafficPolicyInstance request completed successfully.  Failed  Route 53 wasn't able to create or update the resource record sets. When the value of State is Failed,
    ...
    public struct UpdateHealthCheckRequest: AWSEncodableShape {
        ...
        /// 				Amazon EC2 User Guide for Linux Instances    Windows: Elastic IP Addresses (EIP) in the
        ...
        /// 				ChildHealthChecks
        /// 				to null.    FullyQualifiedDomainName: Route 53 resets
        /// 				FullyQualifiedDomainName.
        /// 				to null.    Regions: Route 53 resets the
        /// 				Regions
        /// 				list to the default set of regions.     ResourcePath: Route 53 resets
        /// 				ResourcePath
        /// 				to null.
