...
extension ResilienceHub {
    ...
    public enum AppAssessmentScheduleType: String, CustomStringConvertible, Codable {
        case daily = "Daily"
    ...
    public struct CreateResiliencyPolicyRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.policyDescription, name: "policyDescription", parent: name, min: 0)
    ...
    public struct ListAppAssessmentsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "appArn", location: .querystring(locationName: "appArn")),
            AWSMemberEncoding(label: "assessmentName", location: .querystring(locationName: "assessmentName")),
            AWSMemberEncoding(label: "assessmentStatus", location: .querystring(locationName: "assessmentStatus")),
            AWSMemberEncoding(label: "complianceStatus", location: .querystring(locationName: "complianceStatus")),
            AWSMemberEncoding(label: "invoker", location: .querystring(locationName: "invoker")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "reverseOrder", location: .querystring(locationName: "reverseOrder"))
        ]
    ...
    public struct ListRecommendationTemplatesRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "assessmentArn", location: .querystring(locationName: "assessmentArn")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "name", location: .querystring(locationName: "name")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "recommendationTemplateArn", location: .querystring(locationName: "recommendationTemplateArn")),
            AWSMemberEncoding(label: "reverseOrder", location: .querystring(locationName: "reverseOrder")),
    ...
    public struct ListResiliencyPoliciesRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "policyName", location: .querystring(locationName: "policyName"))
        ]
    ...
    public struct PutDraftAppVersionTemplateRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.appTemplateBody, name: "appTemplateBody", parent: name, min: 0)
    ...
    public struct TerraformSource: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.s3StateFileUrl, name: "s3StateFileUrl", parent: name, min: 0)
