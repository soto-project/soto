...
extension Kinesis {
    ...
    public struct PutRecordInput: AWSEncodableShape {
        ...
        public init(data: AWSBlob, explicitHashKey: String? = nil, partitionKey: String, sequenceNumberForOrdering: String? = nil, streamName: String) {
            self.data = data
    ...
    public struct PutRecordsRequestEntry: AWSEncodableShape {
        ...
        public init(data: AWSBlob, explicitHashKey: String? = nil, partitionKey: String) {
            self.data = data
            self.explicitHashKey = explicitHashKey
            self.partitionKey = partitionKey
        }
    ...
    public struct Record: AWSDecodableShape {
        ...
        public init(approximateArrivalTimestamp: Date? = nil, data: AWSBlob, encryptionType: EncryptionType? = nil, partitionKey: String, sequenceNumber: String) {
