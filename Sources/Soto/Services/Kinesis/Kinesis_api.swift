...
public struct Kinesis: AWSService {
    ...
    ///
    /// Parameters:
    ///   - maxRecordSizeInKiB: The maximum record size of a single record in kibibyte (KiB) that you can write to, and read from a stream.
    ...
    @Sendable
    @inlinable
    public func describeAccountSettings(_ input: DescribeAccountSettingsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAccountSettingsOutput {
        try await self.client.execute(
    ...
    public func describeAccountSettings(
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeAccountSettingsOutput {
    ...
    ///
    /// Parameters:
    ///   - minimumThroughputBillingCommitment: Specifies the minimum throughput billing commitment configuration for your account.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func updateMaxRecordSize(_ input: UpdateMaxRecordSizeInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    public func updateStreamWarmThroughput(
        ...
        return try await self.updateStreamWarmThroughput(input, logger: logger)
    }
}
