...
public struct Kinesis: AWSService {
    ...
    public func addTagsToStream(_ input: AddTagsToStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "AddTagsToStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createStream(_ input: CreateStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "CreateStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func decreaseStreamRetentionPeriod(_ input: DecreaseStreamRetentionPeriodInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DecreaseStreamRetentionPeriod", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteStream(_ input: DeleteStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deregisterStreamConsumer(_ input: DeregisterStreamConsumerInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeregisterStreamConsumer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLimitsOutput {
        return try await self.client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeStreamConsumer(_ input: DescribeStreamConsumerInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeStreamConsumerOutput {
        return try await self.client.execute(operation: "DescribeStreamConsumer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeStreamSummary(_ input: DescribeStreamSummaryInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeStreamSummaryOutput {
        return try await self.client.execute(operation: "DescribeStreamSummary", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func disableEnhancedMonitoring(_ input: DisableEnhancedMonitoringInput, logger: Logger = AWSClient.loggingDisabled) async throws -> EnhancedMonitoringOutput {
        return try await self.client.execute(operation: "DisableEnhancedMonitoring", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func enableEnhancedMonitoring(_ input: EnableEnhancedMonitoringInput, logger: Logger = AWSClient.loggingDisabled) async throws -> EnhancedMonitoringOutput {
        return try await self.client.execute(operation: "EnableEnhancedMonitoring", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func increaseStreamRetentionPeriod(_ input: IncreaseStreamRetentionPeriodInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "IncreaseStreamRetentionPeriod", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listShards(_ input: ListShardsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListShardsOutput {
        return try await self.client.execute(operation: "ListShards", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listStreamConsumers(_ input: ListStreamConsumersInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListStreamConsumersOutput {
        return try await self.client.execute(operation: "ListStreamConsumers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTagsForStream(_ input: ListTagsForStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTagsForStreamOutput {
        return try await self.client.execute(operation: "ListTagsForStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func mergeShards(_ input: MergeShardsInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "MergeShards", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putRecord(_ input: PutRecordInput, logger: Logger = AWSClient.loggingDisabled) async throws -> PutRecordOutput {
        return try await self.client.execute(operation: "PutRecord", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putRecords(_ input: PutRecordsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> PutRecordsOutput {
        return try await self.client.execute(operation: "PutRecords", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func registerStreamConsumer(_ input: RegisterStreamConsumerInput, logger: Logger = AWSClient.loggingDisabled) async throws -> RegisterStreamConsumerOutput {
        return try await self.client.execute(operation: "RegisterStreamConsumer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func removeTagsFromStream(_ input: RemoveTagsFromStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "RemoveTagsFromStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func splitShard(_ input: SplitShardInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "SplitShard", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startStreamEncryption(_ input: StartStreamEncryptionInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "StartStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func stopStreamEncryption(_ input: StopStreamEncryptionInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "StopStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func subscribeToShard(_ input: SubscribeToShardInput, logger: Logger = AWSClient.loggingDisabled) async throws -> SubscribeToShardOutput {
        return try await self.client.execute(operation: "SubscribeToShard", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateShardCount(_ input: UpdateShardCountInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateShardCountOutput {
        return try await self.client.execute(operation: "UpdateShardCount", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateStreamMode(_ input: UpdateStreamModeInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "UpdateStreamMode", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
