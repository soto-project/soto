...
public struct AIOps: AWSService {
    ...
    ///   - crossAccountConfigurations: List of sourceRoleArn values that have been configured for cross-account access.
    ...
    ///
    /// Parameters:
    ///   - identifier: Specify either the name or the ARN of the investigation group that you want to view. This is used to set the name of the investigation group.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - resourceArn: The Amazon Resource Name (ARN) of the resource that you want to remove the tags from. You can use theListInvestigationGroups operation to find the ARNs of investigation groups.
