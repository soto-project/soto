...
extension Glue {
    ...
    public enum AggFunction: String, CustomStringConvertible, Codable {
        case avg
        case count
    ...
    public enum FilterLogicalOperator: String, CustomStringConvertible, Codable {
        case and = "AND"
        case or = "OR"
        public var description: String { return self.rawValue }
    }

    public enum FilterOperation: String, CustomStringConvertible, Codable {
        case eq = "EQ"
        case gt = "GT"
        case gte = "GTE"
        case isnull = "ISNULL"
    ...
    public enum FilterValueType: String, CustomStringConvertible, Codable {
        case columnextracted = "COLUMNEXTRACTED"
        case constant = "CONSTANT"
        public var description: String { return self.rawValue }
    }

    public enum GlueRecordType: String, CustomStringConvertible, Codable {
    ...
    public enum JDBCDataType: String, CustomStringConvertible, Codable {
        case array = "ARRAY"
        case bigint = "BIGINT"
        case binary = "BINARY"
        case bit = "BIT"
    ...
    public enum ParquetCompressionType: String, CustomStringConvertible, Codable {
        case gzip
        case lzo
        case none
        case snappy
    ...
    public enum PiiType: String, CustomStringConvertible, Codable {
    ...
    public enum QuoteChar: String, CustomStringConvertible, Codable {
        case disabled
        case quillemet
        case quote
    ...
    public enum Separator: String, CustomStringConvertible, Codable {
        case comma
        case ctrla
        case pipe
        case semicolon
    ...
    public enum StartingPosition: String, CustomStringConvertible, Codable {
        case earliest
        case latest
    ...
    public enum StatementState: String, CustomStringConvertible, Codable {
        case available = "AVAILABLE"
        case cancelled = "CANCELLED"
        case cancelling = "CANCELLING"
        case error = "ERROR"
    ...
    public enum TargetFormat: String, CustomStringConvertible, Codable {
        case avro
        case csv
        case json
        case orc
    ...
    public enum UnionType: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case distinct = "DISTINCT"
        public var description: String { return self.rawValue }
    }
    ...
    public enum UpdateCatalogBehavior: String, CustomStringConvertible, Codable {
        case log = "LOG"
        case updateInDatabase = "UPDATE_IN_DATABASE"
        public var description: String { return self.rawValue }
    }
    ...
    public struct CancelStatementRequest: AWSEncodableShape {
        ...
        public init(id: Int, requestOrigin: String? = nil, sessionId: String) {
            self.id = id
    ...
    public struct CreateSessionRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.defaultArguments?.forEach {
                ...
                try validate($0.value, name: "defaultArguments[\"\($0.key)\"]", parent: name, min: 0)
    ...
    public struct DropNullFields: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.nullTextList, name: "nullTextList", parent: name, min: 0)
        }
    ...
    public class Mapping: AWSEncodableShape & AWSDecodableShape {
    ...
    public struct PIIDetection: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.maskValue, name: "maskValue", parent: name, min: 0)
            ...
            try self.validate(self.sampleFraction, name: "sampleFraction", parent: name, max: 1)
            try self.validate(self.sampleFraction, name: "sampleFraction", parent: name, min: 0)
            try self.validate(self.thresholdFraction, name: "thresholdFraction", parent: name, max: 1)
            try self.validate(self.thresholdFraction, name: "thresholdFraction", parent: name, min: 0)
        }
    ...
    public struct Spigot: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.name, name: "name", parent: name, pattern: "([\\u0020-\\uD7FF\\uE000-\\uFFFD\\uD800\\uDC00-\\uDBFF\\uDFFF]|[^\\r\\n])*")
            try self.validate(self.path, name: "path", parent: name, pattern: "([\\u0020-\\uD7FF\\uE000-\\uFFFD\\uD800\\uDC00-\\uDBFF\\uDFFF]|[^\\S\\r\\n\"'])*")
            try self.validate(self.prob, name: "prob", parent: name, max: 1)
            try self.validate(self.prob, name: "prob", parent: name, min: 0)
