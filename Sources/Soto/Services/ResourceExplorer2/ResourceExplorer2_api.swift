...
public struct ResourceExplorer2: AWSService {
    ...
    public func associateDefaultView(_ input: AssociateDefaultViewInput, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateDefaultViewOutput {
        return try await self.client.execute(operation: "AssociateDefaultView", path: "/AssociateDefaultView", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func batchGetView(_ input: BatchGetViewInput, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchGetViewOutput {
        return try await self.client.execute(operation: "BatchGetView", path: "/BatchGetView", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createIndex(_ input: CreateIndexInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateIndexOutput {
        return try await self.client.execute(operation: "CreateIndex", path: "/CreateIndex", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createView(_ input: CreateViewInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateViewOutput {
        return try await self.client.execute(operation: "CreateView", path: "/CreateView", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteIndex(_ input: DeleteIndexInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteIndexOutput {
        return try await self.client.execute(operation: "DeleteIndex", path: "/DeleteIndex", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteView(_ input: DeleteViewInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteViewOutput {
        return try await self.client.execute(operation: "DeleteView", path: "/DeleteView", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func disassociateDefaultView(logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DisassociateDefaultView", path: "/DisassociateDefaultView", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func getDefaultView(logger: Logger = AWSClient.loggingDisabled) async throws -> GetDefaultViewOutput {
        return try await self.client.execute(operation: "GetDefaultView", path: "/GetDefaultView", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }

    /// Retrieves details about the Amazon Web Services Resource Explorer index in the Amazon Web Services Region in which you invoked the operation.
    @Sendable
    public func getIndex(logger: Logger = AWSClient.loggingDisabled) async throws -> GetIndexOutput {
        return try await self.client.execute(operation: "GetIndex", path: "/GetIndex", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }

    /// Retrieves details of the specified view.
    @Sendable
    public func getView(_ input: GetViewInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetViewOutput {
        return try await self.client.execute(operation: "GetView", path: "/GetView", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listIndexes(_ input: ListIndexesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListIndexesOutput {
        return try await self.client.execute(operation: "ListIndexes", path: "/ListIndexes", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSupportedResourceTypes(_ input: ListSupportedResourceTypesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSupportedResourceTypesOutput {
        return try await self.client.execute(operation: "ListSupportedResourceTypes", path: "/ListSupportedResourceTypes", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listViews(_ input: ListViewsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListViewsOutput {
        return try await self.client.execute(operation: "ListViews", path: "/ListViews", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func search(_ input: SearchInput, logger: Logger = AWSClient.loggingDisabled) async throws -> SearchOutput {
        return try await self.client.execute(operation: "Search", path: "/Search", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateIndexType(_ input: UpdateIndexTypeInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateIndexTypeOutput {
        return try await self.client.execute(operation: "UpdateIndexType", path: "/UpdateIndexType", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateView(_ input: UpdateViewInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateViewOutput {
        return try await self.client.execute(operation: "UpdateView", path: "/UpdateView", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
