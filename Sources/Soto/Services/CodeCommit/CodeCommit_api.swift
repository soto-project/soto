...
public struct CodeCommit: AWSService {
    ...
    @Sendable
    @inlinable
    public func getBlobDifferences(_ input: GetBlobDifferencesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBlobDifferencesOutput {
        try await self.client.execute(
            operation: "GetBlobDifferences", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///   - beforeBlobId: The ID of the "before" (source) blob in the diff. Typically the value of beforeBlob.blobId from a Difference object returned by GetDifferences. If you do not specify a value, the operation returns a diff against an empty before-state. This is equivalent to treating the file as newly added.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getBlobDifferences(
        afterBlobId: String,
        beforeBlobId: String? = nil,
        contextLines: Int? = nil,
        ignoreWhitespace: Bool? = nil,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        repositoryName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetBlobDifferencesOutput {
        let input = GetBlobDifferencesInput(
        ...
        return try await self.getBlobDifferences(input, logger: logger)
    }
...
extension CodeCommit {
    ...
    /// Return PaginatorSequence for operation ``getBlobDifferences(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func getBlobDifferencesPaginator(
        _ input: GetBlobDifferencesInput,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<GetBlobDifferencesInput, GetBlobDifferencesOutput> {
        return .init(
            input: input,
            command: self.getBlobDifferences,
            inputKey: \GetBlobDifferencesInput.nextToken,
            outputKey: \GetBlobDifferencesOutput.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``getBlobDifferences(_:logger:)``.
    ...
    public func getBlobDifferencesPaginator(
        ...
        return self.getBlobDifferencesPaginator(input, logger: logger)
    }
...
extension CodeCommit.GetBlobDifferencesInput: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> CodeCommit.GetBlobDifferencesInput {
        return .init(
