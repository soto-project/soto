...
extension Support {
    ...
    public func describeCreateCaseOptions(_ input: DescribeCreateCaseOptionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeCreateCaseOptionsResponse {
        return try await self.client.execute(operation: "DescribeCreateCaseOptions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeSupportedLanguages(_ input: DescribeSupportedLanguagesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeSupportedLanguagesResponse {
        return try await self.client.execute(operation: "DescribeSupportedLanguages", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
