...
extension CloudWatch {
    ...
    public enum AlarmMuteRuleStatus: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case active = "ACTIVE"
    ...
    public enum OTelEnrichmentStatus: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    public enum EvaluationWindow: AWSEncodableShape & AWSDecodableShape, Sendable {
        ...
        case wallClockWindow(WallClockWindow)
        ...
        public init(from decoder: Decoder) throws {
            ...
            switch key {
            case .slidingWindow:
                let value = try container.decode(SlidingWindow.self, forKey: .slidingWindow)
                self = .slidingWindow(value)
            case .wallClockWindow:
                let value = try container.decode(WallClockWindow.self, forKey: .wallClockWindow)
                self = .wallClockWindow(value)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .wallClockWindow(let value):
                try container.encode(value, forKey: .wallClockWindow)
            }
        }
        ...
        public func validate(name: String) throws {
            switch self {
            case .wallClockWindow(let value):
                try value.validate(name: "\(name).wallClockWindow")
            default:
                break
            }
        }
    ...
    public struct AlarmContributor: AWSDecodableShape {
        ...
        public let contributorAttributes: [String: String]?
    ...
    public struct AlarmHistoryItem: AWSDecodableShape {
        ...
        public let alarmContributorAttributes: [String: String]?
    ...
    public struct AlarmMuteRuleSummary: AWSDecodableShape {
        /// The Amazon Resource Name (ARN) of the alarm mute rule.
        public let alarmMuteRuleArn: String?
        ...
        public let status: AlarmMuteRuleStatus?

        @inlinable
        public init(alarmMuteRuleArn: String? = nil, expireDate: Date? = nil, lastUpdatedTimestamp: Date? = nil, muteType: String? = nil, status: AlarmMuteRuleStatus? = nil) {
        ...
        private enum CodingKeys: String, CodingKey {
            case alarmMuteRuleArn = "AlarmMuteRuleArn"
            case expireDate = "ExpireDate"
            case lastUpdatedTimestamp = "LastUpdatedTimestamp"
            case muteType = "MuteType"
            case status = "Status"
        }
    }

    public struct AlarmPromQLCriteria: AWSEncodableShape & AWSDecodableShape {
        /// The duration, in seconds, that a contributor must be continuously breaching before it transitions to the ALARM state.
        public let pendingPeriod: Int?
        ...
        public let recoveryPeriod: Int?

        @inlinable
        public init(pendingPeriod: Int? = nil, query: String? = nil, recoveryPeriod: Int? = nil) {
        ...
        public func validate(name: String) throws {
            try self.validate(self.pendingPeriod, name: "pendingPeriod", parent: name, max: 86400)
            try self.validate(self.pendingPeriod, name: "pendingPeriod", parent: name, min: 0)
            try self.validate(self.query, name: "query", parent: name, max: 10000)
            try self.validate(self.query, name: "query", parent: name, min: 1)
            try self.validate(self.recoveryPeriod, name: "recoveryPeriod", parent: name, max: 86400)
            try self.validate(self.recoveryPeriod, name: "recoveryPeriod", parent: name, min: 0)
        }

        private enum CodingKeys: String, CodingKey {
            case pendingPeriod = "PendingPeriod"
            case query = "Query"
            case recoveryPeriod = "RecoveryPeriod"
        }
    }
    ...
    public struct AnomalyDetector: AWSDecodableShape {
        ...
        @inlinable
        public init(anomalyDetectorId: String? = nil, configuration: AnomalyDetectorConfiguration? = nil, metricCharacteristics: MetricCharacteristics? = nil, metricMathAnomalyDetector: MetricMathAnomalyDetector? = nil, singleMetricAnomalyDetector: SingleMetricAnomalyDetector? = nil, stateValue: AnomalyDetectorStateValue? = nil) {
        ...
        @inlinable
        public init(anomalyDetectorId: String? = nil, configuration: AnomalyDetectorConfiguration? = nil, dimensions: [Dimension]? = nil, metricCharacteristics: MetricCharacteristics? = nil, metricMathAnomalyDetector: MetricMathAnomalyDetector? = nil, metricName: String? = nil, namespace: String? = nil, singleMetricAnomalyDetector: SingleMetricAnomalyDetector? = nil, stat: String? = nil, stateValue: AnomalyDetectorStateValue? = nil) {
            self.anomalyDetectorId = anomalyDetectorId
            self.configuration = configuration
    ...
    public struct AssociateDatasetKmsKeyInput: AWSEncodableShape {
        ...
        @inlinable
        public init(datasetIdentifier: String? = nil, kmsKeyArn: String? = nil) {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.datasetIdentifier, name: "datasetIdentifier", parent: name, pattern: "^(default|arn:[a-zA-Z0-9-]+:cloudwatch:[a-zA-Z0-9-]*:\\d{12}:dataset/default)$")
            try self.validate(self.kmsKeyArn, name: "kmsKeyArn", parent: name, max: 2048)
            try self.validate(self.kmsKeyArn, name: "kmsKeyArn", parent: name, min: 20)
            try self.validate(self.kmsKeyArn, name: "kmsKeyArn", parent: name, pattern: "^arn:[a-zA-Z0-9-]+:kms:[a-zA-Z0-9-]+:\\d{12}:key/[a-f0-9-]+$")
        }
    ...
    public struct AssociateDatasetKmsKeyOutput: AWSDecodableShape {
        public init() {}
    }
    ...
    public struct DeleteAlarmMuteRuleInput: AWSEncodableShape {
        /// The name of the alarm mute rule to delete.
        public let alarmMuteRuleName: String?

        @inlinable
        public init(alarmMuteRuleName: String? = nil) {
            self.alarmMuteRuleName = alarmMuteRuleName
        }

        public func validate(name: String) throws {
            try self.validate(self.alarmMuteRuleName, name: "alarmMuteRuleName", parent: name, max: 255)
            try self.validate(self.alarmMuteRuleName, name: "alarmMuteRuleName", parent: name, min: 1)
        }

        private enum CodingKeys: String, CodingKey {
            case alarmMuteRuleName = "AlarmMuteRuleName"
        }
    }
    ...
    public struct DeleteAnomalyDetectorInput: AWSEncodableShape {
        ...
        @inlinable
        public init(anomalyDetectorId: String? = nil, metricMathAnomalyDetector: MetricMathAnomalyDetector? = nil, singleMetricAnomalyDetector: SingleMetricAnomalyDetector? = nil) {
            self.anomalyDetectorId = anomalyDetectorId
            self.dimensions = nil
            self.metricMathAnomalyDetector = metricMathAnomalyDetector
            self.metricName = nil
        ...
        @available(*, deprecated, message: "Members dimensions, metricName, namespace, stat have been deprecated")
        @inlinable
        public init(anomalyDetectorId: String? = nil, dimensions: [Dimension]? = nil, metricMathAnomalyDetector: MetricMathAnomalyDetector? = nil, metricName: String? = nil, namespace: String? = nil, singleMetricAnomalyDetector: SingleMetricAnomalyDetector? = nil, stat: String? = nil) {
            self.anomalyDetectorId = anomalyDetectorId
            self.dimensions = dimensions
            self.metricMathAnomalyDetector = metricMathAnomalyDetector
            self.metricName = metricName
        ...
        public func validate(name: String) throws {
            try self.validate(self.anomalyDetectorId, name: "anomalyDetectorId", parent: name, max: 128)
            try self.validate(self.anomalyDetectorId, name: "anomalyDetectorId", parent: name, min: 1)
            try self.validate(self.anomalyDetectorId, name: "anomalyDetectorId", parent: name, pattern: "^[A-Za-z0-9_./:%()+-]+$")
    ...
    public struct DescribeAlarmContributorsOutput: AWSDecodableShape {
        ...
        public let alarmContributors: [AlarmContributor]?
    ...
    public struct DescribeAlarmHistoryInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.alarmContributorId, name: "alarmContributorId", parent: name, max: 16)
    ...
    public struct DescribeAlarmsOutput: AWSDecodableShape {
        ...
        @inlinable
        public init(compositeAlarms: [CompositeAlarm]? = nil, logAlarms: [LogAlarm]? = nil, metricAlarms: [MetricAlarm]? = nil, nextToken: String? = nil) {
    ...
    public struct DescribeAnomalyDetectorsInput: AWSEncodableShape {
        ...
        @inlinable
        public init(anomalyDetectorIds: [String]? = nil, anomalyDetectorTypes: [AnomalyDetectorType]? = nil, dimensions: [Dimension]? = nil, maxResults: Int? = nil, metricName: String? = nil, namespace: String? = nil, nextToken: String? = nil) {
        ...
        public func validate(name: String) throws {
            try self.anomalyDetectorIds?.forEach {
                try validate($0, name: "anomalyDetectorIds[]", parent: name, max: 128)
                try validate($0, name: "anomalyDetectorIds[]", parent: name, min: 1)
                try validate($0, name: "anomalyDetectorIds[]", parent: name, pattern: "^[A-Za-z0-9_./:%()+-]+$")
            }
            try self.validate(self.anomalyDetectorIds, name: "anomalyDetectorIds", parent: name, max: 50)
        ...
        private enum CodingKeys: String, CodingKey {
            case anomalyDetectorIds = "AnomalyDetectorIds"
    ...
    public struct DisassociateDatasetKmsKeyInput: AWSEncodableShape {
        ...
        @inlinable
        public init(datasetIdentifier: String? = nil) {
            self.datasetIdentifier = datasetIdentifier
        }
    ...
    public struct DisassociateDatasetKmsKeyOutput: AWSDecodableShape {
        public init() {}
    }
    ...
    public struct GetAlarmMuteRuleInput: AWSEncodableShape {
    ...
    public struct GetAlarmMuteRuleOutput: AWSDecodableShape {
        /// The Amazon Resource Name (ARN) of the alarm mute rule.
        public let alarmMuteRuleArn: String?
        ...
        public let muteTargets: MuteTargets?
        /// Indicates whether the mute rule is one-time or recurring. Valid values are ONE_TIME or RECURRING.
        public let muteType: String?
        ...
        @inlinable
        public init(alarmMuteRuleArn: String? = nil, description: String? = nil, expireDate: Date? = nil, lastUpdatedTimestamp: Date? = nil, muteTargets: MuteTargets? = nil, muteType: String? = nil, name: String? = nil, rule: Rule? = nil, startDate: Date? = nil, status: AlarmMuteRuleStatus? = nil) {
            self.alarmMuteRuleArn = alarmMuteRuleArn
    ...
    public struct GetDatasetInput: AWSEncodableShape {
    ...
    public struct GetDatasetOutput: AWSDecodableShape {
        ...
        @inlinable
        public init(arn: String? = nil, datasetId: String? = nil, kmsKeyArn: String? = nil) {
            self.arn = arn
    ...
    public struct GetMetricStreamOutput: AWSDecodableShape {
        ...
        public let statisticsConfigurations: [MetricStreamStatisticsConfiguration]?
    ...
    public struct GetOTelEnrichmentInput: AWSEncodableShape {
        public init() {}
    }
    ...
    public struct InsightRule: AWSDecodableShape {
        ...
        @inlinable
        public init(applyOnTransformedLogs: Bool? = nil, definition: String? = nil, managedRule: Bool? = nil, name: String? = nil, schema: String? = nil, state: String? = nil) {
    ...
    public struct ListAlarmMuteRulesInput: AWSEncodableShape {
        ...
        public let statuses: [AlarmMuteRuleStatus]?

        @inlinable
        public init(alarmName: String? = nil, maxRecords: Int? = nil, nextToken: String? = nil, statuses: [AlarmMuteRuleStatus]? = nil) {
            self.alarmName = alarmName
            self.maxRecords = maxRecords
            self.nextToken = nextToken
    ...
    public struct ListAlarmMuteRulesOutput: AWSDecodableShape {
        /// A list of alarm mute rule summaries.
        public let alarmMuteRuleSummaries: [AlarmMuteRuleSummary]?
        /// The token to use when requesting the next set of results. If this field is absent, there are no more results to retrieve.
        public let nextToken: String?

        @inlinable
        public init(alarmMuteRuleSummaries: [AlarmMuteRuleSummary]? = nil, nextToken: String? = nil) {
            self.alarmMuteRuleSummaries = alarmMuteRuleSummaries
            self.nextToken = nextToken
        }

        private enum CodingKeys: String, CodingKey {
            case alarmMuteRuleSummaries = "AlarmMuteRuleSummaries"
            case nextToken = "NextToken"
        }
    }
    ...
    public struct ListManagedInsightRulesOutput: AWSDecodableShape {
        ...
        public let managedRules: [ManagedRuleDescription]?
        ///  Include this value to get the next set of rules if the value was returned by the previous operation.
        public let nextToken: String?
    ...
    public struct ListMetricsOutput: AWSDecodableShape {
        ...
        public let owningAccounts: [String]?
    ...
    public struct LogAlarm: AWSDecodableShape {
        ...
        public let actionLogLineCount: Int?
        ...
        public let actionLogLineRoleArn: String?
        /// Indicates whether actions should be executed during any changes to the alarm state.
        public let actionsEnabled: Bool?
        /// The actions to execute when this alarm transitions to the ALARM state from any other state. Each action is specified as an Amazon Resource Name (ARN).
        public let alarmActions: [String]?
        ...
        public let queryResultsToAlarm: Int?
        ...
        public let queryResultsToEvaluate: Int?
        ...
        public let scheduledQueryConfiguration: ScheduledQueryConfiguration?
        /// An explanation for the alarm state, in text format.
        public let stateReason: String?
        /// An explanation for the alarm state, in JSON format.
        public let stateReasonData: String?
        ...
        private enum CodingKeys: String, CodingKey {
            case actionLogLineCount = "ActionLogLineCount"
            case actionLogLineRoleArn = "ActionLogLineRoleArn"
            case actionsEnabled = "ActionsEnabled"
            case alarmActions = "AlarmActions"
            case alarmArn = "AlarmArn"
            case alarmConfigurationUpdatedTimestamp = "AlarmConfigurationUpdatedTimestamp"
            ...
            case insufficientDataActions = "InsufficientDataActions"
            case okActions = "OKActions"
            case queryResultsToAlarm = "QueryResultsToAlarm"
            case queryResultsToEvaluate = "QueryResultsToEvaluate"
            case scheduledQueryConfiguration = "ScheduledQueryConfiguration"
            case stateReason = "StateReason"
            case stateReasonData = "StateReasonData"
            case stateTransitionedTimestamp = "StateTransitionedTimestamp"
            case stateUpdatedTimestamp = "StateUpdatedTimestamp"
    ...
    public struct MetricAlarm: AWSDecodableShape {
        ...
        public let evaluationCriteria: EvaluationCriteria?
        /// The frequency, in seconds, at which the alarm is evaluated.
        public let evaluationInterval: Int?
        ...
        public let evaluationWindow: EvaluationWindow?
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case evaluationCriteria = "EvaluationCriteria"
    ...
    public struct MetricStreamStatisticsConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        public let additionalStatistics: [String]?
        ...
        public let includeMetrics: [MetricStreamStatisticsMetric]?
    ...
    public struct MuteTargets: AWSEncodableShape & AWSDecodableShape {
    ...
    public struct PutAlarmMuteRuleInput: AWSEncodableShape {
        ...
        @inlinable
        public init(description: String? = nil, expireDate: Date? = nil, muteTargets: MuteTargets? = nil, name: String? = nil, rule: Rule? = nil, startDate: Date? = nil, tags: [Tag]? = nil) {
            self.description = description
            self.expireDate = expireDate
            self.muteTargets = muteTargets
            self.name = name
        ...
        public func validate(name: String) throws {
            ...
            try self.muteTargets?.validate(name: "\(name).muteTargets")
            try self.validate(self.name, name: "name", parent: name, max: 255)
            try self.validate(self.name, name: "name", parent: name, min: 1)
    ...
    public struct PutAnomalyDetectorOutput: AWSDecodableShape {
        ...
        @inlinable
        public init(anomalyDetectorId: String? = nil) {
            self.anomalyDetectorId = anomalyDetectorId
        }
    ...
    public struct PutDashboardInput: AWSEncodableShape {
        ...
        @inlinable
        public init(dashboardBody: String? = nil, dashboardName: String? = nil, tags: [Tag]? = nil) {
            self.dashboardBody = dashboardBody
            self.dashboardName = dashboardName
            self.tags = tags
        }
    ...
    public struct PutInsightRuleInput: AWSEncodableShape {
        ...
        @inlinable
        public init(applyOnTransformedLogs: Bool? = nil, ruleDefinition: String? = nil, ruleName: String? = nil, ruleState: String? = nil, tags: [Tag]? = nil) {
            self.applyOnTransformedLogs = applyOnTransformedLogs
    ...
    public struct PutLogAlarmInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.okActions, name: "okActions", parent: name, max: 5)
            try self.validate(self.queryResultsToAlarm, name: "queryResultsToAlarm", parent: name, min: 1)
            try self.validate(self.queryResultsToEvaluate, name: "queryResultsToEvaluate", parent: name, min: 1)
            try self.scheduledQueryConfiguration?.validate(name: "\(name).scheduledQueryConfiguration")
            try self.tags?.forEach {
                try $0.validate(name: "\(name).tags[]")
            }
    ...
    public struct PutManagedInsightRulesInput: AWSEncodableShape {
        ...
        public let managedRules: [ManagedRule]?
    ...
    public struct PutMetricAlarmInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.evaluationCriteria?.validate(name: "\(name).evaluationCriteria")
            try self.validate(self.evaluationInterval, name: "evaluationInterval", parent: name, max: 3600)
            try self.validate(self.evaluationInterval, name: "evaluationInterval", parent: name, min: 10)
            try self.validate(self.evaluationPeriods, name: "evaluationPeriods", parent: name, min: 1)
            try self.evaluationWindow?.validate(name: "\(name).evaluationWindow")
            try self.insufficientDataActions?.forEach {
                try validate($0, name: "insufficientDataActions[]", parent: name, max: 1024)
                try validate($0, name: "insufficientDataActions[]", parent: name, min: 1)
            }
    ...
    public struct PutMetricDataInput: AWSEncodableShape {
        ...
        public let entityMetricData: [EntityMetricData]?
    ...
    public struct Schedule: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        public init(duration: String? = nil, expression: String? = nil, timezone: String? = nil) {
        ...
        public func validate(name: String) throws {
            try self.validate(self.duration, name: "duration", parent: name, max: 50)
    ...
    public struct ScheduleConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        public init(endTimeOffset: Int64? = nil, scheduleExpression: String? = nil, startTimeOffset: Int64? = nil) {
        ...
        public func validate(name: String) throws {
            try self.validate(self.endTimeOffset, name: "endTimeOffset", parent: name, max: 2592000)
            try self.validate(self.endTimeOffset, name: "endTimeOffset", parent: name, min: 0)
            ...
            try self.validate(self.startTimeOffset, name: "startTimeOffset", parent: name, max: 2592000)
    ...
    public struct ScheduledQueryConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        public let scheduledQueryRoleARN: String?
        /// A list of key-value pairs to associate with the underlying scheduled query resource.
        public let tags: [Tag]?

        @inlinable
        public init(aggregationExpression: String? = nil, logGroupIdentifiers: [String]? = nil, queryARN: String? = nil, queryString: String? = nil, scheduleConfiguration: ScheduleConfiguration? = nil, scheduledQueryRoleARN: String? = nil, tags: [Tag]? = nil) {
        ...
        public func validate(name: String) throws {
            try self.validate(self.aggregationExpression, name: "aggregationExpression", parent: name, max: 2048)
            try self.validate(self.aggregationExpression, name: "aggregationExpression", parent: name, min: 1)
            try self.logGroupIdentifiers?.forEach {
                try validate($0, name: "logGroupIdentifiers[]", parent: name, max: 1024)
            ...
            try self.validate(self.queryARN, name: "queryARN", parent: name, max: 1024)
            ...
            try self.validate(self.scheduledQueryRoleARN, name: "scheduledQueryRoleARN", parent: name, max: 1024)
            try self.validate(self.scheduledQueryRoleARN, name: "scheduledQueryRoleARN", parent: name, min: 1)
            try self.tags?.forEach {
                try $0.validate(name: "\(name).tags[]")
            }
        }
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case scheduledQueryRoleARN = "ScheduledQueryRoleARN"
            case tags = "Tags"
        }
    }
    ...
    public struct SlidingWindow: AWSEncodableShape & AWSDecodableShape {
        public init() {}
    }
    ...
    public struct StopOTelEnrichmentInput: AWSEncodableShape {
        public init() {}
    }

    public struct StopOTelEnrichmentOutput: AWSDecodableShape {
        public init() {}
    }
    ...
    public struct EvaluationCriteria: AWSEncodableShape & AWSDecodableShape {
        /// The PromQL criteria for the alarm evaluation.
        public let promQLCriteria: AlarmPromQLCriteria?

        @inlinable
        public init(promQLCriteria: AlarmPromQLCriteria? = nil) {
            self.promQLCriteria = promQLCriteria
        }

        public func validate(name: String) throws {
            try self.promQLCriteria?.validate(name: "\(name).promQLCriteria")
        }

        private enum CodingKeys: String, CodingKey {
            case promQLCriteria = "PromQLCriteria"
        }
    }
}
...
public struct CloudWatchErrorType: AWSErrorType {
    ...
    public static var resourceConflict: Self { .init(.resourceConflict) }
