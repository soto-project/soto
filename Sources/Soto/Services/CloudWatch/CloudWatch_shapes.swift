...
extension CloudWatch {
    ...
    public struct ListAlarmMuteRulesInput: AWSEncodableShape {
        ...
        @OptionalCustomCoding<StandardArrayCoder<AlarmMuteRuleStatus>>
        public var statuses: [AlarmMuteRuleStatus]?
    ...
    public struct ListAlarmMuteRulesOutput: AWSDecodableShape {
        ...
        @OptionalCustomCoding<StandardArrayCoder<AlarmMuteRuleSummary>>
        public var alarmMuteRuleSummaries: [AlarmMuteRuleSummary]?
