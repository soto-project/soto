...
public struct CloudWatch: AWSService {
    ...
    @discardableResult public func deleteAlarms(_ input: DeleteAlarmsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteAlarms", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Deletes the specified anomaly detection model from your account.
    public func deleteAnomalyDetector(_ input: DeleteAnomalyDetectorInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteAnomalyDetectorOutput> {
        return self.client.execute(operation: "DeleteAnomalyDetector", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Deletes all dashboards that you specify. You can specify up to 100 dashboards to delete. If there is an error during this call, no dashboards are deleted.
    public func deleteDashboards(_ input: DeleteDashboardsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDashboardsOutput> {
        return self.client.execute(operation: "DeleteDashboards", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteInsightRules(_ input: DeleteInsightRulesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteInsightRulesOutput> {
        return self.client.execute(operation: "DeleteInsightRules", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Permanently deletes the metric stream that you specify.
    public func deleteMetricStream(_ input: DeleteMetricStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMetricStreamOutput> {
        return self.client.execute(operation: "DeleteMetricStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeAlarmHistory(_ input: DescribeAlarmHistoryInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmHistoryOutput> {
        return self.client.execute(operation: "DescribeAlarmHistory", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves the specified alarms. You can filter the results by specifying a prefix for the alarm name, the alarm state, or a prefix for any action.
    public func describeAlarms(_ input: DescribeAlarmsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmsOutput> {
        return self.client.execute(operation: "DescribeAlarms", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeAlarmsForMetric(_ input: DescribeAlarmsForMetricInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmsForMetricOutput> {
        return self.client.execute(operation: "DescribeAlarmsForMetric", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Lists the anomaly detection models that you have created in your account. You can list all models in your account or filter the results to only the models that are related to a certain namespace, metric name, or metric dimension.
    public func describeAnomalyDetectors(_ input: DescribeAnomalyDetectorsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAnomalyDetectorsOutput> {
        return self.client.execute(operation: "DescribeAnomalyDetectors", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeInsightRules(_ input: DescribeInsightRulesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeInsightRulesOutput> {
        return self.client.execute(operation: "DescribeInsightRules", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Disables the actions for the specified alarms. When an alarm's actions are disabled, the alarm actions do not execute when the alarm state changes.
    @discardableResult public func disableAlarmActions(_ input: DisableAlarmActionsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DisableAlarmActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do not incur costs.
    public func disableInsightRules(_ input: DisableInsightRulesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisableInsightRulesOutput> {
        return self.client.execute(operation: "DisableInsightRules", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Enables the actions for the specified alarms.
    @discardableResult public func enableAlarmActions(_ input: EnableAlarmActionsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "EnableAlarmActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.
    public func enableInsightRules(_ input: EnableInsightRulesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EnableInsightRulesOutput> {
        return self.client.execute(operation: "EnableInsightRules", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getDashboard(_ input: GetDashboardInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDashboardOutput> {
        return self.client.execute(operation: "GetDashboard", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getInsightRuleReport(_ input: GetInsightRuleReportInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetInsightRuleReportOutput> {
        return self.client.execute(operation: "GetInsightRuleReport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getMetricData(_ input: GetMetricDataInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricDataOutput> {
        return self.client.execute(operation: "GetMetricData", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getMetricStatistics(_ input: GetMetricStatisticsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricStatisticsOutput> {
        return self.client.execute(operation: "GetMetricStatistics", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns information about the metric stream that you specify.
    public func getMetricStream(_ input: GetMetricStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricStreamOutput> {
        return self.client.execute(operation: "GetMetricStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getMetricWidgetImage(_ input: GetMetricWidgetImageInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricWidgetImageOutput> {
        return self.client.execute(operation: "GetMetricWidgetImage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listDashboards(_ input: ListDashboardsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDashboardsOutput> {
        return self.client.execute(operation: "ListDashboards", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns a list of metric streams in this account.
    public func listMetricStreams(_ input: ListMetricStreamsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMetricStreamsOutput> {
        return self.client.execute(operation: "ListMetricStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listMetrics(_ input: ListMetricsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMetricsOutput> {
        return self.client.execute(operation: "ListMetrics", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putAnomalyDetector(_ input: PutAnomalyDetectorInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAnomalyDetectorOutput> {
        return self.client.execute(operation: "PutAnomalyDetector", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func putCompositeAlarm(_ input: PutCompositeAlarmInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutCompositeAlarm", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putDashboard(_ input: PutDashboardInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutDashboardOutput> {
        return self.client.execute(operation: "PutDashboard", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putInsightRule(_ input: PutInsightRuleInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutInsightRuleOutput> {
        return self.client.execute(operation: "PutInsightRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func putMetricAlarm(_ input: PutMetricAlarmInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutMetricAlarm", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func putMetricData(_ input: PutMetricDataInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PutMetricData", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putMetricStream(_ input: PutMetricStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutMetricStreamOutput> {
        return self.client.execute(operation: "PutMetricStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func setAlarmState(_ input: SetAlarmStateInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "SetAlarmState", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Starts the streaming of metrics for one or more of your metric streams.
    public func startMetricStreams(_ input: StartMetricStreamsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartMetricStreamsOutput> {
        return self.client.execute(operation: "StartMetricStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Stops the streaming of metrics for one or more of your metric streams.
    public func stopMetricStreams(_ input: StopMetricStreamsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopMetricStreamsOutput> {
        return self.client.execute(operation: "StopMetricStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
