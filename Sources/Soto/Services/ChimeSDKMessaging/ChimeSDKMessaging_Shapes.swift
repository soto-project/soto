...
extension ChimeSDKMessaging {
    ...
    public enum SearchFieldKey: String, CustomStringConvertible, Codable {
        case members = "MEMBERS"
        public var description: String { return self.rawValue }
    }

    public enum SearchFieldOperator: String, CustomStringConvertible, Codable {
        case equals = "EQUALS"
    ...
    public struct DeleteChannelFlowRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "channelFlowArn", location: .uri(locationName: "channelFlowArn"))
        ]
    ...
    public struct ListChannelsAssociatedWithChannelFlowRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "channelFlowArn", location: .querystring(locationName: "channel-flow-arn")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "max-results")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "next-token"))
        ]
    ...
    public struct PushNotificationConfiguration: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.body, name: "body", parent: name, min: 0)
