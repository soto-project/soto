...
public struct CognitoSync: AWSService {
    ...
    public func bulkPublish(_ input: BulkPublishRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> BulkPublishResponse {
        return try await self.client.execute(operation: "BulkPublish", path: "/identitypools/{IdentityPoolId}/bulkpublish", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteDataset(_ input: DeleteDatasetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteDatasetResponse {
        return try await self.client.execute(operation: "DeleteDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeDataset(_ input: DescribeDatasetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeDatasetResponse {
        return try await self.client.execute(operation: "DescribeDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeIdentityPoolUsage(_ input: DescribeIdentityPoolUsageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeIdentityPoolUsageResponse {
        return try await self.client.execute(operation: "DescribeIdentityPoolUsage", path: "/identitypools/{IdentityPoolId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeIdentityUsage(_ input: DescribeIdentityUsageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeIdentityUsageResponse {
        return try await self.client.execute(operation: "DescribeIdentityUsage", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBulkPublishDetails(_ input: GetBulkPublishDetailsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBulkPublishDetailsResponse {
        return try await self.client.execute(operation: "GetBulkPublishDetails", path: "/identitypools/{IdentityPoolId}/getBulkPublishDetails", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getCognitoEvents(_ input: GetCognitoEventsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetCognitoEventsResponse {
        return try await self.client.execute(operation: "GetCognitoEvents", path: "/identitypools/{IdentityPoolId}/events", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getIdentityPoolConfiguration(_ input: GetIdentityPoolConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetIdentityPoolConfigurationResponse {
        return try await self.client.execute(operation: "GetIdentityPoolConfiguration", path: "/identitypools/{IdentityPoolId}/configuration", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listDatasets(_ input: ListDatasetsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListDatasetsResponse {
        return try await self.client.execute(operation: "ListDatasets", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listIdentityPoolUsage(_ input: ListIdentityPoolUsageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListIdentityPoolUsageResponse {
        return try await self.client.execute(operation: "ListIdentityPoolUsage", path: "/identitypools", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listRecords(_ input: ListRecordsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListRecordsResponse {
        return try await self.client.execute(operation: "ListRecords", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/records", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func registerDevice(_ input: RegisterDeviceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> RegisterDeviceResponse {
        return try await self.client.execute(operation: "RegisterDevice", path: "/identitypools/{IdentityPoolId}/identity/{IdentityId}/device", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func setCognitoEvents(_ input: SetCognitoEventsRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "SetCognitoEvents", path: "/identitypools/{IdentityPoolId}/events", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func setIdentityPoolConfiguration(_ input: SetIdentityPoolConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SetIdentityPoolConfigurationResponse {
        return try await self.client.execute(operation: "SetIdentityPoolConfiguration", path: "/identitypools/{IdentityPoolId}/configuration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func subscribeToDataset(_ input: SubscribeToDatasetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SubscribeToDatasetResponse {
        return try await self.client.execute(operation: "SubscribeToDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func unsubscribeFromDataset(_ input: UnsubscribeFromDatasetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UnsubscribeFromDatasetResponse {
        return try await self.client.execute(operation: "UnsubscribeFromDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateRecords(_ input: UpdateRecordsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateRecordsResponse {
        return try await self.client.execute(operation: "UpdateRecords", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
