...
extension WAFRegional {
    ...
    public func createByteMatchSet(_ input: CreateByteMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateByteMatchSetResponse {
        return try await self.client.execute(operation: "CreateByteMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func createGeoMatchSet(_ input: CreateGeoMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateGeoMatchSetResponse {
        return try await self.client.execute(operation: "CreateGeoMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createRateBasedRule(_ input: CreateRateBasedRuleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateRateBasedRuleResponse {
        return try await self.client.execute(operation: "CreateRateBasedRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createRegexMatchSet(_ input: CreateRegexMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateRegexMatchSetResponse {
        return try await self.client.execute(operation: "CreateRegexMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func createSizeConstraintSet(_ input: CreateSizeConstraintSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateSizeConstraintSetResponse {
        return try await self.client.execute(operation: "CreateSizeConstraintSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func createSqlInjectionMatchSet(_ input: CreateSqlInjectionMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateSqlInjectionMatchSetResponse {
        return try await self.client.execute(operation: "CreateSqlInjectionMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createWebACLMigrationStack(_ input: CreateWebACLMigrationStackRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateWebACLMigrationStackResponse {
        return try await self.client.execute(operation: "CreateWebACLMigrationStack", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func createXssMatchSet(_ input: CreateXssMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateXssMatchSetResponse {
        return try await self.client.execute(operation: "CreateXssMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteByteMatchSet(_ input: DeleteByteMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteByteMatchSetResponse {
        return try await self.client.execute(operation: "DeleteByteMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteGeoMatchSet(_ input: DeleteGeoMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteGeoMatchSetResponse {
        return try await self.client.execute(operation: "DeleteGeoMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteRateBasedRule(_ input: DeleteRateBasedRuleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteRateBasedRuleResponse {
        return try await self.client.execute(operation: "DeleteRateBasedRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteRegexMatchSet(_ input: DeleteRegexMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteRegexMatchSetResponse {
        return try await self.client.execute(operation: "DeleteRegexMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteSizeConstraintSet(_ input: DeleteSizeConstraintSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteSizeConstraintSetResponse {
        return try await self.client.execute(operation: "DeleteSizeConstraintSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteSqlInjectionMatchSet(_ input: DeleteSqlInjectionMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteSqlInjectionMatchSetResponse {
        return try await self.client.execute(operation: "DeleteSqlInjectionMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteXssMatchSet(_ input: DeleteXssMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteXssMatchSetResponse {
        return try await self.client.execute(operation: "DeleteXssMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getByteMatchSet(_ input: GetByteMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetByteMatchSetResponse {
        return try await self.client.execute(operation: "GetByteMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getChangeToken(_ input: GetChangeTokenRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetChangeTokenResponse {
        return try await self.client.execute(operation: "GetChangeToken", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getChangeTokenStatus(_ input: GetChangeTokenStatusRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetChangeTokenStatusResponse {
        return try await self.client.execute(operation: "GetChangeTokenStatus", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.   Returns the GeoMatchSet that is specified by GeoMatchSetId.
    public func getGeoMatchSet(_ input: GetGeoMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetGeoMatchSetResponse {
        return try await self.client.execute(operation: "GetGeoMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRateBasedRule(_ input: GetRateBasedRuleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRateBasedRuleResponse {
        return try await self.client.execute(operation: "GetRateBasedRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRateBasedRuleManagedKeys(_ input: GetRateBasedRuleManagedKeysRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRateBasedRuleManagedKeysResponse {
        return try await self.client.execute(operation: "GetRateBasedRuleManagedKeys", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.   Returns the RegexMatchSet specified by RegexMatchSetId.
    public func getRegexMatchSet(_ input: GetRegexMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRegexMatchSetResponse {
        return try await self.client.execute(operation: "GetRegexMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRule(_ input: GetRuleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRuleResponse {
        return try await self.client.execute(operation: "GetRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getSizeConstraintSet(_ input: GetSizeConstraintSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetSizeConstraintSetResponse {
        return try await self.client.execute(operation: "GetSizeConstraintSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.
    /// 		       Returns the SqlInjectionMatchSet that is specified by SqlInjectionMatchSetId.
    public func getSqlInjectionMatchSet(_ input: GetSqlInjectionMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetSqlInjectionMatchSetResponse {
        return try await self.client.execute(operation: "GetSqlInjectionMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getXssMatchSet(_ input: GetXssMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetXssMatchSetResponse {
        return try await self.client.execute(operation: "GetXssMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.   Returns an array of ActivatedRule objects.
    public func listActivatedRulesInRuleGroup(_ input: ListActivatedRulesInRuleGroupRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListActivatedRulesInRuleGroupResponse {
        return try await self.client.execute(operation: "ListActivatedRulesInRuleGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.
    /// 		       Returns an array of ByteMatchSetSummary objects.
    public func listByteMatchSets(_ input: ListByteMatchSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListByteMatchSetsResponse {
        return try await self.client.execute(operation: "ListByteMatchSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.   Returns an array of GeoMatchSetSummary objects in the response.
    public func listGeoMatchSets(_ input: ListGeoMatchSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListGeoMatchSetsResponse {
        return try await self.client.execute(operation: "ListGeoMatchSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listRateBasedRules(_ input: ListRateBasedRulesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListRateBasedRulesResponse {
        return try await self.client.execute(operation: "ListRateBasedRules", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.   Returns an array of RegexMatchSetSummary objects.
    public func listRegexMatchSets(_ input: ListRegexMatchSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListRegexMatchSetsResponse {
        return try await self.client.execute(operation: "ListRegexMatchSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listSizeConstraintSets(_ input: ListSizeConstraintSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListSizeConstraintSetsResponse {
        return try await self.client.execute(operation: "ListSizeConstraintSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.
    /// 		       Returns an array of SqlInjectionMatchSet objects.
    public func listSqlInjectionMatchSets(_ input: ListSqlInjectionMatchSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListSqlInjectionMatchSetsResponse {
        return try await self.client.execute(operation: "ListSqlInjectionMatchSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    ///  This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide.  For the latest version of AWS WAF, use the AWS WAFV2 API and see the AWS WAF Developer Guide. With the latest version, AWS WAF has a single set of endpoints for regional and global use.   Returns an array of RuleGroup objects that you are subscribed to.
    public func listSubscribedRuleGroups(_ input: ListSubscribedRuleGroupsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListSubscribedRuleGroupsResponse {
        return try await self.client.execute(operation: "ListSubscribedRuleGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func listXssMatchSets(_ input: ListXssMatchSetsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListXssMatchSetsResponse {
        return try await self.client.execute(operation: "ListXssMatchSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func updateByteMatchSet(_ input: UpdateByteMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateByteMatchSetResponse {
        return try await self.client.execute(operation: "UpdateByteMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func updateGeoMatchSet(_ input: UpdateGeoMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateGeoMatchSetResponse {
        return try await self.client.execute(operation: "UpdateGeoMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    ///
    /// 			    A ByteMatchSet with FieldToMatch of URI    A PositionalConstraint of STARTS_WITH    A TargetString of login    Further, you specify a RateLimit of 1,000. By adding this RateBasedRule to a WebACL, you could limit requests to your login page without affecting the rest of your site.
    public func updateRateBasedRule(_ input: UpdateRateBasedRuleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateRateBasedRuleResponse {
        return try await self.client.execute(operation: "UpdateRateBasedRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func updateRegexMatchSet(_ input: UpdateRegexMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateRegexMatchSetResponse {
        return try await self.client.execute(operation: "UpdateRegexMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateRule(_ input: UpdateRuleRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateRuleResponse {
        return try await self.client.execute(operation: "UpdateRule", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func updateSizeConstraintSet(_ input: UpdateSizeConstraintSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateSizeConstraintSetResponse {
        return try await self.client.execute(operation: "UpdateSizeConstraintSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func updateSqlInjectionMatchSet(_ input: UpdateSqlInjectionMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateSqlInjectionMatchSetResponse {
        return try await self.client.execute(operation: "UpdateSqlInjectionMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 		       For more information about how to use the AWS WAF API to allow or block HTTP requests, see the
    /// 			AWS WAF Developer Guide.
    public func updateXssMatchSet(_ input: UpdateXssMatchSetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateXssMatchSetResponse {
        return try await self.client.execute(operation: "UpdateXssMatchSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
