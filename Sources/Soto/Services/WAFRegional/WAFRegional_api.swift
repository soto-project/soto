...
public struct WAFRegional: AWSService {
    ...
    public func associateWebACL(_ input: AssociateWebACLRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateWebACLResponse {
        return try await self.client.execute(operation: "AssociateWebACL", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func disassociateWebACL(_ input: DisassociateWebACLRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DisassociateWebACLResponse {
        return try await self.client.execute(operation: "DisassociateWebACL", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getWebACLForResource(_ input: GetWebACLForResourceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetWebACLForResourceResponse {
        return try await self.client.execute(operation: "GetWebACLForResource", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listResourcesForWebACL(_ input: ListResourcesForWebACLRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListResourcesForWebACLResponse {
        return try await self.client.execute(operation: "ListResourcesForWebACL", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
