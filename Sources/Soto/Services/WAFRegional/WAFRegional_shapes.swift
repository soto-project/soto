...
extension WAFRegionalErrorType: AWSServiceErrorType {
    public static let errorCodeMap: [String: AWSErrorShape.Type] = [
        "WAFEntityMigrationException": WAFRegional.WAFEntityMigrationException.self,
        "WAFInvalidParameterException": WAFRegional.WAFInvalidParameterException.self
    ]
}
