...
public struct ApplicationAutoScaling: AWSService {
    ...
    public func deleteScalingPolicy(_ input: DeleteScalingPolicyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteScalingPolicyResponse> {
        return self.client.execute(operation: "DeleteScalingPolicy", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteScheduledAction(_ input: DeleteScheduledActionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteScheduledActionResponse> {
    ...
    public func deregisterScalableTarget(_ input: DeregisterScalableTargetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterScalableTargetResponse> {
        return self.client.execute(operation: "DeregisterScalableTarget", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeScalableTargets(_ input: DescribeScalableTargetsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScalableTargetsResponse> {
        return self.client.execute(operation: "DescribeScalableTargets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeScalingActivities(_ input: DescribeScalingActivitiesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScalingActivitiesResponse> {
    ...
    public func describeScalingPolicies(_ input: DescribeScalingPoliciesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScalingPoliciesResponse> {
        return self.client.execute(operation: "DescribeScalingPolicies", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeScheduledActions(_ input: DescribeScheduledActionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScheduledActionsResponse> {
    ...
    public func putScalingPolicy(_ input: PutScalingPolicyRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutScalingPolicyResponse> {
    ...
    public func putScheduledAction(_ input: PutScheduledActionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutScheduledActionResponse> {
        return self.client.execute(operation: "PutScheduledAction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func registerScalableTarget(_ input: RegisterScalableTargetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterScalableTargetResponse> {
        return self.client.execute(operation: "RegisterScalableTarget", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
