...
public struct LexModelsV2: AWSService {
    ...
    public func batchCreateCustomVocabularyItem(_ input: BatchCreateCustomVocabularyItemRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchCreateCustomVocabularyItemResponse {
        return try await self.client.execute(operation: "BatchCreateCustomVocabularyItem", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/batchcreate", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func batchDeleteCustomVocabularyItem(_ input: BatchDeleteCustomVocabularyItemRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchDeleteCustomVocabularyItemResponse {
        return try await self.client.execute(operation: "BatchDeleteCustomVocabularyItem", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/batchdelete", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func batchUpdateCustomVocabularyItem(_ input: BatchUpdateCustomVocabularyItemRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchUpdateCustomVocabularyItemResponse {
        return try await self.client.execute(operation: "BatchUpdateCustomVocabularyItem", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/batchupdate", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func buildBotLocale(_ input: BuildBotLocaleRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> BuildBotLocaleResponse {
        return try await self.client.execute(operation: "BuildBotLocale", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createBot(_ input: CreateBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateBotResponse {
        return try await self.client.execute(operation: "CreateBot", path: "/bots", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createBotAlias(_ input: CreateBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateBotAliasResponse {
        return try await self.client.execute(operation: "CreateBotAlias", path: "/bots/{botId}/botaliases", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createBotLocale(_ input: CreateBotLocaleRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateBotLocaleResponse {
        return try await self.client.execute(operation: "CreateBotLocale", path: "/bots/{botId}/botversions/{botVersion}/botlocales", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateBotVersionResponse {
        return try await self.client.execute(operation: "CreateBotVersion", path: "/bots/{botId}/botversions", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createExport(_ input: CreateExportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateExportResponse {
        return try await self.client.execute(operation: "CreateExport", path: "/exports", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createIntent(_ input: CreateIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateIntentResponse {
        return try await self.client.execute(operation: "CreateIntent", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createResourcePolicy(_ input: CreateResourcePolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateResourcePolicyResponse {
        return try await self.client.execute(operation: "CreateResourcePolicy", path: "/policy/{resourceArn}", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createResourcePolicyStatement(_ input: CreateResourcePolicyStatementRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateResourcePolicyStatementResponse {
        return try await self.client.execute(operation: "CreateResourcePolicyStatement", path: "/policy/{resourceArn}/statements", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSlot(_ input: CreateSlotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSlotResponse {
        return try await self.client.execute(operation: "CreateSlot", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSlotType(_ input: CreateSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSlotTypeResponse {
        return try await self.client.execute(operation: "CreateSlotType", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/slottypes", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createTestSetDiscrepancyReport(_ input: CreateTestSetDiscrepancyReportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateTestSetDiscrepancyReportResponse {
        return try await self.client.execute(operation: "CreateTestSetDiscrepancyReport", path: "/testsets/{testSetId}/testsetdiscrepancy", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createUploadUrl(_ input: CreateUploadUrlRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateUploadUrlResponse {
        return try await self.client.execute(operation: "CreateUploadUrl", path: "/createuploadurl", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBot(_ input: DeleteBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteBotResponse {
        return try await self.client.execute(operation: "DeleteBot", path: "/bots/{botId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBotAlias(_ input: DeleteBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteBotAliasResponse {
        return try await self.client.execute(operation: "DeleteBotAlias", path: "/bots/{botId}/botaliases/{botAliasId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBotLocale(_ input: DeleteBotLocaleRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteBotLocaleResponse {
        return try await self.client.execute(operation: "DeleteBotLocale", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBotVersion(_ input: DeleteBotVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteBotVersionResponse {
        return try await self.client.execute(operation: "DeleteBotVersion", path: "/bots/{botId}/botversions/{botVersion}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteCustomVocabulary(_ input: DeleteCustomVocabularyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteCustomVocabularyResponse {
        return try await self.client.execute(operation: "DeleteCustomVocabulary", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteExport(_ input: DeleteExportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteExportResponse {
        return try await self.client.execute(operation: "DeleteExport", path: "/exports/{exportId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteImport(_ input: DeleteImportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteImportResponse {
        return try await self.client.execute(operation: "DeleteImport", path: "/imports/{importId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteIntent(_ input: DeleteIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteIntent", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteResourcePolicy(_ input: DeleteResourcePolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteResourcePolicyResponse {
        return try await self.client.execute(operation: "DeleteResourcePolicy", path: "/policy/{resourceArn}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteResourcePolicyStatement(_ input: DeleteResourcePolicyStatementRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteResourcePolicyStatementResponse {
        return try await self.client.execute(operation: "DeleteResourcePolicyStatement", path: "/policy/{resourceArn}/statements/{statementId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }

    /// Deletes the specified slot from an intent.
    @Sendable
    public func deleteSlot(_ input: DeleteSlotRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSlot", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots/{slotId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSlotType(_ input: DeleteSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSlotType", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/slottypes/{slotTypeId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }

    /// The action to delete the selected test set.
    @Sendable
    public func deleteTestSet(_ input: DeleteTestSetRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteTestSet", path: "/testsets/{testSetId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteUtterances(_ input: DeleteUtterancesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteUtterancesResponse {
        return try await self.client.execute(operation: "DeleteUtterances", path: "/bots/{botId}/utterances", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeBot(_ input: DescribeBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeBotResponse {
        return try await self.client.execute(operation: "DescribeBot", path: "/bots/{botId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeBotAlias(_ input: DescribeBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeBotAliasResponse {
        return try await self.client.execute(operation: "DescribeBotAlias", path: "/bots/{botId}/botaliases/{botAliasId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeBotLocale(_ input: DescribeBotLocaleRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeBotLocaleResponse {
        return try await self.client.execute(operation: "DescribeBotLocale", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeBotRecommendation(_ input: DescribeBotRecommendationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeBotRecommendationResponse {
        return try await self.client.execute(operation: "DescribeBotRecommendation", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations/{botRecommendationId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeBotVersion(_ input: DescribeBotVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeBotVersionResponse {
        return try await self.client.execute(operation: "DescribeBotVersion", path: "/bots/{botId}/botversions/{botVersion}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeCustomVocabularyMetadata(_ input: DescribeCustomVocabularyMetadataRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeCustomVocabularyMetadataResponse {
        return try await self.client.execute(operation: "DescribeCustomVocabularyMetadata", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/metadata", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeExport(_ input: DescribeExportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeExportResponse {
        return try await self.client.execute(operation: "DescribeExport", path: "/exports/{exportId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeImport(_ input: DescribeImportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeImportResponse {
        return try await self.client.execute(operation: "DescribeImport", path: "/imports/{importId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeIntent(_ input: DescribeIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeIntentResponse {
        return try await self.client.execute(operation: "DescribeIntent", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeResourcePolicy(_ input: DescribeResourcePolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeResourcePolicyResponse {
        return try await self.client.execute(operation: "DescribeResourcePolicy", path: "/policy/{resourceArn}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeSlot(_ input: DescribeSlotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeSlotResponse {
        return try await self.client.execute(operation: "DescribeSlot", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots/{slotId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeSlotType(_ input: DescribeSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeSlotTypeResponse {
        return try await self.client.execute(operation: "DescribeSlotType", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/slottypes/{slotTypeId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeTestExecution(_ input: DescribeTestExecutionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTestExecutionResponse {
        return try await self.client.execute(operation: "DescribeTestExecution", path: "/testexecutions/{testExecutionId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeTestSet(_ input: DescribeTestSetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTestSetResponse {
        return try await self.client.execute(operation: "DescribeTestSet", path: "/testsets/{testSetId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeTestSetDiscrepancyReport(_ input: DescribeTestSetDiscrepancyReportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTestSetDiscrepancyReportResponse {
        return try await self.client.execute(operation: "DescribeTestSetDiscrepancyReport", path: "/testsetdiscrepancy/{testSetDiscrepancyReportId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeTestSetGeneration(_ input: DescribeTestSetGenerationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTestSetGenerationResponse {
        return try await self.client.execute(operation: "DescribeTestSetGeneration", path: "/testsetgenerations/{testSetGenerationId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getTestExecutionArtifactsUrl(_ input: GetTestExecutionArtifactsUrlRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetTestExecutionArtifactsUrlResponse {
        return try await self.client.execute(operation: "GetTestExecutionArtifactsUrl", path: "/testexecutions/{testExecutionId}/artifacturl", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listAggregatedUtterances(_ input: ListAggregatedUtterancesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListAggregatedUtterancesResponse {
        return try await self.client.execute(operation: "ListAggregatedUtterances", path: "/bots/{botId}/aggregatedutterances", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBotAliases(_ input: ListBotAliasesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBotAliasesResponse {
        return try await self.client.execute(operation: "ListBotAliases", path: "/bots/{botId}/botaliases", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBotLocales(_ input: ListBotLocalesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBotLocalesResponse {
        return try await self.client.execute(operation: "ListBotLocales", path: "/bots/{botId}/botversions/{botVersion}/botlocales", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBotRecommendations(_ input: ListBotRecommendationsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBotRecommendationsResponse {
        return try await self.client.execute(operation: "ListBotRecommendations", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBotVersions(_ input: ListBotVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBotVersionsResponse {
        return try await self.client.execute(operation: "ListBotVersions", path: "/bots/{botId}/botversions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }

    /// Gets a list of available bots.
    @Sendable
    public func listBots(_ input: ListBotsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBotsResponse {
        return try await self.client.execute(operation: "ListBots", path: "/bots", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBuiltInIntents(_ input: ListBuiltInIntentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBuiltInIntentsResponse {
        return try await self.client.execute(operation: "ListBuiltInIntents", path: "/builtins/locales/{localeId}/intents", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBuiltInSlotTypes(_ input: ListBuiltInSlotTypesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBuiltInSlotTypesResponse {
        return try await self.client.execute(operation: "ListBuiltInSlotTypes", path: "/builtins/locales/{localeId}/slottypes", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listCustomVocabularyItems(_ input: ListCustomVocabularyItemsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListCustomVocabularyItemsResponse {
        return try await self.client.execute(operation: "ListCustomVocabularyItems", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/customvocabulary/DEFAULT/list", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listExports(_ input: ListExportsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListExportsResponse {
        return try await self.client.execute(operation: "ListExports", path: "/exports", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listImports(_ input: ListImportsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListImportsResponse {
        return try await self.client.execute(operation: "ListImports", path: "/imports", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listIntents(_ input: ListIntentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListIntentsResponse {
        return try await self.client.execute(operation: "ListIntents", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listRecommendedIntents(_ input: ListRecommendedIntentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListRecommendedIntentsResponse {
        return try await self.client.execute(operation: "ListRecommendedIntents", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations/{botRecommendationId}/intents", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSlotTypes(_ input: ListSlotTypesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSlotTypesResponse {
        return try await self.client.execute(operation: "ListSlotTypes", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/slottypes", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSlots(_ input: ListSlotsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSlotsResponse {
        return try await self.client.execute(operation: "ListSlots", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTestExecutionResultItems(_ input: ListTestExecutionResultItemsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTestExecutionResultItemsResponse {
        return try await self.client.execute(operation: "ListTestExecutionResultItems", path: "/testexecutions/{testExecutionId}/results", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTestExecutions(_ input: ListTestExecutionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTestExecutionsResponse {
        return try await self.client.execute(operation: "ListTestExecutions", path: "/testexecutions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTestSetRecords(_ input: ListTestSetRecordsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTestSetRecordsResponse {
        return try await self.client.execute(operation: "ListTestSetRecords", path: "/testsets/{testSetId}/records", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTestSets(_ input: ListTestSetsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTestSetsResponse {
        return try await self.client.execute(operation: "ListTestSets", path: "/testsets", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func searchAssociatedTranscripts(_ input: SearchAssociatedTranscriptsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SearchAssociatedTranscriptsResponse {
        return try await self.client.execute(operation: "SearchAssociatedTranscripts", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations/{botRecommendationId}/associatedtranscripts", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startBotRecommendation(_ input: StartBotRecommendationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartBotRecommendationResponse {
        return try await self.client.execute(operation: "StartBotRecommendation", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startImport(_ input: StartImportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartImportResponse {
        return try await self.client.execute(operation: "StartImport", path: "/imports", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startTestExecution(_ input: StartTestExecutionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartTestExecutionResponse {
        return try await self.client.execute(operation: "StartTestExecution", path: "/testsets/{testSetId}/testexecutions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startTestSetGeneration(_ input: StartTestSetGenerationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartTestSetGenerationResponse {
        return try await self.client.execute(operation: "StartTestSetGeneration", path: "/testsetgenerations", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func stopBotRecommendation(_ input: StopBotRecommendationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StopBotRecommendationResponse {
        return try await self.client.execute(operation: "StopBotRecommendation", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations/{botRecommendationId}/stopbotrecommendation", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateBot(_ input: UpdateBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateBotResponse {
        return try await self.client.execute(operation: "UpdateBot", path: "/bots/{botId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateBotAlias(_ input: UpdateBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateBotAliasResponse {
        return try await self.client.execute(operation: "UpdateBotAlias", path: "/bots/{botId}/botaliases/{botAliasId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateBotLocale(_ input: UpdateBotLocaleRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateBotLocaleResponse {
        return try await self.client.execute(operation: "UpdateBotLocale", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateBotRecommendation(_ input: UpdateBotRecommendationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateBotRecommendationResponse {
        return try await self.client.execute(operation: "UpdateBotRecommendation", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations/{botRecommendationId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateExport(_ input: UpdateExportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateExportResponse {
        return try await self.client.execute(operation: "UpdateExport", path: "/exports/{exportId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateIntent(_ input: UpdateIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateIntentResponse {
        return try await self.client.execute(operation: "UpdateIntent", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateResourcePolicy(_ input: UpdateResourcePolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateResourcePolicyResponse {
        return try await self.client.execute(operation: "UpdateResourcePolicy", path: "/policy/{resourceArn}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateSlot(_ input: UpdateSlotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateSlotResponse {
        return try await self.client.execute(operation: "UpdateSlot", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots/{slotId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateSlotType(_ input: UpdateSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateSlotTypeResponse {
        return try await self.client.execute(operation: "UpdateSlotType", path: "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/slottypes/{slotTypeId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateTestSet(_ input: UpdateTestSetRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateTestSetResponse {
        return try await self.client.execute(operation: "UpdateTestSet", path: "/testsets/{testSetId}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
}
