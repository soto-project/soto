...
extension Proton {
    ...
    public func createServiceInstance(_ input: CreateServiceInstanceInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateServiceInstanceOutput {
        return try await self.client.execute(operation: "CreateServiceInstance", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Create the Proton Ops configuration file.
    public func createServiceSyncConfig(_ input: CreateServiceSyncConfigInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateServiceSyncConfigOutput {
        return try await self.client.execute(operation: "CreateServiceSyncConfig", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteServiceSyncConfig(_ input: DeleteServiceSyncConfigInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteServiceSyncConfigOutput {
        return try await self.client.execute(operation: "DeleteServiceSyncConfig", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getResourcesSummary(_ input: GetResourcesSummaryInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetResourcesSummaryOutput {
        return try await self.client.execute(operation: "GetResourcesSummary", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getServiceInstanceSyncStatus(_ input: GetServiceInstanceSyncStatusInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetServiceInstanceSyncStatusOutput {
        return try await self.client.execute(operation: "GetServiceInstanceSyncStatus", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Get detailed data for the service sync blocker summary.
    public func getServiceSyncBlockerSummary(_ input: GetServiceSyncBlockerSummaryInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetServiceSyncBlockerSummaryOutput {
        return try await self.client.execute(operation: "GetServiceSyncBlockerSummary", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Get detailed information for the service sync configuration.
    public func getServiceSyncConfig(_ input: GetServiceSyncConfigInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetServiceSyncConfigOutput {
        return try await self.client.execute(operation: "GetServiceSyncConfig", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateServiceSyncBlocker(_ input: UpdateServiceSyncBlockerInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateServiceSyncBlockerOutput {
        return try await self.client.execute(operation: "UpdateServiceSyncBlocker", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Update the Proton Ops config file.
    public func updateServiceSyncConfig(_ input: UpdateServiceSyncConfigInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateServiceSyncConfigOutput {
        return try await self.client.execute(operation: "UpdateServiceSyncConfig", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
