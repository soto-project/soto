...
public struct ResourceGroups: AWSService {
    ...
    public func createGroup(_ input: CreateGroupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateGroupOutput {
        return try await self.client.execute(operation: "CreateGroup", path: "/groups", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteGroup(_ input: DeleteGroupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteGroupOutput {
        return try await self.client.execute(operation: "DeleteGroup", path: "/delete-group", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getAccountSettings(logger: Logger = AWSClient.loggingDisabled) async throws -> GetAccountSettingsOutput {
        return try await self.client.execute(operation: "GetAccountSettings", path: "/get-account-settings", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func getGroup(_ input: GetGroupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetGroupOutput {
        return try await self.client.execute(operation: "GetGroup", path: "/get-group", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getGroupConfiguration(_ input: GetGroupConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetGroupConfigurationOutput {
        return try await self.client.execute(operation: "GetGroupConfiguration", path: "/get-group-configuration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getGroupQuery(_ input: GetGroupQueryInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetGroupQueryOutput {
        return try await self.client.execute(operation: "GetGroupQuery", path: "/get-group-query", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getTags(_ input: GetTagsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetTagsOutput {
        return try await self.client.execute(operation: "GetTags", path: "/resources/{Arn}/tags", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func groupResources(_ input: GroupResourcesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GroupResourcesOutput {
        return try await self.client.execute(operation: "GroupResources", path: "/group-resources", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listGroupResources(_ input: ListGroupResourcesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGroupResourcesOutput {
        return try await self.client.execute(operation: "ListGroupResources", path: "/list-group-resources", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listGroups(_ input: ListGroupsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGroupsOutput {
        return try await self.client.execute(operation: "ListGroups", path: "/groups-list", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putGroupConfiguration(_ input: PutGroupConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> PutGroupConfigurationOutput {
        return try await self.client.execute(operation: "PutGroupConfiguration", path: "/put-group-configuration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func searchResources(_ input: SearchResourcesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> SearchResourcesOutput {
        return try await self.client.execute(operation: "SearchResources", path: "/resources/search", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func tag(_ input: TagInput, logger: Logger = AWSClient.loggingDisabled) async throws -> TagOutput {
        return try await self.client.execute(operation: "Tag", path: "/resources/{Arn}/tags", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func ungroupResources(_ input: UngroupResourcesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UngroupResourcesOutput {
        return try await self.client.execute(operation: "UngroupResources", path: "/ungroup-resources", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func untag(_ input: UntagInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UntagOutput {
        return try await self.client.execute(operation: "Untag", path: "/resources/{Arn}/tags", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateAccountSettings(_ input: UpdateAccountSettingsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateAccountSettingsOutput {
        return try await self.client.execute(operation: "UpdateAccountSettings", path: "/update-account-settings", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateGroup(_ input: UpdateGroupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateGroupOutput {
        return try await self.client.execute(operation: "UpdateGroup", path: "/update-group", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateGroupQuery(_ input: UpdateGroupQueryInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateGroupQueryOutput {
        return try await self.client.execute(operation: "UpdateGroupQuery", path: "/update-group-query", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
