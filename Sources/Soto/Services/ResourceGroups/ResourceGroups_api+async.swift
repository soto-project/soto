...
extension ResourceGroups {
    ...
    public func getAccountSettings(logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetAccountSettingsOutput {
        return try await self.client.execute(operation: "GetAccountSettings", path: "/get-account-settings", httpMethod: .POST, serviceConfig: self.config, logger: logger, on: eventLoop)
    }
    ...
    public func updateAccountSettings(_ input: UpdateAccountSettingsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateAccountSettingsOutput {
        return try await self.client.execute(operation: "UpdateAccountSettings", path: "/update-account-settings", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
