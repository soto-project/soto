...
extension GameSparks {
    ...
    public enum DeploymentAction: String, CustomStringConvertible, Codable {
        case deploy = "DEPLOY"
    ...
    public enum GameState: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
        case deleting = "DELETING"
        public var description: String { return self.rawValue }
    }

    public enum GeneratedCodeJobState: String, CustomStringConvertible, Codable {
        case completed = "COMPLETED"
        case failed = "FAILED"
        case inProgress = "IN_PROGRESS"
        case pending = "PENDING"
    ...
    public enum ResultCode: String, CustomStringConvertible, Codable {
    ...
    public enum StageState: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
        case deleting = "DELETING"
        public var description: String { return self.rawValue }
    }
    ...
    public struct CreateSnapshotRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "gameName", location: .uri(locationName: "GameName"))
        ]
    ...
    public struct DisconnectPlayerRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "gameName", location: .uri(locationName: "GameName")),
            AWSMemberEncoding(label: "playerId", location: .uri(locationName: "PlayerId")),
            AWSMemberEncoding(label: "stageName", location: .uri(locationName: "StageName"))
        ]
    ...
    public struct GetExtensionVersionRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "extensionVersion", location: .uri(locationName: "ExtensionVersion")),
            AWSMemberEncoding(label: "name", location: .uri(locationName: "Name")),
            AWSMemberEncoding(label: "namespace", location: .uri(locationName: "Namespace"))
        ]
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.extensionVersion, name: "extensionVersion", parent: name, min: 0)
            try self.validate(self.name, name: "name", parent: name, max: 36)
            try self.validate(self.name, name: "name", parent: name, min: 1)
            try self.validate(self.name, name: "name", parent: name, pattern: "^[a-zA-Z0-9_-]+$")
            try self.validate(self.namespace, name: "namespace", parent: name, max: 36)
    ...
    public struct GetGameConfigurationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "gameName", location: .uri(locationName: "GameName")),
            AWSMemberEncoding(label: "sections", location: .querystring(locationName: "Sections"))
        ]
    ...
    public struct Section: AWSDecodableShape {
        ...
        public init(name: String? = nil, size: Int? = nil) {
            self.name = name
            self.size = size
        }
    ...
    public struct SectionModification: AWSEncodableShape {
        ...
        public init(operation: Operation, path: String, section: String) {
