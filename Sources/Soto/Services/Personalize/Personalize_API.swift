...
public struct Personalize: AWSService {
    ...
    @discardableResult public func stopSolutionVersionCreation(_ input: StopSolutionVersionCreationRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "StopSolutionVersionCreation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
