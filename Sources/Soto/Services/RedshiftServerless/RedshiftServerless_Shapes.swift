...
extension RedshiftServerless {
    ...
    public enum LogExport: String, CustomStringConvertible, Codable {
        case connectionlog
    ...
    public enum UsageLimitUsageType: String, CustomStringConvertible, Codable {
        case crossRegionDatasharing = "cross-region-datasharing"
        case serverlessCompute = "serverless-compute"
        public var description: String { return self.rawValue }
    }

    public enum WorkgroupStatus: String, CustomStringConvertible, Codable {
        case available = "AVAILABLE"
        case creating = "CREATING"
        case deleting = "DELETING"
        case modifying = "MODIFYING"
    ...
    public struct CreateNamespaceRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.logExports, name: "logExports", parent: name, min: 0)
    ...
    public struct EndpointAccess: AWSDecodableShape {
        ...
        public var endpointCreateTime: Date?
    ...
    public struct RecoveryPoint: AWSDecodableShape {
        ...
        @OptionalCustomCoding<ISO8601DateCoder>
        public var recoveryPointCreateTime: Date?
        /// The unique identifier of the recovery point.
        public let recoveryPointId: String?
    ...
    public struct Snapshot: AWSDecodableShape {
        ...
        @OptionalCustomCoding<ISO8601DateCoder>
        public var snapshotCreateTime: Date?
        /// The name of the snapshot.
        public let snapshotName: String?
        ...
        @OptionalCustomCoding<ISO8601DateCoder>
        public var snapshotRetentionStartTime: Date?
