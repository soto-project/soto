...
extension GameLift {
    ...
    public struct CreateScriptInput: AWSEncodableShape {
        ...
        public init(name: String? = nil, storageLocation: S3Location? = nil, tags: [Tag]? = nil, version: String? = nil, zipFile: AWSBlob? = nil) {
            self.name = name
            self.storageLocation = storageLocation
            self.tags = tags
            self.version = version
    ...
    public struct UpdateScriptInput: AWSEncodableShape {
        ...
        public init(name: String? = nil, scriptId: String, storageLocation: S3Location? = nil, version: String? = nil, zipFile: AWSBlob? = nil) {
            self.name = name
            self.scriptId = scriptId
            self.storageLocation = storageLocation
            self.version = version
