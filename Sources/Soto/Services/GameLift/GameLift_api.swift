...
public struct GameLift: AWSService {
    ...
    ///
    /// Parameters:
    ///   - computeName: A unique identifier for the compute resource that you want to connect to. For an EC2 fleet compute, use the instance ID.  Use https://docs.aws.amazon.com/gamelift/latest/apireference/API_ListCompute.html to retrieve compute identifiers.
