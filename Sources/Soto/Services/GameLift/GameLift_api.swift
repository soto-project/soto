...
public struct GameLift: AWSService {
    ...
    ///   - gameServerContainerGroupsPerInstance: The number of times to replicate the game server container group on each fleet instance.  By default, Amazon GameLift Servers calculates the maximum number of game server container groups that can fit on each instance. This calculation is based on the CPU and memory resources of the fleet's instance type). To use the calculated maximum, don't set this parameter. If you set this number manually, Amazon GameLift Servers uses your value as long as it's less than the calculated maximum.
    ...
    public func createContainerFleet(
        ...
        playerGatewayMode: PlayerGatewayMode? = nil,
        tags: [Tag]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///
    /// Parameters:
    ///   - containerGroupType: The type of container group being defined. Container group type determines how Amazon GameLift Servers  deploys the container group on each fleet instance. Default value: GAME_SERVER
    ...
    ///   - logPaths:  This parameter is no longer used. To specify where Amazon GameLift Servers should store log files once a server process shuts down, use the Amazon GameLift Servers server API ProcessReady() and specify one or more directory paths in logParameters. For more information, see Initialize the server process in the Amazon GameLift Servers Developer Guide.
    ...
    ///   - peerVpcAwsAccountId: Used when peering your Amazon GameLift Servers fleet with a VPC, the unique identifier for the Amazon Web Services account that owns the VPC. You can find your account ID in the Amazon Web Services Management Console under account settings.
    ...
    ///   - playerGatewayConfiguration: Configuration settings for player gateway. Use this to specify advanced options for how player gateway handles connections.
    ...
    ///   - scriptId: The unique identifier for a Realtime configuration script to be deployed to a fleet with compute type EC2. You can use either the script ID or ARN. Scripts must be uploaded to Amazon GameLift Servers prior to creating the fleet. This fleet property can't be changed after the fleet is created.
    ...
    public func createFleet(
        ...
        playerGatewayConfiguration: PlayerGatewayConfiguration? = nil,
        playerGatewayMode: PlayerGatewayMode? = nil,
    ...
    ///   - locations: A list of locations to deploy additional instances to and manage as part of the fleet. You can add any Amazon GameLift Servers-supported Amazon Web Services Region as a remote location, in the form of an Amazon Web Services Region code such as us-west-2.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - gameServerGroupName: An identifier for the new game server group. This value is used to generate unique ARN identifiers for the Amazon EC2 Auto Scaling group and the Amazon GameLift Servers FleetIQ game server group. The name must be unique per Region per Amazon Web Services account.
    ...
    ///   - maxSize: The maximum number of instances allowed in the Amazon EC2 Auto Scaling group. During automatic scaling events, Amazon GameLift Servers FleetIQ and EC2 do not scale up the group above this maximum. After the Auto Scaling group is created, update this value directly in the Auto Scaling group using the Amazon Web Services console or APIs.
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to add a player to. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to add players to. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ///   - playerDataMap: Map of string pairs, each specifying a player ID and a set of developer-defined information related to the player. Amazon GameLift Servers does not use this data, so it can be formatted as needed for use in the game. Any player data strings for player IDs that are not included in the PlayerIds parameter are ignored.
    ...
    ///   - nodeJsVersion: The Node.js version used for execution of your Realtime script. The valid values are 10.x | 24.x. By default, NodeJsVersion is 10.x. This value cannot be updated later.   Node.js 10 will reach end of support on September 30, 2026. See more details  in the Node.js 10 FAQs. For migration guidance,  see  Migrating from Node.js 10 to 24.
    ...
    ///
    /// Parameters:
    ///   - gameLiftAwsAccountId: A unique identifier for the Amazon Web Services account that you use to manage your Amazon GameLift Servers fleet.  You can find your Account ID in the Amazon Web Services Management Console under account settings.
    ///   - peerVpcId: A unique identifier for a VPC with resources to be accessed by your Amazon GameLift Servers fleet. The VPC must be in the same Region as your fleet. To look up a VPC ID, use the  VPC Dashboard in the Amazon Web Services Management Console.  Learn more about VPC peering in VPC Peering with Amazon GameLift Servers Fleets.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - fleetId: A unique identifier for the fleet. You can use either the fleet ID or ARN value. This tells Amazon GameLift Servers which GameLift VPC to peer with.
    ///   - peerVpcAwsAccountId: A unique identifier for the Amazon Web Services account with the VPC that you want to peer your Amazon GameLift Servers fleet with. You can find your Account ID in the Amazon Web Services Management Console under account settings.
    ///   - peerVpcId: A unique identifier for a VPC with resources to be accessed by your Amazon GameLift Servers fleet. The VPC must be in the same Region as your fleet. To look up a VPC ID, use the  VPC Dashboard in the Amazon Web Services Management Console.  Learn more about VPC peering in VPC Peering with Amazon GameLift Servers Fleets.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func describeContainerGroupPortMappings(_ input: DescribeContainerGroupPortMappingsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeContainerGroupPortMappingsOutput {
        try await self.client.execute(
            operation: "DescribeContainerGroupPortMappings", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///   - instanceId: A unique identifier for the fleet instance to retrieve port mappings for. When ContainerGroupType is PER_INSTANCE, this parameter is required. When ContainerGroupType is GAME_SERVER, this parameter is optional. If you provide an instance ID, it must match the instance that's running the specified compute. If the instance ID doesn't match, the request fails with an InvalidRequestException.
    ///   - logger: Logger use during operation
    @inlinable
    public func describeContainerGroupPortMappings(
        computeName: String? = nil,
        containerGroupType: ContainerGroupType? = nil,
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeContainerGroupPortMappingsOutput {
        let input = DescribeContainerGroupPortMappingsInput(
            computeName: computeName, 
            containerGroupType: containerGroupType, 
        ...
        return try await self.describeContainerGroupPortMappings(input, logger: logger)
    }
    ...
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to retrieve. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ///   - limit: The maximum number of results to return. Use this parameter with NextToken to get results as a set of sequential pages.
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to retrieve player sessions for. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to get logs for. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func getPlayerConnectionDetails(_ input: GetPlayerConnectionDetailsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetPlayerConnectionDetailsOutput {
        try await self.client.execute(
            operation: "GetPlayerConnectionDetails", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: An identifier for the game session that is unique across all regions for which to retrieve player connection details. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ///   - playerIds: List of unique identifiers for players. Connection details are returned for each player in this list.
    ///   - logger: Logger use during operation
    @inlinable
    public func getPlayerConnectionDetails(
        gameSessionId: String? = nil,
        playerIds: [String]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetPlayerConnectionDetailsOutput {
        let input = GetPlayerConnectionDetailsInput(
            gameSessionId: gameSessionId, 
            playerIds: playerIds
        )
        return try await self.getPlayerConnectionDetails(input, logger: logger)
    }
    ...
    ///  This API works with the following fleet types: EC2 Retrieves build resources for all builds associated with the Amazon Web Services account in use. You can limit results to builds that are in a specific status by using the Status parameter. Use the pagination parameters to retrieve results in
    ///   Build resources are not listed in any particular order.   Learn more   Upload a Custom Server Build   All APIs by task
    @Sendable
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - filters: Filters the list for AWS or CUSTOM locations. Use this parameter to narrow down results to only Amazon Web Services-managed locations (Amazon EC2 or container) or only your custom locations (such as an Amazon GameLift Servers Anywhere fleet).
    ///   - limit: The maximum number of results to return. Use this parameter with NextToken to get results as a set of sequential pages.
    ///   - nextToken: A token that indicates the start of the next sequential page of results. Use the token that is returned with a previous call to this operation. To start at the beginning of the result set, do not specify a value.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - gameProperties: A set of key-value pairs that can store custom data in a game session. For example: {"Key": "difficulty", "Value": "novice"}.    Avoid using periods (".") in property keys if you plan to search for game sessions by properties. Property keys containing periods cannot be searched and will be filtered out from search results due to search index limitations.   If you use SearchGameSessions API, there is a limit of 500 game property keys across all game sessions and all fleets per region. If the limit is exceeded, there will potentially be game session entries missing from SearchGameSessions API results.
    ///   - gameSessionData: A set of custom game session properties, formatted as a single string value. This data is passed to a game server process with a request to start a new game session. For more information, see Start a game session.
    ...
    ///   - ticketId: A unique identifier for a matchmaking ticket. If no ticket ID is specified here, Amazon GameLift Servers will generate one in the form of a UUID. Use this identifier to track the match backfill ticket status and retrieve match results.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - ticketId: A unique identifier for a matchmaking ticket. If no ticket ID is specified here, Amazon GameLift Servers will generate one in the form of a UUID. Use this identifier to track the matchmaking ticket status and retrieve match results.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - tags: A list of one or more tags to assign to the specified Amazon GameLift Servers resource. Tags are developer-defined and structured as key-value pairs. The maximum tag limit may be lower than stated. See  Tagging Amazon Web Services Resources for tagging limits.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to be terminated. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ...
    ///   - tagKeys: A list of one or more tag keys to remove from the specified Amazon GameLift Servers resource.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - gameServerContainerGroupsPerInstance: The number of times to replicate the game server container group on each fleet instance. By default, Amazon GameLift Servers calculates the maximum number of game server container groups that can fit on each instance. You can remove this property value to use the calculated value, or set it manually. If you set this number manually, Amazon GameLift Servers uses your value as long as it's less than the calculated maximum.
    ///   - gameSessionCreationLimitPolicy: A policy that limits the number of game sessions that each individual player can create on instances in this fleet. The limit applies for a specified span of time.
    ...
    ///   - instanceInboundPermissionAuthorizations: A set of ports to add to the container fleet's inbound permissions. The port range must not overlap with the Amazon GameLift Servers reserved port range 4092-4191. This range is reserved for internal Amazon GameLift Servers services.
    ...
    ///   - minSize: The minimum number of instances that are allowed in the specified fleet location. If this parameter is not set, the default is 0. This parameter cannot be set when using a ManagedCapacityConfiguration where ZeroCapacityStrategy has a value of SCALE_TO_AND_FROM_ZERO.
    ///   - logger: Logger use during operation
    @inlinable
    public func updateFleetCapacity(
        ...
        fleetId: String? = nil,
        location: String? = nil,
        managedCapacityConfiguration: ManagedCapacityConfiguration? = nil,
        maxSize: Int? = nil,
        minSize: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///   - gameSessionId: An identifier for the game session that is unique across all regions to update. The value is always a full ARN in the following format: For Home Region game session - arn:aws:gamelift:::gamesession//. For Remote Location game session - arn:aws:gamelift:::gamesession///.
    ///   - maximumPlayerSessionCount: The maximum number of players that can be connected simultaneously to the game session.
    ///   - name: A descriptive label that is associated with a game session. Session names do not need to be unique.
    ...
    ///   - timeoutInSeconds: The maximum time, in seconds, that a new game session placement request remains in the queue. When a request exceeds this time, the game session placement changes to a TIMED_OUT status.  The minimum value is 10 and the maximum value is 600.
    ///   - logger: Logger use during operation
    @inlinable
