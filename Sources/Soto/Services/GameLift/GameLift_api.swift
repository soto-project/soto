...
public struct GameLift: AWSService {
    ...
    ///   - nodeJsVersion: The Node.js version used for execution of your Realtime script. The valid values are 10.x | 24.x. By default, NodeJsVersion is 10.x. This value cannot be updated later.
    ...
    ///
    /// Parameters:
    ///   - gameSessionId: A unique identifier for the game session for which to retrieve player connection details.
