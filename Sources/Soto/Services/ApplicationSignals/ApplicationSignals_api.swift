...
public struct ApplicationSignals: AWSService {
    ...
    @Sendable
    @inlinable
    public func listEntityEvents(_ input: ListEntityEventsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListEntityEventsOutput {
        try await self.client.execute(
            operation: "ListEntityEvents", 
            path: "/events", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - endTime: The end of the time period to retrieve change events for. When used in a raw HTTP Query API, it is formatted as epoch time in seconds. For example: 1698778057
    ///   - entity: The entity for which to retrieve change events. This specifies the service, resource, or other entity whose event history you want to examine. This is a string-to-string map. It can include the following fields.    Type designates the type of object this is.    ResourceType specifies the type of the resource. This field is used only when the value of the Type field is Resource or AWS::Resource.    Name specifies the name of the object. This is used only if the value of the Type field is Service, RemoteService, or AWS::Service.    Identifier identifies the resource objects of this resource. This is used only if the value of the Type field is Resource or AWS::Resource.    Environment specifies the location where this object is hosted, or what it belongs to.    AwsAccountId specifies the account where this object is in.   Below is an example of a service.  { "Type": "Service", "Name": "visits-service", "Environment": "petclinic-test" }  Below is an example of a resource.  { "Type": "AWS::Resource", "ResourceType": "AWS::DynamoDB::Table", "Identifier": "Customers" }
    ///   - maxResults: The maximum number of change events to return in one operation. If you omit this parameter, the default of 50 is used.
    ///   - nextToken: Include this value, if it was returned by the previous operation, to get the next set of change events.
    ///   - startTime: The start of the time period to retrieve change events for. When used in a raw HTTP Query API, it is formatted as epoch time in seconds. For example: 1698778057
    ///   - logger: Logger use during operation
    @inlinable
    public func listEntityEvents(
        endTime: Date,
        ...
        startTime: Date,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListEntityEventsOutput {
        let input = ListEntityEventsInput(
            endTime: endTime, 
            entity: entity, 
            maxResults: maxResults, 
            nextToken: nextToken, 
        ...
        return try await self.listEntityEvents(input, logger: logger)
    }
...
extension ApplicationSignals {
    ...
    @inlinable
    public func listEntityEventsPaginator(
        _ input: ListEntityEventsInput,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<ListEntityEventsInput, ListEntityEventsOutput> {
        return .init(
            input: input,
            command: self.listEntityEvents,
            inputKey: \ListEntityEventsInput.nextToken,
            outputKey: \ListEntityEventsOutput.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``listEntityEvents(_:logger:)``.
