...
extension SnowDeviceManagement {
    ...
    public enum ExecutionState: String, CustomStringConvertible, Codable {
    ...
    public enum IpAddressAssignment: String, CustomStringConvertible, Codable {
        case dhcp = "DHCP"
        case `static` = "STATIC"
        public var description: String { return self.rawValue }
    }

    public enum PhysicalConnectorType: String, CustomStringConvertible, Codable {
        case qsfp = "QSFP"
        case rj45 = "RJ45"
        case rj452 = "RJ45_2"
    ...
    public enum TaskState: String, CustomStringConvertible, Codable {
        case canceled = "CANCELED"
    ...
    public enum UnlockState: String, CustomStringConvertible, Codable {
        case locked = "LOCKED"
    ...
    public struct Command: AWSEncodableShape {
        /// Reboots the device.
        public let reboot: Reboot?
        /// Unlocks the device.
        public let unlock: Unlock?

        public init(reboot: Reboot? = nil, unlock: Unlock? = nil) {
            self.reboot = reboot
            self.unlock = unlock
        }
    ...
    public struct ListDeviceResourcesInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.type, name: "type", parent: name, max: 50)
