...
extension BillingConductor {
    ...
    public enum AssociateResourceErrorReason: String, CustomStringConvertible, Codable {
    ...
    public enum BillingGroupStatus: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
    ...
    public enum CustomLineItemRelationship: String, CustomStringConvertible, Codable {
        case child = "CHILD"
        case parent = "PARENT"
        public var description: String { return self.rawValue }
    }

    public enum CustomLineItemType: String, CustomStringConvertible, Codable {
        case credit = "CREDIT"
        case fee = "FEE"
        public var description: String { return self.rawValue }
    }

    public enum PricingRuleScope: String, CustomStringConvertible, Codable {
        case global = "GLOBAL"
        case service = "SERVICE"
        public var description: String { return self.rawValue }
    }

    public enum PricingRuleType: String, CustomStringConvertible, Codable {
    ...
    public struct CreatePricingPlanInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.pricingRuleArns, name: "pricingRuleArns", parent: name, max: 30)
            try self.validate(self.pricingRuleArns, name: "pricingRuleArns", parent: name, min: 0)
            try self.tags?.forEach {
                try validate($0.key, name: "tags.key", parent: name, max: 128)
                try validate($0.key, name: "tags.key", parent: name, min: 1)
                try validate($0.value, name: "tags[\"\($0.key)\"]", parent: name, max: 256)
    ...
    public struct CreatePricingRuleInput: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.description, name: "description", parent: name, max: 1024)
            try self.validate(self.description, name: "description", parent: name, min: 0)
            try self.validate(self.modifierPercentage, name: "modifierPercentage", parent: name, min: 0)
            try self.validate(self.name, name: "name", parent: name, max: 128)
            try self.validate(self.name, name: "name", parent: name, min: 1)
            try self.validate(self.name, name: "name", parent: name, pattern: "[a-zA-Z0-9_\\+=\\.\\-@]+")
    ...
    public struct CustomLineItemFlatChargeDetails: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.chargeValue, name: "chargeValue", parent: name, max: 1_000_000)
            try self.validate(self.chargeValue, name: "chargeValue", parent: name, min: 0)
        }
    ...
    public struct CustomLineItemPercentageChargeDetails: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.associatedValues, name: "associatedValues", parent: name, min: 0)
            try self.validate(self.percentageValue, name: "percentageValue", parent: name, max: 10000)
            try self.validate(self.percentageValue, name: "percentageValue", parent: name, min: 0)
        }
