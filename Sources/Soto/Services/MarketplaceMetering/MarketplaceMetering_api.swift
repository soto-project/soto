...
public struct MarketplaceMetering: AWSService {
    ...
    public func meterUsage(
        clientToken: String? = MeterUsageRequest.idempotencyToken(),
        dryRun: Bool? = nil,
        productCode: String,
        timestamp: Date,
