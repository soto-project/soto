...
public struct MarketplaceMetering: AWSService {
    ...
    public func batchMeterUsage(_ input: BatchMeterUsageRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchMeterUsageResult> {
        return self.client.execute(operation: "BatchMeterUsage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func meterUsage(_ input: MeterUsageRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<MeterUsageResult> {
        return self.client.execute(operation: "MeterUsage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func registerUsage(_ input: RegisterUsageRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterUsageResult> {
        return self.client.execute(operation: "RegisterUsage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// ResolveCustomer is called by a SaaS application during the registration process. When a buyer visits your website during the registration process, the buyer submits a registration token through their browser. The registration token is resolved through this API to obtain a CustomerIdentifier and product code.
    public func resolveCustomer(_ input: ResolveCustomerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResolveCustomerResult> {
        return self.client.execute(operation: "ResolveCustomer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
