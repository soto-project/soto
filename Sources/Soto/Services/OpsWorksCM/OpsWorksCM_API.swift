...
public struct OpsWorksCM: AWSService {
    ...
    public func associateNode(_ input: AssociateNodeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateNodeResponse> {
        return self.client.execute(operation: "AssociateNode", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createBackup(_ input: CreateBackupRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBackupResponse> {
    ...
    public func createServer(_ input: CreateServerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateServerResponse> {
        return self.client.execute(operation: "CreateServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteBackup(_ input: DeleteBackupRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteBackupResponse> {
    ...
    public func deleteServer(_ input: DeleteServerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteServerResponse> {
        return self.client.execute(operation: "DeleteServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    ///  Describes your OpsWorks-CM account attributes.   This operation is synchronous.
    public func describeAccountAttributes(_ input: DescribeAccountAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAccountAttributesResponse> {
    ...
    public func describeBackups(_ input: DescribeBackupsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBackupsResponse> {
        return self.client.execute(operation: "DescribeBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeNodeAssociationStatus(_ input: DescribeNodeAssociationStatusRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeNodeAssociationStatusResponse> {
        return self.client.execute(operation: "DescribeNodeAssociationStatus", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeServers(_ input: DescribeServersRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeServersResponse> {
        return self.client.execute(operation: "DescribeServers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func disassociateNode(_ input: DisassociateNodeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateNodeResponse> {
        return self.client.execute(operation: "DisassociateNode", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func exportServerEngineAttribute(_ input: ExportServerEngineAttributeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportServerEngineAttributeResponse> {
        return self.client.execute(operation: "ExportServerEngineAttribute", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func restoreServer(_ input: RestoreServerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreServerResponse> {
        return self.client.execute(operation: "RestoreServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startMaintenance(_ input: StartMaintenanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartMaintenanceResponse> {
        return self.client.execute(operation: "StartMaintenance", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateServer(_ input: UpdateServerRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServerResponse> {
        return self.client.execute(operation: "UpdateServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateServerEngineAttributes(_ input: UpdateServerEngineAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServerEngineAttributesResponse> {
        return self.client.execute(operation: "UpdateServerEngineAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
