...
public struct OpsWorksCM: AWSService {
    ...
    public func associateNode(_ input: AssociateNodeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AssociateNodeResponse> {
        return self.client.execute(operation: "AssociateNode", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeBackups(_ input: DescribeBackupsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeBackupsResponse> {
        return self.client.execute(operation: "DescribeBackups", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeNodeAssociationStatus(_ input: DescribeNodeAssociationStatusRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeNodeAssociationStatusResponse> {
        return self.client.execute(operation: "DescribeNodeAssociationStatus", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeServers(_ input: DescribeServersRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeServersResponse> {
        return self.client.execute(operation: "DescribeServers", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func disassociateNode(_ input: DisassociateNodeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DisassociateNodeResponse> {
        return self.client.execute(operation: "DisassociateNode", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func exportServerEngineAttribute(_ input: ExportServerEngineAttributeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ExportServerEngineAttributeResponse> {
        return self.client.execute(operation: "ExportServerEngineAttribute", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func restoreServer(_ input: RestoreServerRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreServerResponse> {
        return self.client.execute(operation: "RestoreServer", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func startMaintenance(_ input: StartMaintenanceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StartMaintenanceResponse> {
        return self.client.execute(operation: "StartMaintenance", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateServerEngineAttributes(_ input: UpdateServerEngineAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateServerEngineAttributesResponse> {
        return self.client.execute(operation: "UpdateServerEngineAttributes", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
}
