...
/*
 Client object for interacting with AWS OpsWorksCM service.
...
public struct OpsWorksCM: AWSService {
    ...
    public func associateNode(_ input: AssociateNodeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AssociateNodeResponse> {
        return self.client.execute(operation: "AssociateNode", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createBackup(_ input: CreateBackupRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateBackupResponse> {
    ...
    public func createServer(_ input: CreateServerRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateServerResponse> {
        return self.client.execute(operation: "CreateServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteServer(_ input: DeleteServerRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteServerResponse> {
        return self.client.execute(operation: "DeleteServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }

    ///   Describes your OpsWorks-CM account attributes.   This operation is synchronous.
    public func describeAccountAttributes(_ input: DescribeAccountAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeAccountAttributesResponse> {
    ...
    public func describeNodeAssociationStatus(_ input: DescribeNodeAssociationStatusRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeNodeAssociationStatusResponse> {
        return self.client.execute(operation: "DescribeNodeAssociationStatus", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeServers(_ input: DescribeServersRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeServersResponse> {
        return self.client.execute(operation: "DescribeServers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func disassociateNode(_ input: DisassociateNodeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DisassociateNodeResponse> {
        return self.client.execute(operation: "DisassociateNode", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func exportServerEngineAttribute(_ input: ExportServerEngineAttributeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ExportServerEngineAttributeResponse> {
        return self.client.execute(operation: "ExportServerEngineAttribute", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func restoreServer(_ input: RestoreServerRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreServerResponse> {
        return self.client.execute(operation: "RestoreServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func startMaintenance(_ input: StartMaintenanceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StartMaintenanceResponse> {
        return self.client.execute(operation: "StartMaintenance", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateServer(_ input: UpdateServerRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateServerResponse> {
        return self.client.execute(operation: "UpdateServer", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateServerEngineAttributes(_ input: UpdateServerEngineAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateServerEngineAttributesResponse> {
        return self.client.execute(operation: "UpdateServerEngineAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
}
