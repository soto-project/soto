...
public struct SecretsManager: AWSService {
    ...
    ///   - type: The exact string that identifies the partner that holds the external secret. For more information, see Using Secrets Manager managed external secrets.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    public func rotateSecret(
        ...
        externalSecretRotationMetadata: [ExternalSecretRotationMetadataItem]? = nil,
        externalSecretRotationRoleArn: String? = nil,
    ...
    ///
    /// Parameters:
    ///   - secretId: The name of the secret or the replica ARN. The replica ARN is the same as the original primary secret ARN expect the Region is changed to the replica Region.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - type: The exact string that identifies the third-party partner that holds the external secret. For more information, see Managed external secret partners.
    ///   - logger: Logger use during operation
    @inlinable
