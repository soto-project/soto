...
extension SecretsManager {
    ...
    public struct CreateSecretRequest: AWSEncodableShape {
        ...
        public let secretBinary: AWSBlob?
        ...
        public init(addReplicaRegions: [ReplicaRegionType]? = nil, clientRequestToken: String? = CreateSecretRequest.idempotencyToken(), description: String? = nil, forceOverwriteReplicaSecret: Bool? = nil, kmsKeyId: String? = nil, name: String, secretBinary: AWSBlob? = nil, secretString: String? = nil, tags: [Tag]? = nil) {
    ...
    public struct GetSecretValueResponse: AWSDecodableShape {
        ...
        public init(arn: String? = nil, createdDate: Date? = nil, name: String? = nil, secretBinary: AWSBlob? = nil, secretString: String? = nil, versionId: String? = nil, versionStages: [String]? = nil) {
            self.arn = arn
            self.createdDate = createdDate
            self.name = name
            self.secretBinary = secretBinary
    ...
    public struct PutSecretValueRequest: AWSEncodableShape {
        ...
        public init(clientRequestToken: String? = PutSecretValueRequest.idempotencyToken(), secretBinary: AWSBlob? = nil, secretId: String, secretString: String? = nil, versionStages: [String]? = nil) {
            self.clientRequestToken = clientRequestToken
            self.secretBinary = secretBinary
            self.secretId = secretId
            self.secretString = secretString
    ...
    public struct UpdateSecretRequest: AWSEncodableShape {
        ...
        public init(clientRequestToken: String? = UpdateSecretRequest.idempotencyToken(), description: String? = nil, kmsKeyId: String? = nil, secretBinary: AWSBlob? = nil, secretId: String, secretString: String? = nil) {
            self.clientRequestToken = clientRequestToken
            self.description = description
            self.kmsKeyId = kmsKeyId
            self.secretBinary = secretBinary
