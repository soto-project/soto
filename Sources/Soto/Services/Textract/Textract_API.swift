...
public struct Textract: AWSService {
    ...
    public func analyzeDocument(_ input: AnalyzeDocumentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AnalyzeDocumentResponse> {
        return self.client.execute(operation: "AnalyzeDocument", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func detectDocumentText(_ input: DetectDocumentTextRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectDocumentTextResponse> {
        return self.client.execute(operation: "DetectDocumentText", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getDocumentAnalysis(_ input: GetDocumentAnalysisRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDocumentAnalysisResponse> {
        return self.client.execute(operation: "GetDocumentAnalysis", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getDocumentTextDetection(_ input: GetDocumentTextDetectionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDocumentTextDetectionResponse> {
        return self.client.execute(operation: "GetDocumentTextDetection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startDocumentAnalysis(_ input: StartDocumentAnalysisRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDocumentAnalysisResponse> {
        return self.client.execute(operation: "StartDocumentAnalysis", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startDocumentTextDetection(_ input: StartDocumentTextDetectionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDocumentTextDetectionResponse> {
        return self.client.execute(operation: "StartDocumentTextDetection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
