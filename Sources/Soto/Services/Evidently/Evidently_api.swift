...
public struct Evidently: AWSService {
    ...
    public func batchEvaluateFeature(_ input: BatchEvaluateFeatureRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchEvaluateFeatureResponse {
        return try await self.client.execute(operation: "BatchEvaluateFeature", path: "/projects/{project}/evaluations", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "dataplane.", logger: logger)
    }
    ...
    public func createExperiment(_ input: CreateExperimentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateExperimentResponse {
        return try await self.client.execute(operation: "CreateExperiment", path: "/projects/{project}/experiments", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createFeature(_ input: CreateFeatureRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateFeatureResponse {
        return try await self.client.execute(operation: "CreateFeature", path: "/projects/{project}/features", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createLaunch(_ input: CreateLaunchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateLaunchResponse {
        return try await self.client.execute(operation: "CreateLaunch", path: "/projects/{project}/launches", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSegment(_ input: CreateSegmentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSegmentResponse {
        return try await self.client.execute(operation: "CreateSegment", path: "/segments", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteExperiment(_ input: DeleteExperimentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteExperimentResponse {
        return try await self.client.execute(operation: "DeleteExperiment", path: "/projects/{project}/experiments/{experiment}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteFeature(_ input: DeleteFeatureRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteFeatureResponse {
        return try await self.client.execute(operation: "DeleteFeature", path: "/projects/{project}/features/{feature}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteLaunch(_ input: DeleteLaunchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteLaunchResponse {
        return try await self.client.execute(operation: "DeleteLaunch", path: "/projects/{project}/launches/{launch}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteProject(_ input: DeleteProjectRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteProjectResponse {
        return try await self.client.execute(operation: "DeleteProject", path: "/projects/{project}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSegment(_ input: DeleteSegmentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteSegmentResponse {
        return try await self.client.execute(operation: "DeleteSegment", path: "/segments/{segment}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func evaluateFeature(_ input: EvaluateFeatureRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> EvaluateFeatureResponse {
        return try await self.client.execute(operation: "EvaluateFeature", path: "/projects/{project}/evaluations/{feature}", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "dataplane.", logger: logger)
    }
    ...
    public func getExperiment(_ input: GetExperimentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetExperimentResponse {
        return try await self.client.execute(operation: "GetExperiment", path: "/projects/{project}/experiments/{experiment}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getExperimentResults(_ input: GetExperimentResultsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetExperimentResultsResponse {
        return try await self.client.execute(operation: "GetExperimentResults", path: "/projects/{project}/experiments/{experiment}/results", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getFeature(_ input: GetFeatureRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetFeatureResponse {
        return try await self.client.execute(operation: "GetFeature", path: "/projects/{project}/features/{feature}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getLaunch(_ input: GetLaunchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetLaunchResponse {
        return try await self.client.execute(operation: "GetLaunch", path: "/projects/{project}/launches/{launch}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getProject(_ input: GetProjectRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetProjectResponse {
        return try await self.client.execute(operation: "GetProject", path: "/projects/{project}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSegment(_ input: GetSegmentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSegmentResponse {
        return try await self.client.execute(operation: "GetSegment", path: "/segments/{segment}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listExperiments(_ input: ListExperimentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListExperimentsResponse {
        return try await self.client.execute(operation: "ListExperiments", path: "/projects/{project}/experiments", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listFeatures(_ input: ListFeaturesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListFeaturesResponse {
        return try await self.client.execute(operation: "ListFeatures", path: "/projects/{project}/features", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listLaunches(_ input: ListLaunchesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListLaunchesResponse {
        return try await self.client.execute(operation: "ListLaunches", path: "/projects/{project}/launches", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSegmentReferences(_ input: ListSegmentReferencesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSegmentReferencesResponse {
        return try await self.client.execute(operation: "ListSegmentReferences", path: "/segments/{segment}/references", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSegments(_ input: ListSegmentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSegmentsResponse {
        return try await self.client.execute(operation: "ListSegments", path: "/segments", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putProjectEvents(_ input: PutProjectEventsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutProjectEventsResponse {
        return try await self.client.execute(operation: "PutProjectEvents", path: "/events/projects/{project}", httpMethod: .POST, serviceConfig: self.config, input: input, hostPrefix: "dataplane.", logger: logger)
    }
    ...
    public func startExperiment(_ input: StartExperimentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartExperimentResponse {
        return try await self.client.execute(operation: "StartExperiment", path: "/projects/{project}/experiments/{experiment}/start", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startLaunch(_ input: StartLaunchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartLaunchResponse {
        return try await self.client.execute(operation: "StartLaunch", path: "/projects/{project}/launches/{launch}/start", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func stopExperiment(_ input: StopExperimentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StopExperimentResponse {
        return try await self.client.execute(operation: "StopExperiment", path: "/projects/{project}/experiments/{experiment}/cancel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func stopLaunch(_ input: StopLaunchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StopLaunchResponse {
        return try await self.client.execute(operation: "StopLaunch", path: "/projects/{project}/launches/{launch}/cancel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func testSegmentPattern(_ input: TestSegmentPatternRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> TestSegmentPatternResponse {
        return try await self.client.execute(operation: "TestSegmentPattern", path: "/test-segment-pattern", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateExperiment(_ input: UpdateExperimentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateExperimentResponse {
        return try await self.client.execute(operation: "UpdateExperiment", path: "/projects/{project}/experiments/{experiment}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateFeature(_ input: UpdateFeatureRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateFeatureResponse {
        return try await self.client.execute(operation: "UpdateFeature", path: "/projects/{project}/features/{feature}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateLaunch(_ input: UpdateLaunchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateLaunchResponse {
        return try await self.client.execute(operation: "UpdateLaunch", path: "/projects/{project}/launches/{launch}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateProject(_ input: UpdateProjectRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateProjectResponse {
        return try await self.client.execute(operation: "UpdateProject", path: "/projects/{project}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateProjectDataDelivery(_ input: UpdateProjectDataDeliveryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateProjectDataDeliveryResponse {
        return try await self.client.execute(operation: "UpdateProjectDataDelivery", path: "/projects/{project}/data-delivery", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
}
