...
extension Budgets {
    ...
    public enum AutoAdjustType: String, CustomStringConvertible, Codable {
    ...
    public struct ActionThreshold: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.actionThresholdValue, name: "actionThresholdValue", parent: name, max: 15_000_000_000_000)
    ...
    public struct Notification: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.threshold, name: "threshold", parent: name, max: 15_000_000_000_000)
