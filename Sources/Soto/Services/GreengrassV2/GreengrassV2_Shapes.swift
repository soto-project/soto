...
extension GreengrassV2 {
    ...
    public struct CreateComponentVersionRequest: AWSEncodableShape {
        ...
        public let inlineRecipe: AWSBlob?
        ...
        public init(clientToken: String? = CreateComponentVersionRequest.idempotencyToken(), inlineRecipe: AWSBlob? = nil, lambdaFunction: LambdaFunctionRecipeSource? = nil, tags: [String: String]? = nil) {
    ...
    public struct GetComponentResponse: AWSDecodableShape {
        ...
        public let recipe: AWSBlob
        /// The format of the recipe.
        public let recipeOutputFormat: RecipeOutputFormat
        /// A list of key-value pairs that contain metadata for the resource. For more information, see Tag your resources in the IoT Greengrass V2 Developer Guide.
        public let tags: [String: String]?

        public init(recipe: AWSBlob, recipeOutputFormat: RecipeOutputFormat, tags: [String: String]? = nil) {
            self.recipe = recipe
            self.recipeOutputFormat = recipeOutputFormat
            self.tags = tags
        }
    ...
    public struct ResolvedComponentVersion: AWSDecodableShape {
        ...
        public init(arn: String? = nil, componentName: String? = nil, componentVersion: String? = nil, recipe: AWSBlob? = nil) {
            self.arn = arn
            self.componentName = componentName
            self.componentVersion = componentVersion
            self.recipe = recipe
