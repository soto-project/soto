...
extension GreengrassV2 {
    ...
    public enum VendorGuidance: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
    ...
    public struct ResolvedComponentVersion: AWSDecodableShape {
        ...
        public init(arn: String? = nil, componentName: String? = nil, componentVersion: String? = nil, message: String? = nil, recipe: Data? = nil, vendorGuidance: VendorGuidance? = nil) {
            self.arn = arn
            self.componentName = componentName
            self.componentVersion = componentVersion
            self.message = message
