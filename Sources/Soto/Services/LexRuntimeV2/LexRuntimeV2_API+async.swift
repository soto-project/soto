...
extension LexRuntimeV2 {
    ...
    public func startConversation(_ input: StartConversationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StartConversationResponse {
        return try await self.client.execute(operation: "StartConversation", path: "/bots/{botId}/botAliases/{botAliasId}/botLocales/{localeId}/sessions/{sessionId}/conversation", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
