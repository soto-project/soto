...
extension LexRuntimeV2 {
    ...
    public struct AudioInputEvent: AWSEncodableShape {
        ...
        public init(audioChunk: AWSBlob? = nil, clientTimestampMillis: Int64? = nil, contentType: String, eventId: String? = nil) {
    ...
    public struct AudioResponseEvent: AWSDecodableShape {
        ...
        public init(audioChunk: AWSBlob? = nil, contentType: String? = nil, eventId: String? = nil) {
            self.audioChunk = audioChunk
            self.contentType = contentType
            self.eventId = eventId
        }
