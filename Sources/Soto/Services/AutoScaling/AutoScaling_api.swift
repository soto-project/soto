...
public struct AutoScaling: AWSService {
    ...
    public func attachInstances(_ input: AttachInstancesQuery, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "AttachInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func attachLoadBalancerTargetGroups(_ input: AttachLoadBalancerTargetGroupsType, logger: Logger = AWSClient.loggingDisabled) async throws -> AttachLoadBalancerTargetGroupsResultType {
        return try await self.client.execute(operation: "AttachLoadBalancerTargetGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func attachLoadBalancers(_ input: AttachLoadBalancersType, logger: Logger = AWSClient.loggingDisabled) async throws -> AttachLoadBalancersResultType {
        return try await self.client.execute(operation: "AttachLoadBalancers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func attachTrafficSources(_ input: AttachTrafficSourcesType, logger: Logger = AWSClient.loggingDisabled) async throws -> AttachTrafficSourcesResultType {
        return try await self.client.execute(operation: "AttachTrafficSources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func batchDeleteScheduledAction(_ input: BatchDeleteScheduledActionType, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchDeleteScheduledActionAnswer {
        return try await self.client.execute(operation: "BatchDeleteScheduledAction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func batchPutScheduledUpdateGroupAction(_ input: BatchPutScheduledUpdateGroupActionType, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchPutScheduledUpdateGroupActionAnswer {
        return try await self.client.execute(operation: "BatchPutScheduledUpdateGroupAction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func cancelInstanceRefresh(_ input: CancelInstanceRefreshType, logger: Logger = AWSClient.loggingDisabled) async throws -> CancelInstanceRefreshAnswer {
        return try await self.client.execute(operation: "CancelInstanceRefresh", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func completeLifecycleAction(_ input: CompleteLifecycleActionType, logger: Logger = AWSClient.loggingDisabled) async throws -> CompleteLifecycleActionAnswer {
        return try await self.client.execute(operation: "CompleteLifecycleAction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createAutoScalingGroup(_ input: CreateAutoScalingGroupType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "CreateAutoScalingGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createLaunchConfiguration(_ input: CreateLaunchConfigurationType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "CreateLaunchConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createOrUpdateTags(_ input: CreateOrUpdateTagsType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "CreateOrUpdateTags", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteAutoScalingGroup(_ input: DeleteAutoScalingGroupType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteAutoScalingGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteLaunchConfiguration(_ input: LaunchConfigurationNameType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteLaunchConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteLifecycleHook(_ input: DeleteLifecycleHookType, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteLifecycleHookAnswer {
        return try await self.client.execute(operation: "DeleteLifecycleHook", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteNotificationConfiguration(_ input: DeleteNotificationConfigurationType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteNotificationConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteScheduledAction(_ input: DeleteScheduledActionType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteScheduledAction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteWarmPool(_ input: DeleteWarmPoolType, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteWarmPoolAnswer {
        return try await self.client.execute(operation: "DeleteWarmPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeAccountLimits(logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAccountLimitsAnswer {
        return try await self.client.execute(operation: "DescribeAccountLimits", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeAdjustmentTypes(logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAdjustmentTypesAnswer {
        return try await self.client.execute(operation: "DescribeAdjustmentTypes", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeAutoScalingGroups(_ input: AutoScalingGroupNamesType, logger: Logger = AWSClient.loggingDisabled) async throws -> AutoScalingGroupsType {
        return try await self.client.execute(operation: "DescribeAutoScalingGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeAutoScalingInstances(_ input: DescribeAutoScalingInstancesType, logger: Logger = AWSClient.loggingDisabled) async throws -> AutoScalingInstancesType {
        return try await self.client.execute(operation: "DescribeAutoScalingInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeAutoScalingNotificationTypes(logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAutoScalingNotificationTypesAnswer {
        return try await self.client.execute(operation: "DescribeAutoScalingNotificationTypes", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeInstanceRefreshes(_ input: DescribeInstanceRefreshesType, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeInstanceRefreshesAnswer {
        return try await self.client.execute(operation: "DescribeInstanceRefreshes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeLaunchConfigurations(_ input: LaunchConfigurationNamesType, logger: Logger = AWSClient.loggingDisabled) async throws -> LaunchConfigurationsType {
        return try await self.client.execute(operation: "DescribeLaunchConfigurations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeLifecycleHookTypes(logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLifecycleHookTypesAnswer {
        return try await self.client.execute(operation: "DescribeLifecycleHookTypes", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeLifecycleHooks(_ input: DescribeLifecycleHooksType, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLifecycleHooksAnswer {
        return try await self.client.execute(operation: "DescribeLifecycleHooks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeLoadBalancerTargetGroups(_ input: DescribeLoadBalancerTargetGroupsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLoadBalancerTargetGroupsResponse {
        return try await self.client.execute(operation: "DescribeLoadBalancerTargetGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeLoadBalancers(_ input: DescribeLoadBalancersRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLoadBalancersResponse {
        return try await self.client.execute(operation: "DescribeLoadBalancers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeMetricCollectionTypes(logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeMetricCollectionTypesAnswer {
        return try await self.client.execute(operation: "DescribeMetricCollectionTypes", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeNotificationConfigurations(_ input: DescribeNotificationConfigurationsType, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeNotificationConfigurationsAnswer {
        return try await self.client.execute(operation: "DescribeNotificationConfigurations", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describePolicies(_ input: DescribePoliciesType, logger: Logger = AWSClient.loggingDisabled) async throws -> PoliciesType {
        return try await self.client.execute(operation: "DescribePolicies", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeScalingActivities(_ input: DescribeScalingActivitiesType, logger: Logger = AWSClient.loggingDisabled) async throws -> ActivitiesType {
        return try await self.client.execute(operation: "DescribeScalingActivities", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeScalingProcessTypes(logger: Logger = AWSClient.loggingDisabled) async throws -> ProcessesType {
        return try await self.client.execute(operation: "DescribeScalingProcessTypes", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeScheduledActions(_ input: DescribeScheduledActionsType, logger: Logger = AWSClient.loggingDisabled) async throws -> ScheduledActionsType {
        return try await self.client.execute(operation: "DescribeScheduledActions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeTerminationPolicyTypes(logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTerminationPolicyTypesAnswer {
        return try await self.client.execute(operation: "DescribeTerminationPolicyTypes", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func describeTrafficSources(_ input: DescribeTrafficSourcesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTrafficSourcesResponse {
        return try await self.client.execute(operation: "DescribeTrafficSources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeWarmPool(_ input: DescribeWarmPoolType, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeWarmPoolAnswer {
        return try await self.client.execute(operation: "DescribeWarmPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func detachInstances(_ input: DetachInstancesQuery, logger: Logger = AWSClient.loggingDisabled) async throws -> DetachInstancesAnswer {
        return try await self.client.execute(operation: "DetachInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func detachLoadBalancerTargetGroups(_ input: DetachLoadBalancerTargetGroupsType, logger: Logger = AWSClient.loggingDisabled) async throws -> DetachLoadBalancerTargetGroupsResultType {
        return try await self.client.execute(operation: "DetachLoadBalancerTargetGroups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func detachLoadBalancers(_ input: DetachLoadBalancersType, logger: Logger = AWSClient.loggingDisabled) async throws -> DetachLoadBalancersResultType {
        return try await self.client.execute(operation: "DetachLoadBalancers", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func detachTrafficSources(_ input: DetachTrafficSourcesType, logger: Logger = AWSClient.loggingDisabled) async throws -> DetachTrafficSourcesResultType {
        return try await self.client.execute(operation: "DetachTrafficSources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func disableMetricsCollection(_ input: DisableMetricsCollectionQuery, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DisableMetricsCollection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func enableMetricsCollection(_ input: EnableMetricsCollectionQuery, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "EnableMetricsCollection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func enterStandby(_ input: EnterStandbyQuery, logger: Logger = AWSClient.loggingDisabled) async throws -> EnterStandbyAnswer {
        return try await self.client.execute(operation: "EnterStandby", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func executePolicy(_ input: ExecutePolicyType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "ExecutePolicy", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func exitStandby(_ input: ExitStandbyQuery, logger: Logger = AWSClient.loggingDisabled) async throws -> ExitStandbyAnswer {
        return try await self.client.execute(operation: "ExitStandby", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getPredictiveScalingForecast(_ input: GetPredictiveScalingForecastType, logger: Logger = AWSClient.loggingDisabled) async throws -> GetPredictiveScalingForecastAnswer {
        return try await self.client.execute(operation: "GetPredictiveScalingForecast", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putLifecycleHook(_ input: PutLifecycleHookType, logger: Logger = AWSClient.loggingDisabled) async throws -> PutLifecycleHookAnswer {
        return try await self.client.execute(operation: "PutLifecycleHook", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putNotificationConfiguration(_ input: PutNotificationConfigurationType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "PutNotificationConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putScalingPolicy(_ input: PutScalingPolicyType, logger: Logger = AWSClient.loggingDisabled) async throws -> PolicyARNType {
        return try await self.client.execute(operation: "PutScalingPolicy", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putScheduledUpdateGroupAction(_ input: PutScheduledUpdateGroupActionType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "PutScheduledUpdateGroupAction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putWarmPool(_ input: PutWarmPoolType, logger: Logger = AWSClient.loggingDisabled) async throws -> PutWarmPoolAnswer {
        return try await self.client.execute(operation: "PutWarmPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func recordLifecycleActionHeartbeat(_ input: RecordLifecycleActionHeartbeatType, logger: Logger = AWSClient.loggingDisabled) async throws -> RecordLifecycleActionHeartbeatAnswer {
        return try await self.client.execute(operation: "RecordLifecycleActionHeartbeat", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func resumeProcesses(_ input: ScalingProcessQuery, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "ResumeProcesses", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func rollbackInstanceRefresh(_ input: RollbackInstanceRefreshType, logger: Logger = AWSClient.loggingDisabled) async throws -> RollbackInstanceRefreshAnswer {
        return try await self.client.execute(operation: "RollbackInstanceRefresh", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func setDesiredCapacity(_ input: SetDesiredCapacityType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "SetDesiredCapacity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func setInstanceHealth(_ input: SetInstanceHealthQuery, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "SetInstanceHealth", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func setInstanceProtection(_ input: SetInstanceProtectionQuery, logger: Logger = AWSClient.loggingDisabled) async throws -> SetInstanceProtectionAnswer {
        return try await self.client.execute(operation: "SetInstanceProtection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startInstanceRefresh(_ input: StartInstanceRefreshType, logger: Logger = AWSClient.loggingDisabled) async throws -> StartInstanceRefreshAnswer {
        return try await self.client.execute(operation: "StartInstanceRefresh", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func suspendProcesses(_ input: ScalingProcessQuery, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "SuspendProcesses", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func terminateInstanceInAutoScalingGroup(_ input: TerminateInstanceInAutoScalingGroupType, logger: Logger = AWSClient.loggingDisabled) async throws -> ActivityType {
        return try await self.client.execute(operation: "TerminateInstanceInAutoScalingGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateAutoScalingGroup(_ input: UpdateAutoScalingGroupType, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "UpdateAutoScalingGroup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
