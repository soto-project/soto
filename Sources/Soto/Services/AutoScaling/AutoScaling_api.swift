...
public struct AutoScaling: AWSService {
    ...
    ///   - availabilityZoneIds:  A list of Availability Zone IDs where the Auto Scaling group can launch instances. You cannot specify both AvailabilityZones and AvailabilityZoneIds in the same request.
    ...
    ///   - autoScalingGroupName: The name of the Auto Scaling group.
    ///   - availabilityZoneDistribution:  The instance capacity distribution across Availability Zones.
    ///   - availabilityZoneIds:  A list of Availability Zone IDs for the Auto Scaling group. You cannot specify both AvailabilityZones and AvailabilityZoneIds in the same request.
    ///   - availabilityZoneImpairmentPolicy:  The policy for Availability Zone impairment.
