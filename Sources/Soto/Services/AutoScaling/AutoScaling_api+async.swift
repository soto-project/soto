...
extension AutoScaling {
    ...
    public func rollbackInstanceRefresh(_ input: RollbackInstanceRefreshType, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RollbackInstanceRefreshAnswer {
        return try await self.client.execute(operation: "RollbackInstanceRefresh", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
