...
public struct Glacier: AWSService {
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func abortVaultLock(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = AbortVaultLockInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.abortVaultLock(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func addTagsToVault(
        accountId: String,
        tags: [String: String]? = nil,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = AddTagsToVaultInput(
            accountId: accountId, 
            tags: tags, 
            vaultName: vaultName
        )
        return try await self.addTagsToVault(input, logger: logger)
    }
    ...
    public func completeMultipartUpload(
        ...
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ArchiveCreationOutput {
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func completeVaultLock(
        accountId: String,
        lockId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = CompleteVaultLockInput(
            accountId: accountId, 
            lockId: lockId, 
            vaultName: vaultName
        )
        return try await self.completeVaultLock(input, logger: logger)
    }
    ...
    public func createVault(
        ...
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateVaultOutput {
        let input = CreateVaultInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.createVault(input, logger: logger)
    }
    ...
    public func deleteVault(
        ...
        let input = DeleteVaultInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.deleteVault(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteVaultAccessPolicy(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteVaultAccessPolicyInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.deleteVaultAccessPolicy(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteVaultNotifications(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteVaultNotificationsInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.deleteVaultNotifications(input, logger: logger)
    }
    ...
    public func describeJob(
        ...
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GlacierJobDescription {
        let input = DescribeJobInput(
            accountId: accountId, 
            jobId: jobId, 
            vaultName: vaultName
        )
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeVault(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeVaultOutput {
        let input = DescribeVaultInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.describeVault(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getDataRetrievalPolicy(
        accountId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetDataRetrievalPolicyOutput {
        let input = GetDataRetrievalPolicyInput(
            accountId: accountId
        )
        return try await self.getDataRetrievalPolicy(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getJobOutput(
        accountId: String,
        jobId: String,
        range: String? = nil,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetJobOutputOutput {
        let input = GetJobOutputInput(
            accountId: accountId, 
            jobId: jobId, 
            range: range, 
            vaultName: vaultName
        )
        return try await self.getJobOutput(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getVaultAccessPolicy(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetVaultAccessPolicyOutput {
        let input = GetVaultAccessPolicyInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.getVaultAccessPolicy(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getVaultLock(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetVaultLockOutput {
        let input = GetVaultLockInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.getVaultLock(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getVaultNotifications(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetVaultNotificationsOutput {
        let input = GetVaultNotificationsInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.getVaultNotifications(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func initiateJob(
        accountId: String,
        jobParameters: JobParameters? = nil,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> InitiateJobOutput {
        let input = InitiateJobInput(
            accountId: accountId, 
            jobParameters: jobParameters, 
            vaultName: vaultName
        )
        return try await self.initiateJob(input, logger: logger)
    }
    ...
    public func initiateMultipartUpload(
        ...
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> InitiateMultipartUploadOutput {
        ...
        return try await self.initiateMultipartUpload(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func initiateVaultLock(
        accountId: String,
        policy: VaultLockPolicy? = nil,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> InitiateVaultLockOutput {
        let input = InitiateVaultLockInput(
            accountId: accountId, 
            policy: policy, 
            vaultName: vaultName
        )
        return try await self.initiateVaultLock(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - accountId: The AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single '-' (hyphen), in which case Amazon Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, don't include any hyphens ('-') in the ID.
    ///   - logger: Logger use during operation
    @inlinable
    public func listProvisionedCapacity(
        accountId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListProvisionedCapacityOutput {
        let input = ListProvisionedCapacityInput(
            accountId: accountId
        )
        return try await self.listProvisionedCapacity(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func listTagsForVault(
        accountId: String,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListTagsForVaultOutput {
        let input = ListTagsForVaultInput(
            accountId: accountId, 
            vaultName: vaultName
        )
        return try await self.listTagsForVault(input, logger: logger)
    }
    ...
    public func listVaults(
        ...
        marker: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListVaultsOutput {
        let input = ListVaultsInput(
            accountId: accountId, 
            limit: limit, 
            marker: marker
        )
        return try await self.listVaults(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func purchaseProvisionedCapacity(
        accountId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> PurchaseProvisionedCapacityOutput {
        let input = PurchaseProvisionedCapacityInput(
            accountId: accountId
        )
        return try await self.purchaseProvisionedCapacity(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func removeTagsFromVault(
        accountId: String,
        tagKeys: [String]? = nil,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = RemoveTagsFromVaultInput(
            accountId: accountId, 
            tagKeys: tagKeys, 
            vaultName: vaultName
        )
        return try await self.removeTagsFromVault(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func setDataRetrievalPolicy(
        accountId: String,
        policy: DataRetrievalPolicy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = SetDataRetrievalPolicyInput(
            accountId: accountId, 
            policy: policy
        )
        return try await self.setDataRetrievalPolicy(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func setVaultAccessPolicy(
        accountId: String,
        policy: VaultAccessPolicy? = nil,
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = SetVaultAccessPolicyInput(
            accountId: accountId, 
            policy: policy, 
            vaultName: vaultName
        )
        return try await self.setVaultAccessPolicy(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func setVaultNotifications(
        accountId: String,
        vaultName: String,
        vaultNotificationConfig: VaultNotificationConfig? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = SetVaultNotificationsInput(
            accountId: accountId, 
            vaultName: vaultName, 
            vaultNotificationConfig: vaultNotificationConfig
        )
        return try await self.setVaultNotifications(input, logger: logger)
    }
    ...
    public func uploadArchive(
        ...
        return try await self.uploadArchive(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func uploadMultipartPart(
        accountId: String,
        body: AWSHTTPBody? = nil,
        checksum: String? = nil,
        range: String? = nil,
        ...
        vaultName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UploadMultipartPartOutput {
        let input = UploadMultipartPartInput(
            accountId: accountId, 
            body: body, 
            checksum: checksum, 
            range: range, 
        ...
        return try await self.uploadMultipartPart(input, logger: logger)
    }
}
...
extension Glacier {
    ...
    /// Return PaginatorSequence for operation ``listMultipartUploads(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listMultipartUploadsPaginator(
        ...
        return self.listMultipartUploadsPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``listVaults(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listVaultsPaginator(
        ...
        return self.listVaultsPaginator(input, logger: logger)
    }
}
...
@available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
extension Glacier {
    /// Waiter for operation ``describeVault(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func waitUntilVaultExists(
        ...
        let waiter = AWSClient.Waiter<DescribeVaultInput, _>(
            acceptors: [
    ...
    public func waitUntilVaultExists(
        ...
        try await self.waitUntilVaultExists(input, logger: logger)
    }
    ...
    public func waitUntilVaultNotExists(
        ...
        try await self.waitUntilVaultNotExists(input, logger: logger)
    }
}
