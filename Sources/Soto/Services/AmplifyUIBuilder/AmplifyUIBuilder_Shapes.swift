...
extension AmplifyUIBuilder {
    ...
    public enum SortDirection: String, CustomStringConvertible, Codable {
        case asc = "ASC"
        case desc = "DESC"
        public var description: String { return self.rawValue }
    }

    public enum TokenProviders: String, CustomStringConvertible, Codable {
        case figma
        public var description: String { return self.rawValue }
    }
    ...
    public struct ExchangeCodeForTokenRequest: AWSEncodableShape & AWSShapeWithPayload {
        ...
        public static var _encoding = [
            AWSMemberEncoding(label: "provider", location: .uri(locationName: "provider"))
        ]
