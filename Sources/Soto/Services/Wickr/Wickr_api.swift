...
public struct Wickr: AWSService {
    ...
    @Sendable
    @inlinable
    public func getOpentdfConfig(_ input: GetOpentdfConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetOpentdfConfigResponse {
        try await self.client.execute(
            operation: "GetOpentdfConfig", 
    ...
    ///
    /// Parameters:
    ///   - networkId: The ID of the Wickr network for which OpenTDF integration will be retrieved.
    ///   - logger: Logger use during operation
    @inlinable
    public func getOpentdfConfig(
        networkId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetOpentdfConfigResponse {
        let input = GetOpentdfConfigRequest(
            networkId: networkId
        )
        return try await self.getOpentdfConfig(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func registerOpentdfConfig(_ input: RegisterOpentdfConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> RegisterOpentdfConfigResponse {
        try await self.client.execute(
            operation: "RegisterOpentdfConfig", 
            path: "/networks/{networkId}/tdf", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func registerOpentdfConfig(
        clientId: String,
        clientSecret: String,
        domain: String,
        dryRun: Bool? = nil,
        ...
        provider: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> RegisterOpentdfConfigResponse {
        let input = RegisterOpentdfConfigRequest(
            clientId: clientId, 
            clientSecret: clientSecret, 
            domain: domain, 
            dryRun: dryRun, 
        ...
        return try await self.registerOpentdfConfig(input, logger: logger)
    }
