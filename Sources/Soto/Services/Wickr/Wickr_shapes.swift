...
extension Wickr {
    ...
    public struct GetOpentdfConfigRequest: AWSEncodableShape {
    ...
    public struct GetOpentdfConfigResponse: AWSDecodableShape {
        ...
        @inlinable
        public init(clientId: String, clientSecret: String, domain: String, provider: String) {
            self.clientId = clientId
            self.clientSecret = clientSecret
            self.domain = domain
    ...
    public struct NetworkSettings: AWSEncodableShape {
        ...
        public let enableTrustedDataFormat: Bool?
    ...
    public struct RegisterOpentdfConfigRequest: AWSEncodableShape {
        /// The OIDC client ID used for authenticating with the OpenTDF provider.
        public let clientId: String
        /// The OIDC client secret used for authenticating with the OpenTDF provider
        public let clientSecret: String
        ...
        @inlinable
        public init(clientId: String, clientSecret: String, domain: String, dryRun: Bool? = nil, networkId: String, provider: String) {
            self.clientId = clientId
            self.clientSecret = clientSecret
            self.domain = domain
            self.dryRun = dryRun
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            request.encodeQuery(self.dryRun, key: "dryRun")
            request.encodePath(self.networkId, key: "networkId")
    ...
    public struct RegisterOpentdfConfigResponse: AWSDecodableShape {
        /// The OIDC client ID used for authenticating with the OpenTDF provider.
        public let clientId: String
        /// The OIDC client secret used for authenticating with the OpenTDF provider.
        public let clientSecret: String
    ...
    public struct ValidationError: AWSErrorShape {
        ...
        @inlinable
        public init(message: String? = nil, reasons: [ErrorDetail]? = nil) {
            self.message = message
