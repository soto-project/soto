...
public struct CloudHSM: AWSService {
    ...
    public func createHapg(_ input: CreateHapgRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateHapgResponse {
        return try await self.client.execute(operation: "CreateHapg", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createHsm(_ input: CreateHsmRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateHsmResponse {
        return try await self.client.execute(operation: "CreateHsm", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createLunaClient(_ input: CreateLunaClientRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateLunaClientResponse {
        return try await self.client.execute(operation: "CreateLunaClient", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteHapg(_ input: DeleteHapgRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteHapgResponse {
        return try await self.client.execute(operation: "DeleteHapg", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteHsm(_ input: DeleteHsmRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteHsmResponse {
        return try await self.client.execute(operation: "DeleteHsm", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteLunaClient(_ input: DeleteLunaClientRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteLunaClientResponse {
        return try await self.client.execute(operation: "DeleteLunaClient", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeHapg(_ input: DescribeHapgRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeHapgResponse {
        return try await self.client.execute(operation: "DescribeHapg", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeHsm(_ input: DescribeHsmRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeHsmResponse {
        return try await self.client.execute(operation: "DescribeHsm", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeLunaClient(_ input: DescribeLunaClientRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLunaClientResponse {
        return try await self.client.execute(operation: "DescribeLunaClient", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getConfig(_ input: GetConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetConfigResponse {
        return try await self.client.execute(operation: "GetConfig", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listAvailableZones(_ input: ListAvailableZonesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListAvailableZonesResponse {
        return try await self.client.execute(operation: "ListAvailableZones", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listHapgs(_ input: ListHapgsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListHapgsResponse {
        return try await self.client.execute(operation: "ListHapgs", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listHsms(_ input: ListHsmsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListHsmsResponse {
        return try await self.client.execute(operation: "ListHsms", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listLunaClients(_ input: ListLunaClientsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListLunaClientsResponse {
        return try await self.client.execute(operation: "ListLunaClients", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func modifyHapg(_ input: ModifyHapgRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ModifyHapgResponse {
        return try await self.client.execute(operation: "ModifyHapg", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func modifyHsm(_ input: ModifyHsmRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ModifyHsmResponse {
        return try await self.client.execute(operation: "ModifyHsm", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func modifyLunaClient(_ input: ModifyLunaClientRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ModifyLunaClientResponse {
        return try await self.client.execute(operation: "ModifyLunaClient", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
