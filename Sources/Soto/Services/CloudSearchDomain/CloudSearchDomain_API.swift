...
public struct CloudSearchDomain: AWSService {
    ...
    public func search(_ input: SearchRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchResponse> {
        return self.client.execute(operation: "Search", path: "/2013-01-01/search?format=sdk&pretty=true", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func suggest(_ input: SuggestRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SuggestResponse> {
        return self.client.execute(operation: "Suggest", path: "/2013-01-01/suggest?format=sdk&pretty=true", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func uploadDocuments(_ input: UploadDocumentsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UploadDocumentsResponse> {
        return self.client.execute(operation: "UploadDocuments", path: "/2013-01-01/documents/batch?format=sdk", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
