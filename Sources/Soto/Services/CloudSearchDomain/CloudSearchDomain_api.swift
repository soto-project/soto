...
public struct CloudSearchDomain: AWSService {
    ...
    public func search(_ input: SearchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SearchResponse {
        return try await self.client.execute(operation: "Search", path: "/2013-01-01/search?format=sdk&pretty=true", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func suggest(_ input: SuggestRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SuggestResponse {
        return try await self.client.execute(operation: "Suggest", path: "/2013-01-01/suggest?format=sdk&pretty=true", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func uploadDocuments(_ input: UploadDocumentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UploadDocumentsResponse {
        return try await self.client.execute(operation: "UploadDocuments", path: "/2013-01-01/documents/batch?format=sdk", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
