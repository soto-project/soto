...
public struct KinesisVideo: AWSService {
    ...
    public func createSignalingChannel(_ input: CreateSignalingChannelInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSignalingChannelOutput {
        return try await self.client.execute(operation: "CreateSignalingChannel", path: "/createSignalingChannel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createStream(_ input: CreateStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateStreamOutput {
        return try await self.client.execute(operation: "CreateStream", path: "/createStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSignalingChannel(_ input: DeleteSignalingChannelInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteSignalingChannelOutput {
        return try await self.client.execute(operation: "DeleteSignalingChannel", path: "/deleteSignalingChannel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteStream(_ input: DeleteStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteStreamOutput {
        return try await self.client.execute(operation: "DeleteStream", path: "/deleteStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeEdgeConfiguration(_ input: DescribeEdgeConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeEdgeConfigurationOutput {
        return try await self.client.execute(operation: "DescribeEdgeConfiguration", path: "/describeEdgeConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeImageGenerationConfiguration(_ input: DescribeImageGenerationConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeImageGenerationConfigurationOutput {
        return try await self.client.execute(operation: "DescribeImageGenerationConfiguration", path: "/describeImageGenerationConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeMappedResourceConfiguration(_ input: DescribeMappedResourceConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeMappedResourceConfigurationOutput {
        return try await self.client.execute(operation: "DescribeMappedResourceConfiguration", path: "/describeMappedResourceConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeMediaStorageConfiguration(_ input: DescribeMediaStorageConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeMediaStorageConfigurationOutput {
        return try await self.client.execute(operation: "DescribeMediaStorageConfiguration", path: "/describeMediaStorageConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeNotificationConfiguration(_ input: DescribeNotificationConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeNotificationConfigurationOutput {
        return try await self.client.execute(operation: "DescribeNotificationConfiguration", path: "/describeNotificationConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeSignalingChannel(_ input: DescribeSignalingChannelInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeSignalingChannelOutput {
        return try await self.client.execute(operation: "DescribeSignalingChannel", path: "/describeSignalingChannel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeStream(_ input: DescribeStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeStreamOutput {
        return try await self.client.execute(operation: "DescribeStream", path: "/describeStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getDataEndpoint(_ input: GetDataEndpointInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetDataEndpointOutput {
        return try await self.client.execute(operation: "GetDataEndpoint", path: "/getDataEndpoint", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSignalingChannelEndpoint(_ input: GetSignalingChannelEndpointInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSignalingChannelEndpointOutput {
        return try await self.client.execute(operation: "GetSignalingChannelEndpoint", path: "/getSignalingChannelEndpoint", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSignalingChannels(_ input: ListSignalingChannelsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSignalingChannelsOutput {
        return try await self.client.execute(operation: "ListSignalingChannels", path: "/listSignalingChannels", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTagsForStream(_ input: ListTagsForStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTagsForStreamOutput {
        return try await self.client.execute(operation: "ListTagsForStream", path: "/listTagsForStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startEdgeConfigurationUpdate(_ input: StartEdgeConfigurationUpdateInput, logger: Logger = AWSClient.loggingDisabled) async throws -> StartEdgeConfigurationUpdateOutput {
        return try await self.client.execute(operation: "StartEdgeConfigurationUpdate", path: "/startEdgeConfigurationUpdate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func tagStream(_ input: TagStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> TagStreamOutput {
        return try await self.client.execute(operation: "TagStream", path: "/tagStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func untagStream(_ input: UntagStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UntagStreamOutput {
        return try await self.client.execute(operation: "UntagStream", path: "/untagStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateDataRetention(_ input: UpdateDataRetentionInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateDataRetentionOutput {
        return try await self.client.execute(operation: "UpdateDataRetention", path: "/updateDataRetention", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateImageGenerationConfiguration(_ input: UpdateImageGenerationConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateImageGenerationConfigurationOutput {
        return try await self.client.execute(operation: "UpdateImageGenerationConfiguration", path: "/updateImageGenerationConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateMediaStorageConfiguration(_ input: UpdateMediaStorageConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateMediaStorageConfigurationOutput {
        return try await self.client.execute(operation: "UpdateMediaStorageConfiguration", path: "/updateMediaStorageConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateNotificationConfiguration(_ input: UpdateNotificationConfigurationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateNotificationConfigurationOutput {
        return try await self.client.execute(operation: "UpdateNotificationConfiguration", path: "/updateNotificationConfiguration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateSignalingChannel(_ input: UpdateSignalingChannelInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateSignalingChannelOutput {
        return try await self.client.execute(operation: "UpdateSignalingChannel", path: "/updateSignalingChannel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateStream(_ input: UpdateStreamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateStreamOutput {
        return try await self.client.execute(operation: "UpdateStream", path: "/updateStream", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
