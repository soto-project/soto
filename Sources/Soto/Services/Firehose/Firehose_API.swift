...
public struct Firehose: AWSService {
    ...
    public func createDeliveryStream(_ input: CreateDeliveryStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDeliveryStreamOutput> {
        return self.client.execute(operation: "CreateDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteDeliveryStream(_ input: DeleteDeliveryStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDeliveryStreamOutput> {
        return self.client.execute(operation: "DeleteDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeDeliveryStream(_ input: DescribeDeliveryStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDeliveryStreamOutput> {
        return self.client.execute(operation: "DescribeDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listDeliveryStreams(_ input: ListDeliveryStreamsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDeliveryStreamsOutput> {
        return self.client.execute(operation: "ListDeliveryStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Lists the tags for the specified delivery stream. This operation has a limit of five transactions per second per account.
    public func listTagsForDeliveryStream(_ input: ListTagsForDeliveryStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForDeliveryStreamOutput> {
        return self.client.execute(operation: "ListTagsForDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putRecord(_ input: PutRecordInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRecordOutput> {
        return self.client.execute(operation: "PutRecord", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putRecordBatch(_ input: PutRecordBatchInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRecordBatchOutput> {
        return self.client.execute(operation: "PutRecordBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startDeliveryStreamEncryption(_ input: StartDeliveryStreamEncryptionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDeliveryStreamEncryptionOutput> {
        return self.client.execute(operation: "StartDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func stopDeliveryStreamEncryption(_ input: StopDeliveryStreamEncryptionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopDeliveryStreamEncryptionOutput> {
        return self.client.execute(operation: "StopDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func tagDeliveryStream(_ input: TagDeliveryStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagDeliveryStreamOutput> {
        return self.client.execute(operation: "TagDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func untagDeliveryStream(_ input: UntagDeliveryStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagDeliveryStreamOutput> {
        return self.client.execute(operation: "UntagDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateDestination(_ input: UpdateDestinationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDestinationOutput> {
        return self.client.execute(operation: "UpdateDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
