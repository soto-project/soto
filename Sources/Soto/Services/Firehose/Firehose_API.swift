...
public struct Firehose: AWSService {
    ...
    public func createDeliveryStream(_ input: CreateDeliveryStreamInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateDeliveryStreamOutput> {
        return self.client.execute(operation: "CreateDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteDeliveryStream(_ input: DeleteDeliveryStreamInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteDeliveryStreamOutput> {
        return self.client.execute(operation: "DeleteDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeDeliveryStream(_ input: DescribeDeliveryStreamInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeDeliveryStreamOutput> {
        return self.client.execute(operation: "DescribeDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listDeliveryStreams(_ input: ListDeliveryStreamsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListDeliveryStreamsOutput> {
        return self.client.execute(operation: "ListDeliveryStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }

    ///  Lists the tags for the specified delivery stream. This operation has a limit of five transactions per second per account.
    public func listTagsForDeliveryStream(_ input: ListTagsForDeliveryStreamInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTagsForDeliveryStreamOutput> {
        return self.client.execute(operation: "ListTagsForDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putRecord(_ input: PutRecordInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutRecordOutput> {
        return self.client.execute(operation: "PutRecord", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putRecordBatch(_ input: PutRecordBatchInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutRecordBatchOutput> {
        return self.client.execute(operation: "PutRecordBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func startDeliveryStreamEncryption(_ input: StartDeliveryStreamEncryptionInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StartDeliveryStreamEncryptionOutput> {
        return self.client.execute(operation: "StartDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func stopDeliveryStreamEncryption(_ input: StopDeliveryStreamEncryptionInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StopDeliveryStreamEncryptionOutput> {
        return self.client.execute(operation: "StopDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func tagDeliveryStream(_ input: TagDeliveryStreamInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<TagDeliveryStreamOutput> {
        return self.client.execute(operation: "TagDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func untagDeliveryStream(_ input: UntagDeliveryStreamInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UntagDeliveryStreamOutput> {
        return self.client.execute(operation: "UntagDeliveryStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateDestination(_ input: UpdateDestinationInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateDestinationOutput> {
        return self.client.execute(operation: "UpdateDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
}
