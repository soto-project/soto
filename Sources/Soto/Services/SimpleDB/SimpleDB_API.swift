...
public struct SimpleDB: AWSService {
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "BatchDeleteAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "BatchPutAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func createDomain(_ input: CreateDomainRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteAttributes(_ input: DeleteAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteDomain(_ input: DeleteDomainRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    public func domainMetadata(_ input: DomainMetadataRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DomainMetadataResult> {
        return self.client.execute(operation: "DomainMetadata", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getAttributes(_ input: GetAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAttributesResult> {
        return self.client.execute(operation: "GetAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func putAttributes(_ input: PutAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    public func select(_ input: SelectRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SelectResult> {
        return self.client.execute(operation: "Select", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
