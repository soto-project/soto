...
extension SESv2 {
    ...
    public enum DkimSigningAttributesOrigin: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        ...
        case awsSesApSoutheast5 = "AWS_SES_AP_SOUTHEAST_5"
        case awsSesCaCentral1 = "AWS_SES_CA_CENTRAL_1"
        case awsSesCaWest1 = "AWS_SES_CA_WEST_1"
    ...
    public struct ArchivingOptions: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.archiveArn, name: "archiveArn", parent: name, pattern: "^arn:(aws|aws-[a-z-]+):ses:[a-z]{2,4}-[a-z-]+-[0-9]:[0-9]{1,20}:mailmanager-archive/a-[a-z0-9]{24,62}$")
        }
    ...
    public struct MessageInsightsFilters: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        public init(destination: [String]? = nil, fromEmailAddress: [String]? = nil, isp: [String]? = nil, lastDeliveryEvent: [DeliveryEventType]? = nil, lastEngagementEvent: [EngagementEventType]? = nil, subject: [String]? = nil, tenantName: [String]? = nil) {
            self.destination = destination
            self.fromEmailAddress = fromEmailAddress
            self.isp = isp
        ...
        public func validate(name: String) throws {
            ...
            try self.tenantName?.forEach {
                try validate($0, name: "tenantName[]", parent: name, min: 1)
            }
            try self.validate(self.tenantName, name: "tenantName", parent: name, max: 5)
        }
