...
extension Inspector2 {
    ...
    public enum AccountSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
    ...
    public enum AggregationFindingType: String, CustomStringConvertible, Codable {
        case networkReachability = "NETWORK_REACHABILITY"
        case packageVulnerability = "PACKAGE_VULNERABILITY"
        public var description: String { return self.rawValue }
    }

    public enum AggregationResourceType: String, CustomStringConvertible, Codable {
    ...
    public enum AmiSortBy: String, CustomStringConvertible, Codable {
    ...
    public enum AwsEcrContainerSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case critical = "CRITICAL"
        case high = "HIGH"
        public var description: String { return self.rawValue }
    ...
    public enum CoverageMapComparison: String, CustomStringConvertible, Codable {
        case equals = "EQUALS"
        public var description: String { return self.rawValue }
    }

    public enum CoverageResourceType: String, CustomStringConvertible, Codable {
        case awsEc2Instance = "AWS_EC2_INSTANCE"
        case awsEcrContainerImage = "AWS_ECR_CONTAINER_IMAGE"
    ...
    public enum CoverageStringComparison: String, CustomStringConvertible, Codable {
        case equals = "EQUALS"
    ...
    public enum DelegatedAdminStatus: String, CustomStringConvertible, Codable {
        case disableInProgress = "DISABLE_IN_PROGRESS"
        case enabled = "ENABLED"
        public var description: String { return self.rawValue }
    }

    public enum Ec2InstanceSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case critical = "CRITICAL"
        case high = "HIGH"
    ...
    public enum EcrScanFrequency: String, CustomStringConvertible, Codable {
    ...
    public enum ExternalReportStatus: String, CustomStringConvertible, Codable {
    ...
    public enum FindingTypeSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case critical = "CRITICAL"
        case high = "HIGH"
        public var description: String { return self.rawValue }
    ...
    public enum FreeTrialInfoErrorCode: String, CustomStringConvertible, Codable {
        case accessDenied = "ACCESS_DENIED"
        case internalError = "INTERNAL_ERROR"
        public var description: String { return self.rawValue }
    }

    public enum FreeTrialStatus: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
        case inactive = "INACTIVE"
        public var description: String { return self.rawValue }
    }

    public enum FreeTrialType: String, CustomStringConvertible, Codable {
        case ec2 = "EC2"
        case ecr = "ECR"
        public var description: String { return self.rawValue }
    }

    public enum GroupKey: String, CustomStringConvertible, Codable {
    ...
    public enum ImageLayerSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case critical = "CRITICAL"
        case high = "HIGH"
        public var description: String { return self.rawValue }
    ...
    public enum MapComparison: String, CustomStringConvertible, Codable {
        case equals = "EQUALS"
        public var description: String { return self.rawValue }
    }
    ...
    public enum PackageManager: String, CustomStringConvertible, Codable {
    ...
    public enum PackageSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case critical = "CRITICAL"
        case high = "HIGH"
        public var description: String { return self.rawValue }
    ...
    public enum ReportingErrorCode: String, CustomStringConvertible, Codable {
        case internalError = "INTERNAL_ERROR"
        case invalidPermissions = "INVALID_PERMISSIONS"
        public var description: String { return self.rawValue }
    }

    public enum RepositorySortBy: String, CustomStringConvertible, Codable {
    ...
    public enum ResourceScanType: String, CustomStringConvertible, Codable {
        case ec2 = "EC2"
        case ecr = "ECR"
        public var description: String { return self.rawValue }
    }
    ...
    public enum ScanStatusCode: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
        case inactive = "INACTIVE"
        public var description: String { return self.rawValue }
    }

    public enum ScanStatusReason: String, CustomStringConvertible, Codable {
        case accessDenied = "ACCESS_DENIED"
    ...
    public enum SortField: String, CustomStringConvertible, Codable {
    ...
    public enum StringComparison: String, CustomStringConvertible, Codable {
        case equals = "EQUALS"
        case notEquals = "NOT_EQUALS"
        case prefix = "PREFIX"
        public var description: String { return self.rawValue }
    ...
    public enum TitleSortBy: String, CustomStringConvertible, Codable {
        case all = "ALL"
        case critical = "CRITICAL"
        case high = "HIGH"
        public var description: String { return self.rawValue }
    ...
    public struct AggregationRequest: AWSEncodableShape {
        /// An object that contains details about an aggregation request based on Amazon Web Services account IDs.
        public let accountAggregation: AccountAggregation?
        /// An object that contains details about an aggregation request based on Amazon Machine Images (AMIs).
        public let amiAggregation: AmiAggregation?
        /// An object that contains details about an aggregation request based on Amazon ECR container images.
        public let awsEcrContainerAggregation: AwsEcrContainerAggregation?
        /// An object that contains details about an aggregation request based on Amazon EC2 instances.
        public let ec2InstanceAggregation: Ec2InstanceAggregation?
        /// An object that contains details about an aggregation request based on finding types.
        public let findingTypeAggregation: FindingTypeAggregation?
        /// An object that contains details about an aggregation request based on container image layers.
        public let imageLayerAggregation: ImageLayerAggregation?
        /// An object that contains details about an aggregation request based on operating system package type.
        public let packageAggregation: PackageAggregation?
        /// An object that contains details about an aggregation request based on Amazon ECR repositories.
        public let repositoryAggregation: RepositoryAggregation?
        /// An object that contains details about an aggregation request based on finding title.
        public let titleAggregation: TitleAggregation?

        public init(accountAggregation: AccountAggregation? = nil, amiAggregation: AmiAggregation? = nil, awsEcrContainerAggregation: AwsEcrContainerAggregation? = nil, ec2InstanceAggregation: Ec2InstanceAggregation? = nil, findingTypeAggregation: FindingTypeAggregation? = nil, imageLayerAggregation: ImageLayerAggregation? = nil, packageAggregation: PackageAggregation? = nil, repositoryAggregation: RepositoryAggregation? = nil, titleAggregation: TitleAggregation? = nil) {
        ...
        public func validate(name: String) throws {
            try self.amiAggregation?.validate(name: "\(name).amiAggregation")
            try self.awsEcrContainerAggregation?.validate(name: "\(name).awsEcrContainerAggregation")
            try self.ec2InstanceAggregation?.validate(name: "\(name).ec2InstanceAggregation")
            try self.imageLayerAggregation?.validate(name: "\(name).imageLayerAggregation")
            try self.packageAggregation?.validate(name: "\(name).packageAggregation")
            try self.repositoryAggregation?.validate(name: "\(name).repositoryAggregation")
            try self.titleAggregation?.validate(name: "\(name).titleAggregation")
        }
    ...
    public struct AggregationResponse: AWSDecodableShape {
        /// An object that contains details about an aggregation response based on Amazon Web Services account IDs.
        public let accountAggregation: AccountAggregationResponse?
        /// An object that contains details about an aggregation response based on Amazon Machine Images (AMIs).
        public let amiAggregation: AmiAggregationResponse?
        /// An object that contains details about an aggregation response based on Amazon ECR container images.
        public let awsEcrContainerAggregation: AwsEcrContainerAggregationResponse?
        /// An object that contains details about an aggregation response based on Amazon EC2 instances.
        public let ec2InstanceAggregation: Ec2InstanceAggregationResponse?
        /// An object that contains details about an aggregation response based on finding types.
        public let findingTypeAggregation: FindingTypeAggregationResponse?
        /// An object that contains details about an aggregation response based on container image layers.
        public let imageLayerAggregation: ImageLayerAggregationResponse?
        /// An object that contains details about an aggregation response based on operating system package type.
        public let packageAggregation: PackageAggregationResponse?
        /// An object that contains details about an aggregation response based on Amazon ECR repositories.
        public let repositoryAggregation: RepositoryAggregationResponse?
        /// An object that contains details about an aggregation response based on finding title.
        public let titleAggregation: TitleAggregationResponse?

        public init(accountAggregation: AccountAggregationResponse? = nil, amiAggregation: AmiAggregationResponse? = nil, awsEcrContainerAggregation: AwsEcrContainerAggregationResponse? = nil, ec2InstanceAggregation: Ec2InstanceAggregationResponse? = nil, findingTypeAggregation: FindingTypeAggregationResponse? = nil, imageLayerAggregation: ImageLayerAggregationResponse? = nil, packageAggregation: PackageAggregationResponse? = nil, repositoryAggregation: RepositoryAggregationResponse? = nil, titleAggregation: TitleAggregationResponse? = nil) {
            self.accountAggregation = accountAggregation
            self.amiAggregation = amiAggregation
            self.awsEcrContainerAggregation = awsEcrContainerAggregation
            self.ec2InstanceAggregation = ec2InstanceAggregation
