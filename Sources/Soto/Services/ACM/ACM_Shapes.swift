...
extension ACM {
    ...
    public enum CertificateTransparencyLoggingPreference: String, CustomStringConvertible, Codable, _SotoSendable {
    ...
    public enum ExtendedKeyUsageName: String, CustomStringConvertible, Codable, _SotoSendable {
        case any = "ANY"
    ...
    public enum KeyUsageName: String, CustomStringConvertible, Codable, _SotoSendable {
        case any = "ANY"
    ...
    public enum RenewalEligibility: String, CustomStringConvertible, Codable, _SotoSendable {
    ...
    public enum ValidationMethod: String, CustomStringConvertible, Codable, _SotoSendable {
        case dns = "DNS"
        case email = "EMAIL"
        public var description: String { return self.rawValue }
    }
    ...
    public struct ExportCertificateRequest: AWSEncodableShape {
        ...
        public let passphrase: AWSBlob

        public init(certificateArn: String, passphrase: AWSBlob) {
            self.certificateArn = certificateArn
    ...
    public struct ImportCertificateRequest: AWSEncodableShape {
        ...
        public let certificate: AWSBlob
        /// The Amazon Resource Name (ARN) of an imported certificate to replace. To import a new certificate, omit this field.
        public let certificateArn: String?
        /// The PEM encoded certificate chain.
        public let certificateChain: AWSBlob?
        /// The private key that matches the public key in the certificate.
        public let privateKey: AWSBlob
        ...
        public init(certificate: AWSBlob, certificateArn: String? = nil, certificateChain: AWSBlob? = nil, privateKey: AWSBlob, tags: [Tag]? = nil) {
            self.certificate = certificate
            self.certificateArn = certificateArn
            self.certificateChain = certificateChain
            self.privateKey = privateKey
    ...
    public struct RequestCertificateRequest: AWSEncodableShape {
        ...
        ///     (63 octets).(63 octets).(63 octets).(61 octets) is legal because the total length is 253 octets (63+1+63+1+63+1+61) and no label exceeds 63 octets.    (64 octets).(63 octets).(63 octets).(61 octets) is not legal because the total length exceeds 253 octets (64+1+63+1+63+1+61) and the first label exceeds 63 octets.    (63 octets).(63 octets).(63 octets).(62 octets) is not legal because the total length of the DNS name (63+1+63+1+63+1+62) exceeds 253 octets.
        public let subjectAlternativeNames: [String]?
