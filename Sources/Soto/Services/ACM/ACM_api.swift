...
public struct ACM: AWSService {
    ...
    public func addTagsToCertificate(_ input: AddTagsToCertificateRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "AddTagsToCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func exportCertificate(_ input: ExportCertificateRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ExportCertificateResponse {
        return try await self.client.execute(operation: "ExportCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getAccountConfiguration(logger: Logger = AWSClient.loggingDisabled) async throws -> GetAccountConfigurationResponse {
        return try await self.client.execute(operation: "GetAccountConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, logger: logger)
    }
    ...
    public func listTagsForCertificate(_ input: ListTagsForCertificateRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTagsForCertificateResponse {
        return try await self.client.execute(operation: "ListTagsForCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putAccountConfiguration(_ input: PutAccountConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "PutAccountConfiguration", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func removeTagsFromCertificate(_ input: RemoveTagsFromCertificateRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "RemoveTagsFromCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func renewCertificate(_ input: RenewCertificateRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "RenewCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func requestCertificate(_ input: RequestCertificateRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> RequestCertificateResponse {
        return try await self.client.execute(operation: "RequestCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func resendValidationEmail(_ input: ResendValidationEmailRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "ResendValidationEmail", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateCertificateOptions(_ input: UpdateCertificateOptionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "UpdateCertificateOptions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
