...
extension Connect {
    ...
    public enum ContactState: String, CustomStringConvertible, Codable {
    ...
    public enum TaskTemplateFieldType: String, CustomStringConvertible, Codable {
    ...
    public enum TaskTemplateStatus: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
    ...
    public struct DeleteTaskTemplateRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "instanceId", location: .uri(locationName: "InstanceId")),
            AWSMemberEncoding(label: "taskTemplateId", location: .uri(locationName: "TaskTemplateId"))
        ]
    ...
    public struct GetTaskTemplateRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "instanceId", location: .uri(locationName: "InstanceId")),
            AWSMemberEncoding(label: "snapshotVersion", location: .querystring(locationName: "snapshotVersion")),
            AWSMemberEncoding(label: "taskTemplateId", location: .uri(locationName: "TaskTemplateId"))
        ]
    ...
    public struct ReferenceSummary: AWSDecodableShape {
        ...
        public let date: DateReference?
        /// Information about a reference when the referenceType is EMAIL. Otherwise, null.
        public let email: EmailReference?
        /// Information about a reference when the referenceType is NUMBER. Otherwise, null.
        public let number: NumberReference?
        /// Information about a reference when the referenceType is STRING. Otherwise, null.
        public let string: StringReference?
        /// Information about the reference when the referenceType is URL. Otherwise, null.
        public let url: UrlReference?

        public init(attachment: AttachmentReference? = nil, date: DateReference? = nil, email: EmailReference? = nil, number: NumberReference? = nil, string: StringReference? = nil, url: UrlReference? = nil) {
