...
public struct Connect: AWSService {
    ...
    public func associateContactWithUser(_ input: AssociateContactWithUserRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateContactWithUserResponse {
        try await self.client.execute(
            ...
            path: "/contacts/{InstanceId}/{ContactId}/associate-user", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func associateContactWithUser(
        contactId: String,
        instanceId: String,
        userId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> AssociateContactWithUserResponse {
        let input = AssociateContactWithUserRequest(
            contactId: contactId, 
            instanceId: instanceId, 
            userId: userId
        )
    ...
    public func associateRoutingProfileQueues(
        instanceId: String,
        manualAssignmentQueueConfigs: [RoutingProfileManualAssignmentQueueConfig]? = nil,
    ...
    public func createPredefinedAttribute(
        attributeConfiguration: InputPredefinedAttributeConfiguration? = nil,
        instanceId: String,
        name: String,
        purposes: [String]? = nil,
    ...
    public func disassociateRoutingProfileQueues(
        instanceId: String,
        manualAssignmentQueueReferences: [RoutingProfileQueueReference]? = nil,
    ...
    public func getContactMetrics(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetContactMetricsResponse {
        let input = GetContactMetricsRequest(
            contactId: contactId, 
            instanceId: instanceId, 
            metrics: metrics
        )
    ...
    public func listRoutingProfileManualAssignmentQueues(_ input: ListRoutingProfileManualAssignmentQueuesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListRoutingProfileManualAssignmentQueuesResponse {
        try await self.client.execute(
            ...
            path: "/routing-profiles/{InstanceId}/{RoutingProfileId}/manual-assignment-queues", 
            httpMethod: .GET, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func listRoutingProfileManualAssignmentQueues(
        instanceId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        routingProfileId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListRoutingProfileManualAssignmentQueuesResponse {
        let input = ListRoutingProfileManualAssignmentQueuesRequest(
            instanceId: instanceId, 
            maxResults: maxResults, 
            nextToken: nextToken, 
            routingProfileId: routingProfileId
        )
        return try await self.listRoutingProfileManualAssignmentQueues(input, logger: logger)
    }
...
extension Connect {
    ...
    ///   - logger: Logger used for logging
    @inlinable
    public func listRoutingProfileManualAssignmentQueuesPaginator(
        _ input: ListRoutingProfileManualAssignmentQueuesRequest,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<ListRoutingProfileManualAssignmentQueuesRequest, ListRoutingProfileManualAssignmentQueuesResponse> {
        return .init(
            input: input,
            command: self.listRoutingProfileManualAssignmentQueues,
            inputKey: \ListRoutingProfileManualAssignmentQueuesRequest.nextToken,
            outputKey: \ListRoutingProfileManualAssignmentQueuesResponse.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``listRoutingProfileManualAssignmentQueues(_:logger:)``.
    ...
    public func listRoutingProfileManualAssignmentQueuesPaginator(
        ...
        return self.listRoutingProfileManualAssignmentQueuesPaginator(input, logger: logger)
    }
...
extension Connect.ListRoutingProfileManualAssignmentQueuesRequest: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> Connect.ListRoutingProfileManualAssignmentQueuesRequest {
        return .init(
            instanceId: self.instanceId,
            maxResults: self.maxResults,
            nextToken: token,
