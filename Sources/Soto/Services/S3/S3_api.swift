...
public struct S3: AWSService {
    ...
    @Sendable
    @inlinable
    public func createBucketMetadataConfiguration(_ input: CreateBucketMetadataConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await S3Middleware.$executionContext.withValue(.init(useS3ExpressControlEndpoint: true)) {
            try await self.client.execute(
                operation: "CreateBucketMetadataConfiguration", 
                path: "/{Bucket}?metadataConfiguration", 
                httpMethod: .POST, 
                serviceConfig: self.config, 
                input: input, 
                logger: logger
    ...
    ///
    /// Parameters:
    ///   - bucket:  The general purpose bucket that you want to create the metadata configuration for.
    ///   - checksumAlgorithm:  The checksum algorithm to use with your metadata configuration.
    ///   - contentMD5:  The Content-MD5 header for the metadata configuration.
    ///   - expectedBucketOwner:  The expected owner of the general purpose bucket that corresponds to your metadata configuration.
    ///   - metadataConfiguration:  The contents of your metadata configuration.
    ///   - logger: Logger use during operation
    @inlinable
    public func createBucketMetadataConfiguration(
        bucket: String,
        checksumAlgorithm: ChecksumAlgorithm? = nil,
        ...
        let input = CreateBucketMetadataConfigurationRequest(
            bucket: bucket, 
            checksumAlgorithm: checksumAlgorithm, 
        ...
        return try await self.createBucketMetadataConfiguration(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - bucket:  The general purpose bucket that you want to create the metadata table configuration for.
    ...
    @Sendable
    @inlinable
    public func deleteBucketMetadataConfiguration(_ input: DeleteBucketMetadataConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await S3Middleware.$executionContext.withValue(.init(useS3ExpressControlEndpoint: true)) {
            try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - bucket:  The general purpose bucket that you want to remove the metadata configuration from.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteBucketMetadataConfiguration(
        bucket: String,
        expectedBucketOwner: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteBucketMetadataConfigurationRequest(
            bucket: bucket, 
            expectedBucketOwner: expectedBucketOwner
        )
        return try await self.deleteBucketMetadataConfiguration(input, logger: logger)
    }
    ...
    ///  This operation is not supported for directory buckets.  Deletes tags from the general purpose bucket if attribute based access control (ABAC) is not enabled for the bucket. When you enable ABAC for a general purpose bucket, you can no longer use this operation for that bucket and must use UntagResource instead. if ABAC is not enabled for the bucket. When you enable ABAC for a general purpose bucket, you can no longer use this operation for that bucket and must use UntagResource instead. To use this operation, you must have permission to perform the s3:PutBucketTagging action. By default, the bucket owner has this permission and can grant this permission to others.  The following operations are related to DeleteBucketTagging:    GetBucketTagging     PutBucketTagging     You must URL encode any signed header values that contain spaces. For example, if your header value is my  file.txt, containing two spaces after my, you must URL encode this value to my%20%20file.txt.
    @Sendable
    @inlinable
    ...
    @Sendable
    @inlinable
    public func getBucketAbac(_ input: GetBucketAbacRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBucketAbacOutput {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getBucketAbac(
        bucket: String,
        expectedBucketOwner: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetBucketAbacOutput {
        let input = GetBucketAbacRequest(
            bucket: bucket, 
            expectedBucketOwner: expectedBucketOwner
        )
        return try await self.getBucketAbac(input, logger: logger)
    }
    ...
    /// If the Object Lambda access point alias in a request is not valid, the error code InvalidAccessPointAliasError is returned.
    /// For more information about InvalidAccessPointAliasError, see List of Error Codes. For more information about CORS, see  Enabling Cross-Origin Resource Sharing. The following operations are related to GetBucketCors:    PutBucketCors     DeleteBucketCors     You must URL encode any signed header values that contain spaces. For example, if your header value is my  file.txt, containing two spaces after my, you must URL encode this value to my%20%20file.txt.
    @Sendable
    @inlinable
    ...
    @Sendable
    @inlinable
    public func getBucketMetadataConfiguration(_ input: GetBucketMetadataConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBucketMetadataConfigurationOutput {
        try await S3Middleware.$executionContext.withValue(.init(useS3ExpressControlEndpoint: true)) {
            try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - bucket:  The general purpose bucket that corresponds to the metadata configuration that you want to retrieve.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getBucketMetadataConfiguration(
        bucket: String,
        expectedBucketOwner: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetBucketMetadataConfigurationOutput {
        let input = GetBucketMetadataConfigurationRequest(
            bucket: bucket, 
            expectedBucketOwner: expectedBucketOwner
        )
        return try await self.getBucketMetadataConfiguration(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - bucket:  The general purpose bucket that corresponds to the metadata table configuration that you want to retrieve.
    ///   - expectedBucketOwner:  The expected owner of the general purpose bucket that you want to retrieve the metadata table configuration for.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///  This operation is not supported for directory buckets.  Returns the tag set associated with the general purpose bucket. if ABAC is not enabled for the bucket. When you enable ABAC for a general purpose bucket, you can no longer use this operation for that bucket and must use ListTagsForResource instead. To use this operation, you must have permission to perform the s3:GetBucketTagging action. By default, the bucket owner has this permission and can grant this permission to others.  GetBucketTagging has the following special error:   Error code: NoSuchTagSet    Description: There is no tag set associated with the bucket.     The following operations are related to GetBucketTagging:    PutBucketTagging     DeleteBucketTagging     You must URL encode any signed header values that contain spaces. For example, if your header value is my  file.txt, containing two spaces after my, you must URL encode this value to my%20%20file.txt.
    @Sendable
    @inlinable
    ...
    ///   - partNumberMarker: Specifies the part after which listing should begin. Only parts with higher part numbers will be listed. For more information, see Uploading and copying objects using multipart upload in Amazon S3  in the Amazon Simple Storage Service user guide.
    ///   - requestPayer: 
    ///   - sseCustomerAlgorithm: Specifies the algorithm to use when encrypting the object (for example, AES256).  This functionality is not supported for directory buckets.
    ///   - sseCustomerKey: Specifies the customer-provided encryption key for Amazon S3 to use in encrypting data. This value is used to store the object and then it is discarded; Amazon S3 does not store the encryption key. The key must be appropriate for use with the algorithm specified in the x-amz-server-side-encryption-customer-algorithm header.  This functionality is not supported for directory buckets.
    ...
    ///   - delimiter: A delimiter is a character that you use to group keys.  CommonPrefixes is filtered out from results if it is not lexicographically greater than the key-marker.
    ///   - encodingType: 
    ///   - expectedBucketOwner: The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code 403 Forbidden (access denied).
    ...
    @Sendable
    @inlinable
    public func putBucketAbac(_ input: PutBucketAbacRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///   - contentMD5: The MD5 hash of the PutBucketAbac request body.  For requests made using the Amazon Web Services Command Line Interface (CLI) or Amazon Web Services SDKs, this field is calculated automatically.
    ///   - expectedBucketOwner: The Amazon Web Services account ID of the general purpose bucket's owner.
    ///   - logger: Logger use during operation
    @inlinable
    public func putBucketAbac(
        ...
        let input = PutBucketAbacRequest(
            abacStatus: abacStatus, 
            bucket: bucket, 
            checksumAlgorithm: checksumAlgorithm, 
            contentMD5: contentMD5, 
        ...
        return try await self.putBucketAbac(input, logger: logger)
    }
    ...
    ///   - contentMD5: >The Base64 encoded 128-bit MD5 digest of the data. You must use this header as a message integrity check to verify that the request body was not corrupted in transit. For more information, see RFC 1864. For requests made using the Amazon Web Services Command Line Interface (CLI) or Amazon Web Services SDKs, this field is calculated automatically.
    ///   - expectedBucketOwner: The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code 403 Forbidden (access denied).
    ///   - mfa: The concatenation of the authentication device's serial number, a space, and the value that is displayed on your authentication device. The serial number is the number that uniquely identifies the MFA device. For physical MFA devices, this is the unique serial number that's provided with the device. For virtual MFA devices, the serial number is the device ARN. For more information, see Enabling versioning on buckets and Configuring MFA delete in the Amazon Simple Storage Service User Guide.
    ...
    ///   - requestPayer: Confirms that the requester knows that she or he will be charged for the tagging object request. Bucket owners need not specify this parameter in their requests.
    ///   - tagging: Container for the TagSet and Tag elements
    ...
    @Sendable
    @inlinable
    public func renameObject(_ input: RenameObjectRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> RenameObjectOutput {
        try await self.client.execute(
            operation: "RenameObject", 
            path: "/{Bucket}/{Key+}?renameObject", 
            httpMethod: .PUT, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    public func renameObject(
        bucket: String,
        clientToken: String? = RenameObjectRequest.idempotencyToken(),
        destinationIfMatch: String? = nil,
        destinationIfModifiedSince: Date? = nil,
        destinationIfNoneMatch: String? = nil,
        destinationIfUnmodifiedSince: Date? = nil,
        key: String,
        renameSource: String,
        sourceIfMatch: String? = nil,
        sourceIfModifiedSince: Date? = nil,
        sourceIfNoneMatch: String? = nil,
        sourceIfUnmodifiedSince: Date? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> RenameObjectOutput {
        let input = RenameObjectRequest(
            bucket: bucket, 
        ...
        return try await self.renameObject(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func updateBucketMetadataInventoryTableConfiguration(_ input: UpdateBucketMetadataInventoryTableConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await S3Middleware.$executionContext.withValue(.init(useS3ExpressControlEndpoint: true)) {
            try await self.client.execute(
                operation: "UpdateBucketMetadataInventoryTableConfiguration", 
                path: "/{Bucket}?metadataInventoryTable", 
                httpMethod: .PUT, 
                serviceConfig: self.config, 
                input: input, 
                logger: logger
    ...
    ///   - contentMD5:  The Content-MD5 header for the inventory table configuration.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func updateBucketMetadataInventoryTableConfiguration(
        bucket: String,
        checksumAlgorithm: ChecksumAlgorithm? = nil,
        contentMD5: String? = nil,
        expectedBucketOwner: String? = nil,
        ...
        let input = UpdateBucketMetadataInventoryTableConfigurationRequest(
            bucket: bucket, 
            checksumAlgorithm: checksumAlgorithm, 
            contentMD5: contentMD5, 
            expectedBucketOwner: expectedBucketOwner, 
        ...
        return try await self.updateBucketMetadataInventoryTableConfiguration(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func updateBucketMetadataJournalTableConfiguration(_ input: UpdateBucketMetadataJournalTableConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await S3Middleware.$executionContext.withValue(.init(useS3ExpressControlEndpoint: true)) {
            try await self.client.execute(
                operation: "UpdateBucketMetadataJournalTableConfiguration", 
                path: "/{Bucket}?metadataJournalTable", 
                httpMethod: .PUT, 
                serviceConfig: self.config, 
                input: input, 
                logger: logger
    ...
    ///
    /// Parameters:
    ///   - bucket:  The general purpose bucket that corresponds to the metadata configuration that you want to  enable or disable journal table record expiration for.
    ///   - checksumAlgorithm:  The checksum algorithm to use with your journal table configuration.
    ///   - contentMD5:  The Content-MD5 header for the journal table configuration.
    ///   - expectedBucketOwner:  The expected owner of the general purpose bucket that corresponds to the metadata table  configuration that you want to enable or disable journal table record expiration for.
    ///   - journalTableConfiguration:  The contents of your journal table configuration.
    ///   - logger: Logger use during operation
    @inlinable
    public func updateBucketMetadataJournalTableConfiguration(
        ...
        let input = UpdateBucketMetadataJournalTableConfigurationRequest(
            bucket: bucket, 
            checksumAlgorithm: checksumAlgorithm, 
            contentMD5: contentMD5, 
            expectedBucketOwner: expectedBucketOwner, 
        ...
        return try await self.updateBucketMetadataJournalTableConfiguration(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func updateObjectEncryption(_ input: UpdateObjectEncryptionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateObjectEncryptionResponse {
        try await self.client.execute(
            operation: "UpdateObjectEncryption", 
            path: "/{Bucket}/{Key+}?encryption", 
            httpMethod: .PUT, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    public func updateObjectEncryption(
        ...
        versionId: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UpdateObjectEncryptionResponse {
        let input = UpdateObjectEncryptionRequest(
            bucket: bucket, 
            checksumAlgorithm: checksumAlgorithm, 
            contentMD5: contentMD5, 
            expectedBucketOwner: expectedBucketOwner, 
        ...
        return try await self.updateObjectEncryption(input, logger: logger)
    }
    ...
    ///   - serverSideEncryption:  The server-side encryption algorithm used when storing requested object in Amazon S3 or Amazon FSx.  When accessing data stored in Amazon FSx file systems using S3 access points, the only valid server side encryption option is aws:fsx.
