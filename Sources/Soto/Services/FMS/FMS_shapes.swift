...
extension FMS {
    ...
    public enum CustomerPolicyStatus: String, CustomStringConvertible, Codable, Sendable {
        case active = "ACTIVE"
    ...
    public enum ResourceSetStatus: String, CustomStringConvertible, Codable, Sendable {
        case active = "ACTIVE"
        case outOfAdminScope = "OUT_OF_ADMIN_SCOPE"
        public var description: String { return self.rawValue }
    }
