...
extension DynamoDB {
    ...
    public enum GlobalTableSettingsReplicationMode: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case disabled = "DISABLED"
        case enabled = "ENABLED"
        case enabledWithOverrides = "ENABLED_WITH_OVERRIDES"
        public var description: String { return self.rawValue }
    }
    ...
    public struct CreateTableInput: AWSEncodableShape {
        ...
        public let globalTableSettingsReplicationMode: GlobalTableSettingsReplicationMode?
        /// The Amazon Resource Name (ARN) of the source table used for the creation of a multi-account global table.
        public let globalTableSourceArn: String?
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.globalTableSourceArn, name: "globalTableSourceArn", parent: name, max: 1024)
            try self.validate(self.globalTableSourceArn, name: "globalTableSourceArn", parent: name, min: 1)
            try self.keySchema?.forEach {
                try $0.validate(name: "\(name).keySchema[]")
            }
            try self.validate(self.keySchema, name: "keySchema", parent: name, min: 1)
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case globalSecondaryIndexes = "GlobalSecondaryIndexes"
            case globalTableSettingsReplicationMode = "GlobalTableSettingsReplicationMode"
            case globalTableSourceArn = "GlobalTableSourceArn"
            case keySchema = "KeySchema"
            case localSecondaryIndexes = "LocalSecondaryIndexes"
            case onDemandThroughput = "OnDemandThroughput"
            case provisionedThroughput = "ProvisionedThroughput"
