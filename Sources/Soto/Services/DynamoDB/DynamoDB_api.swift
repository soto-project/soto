...
public struct DynamoDB: AWSService {
    ...
    public func batchExecuteStatement(_ input: BatchExecuteStatementInput, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchExecuteStatementOutput {
        return try await self.client.execute(operation: "BatchExecuteStatement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func batchGetItem(_ input: BatchGetItemInput, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchGetItemOutput {
        return try await self.client.execute(operation: "BatchGetItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func batchWriteItem(_ input: BatchWriteItemInput, logger: Logger = AWSClient.loggingDisabled) async throws -> BatchWriteItemOutput {
        return try await self.client.execute(operation: "BatchWriteItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func createBackup(_ input: CreateBackupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateBackupOutput {
        return try await self.client.execute(operation: "CreateBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateGlobalTableOutput {
        return try await self.client.execute(operation: "CreateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func createTable(_ input: CreateTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateTableOutput {
        return try await self.client.execute(operation: "CreateTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func deleteBackup(_ input: DeleteBackupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteBackupOutput {
        return try await self.client.execute(operation: "DeleteBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func deleteItem(_ input: DeleteItemInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteItemOutput {
        return try await self.client.execute(operation: "DeleteItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func deleteTable(_ input: DeleteTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteTableOutput {
        return try await self.client.execute(operation: "DeleteTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeBackup(_ input: DescribeBackupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeBackupOutput {
        return try await self.client.execute(operation: "DescribeBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeContinuousBackupsOutput {
        return try await self.client.execute(operation: "DescribeContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeContributorInsights(_ input: DescribeContributorInsightsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeContributorInsightsOutput {
        return try await self.client.execute(operation: "DescribeContributorInsights", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeExport(_ input: DescribeExportInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeExportOutput {
        return try await self.client.execute(operation: "DescribeExport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeGlobalTable(_ input: DescribeGlobalTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeGlobalTableOutput {
        return try await self.client.execute(operation: "DescribeGlobalTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeGlobalTableSettingsOutput {
        return try await self.client.execute(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeImport(_ input: DescribeImportInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeImportOutput {
        return try await self.client.execute(operation: "DescribeImport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeKinesisStreamingDestination(_ input: DescribeKinesisStreamingDestinationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeKinesisStreamingDestinationOutput {
        return try await self.client.execute(operation: "DescribeKinesisStreamingDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLimitsOutput {
        return try await self.client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeTable(_ input: DescribeTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTableOutput {
        return try await self.client.execute(operation: "DescribeTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func describeTableReplicaAutoScaling(_ input: DescribeTableReplicaAutoScalingInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTableReplicaAutoScalingOutput {
        return try await self.client.execute(operation: "DescribeTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeTimeToLive(_ input: DescribeTimeToLiveInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeTimeToLiveOutput {
        return try await self.client.execute(operation: "DescribeTimeToLive", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func disableKinesisStreamingDestination(_ input: KinesisStreamingDestinationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> KinesisStreamingDestinationOutput {
        return try await self.client.execute(operation: "DisableKinesisStreamingDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func enableKinesisStreamingDestination(_ input: KinesisStreamingDestinationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> KinesisStreamingDestinationOutput {
        return try await self.client.execute(operation: "EnableKinesisStreamingDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func executeStatement(_ input: ExecuteStatementInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ExecuteStatementOutput {
        return try await self.client.execute(operation: "ExecuteStatement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func executeTransaction(_ input: ExecuteTransactionInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ExecuteTransactionOutput {
        return try await self.client.execute(operation: "ExecuteTransaction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func exportTableToPointInTime(_ input: ExportTableToPointInTimeInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ExportTableToPointInTimeOutput {
        return try await self.client.execute(operation: "ExportTableToPointInTime", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getItem(_ input: GetItemInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetItemOutput {
        return try await self.client.execute(operation: "GetItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func importTable(_ input: ImportTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ImportTableOutput {
        return try await self.client.execute(operation: "ImportTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listBackups(_ input: ListBackupsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListBackupsOutput {
        return try await self.client.execute(operation: "ListBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func listContributorInsights(_ input: ListContributorInsightsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListContributorInsightsOutput {
        return try await self.client.execute(operation: "ListContributorInsights", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listExports(_ input: ListExportsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListExportsOutput {
        return try await self.client.execute(operation: "ListExports", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGlobalTablesOutput {
        return try await self.client.execute(operation: "ListGlobalTables", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func listImports(_ input: ListImportsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListImportsOutput {
        return try await self.client.execute(operation: "ListImports", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listTables(_ input: ListTablesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTablesOutput {
        return try await self.client.execute(operation: "ListTables", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func listTagsOfResource(_ input: ListTagsOfResourceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListTagsOfResourceOutput {
        return try await self.client.execute(operation: "ListTagsOfResource", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func putItem(_ input: PutItemInput, logger: Logger = AWSClient.loggingDisabled) async throws -> PutItemOutput {
        return try await self.client.execute(operation: "PutItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func query(_ input: QueryInput, logger: Logger = AWSClient.loggingDisabled) async throws -> QueryOutput {
        return try await self.client.execute(operation: "Query", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput, logger: Logger = AWSClient.loggingDisabled) async throws -> RestoreTableFromBackupOutput {
        return try await self.client.execute(operation: "RestoreTableFromBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput, logger: Logger = AWSClient.loggingDisabled) async throws -> RestoreTableToPointInTimeOutput {
        return try await self.client.execute(operation: "RestoreTableToPointInTime", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func scan(_ input: ScanInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ScanOutput {
        return try await self.client.execute(operation: "Scan", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func tagResource(_ input: TagResourceInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "TagResource", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func transactGetItems(_ input: TransactGetItemsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> TransactGetItemsOutput {
        return try await self.client.execute(operation: "TransactGetItems", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func transactWriteItems(_ input: TransactWriteItemsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> TransactWriteItemsOutput {
        return try await self.client.execute(operation: "TransactWriteItems", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func untagResource(_ input: UntagResourceInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "UntagResource", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateContinuousBackupsOutput {
        return try await self.client.execute(operation: "UpdateContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func updateContributorInsights(_ input: UpdateContributorInsightsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateContributorInsightsOutput {
        return try await self.client.execute(operation: "UpdateContributorInsights", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateGlobalTableOutput {
        return try await self.client.execute(operation: "UpdateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateGlobalTableSettingsOutput {
        return try await self.client.execute(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func updateItem(_ input: UpdateItemInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateItemOutput {
        return try await self.client.execute(operation: "UpdateItem", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func updateTable(_ input: UpdateTableInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateTableOutput {
        return try await self.client.execute(operation: "UpdateTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
    ...
    public func updateTableReplicaAutoScaling(_ input: UpdateTableReplicaAutoScalingInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateTableReplicaAutoScalingOutput {
        return try await self.client.execute(operation: "UpdateTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateTimeToLive(_ input: UpdateTimeToLiveInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateTimeToLiveOutput {
        return try await self.client.execute(operation: "UpdateTimeToLive", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: false), logger: logger)
    }
