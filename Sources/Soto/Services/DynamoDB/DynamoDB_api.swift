...
public struct DynamoDB: AWSService {
    ...
    ///   - vectorIndexOverride: The vector indexes for the restored table. If not specified, all vector indexes from the backup are restored. The indexes provided must match existing vector indexes from the backup. You can choose to exclude some or all of the vector indexes at the time of restore.
    ///   - logger: Logger use during operation
    @inlinable
    public func restoreTableFromBackup(
        ...
        vectorIndexOverride: [VectorIndex]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    @Sendable
    @inlinable
    public func searchVectors(_ input: SearchVectorsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> SearchVectorsOutput {
        try await self.client.execute(
    ...
    ///   - returnConsumedCapacity: 
    ///   - searchConditionExpression: A condition expression used to filter the vector search results. The expression can reference attributes defined in the vector index search schema, including HASH and INLINE_FILTER key elements. Only the equality operator (=) is supported for HASH attributes. Comparison and range operators are supported for INLINE_FILTER attributes. Only top-level attributes from the search schema can be referenced.
    ...
    public func searchVectors(
        ...
        projectionExpression: String? = nil,
        returnConsumedCapacity: ReturnConsumedCapacity? = nil,
        searchConditionExpression: String? = nil,
        searchVector: [AttributeValue],
        tableName: String,
        topK: Int,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> SearchVectorsOutput {
        ...
        return try await self.searchVectors(input, logger: logger)
    }
    ...
    public func updateTable(
        ...
        tableClass: TableClass? = nil,
        tableName: String,
        vectorIndexUpdates: [VectorIndexUpdate]? = nil,
        warmThroughput: WarmThroughput? = nil,
        logger: Logger = AWSClient.loggingDisabled        
