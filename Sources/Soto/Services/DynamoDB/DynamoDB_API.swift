...
public struct DynamoDB: AWSService {
    ...
    public func batchExecuteStatement(_ input: BatchExecuteStatementInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchExecuteStatementOutput> {
        return self.client.execute(operation: "BatchExecuteStatement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func batchGetItem(_ input: BatchGetItemInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchGetItemOutput> {
        let attributes: SpanAttributes
        if let aTableName = input.requestItems.first?.key {
            attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: aTableName)])
        } else {
    ...
    public func createBackup(_ input: CreateBackupInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBackupOutput> {
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGlobalTableOutput> {
        return self.client.execute(operation: "CreateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createTable(_ input: CreateTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTableOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func deleteBackup(_ input: DeleteBackupInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteBackupOutput> {
        return self.client.execute(operation: "DeleteBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteItem(_ input: DeleteItemInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteItemOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func deleteTable(_ input: DeleteTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTableOutput> {
        return self.client.execute(operation: "DeleteTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes an existing backup of a table. You can call DescribeBackup at a maximum rate of 10 times per second.
    public func describeBackup(_ input: DescribeBackupInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBackupOutput> {
        return self.client.execute(operation: "DescribeBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContinuousBackupsOutput> {
        return self.client.execute(operation: "DescribeContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns information about contributor insights, for a given table or global secondary index.
    public func describeContributorInsights(_ input: DescribeContributorInsightsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContributorInsightsOutput> {
        return self.client.execute(operation: "DescribeContributorInsights", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns the regional endpoint information.
    public func describeEndpoints(_ input: DescribeEndpointsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEndpointsResponse> {
        return self.client.execute(operation: "DescribeEndpoints", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes an existing table export.
    public func describeExport(_ input: DescribeExportInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeExportOutput> {
        return self.client.execute(operation: "DescribeExport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeGlobalTable(_ input: DescribeGlobalTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGlobalTableOutput> {
        return self.client.execute(operation: "DescribeGlobalTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes Region-specific settings for a global table.  This operation only applies to Version 2017.11.29 of global tables.
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGlobalTableSettingsOutput> {
        return self.client.execute(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns information about the status of Kinesis streaming.
    public func describeKinesisStreamingDestination(_ input: DescribeKinesisStreamingDestinationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeKinesisStreamingDestinationOutput> {
        return self.client.execute(operation: "DescribeKinesisStreamingDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeLimitsOutput> {
        return self.client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeTable(_ input: DescribeTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTableOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func describeTableReplicaAutoScaling(_ input: DescribeTableReplicaAutoScalingInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTableReplicaAutoScalingOutput> {
        return self.client.execute(operation: "DescribeTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gives a description of the Time to Live (TTL) status on the specified table.
    public func describeTimeToLive(_ input: DescribeTimeToLiveInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTimeToLiveOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func disableKinesisStreamingDestination(_ input: KinesisStreamingDestinationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<KinesisStreamingDestinationOutput> {
        return self.client.execute(operation: "DisableKinesisStreamingDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Starts table data replication to the specified Kinesis data stream at a timestamp chosen during the enable workflow. If this operation doesn't return results immediately, use DescribeKinesisStreamingDestination to check if streaming to the Kinesis data stream is ACTIVE.
    public func enableKinesisStreamingDestination(_ input: KinesisStreamingDestinationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<KinesisStreamingDestinationOutput> {
        return self.client.execute(operation: "EnableKinesisStreamingDestination", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    ///  This operation allows you to perform reads and singleton writes on data stored in DynamoDB, using PartiQL.
    public func executeStatement(_ input: ExecuteStatementInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExecuteStatementOutput> {
        return self.client.execute(operation: "ExecuteStatement", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    ///  This operation allows you to perform transactional reads or writes on data stored in DynamoDB, using PartiQL.
    public func executeTransaction(_ input: ExecuteTransactionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExecuteTransactionOutput> {
        return self.client.execute(operation: "ExecuteTransaction", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Exports table data to an S3 bucket. The table must have point in time recovery enabled, and you can export data from any time within the point in time recovery window.
    public func exportTableToPointInTime(_ input: ExportTableToPointInTimeInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportTableToPointInTimeOutput> {
        return self.client.execute(operation: "ExportTableToPointInTime", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getItem(_ input: GetItemInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetItemOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func listBackups(_ input: ListBackupsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBackupsOutput> {
        return self.client.execute(operation: "ListBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
    public func listContributorInsights(_ input: ListContributorInsightsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListContributorInsightsOutput> {
        return self.client.execute(operation: "ListContributorInsights", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Lists completed exports within the past 90 days.
    public func listExports(_ input: ListExportsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListExportsOutput> {
        return self.client.execute(operation: "ListExports", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGlobalTablesOutput> {
        return self.client.execute(operation: "ListGlobalTables", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns an array of table names associated with the current account and endpoint. The output from ListTables is paginated, with each page returning a maximum of 100 table names.
    public func listTables(_ input: ListTablesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTablesOutput> {
        return self.client.execute(operation: "ListTables", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTagsOfResource(_ input: ListTagsOfResourceInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsOfResourceOutput> {
        return self.client.execute(operation: "ListTagsOfResource", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putItem(_ input: PutItemInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutItemOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func query(_ input: QueryInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<QueryOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreTableFromBackupOutput> {
        return self.client.execute(operation: "RestoreTableFromBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreTableToPointInTimeOutput> {
        return self.client.execute(operation: "RestoreTableToPointInTime", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func scan(_ input: ScanInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ScanOutput> {
        return self.client.execute(operation: "Scan", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func transactGetItems(_ input: TransactGetItemsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TransactGetItemsOutput> {
        return self.client.execute(operation: "TransactGetItems", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func transactWriteItems(_ input: TransactWriteItemsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TransactWriteItemsOutput> {
        return self.client.execute(operation: "TransactWriteItems", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContinuousBackupsOutput> {
        return self.client.execute(operation: "UpdateContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Updates the status for contributor insights for a specific table or index.
    public func updateContributorInsights(_ input: UpdateContributorInsightsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContributorInsightsOutput> {
        return self.client.execute(operation: "UpdateContributorInsights", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGlobalTableOutput> {
        return self.client.execute(operation: "UpdateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Updates settings for a global table.
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGlobalTableSettingsOutput> {
        return self.client.execute(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateItem(_ input: UpdateItemInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateItemOutput> {
        let attributes = SpanAttributes(["aws.table_name": SpanAttribute(stringLiteral: input.tableName)])
        let baggageData = SotoServiceBaggage(serviceName: "DynamoDB", serviceAttributes: attributes, databaseSystem: "dynamodb")
        var context = context
        context.baggage[SotoServiceBaggageKey.self] = baggageData
    ...
    public func updateTable(_ input: UpdateTableInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTableOutput> {
        return self.client.execute(operation: "UpdateTable", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateTableReplicaAutoScaling(_ input: UpdateTableReplicaAutoScalingInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTableReplicaAutoScalingOutput> {
        return self.client.execute(operation: "UpdateTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateTimeToLive(_ input: UpdateTimeToLiveInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTimeToLiveOutput> {
        return self.client.execute(operation: "UpdateTimeToLive", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
