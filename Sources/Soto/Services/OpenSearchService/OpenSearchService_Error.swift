...
/// Error enum for OpenSearchService
public struct OpenSearchServiceErrorType: AWSErrorType {
    enum Code: String {
...
extension OpenSearchServiceErrorType: Equatable {
    public static func == (lhs: OpenSearchServiceErrorType, rhs: OpenSearchServiceErrorType) -> Bool {
        lhs.error == rhs.error
    }
}

extension OpenSearchServiceErrorType: CustomStringConvertible {
