...
extension TimestreamWrite {
    ...
    public func createBatchLoadTask(_ input: CreateBatchLoadTaskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateBatchLoadTaskResponse {
        return try await self.client.execute(operation: "CreateBatchLoadTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: true), logger: logger, on: eventLoop)
    }
    ...
    public func describeBatchLoadTask(_ input: DescribeBatchLoadTaskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeBatchLoadTaskResponse {
        return try await self.client.execute(operation: "DescribeBatchLoadTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: true), logger: logger, on: eventLoop)
    }
    ...
    public func listBatchLoadTasks(_ input: ListBatchLoadTasksRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListBatchLoadTasksResponse {
        return try await self.client.execute(operation: "ListBatchLoadTasks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: true), logger: logger, on: eventLoop)
    }
    ...
    ///
    public func resumeBatchLoadTask(_ input: ResumeBatchLoadTaskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ResumeBatchLoadTaskResponse {
        return try await self.client.execute(operation: "ResumeBatchLoadTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, endpointDiscovery: .init(storage: self.endpointStorage, discover: self.getEndpoint, required: true), logger: logger, on: eventLoop)
    }
