...
extension CloudFront {
    ...
    public struct AliasICPRecordal: AWSDecodableShape {
        ...
        /// 			APPROVED, that is, valid to use with China region, a CNAME must have one ICP recordal number associated with it.    SUSPENDED indicates that the associated CNAME does not have a valid ICP recordal
    ...
    public struct CacheBehavior: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 			information, see Creating cache policies or Using the managed cache policies in the Amazon CloudFront Developer Guide. A CacheBehavior must include either a CachePolicyId or ForwardedValues. We recommend that you use a CachePolicyId.
        ...
        /// 			origin request policy. For more information, see Creating origin request policies or Using the managed origin request policies in the Amazon CloudFront Developer Guide. A CacheBehavior must include either a CachePolicyId or ForwardedValues. We recommend that you use a CachePolicyId.
    ...
    public struct CachePolicyCookiesConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        ///
        /// 				            allExcept – All cookies in viewer requests that are  not listed in the CookieNames
        /// 					type are included in the cache key and automatically included in requests that
        /// 					CloudFront sends to the origin.
        ///
        /// 				            all – All cookies in viewer requests are included in the cache key and are
    ...
    public struct CachePolicyQueryStringsConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 					in an OriginRequestPolicy  are included in
        /// 					origin requests.
        ///
        ...
        /// 			not included in the cache key and automatically included in
    ...
    public struct DefaultCacheBehavior: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 			For more information, see Creating cache policies or Using the managed cache policies in the Amazon CloudFront Developer Guide. A DefaultCacheBehavior must include either a CachePolicyId or ForwardedValues. We recommend that you use a CachePolicyId.
        public let cachePolicyId: String?
        /// Whether you want CloudFront to automatically compress certain files for this cache behavior.
        ...
        /// 			Amazon CloudFront Developer Guide.
        /// 		       If you want to send values to the origin but not include them in the cache key, use an
        /// 			origin request policy. For more information, see Creating origin request policies or Using the managed origin request policies in the Amazon CloudFront Developer Guide. A DefaultCacheBehavior must include either a CachePolicyId or ForwardedValues. We recommend that you use a CachePolicyId.
        /// 		       A complex type that specifies how CloudFront handles query strings, cookies, and HTTP headers.
        public let forwardedValues: ForwardedValues?
        /// A list of CloudFront functions that are associated with this cache behavior. CloudFront functions must
        /// 			be published to the LIVE stage to associate them with a cache
    ...
    public struct DistributionConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 			with this distribution. To specify a web ACL created using the latest version of WAF, use the ACL ARN, for example
    ...
    public struct LambdaFunctionAssociation: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 				and before it checks to see whether the requested object is in the edge cache.     origin-request: The function executes only when CloudFront sends a request to your
    ...
    public struct OriginRequestPolicyCookiesConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 					cookies that are listed in a CachePolicy  are
    ...
    public struct OriginRequestPolicyHeadersConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 					listed in a CachePolicy  are included in origin
        /// 					requests.
        ///
        /// 				            whitelist – The HTTP headers that are listed in the Headers type
    ...
    public struct OriginShield: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 		       Specify the Amazon Web Services Region that has the lowest latency to your origin. To specify a region, use the region code, not the region name. For example, specify the US East (Ohio) region as us-east-2. When you enable CloudFront Origin Shield, you must specify the Amazon Web Services Region for Origin Shield. For the list of Amazon Web Services Regions that you can specify, and for help choosing the best Region for your origin, see Choosing the Amazon Web Services Region for Origin Shield in the
        /// 			Amazon CloudFront Developer Guide.
    ...
    public struct ParametersInCacheKeyAndForwardedToOrigin: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 			both of these fields is true  and the viewer request
        ...
        ///
        /// 		       For more information, see Compression support in the Amazon CloudFront Developer Guide. If you set this value to true, and this cache behavior also has an origin
