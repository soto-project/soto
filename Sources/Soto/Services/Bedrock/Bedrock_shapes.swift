...
extension Bedrock {
    ...
    public struct DeleteCustomModelRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "modelIdentifier", location: .uri("modelIdentifier"))
        ]
    ...
    public struct DeleteProvisionedModelThroughputRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "provisionedModelId", location: .uri("provisionedModelId"))
        ]
    ...
    public struct GetModelCustomizationJobRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "jobIdentifier", location: .uri("jobIdentifier"))
        ]
    ...
    public struct ListCustomModelsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "baseModelArnEquals", location: .querystring("baseModelArnEquals")),
            ...
            AWSMemberEncoding(label: "foundationModelArnEquals", location: .querystring("foundationModelArnEquals")),
    ...
    public struct ListFoundationModelsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "byCustomizationType", location: .querystring("byCustomizationType")),
            AWSMemberEncoding(label: "byInferenceType", location: .querystring("byInferenceType")),
            AWSMemberEncoding(label: "byOutputModality", location: .querystring("byOutputModality")),
            AWSMemberEncoding(label: "byProvider", location: .querystring("byProvider"))
        ]
    ...
    public struct ListProvisionedModelThroughputsRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "_creationTimeBefore", location: .querystring("creationTimeBefore")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "modelArnEquals", location: .querystring("modelArnEquals")),
            AWSMemberEncoding(label: "nameContains", location: .querystring("nameContains")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken")),
            AWSMemberEncoding(label: "sortBy", location: .querystring("sortBy")),
            AWSMemberEncoding(label: "sortOrder", location: .querystring("sortOrder")),
