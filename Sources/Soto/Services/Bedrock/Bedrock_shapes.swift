...
extension Bedrock {
    ...
    public enum AutomatedReasoningPolicyBuildResultAssetType: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        ...
        case fidelityReport = "FIDELITY_REPORT"
        case generatedTestCases = "GENERATED_TEST_CASES"
        case policyDefinition = "POLICY_DEFINITION"
        case policyScenarios = "POLICY_SCENARIOS"
    ...
    public enum ConfigurationOwner: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    public enum CustomModelDeploymentUpdateStatus: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    public enum InputTags: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case honor = "HONOR"
        case ignore = "IGNORE"
        public var description: String { return self.rawValue }
    }
    ...
    public enum ModelInvocationType: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    public enum ReasoningEffort: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case high = "high"
        case low = "low"
        case medium = "medium"
        public var description: String { return self.rawValue }
    ...
    public enum AutomatedReasoningPolicyBuildResultAssets: AWSDecodableShape, Sendable {
        ...
        case assetManifest(AutomatedReasoningPolicyBuildResultAssetManifest)
        ...
        case document(AutomatedReasoningPolicySourceDocument)
        ...
        case fidelityReport(AutomatedReasoningPolicyFidelityReport)
        ...
        case generatedTestCases(AutomatedReasoningPolicyGeneratedTestCases)
        ...
        case policyScenarios(AutomatedReasoningPolicyScenarios)
        ...
        public init(from decoder: Decoder) throws {
            ...
            switch key {
            case .assetManifest:
                let value = try container.decode(AutomatedReasoningPolicyBuildResultAssetManifest.self, forKey: .assetManifest)
                self = .assetManifest(value)
            case .buildLog:
                let value = try container.decode(AutomatedReasoningPolicyBuildLog.self, forKey: .buildLog)
                self = .buildLog(value)
            case .document:
                let value = try container.decode(AutomatedReasoningPolicySourceDocument.self, forKey: .document)
                self = .document(value)
            case .fidelityReport:
                let value = try container.decode(AutomatedReasoningPolicyFidelityReport.self, forKey: .fidelityReport)
                self = .fidelityReport(value)
            case .generatedTestCases:
                let value = try container.decode(AutomatedReasoningPolicyGeneratedTestCases.self, forKey: .generatedTestCases)
                self = .generatedTestCases(value)
            ...
            case .policyScenarios:
                let value = try container.decode(AutomatedReasoningPolicyScenarios.self, forKey: .policyScenarios)
                self = .policyScenarios(value)
            case .qualityReport:
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case fidelityReport = "fidelityReport"
            case generatedTestCases = "generatedTestCases"
            case policyDefinition = "policyDefinition"
            case policyScenarios = "policyScenarios"
    ...
    public enum CustomizationConfig: AWSEncodableShape & AWSDecodableShape, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            case .distillationConfig:
                let value = try container.decode(DistillationConfig.self, forKey: .distillationConfig)
                self = .distillationConfig(value)
            case .rftConfig:
                let value = try container.decode(RFTConfig.self, forKey: .rftConfig)
                self = .rftConfig(value)
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            var container = encoder.container(keyedBy: CodingKeys.self)
            switch self {
            case .distillationConfig(let value):
                try container.encode(value, forKey: .distillationConfig)
            case .rftConfig(let value):
                try container.encode(value, forKey: .rftConfig)
            }
        }
        ...
        public func validate(name: String) throws {
            switch self {
            case .distillationConfig(let value):
                try value.validate(name: "\(name).distillationConfig")
            case .rftConfig(let value):
                try value.validate(name: "\(name).rftConfig")
            }
        }
    ...
    public struct AccountEnforcedGuardrailInferenceInputConfiguration: AWSEncodableShape {
    ...
    public struct AccountEnforcedGuardrailOutputConfiguration: AWSDecodableShape {
    ...
    public struct AutomatedReasoningPolicyAnnotatedChunk: AWSDecodableShape {
        /// The lines of text contained within this chunk, each annotated with its line number.
        public let content: [AutomatedReasoningPolicyAnnotatedContent]
        /// The page number where this chunk begins, if the document is divided into pages.
        public let pageNumber: Int?

        @inlinable
        public init(content: [AutomatedReasoningPolicyAnnotatedContent], pageNumber: Int? = nil) {
    ...
    public struct AutomatedReasoningPolicyAnnotatedLine: AWSDecodableShape {
        ...
        @inlinable
        public init(lineNumber: Int? = nil, lineText: String? = nil) {
    ...
    public struct AutomatedReasoningPolicyAtomicStatement: AWSDecodableShape {
        ...
        public let location: AutomatedReasoningPolicyStatementLocation
        /// The actual text content of the atomic statement as extracted from the source document.
        public let text: String

        @inlinable
        public init(id: String, location: AutomatedReasoningPolicyStatementLocation, text: String) {
            self.id = id
    ...
    public struct AutomatedReasoningPolicyBuildResultAssetManifest: AWSDecodableShape {
        /// The list of asset entries in the manifest, each describing an available artifact that can be retrieved.
        public let entries: [AutomatedReasoningPolicyBuildResultAssetManifestEntry]

        @inlinable
        public init(entries: [AutomatedReasoningPolicyBuildResultAssetManifestEntry]) {
            self.entries = entries
        }
    ...
    public struct AutomatedReasoningPolicyBuildResultAssetManifestEntry: AWSDecodableShape {
        ...
        @inlinable
        public init(assetId: String? = nil, assetName: String? = nil, assetType: AutomatedReasoningPolicyBuildResultAssetType) {
    ...
    public struct AutomatedReasoningPolicyBuildWorkflowDocument: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.documentDescription, name: "documentDescription", parent: name, max: 4000)
    ...
    public struct AutomatedReasoningPolicyFidelityReport: AWSDecodableShape {
        ...
        public let documentSources: [AutomatedReasoningPolicyReportSourceDocument]
        ...
        public let ruleReports: [String: AutomatedReasoningPolicyRuleReport]
        ...
        public let variableReports: [String: AutomatedReasoningPolicyVariableReport]

        @inlinable
        public init(accuracyScore: Double, coverageScore: Double, documentSources: [AutomatedReasoningPolicyReportSourceDocument], ruleReports: [String: AutomatedReasoningPolicyRuleReport], variableReports: [String: AutomatedReasoningPolicyVariableReport]) {
    ...
    public struct AutomatedReasoningPolicyGeneratedTestCase: AWSDecodableShape {
        ...
        @inlinable
        public init(expectedAggregatedFindingsResult: AutomatedReasoningCheckResult, guardContent: String, queryContent: String) {
    ...
    public struct AutomatedReasoningPolicyGeneratedTestCases: AWSDecodableShape {
        /// Represents a collection of generated test cases.
        public let generatedTestCases: [AutomatedReasoningPolicyGeneratedTestCase]

        @inlinable
        public init(generatedTestCases: [AutomatedReasoningPolicyGeneratedTestCase]) {
    ...
    public struct AutomatedReasoningPolicyReportSourceDocument: AWSDecodableShape {
        ...
        public let atomicStatements: [AutomatedReasoningPolicyAtomicStatement]
        /// The document's content organized into annotated chunks with line number information for precise referencing.
        public let documentContent: [AutomatedReasoningPolicyAnnotatedChunk]
        ...
        @inlinable
        public init(atomicStatements: [AutomatedReasoningPolicyAtomicStatement], documentContent: [AutomatedReasoningPolicyAnnotatedChunk], documentHash: String, documentId: String, documentName: String) {
        ...
        private enum CodingKeys: String, CodingKey {
            case atomicStatements = "atomicStatements"
    ...
    public struct AutomatedReasoningPolicyRuleReport: AWSDecodableShape {
        ...
        public let groundingJustifications: [String]?
        /// References to statements from the source documents that provide the basis or justification for this rule.
        public let groundingStatements: [AutomatedReasoningPolicyStatementReference]?
        /// The identifier of the policy rule being analyzed in this report.
        public let rule: String

        @inlinable
        public init(accuracyJustification: String? = nil, accuracyScore: Double? = nil, groundingJustifications: [String]? = nil, groundingStatements: [AutomatedReasoningPolicyStatementReference]? = nil, rule: String) {
        ...
        private enum CodingKeys: String, CodingKey {
            case accuracyJustification = "accuracyJustification"
            case accuracyScore = "accuracyScore"
            case groundingJustifications = "groundingJustifications"
            case groundingStatements = "groundingStatements"
            case rule = "rule"
        }
    }
    ...
    public struct AutomatedReasoningPolicyScenarios: AWSDecodableShape {
        /// Represents a collection of generated policy scenarios.
        public let policyScenarios: [AutomatedReasoningPolicyScenario]

        @inlinable
        public init(policyScenarios: [AutomatedReasoningPolicyScenario]) {
    ...
    public struct AutomatedReasoningPolicySourceDocument: AWSDecodableShape {
        ...
        @inlinable
        public init(document: AWSBase64Data, documentContentType: AutomatedReasoningPolicyBuildDocumentContentType, documentDescription: String? = nil, documentHash: String, documentName: String) {
            self.document = document
            self.documentContentType = documentContentType
            self.documentDescription = documentDescription
            self.documentHash = documentHash
    ...
    public struct AutomatedReasoningPolicyStatementLocation: AWSDecodableShape {
    ...
    public struct AutomatedReasoningPolicyStatementReference: AWSDecodableShape {
        ...
        @inlinable
        public init(documentId: String, statementId: String) {
            self.documentId = documentId
    ...
    public struct AutomatedReasoningPolicyVariableReport: AWSDecodableShape {
        ...
        public let policyVariable: String

        @inlinable
        public init(accuracyJustification: String? = nil, accuracyScore: Double? = nil, groundingJustifications: [String]? = nil, groundingStatements: [AutomatedReasoningPolicyStatementReference]? = nil, policyVariable: String) {
            self.accuracyJustification = accuracyJustification
            self.accuracyScore = accuracyScore
            self.groundingJustifications = groundingJustifications
            self.groundingStatements = groundingStatements
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case groundingJustifications = "groundingJustifications"
            case groundingStatements = "groundingStatements"
            case policyVariable = "policyVariable"
        }
    }
    ...
    public struct CreateAutomatedReasoningPolicyTestCaseRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.guardContent, name: "guardContent", parent: name, max: 2048)
            try self.validate(self.policyArn, name: "policyArn", parent: name, max: 2048)
            try self.validate(self.policyArn, name: "policyArn", parent: name, min: 1)
            try self.validate(self.policyArn, name: "policyArn", parent: name, pattern: "^arn:aws(-[^:]+)?:bedrock:[a-z0-9-]{1,20}:[0-9]{12}:automated-reasoning-policy/[a-z0-9]{12}(:([1-9][0-9]{0,11}))?$")
    ...
    public struct CreateModelInvocationJobRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(clientRequestToken: String? = CreateModelInvocationJobRequest.idempotencyToken(), inputDataConfig: ModelInvocationJobInputDataConfig, jobName: String, modelId: String, modelInvocationType: ModelInvocationType? = nil, outputDataConfig: ModelInvocationJobOutputDataConfig, roleArn: String, tags: [Tag]? = nil, timeoutDurationInHours: Int? = nil, vpcConfig: VpcConfig? = nil) {
            self.clientRequestToken = clientRequestToken
    ...
    public struct CustomModelDeploymentUpdateDetails: AWSDecodableShape {
        ///  ARN of the new custom model being deployed as part of the update.
        public let modelArn: String
        ///  Current status of the deployment update.
        public let updateStatus: CustomModelDeploymentUpdateStatus

        @inlinable
        public init(modelArn: String, updateStatus: CustomModelDeploymentUpdateStatus) {
            self.modelArn = modelArn
    ...
    public struct DeleteEnforcedGuardrailConfigurationRequest: AWSEncodableShape {
        /// Unique ID for the account enforced configuration.
        public let configId: String
        ...
        public func validate(name: String) throws {
            try self.validate(self.configId, name: "configId", parent: name, pattern: "^[a-z0-9]+$")
        }

        private enum CodingKeys: CodingKey {}
    }

    public struct DeleteEnforcedGuardrailConfigurationResponse: AWSDecodableShape {
        public init() {}
    }
    ...
    public struct FoundationModelLifecycle: AWSDecodableShape {
        ...
        @OptionalCustomCoding<ISO8601DateCoder>
        public var legacyTime: Date?
        /// Public extended access portion of the legacy period, when users should expect higher pricing
        @OptionalCustomCoding<ISO8601DateCoder>
        public var publicExtendedAccessTime: Date?
        /// Launch time when the model first becomes available
        @OptionalCustomCoding<ISO8601DateCoder>
        public var startOfLifeTime: Date?
        /// Specifies whether a model version is available (ACTIVE) or deprecated (LEGACY.
        public let status: FoundationModelLifecycleStatus

        @inlinable
        public init(endOfLifeTime: Date? = nil, legacyTime: Date? = nil, publicExtendedAccessTime: Date? = nil, startOfLifeTime: Date? = nil, status: FoundationModelLifecycleStatus) {
        ...
        private enum CodingKeys: String, CodingKey {
            case endOfLifeTime = "endOfLifeTime"
            case legacyTime = "legacyTime"
            case publicExtendedAccessTime = "publicExtendedAccessTime"
            case startOfLifeTime = "startOfLifeTime"
            case status = "status"
        }
    }
    ...
    public struct GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(assetId: String? = nil, assetType: AutomatedReasoningPolicyBuildResultAssetType, buildWorkflowId: String, policyArn: String) {
            self.assetId = assetId
            self.assetType = assetType
            self.buildWorkflowId = buildWorkflowId
            self.policyArn = policyArn
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.assetId, name: "assetId", parent: name, pattern: "^[0-9a-fA-F\\-]+$")
            try self.validate(self.buildWorkflowId, name: "buildWorkflowId", parent: name, max: 36)
            try self.validate(self.buildWorkflowId, name: "buildWorkflowId", parent: name, pattern: "^[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12}$")
            try self.validate(self.policyArn, name: "policyArn", parent: name, max: 2048)
            try self.validate(self.policyArn, name: "policyArn", parent: name, min: 1)
    ...
    public struct GetCustomModelDeploymentResponse: AWSDecodableShape {
        ...
        public let updateDetails: CustomModelDeploymentUpdateDetails?

        @inlinable
        public init(createdAt: Date, customModelDeploymentArn: String, description: String? = nil, failureMessage: String? = nil, lastUpdatedAt: Date? = nil, modelArn: String, modelDeploymentName: String, status: CustomModelDeploymentStatus, updateDetails: CustomModelDeploymentUpdateDetails? = nil) {
            self.createdAt = createdAt
            self.customModelDeploymentArn = customModelDeploymentArn
            self.description = description
            self.failureMessage = failureMessage
    ...
    public struct LambdaGraderConfig: AWSEncodableShape & AWSDecodableShape {
    ...
    public struct ListEnforcedGuardrailsConfigurationRequest: AWSEncodableShape {
    ...
    public struct ListEnforcedGuardrailsConfigurationResponse: AWSDecodableShape {
        /// Array of AccountEnforcedGuardrailOutputConfiguration objects.
        public let guardrailsConfig: [AccountEnforcedGuardrailOutputConfiguration]
        /// Opaque continuation token of previous paginated response.
        public let nextToken: String?

        @inlinable
        public init(guardrailsConfig: [AccountEnforcedGuardrailOutputConfiguration], nextToken: String? = nil) {
            self.guardrailsConfig = guardrailsConfig
            self.nextToken = nextToken
        }

        private enum CodingKeys: String, CodingKey {
            case guardrailsConfig = "guardrailsConfig"
            case nextToken = "nextToken"
        }
    }
    ...
    public struct LoggingConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public let audioDataDeliveryEnabled: Bool?
        ...
        @inlinable
        public init(audioDataDeliveryEnabled: Bool? = nil, cloudWatchConfig: CloudWatchConfig? = nil, embeddingDataDeliveryEnabled: Bool? = nil, imageDataDeliveryEnabled: Bool? = nil, s3Config: S3Config? = nil, textDataDeliveryEnabled: Bool? = nil, videoDataDeliveryEnabled: Bool? = nil) {
        ...
        private enum CodingKeys: String, CodingKey {
            case audioDataDeliveryEnabled = "audioDataDeliveryEnabled"
    ...
    public struct PutEnforcedGuardrailConfigurationRequest: AWSEncodableShape {
        ...
        public let guardrailInferenceConfig: AccountEnforcedGuardrailInferenceInputConfiguration

        @inlinable
        public init(configId: String? = nil, guardrailInferenceConfig: AccountEnforcedGuardrailInferenceInputConfiguration) {
            self.configId = configId
        ...
        public func validate(name: String) throws {
            try self.validate(self.configId, name: "configId", parent: name, pattern: "^[a-z0-9]+$")
            try self.guardrailInferenceConfig.validate(name: "\(name).guardrailInferenceConfig")
        }

        private enum CodingKeys: String, CodingKey {
            case configId = "configId"
            case guardrailInferenceConfig = "guardrailInferenceConfig"
        }
    }

    public struct PutEnforcedGuardrailConfigurationResponse: AWSDecodableShape {
        /// Unique ID for the account enforced configuration.
        public let configId: String?
        /// Timestamp.
        @OptionalCustomCoding<ISO8601DateCoder>
        ...
        @inlinable
        public init(configId: String? = nil, updatedAt: Date? = nil, updatedBy: String? = nil) {
            self.configId = configId
            self.updatedAt = updatedAt
            self.updatedBy = updatedBy
        }
    ...
    public struct RFTConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public let hyperParameters: RFTHyperParameters?

        @inlinable
        public init(graderConfig: GraderConfig? = nil, hyperParameters: RFTHyperParameters? = nil) {
            self.graderConfig = graderConfig
            self.hyperParameters = hyperParameters
        }

        public func validate(name: String) throws {
            try self.graderConfig?.validate(name: "\(name).graderConfig")
            try self.hyperParameters?.validate(name: "\(name).hyperParameters")
        }

        private enum CodingKeys: String, CodingKey {
            case graderConfig = "graderConfig"
            case hyperParameters = "hyperParameters"
        }
    }

    public struct RFTHyperParameters: AWSEncodableShape & AWSDecodableShape {
        ...
        public let trainingSamplePerPrompt: Int?

        @inlinable
        public init(batchSize: Int? = nil, epochCount: Int? = nil, evalInterval: Int? = nil, inferenceMaxTokens: Int? = nil, learningRate: Float? = nil, maxPromptLength: Int? = nil, reasoningEffort: ReasoningEffort? = nil, trainingSamplePerPrompt: Int? = nil) {
        ...
        public func validate(name: String) throws {
            try self.validate(self.batchSize, name: "batchSize", parent: name, max: 512)
            try self.validate(self.batchSize, name: "batchSize", parent: name, min: 16)
            try self.validate(self.epochCount, name: "epochCount", parent: name, max: 50)
            try self.validate(self.epochCount, name: "epochCount", parent: name, min: 1)
            try self.validate(self.evalInterval, name: "evalInterval", parent: name, max: 100)
            try self.validate(self.evalInterval, name: "evalInterval", parent: name, min: 1)
            try self.validate(self.learningRate, name: "learningRate", parent: name, max: 0.001)
            try self.validate(self.learningRate, name: "learningRate", parent: name, min: 1e-07)
            try self.validate(self.trainingSamplePerPrompt, name: "trainingSamplePerPrompt", parent: name, max: 16)
            try self.validate(self.trainingSamplePerPrompt, name: "trainingSamplePerPrompt", parent: name, min: 2)
        }

        private enum CodingKeys: String, CodingKey {
            case batchSize = "batchSize"
            case epochCount = "epochCount"
            case evalInterval = "evalInterval"
            case inferenceMaxTokens = "inferenceMaxTokens"
            case learningRate = "learningRate"
            case maxPromptLength = "maxPromptLength"
            case reasoningEffort = "reasoningEffort"
            case trainingSamplePerPrompt = "trainingSamplePerPrompt"
        }
    }
    ...
    public struct UpdateCustomModelDeploymentRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(customModelDeploymentIdentifier: String, modelArn: String) {
            self.customModelDeploymentIdentifier = customModelDeploymentIdentifier
            self.modelArn = modelArn
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            var container = encoder.container(keyedBy: CodingKeys.self)
            request.encodePath(self.customModelDeploymentIdentifier, key: "customModelDeploymentIdentifier")
            try container.encode(self.modelArn, forKey: .modelArn)
        }
    ...
    public struct UpdateCustomModelDeploymentResponse: AWSDecodableShape {
    ...
    public struct AutomatedReasoningPolicyAnnotatedContent: AWSDecodableShape {
        /// An annotated line of text from the source document, including both the line number and the text content.
        public let line: AutomatedReasoningPolicyAnnotatedLine?

        @inlinable
        public init(line: AutomatedReasoningPolicyAnnotatedLine? = nil) {
            self.line = line
        }
    ...
    public struct AutomatedReasoningPolicyGenerateFidelityReportContent: AWSEncodableShape {
        ...
        @inlinable
        public init(documents: [AutomatedReasoningPolicyBuildWorkflowDocument]? = nil) {
    ...
    public struct GraderConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public let lambdaGrader: LambdaGraderConfig?

        @inlinable
        public init(lambdaGrader: LambdaGraderConfig? = nil) {
            self.lambdaGrader = lambdaGrader
        }

        public func validate(name: String) throws {
            try self.lambdaGrader?.validate(name: "\(name).lambdaGrader")
        }

        private enum CodingKeys: String, CodingKey {
            case lambdaGrader = "lambdaGrader"
        }
    }
