...
extension EBS {
    ...
    public struct GetSnapshotBlockResponse: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(blockData: HTTPBody? = nil, checksum: String? = nil, checksumAlgorithm: ChecksumAlgorithm? = nil, dataLength: Int? = nil) {
    ...
    public struct PutSnapshotBlockRequest: AWSEncodableShape & AWSShapeWithPayload {
        ...
        public init(blockData: HTTPBody, blockIndex: Int, checksum: String, checksumAlgorithm: ChecksumAlgorithm, dataLength: Int, progress: Int? = nil, snapshotId: String) {
            self.blockData = blockData
            self.blockIndex = blockIndex
            self.checksum = checksum
            self.checksumAlgorithm = checksumAlgorithm
