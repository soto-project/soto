...
extension BedrockAgentCore {
    ...
    public struct CloudWatchFilterConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public let sessionTraceIds: [SessionTraceIds]?
        /// The time range filter for selecting sessions to evaluate.
        public let timeRange: SessionFilterConfig?

        @inlinable
        public init(sessionIds: [String]? = nil, sessionTraceIds: [SessionTraceIds]? = nil, timeRange: SessionFilterConfig? = nil) {
        ...
        public func validate(name: String) throws {
            try self.sessionTraceIds?.forEach {
                try $0.validate(name: "\(name).sessionTraceIds[]")
            }
            try self.validate(self.sessionTraceIds, name: "sessionTraceIds", parent: name, max: 500)
            try self.validate(self.sessionTraceIds, name: "sessionTraceIds", parent: name, min: 1)
        }

        private enum CodingKeys: String, CodingKey {
            case sessionIds = "sessionIds"
            case sessionTraceIds = "sessionTraceIds"
    ...
    public struct CloudWatchLogsSource: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.filterConfig?.validate(name: "\(name).filterConfig")
    ...
    public struct SessionTraceIds: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        public init(sessionId: String, traceIds: [String]) {
            self.sessionId = sessionId
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.traceIds, name: "traceIds", parent: name, min: 1)
        }
