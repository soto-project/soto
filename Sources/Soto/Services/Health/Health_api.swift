...
public struct Health: AWSService {
    ...
    public func describeEntityAggregatesForOrganization(_ input: DescribeEntityAggregatesForOrganizationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEntityAggregatesForOrganizationResponse> {
        return self.client.execute(operation: "DescribeEntityAggregatesForOrganization", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
