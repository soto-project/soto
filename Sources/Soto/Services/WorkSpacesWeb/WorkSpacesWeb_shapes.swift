...
extension WorkSpacesWeb {
    ...
    public enum Category: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case chat = "Chat"
        case criminalActivity = "CriminalActivity"
        case cults = "Cults"
        case downloadSites = "DownloadSites"
        case gambling = "Gambling"
        case games = "Games"
        case generativeAi = "GenerativeAI"
        case hacking = "Hacking"
        case hateAndIntolerance = "HateAndIntolerance"
        case illegalDrug = "IllegalDrug"
        case illegalSoftware = "IllegalSoftware"
        case imageSharing = "ImageSharing"
        case instantMessaging = "InstantMessaging"
        case nudity = "Nudity"
        case parkedDomains = "ParkedDomains"
        case peerToPeer = "PeerToPeer"
        case pornography = "Pornography"
        case professionalNetwork = "ProfessionalNetwork"
        case schoolCheating = "SchoolCheating"
        case selfHarm = "SelfHarm"
        case sexEducation = "SexEducation"
        case socialNetworking = "SocialNetworking"
        case streamingMediaAndDownloads = "StreamingMediaAndDownloads"
        case tasteless = "Tasteless"
        case violence = "Violence"
        case weapons = "Weapons"
        case webBasedEmail = "WebBasedEmail"
        public var description: String { return self.rawValue }
    }
    ...
    public enum Event: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        ...
        case urlBlockByContentFilter = "UrlBlockByContentFilter"
    ...
    public struct BrowserSettings: AWSDecodableShape {
        ...
        public let webContentFilteringPolicy: WebContentFilteringPolicy?

        @inlinable
        public init(additionalEncryptionContext: [String: String]? = nil, associatedPortalArns: [String]? = nil, browserPolicy: String? = nil, browserSettingsArn: String, customerManagedKey: String? = nil, webContentFilteringPolicy: WebContentFilteringPolicy? = nil) {
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case webContentFilteringPolicy = "webContentFilteringPolicy"
        }
    }
    ...
    public struct CreateBrowserSettingsRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(additionalEncryptionContext: [String: String]? = nil, browserPolicy: String? = nil, clientToken: String? = CreateBrowserSettingsRequest.idempotencyToken(), customerManagedKey: String? = nil, tags: [Tag]? = nil, webContentFilteringPolicy: WebContentFilteringPolicy? = nil) {
            self.additionalEncryptionContext = additionalEncryptionContext
            self.browserPolicy = browserPolicy
        ...
        public func validate(name: String) throws {
            ...
            try self.webContentFilteringPolicy?.validate(name: "\(name).webContentFilteringPolicy")
        }
    ...
    public struct UpdateBrowserSettingsRequest: AWSEncodableShape {
        ...
        @inlinable
        public init(browserPolicy: String? = nil, browserSettingsArn: String, clientToken: String? = UpdateBrowserSettingsRequest.idempotencyToken(), webContentFilteringPolicy: WebContentFilteringPolicy? = nil) {
            self.browserPolicy = browserPolicy
            self.browserSettingsArn = browserSettingsArn
            self.clientToken = clientToken
            self.webContentFilteringPolicy = webContentFilteringPolicy
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            request.encodePath(self.browserSettingsArn, key: "browserSettingsArn")
            try container.encodeIfPresent(self.clientToken, forKey: .clientToken)
            try container.encodeIfPresent(self.webContentFilteringPolicy, forKey: .webContentFilteringPolicy)
        }
    ...
    public struct WebContentFilteringPolicy: AWSEncodableShape & AWSDecodableShape {
        ...
        public let blockedCategories: [Category]?
        /// URLs and domains that end users cannot access.
        public let blockedUrls: [String]?

        @inlinable
        public init(allowedUrls: [String]? = nil, blockedCategories: [Category]? = nil, blockedUrls: [String]? = nil) {
        ...
        public func validate(name: String) throws {
            try self.allowedUrls?.forEach {
                try validate($0, name: "allowedUrls[]", parent: name, pattern: "^((([a-zA-Z][a-zA-Z0-9+.-]*):\\/\\/(\\*|[\\w%._\\-\\+~#=@]+)?(\\/[^@\\s]*)?(?:\\?([^*\\s]+(?:\\*?)))?)|(\\*|[\\w%._\\-\\+~#=@]+\\.[\\w%._\\-\\+~#=@]+)(?::(\\d{1,5}))?(\\/[^@\\s]*)?(?:\\?([^*\\s]+(?:\\*?)))?|(([a-zA-Z][a-zA-Z0-9+.-]*):(\\/\\/)?\\*))$")
            }
            try self.validate(self.allowedUrls, name: "allowedUrls", parent: name, max: 1000)
            try self.validate(self.allowedUrls, name: "allowedUrls", parent: name, min: 1)
            try self.validate(self.blockedCategories, name: "blockedCategories", parent: name, max: 100)
            try self.validate(self.blockedCategories, name: "blockedCategories", parent: name, min: 1)
            try self.blockedUrls?.forEach {
                try validate($0, name: "blockedUrls[]", parent: name, pattern: "^((([a-zA-Z][a-zA-Z0-9+.-]*):\\/\\/(\\*|[\\w%._\\-\\+~#=@]+)?(\\/[^@\\s]*)?(?:\\?([^*\\s]+(?:\\*?)))?)|(\\*|[\\w%._\\-\\+~#=@]+\\.[\\w%._\\-\\+~#=@]+)(?::(\\d{1,5}))?(\\/[^@\\s]*)?(?:\\?([^*\\s]+(?:\\*?)))?|(([a-zA-Z][a-zA-Z0-9+.-]*):(\\/\\/)?\\*))$")
            }
            try self.validate(self.blockedUrls, name: "blockedUrls", parent: name, max: 1000)
            try self.validate(self.blockedUrls, name: "blockedUrls", parent: name, min: 1)
        }

        private enum CodingKeys: String, CodingKey {
            case allowedUrls = "allowedUrls"
            case blockedCategories = "blockedCategories"
            case blockedUrls = "blockedUrls"
        }
    }
}
