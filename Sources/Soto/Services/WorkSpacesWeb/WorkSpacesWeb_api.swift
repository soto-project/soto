...
public struct WorkSpacesWeb: AWSService {
    ...
    ///   - webContentFilteringPolicy: The policy that specifies which URLs end users are allowed to access or which URLs or domain categories they are restricted from accessing for enhanced security.
    ///   - logger: Logger use during operation
    @inlinable
    public func createBrowserSettings(
        ...
        tags: [Tag]? = nil,
        webContentFilteringPolicy: WebContentFilteringPolicy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///   - portalCustomDomain: The custom domain of the web portal that users access in order to start streaming sessions.
    ...
    ///   - brandingConfigurationInput: The branding configuration input that customizes the appearance of the web portal for end users. This includes a custom logo, favicon, localized strings, color theme, and optionally a wallpaper and terms of service.
    ///   - clientToken: A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token returns the result from the original successful request.  If you do not specify a client token, one is automatically generated by the Amazon Web Services SDK.
    ...
    public func createUserSettings(
        additionalEncryptionContext: [String: String]? = nil,
        brandingConfigurationInput: BrandingConfigurationCreateInput? = nil,
    ...
    public func updateUserSettings(
        brandingConfigurationInput: BrandingConfigurationUpdateInput? = nil,
