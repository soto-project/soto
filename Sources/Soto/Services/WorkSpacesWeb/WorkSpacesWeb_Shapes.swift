...
extension WorkSpacesWeb {
    ...
    public struct Certificate: AWSDecodableShape {
        ...
        public init(body: AWSBlob? = nil, issuer: String? = nil, notValidAfter: Date? = nil, notValidBefore: Date? = nil, subject: String? = nil, thumbprint: String? = nil) {
            self.body = body
            self.issuer = issuer
    ...
    public struct CreateTrustStoreRequest: AWSEncodableShape {
        ...
        public let certificateList: [AWSBlob]
        /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token returns the result from the original successful request.  If you do not specify a client token, one is automatically generated by the AWS SDK.
        public let clientToken: String?
        /// The tags to add to the trust store. A tag is a key-value pair.
        public let tags: [Tag]?

        public init(certificateList: [AWSBlob], clientToken: String? = CreateTrustStoreRequest.idempotencyToken(), tags: [Tag]? = nil) {
    ...
    public struct UpdateTrustStoreRequest: AWSEncodableShape {
        ...
        public let certificatesToAdd: [AWSBlob]?
        ...
        public init(certificatesToAdd: [AWSBlob]? = nil, certificatesToDelete: [String]? = nil, clientToken: String? = UpdateTrustStoreRequest.idempotencyToken(), trustStoreArn: String) {
