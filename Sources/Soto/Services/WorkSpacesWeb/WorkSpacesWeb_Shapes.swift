...
extension WorkSpacesWeb {
    ...
    public struct AssociateBrowserSettingsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "browserSettingsArn", location: .querystring(locationName: "browserSettingsArn")),
            AWSMemberEncoding(label: "portalArn", location: .uri(locationName: "portalArn"))
        ]
    ...
    public struct AssociateNetworkSettingsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "networkSettingsArn", location: .querystring(locationName: "networkSettingsArn")),
            AWSMemberEncoding(label: "portalArn", location: .uri(locationName: "portalArn"))
        ]
    ...
    public struct AssociateTrustStoreRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "portalArn", location: .uri(locationName: "portalArn")),
            AWSMemberEncoding(label: "trustStoreArn", location: .querystring(locationName: "trustStoreArn"))
        ]
    ...
    public struct AssociateUserSettingsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "portalArn", location: .uri(locationName: "portalArn")),
            AWSMemberEncoding(label: "userSettingsArn", location: .querystring(locationName: "userSettingsArn"))
        ]
    ...
    public struct CreateBrowserSettingsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.additionalEncryptionContext?.forEach {
                ...
                try validate($0.key, name: "additionalEncryptionContext.key", parent: name, min: 0)
                ...
                try validate($0.value, name: "additionalEncryptionContext[\"\($0.key)\"]", parent: name, min: 0)
    ...
    public struct CreateIdentityProviderRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.identityProviderDetails.forEach {
                ...
                try validate($0.key, name: "identityProviderDetails.key", parent: name, min: 0)
                ...
                try validate($0.value, name: "identityProviderDetails[\"\($0.key)\"]", parent: name, min: 0)
    ...
    public struct DeleteBrowserSettingsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "browserSettingsArn", location: .uri(locationName: "browserSettingsArn"))
        ]
    ...
    public struct DeleteIdentityProviderRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "identityProviderArn", location: .uri(locationName: "identityProviderArn"))
        ]
    ...
    public struct DeleteNetworkSettingsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "networkSettingsArn", location: .uri(locationName: "networkSettingsArn"))
        ]
    ...
    public struct DeleteTrustStoreRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "trustStoreArn", location: .uri(locationName: "trustStoreArn"))
        ]
    ...
    public struct DeleteUserSettingsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "userSettingsArn", location: .uri(locationName: "userSettingsArn"))
        ]
    ...
    public struct GetTrustStoreCertificateRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "thumbprint", location: .querystring(locationName: "thumbprint")),
            AWSMemberEncoding(label: "trustStoreArn", location: .uri(locationName: "trustStoreArn"))
        ]
