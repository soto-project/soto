...
public struct EKS: AWSService {
    ...
    public func associateEncryptionConfig(_ input: AssociateEncryptionConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateEncryptionConfigResponse {
        return try await self.client.execute(operation: "AssociateEncryptionConfig", path: "/clusters/{clusterName}/encryption-config/associate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func associateIdentityProviderConfig(_ input: AssociateIdentityProviderConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateIdentityProviderConfigResponse {
        return try await self.client.execute(operation: "AssociateIdentityProviderConfig", path: "/clusters/{clusterName}/identity-provider-configs/associate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createAddon(_ input: CreateAddonRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateAddonResponse {
        return try await self.client.execute(operation: "CreateAddon", path: "/clusters/{clusterName}/addons", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createCluster(_ input: CreateClusterRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateClusterResponse {
        return try await self.client.execute(operation: "CreateCluster", path: "/clusters", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createFargateProfile(_ input: CreateFargateProfileRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateFargateProfileResponse {
        return try await self.client.execute(operation: "CreateFargateProfile", path: "/clusters/{clusterName}/fargate-profiles", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createNodegroup(_ input: CreateNodegroupRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateNodegroupResponse {
        return try await self.client.execute(operation: "CreateNodegroup", path: "/clusters/{clusterName}/node-groups", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteAddon(_ input: DeleteAddonRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteAddonResponse {
        return try await self.client.execute(operation: "DeleteAddon", path: "/clusters/{clusterName}/addons/{addonName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteCluster(_ input: DeleteClusterRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteClusterResponse {
        return try await self.client.execute(operation: "DeleteCluster", path: "/clusters/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteFargateProfile(_ input: DeleteFargateProfileRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteFargateProfileResponse {
        return try await self.client.execute(operation: "DeleteFargateProfile", path: "/clusters/{clusterName}/fargate-profiles/{fargateProfileName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteNodegroup(_ input: DeleteNodegroupRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteNodegroupResponse {
        return try await self.client.execute(operation: "DeleteNodegroup", path: "/clusters/{clusterName}/node-groups/{nodegroupName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deregisterCluster(_ input: DeregisterClusterRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeregisterClusterResponse {
        return try await self.client.execute(operation: "DeregisterCluster", path: "/cluster-registrations/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeAddon(_ input: DescribeAddonRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAddonResponse {
        return try await self.client.execute(operation: "DescribeAddon", path: "/clusters/{clusterName}/addons/{addonName}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeAddonConfiguration(_ input: DescribeAddonConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAddonConfigurationResponse {
        return try await self.client.execute(operation: "DescribeAddonConfiguration", path: "/addons/configuration-schemas", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeAddonVersions(_ input: DescribeAddonVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeAddonVersionsResponse {
        return try await self.client.execute(operation: "DescribeAddonVersions", path: "/addons/supported-versions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeCluster(_ input: DescribeClusterRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeClusterResponse {
        return try await self.client.execute(operation: "DescribeCluster", path: "/clusters/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeFargateProfile(_ input: DescribeFargateProfileRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeFargateProfileResponse {
        return try await self.client.execute(operation: "DescribeFargateProfile", path: "/clusters/{clusterName}/fargate-profiles/{fargateProfileName}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeIdentityProviderConfig(_ input: DescribeIdentityProviderConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeIdentityProviderConfigResponse {
        return try await self.client.execute(operation: "DescribeIdentityProviderConfig", path: "/clusters/{clusterName}/identity-provider-configs/describe", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeNodegroup(_ input: DescribeNodegroupRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeNodegroupResponse {
        return try await self.client.execute(operation: "DescribeNodegroup", path: "/clusters/{clusterName}/node-groups/{nodegroupName}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeUpdate(_ input: DescribeUpdateRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeUpdateResponse {
        return try await self.client.execute(operation: "DescribeUpdate", path: "/clusters/{name}/updates/{updateId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func disassociateIdentityProviderConfig(_ input: DisassociateIdentityProviderConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DisassociateIdentityProviderConfigResponse {
        return try await self.client.execute(operation: "DisassociateIdentityProviderConfig", path: "/clusters/{clusterName}/identity-provider-configs/disassociate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listAddons(_ input: ListAddonsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListAddonsResponse {
        return try await self.client.execute(operation: "ListAddons", path: "/clusters/{clusterName}/addons", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listFargateProfiles(_ input: ListFargateProfilesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListFargateProfilesResponse {
        return try await self.client.execute(operation: "ListFargateProfiles", path: "/clusters/{clusterName}/fargate-profiles", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listIdentityProviderConfigs(_ input: ListIdentityProviderConfigsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListIdentityProviderConfigsResponse {
        return try await self.client.execute(operation: "ListIdentityProviderConfigs", path: "/clusters/{clusterName}/identity-provider-configs", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listNodegroups(_ input: ListNodegroupsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListNodegroupsResponse {
        return try await self.client.execute(operation: "ListNodegroups", path: "/clusters/{clusterName}/node-groups", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listUpdates(_ input: ListUpdatesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListUpdatesResponse {
        return try await self.client.execute(operation: "ListUpdates", path: "/clusters/{name}/updates", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func registerCluster(_ input: RegisterClusterRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> RegisterClusterResponse {
        return try await self.client.execute(operation: "RegisterCluster", path: "/cluster-registrations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateAddon(_ input: UpdateAddonRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateAddonResponse {
        return try await self.client.execute(operation: "UpdateAddon", path: "/clusters/{clusterName}/addons/{addonName}/update", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateClusterConfig(_ input: UpdateClusterConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateClusterConfigResponse {
        return try await self.client.execute(operation: "UpdateClusterConfig", path: "/clusters/{name}/update-config", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateClusterVersion(_ input: UpdateClusterVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateClusterVersionResponse {
        return try await self.client.execute(operation: "UpdateClusterVersion", path: "/clusters/{name}/updates", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateNodegroupConfig(_ input: UpdateNodegroupConfigRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateNodegroupConfigResponse {
        return try await self.client.execute(operation: "UpdateNodegroupConfig", path: "/clusters/{clusterName}/node-groups/{nodegroupName}/update-config", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateNodegroupVersion(_ input: UpdateNodegroupVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateNodegroupVersionResponse {
        return try await self.client.execute(operation: "UpdateNodegroupVersion", path: "/clusters/{clusterName}/node-groups/{nodegroupName}/update-version", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
