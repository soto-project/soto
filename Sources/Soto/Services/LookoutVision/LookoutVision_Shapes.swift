...
extension LookoutVision {
    ...
    public struct UpdateDatasetEntriesRequest: AWSEncodableShape {
        ...
        public init(changes: AWSBlob, clientToken: String? = UpdateDatasetEntriesRequest.idempotencyToken(), datasetType: String, projectName: String) {
