...
public struct DynamoDBStreams: AWSService {
    ...
    public func describeStream(_ input: DescribeStreamInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStreamOutput> {
        return self.client.execute(operation: "DescribeStream", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getRecords(_ input: GetRecordsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRecordsOutput> {
        return self.client.execute(operation: "GetRecords", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getShardIterator(_ input: GetShardIteratorInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetShardIteratorOutput> {
        return self.client.execute(operation: "GetShardIterator", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listStreams(_ input: ListStreamsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStreamsOutput> {
        return self.client.execute(operation: "ListStreams", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
