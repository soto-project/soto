...
extension IoTWireless {
    ...
    public struct CreateNetworkAnalyzerConfigurationRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.wirelessDevices, name: "wirelessDevices", parent: name, min: 0)
    ...
    public struct DeleteNetworkAnalyzerConfigurationRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "configurationName", location: .uri(locationName: "ConfigurationName"))
        ]
    ...
    public struct DisassociateMulticastGroupFromFuotaTaskRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "id", location: .uri(locationName: "Id")),
            AWSMemberEncoding(label: "multicastGroupId", location: .uri(locationName: "MulticastGroupId"))
        ]
    ...
    public struct ListWirelessDevicesRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "fuotaTaskId", location: .querystring(locationName: "fuotaTaskId")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "multicastGroupId", location: .querystring(locationName: "multicastGroupId")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
    ...
    public struct UpdateNetworkAnalyzerConfigurationRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.wirelessDevicesToAdd, name: "wirelessDevicesToAdd", parent: name, min: 0)
            ...
            try self.validate(self.wirelessDevicesToRemove, name: "wirelessDevicesToRemove", parent: name, min: 0)
