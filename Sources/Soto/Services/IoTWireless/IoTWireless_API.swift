...
public struct IoTWireless: AWSService {
    ...
    public func getLogLevelsByResourceTypes(_ input: GetLogLevelsByResourceTypesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetLogLevelsByResourceTypesResponse> {
        return self.client.execute(operation: "GetLogLevelsByResourceTypes", path: "/log-levels", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getResourceLogLevel(_ input: GetResourceLogLevelRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetResourceLogLevelResponse> {
        return self.client.execute(operation: "GetResourceLogLevel", path: "/log-levels/{ResourceIdentifier}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putResourceLogLevel(_ input: PutResourceLogLevelRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutResourceLogLevelResponse> {
        return self.client.execute(operation: "PutResourceLogLevel", path: "/log-levels/{ResourceIdentifier}", httpMethod: .PUT, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Remove log-level overrides if any for all resources (both wireless devices and wireless gateways).
    public func resetAllResourceLogLevels(_ input: ResetAllResourceLogLevelsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResetAllResourceLogLevelsResponse> {
        return self.client.execute(operation: "ResetAllResourceLogLevels", path: "/log-levels", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func resetResourceLogLevel(_ input: ResetResourceLogLevelRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResetResourceLogLevelResponse> {
        return self.client.execute(operation: "ResetResourceLogLevel", path: "/log-levels/{ResourceIdentifier}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateLogLevelsByResourceTypes(_ input: UpdateLogLevelsByResourceTypesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateLogLevelsByResourceTypesResponse> {
        return self.client.execute(operation: "UpdateLogLevelsByResourceTypes", path: "/log-levels", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
