...
public struct ECS: AWSService {
    ...
    public func createCapacityProvider(_ input: CreateCapacityProviderRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCapacityProviderResponse> {
        return self.client.execute(operation: "CreateCapacityProvider", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createService(_ input: CreateServiceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateServiceResponse> {
        return self.client.execute(operation: "CreateService", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Create a task set in the specified cluster and service. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func createTaskSet(_ input: CreateTaskSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTaskSetResponse> {
        return self.client.execute(operation: "CreateTaskSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Disables an account setting for a specified IAM user, IAM role, or the root user for an account.
    public func deleteAccountSetting(_ input: DeleteAccountSettingRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteAccountSettingResponse> {
        return self.client.execute(operation: "DeleteAccountSetting", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Deletes one or more custom attributes from an Amazon ECS resource.
    public func deleteAttributes(_ input: DeleteAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteAttributesResponse> {
        return self.client.execute(operation: "DeleteAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteCapacityProvider(_ input: DeleteCapacityProviderRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCapacityProviderResponse> {
        return self.client.execute(operation: "DeleteCapacityProvider", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteService(_ input: DeleteServiceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteServiceResponse> {
        return self.client.execute(operation: "DeleteService", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Deletes a specified task set within a service. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func deleteTaskSet(_ input: DeleteTaskSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTaskSetResponse> {
        return self.client.execute(operation: "DeleteTaskSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deregisterContainerInstance(_ input: DeregisterContainerInstanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterContainerInstanceResponse> {
        return self.client.execute(operation: "DeregisterContainerInstance", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deregisterTaskDefinition(_ input: DeregisterTaskDefinitionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterTaskDefinitionResponse> {
        return self.client.execute(operation: "DeregisterTaskDefinition", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes one or more of your capacity providers.
    public func describeCapacityProviders(_ input: DescribeCapacityProvidersRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCapacityProvidersResponse> {
        return self.client.execute(operation: "DescribeCapacityProviders", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeContainerInstances(_ input: DescribeContainerInstancesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContainerInstancesResponse> {
        return self.client.execute(operation: "DescribeContainerInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes the specified services running in your cluster.
    public func describeServices(_ input: DescribeServicesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeServicesResponse> {
        return self.client.execute(operation: "DescribeServices", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes a task definition. You can specify a family and revision to find information about a specific task definition, or you can simply specify the family to find the latest ACTIVE revision in that family.  You can only describe INACTIVE task definitions while an active task or service references them.
    public func describeTaskDefinition(_ input: DescribeTaskDefinitionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTaskDefinitionResponse> {
        return self.client.execute(operation: "DescribeTaskDefinition", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes the task sets in the specified cluster and service. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func describeTaskSets(_ input: DescribeTaskSetsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTaskSetsResponse> {
        return self.client.execute(operation: "DescribeTaskSets", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Describes a specified task or tasks.
    public func describeTasks(_ input: DescribeTasksRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTasksResponse> {
        return self.client.execute(operation: "DescribeTasks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func discoverPollEndpoint(_ input: DiscoverPollEndpointRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DiscoverPollEndpointResponse> {
        return self.client.execute(operation: "DiscoverPollEndpoint", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Runs a command remotely on a container within a task.
    public func executeCommand(_ input: ExecuteCommandRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExecuteCommandResponse> {
        return self.client.execute(operation: "ExecuteCommand", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Lists the account settings for a specified principal.
    public func listAccountSettings(_ input: ListAccountSettingsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAccountSettingsResponse> {
        return self.client.execute(operation: "ListAccountSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Lists the attributes for Amazon ECS resources within a specified target type and cluster. When you specify a target type and cluster, ListAttributes returns a list of attribute objects, one for each attribute on each resource. You can filter the list of results to a single attribute name to only return results that have that name. You can also filter the results by attribute name and value, for example, to see which container instances in a cluster are running a Linux AMI (ecs.os-type=linux).
    public func listAttributes(_ input: ListAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAttributesResponse> {
        return self.client.execute(operation: "ListAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns a list of existing clusters.
    public func listClusters(_ input: ListClustersRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListClustersResponse> {
    ...
    public func listContainerInstances(_ input: ListContainerInstancesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListContainerInstancesResponse> {
        return self.client.execute(operation: "ListContainerInstances", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns a list of services. You can filter the results by cluster, launch type, and scheduling strategy.
    public func listServices(_ input: ListServicesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListServicesResponse> {
        return self.client.execute(operation: "ListServices", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listTaskDefinitionFamilies(_ input: ListTaskDefinitionFamiliesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTaskDefinitionFamiliesResponse> {
        return self.client.execute(operation: "ListTaskDefinitionFamilies", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns a list of task definitions that are registered to your account. You can filter the results by family name with the familyPrefix parameter or by status with the status parameter.
    public func listTaskDefinitions(_ input: ListTaskDefinitionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTaskDefinitionsResponse> {
        return self.client.execute(operation: "ListTaskDefinitions", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putAccountSetting(_ input: PutAccountSettingRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAccountSettingResponse> {
        return self.client.execute(operation: "PutAccountSetting", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Modifies an account setting for all IAM users on an account for whom no individual account setting has been specified. Account settings are set on a per-Region basis.
    public func putAccountSettingDefault(_ input: PutAccountSettingDefaultRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAccountSettingDefaultResponse> {
        return self.client.execute(operation: "PutAccountSettingDefault", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Create or update an attribute on an Amazon ECS resource. If the attribute does not exist, it is created. If the attribute exists, its value is replaced with the specified value. To delete an attribute, use DeleteAttributes. For more information, see Attributes in the Amazon Elastic Container Service Developer Guide.
    public func putAttributes(_ input: PutAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAttributesResponse> {
        return self.client.execute(operation: "PutAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putClusterCapacityProviders(_ input: PutClusterCapacityProvidersRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutClusterCapacityProvidersResponse> {
        return self.client.execute(operation: "PutClusterCapacityProviders", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func registerContainerInstance(_ input: RegisterContainerInstanceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterContainerInstanceResponse> {
        return self.client.execute(operation: "RegisterContainerInstance", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func registerTaskDefinition(_ input: RegisterTaskDefinitionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterTaskDefinitionResponse> {
        return self.client.execute(operation: "RegisterTaskDefinition", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func runTask(_ input: RunTaskRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RunTaskResponse> {
        return self.client.execute(operation: "RunTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startTask(_ input: StartTaskRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartTaskResponse> {
        return self.client.execute(operation: "StartTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func stopTask(_ input: StopTaskRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopTaskResponse> {
        return self.client.execute(operation: "StopTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func submitAttachmentStateChanges(_ input: SubmitAttachmentStateChangesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitAttachmentStateChangesResponse> {
        return self.client.execute(operation: "SubmitAttachmentStateChanges", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func submitContainerStateChange(_ input: SubmitContainerStateChangeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitContainerStateChangeResponse> {
        return self.client.execute(operation: "SubmitContainerStateChange", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func submitTaskStateChange(_ input: SubmitTaskStateChangeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitTaskStateChangeResponse> {
        return self.client.execute(operation: "SubmitTaskStateChange", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateCapacityProvider(_ input: UpdateCapacityProviderRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateCapacityProviderResponse> {
        return self.client.execute(operation: "UpdateCapacityProvider", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateClusterSettings(_ input: UpdateClusterSettingsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateClusterSettingsResponse> {
        return self.client.execute(operation: "UpdateClusterSettings", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateContainerAgent(_ input: UpdateContainerAgentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContainerAgentResponse> {
        return self.client.execute(operation: "UpdateContainerAgent", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateContainerInstancesState(_ input: UpdateContainerInstancesStateRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContainerInstancesStateResponse> {
        return self.client.execute(operation: "UpdateContainerInstancesState", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateService(_ input: UpdateServiceRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServiceResponse> {
        return self.client.execute(operation: "UpdateService", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Modifies which task set in a service is the primary task set. Any parameters that are updated on the primary task set in a service will transition to the service. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func updateServicePrimaryTaskSet(_ input: UpdateServicePrimaryTaskSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServicePrimaryTaskSetResponse> {
        return self.client.execute(operation: "UpdateServicePrimaryTaskSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Modifies a task set. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func updateTaskSet(_ input: UpdateTaskSetRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTaskSetResponse> {
        return self.client.execute(operation: "UpdateTaskSet", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
