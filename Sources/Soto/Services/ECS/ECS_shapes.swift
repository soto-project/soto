...
extension ECS {
    ...
    public enum CapacityReservationPreference: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case reservationsExcluded = "RESERVATIONS_EXCLUDED"
        case reservationsFirst = "RESERVATIONS_FIRST"
        case reservationsOnly = "RESERVATIONS_ONLY"
        public var description: String { return self.rawValue }
    }
    ...
    public struct CapacityReservationRequest: AWSEncodableShape & AWSDecodableShape {
        ...
        public let reservationPreference: CapacityReservationPreference?

        @inlinable
        public init(reservationGroupArn: String? = nil, reservationPreference: CapacityReservationPreference? = nil) {
    ...
    public struct ContainerDefinition: AWSEncodableShape & AWSDecodableShape {
        ...
        /// Linux-specific modifications that are applied to the default Docker container configuration, such as Linux kernel capabilities. For more information see KernelCapabilities.  This parameter is not supported for Windows containers.
    ...
    public struct InstanceLaunchTemplate: AWSEncodableShape & AWSDecodableShape {
        ...
        /// Capacity reservation specifications. You can specify:   Capacity reservation preference   Reservation resource group to be used for targeted capacity reservations   Amazon ECS will launch instances according to the specified criteria.
    ...
    public struct UpdateServiceRequest: AWSEncodableShape {
        ...
        public let cluster: String?
        /// Optional deployment parameters that control how many tasks run during the deployment and the ordering of stopping and starting tasks. This parameter doesn't trigger a new service deployment.
        public let deploymentConfiguration: DeploymentConfiguration?
        public let deploymentController: DeploymentController?
        ...
        public let volumeConfigurations: [ServiceVolumeConfiguration]?
        /// An object representing the VPC Lattice configuration for the service being updated. This parameter triggers a new service deployment.
        public let vpcLatticeConfigurations: [VpcLatticeConfiguration]?
