...
extension ECS {
    ...
    public struct UpdateServiceRequest: AWSEncodableShape {
        ...
        /// 			deployments. The following list provides the valid transitions:   Update the Fargate launch type to an EC2 capacity provider.   Update the Amazon EC2 launch type to a Fargate capacity provider.   Update the Fargate capacity provider to an EC2 capacity provider.   Update the Amazon EC2 capacity provider to a Fargate capacity provider.    Update the EC2 or Fargate capacity provider back to the launch type. Pass an empty list in the capacityProvider parameter.   For information about Amazon Web Services CDK considerations, see Amazon Web Services CDK considerations.
        public let capacityProviderStrategy: [CapacityProviderStrategyItem]?
