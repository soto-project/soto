...
public struct STS: AWSService {
    ...
    @Sendable
    public func assumeRole(_ input: AssumeRoleRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssumeRoleResponse {
    ...
    @Sendable
    public func assumeRoleWithSAML(_ input: AssumeRoleWithSAMLRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssumeRoleWithSAMLResponse {
        return try await self.client.execute(
    ...
    @Sendable
    public func assumeRoleWithWebIdentity(_ input: AssumeRoleWithWebIdentityRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssumeRoleWithWebIdentityResponse {
        return try await self.client.execute(
    ...
    @Sendable
    public func decodeAuthorizationMessage(_ input: DecodeAuthorizationMessageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DecodeAuthorizationMessageResponse {
        return try await self.client.execute(
    ...
    @Sendable
    public func getAccessKeyInfo(_ input: GetAccessKeyInfoRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetAccessKeyInfoResponse {
        return try await self.client.execute(
    ...
    @Sendable
    public func getCallerIdentity(_ input: GetCallerIdentityRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetCallerIdentityResponse {
        return try await self.client.execute(
    ...
    @Sendable
    public func getSessionToken(_ input: GetSessionTokenRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSessionTokenResponse {
        return try await self.client.execute(
