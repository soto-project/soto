...
extension DataSync {
    ...
    public struct CreateLocationHdfsRequest: AWSEncodableShape {
        ...
        public let kerberosKeytab: AWSBlob?
        ...
        public let kerberosKrb5Conf: AWSBlob?
        ...
        public init(agentArns: [String], authenticationType: HdfsAuthenticationType, blockSize: Int? = nil, kerberosKeytab: AWSBlob? = nil, kerberosKrb5Conf: AWSBlob? = nil, kerberosPrincipal: String? = nil, kmsKeyProviderUri: String? = nil, nameNodes: [HdfsNameNode], qopConfiguration: QopConfiguration? = nil, replicationFactor: Int? = nil, simpleUser: String? = nil, subdirectory: String? = nil, tags: [TagListEntry]? = nil) {
    ...
    public struct UpdateLocationHdfsRequest: AWSEncodableShape {
        ...
        public init(agentArns: [String]? = nil, authenticationType: HdfsAuthenticationType? = nil, blockSize: Int? = nil, kerberosKeytab: AWSBlob? = nil, kerberosKrb5Conf: AWSBlob? = nil, kerberosPrincipal: String? = nil, kmsKeyProviderUri: String? = nil, locationArn: String, nameNodes: [HdfsNameNode]? = nil, qopConfiguration: QopConfiguration? = nil, replicationFactor: Int? = nil, simpleUser: String? = nil, subdirectory: String? = nil) {
            self.agentArns = agentArns
            self.authenticationType = authenticationType
            self.blockSize = blockSize
            self.kerberosKeytab = kerberosKeytab
