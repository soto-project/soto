...
public struct Tnb: AWSService {
    ...
    public func cancelSolNetworkOperation(_ input: CancelSolNetworkOperationInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "CancelSolNetworkOperation", path: "/sol/nslcm/v1/ns_lcm_op_occs/{nsLcmOpOccId}/cancel", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSolFunctionPackage(_ input: CreateSolFunctionPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSolFunctionPackageOutput {
        return try await self.client.execute(operation: "CreateSolFunctionPackage", path: "/sol/vnfpkgm/v1/vnf_packages", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSolNetworkInstance(_ input: CreateSolNetworkInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSolNetworkInstanceOutput {
        return try await self.client.execute(operation: "CreateSolNetworkInstance", path: "/sol/nslcm/v1/ns_instances", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSolNetworkPackage(_ input: CreateSolNetworkPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSolNetworkPackageOutput {
        return try await self.client.execute(operation: "CreateSolNetworkPackage", path: "/sol/nsd/v1/ns_descriptors", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSolFunctionPackage(_ input: DeleteSolFunctionPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSolFunctionPackage", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSolNetworkInstance(_ input: DeleteSolNetworkInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSolNetworkInstance", path: "/sol/nslcm/v1/ns_instances/{nsInstanceId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSolNetworkPackage(_ input: DeleteSolNetworkPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSolNetworkPackage", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolFunctionInstance(_ input: GetSolFunctionInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolFunctionInstanceOutput {
        return try await self.client.execute(operation: "GetSolFunctionInstance", path: "/sol/vnflcm/v1/vnf_instances/{vnfInstanceId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolFunctionPackage(_ input: GetSolFunctionPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolFunctionPackageOutput {
        return try await self.client.execute(operation: "GetSolFunctionPackage", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolFunctionPackageContent(_ input: GetSolFunctionPackageContentInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolFunctionPackageContentOutput {
        return try await self.client.execute(operation: "GetSolFunctionPackageContent", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/package_content", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolFunctionPackageDescriptor(_ input: GetSolFunctionPackageDescriptorInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolFunctionPackageDescriptorOutput {
        return try await self.client.execute(operation: "GetSolFunctionPackageDescriptor", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/vnfd", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolNetworkInstance(_ input: GetSolNetworkInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolNetworkInstanceOutput {
        return try await self.client.execute(operation: "GetSolNetworkInstance", path: "/sol/nslcm/v1/ns_instances/{nsInstanceId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolNetworkOperation(_ input: GetSolNetworkOperationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolNetworkOperationOutput {
        return try await self.client.execute(operation: "GetSolNetworkOperation", path: "/sol/nslcm/v1/ns_lcm_op_occs/{nsLcmOpOccId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolNetworkPackage(_ input: GetSolNetworkPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolNetworkPackageOutput {
        return try await self.client.execute(operation: "GetSolNetworkPackage", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolNetworkPackageContent(_ input: GetSolNetworkPackageContentInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolNetworkPackageContentOutput {
        return try await self.client.execute(operation: "GetSolNetworkPackageContent", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSolNetworkPackageDescriptor(_ input: GetSolNetworkPackageDescriptorInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSolNetworkPackageDescriptorOutput {
        return try await self.client.execute(operation: "GetSolNetworkPackageDescriptor", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func instantiateSolNetworkInstance(_ input: InstantiateSolNetworkInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> InstantiateSolNetworkInstanceOutput {
        return try await self.client.execute(operation: "InstantiateSolNetworkInstance", path: "/sol/nslcm/v1/ns_instances/{nsInstanceId}/instantiate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSolFunctionInstances(_ input: ListSolFunctionInstancesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSolFunctionInstancesOutput {
        return try await self.client.execute(operation: "ListSolFunctionInstances", path: "/sol/vnflcm/v1/vnf_instances", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSolFunctionPackages(_ input: ListSolFunctionPackagesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSolFunctionPackagesOutput {
        return try await self.client.execute(operation: "ListSolFunctionPackages", path: "/sol/vnfpkgm/v1/vnf_packages", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSolNetworkInstances(_ input: ListSolNetworkInstancesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSolNetworkInstancesOutput {
        return try await self.client.execute(operation: "ListSolNetworkInstances", path: "/sol/nslcm/v1/ns_instances", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSolNetworkOperations(_ input: ListSolNetworkOperationsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSolNetworkOperationsOutput {
        return try await self.client.execute(operation: "ListSolNetworkOperations", path: "/sol/nslcm/v1/ns_lcm_op_occs", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listSolNetworkPackages(_ input: ListSolNetworkPackagesInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSolNetworkPackagesOutput {
        return try await self.client.execute(operation: "ListSolNetworkPackages", path: "/sol/nsd/v1/ns_descriptors", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putSolFunctionPackageContent(_ input: PutSolFunctionPackageContentInput, logger: Logger = AWSClient.loggingDisabled) async throws -> PutSolFunctionPackageContentOutput {
        return try await self.client.execute(operation: "PutSolFunctionPackageContent", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/package_content", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putSolNetworkPackageContent(_ input: PutSolNetworkPackageContentInput, logger: Logger = AWSClient.loggingDisabled) async throws -> PutSolNetworkPackageContentOutput {
        return try await self.client.execute(operation: "PutSolNetworkPackageContent", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func terminateSolNetworkInstance(_ input: TerminateSolNetworkInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> TerminateSolNetworkInstanceOutput {
        return try await self.client.execute(operation: "TerminateSolNetworkInstance", path: "/sol/nslcm/v1/ns_instances/{nsInstanceId}/terminate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateSolFunctionPackage(_ input: UpdateSolFunctionPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateSolFunctionPackageOutput {
        return try await self.client.execute(operation: "UpdateSolFunctionPackage", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateSolNetworkInstance(_ input: UpdateSolNetworkInstanceInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateSolNetworkInstanceOutput {
        return try await self.client.execute(operation: "UpdateSolNetworkInstance", path: "/sol/nslcm/v1/ns_instances/{nsInstanceId}/update", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateSolNetworkPackage(_ input: UpdateSolNetworkPackageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateSolNetworkPackageOutput {
        return try await self.client.execute(operation: "UpdateSolNetworkPackage", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func validateSolFunctionPackageContent(_ input: ValidateSolFunctionPackageContentInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ValidateSolFunctionPackageContentOutput {
        return try await self.client.execute(operation: "ValidateSolFunctionPackageContent", path: "/sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/package_content/validate", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func validateSolNetworkPackageContent(_ input: ValidateSolNetworkPackageContentInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ValidateSolNetworkPackageContentOutput {
        return try await self.client.execute(operation: "ValidateSolNetworkPackageContent", path: "/sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content/validate", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
}
