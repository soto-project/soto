...
public struct PersonalizeRuntime: AWSService {
    ...
    public func getPersonalizedRanking(_ input: GetPersonalizedRankingRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPersonalizedRankingResponse> {
        return self.client.execute(operation: "GetPersonalizedRanking", path: "/personalize-ranking", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getRecommendations(_ input: GetRecommendationsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRecommendationsResponse> {
        return self.client.execute(operation: "GetRecommendations", path: "/recommendations", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
