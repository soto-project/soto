...
extension Neptunedata {
    ...
    public struct CancelLoaderJobInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "loadId", location: .uri("loadId"))
        ]
    ...
    public struct CancelMLDataProcessingJobInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "clean", location: .querystring("clean")),
            AWSMemberEncoding(label: "id", location: .uri("id")),
            AWSMemberEncoding(label: "neptuneIamRoleArn", location: .querystring("neptuneIamRoleArn"))
        ]
    ...
    public struct CancelOpenCypherQueryInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "queryId", location: .uri("queryId")),
            AWSMemberEncoding(label: "silent", location: .querystring("silent"))
        ]
    ...
    public struct ExecuteGremlinExplainQueryOutput: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "output"
        public static let _options: AWSShapeOptions = [.rawPayload]
        /// A text blob containing the Gremlin explain result, as described in Tuning Gremlin queries.
        public let output: AWSPayload?

        public init(output: AWSPayload? = nil) {
            self.output = output
        }
    ...
    public struct ExecuteGremlinProfileQueryOutput: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "output"
        public static let _options: AWSShapeOptions = [.rawPayload]
    ...
    public struct ExecuteGremlinQueryInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "serializer", location: .header("accept"))
        ]
    ...
    public struct ExecuteOpenCypherExplainQueryOutput: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "results"
        public static let _options: AWSShapeOptions = [.rawPayload]
        /// A text blob containing the openCypher explain results.
        public let results: AWSPayload

        public init(results: AWSPayload) {
            self.results = results
        }
    ...
    public struct GetLoaderJobStatusInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "details", location: .querystring("details")),
            AWSMemberEncoding(label: "errors", location: .querystring("errors")),
            AWSMemberEncoding(label: "errorsPerPage", location: .querystring("errorsPerPage")),
            AWSMemberEncoding(label: "loadId", location: .uri("loadId")),
            AWSMemberEncoding(label: "page", location: .querystring("page"))
        ]
    ...
    public struct GetPropertygraphStreamInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "commitNum", location: .querystring("commitNum")),
            AWSMemberEncoding(label: "encoding", location: .header("Accept-Encoding")),
            AWSMemberEncoding(label: "iteratorType", location: .querystring("iteratorType")),
            AWSMemberEncoding(label: "limit", location: .querystring("limit")),
            AWSMemberEncoding(label: "opNum", location: .querystring("opNum"))
        ]
    ...
    public struct ListGremlinQueriesInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "includeWaiting", location: .querystring("includeWaiting"))
        ]
    ...
    public struct ListLoaderJobsInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "includeQueuedLoads", location: .querystring("includeQueuedLoads")),
            AWSMemberEncoding(label: "limit", location: .querystring("limit"))
        ]
