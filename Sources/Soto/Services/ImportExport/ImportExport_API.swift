...
public struct ImportExport: AWSService {
    ...
    public func cancelJob(_ input: CancelJobInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CancelJobOutput> {
        return self.client.execute(operation: "CancelJob", path: "/?Operation=CancelJob", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createJob(_ input: CreateJobInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateJobOutput> {
        return self.client.execute(operation: "CreateJob", path: "/?Operation=CreateJob", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getShippingLabel(_ input: GetShippingLabelInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetShippingLabelOutput> {
        return self.client.execute(operation: "GetShippingLabel", path: "/?Operation=GetShippingLabel", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getStatus(_ input: GetStatusInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetStatusOutput> {
        return self.client.execute(operation: "GetStatus", path: "/?Operation=GetStatus", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listJobs(_ input: ListJobsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListJobsOutput> {
        return self.client.execute(operation: "ListJobs", path: "/?Operation=ListJobs", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateJob(_ input: UpdateJobInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateJobOutput> {
        return self.client.execute(operation: "UpdateJob", path: "/?Operation=UpdateJob", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
}
