...
public struct LexRuntimeService: AWSService {
    ...
    public func deleteSession(_ input: DeleteSessionRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteSessionResponse> {
        return self.client.execute(operation: "DeleteSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: .DELETE, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getSession(_ input: GetSessionRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetSessionResponse> {
        return self.client.execute(operation: "GetSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session/", httpMethod: .GET, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func postContent(_ input: PostContentRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PostContentResponse> {
        return self.client.execute(operation: "PostContent", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/content", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func postText(_ input: PostTextRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PostTextResponse> {
        return self.client.execute(operation: "PostText", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/text", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putSession(_ input: PutSessionRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutSessionResponse> {
        return self.client.execute(operation: "PutSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func postContentStreaming(_ input: PostContentRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled, _ stream: @escaping (ByteBuffer, EventLoop) -> EventLoopFuture<Void>) -> EventLoopFuture<PostContentResponse> {
        return self.client.execute(operation: "PostContent", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/content", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger, stream: stream)
    }
    ...
    public func putSessionStreaming(_ input: PutSessionRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled, _ stream: @escaping (ByteBuffer, EventLoop) -> EventLoopFuture<Void>) -> EventLoopFuture<PutSessionResponse> {
        return self.client.execute(operation: "PutSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger, stream: stream)
    }
}
