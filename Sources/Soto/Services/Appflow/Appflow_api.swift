...
public struct Appflow: AWSService {
    ...
    public func cancelFlowExecutions(_ input: CancelFlowExecutionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelFlowExecutionsResponse> {
        return self.client.execute(operation: "CancelFlowExecutions", path: "/cancel-flow-executions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func resetConnectorMetadataCache(_ input: ResetConnectorMetadataCacheRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResetConnectorMetadataCacheResponse> {
        return self.client.execute(operation: "ResetConnectorMetadataCache", path: "/reset-connector-metadata-cache", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
