...
public struct CognitoIdentity: AWSService {
    ...
    public func createIdentityPool(_ input: CreateIdentityPoolInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<IdentityPool> {
        return self.client.execute(operation: "CreateIdentityPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteIdentities(_ input: DeleteIdentitiesInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteIdentitiesResponse> {
        return self.client.execute(operation: "DeleteIdentities", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteIdentityPool(_ input: DeleteIdentityPoolInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteIdentityPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeIdentity(_ input: DescribeIdentityInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<IdentityDescription> {
        return self.client.execute(operation: "DescribeIdentity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeIdentityPool(_ input: DescribeIdentityPoolInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<IdentityPool> {
        return self.client.execute(operation: "DescribeIdentityPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getCredentialsForIdentity(_ input: GetCredentialsForIdentityInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetCredentialsForIdentityResponse> {
        return self.client.execute(operation: "GetCredentialsForIdentity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getId(_ input: GetIdInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetIdResponse> {
        return self.client.execute(operation: "GetId", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getIdentityPoolRoles(_ input: GetIdentityPoolRolesInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetIdentityPoolRolesResponse> {
        return self.client.execute(operation: "GetIdentityPoolRoles", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getOpenIdToken(_ input: GetOpenIdTokenInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetOpenIdTokenResponse> {
        return self.client.execute(operation: "GetOpenIdToken", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getOpenIdTokenForDeveloperIdentity(_ input: GetOpenIdTokenForDeveloperIdentityInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetOpenIdTokenForDeveloperIdentityResponse> {
        return self.client.execute(operation: "GetOpenIdTokenForDeveloperIdentity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listIdentityPools(_ input: ListIdentityPoolsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListIdentityPoolsResponse> {
        return self.client.execute(operation: "ListIdentityPools", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func lookupDeveloperIdentity(_ input: LookupDeveloperIdentityInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<LookupDeveloperIdentityResponse> {
        return self.client.execute(operation: "LookupDeveloperIdentity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func mergeDeveloperIdentities(_ input: MergeDeveloperIdentitiesInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<MergeDeveloperIdentitiesResponse> {
        return self.client.execute(operation: "MergeDeveloperIdentities", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func setIdentityPoolRoles(_ input: SetIdentityPoolRolesInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "SetIdentityPoolRoles", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func unlinkDeveloperIdentity(_ input: UnlinkDeveloperIdentityInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "UnlinkDeveloperIdentity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func unlinkIdentity(_ input: UnlinkIdentityInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "UnlinkIdentity", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateIdentityPool(_ input: IdentityPool, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<IdentityPool> {
        return self.client.execute(operation: "UpdateIdentityPool", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, on: eventLoop, logger: logger)
    }
}
