...
public struct Synthetics: AWSService {
    ...
    public func createCanary(_ input: CreateCanaryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCanaryResponse> {
        return self.client.execute(operation: "CreateCanary", path: "/canary", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteCanary(_ input: DeleteCanaryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCanaryResponse> {
        return self.client.execute(operation: "DeleteCanary", path: "/canary/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func describeCanaries(_ input: DescribeCanariesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCanariesResponse> {
        return self.client.execute(operation: "DescribeCanaries", path: "/canaries", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Use this operation to see information from the most recent run of each canary that you have created.
    public func describeCanariesLastRun(_ input: DescribeCanariesLastRunRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCanariesLastRunResponse> {
        return self.client.execute(operation: "DescribeCanariesLastRun", path: "/canaries/last-run", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns a list of Synthetics canary runtime versions. For more information, see  Canary Runtime Versions.
    public func describeRuntimeVersions(_ input: DescribeRuntimeVersionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRuntimeVersionsResponse> {
        return self.client.execute(operation: "DescribeRuntimeVersions", path: "/runtime-versions", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves complete information about one canary. You must specify the name of the canary that you want. To get a list of canaries and their names, use DescribeCanaries.
    public func getCanary(_ input: GetCanaryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCanaryResponse> {
        return self.client.execute(operation: "GetCanary", path: "/canary/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Retrieves a list of runs for a specified canary.
    public func getCanaryRuns(_ input: GetCanaryRunsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCanaryRunsResponse> {
        return self.client.execute(operation: "GetCanaryRuns", path: "/canary/{name}/runs", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startCanary(_ input: StartCanaryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartCanaryResponse> {
        return self.client.execute(operation: "StartCanary", path: "/canary/{name}/start", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func stopCanary(_ input: StopCanaryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopCanaryResponse> {
        return self.client.execute(operation: "StopCanary", path: "/canary/{name}/stop", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateCanary(_ input: UpdateCanaryRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateCanaryResponse> {
        return self.client.execute(operation: "UpdateCanary", path: "/canary/{name}", httpMethod: .PATCH, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
