...
public struct Synthetics: AWSService {
    ...
    public func associateResource(_ input: AssociateResourceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateResourceResponse {
        return try await self.client.execute(operation: "AssociateResource", path: "/group/{GroupIdentifier}/associate", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createCanary(_ input: CreateCanaryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateCanaryResponse {
        return try await self.client.execute(operation: "CreateCanary", path: "/canary", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createGroup(_ input: CreateGroupRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateGroupResponse {
        return try await self.client.execute(operation: "CreateGroup", path: "/group", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteCanary(_ input: DeleteCanaryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteCanaryResponse {
        return try await self.client.execute(operation: "DeleteCanary", path: "/canary/{Name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteGroup(_ input: DeleteGroupRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteGroupResponse {
        return try await self.client.execute(operation: "DeleteGroup", path: "/group/{GroupIdentifier}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeCanaries(_ input: DescribeCanariesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeCanariesResponse {
        return try await self.client.execute(operation: "DescribeCanaries", path: "/canaries", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeCanariesLastRun(_ input: DescribeCanariesLastRunRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeCanariesLastRunResponse {
        return try await self.client.execute(operation: "DescribeCanariesLastRun", path: "/canaries/last-run", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func describeRuntimeVersions(_ input: DescribeRuntimeVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeRuntimeVersionsResponse {
        return try await self.client.execute(operation: "DescribeRuntimeVersions", path: "/runtime-versions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func disassociateResource(_ input: DisassociateResourceRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DisassociateResourceResponse {
        return try await self.client.execute(operation: "DisassociateResource", path: "/group/{GroupIdentifier}/disassociate", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getCanary(_ input: GetCanaryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetCanaryResponse {
        return try await self.client.execute(operation: "GetCanary", path: "/canary/{Name}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getCanaryRuns(_ input: GetCanaryRunsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetCanaryRunsResponse {
        return try await self.client.execute(operation: "GetCanaryRuns", path: "/canary/{Name}/runs", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getGroup(_ input: GetGroupRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetGroupResponse {
        return try await self.client.execute(operation: "GetGroup", path: "/group/{GroupIdentifier}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listAssociatedGroups(_ input: ListAssociatedGroupsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListAssociatedGroupsResponse {
        return try await self.client.execute(operation: "ListAssociatedGroups", path: "/resource/{ResourceArn}/groups", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listGroupResources(_ input: ListGroupResourcesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGroupResourcesResponse {
        return try await self.client.execute(operation: "ListGroupResources", path: "/group/{GroupIdentifier}/resources", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listGroups(_ input: ListGroupsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListGroupsResponse {
        return try await self.client.execute(operation: "ListGroups", path: "/groups", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startCanary(_ input: StartCanaryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartCanaryResponse {
        return try await self.client.execute(operation: "StartCanary", path: "/canary/{Name}/start", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func stopCanary(_ input: StopCanaryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StopCanaryResponse {
        return try await self.client.execute(operation: "StopCanary", path: "/canary/{Name}/stop", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func updateCanary(_ input: UpdateCanaryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateCanaryResponse {
        return try await self.client.execute(operation: "UpdateCanary", path: "/canary/{Name}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger)
    }
}
