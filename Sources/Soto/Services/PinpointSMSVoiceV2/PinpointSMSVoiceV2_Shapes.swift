...
extension PinpointSMSVoiceV2 {
    ...
    public enum AccountLimitName: String, CustomStringConvertible, Codable {
    ...
    public enum ConfigurationSetFilterName: String, CustomStringConvertible, Codable {
    ...
    public enum DestinationCountryParameterKey: String, CustomStringConvertible, Codable {
    ...
    public enum KeywordAction: String, CustomStringConvertible, Codable {
    ...
    public enum KeywordFilterName: String, CustomStringConvertible, Codable {
    ...
    public enum NumberStatus: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
    ...
    public enum NumberType: String, CustomStringConvertible, Codable {
    ...
    public enum OptedOutFilterName: String, CustomStringConvertible, Codable {
        case endUserOptedOut = "end-user-opted-out"
        public var description: String { return self.rawValue }
    }

    public enum PhoneNumberFilterName: String, CustomStringConvertible, Codable {
    ...
    public enum PoolFilterName: String, CustomStringConvertible, Codable {
        case deletionProtectionEnabled = "deletion-protection-enabled"
        case messageType = "message-type"
        case optOutListName = "opt-out-list-name"
        case selfManagedOptOutsEnabled = "self-managed-opt-outs-enabled"
    ...
    public enum PoolOriginationIdentitiesFilterName: String, CustomStringConvertible, Codable {
        case isoCountryCode = "iso-country-code"
        case numberCapability = "number-capability"
        public var description: String { return self.rawValue }
    }
    ...
    public enum RequestableNumberType: String, CustomStringConvertible, Codable {
        case longCode = "LONG_CODE"
        case tenDlc = "TEN_DLC"
        case tollFree = "TOLL_FREE"
        public var description: String { return self.rawValue }
    ...
    public enum SenderIdFilterName: String, CustomStringConvertible, Codable {
        case isoCountryCode = "iso-country-code"
        case messageType = "message-type"
    ...
    public enum SpendLimitName: String, CustomStringConvertible, Codable {
    ...
    public enum VoiceMessageBodyTextType: String, CustomStringConvertible, Codable {
        case ssml = "SSML"
        case text = "TEXT"
        public var description: String { return self.rawValue }
    }
    ...
    public struct DescribeConfigurationSetsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.configurationSetNames, name: "configurationSetNames", parent: name, min: 0)
    ...
    public struct DescribeKeywordsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.keywords, name: "keywords", parent: name, min: 0)
            try self.validate(self.maxResults, name: "maxResults", parent: name, max: 100)
            try self.validate(self.maxResults, name: "maxResults", parent: name, min: 1)
            try self.validate(self.nextToken, name: "nextToken", parent: name, max: 1024)
            try self.validate(self.nextToken, name: "nextToken", parent: name, min: 1)
    ...
    public struct DescribeOptOutListsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.optOutListNames, name: "optOutListNames", parent: name, min: 0)
        }
    ...
    public struct DescribeOptedOutNumbersRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.optedOutNumbers, name: "optedOutNumbers", parent: name, min: 0)
            try self.validate(self.optOutListName, name: "optOutListName", parent: name, max: 256)
            try self.validate(self.optOutListName, name: "optOutListName", parent: name, min: 1)
            try self.validate(self.optOutListName, name: "optOutListName", parent: name, pattern: "[A-Za-z0-9_:/-]+")
        }
    ...
    public struct DescribePhoneNumbersRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.phoneNumberIds, name: "phoneNumberIds", parent: name, min: 0)
        }
    ...
    public struct DescribePoolsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.poolIds, name: "poolIds", parent: name, min: 0)
        }
    ...
    public struct DescribeSenderIdsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.senderIds, name: "senderIds", parent: name, min: 0)
        }
