...
public struct MarketplaceEntitlementService: AWSService {
    ...
    public func getEntitlements(_ input: GetEntitlementsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetEntitlementsResult> {
        return self.client.execute(operation: "GetEntitlements", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
