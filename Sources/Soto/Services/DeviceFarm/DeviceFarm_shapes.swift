...
extension DeviceFarm {
    ...
    public struct CreateRemoteAccessSessionConfiguration: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.vpceConfigurationArns?.forEach {
                ...
                try validate($0, name: "vpceConfigurationArns[]", parent: name, pattern: "^arn:aws:devicefarm:.+$")
            }
        }
    ...
    public struct CreateRemoteAccessSessionRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.deviceArn, name: "deviceArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
            ...
            try self.validate(self.instanceArn, name: "instanceArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
            try self.validate(self.name, name: "name", parent: name, max: 256)
            try self.validate(self.projectArn, name: "projectArn", parent: name, max: 1011)
            try self.validate(self.projectArn, name: "projectArn", parent: name, min: 32)
            try self.validate(self.projectArn, name: "projectArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
    ...
    public struct InstallToRemoteAccessSessionRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.remoteAccessSessionArn, name: "remoteAccessSessionArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
        }
    ...
    public struct ScheduleRunTest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.testPackageArn, name: "testPackageArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
            ...
            try self.validate(self.testSpecArn, name: "testSpecArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
        }
    ...
    public struct UpdateDeviceInstanceRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.profileArn, name: "profileArn", parent: name, pattern: "^arn:aws:devicefarm:.+$")
        }
