...
public struct SageMakerRuntime: AWSService {
    ...
    public func invokeEndpoint(_ input: InvokeEndpointInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InvokeEndpointOutput> {
        return self.client.execute(operation: "InvokeEndpoint", path: "/endpoints/{EndpointName}/invocations", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
