...
extension SageMakerRuntime {
    ...
    public struct InvokeEndpointAsyncInput: AWSEncodableShape {
        ...
        @inlinable
        public init(accept: String? = nil, body: AWSHTTPBody? = nil, contentType: String? = nil, customAttributes: String? = nil, endpointName: String, filename: String? = nil, inferenceId: String? = nil, inputLocation: String? = nil, invocationTimeoutSeconds: Int? = nil, requestTTLSeconds: Int? = nil, s3OutputPathExtension: String? = nil) {
            self.accept = accept
            self.body = body
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.body, name: "body", parent: name, max: 128000)
