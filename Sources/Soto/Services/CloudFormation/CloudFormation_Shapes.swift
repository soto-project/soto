...
extension CloudFormation {
    ...
    public enum ChangeSetHooksStatus: String, CustomStringConvertible, Codable {
    ...
    public enum HookFailureMode: String, CustomStringConvertible, Codable {
        case fail = "FAIL"
        case warn = "WARN"
        public var description: String { return self.rawValue }
    }

    public enum HookInvocationPoint: String, CustomStringConvertible, Codable {
        case preProvision = "PRE_PROVISION"
        public var description: String { return self.rawValue }
    }

    public enum HookStatus: String, CustomStringConvertible, Codable {
    ...
    public enum HookTargetType: String, CustomStringConvertible, Codable {
        case resource = "RESOURCE"
        public var description: String { return self.rawValue }
    }
    ...
    public struct ExecuteChangeSetInput: AWSEncodableShape {
        ...
        public init(changeSetName: String, clientRequestToken: String? = nil, disableRollback: Bool? = nil, stackName: String? = nil) {
            self.changeSetName = changeSetName
            self.clientRequestToken = clientRequestToken
            self.disableRollback = disableRollback
            self.stackName = stackName
    ...
    public struct RegisterTypeInput: AWSEncodableShape {
        ...
        /// The kind of extension.
        public let type: RegistryType?
        /// The name of the extension being registered. We recommend that extension names adhere to the following patterns:   For resource types, company_or_organization::service::type.   For modules, company_or_organization::service::type::MODULE.
    ...
    public struct RollbackStackInput: AWSEncodableShape {
        ...
        public init(clientRequestToken: String? = nil, roleARN: String? = nil, stackName: String) {
            self.clientRequestToken = clientRequestToken
            self.roleARN = roleARN
            self.stackName = stackName
        }
