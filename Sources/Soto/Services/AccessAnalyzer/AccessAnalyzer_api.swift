...
public struct AccessAnalyzer: AWSService {
    ...
    @Sendable
    @inlinable
    public func createServiceLinkedAnalyzer(_ input: CreateServiceLinkedAnalyzerRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateServiceLinkedAnalyzerResponse {
        try await self.client.execute(
            operation: "CreateServiceLinkedAnalyzer", 
    ...
    ///   - archiveRules: Specifies the archive rules to add for the analyzer. Archive rules automatically archive findings that meet the criteria you define for the rule.
    ///   - clientToken: A client token.
    ///   - configuration: Specifies the configuration of the analyzer. The specified scope of unused access is used for the configuration.
    ///   - type: The type of analyzer to create. Valid values are ACCOUNT_UNUSED_ACCESS and ORGANIZATION_UNUSED_ACCESS.
    ///   - logger: Logger use during operation
    @inlinable
    public func createServiceLinkedAnalyzer(
        archiveRules: [InlineArchiveRule]? = nil,
        clientToken: String? = CreateServiceLinkedAnalyzerRequest.idempotencyToken(),
        configuration: AnalyzerConfiguration? = nil,
        type: `Type`,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateServiceLinkedAnalyzerResponse {
        let input = CreateServiceLinkedAnalyzerRequest(
            archiveRules: archiveRules, 
            clientToken: clientToken, 
            configuration: configuration, 
            type: type
        )
        return try await self.createServiceLinkedAnalyzer(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func deleteServiceLinkedAnalyzer(_ input: DeleteServiceLinkedAnalyzerRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
            operation: "DeleteServiceLinkedAnalyzer", 
            path: "/service-linked-analyzer/{analyzerName}", 
            httpMethod: .DELETE, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    ///
    /// Parameters:
    ///   - analyzerName: The name of the service-linked analyzer to delete. Service-linked analyzer names follow the format _AccessAnalyzerFor{ServiceName}-{Id}.
    ///   - clientToken: A client token.
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteServiceLinkedAnalyzer(
        analyzerName: String,
        clientToken: String? = DeleteServiceLinkedAnalyzerRequest.idempotencyToken(),
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteServiceLinkedAnalyzerRequest(
            analyzerName: analyzerName, 
            clientToken: clientToken
        )
        return try await self.deleteServiceLinkedAnalyzer(input, logger: logger)
    }
