...
/// Service object for interacting with AWS ConnectCampaignService service.
///
/// Provide APIs to create and manage Amazon Connect Campaigns.
public struct ConnectCampaignService: AWSService {
    ...
    /// Initialize the ConnectCampaignService client
    /// - parameters:
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            endpoint: endpoint,
            errorType: ConnectCampaignServiceErrorType.self,
            timeout: timeout,
...
extension ConnectCampaignService {
    ...
    public init(from: ConnectCampaignService, patch: AWSServiceConfig.Patch) {
