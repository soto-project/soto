...
extension ConnectCampaignService.ListCampaignsRequest: AWSPaginateToken {
    public func usingPaginationToken(_ token: String) -> ConnectCampaignService.ListCampaignsRequest {
        return .init(
