...
extension ACMPCA {
    ...
    public struct ImportCertificateAuthorityCertificateRequest: AWSEncodableShape {
        ...
        public init(certificate: AWSBlob, certificateAuthorityArn: String, certificateChain: AWSBlob? = nil) {
            self.certificate = certificate
            self.certificateAuthorityArn = certificateAuthorityArn
            self.certificateChain = certificateChain
        }
    ...
    public struct IssueCertificateRequest: AWSEncodableShape {
        ...
        public init(apiPassthrough: ApiPassthrough? = nil, certificateAuthorityArn: String, csr: AWSBlob, idempotencyToken: String? = nil, signingAlgorithm: SigningAlgorithm, templateArn: String? = nil, validity: Validity, validityNotBefore: Validity? = nil) {
