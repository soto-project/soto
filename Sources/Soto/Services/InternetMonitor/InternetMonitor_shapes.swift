...
extension InternetMonitor {
    ...
    public struct CreateMonitorInput: AWSEncodableShape {
        ...
        public init(clientToken: String? = CreateMonitorInput.idempotencyToken(), internetMeasurementsLogDelivery: InternetMeasurementsLogDelivery? = nil, maxCityNetworksToMonitor: Int = 0, monitorName: String, resources: [String]? = nil, tags: [String: String]? = nil) {
    ...
    public struct GetMonitorOutput: AWSDecodableShape {
        ...
        public init(createdAt: Date, internetMeasurementsLogDelivery: InternetMeasurementsLogDelivery? = nil, maxCityNetworksToMonitor: Int, modifiedAt: Date, monitorArn: String, monitorName: String, processingStatus: MonitorProcessingStatusCode? = nil, processingStatusInfo: String? = nil, resources: [String], status: MonitorConfigState, tags: [String: String]? = nil) {
            self.createdAt = createdAt
            self.internetMeasurementsLogDelivery = internetMeasurementsLogDelivery
            self.maxCityNetworksToMonitor = maxCityNetworksToMonitor
    ...
    public struct UpdateMonitorInput: AWSEncodableShape {
        ...
        public init(clientToken: String? = UpdateMonitorInput.idempotencyToken(), internetMeasurementsLogDelivery: InternetMeasurementsLogDelivery? = nil, maxCityNetworksToMonitor: Int? = nil, monitorName: String, resourcesToAdd: [String]? = nil, resourcesToRemove: [String]? = nil, status: MonitorConfigState? = nil) {
            self.clientToken = clientToken
            self.internetMeasurementsLogDelivery = internetMeasurementsLogDelivery
            self.maxCityNetworksToMonitor = maxCityNetworksToMonitor
            self.monitorName = monitorName
