...
extension NetworkManager {
    ...
    public struct GetNetworkResourceRelationshipsRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "registeredGatewayArn", location: .querystring(locationName: "registeredGatewayArn")),
    ...
    public struct GetRouteAnalysisRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "globalNetworkId", location: .uri(locationName: "globalNetworkId")),
            AWSMemberEncoding(label: "routeAnalysisId", location: .uri(locationName: "routeAnalysisId"))
        ]
