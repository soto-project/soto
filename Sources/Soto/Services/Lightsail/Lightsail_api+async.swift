...
extension Lightsail {
    ...
    public func attachDisk(_ input: AttachDiskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AttachDiskResult {
        return try await self.client.execute(operation: "AttachDisk", path: "/ls/api/2016-11-28/AttachDisk", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func attachInstancesToLoadBalancer(_ input: AttachInstancesToLoadBalancerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AttachInstancesToLoadBalancerResult {
        return try await self.client.execute(operation: "AttachInstancesToLoadBalancer", path: "/ls/api/2016-11-28/AttachInstancesToLoadBalancer", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func attachLoadBalancerTlsCertificate(_ input: AttachLoadBalancerTlsCertificateRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AttachLoadBalancerTlsCertificateResult {
        return try await self.client.execute(operation: "AttachLoadBalancerTlsCertificate", path: "/ls/api/2016-11-28/AttachLoadBalancerTlsCertificate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func attachStaticIp(_ input: AttachStaticIpRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AttachStaticIpResult {
        return try await self.client.execute(operation: "AttachStaticIp", path: "/ls/api/2016-11-28/AttachStaticIp", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createBucket(_ input: CreateBucketRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateBucketResult {
        return try await self.client.execute(operation: "CreateBucket", path: "/ls/api/2016-11-28/CreateBucket", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createBucketAccessKey(_ input: CreateBucketAccessKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateBucketAccessKeyResult {
    ...
    public func createContainerService(_ input: CreateContainerServiceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateContainerServiceResult {
        return try await self.client.execute(operation: "CreateContainerService", path: "/ls/api/2016-11-28/container-services", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createContainerServiceRegistryLogin(_ input: CreateContainerServiceRegistryLoginRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateContainerServiceRegistryLoginResult {
        return try await self.client.execute(operation: "CreateContainerServiceRegistryLogin", path: "/ls/api/2016-11-28/container-registry-login", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDisk(_ input: CreateDiskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDiskResult {
        return try await self.client.execute(operation: "CreateDisk", path: "/ls/api/2016-11-28/CreateDisk", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDiskFromSnapshot(_ input: CreateDiskFromSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDiskFromSnapshotResult {
        return try await self.client.execute(operation: "CreateDiskFromSnapshot", path: "/ls/api/2016-11-28/CreateDiskFromSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDiskSnapshot(_ input: CreateDiskSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDiskSnapshotResult {
        return try await self.client.execute(operation: "CreateDiskSnapshot", path: "/ls/api/2016-11-28/CreateDiskSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDistribution(_ input: CreateDistributionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDistributionResult {
        return try await self.client.execute(operation: "CreateDistribution", path: "/ls/api/2016-11-28/CreateDistribution", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createDomain(_ input: CreateDomainRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDomainResult {
        return try await self.client.execute(operation: "CreateDomain", path: "/ls/api/2016-11-28/CreateDomain", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createInstances(_ input: CreateInstancesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateInstancesResult {
        return try await self.client.execute(operation: "CreateInstances", path: "/ls/api/2016-11-28/CreateInstances", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createInstancesFromSnapshot(_ input: CreateInstancesFromSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateInstancesFromSnapshotResult {
        return try await self.client.execute(operation: "CreateInstancesFromSnapshot", path: "/ls/api/2016-11-28/CreateInstancesFromSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createKeyPair(_ input: CreateKeyPairRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateKeyPairResult {
        return try await self.client.execute(operation: "CreateKeyPair", path: "/ls/api/2016-11-28/CreateKeyPair", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createLoadBalancer(_ input: CreateLoadBalancerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateLoadBalancerResult {
        return try await self.client.execute(operation: "CreateLoadBalancer", path: "/ls/api/2016-11-28/CreateLoadBalancer", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createLoadBalancerTlsCertificate(_ input: CreateLoadBalancerTlsCertificateRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateLoadBalancerTlsCertificateResult {
        return try await self.client.execute(operation: "CreateLoadBalancerTlsCertificate", path: "/ls/api/2016-11-28/CreateLoadBalancerTlsCertificate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createRelationalDatabase(_ input: CreateRelationalDatabaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateRelationalDatabaseResult {
        return try await self.client.execute(operation: "CreateRelationalDatabase", path: "/ls/api/2016-11-28/CreateRelationalDatabase", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createRelationalDatabaseFromSnapshot(_ input: CreateRelationalDatabaseFromSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateRelationalDatabaseFromSnapshotResult {
        return try await self.client.execute(operation: "CreateRelationalDatabaseFromSnapshot", path: "/ls/api/2016-11-28/CreateRelationalDatabaseFromSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createRelationalDatabaseSnapshot(_ input: CreateRelationalDatabaseSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateRelationalDatabaseSnapshotResult {
        return try await self.client.execute(operation: "CreateRelationalDatabaseSnapshot", path: "/ls/api/2016-11-28/CreateRelationalDatabaseSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteAlarm(_ input: DeleteAlarmRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteAlarmResult {
        return try await self.client.execute(operation: "DeleteAlarm", path: "/ls/api/2016-11-28/DeleteAlarm", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteAutoSnapshot(_ input: DeleteAutoSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteAutoSnapshotResult {
        return try await self.client.execute(operation: "DeleteAutoSnapshot", path: "/ls/api/2016-11-28/DeleteAutoSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteBucketAccessKey(_ input: DeleteBucketAccessKeyRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteBucketAccessKeyResult {
        return try await self.client.execute(operation: "DeleteBucketAccessKey", path: "/ls/api/2016-11-28/DeleteBucketAccessKey", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteContainerImage(_ input: DeleteContainerImageRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteContainerImageResult {
        return try await self.client.execute(operation: "DeleteContainerImage", path: "/ls/api/2016-11-28/container-services/{serviceName}/images/{image}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteContainerService(_ input: DeleteContainerServiceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteContainerServiceResult {
        return try await self.client.execute(operation: "DeleteContainerService", path: "/ls/api/2016-11-28/container-services/{serviceName}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDisk(_ input: DeleteDiskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDiskResult {
        return try await self.client.execute(operation: "DeleteDisk", path: "/ls/api/2016-11-28/DeleteDisk", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDiskSnapshot(_ input: DeleteDiskSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDiskSnapshotResult {
        return try await self.client.execute(operation: "DeleteDiskSnapshot", path: "/ls/api/2016-11-28/DeleteDiskSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDistribution(_ input: DeleteDistributionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDistributionResult {
        return try await self.client.execute(operation: "DeleteDistribution", path: "/ls/api/2016-11-28/DeleteDistribution", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDomain(_ input: DeleteDomainRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDomainResult {
        return try await self.client.execute(operation: "DeleteDomain", path: "/ls/api/2016-11-28/DeleteDomain", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteDomainEntry(_ input: DeleteDomainEntryRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDomainEntryResult {
        return try await self.client.execute(operation: "DeleteDomainEntry", path: "/ls/api/2016-11-28/DeleteDomainEntry", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteInstance(_ input: DeleteInstanceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteInstanceResult {
        return try await self.client.execute(operation: "DeleteInstance", path: "/ls/api/2016-11-28/DeleteInstance", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteInstanceSnapshot(_ input: DeleteInstanceSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteInstanceSnapshotResult {
        return try await self.client.execute(operation: "DeleteInstanceSnapshot", path: "/ls/api/2016-11-28/DeleteInstanceSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteKeyPair(_ input: DeleteKeyPairRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteKeyPairResult {
        return try await self.client.execute(operation: "DeleteKeyPair", path: "/ls/api/2016-11-28/DeleteKeyPair", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteKnownHostKeys(_ input: DeleteKnownHostKeysRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteKnownHostKeysResult {
        return try await self.client.execute(operation: "DeleteKnownHostKeys", path: "/ls/api/2016-11-28/DeleteKnownHostKeys", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteLoadBalancer(_ input: DeleteLoadBalancerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteLoadBalancerResult {
        return try await self.client.execute(operation: "DeleteLoadBalancer", path: "/ls/api/2016-11-28/DeleteLoadBalancer", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteLoadBalancerTlsCertificate(_ input: DeleteLoadBalancerTlsCertificateRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteLoadBalancerTlsCertificateResult {
        return try await self.client.execute(operation: "DeleteLoadBalancerTlsCertificate", path: "/ls/api/2016-11-28/DeleteLoadBalancerTlsCertificate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteRelationalDatabase(_ input: DeleteRelationalDatabaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteRelationalDatabaseResult {
        return try await self.client.execute(operation: "DeleteRelationalDatabase", path: "/ls/api/2016-11-28/DeleteRelationalDatabase", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func deleteRelationalDatabaseSnapshot(_ input: DeleteRelationalDatabaseSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteRelationalDatabaseSnapshotResult {
        return try await self.client.execute(operation: "DeleteRelationalDatabaseSnapshot", path: "/ls/api/2016-11-28/DeleteRelationalDatabaseSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func detachCertificateFromDistribution(_ input: DetachCertificateFromDistributionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DetachCertificateFromDistributionResult {
        return try await self.client.execute(operation: "DetachCertificateFromDistribution", path: "/ls/api/2016-11-28/DetachCertificateFromDistribution", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func detachDisk(_ input: DetachDiskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DetachDiskResult {
        return try await self.client.execute(operation: "DetachDisk", path: "/ls/api/2016-11-28/DetachDisk", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func detachInstancesFromLoadBalancer(_ input: DetachInstancesFromLoadBalancerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DetachInstancesFromLoadBalancerResult {
        return try await self.client.execute(operation: "DetachInstancesFromLoadBalancer", path: "/ls/api/2016-11-28/DetachInstancesFromLoadBalancer", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func detachStaticIp(_ input: DetachStaticIpRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DetachStaticIpResult {
        return try await self.client.execute(operation: "DetachStaticIp", path: "/ls/api/2016-11-28/DetachStaticIp", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func disableAddOn(_ input: DisableAddOnRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DisableAddOnResult {
        return try await self.client.execute(operation: "DisableAddOn", path: "/ls/api/2016-11-28/DisableAddOn", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func downloadDefaultKeyPair(_ input: DownloadDefaultKeyPairRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DownloadDefaultKeyPairResult {
        return try await self.client.execute(operation: "DownloadDefaultKeyPair", path: "/ls/api/2016-11-28/DownloadDefaultKeyPair", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func enableAddOn(_ input: EnableAddOnRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> EnableAddOnResult {
        return try await self.client.execute(operation: "EnableAddOn", path: "/ls/api/2016-11-28/EnableAddOn", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func exportSnapshot(_ input: ExportSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ExportSnapshotResult {
        return try await self.client.execute(operation: "ExportSnapshot", path: "/ls/api/2016-11-28/ExportSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getActiveNames(_ input: GetActiveNamesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetActiveNamesResult {
        return try await self.client.execute(operation: "GetActiveNames", path: "/ls/api/2016-11-28/GetActiveNames", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getAlarms(_ input: GetAlarmsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetAlarmsResult {
        return try await self.client.execute(operation: "GetAlarms", path: "/ls/api/2016-11-28/GetAlarms", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getAutoSnapshots(_ input: GetAutoSnapshotsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetAutoSnapshotsResult {
        return try await self.client.execute(operation: "GetAutoSnapshots", path: "/ls/api/2016-11-28/GetAutoSnapshots", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBlueprints(_ input: GetBlueprintsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBlueprintsResult {
        return try await self.client.execute(operation: "GetBlueprints", path: "/ls/api/2016-11-28/GetBlueprints", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketAccessKeys(_ input: GetBucketAccessKeysRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBucketAccessKeysResult {
        return try await self.client.execute(operation: "GetBucketAccessKeys", path: "/ls/api/2016-11-28/GetBucketAccessKeys", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketBundles(_ input: GetBucketBundlesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBucketBundlesResult {
        return try await self.client.execute(operation: "GetBucketBundles", path: "/ls/api/2016-11-28/GetBucketBundles", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getBucketMetricData(_ input: GetBucketMetricDataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBucketMetricDataResult {
    ...
    public func getBundles(_ input: GetBundlesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetBundlesResult {
        return try await self.client.execute(operation: "GetBundles", path: "/ls/api/2016-11-28/GetBundles", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getCertificates(_ input: GetCertificatesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetCertificatesResult {
        return try await self.client.execute(operation: "GetCertificates", path: "/ls/api/2016-11-28/GetCertificates", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getContainerAPIMetadata(_ input: GetContainerAPIMetadataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetContainerAPIMetadataResult {
        return try await self.client.execute(operation: "GetContainerAPIMetadata", path: "/ls/api/2016-11-28/container-api-metadata", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getContainerImages(_ input: GetContainerImagesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetContainerImagesResult {
        return try await self.client.execute(operation: "GetContainerImages", path: "/ls/api/2016-11-28/container-services/{serviceName}/images", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getContainerServiceMetricData(_ input: GetContainerServiceMetricDataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetContainerServiceMetricDataResult {
        return try await self.client.execute(operation: "GetContainerServiceMetricData", path: "/ls/api/2016-11-28/container-services/{serviceName}/metrics", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getContainerServicePowers(_ input: GetContainerServicePowersRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetContainerServicePowersResult {
        return try await self.client.execute(operation: "GetContainerServicePowers", path: "/ls/api/2016-11-28/container-service-powers", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDisk(_ input: GetDiskRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDiskResult {
        return try await self.client.execute(operation: "GetDisk", path: "/ls/api/2016-11-28/GetDisk", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDiskSnapshot(_ input: GetDiskSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDiskSnapshotResult {
        return try await self.client.execute(operation: "GetDiskSnapshot", path: "/ls/api/2016-11-28/GetDiskSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDiskSnapshots(_ input: GetDiskSnapshotsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDiskSnapshotsResult {
        return try await self.client.execute(operation: "GetDiskSnapshots", path: "/ls/api/2016-11-28/GetDiskSnapshots", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDistributionLatestCacheReset(_ input: GetDistributionLatestCacheResetRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDistributionLatestCacheResetResult {
        return try await self.client.execute(operation: "GetDistributionLatestCacheReset", path: "/ls/api/2016-11-28/GetDistributionLatestCacheReset", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDistributionMetricData(_ input: GetDistributionMetricDataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDistributionMetricDataResult {
        return try await self.client.execute(operation: "GetDistributionMetricData", path: "/ls/api/2016-11-28/GetDistributionMetricData", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDistributions(_ input: GetDistributionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDistributionsResult {
        return try await self.client.execute(operation: "GetDistributions", path: "/ls/api/2016-11-28/GetDistributions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDomain(_ input: GetDomainRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDomainResult {
        return try await self.client.execute(operation: "GetDomain", path: "/ls/api/2016-11-28/GetDomain", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getDomains(_ input: GetDomainsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetDomainsResult {
        return try await self.client.execute(operation: "GetDomains", path: "/ls/api/2016-11-28/GetDomains", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getExportSnapshotRecords(_ input: GetExportSnapshotRecordsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetExportSnapshotRecordsResult {
        return try await self.client.execute(operation: "GetExportSnapshotRecords", path: "/ls/api/2016-11-28/GetExportSnapshotRecords", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstance(_ input: GetInstanceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceResult {
        return try await self.client.execute(operation: "GetInstance", path: "/ls/api/2016-11-28/GetInstance", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstanceAccessDetails(_ input: GetInstanceAccessDetailsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceAccessDetailsResult {
        return try await self.client.execute(operation: "GetInstanceAccessDetails", path: "/ls/api/2016-11-28/GetInstanceAccessDetails", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstanceMetricData(_ input: GetInstanceMetricDataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceMetricDataResult {
        return try await self.client.execute(operation: "GetInstanceMetricData", path: "/ls/api/2016-11-28/GetInstanceMetricData", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstancePortStates(_ input: GetInstancePortStatesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstancePortStatesResult {
        return try await self.client.execute(operation: "GetInstancePortStates", path: "/ls/api/2016-11-28/GetInstancePortStates", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstanceSnapshot(_ input: GetInstanceSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceSnapshotResult {
        return try await self.client.execute(operation: "GetInstanceSnapshot", path: "/ls/api/2016-11-28/GetInstanceSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstanceSnapshots(_ input: GetInstanceSnapshotsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceSnapshotsResult {
        return try await self.client.execute(operation: "GetInstanceSnapshots", path: "/ls/api/2016-11-28/GetInstanceSnapshots", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstanceState(_ input: GetInstanceStateRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstanceStateResult {
        return try await self.client.execute(operation: "GetInstanceState", path: "/ls/api/2016-11-28/GetInstanceState", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getInstances(_ input: GetInstancesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetInstancesResult {
        return try await self.client.execute(operation: "GetInstances", path: "/ls/api/2016-11-28/GetInstances", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getKeyPair(_ input: GetKeyPairRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetKeyPairResult {
        return try await self.client.execute(operation: "GetKeyPair", path: "/ls/api/2016-11-28/GetKeyPair", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getKeyPairs(_ input: GetKeyPairsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetKeyPairsResult {
        return try await self.client.execute(operation: "GetKeyPairs", path: "/ls/api/2016-11-28/GetKeyPairs", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getLoadBalancer(_ input: GetLoadBalancerRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetLoadBalancerResult {
        return try await self.client.execute(operation: "GetLoadBalancer", path: "/ls/api/2016-11-28/GetLoadBalancer", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getLoadBalancerMetricData(_ input: GetLoadBalancerMetricDataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetLoadBalancerMetricDataResult {
        return try await self.client.execute(operation: "GetLoadBalancerMetricData", path: "/ls/api/2016-11-28/GetLoadBalancerMetricData", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getLoadBalancers(_ input: GetLoadBalancersRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetLoadBalancersResult {
        return try await self.client.execute(operation: "GetLoadBalancers", path: "/ls/api/2016-11-28/GetLoadBalancers", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getOperation(_ input: GetOperationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetOperationResult {
        return try await self.client.execute(operation: "GetOperation", path: "/ls/api/2016-11-28/GetOperation", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getOperations(_ input: GetOperationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetOperationsResult {
        return try await self.client.execute(operation: "GetOperations", path: "/ls/api/2016-11-28/GetOperations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getOperationsForResource(_ input: GetOperationsForResourceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetOperationsForResourceResult {
        return try await self.client.execute(operation: "GetOperationsForResource", path: "/ls/api/2016-11-28/GetOperationsForResource", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRegions(_ input: GetRegionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRegionsResult {
        return try await self.client.execute(operation: "GetRegions", path: "/ls/api/2016-11-28/GetRegions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabase(_ input: GetRelationalDatabaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseResult {
        return try await self.client.execute(operation: "GetRelationalDatabase", path: "/ls/api/2016-11-28/GetRelationalDatabase", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseBlueprints(_ input: GetRelationalDatabaseBlueprintsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseBlueprintsResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseBlueprints", path: "/ls/api/2016-11-28/GetRelationalDatabaseBlueprints", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseBundles(_ input: GetRelationalDatabaseBundlesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseBundlesResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseBundles", path: "/ls/api/2016-11-28/GetRelationalDatabaseBundles", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseEvents(_ input: GetRelationalDatabaseEventsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseEventsResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseEvents", path: "/ls/api/2016-11-28/GetRelationalDatabaseEvents", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseLogEvents(_ input: GetRelationalDatabaseLogEventsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseLogEventsResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseLogEvents", path: "/ls/api/2016-11-28/GetRelationalDatabaseLogEvents", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseLogStreams(_ input: GetRelationalDatabaseLogStreamsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseLogStreamsResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseLogStreams", path: "/ls/api/2016-11-28/GetRelationalDatabaseLogStreams", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseMasterUserPassword(_ input: GetRelationalDatabaseMasterUserPasswordRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseMasterUserPasswordResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseMasterUserPassword", path: "/ls/api/2016-11-28/GetRelationalDatabaseMasterUserPassword", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseMetricData(_ input: GetRelationalDatabaseMetricDataRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseMetricDataResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseMetricData", path: "/ls/api/2016-11-28/GetRelationalDatabaseMetricData", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseParameters(_ input: GetRelationalDatabaseParametersRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseParametersResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseParameters", path: "/ls/api/2016-11-28/GetRelationalDatabaseParameters", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseSnapshot(_ input: GetRelationalDatabaseSnapshotRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseSnapshotResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseSnapshot", path: "/ls/api/2016-11-28/GetRelationalDatabaseSnapshot", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabaseSnapshots(_ input: GetRelationalDatabaseSnapshotsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabaseSnapshotsResult {
        return try await self.client.execute(operation: "GetRelationalDatabaseSnapshots", path: "/ls/api/2016-11-28/GetRelationalDatabaseSnapshots", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getRelationalDatabases(_ input: GetRelationalDatabasesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetRelationalDatabasesResult {
        return try await self.client.execute(operation: "GetRelationalDatabases", path: "/ls/api/2016-11-28/GetRelationalDatabases", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getStaticIp(_ input: GetStaticIpRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetStaticIpResult {
        return try await self.client.execute(operation: "GetStaticIp", path: "/ls/api/2016-11-28/GetStaticIp", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getStaticIps(_ input: GetStaticIpsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetStaticIpsResult {
        return try await self.client.execute(operation: "GetStaticIps", path: "/ls/api/2016-11-28/GetStaticIps", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func importKeyPair(_ input: ImportKeyPairRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ImportKeyPairResult {
        return try await self.client.execute(operation: "ImportKeyPair", path: "/ls/api/2016-11-28/ImportKeyPair", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func isVpcPeered(_ input: IsVpcPeeredRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> IsVpcPeeredResult {
        return try await self.client.execute(operation: "IsVpcPeered", path: "/ls/api/2016-11-28/IsVpcPeered", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func openInstancePublicPorts(_ input: OpenInstancePublicPortsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> OpenInstancePublicPortsResult {
        return try await self.client.execute(operation: "OpenInstancePublicPorts", path: "/ls/api/2016-11-28/OpenInstancePublicPorts", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func peerVpc(_ input: PeerVpcRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PeerVpcResult {
        return try await self.client.execute(operation: "PeerVpc", path: "/ls/api/2016-11-28/PeerVpc", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putAlarm(_ input: PutAlarmRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PutAlarmResult {
        return try await self.client.execute(operation: "PutAlarm", path: "/ls/api/2016-11-28/PutAlarm", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func putInstancePublicPorts(_ input: PutInstancePublicPortsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PutInstancePublicPortsResult {
        return try await self.client.execute(operation: "PutInstancePublicPorts", path: "/ls/api/2016-11-28/PutInstancePublicPorts", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func rebootInstance(_ input: RebootInstanceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RebootInstanceResult {
        return try await self.client.execute(operation: "RebootInstance", path: "/ls/api/2016-11-28/RebootInstance", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func rebootRelationalDatabase(_ input: RebootRelationalDatabaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RebootRelationalDatabaseResult {
        return try await self.client.execute(operation: "RebootRelationalDatabase", path: "/ls/api/2016-11-28/RebootRelationalDatabase", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func registerContainerImage(_ input: RegisterContainerImageRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RegisterContainerImageResult {
        return try await self.client.execute(operation: "RegisterContainerImage", path: "/ls/api/2016-11-28/container-services/{serviceName}/images", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func releaseStaticIp(_ input: ReleaseStaticIpRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ReleaseStaticIpResult {
        return try await self.client.execute(operation: "ReleaseStaticIp", path: "/ls/api/2016-11-28/ReleaseStaticIp", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func setIpAddressType(_ input: SetIpAddressTypeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SetIpAddressTypeResult {
        return try await self.client.execute(operation: "SetIpAddressType", path: "/ls/api/2016-11-28/SetIpAddressType", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopInstance(_ input: StopInstanceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopInstanceResult {
        return try await self.client.execute(operation: "StopInstance", path: "/ls/api/2016-11-28/StopInstance", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func stopRelationalDatabase(_ input: StopRelationalDatabaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopRelationalDatabaseResult {
        return try await self.client.execute(operation: "StopRelationalDatabase", path: "/ls/api/2016-11-28/StopRelationalDatabase", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func tagResource(_ input: TagResourceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> TagResourceResult {
        return try await self.client.execute(operation: "TagResource", path: "/ls/api/2016-11-28/TagResource", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func testAlarm(_ input: TestAlarmRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> TestAlarmResult {
        return try await self.client.execute(operation: "TestAlarm", path: "/ls/api/2016-11-28/TestAlarm", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func unpeerVpc(_ input: UnpeerVpcRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UnpeerVpcResult {
        return try await self.client.execute(operation: "UnpeerVpc", path: "/ls/api/2016-11-28/UnpeerVpc", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func untagResource(_ input: UntagResourceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UntagResourceResult {
        return try await self.client.execute(operation: "UntagResource", path: "/ls/api/2016-11-28/UntagResource", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateContainerService(_ input: UpdateContainerServiceRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateContainerServiceResult {
        return try await self.client.execute(operation: "UpdateContainerService", path: "/ls/api/2016-11-28/container-services/{serviceName}", httpMethod: .PATCH, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateDomainEntry(_ input: UpdateDomainEntryRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateDomainEntryResult {
        return try await self.client.execute(operation: "UpdateDomainEntry", path: "/ls/api/2016-11-28/UpdateDomainEntry", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateInstanceMetadataOptions(_ input: UpdateInstanceMetadataOptionsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateInstanceMetadataOptionsResult {
        return try await self.client.execute(operation: "UpdateInstanceMetadataOptions", path: "/ls/api/2016-11-28/UpdateInstanceMetadataOptions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateLoadBalancerAttribute(_ input: UpdateLoadBalancerAttributeRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateLoadBalancerAttributeResult {
        return try await self.client.execute(operation: "UpdateLoadBalancerAttribute", path: "/ls/api/2016-11-28/UpdateLoadBalancerAttribute", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateRelationalDatabase(_ input: UpdateRelationalDatabaseRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateRelationalDatabaseResult {
        return try await self.client.execute(operation: "UpdateRelationalDatabase", path: "/ls/api/2016-11-28/UpdateRelationalDatabase", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func updateRelationalDatabaseParameters(_ input: UpdateRelationalDatabaseParametersRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateRelationalDatabaseParametersResult {
        return try await self.client.execute(operation: "UpdateRelationalDatabaseParameters", path: "/ls/api/2016-11-28/UpdateRelationalDatabaseParameters", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
