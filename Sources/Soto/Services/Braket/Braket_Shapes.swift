...
extension Braket {
    ...
    public struct CancelJobRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "jobArn", location: .uri(locationName: "jobArn"))
        ]
    ...
    public struct CreateJobRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.hyperParameters?.forEach {
                ...
                try validate($0.value, name: "hyperParameters[\"\($0.key)\"]", parent: name, min: 1)
            }
            ...
            try self.validate(self.inputDataConfig, name: "inputDataConfig", parent: name, min: 0)
            try self.instanceConfig.validate(name: "\(name).instanceConfig")
            try self.validate(self.jobName, name: "jobName", parent: name, max: 50)
            try self.validate(self.jobName, name: "jobName", parent: name, min: 1)
            try self.validate(self.jobName, name: "jobName", parent: name, pattern: "^[a-zA-Z0-9](-*[a-zA-Z0-9]){0,50}$")
    ...
    public struct JobCheckpointConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.s3Uri, name: "s3Uri", parent: name, min: 0)
    ...
    public struct JobOutputDataConfig: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.s3Path, name: "s3Path", parent: name, min: 0)
    ...
    public struct JobStoppingCondition: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.maxRuntimeInSeconds, name: "maxRuntimeInSeconds", parent: name, max: 432_000)
