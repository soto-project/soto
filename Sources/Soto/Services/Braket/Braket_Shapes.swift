...
extension Braket {
    ...
    public struct CancelQuantumTaskRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.quantumTaskArn, name: "quantumTaskArn", parent: name, max: 256)
            try validate(self.quantumTaskArn, name: "quantumTaskArn", parent: name, min: 1)
        }
    ...
    public struct CreateQuantumTaskRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try validate(self.clientToken, name: "clientToken", parent: name, max: 64)
            try validate(self.clientToken, name: "clientToken", parent: name, min: 1)
            try validate(self.deviceArn, name: "deviceArn", parent: name, max: 256)
            try validate(self.deviceArn, name: "deviceArn", parent: name, min: 1)
            try validate(self.deviceParameters, name: "deviceParameters", parent: name, max: 2048)
            try validate(self.deviceParameters, name: "deviceParameters", parent: name, min: 1)
            try validate(self.outputS3Bucket, name: "outputS3Bucket", parent: name, max: 63)
            try validate(self.outputS3Bucket, name: "outputS3Bucket", parent: name, min: 3)
            try validate(self.outputS3KeyPrefix, name: "outputS3KeyPrefix", parent: name, max: 1024)
            try validate(self.outputS3KeyPrefix, name: "outputS3KeyPrefix", parent: name, min: 1)
            try validate(self.shots, name: "shots", parent: name, min: 0)
        }
