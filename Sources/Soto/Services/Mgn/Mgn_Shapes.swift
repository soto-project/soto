...
extension Mgn {
    ...
    public struct DescribeSourceServersRequestFilters: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.lifeCycleStates, name: "lifeCycleStates", parent: name, min: 0)
            try self.validate(self.replicationTypes, name: "replicationTypes", parent: name, max: 2)
            try self.validate(self.replicationTypes, name: "replicationTypes", parent: name, min: 0)
