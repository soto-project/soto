...
public struct EFS: AWSService {
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            endpoint: endpoint,
            serviceEndpoints: [
                "fips-af-south-1": "elasticfilesystem-fips.af-south-1.amazonaws.com",
                "fips-ap-east-1": "elasticfilesystem-fips.ap-east-1.amazonaws.com",
                "fips-ap-northeast-1": "elasticfilesystem-fips.ap-northeast-1.amazonaws.com",
                "fips-ap-northeast-2": "elasticfilesystem-fips.ap-northeast-2.amazonaws.com",
                "fips-ap-northeast-3": "elasticfilesystem-fips.ap-northeast-3.amazonaws.com",
                "fips-ap-south-1": "elasticfilesystem-fips.ap-south-1.amazonaws.com",
                "fips-ap-southeast-1": "elasticfilesystem-fips.ap-southeast-1.amazonaws.com",
                "fips-ap-southeast-2": "elasticfilesystem-fips.ap-southeast-2.amazonaws.com",
                "fips-ap-southeast-3": "elasticfilesystem-fips.ap-southeast-3.amazonaws.com",
                "fips-ca-central-1": "elasticfilesystem-fips.ca-central-1.amazonaws.com",
                ...
                "fips-eu-west-2": "elasticfilesystem-fips.eu-west-2.amazonaws.com",
                "fips-eu-west-3": "elasticfilesystem-fips.eu-west-3.amazonaws.com",
                "fips-me-central-1": "elasticfilesystem-fips.me-central-1.amazonaws.com",
                "fips-me-south-1": "elasticfilesystem-fips.me-south-1.amazonaws.com",
                "fips-sa-east-1": "elasticfilesystem-fips.sa-east-1.amazonaws.com",
                "fips-us-east-1": "elasticfilesystem-fips.us-east-1.amazonaws.com",
                "fips-us-east-2": "elasticfilesystem-fips.us-east-2.amazonaws.com",
    ...
    public func createReplicationConfiguration(_ input: CreateReplicationConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReplicationConfigurationDescription> {
        return self.client.execute(operation: "CreateReplicationConfiguration", path: "/2015-02-01/file-systems/{SourceFileSystemId}/replication-configuration", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    @discardableResult public func deleteReplicationConfiguration(_ input: DeleteReplicationConfigurationRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteReplicationConfiguration", path: "/2015-02-01/file-systems/{SourceFileSystemId}/replication-configuration", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeReplicationConfigurations(_ input: DescribeReplicationConfigurationsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeReplicationConfigurationsResponse> {
        return self.client.execute(operation: "DescribeReplicationConfigurations", path: "/2015-02-01/file-systems/replication-configurations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
