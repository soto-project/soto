...
public struct CodeStarconnections: AWSService {
    ...
    public func createConnection(_ input: CreateConnectionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateConnectionOutput> {
    ...
    public func createHost(_ input: CreateHostInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateHostOutput> {
        return self.client.execute(operation: "CreateHost", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// The connection to be deleted.
    public func deleteConnection(_ input: DeleteConnectionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteConnectionOutput> {
    ...
    public func deleteHost(_ input: DeleteHostInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteHostOutput> {
        return self.client.execute(operation: "DeleteHost", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns the connection ARN and details such as status, owner, and provider type.
    public func getConnection(_ input: GetConnectionInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetConnectionOutput> {
        return self.client.execute(operation: "GetConnection", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns the host ARN and details such as status, provider type, endpoint, and, if applicable, the VPC configuration.
    public func getHost(_ input: GetHostInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostOutput> {
        return self.client.execute(operation: "GetHost", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Lists the connections associated with your account.
    public func listConnections(_ input: ListConnectionsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListConnectionsOutput> {
    ...
    public func listHosts(_ input: ListHostsInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostsOutput> {
        return self.client.execute(operation: "ListHosts", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func updateHost(_ input: UpdateHostInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateHostOutput> {
        return self.client.execute(operation: "UpdateHost", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
