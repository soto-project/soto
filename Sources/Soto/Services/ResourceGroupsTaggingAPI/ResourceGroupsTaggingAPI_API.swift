...
public struct ResourceGroupsTaggingAPI: AWSService {
    ...
    public func describeReportCreation(_ input: DescribeReportCreationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeReportCreationOutput> {
        return self.client.execute(operation: "DescribeReportCreation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getComplianceSummary(_ input: GetComplianceSummaryInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetComplianceSummaryOutput> {
        return self.client.execute(operation: "GetComplianceSummary", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getResources(_ input: GetResourcesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetResourcesOutput> {
        return self.client.execute(operation: "GetResources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getTagKeys(_ input: GetTagKeysInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTagKeysOutput> {
        return self.client.execute(operation: "GetTagKeys", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getTagValues(_ input: GetTagValuesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTagValuesOutput> {
        return self.client.execute(operation: "GetTagValues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func startReportCreation(_ input: StartReportCreationInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartReportCreationOutput> {
        return self.client.execute(operation: "StartReportCreation", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func tagResources(_ input: TagResourcesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagResourcesOutput> {
        return self.client.execute(operation: "TagResources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func untagResources(_ input: UntagResourcesInput, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagResourcesOutput> {
        return self.client.execute(operation: "UntagResources", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
