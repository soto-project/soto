...
public struct ResourceGroupsTaggingAPI: AWSService {
    ...
    @inlinable
    public func describeReportCreation(
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeReportCreationOutput {
        let input = DescribeReportCreationInput(
        )
        return try await self.describeReportCreation(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getComplianceSummary(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetComplianceSummaryOutput {
        let input = GetComplianceSummaryInput(
            groupBy: groupBy, 
        ...
        return try await self.getComplianceSummary(input, logger: logger)
    }
    ...
    public func getResources(
        ...
        tagsPerPage: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetResourcesOutput {
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getTagKeys(
        paginationToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetTagKeysOutput {
        let input = GetTagKeysInput(
            paginationToken: paginationToken
        )
        return try await self.getTagKeys(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - key: Specifies the tag key for which you want to list all existing values that are currently used in the specified Amazon Web Services Region for the calling account.
    ///   - paginationToken: Specifies a PaginationToken response value from a  previous request to indicate that you want the next page of results. Leave this parameter empty  in your initial request.
    ///   - logger: Logger use during operation
    @inlinable
    public func getTagValues(
        key: String,
        paginationToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetTagValuesOutput {
        let input = GetTagValuesInput(
            key: key, 
            paginationToken: paginationToken
        )
        return try await self.getTagValues(input, logger: logger)
    }

    /// Lists the required tags for supported resource types in an Amazon Web Services account.
    @Sendable
    @inlinable
    public func listRequiredTags(_ input: ListRequiredTagsInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListRequiredTagsOutput {
        try await self.client.execute(
            operation: "ListRequiredTags", 
            path: "/ListRequiredTags", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
            logger: logger
    ...
    ///   - nextToken: A token for requesting another page of required tags if the NextToken response element indicates that more required tags are available. Use the value of the returned NextToken element in your request until the token comes back as null. Pass null if this is the first call.
    ///   - logger: Logger use during operation
    @inlinable
    public func listRequiredTags(
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListRequiredTagsOutput {
        let input = ListRequiredTagsInput(
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.listRequiredTags(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - s3Bucket: The name of the Amazon S3 bucket where the report will be stored; for example:  amzn-s3-demo-bucket  For more information on S3 bucket requirements, including an example bucket policy, see the example Amazon S3 bucket policy on this page.
    ///   - logger: Logger use during operation
    @inlinable
    public func startReportCreation(
        s3Bucket: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartReportCreationOutput {
        let input = StartReportCreationInput(
            s3Bucket: s3Bucket
        )
        return try await self.startReportCreation(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - resourceARNList: Specifies the list of ARNs of the resources that you want to apply tags to. An ARN (Amazon Resource Name) uniquely identifies a resource. For more information, see Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces in the Amazon Web Services General Reference.
    ///   - tags: Specifies a list of tags that you want to add to the specified resources. A tag consists of a key and a value that you define.
    ///   - logger: Logger use during operation
    @inlinable
    public func tagResources(
        resourceARNList: [String],
        tags: [String: String],
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> TagResourcesOutput {
        let input = TagResourcesInput(
            resourceARNList: resourceARNList, 
            tags: tags
        )
        return try await self.tagResources(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - resourceARNList: Specifies a list of ARNs of the resources that you want to remove tags from. An ARN (Amazon Resource Name) uniquely identifies a resource. For more information, see Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces in the Amazon Web Services General Reference.
    ///   - tagKeys: Specifies a list of tag keys that you want to remove from the specified resources.
    ///   - logger: Logger use during operation
    @inlinable
    public func untagResources(
        resourceARNList: [String],
        tagKeys: [String],
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UntagResourcesOutput {
        let input = UntagResourcesInput(
            resourceARNList: resourceARNList, 
            tagKeys: tagKeys
        )
        return try await self.untagResources(input, logger: logger)
    }
}
...
extension ResourceGroupsTaggingAPI {
    /// Return PaginatorSequence for operation ``getComplianceSummary(_:logger:)``.
    ///
    /// - Parameters:
    ...
    public func getComplianceSummaryPaginator(
        ...
        return self.getComplianceSummaryPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``getTagKeys(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getTagKeysPaginator(
        ...
        return self.getTagKeysPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getTagValues(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getTagValuesPaginator(
        ...
        return self.getTagValuesPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listRequiredTags(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func listRequiredTagsPaginator(
        _ input: ListRequiredTagsInput,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<ListRequiredTagsInput, ListRequiredTagsOutput> {
        return .init(
            input: input,
            command: self.listRequiredTags,
            inputKey: \ListRequiredTagsInput.nextToken,
            outputKey: \ListRequiredTagsOutput.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``listRequiredTags(_:logger:)``.
    ...
    public func listRequiredTagsPaginator(
        ...
        return self.listRequiredTagsPaginator(input, logger: logger)
    }
}
...
extension ResourceGroupsTaggingAPI.ListRequiredTagsInput: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> ResourceGroupsTaggingAPI.ListRequiredTagsInput {
        return .init(
            maxResults: self.maxResults,
            nextToken: token
        )
