...
public struct LexModelBuildingService: AWSService {
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateBotVersionResponse {
        return try await self.client.execute(operation: "CreateBotVersion", path: "/bots/{name}/versions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createIntentVersion(_ input: CreateIntentVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateIntentVersionResponse {
        return try await self.client.execute(operation: "CreateIntentVersion", path: "/intents/{name}/versions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createSlotTypeVersion(_ input: CreateSlotTypeVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateSlotTypeVersionResponse {
        return try await self.client.execute(operation: "CreateSlotTypeVersion", path: "/slottypes/{name}/versions", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBot(_ input: DeleteBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteBot", path: "/bots/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBotAlias(_ input: DeleteBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBotChannelAssociation(_ input: DeleteBotChannelAssociationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteBotChannelAssociation", path: "/bots/{botName}/aliases/{botAlias}/channels/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteBotVersion(_ input: DeleteBotVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteBotVersion", path: "/bots/{name}/versions/{version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteIntent(_ input: DeleteIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteIntent", path: "/intents/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteIntentVersion(_ input: DeleteIntentVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteIntentVersion", path: "/intents/{name}/versions/{version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSlotType(_ input: DeleteSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSlotType", path: "/slottypes/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteSlotTypeVersion(_ input: DeleteSlotTypeVersionRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteSlotTypeVersion", path: "/slottypes/{name}/version/{version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteUtterances(_ input: DeleteUtterancesRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteUtterances", path: "/bots/{botName}/utterances/{userId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBot(_ input: GetBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotResponse {
        return try await self.client.execute(operation: "GetBot", path: "/bots/{name}/versions/{versionOrAlias}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBotAlias(_ input: GetBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotAliasResponse {
        return try await self.client.execute(operation: "GetBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBotAliases(_ input: GetBotAliasesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotAliasesResponse {
        return try await self.client.execute(operation: "GetBotAliases", path: "/bots/{botName}/aliases", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotChannelAssociationResponse {
        return try await self.client.execute(operation: "GetBotChannelAssociation", path: "/bots/{botName}/aliases/{botAlias}/channels/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotChannelAssociationsResponse {
        return try await self.client.execute(operation: "GetBotChannelAssociations", path: "/bots/{botName}/aliases/{botAlias}/channels", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBotVersions(_ input: GetBotVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotVersionsResponse {
        return try await self.client.execute(operation: "GetBotVersions", path: "/bots/{name}/versions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBots(_ input: GetBotsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBotsResponse {
        return try await self.client.execute(operation: "GetBots", path: "/bots", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBuiltinIntent(_ input: GetBuiltinIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBuiltinIntentResponse {
        return try await self.client.execute(operation: "GetBuiltinIntent", path: "/builtins/intents/{signature}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBuiltinIntents(_ input: GetBuiltinIntentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBuiltinIntentsResponse {
        return try await self.client.execute(operation: "GetBuiltinIntents", path: "/builtins/intents", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getBuiltinSlotTypes(_ input: GetBuiltinSlotTypesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetBuiltinSlotTypesResponse {
        return try await self.client.execute(operation: "GetBuiltinSlotTypes", path: "/builtins/slottypes", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getExport(_ input: GetExportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetExportResponse {
        return try await self.client.execute(operation: "GetExport", path: "/exports", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getImport(_ input: GetImportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetImportResponse {
        return try await self.client.execute(operation: "GetImport", path: "/imports/{importId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getIntent(_ input: GetIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetIntentResponse {
        return try await self.client.execute(operation: "GetIntent", path: "/intents/{name}/versions/{version}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getIntentVersions(_ input: GetIntentVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetIntentVersionsResponse {
        return try await self.client.execute(operation: "GetIntentVersions", path: "/intents/{name}/versions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getIntents(_ input: GetIntentsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetIntentsResponse {
        return try await self.client.execute(operation: "GetIntents", path: "/intents", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getMigration(_ input: GetMigrationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetMigrationResponse {
        return try await self.client.execute(operation: "GetMigration", path: "/migrations/{migrationId}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getMigrations(_ input: GetMigrationsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetMigrationsResponse {
        return try await self.client.execute(operation: "GetMigrations", path: "/migrations", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSlotType(_ input: GetSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSlotTypeResponse {
        return try await self.client.execute(operation: "GetSlotType", path: "/slottypes/{name}/versions/{version}", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSlotTypeVersions(_ input: GetSlotTypeVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSlotTypeVersionsResponse {
        return try await self.client.execute(operation: "GetSlotTypeVersions", path: "/slottypes/{name}/versions", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getSlotTypes(_ input: GetSlotTypesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetSlotTypesResponse {
        return try await self.client.execute(operation: "GetSlotTypes", path: "/slottypes", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getUtterancesView(_ input: GetUtterancesViewRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetUtterancesViewResponse {
        return try await self.client.execute(operation: "GetUtterancesView", path: "/bots/{botName}/utterances?view=aggregation", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putBot(_ input: PutBotRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutBotResponse {
        return try await self.client.execute(operation: "PutBot", path: "/bots/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putBotAlias(_ input: PutBotAliasRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutBotAliasResponse {
        return try await self.client.execute(operation: "PutBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putIntent(_ input: PutIntentRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutIntentResponse {
        return try await self.client.execute(operation: "PutIntent", path: "/intents/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func putSlotType(_ input: PutSlotTypeRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutSlotTypeResponse {
        return try await self.client.execute(operation: "PutSlotType", path: "/slottypes/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startImport(_ input: StartImportRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartImportResponse {
        return try await self.client.execute(operation: "StartImport", path: "/imports", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startMigration(_ input: StartMigrationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartMigrationResponse {
        return try await self.client.execute(operation: "StartMigration", path: "/migrations", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
