...
public struct LexModelBuildingService: AWSService {
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBotVersionResponse> {
        return self.client.execute(operation: "CreateBotVersion", path: "/bots/{name}/versions", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createIntentVersion(_ input: CreateIntentVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateIntentVersionResponse> {
        return self.client.execute(operation: "CreateIntentVersion", path: "/intents/{name}/versions", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createSlotTypeVersion(_ input: CreateSlotTypeVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateSlotTypeVersionResponse> {
        return self.client.execute(operation: "CreateSlotTypeVersion", path: "/slottypes/{name}/versions", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBot(_ input: DeleteBotRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBot", path: "/bots/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBotAlias(_ input: DeleteBotAliasRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBotChannelAssociation(_ input: DeleteBotChannelAssociationRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteBotVersion(_ input: DeleteBotVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteBotVersion", path: "/bots/{name}/versions/{version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteIntent(_ input: DeleteIntentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteIntent", path: "/intents/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteIntentVersion(_ input: DeleteIntentVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteIntentVersion", path: "/intents/{name}/versions/{version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteSlotType(_ input: DeleteSlotTypeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteSlotType", path: "/slottypes/{name}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteSlotTypeVersion(_ input: DeleteSlotTypeVersionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteSlotTypeVersion", path: "/slottypes/{name}/version/{version}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteUtterances(_ input: DeleteUtterancesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteUtterances", path: "/bots/{botName}/utterances/{userId}", httpMethod: .DELETE, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBot(_ input: GetBotRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotResponse> {
        return self.client.execute(operation: "GetBot", path: "/bots/{name}/versions/{versionoralias}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBotAlias(_ input: GetBotAliasRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotAliasResponse> {
        return self.client.execute(operation: "GetBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBotAliases(_ input: GetBotAliasesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotAliasesResponse> {
        return self.client.execute(operation: "GetBotAliases", path: "/bots/{botName}/aliases/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotChannelAssociationResponse> {
        return self.client.execute(operation: "GetBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotChannelAssociationsResponse> {
        return self.client.execute(operation: "GetBotChannelAssociations", path: "/bots/{botName}/aliases/{aliasName}/channels/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBotVersions(_ input: GetBotVersionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotVersionsResponse> {
        return self.client.execute(operation: "GetBotVersions", path: "/bots/{name}/versions/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBots(_ input: GetBotsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBotsResponse> {
        return self.client.execute(operation: "GetBots", path: "/bots/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Returns information about a built-in intent. This operation requires permission for the lex:GetBuiltinIntent action.
    public func getBuiltinIntent(_ input: GetBuiltinIntentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBuiltinIntentResponse> {
        return self.client.execute(operation: "GetBuiltinIntent", path: "/builtins/intents/{signature}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBuiltinIntents(_ input: GetBuiltinIntentsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBuiltinIntentsResponse> {
        return self.client.execute(operation: "GetBuiltinIntents", path: "/builtins/intents/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getBuiltinSlotTypes(_ input: GetBuiltinSlotTypesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBuiltinSlotTypesResponse> {
        return self.client.execute(operation: "GetBuiltinSlotTypes", path: "/builtins/slottypes/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Exports the contents of a Amazon Lex resource in a specified format.
    public func getExport(_ input: GetExportRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetExportResponse> {
        return self.client.execute(operation: "GetExport", path: "/exports/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }

    /// Gets information about an import job started with the StartImport operation.
    public func getImport(_ input: GetImportRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetImportResponse> {
        return self.client.execute(operation: "GetImport", path: "/imports/{importId}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getIntent(_ input: GetIntentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetIntentResponse> {
        return self.client.execute(operation: "GetIntent", path: "/intents/{name}/versions/{version}", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getIntentVersions(_ input: GetIntentVersionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetIntentVersionsResponse> {
        return self.client.execute(operation: "GetIntentVersions", path: "/intents/{name}/versions/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getIntents(_ input: GetIntentsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetIntentsResponse> {
    ...
    public func getSlotTypeVersions(_ input: GetSlotTypeVersionsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSlotTypeVersionsResponse> {
        return self.client.execute(operation: "GetSlotTypeVersions", path: "/slottypes/{name}/versions/", httpMethod: .GET, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getSlotTypes(_ input: GetSlotTypesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSlotTypesResponse> {
    ...
    public func putBot(_ input: PutBotRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutBotResponse> {
        return self.client.execute(operation: "PutBot", path: "/bots/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putBotAlias(_ input: PutBotAliasRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutBotAliasResponse> {
        return self.client.execute(operation: "PutBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .PUT, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putIntent(_ input: PutIntentRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutIntentResponse> {
        return self.client.execute(operation: "PutIntent", path: "/intents/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func putSlotType(_ input: PutSlotTypeRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutSlotTypeResponse> {
        return self.client.execute(operation: "PutSlotType", path: "/slottypes/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
