...
extension Panorama {
    ...
    public enum ApplicationInstanceHealthStatus: String, CustomStringConvertible, Codable {
        case error = "ERROR"
    ...
    public enum DeviceConnectionStatus: String, CustomStringConvertible, Codable {
    ...
    public enum JobResourceType: String, CustomStringConvertible, Codable {
    ...
    public enum NodeCategory: String, CustomStringConvertible, Codable {
    ...
    public enum NodeFromTemplateJobStatus: String, CustomStringConvertible, Codable {
        case failed = "FAILED"
        case pending = "PENDING"
        case succeeded = "SUCCEEDED"
        public var description: String { return self.rawValue }
    ...
    public enum NodeInstanceStatus: String, CustomStringConvertible, Codable {
        case error = "ERROR"
        case notAvailable = "NOT_AVAILABLE"
        case running = "RUNNING"
        public var description: String { return self.rawValue }
    ...
    public enum PackageImportJobStatus: String, CustomStringConvertible, Codable {
        case failed = "FAILED"
        case pending = "PENDING"
        case succeeded = "SUCCEEDED"
        public var description: String { return self.rawValue }
    ...
    public enum PortType: String, CustomStringConvertible, Codable {
    ...
    public enum UpdateProgress: String, CustomStringConvertible, Codable {
    ...
    public struct CreateNodeFromTemplateJobRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.nodeDescription, name: "nodeDescription", parent: name, min: 0)
    ...
    public struct DeregisterPackageVersionRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "ownerAccount", location: .querystring(locationName: "OwnerAccount")),
            AWSMemberEncoding(label: "packageId", location: .uri(locationName: "PackageId")),
            AWSMemberEncoding(label: "packageVersion", location: .uri(locationName: "PackageVersion")),
            AWSMemberEncoding(label: "patchVersion", location: .uri(locationName: "PatchVersion")),
            AWSMemberEncoding(label: "updatedLatestPatchVersion", location: .querystring(locationName: "UpdatedLatestPatchVersion"))
        ]
    ...
    public struct DescribePackageVersionRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "packageId", location: .uri(locationName: "PackageId")),
            AWSMemberEncoding(label: "packageVersion", location: .uri(locationName: "PackageVersion")),
            AWSMemberEncoding(label: "patchVersion", location: .querystring(locationName: "PatchVersion"))
        ]
    ...
    public struct ListApplicationInstancesRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "statusFilter", location: .querystring(locationName: "statusFilter"))
        ]
    ...
    public struct ListNodesRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "ownerAccount", location: .querystring(locationName: "ownerAccount")),
            AWSMemberEncoding(label: "packageName", location: .querystring(locationName: "packageName")),
            AWSMemberEncoding(label: "packageVersion", location: .querystring(locationName: "packageVersion")),
            AWSMemberEncoding(label: "patchVersion", location: .querystring(locationName: "patchVersion"))
        ]
    ...
    public struct ManifestOverridesPayload: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.payloadData, name: "payloadData", parent: name, min: 0)
    ...
    public struct ProvisionDeviceResponse: AWSDecodableShape {
        ...
        public init(arn: String, certificates: Data? = nil, deviceId: String? = nil, iotThingName: String? = nil, status: DeviceStatus) {
            self.arn = arn
