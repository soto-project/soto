...
extension WAF {
    ...
    public enum MigrationErrorType: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case entityNotFound = "ENTITY_NOT_FOUND"
        case entityNotSupported = "ENTITY_NOT_SUPPORTED"
        case s3BucketInvalidRegion = "S3_BUCKET_INVALID_REGION"
        case s3BucketNoPermission = "S3_BUCKET_NO_PERMISSION"
        case s3BucketNotAccessible = "S3_BUCKET_NOT_ACCESSIBLE"
        case s3BucketNotFound = "S3_BUCKET_NOT_FOUND"
        case s3InternalError = "S3_INTERNAL_ERROR"
        public var description: String { return self.rawValue }
    }
    ...
    public enum ParameterExceptionReason: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    public struct WAFEntityMigrationException: AWSErrorShape {
        public let message: String?
        public let migrationErrorReason: String?
        public let migrationErrorType: MigrationErrorType?

        @inlinable
        public init(message: String? = nil, migrationErrorReason: String? = nil, migrationErrorType: MigrationErrorType? = nil) {
    ...
    public struct WAFInvalidParameterException: AWSErrorShape {
        ...
        @inlinable
        public init(field: ParameterExceptionField? = nil, parameter: String? = nil, reason: ParameterExceptionReason? = nil) {
            self.field = field
...
extension WAFErrorType: AWSServiceErrorType {
    public static let errorCodeMap: [String: AWSErrorShape.Type] = [
        "WAFEntityMigrationException": WAF.WAFEntityMigrationException.self,
        "WAFInvalidParameterException": WAF.WAFInvalidParameterException.self
    ]
}
