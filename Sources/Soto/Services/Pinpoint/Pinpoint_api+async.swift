...
extension Pinpoint {
    ...
    public func getJourneyRunExecutionActivityMetrics(_ input: GetJourneyRunExecutionActivityMetricsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetJourneyRunExecutionActivityMetricsResponse {
        return try await self.client.execute(operation: "GetJourneyRunExecutionActivityMetrics", path: "/v1/apps/{ApplicationId}/journeys/{JourneyId}/runs/{RunId}/activities/{JourneyActivityId}/execution-metrics", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Retrieves (queries) pre-aggregated data for a standard run execution metric that applies to a journey.
    public func getJourneyRunExecutionMetrics(_ input: GetJourneyRunExecutionMetricsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetJourneyRunExecutionMetricsResponse {
        return try await self.client.execute(operation: "GetJourneyRunExecutionMetrics", path: "/v1/apps/{ApplicationId}/journeys/{JourneyId}/runs/{RunId}/execution-metrics", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// Provides information about the runs of a journey.
    public func getJourneyRuns(_ input: GetJourneyRunsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetJourneyRunsResponse {
        return try await self.client.execute(operation: "GetJourneyRuns", path: "/v1/apps/{ApplicationId}/journeys/{JourneyId}/runs", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
