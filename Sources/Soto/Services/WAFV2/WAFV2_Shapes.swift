...
extension WAFV2 {
    ...
    public struct DeleteFirewallManagerRuleGroupsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.webACLArn, name: "webACLArn", parent: name, min: 20)
            try validate(self.webACLArn, name: "webACLArn", parent: name, pattern: ".*\\S.*")
            try validate(self.webACLLockToken, name: "webACLLockToken", parent: name, max: 36)
            try validate(self.webACLLockToken, name: "webACLLockToken", parent: name, min: 1)
            try validate(self.webACLLockToken, name: "webACLLockToken", parent: name, pattern: "^[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12}$")
        }
