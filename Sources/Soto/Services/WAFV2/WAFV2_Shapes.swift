...
extension WAFV2 {
    ...
    public struct ByteMatchStatement: AWSEncodableShape & AWSDecodableShape {
        ...
        public let searchString: AWSBlob
        ...
        public init(fieldToMatch: FieldToMatch, positionalConstraint: PositionalConstraint, searchString: AWSBlob, textTransformations: [TextTransformation]) {
