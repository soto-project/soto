...
extension WAFV2 {
    ...
    public final class RateBasedStatement: AWSEncodableShape & AWSDecodableShape {
        ...
        public init(aggregateKeyType: RateBasedStatementAggregateKeyType, customKeys: [RateBasedStatementCustomKey]? = nil, forwardedIPConfig: ForwardedIPConfig? = nil, limit: Int64, scopeDownStatement: Statement? = nil) {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.customKeys, name: "customKeys", parent: name, min: 1)
            try self.forwardedIPConfig?.validate(name: "\(name).forwardedIPConfig")
