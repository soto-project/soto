...
extension LookoutforVision.ListModelPackagingJobsRequest: AWSPaginateToken {
    public func usingPaginationToken(_ token: String) -> LookoutforVision.ListModelPackagingJobsRequest {
        return .init(
            maxResults: self.maxResults,
            nextToken: token,
            projectName: self.projectName
