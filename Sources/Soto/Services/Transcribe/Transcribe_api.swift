...
public struct Transcribe: AWSService {
    ...
    ///   - media: 
    ///   - medicalScribeContext: The MedicalScribeContext object that contains contextual information which is used during clinical note generation to add relevant context to the note.
    ...
    ///   - outputEncryptionKMSKeyId: The Amazon Resource Name (ARN) of a KMS key that you want to use to encrypt your Medical Scribe output. KMS key ARNs have the format arn:partition:kms:region:account:key/key-id. For example:
    ...
    ///   - tags: Adds one or more custom tags, each in the form of a key:value pair, to the Medical Scribe job. To learn more about using tags with Amazon Transcribe, refer to Tagging resources.
    ///   - logger: Logger use during operation
    @inlinable
    public func startMedicalScribeJob(
        ...
        media: Media,
        medicalScribeContext: MedicalScribeContext? = nil,
        medicalScribeJobName: String,
    ...
    ///   - outputEncryptionKMSKeyId: The Amazon Resource Name (ARN) of a KMS key that you want to use to encrypt your transcription output. KMS key ARNs have the format arn:partition:kms:region:account:key/key-id. For example: 	arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab. For more information, see  KMS key ARNs. If you do not specify an encryption key, your output is encrypted with the default Amazon S3 key (SSE-S3). Note that the role making the  request and the role specified in the
