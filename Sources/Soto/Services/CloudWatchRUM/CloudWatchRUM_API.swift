...
/// Service object for interacting with AWS CloudWatchRUM service.
///
...
public struct CloudWatchRUM: AWSService {
    ...
    /// Initialize the CloudWatchRUM client
    /// - parameters:
    ...
    public init(
        ...
        self.config = AWSServiceConfig(
            ...
            endpoint: endpoint,
            errorType: CloudWatchRUMErrorType.self,
            timeout: timeout,
...
extension CloudWatchRUM {
    ...
    public init(from: CloudWatchRUM, patch: AWSServiceConfig.Patch) {
