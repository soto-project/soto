...
extension CloudWatchRUM {
    ...
    public struct AppMonitorConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.excludedPages, name: "excludedPages", parent: name, min: 0)
            try self.validate(self.favoritePages, name: "favoritePages", parent: name, max: 50)
            try self.validate(self.favoritePages, name: "favoritePages", parent: name, min: 0)
            ...
            try self.validate(self.includedPages, name: "includedPages", parent: name, min: 0)
            try self.validate(self.sessionSampleRate, name: "sessionSampleRate", parent: name, max: 1)
            try self.validate(self.sessionSampleRate, name: "sessionSampleRate", parent: name, min: 0)
        }
