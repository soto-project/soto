...
public struct CloudWatchLogs: AWSService {
    ...
    @Sendable
    @inlinable
    public func associateSourceToS3TableIntegration(_ input: AssociateSourceToS3TableIntegrationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateSourceToS3TableIntegrationResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - dataSource: The data source to associate with the S3 Table Integration. Contains the name and type of the data source.
    ///   - integrationArn: The Amazon Resource Name (ARN) of the S3 Table Integration to associate the data source with.
    ///   - logger: Logger use during operation
    @inlinable
    public func associateSourceToS3TableIntegration(
        dataSource: DataSource,
        integrationArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> AssociateSourceToS3TableIntegrationResponse {
        let input = AssociateSourceToS3TableIntegrationRequest(
            dataSource: dataSource, 
            integrationArn: integrationArn
        )
        return try await self.associateSourceToS3TableIntegration(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func cancelImportTask(_ input: CancelImportTaskRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CancelImportTaskResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - importId: The ID of the import task to cancel.
    ///   - logger: Logger use during operation
    @inlinable
    public func cancelImportTask(
        importId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CancelImportTaskResponse {
    ...
    @Sendable
    @inlinable
    public func createImportTask(_ input: CreateImportTaskRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateImportTaskResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - importFilter: Optional filters to constrain the import by CloudTrail event time. Times are specified in Unix timestamp milliseconds. The range of data being imported must be within the specified source's retention period.
    ///   - importRoleArn: The ARN of the IAM role that grants CloudWatch Logs permission to import from the CloudTrail Lake Event Data Store.
    ///   - importSourceArn: The ARN of the source to import from.
    ///   - logger: Logger use during operation
    @inlinable
    public func createImportTask(
        importFilter: ImportFilter? = nil,
        importRoleArn: String,
        importSourceArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateImportTaskResponse {
        let input = CreateImportTaskRequest(
            importFilter: importFilter, 
            importRoleArn: importRoleArn, 
            importSourceArn: importSourceArn
        )
        return try await self.createImportTask(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - deletionProtectionEnabled: Use this parameter to enable deletion protection for the new log group. When enabled on a log group, deletion protection blocks all deletion operations until it is explicitly disabled. By default log groups are created without deletion protection enabled.
    ...
    public func createLookupTable(
        ...
        let input = CreateLookupTableRequest(
        ...
        return try await self.createLookupTable(input, logger: logger)
    }
    ...
    ///   - name: The name of the scheduled query. The name must be unique within your account and region. Length must be between 1 and 300 characters.
    ///   - queryLanguage: The query language to use for the scheduled query. Valid values are CWLI, PPL, and SQL.
    ...
    public func createScheduledQuery(
        ...
        endTimeOffset: Int64? = nil,
        executionRoleArn: String,
        logGroupIdentifiers: [String]? = nil,
        name: String,
        queryLanguage: QueryLanguage,
        queryString: String,
        scheduleEndTime: Int64? = nil,
        scheduleExpression: String,
        scheduleStartTime: Int64? = nil,
        startTimeOffset: Int64? = nil,
    ...
    ///
    /// Parameters:
    ///   - name: The name of the delivery destination that you want to delete. You can find a list of delivery destination names by using the DescribeDeliveryDestinations operation.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func deleteLookupTable(_ input: DeleteLookupTableRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
            operation: "DeleteLookupTable", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - lookupTableArn: The ARN of the lookup table to delete.
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteLookupTable(
        lookupTableArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteLookupTableRequest(
            lookupTableArn: lookupTableArn
        )
        return try await self.deleteLookupTable(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - expectedRevisionId: The expected revision ID of the resource policy. Required when deleting a resource-scoped policy to prevent concurrent modifications.
    ///   - policyName: The name of the policy to be revoked. This parameter is required.
    ///   - resourceArn: The ARN of the CloudWatch Logs resource for which the resource policy needs to be deleted
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func deleteScheduledQuery(_ input: DeleteScheduledQueryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteScheduledQueryResponse {
        try await self.client.execute(
    ...
    public func deleteScheduledQuery(
        identifier: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteScheduledQueryResponse {
    ...
    @Sendable
    @inlinable
    public func deleteSyslogConfiguration(_ input: DeleteSyslogConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
            operation: "DeleteSyslogConfiguration", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - logGroupIdentifier: The name or ARN of the log group to remove the syslog configuration from.
    ///   - vpcEndpointId: The ID of the VPC endpoint associated with the syslog configuration to delete.
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteSyslogConfiguration(
        logGroupIdentifier: String,
        vpcEndpointId: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = DeleteSyslogConfigurationRequest(
            logGroupIdentifier: logGroupIdentifier, 
            vpcEndpointId: vpcEndpointId
        )
        return try await self.deleteSyslogConfiguration(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func describeImportTaskBatches(_ input: DescribeImportTaskBatchesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeImportTaskBatchesResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeImportTaskBatches(
        batchImportStatus: [ImportStatus]? = nil,
        importId: String,
        limit: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeImportTaskBatchesResponse {
        let input = DescribeImportTaskBatchesRequest(
            batchImportStatus: batchImportStatus, 
            importId: importId, 
            limit: limit, 
            nextToken: nextToken
        )
        return try await self.describeImportTaskBatches(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func describeLookupTables(_ input: DescribeLookupTablesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeLookupTablesResponse {
        try await self.client.execute(
            operation: "DescribeLookupTables", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - lookupTableNamePrefix: A prefix to filter lookup tables by name. Only tables whose names start with this prefix are returned. If you don't specify a prefix, all tables in the account and Region are returned.
    ///   - maxResults: The maximum number of lookup tables to return in the response. The default value is 50 and the maximum value is 100.
    ///   - nextToken: The token for the next set of items to return. (You received this token from a previous call.)
    ///   - logger: Logger use during operation
    @inlinable
    public func describeLookupTables(
        lookupTableNamePrefix: String? = nil,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeLookupTablesResponse {
        let input = DescribeLookupTablesRequest(
            lookupTableNamePrefix: lookupTableNamePrefix, 
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.describeLookupTables(input, logger: logger)
    }
    ...
    ///   - nextToken: 
    ///   - policyScope: Specifies the scope of the resource policy. Valid values are ACCOUNT or RESOURCE. When not specified, defaults to ACCOUNT.
    ///   - resourceArn: The ARN of the CloudWatch Logs resource for which to query the resource policy.
    ///   - logger: Logger use during operation
    @inlinable
    public func describeResourcePolicies(
        limit: Int? = nil,
        nextToken: String? = nil,
        policyScope: PolicyScope? = nil,
        resourceArn: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    @Sendable
    @inlinable
    public func disassociateSourceFromS3TableIntegration(_ input: DisassociateSourceFromS3TableIntegrationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DisassociateSourceFromS3TableIntegrationResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - identifier: The unique identifier of the association to remove between the data source and S3 Table Integration.
    ///   - logger: Logger use during operation
    @inlinable
    public func disassociateSourceFromS3TableIntegration(
        identifier: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DisassociateSourceFromS3TableIntegrationResponse {
        let input = DisassociateSourceFromS3TableIntegrationRequest(
            identifier: identifier
        )
        return try await self.disassociateSourceFromS3TableIntegration(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getLogFields(_ input: GetLogFieldsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetLogFieldsResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - dataSourceName: The name of the data source to retrieve log fields for.
    ///   - dataSourceType: The type of the data source to retrieve log fields for.
    ///   - logger: Logger use during operation
    @inlinable
    public func getLogFields(
        dataSourceName: String,
        dataSourceType: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetLogFieldsResponse {
        let input = GetLogFieldsRequest(
            dataSourceName: dataSourceName, 
            dataSourceType: dataSourceType
        )
        return try await self.getLogFields(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getLogObject(_ input: GetLogObjectRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetLogObjectResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getLogObject(
        logObjectPointer: String,
        unmask: Bool? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetLogObjectResponse {
        let input = GetLogObjectRequest(
            logObjectPointer: logObjectPointer, 
            unmask: unmask
        )
        return try await self.getLogObject(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getLookupTable(_ input: GetLookupTableRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetLookupTableResponse {
        try await self.client.execute(
            operation: "GetLookupTable", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - lookupTableArn: The ARN of the lookup table to retrieve.
    ///   - logger: Logger use during operation
    @inlinable
    public func getLookupTable(
        lookupTableArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetLookupTableResponse {
        let input = GetLookupTableRequest(
            lookupTableArn: lookupTableArn
        )
        return try await self.getLookupTable(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getScheduledQuery(_ input: GetScheduledQueryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetScheduledQueryResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getScheduledQuery(
        identifier: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetScheduledQueryResponse {
        let input = GetScheduledQueryRequest(
            identifier: identifier
        )
        return try await self.getScheduledQuery(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getScheduledQueryHistory(_ input: GetScheduledQueryHistoryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetScheduledQueryHistoryResponse {
        try await self.client.execute(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getScheduledQueryHistory(
        endTime: Int64,
        executionStatuses: [ExecutionStatus]? = nil,
        identifier: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        startTime: Int64,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetScheduledQueryHistoryResponse {
        let input = GetScheduledQueryHistoryRequest(
            endTime: endTime, 
    ...
    public func getStorageTierPolicy(_ input: GetStorageTierPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetStorageTierPolicyResponse {
        try await self.client.execute(
            operation: "GetStorageTierPolicy", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getStorageTierPolicy(
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetStorageTierPolicyResponse {
        let input = GetStorageTierPolicyRequest(
        )
        return try await self.getStorageTierPolicy(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func listAggregateLogGroupSummaries(_ input: ListAggregateLogGroupSummariesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListAggregateLogGroupSummariesResponse {
        try await self.client.execute(
    ...
    /// Parameters:
    ///   - accountIdentifiers: When includeLinkedAccounts is set to true, use this parameter to specify the list of accounts to search. You can specify as many as 20 account IDs in the array.
    ///   - dataSources: Filters the results by data source characteristics to include only log groups associated with the specified data sources.
    ///   - groupBy: Specifies how to group the log groups in the summary.
    ///   - includeLinkedAccounts: If you are using a monitoring account, set this to true to have the operation return log groups in the accounts listed in accountIdentifiers. If this parameter is set to true and accountIdentifiers contains a null value, the operation returns all log groups in the monitoring account and all log groups in all source accounts that are linked to the monitoring account.  The default for this parameter is false.
    ///   - limit: The maximum number of aggregated summaries to return. If you omit this parameter, the default is up to 50 aggregated summaries.
    ///   - logGroupClass: Filters the results by log group class to include only log groups of the specified class.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func listAggregateLogGroupSummaries(
        accountIdentifiers: [String]? = nil,
        dataSources: [DataSourceFilter]? = nil,
        ...
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListAggregateLogGroupSummariesResponse {
        let input = ListAggregateLogGroupSummariesRequest(
            accountIdentifiers: accountIdentifiers, 
        ...
        return try await self.listAggregateLogGroupSummaries(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func listLogGroups(_ input: ListLogGroupsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListLogGroupsResponse {
        try await self.client.execute(
    ...
    /// Parameters:
    ///   - accountIdentifiers: When includeLinkedAccounts is set to true, use this parameter to specify the list of accounts to search. You can specify as many as 20 account IDs in the array.
    ///   - dataSources: An array of data source filters to filter log groups by their associated data sources. You can filter by data source name, type, or both. Multiple filters within the same dimension are combined with OR logic, while filters across different dimensions are combined with AND logic.
    ///   - fieldIndexNames: An array of field index names to filter log groups that have specific field indexes. Only log groups containing all specified field indexes are returned. You can specify 1 to 20 field index names, each with 1 to 512 characters.
    ///   - includeLinkedAccounts: If you are using a monitoring account, set this to true to have the operation return log groups in the accounts listed in accountIdentifiers. If this parameter is set to true and accountIdentifiers contains a null value, the operation returns all log groups in the monitoring account and all log groups in all source accounts that are linked to the monitoring account.  The default for this parameter is false.
    ...
    ///   - logGroupNamePattern: Use this parameter to limit the returned log groups to only those with names that match the pattern that you specify. This parameter is a regular expression that can match prefixes and substrings, and supports wildcard matching and matching multiple patterns, as in the following examples.    Use ^ to match log group names by prefix.   For a substring match, specify the string to match. All matches are case sensitive   To match multiple patterns, separate them with a | as in the example ^/aws/lambda|discovery    You can specify as many as five different regular expression patterns in this field, each of which must be between 3 and 24 characters. You can include the ^ symbol as many as five times, and include the | symbol as many as four times.
    ///   - logGroupTags: An array of tag filters to return only log groups that have specific tags. Multiple filters are combined with AND logic.
    ///   - nextToken: 
    ///   - logger: Logger use during operation
    @inlinable
    public func listLogGroups(
        accountIdentifiers: [String]? = nil,
        dataSources: [DataSourceFilter]? = nil,
        fieldIndexNames: [String]? = nil,
        includeLinkedAccounts: Bool? = nil,
        limit: Int? = nil,
        logGroupClass: LogGroupClass? = nil,
        logGroupNamePattern: String? = nil,
        logGroupTags: [TagFilter]? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListLogGroupsResponse {
        let input = ListLogGroupsRequest(
            accountIdentifiers: accountIdentifiers, 
            dataSources: dataSources, 
        ...
        return try await self.listLogGroups(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - maxResults: The maximum number of scheduled queries to return. Valid range is 1 to 1000.
    ///   - nextToken: 
    ///   - scheduleType: Filter scheduled queries by schedule type. Valid values are CUSTOMER_MANAGED and AWS_MANAGED. If not specified, scheduled queries of all schedule types are returned.
    ///   - state: Filter scheduled queries by state. Valid values are ENABLED and DISABLED. If not specified, all scheduled queries are returned.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func listSourcesForS3TableIntegration(_ input: ListSourcesForS3TableIntegrationRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSourcesForS3TableIntegrationResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - integrationArn: The Amazon Resource Name (ARN) of the S3 Table Integration to list associations for.
    ///   - maxResults: The maximum number of associations to return in a single call. Valid range is 1 to 100.
    ///   - nextToken: 
    ///   - logger: Logger use during operation
    @inlinable
    public func listSourcesForS3TableIntegration(
        integrationArn: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListSourcesForS3TableIntegrationResponse {
        let input = ListSourcesForS3TableIntegrationRequest(
            integrationArn: integrationArn, 
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.listSourcesForS3TableIntegration(input, logger: logger)
    }

    /// Returns a list of syslog configurations. You can optionally filter the results by log group or VPC endpoint.
    @Sendable
    @inlinable
    public func listSyslogConfigurations(_ input: ListSyslogConfigurationsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListSyslogConfigurationsResponse {
        try await self.client.execute(
            operation: "ListSyslogConfigurations", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - logGroupIdentifier: The name or ARN of the log group to filter syslog configurations for.
    ///   - maxResults: The maximum number of syslog configurations to return in the response.
    ///   - nextToken: The token for the next set of items to return. You received this token from a previous call.
    ///   - vpcEndpointId: The ID of the VPC endpoint to filter syslog configurations for.
    ///   - logger: Logger use during operation
    @inlinable
    public func listSyslogConfigurations(
        logGroupIdentifier: String? = nil,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        vpcEndpointId: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListSyslogConfigurationsResponse {
        let input = ListSyslogConfigurationsRequest(
            logGroupIdentifier: logGroupIdentifier, 
            maxResults: maxResults, 
            nextToken: nextToken, 
            vpcEndpointId: vpcEndpointId
        )
        return try await self.listSyslogConfigurations(input, logger: logger)
    }
    ...
    ///   - policyName: A name for the policy. This must be unique within the account and cannot start with aws/.
    ...
    @Sendable
    @inlinable
    public func putBearerTokenAuthentication(_ input: PutBearerTokenAuthenticationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - bearerTokenAuthenticationEnabled: Whether to enable bearer token authentication. Type: Boolean Required: Yes
    ///   - logGroupIdentifier: The name or ARN of the log group. Type: String Length Constraints: Minimum length of 1. Maximum length of 512. Pattern: [\.\-_/#A-Za-z0-9]+  Required: Yes
    ///   - logger: Logger use during operation
    @inlinable
    public func putBearerTokenAuthentication(
        bearerTokenAuthenticationEnabled: Bool,
        logGroupIdentifier: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = PutBearerTokenAuthenticationRequest(
            bearerTokenAuthenticationEnabled: bearerTokenAuthenticationEnabled, 
            logGroupIdentifier: logGroupIdentifier
        )
        return try await self.putBearerTokenAuthentication(input, logger: logger)
    }
    ...
    public func putDeliveryDestination(
        deliveryDestinationConfiguration: DeliveryDestinationConfiguration? = nil,
    ...
    public func putDeliverySource(
        deliverySourceConfiguration: [String: String]? = nil,
        logType: String,
        name: String,
        resourceArn: String,
        tags: [String: String]? = nil,
    ...
    @Sendable
    @inlinable
    public func putLogGroupDeletionProtection(_ input: PutLogGroupDeletionProtectionRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - deletionProtectionEnabled: Whether to enable deletion protection. Type: Boolean Required: Yes
    ///   - logGroupIdentifier: The name or ARN of the log group. Type: String Length Constraints: Minimum length of 1. Maximum length of 512. Pattern: [\.\-_/#A-Za-z0-9]+  Required: Yes
    ///   - logger: Logger use during operation
    @inlinable
    public func putLogGroupDeletionProtection(
        deletionProtectionEnabled: Bool,
        logGroupIdentifier: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = PutLogGroupDeletionProtectionRequest(
            deletionProtectionEnabled: deletionProtectionEnabled, 
            logGroupIdentifier: logGroupIdentifier
        )
        return try await self.putLogGroupDeletionProtection(input, logger: logger)
    }
    ...
    ///   - emitSystemFieldDimensions: A list of system fields to emit as additional dimensions in the generated metrics. Valid values are @aws.account and @aws.region. These dimensions help identify the source of centralized log data and count toward the total dimension limit for metric filters.
    ...
    public func putMetricFilter(
        ...
        emitSystemFieldDimensions: [String]? = nil,
        fieldSelectionCriteria: String? = nil,
        filterName: String,
    ...
    ///
    /// Parameters:
    ///   - expectedRevisionId: The expected revision ID of the resource policy. Required when resourceArn is provided to prevent concurrent modifications. Use null when creating a resource policy for the first time.
    ...
    ///   - resourceArn: The ARN of the CloudWatch Logs resource to which the resource policy needs to be added or attached. Currently only supports LogGroup ARN.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    public func putStorageTierPolicy(_ input: PutStorageTierPolicyRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> PutStorageTierPolicyResponse {
        try await self.client.execute(
            operation: "PutStorageTierPolicy", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    public func putStorageTierPolicy(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> PutStorageTierPolicyResponse {
        let input = PutStorageTierPolicyRequest(
            storageTier: storageTier
        )
        return try await self.putStorageTierPolicy(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func putSyslogConfiguration(_ input: PutSyslogConfigurationRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        try await self.client.execute(
            operation: "PutSyslogConfiguration", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - logGroupIdentifier: The name or ARN of the log group to associate with the syslog configuration.
    ///   - vpcEndpointId: The ID of the VPC endpoint to use for syslog ingestion.
    ///   - logger: Logger use during operation
    @inlinable
    public func putSyslogConfiguration(
        logGroupIdentifier: String,
        vpcEndpointId: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws {
        let input = PutSyslogConfigurationRequest(
            logGroupIdentifier: logGroupIdentifier, 
            vpcEndpointId: vpcEndpointId
        )
        return try await self.putSyslogConfiguration(input, logger: logger)
    }
    ...
    ///   - limit: The maximum number of log events to return from the query. The maximum limit is 100,000. The maximum events returned in a single GetQueryResults API call is 10,000 log events per request. You can retrieve up to 100,000 log event results from a query by paginating with the nextToken. 100,000 limit is only supported for Logs Insights QL and is currently not supported for PPL and SQL query languages.
    ...
    @Sendable
    @inlinable
    public func updateScheduledQuery(_ input: UpdateScheduledQueryRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> UpdateScheduledQueryResponse {
        try await self.client.execute(
    ...
    public func updateScheduledQuery(
        ...
        timezone: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UpdateScheduledQueryResponse {
...
extension CloudWatchLogs {
    ...
    /// Return PaginatorSequence for operation ``getScheduledQueryHistory(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func getScheduledQueryHistoryPaginator(
        _ input: GetScheduledQueryHistoryRequest,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<GetScheduledQueryHistoryRequest, GetScheduledQueryHistoryResponse> {
        return .init(
            input: input,
            command: self.getScheduledQueryHistory,
            inputKey: \GetScheduledQueryHistoryRequest.nextToken,
            outputKey: \GetScheduledQueryHistoryResponse.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``getScheduledQueryHistory(_:logger:)``.
    ...
    public func getScheduledQueryHistoryPaginator(
        ...
        return self.getScheduledQueryHistoryPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listAggregateLogGroupSummaries(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func listAggregateLogGroupSummariesPaginator(
        _ input: ListAggregateLogGroupSummariesRequest,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<ListAggregateLogGroupSummariesRequest, ListAggregateLogGroupSummariesResponse> {
        return .init(
            input: input,
            command: self.listAggregateLogGroupSummaries,
            inputKey: \ListAggregateLogGroupSummariesRequest.nextToken,
            outputKey: \ListAggregateLogGroupSummariesResponse.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``listAggregateLogGroupSummaries(_:logger:)``.
    ...
    public func listAggregateLogGroupSummariesPaginator(
        ...
        return self.listAggregateLogGroupSummariesPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``listSourcesForS3TableIntegration(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func listSourcesForS3TableIntegrationPaginator(
        _ input: ListSourcesForS3TableIntegrationRequest,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<ListSourcesForS3TableIntegrationRequest, ListSourcesForS3TableIntegrationResponse> {
        return .init(
            input: input,
            command: self.listSourcesForS3TableIntegration,
            inputKey: \ListSourcesForS3TableIntegrationRequest.nextToken,
            outputKey: \ListSourcesForS3TableIntegrationResponse.nextToken,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``listSourcesForS3TableIntegration(_:logger:)``.
    ...
    public func listSourcesForS3TableIntegrationPaginator(
        ...
        return self.listSourcesForS3TableIntegrationPaginator(input, logger: logger)
    }
}
...
extension CloudWatchLogs.GetScheduledQueryHistoryRequest: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> CloudWatchLogs.GetScheduledQueryHistoryRequest {
        return .init(
            endTime: self.endTime,
...
extension CloudWatchLogs.ListAggregateLogGroupSummariesRequest: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> CloudWatchLogs.ListAggregateLogGroupSummariesRequest {
        return .init(
            accountIdentifiers: self.accountIdentifiers,
...
extension CloudWatchLogs.ListScheduledQueriesRequest: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> CloudWatchLogs.ListScheduledQueriesRequest {
        return .init(
            maxResults: self.maxResults,
            nextToken: token,
...
extension CloudWatchLogs.ListSourcesForS3TableIntegrationRequest: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> CloudWatchLogs.ListSourcesForS3TableIntegrationRequest {
        return .init(
