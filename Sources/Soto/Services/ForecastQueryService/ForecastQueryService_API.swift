...
public struct ForecastQueryService: AWSService {
    ...
    public func queryForecast(_ input: QueryForecastRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<QueryForecastResponse> {
        return self.client.execute(operation: "QueryForecast", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
