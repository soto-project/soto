...
extension SecurityLake {
    ...
    public struct CreateCustomLogSourceRequest: AWSEncodableShape {
        ...
        public init(configuration: CustomLogSourceConfiguration? = nil, eventClasses: [String]? = nil, sourceName: String, sourceVersion: String? = nil) {
    ...
    public struct CreateDataLakeOrganizationConfigurationRequest: AWSEncodableShape {
        ...
        public init(autoEnableNewAccount: [DataLakeAutoEnableNewAccountConfiguration]) {
    ...
    public struct CreateDataLakeRequest: AWSEncodableShape {
        ...
        public init(configurations: [DataLakeConfiguration], metaStoreManagerRoleArn: String) {
    ...
    public struct CreateSubscriberRequest: AWSEncodableShape {
        ...
        public init(accessTypes: [AccessType]? = nil, sources: [LogSourceResource], subscriberDescription: String? = nil, subscriberIdentity: AwsIdentity, subscriberName: String) {
    ...
    public struct HttpsNotificationConfiguration: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.targetRoleArn, name: "targetRoleArn", parent: name, pattern: "^arn:.*$")
        }
    ...
    public struct UpdateDataLakeRequest: AWSEncodableShape {
        ...
        public init(configurations: [DataLakeConfiguration]) {
            self.configurations = configurations
        }
