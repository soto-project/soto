...
public struct RDS: AWSService {
    ...
    ///   - snapshotAvailabilityZone: Specifies the name of the Availability Zone where RDS stores the DB snapshot. This value is valid only for snapshots that RDS stores on a Dedicated Local Zone.
    ///   - snapshotTarget: Configures the location where RDS will store copied snapshots. Valid Values:    local (Dedicated Local Zone)    outposts (Amazon Web Services Outposts)    region (Amazon Web Services Region)
    ...
    public func copyDBSnapshot(
        ...
        preSignedUrl: String? = nil,
        snapshotAvailabilityZone: String? = nil,
    ...
    ///   - engineLifecycleSupport: The lifecycle type for this DB cluster.  By default, this value is set to open-source-rds-extended-support, which enrolls your DB cluster into Amazon RDS Extended Support. At the end of standard support, you can avoid charges for Extended Support by setting the value to open-source-rds-extended-support-disabled. In this case, creating the DB cluster will fail if the DB major version is past its end of standard support date.  You can use this setting to enroll your DB cluster into Amazon RDS Extended Support. With RDS Extended Support, you can run the selected major engine version on your DB cluster past the end of standard support for that engine version. For more information, see the following sections:   Amazon Aurora - Amazon RDS Extended Support with Amazon Aurora in the Amazon Aurora User Guide    Amazon RDS - Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide    Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  Default: open-source-rds-extended-support
    ...
    ///   - withExpressConfiguration: Specifies to create an Aurora DB Cluster with express configuration in seconds. Express configuration provides a cluster with a writer instance and feature specific values set to all other input parameters of this API.  Valid for Cluster Type: Aurora DB clusters
    ///   - logger: Logger use during operation
    @inlinable
    public func createDBCluster(
        allocatedStorage: Int? = nil,
        associatedRoles: [DBClusterAssociatedRole]? = nil,
        ...
        masterUserAuthenticationType: MasterUserAuthenticationType? = nil,
        ...
        withExpressConfiguration: Bool? = nil,
        logger: Logger = AWSClient.loggingDisabled        
        ...
        let input = CreateDBClusterMessage(
            ...
            withExpressConfiguration: withExpressConfiguration
        )
    ...
    ///   - engine: The database engine to use for this DB instance. Not every database engine is available in every Amazon Web Services Region. Valid Values:    aurora-mysql (for Aurora MySQL DB instances)    aurora-postgresql (for Aurora PostgreSQL DB instances)    custom-oracle-ee (for RDS Custom for Oracle DB instances)    custom-oracle-ee-cdb (for RDS Custom for Oracle DB instances)    custom-oracle-se2 (for RDS Custom for Oracle DB instances)    custom-oracle-se2-cdb (for RDS Custom for Oracle DB instances)    custom-sqlserver-ee (for RDS Custom for SQL Server DB instances)    custom-sqlserver-se (for RDS Custom for SQL Server DB instances)    custom-sqlserver-web (for RDS Custom for SQL Server DB instances)    custom-sqlserver-dev (for RDS Custom for SQL Server DB instances)    db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-dev-ee     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ///   - engineLifecycleSupport: The lifecycle type for this DB instance.  By default, this value is set to open-source-rds-extended-support, which enrolls your DB instance into Amazon RDS Extended Support. At the end of standard support, you can avoid charges for Extended Support by setting the value to open-source-rds-extended-support-disabled. In this case, creating the DB instance will fail if the DB major version is past its end of standard support date.  This setting applies only to RDS for MySQL and RDS for PostgreSQL. For Amazon Aurora DB instances, the engine lifecycle support is managed by the DB cluster. You can use this setting to enroll your DB instance into Amazon RDS Extended Support. With RDS Extended Support, you can run the selected major engine version on your DB instance past the end of standard support for that engine version. For more information, see Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide. Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  Default: open-source-rds-extended-support
    ...
    ///   - multiAZ: Specifies whether the DB instance is a Multi-AZ deployment. You can't set the AvailabilityZone parameter if the DB instance is a Multi-AZ deployment. This setting doesn't apply to Amazon Aurora because the DB instance Availability Zones (AZs) are managed by the DB cluster.
    ...
    ///   - backupTarget: The location where RDS stores automated backups and manual snapshots. Valid Values:    local for Dedicated Local Zones    region for Amazon Web Services Region
    ...
    ///   - replicaMode: The open mode of the replica database. This parameter is only supported for Db2 DB instances and Oracle DB instances.  Db2  Standby DB replicas are included in Db2 Advanced Edition (AE), Db2 Community Edition (CE), and Db2 Standard Edition (SE). The main use case for standby replicas is cross-Region disaster recovery. Because it doesn't accept user connections, a standby replica can't serve a read-only workload. You can create a combination of standby and read-only DB replicas for the same primary DB instance. For more information, see Working with replicas for Amazon RDS for Db2 in the Amazon RDS User Guide. To create standby DB replicas for RDS for Db2, set this parameter to mounted.  Oracle  Mounted DB replicas are included in Oracle Database Enterprise Edition. The main use case for mounted replicas is cross-Region disaster recovery. The primary database doesn't use Active Data Guard to transmit information to the mounted replica. Because it doesn't accept user connections, a mounted replica can't serve a read-only workload. You can create a combination of mounted and read-only DB replicas for the same primary DB instance. For more information, see Working with read replicas for Amazon RDS for Oracle in the Amazon RDS User Guide. For RDS Custom, you must specify this parameter and set it to mounted. The value won't be set by default. After replica creation, you can manage the open mode manually.
    ...
    ///   - endpointNetworkType: The network type of the DB proxy endpoint. The network type determines the IP version that the proxy endpoint supports. Valid values:    IPV4 - The proxy endpoint supports IPv4 only.    IPV6 - The proxy endpoint supports IPv6 only.    DUAL - The proxy endpoint supports both IPv4 and IPv6.   Default: IPV4  Constraints:   If you specify IPV6 or DUAL, the VPC and all subnets must have an IPv6 CIDR block.   If you specify IPV6 or DUAL, the VPC tenancy cannot be dedicated.
    ...
    ///   - targetConnectionNetworkType: The network type that the proxy uses to connect to the target database. The network type determines the IP version that the proxy uses for connections to the database. Valid values:    IPV4 - The proxy connects to the database using IPv4 only.    IPV6 - The proxy connects to the database using IPv6 only.   Default: IPV4  Constraints:   If you specify IPV6, the database must support dual-stack mode. RDS doesn't support IPv6-only databases.   All targets registered with the proxy must be compatible with the specified network type.
    ...
    public func createDBProxy(
        ...
        defaultAuthScheme: DefaultAuthScheme? = nil,
        endpointNetworkType: EndpointNetworkType? = nil,
        engineFamily: EngineFamily? = nil,
        idleClientTimeout: Int? = nil,
        requireTLS: Bool? = nil,
        roleArn: String? = nil,
        tags: [Tag]? = nil,
        targetConnectionNetworkType: TargetConnectionNetworkType? = nil,
        vpcSecurityGroupIds: [String]? = nil,
    ...
    ///
    /// Parameters:
    ///   - engineName: The name of the engine to associate this option group with. Valid Values:    db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ...
    ///   - masterUserPassword: The password for the master user in your tenant database. Constraints:   Must be 8 to 30 characters.   Can include any printable ASCII character except forward slash (/), double quote ("), at symbol (@), ampersand (&amp;), or single quote (').   Can't be specified when ManageMasterUserPassword is enabled.
    ///   - masterUserSecretKmsKeyId: The Amazon Web Services KMS key identifier to encrypt a secret that is automatically generated and managed in Amazon Web Services Secrets Manager. This setting is valid only if the master user password is managed by RDS in Amazon Web Services Secrets Manager for the DB instance. The Amazon Web Services KMS key identifier is the key ARN, key ID, alias ARN, or alias name for the KMS key. To use a KMS key in a different Amazon Web Services account, specify the key ARN or alias ARN. If you don't specify MasterUserSecretKmsKeyId, then the aws/secretsmanager KMS key is used to encrypt the secret. If the secret is in a different Amazon Web Services account, then you can't use the aws/secretsmanager KMS key to encrypt the secret, and you must use a customer managed KMS key. There is a default KMS key for your Amazon Web Services account. Your Amazon Web Services account has a different default KMS key for each Amazon Web Services Region.
    ...
    @Sendable
    @inlinable
    public func describeDBMajorEngineVersions(_ input: DescribeDBMajorEngineVersionsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DescribeDBMajorEngineVersionsResponse {
        try await self.client.execute(
    ...
    ///
    /// Parameters:
    ///   - engine: The database engine to return major version details for. Valid Values:    aurora-mysql     aurora-postgresql     custom-sqlserver-ee     custom-sqlserver-se     custom-sqlserver-web     db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ///   - majorEngineVersion: A specific database major engine version to return details for. Example: 8.4
    ///   - marker: An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    ///   - maxRecords: The maximum number of records to include in the response. If more than the MaxRecords value is available, a pagination token called a marker is included in the response so you can retrieve the remaining results. Default: 100
    ///   - logger: Logger use during operation
    @inlinable
    public func describeDBMajorEngineVersions(
        engine: String? = nil,
        majorEngineVersion: String? = nil,
        marker: String? = nil,
        maxRecords: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeDBMajorEngineVersionsResponse {
        let input = DescribeDBMajorEngineVersionsRequest(
            engine: engine, 
            majorEngineVersion: majorEngineVersion, 
            marker: marker, 
            maxRecords: maxRecords
        )
        return try await self.describeDBMajorEngineVersions(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - engineName: The name of the engine to describe options for. Valid Values:    db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ///   - filters: This parameter isn't currently supported.
    ...
    ///
    /// Parameters:
    ///   - engineName: A filter to only include option groups associated with this database engine. Valid Values:    db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ///   - filters: This parameter isn't currently supported.
    ...
    ///   - engine: The name of the database engine to describe DB instance options for. Valid Values:    aurora-mysql     aurora-postgresql     custom-oracle-ee     custom-oracle-ee-cdb     custom-oracle-se2     custom-oracle-se2-cdb     db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ...
    @Sendable
    @inlinable
    public func describeServerlessV2PlatformVersions(_ input: DescribeServerlessV2PlatformVersionsMessage, logger: Logger = AWSClient.loggingDisabled) async throws -> ServerlessV2PlatformVersionsMessage {
        try await self.client.execute(
            operation: "DescribeServerlessV2PlatformVersions", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///   - engine: The database engine to return platform version details for. Valid Values:    aurora-mysql     aurora-postgresql
    ///   - filters: This parameter isn't currently supported.
    ///   - includeAll: Specifies whether to also include platform versions which are no longer in use.
    ///   - marker: An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords.
    ///   - maxRecords: The maximum number of records to include in the response. If more than the MaxRecords value is available, a pagination token called a marker is included in the response so you can retrieve the remaining results. Default: 20 Constraints: Minimum 1, maximum 200.
    ///   - serverlessV2PlatformVersion: A specific platform version to return details for. Example: 3
    ///   - logger: Logger use during operation
    @inlinable
    public func describeServerlessV2PlatformVersions(
        defaultOnly: Bool? = nil,
        engine: String? = nil,
        filters: [Filter]? = nil,
        includeAll: Bool? = nil,
        marker: String? = nil,
        maxRecords: Int? = nil,
        serverlessV2PlatformVersion: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ServerlessV2PlatformVersionsMessage {
        let input = DescribeServerlessV2PlatformVersionsMessage(
            defaultOnly: defaultOnly, 
            engine: engine, 
            filters: filters, 
            includeAll: includeAll, 
        ...
        return try await self.describeServerlessV2PlatformVersions(input, logger: logger)
    }
    ...
    ///   - autoMinorVersionUpgrade: Specifies whether minor engine upgrades are applied automatically to the DB cluster during the maintenance window. By default, minor engine upgrades are applied automatically. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters. For more information about automatic minor version upgrades, see Automatically upgrading the minor engine version.
    ...
    ///   - enableLocalWriteForwarding: Specifies whether read replicas can forward write operations to the writer DB instance in the DB cluster. By default, write operations aren't allowed on reader DB instances. Valid for: Aurora DB clusters only
    ///   - enablePerformanceInsights: Specifies whether to turn on Performance Insights for the DB cluster. For more information, see  Using Amazon Performance Insights in the Amazon RDS User Guide. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters
    ///   - engineLifecycleSupport: The lifecycle type for this DB cluster. You can use this setting to enroll your DB cluster into Amazon RDS Extended Support or to opt out. With RDS Extended Support, you can run the selected major engine version on your DB cluster past the end of standard support for that engine version. For more information, see the following sections:   Amazon Aurora - Amazon RDS Extended Support with Amazon Aurora in the Amazon Aurora User Guide    Amazon RDS - Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide    Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled
    ...
    ///   - engineLifecycleSupport: The lifecycle type for this DB instance. This setting applies only to RDS for MySQL and RDS for PostgreSQL. For Amazon Aurora DB instances, the engine lifecycle support is managed by the DB cluster. You can use this setting to enroll your DB instance into Amazon RDS Extended Support or to opt out. With RDS Extended Support, you can run the selected major engine version on your DB instance past the end of standard support for that engine version. For more information, see Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide. Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  This setting doesn't apply to RDS Custom DB instances.
    ...
    ///   - replicaMode: The open mode of a replica database. This parameter is only supported for Db2 DB instances and Oracle DB instances.  Db2  Standby DB replicas are included in Db2 Advanced Edition (AE), Db2 Community Edition (CE), and Db2 Standard Edition (SE). The main use case for standby replicas is cross-Region disaster recovery. Because it doesn't accept user connections, a standby replica can't serve a read-only workload. You can create a combination of standby and read-only DB replicas for the same primary DB instance. For more information, see Working with replicas for Amazon RDS for Db2 in the Amazon RDS User Guide. To create standby DB replicas for RDS for Db2, set this parameter to mounted.  Oracle  Mounted DB replicas are included in Oracle Database Enterprise Edition. The main use case for mounted replicas is cross-Region disaster recovery. The primary database doesn't use Active Data Guard to transmit information to the mounted replica. Because it doesn't accept user connections, a mounted replica can't serve a read-only workload. You can create a combination of mounted and read-only DB replicas for the same primary DB instance. For more information, see Working with read replicas for Amazon RDS for Oracle in the Amazon RDS User Guide. For RDS Custom, you must specify this parameter and set it to mounted. The value won't be set by default. After replica creation, you can manage the open mode manually.
    ...
    ///
    /// Parameters:
    ///   - associatedRoles: A list of Amazon Web Services Identity and Access Management (IAM) roles to associate with the DB cluster when it's restored from Amazon S3. Each role grants the DB cluster permission to access other Amazon Web Services on your behalf. For each role, specify a role ARN and, optionally, the feature name (such as s3Import, s3Export, or Lambda).
    ...
    ///   - engineLifecycleSupport: The lifecycle type for this DB cluster.  By default, this value is set to open-source-rds-extended-support, which enrolls your DB cluster into Amazon RDS Extended Support. At the end of standard support, you can avoid charges for Extended Support by setting the value to open-source-rds-extended-support-disabled. In this case, RDS automatically upgrades your restored DB cluster to a higher engine version, if the major engine version is past its end of standard support date.  You can use this setting to enroll your DB cluster into Amazon RDS Extended Support. With RDS Extended Support, you can run the selected major engine version on your DB cluster past the end of standard support for that engine version. For more information, see the following sections:   Amazon Aurora - Amazon RDS Extended Support with Amazon Aurora in the Amazon Aurora User Guide    Amazon RDS - Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide    Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  Default: open-source-rds-extended-support
    ...
    ///
    /// Parameters:
    ///   - associatedRoles: A list of Amazon Web Services Identity and Access Management (IAM) roles to associate with the DB cluster when it's restored from a snapshot. Each role grants the DB cluster permission to access other Amazon Web Services on your behalf. For each role, specify a role ARN and, optionally, the feature name (such as s3Import, s3Export, or Lambda). Valid for Cluster Type: Aurora DB clusters only
    ...
    ///   - backupRetentionPeriod: The number of days for which automated backups are retained. Specify a minimum value of 1. Valid for Cluster Type: Aurora DB clusters and Multi-AZ DB clusters Default: Uses existing setting Constraints:   Must be a value from 1 to 35.
    ...
    public func restoreDBClusterFromSnapshot(
        ...
        enableCloudwatchLogsExports: [String]? = nil,
        enableIAMDatabaseAuthentication: Bool? = nil,
        enableInternetAccessGateway: Bool? = nil,
        enablePerformanceInsights: Bool? = nil,
        enableVPCNetworking: Bool? = nil,
        engine: String? = nil,
        engineLifecycleSupport: String? = nil,
        engineMode: String? = nil,
        engineVersion: String? = nil,
    ...
    ///
    /// Parameters:
    ///   - associatedRoles: A list of Amazon Web Services Identity and Access Management (IAM) roles to associate with the DB cluster when it's restored to a point in time. Each role grants the DB cluster permission to access other Amazon Web Services on your behalf. For each role, specify a role ARN and, optionally, the feature name (such as s3Import, s3Export, or Lambda). Valid for Cluster Type: Aurora DB clusters only
    ...
    ///   - engine: The database engine to use for the new instance. This setting doesn't apply to RDS Custom. Default: The same as source Constraint: Must be compatible with the engine of the source. For example, you can restore a MariaDB 10.1 DB instance from a MySQL 5.6 snapshot. Valid Values:    db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web
    ///   - engineLifecycleSupport: The lifecycle type for this DB instance.  By default, this value is set to open-source-rds-extended-support, which enrolls your DB instance into Amazon RDS Extended Support. At the end of standard support, you can avoid charges for Extended Support by setting the value to open-source-rds-extended-support-disabled. In this case, RDS automatically upgrades your restored DB instance to a higher engine version, if the major engine version is past its end of standard support date.  You can use this setting to enroll your DB instance into Amazon RDS Extended Support. With RDS Extended Support, you can run the selected major engine version on your DB instance past the end of standard support for that engine version. For more information, see Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide. This setting applies only to RDS for MySQL and RDS for PostgreSQL. For Amazon Aurora DB instances, the engine lifecycle support is managed by the DB cluster. Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  Default: open-source-rds-extended-support
    ...
    ///   - engineLifecycleSupport: The lifecycle type for this DB instance.  By default, this value is set to open-source-rds-extended-support, which enrolls your DB instance into Amazon RDS Extended Support. At the end of standard support, you can avoid charges for Extended Support by setting the value to open-source-rds-extended-support-disabled. In this case, RDS automatically upgrades your restored DB instance to a higher engine version, if the major engine version is past its end of standard support date.  You can use this setting to enroll your DB instance into Amazon RDS Extended Support. With RDS Extended Support, you can run the selected major engine version on your DB instance past the end of standard support for that engine version. For more information, see Amazon RDS Extended Support Amazon RDS in the Amazon RDS User Guide. This setting applies only to RDS for MySQL and RDS for PostgreSQL. For Amazon Aurora DB instances, the engine lifecycle support is managed by the DB cluster. Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  Default: open-source-rds-extended-support
    ...
    ///   - engine: The database engine to use for the new instance. This setting doesn't apply to RDS Custom. Valid Values:    db2-ae     db2-ce     db2-se     mariadb     mysql     oracle-ee     oracle-ee-cdb     oracle-se2     oracle-se2-cdb     postgres     sqlserver-ee     sqlserver-se     sqlserver-ex     sqlserver-web    Default: The same as source Constraints:   Must be compatible with the engine of the source.
    ///   - engineLifecycleSupport: The lifecycle type for this DB instance.  By default, this value is set to open-source-rds-extended-support, which enrolls your DB instance into Amazon RDS Extended Support. At the end of standard support, you can avoid charges for Extended Support by setting the value to open-source-rds-extended-support-disabled. In this case, RDS automatically upgrades your restored DB instance to a higher engine version, if the major engine version is past its end of standard support date.  You can use this setting to enroll your DB instance into Amazon RDS Extended Support. With RDS Extended Support, you can run the selected major engine version on your DB instance past the end of standard support for that engine version. For more information, see Amazon RDS Extended Support with Amazon RDS in the Amazon RDS User Guide. This setting applies only to RDS for MySQL and RDS for PostgreSQL. For Amazon Aurora DB instances, the engine lifecycle support is managed by the DB cluster. Valid Values: open-source-rds-extended-support | open-source-rds-extended-support-disabled  Default: open-source-rds-extended-support
...
extension RDS {
    ...
    /// Return PaginatorSequence for operation ``describeDBMajorEngineVersions(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func describeDBMajorEngineVersionsPaginator(
        _ input: DescribeDBMajorEngineVersionsRequest,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<DescribeDBMajorEngineVersionsRequest, DescribeDBMajorEngineVersionsResponse> {
        return .init(
            input: input,
            command: self.describeDBMajorEngineVersions,
            inputKey: \DescribeDBMajorEngineVersionsRequest.marker,
            outputKey: \DescribeDBMajorEngineVersionsResponse.marker,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``describeDBMajorEngineVersions(_:logger:)``.
    ...
    public func describeDBMajorEngineVersionsPaginator(
        ...
        return self.describeDBMajorEngineVersionsPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``describeEngineDefaultClusterParameters(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func describeEngineDefaultClusterParametersPaginator(
        _ input: DescribeEngineDefaultClusterParametersMessage,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<DescribeEngineDefaultClusterParametersMessage, DescribeEngineDefaultClusterParametersResult> {
        return .init(
            input: input,
            command: self.describeEngineDefaultClusterParameters,
            inputKey: \DescribeEngineDefaultClusterParametersMessage.marker,
            outputKey: \DescribeEngineDefaultClusterParametersResult.engineDefaults?.marker,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``describeEngineDefaultClusterParameters(_:logger:)``.
    ...
    public func describeEngineDefaultClusterParametersPaginator(
        ...
        return self.describeEngineDefaultClusterParametersPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``describeServerlessV2PlatformVersions(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    @inlinable
    public func describeServerlessV2PlatformVersionsPaginator(
        _ input: DescribeServerlessV2PlatformVersionsMessage,
        logger: Logger = AWSClient.loggingDisabled
    ) -> AWSClient.PaginatorSequence<DescribeServerlessV2PlatformVersionsMessage, ServerlessV2PlatformVersionsMessage> {
        return .init(
            input: input,
            command: self.describeServerlessV2PlatformVersions,
            inputKey: \DescribeServerlessV2PlatformVersionsMessage.marker,
            outputKey: \ServerlessV2PlatformVersionsMessage.marker,
            logger: logger
        )
    }
    /// Return PaginatorSequence for operation ``describeServerlessV2PlatformVersions(_:logger:)``.
    ...
    public func describeServerlessV2PlatformVersionsPaginator(
        ...
        return self.describeServerlessV2PlatformVersionsPaginator(input, logger: logger)
    }
...
extension RDS.DescribeDBMajorEngineVersionsRequest: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> RDS.DescribeDBMajorEngineVersionsRequest {
        return .init(
            engine: self.engine,
...
extension RDS.DescribeEngineDefaultClusterParametersMessage: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> RDS.DescribeEngineDefaultClusterParametersMessage {
        return .init(
            dbParameterGroupFamily: self.dbParameterGroupFamily,
            filters: self.filters,
            marker: token,
...
extension RDS.DescribeServerlessV2PlatformVersionsMessage: AWSPaginateToken {
    @inlinable
    public func usingPaginationToken(_ token: String) -> RDS.DescribeServerlessV2PlatformVersionsMessage {
        return .init(
            defaultOnly: self.defaultOnly,
            engine: self.engine,
            filters: self.filters,
