...
extension RDS {
    ...
    public func deleteDBClusterAutomatedBackup(_ input: DeleteDBClusterAutomatedBackupMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteDBClusterAutomatedBackupResult {
        return try await self.client.execute(operation: "DeleteDBClusterAutomatedBackup", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDBClusterAutomatedBackups(_ input: DescribeDBClusterAutomatedBackupsMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DBClusterAutomatedBackupMessage {
        return try await self.client.execute(operation: "DescribeDBClusterAutomatedBackups", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func switchoverGlobalCluster(_ input: SwitchoverGlobalClusterMessage, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SwitchoverGlobalClusterResult {
        return try await self.client.execute(operation: "SwitchoverGlobalCluster", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
