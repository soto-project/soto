...
public struct Rekognition: AWSService {
    ...
    ///
    /// Parameters:
    ///   - clientRequestToken: Idempotent token used to identify the request to AssociateFaces. If you use the same token with multiple AssociateFaces requests, the same response is returned. Use ClientRequestToken to prevent the same request from being processed more than once.
    ///   - collectionId: The ID of an existing collection containing the UserID.
    ///   - faceIds: An array of FaceIDs to associate with the UserID.
    ///   - userId: The ID for the existing UserID.
    ///   - userMatchThreshold: An optional value specifying the minimum confidence in the UserID match to return. The default value is 75.
    ///   - logger: Logger use during operation
    @inlinable
    public func associateFaces(
        clientRequestToken: String? = AssociateFacesRequest.idempotencyToken(),
        collectionId: String,
        faceIds: [String],
        userId: String,
        userMatchThreshold: Float? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> AssociateFacesResponse {
        let input = AssociateFacesRequest(
        ...
        return try await self.associateFaces(input, logger: logger)
    }
    ...
    public func compareFaces(
        ...
        targetImage: Image,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CompareFacesResponse {
        let input = CompareFacesRequest(
            qualityFilter: qualityFilter, 
            similarityThreshold: similarityThreshold, 
            sourceImage: sourceImage, 
            targetImage: targetImage
        )
        return try await self.compareFaces(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func copyProjectVersion(
        ...
        versionName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CopyProjectVersionResponse {
        let input = CopyProjectVersionRequest(
        ...
        return try await self.copyProjectVersion(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - datasetSource: The source files for the dataset. You can specify the ARN of an existing dataset or specify the Amazon S3 bucket location
    ...
    ///   - kmsKeyId:  The identifier for your AWS Key Management Service key (AWS KMS key). Used to encrypt audit images and reference images.
    ///   - settings: A session settings object. It contains settings for the operation to be performed. For Face Liveness, it accepts OutputConfig and AuditImagesLimit.
    ///   - logger: Logger use during operation
    @inlinable
    public func createFaceLivenessSession(
        clientRequestToken: String? = nil,
        kmsKeyId: String? = nil,
        settings: CreateFaceLivenessSessionRequestSettings? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateFaceLivenessSessionResponse {
        let input = CreateFaceLivenessSessionRequest(
            clientRequestToken: clientRequestToken, 
            kmsKeyId: kmsKeyId, 
            settings: settings
        )
        return try await self.createFaceLivenessSession(input, logger: logger)
    }
    ...
    public func createProject(
        autoUpdate: ProjectAutoUpdate? = nil,
        feature: CustomizationFeature? = nil,
        projectName: String,
        tags: [String: String]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func createProjectVersion(
        featureConfig: CustomizationFeatureConfig? = nil,
        kmsKeyId: String? = nil,
        outputConfig: OutputConfig,
        projectArn: String,
        tags: [String: String]? = nil,
        ...
        versionName: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateProjectVersionResponse {
        let input = CreateProjectVersionRequest(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func createStreamProcessor(
        dataSharingPreference: StreamProcessorDataSharingPreference? = nil,
        input: StreamProcessorInput,
        kmsKeyId: String? = nil,
        name: String,
        notificationChannel: StreamProcessorNotificationChannel? = nil,
        ...
        tags: [String: String]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateStreamProcessorResponse {
        let input = CreateStreamProcessorRequest(
        ...
        return try await self.createStreamProcessor(input, logger: logger)
    }
    ...
    public func createUser(
        clientRequestToken: String? = CreateUserRequest.idempotencyToken(),
        collectionId: String,
        userId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///
    /// Parameters:
    ///   - datasetArn: The ARN of the Amazon Rekognition Custom Labels dataset that you want to delete.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteFaces(
        collectionId: String,
        faceIds: [String],
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteFacesResponse {
        let input = DeleteFacesRequest(
            collectionId: collectionId, 
            faceIds: faceIds
        )
        return try await self.deleteFaces(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - policyName: The name of the policy that you want to delete.
    ///   - policyRevisionId: The ID of the project policy revision that you want to delete.
    ///   - projectArn: The Amazon Resource Name (ARN) of the project that the project policy you want to delete is attached to.
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteProjectPolicy(
        policyName: String,
        policyRevisionId: String? = nil,
        projectArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteProjectPolicyResponse {
        let input = DeleteProjectPolicyRequest(
            policyName: policyName, 
            policyRevisionId: policyRevisionId, 
            projectArn: projectArn
        )
        return try await self.deleteProjectPolicy(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - projectVersionArn: The Amazon Resource Name (ARN) of the project version that you want to delete.
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteProjectVersion(
        projectVersionArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteProjectVersionResponse {
        let input = DeleteProjectVersionRequest(
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func deleteStreamProcessor(
        name: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteStreamProcessorResponse {
        let input = DeleteStreamProcessorRequest(
            name: name
        )
        return try await self.deleteStreamProcessor(input, logger: logger)
    }
    ...
    public func deleteUser(
        clientRequestToken: String? = DeleteUserRequest.idempotencyToken(),
        collectionId: String,
        userId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeCollection(
        collectionId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeCollectionResponse {
        let input = DescribeCollectionRequest(
            collectionId: collectionId
        )
        return try await self.describeCollection(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - datasetArn: The Amazon Resource Name (ARN) of the dataset that you want to describe.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - projectArn: The Amazon Resource Name (ARN) of the project that contains the model/adapter you want to describe.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeProjectVersions(
        maxResults: Int? = nil,
        nextToken: String? = nil,
        projectArn: String,
        versionNames: [String]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeProjectVersionsResponse {
        let input = DescribeProjectVersionsRequest(
            maxResults: maxResults, 
            nextToken: nextToken, 
            projectArn: projectArn, 
            versionNames: versionNames
        )
        return try await self.describeProjectVersions(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeProjects(
        features: [CustomizationFeature]? = nil,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        projectNames: [String]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeProjectsResponse {
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func describeStreamProcessor(
        name: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DescribeStreamProcessorResponse {
        let input = DescribeStreamProcessorRequest(
            name: name
        )
        return try await self.describeStreamProcessor(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func detectCustomLabels(
        image: Image,
        maxResults: Int? = nil,
        minConfidence: Float? = nil,
        projectVersionArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DetectCustomLabelsResponse {
        let input = DetectCustomLabelsRequest(
            image: image, 
            maxResults: maxResults, 
            minConfidence: minConfidence, 
            projectVersionArn: projectVersionArn
        )
        return try await self.detectCustomLabels(input, logger: logger)
    }
    ...
    public func detectFaces(
        ...
        image: Image,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DetectFacesResponse {
        let input = DetectFacesRequest(
            attributes: attributes, 
            image: image
        )
        return try await self.detectFaces(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - features: A list of the types of analysis to perform. Specifying GENERAL_LABELS uses the label detection feature, while specifying IMAGE_PROPERTIES returns information regarding image color and quality. If no option is specified GENERAL_LABELS is used by default.
    ...
    ///   - maxLabels: Maximum number of labels you want the service to return in the response. The service returns the specified number of highest confidence labels. Only valid when GENERAL_LABELS is specified as a feature type in the Feature input parameter.
    ...
    ///   - settings: A list of the filters to be applied to returned detected labels and image properties. Specified filters can be inclusive, exclusive, or a combination of both. Filters can be used for individual labels or label categories. The exact label names or label categories must be supplied. For a full list of labels and label categories, see Detecting labels.
    ///   - logger: Logger use during operation
    @inlinable
    public func detectLabels(
        features: [DetectLabelsFeatureName]? = nil,
        image: Image,
        maxLabels: Int? = nil,
        minConfidence: Float? = nil,
        settings: DetectLabelsSettings? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DetectLabelsResponse {
        ...
        return try await self.detectLabels(input, logger: logger)
    }
    ...
    public func detectModerationLabels(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DetectModerationLabelsResponse {
        let input = DetectModerationLabelsRequest(
            humanLoopConfig: humanLoopConfig, 
            image: image, 
            minConfidence: minConfidence, 
            projectVersion: projectVersion
        )
        return try await self.detectModerationLabels(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func detectProtectiveEquipment(
        image: Image,
        summarizationAttributes: ProtectiveEquipmentSummarizationAttributes? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DetectProtectiveEquipmentResponse {
        let input = DetectProtectiveEquipmentRequest(
            image: image, 
            summarizationAttributes: summarizationAttributes
        )
        return try await self.detectProtectiveEquipment(input, logger: logger)
    }
    ...
    public func detectText(
        ...
        image: Image,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DetectTextResponse {
        let input = DetectTextRequest(
            filters: filters, 
            image: image
        )
        return try await self.detectText(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func disassociateFaces(
        clientRequestToken: String? = DisassociateFacesRequest.idempotencyToken(),
        collectionId: String,
        faceIds: [String],
        userId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DisassociateFacesResponse {
        let input = DisassociateFacesRequest(
            clientRequestToken: clientRequestToken, 
            collectionId: collectionId, 
            faceIds: faceIds, 
            userId: userId
        )
        return try await self.disassociateFaces(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - datasets: The ARNS for the training dataset and test dataset that you want to use. The datasets must belong to the same project. The test dataset must be empty.
    ///   - logger: Logger use during operation
    @inlinable
    public func distributeDatasetEntries(
        datasets: [DistributeDataset],
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DistributeDatasetEntriesResponse {
        let input = DistributeDatasetEntriesRequest(
            datasets: datasets
        )
        return try await self.distributeDatasetEntries(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getCelebrityInfo(
        id: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetCelebrityInfoResponse {
        let input = GetCelebrityInfoRequest(
            id: id
        )
        return try await self.getCelebrityInfo(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getCelebrityRecognition(
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        sortBy: CelebrityRecognitionSortBy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetCelebrityRecognitionResponse {
        let input = GetCelebrityRecognitionRequest(
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken, 
            sortBy: sortBy
        )
        return try await self.getCelebrityRecognition(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getContentModeration(
        aggregateBy: ContentModerationAggregateBy? = nil,
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        sortBy: ContentModerationSortBy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetContentModerationResponse {
        let input = GetContentModerationRequest(
        ...
        return try await self.getContentModeration(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getFaceDetection(
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetFaceDetectionResponse {
        let input = GetFaceDetectionRequest(
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken
        )
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getFaceLivenessSessionResults(
        sessionId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetFaceLivenessSessionResultsResponse {
        let input = GetFaceLivenessSessionResultsRequest(
            sessionId: sessionId
        )
        return try await self.getFaceLivenessSessionResults(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getFaceSearch(
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        sortBy: FaceSearchSortBy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetFaceSearchResponse {
        let input = GetFaceSearchRequest(
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken, 
            sortBy: sortBy
        )
        return try await self.getFaceSearch(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getLabelDetection(
        aggregateBy: LabelDetectionAggregateBy? = nil,
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        sortBy: LabelDetectionSortBy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetLabelDetectionResponse {
        let input = GetLabelDetectionRequest(
            aggregateBy: aggregateBy, 
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken, 
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getMediaAnalysisJob(
        jobId: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetMediaAnalysisJobResponse {
        let input = GetMediaAnalysisJobRequest(
            jobId: jobId
        )
        return try await self.getMediaAnalysisJob(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getPersonTracking(
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        sortBy: PersonTrackingSortBy? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetPersonTrackingResponse {
        let input = GetPersonTrackingRequest(
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken, 
            sortBy: sortBy
        )
        return try await self.getPersonTracking(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getSegmentDetection(
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetSegmentDetectionResponse {
        let input = GetSegmentDetectionRequest(
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.getSegmentDetection(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getTextDetection(
        jobId: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetTextDetectionResponse {
        let input = GetTextDetectionRequest(
            jobId: jobId, 
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.getTextDetection(input, logger: logger)
    }
    ...
    ///   - detectionAttributes: An array of facial attributes you want to be returned. A DEFAULT subset of facial attributes - BoundingBox, Confidence, Pose, Quality, and Landmarks - will always be returned. You can request for specific facial attributes (in addition to the default list) - by using ["DEFAULT", "FACE_OCCLUDED"] or just ["FACE_OCCLUDED"]. You can request for all facial attributes by using ["ALL"]. Requesting more attributes may increase response time. If you provide both, ["ALL", "DEFAULT"], the service uses a logical AND operator to determine which attributes to return (in this case, all attributes).
    ...
    public func indexFaces(
        ...
        qualityFilter: QualityFilter? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> IndexFacesResponse {
        let input = IndexFacesRequest(
            collectionId: collectionId, 
        ...
        return try await self.indexFaces(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - datasetArn: The Amazon Resource Name (ARN) of the dataset that you want to use.
    ///   - maxResults: The maximum number of results to return per paginated call. The largest value you can specify is 100.  If you specify a value greater than 100, a ValidationException error occurs. The default value is 100.
    ///   - nextToken: If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination  token to retrieve the next set of results.
    ///   - logger: Logger use during operation
    @inlinable
    public func listDatasetLabels(
        datasetArn: String,
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListDatasetLabelsResponse {
        let input = ListDatasetLabelsRequest(
            datasetArn: datasetArn, 
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.listDatasetLabels(input, logger: logger)
    }
    ...
    public func listFaces(
        ...
        userId: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListFacesResponse {
        let input = ListFacesRequest(
            collectionId: collectionId, 
            faceIds: faceIds, 
            maxResults: maxResults, 
            nextToken: nextToken, 
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func listMediaAnalysisJobs(
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListMediaAnalysisJobsResponse {
        let input = ListMediaAnalysisJobsRequest(
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.listMediaAnalysisJobs(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - maxResults: The maximum number of results to return per paginated call. The largest value you can specify is 5. If you specify a value greater than 5, a ValidationException error occurs. The default value is 5.
    ///   - nextToken: If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination token to retrieve the next set of results.
    ///   - projectArn: The ARN of the project for which you want to list the project policies.
    ///   - logger: Logger use during operation
    @inlinable
    public func listProjectPolicies(
        maxResults: Int? = nil,
        nextToken: String? = nil,
        projectArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListProjectPoliciesResponse {
        let input = ListProjectPoliciesRequest(
            maxResults: maxResults, 
            nextToken: nextToken, 
            projectArn: projectArn
        )
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func listStreamProcessors(
        maxResults: Int? = nil,
        nextToken: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListStreamProcessorsResponse {
        let input = ListStreamProcessorsRequest(
            maxResults: maxResults, 
            nextToken: nextToken
        )
        return try await self.listStreamProcessors(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - resourceArn:  Amazon Resource Name (ARN) of the model, collection, or stream processor that contains the tags that you want a list of.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///
    /// Parameters:
    ///   - collectionId: The ID of an existing collection.
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func putProjectPolicy(
        policyDocument: String,
        policyName: String,
        policyRevisionId: String? = nil,
        projectArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> PutProjectPolicyResponse {
        let input = PutProjectPolicyRequest(
            policyDocument: policyDocument, 
            policyName: policyName, 
            policyRevisionId: policyRevisionId, 
            projectArn: projectArn
        )
        return try await self.putProjectPolicy(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func recognizeCelebrities(
        image: Image,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> RecognizeCelebritiesResponse {
        let input = RecognizeCelebritiesRequest(
            image: image
        )
        return try await self.recognizeCelebrities(input, logger: logger)
    }
    ...
    public func searchFaces(
        ...
        maxFaces: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> SearchFacesResponse {
        let input = SearchFacesRequest(
            collectionId: collectionId, 
            faceId: faceId, 
            faceMatchThreshold: faceMatchThreshold, 
            maxFaces: maxFaces
        )
        return try await self.searchFaces(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func searchFacesByImage(
        collectionId: String,
        faceMatchThreshold: Float? = nil,
        image: Image,
        maxFaces: Int? = nil,
        qualityFilter: QualityFilter? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> SearchFacesByImageResponse {
        let input = SearchFacesByImageRequest(
            collectionId: collectionId, 
            faceMatchThreshold: faceMatchThreshold, 
            image: image, 
            maxFaces: maxFaces, 
        ...
        return try await self.searchFacesByImage(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func searchUsersByImage(
        collectionId: String,
        image: Image,
        maxUsers: Int? = nil,
        qualityFilter: QualityFilter? = nil,
        userMatchThreshold: Float? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> SearchUsersByImageResponse {
        let input = SearchUsersByImageRequest(
            collectionId: collectionId, 
            image: image, 
            maxUsers: maxUsers, 
            qualityFilter: qualityFilter, 
        ...
        return try await self.searchUsersByImage(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func startCelebrityRecognition(
        clientRequestToken: String? = nil,
        jobTag: String? = nil,
        notificationChannel: NotificationChannel? = nil,
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartCelebrityRecognitionResponse {
        let input = StartCelebrityRecognitionRequest(
            clientRequestToken: clientRequestToken, 
            jobTag: jobTag, 
            notificationChannel: notificationChannel, 
            video: video
        )
        return try await self.startCelebrityRecognition(input, logger: logger)
    }
    ...
    ///   - video: The video in which you want to detect inappropriate, unwanted, or offensive content. The video must be stored in an Amazon S3 bucket.
    ///   - logger: Logger use during operation
    @inlinable
    public func startContentModeration(
        clientRequestToken: String? = nil,
        jobTag: String? = nil,
        minConfidence: Float? = nil,
        notificationChannel: NotificationChannel? = nil,
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartContentModerationResponse {
        let input = StartContentModerationRequest(
            clientRequestToken: clientRequestToken, 
            jobTag: jobTag, 
            minConfidence: minConfidence, 
            notificationChannel: notificationChannel, 
        ...
        return try await self.startContentModeration(input, logger: logger)
    }
    ...
    public func startFaceDetection(
        ...
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartFaceDetectionResponse {
        let input = StartFaceDetectionRequest(
            clientRequestToken: clientRequestToken, 
        ...
        return try await self.startFaceDetection(input, logger: logger)
    }
    ...
    public func startFaceSearch(
        ...
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartFaceSearchResponse {
        let input = StartFaceSearchRequest(
            clientRequestToken: clientRequestToken, 
            collectionId: collectionId, 
            faceMatchThreshold: faceMatchThreshold, 
            jobTag: jobTag, 
        ...
        return try await self.startFaceSearch(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func startLabelDetection(
        clientRequestToken: String? = nil,
        features: [LabelDetectionFeatureName]? = nil,
        jobTag: String? = nil,
        minConfidence: Float? = nil,
        notificationChannel: NotificationChannel? = nil,
        settings: LabelDetectionSettings? = nil,
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartLabelDetectionResponse {
        let input = StartLabelDetectionRequest(
            clientRequestToken: clientRequestToken, 
            features: features, 
            jobTag: jobTag, 
            minConfidence: minConfidence, 
    ...
    ///   - kmsKeyId: The identifier of customer managed AWS KMS key (name or ARN). The key  is used to encrypt images copied into the service. The key is also used  to encrypt results and manifest files written to the output Amazon S3 bucket.
    ///   - operationsConfig: Configuration options for the media analysis job to be created.
    ///   - outputConfig: The Amazon S3 bucket location to store the results.
    ///   - logger: Logger use during operation
    @inlinable
    public func startMediaAnalysisJob(
        clientRequestToken: String? = StartMediaAnalysisJobRequest.idempotencyToken(),
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartMediaAnalysisJobResponse {
        let input = StartMediaAnalysisJobRequest(
            clientRequestToken: clientRequestToken, 
            input: input, 
            jobName: jobName, 
            kmsKeyId: kmsKeyId, 
        ...
        return try await self.startMediaAnalysisJob(input, logger: logger)
    }
    ...
    ///   - jobTag: An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use JobTag to group related jobs and identify them in the completion notification.
    ///   - notificationChannel: The Amazon SNS topic ARN you want Amazon Rekognition Video to publish the completion status of the people detection operation to. The Amazon SNS topic must have a topic name that begins with AmazonRekognition if you are using the AmazonRekognitionServiceRole permissions policy.
    ///   - video: The video in which you want to detect people. The video must be stored in an Amazon S3 bucket.
    ///   - logger: Logger use during operation
    @inlinable
    public func startPersonTracking(
        clientRequestToken: String? = nil,
        jobTag: String? = nil,
        notificationChannel: NotificationChannel? = nil,
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartPersonTrackingResponse {
        let input = StartPersonTrackingRequest(
            clientRequestToken: clientRequestToken, 
            jobTag: jobTag, 
            notificationChannel: notificationChannel, 
            video: video
        )
        return try await self.startPersonTracking(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func startProjectVersion(
        maxInferenceUnits: Int? = nil,
        minInferenceUnits: Int,
        projectVersionArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartProjectVersionResponse {
        let input = StartProjectVersionRequest(
            maxInferenceUnits: maxInferenceUnits, 
            minInferenceUnits: minInferenceUnits, 
            projectVersionArn: projectVersionArn
        )
        return try await self.startProjectVersion(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func startSegmentDetection(
        clientRequestToken: String? = nil,
        ...
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartSegmentDetectionResponse {
        let input = StartSegmentDetectionRequest(
            clientRequestToken: clientRequestToken, 
            filters: filters, 
            jobTag: jobTag, 
            notificationChannel: notificationChannel, 
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func startStreamProcessor(
        name: String,
        startSelector: StreamProcessingStartSelector? = nil,
        stopSelector: StreamProcessingStopSelector? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartStreamProcessorResponse {
        let input = StartStreamProcessorRequest(
            name: name, 
            startSelector: startSelector, 
            stopSelector: stopSelector
        )
        return try await self.startStreamProcessor(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func startTextDetection(
        clientRequestToken: String? = nil,
        ...
        video: Video,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartTextDetectionResponse {
        let input = StartTextDetectionRequest(
            clientRequestToken: clientRequestToken, 
            filters: filters, 
            jobTag: jobTag, 
            notificationChannel: notificationChannel, 
        ...
        return try await self.startTextDetection(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - projectVersionArn: The Amazon Resource Name (ARN) of the model version that you want to stop. This operation requires permissions to perform the rekognition:StopProjectVersion action.
    ///   - logger: Logger use during operation
    @inlinable
    public func stopProjectVersion(
        projectVersionArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StopProjectVersionResponse {
        let input = StopProjectVersionRequest(
            projectVersionArn: projectVersionArn
        )
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func stopStreamProcessor(
        name: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StopStreamProcessorResponse {
        let input = StopStreamProcessorRequest(
            name: name
        )
        return try await self.stopStreamProcessor(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - resourceArn:  Amazon Resource Name (ARN) of the model, collection, or stream processor that you want to assign the tags to.
    ...
    ///
    /// Parameters:
    ///   - resourceArn:  Amazon Resource Name (ARN) of the model, collection, or stream processor that you want to remove the tags from.
    ///   - tagKeys:  A list of the tags that you want to remove.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - regionsOfInterestForUpdate:  Specifies locations in the frames where Amazon Rekognition checks for objects or people. This is an optional parameter for label detection stream processors.
    ///   - settingsForUpdate:  The stream processor settings that you want to update. Label detection settings can be updated to detect different labels with a different minimum confidence.
    ///   - logger: Logger use during operation
    @inlinable
    public func updateStreamProcessor(
        dataSharingPreferenceForUpdate: StreamProcessorDataSharingPreference? = nil,
        name: String,
        parametersToDelete: [StreamProcessorParameterToDelete]? = nil,
        regionsOfInterestForUpdate: [RegionOfInterest]? = nil,
        settingsForUpdate: StreamProcessorSettingsForUpdate? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> UpdateStreamProcessorResponse {
        let input = UpdateStreamProcessorRequest(
        ...
        return try await self.updateStreamProcessor(input, logger: logger)
    }
}
...
extension Rekognition {
    /// Return PaginatorSequence for operation ``describeProjectVersions(_:logger:)``.
    ///
    /// - Parameters:
    ...
    public func describeProjectVersionsPaginator(
        ...
        return self.describeProjectVersionsPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``describeProjects(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func describeProjectsPaginator(
        ...
        return self.describeProjectsPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getCelebrityRecognition(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getCelebrityRecognitionPaginator(
        ...
        return self.getCelebrityRecognitionPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getContentModeration(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getContentModerationPaginator(
        ...
        return self.getContentModerationPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getFaceDetection(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getFaceDetectionPaginator(
        ...
        return self.getFaceDetectionPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getFaceSearch(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getFaceSearchPaginator(
        ...
        return self.getFaceSearchPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getLabelDetection(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getLabelDetectionPaginator(
        ...
        return self.getLabelDetectionPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getPersonTracking(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getPersonTrackingPaginator(
        ...
        return self.getPersonTrackingPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getSegmentDetection(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getSegmentDetectionPaginator(
        ...
        return self.getSegmentDetectionPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``getTextDetection(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func getTextDetectionPaginator(
        ...
        return self.getTextDetectionPaginator(input, logger: logger)
    }
    ...
    /// Return PaginatorSequence for operation ``listDatasetLabels(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listDatasetLabelsPaginator(
        ...
        return self.listDatasetLabelsPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listFaces(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listFacesPaginator(
        ...
        return self.listFacesPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listMediaAnalysisJobs(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listMediaAnalysisJobsPaginator(
        ...
        return self.listMediaAnalysisJobsPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listProjectPolicies(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listProjectPoliciesPaginator(
        ...
        return self.listProjectPoliciesPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listStreamProcessors(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listStreamProcessorsPaginator(
        ...
        return self.listStreamProcessorsPaginator(input, logger: logger)
    }
...
@available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
extension Rekognition {
    /// Waiter for operation ``describeProjectVersions(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func waitUntilProjectVersionRunning(
        ...
        let waiter = AWSClient.Waiter<DescribeProjectVersionsRequest, _>(
            acceptors: [
    ...
    public func waitUntilProjectVersionRunning(
        ...
        try await self.waitUntilProjectVersionRunning(input, logger: logger)
    }
    ...
    public func waitUntilProjectVersionTrainingCompleted(
        ...
        try await self.waitUntilProjectVersionTrainingCompleted(input, logger: logger)
    }
}
