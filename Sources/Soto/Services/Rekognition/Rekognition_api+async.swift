...
extension Rekognition {
    ...
    public func associateFaces(_ input: AssociateFacesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AssociateFacesResponse {
        return try await self.client.execute(operation: "AssociateFaces", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createFaceLivenessSession(_ input: CreateFaceLivenessSessionRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateFaceLivenessSessionResponse {
        return try await self.client.execute(operation: "CreateFaceLivenessSession", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func disassociateFaces(_ input: DisassociateFacesRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DisassociateFacesResponse {
        return try await self.client.execute(operation: "DisassociateFaces", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func getFaceLivenessSessionResults(_ input: GetFaceLivenessSessionResultsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetFaceLivenessSessionResultsResponse {
        return try await self.client.execute(operation: "GetFaceLivenessSessionResults", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func searchUsersByImage(_ input: SearchUsersByImageRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SearchUsersByImageResponse {
        return try await self.client.execute(operation: "SearchUsersByImage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
