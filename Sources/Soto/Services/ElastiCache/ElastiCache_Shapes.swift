...
extension ElastiCache {
    ...
    public enum DataTieringStatus: String, CustomStringConvertible, Codable {
        case disabled
        case enabled
        public var description: String { return self.rawValue }
    }
