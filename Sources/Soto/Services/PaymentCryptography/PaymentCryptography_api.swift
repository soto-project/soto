...
public struct PaymentCryptography: AWSService {
    ...
    public func createKey(_ input: CreateKeyInput, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateKeyOutput {
        return try await self.client.execute(operation: "CreateKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteKey(_ input: DeleteKeyInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteKeyOutput {
        return try await self.client.execute(operation: "DeleteKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func exportKey(_ input: ExportKeyInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ExportKeyOutput {
        return try await self.client.execute(operation: "ExportKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getAlias(_ input: GetAliasInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetAliasOutput {
        return try await self.client.execute(operation: "GetAlias", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getKey(_ input: GetKeyInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetKeyOutput {
        return try await self.client.execute(operation: "GetKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getParametersForExport(_ input: GetParametersForExportInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetParametersForExportOutput {
        return try await self.client.execute(operation: "GetParametersForExport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getParametersForImport(_ input: GetParametersForImportInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetParametersForImportOutput {
        return try await self.client.execute(operation: "GetParametersForImport", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getPublicKeyCertificate(_ input: GetPublicKeyCertificateInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetPublicKeyCertificateOutput {
        return try await self.client.execute(operation: "GetPublicKeyCertificate", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func importKey(_ input: ImportKeyInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ImportKeyOutput {
        return try await self.client.execute(operation: "ImportKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listKeys(_ input: ListKeysInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ListKeysOutput {
        return try await self.client.execute(operation: "ListKeys", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func restoreKey(_ input: RestoreKeyInput, logger: Logger = AWSClient.loggingDisabled) async throws -> RestoreKeyOutput {
        return try await self.client.execute(operation: "RestoreKey", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startKeyUsage(_ input: StartKeyUsageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> StartKeyUsageOutput {
        return try await self.client.execute(operation: "StartKeyUsage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func stopKeyUsage(_ input: StopKeyUsageInput, logger: Logger = AWSClient.loggingDisabled) async throws -> StopKeyUsageOutput {
        return try await self.client.execute(operation: "StopKeyUsage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
