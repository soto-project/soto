...
public struct PaymentCryptography: AWSService {
    ...
    @Sendable
    @inlinable
    public func associateMpaTeam(_ input: AssociateMpaTeamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> AssociateMpaTeamOutput {
        try await self.client.execute(
            operation: "AssociateMpaTeam", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///   - requesterComment: The comment from the requester explaining the reason for the association.  Don't include personal, confidential or sensitive information in this field. This field may be displayed in plaintext in CloudTrail logs and other output.
    ///   - logger: Logger use during operation
    @inlinable
    public func associateMpaTeam(
        action: MpaOperation,
        mpaTeamArn: String,
        requesterComment: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> AssociateMpaTeamOutput {
        let input = AssociateMpaTeamInput(
            action: action, 
            mpaTeamArn: mpaTeamArn, 
            requesterComment: requesterComment
        )
        return try await self.associateMpaTeam(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - resourceArn: The KeyARN of the key whose resource-based policy you want to delete.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    @Sendable
    @inlinable
    public func disassociateMpaTeam(_ input: DisassociateMpaTeamInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DisassociateMpaTeamOutput {
        try await self.client.execute(
            operation: "DisassociateMpaTeam", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - action: The protected operation to disassociate from the MPA team. Currently, the only supported value is IMPORT_ROOT_PUBLIC_KEY_CERTIFICATE.
    ///   - requesterComment: The comment from the requester explaining the reason for the disassociation.  Don't include personal, confidential or sensitive information in this field. This field may be displayed in plaintext in CloudTrail logs and other output.
    ///   - logger: Logger use during operation
    @inlinable
    public func disassociateMpaTeam(
        action: MpaOperation,
        requesterComment: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DisassociateMpaTeamOutput {
        let input = DisassociateMpaTeamInput(
            action: action, 
            requesterComment: requesterComment
        )
        return try await self.disassociateMpaTeam(input, logger: logger)
    }
    ...
    @Sendable
    @inlinable
    public func getMpaTeamAssociation(_ input: GetMpaTeamAssociationInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GetMpaTeamAssociationOutput {
        try await self.client.execute(
            operation: "GetMpaTeamAssociation", 
            path: "/", 
            httpMethod: .POST, 
            serviceConfig: self.config, 
            input: input, 
    ...
    ///
    /// Parameters:
    ///   - action: The protected operation whose MPA team association you want to retrieve. Currently, the only supported value is IMPORT_ROOT_PUBLIC_KEY_CERTIFICATE.
    ///   - logger: Logger use during operation
    @inlinable
    public func getMpaTeamAssociation(
        action: MpaOperation,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetMpaTeamAssociationOutput {
        let input = GetMpaTeamAssociationInput(
            action: action
        )
        return try await self.getMpaTeamAssociation(input, logger: logger)
    }
    ...
    public func getParametersForExport(
        ...
        reuseLastGeneratedToken: Bool? = nil,
    ...
    ///
    /// Parameters:
    ///   - resourceArn: The KeyARN of the key whose resource-based policy you want to retrieve.
    ///   - logger: Logger use during operation
    @inlinable
    ...
    ///   - replicationRegions: 
    ///   - requesterComment: The comment from the requester explaining the reason for the import.  Don't include personal, confidential or sensitive information in this field. This field may be displayed in plaintext in CloudTrail logs and other output.
    ...
    ///   - resourceArn: The KeyARN of the key to attach the resource-based policy to.
    ///   - logger: Logger use during operation
    @inlinable
