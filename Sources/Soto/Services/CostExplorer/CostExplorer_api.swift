...
public struct CostExplorer: AWSService {
    ...
    public func getSavingsPlanPurchaseRecommendationDetails(_ input: GetSavingsPlanPurchaseRecommendationDetailsRequest, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSavingsPlanPurchaseRecommendationDetailsResponse> {
        return self.client.execute(operation: "GetSavingsPlanPurchaseRecommendationDetails", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
