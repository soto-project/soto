...
extension IoT {
    ...
    public struct CreateDomainConfigurationRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.validationCertificateArn, name: "validationCertificateArn", parent: name, pattern: "arn:aws:acm:[a-z]{2}-(gov-)?[a-z]{4,9}-\\d{1}:\\d{12}:certificate/?[a-zA-Z0-9/-]+")
        }
