...
extension IoT {
    ...
    public struct CreateDomainConfigurationRequest: AWSEncodableShape {
        ...
        public init(authorizerConfig: AuthorizerConfig? = nil, domainConfigurationName: String, domainName: String? = nil, serverCertificateArns: [String]? = nil, serviceType: ServiceType? = nil, tags: [Tag]? = nil, tlsConfig: TlsConfig? = nil, validationCertificateArn: String? = nil) {
    ...
    public struct DescribeDomainConfigurationResponse: AWSDecodableShape {
        ...
        public init(authorizerConfig: AuthorizerConfig? = nil, domainConfigurationArn: String? = nil, domainConfigurationName: String? = nil, domainConfigurationStatus: DomainConfigurationStatus? = nil, domainName: String? = nil, domainType: DomainType? = nil, lastStatusChangeDate: Date? = nil, serverCertificates: [ServerCertificateSummary]? = nil, serviceType: ServiceType? = nil, tlsConfig: TlsConfig? = nil) {
            self.authorizerConfig = authorizerConfig
            self.domainConfigurationArn = domainConfigurationArn
            self.domainConfigurationName = domainConfigurationName
    ...
    public struct UpdateDomainConfigurationRequest: AWSEncodableShape {
        ...
        public init(authorizerConfig: AuthorizerConfig? = nil, domainConfigurationName: String, domainConfigurationStatus: DomainConfigurationStatus? = nil, removeAuthorizerConfig: Bool? = nil, tlsConfig: TlsConfig? = nil) {
            self.authorizerConfig = authorizerConfig
            self.domainConfigurationName = domainConfigurationName
            self.domainConfigurationStatus = domainConfigurationStatus
