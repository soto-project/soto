...
extension GameLiftStreams {
    ...
    public struct PerformanceStatsConfiguration: AWSEncodableShape & AWSDecodableShape {
        /// Performance stats for the session are streamed to the client when set to true. Defaults to false.
        public let sharedWithClient: Bool?

        @inlinable
        public init(sharedWithClient: Bool? = nil) {
            self.sharedWithClient = sharedWithClient
        }

        private enum CodingKeys: String, CodingKey {
            case sharedWithClient = "SharedWithClient"
        }
    }
    ...
    public struct StreamGroupSummary: AWSDecodableShape {
        ...
        @inlinable
        public init(arn: String, createdAt: Date? = nil, defaultApplication: DefaultApplication? = nil, description: String? = nil, expiresAt: Date? = nil, id: String? = nil, lastUpdatedAt: Date? = nil, status: StreamGroupStatus? = nil, streamClass: StreamClass? = nil) {
            self.arn = arn
            self.createdAt = createdAt
            self.defaultApplication = defaultApplication
            self.description = description
    ...
    public struct UpdateStreamGroupInput: AWSEncodableShape {
        ...
        @inlinable
        public init(defaultApplicationIdentifier: String? = nil, description: String? = nil, identifier: String, locationConfigurations: [LocationConfiguration]? = nil) {
            self.defaultApplicationIdentifier = defaultApplicationIdentifier
            self.description = description
            self.identifier = identifier
            self.locationConfigurations = locationConfigurations
        ...
        public func encode(to encoder: Encoder) throws {
            let request = encoder.userInfo[.awsRequest]! as! RequestEncodingContainer
            var container = encoder.container(keyedBy: CodingKeys.self)
            try container.encodeIfPresent(self.defaultApplicationIdentifier, forKey: .defaultApplicationIdentifier)
            try container.encodeIfPresent(self.description, forKey: .description)
            request.encodePath(self.identifier, key: "Identifier")
