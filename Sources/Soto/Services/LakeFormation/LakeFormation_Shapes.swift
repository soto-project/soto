...
extension LakeFormation {
    ...
    public struct GetTableObjectsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.partitionPredicate, name: "partitionPredicate", parent: name, min: 0)
    ...
    public struct GetWorkUnitResultsResponse: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public static var _encoding = [
            AWSMemberEncoding(label: "resultStream", location: .body(locationName: "ResultStream"))
        ]
    ...
    public struct RowFilter: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.filterExpression, name: "filterExpression", parent: name, min: 0)
