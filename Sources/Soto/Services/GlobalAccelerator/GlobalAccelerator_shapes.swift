...
extension GlobalAccelerator {
    ...
    public struct AdvertiseByoipCidrRequest: AWSEncodableShape {
        ...
        /// 			You can't advertise only a portion of the provisioned range. For more information, see
    ...
    public struct ByoipCidr: AWSDecodableShape {
        /// The address range, in CIDR notation. For more information, see
        /// 			Bring your own IP addresses (BYOIP) in
        /// 			the Global Accelerator Developer Guide.
        public let cidr: String?
    ...
    public struct CreateCrossAccountAttachmentRequest: AWSEncodableShape {
        ...
        public let principals: [String]?
        /// The Amazon Resource Names (ARNs) for the resources to include in the cross-account attachment. A resource can
        ...
        public let resources: [Resource]?
        /// Add tags for a cross-account attachment. For more information, see Tagging
        /// 			in Global Accelerator in the Global Accelerator Developer Guide.
        public let tags: [Tag]?
    ...
    public struct CrossAccountResource: AWSDecodableShape {
        ...
        public let attachmentArn: String?
        /// An IP address range, in CIDR format, that is specified as an Amazon Web Services resource. The address must
        /// 			be provisioned and advertised in Global Accelerator by following the bring your own IP address (BYOIP) process
        /// 			for Global Accelerator. For more information, see
        /// 			Bring your own IP addresses (BYOIP) in
        /// 			the Global Accelerator Developer Guide.
        public let cidr: String?
    ...
    public struct DeprovisionByoipCidrRequest: AWSEncodableShape {
        ...
        /// 			when you provisioned the address range. For more information, see
        /// 			Bring your own IP addresses (BYOIP) in
        /// 			the Global Accelerator Developer Guide.
        public let cidr: String
    ...
    public struct EndpointConfiguration: AWSEncodableShape {
        ...
        /// 			when you add it as an endpoint. For cross-account endpoints, this must be the ARN of the resource.
        public let endpointId: String?
    ...
    public struct ListCrossAccountResourceAccountsResponse: AWSDecodableShape {
        /// The account IDs of principals (resource owners) in a cross-account attachment who can work
    ...
    public struct ProvisionByoipCidrRequest: AWSEncodableShape {
        ...
        /// 			to this Amazon Web Services Region or another Region. For more information, see
        /// 			Bring your own IP addresses (BYOIP) in
        /// 			the Global Accelerator Developer Guide.
        public let cidr: String
    ...
    public struct Resource: AWSEncodableShape & AWSDecodableShape {
        ...
        /// 			the Global Accelerator Developer Guide.
        public let cidr: String?
        /// The endpoint ID for the endpoint that is specified as a Amazon Web Services resource.  An endpoint ID for the cross-account feature is the ARN of an Amazon Web Services resource, such as a
    ...
    public struct UpdateCrossAccountAttachmentRequest: AWSEncodableShape {
        ...
        /// 			are also listed in the attachment. To add more than one principal, separate the account numbers or accelerator ARNs, or both, with commas.
        ...
        /// 			with an accelerator by the principals that are listed in the attachment. To add more than one resource, separate the resource ARNs with commas.
        ...
        /// 			of an accelerator that the attachment gives permission to work with resources from another account. The resources
        /// 			are also listed in the attachment. To remove more than one principal, separate the account numbers or accelerator ARNs, or both, with commas.
        public let removePrincipals: [String]?
        /// The resources to remove from the cross-account attachment. A resource listed in a cross-account attachment can be used
