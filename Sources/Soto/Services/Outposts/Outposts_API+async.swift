...
extension Outposts {
    ...
    public func listAssets(_ input: ListAssetsInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ListAssetsOutput {
        return try await self.client.execute(operation: "ListAssets", path: "/outposts/{OutpostId}/assets", httpMethod: .GET, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
