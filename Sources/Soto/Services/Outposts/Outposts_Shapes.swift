...
extension Outposts {
    ...
    public struct Address: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.addressLine2, name: "addressLine2", parent: name, min: 0)
            ...
            try self.validate(self.addressLine3, name: "addressLine3", parent: name, min: 0)
            ...
            try self.validate(self.municipality, name: "municipality", parent: name, min: 0)
    ...
    public struct GetCatalogItemInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "catalogItemId", location: .uri(locationName: "CatalogItemId"))
        ]
    ...
    public struct GetSiteAddressInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "addressType", location: .querystring(locationName: "AddressType")),
            AWSMemberEncoding(label: "siteId", location: .uri(locationName: "SiteId"))
        ]
    ...
    public struct ListCatalogItemsInput: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "itemClassFilter", location: .querystring(locationName: "ItemClassFilter")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "MaxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "NextToken")),
            AWSMemberEncoding(label: "supportedStorageFilter", location: .querystring(locationName: "SupportedStorageFilter"))
        ]
    ...
    public struct ListOrdersInput: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "MaxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "NextToken")),
            AWSMemberEncoding(label: "outpostIdentifierFilter", location: .querystring(locationName: "OutpostIdentifierFilter"))
        ]
