...
extension ElasticInference {
    ...
    public struct DescribeAcceleratorOfferingsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.acceleratorTypes, name: "acceleratorTypes", parent: name, max: 100)
            try validate(self.acceleratorTypes, name: "acceleratorTypes", parent: name, min: 0)
        }
    ...
    public struct DescribeAcceleratorsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.acceleratorIds, name: "acceleratorIds", parent: name, max: 1000)
            try validate(self.acceleratorIds, name: "acceleratorIds", parent: name, min: 0)
            try self.filters?.forEach {
                try $0.validate(name: "\(name).filters[]")
            }
            try validate(self.filters, name: "filters", parent: name, max: 100)
    ...
    public struct ListTagsForResourceRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.resourceArn, name: "resourceArn", parent: name, pattern: "^arn:aws\\S*:elastic-inference:\\S+:\\d{12}:elastic-inference-accelerator/eia-[0-9a-f]+$")
        }
