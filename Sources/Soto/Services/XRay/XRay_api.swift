...
public struct XRay: AWSService {
    ...
    ///
    /// Parameters:
    ///   - samplingBoostStatisticsDocuments: Information about rules that the service is using to boost sampling rate.
    ...
    public func getSamplingTargets(
        samplingBoostStatisticsDocuments: [SamplingBoostStatisticsDocument]? = nil,
