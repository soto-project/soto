...
public struct KinesisVideoArchivedMedia: AWSService {
    ...
    ) async throws -> GetClipOutput {
        let input = GetClipInput(
            clipFragmentSelector: clipFragmentSelector, 
            streamARN: streamARN, 
            streamName: streamName
        )
        return try await self.getClip(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getDASHStreamingSessionURL(
        ...
        expires: Int? = nil,
        maxManifestFragmentResults: Int64? = nil,
        playbackMode: DASHPlaybackMode? = nil,
        streamARN: String? = nil,
        streamName: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetDASHStreamingSessionURLOutput {
        let input = GetDASHStreamingSessionURLInput(
        ...
        return try await self.getDASHStreamingSessionURL(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getHLSStreamingSessionURL(
        ...
        maxMediaPlaylistFragmentResults: Int64? = nil,
        playbackMode: HLSPlaybackMode? = nil,
        streamARN: String? = nil,
        streamName: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetHLSStreamingSessionURLOutput {
        let input = GetHLSStreamingSessionURLInput(
        ...
        return try await self.getHLSStreamingSessionURL(input, logger: logger)
    }
    ...
    public func getImages(
        endTimestamp: Date,
        format: Format,
        formatConfig: [FormatConfigKey: String]? = nil,
        ...
        widthPixels: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetImagesOutput {
        let input = GetImagesInput(
        ...
        return try await self.getImages(input, logger: logger)
    }
    ...
    ///   - logger: Logger use during operation
    @inlinable
    public func getMediaForFragmentList(
        fragments: [String],
        streamARN: String? = nil,
        streamName: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetMediaForFragmentListOutput {
        let input = GetMediaForFragmentListInput(
            fragments: fragments, 
            streamARN: streamARN, 
            streamName: streamName
        )
        return try await self.getMediaForFragmentList(input, logger: logger)
    }
    ...
    public func listFragments(
        ...
        streamName: String? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListFragmentsOutput {
        let input = ListFragmentsInput(
        ...
        return try await self.listFragments(input, logger: logger)
    }
}
...
extension KinesisVideoArchivedMedia {
    /// Return PaginatorSequence for operation ``getImages(_:logger:)``.
    ///
    /// - Parameters:
    ...
    public func getImagesPaginator(
        ...
        return self.getImagesPaginator(input, logger: logger)
    }

    /// Return PaginatorSequence for operation ``listFragments(_:logger:)``.
    ///
    /// - Parameters:
    ///   - input: Input for operation
    ///   - logger: Logger used for logging
    ...
    public func listFragmentsPaginator(
        ...
        return self.listFragmentsPaginator(input, logger: logger)
    }
}
