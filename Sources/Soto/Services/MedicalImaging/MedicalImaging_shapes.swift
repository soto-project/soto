...
extension MedicalImaging {
    ...
    public struct CopyImageSetRequest: AWSEncodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "copyImageSetInformation"
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreId", location: .uri("datastoreId")),
            AWSMemberEncoding(label: "sourceImageSetId", location: .uri("sourceImageSetId"))
        ]
        ...
        private enum CodingKeys: String, CodingKey {
            case copyImageSetInformation = "copyImageSetInformation"
        }
    }
    ...
    public struct DeleteImageSetRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreId", location: .uri("datastoreId")),
            AWSMemberEncoding(label: "imageSetId", location: .uri("imageSetId"))
        ]
    ...
    public struct GetImageFrameRequest: AWSEncodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "imageFrameInformation"
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreId", location: .uri("datastoreId")),
            AWSMemberEncoding(label: "imageSetId", location: .uri("imageSetId"))
        ]
        ...
        private enum CodingKeys: String, CodingKey {
            case imageFrameInformation = "imageFrameInformation"
        }
    }

    public struct GetImageFrameResponse: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "imageFrameBlob"
        ...
        public let imageFrameBlob: AWSPayload

        public init(contentType: String? = nil, imageFrameBlob: AWSPayload) {
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case imageFrameBlob = "imageFrameBlob"
        }
    }
    ...
    public struct GetImageSetMetadataRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreId", location: .uri("datastoreId")),
            AWSMemberEncoding(label: "imageSetId", location: .uri("imageSetId")),
            AWSMemberEncoding(label: "versionId", location: .querystring("version"))
        ]
    ...
    public struct GetImageSetMetadataResponse: AWSDecodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "imageSetMetadataBlob"
        public static let _options: AWSShapeOptions = [.rawPayload, .allowStreaming]
        public static var _encoding = [
        ...
        public let imageSetMetadataBlob: AWSPayload

        public init(contentEncoding: String? = nil, contentType: String? = nil, imageSetMetadataBlob: AWSPayload) {
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case contentType = "Content-Type"
            case imageSetMetadataBlob = "imageSetMetadataBlob"
        }
    }
    ...
    public struct ListDatastoresRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreStatus", location: .querystring("datastoreStatus")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken"))
        ]
    ...
    public struct SearchCriteria: AWSEncodableShape {
        ...
        public init(filters: [SearchFilter]? = nil) {
    ...
    public struct SearchImageSetsRequest: AWSEncodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "searchCriteria"
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreId", location: .uri("datastoreId")),
            AWSMemberEncoding(label: "maxResults", location: .querystring("maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring("nextToken"))
    ...
    public struct SearchImageSetsResponse: AWSDecodableShape {
        ...
        public init(imageSetsMetadataSummaries: [ImageSetsMetadataSummary], nextToken: String? = nil) {
    ...
    public struct UpdateImageSetMetadataRequest: AWSEncodableShape & AWSShapeWithPayload {
        /// The key for the payload
        public static let _payloadPath: String = "updateImageSetMetadataUpdates"
        public static var _encoding = [
            AWSMemberEncoding(label: "datastoreId", location: .uri("datastoreId")),
            AWSMemberEncoding(label: "imageSetId", location: .uri("imageSetId")),
            AWSMemberEncoding(label: "latestVersionId", location: .querystring("latestVersion"))
        ]
        ...
        private enum CodingKeys: String, CodingKey {
            case updateImageSetMetadataUpdates = "updateImageSetMetadataUpdates"
        }
    }
