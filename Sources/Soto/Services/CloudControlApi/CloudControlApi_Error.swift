...
/// Error enum for CloudControlApi
public struct CloudControlApiErrorType: AWSErrorType {
    enum Code: String {
...
extension CloudControlApiErrorType: Equatable {
    public static func == (lhs: CloudControlApiErrorType, rhs: CloudControlApiErrorType) -> Bool {
        lhs.error == rhs.error
    }
}

extension CloudControlApiErrorType: CustomStringConvertible {
