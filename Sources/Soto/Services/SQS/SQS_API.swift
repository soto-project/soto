...
public struct SQS: AWSService {
    ...
    @discardableResult public func addPermission(_ input: AddPermissionRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func changeMessageVisibility(_ input: ChangeMessageVisibilityRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "ChangeMessageVisibility", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func changeMessageVisibilityBatch(_ input: ChangeMessageVisibilityBatchRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeMessageVisibilityBatchResult> {
        return self.client.execute(operation: "ChangeMessageVisibilityBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func createQueue(_ input: CreateQueueRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateQueueResult> {
        return self.client.execute(operation: "CreateQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteMessage(_ input: DeleteMessageRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteMessage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func deleteMessageBatch(_ input: DeleteMessageBatchRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMessageBatchResult> {
        return self.client.execute(operation: "DeleteMessageBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func deleteQueue(_ input: DeleteQueueRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "DeleteQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getQueueAttributes(_ input: GetQueueAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetQueueAttributesResult> {
        return self.client.execute(operation: "GetQueueAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func getQueueUrl(_ input: GetQueueUrlRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetQueueUrlResult> {
        return self.client.execute(operation: "GetQueueUrl", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listDeadLetterSourceQueues(_ input: ListDeadLetterSourceQueuesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDeadLetterSourceQueuesResult> {
        return self.client.execute(operation: "ListDeadLetterSourceQueues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listQueueTags(_ input: ListQueueTagsRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListQueueTagsResult> {
        return self.client.execute(operation: "ListQueueTags", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func listQueues(_ input: ListQueuesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListQueuesResult> {
        return self.client.execute(operation: "ListQueues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func purgeQueue(_ input: PurgeQueueRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "PurgeQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func receiveMessage(_ input: ReceiveMessageRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReceiveMessageResult> {
        return self.client.execute(operation: "ReceiveMessage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func sendMessage(_ input: SendMessageRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendMessageResult> {
        return self.client.execute(operation: "SendMessage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    public func sendMessageBatch(_ input: SendMessageBatchRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendMessageBatchResult> {
        return self.client.execute(operation: "SendMessageBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func setQueueAttributes(_ input: SetQueueAttributesRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "SetQueueAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func tagQueue(_ input: TagQueueRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "TagQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
    ...
    @discardableResult public func untagQueue(_ input: UntagQueueRequest, context: LoggingContext, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return self.client.execute(operation: "UntagQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, context: context, on: eventLoop)
    }
}
