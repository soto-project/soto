...
public struct SQS: AWSService {
    ...
    public func cancelMessageMoveTask(
        taskHandle: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CancelMessageMoveTaskResult {
        let input = CancelMessageMoveTaskRequest(
            taskHandle: taskHandle
        )
        return try await self.cancelMessageMoveTask(input, logger: logger)
    }
    ...
    public func changeMessageVisibility(
        ...
        let input = ChangeMessageVisibilityRequest(
            queueUrl: queueUrl, 
            receiptHandle: receiptHandle, 
            visibilityTimeout: visibilityTimeout
        )
        return try await self.changeMessageVisibility(input, logger: logger)
    }
    ...
    public func changeMessageVisibilityBatch(
        ...
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ChangeMessageVisibilityBatchResult {
        let input = ChangeMessageVisibilityBatchRequest(
            entries: entries, 
            queueUrl: queueUrl
        )
        return try await self.changeMessageVisibilityBatch(input, logger: logger)
    }
    ...
    ///   - tags: Add cost allocation tags to the specified Amazon SQS queue. For an overview, see Tagging
    ///   - logger: Logger use during operation
    @inlinable
    public func createQueue(
        attributes: [QueueAttributeName: String]? = nil,
        queueName: String,
        tags: [String: String]? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> CreateQueueResult {
    ...
    public func deleteMessageBatch(
        ...
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> DeleteMessageBatchResult {
        let input = DeleteMessageBatchRequest(
            entries: entries, 
            queueUrl: queueUrl
        )
        return try await self.deleteMessageBatch(input, logger: logger)
    }
    ...
    public func getQueueAttributes(
        ...
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetQueueAttributesResult {
        let input = GetQueueAttributesRequest(
            attributeNames: attributeNames, 
            queueUrl: queueUrl
        )
        return try await self.getQueueAttributes(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - queueName: (Required) The name of the queue for which you want to fetch the URL. The name can be up to 80 characters long and can include alphanumeric characters, hyphens (-), and underscores (_). Queue URLs and names are case-sensitive.
    ///   - queueOwnerAWSAccountId: (Optional) The Amazon Web Services account ID of the account that created the queue. This is only required when you are attempting to access a queue owned by another Amazon Web Services account.
    ///   - logger: Logger use during operation
    @inlinable
    public func getQueueUrl(
        ...
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> GetQueueUrlResult {
        let input = GetQueueUrlRequest(
            queueName: queueName, 
            queueOwnerAWSAccountId: queueOwnerAWSAccountId
        )
        return try await self.getQueueUrl(input, logger: logger)
    }
    ...
    public func listDeadLetterSourceQueues(
        ...
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListDeadLetterSourceQueuesResult {
        let input = ListDeadLetterSourceQueuesRequest(
            maxResults: maxResults, 
            nextToken: nextToken, 
            queueUrl: queueUrl
        )
        return try await self.listDeadLetterSourceQueues(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - maxResults: The maximum number of results to include in the response. The default is 1, which provides the most recent message movement task. The upper limit is 10.
    ...
    public func listMessageMoveTasks(
        ...
        sourceArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListMessageMoveTasksResult {
        let input = ListMessageMoveTasksRequest(
            maxResults: maxResults, 
            sourceArn: sourceArn
        )
        return try await self.listMessageMoveTasks(input, logger: logger)
    }
    ...
    public func listQueueTags(
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ListQueueTagsResult {
        let input = ListQueueTagsRequest(
            queueUrl: queueUrl
        )
        return try await self.listQueueTags(input, logger: logger)
    }
    ...
    public func purgeQueue(
        ...
        let input = PurgeQueueRequest(
            queueUrl: queueUrl
        )
        return try await self.purgeQueue(input, logger: logger)
    }
    ...
    public func receiveMessage(
        maxNumberOfMessages: Int? = nil,
        messageAttributeNames: [String]? = nil,
        messageSystemAttributeNames: [MessageSystemAttributeName]? = nil,
        queueUrl: String,
        receiveRequestAttemptId: String? = nil,
        visibilityTimeout: Int? = nil,
        waitTimeSeconds: Int? = nil,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> ReceiveMessageResult {
        ...
        return try await self.receiveMessage(input, logger: logger)
    }
    ...
    public func sendMessage(
        ...
        messageSystemAttributes: [MessageSystemAttributeNameForSends: MessageSystemAttributeValue]? = nil,
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ...
    public func sendMessageBatch(
        ...
        queueUrl: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> SendMessageBatchResult {
        let input = SendMessageBatchRequest(
            entries: entries, 
            queueUrl: queueUrl
        )
        return try await self.sendMessageBatch(input, logger: logger)
    }
    ...
    public func setQueueAttributes(
        ...
        let input = SetQueueAttributesRequest(
            attributes: attributes, 
            queueUrl: queueUrl
        )
        return try await self.setQueueAttributes(input, logger: logger)
    }
    ...
    ///
    /// Parameters:
    ///   - destinationArn: The ARN of the queue that receives the moved messages. You can use this field to specify the destination queue where you would like to redrive messages. If this field is left blank, the messages will be redriven back to their respective original source queues.
    ...
    ///   - sourceArn: The ARN of the queue that contains the messages to be moved to another queue. Currently, only ARNs of dead-letter queues (DLQs) whose sources are other Amazon SQS queues are accepted. DLQs whose sources are non-SQS queues, such as Lambda or Amazon SNS topics, are not currently supported.
    ///   - logger: Logger use during operation
    @inlinable
    public func startMessageMoveTask(
        destinationArn: String? = nil,
        maxNumberOfMessagesPerSecond: Int? = nil,
        sourceArn: String,
        logger: Logger = AWSClient.loggingDisabled        
    ) async throws -> StartMessageMoveTaskResult {
        let input = StartMessageMoveTaskRequest(
            destinationArn: destinationArn, 
            maxNumberOfMessagesPerSecond: maxNumberOfMessagesPerSecond, 
            sourceArn: sourceArn
        )
        return try await self.startMessageMoveTask(input, logger: logger)
    }
    ...
    public func tagQueue(
        ...
        let input = TagQueueRequest(
            queueUrl: queueUrl, 
            tags: tags
        )
        return try await self.tagQueue(input, logger: logger)
    }
    ...
    public func untagQueue(
        ...
        let input = UntagQueueRequest(
            queueUrl: queueUrl, 
            tagKeys: tagKeys
        )
        return try await self.untagQueue(input, logger: logger)
    }
}
...
extension SQS {
    /// Return PaginatorSequence for operation ``listDeadLetterSourceQueues(_:logger:)``.
    ///
    /// - Parameters:
    ...
    public func listDeadLetterSourceQueuesPaginator(
        ...
        return self.listDeadLetterSourceQueuesPaginator(input, logger: logger)
    }
