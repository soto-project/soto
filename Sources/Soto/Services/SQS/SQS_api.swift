...
public struct SQS: AWSService {
    ...
    public func cancelMessageMoveTask(_ input: CancelMessageMoveTaskRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CancelMessageMoveTaskResult {
        return try await self.client.execute(operation: "CancelMessageMoveTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func changeMessageVisibility(_ input: ChangeMessageVisibilityRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "ChangeMessageVisibility", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func changeMessageVisibilityBatch(_ input: ChangeMessageVisibilityBatchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ChangeMessageVisibilityBatchResult {
        return try await self.client.execute(operation: "ChangeMessageVisibilityBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func createQueue(_ input: CreateQueueRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> CreateQueueResult {
        return try await self.client.execute(operation: "CreateQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteMessage(_ input: DeleteMessageRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteMessage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteMessageBatch(_ input: DeleteMessageBatchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> DeleteMessageBatchResult {
        return try await self.client.execute(operation: "DeleteMessageBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func deleteQueue(_ input: DeleteQueueRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "DeleteQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getQueueAttributes(_ input: GetQueueAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetQueueAttributesResult {
        return try await self.client.execute(operation: "GetQueueAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func getQueueUrl(_ input: GetQueueUrlRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> GetQueueUrlResult {
        return try await self.client.execute(operation: "GetQueueUrl", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listDeadLetterSourceQueues(_ input: ListDeadLetterSourceQueuesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListDeadLetterSourceQueuesResult {
        return try await self.client.execute(operation: "ListDeadLetterSourceQueues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listMessageMoveTasks(_ input: ListMessageMoveTasksRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListMessageMoveTasksResult {
        return try await self.client.execute(operation: "ListMessageMoveTasks", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listQueueTags(_ input: ListQueueTagsRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListQueueTagsResult {
        return try await self.client.execute(operation: "ListQueueTags", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func listQueues(_ input: ListQueuesRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ListQueuesResult {
        return try await self.client.execute(operation: "ListQueues", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func purgeQueue(_ input: PurgeQueueRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "PurgeQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func receiveMessage(_ input: ReceiveMessageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> ReceiveMessageResult {
        return try await self.client.execute(operation: "ReceiveMessage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func sendMessage(_ input: SendMessageRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SendMessageResult {
        return try await self.client.execute(operation: "SendMessage", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func sendMessageBatch(_ input: SendMessageBatchRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> SendMessageBatchResult {
        return try await self.client.execute(operation: "SendMessageBatch", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func setQueueAttributes(_ input: SetQueueAttributesRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "SetQueueAttributes", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func startMessageMoveTask(_ input: StartMessageMoveTaskRequest, logger: Logger = AWSClient.loggingDisabled) async throws -> StartMessageMoveTaskResult {
        return try await self.client.execute(operation: "StartMessageMoveTask", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func tagQueue(_ input: TagQueueRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "TagQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func untagQueue(_ input: UntagQueueRequest, logger: Logger = AWSClient.loggingDisabled) async throws {
        return try await self.client.execute(operation: "UntagQueue", path: "/", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
