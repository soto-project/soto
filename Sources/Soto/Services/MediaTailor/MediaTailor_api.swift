...
public struct MediaTailor: AWSService {
    ...
    ///
    /// Parameters:
    ///   - awsServiceRequestConfiguration: The configuration for an AWS_SERVICE_REQUEST function. You must specify this parameter when FunctionType is AWS_SERVICE_REQUEST.
    ...
    public func putFunction(
        awsServiceRequestConfiguration: AwsServiceRequestConfiguration? = nil,
