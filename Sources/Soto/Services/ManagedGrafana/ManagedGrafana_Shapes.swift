...
extension ManagedGrafana {
    ...
    public enum AccountAccessType: String, CustomStringConvertible, Codable {
        case currentAccount = "CURRENT_ACCOUNT"
        case organization = "ORGANIZATION"
        public var description: String { return self.rawValue }
    }

    public enum AuthenticationProviderTypes: String, CustomStringConvertible, Codable {
        case awsSso = "AWS_SSO"
        case saml = "SAML"
        public var description: String { return self.rawValue }
    }
    ...
    public enum NotificationDestinationType: String, CustomStringConvertible, Codable {
        case sns = "SNS"
        public var description: String { return self.rawValue }
    }
    ...
    public enum SamlConfigurationStatus: String, CustomStringConvertible, Codable {
        case configured = "CONFIGURED"
        case notConfigured = "NOT_CONFIGURED"
        public var description: String { return self.rawValue }
    }

    public enum UpdateAction: String, CustomStringConvertible, Codable {
        case add = "ADD"
        case revoke = "REVOKE"
        public var description: String { return self.rawValue }
    }
    ...
    public enum WorkspaceStatus: String, CustomStringConvertible, Codable {
        case active = "ACTIVE"
    ...
    public struct AssociateLicenseRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "licenseType", location: .uri(locationName: "licenseType")),
    ...
    public struct CreateWorkspaceApiKeyRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.secondsToLive, name: "secondsToLive", parent: name, max: 2_592_000)
            try self.validate(self.secondsToLive, name: "secondsToLive", parent: name, min: 1)
            try self.validate(self.workspaceId, name: "workspaceId", parent: name, pattern: "^g-[0-9a-f]{10}$")
        }
    ...
    public struct CreateWorkspaceRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.workspaceDescription, name: "workspaceDescription", parent: name, min: 0)
    ...
    public struct DeleteWorkspaceApiKeyRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "keyName", location: .uri(locationName: "keyName")),
            AWSMemberEncoding(label: "workspaceId", location: .uri(locationName: "workspaceId"))
        ]
    ...
    public struct IdpMetadata: AWSEncodableShape & AWSDecodableShape {
        /// The URL of the location containing the metadata.
        public let url: String?
        /// The actual full metadata file, in XML format.
        public let xml: String?

        public init(url: String? = nil, xml: String? = nil) {
            self.url = url
            self.xml = xml
        }
    ...
    public struct ListPermissionsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "groupId", location: .querystring(locationName: "groupId")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "userId", location: .querystring(locationName: "userId")),
            AWSMemberEncoding(label: "userType", location: .querystring(locationName: "userType")),
            AWSMemberEncoding(label: "workspaceId", location: .uri(locationName: "workspaceId"))
        ]
    ...
    public struct UpdatePermissionsRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.validate(self.updateInstructionBatch, name: "updateInstructionBatch", parent: name, min: 0)
            try self.validate(self.workspaceId, name: "workspaceId", parent: name, pattern: "^g-[0-9a-f]{10}$")
        }
