...
public struct PaymentCryptographyData: AWSService {
    ...
    public func decryptData(_ input: DecryptDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DecryptDataOutput> {
        return self.client.execute(operation: "DecryptData", path: "/keys/{KeyIdentifier}/decrypt", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func encryptData(_ input: EncryptDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EncryptDataOutput> {
        return self.client.execute(operation: "EncryptData", path: "/keys/{KeyIdentifier}/encrypt", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func generateCardValidationData(_ input: GenerateCardValidationDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GenerateCardValidationDataOutput> {
        return self.client.execute(operation: "GenerateCardValidationData", path: "/cardvalidationdata/generate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func generateMac(_ input: GenerateMacInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GenerateMacOutput> {
        return self.client.execute(operation: "GenerateMac", path: "/mac/generate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func generatePinData(_ input: GeneratePinDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GeneratePinDataOutput> {
        return self.client.execute(operation: "GeneratePinData", path: "/pindata/generate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func reEncryptData(_ input: ReEncryptDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReEncryptDataOutput> {
        return self.client.execute(operation: "ReEncryptData", path: "/keys/{IncomingKeyIdentifier}/reencrypt", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func translatePinData(_ input: TranslatePinDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TranslatePinDataOutput> {
        return self.client.execute(operation: "TranslatePinData", path: "/pindata/translate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func verifyAuthRequestCryptogram(_ input: VerifyAuthRequestCryptogramInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VerifyAuthRequestCryptogramOutput> {
        return self.client.execute(operation: "VerifyAuthRequestCryptogram", path: "/cryptogram/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func verifyCardValidationData(_ input: VerifyCardValidationDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VerifyCardValidationDataOutput> {
        return self.client.execute(operation: "VerifyCardValidationData", path: "/cardvalidationdata/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func verifyMac(_ input: VerifyMacInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VerifyMacOutput> {
        return self.client.execute(operation: "VerifyMac", path: "/mac/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func verifyPinData(_ input: VerifyPinDataInput, logger: Logger = AWSClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VerifyPinDataOutput> {
        return self.client.execute(operation: "VerifyPinData", path: "/pindata/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
}
