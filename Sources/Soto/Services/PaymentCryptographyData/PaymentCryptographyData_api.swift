...
public struct PaymentCryptographyData: AWSService {
    ...
    public func decryptData(_ input: DecryptDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> DecryptDataOutput {
        return try await self.client.execute(operation: "DecryptData", path: "/keys/{KeyIdentifier}/decrypt", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func encryptData(_ input: EncryptDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> EncryptDataOutput {
        return try await self.client.execute(operation: "EncryptData", path: "/keys/{KeyIdentifier}/encrypt", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func generateCardValidationData(_ input: GenerateCardValidationDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateCardValidationDataOutput {
        return try await self.client.execute(operation: "GenerateCardValidationData", path: "/cardvalidationdata/generate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func generateMac(_ input: GenerateMacInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GenerateMacOutput {
        return try await self.client.execute(operation: "GenerateMac", path: "/mac/generate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func generatePinData(_ input: GeneratePinDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> GeneratePinDataOutput {
        return try await self.client.execute(operation: "GeneratePinData", path: "/pindata/generate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func reEncryptData(_ input: ReEncryptDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> ReEncryptDataOutput {
        return try await self.client.execute(operation: "ReEncryptData", path: "/keys/{IncomingKeyIdentifier}/reencrypt", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func translatePinData(_ input: TranslatePinDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> TranslatePinDataOutput {
        return try await self.client.execute(operation: "TranslatePinData", path: "/pindata/translate", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func verifyAuthRequestCryptogram(_ input: VerifyAuthRequestCryptogramInput, logger: Logger = AWSClient.loggingDisabled) async throws -> VerifyAuthRequestCryptogramOutput {
        return try await self.client.execute(operation: "VerifyAuthRequestCryptogram", path: "/cryptogram/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func verifyCardValidationData(_ input: VerifyCardValidationDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> VerifyCardValidationDataOutput {
        return try await self.client.execute(operation: "VerifyCardValidationData", path: "/cardvalidationdata/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func verifyMac(_ input: VerifyMacInput, logger: Logger = AWSClient.loggingDisabled) async throws -> VerifyMacOutput {
        return try await self.client.execute(operation: "VerifyMac", path: "/mac/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
    ...
    public func verifyPinData(_ input: VerifyPinDataInput, logger: Logger = AWSClient.loggingDisabled) async throws -> VerifyPinDataOutput {
        return try await self.client.execute(operation: "VerifyPinData", path: "/pindata/verify", httpMethod: .POST, serviceConfig: self.config, input: input, logger: logger)
    }
}
