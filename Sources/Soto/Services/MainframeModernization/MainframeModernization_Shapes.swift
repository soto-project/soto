...
extension MainframeModernization {
    ...
    public enum ApplicationDeploymentLifecycle: String, CustomStringConvertible, Codable {
        case deployed = "Deployed"
        case deploying = "Deploying"
        public var description: String { return self.rawValue }
    }

    public enum ApplicationLifecycle: String, CustomStringConvertible, Codable {
    ...
    public enum ApplicationVersionLifecycle: String, CustomStringConvertible, Codable {
        case available = "Available"
        case creating = "Creating"
        case failed = "Failed"
        public var description: String { return self.rawValue }
    ...
    public enum BatchJobExecutionStatus: String, CustomStringConvertible, Codable {
    ...
    public enum BatchJobType: String, CustomStringConvertible, Codable {
        case jes2 = "JES2"
        case jes3 = "JES3"
        case vse = "VSE"
        public var description: String { return self.rawValue }
    ...
    public enum DataSetTaskLifecycle: String, CustomStringConvertible, Codable {
    ...
    public enum DeploymentLifecycle: String, CustomStringConvertible, Codable {
        case deploying = "Deploying"
        case failed = "Failed"
        case succeeded = "Succeeded"
        public var description: String { return self.rawValue }
    ...
    public enum EnvironmentLifecycle: String, CustomStringConvertible, Codable {
        case available = "Available"
        case creating = "Creating"
        case deleting = "Deleting"
        case failed = "Failed"
    ...
    public struct BatchJobDefinition: AWSDecodableShape {
        /// Specifies a file containing a batch job definition.
        public let fileBatchJobDefinition: FileBatchJobDefinition?
        /// A script containing a batch job definition.
        public let scriptBatchJobDefinition: ScriptBatchJobDefinition?

        public init(fileBatchJobDefinition: FileBatchJobDefinition? = nil, scriptBatchJobDefinition: ScriptBatchJobDefinition? = nil) {
    ...
    public struct BatchJobIdentifier: AWSEncodableShape {
        /// Specifies a file associated with a specific batch job.
        public let fileBatchJobIdentifier: FileBatchJobIdentifier?
        /// A batch job identifier in which the batch job to run is identified by the script name.
        public let scriptBatchJobIdentifier: ScriptBatchJobIdentifier?

        public init(fileBatchJobIdentifier: FileBatchJobIdentifier? = nil, scriptBatchJobIdentifier: ScriptBatchJobIdentifier? = nil) {
    ...
    public struct CancelBatchJobExecutionRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "executionId", location: .uri(locationName: "executionId"))
        ]
    ...
    public struct DataSetImportConfig: AWSEncodableShape {
        /// The data sets.
        public let dataSets: [DataSetImportItem]?
        /// The Amazon S3 location of the data sets.
        public let s3Location: String?

        public init(dataSets: [DataSetImportItem]? = nil, s3Location: String? = nil) {
    ...
    public struct DatasetDetailOrgAttributes: AWSDecodableShape {
        /// The generation data group of the data set.
        public let gdg: GdgDetailAttributes?
        /// The details of a VSAM data set.
        public let vsam: VsamDetailAttributes?

        public init(gdg: GdgDetailAttributes? = nil, vsam: VsamDetailAttributes? = nil) {
            self.gdg = gdg
            self.vsam = vsam
        }
    ...
    public struct DatasetOrgAttributes: AWSEncodableShape {
        /// The generation data group of the data set.
        public let gdg: GdgAttributes?
        /// The details of a VSAM data set.
        public let vsam: VsamAttributes?

        public init(gdg: GdgAttributes? = nil, vsam: VsamAttributes? = nil) {
            self.gdg = gdg
            self.vsam = vsam
        }
    ...
    public struct Definition: AWSEncodableShape {
        /// The content of the application definition. This is a JSON object that contains the resource configuration/definitions that identify an application.
        public let content: String?
        /// The S3 bucket that contains the application definition.
        public let s3Location: String?

        public init(content: String? = nil, s3Location: String? = nil) {
            self.content = content
            self.s3Location = s3Location
        }

        public func validate(name: String) throws {
            try self.validate(self.content, name: "content", parent: name, max: 65000)
    ...
    public struct GetApplicationVersionRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationId", location: .uri(locationName: "applicationId")),
            AWSMemberEncoding(label: "applicationVersion", location: .uri(locationName: "applicationVersion"))
        ]
    ...
    public struct ListApplicationsRequest: AWSEncodableShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "names", location: .querystring(locationName: "names")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken"))
        ]
    ...
    public struct ListBatchJobExecutionsRequest: AWSEncodableShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "applicationId", location: .uri(locationName: "applicationId")),
            AWSMemberEncoding(label: "executionIds", location: .querystring(locationName: "executionIds")),
            AWSMemberEncoding(label: "jobName", location: .querystring(locationName: "jobName")),
            AWSMemberEncoding(label: "maxResults", location: .querystring(locationName: "maxResults")),
            AWSMemberEncoding(label: "nextToken", location: .querystring(locationName: "nextToken")),
            AWSMemberEncoding(label: "startedAfter", location: .querystring(locationName: "startedAfter")),
            AWSMemberEncoding(label: "startedBefore", location: .querystring(locationName: "startedBefore")),
    ...
    public struct StartBatchJobRequest: AWSEncodableShape {
        ...
        public func validate(name: String) throws {
            ...
            try self.jobParams?.forEach {
                ...
                try validate($0.value, name: "jobParams[\"\($0.key)\"]", parent: name, min: 0)
            }
        }
    ...
    public struct StorageConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        public let efs: EfsStorageConfiguration?
        /// Defines the storage configuration for an Amazon FSx file system.
        public let fsx: FsxStorageConfiguration?

        public init(efs: EfsStorageConfiguration? = nil, fsx: FsxStorageConfiguration? = nil) {
            self.efs = efs
            self.fsx = fsx
        }

        public func validate(name: String) throws {
            try self.efs?.validate(name: "\(name).efs")
            try self.fsx?.validate(name: "\(name).fsx")
        }
