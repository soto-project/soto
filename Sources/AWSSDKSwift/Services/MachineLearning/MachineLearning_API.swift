...
public struct MachineLearning: AWSService {
    ...
    public func createBatchPrediction(_ input: CreateBatchPredictionInput) -> EventLoopFuture<CreateBatchPredictionOutput> {
        return client.execute(operation: "CreateBatchPrediction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDataSourceFromRDS(_ input: CreateDataSourceFromRDSInput) -> EventLoopFuture<CreateDataSourceFromRDSOutput> {
        return client.execute(operation: "CreateDataSourceFromRDS", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDataSourceFromRedshift(_ input: CreateDataSourceFromRedshiftInput) -> EventLoopFuture<CreateDataSourceFromRedshiftOutput> {
        return client.execute(operation: "CreateDataSourceFromRedshift", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDataSourceFromS3(_ input: CreateDataSourceFromS3Input) -> EventLoopFuture<CreateDataSourceFromS3Output> {
        return client.execute(operation: "CreateDataSourceFromS3", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createEvaluation(_ input: CreateEvaluationInput) -> EventLoopFuture<CreateEvaluationOutput> {
        return client.execute(operation: "CreateEvaluation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createMLModel(_ input: CreateMLModelInput) -> EventLoopFuture<CreateMLModelOutput> {
        return client.execute(operation: "CreateMLModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createRealtimeEndpoint(_ input: CreateRealtimeEndpointInput) -> EventLoopFuture<CreateRealtimeEndpointOutput> {
        return client.execute(operation: "CreateRealtimeEndpoint", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteBatchPrediction(_ input: DeleteBatchPredictionInput) -> EventLoopFuture<DeleteBatchPredictionOutput> {
        return client.execute(operation: "DeleteBatchPrediction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteEvaluation(_ input: DeleteEvaluationInput) -> EventLoopFuture<DeleteEvaluationOutput> {
        return client.execute(operation: "DeleteEvaluation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteMLModel(_ input: DeleteMLModelInput) -> EventLoopFuture<DeleteMLModelOutput> {
        return client.execute(operation: "DeleteMLModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteRealtimeEndpoint(_ input: DeleteRealtimeEndpointInput) -> EventLoopFuture<DeleteRealtimeEndpointOutput> {
        return client.execute(operation: "DeleteRealtimeEndpoint", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeBatchPredictions(_ input: DescribeBatchPredictionsInput) -> EventLoopFuture<DescribeBatchPredictionsOutput> {
        return client.execute(operation: "DescribeBatchPredictions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns a list of DataSource that match the search criteria in the request.
    public func describeDataSources(_ input: DescribeDataSourcesInput) -> EventLoopFuture<DescribeDataSourcesOutput> {
        return client.execute(operation: "DescribeDataSources", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeEvaluations(_ input: DescribeEvaluationsInput) -> EventLoopFuture<DescribeEvaluationsOutput> {
        return client.execute(operation: "DescribeEvaluations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns a list of MLModel that match the search criteria in the request.
    public func describeMLModels(_ input: DescribeMLModelsInput) -> EventLoopFuture<DescribeMLModelsOutput> {
        return client.execute(operation: "DescribeMLModels", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBatchPrediction(_ input: GetBatchPredictionInput) -> EventLoopFuture<GetBatchPredictionOutput> {
        return client.execute(operation: "GetBatchPrediction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDataSource(_ input: GetDataSourceInput) -> EventLoopFuture<GetDataSourceOutput> {
        return client.execute(operation: "GetDataSource", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns an Evaluation that includes metadata as well as the current status of the Evaluation.
    public func getEvaluation(_ input: GetEvaluationInput) -> EventLoopFuture<GetEvaluationOutput> {
        return client.execute(operation: "GetEvaluation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getMLModel(_ input: GetMLModelInput) -> EventLoopFuture<GetMLModelOutput> {
        return client.execute(operation: "GetMLModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func predict(_ input: PredictInput) -> EventLoopFuture<PredictOutput> {
        return client.execute(operation: "Predict", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateBatchPrediction(_ input: UpdateBatchPredictionInput) -> EventLoopFuture<UpdateBatchPredictionOutput> {
        return client.execute(operation: "UpdateBatchPrediction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateEvaluation(_ input: UpdateEvaluationInput) -> EventLoopFuture<UpdateEvaluationOutput> {
        return client.execute(operation: "UpdateEvaluation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateMLModel(_ input: UpdateMLModelInput) -> EventLoopFuture<UpdateMLModelOutput> {
        return client.execute(operation: "UpdateMLModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
