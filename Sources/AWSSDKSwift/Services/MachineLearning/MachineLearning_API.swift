...
public struct MachineLearning {
    ...
    public func createBatchPrediction(_ input: CreateBatchPredictionInput) -> Future<CreateBatchPredictionOutput> {
    ...
    public func createDataSourceFromRDS(_ input: CreateDataSourceFromRDSInput) -> Future<CreateDataSourceFromRDSOutput> {
    ...
    public func createDataSourceFromRedshift(_ input: CreateDataSourceFromRedshiftInput) -> Future<CreateDataSourceFromRedshiftOutput> {
    ...
    public func createDataSourceFromS3(_ input: CreateDataSourceFromS3Input) -> Future<CreateDataSourceFromS3Output> {
    ...
    public func createEvaluation(_ input: CreateEvaluationInput) -> Future<CreateEvaluationOutput> {
    ...
    public func createMLModel(_ input: CreateMLModelInput) -> Future<CreateMLModelOutput> {
        return client.send(operation: "CreateMLModel", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a real-time endpoint for the MLModel. The endpoint contains the URI of the MLModel; that is, the location to send real-time prediction requests for the specified MLModel.
    public func createRealtimeEndpoint(_ input: CreateRealtimeEndpointInput) -> Future<CreateRealtimeEndpointOutput> {
    ...
    public func deleteBatchPrediction(_ input: DeleteBatchPredictionInput) -> Future<DeleteBatchPredictionOutput> {
    ...
    public func deleteDataSource(_ input: DeleteDataSourceInput) -> Future<DeleteDataSourceOutput> {
    ...
    public func deleteEvaluation(_ input: DeleteEvaluationInput) -> Future<DeleteEvaluationOutput> {
    ...
    public func deleteMLModel(_ input: DeleteMLModelInput) -> Future<DeleteMLModelOutput> {
        return client.send(operation: "DeleteMLModel", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a real time endpoint of an MLModel.
    public func deleteRealtimeEndpoint(_ input: DeleteRealtimeEndpointInput) -> Future<DeleteRealtimeEndpointOutput> {
    ...
    public func describeBatchPredictions(_ input: DescribeBatchPredictionsInput) -> Future<DescribeBatchPredictionsOutput> {
        return client.send(operation: "DescribeBatchPredictions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of DataSource that match the search criteria in the request.
    public func describeDataSources(_ input: DescribeDataSourcesInput) -> Future<DescribeDataSourcesOutput> {
        return client.send(operation: "DescribeDataSources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of DescribeEvaluations that match the search criteria in the request.
    public func describeEvaluations(_ input: DescribeEvaluationsInput) -> Future<DescribeEvaluationsOutput> {
        return client.send(operation: "DescribeEvaluations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of MLModel that match the search criteria in the request.
    public func describeMLModels(_ input: DescribeMLModelsInput) -> Future<DescribeMLModelsOutput> {
    ...
    public func getBatchPrediction(_ input: GetBatchPredictionInput) -> Future<GetBatchPredictionOutput> {
    ...
    public func getDataSource(_ input: GetDataSourceInput) -> Future<GetDataSourceOutput> {
        return client.send(operation: "GetDataSource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns an Evaluation that includes metadata as well as the current status of the Evaluation.
    public func getEvaluation(_ input: GetEvaluationInput) -> Future<GetEvaluationOutput> {
    ...
    public func getMLModel(_ input: GetMLModelInput) -> Future<GetMLModelOutput> {
    ...
    public func predict(_ input: PredictInput) -> Future<PredictOutput> {
    ...
    public func updateBatchPrediction(_ input: UpdateBatchPredictionInput) -> Future<UpdateBatchPredictionOutput> {
    ...
    public func updateDataSource(_ input: UpdateDataSourceInput) -> Future<UpdateDataSourceOutput> {
    ...
    public func updateEvaluation(_ input: UpdateEvaluationInput) -> Future<UpdateEvaluationOutput> {
    ...
    public func updateMLModel(_ input: UpdateMLModelInput) -> Future<UpdateMLModelOutput> {
