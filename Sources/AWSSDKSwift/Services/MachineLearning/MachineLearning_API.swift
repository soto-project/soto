...
public struct MachineLearning {
    ...
    public func deleteBatchPrediction(_ input: DeleteBatchPredictionInput) throws -> EventLoopFuture<DeleteBatchPredictionOutput> {
    ...
    public func deleteDataSource(_ input: DeleteDataSourceInput) throws -> EventLoopFuture<DeleteDataSourceOutput> {
    ...
    public func updateEvaluation(_ input: UpdateEvaluationInput) throws -> EventLoopFuture<UpdateEvaluationOutput> {
    ...
    public func deleteMLModel(_ input: DeleteMLModelInput) throws -> EventLoopFuture<DeleteMLModelOutput> {
    ...
    public func createDataSourceFromRedshift(_ input: CreateDataSourceFromRedshiftInput) throws -> EventLoopFuture<CreateDataSourceFromRedshiftOutput> {
    ...
    public func createBatchPrediction(_ input: CreateBatchPredictionInput) throws -> EventLoopFuture<CreateBatchPredictionOutput> {
        return try client.send(operation: "CreateBatchPrediction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of DataSource that match the search criteria in the request.
    public func describeDataSources(_ input: DescribeDataSourcesInput) throws -> EventLoopFuture<DescribeDataSourcesOutput> {
        return try client.send(operation: "DescribeDataSources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a BatchPrediction that includes detailed metadata, status, and data file information for a Batch Prediction request.
    public func getBatchPrediction(_ input: GetBatchPredictionInput) throws -> EventLoopFuture<GetBatchPredictionOutput> {
        return try client.send(operation: "GetBatchPrediction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of DescribeEvaluations that match the search criteria in the request.
    public func describeEvaluations(_ input: DescribeEvaluationsInput) throws -> EventLoopFuture<DescribeEvaluationsOutput> {
    ...
    public func createEvaluation(_ input: CreateEvaluationInput) throws -> EventLoopFuture<CreateEvaluationOutput> {
    ...
    public func createMLModel(_ input: CreateMLModelInput) throws -> EventLoopFuture<CreateMLModelOutput> {
    ...
    public func updateDataSource(_ input: UpdateDataSourceInput) throws -> EventLoopFuture<UpdateDataSourceOutput> {
    ...
    public func createDataSourceFromS3(_ input: CreateDataSourceFromS3Input) throws -> EventLoopFuture<CreateDataSourceFromS3Output> {
    ...
    public func updateMLModel(_ input: UpdateMLModelInput) throws -> EventLoopFuture<UpdateMLModelOutput> {
    ...
    public func getMLModel(_ input: GetMLModelInput) throws -> EventLoopFuture<GetMLModelOutput> {
    ...
    public func deleteEvaluation(_ input: DeleteEvaluationInput) throws -> EventLoopFuture<DeleteEvaluationOutput> {
        return try client.send(operation: "DeleteEvaluation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a real-time endpoint for the MLModel. The endpoint contains the URI of the MLModel; that is, the location to send real-time prediction requests for the specified MLModel.
    public func createRealtimeEndpoint(_ input: CreateRealtimeEndpointInput) throws -> EventLoopFuture<CreateRealtimeEndpointOutput> {
    ...
    public func createDataSourceFromRDS(_ input: CreateDataSourceFromRDSInput) throws -> EventLoopFuture<CreateDataSourceFromRDSOutput> {
    ...
    public func updateBatchPrediction(_ input: UpdateBatchPredictionInput) throws -> EventLoopFuture<UpdateBatchPredictionOutput> {
        return try client.send(operation: "UpdateBatchPrediction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of BatchPrediction operations that match the search criteria in the request.
    public func describeBatchPredictions(_ input: DescribeBatchPredictionsInput) throws -> EventLoopFuture<DescribeBatchPredictionsOutput> {
        return try client.send(operation: "DescribeBatchPredictions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns an Evaluation that includes metadata as well as the current status of the Evaluation.
    public func getEvaluation(_ input: GetEvaluationInput) throws -> EventLoopFuture<GetEvaluationOutput> {
    ...
    public func getDataSource(_ input: GetDataSourceInput) throws -> EventLoopFuture<GetDataSourceOutput> {
        return try client.send(operation: "GetDataSource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of MLModel that match the search criteria in the request.
    public func describeMLModels(_ input: DescribeMLModelsInput) throws -> EventLoopFuture<DescribeMLModelsOutput> {
    ...
    public func predict(_ input: PredictInput) throws -> EventLoopFuture<PredictOutput> {
        return try client.send(operation: "Predict", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a real time endpoint of an MLModel.
    public func deleteRealtimeEndpoint(_ input: DeleteRealtimeEndpointInput) throws -> EventLoopFuture<DeleteRealtimeEndpointOutput> {
