...
public struct IoTDataPlane: AWSService {
    ...
    /// return new `IoTDataPlane` with new timeout value
    ...
    /// return new `IoTDataPlane` logging to specified Logger
    ...
    public func deleteThingShadow(_ input: DeleteThingShadowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteThingShadowResponse> {
        return client.execute(operation: "DeleteThingShadow", path: "/things/{thingName}/shadow", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getThingShadow(_ input: GetThingShadowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetThingShadowResponse> {
        return client.execute(operation: "GetThingShadow", path: "/things/{thingName}/shadow", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listNamedShadowsForThing(_ input: ListNamedShadowsForThingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListNamedShadowsForThingResponse> {
        return client.execute(operation: "ListNamedShadowsForThing", path: "/api/things/shadow/ListNamedShadowsForThing/{thingName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func publish(_ input: PublishRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "Publish", path: "/topics/{topic}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateThingShadow(_ input: UpdateThingShadowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateThingShadowResponse> {
        return client.execute(operation: "UpdateThingShadow", path: "/things/{thingName}/shadow", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
