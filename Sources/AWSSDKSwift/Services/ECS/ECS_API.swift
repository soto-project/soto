...
public struct ECS: AWSService {
    ...
    /// return new `ECS` with new timeout value
    ...
    /// return new `ECS` logging to specified Logger
    ...
    public func createCapacityProvider(_ input: CreateCapacityProviderRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCapacityProviderResponse> {
        return client.execute(operation: "CreateCapacityProvider", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createTaskSet(_ input: CreateTaskSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTaskSetResponse> {
        return client.execute(operation: "CreateTaskSet", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Disables an account setting for a specified IAM user, IAM role, or the root user for an account.
    public func deleteAccountSetting(_ input: DeleteAccountSettingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteAccountSettingResponse> {
        return client.execute(operation: "DeleteAccountSetting", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes one or more custom attributes from an Amazon ECS resource.
    public func deleteAttributes(_ input: DeleteAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteAttributesResponse> {
    ...
    public func deleteCapacityProvider(_ input: DeleteCapacityProviderRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCapacityProviderResponse> {
        return client.execute(operation: "DeleteCapacityProvider", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteTaskSet(_ input: DeleteTaskSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTaskSetResponse> {
        return client.execute(operation: "DeleteTaskSet", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deregisterContainerInstance(_ input: DeregisterContainerInstanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterContainerInstanceResponse> {
        return client.execute(operation: "DeregisterContainerInstance", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deregisterTaskDefinition(_ input: DeregisterTaskDefinitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterTaskDefinitionResponse> {
        return client.execute(operation: "DeregisterTaskDefinition", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes one or more of your capacity providers.
    public func describeCapacityProviders(_ input: DescribeCapacityProvidersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCapacityProvidersResponse> {
        return client.execute(operation: "DescribeCapacityProviders", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeContainerInstances(_ input: DescribeContainerInstancesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContainerInstancesResponse> {
        return client.execute(operation: "DescribeContainerInstances", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeTaskDefinition(_ input: DescribeTaskDefinitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTaskDefinitionResponse> {
        return client.execute(operation: "DescribeTaskDefinition", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes the task sets in the specified cluster and service. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func describeTaskSets(_ input: DescribeTaskSetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTaskSetsResponse> {
        return client.execute(operation: "DescribeTaskSets", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes a specified task or tasks.
    public func describeTasks(_ input: DescribeTasksRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTasksResponse> {
        return client.execute(operation: "DescribeTasks", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func discoverPollEndpoint(_ input: DiscoverPollEndpointRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DiscoverPollEndpointResponse> {
        return client.execute(operation: "DiscoverPollEndpoint", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the account settings for a specified principal.
    public func listAccountSettings(_ input: ListAccountSettingsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAccountSettingsResponse> {
        return client.execute(operation: "ListAccountSettings", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the attributes for Amazon ECS resources within a specified target type and cluster. When you specify a target type and cluster, ListAttributes returns a list of attribute objects, one for each attribute on each resource. You can filter the list of results to a single attribute name to only return results that have that name. You can also filter the results by attribute name and value, for example, to see which container instances in a cluster are running a Linux AMI (ecs.os-type=linux). 
    public func listAttributes(_ input: ListAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAttributesResponse> {
        return client.execute(operation: "ListAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listContainerInstances(_ input: ListContainerInstancesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListContainerInstancesResponse> {
        return client.execute(operation: "ListContainerInstances", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTaskDefinitionFamilies(_ input: ListTaskDefinitionFamiliesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTaskDefinitionFamiliesResponse> {
        return client.execute(operation: "ListTaskDefinitionFamilies", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Returns a list of task definitions that are registered to your account. You can filter the results by family name with the familyPrefix parameter or by status with the status parameter.
    public func listTaskDefinitions(_ input: ListTaskDefinitionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTaskDefinitionsResponse> {
        return client.execute(operation: "ListTaskDefinitions", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTasks(_ input: ListTasksRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTasksResponse> {
        return client.execute(operation: "ListTasks", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putAccountSetting(_ input: PutAccountSettingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAccountSettingResponse> {
        return client.execute(operation: "PutAccountSetting", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Modifies an account setting for all IAM users on an account for whom no individual account setting has been specified. Account settings are set on a per-Region basis.
    public func putAccountSettingDefault(_ input: PutAccountSettingDefaultRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAccountSettingDefaultResponse> {
        return client.execute(operation: "PutAccountSettingDefault", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Create or update an attribute on an Amazon ECS resource. If the attribute does not exist, it is created. If the attribute exists, its value is replaced with the specified value. To delete an attribute, use DeleteAttributes. For more information, see Attributes in the Amazon Elastic Container Service Developer Guide.
    public func putAttributes(_ input: PutAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAttributesResponse> {
    ...
    public func putClusterCapacityProviders(_ input: PutClusterCapacityProvidersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutClusterCapacityProvidersResponse> {
        return client.execute(operation: "PutClusterCapacityProviders", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func registerContainerInstance(_ input: RegisterContainerInstanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterContainerInstanceResponse> {
        return client.execute(operation: "RegisterContainerInstance", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func registerTaskDefinition(_ input: RegisterTaskDefinitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterTaskDefinitionResponse> {
        return client.execute(operation: "RegisterTaskDefinition", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func runTask(_ input: RunTaskRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RunTaskResponse> {
        return client.execute(operation: "RunTask", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startTask(_ input: StartTaskRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartTaskResponse> {
        return client.execute(operation: "StartTask", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func stopTask(_ input: StopTaskRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopTaskResponse> {
        return client.execute(operation: "StopTask", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func submitAttachmentStateChanges(_ input: SubmitAttachmentStateChangesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitAttachmentStateChangesResponse> {
        return client.execute(operation: "SubmitAttachmentStateChanges", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func submitContainerStateChange(_ input: SubmitContainerStateChangeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitContainerStateChangeResponse> {
        return client.execute(operation: "SubmitContainerStateChange", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func submitTaskStateChange(_ input: SubmitTaskStateChangeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitTaskStateChangeResponse> {
        return client.execute(operation: "SubmitTaskStateChange", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateClusterSettings(_ input: UpdateClusterSettingsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateClusterSettingsResponse> {
        return client.execute(operation: "UpdateClusterSettings", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateContainerAgent(_ input: UpdateContainerAgentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContainerAgentResponse> {
        return client.execute(operation: "UpdateContainerAgent", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateContainerInstancesState(_ input: UpdateContainerInstancesStateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContainerInstancesStateResponse> {
        return client.execute(operation: "UpdateContainerInstancesState", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateServicePrimaryTaskSet(_ input: UpdateServicePrimaryTaskSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServicePrimaryTaskSetResponse> {
        return client.execute(operation: "UpdateServicePrimaryTaskSet", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Modifies a task set. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func updateTaskSet(_ input: UpdateTaskSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTaskSetResponse> {
        return client.execute(operation: "UpdateTaskSet", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
