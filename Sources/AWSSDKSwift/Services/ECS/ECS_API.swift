...
public struct ECS {
    ...
    public func deleteAccountSetting(_ input: DeleteAccountSettingRequest) throws -> DeleteAccountSettingResponse {
    ...
    public func listAccountSettings(_ input: ListAccountSettingsRequest) throws -> ListAccountSettingsResponse {
    ...
    public func putAccountSetting(_ input: PutAccountSettingRequest) throws -> PutAccountSettingResponse {
