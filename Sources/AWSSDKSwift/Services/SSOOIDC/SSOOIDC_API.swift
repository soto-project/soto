...
public struct SSOOIDC: AWSService {
    ...
    /// return new `SSOOIDC` with new timeout value
    ...
    /// return new `SSOOIDC` logging to specified Logger
    ...
    public func createToken(_ input: CreateTokenRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTokenResponse> {
        return client.execute(operation: "CreateToken", path: "/token", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func registerClient(_ input: RegisterClientRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterClientResponse> {
        return client.execute(operation: "RegisterClient", path: "/client/register", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startDeviceAuthorization(_ input: StartDeviceAuthorizationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDeviceAuthorizationResponse> {
        return client.execute(operation: "StartDeviceAuthorization", path: "/device_authorization", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
