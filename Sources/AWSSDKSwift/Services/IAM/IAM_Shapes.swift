...
extension IAM {
    ...
    public struct ListEntitiesForPolicyResponse: AWSShape {
        ...
        public init(isTruncated: Bool? = nil, policyGroups: [PolicyGroup]? = nil, policyRoles: [PolicyRole]? = nil, policyUsers: [PolicyUser]? = nil, marker: String? = nil) {
            self.isTruncated = isTruncated
    ...
    public struct ListSigningCertificatesRequest: AWSShape {
        ...
        public init(userName: String? = nil, maxItems: Int32? = nil, marker: String? = nil) {
            self.userName = userName
            self.maxItems = maxItems
            self.marker = marker
        }
    ...
    public struct EvaluationResult: AWSShape {
        ...
        public init(evalDecisionDetails: [String: PolicyEvaluationDecisionType]? = nil, missingContextValues: [String]? = nil, evalDecision: PolicyEvaluationDecisionType, evalActionName: String, resourceSpecificResults: [ResourceSpecificResult]? = nil, organizationsDecisionDetail: OrganizationsDecisionDetail? = nil, evalResourceName: String? = nil, matchedStatements: [Statement]? = nil) {
    ...
    public struct CreateOpenIDConnectProviderRequest: AWSShape {
        ...
        public init(thumbprintList: [String], clientIDList: [String]? = nil, url: String) {
    ...
    public struct UpdateGroupRequest: AWSShape {
        ...
        public init(newGroupName: String? = nil, groupName: String, newPath: String? = nil) {
    ...
    public struct Group: AWSShape {
        ...
        public init(groupName: String, createDate: TimeStamp, path: String, arn: String, groupId: String) {
            self.groupName = groupName
            self.createDate = createDate
            self.path = path
            self.arn = arn
    ...
    public struct UserDetail: AWSShape {
        ...
        public init(tags: [Tag]? = nil, groupList: [String]? = nil, arn: String? = nil, userPolicyList: [PolicyDetail]? = nil, userName: String? = nil, attachedManagedPolicies: [AttachedPolicy]? = nil, path: String? = nil, userId: String? = nil, createDate: TimeStamp? = nil, permissionsBoundary: AttachedPermissionsBoundary? = nil) {
            self.tags = tags
    ...
    public struct UpdateAccountPasswordPolicyRequest: AWSShape {
        ...
        public init(requireUppercaseCharacters: Bool? = nil, requireSymbols: Bool? = nil, passwordReusePrevention: Int32? = nil, requireLowercaseCharacters: Bool? = nil, requireNumbers: Bool? = nil, minimumPasswordLength: Int32? = nil, allowUsersToChangePassword: Bool? = nil, maxPasswordAge: Int32? = nil, hardExpiry: Bool? = nil) {
    ...
    public struct ListAttachedUserPoliciesResponse: AWSShape {
        ...
        public init(marker: String? = nil, attachedPolicies: [AttachedPolicy]? = nil, isTruncated: Bool? = nil) {
            self.marker = marker
    ...
    public struct PutGroupPolicyRequest: AWSShape {
        ...
        public init(policyName: String, groupName: String, policyDocument: String) {
            self.policyName = policyName
            self.groupName = groupName
            self.policyDocument = policyDocument
        }
    ...
    public struct ListInstanceProfilesForRoleRequest: AWSShape {
        ...
        public init(roleName: String, marker: String? = nil, maxItems: Int32? = nil) {
            self.roleName = roleName
            self.marker = marker
            self.maxItems = maxItems
        }
    ...
    public struct GetOpenIDConnectProviderResponse: AWSShape {
        ...
        public init(url: String? = nil, createDate: TimeStamp? = nil, clientIDList: [String]? = nil, thumbprintList: [String]? = nil) {
            self.url = url
            self.createDate = createDate
            self.clientIDList = clientIDList
            self.thumbprintList = thumbprintList
    ...
    public struct EnableMFADeviceRequest: AWSShape {
        ...
        public init(userName: String, authenticationCode2: String, authenticationCode1: String, serialNumber: String) {
            self.userName = userName
            self.authenticationCode2 = authenticationCode2
            self.authenticationCode1 = authenticationCode1
            self.serialNumber = serialNumber
    ...
    public struct CreateRoleRequest: AWSShape {
        ...
        public init(description: String? = nil, roleName: String, path: String? = nil, permissionsBoundary: String? = nil, maxSessionDuration: Int32? = nil, tags: [Tag]? = nil, assumeRolePolicyDocument: String) {
            self.description = description
            self.roleName = roleName
            self.path = path
            self.permissionsBoundary = permissionsBoundary
    ...
    public struct ServerCertificate: AWSShape {
        ...
        public init(serverCertificateMetadata: ServerCertificateMetadata, certificateBody: String, certificateChain: String? = nil) {
    ...
    public struct ListPoliciesRequest: AWSShape {
        ...
        public init(policyUsageFilter: PolicyUsageType? = nil, marker: String? = nil, scope: PolicyScopeType? = nil, pathPrefix: String? = nil, onlyAttached: Bool? = nil, maxItems: Int32? = nil) {
    ...
    public struct GetSAMLProviderResponse: AWSShape {
        ...
        public init(sAMLMetadataDocument: String? = nil, createDate: TimeStamp? = nil, validUntil: TimeStamp? = nil) {
    ...
    public struct GetGroupPolicyResponse: AWSShape {
        ...
        public init(policyDocument: String, groupName: String, policyName: String) {
            self.policyDocument = policyDocument
            self.groupName = groupName
            self.policyName = policyName
        }
    ...
    public struct ServiceSpecificCredentialMetadata: AWSShape {
        ...
        public init(serviceUserName: String, userName: String, serviceSpecificCredentialId: String, serviceName: String, createDate: TimeStamp, status: StatusType) {
    ...
    public struct ResourceSpecificResult: AWSShape {
        ...
        public init(missingContextValues: [String]? = nil, evalResourceName: String, evalDecisionDetails: [String: PolicyEvaluationDecisionType]? = nil, evalResourceDecision: PolicyEvaluationDecisionType, matchedStatements: [Statement]? = nil) {
            self.missingContextValues = missingContextValues
            self.evalResourceName = evalResourceName
            self.evalDecisionDetails = evalDecisionDetails
    ...
    public struct GetAccountAuthorizationDetailsRequest: AWSShape {
        ...
        public init(marker: String? = nil, filter: [EntityType]? = nil, maxItems: Int32? = nil) {
            self.marker = marker
            self.filter = filter
            self.maxItems = maxItems
        }
    ...
    public struct SimulateCustomPolicyRequest: AWSShape {
        ...
        public init(resourcePolicy: String? = nil, maxItems: Int32? = nil, policyInputList: [String], callerArn: String? = nil, resourceOwner: String? = nil, resourceArns: [String]? = nil, marker: String? = nil, actionNames: [String], contextEntries: [ContextEntry]? = nil, resourceHandlingOption: String? = nil) {
    ...
    public struct ManagedPolicyDetail: AWSShape {
        ...
        public init(updateDate: TimeStamp? = nil, policyId: String? = nil, path: String? = nil, attachmentCount: Int32? = nil, defaultVersionId: String? = nil, policyName: String? = nil, policyVersionList: [PolicyVersion]? = nil, permissionsBoundaryUsageCount: Int32? = nil, createDate: TimeStamp? = nil, isAttachable: Bool? = nil, arn: String? = nil, description: String? = nil) {
    ...
    public struct PutUserPolicyRequest: AWSShape {
        ...
        public init(policyName: String, policyDocument: String, userName: String) {
            self.policyName = policyName
            self.policyDocument = policyDocument
            self.userName = userName
        }
    ...
    public struct Policy: AWSShape {
        ...
        public init(updateDate: TimeStamp? = nil, attachmentCount: Int32? = nil, path: String? = nil, description: String? = nil, permissionsBoundaryUsageCount: Int32? = nil, defaultVersionId: String? = nil, isAttachable: Bool? = nil, createDate: TimeStamp? = nil, policyName: String? = nil, arn: String? = nil, policyId: String? = nil) {
            self.updateDate = updateDate
            self.attachmentCount = attachmentCount
            self.path = path
            self.description = description
    ...
    public struct SSHPublicKey: AWSShape {
        ...
        public init(fingerprint: String, userName: String, status: StatusType, sSHPublicKeyBody: String, uploadDate: TimeStamp? = nil, sSHPublicKeyId: String) {
    ...
    public struct VirtualMFADevice: AWSShape {
        ...
        public init(base32StringSeed: Data? = nil, user: User? = nil, enableDate: TimeStamp? = nil, qRCodePNG: Data? = nil, serialNumber: String) {
    ...
    public struct InstanceProfile: AWSShape {
        ...
        public init(path: String, createDate: TimeStamp, arn: String, instanceProfileName: String, instanceProfileId: String, roles: [Role]) {
            self.path = path
            self.createDate = createDate
            self.arn = arn
    ...
    public struct User: AWSShape {
        ...
        public init(permissionsBoundary: AttachedPermissionsBoundary? = nil, path: String, tags: [Tag]? = nil, createDate: TimeStamp, userName: String, arn: String, passwordLastUsed: TimeStamp? = nil, userId: String) {
            self.permissionsBoundary = permissionsBoundary
            self.path = path
            self.tags = tags
            self.createDate = createDate
    ...
    public struct Role: AWSShape {
        ...
        public init(roleId: String, permissionsBoundary: AttachedPermissionsBoundary? = nil, path: String, description: String? = nil, createDate: TimeStamp, tags: [Tag]? = nil, assumeRolePolicyDocument: String? = nil, maxSessionDuration: Int32? = nil, roleName: String, arn: String) {
            self.roleId = roleId
            self.permissionsBoundary = permissionsBoundary
            self.path = path
            self.description = description
    ...
    public struct AccessKeyLastUsed: AWSShape {
        ...
        public init(serviceName: String, region: String, lastUsedDate: TimeStamp) {
            self.serviceName = serviceName
            self.region = region
    ...
    public struct SimulatePrincipalPolicyRequest: AWSShape {
        ...
        public init(callerArn: String? = nil, actionNames: [String], resourceOwner: String? = nil, resourceArns: [String]? = nil, marker: String? = nil, resourcePolicy: String? = nil, resourceHandlingOption: String? = nil, contextEntries: [ContextEntry]? = nil, maxItems: Int32? = nil, policySourceArn: String, policyInputList: [String]? = nil) {
            self.callerArn = callerArn
            self.actionNames = actionNames
            self.resourceOwner = resourceOwner
            self.resourceArns = resourceArns
    ...
    public struct GroupDetail: AWSShape {
        ...
        public init(arn: String? = nil, groupId: String? = nil, groupName: String? = nil, groupPolicyList: [PolicyDetail]? = nil, createDate: TimeStamp? = nil, path: String? = nil, attachedManagedPolicies: [AttachedPolicy]? = nil) {
            self.arn = arn
            self.groupId = groupId
            self.groupName = groupName
    ...
    public struct ListAttachedGroupPoliciesResponse: AWSShape {
        ...
        public init(attachedPolicies: [AttachedPolicy]? = nil, marker: String? = nil, isTruncated: Bool? = nil) {
            self.attachedPolicies = attachedPolicies
            self.marker = marker
            self.isTruncated = isTruncated
        }
    ...
    public struct UploadServerCertificateRequest: AWSShape {
        ...
        public init(serverCertificateName: String, path: String? = nil, privateKey: String, certificateBody: String, certificateChain: String? = nil) {
            self.serverCertificateName = serverCertificateName
            self.path = path
    ...
    public struct AccessKey: AWSShape {
        ...
        public init(accessKeyId: String, status: StatusType, createDate: TimeStamp? = nil, secretAccessKey: String, userName: String) {
            self.accessKeyId = accessKeyId
            self.status = status
            self.createDate = createDate
    ...
    public struct ListServerCertificatesRequest: AWSShape {
        ...
        public init(maxItems: Int32? = nil, pathPrefix: String? = nil, marker: String? = nil) {
            self.maxItems = maxItems
            self.pathPrefix = pathPrefix
            self.marker = marker
        }
    ...
    public struct UpdateSigningCertificateRequest: AWSShape {
        ...
        public init(status: StatusType, userName: String? = nil, certificateId: String) {
            self.status = status
            self.userName = userName
            self.certificateId = certificateId
        }
    ...
    public struct CreateUserRequest: AWSShape {
        ...
        public init(path: String? = nil, userName: String, permissionsBoundary: String? = nil, tags: [Tag]? = nil) {
            self.path = path
            self.userName = userName
            self.permissionsBoundary = permissionsBoundary
            self.tags = tags
    ...
    public struct ListInstanceProfilesForRoleResponse: AWSShape {
        ...
        public init(instanceProfiles: [InstanceProfile], marker: String? = nil, isTruncated: Bool? = nil) {
            self.instanceProfiles = instanceProfiles
            self.marker = marker
            self.isTruncated = isTruncated
        }
    ...
    public struct ListInstanceProfilesRequest: AWSShape {
        ...
        public init(pathPrefix: String? = nil, marker: String? = nil, maxItems: Int32? = nil) {
            self.pathPrefix = pathPrefix
            self.marker = marker
            self.maxItems = maxItems
        }
    ...
    public struct ListRolesResponse: AWSShape {
        ...
        public init(roles: [Role], isTruncated: Bool? = nil, marker: String? = nil) {
            self.roles = roles
            self.isTruncated = isTruncated
            self.marker = marker
        }
    ...
    public struct SSHPublicKeyMetadata: AWSShape {
        ...
        public init(status: StatusType, userName: String, sSHPublicKeyId: String, uploadDate: TimeStamp) {
            self.status = status
            self.userName = userName
            self.sSHPublicKeyId = sSHPublicKeyId
            self.uploadDate = uploadDate
    ...
    public struct GetAccountAuthorizationDetailsResponse: AWSShape {
        ...
        public init(roleDetailList: [RoleDetail]? = nil, isTruncated: Bool? = nil, groupDetailList: [GroupDetail]? = nil, policies: [ManagedPolicyDetail]? = nil, userDetailList: [UserDetail]? = nil, marker: String? = nil) {
    ...
    public struct AccessKeyMetadata: AWSShape {
        ...
        public init(accessKeyId: String? = nil, userName: String? = nil, createDate: TimeStamp? = nil, status: StatusType? = nil) {
            self.accessKeyId = accessKeyId
            self.userName = userName
            self.createDate = createDate
            self.status = status
    ...
    public struct ServiceSpecificCredential: AWSShape {
        ...
        public init(status: StatusType, userName: String, serviceUserName: String, createDate: TimeStamp, servicePassword: String, serviceSpecificCredentialId: String, serviceName: String) {
            self.status = status
            self.userName = userName
            self.serviceUserName = serviceUserName
            self.createDate = createDate
    ...
    public struct RoleDetail: AWSShape {
        ...
        public init(roleId: String? = nil, roleName: String? = nil, rolePolicyList: [PolicyDetail]? = nil, path: String? = nil, permissionsBoundary: AttachedPermissionsBoundary? = nil, tags: [Tag]? = nil, instanceProfileList: [InstanceProfile]? = nil, assumeRolePolicyDocument: String? = nil, arn: String? = nil, attachedManagedPolicies: [AttachedPolicy]? = nil, createDate: TimeStamp? = nil) {
            self.roleId = roleId
            self.roleName = roleName
    ...
    public struct GetGroupResponse: AWSShape {
        ...
        public init(group: Group, marker: String? = nil, isTruncated: Bool? = nil, users: [User]) {
            self.group = group
            self.marker = marker
            self.isTruncated = isTruncated
            self.users = users
    ...
    public struct Statement: AWSShape {
        ...
        public init(startPosition: Position? = nil, sourcePolicyId: String? = nil, endPosition: Position? = nil, sourcePolicyType: PolicySourceType? = nil) {
    ...
    public struct ListUserPoliciesResponse: AWSShape {
        ...
        public init(isTruncated: Bool? = nil, policyNames: [String], marker: String? = nil) {
            self.isTruncated = isTruncated
            self.policyNames = policyNames
            self.marker = marker
        }
    ...
    public struct CreatePolicyRequest: AWSShape {
        ...
        public init(policyName: String, description: String? = nil, path: String? = nil, policyDocument: String) {
            self.policyName = policyName
            self.description = description
            self.path = path
            self.policyDocument = policyDocument
    ...
    public struct PolicyVersion: AWSShape {
        ...
        public init(versionId: String? = nil, createDate: TimeStamp? = nil, document: String? = nil, isDefaultVersion: Bool? = nil) {
            self.versionId = versionId
            self.createDate = createDate
    ...
    public struct ListRoleTagsResponse: AWSShape {
        ...
        public init(marker: String? = nil, isTruncated: Bool? = nil, tags: [Tag]) {
            self.marker = marker
            self.isTruncated = isTruncated
            self.tags = tags
        }
    ...
    public struct GetCredentialReportResponse: AWSShape {
        ...
        public init(generatedTime: TimeStamp? = nil, content: Data? = nil, reportFormat: ReportFormatType? = nil) {
    ...
    public struct ListAttachedRolePoliciesRequest: AWSShape {
        ...
        public init(marker: String? = nil, roleName: String, maxItems: Int32? = nil, pathPrefix: String? = nil) {
            self.marker = marker
            self.roleName = roleName
            self.maxItems = maxItems
            self.pathPrefix = pathPrefix
    ...
    public struct PasswordPolicy: AWSShape {
        ...
        public init(passwordReusePrevention: Int32? = nil, requireSymbols: Bool? = nil, allowUsersToChangePassword: Bool? = nil, maxPasswordAge: Int32? = nil, expirePasswords: Bool? = nil, minimumPasswordLength: Int32? = nil, requireNumbers: Bool? = nil, requireUppercaseCharacters: Bool? = nil, requireLowercaseCharacters: Bool? = nil, hardExpiry: Bool? = nil) {
            self.passwordReusePrevention = passwordReusePrevention
            self.requireSymbols = requireSymbols
            self.allowUsersToChangePassword = allowUsersToChangePassword
            self.maxPasswordAge = maxPasswordAge
    ...
    public struct ServerCertificateMetadata: AWSShape {
        ...
        public init(uploadDate: TimeStamp? = nil, serverCertificateName: String, arn: String, expiration: TimeStamp? = nil, serverCertificateId: String, path: String) {
            self.uploadDate = uploadDate
            self.serverCertificateName = serverCertificateName
            self.arn = arn
    ...
    public struct ListEntitiesForPolicyRequest: AWSShape {
        ...
        public init(maxItems: Int32? = nil, policyArn: String, policyUsageFilter: PolicyUsageType? = nil, entityFilter: EntityType? = nil, marker: String? = nil, pathPrefix: String? = nil) {
            self.maxItems = maxItems
            self.policyArn = policyArn
            self.policyUsageFilter = policyUsageFilter
    ...
    public struct UpdateServerCertificateRequest: AWSShape {
        ...
        public init(serverCertificateName: String, newServerCertificateName: String? = nil, newPath: String? = nil) {
            self.serverCertificateName = serverCertificateName
    ...
    public struct ListServerCertificatesResponse: AWSShape {
        ...
        public init(serverCertificateMetadataList: [ServerCertificateMetadata], isTruncated: Bool? = nil, marker: String? = nil) {
    ...
    public struct GetGroupRequest: AWSShape {
        ...
        public init(groupName: String, maxItems: Int32? = nil, marker: String? = nil) {
            self.groupName = groupName
            self.maxItems = maxItems
            self.marker = marker
        }
