...
public struct EKS: AWSService {
    ...
    /// return new `EKS` with new timeout value
    ...
    /// return new `EKS` logging to specified Logger
    ...
    public func createCluster(_ input: CreateClusterRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateClusterResponse> {
        return client.execute(operation: "CreateCluster", path: "/clusters", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createFargateProfile(_ input: CreateFargateProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFargateProfileResponse> {
        return client.execute(operation: "CreateFargateProfile", path: "/clusters/{name}/fargate-profiles", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createNodegroup(_ input: CreateNodegroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateNodegroupResponse> {
        return client.execute(operation: "CreateNodegroup", path: "/clusters/{name}/node-groups", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteCluster(_ input: DeleteClusterRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteClusterResponse> {
        return client.execute(operation: "DeleteCluster", path: "/clusters/{name}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteFargateProfile(_ input: DeleteFargateProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFargateProfileResponse> {
        return client.execute(operation: "DeleteFargateProfile", path: "/clusters/{name}/fargate-profiles/{fargateProfileName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteNodegroup(_ input: DeleteNodegroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteNodegroupResponse> {
        return client.execute(operation: "DeleteNodegroup", path: "/clusters/{name}/node-groups/{nodegroupName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeCluster(_ input: DescribeClusterRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeClusterResponse> {
        return client.execute(operation: "DescribeCluster", path: "/clusters/{name}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeFargateProfile(_ input: DescribeFargateProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFargateProfileResponse> {
        return client.execute(operation: "DescribeFargateProfile", path: "/clusters/{name}/fargate-profiles/{fargateProfileName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeNodegroup(_ input: DescribeNodegroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeNodegroupResponse> {
        return client.execute(operation: "DescribeNodegroup", path: "/clusters/{name}/node-groups/{nodegroupName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeUpdate(_ input: DescribeUpdateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeUpdateResponse> {
        return client.execute(operation: "DescribeUpdate", path: "/clusters/{name}/updates/{updateId}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listClusters(_ input: ListClustersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListClustersResponse> {
        return client.execute(operation: "ListClusters", path: "/clusters", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listFargateProfiles(_ input: ListFargateProfilesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListFargateProfilesResponse> {
        return client.execute(operation: "ListFargateProfiles", path: "/clusters/{name}/fargate-profiles", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listNodegroups(_ input: ListNodegroupsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListNodegroupsResponse> {
        return client.execute(operation: "ListNodegroups", path: "/clusters/{name}/node-groups", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listUpdates(_ input: ListUpdatesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListUpdatesResponse> {
        return client.execute(operation: "ListUpdates", path: "/clusters/{name}/updates", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateClusterConfig(_ input: UpdateClusterConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateClusterConfigResponse> {
        return client.execute(operation: "UpdateClusterConfig", path: "/clusters/{name}/update-config", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateClusterVersion(_ input: UpdateClusterVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateClusterVersionResponse> {
        return client.execute(operation: "UpdateClusterVersion", path: "/clusters/{name}/updates", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateNodegroupConfig(_ input: UpdateNodegroupConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateNodegroupConfigResponse> {
        return client.execute(operation: "UpdateNodegroupConfig", path: "/clusters/{name}/node-groups/{nodegroupName}/update-config", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateNodegroupVersion(_ input: UpdateNodegroupVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateNodegroupVersionResponse> {
        return client.execute(operation: "UpdateNodegroupVersion", path: "/clusters/{name}/node-groups/{nodegroupName}/update-version", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
