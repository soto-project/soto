...
public struct EKS: AWSService {
    ...
    public func createCluster(_ input: CreateClusterRequest) -> EventLoopFuture<CreateClusterResponse> {
        return client.execute(operation: "CreateCluster", path: "/clusters", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createFargateProfile(_ input: CreateFargateProfileRequest) -> EventLoopFuture<CreateFargateProfileResponse> {
        return client.execute(operation: "CreateFargateProfile", path: "/clusters/{name}/fargate-profiles", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createNodegroup(_ input: CreateNodegroupRequest) -> EventLoopFuture<CreateNodegroupResponse> {
        return client.execute(operation: "CreateNodegroup", path: "/clusters/{name}/node-groups", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteCluster(_ input: DeleteClusterRequest) -> EventLoopFuture<DeleteClusterResponse> {
        return client.execute(operation: "DeleteCluster", path: "/clusters/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteFargateProfile(_ input: DeleteFargateProfileRequest) -> EventLoopFuture<DeleteFargateProfileResponse> {
        return client.execute(operation: "DeleteFargateProfile", path: "/clusters/{name}/fargate-profiles/{fargateProfileName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Deletes an Amazon EKS node group for a cluster.
    public func deleteNodegroup(_ input: DeleteNodegroupRequest) -> EventLoopFuture<DeleteNodegroupResponse> {
        return client.execute(operation: "DeleteNodegroup", path: "/clusters/{name}/node-groups/{nodegroupName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeCluster(_ input: DescribeClusterRequest) -> EventLoopFuture<DescribeClusterResponse> {
        return client.execute(operation: "DescribeCluster", path: "/clusters/{name}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeFargateProfile(_ input: DescribeFargateProfileRequest) -> EventLoopFuture<DescribeFargateProfileResponse> {
        return client.execute(operation: "DescribeFargateProfile", path: "/clusters/{name}/fargate-profiles/{fargateProfileName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Returns descriptive information about an Amazon EKS node group.
    public func describeNodegroup(_ input: DescribeNodegroupRequest) -> EventLoopFuture<DescribeNodegroupResponse> {
        return client.execute(operation: "DescribeNodegroup", path: "/clusters/{name}/node-groups/{nodegroupName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeUpdate(_ input: DescribeUpdateRequest) -> EventLoopFuture<DescribeUpdateResponse> {
        return client.execute(operation: "DescribeUpdate", path: "/clusters/{name}/updates/{updateId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Lists the Amazon EKS clusters in your AWS account in the specified Region.
    public func listClusters(_ input: ListClustersRequest) -> EventLoopFuture<ListClustersResponse> {
        return client.execute(operation: "ListClusters", path: "/clusters", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listFargateProfiles(_ input: ListFargateProfilesRequest) -> EventLoopFuture<ListFargateProfilesResponse> {
        return client.execute(operation: "ListFargateProfiles", path: "/clusters/{name}/fargate-profiles", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listNodegroups(_ input: ListNodegroupsRequest) -> EventLoopFuture<ListNodegroupsResponse> {
        return client.execute(operation: "ListNodegroups", path: "/clusters/{name}/node-groups", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listUpdates(_ input: ListUpdatesRequest) -> EventLoopFuture<ListUpdatesResponse> {
        return client.execute(operation: "ListUpdates", path: "/clusters/{name}/updates", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateClusterConfig(_ input: UpdateClusterConfigRequest) -> EventLoopFuture<UpdateClusterConfigResponse> {
        return client.execute(operation: "UpdateClusterConfig", path: "/clusters/{name}/update-config", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateClusterVersion(_ input: UpdateClusterVersionRequest) -> EventLoopFuture<UpdateClusterVersionResponse> {
        return client.execute(operation: "UpdateClusterVersion", path: "/clusters/{name}/updates", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateNodegroupConfig(_ input: UpdateNodegroupConfigRequest) -> EventLoopFuture<UpdateNodegroupConfigResponse> {
        return client.execute(operation: "UpdateNodegroupConfig", path: "/clusters/{name}/node-groups/{nodegroupName}/update-config", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateNodegroupVersion(_ input: UpdateNodegroupVersionRequest) -> EventLoopFuture<UpdateNodegroupVersionResponse> {
        return client.execute(operation: "UpdateNodegroupVersion", path: "/clusters/{name}/node-groups/{nodegroupName}/update-version", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
