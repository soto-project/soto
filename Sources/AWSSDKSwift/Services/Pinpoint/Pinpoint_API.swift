...
public struct Pinpoint {
    ...
    public func deleteVoiceChannel(_ input: DeleteVoiceChannelRequest) throws -> DeleteVoiceChannelResponse {
    ...
    public func updateVoiceChannel(_ input: UpdateVoiceChannelRequest) throws -> UpdateVoiceChannelResponse {
    ...
    ///  Get a Voice Channel
    public func getVoiceChannel(_ input: GetVoiceChannelRequest) throws -> GetVoiceChannelResponse {
