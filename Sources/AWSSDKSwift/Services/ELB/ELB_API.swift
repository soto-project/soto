...
public struct ELB {
    ...
    public func applySecurityGroupsToLoadBalancer(_ input: ApplySecurityGroupsToLoadBalancerInput) throws -> Future<ApplySecurityGroupsToLoadBalancerOutput> {
    ...
    public func attachLoadBalancerToSubnets(_ input: AttachLoadBalancerToSubnetsInput) throws -> Future<AttachLoadBalancerToSubnetsOutput> {
    ...
    public func configureHealthCheck(_ input: ConfigureHealthCheckInput) throws -> Future<ConfigureHealthCheckOutput> {
    ...
    public func createAppCookieStickinessPolicy(_ input: CreateAppCookieStickinessPolicyInput) throws -> Future<CreateAppCookieStickinessPolicyOutput> {
    ...
    public func createLBCookieStickinessPolicy(_ input: CreateLBCookieStickinessPolicyInput) throws -> Future<CreateLBCookieStickinessPolicyOutput> {
    ...
    public func createLoadBalancer(_ input: CreateAccessPointInput) throws -> Future<CreateAccessPointOutput> {
    ...
    public func createLoadBalancerListeners(_ input: CreateLoadBalancerListenerInput) throws -> Future<CreateLoadBalancerListenerOutput> {
    ...
    public func createLoadBalancerPolicy(_ input: CreateLoadBalancerPolicyInput) throws -> Future<CreateLoadBalancerPolicyOutput> {
    ...
    public func deleteLoadBalancer(_ input: DeleteAccessPointInput) throws -> Future<DeleteAccessPointOutput> {
        return try client.send(operation: "DeleteLoadBalancer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified listeners from the specified load balancer.
    public func deleteLoadBalancerListeners(_ input: DeleteLoadBalancerListenerInput) throws -> Future<DeleteLoadBalancerListenerOutput> {
        return try client.send(operation: "DeleteLoadBalancerListeners", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified policy from the specified load balancer. This policy must not be enabled for any listeners.
    public func deleteLoadBalancerPolicy(_ input: DeleteLoadBalancerPolicyInput) throws -> Future<DeleteLoadBalancerPolicyOutput> {
    ...
    public func deregisterInstancesFromLoadBalancer(_ input: DeregisterEndPointsInput) throws -> Future<DeregisterEndPointsOutput> {
    ...
    public func describeInstanceHealth(_ input: DescribeEndPointStateInput) throws -> Future<DescribeEndPointStateOutput> {
    ...
    public func describeLoadBalancerPolicies(_ input: DescribeLoadBalancerPoliciesInput) throws -> Future<DescribeLoadBalancerPoliciesOutput> {
    ...
    public func describeLoadBalancerPolicyTypes(_ input: DescribeLoadBalancerPolicyTypesInput) throws -> Future<DescribeLoadBalancerPolicyTypesOutput> {
    ...
    public func describeLoadBalancers(_ input: DescribeAccessPointsInput) throws -> Future<DescribeAccessPointsOutput> {
    ...
    public func detachLoadBalancerFromSubnets(_ input: DetachLoadBalancerFromSubnetsInput) throws -> Future<DetachLoadBalancerFromSubnetsOutput> {
    ...
    public func disableAvailabilityZonesForLoadBalancer(_ input: RemoveAvailabilityZonesInput) throws -> Future<RemoveAvailabilityZonesOutput> {
    ...
    public func enableAvailabilityZonesForLoadBalancer(_ input: AddAvailabilityZonesInput) throws -> Future<AddAvailabilityZonesOutput> {
    ...
    public func registerInstancesWithLoadBalancer(_ input: RegisterEndPointsInput) throws -> Future<RegisterEndPointsOutput> {
    ...
    public func setLoadBalancerListenerSSLCertificate(_ input: SetLoadBalancerListenerSSLCertificateInput) throws -> Future<SetLoadBalancerListenerSSLCertificateOutput> {
    ...
    public func setLoadBalancerPoliciesForBackendServer(_ input: SetLoadBalancerPoliciesForBackendServerInput) throws -> Future<SetLoadBalancerPoliciesForBackendServerOutput> {
