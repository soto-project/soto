...
public struct ELB {
    ...
    public func createLoadBalancerListeners(_ input: CreateLoadBalancerListenerInput) throws -> EventLoopFuture<CreateLoadBalancerListenerOutput> {
    ...
    public func setLoadBalancerPoliciesForBackendServer(_ input: SetLoadBalancerPoliciesForBackendServerInput) throws -> EventLoopFuture<SetLoadBalancerPoliciesForBackendServerOutput> {
    ...
    public func attachLoadBalancerToSubnets(_ input: AttachLoadBalancerToSubnetsInput) throws -> EventLoopFuture<AttachLoadBalancerToSubnetsOutput> {
        return try client.send(operation: "AttachLoadBalancerToSubnets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the attributes for the specified load balancer.
    public func describeLoadBalancerAttributes(_ input: DescribeLoadBalancerAttributesInput) throws -> EventLoopFuture<DescribeLoadBalancerAttributesOutput> {
    ...
    public func detachLoadBalancerFromSubnets(_ input: DetachLoadBalancerFromSubnetsInput) throws -> EventLoopFuture<DetachLoadBalancerFromSubnetsOutput> {
    ...
    public func enableAvailabilityZonesForLoadBalancer(_ input: AddAvailabilityZonesInput) throws -> EventLoopFuture<AddAvailabilityZonesOutput> {
    ...
    public func describeLoadBalancerPolicyTypes(_ input: DescribeLoadBalancerPolicyTypesInput) throws -> EventLoopFuture<DescribeLoadBalancerPolicyTypesOutput> {
    ...
    public func setLoadBalancerListenerSSLCertificate(_ input: SetLoadBalancerListenerSSLCertificateInput) throws -> EventLoopFuture<SetLoadBalancerListenerSSLCertificateOutput> {
    ...
    public func createAppCookieStickinessPolicy(_ input: CreateAppCookieStickinessPolicyInput) throws -> EventLoopFuture<CreateAppCookieStickinessPolicyOutput> {
    ...
    public func createLoadBalancerPolicy(_ input: CreateLoadBalancerPolicyInput) throws -> EventLoopFuture<CreateLoadBalancerPolicyOutput> {
    ...
    public func configureHealthCheck(_ input: ConfigureHealthCheckInput) throws -> EventLoopFuture<ConfigureHealthCheckOutput> {
        return try client.send(operation: "ConfigureHealthCheck", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the tags associated with the specified load balancers.
    public func describeTags(_ input: DescribeTagsInput) throws -> EventLoopFuture<DescribeTagsOutput> {
    ...
    public func describeLoadBalancerPolicies(_ input: DescribeLoadBalancerPoliciesInput) throws -> EventLoopFuture<DescribeLoadBalancerPoliciesOutput> {
        return try client.send(operation: "DescribeLoadBalancerPolicies", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified policy from the specified load balancer. This policy must not be enabled for any listeners.
    public func deleteLoadBalancerPolicy(_ input: DeleteLoadBalancerPolicyInput) throws -> EventLoopFuture<DeleteLoadBalancerPolicyOutput> {
    ...
    public func applySecurityGroupsToLoadBalancer(_ input: ApplySecurityGroupsToLoadBalancerInput) throws -> EventLoopFuture<ApplySecurityGroupsToLoadBalancerOutput> {
    ...
    public func deregisterInstancesFromLoadBalancer(_ input: DeregisterEndPointsInput) throws -> EventLoopFuture<DeregisterEndPointsOutput> {
    ...
    public func describeInstanceHealth(_ input: DescribeEndPointStateInput) throws -> EventLoopFuture<DescribeEndPointStateOutput> {
    ...
    public func setLoadBalancerPoliciesOfListener(_ input: SetLoadBalancerPoliciesOfListenerInput) throws -> EventLoopFuture<SetLoadBalancerPoliciesOfListenerOutput> {
        return try client.send(operation: "SetLoadBalancerPoliciesOfListener", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified listeners from the specified load balancer.
    public func deleteLoadBalancerListeners(_ input: DeleteLoadBalancerListenerInput) throws -> EventLoopFuture<DeleteLoadBalancerListenerOutput> {
        return try client.send(operation: "DeleteLoadBalancerListeners", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified the load balancers. If no load balancers are specified, the call describes all of your load balancers.
    public func describeLoadBalancers(_ input: DescribeAccessPointsInput) throws -> EventLoopFuture<DescribeAccessPointsOutput> {
    ...
    public func deleteLoadBalancer(_ input: DeleteAccessPointInput) throws -> EventLoopFuture<DeleteAccessPointOutput> {
    ...
    public func modifyLoadBalancerAttributes(_ input: ModifyLoadBalancerAttributesInput) throws -> EventLoopFuture<ModifyLoadBalancerAttributesOutput> {
    ...
    public func registerInstancesWithLoadBalancer(_ input: RegisterEndPointsInput) throws -> EventLoopFuture<RegisterEndPointsOutput> {
    ...
    public func disableAvailabilityZonesForLoadBalancer(_ input: RemoveAvailabilityZonesInput) throws -> EventLoopFuture<RemoveAvailabilityZonesOutput> {
    ...
    public func createLBCookieStickinessPolicy(_ input: CreateLBCookieStickinessPolicyInput) throws -> EventLoopFuture<CreateLBCookieStickinessPolicyOutput> {
    ...
    public func createLoadBalancer(_ input: CreateAccessPointInput) throws -> EventLoopFuture<CreateAccessPointOutput> {
