...
public struct ELB: AWSService {
    ...
    public func applySecurityGroupsToLoadBalancer(_ input: ApplySecurityGroupsToLoadBalancerInput) -> EventLoopFuture<ApplySecurityGroupsToLoadBalancerOutput> {
        return client.execute(operation: "ApplySecurityGroupsToLoadBalancer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func attachLoadBalancerToSubnets(_ input: AttachLoadBalancerToSubnetsInput) -> EventLoopFuture<AttachLoadBalancerToSubnetsOutput> {
        return client.execute(operation: "AttachLoadBalancerToSubnets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func configureHealthCheck(_ input: ConfigureHealthCheckInput) -> EventLoopFuture<ConfigureHealthCheckOutput> {
        return client.execute(operation: "ConfigureHealthCheck", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createAppCookieStickinessPolicy(_ input: CreateAppCookieStickinessPolicyInput) -> EventLoopFuture<CreateAppCookieStickinessPolicyOutput> {
        return client.execute(operation: "CreateAppCookieStickinessPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createLBCookieStickinessPolicy(_ input: CreateLBCookieStickinessPolicyInput) -> EventLoopFuture<CreateLBCookieStickinessPolicyOutput> {
        return client.execute(operation: "CreateLBCookieStickinessPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createLoadBalancerListeners(_ input: CreateLoadBalancerListenerInput) -> EventLoopFuture<CreateLoadBalancerListenerOutput> {
        return client.execute(operation: "CreateLoadBalancerListeners", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createLoadBalancerPolicy(_ input: CreateLoadBalancerPolicyInput) -> EventLoopFuture<CreateLoadBalancerPolicyOutput> {
        return client.execute(operation: "CreateLoadBalancerPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteLoadBalancerListeners(_ input: DeleteLoadBalancerListenerInput) -> EventLoopFuture<DeleteLoadBalancerListenerOutput> {
        return client.execute(operation: "DeleteLoadBalancerListeners", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteLoadBalancerPolicy(_ input: DeleteLoadBalancerPolicyInput) -> EventLoopFuture<DeleteLoadBalancerPolicyOutput> {
        return client.execute(operation: "DeleteLoadBalancerPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deregisterInstancesFromLoadBalancer(_ input: DeregisterEndPointsInput) -> EventLoopFuture<DeregisterEndPointsOutput> {
        return client.execute(operation: "DeregisterInstancesFromLoadBalancer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeInstanceHealth(_ input: DescribeEndPointStateInput) -> EventLoopFuture<DescribeEndPointStateOutput> {
        return client.execute(operation: "DescribeInstanceHealth", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLoadBalancerAttributes(_ input: DescribeLoadBalancerAttributesInput) -> EventLoopFuture<DescribeLoadBalancerAttributesOutput> {
        return client.execute(operation: "DescribeLoadBalancerAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLoadBalancerPolicies(_ input: DescribeLoadBalancerPoliciesInput) -> EventLoopFuture<DescribeLoadBalancerPoliciesOutput> {
        return client.execute(operation: "DescribeLoadBalancerPolicies", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLoadBalancerPolicyTypes(_ input: DescribeLoadBalancerPolicyTypesInput) -> EventLoopFuture<DescribeLoadBalancerPolicyTypesOutput> {
        return client.execute(operation: "DescribeLoadBalancerPolicyTypes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detachLoadBalancerFromSubnets(_ input: DetachLoadBalancerFromSubnetsInput) -> EventLoopFuture<DetachLoadBalancerFromSubnetsOutput> {
        return client.execute(operation: "DetachLoadBalancerFromSubnets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disableAvailabilityZonesForLoadBalancer(_ input: RemoveAvailabilityZonesInput) -> EventLoopFuture<RemoveAvailabilityZonesOutput> {
        return client.execute(operation: "DisableAvailabilityZonesForLoadBalancer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func enableAvailabilityZonesForLoadBalancer(_ input: AddAvailabilityZonesInput) -> EventLoopFuture<AddAvailabilityZonesOutput> {
        return client.execute(operation: "EnableAvailabilityZonesForLoadBalancer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyLoadBalancerAttributes(_ input: ModifyLoadBalancerAttributesInput) -> EventLoopFuture<ModifyLoadBalancerAttributesOutput> {
        return client.execute(operation: "ModifyLoadBalancerAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerInstancesWithLoadBalancer(_ input: RegisterEndPointsInput) -> EventLoopFuture<RegisterEndPointsOutput> {
        return client.execute(operation: "RegisterInstancesWithLoadBalancer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setLoadBalancerListenerSSLCertificate(_ input: SetLoadBalancerListenerSSLCertificateInput) -> EventLoopFuture<SetLoadBalancerListenerSSLCertificateOutput> {
        return client.execute(operation: "SetLoadBalancerListenerSSLCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setLoadBalancerPoliciesForBackendServer(_ input: SetLoadBalancerPoliciesForBackendServerInput) -> EventLoopFuture<SetLoadBalancerPoliciesForBackendServerOutput> {
        return client.execute(operation: "SetLoadBalancerPoliciesForBackendServer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setLoadBalancerPoliciesOfListener(_ input: SetLoadBalancerPoliciesOfListenerInput) -> EventLoopFuture<SetLoadBalancerPoliciesOfListenerOutput> {
        return client.execute(operation: "SetLoadBalancerPoliciesOfListener", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
