...
extension CloudWatchLogs {
    ...
    public func describeDestinationsPaginator(_ input: DescribeDestinationsRequest) -> Future<[Destination]> {
    ...
    public func describeLogGroupsPaginator(_ input: DescribeLogGroupsRequest) -> Future<[LogGroup]> {
    ...
    public func describeLogStreamsPaginator(_ input: DescribeLogStreamsRequest) -> Future<[LogStream]> {
    ...
    public func describeMetricFiltersPaginator(_ input: DescribeMetricFiltersRequest) -> Future<[MetricFilter]> {
    ...
    public func describeSubscriptionFiltersPaginator(_ input: DescribeSubscriptionFiltersRequest) -> Future<[SubscriptionFilter]> {
    ...
    public func filterLogEventsPaginator(_ input: FilterLogEventsRequest) -> Future<[FilteredLogEvent]> {
    ...
    public func getLogEventsPaginator(_ input: GetLogEventsRequest) -> Future<[OutputLogEvent]> {
