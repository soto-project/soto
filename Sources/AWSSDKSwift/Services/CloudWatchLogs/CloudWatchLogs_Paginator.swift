...
extension CloudWatchLogs {
    ...
    public func describeDestinationsPaginator(_ input: DescribeDestinationsRequest, onPage: @escaping ([Destination], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeDestinations, resultKey: \DescribeDestinationsResponse.destinations, tokenKey: \DescribeDestinationsResponse.nextToken, onPage: onPage)
    }
    
    ///  Lists the specified log groups. You can list all your log groups or filter the results by prefix. The results are ASCII-sorted by log group name.
    public func describeLogGroupsPaginator(_ input: DescribeLogGroupsRequest, onPage: @escaping ([LogGroup], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeLogGroups, resultKey: \DescribeLogGroupsResponse.logGroups, tokenKey: \DescribeLogGroupsResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeLogStreamsPaginator(_ input: DescribeLogStreamsRequest, onPage: @escaping ([LogStream], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeLogStreams, resultKey: \DescribeLogStreamsResponse.logStreams, tokenKey: \DescribeLogStreamsResponse.nextToken, onPage: onPage)
    }
    
    ///  Lists the specified metric filters. You can list all the metric filters or filter the results by log name, prefix, metric name, or metric namespace. The results are ASCII-sorted by filter name.
    public func describeMetricFiltersPaginator(_ input: DescribeMetricFiltersRequest, onPage: @escaping ([MetricFilter], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeMetricFilters, resultKey: \DescribeMetricFiltersResponse.metricFilters, tokenKey: \DescribeMetricFiltersResponse.nextToken, onPage: onPage)
    }
    
    ///  Lists the subscription filters for the specified log group. You can list all the subscription filters or filter the results by prefix. The results are ASCII-sorted by filter name.
    public func describeSubscriptionFiltersPaginator(_ input: DescribeSubscriptionFiltersRequest, onPage: @escaping ([SubscriptionFilter], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeSubscriptionFilters, resultKey: \DescribeSubscriptionFiltersResponse.subscriptionFilters, tokenKey: \DescribeSubscriptionFiltersResponse.nextToken, onPage: onPage)
    }
    ...
    public func filterLogEventsPaginator(_ input: FilterLogEventsRequest, onPage: @escaping ([FilteredLogEvent], [SearchedLogStream], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: filterLogEvents, resultKey1: \FilterLogEventsResponse.events, resultKey2: \FilterLogEventsResponse.searchedLogStreams, tokenKey: \FilterLogEventsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getLogEventsPaginator(_ input: GetLogEventsRequest, onPage: @escaping ([OutputLogEvent], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getLogEvents, resultKey: \GetLogEventsResponse.events, tokenKey: \GetLogEventsResponse.nextForwardToken, onPage: onPage)
    }
