...
public struct CloudWatchLogs {
    ...
    @discardableResult public func associateKmsKey(_ input: AssociateKmsKeyRequest) -> Future<Void> {
    ...
    @discardableResult public func createLogGroup(_ input: CreateLogGroupRequest) -> Future<Void> {
    ...
    @discardableResult public func createLogStream(_ input: CreateLogStreamRequest) -> Future<Void> {
        return client.send(operation: "CreateLogStream", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified destination, and eventually disables all the subscription filters that publish to it. This operation does not delete the physical resource encapsulated by the destination.
    @discardableResult public func deleteDestination(_ input: DeleteDestinationRequest) -> Future<Void> {
        return client.send(operation: "DeleteDestination", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified log group and permanently deletes all the archived log events associated with the log group.
    @discardableResult public func deleteLogGroup(_ input: DeleteLogGroupRequest) -> Future<Void> {
        return client.send(operation: "DeleteLogGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified log stream and permanently deletes all the archived log events associated with the log stream.
    @discardableResult public func deleteLogStream(_ input: DeleteLogStreamRequest) -> Future<Void> {
        return client.send(operation: "DeleteLogStream", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified metric filter.
    @discardableResult public func deleteMetricFilter(_ input: DeleteMetricFilterRequest) -> Future<Void> {
        return client.send(operation: "DeleteMetricFilter", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a resource policy from this account. This revokes the access of the identities in that policy to put log events to this account.
    @discardableResult public func deleteResourcePolicy(_ input: DeleteResourcePolicyRequest) -> Future<Void> {
    ...
    @discardableResult public func deleteRetentionPolicy(_ input: DeleteRetentionPolicyRequest) -> Future<Void> {
        return client.send(operation: "DeleteRetentionPolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified subscription filter.
    @discardableResult public func deleteSubscriptionFilter(_ input: DeleteSubscriptionFilterRequest) -> Future<Void> {
        return client.send(operation: "DeleteSubscriptionFilter", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all your destinations. The results are ASCII-sorted by destination name.
    public func describeDestinations(_ input: DescribeDestinationsRequest) -> Future<DescribeDestinationsResponse> {
    ...
    public func describeLogGroups(_ input: DescribeLogGroupsRequest) -> Future<DescribeLogGroupsResponse> {
    ...
    public func describeLogStreams(_ input: DescribeLogStreamsRequest) -> Future<DescribeLogStreamsResponse> {
        return client.send(operation: "DescribeLogStreams", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the specified metric filters. You can list all the metric filters or filter the results by log name, prefix, metric name, or metric namespace. The results are ASCII-sorted by filter name.
    public func describeMetricFilters(_ input: DescribeMetricFiltersRequest) -> Future<DescribeMetricFiltersResponse> {
    ...
    public func describeQueries(_ input: DescribeQueriesRequest) -> Future<DescribeQueriesResponse> {
        return client.send(operation: "DescribeQueries", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the resource policies in this account.
    public func describeResourcePolicies(_ input: DescribeResourcePoliciesRequest) -> Future<DescribeResourcePoliciesResponse> {
    ...
    public func describeSubscriptionFilters(_ input: DescribeSubscriptionFiltersRequest) -> Future<DescribeSubscriptionFiltersResponse> {
    ...
    @discardableResult public func disassociateKmsKey(_ input: DisassociateKmsKeyRequest) -> Future<Void> {
    ...
    public func filterLogEvents(_ input: FilterLogEventsRequest) -> Future<FilterLogEventsResponse> {
    ...
    public func getLogEvents(_ input: GetLogEventsRequest) -> Future<GetLogEventsResponse> {
    ...
    public func getLogGroupFields(_ input: GetLogGroupFieldsRequest) -> Future<GetLogGroupFieldsResponse> {
    ...
    public func getLogRecord(_ input: GetLogRecordRequest) -> Future<GetLogRecordResponse> {
    ...
    public func listTagsLogGroup(_ input: ListTagsLogGroupRequest) -> Future<ListTagsLogGroupResponse> {
    ...
    @discardableResult public func putDestinationPolicy(_ input: PutDestinationPolicyRequest) -> Future<Void> {
    ...
    public func putLogEvents(_ input: PutLogEventsRequest) -> Future<PutLogEventsResponse> {
    ...
    @discardableResult public func putMetricFilter(_ input: PutMetricFilterRequest) -> Future<Void> {
    ...
    @discardableResult public func putRetentionPolicy(_ input: PutRetentionPolicyRequest) -> Future<Void> {
    ...
    @discardableResult public func putSubscriptionFilter(_ input: PutSubscriptionFilterRequest) -> Future<Void> {
    ...
    public func startQuery(_ input: StartQueryRequest) -> Future<StartQueryResponse> {
        return client.send(operation: "StartQuery", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops a CloudWatch Logs Insights query that is in progress. If the query has already ended, the operation returns an error indicating that the specified query is not running.
    public func stopQuery(_ input: StopQueryRequest) -> Future<StopQueryResponse> {
    ...
    @discardableResult public func tagLogGroup(_ input: TagLogGroupRequest) -> Future<Void> {
        return client.send(operation: "TagLogGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Tests the filter pattern of a metric filter against a sample of log event messages. You can use this operation to validate the correctness of a metric filter pattern.
    public func testMetricFilter(_ input: TestMetricFilterRequest) -> Future<TestMetricFilterResponse> {
    ...
    @discardableResult public func untagLogGroup(_ input: UntagLogGroupRequest) -> Future<Void> {
