...
public struct CloudWatchLogs: AWSService {
    ...
    @discardableResult public func associateKmsKey(_ input: AssociateKmsKeyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "AssociateKmsKey", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Cancels the specified export task. The task must be in the PENDING or RUNNING state.
    @discardableResult public func cancelExportTask(_ input: CancelExportTaskRequest) -> EventLoopFuture<Void> {
    ...
    public func createExportTask(_ input: CreateExportTaskRequest) -> EventLoopFuture<CreateExportTaskResponse> {
        return client.execute(operation: "CreateExportTask", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createLogGroup(_ input: CreateLogGroupRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateLogGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createLogStream(_ input: CreateLogStreamRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateLogStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified destination, and eventually disables all the subscription filters that publish to it. This operation does not delete the physical resource encapsulated by the destination.
    @discardableResult public func deleteDestination(_ input: DeleteDestinationRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDestination", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified log group and permanently deletes all the archived log events associated with the log group.
    @discardableResult public func deleteLogGroup(_ input: DeleteLogGroupRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteLogGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified log stream and permanently deletes all the archived log events associated with the log stream.
    @discardableResult public func deleteLogStream(_ input: DeleteLogStreamRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteLogStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified metric filter.
    @discardableResult public func deleteMetricFilter(_ input: DeleteMetricFilterRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteMetricFilter", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    public func deleteQueryDefinition(_ input: DeleteQueryDefinitionRequest) -> EventLoopFuture<DeleteQueryDefinitionResponse> {
        return client.execute(operation: "DeleteQueryDefinition", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteRetentionPolicy(_ input: DeleteRetentionPolicyRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteSubscriptionFilter(_ input: DeleteSubscriptionFilterRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSubscriptionFilter", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists all your destinations. The results are ASCII-sorted by destination name.
    public func describeDestinations(_ input: DescribeDestinationsRequest) -> EventLoopFuture<DescribeDestinationsResponse> {
        return client.execute(operation: "DescribeDestinations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLogGroups(_ input: DescribeLogGroupsRequest) -> EventLoopFuture<DescribeLogGroupsResponse> {
        return client.execute(operation: "DescribeLogGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLogStreams(_ input: DescribeLogStreamsRequest) -> EventLoopFuture<DescribeLogStreamsResponse> {
        return client.execute(operation: "DescribeLogStreams", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the specified metric filters. You can list all the metric filters or filter the results by log name, prefix, metric name, or metric namespace. The results are ASCII-sorted by filter name.
    public func describeMetricFilters(_ input: DescribeMetricFiltersRequest) -> EventLoopFuture<DescribeMetricFiltersResponse> {
        return client.execute(operation: "DescribeMetricFilters", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns a list of CloudWatch Logs Insights queries that are scheduled, executing, or have been executed recently in this account. You can request all queries, or limit it to queries of a specific log group or queries with a certain status.
    public func describeQueries(_ input: DescribeQueriesRequest) -> EventLoopFuture<DescribeQueriesResponse> {
        return client.execute(operation: "DescribeQueries", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    public func describeQueryDefinitions(_ input: DescribeQueryDefinitionsRequest) -> EventLoopFuture<DescribeQueryDefinitionsResponse> {
        return client.execute(operation: "DescribeQueryDefinitions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the resource policies in this account.
    public func describeResourcePolicies(_ input: DescribeResourcePoliciesRequest) -> EventLoopFuture<DescribeResourcePoliciesResponse> {
        return client.execute(operation: "DescribeResourcePolicies", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the subscription filters for the specified log group. You can list all the subscription filters or filter the results by prefix. The results are ASCII-sorted by filter name.
    public func describeSubscriptionFilters(_ input: DescribeSubscriptionFiltersRequest) -> EventLoopFuture<DescribeSubscriptionFiltersResponse> {
        return client.execute(operation: "DescribeSubscriptionFilters", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disassociateKmsKey(_ input: DisassociateKmsKeyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisassociateKmsKey", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func filterLogEvents(_ input: FilterLogEventsRequest) -> EventLoopFuture<FilterLogEventsResponse> {
        return client.execute(operation: "FilterLogEvents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getLogEvents(_ input: GetLogEventsRequest) -> EventLoopFuture<GetLogEventsResponse> {
        return client.execute(operation: "GetLogEvents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getLogGroupFields(_ input: GetLogGroupFieldsRequest) -> EventLoopFuture<GetLogGroupFieldsResponse> {
        return client.execute(operation: "GetLogGroupFields", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getLogRecord(_ input: GetLogRecordRequest) -> EventLoopFuture<GetLogRecordResponse> {
        return client.execute(operation: "GetLogRecord", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getQueryResults(_ input: GetQueryResultsRequest) -> EventLoopFuture<GetQueryResultsResponse> {
    ...
    public func listTagsLogGroup(_ input: ListTagsLogGroupRequest) -> EventLoopFuture<ListTagsLogGroupResponse> {
        return client.execute(operation: "ListTagsLogGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDestination(_ input: PutDestinationRequest) -> EventLoopFuture<PutDestinationResponse> {
        return client.execute(operation: "PutDestination", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates or updates an access policy associated with an existing destination. An access policy is an IAM policy document that is used to authorize claims to register a subscription filter against a given destination.
    @discardableResult public func putDestinationPolicy(_ input: PutDestinationPolicyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutDestinationPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putLogEvents(_ input: PutLogEventsRequest) -> EventLoopFuture<PutLogEventsResponse> {
        return client.execute(operation: "PutLogEvents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putMetricFilter(_ input: PutMetricFilterRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutMetricFilter", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    public func putQueryDefinition(_ input: PutQueryDefinitionRequest) -> EventLoopFuture<PutQueryDefinitionResponse> {
        return client.execute(operation: "PutQueryDefinition", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putRetentionPolicy(_ input: PutRetentionPolicyRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func putSubscriptionFilter(_ input: PutSubscriptionFilterRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutSubscriptionFilter", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startQuery(_ input: StartQueryRequest) -> EventLoopFuture<StartQueryResponse> {
        return client.execute(operation: "StartQuery", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Stops a CloudWatch Logs Insights query that is in progress. If the query has already ended, the operation returns an error indicating that the specified query is not running.
    public func stopQuery(_ input: StopQueryRequest) -> EventLoopFuture<StopQueryResponse> {
        return client.execute(operation: "StopQuery", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func tagLogGroup(_ input: TagLogGroupRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "TagLogGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Tests the filter pattern of a metric filter against a sample of log event messages. You can use this operation to validate the correctness of a metric filter pattern.
    public func testMetricFilter(_ input: TestMetricFilterRequest) -> EventLoopFuture<TestMetricFilterResponse> {
        return client.execute(operation: "TestMetricFilter", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func untagLogGroup(_ input: UntagLogGroupRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "UntagLogGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
