...
extension ACM {
    ...
    public func listCertificatesPaginator(_ input: ListCertificatesRequest) -> EventLoopFuture<[CertificateSummary]> {
        return client.paginate(input: input, command: listCertificates, resultKey: \ListCertificatesResponse.certificateSummaryList, tokenKey: \ListCertificatesResponse.nextToken)
    }
