...
extension ACM {
    ...
    public struct DomainValidation: AWSShape {
        ...
        public init(resourceRecord: ResourceRecord? = nil, validationDomain: String? = nil, validationStatus: DomainStatus? = nil, domainName: String, validationMethod: ValidationMethod? = nil, validationEmails: [String]? = nil) {
    ...
    public struct ListCertificatesRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, includes: Filters? = nil, certificateStatuses: [CertificateStatus]? = nil, maxItems: Int32? = nil) {
    ...
    public struct RequestCertificateRequest: AWSShape {
        ...
        public init(validationMethod: ValidationMethod? = nil, idempotencyToken: String? = nil, subjectAlternativeNames: [String]? = nil, domainName: String, options: CertificateOptions? = nil, certificateAuthorityArn: String? = nil, domainValidationOptions: [DomainValidationOption]? = nil) {
            self.validationMethod = validationMethod
    ...
    public struct ResourceRecord: AWSShape {
        ...
        public init(type: RecordType, name: String, value: String) {
            self.`type` = `type`
            self.name = name
            self.value = value
        }
    ...
    public struct ExportCertificateRequest: AWSShape {
        ...
        public init(passphrase: Data, certificateArn: String) {
    ...
    public struct ResendValidationEmailRequest: AWSShape {
        ...
        public init(validationDomain: String, domain: String, certificateArn: String) {
            self.validationDomain = validationDomain
            self.domain = domain
            self.certificateArn = certificateArn
        }
    ...
    public struct CertificateDetail: AWSShape {
        ...
        public init(inUseBy: [String]? = nil, createdAt: TimeStamp? = nil, domainName: String? = nil, importedAt: TimeStamp? = nil, extendedKeyUsages: [ExtendedKeyUsage]? = nil, keyAlgorithm: KeyAlgorithm? = nil, domainValidationOptions: [DomainValidation]? = nil, issuer: String? = nil, failureReason: FailureReason? = nil, certificateAuthorityArn: String? = nil, serial: String? = nil, issuedAt: TimeStamp? = nil, status: CertificateStatus? = nil, notBefore: TimeStamp? = nil, renewalEligibility: RenewalEligibility? = nil, revocationReason: RevocationReason? = nil, type: CertificateType? = nil, certificateArn: String? = nil, revokedAt: TimeStamp? = nil, keyUsages: [KeyUsage]? = nil, signatureAlgorithm: String? = nil, notAfter: TimeStamp? = nil, subjectAlternativeNames: [String]? = nil, subject: String? = nil, renewalSummary: RenewalSummary? = nil, options: CertificateOptions? = nil) {
    ...
    public struct CertificateSummary: AWSShape {
        ...
        public init(domainName: String? = nil, certificateArn: String? = nil) {
            self.domainName = domainName
            self.certificateArn = certificateArn
        }
    ...
    public struct ImportCertificateRequest: AWSShape {
        ...
        public init(privateKey: Data, certificate: Data, certificateChain: Data? = nil, certificateArn: String? = nil) {
    ...
    public struct ExportCertificateResponse: AWSShape {
        ...
        public init(privateKey: String? = nil, certificateChain: String? = nil, certificate: String? = nil) {
            self.privateKey = privateKey
            self.certificateChain = certificateChain
            self.certificate = certificate
        }
