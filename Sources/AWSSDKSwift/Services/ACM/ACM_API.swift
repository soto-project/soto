...
public struct ACM {
    ...
    @discardableResult public func addTagsToCertificate(_ input: AddTagsToCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddTagsToCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteCertificate(_ input: DeleteCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func exportCertificate(_ input: ExportCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportCertificateResponse> {
        return client.execute(operation: "ExportCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func importCertificate(_ input: ImportCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ImportCertificateResponse> {
        return client.execute(operation: "ImportCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTagsForCertificate(_ input: ListTagsForCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForCertificateResponse> {
        return client.execute(operation: "ListTagsForCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func removeTagsFromCertificate(_ input: RemoveTagsFromCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveTagsFromCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func renewCertificate(_ input: RenewCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RenewCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func requestCertificate(_ input: RequestCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RequestCertificateResponse> {
        return client.execute(operation: "RequestCertificate", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func resendValidationEmail(_ input: ResendValidationEmailRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "ResendValidationEmail", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func updateCertificateOptions(_ input: UpdateCertificateOptionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateCertificateOptions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
