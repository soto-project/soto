...
public struct ACM: AWSService {
    ...
    /// return new `ACM` with new timeout value
    ...
    /// return new `ACM` logging to specified Logger
    ...
    @discardableResult public func addTagsToCertificate(_ input: AddTagsToCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddTagsToCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeCertificate(_ input: DescribeCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCertificateResponse> {
        return client.execute(operation: "DescribeCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func exportCertificate(_ input: ExportCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportCertificateResponse> {
        return client.execute(operation: "ExportCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getCertificate(_ input: GetCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCertificateResponse> {
        return client.execute(operation: "GetCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func importCertificate(_ input: ImportCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ImportCertificateResponse> {
    ...
    public func listCertificates(_ input: ListCertificatesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListCertificatesResponse> {
        return client.execute(operation: "ListCertificates", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the tags that have been applied to the ACM certificate. Use the certificate's Amazon Resource Name (ARN) to specify the certificate. To add a tag to an ACM certificate, use the AddTagsToCertificate action. To delete a tag, use the RemoveTagsFromCertificate action. 
    public func listTagsForCertificate(_ input: ListTagsForCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForCertificateResponse> {
        return client.execute(operation: "ListTagsForCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func removeTagsFromCertificate(_ input: RemoveTagsFromCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveTagsFromCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func renewCertificate(_ input: RenewCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RenewCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func requestCertificate(_ input: RequestCertificateRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RequestCertificateResponse> {
        return client.execute(operation: "RequestCertificate", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func resendValidationEmail(_ input: ResendValidationEmailRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "ResendValidationEmail", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Updates a certificate. Currently, you can use this function to specify whether to opt in to or out of recording your certificate in a certificate transparency log. For more information, see  Opting Out of Certificate Transparency Logging. 
    @discardableResult public func updateCertificateOptions(_ input: UpdateCertificateOptionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateCertificateOptions", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
