...
public struct ACM {
    ...
    public func exportCertificate(_ input: ExportCertificateRequest) throws -> EventLoopFuture<ExportCertificateResponse> {
    ...
    public func requestCertificate(_ input: RequestCertificateRequest) throws -> EventLoopFuture<RequestCertificateResponse> {
    ...
    public func importCertificate(_ input: ImportCertificateRequest) throws -> EventLoopFuture<ImportCertificateResponse> {
    ...
    public func getCertificate(_ input: GetCertificateRequest) throws -> EventLoopFuture<GetCertificateResponse> {
    ...
    public func listTagsForCertificate(_ input: ListTagsForCertificateRequest) throws -> EventLoopFuture<ListTagsForCertificateResponse> {
