...
public struct ACM: AWSService {
    ...
    @discardableResult public func addTagsToCertificate(_ input: AddTagsToCertificateRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddTagsToCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func exportCertificate(_ input: ExportCertificateRequest) -> EventLoopFuture<ExportCertificateResponse> {
        return client.execute(operation: "ExportCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getCertificate(_ input: GetCertificateRequest) -> EventLoopFuture<GetCertificateResponse> {
        return client.execute(operation: "GetCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTagsForCertificate(_ input: ListTagsForCertificateRequest) -> EventLoopFuture<ListTagsForCertificateResponse> {
        return client.execute(operation: "ListTagsForCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func removeTagsFromCertificate(_ input: RemoveTagsFromCertificateRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveTagsFromCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func renewCertificate(_ input: RenewCertificateRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "RenewCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func requestCertificate(_ input: RequestCertificateRequest) -> EventLoopFuture<RequestCertificateResponse> {
        return client.execute(operation: "RequestCertificate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func resendValidationEmail(_ input: ResendValidationEmailRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "ResendValidationEmail", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func updateCertificateOptions(_ input: UpdateCertificateOptionsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateCertificateOptions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
