...
public struct Textract: AWSService {
    ...
    public func analyzeDocument(_ input: AnalyzeDocumentRequest) -> EventLoopFuture<AnalyzeDocumentResponse> {
        return client.execute(operation: "AnalyzeDocument", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detectDocumentText(_ input: DetectDocumentTextRequest) -> EventLoopFuture<DetectDocumentTextResponse> {
        return client.execute(operation: "DetectDocumentText", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDocumentAnalysis(_ input: GetDocumentAnalysisRequest) -> EventLoopFuture<GetDocumentAnalysisResponse> {
        return client.execute(operation: "GetDocumentAnalysis", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDocumentTextDetection(_ input: GetDocumentTextDetectionRequest) -> EventLoopFuture<GetDocumentTextDetectionResponse> {
        return client.execute(operation: "GetDocumentTextDetection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startDocumentAnalysis(_ input: StartDocumentAnalysisRequest) -> EventLoopFuture<StartDocumentAnalysisResponse> {
        return client.execute(operation: "StartDocumentAnalysis", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startDocumentTextDetection(_ input: StartDocumentTextDetectionRequest) -> EventLoopFuture<StartDocumentTextDetectionResponse> {
        return client.execute(operation: "StartDocumentTextDetection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
