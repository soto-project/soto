...
public struct Textract {
    ...
    public func analyzeDocument(_ input: AnalyzeDocumentRequest) -> Future<AnalyzeDocumentResponse> {
    ...
    public func detectDocumentText(_ input: DetectDocumentTextRequest) -> Future<DetectDocumentTextResponse> {
    ...
    public func getDocumentAnalysis(_ input: GetDocumentAnalysisRequest) -> Future<GetDocumentAnalysisResponse> {
    ...
    public func getDocumentTextDetection(_ input: GetDocumentTextDetectionRequest) -> Future<GetDocumentTextDetectionResponse> {
    ...
    public func startDocumentAnalysis(_ input: StartDocumentAnalysisRequest) -> Future<StartDocumentAnalysisResponse> {
    ...
    public func startDocumentTextDetection(_ input: StartDocumentTextDetectionRequest) -> Future<StartDocumentTextDetectionResponse> {
