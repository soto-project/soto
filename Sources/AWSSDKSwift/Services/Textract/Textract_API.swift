...
public struct Textract {
    ...
    public func analyzeDocument(_ input: AnalyzeDocumentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AnalyzeDocumentResponse> {
        return client.send(operation: "AnalyzeDocument", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func detectDocumentText(_ input: DetectDocumentTextRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectDocumentTextResponse> {
        return client.send(operation: "DetectDocumentText", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getDocumentAnalysis(_ input: GetDocumentAnalysisRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDocumentAnalysisResponse> {
        return client.send(operation: "GetDocumentAnalysis", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getDocumentTextDetection(_ input: GetDocumentTextDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDocumentTextDetectionResponse> {
        return client.send(operation: "GetDocumentTextDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startDocumentAnalysis(_ input: StartDocumentAnalysisRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDocumentAnalysisResponse> {
        return client.send(operation: "StartDocumentAnalysis", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startDocumentTextDetection(_ input: StartDocumentTextDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDocumentTextDetectionResponse> {
        return client.send(operation: "StartDocumentTextDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
}
