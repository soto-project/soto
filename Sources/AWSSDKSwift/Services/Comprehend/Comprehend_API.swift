...
public struct Comprehend {
    ...
    public func describeDocumentClassifier(_ input: DescribeDocumentClassifierRequest) throws -> DescribeDocumentClassifierResponse {
    ...
    public func createDocumentClassifier(_ input: CreateDocumentClassifierRequest) throws -> CreateDocumentClassifierResponse {
    ...
    public func deleteEntityRecognizer(_ input: DeleteEntityRecognizerRequest) throws -> DeleteEntityRecognizerResponse {
    ...
    public func listDocumentClassificationJobs(_ input: ListDocumentClassificationJobsRequest) throws -> ListDocumentClassificationJobsResponse {
    ...
    public func listDocumentClassifiers(_ input: ListDocumentClassifiersRequest) throws -> ListDocumentClassifiersResponse {
    ...
    public func createEntityRecognizer(_ input: CreateEntityRecognizerRequest) throws -> CreateEntityRecognizerResponse {
    ...
    public func listEntityRecognizers(_ input: ListEntityRecognizersRequest) throws -> ListEntityRecognizersResponse {
    ...
    public func describeEntityRecognizer(_ input: DescribeEntityRecognizerRequest) throws -> DescribeEntityRecognizerResponse {
    ...
    public func describeDocumentClassificationJob(_ input: DescribeDocumentClassificationJobRequest) throws -> DescribeDocumentClassificationJobResponse {
    ...
    public func startDocumentClassificationJob(_ input: StartDocumentClassificationJobRequest) throws -> StartDocumentClassificationJobResponse {
    ...
    public func deleteDocumentClassifier(_ input: DeleteDocumentClassifierRequest) throws -> DeleteDocumentClassifierResponse {
