...
extension Comprehend {
    ...
    public func listDocumentClassificationJobsPaginator(_ input: ListDocumentClassificationJobsRequest) -> EventLoopFuture<[DocumentClassificationJobProperties]> {
        return client.paginate(input: input, command: listDocumentClassificationJobs, resultKey: \ListDocumentClassificationJobsResponse.documentClassificationJobPropertiesList, tokenKey: \ListDocumentClassificationJobsResponse.nextToken)
    }
    ...
    public func listDocumentClassifiersPaginator(_ input: ListDocumentClassifiersRequest) -> EventLoopFuture<[DocumentClassifierProperties]> {
        return client.paginate(input: input, command: listDocumentClassifiers, resultKey: \ListDocumentClassifiersResponse.documentClassifierPropertiesList, tokenKey: \ListDocumentClassifiersResponse.nextToken)
    }
    ...
    public func listDominantLanguageDetectionJobsPaginator(_ input: ListDominantLanguageDetectionJobsRequest) -> EventLoopFuture<[DominantLanguageDetectionJobProperties]> {
        return client.paginate(input: input, command: listDominantLanguageDetectionJobs, resultKey: \ListDominantLanguageDetectionJobsResponse.dominantLanguageDetectionJobPropertiesList, tokenKey: \ListDominantLanguageDetectionJobsResponse.nextToken)
    }
    ...
    public func listEntitiesDetectionJobsPaginator(_ input: ListEntitiesDetectionJobsRequest) -> EventLoopFuture<[EntitiesDetectionJobProperties]> {
        return client.paginate(input: input, command: listEntitiesDetectionJobs, resultKey: \ListEntitiesDetectionJobsResponse.entitiesDetectionJobPropertiesList, tokenKey: \ListEntitiesDetectionJobsResponse.nextToken)
    }
    ...
    public func listEntityRecognizersPaginator(_ input: ListEntityRecognizersRequest) -> EventLoopFuture<[EntityRecognizerProperties]> {
        return client.paginate(input: input, command: listEntityRecognizers, resultKey: \ListEntityRecognizersResponse.entityRecognizerPropertiesList, tokenKey: \ListEntityRecognizersResponse.nextToken)
    }
    ...
    public func listKeyPhrasesDetectionJobsPaginator(_ input: ListKeyPhrasesDetectionJobsRequest) -> EventLoopFuture<[KeyPhrasesDetectionJobProperties]> {
        return client.paginate(input: input, command: listKeyPhrasesDetectionJobs, resultKey: \ListKeyPhrasesDetectionJobsResponse.keyPhrasesDetectionJobPropertiesList, tokenKey: \ListKeyPhrasesDetectionJobsResponse.nextToken)
    }
    ...
    public func listSentimentDetectionJobsPaginator(_ input: ListSentimentDetectionJobsRequest) -> EventLoopFuture<[SentimentDetectionJobProperties]> {
        return client.paginate(input: input, command: listSentimentDetectionJobs, resultKey: \ListSentimentDetectionJobsResponse.sentimentDetectionJobPropertiesList, tokenKey: \ListSentimentDetectionJobsResponse.nextToken)
    }
    ...
    public func listTopicsDetectionJobsPaginator(_ input: ListTopicsDetectionJobsRequest) -> EventLoopFuture<[TopicsDetectionJobProperties]> {
        return client.paginate(input: input, command: listTopicsDetectionJobs, resultKey: \ListTopicsDetectionJobsResponse.topicsDetectionJobPropertiesList, tokenKey: \ListTopicsDetectionJobsResponse.nextToken)
    }
