...
extension Organizations {
    ...
    public struct CreateAccountRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            try validate(self.accountName, name:"accountName", parent: name, max: 50)
            try validate(self.accountName, name:"accountName", parent: name, min: 1)
            try validate(self.accountName, name:"accountName", parent: name, pattern: "[\\u0020-\\u007E]+")
    ...
    public struct DelegatedAdministrator: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Arn", required: false, type: .string), 
            AWSShapeMember(label: "DelegationEnabledDate", required: false, type: .timestamp), 
            AWSShapeMember(label: "Email", required: false, type: .string), 
            AWSShapeMember(label: "Id", required: false, type: .string), 
            AWSShapeMember(label: "JoinedMethod", required: false, type: .enum), 
            AWSShapeMember(label: "JoinedTimestamp", required: false, type: .timestamp), 
    ...
    public struct ListDelegatedAdministratorsResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "DelegatedAdministrators", required: false, type: .list), 
            AWSShapeMember(label: "NextToken", required: false, type: .string)
        ]
    ...
    public struct ListDelegatedServicesForAccountResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "DelegatedServices", required: false, type: .list), 
            AWSShapeMember(label: "NextToken", required: false, type: .string)
        ]
    ...
    public struct ListTagsForResourceRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            try validate(self.nextToken, name:"nextToken", parent: name, max: 100000)
            try validate(self.nextToken, name:"nextToken", parent: name, pattern: "[\\s\\S]*")
            try validate(self.resourceId, name:"resourceId", parent: name, max: 130)
            try validate(self.resourceId, name:"resourceId", parent: name, pattern: "^(r-[0-9a-z]{4,32})|(\\d{12})|(ou-[0-9a-z]{4,32}-[a-z0-9]{8,32})|(^p-[0-9a-zA-Z_]{8,128})$")
        }
