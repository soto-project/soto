...
public struct Organizations: AWSService {
    ...
    public func acceptHandshake(_ input: AcceptHandshakeRequest) -> EventLoopFuture<AcceptHandshakeResponse> {
        return client.execute(operation: "AcceptHandshake", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func attachPolicy(_ input: AttachPolicyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "AttachPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func cancelHandshake(_ input: CancelHandshakeRequest) -> EventLoopFuture<CancelHandshakeResponse> {
        return client.execute(operation: "CancelHandshake", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createAccount(_ input: CreateAccountRequest) -> EventLoopFuture<CreateAccountResponse> {
        return client.execute(operation: "CreateAccount", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createGovCloudAccount(_ input: CreateGovCloudAccountRequest) -> EventLoopFuture<CreateGovCloudAccountResponse> {
        return client.execute(operation: "CreateGovCloudAccount", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createOrganization(_ input: CreateOrganizationRequest) -> EventLoopFuture<CreateOrganizationResponse> {
        return client.execute(operation: "CreateOrganization", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createOrganizationalUnit(_ input: CreateOrganizationalUnitRequest) -> EventLoopFuture<CreateOrganizationalUnitResponse> {
        return client.execute(operation: "CreateOrganizationalUnit", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func declineHandshake(_ input: DeclineHandshakeRequest) -> EventLoopFuture<DeclineHandshakeResponse> {
        return client.execute(operation: "DeclineHandshake", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteOrganization() -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteOrganization", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteOrganizationalUnit(_ input: DeleteOrganizationalUnitRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteOrganizationalUnit", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deregisterDelegatedAdministrator(_ input: DeregisterDelegatedAdministratorRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeregisterDelegatedAdministrator", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeCreateAccountStatus(_ input: DescribeCreateAccountStatusRequest) -> EventLoopFuture<DescribeCreateAccountStatusResponse> {
        return client.execute(operation: "DescribeCreateAccountStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeEffectivePolicy(_ input: DescribeEffectivePolicyRequest) -> EventLoopFuture<DescribeEffectivePolicyResponse> {
        return client.execute(operation: "DescribeEffectivePolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeHandshake(_ input: DescribeHandshakeRequest) -> EventLoopFuture<DescribeHandshakeResponse> {
        return client.execute(operation: "DescribeHandshake", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeOrganization() -> EventLoopFuture<DescribeOrganizationResponse> {
        return client.execute(operation: "DescribeOrganization", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeOrganizationalUnit(_ input: DescribeOrganizationalUnitRequest) -> EventLoopFuture<DescribeOrganizationalUnitResponse> {
        return client.execute(operation: "DescribeOrganizationalUnit", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describePolicy(_ input: DescribePolicyRequest) -> EventLoopFuture<DescribePolicyResponse> {
        return client.execute(operation: "DescribePolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func detachPolicy(_ input: DetachPolicyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DetachPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disableAWSServiceAccess(_ input: DisableAWSServiceAccessRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisableAWSServiceAccess", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disablePolicyType(_ input: DisablePolicyTypeRequest) -> EventLoopFuture<DisablePolicyTypeResponse> {
        return client.execute(operation: "DisablePolicyType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func enableAWSServiceAccess(_ input: EnableAWSServiceAccessRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "EnableAWSServiceAccess", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func enableAllFeatures(_ input: EnableAllFeaturesRequest) -> EventLoopFuture<EnableAllFeaturesResponse> {
        return client.execute(operation: "EnableAllFeatures", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func enablePolicyType(_ input: EnablePolicyTypeRequest) -> EventLoopFuture<EnablePolicyTypeResponse> {
        return client.execute(operation: "EnablePolicyType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func inviteAccountToOrganization(_ input: InviteAccountToOrganizationRequest) -> EventLoopFuture<InviteAccountToOrganizationResponse> {
        return client.execute(operation: "InviteAccountToOrganization", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func leaveOrganization() -> EventLoopFuture<Void> {
        return client.execute(operation: "LeaveOrganization", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func listAWSServiceAccessForOrganization(_ input: ListAWSServiceAccessForOrganizationRequest) -> EventLoopFuture<ListAWSServiceAccessForOrganizationResponse> {
        return client.execute(operation: "ListAWSServiceAccessForOrganization", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAccounts(_ input: ListAccountsRequest) -> EventLoopFuture<ListAccountsResponse> {
        return client.execute(operation: "ListAccounts", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAccountsForParent(_ input: ListAccountsForParentRequest) -> EventLoopFuture<ListAccountsForParentResponse> {
        return client.execute(operation: "ListAccountsForParent", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listChildren(_ input: ListChildrenRequest) -> EventLoopFuture<ListChildrenResponse> {
        return client.execute(operation: "ListChildren", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listCreateAccountStatus(_ input: ListCreateAccountStatusRequest) -> EventLoopFuture<ListCreateAccountStatusResponse> {
        return client.execute(operation: "ListCreateAccountStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDelegatedAdministrators(_ input: ListDelegatedAdministratorsRequest) -> EventLoopFuture<ListDelegatedAdministratorsResponse> {
        return client.execute(operation: "ListDelegatedAdministrators", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDelegatedServicesForAccount(_ input: ListDelegatedServicesForAccountRequest) -> EventLoopFuture<ListDelegatedServicesForAccountResponse> {
        return client.execute(operation: "ListDelegatedServicesForAccount", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listHandshakesForAccount(_ input: ListHandshakesForAccountRequest) -> EventLoopFuture<ListHandshakesForAccountResponse> {
        return client.execute(operation: "ListHandshakesForAccount", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listHandshakesForOrganization(_ input: ListHandshakesForOrganizationRequest) -> EventLoopFuture<ListHandshakesForOrganizationResponse> {
        return client.execute(operation: "ListHandshakesForOrganization", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listOrganizationalUnitsForParent(_ input: ListOrganizationalUnitsForParentRequest) -> EventLoopFuture<ListOrganizationalUnitsForParentResponse> {
        return client.execute(operation: "ListOrganizationalUnitsForParent", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listParents(_ input: ListParentsRequest) -> EventLoopFuture<ListParentsResponse> {
        return client.execute(operation: "ListParents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listPoliciesForTarget(_ input: ListPoliciesForTargetRequest) -> EventLoopFuture<ListPoliciesForTargetResponse> {
        return client.execute(operation: "ListPoliciesForTarget", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listRoots(_ input: ListRootsRequest) -> EventLoopFuture<ListRootsResponse> {
        return client.execute(operation: "ListRoots", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTargetsForPolicy(_ input: ListTargetsForPolicyRequest) -> EventLoopFuture<ListTargetsForPolicyResponse> {
        return client.execute(operation: "ListTargetsForPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func moveAccount(_ input: MoveAccountRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "MoveAccount", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func registerDelegatedAdministrator(_ input: RegisterDelegatedAdministratorRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "RegisterDelegatedAdministrator", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func removeAccountFromOrganization(_ input: RemoveAccountFromOrganizationRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveAccountFromOrganization", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateOrganizationalUnit(_ input: UpdateOrganizationalUnitRequest) -> EventLoopFuture<UpdateOrganizationalUnitResponse> {
        return client.execute(operation: "UpdateOrganizationalUnit", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updatePolicy(_ input: UpdatePolicyRequest) -> EventLoopFuture<UpdatePolicyResponse> {
        return client.execute(operation: "UpdatePolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
