...
extension Organizations {
    ...
    public func listAWSServiceAccessForOrganizationPaginator(
        ...
        onPage: @escaping (ListAWSServiceAccessForOrganizationResponse,
    ...
    public func listAccountsForParentPaginator(
        ...
        onPage: @escaping (ListAccountsForParentResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listChildrenPaginator(
        ...
        onPage: @escaping (ListChildrenResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listCreateAccountStatusPaginator(
        ...
        onPage: @escaping (ListCreateAccountStatusResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listDelegatedAdministratorsPaginator(
        ...
        onPage: @escaping (ListDelegatedAdministratorsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listDelegatedAdministrators, tokenKey: \ListDelegatedAdministratorsResponse.nextToken, onPage: onPage)
    }
    ...
    public func listDelegatedServicesForAccountPaginator(
        ...
        onPage: @escaping (ListDelegatedServicesForAccountResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listDelegatedServicesForAccount, tokenKey: \ListDelegatedServicesForAccountResponse.nextToken, onPage: onPage)
    }
    ...
    public func listHandshakesForAccountPaginator(
        ...
        onPage: @escaping (ListHandshakesForAccountResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listHandshakesForOrganizationPaginator(
        ...
        onPage: @escaping (ListHandshakesForOrganizationResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listOrganizationalUnitsForParentPaginator(
        ...
        onPage: @escaping (ListOrganizationalUnitsForParentResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listParentsPaginator(
        ...
        onPage: @escaping (ListParentsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listPoliciesForTargetPaginator(
        ...
        onPage: @escaping (ListPoliciesForTargetResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listRootsPaginator(
        ...
        onPage: @escaping (ListRootsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listTargetsForPolicyPaginator(
        ...
        onPage: @escaping (ListTargetsForPolicyResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
