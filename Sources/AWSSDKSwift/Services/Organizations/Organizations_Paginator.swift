...
extension Organizations {
    ...
    public func listAWSServiceAccessForOrganizationPaginator(_ input: ListAWSServiceAccessForOrganizationRequest) -> EventLoopFuture<[EnabledServicePrincipal]> {
        return client.paginate(input: input, command: listAWSServiceAccessForOrganization, resultKey: \ListAWSServiceAccessForOrganizationResponse.enabledServicePrincipals, tokenKey: \ListAWSServiceAccessForOrganizationResponse.nextToken)
    }
    ...
    public func listAccountsPaginator(_ input: ListAccountsRequest) -> EventLoopFuture<[Account]> {
        return client.paginate(input: input, command: listAccounts, resultKey: \ListAccountsResponse.accounts, tokenKey: \ListAccountsResponse.nextToken)
    }
    ...
    public func listAccountsForParentPaginator(_ input: ListAccountsForParentRequest) -> EventLoopFuture<[Account]> {
        return client.paginate(input: input, command: listAccountsForParent, resultKey: \ListAccountsForParentResponse.accounts, tokenKey: \ListAccountsForParentResponse.nextToken)
    }
    ...
    public func listChildrenPaginator(_ input: ListChildrenRequest) -> EventLoopFuture<[Child]> {
        return client.paginate(input: input, command: listChildren, resultKey: \ListChildrenResponse.children, tokenKey: \ListChildrenResponse.nextToken)
    }
    ...
    public func listCreateAccountStatusPaginator(_ input: ListCreateAccountStatusRequest) -> EventLoopFuture<[CreateAccountStatus]> {
        return client.paginate(input: input, command: listCreateAccountStatus, resultKey: \ListCreateAccountStatusResponse.createAccountStatuses, tokenKey: \ListCreateAccountStatusResponse.nextToken)
    }
    ...
    public func listHandshakesForAccountPaginator(_ input: ListHandshakesForAccountRequest) -> EventLoopFuture<[Handshake]> {
        return client.paginate(input: input, command: listHandshakesForAccount, resultKey: \ListHandshakesForAccountResponse.handshakes, tokenKey: \ListHandshakesForAccountResponse.nextToken)
    }
    ...
    public func listHandshakesForOrganizationPaginator(_ input: ListHandshakesForOrganizationRequest) -> EventLoopFuture<[Handshake]> {
        return client.paginate(input: input, command: listHandshakesForOrganization, resultKey: \ListHandshakesForOrganizationResponse.handshakes, tokenKey: \ListHandshakesForOrganizationResponse.nextToken)
    }
    ...
    public func listOrganizationalUnitsForParentPaginator(_ input: ListOrganizationalUnitsForParentRequest) -> EventLoopFuture<[OrganizationalUnit]> {
        return client.paginate(input: input, command: listOrganizationalUnitsForParent, resultKey: \ListOrganizationalUnitsForParentResponse.organizationalUnits, tokenKey: \ListOrganizationalUnitsForParentResponse.nextToken)
    }
    ...
    public func listParentsPaginator(_ input: ListParentsRequest) -> EventLoopFuture<[Parent]> {
        return client.paginate(input: input, command: listParents, resultKey: \ListParentsResponse.parents, tokenKey: \ListParentsResponse.nextToken)
    }
    ...
    public func listPoliciesPaginator(_ input: ListPoliciesRequest) -> EventLoopFuture<[PolicySummary]> {
        return client.paginate(input: input, command: listPolicies, resultKey: \ListPoliciesResponse.policies, tokenKey: \ListPoliciesResponse.nextToken)
    }
    ...
    public func listPoliciesForTargetPaginator(_ input: ListPoliciesForTargetRequest) -> EventLoopFuture<[PolicySummary]> {
        return client.paginate(input: input, command: listPoliciesForTarget, resultKey: \ListPoliciesForTargetResponse.policies, tokenKey: \ListPoliciesForTargetResponse.nextToken)
    }
    ...
    public func listRootsPaginator(_ input: ListRootsRequest) -> EventLoopFuture<[Root]> {
        return client.paginate(input: input, command: listRoots, resultKey: \ListRootsResponse.roots, tokenKey: \ListRootsResponse.nextToken)
    }
    ...
    public func listTargetsForPolicyPaginator(_ input: ListTargetsForPolicyRequest) -> EventLoopFuture<[PolicyTargetSummary]> {
        return client.paginate(input: input, command: listTargetsForPolicy, resultKey: \ListTargetsForPolicyResponse.targets, tokenKey: \ListTargetsForPolicyResponse.nextToken)
    }
