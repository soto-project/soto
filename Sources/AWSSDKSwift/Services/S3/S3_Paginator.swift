...
extension S3 {
    ...
    public func listMultipartUploadsPaginator(
        ...
        onPage: @escaping (ListMultipartUploadsOutput,
    ...
    public func listObjectVersionsPaginator(
        ...
        onPage: @escaping (ListObjectVersionsOutput,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listObjectsPaginator(
        ...
        onPage: @escaping (ListObjectsOutput,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listObjectsV2Paginator(
        ...
        onPage: @escaping (ListObjectsV2Output,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listPartsPaginator(
        ...
        onPage: @escaping (ListPartsOutput,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
