...
extension S3 {
    ...
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsRequest, onPage: @escaping ([MultipartUpload], [CommonPrefix], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listMultipartUploads, resultKey1: \ListMultipartUploadsOutput.uploads, resultKey2: \ListMultipartUploadsOutput.commonPrefixes, tokenKey: \ListMultipartUploadsOutput.nextKeyMarker, onPage: onPage)
    }
    ...
    public func listObjectVersionsPaginator(_ input: ListObjectVersionsRequest, onPage: @escaping ([ObjectVersion], [DeleteMarkerEntry], [CommonPrefix], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listObjectVersions, resultKey1: \ListObjectVersionsOutput.versions, resultKey2: \ListObjectVersionsOutput.deleteMarkers, resultKey3: \ListObjectVersionsOutput.commonPrefixes, tokenKey: \ListObjectVersionsOutput.nextKeyMarker, onPage: onPage)
    }
    ...
    public func listObjectsPaginator(_ input: ListObjectsRequest, onPage: @escaping ([Object], [CommonPrefix], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listObjects, resultKey1: \ListObjectsOutput.contents, resultKey2: \ListObjectsOutput.commonPrefixes, tokenKey: \ListObjectsOutput.nextMarker, onPage: onPage)
    }
    ...
    public func listObjectsV2Paginator(_ input: ListObjectsV2Request, onPage: @escaping ([Object], [CommonPrefix], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listObjectsV2, resultKey1: \ListObjectsV2Output.contents, resultKey2: \ListObjectsV2Output.commonPrefixes, tokenKey: \ListObjectsV2Output.nextContinuationToken, onPage: onPage)
    }
    ...
    public func listPartsPaginator(_ input: ListPartsRequest, onPage: @escaping ([Part], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listParts, resultKey: \ListPartsOutput.parts, tokenKey: \ListPartsOutput.nextPartNumberMarker, onPage: onPage)
    }
