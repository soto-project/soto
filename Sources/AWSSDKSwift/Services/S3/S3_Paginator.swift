...
extension S3 {
    ...
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsRequest) -> EventLoopFuture<[MultipartUpload]> {
        return client.paginate(input: input, command: listMultipartUploads, resultKey: \ListMultipartUploadsOutput.uploads, tokenKey: \ListMultipartUploadsOutput.nextKeyMarker)
    }
    ...
    public func listObjectVersionsPaginator(_ input: ListObjectVersionsRequest) -> EventLoopFuture<[ObjectVersion]> {
        return client.paginate(input: input, command: listObjectVersions, resultKey: \ListObjectVersionsOutput.versions, tokenKey: \ListObjectVersionsOutput.nextKeyMarker)
    }
    ...
    public func listObjectsPaginator(_ input: ListObjectsRequest) -> EventLoopFuture<[Object]> {
        return client.paginate(input: input, command: listObjects, resultKey: \ListObjectsOutput.contents, tokenKey: \ListObjectsOutput.nextMarker)
    }
    ...
    public func listObjectsV2Paginator(_ input: ListObjectsV2Request) -> EventLoopFuture<[Object]> {
        return client.paginate(input: input, command: listObjectsV2, resultKey: \ListObjectsV2Output.contents, tokenKey: \ListObjectsV2Output.nextContinuationToken)
    }
