...
extension S3 {
    ...
    public struct listMultipartUploadsPaginatedResult {
        let uploads: [MultipartUpload]
        let commonPrefixes: [CommonPrefix]
    }
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsRequest) -> EventLoopFuture<listMultipartUploadsPaginatedResult> {
        return client.paginate(input: input, command: listMultipartUploads, resultKey1: \ListMultipartUploadsOutput.uploads, resultKey2: \ListMultipartUploadsOutput.commonPrefixes, tokenKey: \ListMultipartUploadsOutput.nextKeyMarker).map {
            return listMultipartUploadsPaginatedResult(uploads: $0, commonPrefixes: $1)
        }
    }
    ...
    public struct listObjectVersionsPaginatedResult {
        let versions: [ObjectVersion]
        let deleteMarkers: [DeleteMarkerEntry]
        let commonPrefixes: [CommonPrefix]
    }
    public func listObjectVersionsPaginator(_ input: ListObjectVersionsRequest) -> EventLoopFuture<listObjectVersionsPaginatedResult> {
        return client.paginate(input: input, command: listObjectVersions, resultKey1: \ListObjectVersionsOutput.versions, resultKey2: \ListObjectVersionsOutput.deleteMarkers, resultKey3: \ListObjectVersionsOutput.commonPrefixes, tokenKey: \ListObjectVersionsOutput.nextKeyMarker).map {
            return listObjectVersionsPaginatedResult(versions: $0, deleteMarkers: $1, commonPrefixes: $2)
        }
    }
    ...
    public struct listObjectsPaginatedResult {
        let contents: [Object]
        let commonPrefixes: [CommonPrefix]
    }
    public func listObjectsPaginator(_ input: ListObjectsRequest) -> EventLoopFuture<listObjectsPaginatedResult> {
        return client.paginate(input: input, command: listObjects, resultKey1: \ListObjectsOutput.contents, resultKey2: \ListObjectsOutput.commonPrefixes, tokenKey: \ListObjectsOutput.nextMarker).map {
            return listObjectsPaginatedResult(contents: $0, commonPrefixes: $1)
        }
    }
    ...
    public struct listObjectsV2PaginatedResult {
        let contents: [Object]
        let commonPrefixes: [CommonPrefix]
    }
    public func listObjectsV2Paginator(_ input: ListObjectsV2Request) -> EventLoopFuture<listObjectsV2PaginatedResult> {
        return client.paginate(input: input, command: listObjectsV2, resultKey1: \ListObjectsV2Output.contents, resultKey2: \ListObjectsV2Output.commonPrefixes, tokenKey: \ListObjectsV2Output.nextContinuationToken).map {
            return listObjectsV2PaginatedResult(contents: $0, commonPrefixes: $1)
        }
    }
    ...
    public func listPartsPaginator(_ input: ListPartsRequest) -> EventLoopFuture<[Part]> {
        return client.paginate(input: input, command: listParts, resultKey: \ListPartsOutput.parts, tokenKey: \ListPartsOutput.nextPartNumberMarker)
    }
