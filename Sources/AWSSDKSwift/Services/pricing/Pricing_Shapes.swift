...
extension Pricing {
    ...
    public struct DescribeServicesRequest: AWSShape {
        ...
        public init(serviceCode: String? = nil, formatVersion: String? = nil, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.serviceCode = serviceCode
    ...
    public struct GetProductsRequest: AWSShape {
        ...
        public init(serviceCode: String? = nil, formatVersion: String? = nil, filters: [Filter]? = nil, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.serviceCode = serviceCode
            self.formatVersion = formatVersion
    ...
    public struct GetAttributeValuesRequest: AWSShape {
        ...
        public init(serviceCode: String, attributeName: String, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.serviceCode = serviceCode
