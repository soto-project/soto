...
public struct CostExplorer {
    ...
    public func getCostForecast(_ input: GetCostForecastRequest) throws -> EventLoopFuture<GetCostForecastResponse> {
    ...
    public func getCostAndUsage(_ input: GetCostAndUsageRequest) throws -> EventLoopFuture<GetCostAndUsageResponse> {
    ...
    public func getReservationCoverage(_ input: GetReservationCoverageRequest) throws -> EventLoopFuture<GetReservationCoverageResponse> {
    ...
    public func getReservationUtilization(_ input: GetReservationUtilizationRequest) throws -> EventLoopFuture<GetReservationUtilizationResponse> {
        return try client.send(operation: "GetReservationUtilization", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves all available filter values for a specified filter over a period of time. You can search the dimension values for an arbitrary string. 
    public func getDimensionValues(_ input: GetDimensionValuesRequest) throws -> EventLoopFuture<GetDimensionValuesResponse> {
    ...
    public func getReservationPurchaseRecommendation(_ input: GetReservationPurchaseRecommendationRequest) throws -> EventLoopFuture<GetReservationPurchaseRecommendationResponse> {
    ...
    public func getTags(_ input: GetTagsRequest) throws -> EventLoopFuture<GetTagsResponse> {
