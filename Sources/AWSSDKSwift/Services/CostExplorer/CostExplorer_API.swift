...
public struct CostExplorer {
    ...
    public func getCostForecast(_ input: GetCostForecastRequest) throws -> GetCostForecastResponse {
    ...
    public func getReservationCoverage(_ input: GetReservationCoverageRequest) throws -> GetReservationCoverageResponse {
    ...
    public func getReservationPurchaseRecommendation(_ input: GetReservationPurchaseRecommendationRequest) throws -> GetReservationPurchaseRecommendationResponse {
