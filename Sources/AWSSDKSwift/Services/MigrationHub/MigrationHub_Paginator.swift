...
extension MigrationHub {
    ...
    public func listApplicationStatesPaginator(_ input: ListApplicationStatesRequest) -> EventLoopFuture<[ApplicationState]> {
        return client.paginate(input: input, command: listApplicationStates, resultKey: \ListApplicationStatesResult.applicationStateList, tokenKey: \ListApplicationStatesResult.nextToken)
    }
    ...
    public func listCreatedArtifactsPaginator(_ input: ListCreatedArtifactsRequest) -> EventLoopFuture<[CreatedArtifact]> {
        return client.paginate(input: input, command: listCreatedArtifacts, resultKey: \ListCreatedArtifactsResult.createdArtifactList, tokenKey: \ListCreatedArtifactsResult.nextToken)
    }
    ...
    public func listDiscoveredResourcesPaginator(_ input: ListDiscoveredResourcesRequest) -> EventLoopFuture<[DiscoveredResource]> {
        return client.paginate(input: input, command: listDiscoveredResources, resultKey: \ListDiscoveredResourcesResult.discoveredResourceList, tokenKey: \ListDiscoveredResourcesResult.nextToken)
    }
    ...
    public func listMigrationTasksPaginator(_ input: ListMigrationTasksRequest) -> EventLoopFuture<[MigrationTaskSummary]> {
        return client.paginate(input: input, command: listMigrationTasks, resultKey: \ListMigrationTasksResult.migrationTaskSummaryList, tokenKey: \ListMigrationTasksResult.nextToken)
    }
    ...
    public func listProgressUpdateStreamsPaginator(_ input: ListProgressUpdateStreamsRequest) -> EventLoopFuture<[ProgressUpdateStreamSummary]> {
        return client.paginate(input: input, command: listProgressUpdateStreams, resultKey: \ListProgressUpdateStreamsResult.progressUpdateStreamSummaryList, tokenKey: \ListProgressUpdateStreamsResult.nextToken)
    }
