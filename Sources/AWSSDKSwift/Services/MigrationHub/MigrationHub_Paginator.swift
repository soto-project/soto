...
extension MigrationHub {
    ...
    public func listApplicationStatesPaginator(_ input: ListApplicationStatesRequest) -> Future<[ApplicationState]> {
    ...
    public func listCreatedArtifactsPaginator(_ input: ListCreatedArtifactsRequest) -> Future<[CreatedArtifact]> {
    ...
    public func listDiscoveredResourcesPaginator(_ input: ListDiscoveredResourcesRequest) -> Future<[DiscoveredResource]> {
    ...
    public func listMigrationTasksPaginator(_ input: ListMigrationTasksRequest) -> Future<[MigrationTaskSummary]> {
    ...
    public func listProgressUpdateStreamsPaginator(_ input: ListProgressUpdateStreamsRequest) -> Future<[ProgressUpdateStreamSummary]> {
