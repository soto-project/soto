...
public struct MigrationHub {
    ...
    public func listCreatedArtifacts(_ input: ListCreatedArtifactsRequest) throws -> EventLoopFuture<ListCreatedArtifactsResult> {
        return try client.send(operation: "ListCreatedArtifacts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists progress update streams associated with the user account making this call.
    public func listProgressUpdateStreams(_ input: ListProgressUpdateStreamsRequest) throws -> EventLoopFuture<ListProgressUpdateStreamsResult> {
    ...
    public func disassociateDiscoveredResource(_ input: DisassociateDiscoveredResourceRequest) throws -> EventLoopFuture<DisassociateDiscoveredResourceResult> {
    ...
    public func listMigrationTasks(_ input: ListMigrationTasksRequest) throws -> EventLoopFuture<ListMigrationTasksResult> {
        return try client.send(operation: "ListMigrationTasks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists discovered resources associated with the given MigrationTask.
    public func listDiscoveredResources(_ input: ListDiscoveredResourcesRequest) throws -> EventLoopFuture<ListDiscoveredResourcesResult> {
    ...
    public func createProgressUpdateStream(_ input: CreateProgressUpdateStreamRequest) throws -> EventLoopFuture<CreateProgressUpdateStreamResult> {
    ...
    public func putResourceAttributes(_ input: PutResourceAttributesRequest) throws -> EventLoopFuture<PutResourceAttributesResult> {
    ...
    public func notifyApplicationState(_ input: NotifyApplicationStateRequest) throws -> EventLoopFuture<NotifyApplicationStateResult> {
    ...
    public func deleteProgressUpdateStream(_ input: DeleteProgressUpdateStreamRequest) throws -> EventLoopFuture<DeleteProgressUpdateStreamResult> {
    ...
    public func associateDiscoveredResource(_ input: AssociateDiscoveredResourceRequest) throws -> EventLoopFuture<AssociateDiscoveredResourceResult> {
    ...
    public func associateCreatedArtifact(_ input: AssociateCreatedArtifactRequest) throws -> EventLoopFuture<AssociateCreatedArtifactResult> {
        return try client.send(operation: "AssociateCreatedArtifact", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list of all attributes associated with a specific migration task.
    public func describeMigrationTask(_ input: DescribeMigrationTaskRequest) throws -> EventLoopFuture<DescribeMigrationTaskResult> {
        return try client.send(operation: "DescribeMigrationTask", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the migration status of an application.
    public func describeApplicationState(_ input: DescribeApplicationStateRequest) throws -> EventLoopFuture<DescribeApplicationStateResult> {
    ...
    public func notifyMigrationTaskState(_ input: NotifyMigrationTaskStateRequest) throws -> EventLoopFuture<NotifyMigrationTaskStateResult> {
    ...
    public func importMigrationTask(_ input: ImportMigrationTaskRequest) throws -> EventLoopFuture<ImportMigrationTaskResult> {
    ...
    public func disassociateCreatedArtifact(_ input: DisassociateCreatedArtifactRequest) throws -> EventLoopFuture<DisassociateCreatedArtifactResult> {
