...
extension MigrationHub {
    ...
    public struct AssociateDiscoveredResourceRequest: AWSShape {
        ...
        public init(progressUpdateStream: String, dryRun: Bool? = nil, migrationTaskName: String, discoveredResource: DiscoveredResource) {
    ...
    public struct MigrationTask: AWSShape {
        ...
        public init(migrationTaskName: String? = nil, task: Task? = nil, progressUpdateStream: String? = nil, updateDateTime: TimeStamp? = nil, resourceAttributeList: [ResourceAttribute]? = nil) {
            self.migrationTaskName = migrationTaskName
            self.task = task
            self.progressUpdateStream = progressUpdateStream
    ...
    public struct NotifyApplicationStateRequest: AWSShape {
        ...
        public init(status: ApplicationStatus, applicationId: String, dryRun: Bool? = nil) {
            self.status = status
    ...
    public struct ListDiscoveredResourcesRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, migrationTaskName: String, maxResults: Int32? = nil, progressUpdateStream: String) {
            self.nextToken = nextToken
            self.migrationTaskName = migrationTaskName
    ...
    public struct ListCreatedArtifactsRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, migrationTaskName: String, progressUpdateStream: String, nextToken: String? = nil) {
            self.maxResults = maxResults
            self.migrationTaskName = migrationTaskName
            self.progressUpdateStream = progressUpdateStream
            self.nextToken = nextToken
    ...
    public struct DisassociateDiscoveredResourceRequest: AWSShape {
        ...
        public init(migrationTaskName: String, configurationId: String, progressUpdateStream: String, dryRun: Bool? = nil) {
            self.migrationTaskName = migrationTaskName
            self.configurationId = configurationId
            self.progressUpdateStream = progressUpdateStream
            self.dryRun = dryRun
    ...
    public struct AssociateCreatedArtifactRequest: AWSShape {
        ...
        public init(dryRun: Bool? = nil, createdArtifact: CreatedArtifact, migrationTaskName: String, progressUpdateStream: String) {
            self.dryRun = dryRun
    ...
    public struct Task: AWSShape {
        ...
        public init(statusDetail: String? = nil, progressPercent: Int32? = nil, status: Status) {
    ...
    public struct PutResourceAttributesRequest: AWSShape {
        ...
        public init(progressUpdateStream: String, migrationTaskName: String, resourceAttributeList: [ResourceAttribute], dryRun: Bool? = nil) {
            self.progressUpdateStream = progressUpdateStream
            self.migrationTaskName = migrationTaskName
            self.resourceAttributeList = resourceAttributeList
            self.dryRun = dryRun
    ...
    public struct NotifyMigrationTaskStateRequest: AWSShape {
        ...
        public init(nextUpdateSeconds: Int32, migrationTaskName: String, updateDateTime: TimeStamp, task: Task, dryRun: Bool? = nil, progressUpdateStream: String) {
    ...
    public struct MigrationTaskSummary: AWSShape {
        ...
        public init(statusDetail: String? = nil, updateDateTime: TimeStamp? = nil, status: Status? = nil, migrationTaskName: String? = nil, progressPercent: Int32? = nil, progressUpdateStream: String? = nil) {
            self.statusDetail = statusDetail
            self.updateDateTime = updateDateTime
            self.status = status
            self.migrationTaskName = migrationTaskName
