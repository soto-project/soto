...
public struct ConfigService {
    ...
    public func batchGetAggregateResourceConfig(_ input: BatchGetAggregateResourceConfigRequest) throws -> BatchGetAggregateResourceConfigResponse {
    ...
    public func getAggregateDiscoveredResourceCounts(_ input: GetAggregateDiscoveredResourceCountsRequest) throws -> GetAggregateDiscoveredResourceCountsResponse {
    ...
    public func getAggregateResourceConfig(_ input: GetAggregateResourceConfigRequest) throws -> GetAggregateResourceConfigResponse {
    ...
    public func listAggregateDiscoveredResources(_ input: ListAggregateDiscoveredResourcesRequest) throws -> ListAggregateDiscoveredResourcesResponse {
