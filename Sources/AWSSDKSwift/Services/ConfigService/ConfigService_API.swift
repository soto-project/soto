...
public struct ConfigService {
    ...
    public func describePendingAggregationRequests(_ input: DescribePendingAggregationRequestsRequest) throws -> EventLoopFuture<DescribePendingAggregationRequestsResponse> {
    ...
    public func describeConfigurationRecorders(_ input: DescribeConfigurationRecordersRequest) throws -> EventLoopFuture<DescribeConfigurationRecordersResponse> {
    ...
    public func getAggregateConfigRuleComplianceSummary(_ input: GetAggregateConfigRuleComplianceSummaryRequest) throws -> EventLoopFuture<GetAggregateConfigRuleComplianceSummaryResponse> {
    ...
    public func putConfigurationAggregator(_ input: PutConfigurationAggregatorRequest) throws -> EventLoopFuture<PutConfigurationAggregatorResponse> {
        return try client.send(operation: "PutConfigurationAggregator", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns configuration item that is aggregated for your specific resource in a specific source account and region.
    public func getAggregateResourceConfig(_ input: GetAggregateResourceConfigRequest) throws -> EventLoopFuture<GetAggregateResourceConfigResponse> {
        return try client.send(operation: "GetAggregateResourceConfig", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of authorizations granted to various aggregator accounts and regions.
    public func describeAggregationAuthorizations(_ input: DescribeAggregationAuthorizationsRequest) throws -> EventLoopFuture<DescribeAggregationAuthorizationsResponse> {
    ...
    public func describeConfigRules(_ input: DescribeConfigRulesRequest) throws -> EventLoopFuture<DescribeConfigRulesResponse> {
    ...
    public func listAggregateDiscoveredResources(_ input: ListAggregateDiscoveredResourcesRequest) throws -> EventLoopFuture<ListAggregateDiscoveredResourcesResponse> {
    ...
    public func describeConfigurationAggregatorSourcesStatus(_ input: DescribeConfigurationAggregatorSourcesStatusRequest) throws -> EventLoopFuture<DescribeConfigurationAggregatorSourcesStatusResponse> {
    ...
    public func getComplianceSummaryByResourceType(_ input: GetComplianceSummaryByResourceTypeRequest) throws -> EventLoopFuture<GetComplianceSummaryByResourceTypeResponse> {
    ...
    public func getResourceConfigHistory(_ input: GetResourceConfigHistoryRequest) throws -> EventLoopFuture<GetResourceConfigHistoryResponse> {
    ...
    public func batchGetResourceConfig(_ input: BatchGetResourceConfigRequest) throws -> EventLoopFuture<BatchGetResourceConfigResponse> {
    ...
    public func describeDeliveryChannels(_ input: DescribeDeliveryChannelsRequest) throws -> EventLoopFuture<DescribeDeliveryChannelsResponse> {
    ...
    public func putEvaluations(_ input: PutEvaluationsRequest) throws -> EventLoopFuture<PutEvaluationsResponse> {
        return try client.send(operation: "PutEvaluations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the number of AWS Config rules that are compliant and noncompliant, up to a maximum of 25 for each.
    public func getComplianceSummaryByConfigRule() throws -> EventLoopFuture<GetComplianceSummaryByConfigRuleResponse> {
    ...
    public func getDiscoveredResourceCounts(_ input: GetDiscoveredResourceCountsRequest) throws -> EventLoopFuture<GetDiscoveredResourceCountsResponse> {
    ...
    public func putRetentionConfiguration(_ input: PutRetentionConfigurationRequest) throws -> EventLoopFuture<PutRetentionConfigurationResponse> {
        return try client.send(operation: "PutRetentionConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Authorizes the aggregator account and region to collect data from the source account and region. 
    public func putAggregationAuthorization(_ input: PutAggregationAuthorizationRequest) throws -> EventLoopFuture<PutAggregationAuthorizationResponse> {
    ...
    public func getComplianceDetailsByConfigRule(_ input: GetComplianceDetailsByConfigRuleRequest) throws -> EventLoopFuture<GetComplianceDetailsByConfigRuleResponse> {
    ...
    public func describeConfigRuleEvaluationStatus(_ input: DescribeConfigRuleEvaluationStatusRequest) throws -> EventLoopFuture<DescribeConfigRuleEvaluationStatusResponse> {
    ...
    public func getAggregateDiscoveredResourceCounts(_ input: GetAggregateDiscoveredResourceCountsRequest) throws -> EventLoopFuture<GetAggregateDiscoveredResourceCountsResponse> {
    ...
    public func describeComplianceByResource(_ input: DescribeComplianceByResourceRequest) throws -> EventLoopFuture<DescribeComplianceByResourceResponse> {
    ...
    public func describeRetentionConfigurations(_ input: DescribeRetentionConfigurationsRequest) throws -> EventLoopFuture<DescribeRetentionConfigurationsResponse> {
    ...
    public func describeConfigurationAggregators(_ input: DescribeConfigurationAggregatorsRequest) throws -> EventLoopFuture<DescribeConfigurationAggregatorsResponse> {
    ...
    public func startConfigRulesEvaluation(_ input: StartConfigRulesEvaluationRequest) throws -> EventLoopFuture<StartConfigRulesEvaluationResponse> {
    ...
    public func deleteEvaluationResults(_ input: DeleteEvaluationResultsRequest) throws -> EventLoopFuture<DeleteEvaluationResultsResponse> {
    ...
    public func getAggregateComplianceDetailsByConfigRule(_ input: GetAggregateComplianceDetailsByConfigRuleRequest) throws -> EventLoopFuture<GetAggregateComplianceDetailsByConfigRuleResponse> {
    ...
    public func describeConfigurationRecorderStatus(_ input: DescribeConfigurationRecorderStatusRequest) throws -> EventLoopFuture<DescribeConfigurationRecorderStatusResponse> {
    ...
    public func describeDeliveryChannelStatus(_ input: DescribeDeliveryChannelStatusRequest) throws -> EventLoopFuture<DescribeDeliveryChannelStatusResponse> {
    ...
    public func describeComplianceByConfigRule(_ input: DescribeComplianceByConfigRuleRequest) throws -> EventLoopFuture<DescribeComplianceByConfigRuleResponse> {
    ...
    public func batchGetAggregateResourceConfig(_ input: BatchGetAggregateResourceConfigRequest) throws -> EventLoopFuture<BatchGetAggregateResourceConfigResponse> {
    ...
    public func deliverConfigSnapshot(_ input: DeliverConfigSnapshotRequest) throws -> EventLoopFuture<DeliverConfigSnapshotResponse> {
    ...
    public func listDiscoveredResources(_ input: ListDiscoveredResourcesRequest) throws -> EventLoopFuture<ListDiscoveredResourcesResponse> {
    ...
    public func describeAggregateComplianceByConfigRules(_ input: DescribeAggregateComplianceByConfigRulesRequest) throws -> EventLoopFuture<DescribeAggregateComplianceByConfigRulesResponse> {
    ...
    public func getComplianceDetailsByResource(_ input: GetComplianceDetailsByResourceRequest) throws -> EventLoopFuture<GetComplianceDetailsByResourceResponse> {
