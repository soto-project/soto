...
extension ConfigService {
    ...
    public struct Source: AWSShape {
        ...
        public init(sourceDetails: [SourceDetail]? = nil, sourceIdentifier: String, owner: Owner) {
    ...
    public struct DescribeAggregateComplianceByConfigRulesRequest: AWSShape {
        ...
        public init(filters: ConfigRuleComplianceFilters? = nil, nextToken: String? = nil, limit: Int32? = nil, configurationAggregatorName: String) {
    ...
    public struct ConfigurationAggregator: AWSShape {
        ...
        public init(configurationAggregatorArn: String? = nil, accountAggregationSources: [AccountAggregationSource]? = nil, organizationAggregationSource: OrganizationAggregationSource? = nil, configurationAggregatorName: String? = nil, lastUpdatedTime: TimeStamp? = nil, creationTime: TimeStamp? = nil) {
    ...
    public struct PutEvaluationsRequest: AWSShape {
        ...
        public init(testMode: Bool? = nil, evaluations: [Evaluation]? = nil, resultToken: String) {
    ...
    public struct ConfigurationRecorderStatus: AWSShape {
        ...
        public init(lastErrorCode: String? = nil, recording: Bool? = nil, lastStatusChangeTime: TimeStamp? = nil, lastErrorMessage: String? = nil, name: String? = nil, lastStatus: RecorderStatus? = nil, lastStopTime: TimeStamp? = nil, lastStartTime: TimeStamp? = nil) {
    ...
    public struct GetAggregateComplianceDetailsByConfigRuleRequest: AWSShape {
        ...
        public init(limit: Int32? = nil, complianceType: ComplianceType? = nil, nextToken: String? = nil, awsRegion: String, accountId: String, configRuleName: String, configurationAggregatorName: String) {
            self.limit = limit
    ...
    public struct ComplianceByResource: AWSShape {
        ...
        public init(resourceType: String? = nil, compliance: Compliance? = nil, resourceId: String? = nil) {
            self.resourceType = resourceType
    ...
    public struct Evaluation: AWSShape {
        ...
        public init(complianceResourceId: String, complianceType: ComplianceType, complianceResourceType: String, orderingTimestamp: TimeStamp, annotation: String? = nil) {
    ...
    public struct ResourceIdentifier: AWSShape {
        ...
        public init(resourceName: String? = nil, resourceType: ResourceType? = nil, resourceId: String? = nil, resourceDeletionTime: TimeStamp? = nil) {
    ...
    public struct GetDiscoveredResourceCountsResponse: AWSShape {
        ...
        public init(totalDiscoveredResources: Int64? = nil, resourceCounts: [ResourceCount]? = nil, nextToken: String? = nil) {
    ...
    public struct ConfigurationRecorder: AWSShape {
        ...
        public init(roleARN: String? = nil, name: String? = nil, recordingGroup: RecordingGroup? = nil) {
            self.roleARN = roleARN
            self.name = name
    ...
    public struct GetAggregateDiscoveredResourceCountsRequest: AWSShape {
        ...
        public init(filters: ResourceCountFilters? = nil, nextToken: String? = nil, limit: Int32? = nil, groupByKey: ResourceCountGroupKey? = nil, configurationAggregatorName: String) {
            self.filters = filters
            self.nextToken = nextToken
            self.limit = limit
            self.groupByKey = groupByKey
    ...
    public struct AggregateResourceIdentifier: AWSShape {
        ...
        public init(resourceType: ResourceType, resourceName: String? = nil, resourceId: String, sourceRegion: String, sourceAccountId: String) {
            self.resourceType = resourceType
            self.resourceName = resourceName
            self.resourceId = resourceId
    ...
    public struct DeliveryChannel: AWSShape {
        ...
        public init(configSnapshotDeliveryProperties: ConfigSnapshotDeliveryProperties? = nil, snsTopicARN: String? = nil, name: String? = nil, s3KeyPrefix: String? = nil, s3BucketName: String? = nil) {
    ...
    public struct BaseConfigurationItem: AWSShape {
        ...
        public init(configurationItemStatus: ConfigurationItemStatus? = nil, availabilityZone: String? = nil, resourceType: ResourceType? = nil, resourceName: String? = nil, arn: String? = nil, configuration: String? = nil, awsRegion: String? = nil, supplementaryConfiguration: [String: String]? = nil, resourceId: String? = nil, version: String? = nil, configurationStateId: String? = nil, configurationItemCaptureTime: TimeStamp? = nil, resourceCreationTime: TimeStamp? = nil, accountId: String? = nil) {
    ...
    public struct EvaluationResult: AWSShape {
        ...
        public init(complianceType: ComplianceType? = nil, resultRecordedTime: TimeStamp? = nil, configRuleInvokedTime: TimeStamp? = nil, evaluationResultIdentifier: EvaluationResultIdentifier? = nil, resultToken: String? = nil, annotation: String? = nil) {
            self.complianceType = complianceType
    ...
    public struct GetComplianceDetailsByConfigRuleRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, configRuleName: String, limit: Int32? = nil, complianceTypes: [ComplianceType]? = nil) {
            self.nextToken = nextToken
            self.configRuleName = configRuleName
            self.limit = limit
    ...
    public struct DeliveryChannelStatus: AWSShape {
        ...
        public init(configStreamDeliveryInfo: ConfigStreamDeliveryInfo? = nil, configSnapshotDeliveryInfo: ConfigExportDeliveryInfo? = nil, configHistoryDeliveryInfo: ConfigExportDeliveryInfo? = nil, name: String? = nil) {
    ...
    public struct ConfigurationItem: AWSShape {
        ...
        public init(relatedEvents: [String]? = nil, tags: [String: String]? = nil, configurationItemStatus: ConfigurationItemStatus? = nil, availabilityZone: String? = nil, resourceType: ResourceType? = nil, resourceName: String? = nil, arn: String? = nil, configuration: String? = nil, awsRegion: String? = nil, supplementaryConfiguration: [String: String]? = nil, resourceId: String? = nil, version: String? = nil, configurationStateId: String? = nil, configurationItemCaptureTime: TimeStamp? = nil, resourceCreationTime: TimeStamp? = nil, accountId: String? = nil, relationships: [Relationship]? = nil, configurationItemMD5Hash: String? = nil) {
    ...
    public struct DescribeComplianceByConfigRuleRequest: AWSShape {
        ...
        public init(configRuleNames: [String]? = nil, complianceTypes: [ComplianceType]? = nil, nextToken: String? = nil) {
            self.configRuleNames = configRuleNames
            self.complianceTypes = complianceTypes
            self.nextToken = nextToken
        }
    ...
    public struct ResourceFilters: AWSShape {
        ...
        public init(resourceName: String? = nil, resourceId: String? = nil, region: String? = nil, accountId: String? = nil) {
            self.resourceName = resourceName
            self.resourceId = resourceId
            self.region = region
            self.accountId = accountId
    ...
    public struct ConfigExportDeliveryInfo: AWSShape {
        ...
        public init(lastErrorMessage: String? = nil, nextDeliveryTime: TimeStamp? = nil, lastAttemptTime: TimeStamp? = nil, lastStatus: DeliveryStatus? = nil, lastErrorCode: String? = nil, lastSuccessfulTime: TimeStamp? = nil) {
            self.lastErrorMessage = lastErrorMessage
    ...
    public struct GetAggregateConfigRuleComplianceSummaryRequest: AWSShape {
        ...
        public init(filters: ConfigRuleComplianceSummaryFilters? = nil, nextToken: String? = nil, limit: Int32? = nil, groupByKey: ConfigRuleComplianceSummaryGroupKey? = nil, configurationAggregatorName: String) {
            self.filters = filters
            self.nextToken = nextToken
            self.limit = limit
            self.groupByKey = groupByKey
    ...
    public struct PutConfigurationAggregatorRequest: AWSShape {
        ...
        public init(organizationAggregationSource: OrganizationAggregationSource? = nil, accountAggregationSources: [AccountAggregationSource]? = nil, configurationAggregatorName: String) {
            self.organizationAggregationSource = organizationAggregationSource
            self.accountAggregationSources = accountAggregationSources
            self.configurationAggregatorName = configurationAggregatorName
        }
    ...
    public struct AggregatedSourceStatus: AWSShape {
        ...
        public init(lastUpdateStatus: AggregatedSourceStatusType? = nil, lastErrorMessage: String? = nil, lastUpdateTime: TimeStamp? = nil, sourceType: AggregatedSourceType? = nil, awsRegion: String? = nil, lastErrorCode: String? = nil, sourceId: String? = nil) {
    ...
    public struct ConfigRuleComplianceFilters: AWSShape {
        ...
        public init(configRuleName: String? = nil, complianceType: ComplianceType? = nil, awsRegion: String? = nil, accountId: String? = nil) {
            self.configRuleName = configRuleName
            self.complianceType = complianceType
            self.awsRegion = awsRegion
            self.accountId = accountId
    ...
    public struct ListDiscoveredResourcesRequest: AWSShape {
        ...
        public init(resourceName: String? = nil, resourceIds: [String]? = nil, resourceType: ResourceType, includeDeletedResources: Bool? = nil, nextToken: String? = nil, limit: Int32? = nil) {
            self.resourceName = resourceName
    ...
    public struct GetComplianceDetailsByResourceRequest: AWSShape {
        ...
        public init(resourceType: String, nextToken: String? = nil, resourceId: String, complianceTypes: [ComplianceType]? = nil) {
            self.resourceType = resourceType
            self.nextToken = nextToken
            self.resourceId = resourceId
            self.complianceTypes = complianceTypes
    ...
    public struct ConfigStreamDeliveryInfo: AWSShape {
        ...
        public init(lastErrorMessage: String? = nil, lastStatus: DeliveryStatus? = nil, lastErrorCode: String? = nil, lastStatusChangeTime: TimeStamp? = nil) {
            self.lastErrorMessage = lastErrorMessage
            self.lastStatus = lastStatus
            self.lastErrorCode = lastErrorCode
            self.lastStatusChangeTime = lastStatusChangeTime
    ...
    public struct AggregateComplianceByConfigRule: AWSShape {
        ...
        public init(compliance: Compliance? = nil, configRuleName: String? = nil, awsRegion: String? = nil, accountId: String? = nil) {
            self.compliance = compliance
            self.configRuleName = configRuleName
            self.awsRegion = awsRegion
            self.accountId = accountId
    ...
    public struct ListAggregateDiscoveredResourcesRequest: AWSShape {
        ...
        public init(resourceType: ResourceType, filters: ResourceFilters? = nil, nextToken: String? = nil, limit: Int32? = nil, configurationAggregatorName: String) {
            self.resourceType = resourceType
            self.filters = filters
            self.nextToken = nextToken
            self.limit = limit
    ...
    public struct ConfigRule: AWSShape {
        ...
        public init(configRuleState: ConfigRuleState? = nil, maximumExecutionFrequency: MaximumExecutionFrequency? = nil, configRuleId: String? = nil, inputParameters: String? = nil, createdBy: String? = nil, scope: Scope? = nil, configRuleName: String? = nil, source: Source, configRuleArn: String? = nil, description: String? = nil) {
    ...
    public struct Scope: AWSShape {
        ...
        public init(tagKey: String? = nil, complianceResourceId: String? = nil, tagValue: String? = nil, complianceResourceTypes: [String]? = nil) {
            self.tagKey = tagKey
            self.complianceResourceId = complianceResourceId
    ...
    public struct AggregateEvaluationResult: AWSShape {
        ...
        public init(annotation: String? = nil, complianceType: ComplianceType? = nil, evaluationResultIdentifier: EvaluationResultIdentifier? = nil, awsRegion: String? = nil, accountId: String? = nil, configRuleInvokedTime: TimeStamp? = nil, resultRecordedTime: TimeStamp? = nil) {
            self.annotation = annotation
            self.complianceType = complianceType
            self.evaluationResultIdentifier = evaluationResultIdentifier
            self.awsRegion = awsRegion
    ...
    public struct Relationship: AWSShape {
        ...
        public init(resourceName: String? = nil, resourceType: ResourceType? = nil, resourceId: String? = nil, relationshipName: String? = nil) {
            self.resourceName = resourceName
            self.resourceType = resourceType
            self.resourceId = resourceId
    ...
    public struct GetResourceConfigHistoryRequest: AWSShape {
        ...
        public init(limit: Int32? = nil, laterTime: TimeStamp? = nil, resourceId: String, nextToken: String? = nil, earlierTime: TimeStamp? = nil, chronologicalOrder: ChronologicalOrder? = nil, resourceType: ResourceType) {
            self.limit = limit
    ...
    public struct ConfigRuleEvaluationStatus: AWSShape {
        ...
        public init(configRuleId: String? = nil, lastErrorMessage: String? = nil, firstActivatedTime: TimeStamp? = nil, lastSuccessfulEvaluationTime: TimeStamp? = nil, lastFailedInvocationTime: TimeStamp? = nil, lastErrorCode: String? = nil, lastSuccessfulInvocationTime: TimeStamp? = nil, configRuleName: String? = nil, configRuleArn: String? = nil, lastFailedEvaluationTime: TimeStamp? = nil, firstEvaluationStarted: Bool? = nil) {
            self.configRuleId = configRuleId
            self.lastErrorMessage = lastErrorMessage
