...
extension ConfigService {
    ...
    public func describeRemediationExceptionsPaginator(_ input: DescribeRemediationExceptionsRequest) -> EventLoopFuture<[RemediationException]> {
        return client.paginate(input: input, command: describeRemediationExceptions, resultKey: \DescribeRemediationExceptionsResponse.remediationExceptions, tokenKey: \DescribeRemediationExceptionsResponse.nextToken)
    }
    ...
    public func describeRemediationExecutionStatusPaginator(_ input: DescribeRemediationExecutionStatusRequest) -> EventLoopFuture<[RemediationExecutionStatus]> {
        return client.paginate(input: input, command: describeRemediationExecutionStatus, resultKey: \DescribeRemediationExecutionStatusResponse.remediationExecutionStatuses, tokenKey: \DescribeRemediationExecutionStatusResponse.nextToken)
    }
    ...
    public func getResourceConfigHistoryPaginator(_ input: GetResourceConfigHistoryRequest) -> EventLoopFuture<[ConfigurationItem]> {
        return client.paginate(input: input, command: getResourceConfigHistory, resultKey: \GetResourceConfigHistoryResponse.configurationItems, tokenKey: \GetResourceConfigHistoryResponse.nextToken)
    }
