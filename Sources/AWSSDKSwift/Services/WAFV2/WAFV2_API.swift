...
public struct WAFV2 {
    ...
    public func associateWebACL(_ input: AssociateWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AssociateWebACLResponse> {
        return client.execute(operation: "AssociateWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func checkCapacity(_ input: CheckCapacityRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CheckCapacityResponse> {
        return client.execute(operation: "CheckCapacity", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createIPSet(_ input: CreateIPSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateIPSetResponse> {
        return client.execute(operation: "CreateIPSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createRegexPatternSet(_ input: CreateRegexPatternSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateRegexPatternSetResponse> {
        return client.execute(operation: "CreateRegexPatternSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createRuleGroup(_ input: CreateRuleGroupRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateRuleGroupResponse> {
        return client.execute(operation: "CreateRuleGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createWebACL(_ input: CreateWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateWebACLResponse> {
        return client.execute(operation: "CreateWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteFirewallManagerRuleGroups(_ input: DeleteFirewallManagerRuleGroupsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteFirewallManagerRuleGroupsResponse> {
        return client.execute(operation: "DeleteFirewallManagerRuleGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteIPSet(_ input: DeleteIPSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteIPSetResponse> {
        return client.execute(operation: "DeleteIPSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteLoggingConfiguration(_ input: DeleteLoggingConfigurationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteLoggingConfigurationResponse> {
        return client.execute(operation: "DeleteLoggingConfiguration", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deletePermissionPolicy(_ input: DeletePermissionPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeletePermissionPolicyResponse> {
        return client.execute(operation: "DeletePermissionPolicy", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteRegexPatternSet(_ input: DeleteRegexPatternSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteRegexPatternSetResponse> {
        return client.execute(operation: "DeleteRegexPatternSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteRuleGroup(_ input: DeleteRuleGroupRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteRuleGroupResponse> {
        return client.execute(operation: "DeleteRuleGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteWebACL(_ input: DeleteWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteWebACLResponse> {
        return client.execute(operation: "DeleteWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeManagedRuleGroup(_ input: DescribeManagedRuleGroupRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeManagedRuleGroupResponse> {
        return client.execute(operation: "DescribeManagedRuleGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func disassociateWebACL(_ input: DisassociateWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DisassociateWebACLResponse> {
        return client.execute(operation: "DisassociateWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getIPSet(_ input: GetIPSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetIPSetResponse> {
        return client.execute(operation: "GetIPSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getLoggingConfiguration(_ input: GetLoggingConfigurationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetLoggingConfigurationResponse> {
        return client.execute(operation: "GetLoggingConfiguration", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getPermissionPolicy(_ input: GetPermissionPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetPermissionPolicyResponse> {
        return client.execute(operation: "GetPermissionPolicy", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getRateBasedStatementManagedKeys(_ input: GetRateBasedStatementManagedKeysRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetRateBasedStatementManagedKeysResponse> {
        return client.execute(operation: "GetRateBasedStatementManagedKeys", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getRegexPatternSet(_ input: GetRegexPatternSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetRegexPatternSetResponse> {
        return client.execute(operation: "GetRegexPatternSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getRuleGroup(_ input: GetRuleGroupRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetRuleGroupResponse> {
        return client.execute(operation: "GetRuleGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getSampledRequests(_ input: GetSampledRequestsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetSampledRequestsResponse> {
        return client.execute(operation: "GetSampledRequests", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getWebACL(_ input: GetWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetWebACLResponse> {
        return client.execute(operation: "GetWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getWebACLForResource(_ input: GetWebACLForResourceRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetWebACLForResourceResponse> {
        return client.execute(operation: "GetWebACLForResource", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listAvailableManagedRuleGroups(_ input: ListAvailableManagedRuleGroupsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListAvailableManagedRuleGroupsResponse> {
        return client.execute(operation: "ListAvailableManagedRuleGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listIPSets(_ input: ListIPSetsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListIPSetsResponse> {
        return client.execute(operation: "ListIPSets", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listLoggingConfigurations(_ input: ListLoggingConfigurationsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListLoggingConfigurationsResponse> {
        return client.execute(operation: "ListLoggingConfigurations", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listRegexPatternSets(_ input: ListRegexPatternSetsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListRegexPatternSetsResponse> {
        return client.execute(operation: "ListRegexPatternSets", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listResourcesForWebACL(_ input: ListResourcesForWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListResourcesForWebACLResponse> {
        return client.execute(operation: "ListResourcesForWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listRuleGroups(_ input: ListRuleGroupsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListRuleGroupsResponse> {
        return client.execute(operation: "ListRuleGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listWebACLs(_ input: ListWebACLsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListWebACLsResponse> {
        return client.execute(operation: "ListWebACLs", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putLoggingConfiguration(_ input: PutLoggingConfigurationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutLoggingConfigurationResponse> {
        return client.execute(operation: "PutLoggingConfiguration", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putPermissionPolicy(_ input: PutPermissionPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutPermissionPolicyResponse> {
        return client.execute(operation: "PutPermissionPolicy", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateIPSet(_ input: UpdateIPSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateIPSetResponse> {
        return client.execute(operation: "UpdateIPSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateRegexPatternSet(_ input: UpdateRegexPatternSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateRegexPatternSetResponse> {
        return client.execute(operation: "UpdateRegexPatternSet", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateRuleGroup(_ input: UpdateRuleGroupRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateRuleGroupResponse> {
        return client.execute(operation: "UpdateRuleGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateWebACL(_ input: UpdateWebACLRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateWebACLResponse> {
        return client.execute(operation: "UpdateWebACL", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
