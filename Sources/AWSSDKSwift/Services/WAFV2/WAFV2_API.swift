...
public struct WAFV2: AWSService {
    ...
    public func associateWebACL(_ input: AssociateWebACLRequest) -> EventLoopFuture<AssociateWebACLResponse> {
        return client.execute(operation: "AssociateWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func checkCapacity(_ input: CheckCapacityRequest) -> EventLoopFuture<CheckCapacityResponse> {
        return client.execute(operation: "CheckCapacity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createIPSet(_ input: CreateIPSetRequest) -> EventLoopFuture<CreateIPSetResponse> {
        return client.execute(operation: "CreateIPSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createRegexPatternSet(_ input: CreateRegexPatternSetRequest) -> EventLoopFuture<CreateRegexPatternSetResponse> {
        return client.execute(operation: "CreateRegexPatternSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createRuleGroup(_ input: CreateRuleGroupRequest) -> EventLoopFuture<CreateRuleGroupResponse> {
        return client.execute(operation: "CreateRuleGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createWebACL(_ input: CreateWebACLRequest) -> EventLoopFuture<CreateWebACLResponse> {
        return client.execute(operation: "CreateWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteFirewallManagerRuleGroups(_ input: DeleteFirewallManagerRuleGroupsRequest) -> EventLoopFuture<DeleteFirewallManagerRuleGroupsResponse> {
        return client.execute(operation: "DeleteFirewallManagerRuleGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteIPSet(_ input: DeleteIPSetRequest) -> EventLoopFuture<DeleteIPSetResponse> {
        return client.execute(operation: "DeleteIPSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteLoggingConfiguration(_ input: DeleteLoggingConfigurationRequest) -> EventLoopFuture<DeleteLoggingConfigurationResponse> {
        return client.execute(operation: "DeleteLoggingConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deletePermissionPolicy(_ input: DeletePermissionPolicyRequest) -> EventLoopFuture<DeletePermissionPolicyResponse> {
        return client.execute(operation: "DeletePermissionPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteRegexPatternSet(_ input: DeleteRegexPatternSetRequest) -> EventLoopFuture<DeleteRegexPatternSetResponse> {
        return client.execute(operation: "DeleteRegexPatternSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteRuleGroup(_ input: DeleteRuleGroupRequest) -> EventLoopFuture<DeleteRuleGroupResponse> {
        return client.execute(operation: "DeleteRuleGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteWebACL(_ input: DeleteWebACLRequest) -> EventLoopFuture<DeleteWebACLResponse> {
        return client.execute(operation: "DeleteWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeManagedRuleGroup(_ input: DescribeManagedRuleGroupRequest) -> EventLoopFuture<DescribeManagedRuleGroupResponse> {
        return client.execute(operation: "DescribeManagedRuleGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disassociateWebACL(_ input: DisassociateWebACLRequest) -> EventLoopFuture<DisassociateWebACLResponse> {
        return client.execute(operation: "DisassociateWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getIPSet(_ input: GetIPSetRequest) -> EventLoopFuture<GetIPSetResponse> {
        return client.execute(operation: "GetIPSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getLoggingConfiguration(_ input: GetLoggingConfigurationRequest) -> EventLoopFuture<GetLoggingConfigurationResponse> {
        return client.execute(operation: "GetLoggingConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getPermissionPolicy(_ input: GetPermissionPolicyRequest) -> EventLoopFuture<GetPermissionPolicyResponse> {
        return client.execute(operation: "GetPermissionPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getRateBasedStatementManagedKeys(_ input: GetRateBasedStatementManagedKeysRequest) -> EventLoopFuture<GetRateBasedStatementManagedKeysResponse> {
        return client.execute(operation: "GetRateBasedStatementManagedKeys", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getRegexPatternSet(_ input: GetRegexPatternSetRequest) -> EventLoopFuture<GetRegexPatternSetResponse> {
        return client.execute(operation: "GetRegexPatternSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getRuleGroup(_ input: GetRuleGroupRequest) -> EventLoopFuture<GetRuleGroupResponse> {
        return client.execute(operation: "GetRuleGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSampledRequests(_ input: GetSampledRequestsRequest) -> EventLoopFuture<GetSampledRequestsResponse> {
        return client.execute(operation: "GetSampledRequests", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getWebACL(_ input: GetWebACLRequest) -> EventLoopFuture<GetWebACLResponse> {
        return client.execute(operation: "GetWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getWebACLForResource(_ input: GetWebACLForResourceRequest) -> EventLoopFuture<GetWebACLForResourceResponse> {
        return client.execute(operation: "GetWebACLForResource", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAvailableManagedRuleGroups(_ input: ListAvailableManagedRuleGroupsRequest) -> EventLoopFuture<ListAvailableManagedRuleGroupsResponse> {
        return client.execute(operation: "ListAvailableManagedRuleGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listIPSets(_ input: ListIPSetsRequest) -> EventLoopFuture<ListIPSetsResponse> {
        return client.execute(operation: "ListIPSets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listLoggingConfigurations(_ input: ListLoggingConfigurationsRequest) -> EventLoopFuture<ListLoggingConfigurationsResponse> {
        return client.execute(operation: "ListLoggingConfigurations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listRegexPatternSets(_ input: ListRegexPatternSetsRequest) -> EventLoopFuture<ListRegexPatternSetsResponse> {
        return client.execute(operation: "ListRegexPatternSets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listResourcesForWebACL(_ input: ListResourcesForWebACLRequest) -> EventLoopFuture<ListResourcesForWebACLResponse> {
        return client.execute(operation: "ListResourcesForWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listRuleGroups(_ input: ListRuleGroupsRequest) -> EventLoopFuture<ListRuleGroupsResponse> {
        return client.execute(operation: "ListRuleGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listWebACLs(_ input: ListWebACLsRequest) -> EventLoopFuture<ListWebACLsResponse> {
        return client.execute(operation: "ListWebACLs", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putLoggingConfiguration(_ input: PutLoggingConfigurationRequest) -> EventLoopFuture<PutLoggingConfigurationResponse> {
        return client.execute(operation: "PutLoggingConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putPermissionPolicy(_ input: PutPermissionPolicyRequest) -> EventLoopFuture<PutPermissionPolicyResponse> {
        return client.execute(operation: "PutPermissionPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateIPSet(_ input: UpdateIPSetRequest) -> EventLoopFuture<UpdateIPSetResponse> {
        return client.execute(operation: "UpdateIPSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateRegexPatternSet(_ input: UpdateRegexPatternSetRequest) -> EventLoopFuture<UpdateRegexPatternSetResponse> {
        return client.execute(operation: "UpdateRegexPatternSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateRuleGroup(_ input: UpdateRuleGroupRequest) -> EventLoopFuture<UpdateRuleGroupResponse> {
        return client.execute(operation: "UpdateRuleGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateWebACL(_ input: UpdateWebACLRequest) -> EventLoopFuture<UpdateWebACLResponse> {
        return client.execute(operation: "UpdateWebACL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
