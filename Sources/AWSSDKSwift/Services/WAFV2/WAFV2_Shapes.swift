...
extension WAFV2 {
    ...
    public struct DeleteFirewallManagerRuleGroupsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "WebACLArn", required: true, type: .string), 
            AWSShapeMember(label: "WebACLLockToken", required: true, type: .string)
        ]
    ...
    public struct DeleteFirewallManagerRuleGroupsResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "NextWebACLLockToken", required: false, type: .string)
        ]
    ...
    public struct FirewallManagerRuleGroup: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "FirewallManagerStatement", required: true, type: .structure), 
            AWSShapeMember(label: "Name", required: true, type: .string), 
            AWSShapeMember(label: "OverrideAction", required: true, type: .structure), 
    ...
    public struct ForwardedIPConfig: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "FallbackBehavior", required: true, type: .enum), 
    ...
    public struct GeoMatchStatement: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "ForwardedIPConfig", required: false, type: .structure)
        ]
    ...
    public struct IPSetForwardedIPConfig: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "FallbackBehavior", required: true, type: .enum), 
            AWSShapeMember(label: "HeaderName", required: true, type: .string), 
            AWSShapeMember(label: "Position", required: true, type: .enum)
        ]
    ...
    public struct IPSetReferenceStatement: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ARN", required: true, type: .string), 
            AWSShapeMember(label: "IPSetForwardedIPConfig", required: false, type: .structure)
        ]
    ...
    public struct LoggingConfiguration: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "ManagedByFirewallManager", required: false, type: .boolean), 
    ...
    public struct WebACL: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "ManagedByFirewallManager", required: false, type: .boolean), 
            AWSShapeMember(label: "Name", required: true, type: .string), 
            AWSShapeMember(label: "PostProcessFirewallManagerRuleGroups", required: false, type: .list), 
            AWSShapeMember(label: "PreProcessFirewallManagerRuleGroups", required: false, type: .list), 
            AWSShapeMember(label: "Rules", required: false, type: .list), 
            AWSShapeMember(label: "VisibilityConfig", required: true, type: .structure)
        ]
