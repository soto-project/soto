...
extension FSx {
    ...
    public func describeDataRepositoryTasksPaginator(_ input: DescribeDataRepositoryTasksRequest, onPage: @escaping ([DataRepositoryTask], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeDataRepositoryTasks, resultKey: \DescribeDataRepositoryTasksResponse.dataRepositoryTasks, tokenKey: \DescribeDataRepositoryTasksResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeFileSystemsPaginator(_ input: DescribeFileSystemsRequest, onPage: @escaping ([FileSystem], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeFileSystems, resultKey: \DescribeFileSystemsResponse.fileSystems, tokenKey: \DescribeFileSystemsResponse.nextToken, onPage: onPage)
    }
