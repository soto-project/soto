...
extension FSx {
    ...
    public func describeDataRepositoryTasksPaginator(_ input: DescribeDataRepositoryTasksRequest) -> EventLoopFuture<[DataRepositoryTask]> {
        return client.paginate(input: input, command: describeDataRepositoryTasks, resultKey: \DescribeDataRepositoryTasksResponse.dataRepositoryTasks, tokenKey: \DescribeDataRepositoryTasksResponse.nextToken)
    }
    ...
    public func describeFileSystemsPaginator(_ input: DescribeFileSystemsRequest) -> EventLoopFuture<[FileSystem]> {
        return client.paginate(input: input, command: describeFileSystems, resultKey: \DescribeFileSystemsResponse.fileSystems, tokenKey: \DescribeFileSystemsResponse.nextToken)
    }
