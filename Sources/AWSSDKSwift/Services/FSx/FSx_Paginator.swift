...
extension FSx {
    ...
    public func describeDataRepositoryTasksPaginator(_ input: DescribeDataRepositoryTasksRequest) -> EventLoopFuture<[DataRepositoryTask]> {
        return client.paginate(input: input, command: describeDataRepositoryTasks, resultKey: \.dataRepositoryTasks, tokenKey: \.nextToken)
    }
    ...
    public func describeFileSystemsPaginator(_ input: DescribeFileSystemsRequest) -> EventLoopFuture<[FileSystem]> {
        return client.paginate(input: input, command: describeFileSystems, resultKey: \.fileSystems, tokenKey: \.nextToken)
    }
