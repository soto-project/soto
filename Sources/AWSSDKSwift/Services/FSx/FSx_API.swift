...
public struct FSx {
    ...
    public func deleteFileSystem(_ input: DeleteFileSystemRequest) throws -> DeleteFileSystemResponse {
    ...
    public func createFileSystemFromBackup(_ input: CreateFileSystemFromBackupRequest) throws -> CreateFileSystemFromBackupResponse {
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest) throws -> CreateFileSystemResponse {
        return try client.send(operation: "CreateFileSystem", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates a file system configuration.
    public func updateFileSystem(_ input: UpdateFileSystemRequest) throws -> UpdateFileSystemResponse {
