...
public struct FSx: AWSService {
    ...
    /// return new `FSx` with new timeout value
    ...
    /// return new `FSx` logging to specified Logger
    ...
    public func cancelDataRepositoryTask(_ input: CancelDataRepositoryTaskRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelDataRepositoryTaskResponse> {
        return client.execute(operation: "CancelDataRepositoryTask", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createBackup(_ input: CreateBackupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBackupResponse> {
    ...
    public func createDataRepositoryTask(_ input: CreateDataRepositoryTaskRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDataRepositoryTaskResponse> {
        return client.execute(operation: "CreateDataRepositoryTask", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFileSystemResponse> {
        return client.execute(operation: "CreateFileSystem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createFileSystemFromBackup(_ input: CreateFileSystemFromBackupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFileSystemFromBackupResponse> {
        return client.execute(operation: "CreateFileSystemFromBackup", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteFileSystem(_ input: DeleteFileSystemRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFileSystemResponse> {
        return client.execute(operation: "DeleteFileSystem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeBackups(_ input: DescribeBackupsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBackupsResponse> {
        return client.execute(operation: "DescribeBackups", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeDataRepositoryTasks(_ input: DescribeDataRepositoryTasksRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDataRepositoryTasksResponse> {
        return client.execute(operation: "DescribeDataRepositoryTasks", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeFileSystems(_ input: DescribeFileSystemsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFileSystemsResponse> {
        return client.execute(operation: "DescribeFileSystems", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateFileSystem(_ input: UpdateFileSystemRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFileSystemResponse> {
        return client.execute(operation: "UpdateFileSystem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
