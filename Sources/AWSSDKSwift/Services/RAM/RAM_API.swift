...
public struct RAM {
    ...
    public func acceptResourceShareInvitation(_ input: AcceptResourceShareInvitationRequest) throws -> EventLoopFuture<AcceptResourceShareInvitationResponse> {
    ...
    public func getResourceShareInvitations(_ input: GetResourceShareInvitationsRequest) throws -> EventLoopFuture<GetResourceShareInvitationsResponse> {
    ...
    public func getResourceShareAssociations(_ input: GetResourceShareAssociationsRequest) throws -> EventLoopFuture<GetResourceShareAssociationsResponse> {
    ...
    public func associateResourceShare(_ input: AssociateResourceShareRequest) throws -> EventLoopFuture<AssociateResourceShareResponse> {
    ...
    public func listPrincipals(_ input: ListPrincipalsRequest) throws -> EventLoopFuture<ListPrincipalsResponse> {
    ...
    public func enableSharingWithAwsOrganization(_ input: EnableSharingWithAwsOrganizationRequest) throws -> EventLoopFuture<EnableSharingWithAwsOrganizationResponse> {
    ...
    public func disassociateResourceShare(_ input: DisassociateResourceShareRequest) throws -> EventLoopFuture<DisassociateResourceShareResponse> {
    ...
    public func deleteResourceShare(_ input: DeleteResourceShareRequest) throws -> EventLoopFuture<DeleteResourceShareResponse> {
        return try client.send(operation: "DeleteResourceShare", path: "/deleteresourceshare", httpMethod: "DELETE", input: input)
    }

    ///  Creates a resource share.
    public func createResourceShare(_ input: CreateResourceShareRequest) throws -> EventLoopFuture<CreateResourceShareResponse> {
        return try client.send(operation: "CreateResourceShare", path: "/createresourceshare", httpMethod: "POST", input: input)
    }

    ///  Gets the policies for the specifies resources.
    public func getResourcePolicies(_ input: GetResourcePoliciesRequest) throws -> EventLoopFuture<GetResourcePoliciesResponse> {
    ...
    public func updateResourceShare(_ input: UpdateResourceShareRequest) throws -> EventLoopFuture<UpdateResourceShareResponse> {
        return try client.send(operation: "UpdateResourceShare", path: "/updateresourceshare", httpMethod: "POST", input: input)
    }

    ///  Rejects an invitation to a resource share from another AWS account.
    public func rejectResourceShareInvitation(_ input: RejectResourceShareInvitationRequest) throws -> EventLoopFuture<RejectResourceShareInvitationResponse> {
    ...
    public func getResourceShares(_ input: GetResourceSharesRequest) throws -> EventLoopFuture<GetResourceSharesResponse> {
