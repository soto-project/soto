...
public struct SQS {
    ...
    public init(accessKeyId: String? = nil, secretAccessKey: String? = nil, region: AWSSDKSwiftCore.Region? = nil, endpoint: String? = nil) {
        self.client = AWSClient(
            ...
            endpoint: endpoint,
            serviceEndpoints: ["fips-us-east-2": "sqs-fips.us-east-2.amazonaws.com", "fips-us-west-1": "sqs-fips.us-west-1.amazonaws.com", "fips-us-east-1": "sqs-fips.us-east-1.amazonaws.com", "fips-us-west-2": "sqs-fips.us-west-2.amazonaws.com"],
            middlewares: [],
    ...
    public func receiveMessage(_ input: ReceiveMessageRequest) throws -> EventLoopFuture<ReceiveMessageResult> {
    ...
    public func listQueueTags(_ input: ListQueueTagsRequest) throws -> EventLoopFuture<ListQueueTagsResult> {
    ...
    public func getQueueUrl(_ input: GetQueueUrlRequest) throws -> EventLoopFuture<GetQueueUrlResult> {
    ...
    public func changeMessageVisibilityBatch(_ input: ChangeMessageVisibilityBatchRequest) throws -> EventLoopFuture<ChangeMessageVisibilityBatchResult> {
    ...
    public func deleteMessageBatch(_ input: DeleteMessageBatchRequest) throws -> EventLoopFuture<DeleteMessageBatchResult> {
    ...
    public func sendMessage(_ input: SendMessageRequest) throws -> EventLoopFuture<SendMessageResult> {
    ...
    public func createQueue(_ input: CreateQueueRequest) throws -> EventLoopFuture<CreateQueueResult> {
    ...
    public func sendMessageBatch(_ input: SendMessageBatchRequest) throws -> EventLoopFuture<SendMessageBatchResult> {
    ...
    public func getQueueAttributes(_ input: GetQueueAttributesRequest) throws -> EventLoopFuture<GetQueueAttributesResult> {
    ...
    public func listQueues(_ input: ListQueuesRequest) throws -> EventLoopFuture<ListQueuesResult> {
    ...
    public func listDeadLetterSourceQueues(_ input: ListDeadLetterSourceQueuesRequest) throws -> EventLoopFuture<ListDeadLetterSourceQueuesResult> {
