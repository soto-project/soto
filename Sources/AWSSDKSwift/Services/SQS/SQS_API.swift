...
public struct SQS {
    ...
    @discardableResult public func addPermission(_ input: AddPermissionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func changeMessageVisibility(_ input: ChangeMessageVisibilityRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "ChangeMessageVisibility", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func changeMessageVisibilityBatch(_ input: ChangeMessageVisibilityBatchRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeMessageVisibilityBatchResult> {
        return client.execute(operation: "ChangeMessageVisibilityBatch", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createQueue(_ input: CreateQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateQueueResult> {
        return client.execute(operation: "CreateQueue", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteMessage(_ input: DeleteMessageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteMessage", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteMessageBatch(_ input: DeleteMessageBatchRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMessageBatchResult> {
        return client.execute(operation: "DeleteMessageBatch", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteQueue(_ input: DeleteQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteQueue", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getQueueAttributes(_ input: GetQueueAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetQueueAttributesResult> {
        return client.execute(operation: "GetQueueAttributes", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getQueueUrl(_ input: GetQueueUrlRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetQueueUrlResult> {
        return client.execute(operation: "GetQueueUrl", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listDeadLetterSourceQueues(_ input: ListDeadLetterSourceQueuesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDeadLetterSourceQueuesResult> {
        return client.execute(operation: "ListDeadLetterSourceQueues", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listQueueTags(_ input: ListQueueTagsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListQueueTagsResult> {
        return client.execute(operation: "ListQueueTags", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listQueues(_ input: ListQueuesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListQueuesResult> {
        return client.execute(operation: "ListQueues", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func purgeQueue(_ input: PurgeQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PurgeQueue", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func receiveMessage(_ input: ReceiveMessageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReceiveMessageResult> {
        return client.execute(operation: "ReceiveMessage", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func sendMessage(_ input: SendMessageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendMessageResult> {
        return client.execute(operation: "SendMessage", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func sendMessageBatch(_ input: SendMessageBatchRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendMessageBatchResult> {
        return client.execute(operation: "SendMessageBatch", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func setQueueAttributes(_ input: SetQueueAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetQueueAttributes", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func tagQueue(_ input: TagQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "TagQueue", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func untagQueue(_ input: UntagQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "UntagQueue", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
