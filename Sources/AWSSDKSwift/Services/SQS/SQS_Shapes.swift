...
extension SQS {
    ...
    public struct ChangeMessageVisibilityBatchRequestEntry: AWSShape {
        ...
        public init(receiptHandle: String, id: String, visibilityTimeout: Int32? = nil) {
            self.receiptHandle = receiptHandle
            self.id = id
            self.visibilityTimeout = visibilityTimeout
        }
    ...
    public struct BatchResultErrorEntry: AWSShape {
        ...
        public init(senderFault: Bool, message: String? = nil, id: String, code: String) {
    ...
    public struct SendMessageRequest: AWSShape {
        ...
        public init(queueUrl: String, messageBody: String, delaySeconds: Int32? = nil, messageDeduplicationId: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, messageGroupId: String? = nil) {
            self.queueUrl = queueUrl
    ...
    public struct SendMessageBatchRequestEntry: AWSShape {
        ...
        public init(messageBody: String, delaySeconds: Int32? = nil, id: String, messageAttributes: [String: MessageAttributeValue]? = nil, messageDeduplicationId: String? = nil, messageGroupId: String? = nil) {
            self.messageBody = messageBody
            self.delaySeconds = delaySeconds
            self.id = id
            self.messageAttributes = messageAttributes
    ...
    public struct MessageAttributeValue: AWSShape {
        ...
        public init(binaryListValues: BinaryList? = nil, stringValue: String? = nil, stringListValues: StringList? = nil, binaryValue: Data? = nil, dataType: String) {
    ...
    public struct Message: AWSShape {
        ...
        public init(receiptHandle: String? = nil, messageId: String? = nil, mD5OfMessageAttributes: String? = nil, mD5OfBody: String? = nil, body: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, attributes: [MessageSystemAttributeName: String]? = nil) {
            self.receiptHandle = receiptHandle
            self.messageId = messageId
            self.mD5OfMessageAttributes = mD5OfMessageAttributes
    ...
    public struct SendMessageBatchResultEntry: AWSShape {
        ...
        public init(mD5OfMessageAttributes: String? = nil, mD5OfMessageBody: String, id: String, sequenceNumber: String? = nil, messageId: String) {
            self.mD5OfMessageAttributes = mD5OfMessageAttributes
            self.mD5OfMessageBody = mD5OfMessageBody
            self.id = id
            self.sequenceNumber = sequenceNumber
    ...
    public struct ReceiveMessageRequest: AWSShape {
        ...
        public init(maxNumberOfMessages: Int32? = nil, visibilityTimeout: Int32? = nil, messageAttributeNames: MessageAttributeNameList? = nil, attributeNames: AttributeNameList? = nil, waitTimeSeconds: Int32? = nil, queueUrl: String, receiveRequestAttemptId: String? = nil) {
