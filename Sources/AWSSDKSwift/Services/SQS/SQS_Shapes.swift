...
extension SQS {
    ...
    public struct ReceiveMessageRequest: AWSShape {
        ...
        public init(attributeNames: AttributeNameList? = nil, waitTimeSeconds: Int32? = nil, messageAttributeNames: MessageAttributeNameList? = nil, receiveRequestAttemptId: String? = nil, queueUrl: String, maxNumberOfMessages: Int32? = nil, visibilityTimeout: Int32? = nil) {
    ...
    public struct BatchResultErrorEntry: AWSShape {
        ...
        public init(senderFault: Bool, message: String? = nil, code: String, id: String) {
    ...
    public struct SendMessageResult: AWSShape {
        ...
        public init(sequenceNumber: String? = nil, mD5OfMessageBody: String? = nil, mD5OfMessageAttributes: String? = nil, messageId: String? = nil) {
    ...
    public struct SendMessageBatchRequestEntry: AWSShape {
        ...
        public init(messageDeduplicationId: String? = nil, delaySeconds: Int32? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, id: String, messageGroupId: String? = nil, messageBody: String) {
    ...
    public struct MessageAttributeValue: AWSShape {
        ...
        public init(binaryListValues: BinaryList? = nil, binaryValue: Data? = nil, stringListValues: StringList? = nil, dataType: String, stringValue: String? = nil) {
    ...
    public struct ChangeMessageVisibilityRequest: AWSShape {
        ...
        public init(receiptHandle: String, queueUrl: String, visibilityTimeout: Int32) {
            self.receiptHandle = receiptHandle
            self.queueUrl = queueUrl
            self.visibilityTimeout = visibilityTimeout
        }
    ...
    public struct SendMessageBatchResultEntry: AWSShape {
        ...
        public init(messageId: String, mD5OfMessageBody: String, id: String, mD5OfMessageAttributes: String? = nil, sequenceNumber: String? = nil) {
            self.messageId = messageId
            self.mD5OfMessageBody = mD5OfMessageBody
            self.id = id
            self.mD5OfMessageAttributes = mD5OfMessageAttributes
    ...
    public struct SendMessageRequest: AWSShape {
        ...
        public init(messageDeduplicationId: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, messageBody: String, delaySeconds: Int32? = nil, messageGroupId: String? = nil, queueUrl: String) {
            self.messageDeduplicationId = messageDeduplicationId
            self.messageAttributes = messageAttributes
            self.messageBody = messageBody
            self.delaySeconds = delaySeconds
    ...
    public struct AddPermissionRequest: AWSShape {
        ...
        public init(queueUrl: String, label: String, aWSAccountIds: AWSAccountIdList, actions: ActionNameList) {
            self.queueUrl = queueUrl
            self.label = label
    ...
    public struct Message: AWSShape {
        ...
        public init(messageId: String? = nil, body: String? = nil, attributes: [MessageSystemAttributeName: String]? = nil, mD5OfMessageAttributes: String? = nil, mD5OfBody: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, receiptHandle: String? = nil) {
            self.messageId = messageId
            self.body = body
            self.attributes = attributes
            self.mD5OfMessageAttributes = mD5OfMessageAttributes
