...
extension SQS {
    ...
    public struct Message: AWSShape {
        ...
        public init(attributes: [MessageSystemAttributeName: String]? = nil, body: String? = nil, mD5OfMessageAttributes: String? = nil, mD5OfBody: String? = nil, messageId: String? = nil, receiptHandle: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil) {
    ...
    public struct ChangeMessageVisibilityRequest: AWSShape {
        ...
        public init(receiptHandle: String, visibilityTimeout: Int32, queueUrl: String) {
            self.receiptHandle = receiptHandle
    ...
    public struct SendMessageBatchRequestEntry: AWSShape {
        ...
        public init(messageAttributes: [String: MessageAttributeValue]? = nil, id: String, messageDeduplicationId: String? = nil, delaySeconds: Int32? = nil, messageBody: String, messageGroupId: String? = nil) {
            self.messageAttributes = messageAttributes
            self.id = id
    ...
    public struct MessageAttributeValue: AWSShape {
        ...
        public init(stringValue: String? = nil, binaryListValues: BinaryList? = nil, dataType: String, stringListValues: StringList? = nil, binaryValue: Data? = nil) {
    ...
    public struct ReceiveMessageRequest: AWSShape {
        ...
        public init(attributeNames: AttributeNameList? = nil, messageAttributeNames: MessageAttributeNameList? = nil, receiveRequestAttemptId: String? = nil, queueUrl: String, waitTimeSeconds: Int32? = nil, visibilityTimeout: Int32? = nil, maxNumberOfMessages: Int32? = nil) {
    ...
    public struct BatchResultErrorEntry: AWSShape {
        ...
        public init(id: String, code: String, message: String? = nil, senderFault: Bool) {
            self.id = id
            self.code = code
    ...
    public struct SendMessageBatchResultEntry: AWSShape {
        ...
        public init(mD5OfMessageBody: String, mD5OfMessageAttributes: String? = nil, sequenceNumber: String? = nil, messageId: String, id: String) {
    ...
    public struct SendMessageResult: AWSShape {
        ...
        public init(mD5OfMessageBody: String? = nil, mD5OfMessageAttributes: String? = nil, messageId: String? = nil, sequenceNumber: String? = nil) {
            self.mD5OfMessageBody = mD5OfMessageBody
            self.mD5OfMessageAttributes = mD5OfMessageAttributes
            self.messageId = messageId
            self.sequenceNumber = sequenceNumber
    ...
    public struct SendMessageBatchRequest: AWSShape {
        ...
        public init(queueUrl: String, entries: SendMessageBatchRequestEntryList) {
            self.queueUrl = queueUrl
            self.entries = entries
        }
    ...
    public struct ChangeMessageVisibilityBatchRequest: AWSShape {
        ...
        public init(queueUrl: String, entries: ChangeMessageVisibilityBatchRequestEntryList) {
            self.queueUrl = queueUrl
            self.entries = entries
        }
    ...
    public struct AddPermissionRequest: AWSShape {
        ...
        public init(queueUrl: String, actions: ActionNameList, aWSAccountIds: AWSAccountIdList, label: String) {
            self.queueUrl = queueUrl
    ...
    public struct ChangeMessageVisibilityBatchRequestEntry: AWSShape {
        ...
        public init(receiptHandle: String, visibilityTimeout: Int32? = nil, id: String) {
            self.receiptHandle = receiptHandle
            self.visibilityTimeout = visibilityTimeout
            self.id = id
        }
    ...
    public struct SendMessageRequest: AWSShape {
        ...
        public init(messageAttributes: [String: MessageAttributeValue]? = nil, messageDeduplicationId: String? = nil, queueUrl: String, delaySeconds: Int32? = nil, messageBody: String, messageGroupId: String? = nil) {
            self.messageAttributes = messageAttributes
            self.messageDeduplicationId = messageDeduplicationId
            self.queueUrl = queueUrl
            self.delaySeconds = delaySeconds
