...
extension SQS {
    ...
    public struct GetQueueAttributesRequest: AWSShape {
        ...
        public init(queueUrl: String, attributeNames: AttributeNameList? = nil) {
            self.queueUrl = queueUrl
    ...
    public struct SendMessageRequest: AWSShape {
        ...
        public init(messageAttributes: [String: MessageAttributeValue]? = nil, queueUrl: String, messageDeduplicationId: String? = nil, delaySeconds: Int32? = nil, messageBody: String, messageGroupId: String? = nil) {
    ...
    public struct MessageAttributeValue: AWSShape {
        ...
        public init(dataType: String, binaryValue: Data? = nil, stringListValues: StringList? = nil, stringValue: String? = nil, binaryListValues: BinaryList? = nil) {
    ...
    public struct BatchResultErrorEntry: AWSShape {
        ...
        public init(message: String? = nil, code: String, senderFault: Bool, id: String) {
    ...
    public struct SendMessageResult: AWSShape {
        ...
        public init(sequenceNumber: String? = nil, messageId: String? = nil, mD5OfMessageAttributes: String? = nil, mD5OfMessageBody: String? = nil) {
    ...
    public struct SendMessageBatchResultEntry: AWSShape {
        ...
        public init(sequenceNumber: String? = nil, messageId: String, mD5OfMessageAttributes: String? = nil, id: String, mD5OfMessageBody: String) {
            self.sequenceNumber = sequenceNumber
            self.messageId = messageId
            self.mD5OfMessageAttributes = mD5OfMessageAttributes
            self.id = id
    ...
    public struct AddPermissionRequest: AWSShape {
        ...
        public init(label: String, queueUrl: String, actions: ActionNameList, aWSAccountIds: AWSAccountIdList) {
            self.label = label
            self.queueUrl = queueUrl
    ...
    public struct SendMessageBatchRequestEntry: AWSShape {
        ...
        public init(messageAttributes: [String: MessageAttributeValue]? = nil, messageGroupId: String? = nil, messageDeduplicationId: String? = nil, delaySeconds: Int32? = nil, id: String, messageBody: String) {
            self.messageAttributes = messageAttributes
            self.messageGroupId = messageGroupId
            self.messageDeduplicationId = messageDeduplicationId
            self.delaySeconds = delaySeconds
    ...
    public struct Message: AWSShape {
        ...
        public init(body: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, attributes: [MessageSystemAttributeName: String]? = nil, messageId: String? = nil, mD5OfMessageAttributes: String? = nil, mD5OfBody: String? = nil, receiptHandle: String? = nil) {
            self.body = body
            self.messageAttributes = messageAttributes
            self.attributes = attributes
            self.messageId = messageId
    ...
    public struct ReceiveMessageRequest: AWSShape {
        ...
        public init(queueUrl: String, waitTimeSeconds: Int32? = nil, visibilityTimeout: Int32? = nil, messageAttributeNames: MessageAttributeNameList? = nil, attributeNames: AttributeNameList? = nil, receiveRequestAttemptId: String? = nil, maxNumberOfMessages: Int32? = nil) {
            self.queueUrl = queueUrl
