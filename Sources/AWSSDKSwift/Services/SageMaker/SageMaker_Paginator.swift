...
extension SageMaker {
    ...
    public func listAlgorithmsPaginator(_ input: ListAlgorithmsInput) -> Future<[AlgorithmSummary]> {
        return client.paginate(input: input, command: listAlgorithms, resultKey: "algorithmSummaryList", tokenKey: "nextToken")
    }
    
    ///  Lists apps.
    public func listAppsPaginator(_ input: ListAppsRequest) -> Future<[AppDetails]> {
        return client.paginate(input: input, command: listApps, resultKey: "apps", tokenKey: "nextToken")
    }
    
    ///  Request a list of jobs.
    public func listAutoMLJobsPaginator(_ input: ListAutoMLJobsRequest) -> Future<[AutoMLJobSummary]> {
        return client.paginate(input: input, command: listAutoMLJobs, resultKey: "autoMLJobSummaries", tokenKey: "nextToken")
    }
    
    ///  List the Candidates created for the job.
    public func listCandidatesForAutoMLJobPaginator(_ input: ListCandidatesForAutoMLJobRequest) -> Future<[AutoMLCandidate]> {
        return client.paginate(input: input, command: listCandidatesForAutoMLJob, resultKey: "candidates", tokenKey: "nextToken")
    }
    
    ///  Gets a list of the Git repositories in your account.
    public func listCodeRepositoriesPaginator(_ input: ListCodeRepositoriesInput) -> Future<[CodeRepositorySummary]> {
    ...
    public func listCompilationJobsPaginator(_ input: ListCompilationJobsRequest) -> Future<[CompilationJobSummary]> {
        return client.paginate(input: input, command: listCompilationJobs, resultKey: "compilationJobSummaries", tokenKey: "nextToken")
    }
    
    ///  Lists the domains.
    public func listDomainsPaginator(_ input: ListDomainsRequest) -> Future<[DomainDetails]> {
        return client.paginate(input: input, command: listDomains, resultKey: "domains", tokenKey: "nextToken")
    }
    
    ///  Lists endpoint configurations.
    public func listEndpointConfigsPaginator(_ input: ListEndpointConfigsInput) -> Future<[EndpointConfigSummary]> {
        return client.paginate(input: input, command: listEndpointConfigs, resultKey: "endpointConfigs", tokenKey: "nextToken")
    }
    
    ///  Lists endpoints.
    public func listEndpointsPaginator(_ input: ListEndpointsInput) -> Future<[EndpointSummary]> {
    ...
    public func listExperimentsPaginator(_ input: ListExperimentsRequest) -> Future<[ExperimentSummary]> {
        return client.paginate(input: input, command: listExperiments, resultKey: "experimentSummaries", tokenKey: "nextToken")
    }
    
    ///  Returns information about the flow definitions in your account.
    public func listFlowDefinitionsPaginator(_ input: ListFlowDefinitionsRequest) -> Future<[FlowDefinitionSummary]> {
    ...
    public func listHumanTaskUisPaginator(_ input: ListHumanTaskUisRequest) -> Future<[HumanTaskUiSummary]> {
    ...
    public func listHyperParameterTuningJobsPaginator(_ input: ListHyperParameterTuningJobsRequest) -> Future<[HyperParameterTuningJobSummary]> {
    ...
    public func listLabelingJobsPaginator(_ input: ListLabelingJobsRequest) -> Future<[LabelingJobSummary]> {
    ...
    public func listLabelingJobsForWorkteamPaginator(_ input: ListLabelingJobsForWorkteamRequest) -> Future<[LabelingJobForWorkteamSummary]> {
    ...
    public func listModelPackagesPaginator(_ input: ListModelPackagesInput) -> Future<[ModelPackageSummary]> {
    ...
    public func listModelsPaginator(_ input: ListModelsInput) -> Future<[ModelSummary]> {
        return client.paginate(input: input, command: listModels, resultKey: "models", tokenKey: "nextToken")
    }
    
    ///  Returns list of all monitoring job executions.
    public func listMonitoringExecutionsPaginator(_ input: ListMonitoringExecutionsRequest) -> Future<[MonitoringExecutionSummary]> {
    ...
    public func listMonitoringSchedulesPaginator(_ input: ListMonitoringSchedulesRequest) -> Future<[MonitoringScheduleSummary]> {
    ...
    public func listNotebookInstanceLifecycleConfigsPaginator(_ input: ListNotebookInstanceLifecycleConfigsInput) -> Future<[NotebookInstanceLifecycleConfigSummary]> {
    ...
    public func listNotebookInstancesPaginator(_ input: ListNotebookInstancesInput) -> Future<[NotebookInstanceSummary]> {
    ...
    public func listProcessingJobsPaginator(_ input: ListProcessingJobsRequest) -> Future<[ProcessingJobSummary]> {
    ...
    public func listSubscribedWorkteamsPaginator(_ input: ListSubscribedWorkteamsRequest) -> Future<[SubscribedWorkteam]> {
    ...
    public func listTagsPaginator(_ input: ListTagsInput) -> Future<[Tag]> {
        return client.paginate(input: input, command: listTags, resultKey: "tags", tokenKey: "nextToken")
    }
    
    ///  Lists training jobs.
    public func listTrainingJobsPaginator(_ input: ListTrainingJobsRequest) -> Future<[TrainingJobSummary]> {
    ...
    public func listTrainingJobsForHyperParameterTuningJobPaginator(_ input: ListTrainingJobsForHyperParameterTuningJobRequest) -> Future<[HyperParameterTrainingJobSummary]> {
    ...
    public func listTransformJobsPaginator(_ input: ListTransformJobsRequest) -> Future<[TransformJobSummary]> {
    ...
    public func listTrialComponentsPaginator(_ input: ListTrialComponentsRequest) -> Future<[TrialComponentSummary]> {
    ...
    public func listTrialsPaginator(_ input: ListTrialsRequest) -> Future<[TrialSummary]> {
        return client.paginate(input: input, command: listTrials, resultKey: "trialSummaries", tokenKey: "nextToken")
    }
    
    ///  Lists user profiles.
    public func listUserProfilesPaginator(_ input: ListUserProfilesRequest) -> Future<[UserProfileDetails]> {
    ...
    public func listWorkteamsPaginator(_ input: ListWorkteamsRequest) -> Future<[Workteam]> {
    ...
    public func searchPaginator(_ input: SearchRequest) -> Future<[SearchRecord]> {
