...
public struct SageMaker: AWSService {
    ...
    public func createWorkforce(_ input: CreateWorkforceRequest) -> EventLoopFuture<CreateWorkforceResponse> {
        return client.execute(operation: "CreateWorkforce", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteHumanTaskUi(_ input: DeleteHumanTaskUiRequest) -> EventLoopFuture<DeleteHumanTaskUiResponse> {
        return client.execute(operation: "DeleteHumanTaskUi", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteWorkforce(_ input: DeleteWorkforceRequest) -> EventLoopFuture<DeleteWorkforceResponse> {
        return client.execute(operation: "DeleteWorkforce", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listWorkforces(_ input: ListWorkforcesRequest) -> EventLoopFuture<ListWorkforcesResponse> {
        return client.execute(operation: "ListWorkforces", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
