...
public struct CodeGuruProfiler {
    ...
    public func addNotificationChannels(_ input: AddNotificationChannelsRequest) -> EventLoopFuture<AddNotificationChannelsResponse> {
        return client.send(operation: "AddNotificationChannels", path: "/profilingGroups/{profilingGroupName}/notificationConfiguration", httpMethod: "POST", input: input)
    }
    ...
    public func batchGetFrameMetricData(_ input: BatchGetFrameMetricDataRequest) -> EventLoopFuture<BatchGetFrameMetricDataResponse> {
        return client.send(operation: "BatchGetFrameMetricData", path: "/profilingGroups/{profilingGroupName}/frames/-/metrics", httpMethod: "POST", input: input)
    }
    ...
    public func getFindingsReportAccountSummary(_ input: GetFindingsReportAccountSummaryRequest) -> EventLoopFuture<GetFindingsReportAccountSummaryResponse> {
        return client.send(operation: "GetFindingsReportAccountSummary", path: "/internal/findingsReports", httpMethod: "GET", input: input)
    }
    ...
    public func getNotificationConfiguration(_ input: GetNotificationConfigurationRequest) -> EventLoopFuture<GetNotificationConfigurationResponse> {
        return client.send(operation: "GetNotificationConfiguration", path: "/profilingGroups/{profilingGroupName}/notificationConfiguration", httpMethod: "GET", input: input)
    }
    ...
    public func getRecommendations(_ input: GetRecommendationsRequest) -> EventLoopFuture<GetRecommendationsResponse> {
        return client.send(operation: "GetRecommendations", path: "/internal/profilingGroups/{profilingGroupName}/recommendations", httpMethod: "GET", input: input)
    }
    ...
    public func listFindingsReports(_ input: ListFindingsReportsRequest) -> EventLoopFuture<ListFindingsReportsResponse> {
        return client.send(operation: "ListFindingsReports", path: "/internal/profilingGroups/{profilingGroupName}/findingsReports", httpMethod: "GET", input: input)
    }
    ...
    public func removeNotificationChannel(_ input: RemoveNotificationChannelRequest) -> EventLoopFuture<RemoveNotificationChannelResponse> {
        return client.send(operation: "RemoveNotificationChannel", path: "/profilingGroups/{profilingGroupName}/notificationConfiguration/{channelId}", httpMethod: "DELETE", input: input)
    }
    ...
    public func submitFeedback(_ input: SubmitFeedbackRequest) -> EventLoopFuture<SubmitFeedbackResponse> {
        return client.send(operation: "SubmitFeedback", path: "/internal/profilingGroups/{profilingGroupName}/anomalies/{anomalyInstanceId}/feedback", httpMethod: "POST", input: input)
    }
