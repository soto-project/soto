...
public struct CodeGuruProfiler: AWSService {
    ...
    /// return new `CodeGuruProfiler` with new timeout value
    ...
    /// return new `CodeGuruProfiler` logging to specified Logger
    ...
    public func addNotificationChannels(_ input: AddNotificationChannelsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddNotificationChannelsResponse> {
        return client.execute(operation: "AddNotificationChannels", path: "/profilingGroups/{profilingGroupName}/notificationConfiguration", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func batchGetFrameMetricData(_ input: BatchGetFrameMetricDataRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchGetFrameMetricDataResponse> {
        return client.execute(operation: "BatchGetFrameMetricData", path: "/profilingGroups/{profilingGroupName}/frames/-/metrics", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func configureAgent(_ input: ConfigureAgentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfigureAgentResponse> {
        return client.execute(operation: "ConfigureAgent", path: "/profilingGroups/{profilingGroupName}/configureAgent", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createProfilingGroup(_ input: CreateProfilingGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateProfilingGroupResponse> {
        return client.execute(operation: "CreateProfilingGroup", path: "/profilingGroups", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteProfilingGroup(_ input: DeleteProfilingGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteProfilingGroupResponse> {
        return client.execute(operation: "DeleteProfilingGroup", path: "/profilingGroups/{profilingGroupName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeProfilingGroup(_ input: DescribeProfilingGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeProfilingGroupResponse> {
        return client.execute(operation: "DescribeProfilingGroup", path: "/profilingGroups/{profilingGroupName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getFindingsReportAccountSummary(_ input: GetFindingsReportAccountSummaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetFindingsReportAccountSummaryResponse> {
        return client.execute(operation: "GetFindingsReportAccountSummary", path: "/internal/findingsReports", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getNotificationConfiguration(_ input: GetNotificationConfigurationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetNotificationConfigurationResponse> {
        return client.execute(operation: "GetNotificationConfiguration", path: "/profilingGroups/{profilingGroupName}/notificationConfiguration", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }

    ///   Returns the JSON-formatted resource-based policy on a profiling group. 
    public func getPolicy(_ input: GetPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPolicyResponse> {
        return client.execute(operation: "GetPolicy", path: "/profilingGroups/{profilingGroupName}/policy", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getProfile(_ input: GetProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetProfileResponse> {
        return client.execute(operation: "GetProfile", path: "/profilingGroups/{profilingGroupName}/profile", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getRecommendations(_ input: GetRecommendationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRecommendationsResponse> {
        return client.execute(operation: "GetRecommendations", path: "/internal/profilingGroups/{profilingGroupName}/recommendations", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listFindingsReports(_ input: ListFindingsReportsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListFindingsReportsResponse> {
        return client.execute(operation: "ListFindingsReports", path: "/internal/profilingGroups/{profilingGroupName}/findingsReports", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listProfileTimes(_ input: ListProfileTimesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListProfileTimesResponse> {
        return client.execute(operation: "ListProfileTimes", path: "/profilingGroups/{profilingGroupName}/profileTimes", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listProfilingGroups(_ input: ListProfilingGroupsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListProfilingGroupsResponse> {
        return client.execute(operation: "ListProfilingGroups", path: "/profilingGroups", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func postAgentProfile(_ input: PostAgentProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PostAgentProfileResponse> {
        return client.execute(operation: "PostAgentProfile", path: "/profilingGroups/{profilingGroupName}/agentProfile", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putPermission(_ input: PutPermissionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutPermissionResponse> {
        return client.execute(operation: "PutPermission", path: "/profilingGroups/{profilingGroupName}/policy/{actionGroup}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func removeNotificationChannel(_ input: RemoveNotificationChannelRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveNotificationChannelResponse> {
        return client.execute(operation: "RemoveNotificationChannel", path: "/profilingGroups/{profilingGroupName}/notificationConfiguration/{channelId}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func removePermission(_ input: RemovePermissionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemovePermissionResponse> {
        return client.execute(operation: "RemovePermission", path: "/profilingGroups/{profilingGroupName}/policy/{actionGroup}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func submitFeedback(_ input: SubmitFeedbackRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitFeedbackResponse> {
        return client.execute(operation: "SubmitFeedback", path: "/internal/profilingGroups/{profilingGroupName}/anomalies/{anomalyInstanceId}/feedback", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateProfilingGroup(_ input: UpdateProfilingGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateProfilingGroupResponse> {
        return client.execute(operation: "UpdateProfilingGroup", path: "/profilingGroups/{profilingGroupName}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
}
