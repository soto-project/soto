...
public struct WorkSpaces: AWSService {
    ...
    public func describeWorkspaceImagePermissions(_ input: DescribeWorkspaceImagePermissionsRequest) -> EventLoopFuture<DescribeWorkspaceImagePermissionsResult> {
        return client.execute(operation: "DescribeWorkspaceImagePermissions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateWorkspaceImagePermission(_ input: UpdateWorkspaceImagePermissionRequest) -> EventLoopFuture<UpdateWorkspaceImagePermissionResult> {
        return client.execute(operation: "UpdateWorkspaceImagePermission", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
