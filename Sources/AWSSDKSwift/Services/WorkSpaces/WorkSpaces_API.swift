...
public struct WorkSpaces {
    ...
    public func associateIpGroups(_ input: AssociateIpGroupsRequest) -> Future<AssociateIpGroupsResult> {
    ...
    public func authorizeIpRules(_ input: AuthorizeIpRulesRequest) -> Future<AuthorizeIpRulesResult> {
        return client.send(operation: "AuthorizeIpRules", path: "/", httpMethod: "POST", input: input)
    }

    ///  Copies the specified image from the specified Region to the current Region.
    public func copyWorkspaceImage(_ input: CopyWorkspaceImageRequest) -> Future<CopyWorkspaceImageResult> {
    ...
    public func createIpGroup(_ input: CreateIpGroupRequest) -> Future<CreateIpGroupResult> {
        return client.send(operation: "CreateIpGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates the specified tags for the specified WorkSpaces resource.
    public func createTags(_ input: CreateTagsRequest) -> Future<CreateTagsResult> {
        return client.send(operation: "CreateTags", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates one or more WorkSpaces. This operation is asynchronous and returns before the WorkSpaces are created.
    public func createWorkspaces(_ input: CreateWorkspacesRequest) -> Future<CreateWorkspacesResult> {
    ...
    public func deleteIpGroup(_ input: DeleteIpGroupRequest) -> Future<DeleteIpGroupResult> {
        return client.send(operation: "DeleteIpGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified tags from the specified WorkSpaces resource.
    public func deleteTags(_ input: DeleteTagsRequest) -> Future<DeleteTagsResult> {
    ...
    public func deleteWorkspaceImage(_ input: DeleteWorkspaceImageRequest) -> Future<DeleteWorkspaceImageResult> {
    ...
    public func deregisterWorkspaceDirectory(_ input: DeregisterWorkspaceDirectoryRequest) -> Future<DeregisterWorkspaceDirectoryResult> {
        return client.send(operation: "DeregisterWorkspaceDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes the configuration of Bring Your Own License (BYOL) for the specified account.
    public func describeAccount(_ input: DescribeAccountRequest) -> Future<DescribeAccountResult> {
        return client.send(operation: "DescribeAccount", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes modifications to the configuration of Bring Your Own License (BYOL) for the specified account.
    public func describeAccountModifications(_ input: DescribeAccountModificationsRequest) -> Future<DescribeAccountModificationsResult> {
        return client.send(operation: "DescribeAccountModifications", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes one or more specified Amazon WorkSpaces clients.
    public func describeClientProperties(_ input: DescribeClientPropertiesRequest) -> Future<DescribeClientPropertiesResult> {
        return client.send(operation: "DescribeClientProperties", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your IP access control groups.
    public func describeIpGroups(_ input: DescribeIpGroupsRequest) -> Future<DescribeIpGroupsResult> {
    ...
    public func describeWorkspaceBundles(_ input: DescribeWorkspaceBundlesRequest) -> Future<DescribeWorkspaceBundlesResult> {
        return client.send(operation: "DescribeWorkspaceBundles", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the available directories that are registered with Amazon WorkSpaces.
    public func describeWorkspaceDirectories(_ input: DescribeWorkspaceDirectoriesRequest) -> Future<DescribeWorkspaceDirectoriesResult> {
        return client.send(operation: "DescribeWorkspaceDirectories", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes one or more specified images, if the image identifiers are provided. Otherwise, all images in the account are described. 
    public func describeWorkspaceImages(_ input: DescribeWorkspaceImagesRequest) -> Future<DescribeWorkspaceImagesResult> {
        return client.send(operation: "DescribeWorkspaceImages", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the snapshots for the specified WorkSpace.
    public func describeWorkspaceSnapshots(_ input: DescribeWorkspaceSnapshotsRequest) -> Future<DescribeWorkspaceSnapshotsResult> {
    ...
    public func describeWorkspaces(_ input: DescribeWorkspacesRequest) -> Future<DescribeWorkspacesResult> {
        return client.send(operation: "DescribeWorkspaces", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the connection status of the specified WorkSpaces.
    public func describeWorkspacesConnectionStatus(_ input: DescribeWorkspacesConnectionStatusRequest) -> Future<DescribeWorkspacesConnectionStatusResult> {
        return client.send(operation: "DescribeWorkspacesConnectionStatus", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified IP access control group from the specified directory.
    public func disassociateIpGroups(_ input: DisassociateIpGroupsRequest) -> Future<DisassociateIpGroupsResult> {
    ...
    public func importWorkspaceImage(_ input: ImportWorkspaceImageRequest) -> Future<ImportWorkspaceImageResult> {
    ...
    public func listAvailableManagementCidrRanges(_ input: ListAvailableManagementCidrRangesRequest) -> Future<ListAvailableManagementCidrRangesResult> {
    ...
    public func migrateWorkspace(_ input: MigrateWorkspaceRequest) -> Future<MigrateWorkspaceResult> {
        return client.send(operation: "MigrateWorkspace", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the configuration of Bring Your Own License (BYOL) for the specified account.
    public func modifyAccount(_ input: ModifyAccountRequest) -> Future<ModifyAccountResult> {
        return client.send(operation: "ModifyAccount", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the properties of the specified Amazon WorkSpaces clients.
    public func modifyClientProperties(_ input: ModifyClientPropertiesRequest) -> Future<ModifyClientPropertiesResult> {
        return client.send(operation: "ModifyClientProperties", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the self-service WorkSpace management capabilities for your users. For more information, see Enable Self-Service WorkSpace Management Capabilities for Your Users.
    public func modifySelfservicePermissions(_ input: ModifySelfservicePermissionsRequest) -> Future<ModifySelfservicePermissionsResult> {
        return client.send(operation: "ModifySelfservicePermissions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Specifies which devices and operating systems users can use to access their WorkSpaces. For more information, see  Control Device Access.
    public func modifyWorkspaceAccessProperties(_ input: ModifyWorkspaceAccessPropertiesRequest) -> Future<ModifyWorkspaceAccessPropertiesResult> {
        return client.send(operation: "ModifyWorkspaceAccessProperties", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modify the default properties used to create WorkSpaces.
    public func modifyWorkspaceCreationProperties(_ input: ModifyWorkspaceCreationPropertiesRequest) -> Future<ModifyWorkspaceCreationPropertiesResult> {
        return client.send(operation: "ModifyWorkspaceCreationProperties", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified WorkSpace properties.
    public func modifyWorkspaceProperties(_ input: ModifyWorkspacePropertiesRequest) -> Future<ModifyWorkspacePropertiesResult> {
    ...
    public func modifyWorkspaceState(_ input: ModifyWorkspaceStateRequest) -> Future<ModifyWorkspaceStateResult> {
    ...
    public func rebootWorkspaces(_ input: RebootWorkspacesRequest) -> Future<RebootWorkspacesResult> {
    ...
    public func rebuildWorkspaces(_ input: RebuildWorkspacesRequest) -> Future<RebuildWorkspacesResult> {
    ...
    public func registerWorkspaceDirectory(_ input: RegisterWorkspaceDirectoryRequest) -> Future<RegisterWorkspaceDirectoryResult> {
    ...
    public func restoreWorkspace(_ input: RestoreWorkspaceRequest) -> Future<RestoreWorkspaceResult> {
        return client.send(operation: "RestoreWorkspace", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes one or more rules from the specified IP access control group.
    public func revokeIpRules(_ input: RevokeIpRulesRequest) -> Future<RevokeIpRulesResult> {
    ...
    public func startWorkspaces(_ input: StartWorkspacesRequest) -> Future<StartWorkspacesResult> {
    ...
    public func stopWorkspaces(_ input: StopWorkspacesRequest) -> Future<StopWorkspacesResult> {
    ...
    public func terminateWorkspaces(_ input: TerminateWorkspacesRequest) -> Future<TerminateWorkspacesResult> {
        return client.send(operation: "TerminateWorkspaces", path: "/", httpMethod: "POST", input: input)
    }

    ///  Replaces the current rules of the specified IP access control group with the specified rules.
    public func updateRulesOfIpGroup(_ input: UpdateRulesOfIpGroupRequest) -> Future<UpdateRulesOfIpGroupResult> {
