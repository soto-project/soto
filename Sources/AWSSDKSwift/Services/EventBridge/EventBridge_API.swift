...
public struct EventBridge: AWSService {
    ...
    /// return new `EventBridge` with new timeout value
    ...
    /// return new `EventBridge` logging to specified Logger
    ...
    @discardableResult public func activateEventSource(_ input: ActivateEventSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "ActivateEventSource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Creates a new event bus within your account. This can be a custom event bus which you can use to receive events from your custom applications and services, or it can be a partner event bus which can be matched to a partner event source.
    public func createEventBus(_ input: CreateEventBusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateEventBusResponse> {
        return client.execute(operation: "CreateEventBus", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createPartnerEventSource(_ input: CreatePartnerEventSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePartnerEventSourceResponse> {
        return client.execute(operation: "CreatePartnerEventSource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deactivateEventSource(_ input: DeactivateEventSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeactivateEventSource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes the specified custom event bus or partner event bus. All rules associated with this event bus need to be deleted. You can't delete your account's default event bus.
    @discardableResult public func deleteEventBus(_ input: DeleteEventBusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteEventBus", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deletePartnerEventSource(_ input: DeletePartnerEventSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeletePartnerEventSource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteRule(_ input: DeleteRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteRule", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeEventBus(_ input: DescribeEventBusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEventBusResponse> {
        return client.execute(operation: "DescribeEventBus", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  This operation lists details about a partner event source that is shared with your account.
    public func describeEventSource(_ input: DescribeEventSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEventSourceResponse> {
        return client.execute(operation: "DescribeEventSource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describePartnerEventSource(_ input: DescribePartnerEventSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribePartnerEventSourceResponse> {
        return client.execute(operation: "DescribePartnerEventSource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeRule(_ input: DescribeRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRuleResponse> {
        return client.execute(operation: "DescribeRule", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func disableRule(_ input: DisableRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisableRule", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func enableRule(_ input: EnableRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "EnableRule", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists all the event buses in your account, including the default event bus, custom event buses, and partner event buses.
    public func listEventBuses(_ input: ListEventBusesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListEventBusesResponse> {
        return client.execute(operation: "ListEventBuses", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listEventSources(_ input: ListEventSourcesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListEventSourcesResponse> {
        return client.execute(operation: "ListEventSources", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listPartnerEventSourceAccounts(_ input: ListPartnerEventSourceAccountsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPartnerEventSourceAccountsResponse> {
        return client.execute(operation: "ListPartnerEventSourceAccounts", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listPartnerEventSources(_ input: ListPartnerEventSourcesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPartnerEventSourcesResponse> {
        return client.execute(operation: "ListPartnerEventSources", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the rules for the specified target. You can see which of the rules in Amazon EventBridge can invoke a specific target in your account.
    public func listRuleNamesByTarget(_ input: ListRuleNamesByTargetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListRuleNamesByTargetResponse> {
        return client.execute(operation: "ListRuleNamesByTarget", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listRules(_ input: ListRulesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListRulesResponse> {
        return client.execute(operation: "ListRules", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTargetsByRule(_ input: ListTargetsByRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTargetsByRuleResponse> {
        return client.execute(operation: "ListTargetsByRule", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putEvents(_ input: PutEventsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutEventsResponse> {
        return client.execute(operation: "PutEvents", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  This is used by SaaS partners to write events to a customer's partner event bus. AWS customers do not use this operation.
    public func putPartnerEvents(_ input: PutPartnerEventsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutPartnerEventsResponse> {
        return client.execute(operation: "PutPartnerEvents", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putPermission(_ input: PutPermissionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutPermission", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putRule(_ input: PutRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRuleResponse> {
        return client.execute(operation: "PutRule", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putTargets(_ input: PutTargetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutTargetsResponse> {
        return client.execute(operation: "PutTargets", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func removePermission(_ input: RemovePermissionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemovePermission", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Removes the specified targets from the specified rule. When the rule is triggered, those targets are no longer be invoked. When you remove a target, when the associated rule triggers, removed targets might continue to be invoked. Allow a short period of time for changes to take effect. This action can partially fail if too many requests are made at the same time. If that happens, FailedEntryCount is non-zero in the response and each entry in FailedEntries provides the ID of the failed target and the error code.
    public func removeTargets(_ input: RemoveTargetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveTargetsResponse> {
        return client.execute(operation: "RemoveTargets", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func testEventPattern(_ input: TestEventPatternRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TestEventPatternResponse> {
        return client.execute(operation: "TestEventPattern", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
