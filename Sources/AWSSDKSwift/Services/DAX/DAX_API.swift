...
public struct DAX {
    ...
    public func createParameterGroup(_ input: CreateParameterGroupRequest) -> Future<CreateParameterGroupResponse> {
        return client.send(operation: "CreateParameterGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new subnet group.
    public func createSubnetGroup(_ input: CreateSubnetGroupRequest) -> Future<CreateSubnetGroupResponse> {
    ...
    public func decreaseReplicationFactor(_ input: DecreaseReplicationFactorRequest) -> Future<DecreaseReplicationFactorResponse> {
    ...
    public func deleteParameterGroup(_ input: DeleteParameterGroupRequest) -> Future<DeleteParameterGroupResponse> {
    ...
    public func deleteSubnetGroup(_ input: DeleteSubnetGroupRequest) -> Future<DeleteSubnetGroupResponse> {
    ...
    public func describeDefaultParameters(_ input: DescribeDefaultParametersRequest) -> Future<DescribeDefaultParametersResponse> {
    ...
    public func describeParameterGroups(_ input: DescribeParameterGroupsRequest) -> Future<DescribeParameterGroupsResponse> {
        return client.send(operation: "DescribeParameterGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the detailed parameter list for a particular parameter group.
    public func describeParameters(_ input: DescribeParametersRequest) -> Future<DescribeParametersResponse> {
        return client.send(operation: "DescribeParameters", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of subnet group descriptions. If a subnet group name is specified, the list will contain only the description of that group.
    public func describeSubnetGroups(_ input: DescribeSubnetGroupsRequest) -> Future<DescribeSubnetGroupsResponse> {
        return client.send(operation: "DescribeSubnetGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds one or more nodes to a DAX cluster.
    public func increaseReplicationFactor(_ input: IncreaseReplicationFactorRequest) -> Future<IncreaseReplicationFactorResponse> {
    ...
    public func updateCluster(_ input: UpdateClusterRequest) -> Future<UpdateClusterResponse> {
        return client.send(operation: "UpdateCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the parameters of a parameter group. You can modify up to 20 parameters in a single request by submitting a list parameter name and value pairs.
    public func updateParameterGroup(_ input: UpdateParameterGroupRequest) -> Future<UpdateParameterGroupResponse> {
        return client.send(operation: "UpdateParameterGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies an existing subnet group.
    public func updateSubnetGroup(_ input: UpdateSubnetGroupRequest) -> Future<UpdateSubnetGroupResponse> {
