...
extension CloudSearchDomain {
    ...
    public struct SuggestionMatch: AWSShape {
        ...
        public init(score: Int64? = nil, id: String? = nil, suggestion: String? = nil) {
            self.score = score
            self.id = id
    ...
    public struct FieldStats: AWSShape {
        ...
        public init(max: String? = nil, sumOfSquares: Double? = nil, count: Int64? = nil, min: String? = nil, mean: String? = nil, missing: Int64? = nil, stddev: Double? = nil, sum: Double? = nil) {
            self.max = max
    ...
    public struct SearchRequest: AWSShape {
        ...
        public init(expr: String? = nil, stats: String? = nil, start: Int64? = nil, facet: String? = nil, partial: Bool? = nil, queryOptions: String? = nil, return: String? = nil, filterQuery: String? = nil, cursor: String? = nil, sort: String? = nil, query: String, size: Int64? = nil, highlight: String? = nil, queryParser: QueryParser? = nil) {
            self.expr = expr
            self.stats = stats
            self.start = start
            self.facet = facet
    ...
    public struct Hits: AWSShape {
        ...
        public init(found: Int64? = nil, start: Int64? = nil, cursor: String? = nil, hit: [Hit]? = nil) {
            self.found = found
            self.start = start
            self.cursor = cursor
            self.hit = hit
    ...
    public struct SuggestResponse: AWSShape {
        ...
        public init(suggest: SuggestModel? = nil, status: SuggestStatus? = nil) {
    ...
    public struct UploadDocumentsResponse: AWSShape {
        ...
        public init(adds: Int64? = nil, status: String? = nil, warnings: [DocumentServiceWarning]? = nil, deletes: Int64? = nil) {
            self.adds = adds
            self.status = status
    ...
    public struct Hit: AWSShape {
        ...
        public init(highlights: [String: String]? = nil, id: String? = nil, fields: [String: [String]]? = nil, exprs: [String: String]? = nil) {
    ...
    public struct SearchResponse: AWSShape {
        ...
        public init(status: SearchStatus? = nil, hits: Hits? = nil, stats: [String: FieldStats]? = nil, facets: [String: BucketInfo]? = nil) {
            self.status = status
            self.hits = hits
            self.stats = stats
            self.facets = facets
