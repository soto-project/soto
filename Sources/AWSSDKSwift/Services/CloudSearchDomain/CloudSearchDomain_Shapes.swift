...
extension CloudSearchDomain {
    ...
    public struct SuggestionMatch: AWSShape {
        ...
        public init(suggestion: String? = nil, id: String? = nil, score: Int64? = nil) {
    ...
    public struct SearchRequest: AWSShape {
        ...
        public init(highlight: String? = nil, query: String, cursor: String? = nil, expr: String? = nil, size: Int64? = nil, return: String? = nil, partial: Bool? = nil, queryParser: QueryParser? = nil, queryOptions: String? = nil, facet: String? = nil, start: Int64? = nil, stats: String? = nil, filterQuery: String? = nil, sort: String? = nil) {
    ...
    public struct Hits: AWSShape {
        ...
        public init(found: Int64? = nil, cursor: String? = nil, hit: [Hit]? = nil, start: Int64? = nil) {
            self.found = found
            self.cursor = cursor
            self.hit = hit
            self.start = start
    ...
    public struct Hit: AWSShape {
        ...
        public init(fields: [String: [String]]? = nil, highlights: [String: String]? = nil, exprs: [String: String]? = nil, id: String? = nil) {
            self.fields = fields
    ...
    public struct UploadDocumentsResponse: AWSShape {
        ...
        public init(deletes: Int64? = nil, status: String? = nil, adds: Int64? = nil, warnings: [DocumentServiceWarning]? = nil) {
    ...
    public struct SearchResponse: AWSShape {
        ...
        public init(stats: [String: FieldStats]? = nil, facets: [String: BucketInfo]? = nil, status: SearchStatus? = nil, hits: Hits? = nil) {
            self.stats = stats
            self.facets = facets
            self.status = status
            self.hits = hits
    ...
    public struct FieldStats: AWSShape {
        ...
        public init(stddev: Double? = nil, missing: Int64? = nil, sum: Double? = nil, min: String? = nil, max: String? = nil, sumOfSquares: Double? = nil, mean: String? = nil, count: Int64? = nil) {
            self.stddev = stddev
