...
extension CloudSearchDomain {
    ...
    public struct Hit: AWSShape {
        ...
        public init(highlights: [String: String]? = nil, fields: [String: [String]]? = nil, id: String? = nil, exprs: [String: String]? = nil) {
    ...
    public struct SearchResponse: AWSShape {
        ...
        public init(facets: [String: BucketInfo]? = nil, stats: [String: FieldStats]? = nil, status: SearchStatus? = nil, hits: Hits? = nil) {
            self.facets = facets
            self.stats = stats
            self.status = status
            self.hits = hits
    ...
    public struct SearchRequest: AWSShape {
        ...
        public init(start: Int64? = nil, queryParser: QueryParser? = nil, stats: String? = nil, facet: String? = nil, queryOptions: String? = nil, sort: String? = nil, partial: Bool? = nil, size: Int64? = nil, cursor: String? = nil, expr: String? = nil, highlight: String? = nil, return: String? = nil, filterQuery: String? = nil, query: String) {
            self.start = start
    ...
    public struct UploadDocumentsResponse: AWSShape {
        ...
        public init(warnings: [DocumentServiceWarning]? = nil, status: String? = nil, deletes: Int64? = nil, adds: Int64? = nil) {
    ...
    public struct FieldStats: AWSShape {
        ...
        public init(min: String? = nil, count: Int64? = nil, missing: Int64? = nil, sum: Double? = nil, sumOfSquares: Double? = nil, stddev: Double? = nil, mean: String? = nil, max: String? = nil) {
            self.min = min
            self.count = count
    ...
    public struct SuggestModel: AWSShape {
        ...
        public init(suggestions: [SuggestionMatch]? = nil, query: String? = nil, found: Int64? = nil) {
    ...
    public struct Hits: AWSShape {
        ...
        public init(hit: [Hit]? = nil, found: Int64? = nil, start: Int64? = nil, cursor: String? = nil) {
            self.hit = hit
            self.found = found
            self.start = start
            self.cursor = cursor
