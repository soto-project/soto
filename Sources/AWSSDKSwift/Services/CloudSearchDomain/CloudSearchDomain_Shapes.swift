...
extension CloudSearchDomain {
    ...
    public struct Hits: AWSShape {
        ...
        public init(hit: [Hit]? = nil, start: Int64? = nil, cursor: String? = nil, found: Int64? = nil) {
            self.hit = hit
            self.start = start
            self.cursor = cursor
            self.found = found
    ...
    public struct Hit: AWSShape {
        ...
        public init(id: String? = nil, exprs: [String: String]? = nil, highlights: [String: String]? = nil, fields: [String: [String]]? = nil) {
            self.id = id
            self.exprs = exprs
    ...
    public struct SuggestRequest: AWSShape {
        ...
        public init(size: Int64? = nil, query: String, suggester: String) {
            self.size = size
            self.query = query
    ...
    public struct SearchRequest: AWSShape {
        ...
        public init(filterQuery: String? = nil, size: Int64? = nil, partial: Bool? = nil, query: String, return: String? = nil, queryParser: QueryParser? = nil, start: Int64? = nil, stats: String? = nil, cursor: String? = nil, sort: String? = nil, expr: String? = nil, facet: String? = nil, highlight: String? = nil, queryOptions: String? = nil) {
    ...
    public struct FieldStats: AWSShape {
        ...
        public init(stddev: Double? = nil, sumOfSquares: Double? = nil, mean: String? = nil, missing: Int64? = nil, max: String? = nil, sum: Double? = nil, min: String? = nil, count: Int64? = nil) {
            self.stddev = stddev
