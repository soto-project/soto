...
public struct CloudSearchDomain {
    ...
    public func suggest(_ input: SuggestRequest) -> Future<SuggestResponse> {
    ...
    public func uploadDocuments(_ input: UploadDocumentsRequest) -> Future<UploadDocumentsResponse> {
