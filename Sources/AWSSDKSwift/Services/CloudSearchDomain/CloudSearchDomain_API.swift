...
public struct CloudSearchDomain {
    ...
    public func search(_ input: SearchRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SearchResponse> {
        return self.client.execute(operation: "Search", path: "/2013-01-01/search?format=sdk&pretty=true", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func suggest(_ input: SuggestRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SuggestResponse> {
        return self.client.execute(operation: "Suggest", path: "/2013-01-01/suggest?format=sdk&pretty=true", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func uploadDocuments(_ input: UploadDocumentsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UploadDocumentsResponse> {
        return self.client.execute(operation: "UploadDocuments", path: "/2013-01-01/documents/batch?format=sdk", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
