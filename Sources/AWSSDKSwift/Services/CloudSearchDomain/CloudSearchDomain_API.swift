...
public struct CloudSearchDomain {
    ...
    public func suggest(_ input: SuggestRequest) throws -> EventLoopFuture<SuggestResponse> {
    ...
    public func uploadDocuments(_ input: UploadDocumentsRequest) throws -> EventLoopFuture<UploadDocumentsResponse> {
