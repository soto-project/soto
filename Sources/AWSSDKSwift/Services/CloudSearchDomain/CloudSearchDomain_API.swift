...
public struct CloudSearchDomain {
    ...
    public func search(_ input: SearchRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchResponse> {
        return client.execute(operation: "Search", path: "/2013-01-01/search?format=sdk&pretty=true", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func suggest(_ input: SuggestRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SuggestResponse> {
        return client.execute(operation: "Suggest", path: "/2013-01-01/suggest?format=sdk&pretty=true", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func uploadDocuments(_ input: UploadDocumentsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UploadDocumentsResponse> {
        return client.execute(operation: "UploadDocuments", path: "/2013-01-01/documents/batch?format=sdk", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
