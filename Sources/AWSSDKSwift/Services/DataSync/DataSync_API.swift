...
public struct DataSync {
    ...
    public func startTaskExecution(_ input: StartTaskExecutionRequest) throws -> StartTaskExecutionResponse {
    ...
    public func createLocationS3(_ input: CreateLocationS3Request) throws -> CreateLocationS3Response {
    ...
    public func listLocations(_ input: ListLocationsRequest) throws -> ListLocationsResponse {
    ...
    public func cancelTaskExecution(_ input: CancelTaskExecutionRequest) throws -> CancelTaskExecutionResponse {
