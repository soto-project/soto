...
public struct DataSync {
    ...
    public func updateAgent(_ input: UpdateAgentRequest) throws -> EventLoopFuture<UpdateAgentResponse> {
        return try client.send(operation: "UpdateAgent", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns detailed metadata about a task that is being executed.
    public func describeTaskExecution(_ input: DescribeTaskExecutionRequest) throws -> EventLoopFuture<DescribeTaskExecutionResponse> {
    ...
    public func listLocations(_ input: ListLocationsRequest) throws -> EventLoopFuture<ListLocationsResponse> {
        return try client.send(operation: "ListLocations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns metadata, such as the path information, about a NFS location.
    public func describeLocationNfs(_ input: DescribeLocationNfsRequest) throws -> EventLoopFuture<DescribeLocationNfsResponse> {
    ...
    public func describeAgent(_ input: DescribeAgentRequest) throws -> EventLoopFuture<DescribeAgentResponse> {
    ...
    public func createLocationS3(_ input: CreateLocationS3Request) throws -> EventLoopFuture<CreateLocationS3Response> {
        return try client.send(operation: "CreateLocationS3", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the configuration of a location used by AWS DataSync. 
    public func deleteLocation(_ input: DeleteLocationRequest) throws -> EventLoopFuture<DeleteLocationResponse> {
    ...
    public func cancelTaskExecution(_ input: CancelTaskExecutionRequest) throws -> EventLoopFuture<CancelTaskExecutionResponse> {
        return try client.send(operation: "CancelTaskExecution", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates an endpoint for a Network File System (NFS) file system.
    public func createLocationNfs(_ input: CreateLocationNfsRequest) throws -> EventLoopFuture<CreateLocationNfsResponse> {
    ...
    public func deleteAgent(_ input: DeleteAgentRequest) throws -> EventLoopFuture<DeleteAgentResponse> {
    ...
    public func createTask(_ input: CreateTaskRequest) throws -> EventLoopFuture<CreateTaskResponse> {
        return try client.send(operation: "CreateTask", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of executed tasks.
    public func listTaskExecutions(_ input: ListTaskExecutionsRequest) throws -> EventLoopFuture<ListTaskExecutionsResponse> {
        return try client.send(operation: "ListTaskExecutions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns metadata, such as the path information about an Amazon EFS location.
    public func describeLocationEfs(_ input: DescribeLocationEfsRequest) throws -> EventLoopFuture<DescribeLocationEfsResponse> {
    ...
    public func startTaskExecution(_ input: StartTaskExecutionRequest) throws -> EventLoopFuture<StartTaskExecutionResponse> {
    ...
    public func createAgent(_ input: CreateAgentRequest) throws -> EventLoopFuture<CreateAgentResponse> {
        return try client.send(operation: "CreateAgent", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns metadata about a task.
    public func describeTask(_ input: DescribeTaskRequest) throws -> EventLoopFuture<DescribeTaskResponse> {
    ...
    public func listAgents(_ input: ListAgentsRequest) throws -> EventLoopFuture<ListAgentsResponse> {
        return try client.send(operation: "ListAgents", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates an endpoint for an Amazon EFS file system.
    public func createLocationEfs(_ input: CreateLocationEfsRequest) throws -> EventLoopFuture<CreateLocationEfsResponse> {
        return try client.send(operation: "CreateLocationEfs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the metadata associated with a task.
    public func updateTask(_ input: UpdateTaskRequest) throws -> EventLoopFuture<UpdateTaskResponse> {
        return try client.send(operation: "UpdateTask", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns metadata, such as bucket name, about an Amazon S3 bucket location.
    public func describeLocationS3(_ input: DescribeLocationS3Request) throws -> EventLoopFuture<DescribeLocationS3Response> {
        return try client.send(operation: "DescribeLocationS3", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a task.
    public func deleteTask(_ input: DeleteTaskRequest) throws -> EventLoopFuture<DeleteTaskResponse> {
