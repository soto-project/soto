...
extension DataSync {
    ...
    public struct CreateLocationS3Request: AWSShape {
        ...
        public init(tags: [TagListEntry]? = nil, s3BucketArn: String, s3Config: S3Config, subdirectory: String) {
            self.tags = tags
    ...
    public struct CreateLocationNfsRequest: AWSShape {
        ...
        public init(tags: [TagListEntry]? = nil, onPremConfig: OnPremConfig, serverHostname: String, subdirectory: String) {
            self.tags = tags
    ...
    public struct DescribeTaskResponse: AWSShape {
        ...
        public init(name: String? = nil, sourceLocationArn: String? = nil, status: TaskStatus? = nil, options: Options? = nil, errorCode: String? = nil, currentTaskExecutionArn: String? = nil, creationTime: TimeStamp? = nil, cloudWatchLogGroupArn: String? = nil, destinationLocationArn: String? = nil, taskArn: String? = nil, errorDetail: String? = nil) {
            self.name = name
    ...
    public struct CreateTaskRequest: AWSShape {
        ...
        public init(name: String? = nil, destinationLocationArn: String, cloudWatchLogGroupArn: String? = nil, options: Options? = nil, sourceLocationArn: String, tags: [TagListEntry]? = nil) {
            self.name = name
            self.destinationLocationArn = destinationLocationArn
            self.cloudWatchLogGroupArn = cloudWatchLogGroupArn
            self.options = options
    ...
    public struct TaskListEntry: AWSShape {
        ...
        public init(status: TaskStatus? = nil, name: String? = nil, taskArn: String? = nil) {
            self.status = status
            self.name = name
            self.taskArn = taskArn
        }
    ...
    public struct ListTaskExecutionsRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, taskArn: String? = nil, maxResults: Int32? = nil) {
            self.nextToken = nextToken
            self.taskArn = taskArn
            self.maxResults = maxResults
        }
    ...
    public struct DescribeAgentResponse: AWSShape {
        ...
        public init(name: String? = nil, agentArn: String? = nil, status: AgentStatus? = nil, lastConnectionTime: TimeStamp? = nil, creationTime: TimeStamp? = nil) {
            self.name = name
            self.agentArn = agentArn
            self.status = status
    ...
    public struct DescribeTaskExecutionResponse: AWSShape {
        ...
        public init(taskExecutionArn: String? = nil, status: TaskExecutionStatus? = nil, estimatedFilesToTransfer: Int64? = nil, options: Options? = nil, filesTransferred: Int64? = nil, bytesWritten: Int64? = nil, result: TaskExecutionResultDetail? = nil, startTime: TimeStamp? = nil, estimatedBytesToTransfer: Int64? = nil, bytesTransferred: Int64? = nil) {
            self.taskExecutionArn = taskExecutionArn
            self.status = status
    ...
    public struct TaskExecutionResultDetail: AWSShape {
        ...
        public init(prepareStatus: PhaseStatus? = nil, verifyDuration: Int64? = nil, verifyStatus: PhaseStatus? = nil, errorCode: String? = nil, transferStatus: PhaseStatus? = nil, prepareDuration: Int64? = nil, errorDetail: String? = nil, transferDuration: Int64? = nil) {
    ...
    public struct DescribeLocationEfsResponse: AWSShape {
        ...
        public init(ec2Config: Ec2Config? = nil, locationArn: String? = nil, locationUri: String? = nil, creationTime: TimeStamp? = nil) {
    ...
    public struct CreateAgentRequest: AWSShape {
        ...
        public init(activationKey: String, tags: [TagListEntry]? = nil, agentName: String? = nil) {
    ...
    public struct Options: AWSShape {
        ...
        public init(posixPermissions: PosixPermissions? = nil, atime: Atime? = nil, gid: Gid? = nil, uid: Uid? = nil, preserveDevices: PreserveDevices? = nil, verifyMode: VerifyMode? = nil, preserveDeletedFiles: PreserveDeletedFiles? = nil, mtime: Mtime? = nil, bytesPerSecond: Int64? = nil) {
    ...
    public struct CreateLocationEfsRequest: AWSShape {
        ...
        public init(tags: [TagListEntry]? = nil, efsFilesystemArn: String, ec2Config: Ec2Config, subdirectory: String) {
            self.tags = tags
    ...
    public struct DescribeLocationS3Response: AWSShape {
        ...
        public init(locationArn: String? = nil, s3Config: S3Config? = nil, locationUri: String? = nil, creationTime: TimeStamp? = nil) {
            self.locationArn = locationArn
            self.s3Config = s3Config
            self.locationUri = locationUri
            self.creationTime = creationTime
