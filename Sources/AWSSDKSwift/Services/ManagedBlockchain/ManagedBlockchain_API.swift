...
public struct ManagedBlockchain {
    ...
    public func createMember(_ input: CreateMemberInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateMemberOutput> {
        return client.send(operation: "CreateMember", path: "/networks/{networkId}/members", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createNetwork(_ input: CreateNetworkInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateNetworkOutput> {
        return client.send(operation: "CreateNetwork", path: "/networks", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Creates a peer node in a member.
    public func createNode(_ input: CreateNodeInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateNodeOutput> {
        return client.send(operation: "CreateNode", path: "/networks/{networkId}/members/{memberId}/nodes", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createProposal(_ input: CreateProposalInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateProposalOutput> {
        return client.send(operation: "CreateProposal", path: "/networks/{networkId}/proposals", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func deleteMember(_ input: DeleteMemberInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteMemberOutput> {
        return client.send(operation: "DeleteMember", path: "/networks/{networkId}/members/{memberId}", httpMethod: "DELETE", input: input, on: eventLoop)
    }
    ...
    public func deleteNode(_ input: DeleteNodeInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteNodeOutput> {
        return client.send(operation: "DeleteNode", path: "/networks/{networkId}/members/{memberId}/nodes/{nodeId}", httpMethod: "DELETE", input: input, on: eventLoop)
    }

    ///  Returns detailed information about a member.
    public func getMember(_ input: GetMemberInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMemberOutput> {
        return client.send(operation: "GetMember", path: "/networks/{networkId}/members/{memberId}", httpMethod: "GET", input: input, on: eventLoop)
    }

    ///  Returns detailed information about a network.
    public func getNetwork(_ input: GetNetworkInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetNetworkOutput> {
        return client.send(operation: "GetNetwork", path: "/networks/{networkId}", httpMethod: "GET", input: input, on: eventLoop)
    }

    ///  Returns detailed information about a peer node.
    public func getNode(_ input: GetNodeInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetNodeOutput> {
        return client.send(operation: "GetNode", path: "/networks/{networkId}/members/{memberId}/nodes/{nodeId}", httpMethod: "GET", input: input, on: eventLoop)
    }

    ///  Returns detailed information about a proposal.
    public func getProposal(_ input: GetProposalInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetProposalOutput> {
        return client.send(operation: "GetProposal", path: "/networks/{networkId}/proposals/{proposalId}", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listMembers(_ input: ListMembersInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMembersOutput> {
        return client.send(operation: "ListMembers", path: "/networks/{networkId}/members", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listNetworks(_ input: ListNetworksInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListNetworksOutput> {
        return client.send(operation: "ListNetworks", path: "/networks", httpMethod: "GET", input: input, on: eventLoop)
    }

    ///  Returns information about the nodes within a network.
    public func listNodes(_ input: ListNodesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListNodesOutput> {
        return client.send(operation: "ListNodes", path: "/networks/{networkId}/members/{memberId}/nodes", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listProposalVotes(_ input: ListProposalVotesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListProposalVotesOutput> {
        return client.send(operation: "ListProposalVotes", path: "/networks/{networkId}/proposals/{proposalId}/votes", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listProposals(_ input: ListProposalsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListProposalsOutput> {
        return client.send(operation: "ListProposals", path: "/networks/{networkId}/proposals", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func rejectInvitation(_ input: RejectInvitationInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RejectInvitationOutput> {
        return client.send(operation: "RejectInvitation", path: "/invitations/{invitationId}", httpMethod: "DELETE", input: input, on: eventLoop)
    }
    ...
    public func updateMember(_ input: UpdateMemberInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateMemberOutput> {
        return client.send(operation: "UpdateMember", path: "/networks/{networkId}/members/{memberId}", httpMethod: "PATCH", input: input, on: eventLoop)
    }

    ///  Updates a node configuration with new parameters.
    public func updateNode(_ input: UpdateNodeInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateNodeOutput> {
        return client.send(operation: "UpdateNode", path: "/networks/{networkId}/members/{memberId}/nodes/{nodeId}", httpMethod: "PATCH", input: input, on: eventLoop)
    }
    ...
    public func voteOnProposal(_ input: VoteOnProposalInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VoteOnProposalOutput> {
        return client.send(operation: "VoteOnProposal", path: "/networks/{networkId}/proposals/{proposalId}/votes", httpMethod: "POST", input: input, on: eventLoop)
    }
}
