...
public struct MediaConnect: AWSService {
    ...
    /// return new `MediaConnect` with new timeout value
    ...
    /// return new `MediaConnect` logging to specified Logger
    ...
    public func addFlowOutputs(_ input: AddFlowOutputsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddFlowOutputsResponse> {
        return client.execute(operation: "AddFlowOutputs", path: "/v1/flows/{flowArn}/outputs", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func addFlowSources(_ input: AddFlowSourcesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddFlowSourcesResponse> {
        return client.execute(operation: "AddFlowSources", path: "/v1/flows/{flowArn}/source", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func addFlowVpcInterfaces(_ input: AddFlowVpcInterfacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddFlowVpcInterfacesResponse> {
        return client.execute(operation: "AddFlowVpcInterfaces", path: "/v1/flows/{flowArn}/vpcInterfaces", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createFlow(_ input: CreateFlowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateFlowResponse> {
        return client.execute(operation: "CreateFlow", path: "/v1/flows", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteFlow(_ input: DeleteFlowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFlowResponse> {
        return client.execute(operation: "DeleteFlow", path: "/v1/flows/{flowArn}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeFlow(_ input: DescribeFlowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeFlowResponse> {
        return client.execute(operation: "DescribeFlow", path: "/v1/flows/{flowArn}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func grantFlowEntitlements(_ input: GrantFlowEntitlementsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GrantFlowEntitlementsResponse> {
        return client.execute(operation: "GrantFlowEntitlements", path: "/v1/flows/{flowArn}/entitlements", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listEntitlements(_ input: ListEntitlementsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListEntitlementsResponse> {
        return client.execute(operation: "ListEntitlements", path: "/v1/entitlements", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listFlows(_ input: ListFlowsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListFlowsResponse> {
        return client.execute(operation: "ListFlows", path: "/v1/flows", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func removeFlowOutput(_ input: RemoveFlowOutputRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveFlowOutputResponse> {
        return client.execute(operation: "RemoveFlowOutput", path: "/v1/flows/{flowArn}/outputs/{outputArn}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func removeFlowSource(_ input: RemoveFlowSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveFlowSourceResponse> {
        return client.execute(operation: "RemoveFlowSource", path: "/v1/flows/{flowArn}/source/{sourceArn}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func removeFlowVpcInterface(_ input: RemoveFlowVpcInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveFlowVpcInterfaceResponse> {
        return client.execute(operation: "RemoveFlowVpcInterface", path: "/v1/flows/{flowArn}/vpcInterfaces/{vpcInterfaceName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func revokeFlowEntitlement(_ input: RevokeFlowEntitlementRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RevokeFlowEntitlementResponse> {
        return client.execute(operation: "RevokeFlowEntitlement", path: "/v1/flows/{flowArn}/entitlements/{entitlementArn}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Starts a flow.
    public func startFlow(_ input: StartFlowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartFlowResponse> {
        return client.execute(operation: "StartFlow", path: "/v1/flows/start/{flowArn}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Stops a flow.
    public func stopFlow(_ input: StopFlowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopFlowResponse> {
        return client.execute(operation: "StopFlow", path: "/v1/flows/stop/{flowArn}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateFlow(_ input: UpdateFlowRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFlowResponse> {
        return client.execute(operation: "UpdateFlow", path: "/v1/flows/{flowArn}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateFlowEntitlement(_ input: UpdateFlowEntitlementRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFlowEntitlementResponse> {
        return client.execute(operation: "UpdateFlowEntitlement", path: "/v1/flows/{flowArn}/entitlements/{entitlementArn}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateFlowOutput(_ input: UpdateFlowOutputRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFlowOutputResponse> {
        return client.execute(operation: "UpdateFlowOutput", path: "/v1/flows/{flowArn}/outputs/{outputArn}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateFlowSource(_ input: UpdateFlowSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateFlowSourceResponse> {
        return client.execute(operation: "UpdateFlowSource", path: "/v1/flows/{flowArn}/source/{sourceArn}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
}
