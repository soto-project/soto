...
public struct SavingsPlans {
    ...
    public func createSavingsPlan(_ input: CreateSavingsPlanRequest) -> Future<CreateSavingsPlanResponse> {
        return client.send(operation: "CreateSavingsPlan", path: "/CreateSavingsPlan", httpMethod: "POST", input: input)
    }

    ///  Describes the specified Savings Plans rates.
    public func describeSavingsPlanRates(_ input: DescribeSavingsPlanRatesRequest) -> Future<DescribeSavingsPlanRatesResponse> {
        return client.send(operation: "DescribeSavingsPlanRates", path: "/DescribeSavingsPlanRates", httpMethod: "POST", input: input)
    }

    ///  Describes the specified Savings Plans.
    public func describeSavingsPlans(_ input: DescribeSavingsPlansRequest) -> Future<DescribeSavingsPlansResponse> {
        return client.send(operation: "DescribeSavingsPlans", path: "/DescribeSavingsPlans", httpMethod: "POST", input: input)
    }

    ///  Describes the specified Savings Plans offering rates.
    public func describeSavingsPlansOfferingRates(_ input: DescribeSavingsPlansOfferingRatesRequest) -> Future<DescribeSavingsPlansOfferingRatesResponse> {
    ...
    public func describeSavingsPlansOfferings(_ input: DescribeSavingsPlansOfferingsRequest) -> Future<DescribeSavingsPlansOfferingsResponse> {
