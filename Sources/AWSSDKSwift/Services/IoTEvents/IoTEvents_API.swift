...
public struct IoTEvents: AWSService {
    ...
    /// return new `IoTEvents` with new timeout value
    ...
    /// return new `IoTEvents` logging to specified Logger
    ...
    public func createDetectorModel(_ input: CreateDetectorModelRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDetectorModelResponse> {
        return client.execute(operation: "CreateDetectorModel", path: "/detector-models", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Creates an input.
    public func createInput(_ input: CreateInputRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateInputResponse> {
        return client.execute(operation: "CreateInput", path: "/inputs", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteDetectorModel(_ input: DeleteDetectorModelRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDetectorModelResponse> {
        return client.execute(operation: "DeleteDetectorModel", path: "/detector-models/{detectorModelName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes an input.
    public func deleteInput(_ input: DeleteInputRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteInputResponse> {
        return client.execute(operation: "DeleteInput", path: "/inputs/{inputName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeDetectorModel(_ input: DescribeDetectorModelRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDetectorModelResponse> {
        return client.execute(operation: "DescribeDetectorModel", path: "/detector-models/{detectorModelName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes an input.
    public func describeInput(_ input: DescribeInputRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeInputResponse> {
        return client.execute(operation: "DescribeInput", path: "/inputs/{inputName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listDetectorModelVersions(_ input: ListDetectorModelVersionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDetectorModelVersionsResponse> {
        return client.execute(operation: "ListDetectorModelVersions", path: "/detector-models/{detectorModelName}/versions", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listDetectorModels(_ input: ListDetectorModelsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDetectorModelsResponse> {
        return client.execute(operation: "ListDetectorModels", path: "/detector-models", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the inputs you have created.
    public func listInputs(_ input: ListInputsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListInputsResponse> {
        return client.execute(operation: "ListInputs", path: "/inputs", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateDetectorModel(_ input: UpdateDetectorModelRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDetectorModelResponse> {
        return client.execute(operation: "UpdateDetectorModel", path: "/detector-models/{detectorModelName}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Updates an input.
    public func updateInput(_ input: UpdateInputRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateInputResponse> {
        return client.execute(operation: "UpdateInput", path: "/inputs/{inputName}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
}
