...
public struct MediaStore {
    ...
    public func getCorsPolicy(_ input: GetCorsPolicyInput) throws -> GetCorsPolicyOutput {
    ...
    public func putCorsPolicy(_ input: PutCorsPolicyInput) throws -> PutCorsPolicyOutput {
    ...
    public func deleteCorsPolicy(_ input: DeleteCorsPolicyInput) throws -> DeleteCorsPolicyOutput {
