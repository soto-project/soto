...
public struct MediaStore {
    ...
    public func putCorsPolicy(_ input: PutCorsPolicyInput) throws -> EventLoopFuture<PutCorsPolicyOutput> {
    ...
    public func deleteCorsPolicy(_ input: DeleteCorsPolicyInput) throws -> EventLoopFuture<DeleteCorsPolicyOutput> {
    ...
    public func putContainerPolicy(_ input: PutContainerPolicyInput) throws -> EventLoopFuture<PutContainerPolicyOutput> {
    ...
    public func describeContainer(_ input: DescribeContainerInput) throws -> EventLoopFuture<DescribeContainerOutput> {
    ...
    public func listContainers(_ input: ListContainersInput) throws -> EventLoopFuture<ListContainersOutput> {
        return try client.send(operation: "ListContainers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a storage container to hold objects. A container is similar to a bucket in the Amazon S3 service.
    public func createContainer(_ input: CreateContainerInput) throws -> EventLoopFuture<CreateContainerOutput> {
        return try client.send(operation: "CreateContainer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified container. Before you make a DeleteContainer request, delete any objects in the container or in any folders in the container. You can delete only empty containers. 
    public func deleteContainer(_ input: DeleteContainerInput) throws -> EventLoopFuture<DeleteContainerOutput> {
        return try client.send(operation: "DeleteContainer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the access policy that is associated with the specified container.
    public func deleteContainerPolicy(_ input: DeleteContainerPolicyInput) throws -> EventLoopFuture<DeleteContainerPolicyOutput> {
    ...
    public func getCorsPolicy(_ input: GetCorsPolicyInput) throws -> EventLoopFuture<GetCorsPolicyOutput> {
        return try client.send(operation: "GetCorsPolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the access policy for the specified container. For information about the data that is included in an access policy, see the AWS Identity and Access Management User Guide.
    public func getContainerPolicy(_ input: GetContainerPolicyInput) throws -> EventLoopFuture<GetContainerPolicyOutput> {
