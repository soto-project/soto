...
extension MediaStore {
    ...
    public struct Container: AWSShape {
        ...
        public init(endpoint: String? = nil, creationTime: TimeStamp? = nil, arn: String? = nil, name: String? = nil, status: ContainerStatus? = nil) {
    ...
    public struct CorsRule: AWSShape {
        ...
        public init(allowedHeaders: [String]? = nil, exposeHeaders: [String]? = nil, maxAgeSeconds: Int32? = nil, allowedMethods: [MethodName]? = nil, allowedOrigins: [String]? = nil) {
