...
extension MarketplaceCommerceAnalytics {
    ...
    public struct GenerateDataSetRequest: AWSShape {
        ...
        public init(customerDefinedValues: [String: String]? = nil, dataSetPublicationDate: TimeStamp, destinationS3BucketName: String, destinationS3Prefix: String? = nil, dataSetType: DataSetType, snsTopicArn: String, roleNameArn: String) {
    ...
    public struct StartSupportDataExportRequest: AWSShape {
        ...
        public init(roleNameArn: String, dataSetType: SupportDataSetType, fromDate: TimeStamp, snsTopicArn: String, destinationS3Prefix: String? = nil, customerDefinedValues: [String: String]? = nil, destinationS3BucketName: String) {
            self.roleNameArn = roleNameArn
            self.dataSetType = dataSetType
