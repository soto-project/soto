...
extension MarketplaceCommerceAnalytics {
    ...
    public struct GenerateDataSetRequest: AWSShape {
        ...
        public init(customerDefinedValues: [String: String]? = nil, dataSetType: DataSetType, dataSetPublicationDate: TimeStamp, destinationS3BucketName: String, snsTopicArn: String, destinationS3Prefix: String? = nil, roleNameArn: String) {
    ...
    public struct StartSupportDataExportRequest: AWSShape {
        ...
        public init(fromDate: TimeStamp, customerDefinedValues: [String: String]? = nil, dataSetType: SupportDataSetType, destinationS3BucketName: String, snsTopicArn: String, destinationS3Prefix: String? = nil, roleNameArn: String) {
