...
extension MarketplaceCommerceAnalytics {
    ...
    public struct GenerateDataSetRequest: AWSShape {
        ...
        public init(roleNameArn: String, customerDefinedValues: [String: String]? = nil, dataSetPublicationDate: TimeStamp, destinationS3Prefix: String? = nil, destinationS3BucketName: String, dataSetType: DataSetType, snsTopicArn: String) {
    ...
    public struct StartSupportDataExportRequest: AWSShape {
        ...
        public init(roleNameArn: String, fromDate: TimeStamp, customerDefinedValues: [String: String]? = nil, destinationS3Prefix: String? = nil, destinationS3BucketName: String, dataSetType: SupportDataSetType, snsTopicArn: String) {
            self.roleNameArn = roleNameArn
