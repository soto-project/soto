...
extension MarketplaceCommerceAnalytics {
    ...
    public struct GenerateDataSetRequest: AWSShape {
        ...
        public init(dataSetType: DataSetType, customerDefinedValues: [String: String]? = nil, roleNameArn: String, dataSetPublicationDate: TimeStamp, destinationS3Prefix: String? = nil, snsTopicArn: String, destinationS3BucketName: String) {
    ...
    public struct StartSupportDataExportRequest: AWSShape {
        ...
        public init(dataSetType: SupportDataSetType, fromDate: TimeStamp, customerDefinedValues: [String: String]? = nil, roleNameArn: String, destinationS3Prefix: String? = nil, snsTopicArn: String, destinationS3BucketName: String) {
            self.dataSetType = dataSetType
