...
extension MarketplaceCommerceAnalytics {
    ...
    public struct StartSupportDataExportRequest: AWSShape {
        ...
        public init(roleNameArn: String, customerDefinedValues: [String: String]? = nil, destinationS3BucketName: String, dataSetType: SupportDataSetType, destinationS3Prefix: String? = nil, snsTopicArn: String, fromDate: TimeStamp) {
    ...
    public struct GenerateDataSetRequest: AWSShape {
        ...
        public init(roleNameArn: String, customerDefinedValues: [String: String]? = nil, destinationS3BucketName: String, dataSetType: DataSetType, dataSetPublicationDate: TimeStamp, destinationS3Prefix: String? = nil, snsTopicArn: String) {
            self.roleNameArn = roleNameArn
            self.customerDefinedValues = customerDefinedValues
            self.destinationS3BucketName = destinationS3BucketName
            self.dataSetType = dataSetType
