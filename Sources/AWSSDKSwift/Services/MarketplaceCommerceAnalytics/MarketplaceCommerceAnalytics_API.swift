...
public struct MarketplaceCommerceAnalytics {
    ...
    public func generateDataSet(_ input: GenerateDataSetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GenerateDataSetResult> {
    ...
    public func startSupportDataExport(_ input: StartSupportDataExportRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StartSupportDataExportResult> {
