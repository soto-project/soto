...
public struct MarketplaceCommerceAnalytics {
    ...
    public func generateDataSet(_ input: GenerateDataSetRequest) throws -> EventLoopFuture<GenerateDataSetResult> {
    ...
    public func startSupportDataExport(_ input: StartSupportDataExportRequest) throws -> EventLoopFuture<StartSupportDataExportResult> {
