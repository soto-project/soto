...
extension CodeArtifact {
    ...
    public func listDomainsPaginator(
        ...
        onPage: @escaping (ListDomainsResult,
    ...
    public func listPackageVersionAssetsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListPackageVersionAssetsResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listPackageVersionsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListPackageVersionsResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listPackagesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListPackagesResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listRepositoriesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListRepositoriesResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listRepositoriesInDomainPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListRepositoriesInDomainResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
