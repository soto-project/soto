...
extension WAF {
    ...
    public struct Predicate: AWSShape {
        ...
        public init(type: PredicateType, dataId: String, negated: Bool) {
            self.`type` = `type`
            self.dataId = dataId
    ...
    public struct RuleGroupSummary: AWSShape {
        ...
        public init(ruleGroupId: String, name: String) {
            self.ruleGroupId = ruleGroupId
            self.name = name
        }
    ...
    public struct UpdateWebACLRequest: AWSShape {
        ...
        public init(webACLId: String, defaultAction: WafAction? = nil, updates: [WebACLUpdate]? = nil, changeToken: String) {
    ...
    public struct UpdateIPSetRequest: AWSShape {
        ...
        public init(updates: [IPSetUpdate], changeToken: String, iPSetId: String) {
            self.updates = updates
            self.changeToken = changeToken
    ...
    public struct UpdateSqlInjectionMatchSetRequest: AWSShape {
        ...
        public init(updates: [SqlInjectionMatchSetUpdate], changeToken: String, sqlInjectionMatchSetId: String) {
            self.updates = updates
            self.changeToken = changeToken
            self.sqlInjectionMatchSetId = sqlInjectionMatchSetId
        }
    ...
    public struct SampledHTTPRequest: AWSShape {
        ...
        public init(weight: Int64, timestamp: TimeStamp? = nil, action: String? = nil, request: HTTPRequest, ruleWithinRuleGroup: String? = nil) {
            self.weight = weight
    ...
    public struct RateBasedRule: AWSShape {
        ...
        public init(name: String? = nil, rateKey: RateKey, matchPredicates: [Predicate], rateLimit: Int64, metricName: String? = nil, ruleId: String) {
            self.name = name
    ...
    public struct WebACL: AWSShape {
        ...
        public init(webACLId: String, name: String? = nil, defaultAction: WafAction, metricName: String? = nil, rules: [ActivatedRule]) {
            self.webACLId = webACLId
            self.name = name
            self.defaultAction = defaultAction
            self.metricName = metricName
    ...
    public struct CreateRateBasedRuleRequest: AWSShape {
        ...
        public init(name: String, rateKey: RateKey, rateLimit: Int64, metricName: String, changeToken: String) {
            self.name = name
            self.rateKey = rateKey
            self.rateLimit = rateLimit
            self.metricName = metricName
    ...
    public struct UpdateSizeConstraintSetRequest: AWSShape {
        ...
        public init(updates: [SizeConstraintSetUpdate], changeToken: String, sizeConstraintSetId: String) {
            self.updates = updates
            self.changeToken = changeToken
            self.sizeConstraintSetId = sizeConstraintSetId
        }
    ...
    public struct SizeConstraint: AWSShape {
        ...
        public init(textTransformation: TextTransformation, comparisonOperator: ComparisonOperator, size: Int64, fieldToMatch: FieldToMatch) {
            self.textTransformation = textTransformation
    ...
    public struct CreateWebACLRequest: AWSShape {
        ...
        public init(name: String, defaultAction: WafAction, metricName: String, changeToken: String) {
            self.name = name
            self.defaultAction = defaultAction
            self.metricName = metricName
            self.changeToken = changeToken
    ...
    public struct HTTPRequest: AWSShape {
        ...
        public init(method: String? = nil, clientIP: String? = nil, headers: [HTTPHeader]? = nil, uri: String? = nil, hTTPVersion: String? = nil, country: String? = nil) {
            self.method = method
    ...
    public struct UpdateByteMatchSetRequest: AWSShape {
        ...
        public init(updates: [ByteMatchSetUpdate], changeToken: String, byteMatchSetId: String) {
            self.updates = updates
            self.changeToken = changeToken
            self.byteMatchSetId = byteMatchSetId
        }
    ...
    public struct ByteMatchTuple: AWSShape {
        ...
        public init(positionalConstraint: PositionalConstraint, fieldToMatch: FieldToMatch, targetString: Data, textTransformation: TextTransformation) {
    ...
    public struct ActivatedRule: AWSShape {
        ...
        public init(priority: Int32, type: WafRuleType? = nil, ruleId: String, action: WafAction? = nil, overrideAction: WafOverrideAction? = nil) {
    ...
    public struct Rule: AWSShape {
        ...
        public init(name: String? = nil, ruleId: String, metricName: String? = nil, predicates: [Predicate]) {
            self.name = name
            self.ruleId = ruleId
            self.metricName = metricName
    ...
    public struct RegexPatternSet: AWSShape {
        ...
        public init(regexPatternSetId: String, regexPatternStrings: [String], name: String? = nil) {
            self.regexPatternSetId = regexPatternSetId
    ...
    public struct UpdateRuleRequest: AWSShape {
        ...
        public init(updates: [RuleUpdate], changeToken: String, ruleId: String) {
            self.updates = updates
            self.changeToken = changeToken
            self.ruleId = ruleId
        }
    ...
    public struct UpdateRateBasedRuleRequest: AWSShape {
        ...
        public init(ruleId: String, rateLimit: Int64, updates: [RuleUpdate], changeToken: String) {
            self.ruleId = ruleId
            self.rateLimit = rateLimit
            self.updates = updates
            self.changeToken = changeToken
