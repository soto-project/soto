...
extension WAF {
    ...
    public struct GetSampledRequestsResponse: AWSShape {
        ...
        public init(timeWindow: TimeWindow? = nil, populationSize: Int64? = nil, sampledRequests: [SampledHTTPRequest]? = nil) {
    ...
    public struct UpdateByteMatchSetRequest: AWSShape {
        ...
        public init(changeToken: String, updates: [ByteMatchSetUpdate], byteMatchSetId: String) {
    ...
    public struct CreateRateBasedRuleRequest: AWSShape {
        ...
        public init(rateKey: RateKey, changeToken: String, name: String, rateLimit: Int64, metricName: String) {
    ...
    public struct SizeConstraint: AWSShape {
        ...
        public init(fieldToMatch: FieldToMatch, size: Int64, textTransformation: TextTransformation, comparisonOperator: ComparisonOperator) {
    ...
    public struct UpdateRuleGroupRequest: AWSShape {
        ...
        public init(updates: [RuleGroupUpdate], changeToken: String, ruleGroupId: String) {
            self.updates = updates
            self.changeToken = changeToken
            self.ruleGroupId = ruleGroupId
        }
    ...
    public struct GetRateBasedRuleManagedKeysResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, managedKeys: [String]? = nil) {
            self.nextMarker = nextMarker
    ...
    public struct CreateRuleRequest: AWSShape {
        ...
        public init(name: String, metricName: String, changeToken: String) {
            self.name = name
            self.metricName = metricName
            self.changeToken = changeToken
        }
    ...
    public struct ListByteMatchSetsResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, byteMatchSets: [ByteMatchSetSummary]? = nil) {
            self.nextMarker = nextMarker
    ...
    public struct UpdateSqlInjectionMatchSetRequest: AWSShape {
        ...
        public init(sqlInjectionMatchSetId: String, changeToken: String, updates: [SqlInjectionMatchSetUpdate]) {
    ...
    public struct RegexMatchTuple: AWSShape {
        ...
        public init(regexPatternSetId: String, fieldToMatch: FieldToMatch, textTransformation: TextTransformation) {
    ...
    public struct UpdateGeoMatchSetRequest: AWSShape {
        ...
        public init(updates: [GeoMatchSetUpdate], changeToken: String, geoMatchSetId: String) {
            self.updates = updates
            self.changeToken = changeToken
    ...
    public struct GetSampledRequestsRequest: AWSShape {
        ...
        public init(webAclId: String, ruleId: String, timeWindow: TimeWindow, maxItems: Int64) {
    ...
    public struct ListIPSetsResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, iPSets: [IPSetSummary]? = nil) {
            self.nextMarker = nextMarker
            self.iPSets = iPSets
        }
    ...
    public struct CreateWebACLRequest: AWSShape {
        ...
        public init(defaultAction: WafAction, name: String, changeToken: String, metricName: String) {
    ...
    public struct SampledHTTPRequest: AWSShape {
        ...
        public init(ruleWithinRuleGroup: String? = nil, action: String? = nil, timestamp: TimeStamp? = nil, weight: Int64, request: HTTPRequest) {
    ...
    public struct TimeWindow: AWSShape {
        ...
        public init(startTime: TimeStamp, endTime: TimeStamp) {
    ...
    public struct ListByteMatchSetsRequest: AWSShape {
        ...
        public init(nextMarker: String? = nil, limit: Int32? = nil) {
            self.nextMarker = nextMarker
            self.limit = limit
        }
    ...
    public struct LoggingConfiguration: AWSShape {
        ...
        public init(logDestinationConfigs: [String], resourceArn: String, redactedFields: [FieldToMatch]? = nil) {
    ...
    public struct RegexMatchSet: AWSShape {
        ...
        public init(regexMatchTuples: [RegexMatchTuple]? = nil, name: String? = nil, regexMatchSetId: String? = nil) {
    ...
    public struct ListGeoMatchSetsResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, geoMatchSets: [GeoMatchSetSummary]? = nil) {
            self.nextMarker = nextMarker
    ...
    public struct SizeConstraintSet: AWSShape {
        ...
        public init(sizeConstraintSetId: String, name: String? = nil, sizeConstraints: [SizeConstraint]) {
            self.sizeConstraintSetId = sizeConstraintSetId
            self.name = name
    ...
    public struct HTTPRequest: AWSShape {
        ...
        public init(clientIP: String? = nil, uri: String? = nil, method: String? = nil, hTTPVersion: String? = nil, headers: [HTTPHeader]? = nil, country: String? = nil) {
    ...
    public struct WebACLUpdate: AWSShape {
        ...
        public init(activatedRule: ActivatedRule, action: ChangeAction) {
    ...
    public struct ListActivatedRulesInRuleGroupResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, activatedRules: [ActivatedRule]? = nil) {
            self.nextMarker = nextMarker
    ...
    public struct UpdateIPSetRequest: AWSShape {
        ...
        public init(iPSetId: String, updates: [IPSetUpdate], changeToken: String) {
            self.iPSetId = iPSetId
            self.updates = updates
            self.changeToken = changeToken
        }
    ...
    public struct GeoMatchSet: AWSShape {
        ...
        public init(name: String? = nil, geoMatchConstraints: [GeoMatchConstraint], geoMatchSetId: String) {
            self.name = name
    ...
    public struct ActivatedRule: AWSShape {
        ...
        public init(priority: Int32, type: WafRuleType? = nil, overrideAction: WafOverrideAction? = nil, ruleId: String, action: WafAction? = nil) {
    ...
    public struct SqlInjectionMatchSet: AWSShape {
        ...
        public init(sqlInjectionMatchTuples: [SqlInjectionMatchTuple], sqlInjectionMatchSetId: String, name: String? = nil) {
    ...
    public struct WebACL: AWSShape {
        ...
        public init(rules: [ActivatedRule], name: String? = nil, webACLId: String, defaultAction: WafAction, metricName: String? = nil) {
            self.rules = rules
            self.name = name
            self.webACLId = webACLId
            self.defaultAction = defaultAction
    ...
    public struct RegexPatternSet: AWSShape {
        ...
        public init(regexPatternStrings: [String], regexPatternSetId: String, name: String? = nil) {
    ...
    public struct SqlInjectionMatchSetUpdate: AWSShape {
        ...
        public init(sqlInjectionMatchTuple: SqlInjectionMatchTuple, action: ChangeAction) {
    ...
    public struct UpdateRegexPatternSetRequest: AWSShape {
        ...
        public init(regexPatternSetId: String, updates: [RegexPatternSetUpdate], changeToken: String) {
            self.regexPatternSetId = regexPatternSetId
            self.updates = updates
            self.changeToken = changeToken
        }
    ...
    public struct ByteMatchTuple: AWSShape {
        ...
        public init(fieldToMatch: FieldToMatch, targetString: Data, positionalConstraint: PositionalConstraint, textTransformation: TextTransformation) {
            self.fieldToMatch = fieldToMatch
    ...
    public struct Rule: AWSShape {
        ...
        public init(name: String? = nil, metricName: String? = nil, predicates: [Predicate], ruleId: String) {
            self.name = name
            self.metricName = metricName
    ...
    public struct RuleGroup: AWSShape {
        ...
        public init(name: String? = nil, metricName: String? = nil, ruleGroupId: String) {
            self.name = name
            self.metricName = metricName
            self.ruleGroupId = ruleGroupId
        }
    ...
    public struct UpdateWebACLRequest: AWSShape {
        ...
        public init(webACLId: String, defaultAction: WafAction? = nil, changeToken: String, updates: [WebACLUpdate]? = nil) {
            self.webACLId = webACLId
            self.defaultAction = defaultAction
            self.changeToken = changeToken
            self.updates = updates
    ...
    public struct SubscribedRuleGroupSummary: AWSShape {
        ...
        public init(ruleGroupId: String, metricName: String, name: String) {
            self.ruleGroupId = ruleGroupId
            self.metricName = metricName
            self.name = name
        }
    ...
    public struct ListActivatedRulesInRuleGroupRequest: AWSShape {
        ...
        public init(nextMarker: String? = nil, limit: Int32? = nil, ruleGroupId: String? = nil) {
            self.nextMarker = nextMarker
            self.limit = limit
            self.ruleGroupId = ruleGroupId
        }
    ...
    public struct UpdateRateBasedRuleRequest: AWSShape {
        ...
        public init(changeToken: String, rateLimit: Int64, updates: [RuleUpdate], ruleId: String) {
            self.changeToken = changeToken
            self.rateLimit = rateLimit
            self.updates = updates
            self.ruleId = ruleId
    ...
    public struct RateBasedRule: AWSShape {
        ...
        public init(matchPredicates: [Predicate], rateKey: RateKey, name: String? = nil, metricName: String? = nil, rateLimit: Int64, ruleId: String) {
    ...
    public struct CreateGeoMatchSetResponse: AWSShape {
        ...
        public init(geoMatchSet: GeoMatchSet? = nil, changeToken: String? = nil) {
            self.geoMatchSet = geoMatchSet
            self.changeToken = changeToken
        }
    ...
    public struct ListLoggingConfigurationsResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, loggingConfigurations: [LoggingConfiguration]? = nil) {
            self.nextMarker = nextMarker
