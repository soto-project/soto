...
extension GameLift {
    ...
    public struct CreateGameServerGroupInput: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "BalancingStrategy", required: false, type: .enum), 
            AWSShapeMember(label: "GameServerGroupName", required: true, type: .string), 
            AWSShapeMember(label: "GameServerProtectionPolicy", required: false, type: .enum), 
            AWSShapeMember(label: "InstanceDefinitions", required: true, type: .list), 
            AWSShapeMember(label: "LaunchTemplate", required: true, type: .structure), 
    ...
    public struct DeleteGameServerGroupInput: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "DeleteOption", required: false, type: .enum), 
            AWSShapeMember(label: "GameServerGroupName", required: true, type: .string)
        ]
    ...
    public struct FleetAttributes: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "OperatingSystem", required: false, type: .enum), 
            AWSShapeMember(label: "ResourceCreationLimitPolicy", required: false, type: .structure), 
            AWSShapeMember(label: "ScriptArn", required: false, type: .string), 
            AWSShapeMember(label: "ScriptId", required: false, type: .string), 
            AWSShapeMember(label: "ServerLaunchParameters", required: false, type: .string), 
            AWSShapeMember(label: "ServerLaunchPath", required: false, type: .string), 
            AWSShapeMember(label: "Status", required: false, type: .enum), 
    ...
    public struct GameServer: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "GameServerId", required: false, type: .string), 
            AWSShapeMember(label: "InstanceId", required: false, type: .string), 
            AWSShapeMember(label: "LastClaimTime", required: false, type: .timestamp), 
            AWSShapeMember(label: "LastHealthCheckTime", required: false, type: .timestamp), 
            AWSShapeMember(label: "RegistrationTime", required: false, type: .timestamp), 
    ...
    public struct GameServerGroup: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "GameServerGroupName", required: false, type: .string), 
            AWSShapeMember(label: "GameServerProtectionPolicy", required: false, type: .enum), 
            AWSShapeMember(label: "InstanceDefinitions", required: false, type: .list), 
            AWSShapeMember(label: "LastUpdatedTime", required: false, type: .timestamp), 
    ...
    public struct InstanceDefinition: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "WeightedCapacity", required: false, type: .string)
        ]
    ...
    public struct ListGameServerGroupsOutput: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "GameServerGroups", required: false, type: .list), 
            AWSShapeMember(label: "NextToken", required: false, type: .string)
        ]
    ...
    public struct ListGameServersOutput: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "GameServers", required: false, type: .list), 
            AWSShapeMember(label: "NextToken", required: false, type: .string)
        ]
    ...
    public struct MatchmakingConfiguration: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "AdditionalPlayerCount", required: false, type: .integer), 
            AWSShapeMember(label: "BackfillMode", required: false, type: .enum), 
            AWSShapeMember(label: "ConfigurationArn", required: false, type: .string), 
            AWSShapeMember(label: "CreationTime", required: false, type: .timestamp), 
            AWSShapeMember(label: "CustomEventData", required: false, type: .string), 
            AWSShapeMember(label: "Description", required: false, type: .string), 
            AWSShapeMember(label: "GameProperties", required: false, type: .list), 
            ...
            AWSShapeMember(label: "RuleSetArn", required: false, type: .string), 
            AWSShapeMember(label: "RuleSetName", required: false, type: .string)
        ]
    ...
    public struct UpdateGameServerInput: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "GameServerGroupName", required: true, type: .string), 
            AWSShapeMember(label: "GameServerId", required: true, type: .string), 
            AWSShapeMember(label: "HealthCheck", required: false, type: .enum), 
            AWSShapeMember(label: "UtilizationStatus", required: false, type: .enum)
        ]
