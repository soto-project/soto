...
public struct PinpointSMSVoice {
    ...
    public func sendVoiceMessage(_ input: SendVoiceMessageRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SendVoiceMessageResponse> {
