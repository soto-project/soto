...
public struct Dynamodb {
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput) throws -> CreateGlobalTableOutput {
        return try client.send(operation: "CreateGlobalTable", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes region specific settings for a global table.
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput) throws -> DescribeGlobalTableSettingsOutput {
        return try client.send(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about the specified global table.
    public func describeGlobalTable(_ input: DescribeGlobalTableInput) throws -> DescribeGlobalTableOutput {
        return try client.send(operation: "DescribeGlobalTable", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createBackup(_ input: CreateBackupInput) throws -> CreateBackupOutput {
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput) throws -> RestoreTableFromBackupOutput {
        return try client.send(operation: "RestoreTableFromBackup", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput) throws -> ListGlobalTablesOutput {
        return try client.send(operation: "ListGlobalTables", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listBackups(_ input: ListBackupsInput) throws -> ListBackupsOutput {
        return try client.send(operation: "ListBackups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an existing backup of a table. You can call DeleteBackup at a maximum rate of 10 times per second.
    public func deleteBackup(_ input: DeleteBackupInput) throws -> DeleteBackupOutput {
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput) throws -> DescribeContinuousBackupsOutput {
    ...
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput) throws -> UpdateGlobalTableSettingsOutput {
        return try client.send(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput) throws -> UpdateContinuousBackupsOutput {
        return try client.send(operation: "UpdateContinuousBackups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes an existing backup of a table. You can call DescribeBackup at a maximum rate of 10 times per second.
    public func describeBackup(_ input: DescribeBackupInput) throws -> DescribeBackupOutput {
        return try client.send(operation: "DescribeBackup", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput) throws -> UpdateGlobalTableOutput {
        return try client.send(operation: "UpdateGlobalTable", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput) throws -> RestoreTableToPointInTimeOutput {
        return try client.send(operation: "RestoreTableToPointInTime", path: "/", httpMethod: "POST", input: input)
    }
