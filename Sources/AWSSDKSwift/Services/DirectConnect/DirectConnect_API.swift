...
public struct DirectConnect: AWSService {
    ...
    public func acceptDirectConnectGatewayAssociationProposal(_ input: AcceptDirectConnectGatewayAssociationProposalRequest) -> EventLoopFuture<AcceptDirectConnectGatewayAssociationProposalResult> {
        return client.execute(operation: "AcceptDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func allocateConnectionOnInterconnect(_ input: AllocateConnectionOnInterconnectRequest) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AllocateConnectionOnInterconnect", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func allocateHostedConnection(_ input: AllocateHostedConnectionRequest) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AllocateHostedConnection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func allocatePrivateVirtualInterface(_ input: AllocatePrivateVirtualInterfaceRequest) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "AllocatePrivateVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func allocatePublicVirtualInterface(_ input: AllocatePublicVirtualInterfaceRequest) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "AllocatePublicVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func allocateTransitVirtualInterface(_ input: AllocateTransitVirtualInterfaceRequest) -> EventLoopFuture<AllocateTransitVirtualInterfaceResult> {
        return client.execute(operation: "AllocateTransitVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func associateConnectionWithLag(_ input: AssociateConnectionWithLagRequest) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AssociateConnectionWithLag", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func associateHostedConnection(_ input: AssociateHostedConnectionRequest) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AssociateHostedConnection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func associateVirtualInterface(_ input: AssociateVirtualInterfaceRequest) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "AssociateVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func confirmConnection(_ input: ConfirmConnectionRequest) -> EventLoopFuture<ConfirmConnectionResponse> {
        return client.execute(operation: "ConfirmConnection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func confirmPrivateVirtualInterface(_ input: ConfirmPrivateVirtualInterfaceRequest) -> EventLoopFuture<ConfirmPrivateVirtualInterfaceResponse> {
        return client.execute(operation: "ConfirmPrivateVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func confirmPublicVirtualInterface(_ input: ConfirmPublicVirtualInterfaceRequest) -> EventLoopFuture<ConfirmPublicVirtualInterfaceResponse> {
        return client.execute(operation: "ConfirmPublicVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func confirmTransitVirtualInterface(_ input: ConfirmTransitVirtualInterfaceRequest) -> EventLoopFuture<ConfirmTransitVirtualInterfaceResponse> {
        return client.execute(operation: "ConfirmTransitVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createBGPPeer(_ input: CreateBGPPeerRequest) -> EventLoopFuture<CreateBGPPeerResponse> {
        return client.execute(operation: "CreateBGPPeer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDirectConnectGateway(_ input: CreateDirectConnectGatewayRequest) -> EventLoopFuture<CreateDirectConnectGatewayResult> {
        return client.execute(operation: "CreateDirectConnectGateway", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDirectConnectGatewayAssociation(_ input: CreateDirectConnectGatewayAssociationRequest) -> EventLoopFuture<CreateDirectConnectGatewayAssociationResult> {
        return client.execute(operation: "CreateDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDirectConnectGatewayAssociationProposal(_ input: CreateDirectConnectGatewayAssociationProposalRequest) -> EventLoopFuture<CreateDirectConnectGatewayAssociationProposalResult> {
        return client.execute(operation: "CreateDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createInterconnect(_ input: CreateInterconnectRequest) -> EventLoopFuture<Interconnect> {
        return client.execute(operation: "CreateInterconnect", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createLag(_ input: CreateLagRequest) -> EventLoopFuture<Lag> {
        return client.execute(operation: "CreateLag", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createPrivateVirtualInterface(_ input: CreatePrivateVirtualInterfaceRequest) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "CreatePrivateVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createPublicVirtualInterface(_ input: CreatePublicVirtualInterfaceRequest) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "CreatePublicVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createTransitVirtualInterface(_ input: CreateTransitVirtualInterfaceRequest) -> EventLoopFuture<CreateTransitVirtualInterfaceResult> {
        return client.execute(operation: "CreateTransitVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteBGPPeer(_ input: DeleteBGPPeerRequest) -> EventLoopFuture<DeleteBGPPeerResponse> {
        return client.execute(operation: "DeleteBGPPeer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDirectConnectGateway(_ input: DeleteDirectConnectGatewayRequest) -> EventLoopFuture<DeleteDirectConnectGatewayResult> {
        return client.execute(operation: "DeleteDirectConnectGateway", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDirectConnectGatewayAssociation(_ input: DeleteDirectConnectGatewayAssociationRequest) -> EventLoopFuture<DeleteDirectConnectGatewayAssociationResult> {
        return client.execute(operation: "DeleteDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDirectConnectGatewayAssociationProposal(_ input: DeleteDirectConnectGatewayAssociationProposalRequest) -> EventLoopFuture<DeleteDirectConnectGatewayAssociationProposalResult> {
        return client.execute(operation: "DeleteDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteInterconnect(_ input: DeleteInterconnectRequest) -> EventLoopFuture<DeleteInterconnectResponse> {
        return client.execute(operation: "DeleteInterconnect", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified link aggregation group (LAG). You cannot delete a LAG if it has active virtual interfaces or hosted connections.
    public func deleteLag(_ input: DeleteLagRequest) -> EventLoopFuture<Lag> {
        return client.execute(operation: "DeleteLag", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteVirtualInterface(_ input: DeleteVirtualInterfaceRequest) -> EventLoopFuture<DeleteVirtualInterfaceResponse> {
        return client.execute(operation: "DeleteVirtualInterface", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeConnectionLoa(_ input: DescribeConnectionLoaRequest) -> EventLoopFuture<DescribeConnectionLoaResponse> {
        return client.execute(operation: "DescribeConnectionLoa", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeConnectionsOnInterconnect(_ input: DescribeConnectionsOnInterconnectRequest) -> EventLoopFuture<Connections> {
        return client.execute(operation: "DescribeConnectionsOnInterconnect", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDirectConnectGatewayAssociationProposals(_ input: DescribeDirectConnectGatewayAssociationProposalsRequest) -> EventLoopFuture<DescribeDirectConnectGatewayAssociationProposalsResult> {
        return client.execute(operation: "DescribeDirectConnectGatewayAssociationProposals", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDirectConnectGatewayAssociations(_ input: DescribeDirectConnectGatewayAssociationsRequest) -> EventLoopFuture<DescribeDirectConnectGatewayAssociationsResult> {
        return client.execute(operation: "DescribeDirectConnectGatewayAssociations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDirectConnectGatewayAttachments(_ input: DescribeDirectConnectGatewayAttachmentsRequest) -> EventLoopFuture<DescribeDirectConnectGatewayAttachmentsResult> {
        return client.execute(operation: "DescribeDirectConnectGatewayAttachments", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDirectConnectGateways(_ input: DescribeDirectConnectGatewaysRequest) -> EventLoopFuture<DescribeDirectConnectGatewaysResult> {
        return client.execute(operation: "DescribeDirectConnectGateways", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeHostedConnections(_ input: DescribeHostedConnectionsRequest) -> EventLoopFuture<Connections> {
        return client.execute(operation: "DescribeHostedConnections", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeInterconnectLoa(_ input: DescribeInterconnectLoaRequest) -> EventLoopFuture<DescribeInterconnectLoaResponse> {
        return client.execute(operation: "DescribeInterconnectLoa", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the interconnects owned by the AWS account or only the specified interconnect.
    public func describeInterconnects(_ input: DescribeInterconnectsRequest) -> EventLoopFuture<Interconnects> {
        return client.execute(operation: "DescribeInterconnects", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes all your link aggregation groups (LAG) or the specified LAG.
    public func describeLags(_ input: DescribeLagsRequest) -> EventLoopFuture<Lags> {
        return client.execute(operation: "DescribeLags", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLoa(_ input: DescribeLoaRequest) -> EventLoopFuture<Loa> {
        return client.execute(operation: "DescribeLoa", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLocations() -> EventLoopFuture<Locations> {
        return client.execute(operation: "DescribeLocations", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeVirtualGateways() -> EventLoopFuture<VirtualGateways> {
        return client.execute(operation: "DescribeVirtualGateways", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeVirtualInterfaces(_ input: DescribeVirtualInterfacesRequest) -> EventLoopFuture<VirtualInterfaces> {
        return client.execute(operation: "DescribeVirtualInterfaces", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disassociateConnectionFromLag(_ input: DisassociateConnectionFromLagRequest) -> EventLoopFuture<Connection> {
        return client.execute(operation: "DisassociateConnectionFromLag", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the virtual interface failover test history.
    public func listVirtualInterfaceTestHistory(_ input: ListVirtualInterfaceTestHistoryRequest) -> EventLoopFuture<ListVirtualInterfaceTestHistoryResponse> {
        return client.execute(operation: "ListVirtualInterfaceTestHistory", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startBgpFailoverTest(_ input: StartBgpFailoverTestRequest) -> EventLoopFuture<StartBgpFailoverTestResponse> {
        return client.execute(operation: "StartBgpFailoverTest", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Stops the virtual interface failover test.
    public func stopBgpFailoverTest(_ input: StopBgpFailoverTestRequest) -> EventLoopFuture<StopBgpFailoverTestResponse> {
        return client.execute(operation: "StopBgpFailoverTest", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateDirectConnectGatewayAssociation(_ input: UpdateDirectConnectGatewayAssociationRequest) -> EventLoopFuture<UpdateDirectConnectGatewayAssociationResult> {
        return client.execute(operation: "UpdateDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateLag(_ input: UpdateLagRequest) -> EventLoopFuture<Lag> {
        return client.execute(operation: "UpdateLag", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateVirtualInterfaceAttributes(_ input: UpdateVirtualInterfaceAttributesRequest) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "UpdateVirtualInterfaceAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
