...
public struct DirectConnect: AWSService {
    ...
    /// return new `DirectConnect` with new timeout value
    ...
    /// return new `DirectConnect` logging to specified Logger
    ...
    public func acceptDirectConnectGatewayAssociationProposal(_ input: AcceptDirectConnectGatewayAssociationProposalRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AcceptDirectConnectGatewayAssociationProposalResult> {
        return client.execute(operation: "AcceptDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func allocateConnectionOnInterconnect(_ input: AllocateConnectionOnInterconnectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AllocateConnectionOnInterconnect", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func allocateHostedConnection(_ input: AllocateHostedConnectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AllocateHostedConnection", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func allocatePrivateVirtualInterface(_ input: AllocatePrivateVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "AllocatePrivateVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func allocatePublicVirtualInterface(_ input: AllocatePublicVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "AllocatePublicVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func allocateTransitVirtualInterface(_ input: AllocateTransitVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AllocateTransitVirtualInterfaceResult> {
        return client.execute(operation: "AllocateTransitVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func associateConnectionWithLag(_ input: AssociateConnectionWithLagRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AssociateConnectionWithLag", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func associateHostedConnection(_ input: AssociateHostedConnectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
        return client.execute(operation: "AssociateHostedConnection", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func associateVirtualInterface(_ input: AssociateVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "AssociateVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func confirmConnection(_ input: ConfirmConnectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfirmConnectionResponse> {
        return client.execute(operation: "ConfirmConnection", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func confirmPrivateVirtualInterface(_ input: ConfirmPrivateVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfirmPrivateVirtualInterfaceResponse> {
        return client.execute(operation: "ConfirmPrivateVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func confirmPublicVirtualInterface(_ input: ConfirmPublicVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfirmPublicVirtualInterfaceResponse> {
        return client.execute(operation: "ConfirmPublicVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func confirmTransitVirtualInterface(_ input: ConfirmTransitVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfirmTransitVirtualInterfaceResponse> {
        return client.execute(operation: "ConfirmTransitVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createBGPPeer(_ input: CreateBGPPeerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBGPPeerResponse> {
        return client.execute(operation: "CreateBGPPeer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createConnection(_ input: CreateConnectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
    ...
    public func createDirectConnectGateway(_ input: CreateDirectConnectGatewayRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDirectConnectGatewayResult> {
        return client.execute(operation: "CreateDirectConnectGateway", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Creates an association between a Direct Connect gateway and a virtual private gateway. The virtual private gateway must be attached to a VPC and must not be associated with another Direct Connect gateway.
    public func createDirectConnectGatewayAssociation(_ input: CreateDirectConnectGatewayAssociationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDirectConnectGatewayAssociationResult> {
        return client.execute(operation: "CreateDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createDirectConnectGatewayAssociationProposal(_ input: CreateDirectConnectGatewayAssociationProposalRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDirectConnectGatewayAssociationProposalResult> {
        return client.execute(operation: "CreateDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createInterconnect(_ input: CreateInterconnectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Interconnect> {
        return client.execute(operation: "CreateInterconnect", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createLag(_ input: CreateLagRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Lag> {
        return client.execute(operation: "CreateLag", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createPrivateVirtualInterface(_ input: CreatePrivateVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "CreatePrivateVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createPublicVirtualInterface(_ input: CreatePublicVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "CreatePublicVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createTransitVirtualInterface(_ input: CreateTransitVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTransitVirtualInterfaceResult> {
        return client.execute(operation: "CreateTransitVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteBGPPeer(_ input: DeleteBGPPeerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteBGPPeerResponse> {
        return client.execute(operation: "DeleteBGPPeer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteConnection(_ input: DeleteConnectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
    ...
    public func deleteDirectConnectGateway(_ input: DeleteDirectConnectGatewayRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDirectConnectGatewayResult> {
        return client.execute(operation: "DeleteDirectConnectGateway", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteDirectConnectGatewayAssociation(_ input: DeleteDirectConnectGatewayAssociationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDirectConnectGatewayAssociationResult> {
        return client.execute(operation: "DeleteDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes the association proposal request between the specified Direct Connect gateway and virtual private gateway or transit gateway.
    public func deleteDirectConnectGatewayAssociationProposal(_ input: DeleteDirectConnectGatewayAssociationProposalRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDirectConnectGatewayAssociationProposalResult> {
        return client.execute(operation: "DeleteDirectConnectGatewayAssociationProposal", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes the specified interconnect.  Intended for use by AWS Direct Connect Partners only. 
    public func deleteInterconnect(_ input: DeleteInterconnectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteInterconnectResponse> {
        return client.execute(operation: "DeleteInterconnect", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes the specified link aggregation group (LAG). You cannot delete a LAG if it has active virtual interfaces or hosted connections.
    public func deleteLag(_ input: DeleteLagRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Lag> {
        return client.execute(operation: "DeleteLag", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes a virtual interface.
    public func deleteVirtualInterface(_ input: DeleteVirtualInterfaceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteVirtualInterfaceResponse> {
        return client.execute(operation: "DeleteVirtualInterface", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeConnectionLoa(_ input: DescribeConnectionLoaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeConnectionLoaResponse> {
        return client.execute(operation: "DescribeConnectionLoa", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Displays the specified connection or all connections in this Region.
    public func describeConnections(_ input: DescribeConnectionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connections> {
    ...
    public func describeConnectionsOnInterconnect(_ input: DescribeConnectionsOnInterconnectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connections> {
        return client.execute(operation: "DescribeConnectionsOnInterconnect", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes one or more association proposals for connection between a virtual private gateway or transit gateway and a Direct Connect gateway. 
    public func describeDirectConnectGatewayAssociationProposals(_ input: DescribeDirectConnectGatewayAssociationProposalsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDirectConnectGatewayAssociationProposalsResult> {
        return client.execute(operation: "DescribeDirectConnectGatewayAssociationProposals", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the associations between your Direct Connect gateways and virtual private gateways. You must specify a Direct Connect gateway, a virtual private gateway, or both. If you specify a Direct Connect gateway, the response contains all virtual private gateways associated with the Direct Connect gateway. If you specify a virtual private gateway, the response contains all Direct Connect gateways associated with the virtual private gateway. If you specify both, the response contains the association between the Direct Connect gateway and the virtual private gateway.
    public func describeDirectConnectGatewayAssociations(_ input: DescribeDirectConnectGatewayAssociationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDirectConnectGatewayAssociationsResult> {
        return client.execute(operation: "DescribeDirectConnectGatewayAssociations", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the attachments between your Direct Connect gateways and virtual interfaces. You must specify a Direct Connect gateway, a virtual interface, or both. If you specify a Direct Connect gateway, the response contains all virtual interfaces attached to the Direct Connect gateway. If you specify a virtual interface, the response contains all Direct Connect gateways attached to the virtual interface. If you specify both, the response contains the attachment between the Direct Connect gateway and the virtual interface.
    public func describeDirectConnectGatewayAttachments(_ input: DescribeDirectConnectGatewayAttachmentsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDirectConnectGatewayAttachmentsResult> {
        return client.execute(operation: "DescribeDirectConnectGatewayAttachments", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists all your Direct Connect gateways or only the specified Direct Connect gateway. Deleted Direct Connect gateways are not returned.
    public func describeDirectConnectGateways(_ input: DescribeDirectConnectGatewaysRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDirectConnectGatewaysResult> {
        return client.execute(operation: "DescribeDirectConnectGateways", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeHostedConnections(_ input: DescribeHostedConnectionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connections> {
        return client.execute(operation: "DescribeHostedConnections", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeInterconnectLoa(_ input: DescribeInterconnectLoaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeInterconnectLoaResponse> {
        return client.execute(operation: "DescribeInterconnectLoa", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the interconnects owned by the AWS account or only the specified interconnect.
    public func describeInterconnects(_ input: DescribeInterconnectsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Interconnects> {
        return client.execute(operation: "DescribeInterconnects", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes all your link aggregation groups (LAG) or the specified LAG.
    public func describeLags(_ input: DescribeLagsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Lags> {
        return client.execute(operation: "DescribeLags", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeLoa(_ input: DescribeLoaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Loa> {
        return client.execute(operation: "DescribeLoa", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeLocations(on eventLoop: EventLoop? = nil) -> EventLoopFuture<Locations> {
        return client.execute(operation: "DescribeLocations", path: "/", httpMethod: .POST, serviceContext: context, on: eventLoop)
    }
    ...
    public func describeVirtualGateways(on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualGateways> {
        return client.execute(operation: "DescribeVirtualGateways", path: "/", httpMethod: .POST, serviceContext: context, on: eventLoop)
    }
    ...
    public func describeVirtualInterfaces(_ input: DescribeVirtualInterfacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterfaces> {
        return client.execute(operation: "DescribeVirtualInterfaces", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func disassociateConnectionFromLag(_ input: DisassociateConnectionFromLagRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Connection> {
        return client.execute(operation: "DisassociateConnectionFromLag", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listVirtualInterfaceTestHistory(_ input: ListVirtualInterfaceTestHistoryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListVirtualInterfaceTestHistoryResponse> {
        return client.execute(operation: "ListVirtualInterfaceTestHistory", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startBgpFailoverTest(_ input: StartBgpFailoverTestRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartBgpFailoverTestResponse> {
        return client.execute(operation: "StartBgpFailoverTest", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func stopBgpFailoverTest(_ input: StopBgpFailoverTestRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopBgpFailoverTestResponse> {
        return client.execute(operation: "StopBgpFailoverTest", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateDirectConnectGatewayAssociation(_ input: UpdateDirectConnectGatewayAssociationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDirectConnectGatewayAssociationResult> {
        return client.execute(operation: "UpdateDirectConnectGatewayAssociation", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateLag(_ input: UpdateLagRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Lag> {
        return client.execute(operation: "UpdateLag", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateVirtualInterfaceAttributes(_ input: UpdateVirtualInterfaceAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<VirtualInterface> {
        return client.execute(operation: "UpdateVirtualInterfaceAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
