...
public struct DirectConnect {
    ...
    public func updateLag(_ input: UpdateLagRequest) throws -> EventLoopFuture<Lag> {
    ...
    public func deleteInterconnect(_ input: DeleteInterconnectRequest) throws -> EventLoopFuture<DeleteInterconnectResponse> {
    ...
    public func describeVirtualInterfaces(_ input: DescribeVirtualInterfacesRequest) throws -> EventLoopFuture<VirtualInterfaces> {
    ...
    public func confirmConnection(_ input: ConfirmConnectionRequest) throws -> EventLoopFuture<ConfirmConnectionResponse> {
    ...
    public func describeDirectConnectGatewayAssociations(_ input: DescribeDirectConnectGatewayAssociationsRequest) throws -> EventLoopFuture<DescribeDirectConnectGatewayAssociationsResult> {
    ...
    public func createPrivateVirtualInterface(_ input: CreatePrivateVirtualInterfaceRequest) throws -> EventLoopFuture<VirtualInterface> {
    ...
    public func describeInterconnectLoa(_ input: DescribeInterconnectLoaRequest) throws -> EventLoopFuture<DescribeInterconnectLoaResponse> {
    ...
    public func createDirectConnectGatewayAssociation(_ input: CreateDirectConnectGatewayAssociationRequest) throws -> EventLoopFuture<CreateDirectConnectGatewayAssociationResult> {
    ...
    public func confirmPublicVirtualInterface(_ input: ConfirmPublicVirtualInterfaceRequest) throws -> EventLoopFuture<ConfirmPublicVirtualInterfaceResponse> {
    ...
    public func createDirectConnectGateway(_ input: CreateDirectConnectGatewayRequest) throws -> EventLoopFuture<CreateDirectConnectGatewayResult> {
    ...
    public func createPublicVirtualInterface(_ input: CreatePublicVirtualInterfaceRequest) throws -> EventLoopFuture<VirtualInterface> {
        return try client.send(operation: "CreatePublicVirtualInterface", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the association between the specified Direct Connect gateway and virtual private gateway.
    public func deleteDirectConnectGatewayAssociation(_ input: DeleteDirectConnectGatewayAssociationRequest) throws -> EventLoopFuture<DeleteDirectConnectGatewayAssociationResult> {
    ...
    public func describeConnectionLoa(_ input: DescribeConnectionLoaRequest) throws -> EventLoopFuture<DescribeConnectionLoaResponse> {
    ...
    public func createBGPPeer(_ input: CreateBGPPeerRequest) throws -> EventLoopFuture<CreateBGPPeerResponse> {
    ...
    public func createInterconnect(_ input: CreateInterconnectRequest) throws -> EventLoopFuture<Interconnect> {
    ...
    public func deleteDirectConnectGateway(_ input: DeleteDirectConnectGatewayRequest) throws -> EventLoopFuture<DeleteDirectConnectGatewayResult> {
    ...
    public func associateVirtualInterface(_ input: AssociateVirtualInterfaceRequest) throws -> EventLoopFuture<VirtualInterface> {
    ...
    public func describeVirtualGateways() throws -> EventLoopFuture<VirtualGateways> {
    ...
    public func allocateConnectionOnInterconnect(_ input: AllocateConnectionOnInterconnectRequest) throws -> EventLoopFuture<Connection> {
        return try client.send(operation: "AllocateConnectionOnInterconnect", path: "/", httpMethod: "POST", input: input)
    }

    ///  Displays the specified connection or all connections in this Region.
    public func describeConnections(_ input: DescribeConnectionsRequest) throws -> EventLoopFuture<Connections> {
        return try client.send(operation: "DescribeConnections", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified link aggregation group (LAG). You cannot delete a LAG if it has active virtual interfaces or hosted connections.
    public func deleteLag(_ input: DeleteLagRequest) throws -> EventLoopFuture<Lag> {
    ...
    public func disassociateConnectionFromLag(_ input: DisassociateConnectionFromLagRequest) throws -> EventLoopFuture<Connection> {
    ...
    public func allocatePublicVirtualInterface(_ input: AllocatePublicVirtualInterfaceRequest) throws -> EventLoopFuture<VirtualInterface> {
    ...
    public func describeConnectionsOnInterconnect(_ input: DescribeConnectionsOnInterconnectRequest) throws -> EventLoopFuture<Connections> {
        return try client.send(operation: "DescribeConnectionsOnInterconnect", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes all your link aggregation groups (LAG) or the specified LAG.
    public func describeLags(_ input: DescribeLagsRequest) throws -> EventLoopFuture<Lags> {
    ...
    public func deleteBGPPeer(_ input: DeleteBGPPeerRequest) throws -> EventLoopFuture<DeleteBGPPeerResponse> {
    ...
    public func allocateHostedConnection(_ input: AllocateHostedConnectionRequest) throws -> EventLoopFuture<Connection> {
    ...
    public func updateVirtualInterfaceAttributes(_ input: UpdateVirtualInterfaceAttributesRequest) throws -> EventLoopFuture<VirtualInterface> {
        return try client.send(operation: "UpdateVirtualInterfaceAttributes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a virtual interface.
    public func deleteVirtualInterface(_ input: DeleteVirtualInterfaceRequest) throws -> EventLoopFuture<DeleteVirtualInterfaceResponse> {
    ...
    public func createConnection(_ input: CreateConnectionRequest) throws -> EventLoopFuture<Connection> {
    ...
    public func confirmPrivateVirtualInterface(_ input: ConfirmPrivateVirtualInterfaceRequest) throws -> EventLoopFuture<ConfirmPrivateVirtualInterfaceResponse> {
    ...
    public func describeDirectConnectGatewayAttachments(_ input: DescribeDirectConnectGatewayAttachmentsRequest) throws -> EventLoopFuture<DescribeDirectConnectGatewayAttachmentsResult> {
    ...
    public func associateHostedConnection(_ input: AssociateHostedConnectionRequest) throws -> EventLoopFuture<Connection> {
    ...
    public func associateConnectionWithLag(_ input: AssociateConnectionWithLagRequest) throws -> EventLoopFuture<Connection> {
    ...
    public func describeLocations() throws -> EventLoopFuture<Locations> {
        return try client.send(operation: "DescribeLocations", path: "/", httpMethod: "POST")
    }

    ///  Lists all your Direct Connect gateways or only the specified Direct Connect gateway. Deleted Direct Connect gateways are not returned.
    public func describeDirectConnectGateways(_ input: DescribeDirectConnectGatewaysRequest) throws -> EventLoopFuture<DescribeDirectConnectGatewaysResult> {
    ...
    public func describeHostedConnections(_ input: DescribeHostedConnectionsRequest) throws -> EventLoopFuture<Connections> {
    ...
    public func createLag(_ input: CreateLagRequest) throws -> EventLoopFuture<Lag> {
        return try client.send(operation: "CreateLag", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the interconnects owned by the AWS account or only the specified interconnect.
    public func describeInterconnects(_ input: DescribeInterconnectsRequest) throws -> EventLoopFuture<Interconnects> {
    ...
    public func allocatePrivateVirtualInterface(_ input: AllocatePrivateVirtualInterfaceRequest) throws -> EventLoopFuture<VirtualInterface> {
    ...
    public func describeLoa(_ input: DescribeLoaRequest) throws -> EventLoopFuture<Loa> {
    ...
    public func deleteConnection(_ input: DeleteConnectionRequest) throws -> EventLoopFuture<Connection> {
