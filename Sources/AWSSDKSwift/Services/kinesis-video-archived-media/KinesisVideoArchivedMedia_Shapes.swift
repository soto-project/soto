...
extension KinesisVideoArchivedMedia {
    ...
    public struct GetHLSStreamingSessionURLInput: AWSShape {
        ...
        public init(streamARN: String? = nil, expires: Int32? = nil, discontinuityMode: DiscontinuityMode? = nil, hLSFragmentSelector: HLSFragmentSelector? = nil, streamName: String? = nil, maxMediaPlaylistFragmentResults: Int64? = nil, playbackMode: PlaybackMode? = nil) {
    ...
    public struct ListFragmentsInput: AWSShape {
        ...
        public init(fragmentSelector: FragmentSelector? = nil, streamName: String, nextToken: String? = nil, maxResults: Int64? = nil) {
