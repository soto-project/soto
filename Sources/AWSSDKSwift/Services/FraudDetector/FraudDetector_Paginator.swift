...
extension FraudDetector {
    ...
    public func getEntityTypesPaginator(
        ...
        return client.paginate(input: input, command: getEntityTypes, tokenKey: \GetEntityTypesResult.nextToken, on: eventLoop, onPage: onPage)
    }
    ...
    public func getEventTypesPaginator(
        ...
        return client.paginate(input: input, command: getEventTypes, tokenKey: \GetEventTypesResult.nextToken, on: eventLoop, onPage: onPage)
    }
    ...
    public func getLabelsPaginator(
        ...
        return client.paginate(input: input, command: getLabels, tokenKey: \GetLabelsResult.nextToken, on: eventLoop, onPage: onPage)
    }
    ...
    public func listTagsForResourcePaginator(
        ...
        return client.paginate(input: input, command: listTagsForResource, tokenKey: \ListTagsForResourceResult.nextToken, on: eventLoop, onPage: onPage)
    }
