...
public struct AWSBackup {
    ...
    public func createBackupVault(_ input: CreateBackupVaultInput) -> Future<CreateBackupVaultOutput> {
    ...
    public func deleteBackupPlan(_ input: DeleteBackupPlanInput) -> Future<DeleteBackupPlanOutput> {
    ...
    @discardableResult public func deleteBackupSelection(_ input: DeleteBackupSelectionInput) -> Future<Void> {
    ...
    @discardableResult public func deleteBackupVault(_ input: DeleteBackupVaultInput) -> Future<Void> {
    ...
    @discardableResult public func deleteBackupVaultAccessPolicy(_ input: DeleteBackupVaultAccessPolicyInput) -> Future<Void> {
    ...
    @discardableResult public func deleteBackupVaultNotifications(_ input: DeleteBackupVaultNotificationsInput) -> Future<Void> {
    ...
    @discardableResult public func deleteRecoveryPoint(_ input: DeleteRecoveryPointInput) -> Future<Void> {
    ...
    public func describeBackupJob(_ input: DescribeBackupJobInput) -> Future<DescribeBackupJobOutput> {
    ...
    public func describeProtectedResource(_ input: DescribeProtectedResourceInput) -> Future<DescribeProtectedResourceOutput> {
    ...
    public func describeRecoveryPoint(_ input: DescribeRecoveryPointInput) -> Future<DescribeRecoveryPointOutput> {
    ...
    public func describeRestoreJob(_ input: DescribeRestoreJobInput) -> Future<DescribeRestoreJobOutput> {
        return client.send(operation: "DescribeRestoreJob", path: "/restore-jobs/{restoreJobId}", httpMethod: "GET", input: input)
    }

    ///  Returns the backup plan that is specified by the plan ID as a backup template.
    public func exportBackupPlanTemplate(_ input: ExportBackupPlanTemplateInput) -> Future<ExportBackupPlanTemplateOutput> {
    ...
    public func getBackupPlan(_ input: GetBackupPlanInput) -> Future<GetBackupPlanOutput> {
        return client.send(operation: "GetBackupPlan", path: "/backup/plans/{backupPlanId}/", httpMethod: "GET", input: input)
    }

    ///  Returns a valid JSON document specifying a backup plan or an error.
    public func getBackupPlanFromJSON(_ input: GetBackupPlanFromJSONInput) -> Future<GetBackupPlanFromJSONOutput> {
    ...
    public func getBackupPlanFromTemplate(_ input: GetBackupPlanFromTemplateInput) -> Future<GetBackupPlanFromTemplateOutput> {
    ...
    public func getBackupSelection(_ input: GetBackupSelectionInput) -> Future<GetBackupSelectionOutput> {
    ...
    public func getBackupVaultAccessPolicy(_ input: GetBackupVaultAccessPolicyInput) -> Future<GetBackupVaultAccessPolicyOutput> {
    ...
    public func getBackupVaultNotifications(_ input: GetBackupVaultNotificationsInput) -> Future<GetBackupVaultNotificationsOutput> {
    ...
    public func getSupportedResourceTypes() -> Future<GetSupportedResourceTypesOutput> {
        return client.send(operation: "GetSupportedResourceTypes", path: "/supported-resource-types", httpMethod: "GET")
    }

    ///  Returns metadata about your backup jobs.
    public func listBackupJobs(_ input: ListBackupJobsInput) -> Future<ListBackupJobsOutput> {
        return client.send(operation: "ListBackupJobs", path: "/backup-jobs/", httpMethod: "GET", input: input)
    }

    ///  Returns metadata of your saved backup plan templates, including the template ID, name, and the creation and deletion dates.
    public func listBackupPlanTemplates(_ input: ListBackupPlanTemplatesInput) -> Future<ListBackupPlanTemplatesOutput> {
    ...
    public func listBackupPlanVersions(_ input: ListBackupPlanVersionsInput) -> Future<ListBackupPlanVersionsOutput> {
    ...
    public func listBackupPlans(_ input: ListBackupPlansInput) -> Future<ListBackupPlansOutput> {
        return client.send(operation: "ListBackupPlans", path: "/backup/plans/", httpMethod: "GET", input: input)
    }

    ///  Returns an array containing metadata of the resources associated with the target backup plan.
    public func listBackupSelections(_ input: ListBackupSelectionsInput) -> Future<ListBackupSelectionsOutput> {
    ...
    public func listProtectedResources(_ input: ListProtectedResourcesInput) -> Future<ListProtectedResourcesOutput> {
        return client.send(operation: "ListProtectedResources", path: "/resources/", httpMethod: "GET", input: input)
    }

    ///  Returns detailed information about the recovery points stored in a backup vault.
    public func listRecoveryPointsByBackupVault(_ input: ListRecoveryPointsByBackupVaultInput) -> Future<ListRecoveryPointsByBackupVaultOutput> {
    ...
    public func listRecoveryPointsByResource(_ input: ListRecoveryPointsByResourceInput) -> Future<ListRecoveryPointsByResourceOutput> {
    ...
    public func listRestoreJobs(_ input: ListRestoreJobsInput) -> Future<ListRestoreJobsOutput> {
    ...
    @discardableResult public func putBackupVaultAccessPolicy(_ input: PutBackupVaultAccessPolicyInput) -> Future<Void> {
    ...
    @discardableResult public func putBackupVaultNotifications(_ input: PutBackupVaultNotificationsInput) -> Future<Void> {
    ...
    public func startRestoreJob(_ input: StartRestoreJobInput) -> Future<StartRestoreJobOutput> {
        return client.send(operation: "StartRestoreJob", path: "/restore-jobs", httpMethod: "PUT", input: input)
    }

    ///  Attempts to cancel a job to create a one-time backup of a resource.
    @discardableResult public func stopBackupJob(_ input: StopBackupJobInput) -> Future<Void> {
    ...
    public func updateBackupPlan(_ input: UpdateBackupPlanInput) -> Future<UpdateBackupPlanOutput> {
    ...
    public func updateRecoveryPointLifecycle(_ input: UpdateRecoveryPointLifecycleInput) -> Future<UpdateRecoveryPointLifecycleOutput> {
