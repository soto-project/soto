...
public struct CodeStar: AWSService {
    ...
    /// return new `CodeStar` with new timeout value
    ...
    /// return new `CodeStar` logging to specified Logger
    ...
    public func associateTeamMember(_ input: AssociateTeamMemberRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateTeamMemberResult> {
        return client.execute(operation: "AssociateTeamMember", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeProject(_ input: DescribeProjectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeProjectResult> {
        return client.execute(operation: "DescribeProject", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func disassociateTeamMember(_ input: DisassociateTeamMemberRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateTeamMemberResult> {
        return client.execute(operation: "DisassociateTeamMember", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTagsForProject(_ input: ListTagsForProjectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForProjectResult> {
        return client.execute(operation: "ListTagsForProject", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTeamMembers(_ input: ListTeamMembersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTeamMembersResult> {
        return client.execute(operation: "ListTeamMembers", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func tagProject(_ input: TagProjectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagProjectResult> {
        return client.execute(operation: "TagProject", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Removes tags from a project.
    public func untagProject(_ input: UntagProjectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagProjectResult> {
        return client.execute(operation: "UntagProject", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateTeamMember(_ input: UpdateTeamMemberRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTeamMemberResult> {
        return client.execute(operation: "UpdateTeamMember", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
