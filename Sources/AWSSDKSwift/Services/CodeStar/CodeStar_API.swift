...
public struct CodeStar {
    ...
    public func createUserProfile(_ input: CreateUserProfileRequest) throws -> EventLoopFuture<CreateUserProfileResult> {
    ...
    public func deleteUserProfile(_ input: DeleteUserProfileRequest) throws -> EventLoopFuture<DeleteUserProfileResult> {
    ...
    public func updateUserProfile(_ input: UpdateUserProfileRequest) throws -> EventLoopFuture<UpdateUserProfileResult> {
        return try client.send(operation: "UpdateUserProfile", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes tags from a project.
    public func untagProject(_ input: UntagProjectRequest) throws -> EventLoopFuture<UntagProjectResult> {
        return try client.send(operation: "UntagProject", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists resources associated with a project in AWS CodeStar.
    public func listResources(_ input: ListResourcesRequest) throws -> EventLoopFuture<ListResourcesResult> {
    ...
    public func tagProject(_ input: TagProjectRequest) throws -> EventLoopFuture<TagProjectResult> {
        return try client.send(operation: "TagProject", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes a user in AWS CodeStar and the user attributes across all projects.
    public func describeUserProfile(_ input: DescribeUserProfileRequest) throws -> EventLoopFuture<DescribeUserProfileResult> {
        return try client.send(operation: "DescribeUserProfile", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all the user profiles configured for your AWS account in AWS CodeStar.
    public func listUserProfiles(_ input: ListUserProfilesRequest) throws -> EventLoopFuture<ListUserProfilesResult> {
    ...
    public func disassociateTeamMember(_ input: DisassociateTeamMemberRequest) throws -> EventLoopFuture<DisassociateTeamMemberResult> {
        return try client.send(operation: "DisassociateTeamMember", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes a project and its resources.
    public func describeProject(_ input: DescribeProjectRequest) throws -> EventLoopFuture<DescribeProjectResult> {
        return try client.send(operation: "DescribeProject", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team member's role in the project, or change whether they have remote access to project resources.
    public func updateTeamMember(_ input: UpdateTeamMemberRequest) throws -> EventLoopFuture<UpdateTeamMemberResult> {
        return try client.send(operation: "UpdateTeamMember", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds an IAM user to the team for an AWS CodeStar project.
    public func associateTeamMember(_ input: AssociateTeamMemberRequest) throws -> EventLoopFuture<AssociateTeamMemberResult> {
    ...
    public func listTagsForProject(_ input: ListTagsForProjectRequest) throws -> EventLoopFuture<ListTagsForProjectResult> {
        return try client.send(operation: "ListTagsForProject", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all team members associated with a project.
    public func listTeamMembers(_ input: ListTeamMembersRequest) throws -> EventLoopFuture<ListTeamMembersResult> {
