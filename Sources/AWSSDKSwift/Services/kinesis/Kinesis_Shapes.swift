...
extension Kinesis {
    ...
    public struct StreamDescriptionSummary: AWSShape {
        ...
        public init(encryptionType: EncryptionType? = nil, streamARN: String, keyId: String? = nil, retentionPeriodHours: Int32, enhancedMonitoring: [EnhancedMetrics], openShardCount: Int32, consumerCount: Int32? = nil, streamCreationTimestamp: TimeStamp, streamStatus: StreamStatus, streamName: String) {
    ...
    public struct ListStreamConsumersInput: AWSShape {
        ...
        public init(streamCreationTimestamp: TimeStamp? = nil, streamARN: String, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.streamCreationTimestamp = streamCreationTimestamp
            self.streamARN = streamARN
    ...
    public struct ConsumerDescription: AWSShape {
        ...
        public init(consumerARN: String, streamARN: String, consumerName: String, consumerStatus: ConsumerStatus, consumerCreationTimestamp: TimeStamp) {
            self.consumerARN = consumerARN
            self.streamARN = streamARN
            self.consumerName = consumerName
            self.consumerStatus = consumerStatus
    ...
    public struct DeregisterStreamConsumerInput: AWSShape {
        ...
        public init(consumerName: String? = nil, streamARN: String? = nil, consumerARN: String? = nil) {
            self.consumerName = consumerName
            self.streamARN = streamARN
            self.consumerARN = consumerARN
        }
    ...
    public struct ListShardsInput: AWSShape {
        ...
        public init(streamCreationTimestamp: TimeStamp? = nil, exclusiveStartShardId: String? = nil, streamName: String? = nil, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.streamCreationTimestamp = streamCreationTimestamp
            self.exclusiveStartShardId = exclusiveStartShardId
            self.streamName = streamName
            self.nextToken = nextToken
