...
public struct CodePipeline {
    ...
    public func startPipelineExecution(_ input: StartPipelineExecutionInput) throws -> EventLoopFuture<StartPipelineExecutionOutput> {
    ...
    public func putWebhook(_ input: PutWebhookInput) throws -> EventLoopFuture<PutWebhookOutput> {
    ...
    public func acknowledgeThirdPartyJob(_ input: AcknowledgeThirdPartyJobInput) throws -> EventLoopFuture<AcknowledgeThirdPartyJobOutput> {
    ...
    public func getPipelineExecution(_ input: GetPipelineExecutionInput) throws -> EventLoopFuture<GetPipelineExecutionOutput> {
        return try client.send(operation: "GetPipelineExecution", path: "/", httpMethod: "POST", input: input)
    }

    ///  Configures a connection between the webhook that was created and the external tool with events to be detected.
    public func registerWebhookWithThirdParty(_ input: RegisterWebhookWithThirdPartyInput) throws -> EventLoopFuture<RegisterWebhookWithThirdPartyOutput> {
    ...
    public func deregisterWebhookWithThirdParty(_ input: DeregisterWebhookWithThirdPartyInput) throws -> EventLoopFuture<DeregisterWebhookWithThirdPartyOutput> {
    ...
    public func pollForJobs(_ input: PollForJobsInput) throws -> EventLoopFuture<PollForJobsOutput> {
    ...
    public func putApprovalResult(_ input: PutApprovalResultInput) throws -> EventLoopFuture<PutApprovalResultOutput> {
        return try client.send(operation: "PutApprovalResult", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a summary of the most recent executions for a pipeline.
    public func listPipelineExecutions(_ input: ListPipelineExecutionsInput) throws -> EventLoopFuture<ListPipelineExecutionsOutput> {
        return try client.send(operation: "ListPipelineExecutions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about the state of a pipeline, including the stages and actions.
    public func getPipelineState(_ input: GetPipelineStateInput) throws -> EventLoopFuture<GetPipelineStateOutput> {
    ...
    public func listWebhooks(_ input: ListWebhooksInput) throws -> EventLoopFuture<ListWebhooksOutput> {
    ...
    public func acknowledgeJob(_ input: AcknowledgeJobInput) throws -> EventLoopFuture<AcknowledgeJobOutput> {
    ...
    public func getThirdPartyJobDetails(_ input: GetThirdPartyJobDetailsInput) throws -> EventLoopFuture<GetThirdPartyJobDetailsOutput> {
        return try client.send(operation: "GetThirdPartyJobDetails", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new custom action that can be used in all pipelines associated with the AWS account. Only used for custom actions.
    public func createCustomActionType(_ input: CreateCustomActionTypeInput) throws -> EventLoopFuture<CreateCustomActionTypeOutput> {
        return try client.send(operation: "CreateCustomActionType", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a summary of all AWS CodePipeline action types associated with your account.
    public func listActionTypes(_ input: ListActionTypesInput) throws -> EventLoopFuture<ListActionTypesOutput> {
    ...
    public func retryStageExecution(_ input: RetryStageExecutionInput) throws -> EventLoopFuture<RetryStageExecutionOutput> {
    ...
    public func pollForThirdPartyJobs(_ input: PollForThirdPartyJobsInput) throws -> EventLoopFuture<PollForThirdPartyJobsOutput> {
        return try client.send(operation: "PollForThirdPartyJobs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a pipeline.
    public func createPipeline(_ input: CreatePipelineInput) throws -> EventLoopFuture<CreatePipelineOutput> {
    ...
    public func updatePipeline(_ input: UpdatePipelineInput) throws -> EventLoopFuture<UpdatePipelineOutput> {
    ...
    public func getJobDetails(_ input: GetJobDetailsInput) throws -> EventLoopFuture<GetJobDetailsOutput> {
        return try client.send(operation: "GetJobDetails", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides information to AWS CodePipeline about new revisions to a source.
    public func putActionRevision(_ input: PutActionRevisionInput) throws -> EventLoopFuture<PutActionRevisionOutput> {
    ...
    public func getPipeline(_ input: GetPipelineInput) throws -> EventLoopFuture<GetPipelineOutput> {
        return try client.send(operation: "GetPipeline", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a summary of all of the pipelines associated with your account.
    public func listPipelines(_ input: ListPipelinesInput) throws -> EventLoopFuture<ListPipelinesOutput> {
