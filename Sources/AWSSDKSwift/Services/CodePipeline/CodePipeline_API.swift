...
public struct CodePipeline: AWSService {
    ...
    public func acknowledgeJob(_ input: AcknowledgeJobInput) -> EventLoopFuture<AcknowledgeJobOutput> {
        return client.execute(operation: "AcknowledgeJob", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func acknowledgeThirdPartyJob(_ input: AcknowledgeThirdPartyJobInput) -> EventLoopFuture<AcknowledgeThirdPartyJobOutput> {
        return client.execute(operation: "AcknowledgeThirdPartyJob", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createCustomActionType(_ input: CreateCustomActionTypeInput) -> EventLoopFuture<CreateCustomActionTypeOutput> {
        return client.execute(operation: "CreateCustomActionType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createPipeline(_ input: CreatePipelineInput) -> EventLoopFuture<CreatePipelineOutput> {
        return client.execute(operation: "CreatePipeline", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteCustomActionType(_ input: DeleteCustomActionTypeInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteCustomActionType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified pipeline.
    @discardableResult public func deletePipeline(_ input: DeletePipelineInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeletePipeline", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deregisterWebhookWithThirdParty(_ input: DeregisterWebhookWithThirdPartyInput) -> EventLoopFuture<DeregisterWebhookWithThirdPartyOutput> {
        return client.execute(operation: "DeregisterWebhookWithThirdParty", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disableStageTransition(_ input: DisableStageTransitionInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisableStageTransition", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func enableStageTransition(_ input: EnableStageTransitionInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "EnableStageTransition", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getJobDetails(_ input: GetJobDetailsInput) -> EventLoopFuture<GetJobDetailsOutput> {
        return client.execute(operation: "GetJobDetails", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getPipeline(_ input: GetPipelineInput) -> EventLoopFuture<GetPipelineOutput> {
        return client.execute(operation: "GetPipeline", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getPipelineExecution(_ input: GetPipelineExecutionInput) -> EventLoopFuture<GetPipelineExecutionOutput> {
        return client.execute(operation: "GetPipelineExecution", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getPipelineState(_ input: GetPipelineStateInput) -> EventLoopFuture<GetPipelineStateOutput> {
        return client.execute(operation: "GetPipelineState", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getThirdPartyJobDetails(_ input: GetThirdPartyJobDetailsInput) -> EventLoopFuture<GetThirdPartyJobDetailsOutput> {
        return client.execute(operation: "GetThirdPartyJobDetails", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listActionExecutions(_ input: ListActionExecutionsInput) -> EventLoopFuture<ListActionExecutionsOutput> {
        return client.execute(operation: "ListActionExecutions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets a summary of all AWS CodePipeline action types associated with your account.
    public func listActionTypes(_ input: ListActionTypesInput) -> EventLoopFuture<ListActionTypesOutput> {
        return client.execute(operation: "ListActionTypes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listPipelineExecutions(_ input: ListPipelineExecutionsInput) -> EventLoopFuture<ListPipelineExecutionsOutput> {
        return client.execute(operation: "ListPipelineExecutions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets a summary of all of the pipelines associated with your account.
    public func listPipelines(_ input: ListPipelinesInput) -> EventLoopFuture<ListPipelinesOutput> {
        return client.execute(operation: "ListPipelines", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listWebhooks(_ input: ListWebhooksInput) -> EventLoopFuture<ListWebhooksOutput> {
        return client.execute(operation: "ListWebhooks", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func pollForJobs(_ input: PollForJobsInput) -> EventLoopFuture<PollForJobsOutput> {
        return client.execute(operation: "PollForJobs", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func pollForThirdPartyJobs(_ input: PollForThirdPartyJobsInput) -> EventLoopFuture<PollForThirdPartyJobsOutput> {
        return client.execute(operation: "PollForThirdPartyJobs", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Provides information to AWS CodePipeline about new revisions to a source.
    public func putActionRevision(_ input: PutActionRevisionInput) -> EventLoopFuture<PutActionRevisionOutput> {
        return client.execute(operation: "PutActionRevision", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putApprovalResult(_ input: PutApprovalResultInput) -> EventLoopFuture<PutApprovalResultOutput> {
        return client.execute(operation: "PutApprovalResult", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putJobFailureResult(_ input: PutJobFailureResultInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutJobFailureResult", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putJobSuccessResult(_ input: PutJobSuccessResultInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutJobSuccessResult", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putThirdPartyJobFailureResult(_ input: PutThirdPartyJobFailureResultInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutThirdPartyJobFailureResult", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putThirdPartyJobSuccessResult(_ input: PutThirdPartyJobSuccessResultInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutThirdPartyJobSuccessResult", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putWebhook(_ input: PutWebhookInput) -> EventLoopFuture<PutWebhookOutput> {
        return client.execute(operation: "PutWebhook", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerWebhookWithThirdParty(_ input: RegisterWebhookWithThirdPartyInput) -> EventLoopFuture<RegisterWebhookWithThirdPartyOutput> {
        return client.execute(operation: "RegisterWebhookWithThirdParty", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func retryStageExecution(_ input: RetryStageExecutionInput) -> EventLoopFuture<RetryStageExecutionOutput> {
        return client.execute(operation: "RetryStageExecution", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startPipelineExecution(_ input: StartPipelineExecutionInput) -> EventLoopFuture<StartPipelineExecutionOutput> {
        return client.execute(operation: "StartPipelineExecution", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func stopPipelineExecution(_ input: StopPipelineExecutionInput) -> EventLoopFuture<StopPipelineExecutionOutput> {
        return client.execute(operation: "StopPipelineExecution", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updatePipeline(_ input: UpdatePipelineInput) -> EventLoopFuture<UpdatePipelineOutput> {
        return client.execute(operation: "UpdatePipeline", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
