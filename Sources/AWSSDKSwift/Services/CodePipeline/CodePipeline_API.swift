...
public struct CodePipeline {
    ...
    public func listWebhooks(_ input: ListWebhooksInput) throws -> ListWebhooksOutput {
    ...
    public func deregisterWebhookWithThirdParty(_ input: DeregisterWebhookWithThirdPartyInput) throws -> DeregisterWebhookWithThirdPartyOutput {
    ...
    public func putWebhook(_ input: PutWebhookInput) throws -> PutWebhookOutput {
    ...
    public func registerWebhookWithThirdParty(_ input: RegisterWebhookWithThirdPartyInput) throws -> RegisterWebhookWithThirdPartyOutput {
