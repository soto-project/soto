...
extension Personalize {
    ...
    public func listBatchInferenceJobsPaginator(_ input: ListBatchInferenceJobsRequest) -> Future<[BatchInferenceJobSummary]> {
    ...
    public func listCampaignsPaginator(_ input: ListCampaignsRequest) -> Future<[CampaignSummary]> {
    ...
    public func listEventTrackersPaginator(_ input: ListEventTrackersRequest) -> Future<[EventTrackerSummary]> {
    ...
    public func listRecipesPaginator(_ input: ListRecipesRequest) -> Future<[RecipeSummary]> {
    ...
    public func listSchemasPaginator(_ input: ListSchemasRequest) -> Future<[DatasetSchemaSummary]> {
    ...
    public func listSolutionVersionsPaginator(_ input: ListSolutionVersionsRequest) -> Future<[SolutionVersionSummary]> {
    ...
    public func listSolutionsPaginator(_ input: ListSolutionsRequest) -> Future<[SolutionSummary]> {
