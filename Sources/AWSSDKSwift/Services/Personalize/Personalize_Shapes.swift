...
extension Personalize {
    ...
    public struct CreateDatasetImportJobRequest: AWSShape {
        ...
        public init(dataSource: DataSource, datasetArn: String, jobName: String, roleArn: String) {
    ...
    public struct DatasetImportJob: AWSShape {
        ...
        public init(creationDateTime: TimeStamp? = nil, dataSource: DataSource? = nil, datasetArn: String? = nil, datasetImportJobArn: String? = nil, failureReason: String? = nil, jobName: String? = nil, lastUpdatedDateTime: TimeStamp? = nil, roleArn: String? = nil, status: String? = nil) {
            self.creationDateTime = creationDateTime
            self.dataSource = dataSource
            self.datasetArn = datasetArn
            self.datasetImportJobArn = datasetImportJobArn
