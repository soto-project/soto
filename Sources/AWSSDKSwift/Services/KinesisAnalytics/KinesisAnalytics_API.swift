...
public struct KinesisAnalytics {
    ...
    public func deleteApplication(_ input: DeleteApplicationRequest) throws -> EventLoopFuture<DeleteApplicationResponse> {
    ...
    public func deleteApplicationOutput(_ input: DeleteApplicationOutputRequest) throws -> EventLoopFuture<DeleteApplicationOutputResponse> {
    ...
    public func describeApplication(_ input: DescribeApplicationRequest) throws -> EventLoopFuture<DescribeApplicationResponse> {
    ...
    public func startApplication(_ input: StartApplicationRequest) throws -> EventLoopFuture<StartApplicationResponse> {
    ...
    public func addApplicationCloudWatchLoggingOption(_ input: AddApplicationCloudWatchLoggingOptionRequest) throws -> EventLoopFuture<AddApplicationCloudWatchLoggingOptionResponse> {
    ...
    public func deleteApplicationCloudWatchLoggingOption(_ input: DeleteApplicationCloudWatchLoggingOptionRequest) throws -> EventLoopFuture<DeleteApplicationCloudWatchLoggingOptionResponse> {
    ...
    public func addApplicationInput(_ input: AddApplicationInputRequest) throws -> EventLoopFuture<AddApplicationInputResponse> {
    ...
    public func deleteApplicationReferenceDataSource(_ input: DeleteApplicationReferenceDataSourceRequest) throws -> EventLoopFuture<DeleteApplicationReferenceDataSourceResponse> {
    ...
    public func stopApplication(_ input: StopApplicationRequest) throws -> EventLoopFuture<StopApplicationResponse> {
        return try client.send(operation: "StopApplication", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an InputProcessingConfiguration from an input.
    public func deleteApplicationInputProcessingConfiguration(_ input: DeleteApplicationInputProcessingConfigurationRequest) throws -> EventLoopFuture<DeleteApplicationInputProcessingConfigurationResponse> {
    ...
    public func addApplicationInputProcessingConfiguration(_ input: AddApplicationInputProcessingConfigurationRequest) throws -> EventLoopFuture<AddApplicationInputProcessingConfigurationResponse> {
    ...
    public func addApplicationReferenceDataSource(_ input: AddApplicationReferenceDataSourceRequest) throws -> EventLoopFuture<AddApplicationReferenceDataSourceResponse> {
    ...
    public func addApplicationOutput(_ input: AddApplicationOutputRequest) throws -> EventLoopFuture<AddApplicationOutputResponse> {
    ...
    public func discoverInputSchema(_ input: DiscoverInputSchemaRequest) throws -> EventLoopFuture<DiscoverInputSchemaResponse> {
