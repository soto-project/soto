...
extension KinesisAnalytics {
    ...
    public struct RecordColumn: AWSShape {
        ...
        public init(name: String, mapping: String? = nil, sqlType: String) {
            self.name = name
    ...
    public struct CloudWatchLoggingOptionDescription: AWSShape {
        ...
        public init(roleARN: String, logStreamARN: String, cloudWatchLoggingOptionId: String? = nil) {
    ...
    public struct InputUpdate: AWSShape {
        ...
        public init(inputSchemaUpdate: InputSchemaUpdate? = nil, inputParallelismUpdate: InputParallelismUpdate? = nil, inputProcessingConfigurationUpdate: InputProcessingConfigurationUpdate? = nil, namePrefixUpdate: String? = nil, inputId: String, kinesisStreamsInputUpdate: KinesisStreamsInputUpdate? = nil, kinesisFirehoseInputUpdate: KinesisFirehoseInputUpdate? = nil) {
    ...
    public struct OutputUpdate: AWSShape {
        ...
        public init(outputId: String, lambdaOutputUpdate: LambdaOutputUpdate? = nil, destinationSchemaUpdate: DestinationSchema? = nil, kinesisFirehoseOutputUpdate: KinesisFirehoseOutputUpdate? = nil, kinesisStreamsOutputUpdate: KinesisStreamsOutputUpdate? = nil, nameUpdate: String? = nil) {
    ...
    public struct OutputDescription: AWSShape {
        ...
        public init(destinationSchema: DestinationSchema? = nil, outputId: String? = nil, name: String? = nil, kinesisFirehoseOutputDescription: KinesisFirehoseOutputDescription? = nil, kinesisStreamsOutputDescription: KinesisStreamsOutputDescription? = nil, lambdaOutputDescription: LambdaOutputDescription? = nil) {
    ...
    public struct S3Configuration: AWSShape {
        ...
        public init(roleARN: String, fileKey: String, bucketARN: String) {
            self.roleARN = roleARN
            self.fileKey = fileKey
            self.bucketARN = bucketARN
        }
    ...
    public struct DeleteApplicationInputProcessingConfigurationRequest: AWSShape {
        ...
        public init(currentApplicationVersionId: Int64, applicationName: String, inputId: String) {
    ...
    public struct UpdateApplicationRequest: AWSShape {
        ...
        public init(applicationUpdate: ApplicationUpdate, applicationName: String, currentApplicationVersionId: Int64) {
    ...
    public struct ReferenceDataSourceDescription: AWSShape {
        ...
        public init(tableName: String, s3ReferenceDataSourceDescription: S3ReferenceDataSourceDescription, referenceSchema: SourceSchema? = nil, referenceId: String) {
            self.tableName = tableName
    ...
    public struct InputSchemaUpdate: AWSShape {
        ...
        public init(recordFormatUpdate: RecordFormat? = nil, recordColumnUpdates: [RecordColumn]? = nil, recordEncodingUpdate: String? = nil) {
    ...
    public struct Output: AWSShape {
        ...
        public init(kinesisStreamsOutput: KinesisStreamsOutput? = nil, destinationSchema: DestinationSchema, kinesisFirehoseOutput: KinesisFirehoseOutput? = nil, lambdaOutput: LambdaOutput? = nil, name: String) {
    ...
    public struct ApplicationUpdate: AWSShape {
        ...
        public init(applicationCodeUpdate: String? = nil, referenceDataSourceUpdates: [ReferenceDataSourceUpdate]? = nil, outputUpdates: [OutputUpdate]? = nil, cloudWatchLoggingOptionUpdates: [CloudWatchLoggingOptionUpdate]? = nil, inputUpdates: [InputUpdate]? = nil) {
    ...
    public struct Input: AWSShape {
        ...
        public init(inputParallelism: InputParallelism? = nil, inputProcessingConfiguration: InputProcessingConfiguration? = nil, kinesisStreamsInput: KinesisStreamsInput? = nil, inputSchema: SourceSchema, kinesisFirehoseInput: KinesisFirehoseInput? = nil, namePrefix: String) {
    ...
    public struct DiscoverInputSchemaRequest: AWSShape {
        ...
        public init(resourceARN: String? = nil, inputProcessingConfiguration: InputProcessingConfiguration? = nil, inputStartingPositionConfiguration: InputStartingPositionConfiguration? = nil, s3Configuration: S3Configuration? = nil, roleARN: String? = nil) {
            self.resourceARN = resourceARN
            self.inputProcessingConfiguration = inputProcessingConfiguration
            self.inputStartingPositionConfiguration = inputStartingPositionConfiguration
    ...
    public struct AddApplicationInputProcessingConfigurationRequest: AWSShape {
        ...
        public init(inputProcessingConfiguration: InputProcessingConfiguration, applicationName: String, currentApplicationVersionId: Int64, inputId: String) {
            self.inputProcessingConfiguration = inputProcessingConfiguration
            self.applicationName = applicationName
            self.currentApplicationVersionId = currentApplicationVersionId
            self.inputId = inputId
    ...
    public struct SourceSchema: AWSShape {
        ...
        public init(recordColumns: [RecordColumn], recordFormat: RecordFormat, recordEncoding: String? = nil) {
    ...
    public struct InputDescription: AWSShape {
        ...
        public init(inputParallelism: InputParallelism? = nil, inputSchema: SourceSchema? = nil, inputId: String? = nil, namePrefix: String? = nil, inAppStreamNames: [String]? = nil, inputStartingPositionConfiguration: InputStartingPositionConfiguration? = nil, kinesisFirehoseInputDescription: KinesisFirehoseInputDescription? = nil, inputProcessingConfigurationDescription: InputProcessingConfigurationDescription? = nil, kinesisStreamsInputDescription: KinesisStreamsInputDescription? = nil) {
            self.inputParallelism = inputParallelism
            self.inputSchema = inputSchema
            self.inputId = inputId
            self.namePrefix = namePrefix
    ...
    public struct CreateApplicationRequest: AWSShape {
        ...
        public init(applicationDescription: String? = nil, cloudWatchLoggingOptions: [CloudWatchLoggingOption]? = nil, outputs: [Output]? = nil, applicationCode: String? = nil, inputs: [Input]? = nil, applicationName: String) {
    ...
    public struct ApplicationDetail: AWSShape {
        ...
        public init(inputDescriptions: [InputDescription]? = nil, applicationName: String, lastUpdateTimestamp: TimeStamp? = nil, cloudWatchLoggingOptionDescriptions: [CloudWatchLoggingOptionDescription]? = nil, applicationARN: String, applicationVersionId: Int64, referenceDataSourceDescriptions: [ReferenceDataSourceDescription]? = nil, applicationDescription: String? = nil, outputDescriptions: [OutputDescription]? = nil, applicationStatus: ApplicationStatus, applicationCode: String? = nil, createTimestamp: TimeStamp? = nil) {
