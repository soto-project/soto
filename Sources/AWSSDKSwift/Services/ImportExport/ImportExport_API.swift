...
public struct ImportExport {
    ...
    public func getStatus(_ input: GetStatusInput) throws -> EventLoopFuture<GetStatusOutput> {
    ...
    public func listJobs(_ input: ListJobsInput) throws -> EventLoopFuture<ListJobsOutput> {
    ...
    public func updateJob(_ input: UpdateJobInput) throws -> EventLoopFuture<UpdateJobOutput> {
        return try client.send(operation: "UpdateJob", path: "/?Operation=UpdateJob", httpMethod: "POST", input: input)
    }

    ///  This operation generates a pre-paid UPS shipping label that you will use to ship your device to AWS for processing.
    public func getShippingLabel(_ input: GetShippingLabelInput) throws -> EventLoopFuture<GetShippingLabelOutput> {
    ...
    public func createJob(_ input: CreateJobInput) throws -> EventLoopFuture<CreateJobOutput> {
    ...
    public func cancelJob(_ input: CancelJobInput) throws -> EventLoopFuture<CancelJobOutput> {
