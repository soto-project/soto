...
public struct ImportExport {
    ...
    public func cancelJob(_ input: CancelJobInput) -> Future<CancelJobOutput> {
    ...
    public func createJob(_ input: CreateJobInput) -> Future<CreateJobOutput> {
        return client.send(operation: "CreateJob", path: "/?Operation=CreateJob", httpMethod: "POST", input: input)
    }

    ///  This operation generates a pre-paid UPS shipping label that you will use to ship your device to AWS for processing.
    public func getShippingLabel(_ input: GetShippingLabelInput) -> Future<GetShippingLabelOutput> {
    ...
    public func getStatus(_ input: GetStatusInput) -> Future<GetStatusOutput> {
    ...
    public func listJobs(_ input: ListJobsInput) -> Future<ListJobsOutput> {
    ...
    public func updateJob(_ input: UpdateJobInput) -> Future<UpdateJobOutput> {
