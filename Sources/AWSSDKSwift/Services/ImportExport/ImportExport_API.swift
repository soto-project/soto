...
public struct ImportExport: AWSService {
    ...
    /// return new `ImportExport` with new timeout value
    ...
    /// return new `ImportExport` logging to specified Logger
    ...
    public func cancelJob(_ input: CancelJobInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelJobOutput> {
        return client.execute(operation: "CancelJob", path: "/?Operation=CancelJob", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createJob(_ input: CreateJobInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateJobOutput> {
        return client.execute(operation: "CreateJob", path: "/?Operation=CreateJob", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getShippingLabel(_ input: GetShippingLabelInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetShippingLabelOutput> {
        return client.execute(operation: "GetShippingLabel", path: "/?Operation=GetShippingLabel", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getStatus(_ input: GetStatusInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetStatusOutput> {
        return client.execute(operation: "GetStatus", path: "/?Operation=GetStatus", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listJobs(_ input: ListJobsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJobsOutput> {
        return client.execute(operation: "ListJobs", path: "/?Operation=ListJobs", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateJob(_ input: UpdateJobInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateJobOutput> {
        return client.execute(operation: "UpdateJob", path: "/?Operation=UpdateJob", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
