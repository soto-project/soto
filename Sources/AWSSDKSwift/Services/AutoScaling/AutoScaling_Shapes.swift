...
extension AutoScaling {
    ...
    public struct ActivitiesType: AWSShape {
        ...
        public struct _ActivitiesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The scaling activities. Activities are sorted by start time. Activities still in progress are described first.
        @Coding<ArrayCoder<_ActivitiesEncoding, Activity>> public var activities: [Activity]
    ...
    public struct AttachInstancesQuery: AWSShape {
        ...
        public struct _InstanceIdsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String
    ...
    public struct AttachLoadBalancerTargetGroupsType: AWSShape {
        ...
        @Coding<ArrayCoder<_TargetGroupARNsEncoding, String>> public var targetGroupARNs: [String]
    ...
    public struct AutoScalingGroup: AWSShape {
        public static var _encoding = [
            ...
            AWSMemberEncoding(label: "loadBalancerNames", location: .body(locationName: "LoadBalancerNames"), encoding: .list(member:"member")), 
            AWSMemberEncoding(label: "suspendedProcesses", location: .body(locationName: "SuspendedProcesses"), encoding: .list(member:"member")), 
        ...
        public struct _EnabledMetricsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _InstancesEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _LoadBalancerNamesEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _SuspendedProcessesEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TagsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TargetGroupARNsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TerminationPoliciesEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_EnabledMetricsEncoding, EnabledMetric>> public var enabledMetrics: [EnabledMetric]?
        ...
        @OptionalCoding<ArrayCoder<_SuspendedProcessesEncoding, SuspendedProcess>> public var suspendedProcesses: [SuspendedProcess]?
        /// The tags for the group.
        @OptionalCoding<ArrayCoder<_TagsEncoding, TagDescription>> public var tags: [TagDescription]?
        /// The Amazon Resource Names (ARN) of the target groups for your load balancer.
        @OptionalCoding<ArrayCoder<_TargetGroupARNsEncoding, String>> public var targetGroupARNs: [String]?
        /// The termination policies for the group.
        @OptionalCoding<ArrayCoder<_TerminationPoliciesEncoding, String>> public var terminationPolicies: [String]?
    ...
    public struct AutoScalingGroupNamesType: AWSShape {
        ...
        public struct _AutoScalingGroupNamesEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_AutoScalingGroupNamesEncoding, String>> public var autoScalingGroupNames: [String]?
    ...
    public struct AutoScalingGroupsType: AWSShape {
        ...
        /// The groups.
        @Coding<ArrayCoder<_AutoScalingGroupsEncoding, AutoScalingGroup>> public var autoScalingGroups: [AutoScalingGroup]
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
    ...
    public struct AutoScalingInstancesType: AWSShape {
        ...
        public struct _AutoScalingInstancesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The instances.
        @OptionalCoding<ArrayCoder<_AutoScalingInstancesEncoding, AutoScalingInstanceDetails>> public var autoScalingInstances: [AutoScalingInstanceDetails]?
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
    ...
    public struct BatchDeleteScheduledActionAnswer: AWSShape {
        ...
        public struct _FailedScheduledActionsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The names of the scheduled actions that could not be deleted, including an error message.
        @OptionalCoding<ArrayCoder<_FailedScheduledActionsEncoding, FailedScheduledUpdateGroupActionRequest>> public var failedScheduledActions: [FailedScheduledUpdateGroupActionRequest]?
    ...
    public struct BatchDeleteScheduledActionType: AWSShape {
        ...
        public struct _ScheduledActionNamesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String
        /// The names of the scheduled actions to delete. The maximum number allowed is 50. 
        @Coding<ArrayCoder<_ScheduledActionNamesEncoding, String>> public var scheduledActionNames: [String]
    ...
    public struct BatchPutScheduledUpdateGroupActionAnswer: AWSShape {
        ...
        public struct _FailedScheduledUpdateGroupActionsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The names of the scheduled actions that could not be created or updated, including an error message.
        @OptionalCoding<ArrayCoder<_FailedScheduledUpdateGroupActionsEncoding, FailedScheduledUpdateGroupActionRequest>> public var failedScheduledUpdateGroupActions: [FailedScheduledUpdateGroupActionRequest]?
    ...
    public struct BatchPutScheduledUpdateGroupActionType: AWSShape {
        ...
        public struct _ScheduledUpdateGroupActionsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String
        /// One or more scheduled actions. The maximum number allowed is 50.
        @Coding<ArrayCoder<_ScheduledUpdateGroupActionsEncoding, ScheduledUpdateGroupActionRequest>> public var scheduledUpdateGroupActions: [ScheduledUpdateGroupActionRequest]
    ...
    public struct CreateAutoScalingGroupType: AWSShape {
        ...
        public struct _AvailabilityZonesEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _LifecycleHookSpecificationListEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _LoadBalancerNamesEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TagsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TargetGroupARNsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TerminationPoliciesEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_LifecycleHookSpecificationListEncoding, LifecycleHookSpecification>> public var lifecycleHookSpecificationList: [LifecycleHookSpecification]?
    ...
    public struct CreateLaunchConfigurationType: AWSShape {
        ...
        public struct _BlockDeviceMappingsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _ClassicLinkVPCSecurityGroupsEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_ClassicLinkVPCSecurityGroupsEncoding, String>> public var classicLinkVPCSecurityGroups: [String]?
    ...
    public struct CustomizedMetricSpecification: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_DimensionsEncoding, MetricDimension>> public var dimensions: [MetricDimension]?
    ...
    public struct DescribeAdjustmentTypesAnswer: AWSShape {
        ...
        public struct _AdjustmentTypesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The policy adjustment types.
        @OptionalCoding<ArrayCoder<_AdjustmentTypesEncoding, AdjustmentType>> public var adjustmentTypes: [AdjustmentType]?
    ...
    public struct DescribeAutoScalingNotificationTypesAnswer: AWSShape {
        ...
        public struct _AutoScalingNotificationTypesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The notification types.
        @OptionalCoding<ArrayCoder<_AutoScalingNotificationTypesEncoding, String>> public var autoScalingNotificationTypes: [String]?
    ...
    public struct DescribeLifecycleHookTypesAnswer: AWSShape {
        ...
        public struct _LifecycleHookTypesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The lifecycle hook types.
        @OptionalCoding<ArrayCoder<_LifecycleHookTypesEncoding, String>> public var lifecycleHookTypes: [String]?
    ...
    public struct DescribeLifecycleHooksAnswer: AWSShape {
        ...
        public struct _LifecycleHooksEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The lifecycle hooks for the specified group.
        @OptionalCoding<ArrayCoder<_LifecycleHooksEncoding, LifecycleHook>> public var lifecycleHooks: [LifecycleHook]?
    ...
    public struct DescribeLifecycleHooksType: AWSShape {
        ...
        public struct _LifecycleHookNamesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String
        /// The names of one or more lifecycle hooks. If you omit this parameter, all lifecycle hooks are described.
        @OptionalCoding<ArrayCoder<_LifecycleHookNamesEncoding, String>> public var lifecycleHookNames: [String]?
    ...
    public struct DescribeLoadBalancerTargetGroupsResponse: AWSShape {
        ...
        public struct _LoadBalancerTargetGroupsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// Information about the target groups.
        @OptionalCoding<ArrayCoder<_LoadBalancerTargetGroupsEncoding, LoadBalancerTargetGroupState>> public var loadBalancerTargetGroups: [LoadBalancerTargetGroupState]?
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
    ...
    public struct DescribeLoadBalancersResponse: AWSShape {
        ...
        /// The load balancers.
        @OptionalCoding<ArrayCoder<_LoadBalancersEncoding, LoadBalancerState>> public var loadBalancers: [LoadBalancerState]?
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
    ...
    public struct DescribeMetricCollectionTypesAnswer: AWSShape {
        ...
        public struct _GranularitiesEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _MetricsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The granularities for the metrics.
        @OptionalCoding<ArrayCoder<_GranularitiesEncoding, MetricGranularityType>> public var granularities: [MetricGranularityType]?
        /// One or more metrics.
        @OptionalCoding<ArrayCoder<_MetricsEncoding, MetricCollectionType>> public var metrics: [MetricCollectionType]?
    ...
    public struct DescribeNotificationConfigurationsAnswer: AWSShape {
        ...
        public struct _NotificationConfigurationsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
        /// The notification configurations.
        @Coding<ArrayCoder<_NotificationConfigurationsEncoding, NotificationConfiguration>> public var notificationConfigurations: [NotificationConfiguration]
    ...
    public struct DescribePoliciesType: AWSShape {
        ...
        public struct _PolicyTypesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String?
        ...
        @OptionalCoding<ArrayCoder<_PolicyTypesEncoding, String>> public var policyTypes: [String]?
    ...
    public struct DescribeScalingActivitiesType: AWSShape {
        ...
        public struct _ActivityIdsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The activity IDs of the desired scaling activities. You can specify up to 50 IDs. If you omit this parameter, all activities for the past six weeks are described. If unknown activities are requested, they are ignored with no error. If you specify an Auto Scaling group, the results are limited to that group.
        @OptionalCoding<ArrayCoder<_ActivityIdsEncoding, String>> public var activityIds: [String]?
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String?
        /// The maximum number of items to return with this call. The default value is 100 and the maximum value is 100.
        public let maxRecords: Int?
    ...
    public struct DescribeScheduledActionsType: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_ScheduledActionNamesEncoding, String>> public var scheduledActionNames: [String]?
    ...
    public struct DescribeTerminationPolicyTypesAnswer: AWSShape {
        ...
        public struct _TerminationPolicyTypesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The termination policies supported by Amazon EC2 Auto Scaling: OldestInstance, OldestLaunchConfiguration, NewestInstance, ClosestToNextInstanceHour, Default, OldestLaunchTemplate, and AllocationStrategy.
        @OptionalCoding<ArrayCoder<_TerminationPolicyTypesEncoding, String>> public var terminationPolicyTypes: [String]?
    ...
    public struct DetachInstancesAnswer: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_ActivitiesEncoding, Activity>> public var activities: [Activity]?
    ...
    public struct LaunchConfigurationNamesType: AWSShape {
        ...
        public struct _LaunchConfigurationNamesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The launch configuration names. If you omit this parameter, all launch configurations are described.
        @OptionalCoding<ArrayCoder<_LaunchConfigurationNamesEncoding, String>> public var launchConfigurationNames: [String]?
        /// The maximum number of items to return with this call. The default value is 50 and the maximum value is 100.
        public let maxRecords: Int?
        /// The token for the next set of items to return. (You received this token from a previous call.)
        public let nextToken: String?
    ...
    public struct LaunchConfigurationsType: AWSShape {
        ...
        @Coding<ArrayCoder<_LaunchConfigurationsEncoding, LaunchConfiguration>> public var launchConfigurations: [LaunchConfiguration]
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
    ...
    public struct LaunchTemplate: AWSShape {
        ...
        public struct _OverridesEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_OverridesEncoding, LaunchTemplateOverrides>> public var overrides: [LaunchTemplateOverrides]?
    ...
    public struct PoliciesType: AWSShape {
        ...
        public struct _ScalingPoliciesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// A string that indicates that the response contains more items than can be returned in a single response. To receive additional items, specify this string for the NextToken value when requesting the next set of items. This value is null when there are no more items to return.
        public let nextToken: String?
        /// The scaling policies.
        @OptionalCoding<ArrayCoder<_ScalingPoliciesEncoding, ScalingPolicy>> public var scalingPolicies: [ScalingPolicy]?
    ...
    public struct PolicyARNType: AWSShape {
        ...
        public struct _AlarmsEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The CloudWatch alarms created for the target tracking scaling policy.
        @OptionalCoding<ArrayCoder<_AlarmsEncoding, Alarm>> public var alarms: [Alarm]?
    ...
    public struct ProcessesType: AWSShape {
        ...
        public struct _ProcessesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The names of the process types.
        @OptionalCoding<ArrayCoder<_ProcessesEncoding, ProcessType>> public var processes: [ProcessType]?
    ...
    public struct PutNotificationConfigurationType: AWSShape {
        ...
        public struct _NotificationTypesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String
        ...
        @Coding<ArrayCoder<_NotificationTypesEncoding, String>> public var notificationTypes: [String]
        /// The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (Amazon SNS) topic.
        public let topicARN: String
    ...
    public struct PutScalingPolicyType: AWSShape {
        ...
        public struct _StepAdjustmentsEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_StepAdjustmentsEncoding, StepAdjustment>> public var stepAdjustments: [StepAdjustment]?
    ...
    public struct ScalingProcessQuery: AWSShape {
        ...
        public struct _ScalingProcessesEncoding: ArrayCoderProperties { static public let member = "member" }
        /// The name of the Auto Scaling group.
        public let autoScalingGroupName: String
        ...
        @OptionalCoding<ArrayCoder<_ScalingProcessesEncoding, String>> public var scalingProcesses: [String]?
    ...
    public struct ScheduledActionsType: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_ScheduledUpdateGroupActionsEncoding, ScheduledUpdateGroupAction>> public var scheduledUpdateGroupActions: [ScheduledUpdateGroupAction]?
    ...
    public struct SetInstanceProtectionQuery: AWSShape {
        ...
        @Coding<ArrayCoder<_InstanceIdsEncoding, String>> public var instanceIds: [String]
        /// Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling in.
        public let protectedFromScaleIn: Bool
