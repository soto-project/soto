...
public struct AutoScaling: AWSService {
    ...
    @discardableResult public func attachInstances(_ input: AttachInstancesQuery) -> EventLoopFuture<Void> {
        return client.execute(operation: "AttachInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func attachLoadBalancerTargetGroups(_ input: AttachLoadBalancerTargetGroupsType) -> EventLoopFuture<AttachLoadBalancerTargetGroupsResultType> {
        return client.execute(operation: "AttachLoadBalancerTargetGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func attachLoadBalancers(_ input: AttachLoadBalancersType) -> EventLoopFuture<AttachLoadBalancersResultType> {
        return client.execute(operation: "AttachLoadBalancers", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchDeleteScheduledAction(_ input: BatchDeleteScheduledActionType) -> EventLoopFuture<BatchDeleteScheduledActionAnswer> {
        return client.execute(operation: "BatchDeleteScheduledAction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchPutScheduledUpdateGroupAction(_ input: BatchPutScheduledUpdateGroupActionType) -> EventLoopFuture<BatchPutScheduledUpdateGroupActionAnswer> {
        return client.execute(operation: "BatchPutScheduledUpdateGroupAction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func cancelInstanceRefresh(_ input: CancelInstanceRefreshType) -> EventLoopFuture<CancelInstanceRefreshAnswer> {
        return client.execute(operation: "CancelInstanceRefresh", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func completeLifecycleAction(_ input: CompleteLifecycleActionType) -> EventLoopFuture<CompleteLifecycleActionAnswer> {
        return client.execute(operation: "CompleteLifecycleAction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createAutoScalingGroup(_ input: CreateAutoScalingGroupType) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateAutoScalingGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createLaunchConfiguration(_ input: CreateLaunchConfigurationType) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateLaunchConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createOrUpdateTags(_ input: CreateOrUpdateTagsType) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateOrUpdateTags", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteAutoScalingGroup(_ input: DeleteAutoScalingGroupType) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAutoScalingGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteLaunchConfiguration(_ input: LaunchConfigurationNameType) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteLaunchConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteLifecycleHook(_ input: DeleteLifecycleHookType) -> EventLoopFuture<DeleteLifecycleHookAnswer> {
        return client.execute(operation: "DeleteLifecycleHook", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteNotificationConfiguration(_ input: DeleteNotificationConfigurationType) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteNotificationConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAccountLimits() -> EventLoopFuture<DescribeAccountLimitsAnswer> {
        return client.execute(operation: "DescribeAccountLimits", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeAdjustmentTypes() -> EventLoopFuture<DescribeAdjustmentTypesAnswer> {
        return client.execute(operation: "DescribeAdjustmentTypes", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }

    ///  Describes one or more Auto Scaling groups.
    public func describeAutoScalingGroups(_ input: AutoScalingGroupNamesType) -> EventLoopFuture<AutoScalingGroupsType> {
        return client.execute(operation: "DescribeAutoScalingGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAutoScalingInstances(_ input: DescribeAutoScalingInstancesType) -> EventLoopFuture<AutoScalingInstancesType> {
        return client.execute(operation: "DescribeAutoScalingInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAutoScalingNotificationTypes() -> EventLoopFuture<DescribeAutoScalingNotificationTypesAnswer> {
        return client.execute(operation: "DescribeAutoScalingNotificationTypes", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeInstanceRefreshes(_ input: DescribeInstanceRefreshesType) -> EventLoopFuture<DescribeInstanceRefreshesAnswer> {
        return client.execute(operation: "DescribeInstanceRefreshes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLaunchConfigurations(_ input: LaunchConfigurationNamesType) -> EventLoopFuture<LaunchConfigurationsType> {
        return client.execute(operation: "DescribeLaunchConfigurations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLifecycleHookTypes() -> EventLoopFuture<DescribeLifecycleHookTypesAnswer> {
        return client.execute(operation: "DescribeLifecycleHookTypes", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeLifecycleHooks(_ input: DescribeLifecycleHooksType) -> EventLoopFuture<DescribeLifecycleHooksAnswer> {
        return client.execute(operation: "DescribeLifecycleHooks", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLoadBalancerTargetGroups(_ input: DescribeLoadBalancerTargetGroupsRequest) -> EventLoopFuture<DescribeLoadBalancerTargetGroupsResponse> {
        return client.execute(operation: "DescribeLoadBalancerTargetGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLoadBalancers(_ input: DescribeLoadBalancersRequest) -> EventLoopFuture<DescribeLoadBalancersResponse> {
        return client.execute(operation: "DescribeLoadBalancers", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeMetricCollectionTypes() -> EventLoopFuture<DescribeMetricCollectionTypesAnswer> {
        return client.execute(operation: "DescribeMetricCollectionTypes", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeNotificationConfigurations(_ input: DescribeNotificationConfigurationsType) -> EventLoopFuture<DescribeNotificationConfigurationsAnswer> {
        return client.execute(operation: "DescribeNotificationConfigurations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes the policies for the specified Auto Scaling group.
    public func describePolicies(_ input: DescribePoliciesType) -> EventLoopFuture<PoliciesType> {
        return client.execute(operation: "DescribePolicies", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeScalingProcessTypes() -> EventLoopFuture<ProcessesType> {
        return client.execute(operation: "DescribeScalingProcessTypes", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func describeTerminationPolicyTypes() -> EventLoopFuture<DescribeTerminationPolicyTypesAnswer> {
        return client.execute(operation: "DescribeTerminationPolicyTypes", path: "/", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func detachInstances(_ input: DetachInstancesQuery) -> EventLoopFuture<DetachInstancesAnswer> {
        return client.execute(operation: "DetachInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detachLoadBalancerTargetGroups(_ input: DetachLoadBalancerTargetGroupsType) -> EventLoopFuture<DetachLoadBalancerTargetGroupsResultType> {
        return client.execute(operation: "DetachLoadBalancerTargetGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detachLoadBalancers(_ input: DetachLoadBalancersType) -> EventLoopFuture<DetachLoadBalancersResultType> {
        return client.execute(operation: "DetachLoadBalancers", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disableMetricsCollection(_ input: DisableMetricsCollectionQuery) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisableMetricsCollection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func enableMetricsCollection(_ input: EnableMetricsCollectionQuery) -> EventLoopFuture<Void> {
        return client.execute(operation: "EnableMetricsCollection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func enterStandby(_ input: EnterStandbyQuery) -> EventLoopFuture<EnterStandbyAnswer> {
        return client.execute(operation: "EnterStandby", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Executes the specified policy. This can be useful for testing the design of your scaling policy.
    @discardableResult public func executePolicy(_ input: ExecutePolicyType) -> EventLoopFuture<Void> {
        return client.execute(operation: "ExecutePolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func exitStandby(_ input: ExitStandbyQuery) -> EventLoopFuture<ExitStandbyAnswer> {
        return client.execute(operation: "ExitStandby", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putLifecycleHook(_ input: PutLifecycleHookType) -> EventLoopFuture<PutLifecycleHookAnswer> {
        return client.execute(operation: "PutLifecycleHook", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putNotificationConfiguration(_ input: PutNotificationConfigurationType) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutNotificationConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putScheduledUpdateGroupAction(_ input: PutScheduledUpdateGroupActionType) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutScheduledUpdateGroupAction", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func recordLifecycleActionHeartbeat(_ input: RecordLifecycleActionHeartbeatType) -> EventLoopFuture<RecordLifecycleActionHeartbeatAnswer> {
        return client.execute(operation: "RecordLifecycleActionHeartbeat", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func resumeProcesses(_ input: ScalingProcessQuery) -> EventLoopFuture<Void> {
        return client.execute(operation: "ResumeProcesses", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setDesiredCapacity(_ input: SetDesiredCapacityType) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetDesiredCapacity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setInstanceHealth(_ input: SetInstanceHealthQuery) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetInstanceHealth", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setInstanceProtection(_ input: SetInstanceProtectionQuery) -> EventLoopFuture<SetInstanceProtectionAnswer> {
        return client.execute(operation: "SetInstanceProtection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startInstanceRefresh(_ input: StartInstanceRefreshType) -> EventLoopFuture<StartInstanceRefreshAnswer> {
        return client.execute(operation: "StartInstanceRefresh", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func suspendProcesses(_ input: ScalingProcessQuery) -> EventLoopFuture<Void> {
        return client.execute(operation: "SuspendProcesses", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func terminateInstanceInAutoScalingGroup(_ input: TerminateInstanceInAutoScalingGroupType) -> EventLoopFuture<ActivityType> {
        return client.execute(operation: "TerminateInstanceInAutoScalingGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func updateAutoScalingGroup(_ input: UpdateAutoScalingGroupType) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateAutoScalingGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
