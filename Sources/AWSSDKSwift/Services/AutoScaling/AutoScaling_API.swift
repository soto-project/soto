...
public struct AutoScaling {
    ...
    public func cancelInstanceRefresh(_ input: CancelInstanceRefreshType, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelInstanceRefreshAnswer> {
        return client.execute(operation: "CancelInstanceRefresh", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeInstanceRefreshes(_ input: DescribeInstanceRefreshesType, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeInstanceRefreshesAnswer> {
        return client.execute(operation: "DescribeInstanceRefreshes", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startInstanceRefresh(_ input: StartInstanceRefreshType, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartInstanceRefreshAnswer> {
        return client.execute(operation: "StartInstanceRefresh", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
