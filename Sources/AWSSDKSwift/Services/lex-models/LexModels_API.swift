...
public struct LexModels {
    ...
    public init(accessKeyId: String? = nil, secretAccessKey: String? = nil, region: AWSSDKSwiftCore.Region? = nil, endpoint: String? = nil) {
        self.client = AWSClient(
            ...
            endpoint: endpoint,
            middlewares: [],
            possibleErrorTypes: [LexModelsError.self]
        )
    }
    ...
    public func getBotAlias(_ input: GetBotAliasRequest) throws -> GetBotAliasResponse {
        return try client.send(operation: "GetBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: "GET", input: input)
    }

    ///  Gets information about an import job started with the StartImport operation.
    public func getImport(_ input: GetImportRequest) throws -> GetImportResponse {
    ...
    public func getBuiltinSlotTypes(_ input: GetBuiltinSlotTypesRequest) throws -> GetBuiltinSlotTypesResponse {
    ...
    public func getBuiltinIntent(_ input: GetBuiltinIntentRequest) throws -> GetBuiltinIntentResponse {
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest) throws -> GetBotChannelAssociationResponse {
    ...
    public func getBuiltinIntents(_ input: GetBuiltinIntentsRequest) throws -> GetBuiltinIntentsResponse {
    ...
    public func getSlotTypes(_ input: GetSlotTypesRequest) throws -> GetSlotTypesResponse {
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest) throws -> GetBotChannelAssociationsResponse {
    ...
    public func putSlotType(_ input: PutSlotTypeRequest) throws -> PutSlotTypeResponse {
    ...
    public func createSlotTypeVersion(_ input: CreateSlotTypeVersionRequest) throws -> CreateSlotTypeVersionResponse {
    ...
    public func getBotAliases(_ input: GetBotAliasesRequest) throws -> GetBotAliasesResponse {
    ...
    public func getIntentVersions(_ input: GetIntentVersionsRequest) throws -> GetIntentVersionsResponse {
    ...
    public func getBots(_ input: GetBotsRequest) throws -> GetBotsResponse {
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest) throws -> CreateBotVersionResponse {
    ...
    public func getSlotType(_ input: GetSlotTypeRequest) throws -> GetSlotTypeResponse {
        return try client.send(operation: "GetSlotType", path: "/slottypes/{name}/versions/{version}", httpMethod: "GET", input: input)
    }

    ///  Starts a job to import a resource to Amazon Lex.
    public func startImport(_ input: StartImportRequest) throws -> StartImportResponse {
    ...
    public func getIntents(_ input: GetIntentsRequest) throws -> GetIntentsResponse {
    ...
    public func getIntent(_ input: GetIntentRequest) throws -> GetIntentResponse {
    ...
    public func getSlotTypeVersions(_ input: GetSlotTypeVersionsRequest) throws -> GetSlotTypeVersionsResponse {
    ...
    public func getBotVersions(_ input: GetBotVersionsRequest) throws -> GetBotVersionsResponse {
    ...
    public func putBotAlias(_ input: PutBotAliasRequest) throws -> PutBotAliasResponse {
