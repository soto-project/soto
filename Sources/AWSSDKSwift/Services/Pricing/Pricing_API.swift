...
public struct Pricing {
    ...
    public func describeServices(_ input: DescribeServicesRequest) -> Future<DescribeServicesResponse> {
        return client.send(operation: "DescribeServices", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of attribute values. Attibutes are similar to the details in a Price List API offer file. For a list of available attributes, see Offer File Definitions in the AWS Billing and Cost Management User Guide.
    public func getAttributeValues(_ input: GetAttributeValuesRequest) -> Future<GetAttributeValuesResponse> {
        return client.send(operation: "GetAttributeValues", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of all products that match the filter criteria.
    public func getProducts(_ input: GetProductsRequest) -> Future<GetProductsResponse> {
