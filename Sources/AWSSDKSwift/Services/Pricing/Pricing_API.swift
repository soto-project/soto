...
public struct Pricing: AWSService {
    ...
    /// return new `Pricing` with new timeout value
    ...
    /// return new `Pricing` logging to specified Logger
    ...
    public func describeServices(_ input: DescribeServicesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeServicesResponse> {
        return client.execute(operation: "DescribeServices", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getAttributeValues(_ input: GetAttributeValuesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAttributeValuesResponse> {
        return client.execute(operation: "GetAttributeValues", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getProducts(_ input: GetProductsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetProductsResponse> {
        return client.execute(operation: "GetProducts", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
