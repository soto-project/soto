...
public struct Pricing {
    ...
    public func describeServices(_ input: DescribeServicesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeServicesResponse> {
    ...
    public func getAttributeValues(_ input: GetAttributeValuesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetAttributeValuesResponse> {
    ...
    public func getProducts(_ input: GetProductsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetProductsResponse> {
