...
extension Pricing {
    ...
    public func describeServicesPaginator(_ input: DescribeServicesRequest) -> EventLoopFuture<[Service]> {
        return client.paginate(input: input, command: describeServices, resultKey: \DescribeServicesResponse.services, tokenKey: \DescribeServicesResponse.nextToken)
    }
    ...
    public func getAttributeValuesPaginator(_ input: GetAttributeValuesRequest) -> EventLoopFuture<[AttributeValue]> {
        return client.paginate(input: input, command: getAttributeValues, resultKey: \GetAttributeValuesResponse.attributeValues, tokenKey: \GetAttributeValuesResponse.nextToken)
    }
    
    ///  Returns a list of all products that match the filter criteria.
    public func getProductsPaginator(_ input: GetProductsRequest) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: getProducts, resultKey: \GetProductsResponse.priceList, tokenKey: \GetProductsResponse.nextToken)
    }
