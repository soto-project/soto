...
extension Pricing {
    ...
    public struct GetProductsResponse: AWSShape {
        ...
        public init(nextToken: String? = nil, priceList: [String]? = nil, formatVersion: String? = nil) {
    ...
    public struct GetAttributeValuesRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, attributeName: String, nextToken: String? = nil, serviceCode: String) {
    ...
    public struct DescribeServicesRequest: AWSShape {
        ...
        public init(serviceCode: String? = nil, maxResults: Int32? = nil, formatVersion: String? = nil, nextToken: String? = nil) {
            self.serviceCode = serviceCode
            self.maxResults = maxResults
            self.formatVersion = formatVersion
            self.nextToken = nextToken
    ...
    public struct GetProductsRequest: AWSShape {
        ...
        public init(formatVersion: String? = nil, nextToken: String? = nil, maxResults: Int32? = nil, serviceCode: String? = nil, filters: [Filter]? = nil) {
            self.formatVersion = formatVersion
            self.nextToken = nextToken
            self.maxResults = maxResults
            self.serviceCode = serviceCode
