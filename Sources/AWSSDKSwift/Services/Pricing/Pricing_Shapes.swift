...
extension Pricing {
    ...
    public struct GetProductsRequest: AWSShape {
        ...
        public init(serviceCode: String? = nil, formatVersion: String? = nil, filters: [Filter]? = nil, maxResults: Int32? = nil, nextToken: String? = nil) {
    ...
    public struct GetAttributeValuesRequest: AWSShape {
        ...
        public init(attributeName: String, serviceCode: String, maxResults: Int32? = nil, nextToken: String? = nil) {
    ...
    public struct Filter: AWSShape {
        ...
        public init(value: String, field: String, type: FilterType) {
            self.value = value
            self.field = field
            self.`type` = `type`
        }
    ...
    public struct DescribeServicesRequest: AWSShape {
        ...
        public init(serviceCode: String? = nil, formatVersion: String? = nil, maxResults: Int32? = nil, nextToken: String? = nil) {
            self.serviceCode = serviceCode
            self.formatVersion = formatVersion
            self.maxResults = maxResults
            self.nextToken = nextToken
