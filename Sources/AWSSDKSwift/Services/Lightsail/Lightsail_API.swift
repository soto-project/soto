...
public struct Lightsail {
    ...
    public func createLoadBalancerTlsCertificate(_ input: CreateLoadBalancerTlsCertificateRequest) throws -> EventLoopFuture<CreateLoadBalancerTlsCertificateResult> {
    ...
    public func detachDisk(_ input: DetachDiskRequest) throws -> EventLoopFuture<DetachDiskResult> {
    ...
    public func deleteInstance(_ input: DeleteInstanceRequest) throws -> EventLoopFuture<DeleteInstanceResult> {
    ...
    public func attachDisk(_ input: AttachDiskRequest) throws -> EventLoopFuture<AttachDiskResult> {
        return try client.send(operation: "AttachDisk", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a specific static IP from your account.
    public func releaseStaticIp(_ input: ReleaseStaticIpRequest) throws -> EventLoopFuture<ReleaseStaticIpResult> {
        return try client.send(operation: "ReleaseStaticIp", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific static IP.
    public func getStaticIp(_ input: GetStaticIpRequest) throws -> EventLoopFuture<GetStaticIpResult> {
    ...
    public func deleteRelationalDatabaseSnapshot(_ input: DeleteRelationalDatabaseSnapshotRequest) throws -> EventLoopFuture<DeleteRelationalDatabaseSnapshotResult> {
    ...
    public func getExportSnapshotRecords(_ input: GetExportSnapshotRecordsRequest) throws -> EventLoopFuture<GetExportSnapshotRecordsResult> {
        return try client.send(operation: "GetExportSnapshotRecords", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the data points of the specified metric for a database in Amazon Lightsail.
    public func getRelationalDatabaseMetricData(_ input: GetRelationalDatabaseMetricDataRequest) throws -> EventLoopFuture<GetRelationalDatabaseMetricDataResult> {
    ...
    public func deleteLoadBalancerTlsCertificate(_ input: DeleteLoadBalancerTlsCertificateRequest) throws -> EventLoopFuture<DeleteLoadBalancerTlsCertificateResult> {
    ...
    public func deleteInstanceSnapshot(_ input: DeleteInstanceSnapshotRequest) throws -> EventLoopFuture<DeleteInstanceSnapshotResult> {
    ...
    public func createLoadBalancer(_ input: CreateLoadBalancerRequest) throws -> EventLoopFuture<CreateLoadBalancerResult> {
    ...
    public func updateRelationalDatabase(_ input: UpdateRelationalDatabaseRequest) throws -> EventLoopFuture<UpdateRelationalDatabaseResult> {
        return try client.send(operation: "UpdateRelationalDatabase", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the list of bundles that are available for purchase. A bundle describes the specs for your virtual private server (or instance).
    public func getBundles(_ input: GetBundlesRequest) throws -> EventLoopFuture<GetBundlesResult> {
    ...
    public func createRelationalDatabaseSnapshot(_ input: CreateRelationalDatabaseSnapshotRequest) throws -> EventLoopFuture<CreateRelationalDatabaseSnapshotResult> {
        return try client.send(operation: "CreateRelationalDatabaseSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Tries to peer the Lightsail VPC with the user's default VPC.
    public func peerVpc(_ input: PeerVpcRequest) throws -> EventLoopFuture<PeerVpcResult> {
        return try client.send(operation: "PeerVpc", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of events for a specific database in Amazon Lightsail.
    public func getRelationalDatabaseEvents(_ input: GetRelationalDatabaseEventsRequest) throws -> EventLoopFuture<GetRelationalDatabaseEventsResult> {
        return try client.send(operation: "GetRelationalDatabaseEvents", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allocates a static IP address.
    public func allocateStaticIp(_ input: AllocateStaticIpRequest) throws -> EventLoopFuture<AllocateStaticIpResult> {
    ...
    public func createDomainEntry(_ input: CreateDomainEntryRequest) throws -> EventLoopFuture<CreateDomainEntryResult> {
    ...
    public func getRelationalDatabaseBlueprints(_ input: GetRelationalDatabaseBlueprintsRequest) throws -> EventLoopFuture<GetRelationalDatabaseBlueprintsResult> {
    ...
    public func getInstanceAccessDetails(_ input: GetInstanceAccessDetailsRequest) throws -> EventLoopFuture<GetInstanceAccessDetailsResult> {
        return try client.send(operation: "GetInstanceAccessDetails", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about all Amazon Lightsail virtual private servers, or instances.
    public func getInstances(_ input: GetInstancesRequest) throws -> EventLoopFuture<GetInstancesResult> {
    ...
    public func startRelationalDatabase(_ input: StartRelationalDatabaseRequest) throws -> EventLoopFuture<StartRelationalDatabaseResult> {
    ...
    public func stopRelationalDatabase(_ input: StopRelationalDatabaseRequest) throws -> EventLoopFuture<StopRelationalDatabaseResult> {
        return try client.send(operation: "StopRelationalDatabase", path: "/", httpMethod: "POST", input: input)
    }

    ///  Attaches a static IP address to a specific Amazon Lightsail instance.
    public func attachStaticIp(_ input: AttachStaticIpRequest) throws -> EventLoopFuture<AttachStaticIpResult> {
        return try client.send(operation: "AttachStaticIp", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of all domains in the user's account.
    public func getDomains(_ input: GetDomainsRequest) throws -> EventLoopFuture<GetDomainsResult> {
    ...
    public func getCloudFormationStackRecords(_ input: GetCloudFormationStackRecordsRequest) throws -> EventLoopFuture<GetCloudFormationStackRecordsResult> {
    ...
    public func deleteDisk(_ input: DeleteDiskRequest) throws -> EventLoopFuture<DeleteDiskResult> {
        return try client.send(operation: "DeleteDisk", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific instance snapshot.
    public func getInstanceSnapshot(_ input: GetInstanceSnapshotRequest) throws -> EventLoopFuture<GetInstanceSnapshotResult> {
        return try client.send(operation: "GetInstanceSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of available log streams for a specific database in Amazon Lightsail.
    public func getRelationalDatabaseLogStreams(_ input: GetRelationalDatabaseLogStreamsRequest) throws -> EventLoopFuture<GetRelationalDatabaseLogStreamsResult> {
    ...
    public func getRelationalDatabaseBundles(_ input: GetRelationalDatabaseBundlesRequest) throws -> EventLoopFuture<GetRelationalDatabaseBundlesResult> {
    ...
    public func rebootInstance(_ input: RebootInstanceRequest) throws -> EventLoopFuture<RebootInstanceResult> {
        return try client.send(operation: "RebootInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Downloads the default SSH key pair from the user's account.
    public func downloadDefaultKeyPair(_ input: DownloadDefaultKeyPairRequest) throws -> EventLoopFuture<DownloadDefaultKeyPairResult> {
    ...
    public func getLoadBalancerTlsCertificates(_ input: GetLoadBalancerTlsCertificatesRequest) throws -> EventLoopFuture<GetLoadBalancerTlsCertificatesResult> {
    ...
    public func deleteDiskSnapshot(_ input: DeleteDiskSnapshotRequest) throws -> EventLoopFuture<DeleteDiskSnapshotResult> {
    ...
    public func createInstancesFromSnapshot(_ input: CreateInstancesFromSnapshotRequest) throws -> EventLoopFuture<CreateInstancesFromSnapshotResult> {
    ...
    public func getDiskSnapshot(_ input: GetDiskSnapshotRequest) throws -> EventLoopFuture<GetDiskSnapshotResult> {
    ...
    public func getLoadBalancers(_ input: GetLoadBalancersRequest) throws -> EventLoopFuture<GetLoadBalancersResult> {
    ...
    public func exportSnapshot(_ input: ExportSnapshotRequest) throws -> EventLoopFuture<ExportSnapshotResult> {
    ...
    public func createDiskFromSnapshot(_ input: CreateDiskFromSnapshotRequest) throws -> EventLoopFuture<CreateDiskFromSnapshotResult> {
    ...
    public func deleteKeyPair(_ input: DeleteKeyPairRequest) throws -> EventLoopFuture<DeleteKeyPairResult> {
    ...
    public func createDisk(_ input: CreateDiskRequest) throws -> EventLoopFuture<CreateDiskResult> {
        return try client.send(operation: "CreateDisk", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the state of a specific instance. Works on one instance at a time.
    public func getInstanceState(_ input: GetInstanceStateRequest) throws -> EventLoopFuture<GetInstanceStateResult> {
        return try client.send(operation: "GetInstanceState", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets operations for a specific resource (e.g., an instance or a static IP).
    public func getOperationsForResource(_ input: GetOperationsForResourceRequest) throws -> EventLoopFuture<GetOperationsForResourceResult> {
        return try client.send(operation: "GetOperationsForResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a Boolean value indicating whether your Lightsail VPC is peered.
    public func isVpcPeered(_ input: IsVpcPeeredRequest) throws -> EventLoopFuture<IsVpcPeeredResult> {
        return try client.send(operation: "IsVpcPeered", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about all of your database snapshots in Amazon Lightsail.
    public func getRelationalDatabaseSnapshots(_ input: GetRelationalDatabaseSnapshotsRequest) throws -> EventLoopFuture<GetRelationalDatabaseSnapshotsResult> {
        return try client.send(operation: "GetRelationalDatabaseSnapshots", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific key pair.
    public func getKeyPair(_ input: GetKeyPairRequest) throws -> EventLoopFuture<GetKeyPairResult> {
    ...
    public func deleteDomain(_ input: DeleteDomainRequest) throws -> EventLoopFuture<DeleteDomainResult> {
    ...
    public func getRelationalDatabaseMasterUserPassword(_ input: GetRelationalDatabaseMasterUserPasswordRequest) throws -> EventLoopFuture<GetRelationalDatabaseMasterUserPasswordResult> {
    ...
    public func createDomain(_ input: CreateDomainRequest) throws -> EventLoopFuture<CreateDomainResult> {
    ...
    public func createCloudFormationStack(_ input: CreateCloudFormationStackRequest) throws -> EventLoopFuture<CreateCloudFormationStackResult> {
        return try client.send(operation: "CreateCloudFormationStack", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about all static IPs in the user's account.
    public func getStaticIps(_ input: GetStaticIpsRequest) throws -> EventLoopFuture<GetStaticIpsResult> {
        return try client.send(operation: "GetStaticIps", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific block storage disk.
    public func getDisk(_ input: GetDiskRequest) throws -> EventLoopFuture<GetDiskResult> {
        return try client.send(operation: "GetDisk", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the data points for the specified Amazon Lightsail instance metric, given an instance name.
    public func getInstanceMetricData(_ input: GetInstanceMetricDataRequest) throws -> EventLoopFuture<GetInstanceMetricDataResult> {
        return try client.send(operation: "GetInstanceMetricData", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific domain recordset.
    public func getDomain(_ input: GetDomainRequest) throws -> EventLoopFuture<GetDomainResult> {
    ...
    public func updateLoadBalancerAttribute(_ input: UpdateLoadBalancerAttributeRequest) throws -> EventLoopFuture<UpdateLoadBalancerAttributeResult> {
    ...
    public func updateDomainEntry(_ input: UpdateDomainEntryRequest) throws -> EventLoopFuture<UpdateDomainEntryResult> {
    ...
    public func createDiskSnapshot(_ input: CreateDiskSnapshotRequest) throws -> EventLoopFuture<CreateDiskSnapshotResult> {
    ...
    public func detachInstancesFromLoadBalancer(_ input: DetachInstancesFromLoadBalancerRequest) throws -> EventLoopFuture<DetachInstancesFromLoadBalancerResult> {
        return try client.send(operation: "DetachInstancesFromLoadBalancer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the port states for a specific virtual private server, or instance.
    public func getInstancePortStates(_ input: GetInstancePortStatesRequest) throws -> EventLoopFuture<GetInstancePortStatesResult> {
    ...
    public func getRelationalDatabaseParameters(_ input: GetRelationalDatabaseParametersRequest) throws -> EventLoopFuture<GetRelationalDatabaseParametersResult> {
        return try client.send(operation: "GetRelationalDatabaseParameters", path: "/", httpMethod: "POST", input: input)
    }

    ///  Attempts to unpeer the Lightsail VPC from the user's default VPC.
    public func unpeerVpc(_ input: UnpeerVpcRequest) throws -> EventLoopFuture<UnpeerVpcResult> {
    ...
    public func attachLoadBalancerTlsCertificate(_ input: AttachLoadBalancerTlsCertificateRequest) throws -> EventLoopFuture<AttachLoadBalancerTlsCertificateResult> {
        return try client.send(operation: "AttachLoadBalancerTlsCertificate", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns all instance snapshots for the user's account.
    public func getInstanceSnapshots(_ input: GetInstanceSnapshotsRequest) throws -> EventLoopFuture<GetInstanceSnapshotsResult> {
    ...
    public func createRelationalDatabase(_ input: CreateRelationalDatabaseRequest) throws -> EventLoopFuture<CreateRelationalDatabaseResult> {
    ...
    public func deleteRelationalDatabase(_ input: DeleteRelationalDatabaseRequest) throws -> EventLoopFuture<DeleteRelationalDatabaseResult> {
    ...
    public func getDisks(_ input: GetDisksRequest) throws -> EventLoopFuture<GetDisksResult> {
        return try client.send(operation: "GetDisks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about all of your databases in Amazon Lightsail.
    public func getRelationalDatabases(_ input: GetRelationalDatabasesRequest) throws -> EventLoopFuture<GetRelationalDatabasesResult> {
        return try client.send(operation: "GetRelationalDatabases", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about health metrics for your Lightsail load balancer.
    public func getLoadBalancerMetricData(_ input: GetLoadBalancerMetricDataRequest) throws -> EventLoopFuture<GetLoadBalancerMetricDataResult> {
    ...
    public func putInstancePublicPorts(_ input: PutInstancePublicPortsRequest) throws -> EventLoopFuture<PutInstancePublicPortsResult> {
        return try client.send(operation: "PutInstancePublicPorts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about all key pairs in the user's account.
    public func getKeyPairs(_ input: GetKeyPairsRequest) throws -> EventLoopFuture<GetKeyPairsResult> {
        return try client.send(operation: "GetKeyPairs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Detaches a static IP from the Amazon Lightsail instance to which it is attached.
    public func detachStaticIp(_ input: DetachStaticIpRequest) throws -> EventLoopFuture<DetachStaticIpResult> {
    ...
    public func deleteDomainEntry(_ input: DeleteDomainEntryRequest) throws -> EventLoopFuture<DeleteDomainEntryResult> {
    ...
    public func tagResource(_ input: TagResourceRequest) throws -> EventLoopFuture<TagResourceResult> {
    ...
    public func openInstancePublicPorts(_ input: OpenInstancePublicPortsRequest) throws -> EventLoopFuture<OpenInstancePublicPortsResult> {
        return try client.send(operation: "OpenInstancePublicPorts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of all valid regions for Amazon Lightsail. Use the include availability zones parameter to also return the Availability Zones in a region.
    public func getRegions(_ input: GetRegionsRequest) throws -> EventLoopFuture<GetRegionsResult> {
    ...
    public func getOperations(_ input: GetOperationsRequest) throws -> EventLoopFuture<GetOperationsResult> {
    ...
    public func attachInstancesToLoadBalancer(_ input: AttachInstancesToLoadBalancerRequest) throws -> EventLoopFuture<AttachInstancesToLoadBalancerResult> {
    ...
    public func deleteLoadBalancer(_ input: DeleteLoadBalancerRequest) throws -> EventLoopFuture<DeleteLoadBalancerResult> {
        return try client.send(operation: "DeleteLoadBalancer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about the specified Lightsail load balancer.
    public func getLoadBalancer(_ input: GetLoadBalancerRequest) throws -> EventLoopFuture<GetLoadBalancerResult> {
    ...
    public func getBlueprints(_ input: GetBlueprintsRequest) throws -> EventLoopFuture<GetBlueprintsResult> {
    ...
    public func createRelationalDatabaseFromSnapshot(_ input: CreateRelationalDatabaseFromSnapshotRequest) throws -> EventLoopFuture<CreateRelationalDatabaseFromSnapshotResult> {
    ...
    public func startInstance(_ input: StartInstanceRequest) throws -> EventLoopFuture<StartInstanceResult> {
        return try client.send(operation: "StartInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific Amazon Lightsail instance, which is a virtual private server.
    public func getInstance(_ input: GetInstanceRequest) throws -> EventLoopFuture<GetInstanceResult> {
    ...
    public func closeInstancePublicPorts(_ input: CloseInstancePublicPortsRequest) throws -> EventLoopFuture<CloseInstancePublicPortsResult> {
        return try client.send(operation: "CloseInstancePublicPorts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of log events for a database in Amazon Lightsail.
    public func getRelationalDatabaseLogEvents(_ input: GetRelationalDatabaseLogEventsRequest) throws -> EventLoopFuture<GetRelationalDatabaseLogEventsResult> {
    ...
    public func rebootRelationalDatabase(_ input: RebootRelationalDatabaseRequest) throws -> EventLoopFuture<RebootRelationalDatabaseResult> {
    ...
    public func untagResource(_ input: UntagResourceRequest) throws -> EventLoopFuture<UntagResourceResult> {
        return try client.send(operation: "UntagResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific database in Amazon Lightsail.
    public func getRelationalDatabase(_ input: GetRelationalDatabaseRequest) throws -> EventLoopFuture<GetRelationalDatabaseResult> {
        return try client.send(operation: "GetRelationalDatabase", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific database snapshot in Amazon Lightsail.
    public func getRelationalDatabaseSnapshot(_ input: GetRelationalDatabaseSnapshotRequest) throws -> EventLoopFuture<GetRelationalDatabaseSnapshotResult> {
    ...
    public func createInstances(_ input: CreateInstancesRequest) throws -> EventLoopFuture<CreateInstancesResult> {
    ...
    public func stopInstance(_ input: StopInstanceRequest) throws -> EventLoopFuture<StopInstanceResult> {
    ...
    public func createInstanceSnapshot(_ input: CreateInstanceSnapshotRequest) throws -> EventLoopFuture<CreateInstanceSnapshotResult> {
    ...
    public func updateRelationalDatabaseParameters(_ input: UpdateRelationalDatabaseParametersRequest) throws -> EventLoopFuture<UpdateRelationalDatabaseParametersResult> {
    ...
    public func createKeyPair(_ input: CreateKeyPairRequest) throws -> EventLoopFuture<CreateKeyPairResult> {
    ...
    public func getDiskSnapshots(_ input: GetDiskSnapshotsRequest) throws -> EventLoopFuture<GetDiskSnapshotsResult> {
        return try client.send(operation: "GetDiskSnapshots", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the names of all active (not deleted) resources.
    public func getActiveNames(_ input: GetActiveNamesRequest) throws -> EventLoopFuture<GetActiveNamesResult> {
        return try client.send(operation: "GetActiveNames", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific operation. Operations include events such as when you create an instance, allocate a static IP, attach a static IP, and so on.
    public func getOperation(_ input: GetOperationRequest) throws -> EventLoopFuture<GetOperationResult> {
