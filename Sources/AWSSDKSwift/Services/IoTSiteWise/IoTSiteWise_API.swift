...
public struct IoTSiteWise: AWSService {
    ...
    @discardableResult public func associateAssets(_ input: AssociateAssetsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "AssociateAssets", path: "/assets/{assetId}/associate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchAssociateProjectAssets(_ input: BatchAssociateProjectAssetsRequest) -> EventLoopFuture<BatchAssociateProjectAssetsResponse> {
        return client.execute(operation: "BatchAssociateProjectAssets", path: "/projects/{projectId}/assets/associate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchDisassociateProjectAssets(_ input: BatchDisassociateProjectAssetsRequest) -> EventLoopFuture<BatchDisassociateProjectAssetsResponse> {
        return client.execute(operation: "BatchDisassociateProjectAssets", path: "/projects/{projectId}/assets/disassociate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchPutAssetPropertyValue(_ input: BatchPutAssetPropertyValueRequest) -> EventLoopFuture<BatchPutAssetPropertyValueResponse> {
        return client.execute(operation: "BatchPutAssetPropertyValue", path: "/properties", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createAccessPolicy(_ input: CreateAccessPolicyRequest) -> EventLoopFuture<CreateAccessPolicyResponse> {
        return client.execute(operation: "CreateAccessPolicy", path: "/access-policies", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createAssetModel(_ input: CreateAssetModelRequest) -> EventLoopFuture<CreateAssetModelResponse> {
        return client.execute(operation: "CreateAssetModel", path: "/asset-models", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a dashboard in an AWS IoT SiteWise Monitor project.
    public func createDashboard(_ input: CreateDashboardRequest) -> EventLoopFuture<CreateDashboardResponse> {
        return client.execute(operation: "CreateDashboard", path: "/dashboards", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createGateway(_ input: CreateGatewayRequest) -> EventLoopFuture<CreateGatewayResponse> {
        return client.execute(operation: "CreateGateway", path: "/20200301/gateways", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createPortal(_ input: CreatePortalRequest) -> EventLoopFuture<CreatePortalResponse> {
        return client.execute(operation: "CreatePortal", path: "/portals", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteAccessPolicy(_ input: DeleteAccessPolicyRequest) -> EventLoopFuture<DeleteAccessPolicyResponse> {
        return client.execute(operation: "DeleteAccessPolicy", path: "/access-policies/{accessPolicyId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteAsset(_ input: DeleteAssetRequest) -> EventLoopFuture<DeleteAssetResponse> {
        return client.execute(operation: "DeleteAsset", path: "/assets/{assetId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteAssetModel(_ input: DeleteAssetModelRequest) -> EventLoopFuture<DeleteAssetModelResponse> {
        return client.execute(operation: "DeleteAssetModel", path: "/asset-models/{assetModelId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Deletes a dashboard from AWS IoT SiteWise Monitor.
    public func deleteDashboard(_ input: DeleteDashboardRequest) -> EventLoopFuture<DeleteDashboardResponse> {
        return client.execute(operation: "DeleteDashboard", path: "/dashboards/{dashboardId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteGateway(_ input: DeleteGatewayRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteGateway", path: "/20200301/gateways/{gatewayId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Deletes a portal from AWS IoT SiteWise Monitor.
    public func deletePortal(_ input: DeletePortalRequest) -> EventLoopFuture<DeletePortalResponse> {
        return client.execute(operation: "DeletePortal", path: "/portals/{portalId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAccessPolicy(_ input: DescribeAccessPolicyRequest) -> EventLoopFuture<DescribeAccessPolicyResponse> {
        return client.execute(operation: "DescribeAccessPolicy", path: "/access-policies/{accessPolicyId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves information about an asset.
    public func describeAsset(_ input: DescribeAssetRequest) -> EventLoopFuture<DescribeAssetResponse> {
        return client.execute(operation: "DescribeAsset", path: "/assets/{assetId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves information about an asset model.
    public func describeAssetModel(_ input: DescribeAssetModelRequest) -> EventLoopFuture<DescribeAssetModelResponse> {
        return client.execute(operation: "DescribeAssetModel", path: "/asset-models/{assetModelId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAssetProperty(_ input: DescribeAssetPropertyRequest) -> EventLoopFuture<DescribeAssetPropertyResponse> {
        return client.execute(operation: "DescribeAssetProperty", path: "/assets/{assetId}/properties/{propertyId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves information about a dashboard.
    public func describeDashboard(_ input: DescribeDashboardRequest) -> EventLoopFuture<DescribeDashboardResponse> {
        return client.execute(operation: "DescribeDashboard", path: "/dashboards/{dashboardId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves information about a gateway.
    public func describeGateway(_ input: DescribeGatewayRequest) -> EventLoopFuture<DescribeGatewayResponse> {
        return client.execute(operation: "DescribeGateway", path: "/20200301/gateways/{gatewayId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeGatewayCapabilityConfiguration(_ input: DescribeGatewayCapabilityConfigurationRequest) -> EventLoopFuture<DescribeGatewayCapabilityConfigurationResponse> {
        return client.execute(operation: "DescribeGatewayCapabilityConfiguration", path: "/20200301/gateways/{gatewayId}/capability/{capabilityNamespace}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describePortal(_ input: DescribePortalRequest) -> EventLoopFuture<DescribePortalResponse> {
        return client.execute(operation: "DescribePortal", path: "/portals/{portalId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves information about a project.
    public func describeProject(_ input: DescribeProjectRequest) -> EventLoopFuture<DescribeProjectResponse> {
        return client.execute(operation: "DescribeProject", path: "/projects/{projectId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disassociateAssets(_ input: DisassociateAssetsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisassociateAssets", path: "/assets/{assetId}/disassociate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getAssetPropertyAggregates(_ input: GetAssetPropertyAggregatesRequest) -> EventLoopFuture<GetAssetPropertyAggregatesResponse> {
        return client.execute(operation: "GetAssetPropertyAggregates", path: "/properties/aggregates", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getAssetPropertyValue(_ input: GetAssetPropertyValueRequest) -> EventLoopFuture<GetAssetPropertyValueResponse> {
        return client.execute(operation: "GetAssetPropertyValue", path: "/properties/latest", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getAssetPropertyValueHistory(_ input: GetAssetPropertyValueHistoryRequest) -> EventLoopFuture<GetAssetPropertyValueHistoryResponse> {
        return client.execute(operation: "GetAssetPropertyValueHistory", path: "/properties/history", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAccessPolicies(_ input: ListAccessPoliciesRequest) -> EventLoopFuture<ListAccessPoliciesResponse> {
        return client.execute(operation: "ListAccessPolicies", path: "/access-policies", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves a paginated list of summaries of all asset models.
    public func listAssetModels(_ input: ListAssetModelsRequest) -> EventLoopFuture<ListAssetModelsResponse> {
        return client.execute(operation: "ListAssetModels", path: "/asset-models", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAssociatedAssets(_ input: ListAssociatedAssetsRequest) -> EventLoopFuture<ListAssociatedAssetsResponse> {
        return client.execute(operation: "ListAssociatedAssets", path: "/assets/{assetId}/hierarchies", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves a paginated list of dashboards for an AWS IoT SiteWise Monitor project.
    public func listDashboards(_ input: ListDashboardsRequest) -> EventLoopFuture<ListDashboardsResponse> {
        return client.execute(operation: "ListDashboards", path: "/dashboards", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves a paginated list of gateways.
    public func listGateways(_ input: ListGatewaysRequest) -> EventLoopFuture<ListGatewaysResponse> {
        return client.execute(operation: "ListGateways", path: "/20200301/gateways", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves a paginated list of AWS IoT SiteWise Monitor portals.
    public func listPortals(_ input: ListPortalsRequest) -> EventLoopFuture<ListPortalsResponse> {
        return client.execute(operation: "ListPortals", path: "/portals", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listProjectAssets(_ input: ListProjectAssetsRequest) -> EventLoopFuture<ListProjectAssetsResponse> {
        return client.execute(operation: "ListProjectAssets", path: "/projects/{projectId}/assets", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateAccessPolicy(_ input: UpdateAccessPolicyRequest) -> EventLoopFuture<UpdateAccessPolicyResponse> {
        return client.execute(operation: "UpdateAccessPolicy", path: "/access-policies/{accessPolicyId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateAsset(_ input: UpdateAssetRequest) -> EventLoopFuture<UpdateAssetResponse> {
        return client.execute(operation: "UpdateAsset", path: "/assets/{assetId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateAssetModel(_ input: UpdateAssetModelRequest) -> EventLoopFuture<UpdateAssetModelResponse> {
        return client.execute(operation: "UpdateAssetModel", path: "/asset-models/{assetModelId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func updateAssetProperty(_ input: UpdateAssetPropertyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateAssetProperty", path: "/assets/{assetId}/properties/{propertyId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Updates an AWS IoT SiteWise Monitor dashboard.
    public func updateDashboard(_ input: UpdateDashboardRequest) -> EventLoopFuture<UpdateDashboardResponse> {
        return client.execute(operation: "UpdateDashboard", path: "/dashboards/{dashboardId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Updates a gateway's name.
    @discardableResult public func updateGateway(_ input: UpdateGatewayRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateGateway", path: "/20200301/gateways/{gatewayId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateGatewayCapabilityConfiguration(_ input: UpdateGatewayCapabilityConfigurationRequest) -> EventLoopFuture<UpdateGatewayCapabilityConfigurationResponse> {
        return client.execute(operation: "UpdateGatewayCapabilityConfiguration", path: "/20200301/gateways/{gatewayId}/capability", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Updates an AWS IoT SiteWise Monitor portal.
    public func updatePortal(_ input: UpdatePortalRequest) -> EventLoopFuture<UpdatePortalResponse> {
        return client.execute(operation: "UpdatePortal", path: "/portals/{portalId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Updates an AWS IoT SiteWise Monitor project.
    public func updateProject(_ input: UpdateProjectRequest) -> EventLoopFuture<UpdateProjectResponse> {
        return client.execute(operation: "UpdateProject", path: "/projects/{projectId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
}
