...
extension WAFRegional {
    ...
    public struct CreateRateBasedRuleRequest: AWSShape {
        ...
        public init(changeToken: String, name: String, rateLimit: Int64, metricName: String, rateKey: RateKey) {
            self.changeToken = changeToken
            self.name = name
    ...
    public struct IPSet: AWSShape {
        ...
        public init(iPSetDescriptors: [IPSetDescriptor], name: String? = nil, iPSetId: String) {
    ...
    public struct SizeConstraint: AWSShape {
        ...
        public init(textTransformation: TextTransformation, size: Int64, comparisonOperator: ComparisonOperator, fieldToMatch: FieldToMatch) {
    ...
    public struct RegexMatchTuple: AWSShape {
        ...
        public init(fieldToMatch: FieldToMatch, textTransformation: TextTransformation, regexPatternSetId: String) {
            self.fieldToMatch = fieldToMatch
            self.textTransformation = textTransformation
    ...
    public struct GetSampledRequestsRequest: AWSShape {
        ...
        public init(ruleId: String, webAclId: String, maxItems: Int64, timeWindow: TimeWindow) {
            self.ruleId = ruleId
    ...
    public struct CreateWebACLRequest: AWSShape {
        ...
        public init(defaultAction: WafAction, changeToken: String, name: String, metricName: String) {
    ...
    public struct SampledHTTPRequest: AWSShape {
        ...
        public init(action: String? = nil, request: HTTPRequest, timestamp: TimeStamp? = nil, weight: Int64, ruleWithinRuleGroup: String? = nil) {
            self.action = action
    ...
    public struct LoggingConfiguration: AWSShape {
        ...
        public init(resourceArn: String, logDestinationConfigs: [String], redactedFields: [FieldToMatch]? = nil) {
            self.resourceArn = resourceArn
    ...
    public struct UpdateSizeConstraintSetRequest: AWSShape {
        ...
        public init(sizeConstraintSetId: String, changeToken: String, updates: [SizeConstraintSetUpdate]) {
    ...
    public struct RegexMatchSet: AWSShape {
        ...
        public init(regexMatchSetId: String? = nil, regexMatchTuples: [RegexMatchTuple]? = nil, name: String? = nil) {
            self.regexMatchSetId = regexMatchSetId
    ...
    public struct ListResourcesForWebACLRequest: AWSShape {
        ...
        public init(webACLId: String, resourceType: ResourceType? = nil) {
            self.webACLId = webACLId
    ...
    public struct AssociateWebACLRequest: AWSShape {
        ...
        public init(webACLId: String, resourceArn: String) {
            self.webACLId = webACLId
            self.resourceArn = resourceArn
        }
    ...
    public struct ByteMatchSet: AWSShape {
        ...
        public init(name: String? = nil, byteMatchTuples: [ByteMatchTuple], byteMatchSetId: String) {
            self.name = name
    ...
    public struct Predicate: AWSShape {
        ...
        public init(negated: Bool, dataId: String, type: PredicateType) {
    ...
    public struct HTTPRequest: AWSShape {
        ...
        public init(country: String? = nil, hTTPVersion: String? = nil, headers: [HTTPHeader]? = nil, method: String? = nil, uri: String? = nil, clientIP: String? = nil) {
    ...
    public struct IPSetSummary: AWSShape {
        ...
        public init(name: String, iPSetId: String) {
            self.name = name
            self.iPSetId = iPSetId
        }
    ...
    public struct CreateRuleGroupResponse: AWSShape {
        ...
        public init(ruleGroup: RuleGroup? = nil, changeToken: String? = nil) {
    ...
    public struct ActivatedRule: AWSShape {
        ...
        public init(action: WafAction? = nil, type: WafRuleType? = nil, overrideAction: WafOverrideAction? = nil, priority: Int32, ruleId: String) {
            self.action = action
            self.`type` = `type`
    ...
    public struct WebACL: AWSShape {
        ...
        public init(rules: [ActivatedRule], name: String? = nil, webACLId: String, defaultAction: WafAction, webACLArn: String? = nil, metricName: String? = nil) {
            self.rules = rules
            self.name = name
            self.webACLId = webACLId
            self.defaultAction = defaultAction
    ...
    public struct RegexPatternSet: AWSShape {
        ...
        public init(name: String? = nil, regexPatternStrings: [String], regexPatternSetId: String) {
            self.name = name
    ...
    public struct UpdateRegexPatternSetRequest: AWSShape {
        ...
        public init(changeToken: String, updates: [RegexPatternSetUpdate], regexPatternSetId: String) {
            self.changeToken = changeToken
            self.updates = updates
            self.regexPatternSetId = regexPatternSetId
        }
    ...
    public struct ByteMatchTuple: AWSShape {
        ...
        public init(targetString: Data, textTransformation: TextTransformation, positionalConstraint: PositionalConstraint, fieldToMatch: FieldToMatch) {
    ...
    public struct Rule: AWSShape {
        ...
        public init(ruleId: String, predicates: [Predicate], metricName: String? = nil, name: String? = nil) {
            self.ruleId = ruleId
    ...
    public struct RuleGroup: AWSShape {
        ...
        public init(ruleGroupId: String, metricName: String? = nil, name: String? = nil) {
            self.ruleGroupId = ruleGroupId
            self.metricName = metricName
            self.name = name
        }
    ...
    public struct UpdateWebACLRequest: AWSShape {
        ...
        public init(defaultAction: WafAction? = nil, changeToken: String, webACLId: String, updates: [WebACLUpdate]? = nil) {
            self.defaultAction = defaultAction
            self.changeToken = changeToken
            self.webACLId = webACLId
            self.updates = updates
    ...
    public struct UpdateRateBasedRuleRequest: AWSShape {
        ...
        public init(changeToken: String, updates: [RuleUpdate], rateLimit: Int64, ruleId: String) {
            self.changeToken = changeToken
            self.updates = updates
            self.rateLimit = rateLimit
            self.ruleId = ruleId
    ...
    public struct RateBasedRule: AWSShape {
        ...
        public init(name: String? = nil, metricName: String? = nil, matchPredicates: [Predicate], ruleId: String, rateKey: RateKey, rateLimit: Int64) {
            self.name = name
            self.metricName = metricName
