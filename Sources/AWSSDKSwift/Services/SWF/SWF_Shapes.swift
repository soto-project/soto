...
extension SWF {
    ...
    public struct ActivityTaskFailedEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, scheduledEventId: Int64, reason: String? = nil, details: String? = nil) {
    ...
    public struct DecisionTask: AWSShape {
        ...
        public init(startedEventId: Int64, workflowExecution: WorkflowExecution, previousStartedEventId: Int64? = nil, nextPageToken: String? = nil, taskToken: String, workflowType: WorkflowType, events: [HistoryEvent]) {
            self.startedEventId = startedEventId
    ...
    public struct LambdaFunctionScheduledEventAttributes: AWSShape {
        ...
        public init(startToCloseTimeout: String? = nil, name: String, id: String, input: String? = nil, control: String? = nil, decisionTaskCompletedEventId: Int64) {
    ...
    public struct TimerStartedEventAttributes: AWSShape {
        ...
        public init(timerId: String, control: String? = nil, startToFireTimeout: String, decisionTaskCompletedEventId: Int64) {
            self.timerId = timerId
            self.control = control
    ...
    public struct MarkerRecordedEventAttributes: AWSShape {
        ...
        public init(markerName: String, decisionTaskCompletedEventId: Int64, details: String? = nil) {
    ...
    public struct PollForDecisionTaskInput: AWSShape {
        ...
        public init(nextPageToken: String? = nil, maximumPageSize: Int32? = nil, reverseOrder: Bool? = nil, domain: String, identity: String? = nil, taskList: TaskList) {
            self.nextPageToken = nextPageToken
    ...
    public struct StartChildWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(lambdaRole: String? = nil, taskList: TaskList? = nil, taskStartToCloseTimeout: String? = nil, input: String? = nil, childPolicy: ChildPolicy? = nil, workflowType: WorkflowType, taskPriority: String? = nil, workflowId: String, tagList: [String]? = nil, executionStartToCloseTimeout: String? = nil, control: String? = nil) {
    ...
    public struct RegisterActivityTypeInput: AWSShape {
        ...
        public init(description: String? = nil, defaultTaskHeartbeatTimeout: String? = nil, defaultTaskList: TaskList? = nil, domain: String, defaultTaskScheduleToStartTimeout: String? = nil, version: String, defaultTaskScheduleToCloseTimeout: String? = nil, name: String, defaultTaskStartToCloseTimeout: String? = nil, defaultTaskPriority: String? = nil) {
    ...
    public struct ScheduleActivityTaskFailedEventAttributes: AWSShape {
        ...
        public init(cause: ScheduleActivityTaskFailedCause, activityType: ActivityType, decisionTaskCompletedEventId: Int64, activityId: String) {
            self.cause = cause
    ...
    public struct LambdaFunctionCompletedEventAttributes: AWSShape {
        ...
        public init(result: String? = nil, startedEventId: Int64, scheduledEventId: Int64) {
            self.result = result
            self.startedEventId = startedEventId
            self.scheduledEventId = scheduledEventId
        }
    ...
    public struct ChildWorkflowExecutionCompletedEventAttributes: AWSShape {
        ...
        public init(result: String? = nil, initiatedEventId: Int64, startedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType) {
            self.result = result
    ...
    public struct WorkflowExecutionContinuedAsNewEventAttributes: AWSShape {
        ...
        public init(taskList: TaskList, decisionTaskCompletedEventId: Int64, taskStartToCloseTimeout: String? = nil, lambdaRole: String? = nil, input: String? = nil, tagList: [String]? = nil, newExecutionRunId: String, workflowType: WorkflowType, executionStartToCloseTimeout: String? = nil, taskPriority: String? = nil, childPolicy: ChildPolicy) {
            self.taskList = taskList
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.taskStartToCloseTimeout = taskStartToCloseTimeout
            self.lambdaRole = lambdaRole
    ...
    public struct ListClosedWorkflowExecutionsInput: AWSShape {
        ...
        public init(closeStatusFilter: CloseStatusFilter? = nil, executionFilter: WorkflowExecutionFilter? = nil, closeTimeFilter: ExecutionTimeFilter? = nil, typeFilter: WorkflowTypeFilter? = nil, domain: String, reverseOrder: Bool? = nil, nextPageToken: String? = nil, startTimeFilter: ExecutionTimeFilter? = nil, tagFilter: TagFilter? = nil, maximumPageSize: Int32? = nil) {
    ...
    public struct DecisionTaskTimedOutEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, timeoutType: DecisionTaskTimeoutType, scheduledEventId: Int64) {
            self.startedEventId = startedEventId
    ...
    public struct CountClosedWorkflowExecutionsInput: AWSShape {
        ...
        public init(typeFilter: WorkflowTypeFilter? = nil, closeStatusFilter: CloseStatusFilter? = nil, closeTimeFilter: ExecutionTimeFilter? = nil, startTimeFilter: ExecutionTimeFilter? = nil, tagFilter: TagFilter? = nil, domain: String, executionFilter: WorkflowExecutionFilter? = nil) {
            self.typeFilter = typeFilter
            self.closeStatusFilter = closeStatusFilter
            self.closeTimeFilter = closeTimeFilter
            self.startTimeFilter = startTimeFilter
    ...
    public struct StartTimerFailedEventAttributes: AWSShape {
        ...
        public init(timerId: String, cause: StartTimerFailedCause, decisionTaskCompletedEventId: Int64) {
            self.timerId = timerId
            self.cause = cause
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
        }
    ...
    public struct RequestCancelExternalWorkflowExecutionInitiatedEventAttributes: AWSShape {
        ...
        public init(control: String? = nil, runId: String? = nil, decisionTaskCompletedEventId: Int64, workflowId: String) {
            self.control = control
            self.runId = runId
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.workflowId = workflowId
    ...
    public struct WorkflowExecutionConfiguration: AWSShape {
        ...
        public init(childPolicy: ChildPolicy, taskStartToCloseTimeout: String, taskPriority: String? = nil, executionStartToCloseTimeout: String, taskList: TaskList, lambdaRole: String? = nil) {
            self.childPolicy = childPolicy
            self.taskStartToCloseTimeout = taskStartToCloseTimeout
            self.taskPriority = taskPriority
            self.executionStartToCloseTimeout = executionStartToCloseTimeout
    ...
    public struct RequestCancelExternalWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(workflowId: String, control: String? = nil, runId: String? = nil) {
            self.workflowId = workflowId
            self.control = control
            self.runId = runId
        }
    ...
    public struct WorkflowExecutionDetail: AWSShape {
        ...
        public init(latestExecutionContext: String? = nil, openCounts: WorkflowExecutionOpenCounts, executionConfiguration: WorkflowExecutionConfiguration, executionInfo: WorkflowExecutionInfo, latestActivityTaskTimestamp: TimeStamp? = nil) {
    ...
    public struct TerminateWorkflowExecutionInput: AWSShape {
        ...
        public init(childPolicy: ChildPolicy? = nil, reason: String? = nil, details: String? = nil, runId: String? = nil, workflowId: String, domain: String) {
            self.childPolicy = childPolicy
            self.reason = reason
            self.details = details
            self.runId = runId
    ...
    public struct ChildWorkflowExecutionCanceledEventAttributes: AWSShape {
        ...
        public init(details: String? = nil, startedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType, initiatedEventId: Int64) {
            self.details = details
            self.startedEventId = startedEventId
            self.workflowExecution = workflowExecution
            self.workflowType = workflowType
    ...
    public struct WorkflowExecutionOpenCounts: AWSShape {
        ...
        public init(openDecisionTasks: Int32, openActivityTasks: Int32, openChildWorkflowExecutions: Int32, openLambdaFunctions: Int32? = nil, openTimers: Int32) {
    ...
    public struct SignalWorkflowExecutionInput: AWSShape {
        ...
        public init(input: String? = nil, domain: String, runId: String? = nil, signalName: String, workflowId: String) {
            self.input = input
            self.domain = domain
            self.runId = runId
    ...
    public struct StartChildWorkflowExecutionInitiatedEventAttributes: AWSShape {
        ...
        public init(tagList: [String]? = nil, taskStartToCloseTimeout: String? = nil, childPolicy: ChildPolicy, control: String? = nil, decisionTaskCompletedEventId: Int64, taskList: TaskList, workflowType: WorkflowType, input: String? = nil, workflowId: String, lambdaRole: String? = nil, taskPriority: String? = nil, executionStartToCloseTimeout: String? = nil) {
            self.tagList = tagList
            self.taskStartToCloseTimeout = taskStartToCloseTimeout
            self.childPolicy = childPolicy
            self.control = control
    ...
    public struct ScheduleActivityTaskDecisionAttributes: AWSShape {
        ...
        public init(startToCloseTimeout: String? = nil, control: String? = nil, activityId: String, heartbeatTimeout: String? = nil, input: String? = nil, taskPriority: String? = nil, scheduleToStartTimeout: String? = nil, taskList: TaskList? = nil, activityType: ActivityType, scheduleToCloseTimeout: String? = nil) {
            self.startToCloseTimeout = startToCloseTimeout
            self.control = control
            self.activityId = activityId
    ...
    public struct ListDomainsInput: AWSShape {
        ...
        public init(reverseOrder: Bool? = nil, registrationStatus: RegistrationStatus, maximumPageSize: Int32? = nil, nextPageToken: String? = nil) {
            self.reverseOrder = reverseOrder
    ...
    public struct ScheduleLambdaFunctionFailedEventAttributes: AWSShape {
        ...
        public init(cause: ScheduleLambdaFunctionFailedCause, id: String, name: String, decisionTaskCompletedEventId: Int64) {
            self.cause = cause
            self.id = id
            self.name = name
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
    ...
    public struct ListActivityTypesInput: AWSShape {
        ...
        public init(reverseOrder: Bool? = nil, domain: String, maximumPageSize: Int32? = nil, name: String? = nil, registrationStatus: RegistrationStatus, nextPageToken: String? = nil) {
            self.reverseOrder = reverseOrder
            self.domain = domain
            self.maximumPageSize = maximumPageSize
            self.name = name
    ...
    public struct ActivityTypeConfiguration: AWSShape {
        ...
        public init(defaultTaskHeartbeatTimeout: String? = nil, defaultTaskList: TaskList? = nil, defaultTaskStartToCloseTimeout: String? = nil, defaultTaskScheduleToCloseTimeout: String? = nil, defaultTaskScheduleToStartTimeout: String? = nil, defaultTaskPriority: String? = nil) {
            self.defaultTaskHeartbeatTimeout = defaultTaskHeartbeatTimeout
            self.defaultTaskList = defaultTaskList
            self.defaultTaskStartToCloseTimeout = defaultTaskStartToCloseTimeout
            self.defaultTaskScheduleToCloseTimeout = defaultTaskScheduleToCloseTimeout
    ...
    public struct WorkflowTypeConfiguration: AWSShape {
        ...
        public init(defaultTaskList: TaskList? = nil, defaultExecutionStartToCloseTimeout: String? = nil, defaultChildPolicy: ChildPolicy? = nil, defaultTaskStartToCloseTimeout: String? = nil, defaultLambdaRole: String? = nil, defaultTaskPriority: String? = nil) {
            self.defaultTaskList = defaultTaskList
    ...
    public struct ActivityTaskCanceledEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, scheduledEventId: Int64, details: String? = nil, latestCancelRequestedEventId: Int64? = nil) {
            self.startedEventId = startedEventId
            self.scheduledEventId = scheduledEventId
            self.details = details
    ...
    public struct SignalExternalWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(control: String? = nil, cause: SignalExternalWorkflowExecutionFailedCause, decisionTaskCompletedEventId: Int64, workflowId: String, initiatedEventId: Int64, runId: String? = nil) {
            self.control = control
            self.cause = cause
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.workflowId = workflowId
    ...
    public struct ActivityTaskTimedOutEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, timeoutType: ActivityTaskTimeoutType, scheduledEventId: Int64, details: String? = nil) {
            self.startedEventId = startedEventId
            self.timeoutType = timeoutType
            self.scheduledEventId = scheduledEventId
            self.details = details
    ...
    public struct WorkflowExecutionTerminatedEventAttributes: AWSShape {
        ...
        public init(reason: String? = nil, cause: WorkflowExecutionTerminatedCause? = nil, details: String? = nil, childPolicy: ChildPolicy) {
            self.reason = reason
            self.cause = cause
            self.details = details
            self.childPolicy = childPolicy
    ...
    public struct ActivityTask: AWSShape {
        ...
        public init(input: String? = nil, activityId: String, workflowExecution: WorkflowExecution, activityType: ActivityType, startedEventId: Int64, taskToken: String) {
            self.input = input
            self.activityId = activityId
            self.workflowExecution = workflowExecution
            self.activityType = activityType
    ...
    public struct StartChildWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(cause: StartChildWorkflowExecutionFailedCause, initiatedEventId: Int64, decisionTaskCompletedEventId: Int64, control: String? = nil, workflowId: String, workflowType: WorkflowType) {
            self.cause = cause
            self.initiatedEventId = initiatedEventId
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.control = control
    ...
    public struct WorkflowExecutionCancelRequestedEventAttributes: AWSShape {
        ...
        public init(externalInitiatedEventId: Int64? = nil, cause: WorkflowExecutionCancelRequestedCause? = nil, externalWorkflowExecution: WorkflowExecution? = nil) {
            self.externalInitiatedEventId = externalInitiatedEventId
            self.cause = cause
            self.externalWorkflowExecution = externalWorkflowExecution
        }
    ...
    public struct ListOpenWorkflowExecutionsInput: AWSShape {
        ...
        public init(executionFilter: WorkflowExecutionFilter? = nil, nextPageToken: String? = nil, typeFilter: WorkflowTypeFilter? = nil, tagFilter: TagFilter? = nil, maximumPageSize: Int32? = nil, startTimeFilter: ExecutionTimeFilter, reverseOrder: Bool? = nil, domain: String) {
            self.executionFilter = executionFilter
            self.nextPageToken = nextPageToken
            self.typeFilter = typeFilter
            self.tagFilter = tagFilter
    ...
    public struct HistoryEvent: AWSShape {
        ...
        public init(cancelWorkflowExecutionFailedEventAttributes: CancelWorkflowExecutionFailedEventAttributes? = nil, workflowExecutionFailedEventAttributes: WorkflowExecutionFailedEventAttributes? = nil, completeWorkflowExecutionFailedEventAttributes: CompleteWorkflowExecutionFailedEventAttributes? = nil, workflowExecutionTerminatedEventAttributes: WorkflowExecutionTerminatedEventAttributes? = nil, timerStartedEventAttributes: TimerStartedEventAttributes? = nil, workflowExecutionSignaledEventAttributes: WorkflowExecutionSignaledEventAttributes? = nil, startTimerFailedEventAttributes: StartTimerFailedEventAttributes? = nil, startChildWorkflowExecutionFailedEventAttributes: StartChildWorkflowExecutionFailedEventAttributes? = nil, workflowExecutionCancelRequestedEventAttributes: WorkflowExecutionCancelRequestedEventAttributes? = nil, startLambdaFunctionFailedEventAttributes: StartLambdaFunctionFailedEventAttributes? = nil, lambdaFunctionCompletedEventAttributes: LambdaFunctionCompletedEventAttributes? = nil, childWorkflowExecutionTimedOutEventAttributes: ChildWorkflowExecutionTimedOutEventAttributes? = nil, requestCancelExternalWorkflowExecutionFailedEventAttributes: RequestCancelExternalWorkflowExecutionFailedEventAttributes? = nil, activityTaskCanceledEventAttributes: ActivityTaskCanceledEventAttributes? = nil, eventType: EventType, workflowExecutionStartedEventAttributes: WorkflowExecutionStartedEventAttributes? = nil, workflowExecutionContinuedAsNewEventAttributes: WorkflowExecutionContinuedAsNewEventAttributes? = nil, eventId: Int64, workflowExecutionCompletedEventAttributes: WorkflowExecutionCompletedEventAttributes? = nil, activityTaskCancelRequestedEventAttributes: ActivityTaskCancelRequestedEventAttributes? = nil, requestCancelActivityTaskFailedEventAttributes: RequestCancelActivityTaskFailedEventAttributes? = nil, childWorkflowExecutionCompletedEventAttributes: ChildWorkflowExecutionCompletedEventAttributes? = nil, childWorkflowExecutionFailedEventAttributes: ChildWorkflowExecutionFailedEventAttributes? = nil, markerRecordedEventAttributes: MarkerRecordedEventAttributes? = nil, decisionTaskTimedOutEventAttributes: DecisionTaskTimedOutEventAttributes? = nil, workflowExecutionCanceledEventAttributes: WorkflowExecutionCanceledEventAttributes? = nil, requestCancelExternalWorkflowExecutionInitiatedEventAttributes: RequestCancelExternalWorkflowExecutionInitiatedEventAttributes? = nil, lambdaFunctionStartedEventAttributes: LambdaFunctionStartedEventAttributes? = nil, recordMarkerFailedEventAttributes: RecordMarkerFailedEventAttributes? = nil, activityTaskScheduledEventAttributes: ActivityTaskScheduledEventAttributes? = nil, startChildWorkflowExecutionInitiatedEventAttributes: StartChildWorkflowExecutionInitiatedEventAttributes? = nil, childWorkflowExecutionStartedEventAttributes: ChildWorkflowExecutionStartedEventAttributes? = nil, activityTaskStartedEventAttributes: ActivityTaskStartedEventAttributes? = nil, decisionTaskCompletedEventAttributes: DecisionTaskCompletedEventAttributes? = nil, childWorkflowExecutionCanceledEventAttributes: ChildWorkflowExecutionCanceledEventAttributes? = nil, lambdaFunctionTimedOutEventAttributes: LambdaFunctionTimedOutEventAttributes? = nil, externalWorkflowExecutionSignaledEventAttributes: ExternalWorkflowExecutionSignaledEventAttributes? = nil, signalExternalWorkflowExecutionFailedEventAttributes: SignalExternalWorkflowExecutionFailedEventAttributes? = nil, failWorkflowExecutionFailedEventAttributes: FailWorkflowExecutionFailedEventAttributes? = nil, timerFiredEventAttributes: TimerFiredEventAttributes? = nil, decisionTaskStartedEventAttributes: DecisionTaskStartedEventAttributes? = nil, activityTaskFailedEventAttributes: ActivityTaskFailedEventAttributes? = nil, lambdaFunctionFailedEventAttributes: LambdaFunctionFailedEventAttributes? = nil, signalExternalWorkflowExecutionInitiatedEventAttributes: SignalExternalWorkflowExecutionInitiatedEventAttributes? = nil, timerCanceledEventAttributes: TimerCanceledEventAttributes? = nil, workflowExecutionTimedOutEventAttributes: WorkflowExecutionTimedOutEventAttributes? = nil, scheduleActivityTaskFailedEventAttributes: ScheduleActivityTaskFailedEventAttributes? = nil, externalWorkflowExecutionCancelRequestedEventAttributes: ExternalWorkflowExecutionCancelRequestedEventAttributes? = nil, eventTimestamp: TimeStamp, activityTaskTimedOutEventAttributes: ActivityTaskTimedOutEventAttributes? = nil, cancelTimerFailedEventAttributes: CancelTimerFailedEventAttributes? = nil, continueAsNewWorkflowExecutionFailedEventAttributes: ContinueAsNewWorkflowExecutionFailedEventAttributes? = nil, scheduleLambdaFunctionFailedEventAttributes: ScheduleLambdaFunctionFailedEventAttributes? = nil, decisionTaskScheduledEventAttributes: DecisionTaskScheduledEventAttributes? = nil, lambdaFunctionScheduledEventAttributes: LambdaFunctionScheduledEventAttributes? = nil, childWorkflowExecutionTerminatedEventAttributes: ChildWorkflowExecutionTerminatedEventAttributes? = nil, activityTaskCompletedEventAttributes: ActivityTaskCompletedEventAttributes? = nil) {
    ...
    public struct Decision: AWSShape {
        ...
        public init(cancelTimerDecisionAttributes: CancelTimerDecisionAttributes? = nil, startChildWorkflowExecutionDecisionAttributes: StartChildWorkflowExecutionDecisionAttributes? = nil, failWorkflowExecutionDecisionAttributes: FailWorkflowExecutionDecisionAttributes? = nil, cancelWorkflowExecutionDecisionAttributes: CancelWorkflowExecutionDecisionAttributes? = nil, recordMarkerDecisionAttributes: RecordMarkerDecisionAttributes? = nil, startTimerDecisionAttributes: StartTimerDecisionAttributes? = nil, scheduleLambdaFunctionDecisionAttributes: ScheduleLambdaFunctionDecisionAttributes? = nil, requestCancelExternalWorkflowExecutionDecisionAttributes: RequestCancelExternalWorkflowExecutionDecisionAttributes? = nil, continueAsNewWorkflowExecutionDecisionAttributes: ContinueAsNewWorkflowExecutionDecisionAttributes? = nil, signalExternalWorkflowExecutionDecisionAttributes: SignalExternalWorkflowExecutionDecisionAttributes? = nil, completeWorkflowExecutionDecisionAttributes: CompleteWorkflowExecutionDecisionAttributes? = nil, scheduleActivityTaskDecisionAttributes: ScheduleActivityTaskDecisionAttributes? = nil, decisionType: DecisionType, requestCancelActivityTaskDecisionAttributes: RequestCancelActivityTaskDecisionAttributes? = nil) {
    ...
    public struct WorkflowTypeInfo: AWSShape {
        ...
        public init(creationDate: TimeStamp, description: String? = nil, workflowType: WorkflowType, deprecationDate: TimeStamp? = nil, status: RegistrationStatus) {
    ...
    public struct SignalExternalWorkflowExecutionInitiatedEventAttributes: AWSShape {
        ...
        public init(runId: String? = nil, control: String? = nil, decisionTaskCompletedEventId: Int64, signalName: String, workflowId: String, input: String? = nil) {
            self.runId = runId
            self.control = control
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.signalName = signalName
    ...
    public struct RequestCancelExternalWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(decisionTaskCompletedEventId: Int64, control: String? = nil, workflowId: String, runId: String? = nil, cause: RequestCancelExternalWorkflowExecutionFailedCause, initiatedEventId: Int64) {
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.control = control
            self.workflowId = workflowId
            self.runId = runId
    ...
    public struct CountOpenWorkflowExecutionsInput: AWSShape {
        ...
        public init(executionFilter: WorkflowExecutionFilter? = nil, tagFilter: TagFilter? = nil, domain: String, startTimeFilter: ExecutionTimeFilter, typeFilter: WorkflowTypeFilter? = nil) {
            self.executionFilter = executionFilter
            self.tagFilter = tagFilter
            self.domain = domain
            self.startTimeFilter = startTimeFilter
    ...
    public struct SignalExternalWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(signalName: String, control: String? = nil, runId: String? = nil, input: String? = nil, workflowId: String) {
            self.signalName = signalName
            self.control = control
            self.runId = runId
            self.input = input
    ...
    public struct ChildWorkflowExecutionTimedOutEventAttributes: AWSShape {
        ...
        public init(timeoutType: WorkflowExecutionTimeoutType, startedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType, initiatedEventId: Int64) {
            self.timeoutType = timeoutType
            self.startedEventId = startedEventId
            self.workflowExecution = workflowExecution
            self.workflowType = workflowType
    ...
    public struct ScheduleLambdaFunctionDecisionAttributes: AWSShape {
        ...
        public init(input: String? = nil, id: String, control: String? = nil, startToCloseTimeout: String? = nil, name: String) {
            self.input = input
            self.id = id
            self.control = control
            self.startToCloseTimeout = startToCloseTimeout
    ...
    public struct ContinueAsNewWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(childPolicy: ChildPolicy? = nil, taskPriority: String? = nil, workflowTypeVersion: String? = nil, taskList: TaskList? = nil, tagList: [String]? = nil, input: String? = nil, executionStartToCloseTimeout: String? = nil, taskStartToCloseTimeout: String? = nil, lambdaRole: String? = nil) {
            self.childPolicy = childPolicy
            self.taskPriority = taskPriority
    ...
    public struct ChildWorkflowExecutionTerminatedEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, initiatedEventId: Int64, workflowType: WorkflowType, workflowExecution: WorkflowExecution) {
            self.startedEventId = startedEventId
            self.initiatedEventId = initiatedEventId
            self.workflowType = workflowType
            self.workflowExecution = workflowExecution
    ...
    public struct RegisterWorkflowTypeInput: AWSShape {
        ...
        public init(description: String? = nil, defaultChildPolicy: ChildPolicy? = nil, defaultTaskPriority: String? = nil, version: String, defaultLambdaRole: String? = nil, defaultExecutionStartToCloseTimeout: String? = nil, defaultTaskList: TaskList? = nil, name: String, domain: String, defaultTaskStartToCloseTimeout: String? = nil) {
            self.description = description
            self.defaultChildPolicy = defaultChildPolicy
            self.defaultTaskPriority = defaultTaskPriority
            self.version = version
    ...
    public struct ListWorkflowTypesInput: AWSShape {
        ...
        public init(registrationStatus: RegistrationStatus, name: String? = nil, domain: String, reverseOrder: Bool? = nil, nextPageToken: String? = nil, maximumPageSize: Int32? = nil) {
            self.registrationStatus = registrationStatus
            self.name = name
            self.domain = domain
            self.reverseOrder = reverseOrder
    ...
    public struct StartWorkflowExecutionInput: AWSShape {
        ...
        public init(taskStartToCloseTimeout: String? = nil, domain: String, executionStartToCloseTimeout: String? = nil, input: String? = nil, childPolicy: ChildPolicy? = nil, lambdaRole: String? = nil, taskPriority: String? = nil, tagList: [String]? = nil, workflowId: String, taskList: TaskList? = nil, workflowType: WorkflowType) {
            self.taskStartToCloseTimeout = taskStartToCloseTimeout
            self.domain = domain
            self.executionStartToCloseTimeout = executionStartToCloseTimeout
            self.input = input
    ...
    public struct WorkflowExecutionStartedEventAttributes: AWSShape {
        ...
        public init(input: String? = nil, parentWorkflowExecution: WorkflowExecution? = nil, taskPriority: String? = nil, tagList: [String]? = nil, continuedExecutionRunId: String? = nil, lambdaRole: String? = nil, parentInitiatedEventId: Int64? = nil, childPolicy: ChildPolicy, workflowType: WorkflowType, taskStartToCloseTimeout: String? = nil, executionStartToCloseTimeout: String? = nil, taskList: TaskList) {
            self.input = input
    ...
    public struct ActivityTaskScheduledEventAttributes: AWSShape {
        ...
        public init(activityId: String, input: String? = nil, scheduleToCloseTimeout: String? = nil, decisionTaskCompletedEventId: Int64, control: String? = nil, heartbeatTimeout: String? = nil, activityType: ActivityType, taskPriority: String? = nil, startToCloseTimeout: String? = nil, taskList: TaskList, scheduleToStartTimeout: String? = nil) {
            self.activityId = activityId
            self.input = input
            self.scheduleToCloseTimeout = scheduleToCloseTimeout
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
    ...
    public struct WorkflowExecutionInfo: AWSShape {
        ...
        public init(executionStatus: ExecutionStatus, workflowType: WorkflowType, execution: WorkflowExecution, closeStatus: CloseStatus? = nil, parent: WorkflowExecution? = nil, cancelRequested: Bool? = nil, closeTimestamp: TimeStamp? = nil, startTimestamp: TimeStamp, tagList: [String]? = nil) {
    ...
    public struct ActivityTypeInfo: AWSShape {
        ...
        public init(deprecationDate: TimeStamp? = nil, status: RegistrationStatus, description: String? = nil, creationDate: TimeStamp, activityType: ActivityType) {
            self.deprecationDate = deprecationDate
            self.status = status
            self.description = description
            self.creationDate = creationDate
    ...
    public struct GetWorkflowExecutionHistoryInput: AWSShape {
        ...
        public init(execution: WorkflowExecution, maximumPageSize: Int32? = nil, reverseOrder: Bool? = nil, nextPageToken: String? = nil, domain: String) {
            self.execution = execution
            self.maximumPageSize = maximumPageSize
            self.reverseOrder = reverseOrder
            self.nextPageToken = nextPageToken
