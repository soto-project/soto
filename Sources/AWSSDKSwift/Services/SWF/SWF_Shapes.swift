...
extension SWF {
    ...
    public struct StartChildWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(control: String? = nil, cause: StartChildWorkflowExecutionFailedCause, decisionTaskCompletedEventId: Int64, initiatedEventId: Int64, workflowId: String, workflowType: WorkflowType) {
    ...
    public struct WorkflowExecutionOpenCounts: AWSShape {
        ...
        public init(openLambdaFunctions: Int32? = nil, openDecisionTasks: Int32, openActivityTasks: Int32, openTimers: Int32, openChildWorkflowExecutions: Int32) {
    ...
    public struct StartChildWorkflowExecutionInitiatedEventAttributes: AWSShape {
        ...
        public init(taskPriority: String? = nil, decisionTaskCompletedEventId: Int64, lambdaRole: String? = nil, childPolicy: ChildPolicy, workflowId: String, taskStartToCloseTimeout: String? = nil, tagList: [String]? = nil, workflowType: WorkflowType, input: String? = nil, control: String? = nil, taskList: TaskList, executionStartToCloseTimeout: String? = nil) {
    ...
    public struct StartWorkflowExecutionInput: AWSShape {
        ...
        public init(taskPriority: String? = nil, workflowId: String, lambdaRole: String? = nil, domain: String, input: String? = nil, tagList: [String]? = nil, childPolicy: ChildPolicy? = nil, workflowType: WorkflowType, taskStartToCloseTimeout: String? = nil, taskList: TaskList? = nil, executionStartToCloseTimeout: String? = nil) {
            self.taskPriority = taskPriority
            self.workflowId = workflowId
            self.lambdaRole = lambdaRole
            self.domain = domain
    ...
    public struct WorkflowExecutionDetail: AWSShape {
        ...
        public init(executionConfiguration: WorkflowExecutionConfiguration, openCounts: WorkflowExecutionOpenCounts, latestExecutionContext: String? = nil, executionInfo: WorkflowExecutionInfo, latestActivityTaskTimestamp: TimeStamp? = nil) {
    ...
    public struct ChildWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, reason: String? = nil, details: String? = nil, initiatedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType) {
            self.startedEventId = startedEventId
            self.reason = reason
    ...
    public struct ListWorkflowTypesInput: AWSShape {
        ...
        public init(maximumPageSize: Int32? = nil, domain: String, nextPageToken: String? = nil, reverseOrder: Bool? = nil, name: String? = nil, registrationStatus: RegistrationStatus) {
    ...
    public struct SignalExternalWorkflowExecutionInitiatedEventAttributes: AWSShape {
        ...
        public init(control: String? = nil, decisionTaskCompletedEventId: Int64, signalName: String, runId: String? = nil, workflowId: String, input: String? = nil) {
            self.control = control
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
    ...
    public struct ChildWorkflowExecutionTimedOutEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, initiatedEventId: Int64, workflowExecution: WorkflowExecution, timeoutType: WorkflowExecutionTimeoutType, workflowType: WorkflowType) {
            self.startedEventId = startedEventId
            self.initiatedEventId = initiatedEventId
            self.workflowExecution = workflowExecution
    ...
    public struct StartChildWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(taskPriority: String? = nil, workflowId: String, lambdaRole: String? = nil, childPolicy: ChildPolicy? = nil, input: String? = nil, tagList: [String]? = nil, taskStartToCloseTimeout: String? = nil, workflowType: WorkflowType, control: String? = nil, taskList: TaskList? = nil, executionStartToCloseTimeout: String? = nil) {
            self.taskPriority = taskPriority
            self.workflowId = workflowId
            self.lambdaRole = lambdaRole
            self.childPolicy = childPolicy
    ...
    public struct ChildWorkflowExecutionCanceledEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, details: String? = nil, initiatedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType) {
            self.startedEventId = startedEventId
            self.details = details
            self.initiatedEventId = initiatedEventId
            self.workflowExecution = workflowExecution
    ...
    public struct ActivityTypeInfo: AWSShape {
        ...
        public init(description: String? = nil, status: RegistrationStatus, activityType: ActivityType, deprecationDate: TimeStamp? = nil, creationDate: TimeStamp) {
            self.description = description
            self.status = status
            self.activityType = activityType
    ...
    public struct TerminateWorkflowExecutionInput: AWSShape {
        ...
        public init(details: String? = nil, reason: String? = nil, domain: String, childPolicy: ChildPolicy? = nil, runId: String? = nil, workflowId: String) {
            self.details = details
            self.reason = reason
            self.domain = domain
            self.childPolicy = childPolicy
    ...
    public struct PollForDecisionTaskInput: AWSShape {
        ...
        public init(domain: String, maximumPageSize: Int32? = nil, identity: String? = nil, reverseOrder: Bool? = nil, taskList: TaskList, nextPageToken: String? = nil) {
            self.domain = domain
            self.maximumPageSize = maximumPageSize
    ...
    public struct CountClosedWorkflowExecutionsInput: AWSShape {
        ...
        public init(executionFilter: WorkflowExecutionFilter? = nil, domain: String, startTimeFilter: ExecutionTimeFilter? = nil, tagFilter: TagFilter? = nil, typeFilter: WorkflowTypeFilter? = nil, closeTimeFilter: ExecutionTimeFilter? = nil, closeStatusFilter: CloseStatusFilter? = nil) {
    ...
    public struct ChildWorkflowExecutionTerminatedEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, initiatedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType) {
            self.startedEventId = startedEventId
            self.initiatedEventId = initiatedEventId
            self.workflowExecution = workflowExecution
            self.workflowType = workflowType
    ...
    public struct ActivityTask: AWSShape {
        ...
        public init(startedEventId: Int64, activityId: String, activityType: ActivityType, taskToken: String, workflowExecution: WorkflowExecution, input: String? = nil) {
            self.startedEventId = startedEventId
    ...
    public struct ListClosedWorkflowExecutionsInput: AWSShape {
        ...
        public init(closeStatusFilter: CloseStatusFilter? = nil, maximumPageSize: Int32? = nil, executionFilter: WorkflowExecutionFilter? = nil, domain: String, startTimeFilter: ExecutionTimeFilter? = nil, tagFilter: TagFilter? = nil, nextPageToken: String? = nil, typeFilter: WorkflowTypeFilter? = nil, closeTimeFilter: ExecutionTimeFilter? = nil, reverseOrder: Bool? = nil) {
            self.closeStatusFilter = closeStatusFilter
            self.maximumPageSize = maximumPageSize
            self.executionFilter = executionFilter
            self.domain = domain
    ...
    public struct ListOpenWorkflowExecutionsInput: AWSShape {
        ...
        public init(maximumPageSize: Int32? = nil, executionFilter: WorkflowExecutionFilter? = nil, domain: String, startTimeFilter: ExecutionTimeFilter, tagFilter: TagFilter? = nil, nextPageToken: String? = nil, typeFilter: WorkflowTypeFilter? = nil, reverseOrder: Bool? = nil) {
            self.maximumPageSize = maximumPageSize
            self.executionFilter = executionFilter
            self.domain = domain
            self.startTimeFilter = startTimeFilter
    ...
    public struct ScheduleActivityTaskFailedEventAttributes: AWSShape {
        ...
        public init(cause: ScheduleActivityTaskFailedCause, decisionTaskCompletedEventId: Int64, activityType: ActivityType, activityId: String) {
            self.cause = cause
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.activityType = activityType
            self.activityId = activityId
    ...
    public struct WorkflowExecutionStartedEventAttributes: AWSShape {
        ...
        public init(taskPriority: String? = nil, lambdaRole: String? = nil, childPolicy: ChildPolicy, input: String? = nil, taskStartToCloseTimeout: String? = nil, tagList: [String]? = nil, workflowType: WorkflowType, parentInitiatedEventId: Int64? = nil, parentWorkflowExecution: WorkflowExecution? = nil, continuedExecutionRunId: String? = nil, taskList: TaskList, executionStartToCloseTimeout: String? = nil) {
            self.taskPriority = taskPriority
            self.lambdaRole = lambdaRole
            self.childPolicy = childPolicy
            self.input = input
    ...
    public struct SignalExternalWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(cause: SignalExternalWorkflowExecutionFailedCause, decisionTaskCompletedEventId: Int64, control: String? = nil, initiatedEventId: Int64, runId: String? = nil, workflowId: String) {
            self.cause = cause
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.control = control
            self.initiatedEventId = initiatedEventId
    ...
    public struct RespondActivityTaskFailedInput: AWSShape {
        ...
        public init(reason: String? = nil, details: String? = nil, taskToken: String) {
            self.reason = reason
            self.details = details
            self.taskToken = taskToken
        }
    ...
    public struct DecisionTaskScheduledEventAttributes: AWSShape {
        ...
        public init(taskList: TaskList, startToCloseTimeout: String? = nil, taskPriority: String? = nil) {
            self.taskList = taskList
    ...
    public struct HistoryEvent: AWSShape {
        ...
        public init(workflowExecutionTerminatedEventAttributes: WorkflowExecutionTerminatedEventAttributes? = nil, activityTaskFailedEventAttributes: ActivityTaskFailedEventAttributes? = nil, eventType: EventType, startChildWorkflowExecutionFailedEventAttributes: StartChildWorkflowExecutionFailedEventAttributes? = nil, activityTaskScheduledEventAttributes: ActivityTaskScheduledEventAttributes? = nil, cancelWorkflowExecutionFailedEventAttributes: CancelWorkflowExecutionFailedEventAttributes? = nil, eventTimestamp: TimeStamp, activityTaskCancelRequestedEventAttributes: ActivityTaskCancelRequestedEventAttributes? = nil, cancelTimerFailedEventAttributes: CancelTimerFailedEventAttributes? = nil, decisionTaskTimedOutEventAttributes: DecisionTaskTimedOutEventAttributes? = nil, startChildWorkflowExecutionInitiatedEventAttributes: StartChildWorkflowExecutionInitiatedEventAttributes? = nil, signalExternalWorkflowExecutionInitiatedEventAttributes: SignalExternalWorkflowExecutionInitiatedEventAttributes? = nil, timerCanceledEventAttributes: TimerCanceledEventAttributes? = nil, requestCancelActivityTaskFailedEventAttributes: RequestCancelActivityTaskFailedEventAttributes? = nil, lambdaFunctionScheduledEventAttributes: LambdaFunctionScheduledEventAttributes? = nil, failWorkflowExecutionFailedEventAttributes: FailWorkflowExecutionFailedEventAttributes? = nil, activityTaskCompletedEventAttributes: ActivityTaskCompletedEventAttributes? = nil, signalExternalWorkflowExecutionFailedEventAttributes: SignalExternalWorkflowExecutionFailedEventAttributes? = nil, startTimerFailedEventAttributes: StartTimerFailedEventAttributes? = nil, workflowExecutionContinuedAsNewEventAttributes: WorkflowExecutionContinuedAsNewEventAttributes? = nil, recordMarkerFailedEventAttributes: RecordMarkerFailedEventAttributes? = nil, timerStartedEventAttributes: TimerStartedEventAttributes? = nil, lambdaFunctionCompletedEventAttributes: LambdaFunctionCompletedEventAttributes? = nil, activityTaskCanceledEventAttributes: ActivityTaskCanceledEventAttributes? = nil, workflowExecutionTimedOutEventAttributes: WorkflowExecutionTimedOutEventAttributes? = nil, activityTaskStartedEventAttributes: ActivityTaskStartedEventAttributes? = nil, lambdaFunctionFailedEventAttributes: LambdaFunctionFailedEventAttributes? = nil, eventId: Int64, activityTaskTimedOutEventAttributes: ActivityTaskTimedOutEventAttributes? = nil, externalWorkflowExecutionSignaledEventAttributes: ExternalWorkflowExecutionSignaledEventAttributes? = nil, workflowExecutionCancelRequestedEventAttributes: WorkflowExecutionCancelRequestedEventAttributes? = nil, workflowExecutionSignaledEventAttributes: WorkflowExecutionSignaledEventAttributes? = nil, timerFiredEventAttributes: TimerFiredEventAttributes? = nil, completeWorkflowExecutionFailedEventAttributes: CompleteWorkflowExecutionFailedEventAttributes? = nil, childWorkflowExecutionTerminatedEventAttributes: ChildWorkflowExecutionTerminatedEventAttributes? = nil, externalWorkflowExecutionCancelRequestedEventAttributes: ExternalWorkflowExecutionCancelRequestedEventAttributes? = nil, childWorkflowExecutionStartedEventAttributes: ChildWorkflowExecutionStartedEventAttributes? = nil, lambdaFunctionStartedEventAttributes: LambdaFunctionStartedEventAttributes? = nil, workflowExecutionCanceledEventAttributes: WorkflowExecutionCanceledEventAttributes? = nil, markerRecordedEventAttributes: MarkerRecordedEventAttributes? = nil, workflowExecutionCompletedEventAttributes: WorkflowExecutionCompletedEventAttributes? = nil, decisionTaskCompletedEventAttributes: DecisionTaskCompletedEventAttributes? = nil, requestCancelExternalWorkflowExecutionFailedEventAttributes: RequestCancelExternalWorkflowExecutionFailedEventAttributes? = nil, decisionTaskScheduledEventAttributes: DecisionTaskScheduledEventAttributes? = nil, scheduleLambdaFunctionFailedEventAttributes: ScheduleLambdaFunctionFailedEventAttributes? = nil, childWorkflowExecutionCanceledEventAttributes: ChildWorkflowExecutionCanceledEventAttributes? = nil, decisionTaskStartedEventAttributes: DecisionTaskStartedEventAttributes? = nil, childWorkflowExecutionTimedOutEventAttributes: ChildWorkflowExecutionTimedOutEventAttributes? = nil, requestCancelExternalWorkflowExecutionInitiatedEventAttributes: RequestCancelExternalWorkflowExecutionInitiatedEventAttributes? = nil, scheduleActivityTaskFailedEventAttributes: ScheduleActivityTaskFailedEventAttributes? = nil, childWorkflowExecutionFailedEventAttributes: ChildWorkflowExecutionFailedEventAttributes? = nil, lambdaFunctionTimedOutEventAttributes: LambdaFunctionTimedOutEventAttributes? = nil, workflowExecutionFailedEventAttributes: WorkflowExecutionFailedEventAttributes? = nil, continueAsNewWorkflowExecutionFailedEventAttributes: ContinueAsNewWorkflowExecutionFailedEventAttributes? = nil, startLambdaFunctionFailedEventAttributes: StartLambdaFunctionFailedEventAttributes? = nil, childWorkflowExecutionCompletedEventAttributes: ChildWorkflowExecutionCompletedEventAttributes? = nil, workflowExecutionStartedEventAttributes: WorkflowExecutionStartedEventAttributes? = nil) {
    ...
    public struct LambdaFunctionScheduledEventAttributes: AWSShape {
        ...
        public init(control: String? = nil, decisionTaskCompletedEventId: Int64, name: String, id: String, input: String? = nil, startToCloseTimeout: String? = nil) {
            self.control = control
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.name = name
            self.id = id
    ...
    public struct Decision: AWSShape {
        ...
        public init(requestCancelExternalWorkflowExecutionDecisionAttributes: RequestCancelExternalWorkflowExecutionDecisionAttributes? = nil, signalExternalWorkflowExecutionDecisionAttributes: SignalExternalWorkflowExecutionDecisionAttributes? = nil, continueAsNewWorkflowExecutionDecisionAttributes: ContinueAsNewWorkflowExecutionDecisionAttributes? = nil, startTimerDecisionAttributes: StartTimerDecisionAttributes? = nil, requestCancelActivityTaskDecisionAttributes: RequestCancelActivityTaskDecisionAttributes? = nil, cancelWorkflowExecutionDecisionAttributes: CancelWorkflowExecutionDecisionAttributes? = nil, recordMarkerDecisionAttributes: RecordMarkerDecisionAttributes? = nil, completeWorkflowExecutionDecisionAttributes: CompleteWorkflowExecutionDecisionAttributes? = nil, failWorkflowExecutionDecisionAttributes: FailWorkflowExecutionDecisionAttributes? = nil, startChildWorkflowExecutionDecisionAttributes: StartChildWorkflowExecutionDecisionAttributes? = nil, scheduleActivityTaskDecisionAttributes: ScheduleActivityTaskDecisionAttributes? = nil, cancelTimerDecisionAttributes: CancelTimerDecisionAttributes? = nil, scheduleLambdaFunctionDecisionAttributes: ScheduleLambdaFunctionDecisionAttributes? = nil, decisionType: DecisionType) {
    ...
    public struct SignalWorkflowExecutionInput: AWSShape {
        ...
        public init(domain: String, signalName: String, runId: String? = nil, workflowId: String, input: String? = nil) {
            self.domain = domain
            self.signalName = signalName
            self.runId = runId
            self.workflowId = workflowId
    ...
    public struct ChildWorkflowExecutionCompletedEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, result: String? = nil, initiatedEventId: Int64, workflowExecution: WorkflowExecution, workflowType: WorkflowType) {
            self.startedEventId = startedEventId
            self.result = result
            self.initiatedEventId = initiatedEventId
            self.workflowExecution = workflowExecution
    ...
    public struct WorkflowExecutionContinuedAsNewEventAttributes: AWSShape {
        ...
        public init(taskPriority: String? = nil, decisionTaskCompletedEventId: Int64, lambdaRole: String? = nil, childPolicy: ChildPolicy, input: String? = nil, tagList: [String]? = nil, newExecutionRunId: String, workflowType: WorkflowType, taskStartToCloseTimeout: String? = nil, taskList: TaskList, executionStartToCloseTimeout: String? = nil) {
            self.taskPriority = taskPriority
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.lambdaRole = lambdaRole
            self.childPolicy = childPolicy
    ...
    public struct SignalExternalWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(control: String? = nil, signalName: String, runId: String? = nil, workflowId: String, input: String? = nil) {
            self.control = control
            self.signalName = signalName
            self.runId = runId
            self.workflowId = workflowId
    ...
    public struct RegisterActivityTypeInput: AWSShape {
        ...
        public init(domain: String, defaultTaskHeartbeatTimeout: String? = nil, defaultTaskScheduleToCloseTimeout: String? = nil, version: String, defaultTaskList: TaskList? = nil, name: String, defaultTaskPriority: String? = nil, defaultTaskScheduleToStartTimeout: String? = nil, description: String? = nil, defaultTaskStartToCloseTimeout: String? = nil) {
            self.domain = domain
    ...
    public struct TimerStartedEventAttributes: AWSShape {
        ...
        public init(control: String? = nil, startToFireTimeout: String, decisionTaskCompletedEventId: Int64, timerId: String) {
            self.control = control
            self.startToFireTimeout = startToFireTimeout
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.timerId = timerId
    ...
    public struct ActivityTypeConfiguration: AWSShape {
        ...
        public init(defaultTaskHeartbeatTimeout: String? = nil, defaultTaskScheduleToStartTimeout: String? = nil, defaultTaskScheduleToCloseTimeout: String? = nil, defaultTaskList: TaskList? = nil, defaultTaskPriority: String? = nil, defaultTaskStartToCloseTimeout: String? = nil) {
            self.defaultTaskHeartbeatTimeout = defaultTaskHeartbeatTimeout
            self.defaultTaskScheduleToStartTimeout = defaultTaskScheduleToStartTimeout
            self.defaultTaskScheduleToCloseTimeout = defaultTaskScheduleToCloseTimeout
            self.defaultTaskList = defaultTaskList
    ...
    public struct WorkflowExecutionConfiguration: AWSShape {
        ...
        public init(taskPriority: String? = nil, childPolicy: ChildPolicy, taskStartToCloseTimeout: String, lambdaRole: String? = nil, executionStartToCloseTimeout: String, taskList: TaskList) {
            self.taskPriority = taskPriority
            self.childPolicy = childPolicy
            self.taskStartToCloseTimeout = taskStartToCloseTimeout
            self.lambdaRole = lambdaRole
    ...
    public struct RecordMarkerFailedEventAttributes: AWSShape {
        ...
        public init(decisionTaskCompletedEventId: Int64, cause: RecordMarkerFailedCause, markerName: String) {
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.cause = cause
            self.markerName = markerName
        }
    ...
    public struct WorkflowExecutionInfo: AWSShape {
        ...
        public init(startTimestamp: TimeStamp, closeStatus: CloseStatus? = nil, execution: WorkflowExecution, closeTimestamp: TimeStamp? = nil, tagList: [String]? = nil, workflowType: WorkflowType, executionStatus: ExecutionStatus, parent: WorkflowExecution? = nil, cancelRequested: Bool? = nil) {
    ...
    public struct ScheduleLambdaFunctionDecisionAttributes: AWSShape {
        ...
        public init(control: String? = nil, id: String, name: String, input: String? = nil, startToCloseTimeout: String? = nil) {
            self.control = control
            self.id = id
            self.name = name
            self.input = input
    ...
    public struct ListDomainsInput: AWSShape {
        ...
        public init(nextPageToken: String? = nil, maximumPageSize: Int32? = nil, reverseOrder: Bool? = nil, registrationStatus: RegistrationStatus) {
            self.nextPageToken = nextPageToken
            self.maximumPageSize = maximumPageSize
            self.reverseOrder = reverseOrder
            self.registrationStatus = registrationStatus
    ...
    public struct DecisionTask: AWSShape {
        ...
        public init(events: [HistoryEvent], startedEventId: Int64, workflowType: WorkflowType, nextPageToken: String? = nil, workflowExecution: WorkflowExecution, taskToken: String, previousStartedEventId: Int64? = nil) {
            self.events = events
            self.startedEventId = startedEventId
            self.workflowType = workflowType
            self.nextPageToken = nextPageToken
    ...
    public struct CancelTimerFailedEventAttributes: AWSShape {
        ...
        public init(timerId: String, cause: CancelTimerFailedCause, decisionTaskCompletedEventId: Int64) {
            self.timerId = timerId
            self.cause = cause
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
        }
    ...
    public struct ActivityTaskScheduledEventAttributes: AWSShape {
        ...
        public init(decisionTaskCompletedEventId: Int64, taskPriority: String? = nil, scheduleToStartTimeout: String? = nil, input: String? = nil, activityId: String, scheduleToCloseTimeout: String? = nil, heartbeatTimeout: String? = nil, activityType: ActivityType, startToCloseTimeout: String? = nil, taskList: TaskList, control: String? = nil) {
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.taskPriority = taskPriority
    ...
    public struct WorkflowTypeConfiguration: AWSShape {
        ...
        public init(defaultExecutionStartToCloseTimeout: String? = nil, defaultLambdaRole: String? = nil, defaultChildPolicy: ChildPolicy? = nil, defaultTaskList: TaskList? = nil, defaultTaskPriority: String? = nil, defaultTaskStartToCloseTimeout: String? = nil) {
    ...
    public struct ActivityTaskCanceledEventAttributes: AWSShape {
        ...
        public init(startedEventId: Int64, details: String? = nil, latestCancelRequestedEventId: Int64? = nil, scheduledEventId: Int64) {
            self.startedEventId = startedEventId
            self.details = details
    ...
    public struct CountOpenWorkflowExecutionsInput: AWSShape {
        ...
        public init(tagFilter: TagFilter? = nil, domain: String, typeFilter: WorkflowTypeFilter? = nil, executionFilter: WorkflowExecutionFilter? = nil, startTimeFilter: ExecutionTimeFilter) {
            self.tagFilter = tagFilter
            self.domain = domain
            self.typeFilter = typeFilter
            self.executionFilter = executionFilter
    ...
    public struct ScheduleActivityTaskDecisionAttributes: AWSShape {
        ...
        public init(taskPriority: String? = nil, scheduleToStartTimeout: String? = nil, input: String? = nil, activityId: String, scheduleToCloseTimeout: String? = nil, heartbeatTimeout: String? = nil, activityType: ActivityType, startToCloseTimeout: String? = nil, taskList: TaskList? = nil, control: String? = nil) {
            self.taskPriority = taskPriority
            self.scheduleToStartTimeout = scheduleToStartTimeout
            self.input = input
            self.activityId = activityId
    ...
    public struct GetWorkflowExecutionHistoryInput: AWSShape {
        ...
        public init(domain: String, maximumPageSize: Int32? = nil, execution: WorkflowExecution, nextPageToken: String? = nil, reverseOrder: Bool? = nil) {
            self.domain = domain
            self.maximumPageSize = maximumPageSize
            self.execution = execution
            self.nextPageToken = nextPageToken
    ...
    public struct WorkflowTypeInfo: AWSShape {
        ...
        public init(description: String? = nil, status: RegistrationStatus, deprecationDate: TimeStamp? = nil, creationDate: TimeStamp, workflowType: WorkflowType) {
            self.description = description
            self.status = status
            self.deprecationDate = deprecationDate
            self.creationDate = creationDate
    ...
    public struct ContinueAsNewWorkflowExecutionDecisionAttributes: AWSShape {
        ...
        public init(taskPriority: String? = nil, lambdaRole: String? = nil, childPolicy: ChildPolicy? = nil, input: String? = nil, taskStartToCloseTimeout: String? = nil, tagList: [String]? = nil, taskList: TaskList? = nil, workflowTypeVersion: String? = nil, executionStartToCloseTimeout: String? = nil) {
            self.taskPriority = taskPriority
            self.lambdaRole = lambdaRole
            self.childPolicy = childPolicy
            self.input = input
    ...
    public struct RegisterWorkflowTypeInput: AWSShape {
        ...
        public init(defaultChildPolicy: ChildPolicy? = nil, defaultLambdaRole: String? = nil, domain: String, name: String, defaultTaskList: TaskList? = nil, version: String, defaultTaskPriority: String? = nil, description: String? = nil, defaultTaskStartToCloseTimeout: String? = nil, defaultExecutionStartToCloseTimeout: String? = nil) {
            self.defaultChildPolicy = defaultChildPolicy
            self.defaultLambdaRole = defaultLambdaRole
            self.domain = domain
            self.name = name
    ...
    public struct RequestCancelExternalWorkflowExecutionFailedEventAttributes: AWSShape {
        ...
        public init(cause: RequestCancelExternalWorkflowExecutionFailedCause, decisionTaskCompletedEventId: Int64, control: String? = nil, initiatedEventId: Int64, runId: String? = nil, workflowId: String) {
            self.cause = cause
            self.decisionTaskCompletedEventId = decisionTaskCompletedEventId
            self.control = control
            self.initiatedEventId = initiatedEventId
