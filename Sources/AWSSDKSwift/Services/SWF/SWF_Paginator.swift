...
extension SWF {
    ...
    public func getWorkflowExecutionHistoryPaginator(_ input: GetWorkflowExecutionHistoryInput, onPage: @escaping ([HistoryEvent], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getWorkflowExecutionHistory, resultKey: \History.events, tokenKey: \History.nextPageToken, onPage: onPage)
    }
    ...
    public func listActivityTypesPaginator(_ input: ListActivityTypesInput, onPage: @escaping ([ActivityTypeInfo], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listActivityTypes, resultKey: \ActivityTypeInfos.typeInfos, tokenKey: \ActivityTypeInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listClosedWorkflowExecutionsPaginator(_ input: ListClosedWorkflowExecutionsInput, onPage: @escaping ([WorkflowExecutionInfo], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listClosedWorkflowExecutions, resultKey: \WorkflowExecutionInfos.executionInfos, tokenKey: \WorkflowExecutionInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listDomainsPaginator(_ input: ListDomainsInput, onPage: @escaping ([DomainInfo], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listDomains, resultKey: \DomainInfos.domainInfos, tokenKey: \DomainInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listOpenWorkflowExecutionsPaginator(_ input: ListOpenWorkflowExecutionsInput, onPage: @escaping ([WorkflowExecutionInfo], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listOpenWorkflowExecutions, resultKey: \WorkflowExecutionInfos.executionInfos, tokenKey: \WorkflowExecutionInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listWorkflowTypesPaginator(_ input: ListWorkflowTypesInput, onPage: @escaping ([WorkflowTypeInfo], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listWorkflowTypes, resultKey: \WorkflowTypeInfos.typeInfos, tokenKey: \WorkflowTypeInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func pollForDecisionTaskPaginator(_ input: PollForDecisionTaskInput, onPage: @escaping ([HistoryEvent], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: pollForDecisionTask, resultKey: \DecisionTask.events, tokenKey: \DecisionTask.nextPageToken, onPage: onPage)
    }
