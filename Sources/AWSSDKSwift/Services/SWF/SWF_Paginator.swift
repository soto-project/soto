...
extension SWF {
    ...
    public func getWorkflowExecutionHistoryPaginator(_ input: GetWorkflowExecutionHistoryInput, onPage: @escaping (History, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getWorkflowExecutionHistory, tokenKey: \History.nextPageToken, onPage: onPage)
    }
    ...
    public func listActivityTypesPaginator(_ input: ListActivityTypesInput, onPage: @escaping (ActivityTypeInfos, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listActivityTypes, tokenKey: \ActivityTypeInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listClosedWorkflowExecutionsPaginator(_ input: ListClosedWorkflowExecutionsInput, onPage: @escaping (WorkflowExecutionInfos, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listClosedWorkflowExecutions, tokenKey: \WorkflowExecutionInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listDomainsPaginator(_ input: ListDomainsInput, onPage: @escaping (DomainInfos, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listDomains, tokenKey: \DomainInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listOpenWorkflowExecutionsPaginator(_ input: ListOpenWorkflowExecutionsInput, onPage: @escaping (WorkflowExecutionInfos, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listOpenWorkflowExecutions, tokenKey: \WorkflowExecutionInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func listWorkflowTypesPaginator(_ input: ListWorkflowTypesInput, onPage: @escaping (WorkflowTypeInfos, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listWorkflowTypes, tokenKey: \WorkflowTypeInfos.nextPageToken, onPage: onPage)
    }
    ...
    public func pollForDecisionTaskPaginator(_ input: PollForDecisionTaskInput, onPage: @escaping (DecisionTask, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: pollForDecisionTask, tokenKey: \DecisionTask.nextPageToken, onPage: onPage)
    }
