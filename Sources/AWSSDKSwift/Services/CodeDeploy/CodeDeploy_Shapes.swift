...
extension CodeDeploy {
    ...
    public struct CreateDeploymentConfigInput: AWSShape {
        ...
        public init(deploymentConfigName: String, minimumHealthyHosts: MinimumHealthyHosts? = nil, computePlatform: ComputePlatform? = nil, trafficRoutingConfig: TrafficRoutingConfig? = nil) {
    ...
    public struct InstanceInfo: AWSShape {
        ...
        public init(registerTime: TimeStamp? = nil, deregisterTime: TimeStamp? = nil, instanceArn: String? = nil, iamUserArn: String? = nil, instanceName: String? = nil, iamSessionArn: String? = nil, tags: [Tag]? = nil) {
    ...
    public struct ApplicationInfo: AWSShape {
        ...
        public init(gitHubAccountName: String? = nil, createTime: TimeStamp? = nil, applicationId: String? = nil, linkedToGitHub: Bool? = nil, computePlatform: ComputePlatform? = nil, applicationName: String? = nil) {
    ...
    public struct CreateDeploymentGroupInput: AWSShape {
        ...
        public init(alarmConfiguration: AlarmConfiguration? = nil, deploymentConfigName: String? = nil, ec2TagFilters: [EC2TagFilter]? = nil, ec2TagSet: EC2TagSet? = nil, blueGreenDeploymentConfiguration: BlueGreenDeploymentConfiguration? = nil, onPremisesInstanceTagFilters: [TagFilter]? = nil, triggerConfigurations: [TriggerConfig]? = nil, applicationName: String, serviceRoleArn: String, autoRollbackConfiguration: AutoRollbackConfiguration? = nil, onPremisesTagSet: OnPremisesTagSet? = nil, deploymentStyle: DeploymentStyle? = nil, deploymentGroupName: String, loadBalancerInfo: LoadBalancerInfo? = nil, autoScalingGroups: [String]? = nil) {
    ...
    public struct ListDeploymentsInput: AWSShape {
        ...
        public init(nextToken: String? = nil, applicationName: String? = nil, deploymentGroupName: String? = nil, createTimeRange: TimeRange? = nil, includeOnlyStatuses: [DeploymentStatus]? = nil) {
            self.nextToken = nextToken
            self.applicationName = applicationName
            self.deploymentGroupName = deploymentGroupName
    ...
    public struct InstanceSummary: AWSShape {
        ...
        public init(instanceType: InstanceType? = nil, status: InstanceStatus? = nil, lastUpdatedAt: TimeStamp? = nil, deploymentId: String? = nil, instanceId: String? = nil, lifecycleEvents: [LifecycleEvent]? = nil) {
    ...
    public struct RevisionLocation: AWSShape {
        ...
        public init(string: RawString? = nil, gitHubLocation: GitHubLocation? = nil, s3Location: S3Location? = nil, revisionType: RevisionLocationType? = nil) {
            self.string = string
    ...
    public struct GetApplicationRevisionOutput: AWSShape {
        ...
        public init(revisionInfo: GenericRevisionInfo? = nil, applicationName: String? = nil, revision: RevisionLocation? = nil) {
    ...
    public struct DeploymentOverview: AWSShape {
        ...
        public init(ready: Int64? = nil, succeeded: Int64? = nil, failed: Int64? = nil, inProgress: Int64? = nil, pending: Int64? = nil, skipped: Int64? = nil) {
            self.ready = ready
    ...
    public struct LastDeploymentInfo: AWSShape {
        ...
        public init(endTime: TimeStamp? = nil, status: DeploymentStatus? = nil, createTime: TimeStamp? = nil, deploymentId: String? = nil) {
    ...
    public struct UpdateDeploymentGroupInput: AWSShape {
        ...
        public init(alarmConfiguration: AlarmConfiguration? = nil, deploymentConfigName: String? = nil, ec2TagFilters: [EC2TagFilter]? = nil, newDeploymentGroupName: String? = nil, blueGreenDeploymentConfiguration: BlueGreenDeploymentConfiguration? = nil, ec2TagSet: EC2TagSet? = nil, triggerConfigurations: [TriggerConfig]? = nil, applicationName: String, onPremisesInstanceTagFilters: [TagFilter]? = nil, currentDeploymentGroupName: String, serviceRoleArn: String? = nil, autoRollbackConfiguration: AutoRollbackConfiguration? = nil, onPremisesTagSet: OnPremisesTagSet? = nil, deploymentStyle: DeploymentStyle? = nil, loadBalancerInfo: LoadBalancerInfo? = nil, autoScalingGroups: [String]? = nil) {
            self.alarmConfiguration = alarmConfiguration
            self.deploymentConfigName = deploymentConfigName
            self.ec2TagFilters = ec2TagFilters
    ...
    public struct LoadBalancerInfo: AWSShape {
        ...
        public init(elbInfoList: [ELBInfo]? = nil, targetGroupInfoList: [TargetGroupInfo]? = nil) {
    ...
    public struct DeploymentConfigInfo: AWSShape {
        ...
        public init(trafficRoutingConfig: TrafficRoutingConfig? = nil, createTime: TimeStamp? = nil, minimumHealthyHosts: MinimumHealthyHosts? = nil, deploymentConfigId: String? = nil, computePlatform: ComputePlatform? = nil, deploymentConfigName: String? = nil) {
            self.trafficRoutingConfig = trafficRoutingConfig
            self.createTime = createTime
            self.minimumHealthyHosts = minimumHealthyHosts
    ...
    public struct ListApplicationRevisionsInput: AWSShape {
        ...
        public init(applicationName: String, deployed: ListStateFilterAction? = nil, nextToken: String? = nil, sortOrder: SortOrder? = nil, s3Bucket: String? = nil, s3KeyPrefix: String? = nil, sortBy: ApplicationRevisionSortBy? = nil) {
            self.applicationName = applicationName
    ...
    public struct Diagnostics: AWSShape {
        ...
        public init(errorCode: LifecycleErrorCode? = nil, logTail: String? = nil, scriptName: String? = nil, message: String? = nil) {
    ...
    public struct DeploymentInfo: AWSShape {
        ...
        public init(errorInformation: ErrorInformation? = nil, revision: RevisionLocation? = nil, blueGreenDeploymentConfiguration: BlueGreenDeploymentConfiguration? = nil, deploymentStatusMessages: [String]? = nil, deploymentStyle: DeploymentStyle? = nil, deploymentOverview: DeploymentOverview? = nil, fileExistsBehavior: FileExistsBehavior? = nil, deploymentConfigName: String? = nil, rollbackInfo: RollbackInfo? = nil, description: String? = nil, createTime: TimeStamp? = nil, applicationName: String? = nil, computePlatform: ComputePlatform? = nil, completeTime: TimeStamp? = nil, creator: DeploymentCreator? = nil, updateOutdatedInstancesOnly: Bool? = nil, deploymentGroupName: String? = nil, previousRevision: RevisionLocation? = nil, loadBalancerInfo: LoadBalancerInfo? = nil, targetInstances: TargetInstances? = nil, deploymentId: String? = nil, autoRollbackConfiguration: AutoRollbackConfiguration? = nil, ignoreApplicationStopFailures: Bool? = nil, additionalDeploymentStatusInfo: String? = nil, instanceTerminationWaitTimeStarted: Bool? = nil, startTime: TimeStamp? = nil, status: DeploymentStatus? = nil) {
    ...
    public struct GenericRevisionInfo: AWSShape {
        ...
        public init(description: String? = nil, registerTime: TimeStamp? = nil, deploymentGroups: [String]? = nil, firstUsedTime: TimeStamp? = nil, lastUsedTime: TimeStamp? = nil) {
            self.description = description
            self.registerTime = registerTime
    ...
    public struct TimeBasedCanary: AWSShape {
        ...
        public init(canaryPercentage: Int32? = nil, canaryInterval: Int32? = nil) {
    ...
    public struct DeploymentGroupInfo: AWSShape {
        ...
        public init(alarmConfiguration: AlarmConfiguration? = nil, targetRevision: RevisionLocation? = nil, deploymentConfigName: String? = nil, ec2TagFilters: [EC2TagFilter]? = nil, ec2TagSet: EC2TagSet? = nil, blueGreenDeploymentConfiguration: BlueGreenDeploymentConfiguration? = nil, onPremisesInstanceTagFilters: [TagFilter]? = nil, lastSuccessfulDeployment: LastDeploymentInfo? = nil, applicationName: String? = nil, triggerConfigurations: [TriggerConfig]? = nil, deploymentGroupId: String? = nil, autoRollbackConfiguration: AutoRollbackConfiguration? = nil, lastAttemptedDeployment: LastDeploymentInfo? = nil, serviceRoleArn: String? = nil, onPremisesTagSet: OnPremisesTagSet? = nil, deploymentStyle: DeploymentStyle? = nil, deploymentGroupName: String? = nil, computePlatform: ComputePlatform? = nil, loadBalancerInfo: LoadBalancerInfo? = nil, autoScalingGroups: [AutoScalingGroup]? = nil) {
            self.alarmConfiguration = alarmConfiguration
    ...
    public struct S3Location: AWSShape {
        ...
        public init(bucket: String? = nil, eTag: String? = nil, bundleType: BundleType? = nil, version: String? = nil, key: String? = nil) {
            self.bucket = bucket
            self.eTag = eTag
    ...
    public struct LifecycleEvent: AWSShape {
        ...
        public init(endTime: TimeStamp? = nil, status: LifecycleEventStatus? = nil, startTime: TimeStamp? = nil, diagnostics: Diagnostics? = nil, lifecycleEventName: String? = nil) {
            self.endTime = endTime
            self.status = status
            self.startTime = startTime
    ...
    public struct CreateDeploymentInput: AWSShape {
        ...
        public init(targetInstances: TargetInstances? = nil, applicationName: String, fileExistsBehavior: FileExistsBehavior? = nil, autoRollbackConfiguration: AutoRollbackConfiguration? = nil, updateOutdatedInstancesOnly: Bool? = nil, deploymentConfigName: String? = nil, description: String? = nil, ignoreApplicationStopFailures: Bool? = nil, revision: RevisionLocation? = nil, deploymentGroupName: String? = nil) {
            self.targetInstances = targetInstances
            self.applicationName = applicationName
            self.fileExistsBehavior = fileExistsBehavior
            self.autoRollbackConfiguration = autoRollbackConfiguration
    ...
    public struct AlarmConfiguration: AWSShape {
        ...
        public init(ignorePollAlarmFailure: Bool? = nil, enabled: Bool? = nil, alarms: [Alarm]? = nil) {
    ...
    public struct TrafficRoutingConfig: AWSShape {
        ...
        public init(type: TrafficRoutingType? = nil, timeBasedCanary: TimeBasedCanary? = nil, timeBasedLinear: TimeBasedLinear? = nil) {
            self.`type` = `type`
    ...
    public struct TriggerConfig: AWSShape {
        ...
        public init(triggerName: String? = nil, triggerTargetArn: String? = nil, triggerEvents: [TriggerEventType]? = nil) {
    ...
    public struct ListDeploymentInstancesInput: AWSShape {
        ...
        public init(instanceTypeFilter: [InstanceType]? = nil, nextToken: String? = nil, instanceStatusFilter: [InstanceStatus]? = nil, deploymentId: String) {
