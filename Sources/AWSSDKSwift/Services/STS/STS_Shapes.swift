...
extension STS {
    ...
    public struct AssumeRoleRequest: AWSShape {
        public static var _encoding = [
            AWSMemberEncoding(label: "policyArns", location: .body(locationName: "PolicyArns"), encoding: .list(member:"member")), 
            AWSMemberEncoding(label: "tags", location: .body(locationName: "Tags"), encoding: .list(member:"member")), 
            AWSMemberEncoding(label: "transitiveTagKeys", location: .body(locationName: "TransitiveTagKeys"), encoding: .list(member:"member"))
        ]

        public struct _PolicyArnsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TagsEncoding: ArrayCoderProperties { static public let member = "member" }
        public struct _TransitiveTagKeysEncoding: ArrayCoderProperties { static public let member = "member" }
        ...
        @OptionalCoding<ArrayCoder<_PolicyArnsEncoding, PolicyDescriptorType>> public var policyArns: [PolicyDescriptorType]?
        ...
        @OptionalCoding<ArrayCoder<_TransitiveTagKeysEncoding, String>> public var transitiveTagKeys: [String]?
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.transitiveTagKeys, name:"transitiveTagKeys", parent: name, max: 50)
        }
