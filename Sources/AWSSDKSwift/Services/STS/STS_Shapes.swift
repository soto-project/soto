...
extension STS {
    ...
    public struct AssumeRoleWithSAMLRequest: AWSShape {
        ...
        public init(durationSeconds: Int32? = nil, policy: String? = nil, sAMLAssertion: String, roleArn: String, principalArn: String) {
    ...
    public struct AssumeRoleWithWebIdentityResponse: AWSShape {
        ...
        public init(credentials: Credentials? = nil, assumedRoleUser: AssumedRoleUser? = nil, packedPolicySize: Int32? = nil, audience: String? = nil, provider: String? = nil, subjectFromWebIdentityToken: String? = nil) {
            self.credentials = credentials
    ...
    public struct AssumeRoleResponse: AWSShape {
        ...
        public init(credentials: Credentials? = nil, packedPolicySize: Int32? = nil, assumedRoleUser: AssumedRoleUser? = nil) {
            self.credentials = credentials
            self.packedPolicySize = packedPolicySize
            self.assumedRoleUser = assumedRoleUser
        }
    ...
    public struct AssumeRoleWithWebIdentityRequest: AWSShape {
        ...
        public init(providerId: String? = nil, webIdentityToken: String, roleSessionName: String, roleArn: String, policy: String? = nil, durationSeconds: Int32? = nil) {
    ...
    public struct Credentials: AWSShape {
        ...
        public init(expiration: TimeStamp, accessKeyId: String, sessionToken: String, secretAccessKey: String) {
    ...
    public struct AssumeRoleRequest: AWSShape {
        ...
        public init(roleArn: String, durationSeconds: Int32? = nil, policy: String? = nil, externalId: String? = nil, roleSessionName: String, tokenCode: String? = nil, serialNumber: String? = nil) {
            self.roleArn = roleArn
            self.durationSeconds = durationSeconds
            self.policy = policy
    ...
    public struct AssumeRoleWithSAMLResponse: AWSShape {
        ...
        public init(packedPolicySize: Int32? = nil, credentials: Credentials? = nil, issuer: String? = nil, nameQualifier: String? = nil, subject: String? = nil, subjectType: String? = nil, audience: String? = nil, assumedRoleUser: AssumedRoleUser? = nil) {
            self.packedPolicySize = packedPolicySize
            self.credentials = credentials
            self.issuer = issuer
