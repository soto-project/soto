...
extension STS {
    ...
    public struct AssumeRoleWithSAMLResponse: AWSShape {
        ...
        public init(nameQualifier: String? = nil, subjectType: String? = nil, packedPolicySize: Int32? = nil, assumedRoleUser: AssumedRoleUser? = nil, subject: String? = nil, issuer: String? = nil, credentials: Credentials? = nil, audience: String? = nil) {
    ...
    public struct AssumeRoleWithWebIdentityRequest: AWSShape {
        ...
        public init(roleSessionName: String, webIdentityToken: String, roleArn: String, durationSeconds: Int32? = nil, providerId: String? = nil, policy: String? = nil) {
    ...
    public struct AssumeRoleWithSAMLRequest: AWSShape {
        ...
        public init(durationSeconds: Int32? = nil, principalArn: String, policy: String? = nil, sAMLAssertion: String, roleArn: String) {
            self.durationSeconds = durationSeconds
    ...
    public struct GetFederationTokenResponse: AWSShape {
        ...
        public init(federatedUser: FederatedUser? = nil, credentials: Credentials? = nil, packedPolicySize: Int32? = nil) {
    ...
    public struct AssumeRoleResponse: AWSShape {
        ...
        public init(assumedRoleUser: AssumedRoleUser? = nil, packedPolicySize: Int32? = nil, credentials: Credentials? = nil) {
            self.assumedRoleUser = assumedRoleUser
            self.packedPolicySize = packedPolicySize
            self.credentials = credentials
        }
    ...
    public struct GetSessionTokenRequest: AWSShape {
        ...
        public init(serialNumber: String? = nil, durationSeconds: Int32? = nil, tokenCode: String? = nil) {
    ...
    public struct GetCallerIdentityResponse: AWSShape {
        ...
        public init(arn: String? = nil, account: String? = nil, userId: String? = nil) {
            self.arn = arn
    ...
    public struct AssumeRoleWithWebIdentityResponse: AWSShape {
        ...
        public init(assumedRoleUser: AssumedRoleUser? = nil, packedPolicySize: Int32? = nil, audience: String? = nil, subjectFromWebIdentityToken: String? = nil, credentials: Credentials? = nil, provider: String? = nil) {
            self.assumedRoleUser = assumedRoleUser
            self.packedPolicySize = packedPolicySize
            self.audience = audience
    ...
    public struct AssumeRoleRequest: AWSShape {
        ...
        public init(policy: String? = nil, durationSeconds: Int32? = nil, externalId: String? = nil, tokenCode: String? = nil, roleArn: String, roleSessionName: String, serialNumber: String? = nil) {
            self.policy = policy
            self.durationSeconds = durationSeconds
    ...
    public struct Credentials: AWSShape {
        ...
        public init(expiration: TimeStamp, secretAccessKey: String, sessionToken: String, accessKeyId: String) {
