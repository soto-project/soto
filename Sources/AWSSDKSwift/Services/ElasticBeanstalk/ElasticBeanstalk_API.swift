...
public struct ElasticBeanstalk {
    ...
    public func describeEnvironments(_ input: DescribeEnvironmentsMessage) throws -> EventLoopFuture<EnvironmentDescriptionsMessage> {
    ...
    public func createApplicationVersion(_ input: CreateApplicationVersionMessage) throws -> EventLoopFuture<ApplicationVersionDescriptionMessage> {
    ...
    public func describeConfigurationSettings(_ input: DescribeConfigurationSettingsMessage) throws -> EventLoopFuture<ConfigurationSettingsDescriptions> {
        return try client.send(operation: "DescribeConfigurationSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists an environment's completed and failed managed actions.
    public func describeEnvironmentManagedActionHistory(_ input: DescribeEnvironmentManagedActionHistoryRequest) throws -> EventLoopFuture<DescribeEnvironmentManagedActionHistoryResult> {
    ...
    public func createStorageLocation() throws -> EventLoopFuture<CreateStorageLocationResultMessage> {
        return try client.send(operation: "CreateStorageLocation", path: "/", httpMethod: "POST")
    }

    ///  Returns AWS resources for this environment.
    public func describeEnvironmentResources(_ input: DescribeEnvironmentResourcesMessage) throws -> EventLoopFuture<EnvironmentResourceDescriptionsMessage> {
    ...
    public func updateApplication(_ input: UpdateApplicationMessage) throws -> EventLoopFuture<ApplicationDescriptionMessage> {
        return try client.send(operation: "UpdateApplication", path: "/", httpMethod: "POST", input: input)
    }

    ///  Terminates the specified environment.
    public func terminateEnvironment(_ input: TerminateEnvironmentMessage) throws -> EventLoopFuture<EnvironmentDescription> {
        return try client.send(operation: "TerminateEnvironment", path: "/", httpMethod: "POST", input: input)
    }

    ///   Creates an application that has one configuration template named default and no application versions. 
    public func createApplication(_ input: CreateApplicationMessage) throws -> EventLoopFuture<ApplicationDescriptionMessage> {
        return try client.send(operation: "CreateApplication", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies lifecycle settings for an application.
    public func updateApplicationResourceLifecycle(_ input: UpdateApplicationResourceLifecycleMessage) throws -> EventLoopFuture<ApplicationResourceLifecycleDescriptionMessage> {
        return try client.send(operation: "UpdateApplicationResourceLifecycle", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists an environment's upcoming and in-progress managed actions.
    public func describeEnvironmentManagedActions(_ input: DescribeEnvironmentManagedActionsRequest) throws -> EventLoopFuture<DescribeEnvironmentManagedActionsResult> {
        return try client.send(operation: "DescribeEnvironmentManagedActions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Launches an environment for the specified application using the specified configuration.
    public func createEnvironment(_ input: CreateEnvironmentMessage) throws -> EventLoopFuture<EnvironmentDescription> {
    ...
    public func applyEnvironmentManagedAction(_ input: ApplyEnvironmentManagedActionRequest) throws -> EventLoopFuture<ApplyEnvironmentManagedActionResult> {
    ...
    public func describeApplications(_ input: DescribeApplicationsMessage) throws -> EventLoopFuture<ApplicationDescriptionsMessage> {
        return try client.send(operation: "DescribeApplications", path: "/", httpMethod: "POST", input: input)
    }

    ///  Checks if the specified CNAME is available.
    public func checkDNSAvailability(_ input: CheckDNSAvailabilityMessage) throws -> EventLoopFuture<CheckDNSAvailabilityResultMessage> {
        return try client.send(operation: "CheckDNSAvailability", path: "/", httpMethod: "POST", input: input)
    }

    ///  Create a new version of your custom platform.
    public func createPlatformVersion(_ input: CreatePlatformVersionRequest) throws -> EventLoopFuture<CreatePlatformVersionResult> {
    ...
    public func describeEnvironmentHealth(_ input: DescribeEnvironmentHealthRequest) throws -> EventLoopFuture<DescribeEnvironmentHealthResult> {
        return try client.send(operation: "DescribeEnvironmentHealth", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieve a list of application versions.
    public func describeApplicationVersions(_ input: DescribeApplicationVersionsMessage) throws -> EventLoopFuture<ApplicationVersionDescriptionsMessage> {
    ...
    public func createConfigurationTemplate(_ input: CreateConfigurationTemplateMessage) throws -> EventLoopFuture<ConfigurationSettingsDescription> {
    ...
    public func describeEvents(_ input: DescribeEventsMessage) throws -> EventLoopFuture<EventDescriptionsMessage> {
    ...
    public func updateConfigurationTemplate(_ input: UpdateConfigurationTemplateMessage) throws -> EventLoopFuture<ConfigurationSettingsDescription> {
    ...
    public func validateConfigurationSettings(_ input: ValidateConfigurationSettingsMessage) throws -> EventLoopFuture<ConfigurationSettingsValidationMessages> {
    ...
    public func describeConfigurationOptions(_ input: DescribeConfigurationOptionsMessage) throws -> EventLoopFuture<ConfigurationOptionsDescription> {
    ...
    public func updateApplicationVersion(_ input: UpdateApplicationVersionMessage) throws -> EventLoopFuture<ApplicationVersionDescriptionMessage> {
    ...
    public func listTagsForResource(_ input: ListTagsForResourceMessage) throws -> EventLoopFuture<ResourceTagsDescriptionMessage> {
    ...
    public func describeAccountAttributes() throws -> EventLoopFuture<DescribeAccountAttributesResult> {
        return try client.send(operation: "DescribeAccountAttributes", path: "/", httpMethod: "POST")
    }

    ///  Describes the version of the platform.
    public func describePlatformVersion(_ input: DescribePlatformVersionRequest) throws -> EventLoopFuture<DescribePlatformVersionResult> {
    ...
    public func retrieveEnvironmentInfo(_ input: RetrieveEnvironmentInfoMessage) throws -> EventLoopFuture<RetrieveEnvironmentInfoResultMessage> {
        return try client.send(operation: "RetrieveEnvironmentInfo", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified version of a custom platform.
    public func deletePlatformVersion(_ input: DeletePlatformVersionRequest) throws -> EventLoopFuture<DeletePlatformVersionResult> {
        return try client.send(operation: "DeletePlatformVersion", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves detailed information about the health of instances in your AWS Elastic Beanstalk. This operation requires enhanced health reporting.
    public func describeInstancesHealth(_ input: DescribeInstancesHealthRequest) throws -> EventLoopFuture<DescribeInstancesHealthResult> {
    ...
    public func updateEnvironment(_ input: UpdateEnvironmentMessage) throws -> EventLoopFuture<EnvironmentDescription> {
    ...
    public func composeEnvironments(_ input: ComposeEnvironmentsMessage) throws -> EventLoopFuture<EnvironmentDescriptionsMessage> {
        return try client.send(operation: "ComposeEnvironments", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the available platforms.
    public func listPlatformVersions(_ input: ListPlatformVersionsRequest) throws -> EventLoopFuture<ListPlatformVersionsResult> {
    ...
    public func listAvailableSolutionStacks() throws -> EventLoopFuture<ListAvailableSolutionStacksResultMessage> {
