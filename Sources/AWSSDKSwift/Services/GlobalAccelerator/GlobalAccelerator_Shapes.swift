...
extension GlobalAccelerator {
    ...
    public struct AdvertiseByoipCidrRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            try validate(self.cidr, name:"cidr", parent: name, max: 255)
        }
    ...
    public struct AdvertiseByoipCidrResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ByoipCidr", required: false, type: .structure)
        ]
    ...
    public struct CidrAuthorizationContext: AWSShape {
        ...
        public func validate(name: String) throws {
            try validate(self.message, name:"message", parent: name, max: 255)
            try validate(self.signature, name:"signature", parent: name, max: 255)
        }
    ...
    public struct CreateAcceleratorRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.ipAddresses, name:"ipAddresses", parent: name, max: 2)
            try validate(self.ipAddresses, name:"ipAddresses", parent: name, min: 0)
    ...
    public struct DeprovisionByoipCidrResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ByoipCidr", required: false, type: .structure)
        ]
    ...
    public struct ListByoipCidrsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "MaxResults", required: false, type: .integer), 
            AWSShapeMember(label: "NextToken", required: false, type: .string)
        ]
    ...
    public struct ListByoipCidrsResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ByoipCidrs", required: false, type: .list), 
            AWSShapeMember(label: "NextToken", required: false, type: .string)
        ]
    ...
    public struct ProvisionByoipCidrRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Cidr", required: true, type: .string), 
            AWSShapeMember(label: "CidrAuthorizationContext", required: true, type: .structure)
        ]
    ...
    public struct ProvisionByoipCidrResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ByoipCidr", required: false, type: .structure)
        ]
    ...
    public struct WithdrawByoipCidrResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ByoipCidr", required: false, type: .structure)
        ]
