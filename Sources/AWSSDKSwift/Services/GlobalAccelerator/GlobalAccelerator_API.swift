...
public struct GlobalAccelerator {
    ...
    public func updateAccelerator(_ input: UpdateAcceleratorRequest) throws -> UpdateAcceleratorResponse {
    ...
    public func updateAcceleratorAttributes(_ input: UpdateAcceleratorAttributesRequest) throws -> UpdateAcceleratorAttributesResponse {
