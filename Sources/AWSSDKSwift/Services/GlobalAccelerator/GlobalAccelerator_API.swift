...
public struct GlobalAccelerator {
    ...
    ///  Describe a listener.
    public func describeListener(_ input: DescribeListenerRequest) throws -> EventLoopFuture<DescribeListenerResponse> {
        return try client.send(operation: "DescribeListener", path: "/", httpMethod: "POST", input: input)
    }

    ///  Update an accelerator.
    public func updateAccelerator(_ input: UpdateAcceleratorRequest) throws -> EventLoopFuture<UpdateAcceleratorResponse> {
    ...
    public func createAccelerator(_ input: CreateAcceleratorRequest) throws -> EventLoopFuture<CreateAcceleratorResponse> {
    ...
    public func createEndpointGroup(_ input: CreateEndpointGroupRequest) throws -> EventLoopFuture<CreateEndpointGroupResponse> {
    ...
    public func createListener(_ input: CreateListenerRequest) throws -> EventLoopFuture<CreateListenerResponse> {
        return try client.send(operation: "CreateListener", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describe an accelerator. To see an AWS CLI example of describing an accelerator, scroll down to Example.
    public func describeAccelerator(_ input: DescribeAcceleratorRequest) throws -> EventLoopFuture<DescribeAcceleratorResponse> {
    ...
    public func updateAcceleratorAttributes(_ input: UpdateAcceleratorAttributesRequest) throws -> EventLoopFuture<UpdateAcceleratorAttributesResponse> {
        return try client.send(operation: "UpdateAcceleratorAttributes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describe an endpoint group.
    public func describeEndpointGroup(_ input: DescribeEndpointGroupRequest) throws -> EventLoopFuture<DescribeEndpointGroupResponse> {
    ...
    public func listEndpointGroups(_ input: ListEndpointGroupsRequest) throws -> EventLoopFuture<ListEndpointGroupsResponse> {
        return try client.send(operation: "ListEndpointGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Update an endpoint group. To see an AWS CLI example of updating an endpoint group, scroll down to Example.
    public func updateEndpointGroup(_ input: UpdateEndpointGroupRequest) throws -> EventLoopFuture<UpdateEndpointGroupResponse> {
        return try client.send(operation: "UpdateEndpointGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  List the listeners for an accelerator.
    public func listListeners(_ input: ListListenersRequest) throws -> EventLoopFuture<ListListenersResponse> {
        return try client.send(operation: "ListListeners", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describe the attributes of an accelerator.
    public func describeAcceleratorAttributes(_ input: DescribeAcceleratorAttributesRequest) throws -> EventLoopFuture<DescribeAcceleratorAttributesResponse> {
    ...
    public func listAccelerators(_ input: ListAcceleratorsRequest) throws -> EventLoopFuture<ListAcceleratorsResponse> {
        return try client.send(operation: "ListAccelerators", path: "/", httpMethod: "POST", input: input)
    }

    ///  Update a listener.
    public func updateListener(_ input: UpdateListenerRequest) throws -> EventLoopFuture<UpdateListenerResponse> {
