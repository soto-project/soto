...
extension ElasticTranscoder {
    ...
    public func listJobsByPipelinePaginator(_ input: ListJobsByPipelineRequest) -> Future<[Job]> {
    ...
    public func listJobsByStatusPaginator(_ input: ListJobsByStatusRequest) -> Future<[Job]> {
        return client.paginate(input: input, command: listJobsByStatus, resultKey: "jobs", tokenKey: "nextPageToken")
    }
    
    ///  The ListPipelines operation gets a list of the pipelines associated with the current AWS account.
    public func listPipelinesPaginator(_ input: ListPipelinesRequest) -> Future<[Pipeline]> {
