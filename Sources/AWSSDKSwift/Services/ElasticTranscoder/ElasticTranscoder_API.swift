...
public struct ElasticTranscoder {
    ...
    public func readJob(_ input: ReadJobRequest) throws -> EventLoopFuture<ReadJobResponse> {
    ...
    public func readPipeline(_ input: ReadPipelineRequest) throws -> EventLoopFuture<ReadPipelineResponse> {
    ...
    public func listJobsByStatus(_ input: ListJobsByStatusRequest) throws -> EventLoopFuture<ListJobsByStatusResponse> {
    ...
    public func listJobsByPipeline(_ input: ListJobsByPipelineRequest) throws -> EventLoopFuture<ListJobsByPipelineResponse> {
    ...
    public func deletePipeline(_ input: DeletePipelineRequest) throws -> EventLoopFuture<DeletePipelineResponse> {
    ...
    public func testRole(_ input: TestRoleRequest) throws -> EventLoopFuture<TestRoleResponse> {
    ...
    public func updatePipelineNotifications(_ input: UpdatePipelineNotificationsRequest) throws -> EventLoopFuture<UpdatePipelineNotificationsResponse> {
    ...
    public func updatePipeline(_ input: UpdatePipelineRequest) throws -> EventLoopFuture<UpdatePipelineResponse> {
    ...
    public func updatePipelineStatus(_ input: UpdatePipelineStatusRequest) throws -> EventLoopFuture<UpdatePipelineStatusResponse> {
    ...
    public func readPreset(_ input: ReadPresetRequest) throws -> EventLoopFuture<ReadPresetResponse> {
