...
public struct ElasticTranscoder: AWSService {
    ...
    /// return new `ElasticTranscoder` with new timeout value
    ...
    /// return new `ElasticTranscoder` logging to specified Logger
    ...
    public func cancelJob(_ input: CancelJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelJobResponse> {
        return client.execute(operation: "CancelJob", path: "/2012-09-25/jobs/{Id}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createJob(_ input: CreateJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateJobResponse> {
        return client.execute(operation: "CreateJob", path: "/2012-09-25/jobs", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createPipeline(_ input: CreatePipelineRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePipelineResponse> {
        return client.execute(operation: "CreatePipeline", path: "/2012-09-25/pipelines", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createPreset(_ input: CreatePresetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreatePresetResponse> {
        return client.execute(operation: "CreatePreset", path: "/2012-09-25/presets", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deletePipeline(_ input: DeletePipelineRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeletePipelineResponse> {
        return client.execute(operation: "DeletePipeline", path: "/2012-09-25/pipelines/{Id}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deletePreset(_ input: DeletePresetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeletePresetResponse> {
        return client.execute(operation: "DeletePreset", path: "/2012-09-25/presets/{Id}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listJobsByPipeline(_ input: ListJobsByPipelineRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJobsByPipelineResponse> {
        return client.execute(operation: "ListJobsByPipeline", path: "/2012-09-25/jobsByPipeline/{PipelineId}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listJobsByStatus(_ input: ListJobsByStatusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJobsByStatusResponse> {
        return client.execute(operation: "ListJobsByStatus", path: "/2012-09-25/jobsByStatus/{Status}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listPipelines(_ input: ListPipelinesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPipelinesResponse> {
        return client.execute(operation: "ListPipelines", path: "/2012-09-25/pipelines", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listPresets(_ input: ListPresetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListPresetsResponse> {
        return client.execute(operation: "ListPresets", path: "/2012-09-25/presets", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }

    ///  The ReadJob operation returns detailed information about a job.
    public func readJob(_ input: ReadJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReadJobResponse> {
        return client.execute(operation: "ReadJob", path: "/2012-09-25/jobs/{Id}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func readPipeline(_ input: ReadPipelineRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReadPipelineResponse> {
        return client.execute(operation: "ReadPipeline", path: "/2012-09-25/pipelines/{Id}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func readPreset(_ input: ReadPresetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReadPresetResponse> {
        return client.execute(operation: "ReadPreset", path: "/2012-09-25/presets/{Id}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func testRole(_ input: TestRoleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TestRoleResponse> {
        return client.execute(operation: "TestRole", path: "/2012-09-25/roleTests", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updatePipeline(_ input: UpdatePipelineRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdatePipelineResponse> {
        return client.execute(operation: "UpdatePipeline", path: "/2012-09-25/pipelines/{Id}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updatePipelineNotifications(_ input: UpdatePipelineNotificationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdatePipelineNotificationsResponse> {
        return client.execute(operation: "UpdatePipelineNotifications", path: "/2012-09-25/pipelines/{Id}/notifications", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updatePipelineStatus(_ input: UpdatePipelineStatusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdatePipelineStatusResponse> {
        return client.execute(operation: "UpdatePipelineStatus", path: "/2012-09-25/pipelines/{Id}/status", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
