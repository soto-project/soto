...
extension ElasticTranscoder {
    ...
    public struct PlayReadyDrm: AWSShape {
        ...
        public init(format: String? = nil, licenseAcquisitionUrl: String? = nil, initializationVector: String? = nil, key: String? = nil, keyId: String? = nil, keyMd5: String? = nil) {
            self.format = format
    ...
    public struct AudioParameters: AWSShape {
        ...
        public init(sampleRate: String? = nil, audioPackingMode: String? = nil, codecOptions: AudioCodecOptions? = nil, bitRate: String? = nil, channels: String? = nil, codec: String? = nil) {
    ...
    public struct CreateJobRequest: AWSShape {
        ...
        public init(userMetadata: [String: String]? = nil, input: JobInput? = nil, outputKeyPrefix: String? = nil, inputs: [JobInput]? = nil, output: CreateJobOutput? = nil, playlists: [CreateJobPlaylist]? = nil, pipelineId: String, outputs: [CreateJobOutput]? = nil) {
    ...
    public struct HlsContentProtection: AWSShape {
        ...
        public init(method: String? = nil, key: String? = nil, licenseAcquisitionUrl: String? = nil, keyMd5: String? = nil, initializationVector: String? = nil, keyStoragePolicy: String? = nil) {
            self.method = method
            self.key = key
            self.licenseAcquisitionUrl = licenseAcquisitionUrl
            self.keyMd5 = keyMd5
    ...
    public struct CreatePresetRequest: AWSShape {
        ...
        public init(name: String, description: String? = nil, thumbnails: Thumbnails? = nil, audio: AudioParameters? = nil, video: VideoParameters? = nil, container: String) {
            self.name = name
    ...
    public struct DetectedProperties: AWSShape {
        ...
        public init(durationMillis: Int64? = nil, fileSize: Int64? = nil, height: Int32? = nil, frameRate: String? = nil, width: Int32? = nil) {
    ...
    public struct VideoParameters: AWSShape {
        ...
        public init(keyframesMaxDist: String? = nil, codec: String? = nil, sizingPolicy: String? = nil, aspectRatio: String? = nil, codecOptions: [String: String]? = nil, fixedGOP: String? = nil, maxHeight: String? = nil, paddingPolicy: String? = nil, bitRate: String? = nil, watermarks: [PresetWatermark]? = nil, frameRate: String? = nil, resolution: String? = nil, maxWidth: String? = nil, maxFrameRate: String? = nil, displayAspectRatio: String? = nil) {
    ...
    public struct Thumbnails: AWSShape {
        ...
        public init(aspectRatio: String? = nil, resolution: String? = nil, maxHeight: String? = nil, paddingPolicy: String? = nil, sizingPolicy: String? = nil, maxWidth: String? = nil, interval: String? = nil, format: String? = nil) {
            self.aspectRatio = aspectRatio
            self.resolution = resolution
            self.maxHeight = maxHeight
            self.paddingPolicy = paddingPolicy
    ...
    public struct PresetWatermark: AWSShape {
        ...
        public init(maxHeight: String? = nil, target: String? = nil, horizontalAlign: String? = nil, sizingPolicy: String? = nil, maxWidth: String? = nil, verticalAlign: String? = nil, opacity: String? = nil, verticalOffset: String? = nil, id: String? = nil, horizontalOffset: String? = nil) {
            self.maxHeight = maxHeight
            self.target = target
    ...
    public struct JobOutput: AWSShape {
        ...
        public init(captions: Captions? = nil, segmentDuration: String? = nil, rotate: String? = nil, presetId: String? = nil, thumbnailEncryption: Encryption? = nil, appliedColorSpaceConversion: String? = nil, key: String? = nil, statusDetail: String? = nil, duration: Int64? = nil, width: Int32? = nil, fileSize: Int64? = nil, frameRate: String? = nil, id: String? = nil, composition: [Clip]? = nil, height: Int32? = nil, watermarks: [JobWatermark]? = nil, albumArt: JobAlbumArt? = nil, durationMillis: Int64? = nil, status: String? = nil, encryption: Encryption? = nil, thumbnailPattern: String? = nil) {
    ...
    public struct AudioCodecOptions: AWSShape {
        ...
        public init(signed: String? = nil, bitOrder: String? = nil, bitDepth: String? = nil, profile: String? = nil) {
            self.signed = signed
    ...
    public struct CaptionSource: AWSShape {
        ...
        public init(label: String? = nil, timeOffset: String? = nil, key: String? = nil, encryption: Encryption? = nil, language: String? = nil) {
            self.label = label
    ...
    public struct Playlist: AWSShape {
        ...
        public init(status: String? = nil, hlsContentProtection: HlsContentProtection? = nil, playReadyDrm: PlayReadyDrm? = nil, outputKeys: [String]? = nil, format: String? = nil, name: String? = nil, statusDetail: String? = nil) {
            self.status = status
    ...
    public struct UpdatePipelineRequest: AWSShape {
        ...
        public init(notifications: Notifications? = nil, awsKmsKeyArn: String? = nil, role: String? = nil, contentConfig: PipelineOutputConfig? = nil, inputBucket: String? = nil, id: String, name: String? = nil, thumbnailConfig: PipelineOutputConfig? = nil) {
    ...
    public struct Artwork: AWSShape {
        ...
        public init(albumArtFormat: String? = nil, maxHeight: String? = nil, paddingPolicy: String? = nil, sizingPolicy: String? = nil, maxWidth: String? = nil, inputKey: String? = nil, encryption: Encryption? = nil) {
    ...
    public struct TestRoleRequest: AWSShape {
        ...
        public init(role: String, topics: [String], inputBucket: String, outputBucket: String) {
            self.role = role
            self.topics = topics
            self.inputBucket = inputBucket
    ...
    public struct CreateJobOutput: AWSShape {
        ...
        public init(encryption: Encryption? = nil, key: String? = nil, rotate: String? = nil, albumArt: JobAlbumArt? = nil, watermarks: [JobWatermark]? = nil, captions: Captions? = nil, composition: [Clip]? = nil, thumbnailEncryption: Encryption? = nil, segmentDuration: String? = nil, thumbnailPattern: String? = nil, presetId: String? = nil) {
            self.encryption = encryption
            self.key = key
            self.rotate = rotate
            self.albumArt = albumArt
    ...
    public struct JobInput: AWSShape {
        ...
        public init(inputCaptions: InputCaptions? = nil, aspectRatio: String? = nil, detectedProperties: DetectedProperties? = nil, resolution: String? = nil, key: String? = nil, interlaced: String? = nil, timeSpan: TimeSpan? = nil, frameRate: String? = nil, container: String? = nil, encryption: Encryption? = nil) {
    ...
    public struct Notifications: AWSShape {
        ...
        public init(warning: String? = nil, progressing: String? = nil, error: String? = nil, completed: String? = nil) {
            self.warning = warning
    ...
    public struct CreateJobPlaylist: AWSShape {
        ...
        public init(name: String? = nil, format: String? = nil, playReadyDrm: PlayReadyDrm? = nil, hlsContentProtection: HlsContentProtection? = nil, outputKeys: [String]? = nil) {
            self.name = name
            self.format = format
            self.playReadyDrm = playReadyDrm
            self.hlsContentProtection = hlsContentProtection
    ...
    public struct Job: AWSShape {
        ...
        public init(userMetadata: [String: String]? = nil, input: JobInput? = nil, timing: Timing? = nil, status: String? = nil, arn: String? = nil, inputs: [JobInput]? = nil, output: JobOutput? = nil, playlists: [Playlist]? = nil, outputKeyPrefix: String? = nil, id: String? = nil, outputs: [JobOutput]? = nil, pipelineId: String? = nil) {
            self.userMetadata = userMetadata
            self.input = input
            self.timing = timing
            self.status = status
    ...
    public struct Encryption: AWSShape {
        ...
        public init(mode: String? = nil, key: String? = nil, initializationVector: String? = nil, keyMd5: String? = nil) {
            self.mode = mode
            self.key = key
            self.initializationVector = initializationVector
            self.keyMd5 = keyMd5
    ...
    public struct Timing: AWSShape {
        ...
        public init(finishTimeMillis: Int64? = nil, submitTimeMillis: Int64? = nil, startTimeMillis: Int64? = nil) {
    ...
    public struct Preset: AWSShape {
        ...
        public init(thumbnails: Thumbnails? = nil, arn: String? = nil, type: String? = nil, audio: AudioParameters? = nil, container: String? = nil, video: VideoParameters? = nil, id: String? = nil, name: String? = nil, description: String? = nil) {
            self.thumbnails = thumbnails
            self.arn = arn
            self.`type` = `type`
            self.audio = audio
    ...
    public struct CaptionFormat: AWSShape {
        ...
        public init(pattern: String? = nil, format: String? = nil, encryption: Encryption? = nil) {
    ...
    public struct CreatePipelineRequest: AWSShape {
        ...
        public init(notifications: Notifications? = nil, awsKmsKeyArn: String? = nil, role: String, contentConfig: PipelineOutputConfig? = nil, inputBucket: String, outputBucket: String? = nil, name: String, thumbnailConfig: PipelineOutputConfig? = nil) {
            self.notifications = notifications
            self.awsKmsKeyArn = awsKmsKeyArn
            self.role = role
            self.contentConfig = contentConfig
    ...
    public struct Pipeline: AWSShape {
        ...
        public init(notifications: Notifications? = nil, awsKmsKeyArn: String? = nil, status: String? = nil, arn: String? = nil, role: String? = nil, contentConfig: PipelineOutputConfig? = nil, inputBucket: String? = nil, outputBucket: String? = nil, id: String? = nil, name: String? = nil, thumbnailConfig: PipelineOutputConfig? = nil) {
            self.notifications = notifications
            self.awsKmsKeyArn = awsKmsKeyArn
            self.status = status
            self.arn = arn
