...
extension Kinesis {
    ...
    public struct PutRecordsRequestEntry: AWSShape {
        ...
        public init(explicitHashKey: String? = nil, data: Data, partitionKey: String) {
    ...
    public struct ListStreamConsumersInput: AWSShape {
        ...
        public init(streamCreationTimestamp: TimeStamp? = nil, maxResults: Int32? = nil, streamARN: String, nextToken: String? = nil) {
    ...
    public struct PutRecordsResultEntry: AWSShape {
        ...
        public init(shardId: String? = nil, errorMessage: String? = nil, errorCode: String? = nil, sequenceNumber: String? = nil) {
    ...
    public struct Record: AWSShape {
        ...
        public init(partitionKey: String, encryptionType: EncryptionType? = nil, approximateArrivalTimestamp: TimeStamp? = nil, data: Data, sequenceNumber: String) {
            self.partitionKey = partitionKey
    ...
    public struct StreamDescription: AWSShape {
        ...
        public init(streamCreationTimestamp: TimeStamp, streamName: String, keyId: String? = nil, hasMoreShards: Bool, retentionPeriodHours: Int32, encryptionType: EncryptionType? = nil, enhancedMonitoring: [EnhancedMetrics], streamARN: String, shards: [Shard], streamStatus: StreamStatus) {
            self.streamCreationTimestamp = streamCreationTimestamp
            self.streamName = streamName
            self.keyId = keyId
    ...
    public struct Shard: AWSShape {
        ...
        public init(shardId: String, parentShardId: String? = nil, hashKeyRange: HashKeyRange, adjacentParentShardId: String? = nil, sequenceNumberRange: SequenceNumberRange) {
            self.shardId = shardId
    ...
    public struct ListTagsForStreamInput: AWSShape {
        ...
        public init(streamName: String, exclusiveStartTagKey: String? = nil, limit: Int32? = nil) {
            self.streamName = streamName
    ...
    public struct GetRecordsOutput: AWSShape {
        ...
        public init(records: [Record], millisBehindLatest: Int64? = nil, nextShardIterator: String? = nil) {
            self.records = records
    ...
    public struct StopStreamEncryptionInput: AWSShape {
        ...
        public init(streamName: String, encryptionType: EncryptionType, keyId: String) {
            self.streamName = streamName
            self.encryptionType = encryptionType
            self.keyId = keyId
        }
    ...
    public struct PutRecordInput: AWSShape {
        ...
        public init(sequenceNumberForOrdering: String? = nil, streamName: String, partitionKey: String, data: Data, explicitHashKey: String? = nil) {
    ...
    public struct ConsumerDescription: AWSShape {
        ...
        public init(consumerARN: String, consumerName: String, consumerStatus: ConsumerStatus, consumerCreationTimestamp: TimeStamp, streamARN: String) {
            self.consumerARN = consumerARN
    ...
    public struct PutRecordsOutput: AWSShape {
        ...
        public init(records: [PutRecordsResultEntry], encryptionType: EncryptionType? = nil, failedRecordCount: Int32? = nil) {
            self.records = records
            self.encryptionType = encryptionType
    ...
    public struct StartingPosition: AWSShape {
        ...
        public init(timestamp: TimeStamp? = nil, sequenceNumber: String? = nil, type: ShardIteratorType) {
    ...
    public struct ListShardsInput: AWSShape {
        ...
        public init(exclusiveStartShardId: String? = nil, nextToken: String? = nil, maxResults: Int32? = nil, streamName: String? = nil, streamCreationTimestamp: TimeStamp? = nil) {
    ...
    public struct GetShardIteratorInput: AWSShape {
        ...
        public init(startingSequenceNumber: String? = nil, shardId: String, streamName: String, shardIteratorType: ShardIteratorType, timestamp: TimeStamp? = nil) {
            self.startingSequenceNumber = startingSequenceNumber
            self.shardId = shardId
            self.streamName = streamName
    ...
    public struct SubscribeToShardEvent: AWSShape {
        ...
        public init(records: [Record], continuationSequenceNumber: String, millisBehindLatest: Int64) {
            self.records = records
    ...
    public struct Consumer: AWSShape {
        ...
        public init(consumerARN: String, consumerName: String, consumerStatus: ConsumerStatus, consumerCreationTimestamp: TimeStamp) {
            self.consumerARN = consumerARN
            self.consumerName = consumerName
            self.consumerStatus = consumerStatus
            self.consumerCreationTimestamp = consumerCreationTimestamp
    ...
    public struct StreamDescriptionSummary: AWSShape {
        ...
        public init(streamCreationTimestamp: TimeStamp, streamName: String, keyId: String? = nil, retentionPeriodHours: Int32, encryptionType: EncryptionType? = nil, enhancedMonitoring: [EnhancedMetrics], openShardCount: Int32, streamARN: String, consumerCount: Int32? = nil, streamStatus: StreamStatus) {
            self.streamCreationTimestamp = streamCreationTimestamp
            self.streamName = streamName
            self.keyId = keyId
            self.retentionPeriodHours = retentionPeriodHours
