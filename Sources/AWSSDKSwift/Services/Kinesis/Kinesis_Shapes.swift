...
extension Kinesis {
    ...
    public struct SubscribeToShardEvent: AWSShape {
        ...
        public init(continuationSequenceNumber: String, records: [Record], millisBehindLatest: Int64) {
    ...
    public struct SubscribeToShardInput: AWSShape {
        ...
        public init(shardId: String, startingPosition: StartingPosition, consumerARN: String) {
            self.shardId = shardId
    ...
    public struct GetShardIteratorInput: AWSShape {
        ...
        public init(shardId: String, startingSequenceNumber: String? = nil, shardIteratorType: ShardIteratorType, timestamp: TimeStamp? = nil, streamName: String) {
            self.shardId = shardId
    ...
    public struct UpdateShardCountInput: AWSShape {
        ...
        public init(streamName: String, scalingType: ScalingType, targetShardCount: Int32) {
            self.streamName = streamName
    ...
    public struct PutRecordsResultEntry: AWSShape {
        ...
        public init(shardId: String? = nil, errorCode: String? = nil, sequenceNumber: String? = nil, errorMessage: String? = nil) {
            self.shardId = shardId
    ...
    public struct StreamDescription: AWSShape {
        ...
        public init(retentionPeriodHours: Int32, streamName: String, keyId: String? = nil, hasMoreShards: Bool, streamCreationTimestamp: TimeStamp, streamARN: String, enhancedMonitoring: [EnhancedMetrics], streamStatus: StreamStatus, shards: [Shard], encryptionType: EncryptionType? = nil) {
            self.retentionPeriodHours = retentionPeriodHours
            self.streamName = streamName
            self.keyId = keyId
    ...
    public struct DescribeStreamInput: AWSShape {
        ...
        public init(streamName: String, limit: Int32? = nil, exclusiveStartShardId: String? = nil) {
            self.streamName = streamName
            self.limit = limit
    ...
    public struct ListTagsForStreamInput: AWSShape {
        ...
        public init(streamName: String, limit: Int32? = nil, exclusiveStartTagKey: String? = nil) {
            self.streamName = streamName
            self.limit = limit
    ...
    public struct StreamDescriptionSummary: AWSShape {
        ...
        public init(retentionPeriodHours: Int32, streamName: String, enhancedMonitoring: [EnhancedMetrics], keyId: String? = nil, streamCreationTimestamp: TimeStamp, streamARN: String, streamStatus: StreamStatus, consumerCount: Int32? = nil, encryptionType: EncryptionType? = nil, openShardCount: Int32) {
            self.retentionPeriodHours = retentionPeriodHours
            self.streamName = streamName
            self.enhancedMonitoring = enhancedMonitoring
            self.keyId = keyId
    ...
    public struct Consumer: AWSShape {
        ...
        public init(consumerARN: String, consumerStatus: ConsumerStatus, consumerCreationTimestamp: TimeStamp, consumerName: String) {
            self.consumerARN = consumerARN
    ...
    public struct UpdateShardCountOutput: AWSShape {
        ...
        public init(streamName: String? = nil, currentShardCount: Int32? = nil, targetShardCount: Int32? = nil) {
            self.streamName = streamName
    ...
    public struct EnhancedMonitoringOutput: AWSShape {
        ...
        public init(streamName: String? = nil, currentShardLevelMetrics: [MetricsName]? = nil, desiredShardLevelMetrics: [MetricsName]? = nil) {
            self.streamName = streamName
    ...
    public struct ListShardsInput: AWSShape {
        ...
        public init(nextToken: String? = nil, streamCreationTimestamp: TimeStamp? = nil, exclusiveStartShardId: String? = nil, maxResults: Int32? = nil, streamName: String? = nil) {
            self.nextToken = nextToken
            self.streamCreationTimestamp = streamCreationTimestamp
            self.exclusiveStartShardId = exclusiveStartShardId
    ...
    public struct ListStreamConsumersOutput: AWSShape {
        ...
        public init(nextToken: String? = nil, consumers: [Consumer]? = nil) {
            self.nextToken = nextToken
    ...
    public struct PutRecordsInput: AWSShape {
        ...
        public init(streamName: String, records: [PutRecordsRequestEntry]) {
            self.streamName = streamName
            self.records = records
        }
    ...
    public struct Record: AWSShape {
        ...
        public init(approximateArrivalTimestamp: TimeStamp? = nil, sequenceNumber: String, partitionKey: String, encryptionType: EncryptionType? = nil, data: Data) {
    ...
    public struct ConsumerDescription: AWSShape {
        ...
        public init(consumerARN: String, consumerStatus: ConsumerStatus, consumerCreationTimestamp: TimeStamp, streamARN: String, consumerName: String) {
            self.consumerARN = consumerARN
            self.consumerStatus = consumerStatus
            self.consumerCreationTimestamp = consumerCreationTimestamp
            self.streamARN = streamARN
    ...
    public struct Shard: AWSShape {
        ...
        public init(shardId: String, hashKeyRange: HashKeyRange, parentShardId: String? = nil, adjacentParentShardId: String? = nil, sequenceNumberRange: SequenceNumberRange) {
            self.shardId = shardId
