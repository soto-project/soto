...
extension Kinesis {
    ...
    public struct Consumer: AWSShape {
        ...
        public init(consumerName: String, consumerARN: String, consumerStatus: ConsumerStatus, consumerCreationTimestamp: TimeStamp) {
    ...
    public struct EnableEnhancedMonitoringInput: AWSShape {
        ...
        public init(streamName: String, shardLevelMetrics: [MetricsName]) {
            self.streamName = streamName
    ...
    public struct SplitShardInput: AWSShape {
        ...
        public init(shardToSplit: String, streamName: String, newStartingHashKey: String) {
    ...
    public struct DescribeStreamConsumerInput: AWSShape {
        ...
        public init(consumerARN: String? = nil, streamARN: String? = nil, consumerName: String? = nil) {
            self.consumerARN = consumerARN
    ...
    public struct Shard: AWSShape {
        ...
        public init(parentShardId: String? = nil, hashKeyRange: HashKeyRange, shardId: String, adjacentParentShardId: String? = nil, sequenceNumberRange: SequenceNumberRange) {
    ...
    public struct StartingPosition: AWSShape {
        ...
        public init(type: ShardIteratorType, sequenceNumber: String? = nil, timestamp: TimeStamp? = nil) {
            self.`type` = `type`
    ...
    public struct GetShardIteratorInput: AWSShape {
        ...
        public init(startingSequenceNumber: String? = nil, timestamp: TimeStamp? = nil, shardIteratorType: ShardIteratorType, shardId: String, streamName: String) {
    ...
    public struct PutRecordInput: AWSShape {
        ...
        public init(partitionKey: String, data: Data, streamName: String, explicitHashKey: String? = nil, sequenceNumberForOrdering: String? = nil) {
    ...
    public struct GetRecordsOutput: AWSShape {
        ...
        public init(records: [Record], nextShardIterator: String? = nil, millisBehindLatest: Int64? = nil) {
            self.records = records
    ...
    public struct ListStreamConsumersInput: AWSShape {
        ...
        public init(maxResults: Int32? = nil, streamCreationTimestamp: TimeStamp? = nil, nextToken: String? = nil, streamARN: String) {
    ...
    public struct PutRecordOutput: AWSShape {
        ...
        public init(shardId: String, sequenceNumber: String, encryptionType: EncryptionType? = nil) {
            self.shardId = shardId
            self.sequenceNumber = sequenceNumber
            self.encryptionType = encryptionType
        }
    ...
    public struct PutRecordsOutput: AWSShape {
        ...
        public init(records: [PutRecordsResultEntry], failedRecordCount: Int32? = nil, encryptionType: EncryptionType? = nil) {
            self.records = records
    ...
    public struct UpdateShardCountInput: AWSShape {
        ...
        public init(scalingType: ScalingType, targetShardCount: Int32, streamName: String) {
    ...
    public struct MergeShardsInput: AWSShape {
        ...
        public init(shardToMerge: String, streamName: String, adjacentShardToMerge: String) {
    ...
    public struct ListShardsInput: AWSShape {
        ...
        public init(maxResults: Int32? = nil, streamCreationTimestamp: TimeStamp? = nil, nextToken: String? = nil, exclusiveStartShardId: String? = nil, streamName: String? = nil) {
            self.maxResults = maxResults
            self.streamCreationTimestamp = streamCreationTimestamp
            self.nextToken = nextToken
    ...
    public struct PutRecordsResultEntry: AWSShape {
        ...
        public init(sequenceNumber: String? = nil, shardId: String? = nil, errorCode: String? = nil, errorMessage: String? = nil) {
            self.sequenceNumber = sequenceNumber
            self.shardId = shardId
    ...
    public struct StreamDescription: AWSShape {
        ...
        public init(retentionPeriodHours: Int32, encryptionType: EncryptionType? = nil, streamCreationTimestamp: TimeStamp, keyId: String? = nil, enhancedMonitoring: [EnhancedMetrics], shards: [Shard], hasMoreShards: Bool, streamStatus: StreamStatus, streamARN: String, streamName: String) {
            self.retentionPeriodHours = retentionPeriodHours
            self.encryptionType = encryptionType
            self.streamCreationTimestamp = streamCreationTimestamp
            self.keyId = keyId
    ...
    public struct DescribeStreamInput: AWSShape {
        ...
        public init(limit: Int32? = nil, streamName: String, exclusiveStartShardId: String? = nil) {
            self.limit = limit
            self.streamName = streamName
            self.exclusiveStartShardId = exclusiveStartShardId
        }
    ...
    public struct ConsumerDescription: AWSShape {
        ...
        public init(consumerName: String, consumerARN: String, consumerStatus: ConsumerStatus, streamARN: String, consumerCreationTimestamp: TimeStamp) {
            self.consumerName = consumerName
            self.consumerARN = consumerARN
            self.consumerStatus = consumerStatus
            self.streamARN = streamARN
    ...
    public struct StartStreamEncryptionInput: AWSShape {
        ...
        public init(keyId: String, streamName: String, encryptionType: EncryptionType) {
            self.keyId = keyId
            self.streamName = streamName
            self.encryptionType = encryptionType
        }
    ...
    public struct DeleteStreamInput: AWSShape {
        ...
        public init(streamName: String, enforceConsumerDeletion: Bool? = nil) {
            self.streamName = streamName
    ...
    public struct SubscribeToShardEvent: AWSShape {
        ...
        public init(records: [Record], millisBehindLatest: Int64, continuationSequenceNumber: String) {
            self.records = records
            self.millisBehindLatest = millisBehindLatest
    ...
    public struct StreamDescriptionSummary: AWSShape {
        ...
        public init(retentionPeriodHours: Int32, encryptionType: EncryptionType? = nil, streamCreationTimestamp: TimeStamp, keyId: String? = nil, enhancedMonitoring: [EnhancedMetrics], consumerCount: Int32? = nil, openShardCount: Int32, streamStatus: StreamStatus, streamARN: String, streamName: String) {
            self.retentionPeriodHours = retentionPeriodHours
            self.encryptionType = encryptionType
            self.streamCreationTimestamp = streamCreationTimestamp
            self.keyId = keyId
    ...
    public struct SubscribeToShardInput: AWSShape {
        ...
        public init(startingPosition: StartingPosition, consumerARN: String, shardId: String) {
    ...
    public struct PutRecordsRequestEntry: AWSShape {
        ...
        public init(partitionKey: String, data: Data, explicitHashKey: String? = nil) {
            self.partitionKey = partitionKey
            self.data = data
            self.explicitHashKey = explicitHashKey
        }
