...
public struct Kinesis {
    ...
    @discardableResult public func addTagsToStream(_ input: AddTagsToStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddTagsToStream", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func createStream(_ input: CreateStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateStream", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func decreaseStreamRetentionPeriod(_ input: DecreaseStreamRetentionPeriodInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DecreaseStreamRetentionPeriod", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteStream(_ input: DeleteStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteStream", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deregisterStreamConsumer(_ input: DeregisterStreamConsumerInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeregisterStreamConsumer", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeStream(_ input: DescribeStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStreamOutput> {
        return client.execute(operation: "DescribeStream", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeStreamConsumer(_ input: DescribeStreamConsumerInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStreamConsumerOutput> {
        return client.execute(operation: "DescribeStreamConsumer", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeStreamSummary(_ input: DescribeStreamSummaryInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStreamSummaryOutput> {
        return client.execute(operation: "DescribeStreamSummary", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Disables enhanced monitoring.
    public func disableEnhancedMonitoring(_ input: DisableEnhancedMonitoringInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EnhancedMonitoringOutput> {
        return client.execute(operation: "DisableEnhancedMonitoring", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Enables enhanced Kinesis data stream monitoring for shard-level metrics.
    public func enableEnhancedMonitoring(_ input: EnableEnhancedMonitoringInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EnhancedMonitoringOutput> {
        return client.execute(operation: "EnableEnhancedMonitoring", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getRecords(_ input: GetRecordsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRecordsOutput> {
        return client.execute(operation: "GetRecords", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getShardIterator(_ input: GetShardIteratorInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetShardIteratorOutput> {
        return client.execute(operation: "GetShardIterator", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func increaseStreamRetentionPeriod(_ input: IncreaseStreamRetentionPeriodInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "IncreaseStreamRetentionPeriod", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listShards(_ input: ListShardsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListShardsOutput> {
        return client.execute(operation: "ListShards", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listStreamConsumers(_ input: ListStreamConsumersInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStreamConsumersOutput> {
        return client.execute(operation: "ListStreamConsumers", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listStreams(_ input: ListStreamsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStreamsOutput> {
        return client.execute(operation: "ListStreams", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTagsForStream(_ input: ListTagsForStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForStreamOutput> {
        return client.execute(operation: "ListTagsForStream", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func mergeShards(_ input: MergeShardsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "MergeShards", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putRecord(_ input: PutRecordInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRecordOutput> {
        return client.execute(operation: "PutRecord", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putRecords(_ input: PutRecordsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRecordsOutput> {
        return client.execute(operation: "PutRecords", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func registerStreamConsumer(_ input: RegisterStreamConsumerInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterStreamConsumerOutput> {
        return client.execute(operation: "RegisterStreamConsumer", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func removeTagsFromStream(_ input: RemoveTagsFromStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveTagsFromStream", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func splitShard(_ input: SplitShardInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "SplitShard", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func startStreamEncryption(_ input: StartStreamEncryptionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "StartStreamEncryption", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func stopStreamEncryption(_ input: StopStreamEncryptionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "StopStreamEncryption", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func subscribeToShard(_ input: SubscribeToShardInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubscribeToShardOutput> {
        return client.execute(operation: "SubscribeToShard", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateShardCount(_ input: UpdateShardCountInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateShardCountOutput> {
        return client.execute(operation: "UpdateShardCount", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
