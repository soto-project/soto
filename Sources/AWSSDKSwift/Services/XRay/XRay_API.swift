...
public struct XRay: AWSService {
    ...
    /// return new `XRay` with new timeout value
    ...
    /// return new `XRay` logging to specified Logger
    ...
    public func batchGetTraces(_ input: BatchGetTracesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchGetTracesResult> {
        return client.execute(operation: "BatchGetTraces", path: "/Traces", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createGroup(_ input: CreateGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGroupResult> {
        return client.execute(operation: "CreateGroup", path: "/CreateGroup", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createSamplingRule(_ input: CreateSamplingRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateSamplingRuleResult> {
        return client.execute(operation: "CreateSamplingRule", path: "/CreateSamplingRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes a group resource.
    public func deleteGroup(_ input: DeleteGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteGroupResult> {
        return client.execute(operation: "DeleteGroup", path: "/DeleteGroup", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteSamplingRule(_ input: DeleteSamplingRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteSamplingRuleResult> {
        return client.execute(operation: "DeleteSamplingRule", path: "/DeleteSamplingRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getEncryptionConfig(_ input: GetEncryptionConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetEncryptionConfigResult> {
        return client.execute(operation: "GetEncryptionConfig", path: "/EncryptionConfig", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Retrieves group resource details.
    public func getGroup(_ input: GetGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetGroupResult> {
        return client.execute(operation: "GetGroup", path: "/GetGroup", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Retrieves all active group details.
    public func getGroups(_ input: GetGroupsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetGroupsResult> {
        return client.execute(operation: "GetGroups", path: "/Groups", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getSamplingRules(_ input: GetSamplingRulesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSamplingRulesResult> {
        return client.execute(operation: "GetSamplingRules", path: "/GetSamplingRules", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getSamplingStatisticSummaries(_ input: GetSamplingStatisticSummariesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSamplingStatisticSummariesResult> {
        return client.execute(operation: "GetSamplingStatisticSummaries", path: "/SamplingStatisticSummaries", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getSamplingTargets(_ input: GetSamplingTargetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSamplingTargetsResult> {
        return client.execute(operation: "GetSamplingTargets", path: "/SamplingTargets", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getServiceGraph(_ input: GetServiceGraphRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetServiceGraphResult> {
        return client.execute(operation: "GetServiceGraph", path: "/ServiceGraph", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getTimeSeriesServiceStatistics(_ input: GetTimeSeriesServiceStatisticsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTimeSeriesServiceStatisticsResult> {
        return client.execute(operation: "GetTimeSeriesServiceStatistics", path: "/TimeSeriesServiceStatistics", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getTraceGraph(_ input: GetTraceGraphRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTraceGraphResult> {
        return client.execute(operation: "GetTraceGraph", path: "/TraceGraph", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getTraceSummaries(_ input: GetTraceSummariesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTraceSummariesResult> {
        return client.execute(operation: "GetTraceSummaries", path: "/TraceSummaries", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putEncryptionConfig(_ input: PutEncryptionConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutEncryptionConfigResult> {
        return client.execute(operation: "PutEncryptionConfig", path: "/PutEncryptionConfig", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putTelemetryRecords(_ input: PutTelemetryRecordsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutTelemetryRecordsResult> {
        return client.execute(operation: "PutTelemetryRecords", path: "/TelemetryRecords", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putTraceSegments(_ input: PutTraceSegmentsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutTraceSegmentsResult> {
        return client.execute(operation: "PutTraceSegments", path: "/TraceSegments", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Updates a group resource.
    public func updateGroup(_ input: UpdateGroupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGroupResult> {
        return client.execute(operation: "UpdateGroup", path: "/UpdateGroup", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateSamplingRule(_ input: UpdateSamplingRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateSamplingRuleResult> {
        return client.execute(operation: "UpdateSamplingRule", path: "/UpdateSamplingRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
