...
public struct XRay {
    ...
    public func batchGetTraces(_ input: BatchGetTracesRequest) -> Future<BatchGetTracesResult> {
        return client.send(operation: "BatchGetTraces", path: "/Traces", httpMethod: "POST", input: input)
    }

    ///  Creates a group resource with a name and a filter expression. 
    public func createGroup(_ input: CreateGroupRequest) -> Future<CreateGroupResult> {
    ...
    public func createSamplingRule(_ input: CreateSamplingRuleRequest) -> Future<CreateSamplingRuleResult> {
        return client.send(operation: "CreateSamplingRule", path: "/CreateSamplingRule", httpMethod: "POST", input: input)
    }

    ///  Deletes a group resource.
    public func deleteGroup(_ input: DeleteGroupRequest) -> Future<DeleteGroupResult> {
        return client.send(operation: "DeleteGroup", path: "/DeleteGroup", httpMethod: "POST", input: input)
    }

    ///  Deletes a sampling rule.
    public func deleteSamplingRule(_ input: DeleteSamplingRuleRequest) -> Future<DeleteSamplingRuleResult> {
        return client.send(operation: "DeleteSamplingRule", path: "/DeleteSamplingRule", httpMethod: "POST", input: input)
    }

    ///  Retrieves the current encryption configuration for X-Ray data.
    public func getEncryptionConfig(_ input: GetEncryptionConfigRequest) -> Future<GetEncryptionConfigResult> {
        return client.send(operation: "GetEncryptionConfig", path: "/EncryptionConfig", httpMethod: "POST", input: input)
    }

    ///  Retrieves group resource details.
    public func getGroup(_ input: GetGroupRequest) -> Future<GetGroupResult> {
        return client.send(operation: "GetGroup", path: "/GetGroup", httpMethod: "POST", input: input)
    }

    ///  Retrieves all active group details.
    public func getGroups(_ input: GetGroupsRequest) -> Future<GetGroupsResult> {
        return client.send(operation: "GetGroups", path: "/Groups", httpMethod: "POST", input: input)
    }

    ///  Retrieves all sampling rules.
    public func getSamplingRules(_ input: GetSamplingRulesRequest) -> Future<GetSamplingRulesResult> {
        return client.send(operation: "GetSamplingRules", path: "/GetSamplingRules", httpMethod: "POST", input: input)
    }

    ///  Retrieves information about recent sampling results for all sampling rules.
    public func getSamplingStatisticSummaries(_ input: GetSamplingStatisticSummariesRequest) -> Future<GetSamplingStatisticSummariesResult> {
    ...
    public func getSamplingTargets(_ input: GetSamplingTargetsRequest) -> Future<GetSamplingTargetsResult> {
    ...
    public func getServiceGraph(_ input: GetServiceGraphRequest) -> Future<GetServiceGraphResult> {
        return client.send(operation: "GetServiceGraph", path: "/ServiceGraph", httpMethod: "POST", input: input)
    }

    ///  Get an aggregation of service statistics defined by a specific time range.
    public func getTimeSeriesServiceStatistics(_ input: GetTimeSeriesServiceStatisticsRequest) -> Future<GetTimeSeriesServiceStatisticsResult> {
    ...
    public func getTraceGraph(_ input: GetTraceGraphRequest) -> Future<GetTraceGraphResult> {
    ...
    public func getTraceSummaries(_ input: GetTraceSummariesRequest) -> Future<GetTraceSummariesResult> {
        return client.send(operation: "GetTraceSummaries", path: "/TraceSummaries", httpMethod: "POST", input: input)
    }

    ///  Updates the encryption configuration for X-Ray data.
    public func putEncryptionConfig(_ input: PutEncryptionConfigRequest) -> Future<PutEncryptionConfigResult> {
        return client.send(operation: "PutEncryptionConfig", path: "/PutEncryptionConfig", httpMethod: "POST", input: input)
    }

    ///  Used by the AWS X-Ray daemon to upload telemetry.
    public func putTelemetryRecords(_ input: PutTelemetryRecordsRequest) -> Future<PutTelemetryRecordsResult> {
    ...
    public func putTraceSegments(_ input: PutTraceSegmentsRequest) -> Future<PutTraceSegmentsResult> {
        return client.send(operation: "PutTraceSegments", path: "/TraceSegments", httpMethod: "POST", input: input)
    }

    ///  Updates a group resource.
    public func updateGroup(_ input: UpdateGroupRequest) -> Future<UpdateGroupResult> {
        return client.send(operation: "UpdateGroup", path: "/UpdateGroup", httpMethod: "POST", input: input)
    }

    ///  Modifies a sampling rule's configuration.
    public func updateSamplingRule(_ input: UpdateSamplingRuleRequest) -> Future<UpdateSamplingRuleResult> {
