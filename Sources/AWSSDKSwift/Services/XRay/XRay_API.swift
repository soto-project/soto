...
public struct XRay {
    ...
    public func getSamplingRules(_ input: GetSamplingRulesRequest) throws -> GetSamplingRulesResult {
    ...
    public func updateSamplingRule(_ input: UpdateSamplingRuleRequest) throws -> UpdateSamplingRuleResult {
    ...
    public func createSamplingRule(_ input: CreateSamplingRuleRequest) throws -> CreateSamplingRuleResult {
        return try client.send(operation: "CreateSamplingRule", path: "/CreateSamplingRule", httpMethod: "POST", input: input)
    }

    ///  Deletes a group resource.
    public func deleteGroup(_ input: DeleteGroupRequest) throws -> DeleteGroupResult {
        return try client.send(operation: "DeleteGroup", path: "/DeleteGroup", httpMethod: "POST", input: input)
    }

    ///  Retrieves information about recent sampling results for all sampling rules.
    public func getSamplingStatisticSummaries(_ input: GetSamplingStatisticSummariesRequest) throws -> GetSamplingStatisticSummariesResult {
    ...
    public func createGroup(_ input: CreateGroupRequest) throws -> CreateGroupResult {
    ...
    public func getGroup(_ input: GetGroupRequest) throws -> GetGroupResult {
    ...
    public func getGroups(_ input: GetGroupsRequest) throws -> GetGroupsResult {
        return try client.send(operation: "GetGroups", path: "/Groups", httpMethod: "POST", input: input)
    }

    ///  Deletes a sampling rule.
    public func deleteSamplingRule(_ input: DeleteSamplingRuleRequest) throws -> DeleteSamplingRuleResult {
        return try client.send(operation: "DeleteSamplingRule", path: "/DeleteSamplingRule", httpMethod: "POST", input: input)
    }

    ///  Updates a group resource.
    public func updateGroup(_ input: UpdateGroupRequest) throws -> UpdateGroupResult {
        return try client.send(operation: "UpdateGroup", path: "/UpdateGroup", httpMethod: "POST", input: input)
    }

    ///  Requests a sampling quota for rules that the service is using to sample requests. 
    public func getSamplingTargets(_ input: GetSamplingTargetsRequest) throws -> GetSamplingTargetsResult {
