...
extension XRay {
    ...
    public func batchGetTracesPaginator(_ input: BatchGetTracesRequest) -> Future<[Trace]> {
        return client.paginate(input: input, command: batchGetTraces, resultKey: "traces", tokenKey: "nextToken")
    }
    
    ///  Retrieves all active group details.
    public func getGroupsPaginator(_ input: GetGroupsRequest) -> Future<[GroupSummary]> {
        return client.paginate(input: input, command: getGroups, resultKey: "groups", tokenKey: "nextToken")
    }
    
    ///  Retrieves all sampling rules.
    public func getSamplingRulesPaginator(_ input: GetSamplingRulesRequest) -> Future<[SamplingRuleRecord]> {
    ...
    public func getSamplingStatisticSummariesPaginator(_ input: GetSamplingStatisticSummariesRequest) -> Future<[SamplingStatisticSummary]> {
    ...
    public func getServiceGraphPaginator(_ input: GetServiceGraphRequest) -> Future<[Service]> {
        return client.paginate(input: input, command: getServiceGraph, resultKey: "services", tokenKey: "nextToken")
    }
    
    ///  Get an aggregation of service statistics defined by a specific time range.
    public func getTimeSeriesServiceStatisticsPaginator(_ input: GetTimeSeriesServiceStatisticsRequest) -> Future<[TimeSeriesServiceStatistics]> {
    ...
    public func getTraceGraphPaginator(_ input: GetTraceGraphRequest) -> Future<[Service]> {
    ...
    public func getTraceSummariesPaginator(_ input: GetTraceSummariesRequest) -> Future<[TraceSummary]> {
