...
extension XRay {
    ...
    public func batchGetTracesPaginator(
        ...
        onPage: @escaping (BatchGetTracesResult,
    ...
    public func getGroupsPaginator(
        ...
        onPage: @escaping (GetGroupsResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getSamplingRulesPaginator(
        ...
        onPage: @escaping (GetSamplingRulesResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getSamplingStatisticSummariesPaginator(
        ...
        onPage: @escaping (GetSamplingStatisticSummariesResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getServiceGraphPaginator(
        ...
        onPage: @escaping (GetServiceGraphResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getTimeSeriesServiceStatisticsPaginator(
        ...
        onPage: @escaping (GetTimeSeriesServiceStatisticsResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getTraceGraphPaginator(
        ...
        onPage: @escaping (GetTraceGraphResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getTraceSummariesPaginator(
        ...
        onPage: @escaping (GetTraceSummariesResult,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
