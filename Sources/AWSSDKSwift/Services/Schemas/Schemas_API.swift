...
public struct Schemas: AWSService {
    ...
    /// return new `Schemas` with new timeout value
    ...
    /// return new `Schemas` logging to specified Logger
    ...
    public func createDiscoverer(_ input: CreateDiscovererRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDiscovererResponse> {
        return client.execute(operation: "CreateDiscoverer", path: "/v1/discoverers", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createRegistry(_ input: CreateRegistryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateRegistryResponse> {
        return client.execute(operation: "CreateRegistry", path: "/v1/registries/name/{registryName}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createSchema(_ input: CreateSchemaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateSchemaResponse> {
        return client.execute(operation: "CreateSchema", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteDiscoverer(_ input: DeleteDiscovererRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDiscoverer", path: "/v1/discoverers/id/{discovererId}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteRegistry(_ input: DeleteRegistryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteRegistry", path: "/v1/registries/name/{registryName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteResourcePolicy(_ input: DeleteResourcePolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteResourcePolicy", path: "/v1/policy", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteSchema(_ input: DeleteSchemaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSchema", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteSchemaVersion(_ input: DeleteSchemaVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSchemaVersion", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}/version/{schemaVersion}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeCodeBinding(_ input: DescribeCodeBindingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCodeBindingResponse> {
        return client.execute(operation: "DescribeCodeBinding", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}/language/{language}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeDiscoverer(_ input: DescribeDiscovererRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDiscovererResponse> {
        return client.execute(operation: "DescribeDiscoverer", path: "/v1/discoverers/id/{discovererId}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeRegistry(_ input: DescribeRegistryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRegistryResponse> {
        return client.execute(operation: "DescribeRegistry", path: "/v1/registries/name/{registryName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeSchema(_ input: DescribeSchemaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSchemaResponse> {
        return client.execute(operation: "DescribeSchema", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getCodeBindingSource(_ input: GetCodeBindingSourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCodeBindingSourceResponse> {
        return client.execute(operation: "GetCodeBindingSource", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}/language/{language}/source", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getDiscoveredSchema(_ input: GetDiscoveredSchemaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDiscoveredSchemaResponse> {
        return client.execute(operation: "GetDiscoveredSchema", path: "/v1/discover", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getResourcePolicy(_ input: GetResourcePolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetResourcePolicyResponse> {
        return client.execute(operation: "GetResourcePolicy", path: "/v1/policy", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listDiscoverers(_ input: ListDiscoverersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDiscoverersResponse> {
        return client.execute(operation: "ListDiscoverers", path: "/v1/discoverers", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listRegistries(_ input: ListRegistriesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListRegistriesResponse> {
        return client.execute(operation: "ListRegistries", path: "/v1/registries", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listSchemaVersions(_ input: ListSchemaVersionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSchemaVersionsResponse> {
        return client.execute(operation: "ListSchemaVersions", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}/versions", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }

    ///  List the schemas.
    public func listSchemas(_ input: ListSchemasRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSchemasResponse> {
        return client.execute(operation: "ListSchemas", path: "/v1/registries/name/{registryName}/schemas", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putCodeBinding(_ input: PutCodeBindingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutCodeBindingResponse> {
        return client.execute(operation: "PutCodeBinding", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}/language/{language}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putResourcePolicy(_ input: PutResourcePolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutResourcePolicyResponse> {
        return client.execute(operation: "PutResourcePolicy", path: "/v1/policy", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Search the schemas
    public func searchSchemas(_ input: SearchSchemasRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchSchemasResponse> {
        return client.execute(operation: "SearchSchemas", path: "/v1/registries/name/{registryName}/schemas/search", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startDiscoverer(_ input: StartDiscovererRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDiscovererResponse> {
        return client.execute(operation: "StartDiscoverer", path: "/v1/discoverers/id/{discovererId}/start", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func stopDiscoverer(_ input: StopDiscovererRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopDiscovererResponse> {
        return client.execute(operation: "StopDiscoverer", path: "/v1/discoverers/id/{discovererId}/stop", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateDiscoverer(_ input: UpdateDiscovererRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDiscovererResponse> {
        return client.execute(operation: "UpdateDiscoverer", path: "/v1/discoverers/id/{discovererId}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateRegistry(_ input: UpdateRegistryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateRegistryResponse> {
        return client.execute(operation: "UpdateRegistry", path: "/v1/registries/name/{registryName}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateSchema(_ input: UpdateSchemaRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateSchemaResponse> {
        return client.execute(operation: "UpdateSchema", path: "/v1/registries/name/{registryName}/schemas/name/{schemaName}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
}
