...
public struct ResourceGroups: AWSService {
    ...
    public func deleteGroup(_ input: DeleteGroupInput) -> EventLoopFuture<DeleteGroupOutput> {
        return client.execute(operation: "DeleteGroup", path: "/groups/{GroupName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Returns information about a specified resource group.
    public func getGroup(_ input: GetGroupInput) -> EventLoopFuture<GetGroupOutput> {
        return client.execute(operation: "GetGroup", path: "/groups/{GroupName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Returns the resource query associated with the specified resource group.
    public func getGroupQuery(_ input: GetGroupQueryInput) -> EventLoopFuture<GetGroupQueryOutput> {
        return client.execute(operation: "GetGroupQuery", path: "/groups/{GroupName}/query", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listGroupResources(_ input: ListGroupResourcesInput) -> EventLoopFuture<ListGroupResourcesOutput> {
        return client.execute(operation: "ListGroupResources", path: "/groups/{GroupName}/resource-identifiers-list", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateGroup(_ input: UpdateGroupInput) -> EventLoopFuture<UpdateGroupOutput> {
        return client.execute(operation: "UpdateGroup", path: "/groups/{GroupName}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Updates the resource query of a group.
    public func updateGroupQuery(_ input: UpdateGroupQueryInput) -> EventLoopFuture<UpdateGroupQueryOutput> {
        return client.execute(operation: "UpdateGroupQuery", path: "/groups/{GroupName}/query", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
}
