...
extension ResourceGroups {
    ...
    public struct CreateGroupOutput: AWSShape {
        ...
        public init(group: Group? = nil, tags: [String: String]? = nil, resourceQuery: ResourceQuery? = nil) {
            self.group = group
            self.tags = tags
            self.resourceQuery = resourceQuery
        }
    ...
    public struct CreateGroupInput: AWSShape {
        ...
        public init(name: String, resourceQuery: ResourceQuery, description: String? = nil, tags: [String: String]? = nil) {
            self.name = name
            self.resourceQuery = resourceQuery
            self.description = description
            self.tags = tags
    ...
    public struct ListGroupsOutput: AWSShape {
        ...
        public init(groups: [Group]? = nil, groupIdentifiers: [GroupIdentifier]? = nil, nextToken: String? = nil) {
            self.groups = groups
    ...
    public struct ListGroupResourcesInput: AWSShape {
        ...
        public init(maxResults: Int32? = nil, filters: [ResourceFilter]? = nil, nextToken: String? = nil, groupName: String) {
            self.maxResults = maxResults
            self.filters = filters
            self.nextToken = nextToken
            self.groupName = groupName
