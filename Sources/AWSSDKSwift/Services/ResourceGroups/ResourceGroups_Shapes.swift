...
extension ResourceGroups {
    ...
    public struct Group: AWSShape {
        ...
        public init(groupArn: String, name: String, description: String? = nil) {
    ...
    public struct SearchResourcesOutput: AWSShape {
        ...
        public init(nextToken: String? = nil, resourceIdentifiers: [ResourceIdentifier]? = nil, queryErrors: [QueryError]? = nil) {
            self.nextToken = nextToken
    ...
    public struct ListGroupResourcesInput: AWSShape {
        ...
        public init(groupName: String, maxResults: Int32? = nil, filters: [ResourceFilter]? = nil, nextToken: String? = nil) {
            self.groupName = groupName
            self.maxResults = maxResults
            self.filters = filters
            self.nextToken = nextToken
    ...
    public struct CreateGroupInput: AWSShape {
        ...
        public init(resourceQuery: ResourceQuery, description: String? = nil, tags: [String: String]? = nil, name: String) {
            self.resourceQuery = resourceQuery
            self.description = description
            self.tags = tags
            self.name = name
    ...
    public struct ListGroupResourcesOutput: AWSShape {
        ...
        public init(queryErrors: [QueryError]? = nil, nextToken: String? = nil, resourceIdentifiers: [ResourceIdentifier]? = nil) {
            self.queryErrors = queryErrors
            self.nextToken = nextToken
            self.resourceIdentifiers = resourceIdentifiers
        }
    ...
    public struct ListGroupsOutput: AWSShape {
        ...
        public init(nextToken: String? = nil, groupIdentifiers: [GroupIdentifier]? = nil, groups: [Group]? = nil) {
            self.nextToken = nextToken
