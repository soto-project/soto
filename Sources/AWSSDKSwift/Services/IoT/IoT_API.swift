...
public struct IoT {
    ...
    public func getIndexingConfiguration(_ input: GetIndexingConfigurationRequest) throws -> EventLoopFuture<GetIndexingConfigurationResponse> {
        return try client.send(operation: "GetIndexingConfiguration", path: "/indexing/config", httpMethod: "GET", input: input)
    }

    ///  Lists the things associated with the specified principal.
    public func listPrincipalThings(_ input: ListPrincipalThingsRequest) throws -> EventLoopFuture<ListPrincipalThingsResponse> {
        return try client.send(operation: "ListPrincipalThings", path: "/principals/things", httpMethod: "GET", input: input)
    }

    ///  Updates the groups to which the thing belongs.
    public func updateThingGroupsForThing(_ input: UpdateThingGroupsForThingRequest) throws -> EventLoopFuture<UpdateThingGroupsForThingResponse> {
    ...
    public func describeStream(_ input: DescribeStreamRequest) throws -> EventLoopFuture<DescribeStreamResponse> {
        return try client.send(operation: "DescribeStream", path: "/streams/{streamId}", httpMethod: "GET", input: input)
    }

    ///  Updates a Device Defender security profile.
    public func updateSecurityProfile(_ input: UpdateSecurityProfileRequest) throws -> EventLoopFuture<UpdateSecurityProfileResponse> {
    ...
    public func stopThingRegistrationTask(_ input: StopThingRegistrationTaskRequest) throws -> EventLoopFuture<StopThingRegistrationTaskResponse> {
    ...
    public func updateRoleAlias(_ input: UpdateRoleAliasRequest) throws -> EventLoopFuture<UpdateRoleAliasResponse> {
        return try client.send(operation: "UpdateRoleAlias", path: "/role-aliases/{roleAlias}", httpMethod: "PUT", input: input)
    }

    ///  Starts an on-demand Device Defender audit.
    public func startOnDemandAuditTask(_ input: StartOnDemandAuditTaskRequest) throws -> EventLoopFuture<StartOnDemandAuditTaskResponse> {
        return try client.send(operation: "StartOnDemandAuditTask", path: "/audit/tasks", httpMethod: "POST", input: input)
    }

    ///  Describes a registered CA certificate.
    public func describeCACertificate(_ input: DescribeCACertificateRequest) throws -> EventLoopFuture<DescribeCACertificateResponse> {
    ...
    public func updateAccountAuditConfiguration(_ input: UpdateAccountAuditConfigurationRequest) throws -> EventLoopFuture<UpdateAccountAuditConfigurationResponse> {
    ...
    public func updateBillingGroup(_ input: UpdateBillingGroupRequest) throws -> EventLoopFuture<UpdateBillingGroupResponse> {
    ...
    public func createThingType(_ input: CreateThingTypeRequest) throws -> EventLoopFuture<CreateThingTypeResponse> {
    ...
    public func updateStream(_ input: UpdateStreamRequest) throws -> EventLoopFuture<UpdateStreamResponse> {
    ...
    public func listRoleAliases(_ input: ListRoleAliasesRequest) throws -> EventLoopFuture<ListRoleAliasesResponse> {
    ...
    public func createSecurityProfile(_ input: CreateSecurityProfileRequest) throws -> EventLoopFuture<CreateSecurityProfileResponse> {
    ...
    public func associateTargetsWithJob(_ input: AssociateTargetsWithJobRequest) throws -> EventLoopFuture<AssociateTargetsWithJobResponse> {
        return try client.send(operation: "AssociateTargetsWithJob", path: "/jobs/{jobId}/targets", httpMethod: "POST", input: input)
    }

    ///  Deletes a role alias
    public func deleteRoleAlias(_ input: DeleteRoleAliasRequest) throws -> EventLoopFuture<DeleteRoleAliasResponse> {
    ...
    public func listCACertificates(_ input: ListCACertificatesRequest) throws -> EventLoopFuture<ListCACertificatesResponse> {
    ...
    public func createPolicyVersion(_ input: CreatePolicyVersionRequest) throws -> EventLoopFuture<CreatePolicyVersionResponse> {
        return try client.send(operation: "CreatePolicyVersion", path: "/policies/{policyName}/version", httpMethod: "POST", input: input)
    }

    ///  Creates a billing group.
    public func createBillingGroup(_ input: CreateBillingGroupRequest) throws -> EventLoopFuture<CreateBillingGroupResponse> {
    ...
    public func clearDefaultAuthorizer(_ input: ClearDefaultAuthorizerRequest) throws -> EventLoopFuture<ClearDefaultAuthorizerResponse> {
    ...
    public func listViolationEvents(_ input: ListViolationEventsRequest) throws -> EventLoopFuture<ListViolationEventsResponse> {
        return try client.send(operation: "ListViolationEvents", path: "/violation-events", httpMethod: "GET", input: input)
    }

    ///  Updates an authorizer.
    public func updateAuthorizer(_ input: UpdateAuthorizerRequest) throws -> EventLoopFuture<UpdateAuthorizerResponse> {
        return try client.send(operation: "UpdateAuthorizer", path: "/authorizer/{authorizerName}", httpMethod: "PUT", input: input)
    }

    ///  Update a thing group.
    public func updateThingGroup(_ input: UpdateThingGroupRequest) throws -> EventLoopFuture<UpdateThingGroupResponse> {
    ...
    public func listThingGroupsForThing(_ input: ListThingGroupsForThingRequest) throws -> EventLoopFuture<ListThingGroupsForThingResponse> {
    ...
    public func createAuthorizer(_ input: CreateAuthorizerRequest) throws -> EventLoopFuture<CreateAuthorizerResponse> {
    ...
    public func listOutgoingCertificates(_ input: ListOutgoingCertificatesRequest) throws -> EventLoopFuture<ListOutgoingCertificatesResponse> {
    ...
    public func detachSecurityProfile(_ input: DetachSecurityProfileRequest) throws -> EventLoopFuture<DetachSecurityProfileResponse> {
    ...
    public func attachThingPrincipal(_ input: AttachThingPrincipalRequest) throws -> EventLoopFuture<AttachThingPrincipalResponse> {
        return try client.send(operation: "AttachThingPrincipal", path: "/things/{thingName}/principals", httpMethod: "PUT", input: input)
    }

    ///  Lists the rules for the specific topic.
    public func listTopicRules(_ input: ListTopicRulesRequest) throws -> EventLoopFuture<ListTopicRulesResponse> {
    ...
    public func listPrincipalPolicies(_ input: ListPrincipalPoliciesRequest) throws -> EventLoopFuture<ListPrincipalPoliciesResponse> {
        return try client.send(operation: "ListPrincipalPolicies", path: "/principal-policies", httpMethod: "GET", input: input)
    }

    ///  Information about the thing registration tasks.
    public func listThingRegistrationTaskReports(_ input: ListThingRegistrationTaskReportsRequest) throws -> EventLoopFuture<ListThingRegistrationTaskReportsResponse> {
    ...
    public func describeJobExecution(_ input: DescribeJobExecutionRequest) throws -> EventLoopFuture<DescribeJobExecutionResponse> {
        return try client.send(operation: "DescribeJobExecution", path: "/things/{thingName}/jobs/{jobId}", httpMethod: "GET", input: input)
    }

    ///  Describes the default authorizer.
    public func describeDefaultAuthorizer(_ input: DescribeDefaultAuthorizerRequest) throws -> EventLoopFuture<DescribeDefaultAuthorizerResponse> {
    ...
    public func searchIndex(_ input: SearchIndexRequest) throws -> EventLoopFuture<SearchIndexResponse> {
        return try client.send(operation: "SearchIndex", path: "/indices/search", httpMethod: "POST", input: input)
    }

    ///  List targets for the specified policy.
    public func listTargetsForPolicy(_ input: ListTargetsForPolicyRequest) throws -> EventLoopFuture<ListTargetsForPolicyResponse> {
    ...
    public func cancelAuditTask(_ input: CancelAuditTaskRequest) throws -> EventLoopFuture<CancelAuditTaskResponse> {
    ...
    public func describeAuditTask(_ input: DescribeAuditTaskRequest) throws -> EventLoopFuture<DescribeAuditTaskResponse> {
        return try client.send(operation: "DescribeAuditTask", path: "/audit/tasks/{taskId}", httpMethod: "GET", input: input)
    }

    ///  Deletes a registered CA certificate.
    public func deleteCACertificate(_ input: DeleteCACertificateRequest) throws -> EventLoopFuture<DeleteCACertificateResponse> {
    ...
    public func attachSecurityProfile(_ input: AttachSecurityProfileRequest) throws -> EventLoopFuture<AttachSecurityProfileResponse> {
    ...
    public func describeRoleAlias(_ input: DescribeRoleAliasRequest) throws -> EventLoopFuture<DescribeRoleAliasResponse> {
        return try client.send(operation: "DescribeRoleAlias", path: "/role-aliases/{roleAlias}", httpMethod: "GET", input: input)
    }

    ///  Cancels a job.
    public func cancelJob(_ input: CancelJobRequest) throws -> EventLoopFuture<CancelJobResponse> {
    ...
    public func listAuditFindings(_ input: ListAuditFindingsRequest) throws -> EventLoopFuture<ListAuditFindingsResponse> {
    ...
    public func createThing(_ input: CreateThingRequest) throws -> EventLoopFuture<CreateThingResponse> {
    ...
    public func getEffectivePolicies(_ input: GetEffectivePoliciesRequest) throws -> EventLoopFuture<GetEffectivePoliciesResponse> {
        return try client.send(operation: "GetEffectivePolicies", path: "/effective-policies", httpMethod: "POST", input: input)
    }

    ///  Gets information about a scheduled audit.
    public func describeScheduledAudit(_ input: DescribeScheduledAuditRequest) throws -> EventLoopFuture<DescribeScheduledAuditResponse> {
    ...
    public func listAttachedPolicies(_ input: ListAttachedPoliciesRequest) throws -> EventLoopFuture<ListAttachedPoliciesResponse> {
    ...
    public func listThingPrincipals(_ input: ListThingPrincipalsRequest) throws -> EventLoopFuture<ListThingPrincipalsResponse> {
        return try client.send(operation: "ListThingPrincipals", path: "/things/{thingName}/principals", httpMethod: "GET", input: input)
    }

    ///  Adds a thing to a thing group.
    public func addThingToThingGroup(_ input: AddThingToThingGroupRequest) throws -> EventLoopFuture<AddThingToThingGroupResponse> {
        return try client.send(operation: "AddThingToThingGroup", path: "/thing-groups/addThingToThingGroup", httpMethod: "PUT", input: input)
    }

    ///  Lists jobs.
    public func listJobs(_ input: ListJobsRequest) throws -> EventLoopFuture<ListJobsResponse> {
        return try client.send(operation: "ListJobs", path: "/jobs", httpMethod: "GET", input: input)
    }

    ///  Deletes a thing group.
    public func deleteThingGroup(_ input: DeleteThingGroupRequest) throws -> EventLoopFuture<DeleteThingGroupResponse> {
    ...
    public func updateThing(_ input: UpdateThingRequest) throws -> EventLoopFuture<UpdateThingResponse> {
        return try client.send(operation: "UpdateThing", path: "/things/{thingName}", httpMethod: "PATCH", input: input)
    }

    ///  Gets an OTA update.
    public func getOTAUpdate(_ input: GetOTAUpdateRequest) throws -> EventLoopFuture<GetOTAUpdateResponse> {
        return try client.send(operation: "GetOTAUpdate", path: "/otaUpdates/{otaUpdateId}", httpMethod: "GET", input: input)
    }

    ///  Updates a dynamic thing group.
    public func updateDynamicThingGroup(_ input: UpdateDynamicThingGroupRequest) throws -> EventLoopFuture<UpdateDynamicThingGroupResponse> {
    ...
    public func startThingRegistrationTask(_ input: StartThingRegistrationTaskRequest) throws -> EventLoopFuture<StartThingRegistrationTaskResponse> {
    ...
    public func getTopicRule(_ input: GetTopicRuleRequest) throws -> EventLoopFuture<GetTopicRuleResponse> {
        return try client.send(operation: "GetTopicRule", path: "/rules/{ruleName}", httpMethod: "GET", input: input)
    }

    ///  Updates a scheduled audit, including what checks are performed and how often the audit takes place.
    public func updateScheduledAudit(_ input: UpdateScheduledAuditRequest) throws -> EventLoopFuture<UpdateScheduledAuditResponse> {
    ...
    public func registerCertificate(_ input: RegisterCertificateRequest) throws -> EventLoopFuture<RegisterCertificateResponse> {
        return try client.send(operation: "RegisterCertificate", path: "/certificate/register", httpMethod: "POST", input: input)
    }

    ///  Lists the existing thing types.
    public func listThingTypes(_ input: ListThingTypesRequest) throws -> EventLoopFuture<ListThingTypesResponse> {
        return try client.send(operation: "ListThingTypes", path: "/thing-types", httpMethod: "GET", input: input)
    }

    ///  Adds a thing to a billing group.
    public func addThingToBillingGroup(_ input: AddThingToBillingGroupRequest) throws -> EventLoopFuture<AddThingToBillingGroupResponse> {
    ...
    public func deleteAccountAuditConfiguration(_ input: DeleteAccountAuditConfigurationRequest) throws -> EventLoopFuture<DeleteAccountAuditConfigurationResponse> {
    ...
    public func createDynamicThingGroup(_ input: CreateDynamicThingGroupRequest) throws -> EventLoopFuture<CreateDynamicThingGroupResponse> {
    ...
    public func listStreams(_ input: ListStreamsRequest) throws -> EventLoopFuture<ListStreamsResponse> {
        return try client.send(operation: "ListStreams", path: "/streams", httpMethod: "GET", input: input)
    }

    ///  Deletes a dynamic thing group.
    public func deleteDynamicThingGroup(_ input: DeleteDynamicThingGroupRequest) throws -> EventLoopFuture<DeleteDynamicThingGroupResponse> {
    ...
    public func listThings(_ input: ListThingsRequest) throws -> EventLoopFuture<ListThingsResponse> {
        return try client.send(operation: "ListThings", path: "/things", httpMethod: "GET", input: input)
    }

    ///  Lists your policies.
    public func listPolicies(_ input: ListPoliciesRequest) throws -> EventLoopFuture<ListPoliciesResponse> {
        return try client.send(operation: "ListPolicies", path: "/policies", httpMethod: "GET", input: input)
    }

    ///  Deletes a stream.
    public func deleteStream(_ input: DeleteStreamRequest) throws -> EventLoopFuture<DeleteStreamResponse> {
        return try client.send(operation: "DeleteStream", path: "/streams/{streamId}", httpMethod: "DELETE", input: input)
    }

    ///  Lists the things in the specified group.
    public func listThingsInThingGroup(_ input: ListThingsInThingGroupRequest) throws -> EventLoopFuture<ListThingsInThingGroupResponse> {
    ...
    public func listCertificatesByCA(_ input: ListCertificatesByCARequest) throws -> EventLoopFuture<ListCertificatesByCAResponse> {
    ...
    public func deleteBillingGroup(_ input: DeleteBillingGroupRequest) throws -> EventLoopFuture<DeleteBillingGroupResponse> {
    ...
    public func removeThingFromBillingGroup(_ input: RemoveThingFromBillingGroupRequest) throws -> EventLoopFuture<RemoveThingFromBillingGroupResponse> {
    ...
    public func createScheduledAudit(_ input: CreateScheduledAuditRequest) throws -> EventLoopFuture<CreateScheduledAuditResponse> {
    ...
    public func deleteScheduledAudit(_ input: DeleteScheduledAuditRequest) throws -> EventLoopFuture<DeleteScheduledAuditResponse> {
    ...
    public func detachThingPrincipal(_ input: DetachThingPrincipalRequest) throws -> EventLoopFuture<DetachThingPrincipalResponse> {
    ...
    public func createThingGroup(_ input: CreateThingGroupRequest) throws -> EventLoopFuture<CreateThingGroupResponse> {
        return try client.send(operation: "CreateThingGroup", path: "/thing-groups/{thingGroupName}", httpMethod: "POST", input: input)
    }

    ///  Describes a job.
    public func describeJob(_ input: DescribeJobRequest) throws -> EventLoopFuture<DescribeJobResponse> {
        return try client.send(operation: "DescribeJob", path: "/jobs/{jobId}", httpMethod: "GET", input: input)
    }

    ///  Lists the targets (thing groups) associated with a given Device Defender security profile.
    public func listTargetsForSecurityProfile(_ input: ListTargetsForSecurityProfileRequest) throws -> EventLoopFuture<ListTargetsForSecurityProfileResponse> {
    ...
    public func createKeysAndCertificate(_ input: CreateKeysAndCertificateRequest) throws -> EventLoopFuture<CreateKeysAndCertificateResponse> {
        return try client.send(operation: "CreateKeysAndCertificate", path: "/keys-and-certificate", httpMethod: "POST", input: input)
    }

    ///  Describes a bulk thing provisioning task.
    public func describeThingRegistrationTask(_ input: DescribeThingRegistrationTaskRequest) throws -> EventLoopFuture<DescribeThingRegistrationTaskResponse> {
    ...
    public func setDefaultAuthorizer(_ input: SetDefaultAuthorizerRequest) throws -> EventLoopFuture<SetDefaultAuthorizerResponse> {
        return try client.send(operation: "SetDefaultAuthorizer", path: "/default-authorizer", httpMethod: "POST", input: input)
    }

    ///  Deletes a Device Defender security profile.
    public func deleteSecurityProfile(_ input: DeleteSecurityProfileRequest) throws -> EventLoopFuture<DeleteSecurityProfileResponse> {
    ...
    public func listThingsInBillingGroup(_ input: ListThingsInBillingGroupRequest) throws -> EventLoopFuture<ListThingsInBillingGroupResponse> {
    ...
    public func listScheduledAudits(_ input: ListScheduledAuditsRequest) throws -> EventLoopFuture<ListScheduledAuditsResponse> {
        return try client.send(operation: "ListScheduledAudits", path: "/audit/scheduledaudits", httpMethod: "GET", input: input)
    }

    ///  Gets information about the specified policy version.
    public func getPolicyVersion(_ input: GetPolicyVersionRequest) throws -> EventLoopFuture<GetPolicyVersionResponse> {
    ...
    public func updateEventConfigurations(_ input: UpdateEventConfigurationsRequest) throws -> EventLoopFuture<UpdateEventConfigurationsResponse> {
    ...
    public func listJobExecutionsForThing(_ input: ListJobExecutionsForThingRequest) throws -> EventLoopFuture<ListJobExecutionsForThingResponse> {
        return try client.send(operation: "ListJobExecutionsForThing", path: "/things/{thingName}/jobs", httpMethod: "GET", input: input)
    }

    ///  Updates the search configuration.
    public func updateIndexingConfiguration(_ input: UpdateIndexingConfigurationRequest) throws -> EventLoopFuture<UpdateIndexingConfigurationResponse> {
    ...
    public func getRegistrationCode(_ input: GetRegistrationCodeRequest) throws -> EventLoopFuture<GetRegistrationCodeResponse> {
    ...
    public func createStream(_ input: CreateStreamRequest) throws -> EventLoopFuture<CreateStreamResponse> {
    ...
    public func testAuthorization(_ input: TestAuthorizationRequest) throws -> EventLoopFuture<TestAuthorizationResponse> {
    ...
    public func listPolicyPrincipals(_ input: ListPolicyPrincipalsRequest) throws -> EventLoopFuture<ListPolicyPrincipalsResponse> {
        return try client.send(operation: "ListPolicyPrincipals", path: "/policy-principals", httpMethod: "GET", input: input)
    }

    ///  Gets information about the specified certificate.
    public func describeCertificate(_ input: DescribeCertificateRequest) throws -> EventLoopFuture<DescribeCertificateResponse> {
        return try client.send(operation: "DescribeCertificate", path: "/certificates/{certificateId}", httpMethod: "GET", input: input)
    }

    ///  Gets a job document.
    public func getJobDocument(_ input: GetJobDocumentRequest) throws -> EventLoopFuture<GetJobDocumentResponse> {
        return try client.send(operation: "GetJobDocument", path: "/jobs/{jobId}/job-document", httpMethod: "GET", input: input)
    }

    ///  Creates an AWS IoT OTAUpdate on a target group of things or groups.
    public func createOTAUpdate(_ input: CreateOTAUpdateRequest) throws -> EventLoopFuture<CreateOTAUpdateResponse> {
        return try client.send(operation: "CreateOTAUpdate", path: "/otaUpdates/{otaUpdateId}", httpMethod: "POST", input: input)
    }

    ///  Deletes an authorizer.
    public func deleteAuthorizer(_ input: DeleteAuthorizerRequest) throws -> EventLoopFuture<DeleteAuthorizerResponse> {
    ...
    public func describeAccountAuditConfiguration(_ input: DescribeAccountAuditConfigurationRequest) throws -> EventLoopFuture<DescribeAccountAuditConfigurationResponse> {
    ...
    public func describeThing(_ input: DescribeThingRequest) throws -> EventLoopFuture<DescribeThingResponse> {
        return try client.send(operation: "DescribeThing", path: "/things/{thingName}", httpMethod: "GET", input: input)
    }

    ///  Describe a thing group.
    public func describeThingGroup(_ input: DescribeThingGroupRequest) throws -> EventLoopFuture<DescribeThingGroupResponse> {
    ...
    public func deleteThing(_ input: DeleteThingRequest) throws -> EventLoopFuture<DeleteThingResponse> {
    ...
    public func deprecateThingType(_ input: DeprecateThingTypeRequest) throws -> EventLoopFuture<DeprecateThingTypeResponse> {
    ...
    public func deleteThingType(_ input: DeleteThingTypeRequest) throws -> EventLoopFuture<DeleteThingTypeResponse> {
    ...
    public func transferCertificate(_ input: TransferCertificateRequest) throws -> EventLoopFuture<TransferCertificateResponse> {
    ...
    public func validateSecurityProfileBehaviors(_ input: ValidateSecurityProfileBehaviorsRequest) throws -> EventLoopFuture<ValidateSecurityProfileBehaviorsResponse> {
    ...
    public func listThingGroups(_ input: ListThingGroupsRequest) throws -> EventLoopFuture<ListThingGroupsResponse> {
        return try client.send(operation: "ListThingGroups", path: "/thing-groups", httpMethod: "GET", input: input)
    }

    ///  Gets information about the specified thing type.
    public func describeThingType(_ input: DescribeThingTypeRequest) throws -> EventLoopFuture<DescribeThingTypeResponse> {
    ...
    public func createCertificateFromCsr(_ input: CreateCertificateFromCsrRequest) throws -> EventLoopFuture<CreateCertificateFromCsrResponse> {
    ...
    public func getLoggingOptions(_ input: GetLoggingOptionsRequest) throws -> EventLoopFuture<GetLoggingOptionsResponse> {
        return try client.send(operation: "GetLoggingOptions", path: "/loggingOptions", httpMethod: "GET", input: input)
    }

    ///  Creates a role alias.
    public func createRoleAlias(_ input: CreateRoleAliasRequest) throws -> EventLoopFuture<CreateRoleAliasResponse> {
    ...
    public func listAuditTasks(_ input: ListAuditTasksRequest) throws -> EventLoopFuture<ListAuditTasksResponse> {
        return try client.send(operation: "ListAuditTasks", path: "/audit/tasks", httpMethod: "GET", input: input)
    }

    ///  Returns a unique endpoint specific to the AWS account making the call.
    public func describeEndpoint(_ input: DescribeEndpointRequest) throws -> EventLoopFuture<DescribeEndpointResponse> {
    ...
    public func listSecurityProfiles(_ input: ListSecurityProfilesRequest) throws -> EventLoopFuture<ListSecurityProfilesResponse> {
        return try client.send(operation: "ListSecurityProfiles", path: "/security-profiles", httpMethod: "GET", input: input)
    }

    ///  Lists the authorizers registered in your account.
    public func listAuthorizers(_ input: ListAuthorizersRequest) throws -> EventLoopFuture<ListAuthorizersResponse> {
        return try client.send(operation: "ListAuthorizers", path: "/authorizers/", httpMethod: "GET", input: input)
    }

    ///  Lists the billing groups you have created.
    public func listBillingGroups(_ input: ListBillingGroupsRequest) throws -> EventLoopFuture<ListBillingGroupsResponse> {
    ...
    public func deleteRegistrationCode(_ input: DeleteRegistrationCodeRequest) throws -> EventLoopFuture<DeleteRegistrationCodeResponse> {
        return try client.send(operation: "DeleteRegistrationCode", path: "/registrationcode", httpMethod: "DELETE", input: input)
    }

    ///  Remove the specified thing from the specified group.
    public func removeThingFromThingGroup(_ input: RemoveThingFromThingGroupRequest) throws -> EventLoopFuture<RemoveThingFromThingGroupResponse> {
    ...
    public func deleteOTAUpdate(_ input: DeleteOTAUpdateRequest) throws -> EventLoopFuture<DeleteOTAUpdateResponse> {
    ...
    public func listSecurityProfilesForTarget(_ input: ListSecurityProfilesForTargetRequest) throws -> EventLoopFuture<ListSecurityProfilesForTargetResponse> {
    ...
    public func describeIndex(_ input: DescribeIndexRequest) throws -> EventLoopFuture<DescribeIndexResponse> {
    ...
    public func listCertificates(_ input: ListCertificatesRequest) throws -> EventLoopFuture<ListCertificatesResponse> {
    ...
    public func registerCACertificate(_ input: RegisterCACertificateRequest) throws -> EventLoopFuture<RegisterCACertificateResponse> {
        return try client.send(operation: "RegisterCACertificate", path: "/cacertificate", httpMethod: "POST", input: input)
    }

    ///  Lists OTA updates.
    public func listOTAUpdates(_ input: ListOTAUpdatesRequest) throws -> EventLoopFuture<ListOTAUpdatesResponse> {
        return try client.send(operation: "ListOTAUpdates", path: "/otaUpdates", httpMethod: "GET", input: input)
    }

    ///  Provisions a thing.
    public func registerThing(_ input: RegisterThingRequest) throws -> EventLoopFuture<RegisterThingResponse> {
        return try client.send(operation: "RegisterThing", path: "/things", httpMethod: "POST", input: input)
    }

    ///  List bulk thing provisioning tasks.
    public func listThingRegistrationTasks(_ input: ListThingRegistrationTasksRequest) throws -> EventLoopFuture<ListThingRegistrationTasksResponse> {
    ...
    public func listJobExecutionsForJob(_ input: ListJobExecutionsForJobRequest) throws -> EventLoopFuture<ListJobExecutionsForJobResponse> {
    ...
    public func createPolicy(_ input: CreatePolicyRequest) throws -> EventLoopFuture<CreatePolicyResponse> {
        return try client.send(operation: "CreatePolicy", path: "/policies/{policyName}", httpMethod: "POST", input: input)
    }

    ///  Lists logging levels.
    public func listV2LoggingLevels(_ input: ListV2LoggingLevelsRequest) throws -> EventLoopFuture<ListV2LoggingLevelsResponse> {
        return try client.send(operation: "ListV2LoggingLevels", path: "/v2LoggingLevel", httpMethod: "GET", input: input)
    }

    ///  Gets the fine grained logging options.
    public func getV2LoggingOptions(_ input: GetV2LoggingOptionsRequest) throws -> EventLoopFuture<GetV2LoggingOptionsResponse> {
        return try client.send(operation: "GetV2LoggingOptions", path: "/v2LoggingOptions", httpMethod: "GET", input: input)
    }

    ///  Gets information about a Device Defender security profile.
    public func describeSecurityProfile(_ input: DescribeSecurityProfileRequest) throws -> EventLoopFuture<DescribeSecurityProfileResponse> {
    ...
    public func listPolicyVersions(_ input: ListPolicyVersionsRequest) throws -> EventLoopFuture<ListPolicyVersionsResponse> {
        return try client.send(operation: "ListPolicyVersions", path: "/policies/{policyName}/version", httpMethod: "GET", input: input)
    }

    ///  Lists the search indices.
    public func listIndices(_ input: ListIndicesRequest) throws -> EventLoopFuture<ListIndicesResponse> {
        return try client.send(operation: "ListIndices", path: "/indices", httpMethod: "GET", input: input)
    }

    ///  Returns information about a billing group.
    public func describeBillingGroup(_ input: DescribeBillingGroupRequest) throws -> EventLoopFuture<DescribeBillingGroupResponse> {
    ...
    public func describeEventConfigurations(_ input: DescribeEventConfigurationsRequest) throws -> EventLoopFuture<DescribeEventConfigurationsResponse> {
    ...
    public func getPolicy(_ input: GetPolicyRequest) throws -> EventLoopFuture<GetPolicyResponse> {
    ...
    public func describeAuthorizer(_ input: DescribeAuthorizerRequest) throws -> EventLoopFuture<DescribeAuthorizerResponse> {
    ...
    public func listActiveViolations(_ input: ListActiveViolationsRequest) throws -> EventLoopFuture<ListActiveViolationsResponse> {
