...
public struct IoT: AWSService {
    ...
    public func createAuditSuppression(_ input: CreateAuditSuppressionRequest) -> EventLoopFuture<CreateAuditSuppressionResponse> {
        return client.execute(operation: "CreateAuditSuppression", path: "/audit/suppressions/create", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteAuditSuppression(_ input: DeleteAuditSuppressionRequest) -> EventLoopFuture<DeleteAuditSuppressionResponse> {
        return client.execute(operation: "DeleteAuditSuppression", path: "/audit/suppressions/delete", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAuditSuppression(_ input: DescribeAuditSuppressionRequest) -> EventLoopFuture<DescribeAuditSuppressionResponse> {
        return client.execute(operation: "DescribeAuditSuppression", path: "/audit/suppressions/describe", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAuditSuppressions(_ input: ListAuditSuppressionsRequest) -> EventLoopFuture<ListAuditSuppressionsResponse> {
        return client.execute(operation: "ListAuditSuppressions", path: "/audit/suppressions/list", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateAuditSuppression(_ input: UpdateAuditSuppressionRequest) -> EventLoopFuture<UpdateAuditSuppressionResponse> {
        return client.execute(operation: "UpdateAuditSuppression", path: "/audit/suppressions/update", httpMethod: .PATCH, input: input, config: self.config, context: self.context)
    }
