...
public struct ServiceCatalog {
    ...
    public func acceptPortfolioShare(_ input: AcceptPortfolioShareInput) -> Future<AcceptPortfolioShareOutput> {
        return client.send(operation: "AcceptPortfolioShare", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified budget with the specified resource.
    public func associateBudgetWithResource(_ input: AssociateBudgetWithResourceInput) -> Future<AssociateBudgetWithResourceOutput> {
        return client.send(operation: "AssociateBudgetWithResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified principal ARN with the specified portfolio.
    public func associatePrincipalWithPortfolio(_ input: AssociatePrincipalWithPortfolioInput) -> Future<AssociatePrincipalWithPortfolioOutput> {
        return client.send(operation: "AssociatePrincipalWithPortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified product with the specified portfolio.
    public func associateProductWithPortfolio(_ input: AssociateProductWithPortfolioInput) -> Future<AssociateProductWithPortfolioOutput> {
        return client.send(operation: "AssociateProductWithPortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates a self-service action with a provisioning artifact.
    public func associateServiceActionWithProvisioningArtifact(_ input: AssociateServiceActionWithProvisioningArtifactInput) -> Future<AssociateServiceActionWithProvisioningArtifactOutput> {
    ...
    public func associateTagOptionWithResource(_ input: AssociateTagOptionWithResourceInput) -> Future<AssociateTagOptionWithResourceOutput> {
        return client.send(operation: "AssociateTagOptionWithResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates multiple self-service actions with provisioning artifacts.
    public func batchAssociateServiceActionWithProvisioningArtifact(_ input: BatchAssociateServiceActionWithProvisioningArtifactInput) -> Future<BatchAssociateServiceActionWithProvisioningArtifactOutput> {
    ...
    public func batchDisassociateServiceActionFromProvisioningArtifact(_ input: BatchDisassociateServiceActionFromProvisioningArtifactInput) -> Future<BatchDisassociateServiceActionFromProvisioningArtifactOutput> {
    ...
    public func copyProduct(_ input: CopyProductInput) -> Future<CopyProductOutput> {
        return client.send(operation: "CopyProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a constraint.
    public func createConstraint(_ input: CreateConstraintInput) -> Future<CreateConstraintOutput> {
        return client.send(operation: "CreateConstraint", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a portfolio.
    public func createPortfolio(_ input: CreatePortfolioInput) -> Future<CreatePortfolioOutput> {
    ...
    public func createPortfolioShare(_ input: CreatePortfolioShareInput) -> Future<CreatePortfolioShareOutput> {
        return client.send(operation: "CreatePortfolioShare", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a product.
    public func createProduct(_ input: CreateProductInput) -> Future<CreateProductOutput> {
    ...
    public func createProvisionedProductPlan(_ input: CreateProvisionedProductPlanInput) -> Future<CreateProvisionedProductPlanOutput> {
    ...
    public func createProvisioningArtifact(_ input: CreateProvisioningArtifactInput) -> Future<CreateProvisioningArtifactOutput> {
        return client.send(operation: "CreateProvisioningArtifact", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a self-service action.
    public func createServiceAction(_ input: CreateServiceActionInput) -> Future<CreateServiceActionOutput> {
        return client.send(operation: "CreateServiceAction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a TagOption.
    public func createTagOption(_ input: CreateTagOptionInput) -> Future<CreateTagOptionOutput> {
        return client.send(operation: "CreateTagOption", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified constraint.
    public func deleteConstraint(_ input: DeleteConstraintInput) -> Future<DeleteConstraintOutput> {
    ...
    public func deletePortfolio(_ input: DeletePortfolioInput) -> Future<DeletePortfolioOutput> {
        return client.send(operation: "DeletePortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops sharing the specified portfolio with the specified account or organization node. Shares to an organization node can only be deleted by the master account of an Organization.
    public func deletePortfolioShare(_ input: DeletePortfolioShareInput) -> Future<DeletePortfolioShareOutput> {
    ...
    public func deleteProduct(_ input: DeleteProductInput) -> Future<DeleteProductOutput> {
        return client.send(operation: "DeleteProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified plan.
    public func deleteProvisionedProductPlan(_ input: DeleteProvisionedProductPlanInput) -> Future<DeleteProvisionedProductPlanOutput> {
    ...
    public func deleteProvisioningArtifact(_ input: DeleteProvisioningArtifactInput) -> Future<DeleteProvisioningArtifactOutput> {
        return client.send(operation: "DeleteProvisioningArtifact", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a self-service action.
    public func deleteServiceAction(_ input: DeleteServiceActionInput) -> Future<DeleteServiceActionOutput> {
    ...
    public func deleteTagOption(_ input: DeleteTagOptionInput) -> Future<DeleteTagOptionOutput> {
        return client.send(operation: "DeleteTagOption", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified constraint.
    public func describeConstraint(_ input: DescribeConstraintInput) -> Future<DescribeConstraintOutput> {
        return client.send(operation: "DescribeConstraint", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the status of the specified copy product operation.
    public func describeCopyProductStatus(_ input: DescribeCopyProductStatusInput) -> Future<DescribeCopyProductStatusOutput> {
        return client.send(operation: "DescribeCopyProductStatus", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified portfolio.
    public func describePortfolio(_ input: DescribePortfolioInput) -> Future<DescribePortfolioOutput> {
        return client.send(operation: "DescribePortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the status of the specified portfolio share operation. This API can only be called by the master account in the organization.
    public func describePortfolioShareStatus(_ input: DescribePortfolioShareStatusInput) -> Future<DescribePortfolioShareStatusOutput> {
        return client.send(operation: "DescribePortfolioShareStatus", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified product.
    public func describeProduct(_ input: DescribeProductInput) -> Future<DescribeProductOutput> {
        return client.send(operation: "DescribeProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified product. This operation is run with administrator access.
    public func describeProductAsAdmin(_ input: DescribeProductAsAdminInput) -> Future<DescribeProductAsAdminOutput> {
        return client.send(operation: "DescribeProductAsAdmin", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified product.
    public func describeProductView(_ input: DescribeProductViewInput) -> Future<DescribeProductViewOutput> {
        return client.send(operation: "DescribeProductView", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified provisioned product.
    public func describeProvisionedProduct(_ input: DescribeProvisionedProductInput) -> Future<DescribeProvisionedProductOutput> {
        return client.send(operation: "DescribeProvisionedProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the resource changes for the specified plan.
    public func describeProvisionedProductPlan(_ input: DescribeProvisionedProductPlanInput) -> Future<DescribeProvisionedProductPlanOutput> {
        return client.send(operation: "DescribeProvisionedProductPlan", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the specified provisioning artifact (also known as a version) for the specified product.
    public func describeProvisioningArtifact(_ input: DescribeProvisioningArtifactInput) -> Future<DescribeProvisioningArtifactOutput> {
    ...
    public func describeProvisioningParameters(_ input: DescribeProvisioningParametersInput) -> Future<DescribeProvisioningParametersOutput> {
    ...
    public func describeRecord(_ input: DescribeRecordInput) -> Future<DescribeRecordOutput> {
        return client.send(operation: "DescribeRecord", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes a self-service action.
    public func describeServiceAction(_ input: DescribeServiceActionInput) -> Future<DescribeServiceActionOutput> {
    ...
    public func disableAWSOrganizationsAccess(_ input: DisableAWSOrganizationsAccessInput) -> Future<DisableAWSOrganizationsAccessOutput> {
        return client.send(operation: "DisableAWSOrganizationsAccess", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified budget from the specified resource.
    public func disassociateBudgetFromResource(_ input: DisassociateBudgetFromResourceInput) -> Future<DisassociateBudgetFromResourceOutput> {
        return client.send(operation: "DisassociateBudgetFromResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates a previously associated principal ARN from a specified portfolio.
    public func disassociatePrincipalFromPortfolio(_ input: DisassociatePrincipalFromPortfolioInput) -> Future<DisassociatePrincipalFromPortfolioOutput> {
        return client.send(operation: "DisassociatePrincipalFromPortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified product from the specified portfolio. 
    public func disassociateProductFromPortfolio(_ input: DisassociateProductFromPortfolioInput) -> Future<DisassociateProductFromPortfolioOutput> {
        return client.send(operation: "DisassociateProductFromPortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified self-service action association from the specified provisioning artifact.
    public func disassociateServiceActionFromProvisioningArtifact(_ input: DisassociateServiceActionFromProvisioningArtifactInput) -> Future<DisassociateServiceActionFromProvisioningArtifactOutput> {
    ...
    public func disassociateTagOptionFromResource(_ input: DisassociateTagOptionFromResourceInput) -> Future<DisassociateTagOptionFromResourceOutput> {
    ...
    public func enableAWSOrganizationsAccess(_ input: EnableAWSOrganizationsAccessInput) -> Future<EnableAWSOrganizationsAccessOutput> {
        return client.send(operation: "EnableAWSOrganizationsAccess", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provisions or modifies a product based on the resource changes for the specified plan.
    public func executeProvisionedProductPlan(_ input: ExecuteProvisionedProductPlanInput) -> Future<ExecuteProvisionedProductPlanOutput> {
        return client.send(operation: "ExecuteProvisionedProductPlan", path: "/", httpMethod: "POST", input: input)
    }

    ///  Executes a self-service action against a provisioned product.
    public func executeProvisionedProductServiceAction(_ input: ExecuteProvisionedProductServiceActionInput) -> Future<ExecuteProvisionedProductServiceActionOutput> {
    ...
    public func getAWSOrganizationsAccessStatus(_ input: GetAWSOrganizationsAccessStatusInput) -> Future<GetAWSOrganizationsAccessStatusOutput> {
        return client.send(operation: "GetAWSOrganizationsAccessStatus", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all portfolios for which sharing was accepted by this account.
    public func listAcceptedPortfolioShares(_ input: ListAcceptedPortfolioSharesInput) -> Future<ListAcceptedPortfolioSharesOutput> {
        return client.send(operation: "ListAcceptedPortfolioShares", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all the budgets associated to the specified resource.
    public func listBudgetsForResource(_ input: ListBudgetsForResourceInput) -> Future<ListBudgetsForResourceOutput> {
        return client.send(operation: "ListBudgetsForResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the constraints for the specified portfolio and product.
    public func listConstraintsForPortfolio(_ input: ListConstraintsForPortfolioInput) -> Future<ListConstraintsForPortfolioOutput> {
    ...
    public func listLaunchPaths(_ input: ListLaunchPathsInput) -> Future<ListLaunchPathsOutput> {
        return client.send(operation: "ListLaunchPaths", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the organization nodes that have access to the specified portfolio. This API can only be called by the master account in the organization.
    public func listOrganizationPortfolioAccess(_ input: ListOrganizationPortfolioAccessInput) -> Future<ListOrganizationPortfolioAccessOutput> {
        return client.send(operation: "ListOrganizationPortfolioAccess", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the account IDs that have access to the specified portfolio.
    public func listPortfolioAccess(_ input: ListPortfolioAccessInput) -> Future<ListPortfolioAccessOutput> {
        return client.send(operation: "ListPortfolioAccess", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all portfolios in the catalog.
    public func listPortfolios(_ input: ListPortfoliosInput) -> Future<ListPortfoliosOutput> {
        return client.send(operation: "ListPortfolios", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all portfolios that the specified product is associated with.
    public func listPortfoliosForProduct(_ input: ListPortfoliosForProductInput) -> Future<ListPortfoliosForProductOutput> {
        return client.send(operation: "ListPortfoliosForProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all principal ARNs associated with the specified portfolio.
    public func listPrincipalsForPortfolio(_ input: ListPrincipalsForPortfolioInput) -> Future<ListPrincipalsForPortfolioOutput> {
        return client.send(operation: "ListPrincipalsForPortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the plans for the specified provisioned product or all plans to which the user has access.
    public func listProvisionedProductPlans(_ input: ListProvisionedProductPlansInput) -> Future<ListProvisionedProductPlansOutput> {
        return client.send(operation: "ListProvisionedProductPlans", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all provisioning artifacts (also known as versions) for the specified product.
    public func listProvisioningArtifacts(_ input: ListProvisioningArtifactsInput) -> Future<ListProvisioningArtifactsOutput> {
        return client.send(operation: "ListProvisioningArtifacts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all provisioning artifacts (also known as versions) for the specified self-service action.
    public func listProvisioningArtifactsForServiceAction(_ input: ListProvisioningArtifactsForServiceActionInput) -> Future<ListProvisioningArtifactsForServiceActionOutput> {
        return client.send(operation: "ListProvisioningArtifactsForServiceAction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the specified requests or all performed requests.
    public func listRecordHistory(_ input: ListRecordHistoryInput) -> Future<ListRecordHistoryOutput> {
        return client.send(operation: "ListRecordHistory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the resources associated with the specified TagOption.
    public func listResourcesForTagOption(_ input: ListResourcesForTagOptionInput) -> Future<ListResourcesForTagOptionOutput> {
        return client.send(operation: "ListResourcesForTagOption", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all self-service actions.
    public func listServiceActions(_ input: ListServiceActionsInput) -> Future<ListServiceActionsOutput> {
        return client.send(operation: "ListServiceActions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a paginated list of self-service actions associated with the specified Product ID and Provisioning Artifact ID.
    public func listServiceActionsForProvisioningArtifact(_ input: ListServiceActionsForProvisioningArtifactInput) -> Future<ListServiceActionsForProvisioningArtifactOutput> {
    ...
    public func listStackInstancesForProvisionedProduct(_ input: ListStackInstancesForProvisionedProductInput) -> Future<ListStackInstancesForProvisionedProductOutput> {
        return client.send(operation: "ListStackInstancesForProvisionedProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the specified TagOptions or all TagOptions.
    public func listTagOptions(_ input: ListTagOptionsInput) -> Future<ListTagOptionsOutput> {
    ...
    public func provisionProduct(_ input: ProvisionProductInput) -> Future<ProvisionProductOutput> {
        return client.send(operation: "ProvisionProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Rejects an offer to share the specified portfolio.
    public func rejectPortfolioShare(_ input: RejectPortfolioShareInput) -> Future<RejectPortfolioShareOutput> {
    ...
    public func scanProvisionedProducts(_ input: ScanProvisionedProductsInput) -> Future<ScanProvisionedProductsOutput> {
        return client.send(operation: "ScanProvisionedProducts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the products to which the caller has access.
    public func searchProducts(_ input: SearchProductsInput) -> Future<SearchProductsOutput> {
        return client.send(operation: "SearchProducts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the products for the specified portfolio or all products.
    public func searchProductsAsAdmin(_ input: SearchProductsAsAdminInput) -> Future<SearchProductsAsAdminOutput> {
        return client.send(operation: "SearchProductsAsAdmin", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the provisioned products that meet the specified criteria.
    public func searchProvisionedProducts(_ input: SearchProvisionedProductsInput) -> Future<SearchProvisionedProductsOutput> {
    ...
    public func terminateProvisionedProduct(_ input: TerminateProvisionedProductInput) -> Future<TerminateProvisionedProductOutput> {
        return client.send(operation: "TerminateProvisionedProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the specified constraint.
    public func updateConstraint(_ input: UpdateConstraintInput) -> Future<UpdateConstraintOutput> {
    ...
    public func updatePortfolio(_ input: UpdatePortfolioInput) -> Future<UpdatePortfolioOutput> {
        return client.send(operation: "UpdatePortfolio", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the specified product.
    public func updateProduct(_ input: UpdateProductInput) -> Future<UpdateProductOutput> {
    ...
    public func updateProvisionedProduct(_ input: UpdateProvisionedProductInput) -> Future<UpdateProvisionedProductOutput> {
        return client.send(operation: "UpdateProvisionedProduct", path: "/", httpMethod: "POST", input: input)
    }

    ///  Requests updates to the properties of the specified provisioned product.
    public func updateProvisionedProductProperties(_ input: UpdateProvisionedProductPropertiesInput) -> Future<UpdateProvisionedProductPropertiesOutput> {
    ...
    public func updateProvisioningArtifact(_ input: UpdateProvisioningArtifactInput) -> Future<UpdateProvisioningArtifactOutput> {
        return client.send(operation: "UpdateProvisioningArtifact", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates a self-service action.
    public func updateServiceAction(_ input: UpdateServiceActionInput) -> Future<UpdateServiceActionOutput> {
        return client.send(operation: "UpdateServiceAction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the specified TagOption.
    public func updateTagOption(_ input: UpdateTagOptionInput) -> Future<UpdateTagOptionOutput> {
