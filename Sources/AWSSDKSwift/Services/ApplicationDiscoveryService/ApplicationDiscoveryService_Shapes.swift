...
extension ApplicationDiscoveryService {
    ...
    public struct StartExportTaskRequest: AWSShape {
        ...
        public init(startTime: TimeStamp? = nil, exportDataFormat: [ExportDataFormat]? = nil, filters: [ExportFilter]? = nil, endTime: TimeStamp? = nil) {
    ...
    public struct ListConfigurationsRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, nextToken: String? = nil, filters: [Filter]? = nil, orderBy: [OrderByElement]? = nil, configurationType: ConfigurationItemType) {
    ...
    public struct UpdateApplicationRequest: AWSShape {
        ...
        public init(description: String? = nil, configurationId: String, name: String? = nil) {
            self.description = description
            self.configurationId = configurationId
            self.name = name
        }
    ...
    public struct ListServerNeighborsRequest: AWSShape {
        ...
        public init(configurationId: String, maxResults: Int32? = nil, portInformationNeeded: Bool? = nil, nextToken: String? = nil, neighborConfigurationIds: [String]? = nil) {
            self.configurationId = configurationId
            self.maxResults = maxResults
    ...
    public struct GetDiscoverySummaryResponse: AWSShape {
        ...
        public init(applications: Int64? = nil, servers: Int64? = nil, serversMappedToApplications: Int64? = nil, connectorSummary: CustomerConnectorInfo? = nil, serversMappedtoTags: Int64? = nil, agentSummary: CustomerAgentInfo? = nil) {
    ...
    public struct CustomerAgentInfo: AWSShape {
        ...
        public init(totalAgents: Int32, activeAgents: Int32, unknownAgents: Int32, healthyAgents: Int32, blackListedAgents: Int32, unhealthyAgents: Int32, shutdownAgents: Int32) {
    ...
    public struct ExportInfo: AWSShape {
        ...
        public init(exportId: String, statusMessage: String, requestedStartTime: TimeStamp? = nil, exportRequestTime: TimeStamp, requestedEndTime: TimeStamp? = nil, configurationsDownloadUrl: String? = nil, exportStatus: ExportStatus, isTruncated: Bool? = nil) {
            self.exportId = exportId
    ...
    public struct ContinuousExportDescription: AWSShape {
        ...
        public init(exportId: String? = nil, schemaStorageConfig: [String: String]? = nil, status: ContinuousExportStatus? = nil, startTime: TimeStamp? = nil, dataSource: DataSource? = nil, statusDetail: String? = nil, s3Bucket: String? = nil, stopTime: TimeStamp? = nil) {
            self.exportId = exportId
    ...
    public struct DescribeAgentsRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, agentIds: [String]? = nil, nextToken: String? = nil, filters: [Filter]? = nil) {
            self.maxResults = maxResults
            self.agentIds = agentIds
            self.nextToken = nextToken
            self.filters = filters
    ...
    public struct NeighborConnectionDetail: AWSShape {
        ...
        public init(transportProtocol: String? = nil, connectionsCount: Int64, destinationPort: Int32? = nil, sourceServerId: String, destinationServerId: String) {
    ...
    public struct CustomerConnectorInfo: AWSShape {
        ...
        public init(activeConnectors: Int32, shutdownConnectors: Int32, unhealthyConnectors: Int32, totalConnectors: Int32, unknownConnectors: Int32, healthyConnectors: Int32, blackListedConnectors: Int32) {
    ...
    public struct AgentInfo: AWSShape {
        ...
        public init(collectionStatus: String? = nil, agentType: String? = nil, connectorId: String? = nil, agentNetworkInfoList: [AgentNetworkInfo]? = nil, version: String? = nil, agentId: String? = nil, lastHealthPingTime: String? = nil, health: AgentStatus? = nil, hostName: String? = nil, registeredTime: String? = nil) {
    ...
    public struct ListServerNeighborsResponse: AWSShape {
        ...
        public init(nextToken: String? = nil, neighbors: [NeighborConnectionDetail], knownDependencyCount: Int64? = nil) {
            self.nextToken = nextToken
    ...
    public struct StartContinuousExportResponse: AWSShape {
        ...
        public init(startTime: TimeStamp? = nil, s3Bucket: String? = nil, exportId: String? = nil, schemaStorageConfig: [String: String]? = nil, dataSource: DataSource? = nil) {
            self.startTime = startTime
            self.s3Bucket = s3Bucket
            self.exportId = exportId
            self.schemaStorageConfig = schemaStorageConfig
