...
public struct CloudDirectory {
    ...
    public func deleteFacet(_ input: DeleteFacetRequest) throws -> EventLoopFuture<DeleteFacetResponse> {
    ...
    public func applySchema(_ input: ApplySchemaRequest) throws -> EventLoopFuture<ApplySchemaResponse> {
    ...
    public func batchWrite(_ input: BatchWriteRequest) throws -> EventLoopFuture<BatchWriteResponse> {
    ...
    public func enableDirectory(_ input: EnableDirectoryRequest) throws -> EventLoopFuture<EnableDirectoryResponse> {
    ...
    public func upgradePublishedSchema(_ input: UpgradePublishedSchemaRequest) throws -> EventLoopFuture<UpgradePublishedSchemaResponse> {
    ...
    public func listPolicyAttachments(_ input: ListPolicyAttachmentsRequest) throws -> EventLoopFuture<ListPolicyAttachmentsResponse> {
    ...
    public func listIndex(_ input: ListIndexRequest) throws -> EventLoopFuture<ListIndexResponse> {
    ...
    public func removeFacetFromObject(_ input: RemoveFacetFromObjectRequest) throws -> EventLoopFuture<RemoveFacetFromObjectResponse> {
    ...
    public func attachPolicy(_ input: AttachPolicyRequest) throws -> EventLoopFuture<AttachPolicyResponse> {
    ...
    public func listObjectParents(_ input: ListObjectParentsRequest) throws -> EventLoopFuture<ListObjectParentsResponse> {
    ...
    public func listObjectPolicies(_ input: ListObjectPoliciesRequest) throws -> EventLoopFuture<ListObjectPoliciesResponse> {
    ...
    public func listObjectChildren(_ input: ListObjectChildrenRequest) throws -> EventLoopFuture<ListObjectChildrenResponse> {
    ...
    public func getAppliedSchemaVersion(_ input: GetAppliedSchemaVersionRequest) throws -> EventLoopFuture<GetAppliedSchemaVersionResponse> {
    ...
    public func listManagedSchemaArns(_ input: ListManagedSchemaArnsRequest) throws -> EventLoopFuture<ListManagedSchemaArnsResponse> {
    ...
    public func updateLinkAttributes(_ input: UpdateLinkAttributesRequest) throws -> EventLoopFuture<UpdateLinkAttributesResponse> {
    ...
    public func getObjectInformation(_ input: GetObjectInformationRequest) throws -> EventLoopFuture<GetObjectInformationResponse> {
    ...
    public func listAttachedIndices(_ input: ListAttachedIndicesRequest) throws -> EventLoopFuture<ListAttachedIndicesResponse> {
    ...
    public func batchRead(_ input: BatchReadRequest) throws -> EventLoopFuture<BatchReadResponse> {
    ...
    public func deleteDirectory(_ input: DeleteDirectoryRequest) throws -> EventLoopFuture<DeleteDirectoryResponse> {
    ...
    public func listIncomingTypedLinks(_ input: ListIncomingTypedLinksRequest) throws -> EventLoopFuture<ListIncomingTypedLinksResponse> {
    ...
    public func getFacet(_ input: GetFacetRequest) throws -> EventLoopFuture<GetFacetResponse> {
    ...
    public func updateSchema(_ input: UpdateSchemaRequest) throws -> EventLoopFuture<UpdateSchemaResponse> {
    ...
    public func updateObjectAttributes(_ input: UpdateObjectAttributesRequest) throws -> EventLoopFuture<UpdateObjectAttributesResponse> {
    ...
    public func attachToIndex(_ input: AttachToIndexRequest) throws -> EventLoopFuture<AttachToIndexResponse> {
    ...
    public func listDirectories(_ input: ListDirectoriesRequest) throws -> EventLoopFuture<ListDirectoriesResponse> {
    ...
    public func listTypedLinkFacetNames(_ input: ListTypedLinkFacetNamesRequest) throws -> EventLoopFuture<ListTypedLinkFacetNamesResponse> {
    ...
    public func getLinkAttributes(_ input: GetLinkAttributesRequest) throws -> EventLoopFuture<GetLinkAttributesResponse> {
    ...
    public func createFacet(_ input: CreateFacetRequest) throws -> EventLoopFuture<CreateFacetResponse> {
    ...
    public func attachTypedLink(_ input: AttachTypedLinkRequest) throws -> EventLoopFuture<AttachTypedLinkResponse> {
    ...
    public func disableDirectory(_ input: DisableDirectoryRequest) throws -> EventLoopFuture<DisableDirectoryResponse> {
    ...
    public func getSchemaAsJson(_ input: GetSchemaAsJsonRequest) throws -> EventLoopFuture<GetSchemaAsJsonResponse> {
    ...
    public func listTypedLinkFacetAttributes(_ input: ListTypedLinkFacetAttributesRequest) throws -> EventLoopFuture<ListTypedLinkFacetAttributesResponse> {
    ...
    public func listObjectParentPaths(_ input: ListObjectParentPathsRequest) throws -> EventLoopFuture<ListObjectParentPathsResponse> {
    ...
    public func addFacetToObject(_ input: AddFacetToObjectRequest) throws -> EventLoopFuture<AddFacetToObjectResponse> {
    ...
    public func getDirectory(_ input: GetDirectoryRequest) throws -> EventLoopFuture<GetDirectoryResponse> {
    ...
    public func putSchemaFromJson(_ input: PutSchemaFromJsonRequest) throws -> EventLoopFuture<PutSchemaFromJsonResponse> {
    ...
    public func createObject(_ input: CreateObjectRequest) throws -> EventLoopFuture<CreateObjectResponse> {
    ...
    public func createSchema(_ input: CreateSchemaRequest) throws -> EventLoopFuture<CreateSchemaResponse> {
    ...
    public func getObjectAttributes(_ input: GetObjectAttributesRequest) throws -> EventLoopFuture<GetObjectAttributesResponse> {
    ...
    public func lookupPolicy(_ input: LookupPolicyRequest) throws -> EventLoopFuture<LookupPolicyResponse> {
    ...
    public func listPublishedSchemaArns(_ input: ListPublishedSchemaArnsRequest) throws -> EventLoopFuture<ListPublishedSchemaArnsResponse> {
    ...
    public func createDirectory(_ input: CreateDirectoryRequest) throws -> EventLoopFuture<CreateDirectoryResponse> {
    ...
    public func listFacetAttributes(_ input: ListFacetAttributesRequest) throws -> EventLoopFuture<ListFacetAttributesResponse> {
    ...
    public func deleteSchema(_ input: DeleteSchemaRequest) throws -> EventLoopFuture<DeleteSchemaResponse> {
    ...
    public func upgradeAppliedSchema(_ input: UpgradeAppliedSchemaRequest) throws -> EventLoopFuture<UpgradeAppliedSchemaResponse> {
    ...
    public func listFacetNames(_ input: ListFacetNamesRequest) throws -> EventLoopFuture<ListFacetNamesResponse> {
    ...
    public func detachFromIndex(_ input: DetachFromIndexRequest) throws -> EventLoopFuture<DetachFromIndexResponse> {
    ...
    public func listDevelopmentSchemaArns(_ input: ListDevelopmentSchemaArnsRequest) throws -> EventLoopFuture<ListDevelopmentSchemaArnsResponse> {
    ...
    public func listAppliedSchemaArns(_ input: ListAppliedSchemaArnsRequest) throws -> EventLoopFuture<ListAppliedSchemaArnsResponse> {
    ...
    public func listOutgoingTypedLinks(_ input: ListOutgoingTypedLinksRequest) throws -> EventLoopFuture<ListOutgoingTypedLinksResponse> {
    ...
    public func attachObject(_ input: AttachObjectRequest) throws -> EventLoopFuture<AttachObjectResponse> {
    ...
    public func getTypedLinkFacetInformation(_ input: GetTypedLinkFacetInformationRequest) throws -> EventLoopFuture<GetTypedLinkFacetInformationResponse> {
    ...
    public func deleteTypedLinkFacet(_ input: DeleteTypedLinkFacetRequest) throws -> EventLoopFuture<DeleteTypedLinkFacetResponse> {
    ...
    public func createIndex(_ input: CreateIndexRequest) throws -> EventLoopFuture<CreateIndexResponse> {
        return try client.send(operation: "CreateIndex", path: "/amazonclouddirectory/2017-01-11/index", httpMethod: "PUT", input: input)
    }

    ///  Detaches a policy from an object.
    public func detachPolicy(_ input: DetachPolicyRequest) throws -> EventLoopFuture<DetachPolicyResponse> {
    ...
    public func publishSchema(_ input: PublishSchemaRequest) throws -> EventLoopFuture<PublishSchemaResponse> {
    ...
    public func listObjectAttributes(_ input: ListObjectAttributesRequest) throws -> EventLoopFuture<ListObjectAttributesResponse> {
    ...
    public func createTypedLinkFacet(_ input: CreateTypedLinkFacetRequest) throws -> EventLoopFuture<CreateTypedLinkFacetResponse> {
    ...
    public func detachObject(_ input: DetachObjectRequest) throws -> EventLoopFuture<DetachObjectResponse> {
    ...
    public func updateTypedLinkFacet(_ input: UpdateTypedLinkFacetRequest) throws -> EventLoopFuture<UpdateTypedLinkFacetResponse> {
    ...
    public func updateFacet(_ input: UpdateFacetRequest) throws -> EventLoopFuture<UpdateFacetResponse> {
