...
public struct LexModelBuildingService {
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateBotVersionResponse> {
        return client.execute(operation: "CreateBotVersion", path: "/bots/{name}/versions", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createIntentVersion(_ input: CreateIntentVersionRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateIntentVersionResponse> {
        return client.execute(operation: "CreateIntentVersion", path: "/intents/{name}/versions", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createSlotTypeVersion(_ input: CreateSlotTypeVersionRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateSlotTypeVersionResponse> {
        return client.execute(operation: "CreateSlotTypeVersion", path: "/slottypes/{name}/versions", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteBot(_ input: DeleteBotRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBot", path: "/bots/{name}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteBotAlias(_ input: DeleteBotAliasRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteBotChannelAssociation(_ input: DeleteBotChannelAssociationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteBotVersion(_ input: DeleteBotVersionRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBotVersion", path: "/bots/{name}/versions/{version}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteIntent(_ input: DeleteIntentRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteIntent", path: "/intents/{name}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteIntentVersion(_ input: DeleteIntentVersionRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteIntentVersion", path: "/intents/{name}/versions/{version}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteSlotType(_ input: DeleteSlotTypeRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSlotType", path: "/slottypes/{name}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteSlotTypeVersion(_ input: DeleteSlotTypeVersionRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSlotTypeVersion", path: "/slottypes/{name}/version/{version}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteUtterances(_ input: DeleteUtterancesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteUtterances", path: "/bots/{botName}/utterances/{userId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBot(_ input: GetBotRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotResponse> {
        return client.execute(operation: "GetBot", path: "/bots/{name}/versions/{versionoralias}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBotAlias(_ input: GetBotAliasRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotAliasResponse> {
        return client.execute(operation: "GetBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBotAliases(_ input: GetBotAliasesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotAliasesResponse> {
        return client.execute(operation: "GetBotAliases", path: "/bots/{botName}/aliases/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotChannelAssociationResponse> {
        return client.execute(operation: "GetBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotChannelAssociationsResponse> {
        return client.execute(operation: "GetBotChannelAssociations", path: "/bots/{botName}/aliases/{aliasName}/channels/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBotVersions(_ input: GetBotVersionsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotVersionsResponse> {
        return client.execute(operation: "GetBotVersions", path: "/bots/{name}/versions/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBots(_ input: GetBotsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBotsResponse> {
        return client.execute(operation: "GetBots", path: "/bots/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Returns information about a built-in intent. This operation requires permission for the lex:GetBuiltinIntent action.
    public func getBuiltinIntent(_ input: GetBuiltinIntentRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBuiltinIntentResponse> {
        return client.execute(operation: "GetBuiltinIntent", path: "/builtins/intents/{signature}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBuiltinIntents(_ input: GetBuiltinIntentsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBuiltinIntentsResponse> {
        return client.execute(operation: "GetBuiltinIntents", path: "/builtins/intents/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getBuiltinSlotTypes(_ input: GetBuiltinSlotTypesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetBuiltinSlotTypesResponse> {
        return client.execute(operation: "GetBuiltinSlotTypes", path: "/builtins/slottypes/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Exports the contents of a Amazon Lex resource in a specified format. 
    public func getExport(_ input: GetExportRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetExportResponse> {
        return client.execute(operation: "GetExport", path: "/exports/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets information about an import job started with the StartImport operation.
    public func getImport(_ input: GetImportRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetImportResponse> {
        return client.execute(operation: "GetImport", path: "/imports/{importId}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getIntent(_ input: GetIntentRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetIntentResponse> {
        return client.execute(operation: "GetIntent", path: "/intents/{name}/versions/{version}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getIntentVersions(_ input: GetIntentVersionsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetIntentVersionsResponse> {
        return client.execute(operation: "GetIntentVersions", path: "/intents/{name}/versions/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getIntents(_ input: GetIntentsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetIntentsResponse> {
        return client.execute(operation: "GetIntents", path: "/intents/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getSlotType(_ input: GetSlotTypeRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetSlotTypeResponse> {
        return client.execute(operation: "GetSlotType", path: "/slottypes/{name}/versions/{version}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getSlotTypeVersions(_ input: GetSlotTypeVersionsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetSlotTypeVersionsResponse> {
        return client.execute(operation: "GetSlotTypeVersions", path: "/slottypes/{name}/versions/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getSlotTypes(_ input: GetSlotTypesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetSlotTypesResponse> {
        return client.execute(operation: "GetSlotTypes", path: "/slottypes/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getUtterancesView(_ input: GetUtterancesViewRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetUtterancesViewResponse> {
        return client.execute(operation: "GetUtterancesView", path: "/bots/{botname}/utterances?view=aggregation", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putBot(_ input: PutBotRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutBotResponse> {
        return client.execute(operation: "PutBot", path: "/bots/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putBotAlias(_ input: PutBotAliasRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutBotAliasResponse> {
        return client.execute(operation: "PutBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putIntent(_ input: PutIntentRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutIntentResponse> {
        return client.execute(operation: "PutIntent", path: "/intents/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putSlotType(_ input: PutSlotTypeRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutSlotTypeResponse> {
        return client.execute(operation: "PutSlotType", path: "/slottypes/{name}/versions/$LATEST", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Starts a job to import a resource to Amazon Lex.
    public func startImport(_ input: StartImportRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StartImportResponse> {
        return client.execute(operation: "StartImport", path: "/imports/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
