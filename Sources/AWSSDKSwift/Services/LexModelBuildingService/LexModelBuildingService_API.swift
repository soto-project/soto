...
public struct LexModelBuildingService: AWSService {
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest) -> EventLoopFuture<CreateBotVersionResponse> {
        return client.execute(operation: "CreateBotVersion", path: "/bots/{name}/versions", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createIntentVersion(_ input: CreateIntentVersionRequest) -> EventLoopFuture<CreateIntentVersionResponse> {
        return client.execute(operation: "CreateIntentVersion", path: "/intents/{name}/versions", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createSlotTypeVersion(_ input: CreateSlotTypeVersionRequest) -> EventLoopFuture<CreateSlotTypeVersionResponse> {
        return client.execute(operation: "CreateSlotTypeVersion", path: "/slottypes/{name}/versions", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteBot(_ input: DeleteBotRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBot", path: "/bots/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteBotAlias(_ input: DeleteBotAliasRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteBotChannelAssociation(_ input: DeleteBotChannelAssociationRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteBotVersion(_ input: DeleteBotVersionRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteBotVersion", path: "/bots/{name}/versions/{version}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteIntent(_ input: DeleteIntentRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteIntent", path: "/intents/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteIntentVersion(_ input: DeleteIntentVersionRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteIntentVersion", path: "/intents/{name}/versions/{version}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteSlotType(_ input: DeleteSlotTypeRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSlotType", path: "/slottypes/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteSlotTypeVersion(_ input: DeleteSlotTypeVersionRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteSlotTypeVersion", path: "/slottypes/{name}/version/{version}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteUtterances(_ input: DeleteUtterancesRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteUtterances", path: "/bots/{botName}/utterances/{userId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBot(_ input: GetBotRequest) -> EventLoopFuture<GetBotResponse> {
        return client.execute(operation: "GetBot", path: "/bots/{name}/versions/{versionoralias}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBotAlias(_ input: GetBotAliasRequest) -> EventLoopFuture<GetBotAliasResponse> {
        return client.execute(operation: "GetBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBotAliases(_ input: GetBotAliasesRequest) -> EventLoopFuture<GetBotAliasesResponse> {
        return client.execute(operation: "GetBotAliases", path: "/bots/{botName}/aliases/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest) -> EventLoopFuture<GetBotChannelAssociationResponse> {
        return client.execute(operation: "GetBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest) -> EventLoopFuture<GetBotChannelAssociationsResponse> {
        return client.execute(operation: "GetBotChannelAssociations", path: "/bots/{botName}/aliases/{aliasName}/channels/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBotVersions(_ input: GetBotVersionsRequest) -> EventLoopFuture<GetBotVersionsResponse> {
        return client.execute(operation: "GetBotVersions", path: "/bots/{name}/versions/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBots(_ input: GetBotsRequest) -> EventLoopFuture<GetBotsResponse> {
        return client.execute(operation: "GetBots", path: "/bots/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBuiltinIntent(_ input: GetBuiltinIntentRequest) -> EventLoopFuture<GetBuiltinIntentResponse> {
        return client.execute(operation: "GetBuiltinIntent", path: "/builtins/intents/{signature}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBuiltinIntents(_ input: GetBuiltinIntentsRequest) -> EventLoopFuture<GetBuiltinIntentsResponse> {
        return client.execute(operation: "GetBuiltinIntents", path: "/builtins/intents/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBuiltinSlotTypes(_ input: GetBuiltinSlotTypesRequest) -> EventLoopFuture<GetBuiltinSlotTypesResponse> {
        return client.execute(operation: "GetBuiltinSlotTypes", path: "/builtins/slottypes/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Exports the contents of a Amazon Lex resource in a specified format. 
    public func getExport(_ input: GetExportRequest) -> EventLoopFuture<GetExportResponse> {
        return client.execute(operation: "GetExport", path: "/exports/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Gets information about an import job started with the StartImport operation.
    public func getImport(_ input: GetImportRequest) -> EventLoopFuture<GetImportResponse> {
        return client.execute(operation: "GetImport", path: "/imports/{importId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getIntent(_ input: GetIntentRequest) -> EventLoopFuture<GetIntentResponse> {
        return client.execute(operation: "GetIntent", path: "/intents/{name}/versions/{version}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getIntentVersions(_ input: GetIntentVersionsRequest) -> EventLoopFuture<GetIntentVersionsResponse> {
        return client.execute(operation: "GetIntentVersions", path: "/intents/{name}/versions/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getIntents(_ input: GetIntentsRequest) -> EventLoopFuture<GetIntentsResponse> {
        return client.execute(operation: "GetIntents", path: "/intents/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSlotType(_ input: GetSlotTypeRequest) -> EventLoopFuture<GetSlotTypeResponse> {
        return client.execute(operation: "GetSlotType", path: "/slottypes/{name}/versions/{version}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSlotTypeVersions(_ input: GetSlotTypeVersionsRequest) -> EventLoopFuture<GetSlotTypeVersionsResponse> {
        return client.execute(operation: "GetSlotTypeVersions", path: "/slottypes/{name}/versions/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSlotTypes(_ input: GetSlotTypesRequest) -> EventLoopFuture<GetSlotTypesResponse> {
        return client.execute(operation: "GetSlotTypes", path: "/slottypes/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getUtterancesView(_ input: GetUtterancesViewRequest) -> EventLoopFuture<GetUtterancesViewResponse> {
        return client.execute(operation: "GetUtterancesView", path: "/bots/{botname}/utterances?view=aggregation", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func putBot(_ input: PutBotRequest) -> EventLoopFuture<PutBotResponse> {
        return client.execute(operation: "PutBot", path: "/bots/{name}/versions/$LATEST", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putBotAlias(_ input: PutBotAliasRequest) -> EventLoopFuture<PutBotAliasResponse> {
        return client.execute(operation: "PutBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putIntent(_ input: PutIntentRequest) -> EventLoopFuture<PutIntentResponse> {
        return client.execute(operation: "PutIntent", path: "/intents/{name}/versions/$LATEST", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putSlotType(_ input: PutSlotTypeRequest) -> EventLoopFuture<PutSlotTypeResponse> {
        return client.execute(operation: "PutSlotType", path: "/slottypes/{name}/versions/$LATEST", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Starts a job to import a resource to Amazon Lex.
    public func startImport(_ input: StartImportRequest) -> EventLoopFuture<StartImportResponse> {
        return client.execute(operation: "StartImport", path: "/imports/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
