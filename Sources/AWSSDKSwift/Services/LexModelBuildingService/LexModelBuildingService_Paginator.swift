...
extension LexModelBuildingService {
    ...
    public func getBotAliasesPaginator(_ input: GetBotAliasesRequest) -> EventLoopFuture<[BotAliasMetadata]> {
        return client.paginate(input: input, command: getBotAliases, resultKey: \GetBotAliasesResponse.botAliases, tokenKey: \GetBotAliasesResponse.nextToken)
    }
    ...
    public func getBotChannelAssociationsPaginator(_ input: GetBotChannelAssociationsRequest) -> EventLoopFuture<[BotChannelAssociation]> {
        return client.paginate(input: input, command: getBotChannelAssociations, resultKey: \GetBotChannelAssociationsResponse.botChannelAssociations, tokenKey: \GetBotChannelAssociationsResponse.nextToken)
    }
    ...
    public func getBotVersionsPaginator(_ input: GetBotVersionsRequest) -> EventLoopFuture<[BotMetadata]> {
        return client.paginate(input: input, command: getBotVersions, resultKey: \GetBotVersionsResponse.bots, tokenKey: \GetBotVersionsResponse.nextToken)
    }
    ...
    public func getBotsPaginator(_ input: GetBotsRequest) -> EventLoopFuture<[BotMetadata]> {
        return client.paginate(input: input, command: getBots, resultKey: \GetBotsResponse.bots, tokenKey: \GetBotsResponse.nextToken)
    }
    ...
    public func getBuiltinIntentsPaginator(_ input: GetBuiltinIntentsRequest) -> EventLoopFuture<[BuiltinIntentMetadata]> {
        return client.paginate(input: input, command: getBuiltinIntents, resultKey: \GetBuiltinIntentsResponse.intents, tokenKey: \GetBuiltinIntentsResponse.nextToken)
    }
    ...
    public func getBuiltinSlotTypesPaginator(_ input: GetBuiltinSlotTypesRequest) -> EventLoopFuture<[BuiltinSlotTypeMetadata]> {
        return client.paginate(input: input, command: getBuiltinSlotTypes, resultKey: \GetBuiltinSlotTypesResponse.slotTypes, tokenKey: \GetBuiltinSlotTypesResponse.nextToken)
    }
    ...
    public func getIntentVersionsPaginator(_ input: GetIntentVersionsRequest) -> EventLoopFuture<[IntentMetadata]> {
        return client.paginate(input: input, command: getIntentVersions, resultKey: \GetIntentVersionsResponse.intents, tokenKey: \GetIntentVersionsResponse.nextToken)
    }
    ...
    public func getIntentsPaginator(_ input: GetIntentsRequest) -> EventLoopFuture<[IntentMetadata]> {
        return client.paginate(input: input, command: getIntents, resultKey: \GetIntentsResponse.intents, tokenKey: \GetIntentsResponse.nextToken)
    }
    ...
    public func getSlotTypeVersionsPaginator(_ input: GetSlotTypeVersionsRequest) -> EventLoopFuture<[SlotTypeMetadata]> {
        return client.paginate(input: input, command: getSlotTypeVersions, resultKey: \GetSlotTypeVersionsResponse.slotTypes, tokenKey: \GetSlotTypeVersionsResponse.nextToken)
    }
    ...
    public func getSlotTypesPaginator(_ input: GetSlotTypesRequest) -> EventLoopFuture<[SlotTypeMetadata]> {
        return client.paginate(input: input, command: getSlotTypes, resultKey: \GetSlotTypesResponse.slotTypes, tokenKey: \GetSlotTypesResponse.nextToken)
    }
