...
extension LexModelBuildingService {
    ...
    public func getBotAliasesPaginator(_ input: GetBotAliasesRequest, onPage: @escaping ([BotAliasMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getBotAliases, resultKey: \GetBotAliasesResponse.botAliases, tokenKey: \GetBotAliasesResponse.nextToken, onPage: onPage)
    }
    ...
    public func getBotChannelAssociationsPaginator(_ input: GetBotChannelAssociationsRequest, onPage: @escaping ([BotChannelAssociation], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getBotChannelAssociations, resultKey: \GetBotChannelAssociationsResponse.botChannelAssociations, tokenKey: \GetBotChannelAssociationsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getBotVersionsPaginator(_ input: GetBotVersionsRequest, onPage: @escaping ([BotMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getBotVersions, resultKey: \GetBotVersionsResponse.bots, tokenKey: \GetBotVersionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getBotsPaginator(_ input: GetBotsRequest, onPage: @escaping ([BotMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getBots, resultKey: \GetBotsResponse.bots, tokenKey: \GetBotsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getBuiltinIntentsPaginator(_ input: GetBuiltinIntentsRequest, onPage: @escaping ([BuiltinIntentMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getBuiltinIntents, resultKey: \GetBuiltinIntentsResponse.intents, tokenKey: \GetBuiltinIntentsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getBuiltinSlotTypesPaginator(_ input: GetBuiltinSlotTypesRequest, onPage: @escaping ([BuiltinSlotTypeMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getBuiltinSlotTypes, resultKey: \GetBuiltinSlotTypesResponse.slotTypes, tokenKey: \GetBuiltinSlotTypesResponse.nextToken, onPage: onPage)
    }
    ...
    public func getIntentVersionsPaginator(_ input: GetIntentVersionsRequest, onPage: @escaping ([IntentMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getIntentVersions, resultKey: \GetIntentVersionsResponse.intents, tokenKey: \GetIntentVersionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getIntentsPaginator(_ input: GetIntentsRequest, onPage: @escaping ([IntentMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getIntents, resultKey: \GetIntentsResponse.intents, tokenKey: \GetIntentsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getSlotTypeVersionsPaginator(_ input: GetSlotTypeVersionsRequest, onPage: @escaping ([SlotTypeMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getSlotTypeVersions, resultKey: \GetSlotTypeVersionsResponse.slotTypes, tokenKey: \GetSlotTypeVersionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getSlotTypesPaginator(_ input: GetSlotTypesRequest, onPage: @escaping ([SlotTypeMetadata], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getSlotTypes, resultKey: \GetSlotTypesResponse.slotTypes, tokenKey: \GetSlotTypesResponse.nextToken, onPage: onPage)
    }
