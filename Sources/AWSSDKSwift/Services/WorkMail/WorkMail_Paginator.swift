...
extension WorkMail {
    ...
    public func listAliasesPaginator(_ input: ListAliasesRequest) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: listAliases, resultKey: \ListAliasesResponse.aliases, tokenKey: \ListAliasesResponse.nextToken)
    }
    
    ///  Returns an overview of the members of a group. Users and groups can be members of a group.
    public func listGroupMembersPaginator(_ input: ListGroupMembersRequest) -> EventLoopFuture<[Member]> {
        return client.paginate(input: input, command: listGroupMembers, resultKey: \ListGroupMembersResponse.members, tokenKey: \ListGroupMembersResponse.nextToken)
    }
    ...
    public func listMailboxPermissionsPaginator(_ input: ListMailboxPermissionsRequest) -> EventLoopFuture<[Permission]> {
        return client.paginate(input: input, command: listMailboxPermissions, resultKey: \ListMailboxPermissionsResponse.permissions, tokenKey: \ListMailboxPermissionsResponse.nextToken)
    }
    
    ///  Returns summaries of the customer's non-deleted organizations.
    public func listOrganizationsPaginator(_ input: ListOrganizationsRequest) -> EventLoopFuture<[OrganizationSummary]> {
        return client.paginate(input: input, command: listOrganizations, resultKey: \ListOrganizationsResponse.organizationSummaries, tokenKey: \ListOrganizationsResponse.nextToken)
    }
    ...
    public func listResourceDelegatesPaginator(_ input: ListResourceDelegatesRequest) -> EventLoopFuture<[Delegate]> {
        return client.paginate(input: input, command: listResourceDelegates, resultKey: \ListResourceDelegatesResponse.delegates, tokenKey: \ListResourceDelegatesResponse.nextToken)
    }
