...
public struct WorkMail {
    ...
    public func deleteMailboxPermissions(_ input: DeleteMailboxPermissionsRequest) throws -> EventLoopFuture<DeleteMailboxPermissionsResponse> {
    ...
    public func disassociateDelegateFromResource(_ input: DisassociateDelegateFromResourceRequest) throws -> EventLoopFuture<DisassociateDelegateFromResourceResponse> {
        return try client.send(operation: "DisassociateDelegateFromResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the data available for the resource.
    public func describeResource(_ input: DescribeResourceRequest) throws -> EventLoopFuture<DescribeResourceResponse> {
    ...
    public func deleteAlias(_ input: DeleteAliasRequest) throws -> EventLoopFuture<DeleteAliasResponse> {
        return try client.send(operation: "DeleteAlias", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified resource. 
    public func deleteResource(_ input: DeleteResourceRequest) throws -> EventLoopFuture<DeleteResourceResponse> {
    ...
    public func updateResource(_ input: UpdateResourceRequest) throws -> EventLoopFuture<UpdateResourceResponse> {
        return try client.send(operation: "UpdateResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds a member to the resource's set of delegates.
    public func associateDelegateToResource(_ input: AssociateDelegateToResourceRequest) throws -> EventLoopFuture<AssociateDelegateToResourceResponse> {
        return try client.send(operation: "AssociateDelegateToResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds an alias to the set of a given member of Amazon WorkMail.
    public func createAlias(_ input: CreateAliasRequest) throws -> EventLoopFuture<CreateAliasResponse> {
    ...
    public func createResource(_ input: CreateResourceRequest) throws -> EventLoopFuture<CreateResourceResponse> {
        return try client.send(operation: "CreateResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns summaries of the customer's non-deleted organizations.
    public func listOrganizations(_ input: ListOrganizationsRequest) throws -> EventLoopFuture<ListOrganizationsResponse> {
        return try client.send(operation: "ListOrganizations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds a member to the group's set.
    public func associateMemberToGroup(_ input: AssociateMemberToGroupRequest) throws -> EventLoopFuture<AssociateMemberToGroupResponse> {
    ...
    public func registerToWorkMail(_ input: RegisterToWorkMailRequest) throws -> EventLoopFuture<RegisterToWorkMailResponse> {
        return try client.send(operation: "RegisterToWorkMail", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides more information regarding a given organization based on its identifier.
    public func describeOrganization(_ input: DescribeOrganizationRequest) throws -> EventLoopFuture<DescribeOrganizationResponse> {
    ...
    public func putMailboxPermissions(_ input: PutMailboxPermissionsRequest) throws -> EventLoopFuture<PutMailboxPermissionsResponse> {
        return try client.send(operation: "PutMailboxPermissions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the mailbox permissions associated with a mailbox.
    public func listMailboxPermissions(_ input: ListMailboxPermissionsRequest) throws -> EventLoopFuture<ListMailboxPermissionsResponse> {
    ...
    public func updatePrimaryEmailAddress(_ input: UpdatePrimaryEmailAddressRequest) throws -> EventLoopFuture<UpdatePrimaryEmailAddressResponse> {
        return try client.send(operation: "UpdatePrimaryEmailAddress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes a member from a group.
    public func disassociateMemberFromGroup(_ input: DisassociateMemberFromGroupRequest) throws -> EventLoopFuture<DisassociateMemberFromGroupResponse> {
    ...
    public func listResourceDelegates(_ input: ListResourceDelegatesRequest) throws -> EventLoopFuture<ListResourceDelegatesResponse> {
        return try client.send(operation: "ListResourceDelegates", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allows the administrator to reset the password for a user.
    public func resetPassword(_ input: ResetPasswordRequest) throws -> EventLoopFuture<ResetPasswordResponse> {
    ...
    public func describeGroup(_ input: DescribeGroupRequest) throws -> EventLoopFuture<DescribeGroupResponse> {
    ...
    public func listGroupMembers(_ input: ListGroupMembersRequest) throws -> EventLoopFuture<ListGroupMembersResponse> {
        return try client.send(operation: "ListGroupMembers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns summaries of the organization's resources.
    public func listResources(_ input: ListResourcesRequest) throws -> EventLoopFuture<ListResourcesResponse> {
    ...
    public func deregisterFromWorkMail(_ input: DeregisterFromWorkMailRequest) throws -> EventLoopFuture<DeregisterFromWorkMailResponse> {
