...
public struct CloudFormation: AWSService {
    ...
    @discardableResult public func cancelUpdateStack(_ input: CancelUpdateStackInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "CancelUpdateStack", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func continueUpdateRollback(_ input: ContinueUpdateRollbackInput) -> EventLoopFuture<ContinueUpdateRollbackOutput> {
        return client.execute(operation: "ContinueUpdateRollback", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createChangeSet(_ input: CreateChangeSetInput) -> EventLoopFuture<CreateChangeSetOutput> {
        return client.execute(operation: "CreateChangeSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a stack as specified in the template. After the call completes successfully, the stack creation starts. You can check the status of the stack via the DescribeStacks API.
    public func createStack(_ input: CreateStackInput) -> EventLoopFuture<CreateStackOutput> {
    ...
    public func createStackInstances(_ input: CreateStackInstancesInput) -> EventLoopFuture<CreateStackInstancesOutput> {
        return client.execute(operation: "CreateStackInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a stack set.
    public func createStackSet(_ input: CreateStackSetInput) -> EventLoopFuture<CreateStackSetOutput> {
        return client.execute(operation: "CreateStackSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteChangeSet(_ input: DeleteChangeSetInput) -> EventLoopFuture<DeleteChangeSetOutput> {
        return client.execute(operation: "DeleteChangeSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes a specified stack. Once the call completes successfully, stack deletion starts. Deleted stacks do not show up in the DescribeStacks API if the deletion has been completed successfully.
    @discardableResult public func deleteStack(_ input: DeleteStackInput) -> EventLoopFuture<Void> {
    ...
    public func deleteStackInstances(_ input: DeleteStackInstancesInput) -> EventLoopFuture<DeleteStackInstancesOutput> {
        return client.execute(operation: "DeleteStackInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes a stack set. Before you can delete a stack set, all of its member stack instances must be deleted. For more information about how to do this, see DeleteStackInstances. 
    public func deleteStackSet(_ input: DeleteStackSetInput) -> EventLoopFuture<DeleteStackSetOutput> {
        return client.execute(operation: "DeleteStackSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deregisterType(_ input: DeregisterTypeInput) -> EventLoopFuture<DeregisterTypeOutput> {
        return client.execute(operation: "DeregisterType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAccountLimits(_ input: DescribeAccountLimitsInput) -> EventLoopFuture<DescribeAccountLimitsOutput> {
        return client.execute(operation: "DescribeAccountLimits", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the inputs for the change set and a list of changes that AWS CloudFormation will make if you execute the change set. For more information, see Updating Stacks Using Change Sets in the AWS CloudFormation User Guide.
    public func describeChangeSet(_ input: DescribeChangeSetInput) -> EventLoopFuture<DescribeChangeSetOutput> {
        return client.execute(operation: "DescribeChangeSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStackDriftDetectionStatus(_ input: DescribeStackDriftDetectionStatusInput) -> EventLoopFuture<DescribeStackDriftDetectionStatusOutput> {
        return client.execute(operation: "DescribeStackDriftDetectionStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStackEvents(_ input: DescribeStackEventsInput) -> EventLoopFuture<DescribeStackEventsOutput> {
        return client.execute(operation: "DescribeStackEvents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStackInstance(_ input: DescribeStackInstanceInput) -> EventLoopFuture<DescribeStackInstanceOutput> {
        return client.execute(operation: "DescribeStackInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStackResource(_ input: DescribeStackResourceInput) -> EventLoopFuture<DescribeStackResourceOutput> {
        return client.execute(operation: "DescribeStackResource", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStackResourceDrifts(_ input: DescribeStackResourceDriftsInput) -> EventLoopFuture<DescribeStackResourceDriftsOutput> {
        return client.execute(operation: "DescribeStackResourceDrifts", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStackResources(_ input: DescribeStackResourcesInput) -> EventLoopFuture<DescribeStackResourcesOutput> {
        return client.execute(operation: "DescribeStackResources", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the description of the specified stack set. 
    public func describeStackSet(_ input: DescribeStackSetInput) -> EventLoopFuture<DescribeStackSetOutput> {
        return client.execute(operation: "DescribeStackSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the description of the specified stack set operation. 
    public func describeStackSetOperation(_ input: DescribeStackSetOperationInput) -> EventLoopFuture<DescribeStackSetOperationOutput> {
        return client.execute(operation: "DescribeStackSetOperation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeStacks(_ input: DescribeStacksInput) -> EventLoopFuture<DescribeStacksOutput> {
    ...
    public func describeType(_ input: DescribeTypeInput) -> EventLoopFuture<DescribeTypeOutput> {
        return client.execute(operation: "DescribeType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTypeRegistration(_ input: DescribeTypeRegistrationInput) -> EventLoopFuture<DescribeTypeRegistrationOutput> {
        return client.execute(operation: "DescribeTypeRegistration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detectStackDrift(_ input: DetectStackDriftInput) -> EventLoopFuture<DetectStackDriftOutput> {
        return client.execute(operation: "DetectStackDrift", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detectStackResourceDrift(_ input: DetectStackResourceDriftInput) -> EventLoopFuture<DetectStackResourceDriftOutput> {
        return client.execute(operation: "DetectStackResourceDrift", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func detectStackSetDrift(_ input: DetectStackSetDriftInput) -> EventLoopFuture<DetectStackSetDriftOutput> {
        return client.execute(operation: "DetectStackSetDrift", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the estimated monthly cost of a template. The return value is an AWS Simple Monthly Calculator URL with a query string that describes the resources required to run the template.
    public func estimateTemplateCost(_ input: EstimateTemplateCostInput) -> EventLoopFuture<EstimateTemplateCostOutput> {
        return client.execute(operation: "EstimateTemplateCost", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func executeChangeSet(_ input: ExecuteChangeSetInput) -> EventLoopFuture<ExecuteChangeSetOutput> {
        return client.execute(operation: "ExecuteChangeSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the stack policy for a specified stack. If a stack doesn't have a policy, a null value is returned.
    public func getStackPolicy(_ input: GetStackPolicyInput) -> EventLoopFuture<GetStackPolicyOutput> {
        return client.execute(operation: "GetStackPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getTemplate(_ input: GetTemplateInput) -> EventLoopFuture<GetTemplateOutput> {
    ...
    public func getTemplateSummary(_ input: GetTemplateSummaryInput) -> EventLoopFuture<GetTemplateSummaryOutput> {
        return client.execute(operation: "GetTemplateSummary", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the ID and status of each active change set for a stack. For example, AWS CloudFormation lists change sets that are in the CREATE_IN_PROGRESS or CREATE_PENDING state.
    public func listChangeSets(_ input: ListChangeSetsInput) -> EventLoopFuture<ListChangeSetsOutput> {
        return client.execute(operation: "ListChangeSets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listExports(_ input: ListExportsInput) -> EventLoopFuture<ListExportsOutput> {
        return client.execute(operation: "ListExports", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listImports(_ input: ListImportsInput) -> EventLoopFuture<ListImportsOutput> {
        return client.execute(operation: "ListImports", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listStackInstances(_ input: ListStackInstancesInput) -> EventLoopFuture<ListStackInstancesOutput> {
        return client.execute(operation: "ListStackInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listStackResources(_ input: ListStackResourcesInput) -> EventLoopFuture<ListStackResourcesOutput> {
        return client.execute(operation: "ListStackResources", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns summary information about the results of a stack set operation. 
    public func listStackSetOperationResults(_ input: ListStackSetOperationResultsInput) -> EventLoopFuture<ListStackSetOperationResultsOutput> {
        return client.execute(operation: "ListStackSetOperationResults", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns summary information about operations performed on a stack set. 
    public func listStackSetOperations(_ input: ListStackSetOperationsInput) -> EventLoopFuture<ListStackSetOperationsOutput> {
        return client.execute(operation: "ListStackSetOperations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns summary information about stack sets that are associated with the user.
    public func listStackSets(_ input: ListStackSetsInput) -> EventLoopFuture<ListStackSetsOutput> {
        return client.execute(operation: "ListStackSets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the summary information for stacks whose status matches the specified StackStatusFilter. Summary information for stacks that have been deleted is kept for 90 days after the stack is deleted. If no StackStatusFilter is specified, summary information for all stacks is returned (including existing stacks and stacks that have been deleted).
    public func listStacks(_ input: ListStacksInput) -> EventLoopFuture<ListStacksOutput> {
        return client.execute(operation: "ListStacks", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTypeRegistrations(_ input: ListTypeRegistrationsInput) -> EventLoopFuture<ListTypeRegistrationsOutput> {
        return client.execute(operation: "ListTypeRegistrations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns summary information about the versions of a type.
    public func listTypeVersions(_ input: ListTypeVersionsInput) -> EventLoopFuture<ListTypeVersionsOutput> {
        return client.execute(operation: "ListTypeVersions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns summary information about types that have been registered with CloudFormation.
    public func listTypes(_ input: ListTypesInput) -> EventLoopFuture<ListTypesOutput> {
        return client.execute(operation: "ListTypes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func recordHandlerProgress(_ input: RecordHandlerProgressInput) -> EventLoopFuture<RecordHandlerProgressOutput> {
        return client.execute(operation: "RecordHandlerProgress", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerType(_ input: RegisterTypeInput) -> EventLoopFuture<RegisterTypeOutput> {
        return client.execute(operation: "RegisterType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Sets a stack policy for a specified stack.
    @discardableResult public func setStackPolicy(_ input: SetStackPolicyInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetStackPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Specify the default version of a type. The default version of a type will be used in CloudFormation operations.
    public func setTypeDefaultVersion(_ input: SetTypeDefaultVersionInput) -> EventLoopFuture<SetTypeDefaultVersionOutput> {
        return client.execute(operation: "SetTypeDefaultVersion", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Sends a signal to the specified resource with a success or failure status. You can use the SignalResource API in conjunction with a creation policy or update policy. AWS CloudFormation doesn't proceed with a stack creation or update until resources receive the required number of signals or the timeout period is exceeded. The SignalResource API is useful in cases where you want to send signals from anywhere other than an Amazon EC2 instance.
    @discardableResult public func signalResource(_ input: SignalResourceInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "SignalResource", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Stops an in-progress operation on a stack set and its associated stack instances. 
    public func stopStackSetOperation(_ input: StopStackSetOperationInput) -> EventLoopFuture<StopStackSetOperationOutput> {
        return client.execute(operation: "StopStackSetOperation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateStack(_ input: UpdateStackInput) -> EventLoopFuture<UpdateStackOutput> {
    ...
    public func updateStackInstances(_ input: UpdateStackInstancesInput) -> EventLoopFuture<UpdateStackInstancesOutput> {
        return client.execute(operation: "UpdateStackInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateStackSet(_ input: UpdateStackSetInput) -> EventLoopFuture<UpdateStackSetOutput> {
        return client.execute(operation: "UpdateStackSet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateTerminationProtection(_ input: UpdateTerminationProtectionInput) -> EventLoopFuture<UpdateTerminationProtectionOutput> {
        return client.execute(operation: "UpdateTerminationProtection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Validates a specified template. AWS CloudFormation first checks if the template is valid JSON. If it isn't, AWS CloudFormation checks if the template is valid YAML. If both these checks fail, AWS CloudFormation returns a template validation error.
    public func validateTemplate(_ input: ValidateTemplateInput) -> EventLoopFuture<ValidateTemplateOutput> {
        return client.execute(operation: "ValidateTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
