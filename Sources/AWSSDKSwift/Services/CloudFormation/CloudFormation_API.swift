...
public struct CloudFormation {
    ...
    public func updateStack(_ input: UpdateStackInput) throws -> EventLoopFuture<UpdateStackOutput> {
    ...
    public func describeStackDriftDetectionStatus(_ input: DescribeStackDriftDetectionStatusInput) throws -> EventLoopFuture<DescribeStackDriftDetectionStatusOutput> {
        return try client.send(operation: "DescribeStackDriftDetectionStatus", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns summary information about the results of a stack set operation. 
    public func listStackSetOperationResults(_ input: ListStackSetOperationResultsInput) throws -> EventLoopFuture<ListStackSetOperationResultsOutput> {
        return try client.send(operation: "ListStackSetOperationResults", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns summary information about stack sets that are associated with the user.
    public func listStackSets(_ input: ListStackSetsInput) throws -> EventLoopFuture<ListStackSetsOutput> {
    ...
    public func updateStackSet(_ input: UpdateStackSetInput) throws -> EventLoopFuture<UpdateStackSetOutput> {
        return try client.send(operation: "UpdateStackSet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops an in-progress operation on a stack set and its associated stack instances. 
    public func stopStackSetOperation(_ input: StopStackSetOperationInput) throws -> EventLoopFuture<StopStackSetOperationOutput> {
    ...
    public func createChangeSet(_ input: CreateChangeSetInput) throws -> EventLoopFuture<CreateChangeSetOutput> {
        return try client.send(operation: "CreateChangeSet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a stack as specified in the template. After the call completes successfully, the stack creation starts. You can check the status of the stack via the DescribeStacks API.
    public func createStack(_ input: CreateStackInput) throws -> EventLoopFuture<CreateStackOutput> {
    ...
    public func getTemplate(_ input: GetTemplateInput) throws -> EventLoopFuture<GetTemplateOutput> {
    ...
    public func validateTemplate(_ input: ValidateTemplateInput) throws -> EventLoopFuture<ValidateTemplateOutput> {
    ...
    public func describeStackResource(_ input: DescribeStackResourceInput) throws -> EventLoopFuture<DescribeStackResourceOutput> {
    ...
    public func listExports(_ input: ListExportsInput) throws -> EventLoopFuture<ListExportsOutput> {
    ...
    public func describeStacks(_ input: DescribeStacksInput) throws -> EventLoopFuture<DescribeStacksOutput> {
    ...
    public func executeChangeSet(_ input: ExecuteChangeSetInput) throws -> EventLoopFuture<ExecuteChangeSetOutput> {
        return try client.send(operation: "ExecuteChangeSet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns summary information about operations performed on a stack set. 
    public func listStackSetOperations(_ input: ListStackSetOperationsInput) throws -> EventLoopFuture<ListStackSetOperationsOutput> {
    ...
    public func detectStackResourceDrift(_ input: DetectStackResourceDriftInput) throws -> EventLoopFuture<DetectStackResourceDriftOutput> {
        return try client.send(operation: "DetectStackResourceDrift", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the description of the specified stack set operation. 
    public func describeStackSetOperation(_ input: DescribeStackSetOperationInput) throws -> EventLoopFuture<DescribeStackSetOperationOutput> {
        return try client.send(operation: "DescribeStackSetOperation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the description of the specified stack set. 
    public func describeStackSet(_ input: DescribeStackSetInput) throws -> EventLoopFuture<DescribeStackSetOutput> {
    ...
    public func listStackInstances(_ input: ListStackInstancesInput) throws -> EventLoopFuture<ListStackInstancesOutput> {
        return try client.send(operation: "ListStackInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the stack policy for a specified stack. If a stack doesn't have a policy, a null value is returned.
    public func getStackPolicy(_ input: GetStackPolicyInput) throws -> EventLoopFuture<GetStackPolicyOutput> {
    ...
    public func describeChangeSet(_ input: DescribeChangeSetInput) throws -> EventLoopFuture<DescribeChangeSetOutput> {
    ...
    public func listStacks(_ input: ListStacksInput) throws -> EventLoopFuture<ListStacksOutput> {
    ...
    public func getTemplateSummary(_ input: GetTemplateSummaryInput) throws -> EventLoopFuture<GetTemplateSummaryOutput> {
        return try client.send(operation: "GetTemplateSummary", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the ID and status of each active change set for a stack. For example, AWS CloudFormation lists change sets that are in the CREATE_IN_PROGRESS or CREATE_PENDING state.
    public func listChangeSets(_ input: ListChangeSetsInput) throws -> EventLoopFuture<ListChangeSetsOutput> {
    ...
    public func describeStackInstance(_ input: DescribeStackInstanceInput) throws -> EventLoopFuture<DescribeStackInstanceOutput> {
    ...
    public func deleteStackSet(_ input: DeleteStackSetInput) throws -> EventLoopFuture<DeleteStackSetOutput> {
    ...
    public func continueUpdateRollback(_ input: ContinueUpdateRollbackInput) throws -> EventLoopFuture<ContinueUpdateRollbackOutput> {
        return try client.send(operation: "ContinueUpdateRollback", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a stack set.
    public func createStackSet(_ input: CreateStackSetInput) throws -> EventLoopFuture<CreateStackSetOutput> {
    ...
    public func detectStackDrift(_ input: DetectStackDriftInput) throws -> EventLoopFuture<DetectStackDriftOutput> {
    ...
    public func describeStackEvents(_ input: DescribeStackEventsInput) throws -> EventLoopFuture<DescribeStackEventsOutput> {
        return try client.send(operation: "DescribeStackEvents", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves your account's AWS CloudFormation limits, such as the maximum number of stacks that you can create in your account.
    public func describeAccountLimits(_ input: DescribeAccountLimitsInput) throws -> EventLoopFuture<DescribeAccountLimitsOutput> {
    ...
    public func listImports(_ input: ListImportsInput) throws -> EventLoopFuture<ListImportsOutput> {
        return try client.send(operation: "ListImports", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the estimated monthly cost of a template. The return value is an AWS Simple Monthly Calculator URL with a query string that describes the resources required to run the template.
    public func estimateTemplateCost(_ input: EstimateTemplateCostInput) throws -> EventLoopFuture<EstimateTemplateCostOutput> {
    ...
    public func describeStackResourceDrifts(_ input: DescribeStackResourceDriftsInput) throws -> EventLoopFuture<DescribeStackResourceDriftsOutput> {
    ...
    public func updateTerminationProtection(_ input: UpdateTerminationProtectionInput) throws -> EventLoopFuture<UpdateTerminationProtectionOutput> {
        return try client.send(operation: "UpdateTerminationProtection", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes stack instances for the specified accounts, in the specified regions. 
    public func deleteStackInstances(_ input: DeleteStackInstancesInput) throws -> EventLoopFuture<DeleteStackInstancesOutput> {
    ...
    public func createStackInstances(_ input: CreateStackInstancesInput) throws -> EventLoopFuture<CreateStackInstancesOutput> {
    ...
    public func describeStackResources(_ input: DescribeStackResourcesInput) throws -> EventLoopFuture<DescribeStackResourcesOutput> {
    ...
    public func listStackResources(_ input: ListStackResourcesInput) throws -> EventLoopFuture<ListStackResourcesOutput> {
    ...
    public func updateStackInstances(_ input: UpdateStackInstancesInput) throws -> EventLoopFuture<UpdateStackInstancesOutput> {
    ...
    public func deleteChangeSet(_ input: DeleteChangeSetInput) throws -> EventLoopFuture<DeleteChangeSetOutput> {
