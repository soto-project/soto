...
public struct CloudFormation {
    ...
    public func describeStackDriftDetectionStatus(_ input: DescribeStackDriftDetectionStatusInput) throws -> DescribeStackDriftDetectionStatusOutput {
    ...
    public func describeStackResourceDrifts(_ input: DescribeStackResourceDriftsInput) throws -> DescribeStackResourceDriftsOutput {
    ...
    public func detectStackDrift(_ input: DetectStackDriftInput) throws -> DetectStackDriftOutput {
    ...
    public func detectStackResourceDrift(_ input: DetectStackResourceDriftInput) throws -> DetectStackResourceDriftOutput {
