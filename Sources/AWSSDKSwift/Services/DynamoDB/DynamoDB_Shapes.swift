...
extension DynamoDB {
    ...
    public struct ListBackupsInput: AWSShape {
        ...
        public init(timeRangeUpperBound: TimeStamp? = nil, timeRangeLowerBound: TimeStamp? = nil, limit: Int32? = nil, exclusiveStartBackupArn: String? = nil, backupType: BackupTypeFilter? = nil, tableName: String? = nil) {
    ...
    public struct SourceTableDetails: AWSShape {
        ...
        public init(billingMode: BillingMode? = nil, tableCreationDateTime: TimeStamp, provisionedThroughput: ProvisionedThroughput, tableSizeBytes: Int64? = nil, tableName: String, tableArn: String? = nil, tableId: String, keySchema: [KeySchemaElement], itemCount: Int64? = nil) {
    ...
    public struct LocalSecondaryIndex: AWSShape {
        ...
        public init(keySchema: [KeySchemaElement], indexName: String, projection: Projection) {
            self.keySchema = keySchema
    ...
    public struct AutoScalingPolicyUpdate: AWSShape {
        ...
        public init(targetTrackingScalingPolicyConfiguration: AutoScalingTargetTrackingScalingPolicyConfigurationUpdate, policyName: String? = nil) {
    ...
    public struct ConsumedCapacity: AWSShape {
        ...
        public init(capacityUnits: Double? = nil, globalSecondaryIndexes: [String: Capacity]? = nil, readCapacityUnits: Double? = nil, table: Capacity? = nil, tableName: String? = nil, writeCapacityUnits: Double? = nil, localSecondaryIndexes: [String: Capacity]? = nil) {
    ...
    public struct ReplicaSettingsDescription: AWSShape {
        ...
        public init(replicaProvisionedReadCapacityUnits: Int64? = nil, replicaGlobalSecondaryIndexSettings: [ReplicaGlobalSecondaryIndexSettingsDescription]? = nil, regionName: String, replicaProvisionedWriteCapacityUnits: Int64? = nil, replicaStatus: ReplicaStatus? = nil, replicaBillingModeSummary: BillingModeSummary? = nil, replicaProvisionedWriteCapacityAutoScalingSettings: AutoScalingSettingsDescription? = nil, replicaProvisionedReadCapacityAutoScalingSettings: AutoScalingSettingsDescription? = nil) {
    ...
    public struct ReplicaGlobalSecondaryIndexSettingsDescription: AWSShape {
        ...
        public init(provisionedWriteCapacityAutoScalingSettings: AutoScalingSettingsDescription? = nil, provisionedReadCapacityAutoScalingSettings: AutoScalingSettingsDescription? = nil, provisionedWriteCapacityUnits: Int64? = nil, provisionedReadCapacityUnits: Int64? = nil, indexName: String, indexStatus: IndexStatus? = nil) {
    ...
    public struct GlobalSecondaryIndexDescription: AWSShape {
        ...
        public init(indexName: String? = nil, itemCount: Int64? = nil, keySchema: [KeySchemaElement]? = nil, backfilling: Bool? = nil, provisionedThroughput: ProvisionedThroughputDescription? = nil, projection: Projection? = nil, indexSizeBytes: Int64? = nil, indexStatus: IndexStatus? = nil, indexArn: String? = nil) {
            self.indexName = indexName
            self.itemCount = itemCount
            self.keySchema = keySchema
    ...
    public struct SSESpecification: AWSShape {
        ...
        public init(kMSMasterKeyId: String? = nil, sSEType: SSEType? = nil, enabled: Bool? = nil) {
    ...
    public struct UpdateGlobalTableSettingsInput: AWSShape {
        ...
        public init(globalTableName: String, globalTableBillingMode: BillingMode? = nil, globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate: AutoScalingSettingsUpdate? = nil, globalTableGlobalSecondaryIndexSettingsUpdate: [GlobalTableGlobalSecondaryIndexSettingsUpdate]? = nil, replicaSettingsUpdate: [ReplicaSettingsUpdate]? = nil, globalTableProvisionedWriteCapacityUnits: Int64? = nil) {
            self.globalTableName = globalTableName
    ...
    public struct ScanInput: AWSShape {
        ...
        public init(projectionExpression: String? = nil, select: Select? = nil, conditionalOperator: ConditionalOperator? = nil, tableName: String, totalSegments: Int32? = nil, exclusiveStartKey: [String: AttributeValue]? = nil, indexName: String? = nil, attributesToGet: [String]? = nil, expressionAttributeValues: [String: AttributeValue]? = nil, expressionAttributeNames: [String: String]? = nil, segment: Int32? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil, filterExpression: String? = nil, consistentRead: Bool? = nil, scanFilter: [String: Condition]? = nil, limit: Int32? = nil) {
    ...
    public struct BackupDetails: AWSShape {
        ...
        public init(backupArn: String, backupSizeBytes: Int64? = nil, backupName: String, backupStatus: BackupStatus, backupExpiryDateTime: TimeStamp? = nil, backupType: BackupType, backupCreationDateTime: TimeStamp) {
    ...
    public struct ScanOutput: AWSShape {
        ...
        public init(count: Int32? = nil, scannedCount: Int32? = nil, lastEvaluatedKey: [String: AttributeValue]? = nil, consumedCapacity: ConsumedCapacity? = nil, items: [[String: AttributeValue]]? = nil) {
            self.count = count
    ...
    public struct Get: AWSShape {
        ...
        public init(key: [String: AttributeValue], expressionAttributeNames: [String: String]? = nil, projectionExpression: String? = nil, tableName: String) {
            self.key = key
            self.expressionAttributeNames = expressionAttributeNames
            self.projectionExpression = projectionExpression
            self.tableName = tableName
    ...
    public struct GetItemInput: AWSShape {
        ...
        public init(key: [String: AttributeValue], consistentRead: Bool? = nil, tableName: String, expressionAttributeNames: [String: String]? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil, projectionExpression: String? = nil, attributesToGet: [String]? = nil) {
            self.key = key
            self.consistentRead = consistentRead
            self.tableName = tableName
            self.expressionAttributeNames = expressionAttributeNames
    ...
    public struct ListGlobalTablesInput: AWSShape {
        ...
        public init(limit: Int32? = nil, exclusiveStartGlobalTableName: String? = nil, regionName: String? = nil) {
            self.limit = limit
    ...
    public struct SSEDescription: AWSShape {
        ...
        public init(sSEType: SSEType? = nil, status: SSEStatus? = nil, kMSMasterKeyArn: String? = nil) {
            self.sSEType = sSEType
            self.status = status
    ...
    public struct GlobalSecondaryIndex: AWSShape {
        ...
        public init(provisionedThroughput: ProvisionedThroughput? = nil, keySchema: [KeySchemaElement], indexName: String, projection: Projection) {
            self.provisionedThroughput = provisionedThroughput
            self.keySchema = keySchema
            self.indexName = indexName
            self.projection = projection
    ...
    public struct DescribeLimitsOutput: AWSShape {
        ...
        public init(tableMaxReadCapacityUnits: Int64? = nil, tableMaxWriteCapacityUnits: Int64? = nil, accountMaxWriteCapacityUnits: Int64? = nil, accountMaxReadCapacityUnits: Int64? = nil) {
    ...
    public struct PutItemInput: AWSShape {
        ...
        public init(conditionalOperator: ConditionalOperator? = nil, conditionExpression: String? = nil, item: [String: AttributeValue], returnItemCollectionMetrics: ReturnItemCollectionMetrics? = nil, tableName: String, expressionAttributeNames: [String: String]? = nil, returnValues: ReturnValue? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil, expected: [String: ExpectedAttributeValue]? = nil, expressionAttributeValues: [String: AttributeValue]? = nil) {
            self.conditionalOperator = conditionalOperator
    ...
    public struct Put: AWSShape {
        ...
        public init(expressionAttributeValues: [String: AttributeValue]? = nil, returnValuesOnConditionCheckFailure: ReturnValuesOnConditionCheckFailure? = nil, conditionExpression: String? = nil, expressionAttributeNames: [String: String]? = nil, tableName: String, item: [String: AttributeValue]) {
            self.expressionAttributeValues = expressionAttributeValues
    ...
    public struct CreateTableInput: AWSShape {
        ...
        public init(globalSecondaryIndexes: [GlobalSecondaryIndex]? = nil, billingMode: BillingMode? = nil, sSESpecification: SSESpecification? = nil, provisionedThroughput: ProvisionedThroughput? = nil, tableName: String, streamSpecification: StreamSpecification? = nil, attributeDefinitions: [AttributeDefinition], keySchema: [KeySchemaElement], localSecondaryIndexes: [LocalSecondaryIndex]? = nil) {
            self.globalSecondaryIndexes = globalSecondaryIndexes
            self.billingMode = billingMode
    ...
    public struct UpdateContinuousBackupsInput: AWSShape {
        ...
        public init(tableName: String, pointInTimeRecoverySpecification: PointInTimeRecoverySpecification) {
            self.tableName = tableName
    ...
    public struct TransactWriteItemsInput: AWSShape {
        ...
        public init(transactItems: [TransactWriteItem], returnItemCollectionMetrics: ReturnItemCollectionMetrics? = nil, clientRequestToken: String? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil) {
    ...
    public struct RestoreSummary: AWSShape {
        ...
        public init(sourceBackupArn: String? = nil, sourceTableArn: String? = nil, restoreDateTime: TimeStamp, restoreInProgress: Bool) {
    ...
    public struct SourceTableFeatureDetails: AWSShape {
        ...
        public init(localSecondaryIndexes: [LocalSecondaryIndexInfo]? = nil, sSEDescription: SSEDescription? = nil, globalSecondaryIndexes: [GlobalSecondaryIndexInfo]? = nil, timeToLiveDescription: TimeToLiveDescription? = nil, streamDescription: StreamSpecification? = nil) {
            self.localSecondaryIndexes = localSecondaryIndexes
    ...
    public struct AutoScalingPolicyDescription: AWSShape {
        ...
        public init(targetTrackingScalingPolicyConfiguration: AutoScalingTargetTrackingScalingPolicyConfigurationDescription? = nil, policyName: String? = nil) {
            self.targetTrackingScalingPolicyConfiguration = targetTrackingScalingPolicyConfiguration
            self.policyName = policyName
        }
    ...
    public struct QueryInput: AWSShape {
        ...
        public init(projectionExpression: String? = nil, keyConditions: [String: Condition]? = nil, conditionalOperator: ConditionalOperator? = nil, tableName: String, select: Select? = nil, keyConditionExpression: String? = nil, exclusiveStartKey: [String: AttributeValue]? = nil, indexName: String? = nil, attributesToGet: [String]? = nil, queryFilter: [String: Condition]? = nil, expressionAttributeValues: [String: AttributeValue]? = nil, expressionAttributeNames: [String: String]? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil, filterExpression: String? = nil, consistentRead: Bool? = nil, scanIndexForward: Bool? = nil, limit: Int32? = nil) {
            self.projectionExpression = projectionExpression
    ...
    public struct CancellationReason: AWSShape {
        ...
        public init(item: [String: AttributeValue]? = nil, code: String? = nil, message: String? = nil) {
            self.item = item
            self.code = code
    ...
    public struct UpdateTableInput: AWSShape {
        ...
        public init(sSESpecification: SSESpecification? = nil, billingMode: BillingMode? = nil, provisionedThroughput: ProvisionedThroughput? = nil, tableName: String, streamSpecification: StreamSpecification? = nil, attributeDefinitions: [AttributeDefinition]? = nil, globalSecondaryIndexUpdates: [GlobalSecondaryIndexUpdate]? = nil) {
            self.sSESpecification = sSESpecification
            self.billingMode = billingMode
            self.provisionedThroughput = provisionedThroughput
            self.tableName = tableName
    ...
    public struct ReplicaGlobalSecondaryIndexSettingsUpdate: AWSShape {
        ...
        public init(provisionedReadCapacityAutoScalingSettingsUpdate: AutoScalingSettingsUpdate? = nil, provisionedReadCapacityUnits: Int64? = nil, indexName: String) {
    ...
    public struct TableDescription: AWSShape {
        ...
        public init(attributeDefinitions: [AttributeDefinition]? = nil, latestStreamArn: String? = nil, globalSecondaryIndexes: [GlobalSecondaryIndexDescription]? = nil, tableName: String? = nil, tableArn: String? = nil, tableId: String? = nil, billingModeSummary: BillingModeSummary? = nil, keySchema: [KeySchemaElement]? = nil, localSecondaryIndexes: [LocalSecondaryIndexDescription]? = nil, tableStatus: TableStatus? = nil, streamSpecification: StreamSpecification? = nil, creationDateTime: TimeStamp? = nil, restoreSummary: RestoreSummary? = nil, itemCount: Int64? = nil, tableSizeBytes: Int64? = nil, latestStreamLabel: String? = nil, provisionedThroughput: ProvisionedThroughputDescription? = nil, sSEDescription: SSEDescription? = nil) {
            self.attributeDefinitions = attributeDefinitions
    ...
    public struct Update: AWSShape {
        ...
        public init(key: [String: AttributeValue], conditionExpression: String? = nil, tableName: String, expressionAttributeNames: [String: String]? = nil, returnValuesOnConditionCheckFailure: ReturnValuesOnConditionCheckFailure? = nil, expressionAttributeValues: [String: AttributeValue]? = nil, updateExpression: String) {
            self.key = key
            self.conditionExpression = conditionExpression
            self.tableName = tableName
            self.expressionAttributeNames = expressionAttributeNames
    ...
    public struct Delete: AWSShape {
        ...
        public init(expressionAttributeValues: [String: AttributeValue]? = nil, key: [String: AttributeValue], expressionAttributeNames: [String: String]? = nil, returnValuesOnConditionCheckFailure: ReturnValuesOnConditionCheckFailure? = nil, conditionExpression: String? = nil, tableName: String) {
            self.expressionAttributeValues = expressionAttributeValues
            self.key = key
            self.expressionAttributeNames = expressionAttributeNames
            self.returnValuesOnConditionCheckFailure = returnValuesOnConditionCheckFailure
    ...
    public struct LocalSecondaryIndexInfo: AWSShape {
        ...
        public init(keySchema: [KeySchemaElement]? = nil, indexName: String? = nil, projection: Projection? = nil) {
            self.keySchema = keySchema
            self.indexName = indexName
            self.projection = projection
        }
    ...
    public struct AutoScalingSettingsDescription: AWSShape {
        ...
        public init(autoScalingDisabled: Bool? = nil, maximumUnits: Int64? = nil, scalingPolicies: [AutoScalingPolicyDescription]? = nil, autoScalingRoleArn: String? = nil, minimumUnits: Int64? = nil) {
    ...
    public struct GlobalSecondaryIndexUpdate: AWSShape {
        ...
        public init(update: UpdateGlobalSecondaryIndexAction? = nil, delete: DeleteGlobalSecondaryIndexAction? = nil, create: CreateGlobalSecondaryIndexAction? = nil) {
            self.update = update
            self.delete = delete
            self.create = create
        }
    ...
    public struct ListTablesInput: AWSShape {
        ...
        public init(limit: Int32? = nil, exclusiveStartTableName: String? = nil) {
            self.limit = limit
    ...
    public struct ExpectedAttributeValue: AWSShape {
        ...
        public init(comparisonOperator: ComparisonOperator? = nil, value: AttributeValue? = nil, exists: Bool? = nil, attributeValueList: [AttributeValue]? = nil) {
            self.comparisonOperator = comparisonOperator
            self.value = value
            self.exists = exists
            self.attributeValueList = attributeValueList
    ...
    public struct BillingModeSummary: AWSShape {
        ...
        public init(lastUpdateToPayPerRequestDateTime: TimeStamp? = nil, billingMode: BillingMode? = nil) {
    ...
    public struct TransactGetItemsInput: AWSShape {
        ...
        public init(transactItems: [TransactGetItem], returnConsumedCapacity: ReturnConsumedCapacity? = nil) {
            self.transactItems = transactItems
            self.returnConsumedCapacity = returnConsumedCapacity
        }
    ...
    public struct Capacity: AWSShape {
        ...
        public init(readCapacityUnits: Double? = nil, writeCapacityUnits: Double? = nil, capacityUnits: Double? = nil) {
            self.readCapacityUnits = readCapacityUnits
            self.writeCapacityUnits = writeCapacityUnits
            self.capacityUnits = capacityUnits
        }
    ...
    public struct LocalSecondaryIndexDescription: AWSShape {
        ...
        public init(itemCount: Int64? = nil, keySchema: [KeySchemaElement]? = nil, indexName: String? = nil, indexArn: String? = nil, indexSizeBytes: Int64? = nil, projection: Projection? = nil) {
            self.itemCount = itemCount
            self.keySchema = keySchema
            self.indexName = indexName
            self.indexArn = indexArn
    ...
    public struct KeysAndAttributes: AWSShape {
        ...
        public init(keys: [[String: AttributeValue]], expressionAttributeNames: [String: String]? = nil, projectionExpression: String? = nil, consistentRead: Bool? = nil, attributesToGet: [String]? = nil) {
            self.keys = keys
            self.expressionAttributeNames = expressionAttributeNames
            self.projectionExpression = projectionExpression
            self.consistentRead = consistentRead
    ...
    public struct UpdateItemInput: AWSShape {
        ...
        public init(conditionalOperator: ConditionalOperator? = nil, key: [String: AttributeValue], conditionExpression: String? = nil, attributeUpdates: [String: AttributeValueUpdate]? = nil, returnItemCollectionMetrics: ReturnItemCollectionMetrics? = nil, tableName: String, expressionAttributeNames: [String: String]? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil, expected: [String: ExpectedAttributeValue]? = nil, returnValues: ReturnValue? = nil, updateExpression: String? = nil, expressionAttributeValues: [String: AttributeValue]? = nil) {
            self.conditionalOperator = conditionalOperator
            self.key = key
            self.conditionExpression = conditionExpression
    ...
    public struct DeleteItemInput: AWSShape {
        ...
        public init(conditionalOperator: ConditionalOperator? = nil, key: [String: AttributeValue], conditionExpression: String? = nil, returnItemCollectionMetrics: ReturnItemCollectionMetrics? = nil, tableName: String, expressionAttributeNames: [String: String]? = nil, returnValues: ReturnValue? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil, expected: [String: ExpectedAttributeValue]? = nil, expressionAttributeValues: [String: AttributeValue]? = nil) {
            self.conditionalOperator = conditionalOperator
            self.key = key
            self.conditionExpression = conditionExpression
            self.returnItemCollectionMetrics = returnItemCollectionMetrics
    ...
    public struct GlobalTableDescription: AWSShape {
        ...
        public init(globalTableName: String? = nil, globalTableArn: String? = nil, replicationGroup: [ReplicaDescription]? = nil, globalTableStatus: GlobalTableStatus? = nil, creationDateTime: TimeStamp? = nil) {
            self.globalTableName = globalTableName
    ...
    public struct BackupSummary: AWSShape {
        ...
        public init(backupArn: String? = nil, backupSizeBytes: Int64? = nil, backupName: String? = nil, backupExpiryDateTime: TimeStamp? = nil, tableName: String? = nil, tableArn: String? = nil, tableId: String? = nil, backupType: BackupType? = nil, backupStatus: BackupStatus? = nil, backupCreationDateTime: TimeStamp? = nil) {
            self.backupArn = backupArn
            self.backupSizeBytes = backupSizeBytes
            self.backupName = backupName
            self.backupExpiryDateTime = backupExpiryDateTime
    ...
    public struct BatchWriteItemInput: AWSShape {
        ...
        public init(requestItems: [String: [WriteRequest]], returnItemCollectionMetrics: ReturnItemCollectionMetrics? = nil, returnConsumedCapacity: ReturnConsumedCapacity? = nil) {
            self.requestItems = requestItems
            self.returnItemCollectionMetrics = returnItemCollectionMetrics
            self.returnConsumedCapacity = returnConsumedCapacity
        }
    ...
    public struct ConditionCheck: AWSShape {
        ...
        public init(expressionAttributeValues: [String: AttributeValue]? = nil, key: [String: AttributeValue], expressionAttributeNames: [String: String]? = nil, returnValuesOnConditionCheckFailure: ReturnValuesOnConditionCheckFailure? = nil, conditionExpression: String, tableName: String) {
            self.expressionAttributeValues = expressionAttributeValues
            self.key = key
            self.expressionAttributeNames = expressionAttributeNames
            self.returnValuesOnConditionCheckFailure = returnValuesOnConditionCheckFailure
    ...
    public struct BatchGetItemOutput: AWSShape {
        ...
        public init(responses: [String: [[String: AttributeValue]]]? = nil, unprocessedKeys: [String: KeysAndAttributes]? = nil, consumedCapacity: [ConsumedCapacity]? = nil) {
            self.responses = responses
    ...
    public struct ReplicaSettingsUpdate: AWSShape {
        ...
        public init(replicaProvisionedReadCapacityAutoScalingSettingsUpdate: AutoScalingSettingsUpdate? = nil, replicaGlobalSecondaryIndexSettingsUpdate: [ReplicaGlobalSecondaryIndexSettingsUpdate]? = nil, regionName: String, replicaProvisionedReadCapacityUnits: Int64? = nil) {
    ...
    public struct GlobalSecondaryIndexInfo: AWSShape {
        ...
        public init(provisionedThroughput: ProvisionedThroughput? = nil, keySchema: [KeySchemaElement]? = nil, indexName: String? = nil, projection: Projection? = nil) {
            self.provisionedThroughput = provisionedThroughput
            self.keySchema = keySchema
            self.indexName = indexName
            self.projection = projection
    ...
    public struct ProvisionedThroughputDescription: AWSShape {
        ...
        public init(numberOfDecreasesToday: Int64? = nil, lastIncreaseDateTime: TimeStamp? = nil, readCapacityUnits: Int64? = nil, lastDecreaseDateTime: TimeStamp? = nil, writeCapacityUnits: Int64? = nil) {
    ...
    public struct PointInTimeRecoveryDescription: AWSShape {
        ...
        public init(pointInTimeRecoveryStatus: PointInTimeRecoveryStatus? = nil, earliestRestorableDateTime: TimeStamp? = nil, latestRestorableDateTime: TimeStamp? = nil) {
    ...
    public struct AutoScalingSettingsUpdate: AWSShape {
        ...
        public init(autoScalingDisabled: Bool? = nil, maximumUnits: Int64? = nil, autoScalingRoleArn: String? = nil, scalingPolicyUpdate: AutoScalingPolicyUpdate? = nil, minimumUnits: Int64? = nil) {
            self.autoScalingDisabled = autoScalingDisabled
            self.maximumUnits = maximumUnits
            self.autoScalingRoleArn = autoScalingRoleArn
