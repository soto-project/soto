...
public struct DynamoDB: AWSService {
    ...
    public func batchGetItem(_ input: BatchGetItemInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<BatchGetItemOutput> {
        return self.client.execute(operation: "BatchGetItem", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func batchWriteItem(_ input: BatchWriteItemInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<BatchWriteItemOutput> {
        return self.client.execute(operation: "BatchWriteItem", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createBackup(_ input: CreateBackupInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateBackupOutput> {
        return self.client.execute(operation: "CreateBackup", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateGlobalTableOutput> {
        return self.client.execute(operation: "CreateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteBackup(_ input: DeleteBackupInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteBackupOutput> {
        return self.client.execute(operation: "DeleteBackup", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteItem(_ input: DeleteItemInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteItemOutput> {
        return self.client.execute(operation: "DeleteItem", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeBackup(_ input: DescribeBackupInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeBackupOutput> {
        return self.client.execute(operation: "DescribeBackup", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeContinuousBackupsOutput> {
        return self.client.execute(operation: "DescribeContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeContributorInsights(_ input: DescribeContributorInsightsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeContributorInsightsOutput> {
        return self.client.execute(operation: "DescribeContributorInsights", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeEndpoints(_ input: DescribeEndpointsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeEndpointsResponse> {
        return self.client.execute(operation: "DescribeEndpoints", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeGlobalTable(_ input: DescribeGlobalTableInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeGlobalTableOutput> {
        return self.client.execute(operation: "DescribeGlobalTable", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeGlobalTableSettingsOutput> {
        return self.client.execute(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeLimitsOutput> {
        return self.client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTable(_ input: DescribeTableInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTableOutput> {
        return self.client.execute(operation: "DescribeTable", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTableReplicaAutoScaling(_ input: DescribeTableReplicaAutoScalingInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTableReplicaAutoScalingOutput> {
        return self.client.execute(operation: "DescribeTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTimeToLive(_ input: DescribeTimeToLiveInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTimeToLiveOutput> {
        return self.client.execute(operation: "DescribeTimeToLive", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getItem(_ input: GetItemInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetItemOutput> {
        return self.client.execute(operation: "GetItem", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listBackups(_ input: ListBackupsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListBackupsOutput> {
        return self.client.execute(operation: "ListBackups", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listContributorInsights(_ input: ListContributorInsightsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListContributorInsightsOutput> {
        return self.client.execute(operation: "ListContributorInsights", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListGlobalTablesOutput> {
        return self.client.execute(operation: "ListGlobalTables", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTables(_ input: ListTablesInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTablesOutput> {
        return self.client.execute(operation: "ListTables", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTagsOfResource(_ input: ListTagsOfResourceInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTagsOfResourceOutput> {
        return self.client.execute(operation: "ListTagsOfResource", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putItem(_ input: PutItemInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutItemOutput> {
        return self.client.execute(operation: "PutItem", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreTableFromBackupOutput> {
        return self.client.execute(operation: "RestoreTableFromBackup", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreTableToPointInTimeOutput> {
        return self.client.execute(operation: "RestoreTableToPointInTime", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func scan(_ input: ScanInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ScanOutput> {
        return self.client.execute(operation: "Scan", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func transactGetItems(_ input: TransactGetItemsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<TransactGetItemsOutput> {
        return self.client.execute(operation: "TransactGetItems", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func transactWriteItems(_ input: TransactWriteItemsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<TransactWriteItemsOutput> {
        return self.client.execute(operation: "TransactWriteItems", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateContinuousBackupsOutput> {
        return self.client.execute(operation: "UpdateContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateContributorInsights(_ input: UpdateContributorInsightsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateContributorInsightsOutput> {
        return self.client.execute(operation: "UpdateContributorInsights", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateGlobalTableOutput> {
        return self.client.execute(operation: "UpdateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateGlobalTableSettingsOutput> {
        return self.client.execute(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateItem(_ input: UpdateItemInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateItemOutput> {
        return self.client.execute(operation: "UpdateItem", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateTableReplicaAutoScaling(_ input: UpdateTableReplicaAutoScalingInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTableReplicaAutoScalingOutput> {
        return self.client.execute(operation: "UpdateTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateTimeToLive(_ input: UpdateTimeToLiveInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTimeToLiveOutput> {
        return self.client.execute(operation: "UpdateTimeToLive", path: "/", httpMethod: .POST, serviceConfig: config, input: input, on: eventLoop, logger: logger)
    }
}
