...
public struct DynamoDB: AWSService {
    ...
    /// return new `DynamoDB` with new timeout value
    ...
    /// return new `DynamoDB` logging to specified Logger
    ...
    public func batchGetItem(_ input: BatchGetItemInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchGetItemOutput> {
        return client.execute(operation: "BatchGetItem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func batchWriteItem(_ input: BatchWriteItemInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchWriteItemOutput> {
        return client.execute(operation: "BatchWriteItem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createBackup(_ input: CreateBackupInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBackupOutput> {
        return client.execute(operation: "CreateBackup", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateGlobalTableOutput> {
        return client.execute(operation: "CreateGlobalTable", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createTable(_ input: CreateTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTableOutput> {
    ...
    public func deleteBackup(_ input: DeleteBackupInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteBackupOutput> {
        return client.execute(operation: "DeleteBackup", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteItem(_ input: DeleteItemInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteItemOutput> {
        return client.execute(operation: "DeleteItem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteTable(_ input: DeleteTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTableOutput> {
    ...
    public func describeBackup(_ input: DescribeBackupInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBackupOutput> {
        return client.execute(operation: "DescribeBackup", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContinuousBackupsOutput> {
        return client.execute(operation: "DescribeContinuousBackups", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Returns information about contributor insights, for a given table or global secondary index.
    public func describeContributorInsights(_ input: DescribeContributorInsightsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContributorInsightsOutput> {
        return client.execute(operation: "DescribeContributorInsights", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeGlobalTable(_ input: DescribeGlobalTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGlobalTableOutput> {
        return client.execute(operation: "DescribeGlobalTable", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Describes Region-specific settings for a global table.  This operation only applies to Version 2017.11.29 of global tables. 
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeGlobalTableSettingsOutput> {
        return client.execute(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeLimitsOutput> {
        return client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeTable(_ input: DescribeTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTableOutput> {
        return client.execute(operation: "DescribeTable", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeTableReplicaAutoScaling(_ input: DescribeTableReplicaAutoScalingInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTableReplicaAutoScalingOutput> {
        return client.execute(operation: "DescribeTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Gives a description of the Time to Live (TTL) status on the specified table. 
    public func describeTimeToLive(_ input: DescribeTimeToLiveInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTimeToLiveOutput> {
        return client.execute(operation: "DescribeTimeToLive", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getItem(_ input: GetItemInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetItemOutput> {
        return client.execute(operation: "GetItem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listBackups(_ input: ListBackupsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListBackupsOutput> {
        return client.execute(operation: "ListBackups", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
    public func listContributorInsights(_ input: ListContributorInsightsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListContributorInsightsOutput> {
        return client.execute(operation: "ListContributorInsights", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGlobalTablesOutput> {
        return client.execute(operation: "ListGlobalTables", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Returns an array of table names associated with the current account and endpoint. The output from ListTables is paginated, with each page returning a maximum of 100 table names.
    public func listTables(_ input: ListTablesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTablesOutput> {
        return client.execute(operation: "ListTables", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTagsOfResource(_ input: ListTagsOfResourceInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsOfResourceOutput> {
        return client.execute(operation: "ListTagsOfResource", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putItem(_ input: PutItemInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutItemOutput> {
        return client.execute(operation: "PutItem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func query(_ input: QueryInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<QueryOutput> {
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreTableFromBackupOutput> {
        return client.execute(operation: "RestoreTableFromBackup", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreTableToPointInTimeOutput> {
        return client.execute(operation: "RestoreTableToPointInTime", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func scan(_ input: ScanInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ScanOutput> {
        return client.execute(operation: "Scan", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func transactGetItems(_ input: TransactGetItemsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TransactGetItemsOutput> {
        return client.execute(operation: "TransactGetItems", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func transactWriteItems(_ input: TransactWriteItemsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TransactWriteItemsOutput> {
        return client.execute(operation: "TransactWriteItems", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContinuousBackupsOutput> {
        return client.execute(operation: "UpdateContinuousBackups", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Updates the status for contributor insights for a specific table or index.
    public func updateContributorInsights(_ input: UpdateContributorInsightsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateContributorInsightsOutput> {
        return client.execute(operation: "UpdateContributorInsights", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGlobalTableOutput> {
        return client.execute(operation: "UpdateGlobalTable", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Updates settings for a global table.
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateGlobalTableSettingsOutput> {
        return client.execute(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateItem(_ input: UpdateItemInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateItemOutput> {
        return client.execute(operation: "UpdateItem", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateTable(_ input: UpdateTableInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTableOutput> {
    ...
    public func updateTableReplicaAutoScaling(_ input: UpdateTableReplicaAutoScalingInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTableReplicaAutoScalingOutput> {
        return client.execute(operation: "UpdateTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateTimeToLive(_ input: UpdateTimeToLiveInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTimeToLiveOutput> {
        return client.execute(operation: "UpdateTimeToLive", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
