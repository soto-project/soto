...
public struct DynamoDB: AWSService {
    ...
    public func batchGetItem(_ input: BatchGetItemInput) -> EventLoopFuture<BatchGetItemOutput> {
        return client.execute(operation: "BatchGetItem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchWriteItem(_ input: BatchWriteItemInput) -> EventLoopFuture<BatchWriteItemOutput> {
        return client.execute(operation: "BatchWriteItem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createBackup(_ input: CreateBackupInput) -> EventLoopFuture<CreateBackupOutput> {
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput) -> EventLoopFuture<CreateGlobalTableOutput> {
        return client.execute(operation: "CreateGlobalTable", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createTable(_ input: CreateTableInput) -> EventLoopFuture<CreateTableOutput> {
    ...
    public func deleteBackup(_ input: DeleteBackupInput) -> EventLoopFuture<DeleteBackupOutput> {
    ...
    public func deleteItem(_ input: DeleteItemInput) -> EventLoopFuture<DeleteItemOutput> {
        return client.execute(operation: "DeleteItem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteTable(_ input: DeleteTableInput) -> EventLoopFuture<DeleteTableOutput> {
    ...
    public func describeBackup(_ input: DescribeBackupInput) -> EventLoopFuture<DescribeBackupOutput> {
        return client.execute(operation: "DescribeBackup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput) -> EventLoopFuture<DescribeContinuousBackupsOutput> {
        return client.execute(operation: "DescribeContinuousBackups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns information about contributor insights, for a given table or global secondary index.
    public func describeContributorInsights(_ input: DescribeContributorInsightsInput) -> EventLoopFuture<DescribeContributorInsightsOutput> {
        return client.execute(operation: "DescribeContributorInsights", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeGlobalTable(_ input: DescribeGlobalTableInput) -> EventLoopFuture<DescribeGlobalTableOutput> {
        return client.execute(operation: "DescribeGlobalTable", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput) -> EventLoopFuture<DescribeGlobalTableSettingsOutput> {
        return client.execute(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput) -> EventLoopFuture<DescribeLimitsOutput> {
        return client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTable(_ input: DescribeTableInput) -> EventLoopFuture<DescribeTableOutput> {
        return client.execute(operation: "DescribeTable", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTableReplicaAutoScaling(_ input: DescribeTableReplicaAutoScalingInput) -> EventLoopFuture<DescribeTableReplicaAutoScalingOutput> {
        return client.execute(operation: "DescribeTableReplicaAutoScaling", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gives a description of the Time to Live (TTL) status on the specified table. 
    public func describeTimeToLive(_ input: DescribeTimeToLiveInput) -> EventLoopFuture<DescribeTimeToLiveOutput> {
        return client.execute(operation: "DescribeTimeToLive", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getItem(_ input: GetItemInput) -> EventLoopFuture<GetItemOutput> {
        return client.execute(operation: "GetItem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listBackups(_ input: ListBackupsInput) -> EventLoopFuture<ListBackupsOutput> {
        return client.execute(operation: "ListBackups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
    public func listContributorInsights(_ input: ListContributorInsightsInput) -> EventLoopFuture<ListContributorInsightsOutput> {
        return client.execute(operation: "ListContributorInsights", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput) -> EventLoopFuture<ListGlobalTablesOutput> {
        return client.execute(operation: "ListGlobalTables", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns an array of table names associated with the current account and endpoint. The output from ListTables is paginated, with each page returning a maximum of 100 table names.
    public func listTables(_ input: ListTablesInput) -> EventLoopFuture<ListTablesOutput> {
        return client.execute(operation: "ListTables", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTagsOfResource(_ input: ListTagsOfResourceInput) -> EventLoopFuture<ListTagsOfResourceOutput> {
        return client.execute(operation: "ListTagsOfResource", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putItem(_ input: PutItemInput) -> EventLoopFuture<PutItemOutput> {
        return client.execute(operation: "PutItem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func query(_ input: QueryInput) -> EventLoopFuture<QueryOutput> {
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput) -> EventLoopFuture<RestoreTableFromBackupOutput> {
        return client.execute(operation: "RestoreTableFromBackup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput) -> EventLoopFuture<RestoreTableToPointInTimeOutput> {
        return client.execute(operation: "RestoreTableToPointInTime", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func scan(_ input: ScanInput) -> EventLoopFuture<ScanOutput> {
        return client.execute(operation: "Scan", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func transactGetItems(_ input: TransactGetItemsInput) -> EventLoopFuture<TransactGetItemsOutput> {
        return client.execute(operation: "TransactGetItems", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func transactWriteItems(_ input: TransactWriteItemsInput) -> EventLoopFuture<TransactWriteItemsOutput> {
        return client.execute(operation: "TransactWriteItems", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput) -> EventLoopFuture<UpdateContinuousBackupsOutput> {
        return client.execute(operation: "UpdateContinuousBackups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Updates the status for contributor insights for a specific table or index.
    public func updateContributorInsights(_ input: UpdateContributorInsightsInput) -> EventLoopFuture<UpdateContributorInsightsOutput> {
        return client.execute(operation: "UpdateContributorInsights", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput) -> EventLoopFuture<UpdateGlobalTableOutput> {
        return client.execute(operation: "UpdateGlobalTable", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Updates settings for a global table.
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput) -> EventLoopFuture<UpdateGlobalTableSettingsOutput> {
        return client.execute(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateItem(_ input: UpdateItemInput) -> EventLoopFuture<UpdateItemOutput> {
        return client.execute(operation: "UpdateItem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateTable(_ input: UpdateTableInput) -> EventLoopFuture<UpdateTableOutput> {
    ...
    public func updateTableReplicaAutoScaling(_ input: UpdateTableReplicaAutoScalingInput) -> EventLoopFuture<UpdateTableReplicaAutoScalingOutput> {
        return client.execute(operation: "UpdateTableReplicaAutoScaling", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateTimeToLive(_ input: UpdateTimeToLiveInput) -> EventLoopFuture<UpdateTimeToLiveOutput> {
        return client.execute(operation: "UpdateTimeToLive", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
