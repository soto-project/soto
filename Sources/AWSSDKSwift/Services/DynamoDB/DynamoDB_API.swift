...
public struct DynamoDB {
    ...
    public func batchGetItem(_ input: BatchGetItemInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<BatchGetItemOutput> {
        return client.execute(operation: "BatchGetItem", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func batchWriteItem(_ input: BatchWriteItemInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<BatchWriteItemOutput> {
        return client.execute(operation: "BatchWriteItem", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createBackup(_ input: CreateBackupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateBackupOutput> {
    ...
    public func createGlobalTable(_ input: CreateGlobalTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateGlobalTableOutput> {
        return client.execute(operation: "CreateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createTable(_ input: CreateTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateTableOutput> {
    ...
    public func deleteBackup(_ input: DeleteBackupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteBackupOutput> {
    ...
    public func deleteItem(_ input: DeleteItemInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteItemOutput> {
        return client.execute(operation: "DeleteItem", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteTable(_ input: DeleteTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteTableOutput> {
    ...
    public func describeBackup(_ input: DescribeBackupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeBackupOutput> {
        return client.execute(operation: "DescribeBackup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeContinuousBackups(_ input: DescribeContinuousBackupsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeContinuousBackupsOutput> {
        return client.execute(operation: "DescribeContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Returns information about contributor insights, for a given table or global secondary index.
    public func describeContributorInsights(_ input: DescribeContributorInsightsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeContributorInsightsOutput> {
        return client.execute(operation: "DescribeContributorInsights", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeGlobalTable(_ input: DescribeGlobalTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeGlobalTableOutput> {
        return client.execute(operation: "DescribeGlobalTable", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Describes Region-specific settings for a global table.  This operation only applies to Version 2017.11.29 of global tables. 
    public func describeGlobalTableSettings(_ input: DescribeGlobalTableSettingsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeGlobalTableSettingsOutput> {
        return client.execute(operation: "DescribeGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeLimits(_ input: DescribeLimitsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeLimitsOutput> {
        return client.execute(operation: "DescribeLimits", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTable(_ input: DescribeTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTableOutput> {
        return client.execute(operation: "DescribeTable", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTableReplicaAutoScaling(_ input: DescribeTableReplicaAutoScalingInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTableReplicaAutoScalingOutput> {
        return client.execute(operation: "DescribeTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gives a description of the Time to Live (TTL) status on the specified table. 
    public func describeTimeToLive(_ input: DescribeTimeToLiveInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTimeToLiveOutput> {
        return client.execute(operation: "DescribeTimeToLive", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getItem(_ input: GetItemInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetItemOutput> {
        return client.execute(operation: "GetItem", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listBackups(_ input: ListBackupsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListBackupsOutput> {
        return client.execute(operation: "ListBackups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
    public func listContributorInsights(_ input: ListContributorInsightsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListContributorInsightsOutput> {
        return client.execute(operation: "ListContributorInsights", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listGlobalTables(_ input: ListGlobalTablesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListGlobalTablesOutput> {
        return client.execute(operation: "ListGlobalTables", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Returns an array of table names associated with the current account and endpoint. The output from ListTables is paginated, with each page returning a maximum of 100 table names.
    public func listTables(_ input: ListTablesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTablesOutput> {
        return client.execute(operation: "ListTables", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTagsOfResource(_ input: ListTagsOfResourceInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTagsOfResourceOutput> {
        return client.execute(operation: "ListTagsOfResource", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putItem(_ input: PutItemInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutItemOutput> {
        return client.execute(operation: "PutItem", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func query(_ input: QueryInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<QueryOutput> {
    ...
    public func restoreTableFromBackup(_ input: RestoreTableFromBackupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreTableFromBackupOutput> {
        return client.execute(operation: "RestoreTableFromBackup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func restoreTableToPointInTime(_ input: RestoreTableToPointInTimeInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreTableToPointInTimeOutput> {
        return client.execute(operation: "RestoreTableToPointInTime", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func scan(_ input: ScanInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ScanOutput> {
        return client.execute(operation: "Scan", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func transactGetItems(_ input: TransactGetItemsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<TransactGetItemsOutput> {
        return client.execute(operation: "TransactGetItems", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func transactWriteItems(_ input: TransactWriteItemsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<TransactWriteItemsOutput> {
        return client.execute(operation: "TransactWriteItems", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateContinuousBackups(_ input: UpdateContinuousBackupsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateContinuousBackupsOutput> {
        return client.execute(operation: "UpdateContinuousBackups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Updates the status for contributor insights for a specific table or index.
    public func updateContributorInsights(_ input: UpdateContributorInsightsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateContributorInsightsOutput> {
        return client.execute(operation: "UpdateContributorInsights", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateGlobalTable(_ input: UpdateGlobalTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateGlobalTableOutput> {
        return client.execute(operation: "UpdateGlobalTable", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Updates settings for a global table.
    public func updateGlobalTableSettings(_ input: UpdateGlobalTableSettingsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateGlobalTableSettingsOutput> {
        return client.execute(operation: "UpdateGlobalTableSettings", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateItem(_ input: UpdateItemInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateItemOutput> {
        return client.execute(operation: "UpdateItem", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateTable(_ input: UpdateTableInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTableOutput> {
    ...
    public func updateTableReplicaAutoScaling(_ input: UpdateTableReplicaAutoScalingInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTableReplicaAutoScalingOutput> {
        return client.execute(operation: "UpdateTableReplicaAutoScaling", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateTimeToLive(_ input: UpdateTimeToLiveInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTimeToLiveOutput> {
        return client.execute(operation: "UpdateTimeToLive", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
