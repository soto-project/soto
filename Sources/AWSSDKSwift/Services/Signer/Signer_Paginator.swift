...
extension Signer {
    ...
    public func listSigningJobsPaginator(_ input: ListSigningJobsRequest) -> EventLoopFuture<[SigningJob]> {
        return client.paginate(input: input, command: listSigningJobs, resultKey: \ListSigningJobsResponse.jobs, tokenKey: \ListSigningJobsResponse.nextToken)
    }
    ...
    public func listSigningPlatformsPaginator(_ input: ListSigningPlatformsRequest) -> EventLoopFuture<[SigningPlatform]> {
        return client.paginate(input: input, command: listSigningPlatforms, resultKey: \ListSigningPlatformsResponse.platforms, tokenKey: \ListSigningPlatformsResponse.nextToken)
    }
    ...
    public func listSigningProfilesPaginator(_ input: ListSigningProfilesRequest) -> EventLoopFuture<[SigningProfile]> {
        return client.paginate(input: input, command: listSigningProfiles, resultKey: \ListSigningProfilesResponse.profiles, tokenKey: \ListSigningProfilesResponse.nextToken)
    }
