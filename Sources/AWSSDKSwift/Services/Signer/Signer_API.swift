...
public struct Signer {
    ...
    public func describeSigningJob(_ input: DescribeSigningJobRequest) throws -> EventLoopFuture<DescribeSigningJobResponse> {
    ...
    public func startSigningJob(_ input: StartSigningJobRequest) throws -> EventLoopFuture<StartSigningJobResponse> {
    ...
    public func listSigningProfiles(_ input: ListSigningProfilesRequest) throws -> EventLoopFuture<ListSigningProfilesResponse> {
    ...
    public func getSigningProfile(_ input: GetSigningProfileRequest) throws -> EventLoopFuture<GetSigningProfileResponse> {
    ...
    public func listSigningJobs(_ input: ListSigningJobsRequest) throws -> EventLoopFuture<ListSigningJobsResponse> {
    ...
    public func putSigningProfile(_ input: PutSigningProfileRequest) throws -> EventLoopFuture<PutSigningProfileResponse> {
    ...
    public func listSigningPlatforms(_ input: ListSigningPlatformsRequest) throws -> EventLoopFuture<ListSigningPlatformsResponse> {
        return try client.send(operation: "ListSigningPlatforms", path: "/signing-platforms", httpMethod: "GET", input: input)
    }

    ///  Returns information on a specific signing platform.
    public func getSigningPlatform(_ input: GetSigningPlatformRequest) throws -> EventLoopFuture<GetSigningPlatformResponse> {
