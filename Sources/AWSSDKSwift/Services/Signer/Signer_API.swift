...
public struct Signer {
    ...
    @discardableResult public func cancelSigningProfile(_ input: CancelSigningProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "CancelSigningProfile", path: "/signing-profiles/{profileName}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeSigningJob(_ input: DescribeSigningJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSigningJobResponse> {
        return client.execute(operation: "DescribeSigningJob", path: "/signing-jobs/{jobId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getSigningPlatform(_ input: GetSigningPlatformRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSigningPlatformResponse> {
        return client.execute(operation: "GetSigningPlatform", path: "/signing-platforms/{platformId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getSigningProfile(_ input: GetSigningProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSigningProfileResponse> {
        return client.execute(operation: "GetSigningProfile", path: "/signing-profiles/{profileName}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listSigningJobs(_ input: ListSigningJobsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSigningJobsResponse> {
        return client.execute(operation: "ListSigningJobs", path: "/signing-jobs", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listSigningPlatforms(_ input: ListSigningPlatformsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSigningPlatformsResponse> {
        return client.execute(operation: "ListSigningPlatforms", path: "/signing-platforms", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listSigningProfiles(_ input: ListSigningProfilesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSigningProfilesResponse> {
        return client.execute(operation: "ListSigningProfiles", path: "/signing-profiles", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putSigningProfile(_ input: PutSigningProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutSigningProfileResponse> {
        return client.execute(operation: "PutSigningProfile", path: "/signing-profiles/{profileName}", httpMethod: "PUT", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startSigningJob(_ input: StartSigningJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartSigningJobResponse> {
        return client.execute(operation: "StartSigningJob", path: "/signing-jobs", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
