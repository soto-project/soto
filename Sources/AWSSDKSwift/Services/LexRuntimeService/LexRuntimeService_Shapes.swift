...
extension LexRuntimeService {
    ...
    public struct GenericAttachment: AWSShape {
        ...
        public init(title: String? = nil, subTitle: String? = nil, imageUrl: String? = nil, attachmentLinkUrl: String? = nil, buttons: [Button]? = nil) {
            self.title = title
    ...
    public struct PostTextRequest: AWSShape {
        ...
        public init(botAlias: String, userId: String, inputText: String, requestAttributes: [String: String]? = nil, sessionAttributes: [String: String]? = nil, botName: String) {
    ...
    public struct PostContentRequest: AWSShape {
        ...
        public init(sessionAttributes: String? = nil, accept: String? = nil, requestAttributes: String? = nil, userId: String, botName: String, contentType: String, inputStream: Data, botAlias: String) {
            self.sessionAttributes = sessionAttributes
            self.accept = accept
            self.requestAttributes = requestAttributes
            self.userId = userId
    ...
    public struct PostContentResponse: AWSShape {
        ...
        public init(audioStream: Data? = nil, sessionAttributes: String? = nil, slots: String? = nil, slotToElicit: String? = nil, messageFormat: MessageFormatType? = nil, intentName: String? = nil, contentType: String? = nil, dialogState: DialogState? = nil, inputTranscript: String? = nil, message: String? = nil) {
    ...
    public struct PostTextResponse: AWSShape {
        ...
        public init(slots: [String: String]? = nil, sessionAttributes: [String: String]? = nil, responseCard: ResponseCard? = nil, slotToElicit: String? = nil, messageFormat: MessageFormatType? = nil, intentName: String? = nil, dialogState: DialogState? = nil, message: String? = nil) {
            self.slots = slots
            self.sessionAttributes = sessionAttributes
