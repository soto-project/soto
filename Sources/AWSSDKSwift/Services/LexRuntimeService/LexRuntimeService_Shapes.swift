...
extension LexRuntimeService {
    ...
    public struct GenericAttachment: AWSShape {
        ...
        public init(attachmentLinkUrl: String? = nil, buttons: [Button]? = nil, subTitle: String? = nil, imageUrl: String? = nil, title: String? = nil) {
    ...
    public struct PostContentRequest: AWSShape {
        ...
        public init(userId: String, sessionAttributes: String? = nil, requestAttributes: String? = nil, inputStream: Data, botAlias: String, contentType: String, accept: String? = nil, botName: String) {
            self.userId = userId
    ...
    public struct PostContentResponse: AWSShape {
        ...
        public init(inputTranscript: String? = nil, sessionAttributes: String? = nil, message: String? = nil, slotToElicit: String? = nil, slots: String? = nil, audioStream: Data? = nil, dialogState: DialogState? = nil, contentType: String? = nil, intentName: String? = nil, messageFormat: MessageFormatType? = nil) {
    ...
    public struct ResponseCard: AWSShape {
        ...
        public init(contentType: ContentType? = nil, version: String? = nil, genericAttachments: [GenericAttachment]? = nil) {
            self.contentType = contentType
    ...
    public struct PostTextResponse: AWSShape {
        ...
        public init(sessionAttributes: [String: String]? = nil, slotToElicit: String? = nil, slots: [String: String]? = nil, responseCard: ResponseCard? = nil, message: String? = nil, dialogState: DialogState? = nil, intentName: String? = nil, messageFormat: MessageFormatType? = nil) {
            self.sessionAttributes = sessionAttributes
            self.slotToElicit = slotToElicit
            self.slots = slots
    ...
    public struct PostTextRequest: AWSShape {
        ...
        public init(sessionAttributes: [String: String]? = nil, botName: String, botAlias: String, inputText: String, userId: String, requestAttributes: [String: String]? = nil) {
            self.sessionAttributes = sessionAttributes
            self.botName = botName
            self.botAlias = botAlias
