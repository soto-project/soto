...
extension LexRuntimeService {
    ...
    public struct PostContentResponse: AWSShape {
        ...
        public init(slots: String? = nil, slotToElicit: String? = nil, sessionAttributes: String? = nil, dialogState: DialogState? = nil, audioStream: Data? = nil, intentName: String? = nil, inputTranscript: String? = nil, message: String? = nil, contentType: String? = nil, messageFormat: MessageFormatType? = nil) {
            self.slots = slots
    ...
    public struct PostTextRequest: AWSShape {
        ...
        public init(botAlias: String, userId: String, requestAttributes: [String: String]? = nil, botName: String, sessionAttributes: [String: String]? = nil, inputText: String) {
    ...
    public struct PostTextResponse: AWSShape {
        ...
        public init(intentName: String? = nil, responseCard: ResponseCard? = nil, sessionAttributes: [String: String]? = nil, message: String? = nil, messageFormat: MessageFormatType? = nil, dialogState: DialogState? = nil, slotToElicit: String? = nil, slots: [String: String]? = nil) {
            self.intentName = intentName
    ...
    public struct PostContentRequest: AWSShape {
        ...
        public init(requestAttributes: String? = nil, sessionAttributes: String? = nil, inputStream: Data, botName: String, accept: String? = nil, userId: String, contentType: String, botAlias: String) {
            self.requestAttributes = requestAttributes
            self.sessionAttributes = sessionAttributes
    ...
    public struct ResponseCard: AWSShape {
        ...
        public init(genericAttachments: [GenericAttachment]? = nil, contentType: ContentType? = nil, version: String? = nil) {
    ...
    public struct GenericAttachment: AWSShape {
        ...
        public init(attachmentLinkUrl: String? = nil, imageUrl: String? = nil, title: String? = nil, subTitle: String? = nil, buttons: [Button]? = nil) {
