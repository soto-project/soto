...
public struct LexRuntimeService {
    ...
    public func postContent(_ input: PostContentRequest) throws -> EventLoopFuture<PostContentResponse> {
    ...
    public func postText(_ input: PostTextRequest) throws -> EventLoopFuture<PostTextResponse> {
