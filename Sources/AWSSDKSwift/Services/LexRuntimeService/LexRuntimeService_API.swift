...
public struct LexRuntimeService: AWSService {
    ...
    public func deleteSession(_ input: DeleteSessionRequest) -> EventLoopFuture<DeleteSessionResponse> {
        return client.execute(operation: "DeleteSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Returns session information for a specified bot, alias, and user ID.
    public func getSession(_ input: GetSessionRequest) -> EventLoopFuture<GetSessionResponse> {
        return client.execute(operation: "GetSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func postContent(_ input: PostContentRequest) -> EventLoopFuture<PostContentResponse> {
        return client.execute(operation: "PostContent", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/content", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func postText(_ input: PostTextRequest) -> EventLoopFuture<PostTextResponse> {
        return client.execute(operation: "PostText", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/text", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putSession(_ input: PutSessionRequest) -> EventLoopFuture<PutSessionResponse> {
        return client.execute(operation: "PutSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func postContentStreaming(_ input: PostContentRequest, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<PostContentResponse> {
        return client.execute(operation: "PostContent", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/content", httpMethod: .POST, input: input, config: self.config, context: self.context, stream: stream)
    }
    ...
    public func putSessionStreaming(_ input: PutSessionRequest, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<PutSessionResponse> {
        return client.execute(operation: "PutSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: .POST, input: input, config: self.config, context: self.context, stream: stream)
    }
}
