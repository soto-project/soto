...
public struct LexRuntimeService {
    ...
    public func deleteSession(_ input: DeleteSessionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteSessionResponse> {
        return client.execute(operation: "DeleteSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getSession(_ input: GetSessionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSessionResponse> {
        return client.execute(operation: "GetSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session/", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func postContent(_ input: PostContentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PostContentResponse> {
        return client.execute(operation: "PostContent", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/content", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func postText(_ input: PostTextRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PostTextResponse> {
        return client.execute(operation: "PostText", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/text", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putSession(_ input: PutSessionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutSessionResponse> {
        return client.execute(operation: "PutSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func postContentStreaming(_ input: PostContentRequest, on eventLoop: EventLoop? = nil, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<PostContentResponse> {
        return client.execute(operation: "PostContent", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/content", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop, stream: stream)
    }
    ...
    public func putSessionStreaming(_ input: PutSessionRequest, on eventLoop: EventLoop? = nil, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<PutSessionResponse> {
        return client.execute(operation: "PutSession", path: "/bot/{botName}/alias/{botAlias}/user/{userId}/session", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop, stream: stream)
    }
}
