...
public struct Shield {
    ...
    public func updateEmergencyContactSettings(_ input: UpdateEmergencyContactSettingsRequest) throws -> UpdateEmergencyContactSettingsResponse {
    ...
    public func describeDRTAccess(_ input: DescribeDRTAccessRequest) throws -> DescribeDRTAccessResponse {
    ...
    public func associateDRTLogBucket(_ input: AssociateDRTLogBucketRequest) throws -> AssociateDRTLogBucketResponse {
    ...
    public func disassociateDRTRole(_ input: DisassociateDRTRoleRequest) throws -> DisassociateDRTRoleResponse {
    ...
    public func updateSubscription(_ input: UpdateSubscriptionRequest) throws -> UpdateSubscriptionResponse {
    ...
    public func describeEmergencyContactSettings(_ input: DescribeEmergencyContactSettingsRequest) throws -> DescribeEmergencyContactSettingsResponse {
    ...
    public func associateDRTRole(_ input: AssociateDRTRoleRequest) throws -> AssociateDRTRoleResponse {
    ...
    public func disassociateDRTLogBucket(_ input: DisassociateDRTLogBucketRequest) throws -> DisassociateDRTLogBucketResponse {
