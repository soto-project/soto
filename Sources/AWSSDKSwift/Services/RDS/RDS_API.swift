...
public struct RDS {
    ...
    @discardableResult public func addRoleToDBCluster(_ input: AddRoleToDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddRoleToDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func addRoleToDBInstance(_ input: AddRoleToDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddRoleToDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Adds a source identifier to an existing RDS event notification subscription.
    public func addSourceIdentifierToSubscription(_ input: AddSourceIdentifierToSubscriptionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddSourceIdentifierToSubscriptionResult> {
        return client.execute(operation: "AddSourceIdentifierToSubscription", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func applyPendingMaintenanceAction(_ input: ApplyPendingMaintenanceActionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ApplyPendingMaintenanceActionResult> {
        return client.execute(operation: "ApplyPendingMaintenanceAction", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func authorizeDBSecurityGroupIngress(_ input: AuthorizeDBSecurityGroupIngressMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AuthorizeDBSecurityGroupIngressResult> {
    ...
    public func cancelExportTask(_ input: CancelExportTaskMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportTask> {
    ...
    public func copyDBClusterParameterGroup(_ input: CopyDBClusterParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyDBClusterParameterGroupResult> {
        return client.execute(operation: "CopyDBClusterParameterGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func copyDBClusterSnapshot(_ input: CopyDBClusterSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyDBClusterSnapshotResult> {
        return client.execute(operation: "CopyDBClusterSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Copies the specified DB parameter group.
    public func copyDBParameterGroup(_ input: CopyDBParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyDBParameterGroupResult> {
        return client.execute(operation: "CopyDBParameterGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func copyDBSnapshot(_ input: CopyDBSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyDBSnapshotResult> {
        return client.execute(operation: "CopyDBSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Copies the specified option group.
    public func copyOptionGroup(_ input: CopyOptionGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyOptionGroupResult> {
        return client.execute(operation: "CopyOptionGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createCustomAvailabilityZone(_ input: CreateCustomAvailabilityZoneMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCustomAvailabilityZoneResult> {
        return client.execute(operation: "CreateCustomAvailabilityZone", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBCluster(_ input: CreateDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBClusterResult> {
        return client.execute(operation: "CreateDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBClusterEndpoint(_ input: CreateDBClusterEndpointMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterEndpoint> {
        return client.execute(operation: "CreateDBClusterEndpoint", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBClusterParameterGroup(_ input: CreateDBClusterParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBClusterParameterGroupResult> {
        return client.execute(operation: "CreateDBClusterParameterGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBClusterSnapshot(_ input: CreateDBClusterSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBClusterSnapshotResult> {
        return client.execute(operation: "CreateDBClusterSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBInstance(_ input: CreateDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBInstanceResult> {
        return client.execute(operation: "CreateDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBInstanceReadReplica(_ input: CreateDBInstanceReadReplicaMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBInstanceReadReplicaResult> {
        return client.execute(operation: "CreateDBInstanceReadReplica", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBParameterGroup(_ input: CreateDBParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBParameterGroupResult> {
    ...
    public func createDBSecurityGroup(_ input: CreateDBSecurityGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBSecurityGroupResult> {
        return client.execute(operation: "CreateDBSecurityGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Creates a DBSnapshot. The source DBInstance must be in "available" state.
    public func createDBSnapshot(_ input: CreateDBSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBSnapshotResult> {
        return client.execute(operation: "CreateDBSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDBSubnetGroup(_ input: CreateDBSubnetGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDBSubnetGroupResult> {
        return client.execute(operation: "CreateDBSubnetGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createEventSubscription(_ input: CreateEventSubscriptionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateEventSubscriptionResult> {
    ...
    public func createOptionGroup(_ input: CreateOptionGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateOptionGroupResult> {
        return client.execute(operation: "CreateOptionGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteCustomAvailabilityZone(_ input: DeleteCustomAvailabilityZoneMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCustomAvailabilityZoneResult> {
        return client.execute(operation: "DeleteCustomAvailabilityZone", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteDBCluster(_ input: DeleteDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDBClusterResult> {
        return client.execute(operation: "DeleteDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes a custom endpoint and removes it from an Amazon Aurora DB cluster.  This action only applies to Aurora DB clusters. 
    public func deleteDBClusterEndpoint(_ input: DeleteDBClusterEndpointMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterEndpoint> {
        return client.execute(operation: "DeleteDBClusterEndpoint", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteDBClusterParameterGroup(_ input: DeleteDBClusterParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDBClusterParameterGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteDBClusterSnapshot(_ input: DeleteDBClusterSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDBClusterSnapshotResult> {
        return client.execute(operation: "DeleteDBClusterSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteDBInstance(_ input: DeleteDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDBInstanceResult> {
        return client.execute(operation: "DeleteDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes automated backups based on the source instance's DbiResourceId value or the restorable instance's resource ID.
    public func deleteDBInstanceAutomatedBackup(_ input: DeleteDBInstanceAutomatedBackupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDBInstanceAutomatedBackupResult> {
        return client.execute(operation: "DeleteDBInstanceAutomatedBackup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes a specified DB parameter group. The DB parameter group to be deleted can't be associated with any DB instances.
    @discardableResult public func deleteDBParameterGroup(_ input: DeleteDBParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteDBSecurityGroup(_ input: DeleteDBSecurityGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDBSecurityGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteDBSnapshot(_ input: DeleteDBSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDBSnapshotResult> {
        return client.execute(operation: "DeleteDBSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteDBSubnetGroup(_ input: DeleteDBSubnetGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDBSubnetGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes an RDS event notification subscription.
    public func deleteEventSubscription(_ input: DeleteEventSubscriptionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteEventSubscriptionResult> {
        return client.execute(operation: "DeleteEventSubscription", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteGlobalCluster(_ input: DeleteGlobalClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteGlobalClusterResult> {
        return client.execute(operation: "DeleteGlobalCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes the installation medium for a DB engine that requires an on-premises customer provided license, such as Microsoft SQL Server.
    public func deleteInstallationMedia(_ input: DeleteInstallationMediaMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InstallationMedia> {
        return client.execute(operation: "DeleteInstallationMedia", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes an existing option group.
    @discardableResult public func deleteOptionGroup(_ input: DeleteOptionGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
    ...
    public func describeAccountAttributes(_ input: DescribeAccountAttributesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AccountAttributesMessage> {
    ...
    public func describeCertificates(_ input: DescribeCertificatesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CertificateMessage> {
        return client.execute(operation: "DescribeCertificates", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeCustomAvailabilityZones(_ input: DescribeCustomAvailabilityZonesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CustomAvailabilityZoneMessage> {
    ...
    public func describeDBClusterEndpoints(_ input: DescribeDBClusterEndpointsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterEndpointMessage> {
        return client.execute(operation: "DescribeDBClusterEndpoints", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBClusterParameterGroups(_ input: DescribeDBClusterParameterGroupsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterParameterGroupsMessage> {
        return client.execute(operation: "DescribeDBClusterParameterGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBClusterParameters(_ input: DescribeDBClusterParametersMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterParameterGroupDetails> {
        return client.execute(operation: "DescribeDBClusterParameters", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBClusterSnapshotAttributes(_ input: DescribeDBClusterSnapshotAttributesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDBClusterSnapshotAttributesResult> {
        return client.execute(operation: "DescribeDBClusterSnapshotAttributes", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBClusterSnapshots(_ input: DescribeDBClusterSnapshotsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterSnapshotMessage> {
        return client.execute(operation: "DescribeDBClusterSnapshots", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBClusters(_ input: DescribeDBClustersMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterMessage> {
        return client.execute(operation: "DescribeDBClusters", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBEngineVersions(_ input: DescribeDBEngineVersionsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBEngineVersionMessage> {
        return client.execute(operation: "DescribeDBEngineVersions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Displays backups for both current and deleted instances. For example, use this operation to find details about automated backups for previously deleted instances. Current instances with retention periods greater than zero (0) are returned for both the DescribeDBInstanceAutomatedBackups and DescribeDBInstances operations. All parameters are optional.
    public func describeDBInstanceAutomatedBackups(_ input: DescribeDBInstanceAutomatedBackupsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBInstanceAutomatedBackupMessage> {
        return client.execute(operation: "DescribeDBInstanceAutomatedBackups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBInstances(_ input: DescribeDBInstancesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBInstanceMessage> {
        return client.execute(operation: "DescribeDBInstances", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Returns a list of DB log files for the DB instance.
    public func describeDBLogFiles(_ input: DescribeDBLogFilesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDBLogFilesResponse> {
        return client.execute(operation: "DescribeDBLogFiles", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///   Returns a list of DBParameterGroup descriptions. If a DBParameterGroupName is specified, the list will contain only the description of the specified DB parameter group. 
    public func describeDBParameterGroups(_ input: DescribeDBParameterGroupsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBParameterGroupsMessage> {
        return client.execute(operation: "DescribeDBParameterGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Returns the detailed parameter list for a particular DB parameter group.
    public func describeDBParameters(_ input: DescribeDBParametersMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBParameterGroupDetails> {
    ...
    public func describeDBSecurityGroups(_ input: DescribeDBSecurityGroupsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBSecurityGroupMessage> {
        return client.execute(operation: "DescribeDBSecurityGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBSnapshotAttributes(_ input: DescribeDBSnapshotAttributesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDBSnapshotAttributesResult> {
        return client.execute(operation: "DescribeDBSnapshotAttributes", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Returns information about DB snapshots. This API action supports pagination.
    public func describeDBSnapshots(_ input: DescribeDBSnapshotsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBSnapshotMessage> {
        return client.execute(operation: "DescribeDBSnapshots", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeDBSubnetGroups(_ input: DescribeDBSubnetGroupsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBSubnetGroupMessage> {
        return client.execute(operation: "DescribeDBSubnetGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeEngineDefaultClusterParameters(_ input: DescribeEngineDefaultClusterParametersMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEngineDefaultClusterParametersResult> {
        return client.execute(operation: "DescribeEngineDefaultClusterParameters", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Returns the default engine and system parameter information for the specified database engine.
    public func describeEngineDefaultParameters(_ input: DescribeEngineDefaultParametersMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeEngineDefaultParametersResult> {
        return client.execute(operation: "DescribeEngineDefaultParameters", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeEventCategories(_ input: DescribeEventCategoriesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EventCategoriesMessage> {
        return client.execute(operation: "DescribeEventCategories", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Lists all the subscription descriptions for a customer account. The description for a subscription includes SubscriptionName, SNSTopicARN, CustomerID, SourceType, SourceID, CreationTime, and Status. If you specify a SubscriptionName, lists the description for that subscription.
    public func describeEventSubscriptions(_ input: DescribeEventSubscriptionsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EventSubscriptionsMessage> {
        return client.execute(operation: "DescribeEventSubscriptions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeExportTasks(_ input: DescribeExportTasksMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportTasksMessage> {
    ...
    public func describeGlobalClusters(_ input: DescribeGlobalClustersMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GlobalClustersMessage> {
        return client.execute(operation: "DescribeGlobalClusters", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Describes the available installation media for a DB engine that requires an on-premises customer provided license, such as Microsoft SQL Server.
    public func describeInstallationMedia(_ input: DescribeInstallationMediaMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InstallationMediaMessage> {
        return client.execute(operation: "DescribeInstallationMedia", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Describes all available options.
    public func describeOptionGroupOptions(_ input: DescribeOptionGroupOptionsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<OptionGroupOptionsMessage> {
        return client.execute(operation: "DescribeOptionGroupOptions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Describes the available option groups.
    public func describeOptionGroups(_ input: DescribeOptionGroupsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<OptionGroups> {
        return client.execute(operation: "DescribeOptionGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeOrderableDBInstanceOptions(_ input: DescribeOrderableDBInstanceOptionsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<OrderableDBInstanceOptionsMessage> {
        return client.execute(operation: "DescribeOrderableDBInstanceOptions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describePendingMaintenanceActions(_ input: DescribePendingMaintenanceActionsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PendingMaintenanceActionsMessage> {
        return client.execute(operation: "DescribePendingMaintenanceActions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Returns information about reserved DB instances for this account, or about a specified reserved DB instance.
    public func describeReservedDBInstances(_ input: DescribeReservedDBInstancesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReservedDBInstanceMessage> {
        return client.execute(operation: "DescribeReservedDBInstances", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Lists available reserved DB instance offerings.
    public func describeReservedDBInstancesOfferings(_ input: DescribeReservedDBInstancesOfferingsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ReservedDBInstancesOfferingMessage> {
        return client.execute(operation: "DescribeReservedDBInstancesOfferings", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Returns a list of the source AWS Regions where the current AWS Region can create a read replica or copy a DB snapshot from. This API action supports pagination.
    public func describeSourceRegions(_ input: DescribeSourceRegionsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SourceRegionMessage> {
        return client.execute(operation: "DescribeSourceRegions", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  You can call DescribeValidDBInstanceModifications to learn what modifications you can make to your DB instance. You can use this information when you call ModifyDBInstance. 
    public func describeValidDBInstanceModifications(_ input: DescribeValidDBInstanceModificationsMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeValidDBInstanceModificationsResult> {
        return client.execute(operation: "DescribeValidDBInstanceModifications", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Downloads all or a portion of the specified log file, up to 1 MB in size.
    public func downloadDBLogFilePortion(_ input: DownloadDBLogFilePortionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DownloadDBLogFilePortionDetails> {
        return client.execute(operation: "DownloadDBLogFilePortion", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func failoverDBCluster(_ input: FailoverDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<FailoverDBClusterResult> {
        return client.execute(operation: "FailoverDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Imports the installation media for a DB engine that requires an on-premises customer provided license, such as SQL Server.
    public func importInstallationMedia(_ input: ImportInstallationMediaMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InstallationMedia> {
        return client.execute(operation: "ImportInstallationMedia", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func modifyCertificates(_ input: ModifyCertificatesMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyCertificatesResult> {
        return client.execute(operation: "ModifyCertificates", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func modifyCurrentDBClusterCapacity(_ input: ModifyCurrentDBClusterCapacityMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterCapacityInfo> {
        return client.execute(operation: "ModifyCurrentDBClusterCapacity", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func modifyDBCluster(_ input: ModifyDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyDBClusterResult> {
        return client.execute(operation: "ModifyDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Modifies the properties of an endpoint in an Amazon Aurora DB cluster.  This action only applies to Aurora DB clusters. 
    public func modifyDBClusterEndpoint(_ input: ModifyDBClusterEndpointMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterEndpoint> {
        return client.execute(operation: "ModifyDBClusterEndpoint", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func modifyDBInstance(_ input: ModifyDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyDBInstanceResult> {
        return client.execute(operation: "ModifyDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func modifyDBParameterGroup(_ input: ModifyDBParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBParameterGroupNameMessage> {
    ...
    public func modifyDBSnapshot(_ input: ModifyDBSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyDBSnapshotResult> {
    ...
    public func modifyDBSubnetGroup(_ input: ModifyDBSubnetGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyDBSubnetGroupResult> {
        return client.execute(operation: "ModifyDBSubnetGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func modifyEventSubscription(_ input: ModifyEventSubscriptionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyEventSubscriptionResult> {
        return client.execute(operation: "ModifyEventSubscription", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///   Modify a setting for an Amazon Aurora global cluster. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. For more information on Amazon Aurora, see  What Is Amazon Aurora? in the Amazon Aurora User Guide.   This action only applies to Aurora DB clusters. 
    public func modifyGlobalCluster(_ input: ModifyGlobalClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyGlobalClusterResult> {
        return client.execute(operation: "ModifyGlobalCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Modifies an existing option group.
    public func modifyOptionGroup(_ input: ModifyOptionGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyOptionGroupResult> {
        return client.execute(operation: "ModifyOptionGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func promoteReadReplica(_ input: PromoteReadReplicaMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PromoteReadReplicaResult> {
        return client.execute(operation: "PromoteReadReplica", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Promotes a read replica DB cluster to a standalone DB cluster.  This action only applies to Aurora DB clusters. 
    public func promoteReadReplicaDBCluster(_ input: PromoteReadReplicaDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PromoteReadReplicaDBClusterResult> {
        return client.execute(operation: "PromoteReadReplicaDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Purchases a reserved DB instance offering.
    public func purchaseReservedDBInstancesOffering(_ input: PurchaseReservedDBInstancesOfferingMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PurchaseReservedDBInstancesOfferingResult> {
        return client.execute(operation: "PurchaseReservedDBInstancesOffering", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func removeFromGlobalCluster(_ input: RemoveFromGlobalClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveFromGlobalClusterResult> {
        return client.execute(operation: "RemoveFromGlobalCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func removeRoleFromDBCluster(_ input: RemoveRoleFromDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveRoleFromDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Disassociates an AWS Identity and Access Management (IAM) role from a DB instance.
    @discardableResult public func removeRoleFromDBInstance(_ input: RemoveRoleFromDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveRoleFromDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Removes a source identifier from an existing RDS event notification subscription.
    public func removeSourceIdentifierFromSubscription(_ input: RemoveSourceIdentifierFromSubscriptionMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RemoveSourceIdentifierFromSubscriptionResult> {
        return client.execute(operation: "RemoveSourceIdentifierFromSubscription", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func resetDBClusterParameterGroup(_ input: ResetDBClusterParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBClusterParameterGroupNameMessage> {
        return client.execute(operation: "ResetDBClusterParameterGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Modifies the parameters of a DB parameter group to the engine/system default value. To reset specific parameters, provide a list of the following: ParameterName and ApplyMethod. To reset the entire DB parameter group, specify the DBParameterGroup name and ResetAllParameters parameters. When resetting the entire group, dynamic parameters are updated immediately and static parameters are set to pending-reboot to take effect on the next DB instance restart or RebootDBInstance request. 
    public func resetDBParameterGroup(_ input: ResetDBParameterGroupMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DBParameterGroupNameMessage> {
        return client.execute(operation: "ResetDBParameterGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func restoreDBClusterFromS3(_ input: RestoreDBClusterFromS3Message, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreDBClusterFromS3Result> {
        return client.execute(operation: "RestoreDBClusterFromS3", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func restoreDBClusterFromSnapshot(_ input: RestoreDBClusterFromSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreDBClusterFromSnapshotResult> {
        return client.execute(operation: "RestoreDBClusterFromSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func restoreDBClusterToPointInTime(_ input: RestoreDBClusterToPointInTimeMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreDBClusterToPointInTimeResult> {
        return client.execute(operation: "RestoreDBClusterToPointInTime", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func restoreDBInstanceFromDBSnapshot(_ input: RestoreDBInstanceFromDBSnapshotMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreDBInstanceFromDBSnapshotResult> {
        return client.execute(operation: "RestoreDBInstanceFromDBSnapshot", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Amazon Relational Database Service (Amazon RDS) supports importing MySQL databases by using backup files. You can create a backup of your on-premises database, store it on Amazon Simple Storage Service (Amazon S3), and then restore the backup file onto a new Amazon RDS DB instance running MySQL. For more information, see Importing Data into an Amazon RDS MySQL DB Instance in the Amazon RDS User Guide. 
    public func restoreDBInstanceFromS3(_ input: RestoreDBInstanceFromS3Message, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreDBInstanceFromS3Result> {
        return client.execute(operation: "RestoreDBInstanceFromS3", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func restoreDBInstanceToPointInTime(_ input: RestoreDBInstanceToPointInTimeMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreDBInstanceToPointInTimeResult> {
        return client.execute(operation: "RestoreDBInstanceToPointInTime", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Revokes ingress from a DBSecurityGroup for previously authorized IP ranges or EC2 or VPC Security Groups. Required parameters for this API are one of CIDRIP, EC2SecurityGroupId for VPC, or (EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId).
    public func revokeDBSecurityGroupIngress(_ input: RevokeDBSecurityGroupIngressMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RevokeDBSecurityGroupIngressResult> {
        return client.execute(operation: "RevokeDBSecurityGroupIngress", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startActivityStream(_ input: StartActivityStreamRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartActivityStreamResponse> {
        return client.execute(operation: "StartActivityStream", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startDBCluster(_ input: StartDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDBClusterResult> {
        return client.execute(operation: "StartDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startDBInstance(_ input: StartDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDBInstanceResult> {
        return client.execute(operation: "StartDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Starts an export of a snapshot to Amazon S3. The provided IAM role must have access to the S3 bucket. 
    public func startExportTask(_ input: StartExportTaskMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportTask> {
    ...
    public func stopActivityStream(_ input: StopActivityStreamRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopActivityStreamResponse> {
        return client.execute(operation: "StopActivityStream", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func stopDBCluster(_ input: StopDBClusterMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopDBClusterResult> {
        return client.execute(operation: "StopDBCluster", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func stopDBInstance(_ input: StopDBInstanceMessage, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopDBInstanceResult> {
        return client.execute(operation: "StopDBInstance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
