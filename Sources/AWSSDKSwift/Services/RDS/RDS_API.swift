...
public struct RDS: AWSService {
    ...
    @discardableResult public func addRoleToDBCluster(_ input: AddRoleToDBClusterMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddRoleToDBCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func addRoleToDBInstance(_ input: AddRoleToDBInstanceMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "AddRoleToDBInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func addSourceIdentifierToSubscription(_ input: AddSourceIdentifierToSubscriptionMessage) -> EventLoopFuture<AddSourceIdentifierToSubscriptionResult> {
        return client.execute(operation: "AddSourceIdentifierToSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func authorizeDBSecurityGroupIngress(_ input: AuthorizeDBSecurityGroupIngressMessage) -> EventLoopFuture<AuthorizeDBSecurityGroupIngressResult> {
        return client.execute(operation: "AuthorizeDBSecurityGroupIngress", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func backtrackDBCluster(_ input: BacktrackDBClusterMessage) -> EventLoopFuture<DBClusterBacktrack> {
        return client.execute(operation: "BacktrackDBCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Cancels an export task in progress that is exporting a snapshot to Amazon S3. Any data that has already been written to the S3 bucket isn't removed. 
    public func cancelExportTask(_ input: CancelExportTaskMessage) -> EventLoopFuture<ExportTask> {
        return client.execute(operation: "CancelExportTask", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func copyDBParameterGroup(_ input: CopyDBParameterGroupMessage) -> EventLoopFuture<CopyDBParameterGroupResult> {
        return client.execute(operation: "CopyDBParameterGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func copyDBSnapshot(_ input: CopyDBSnapshotMessage) -> EventLoopFuture<CopyDBSnapshotResult> {
        return client.execute(operation: "CopyDBSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Copies the specified option group.
    public func copyOptionGroup(_ input: CopyOptionGroupMessage) -> EventLoopFuture<CopyOptionGroupResult> {
        return client.execute(operation: "CopyOptionGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createCustomAvailabilityZone(_ input: CreateCustomAvailabilityZoneMessage) -> EventLoopFuture<CreateCustomAvailabilityZoneResult> {
        return client.execute(operation: "CreateCustomAvailabilityZone", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDBClusterEndpoint(_ input: CreateDBClusterEndpointMessage) -> EventLoopFuture<DBClusterEndpoint> {
        return client.execute(operation: "CreateDBClusterEndpoint", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDBInstanceReadReplica(_ input: CreateDBInstanceReadReplicaMessage) -> EventLoopFuture<CreateDBInstanceReadReplicaResult> {
        return client.execute(operation: "CreateDBInstanceReadReplica", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDBParameterGroup(_ input: CreateDBParameterGroupMessage) -> EventLoopFuture<CreateDBParameterGroupResult> {
        return client.execute(operation: "CreateDBParameterGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a new DB proxy.
    public func createDBProxy(_ input: CreateDBProxyRequest) -> EventLoopFuture<CreateDBProxyResponse> {
        return client.execute(operation: "CreateDBProxy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDBSecurityGroup(_ input: CreateDBSecurityGroupMessage) -> EventLoopFuture<CreateDBSecurityGroupResult> {
        return client.execute(operation: "CreateDBSecurityGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a DBSnapshot. The source DBInstance must be in "available" state.
    public func createDBSnapshot(_ input: CreateDBSnapshotMessage) -> EventLoopFuture<CreateDBSnapshotResult> {
        return client.execute(operation: "CreateDBSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createGlobalCluster(_ input: CreateGlobalClusterMessage) -> EventLoopFuture<CreateGlobalClusterResult> {
        return client.execute(operation: "CreateGlobalCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a new option group. You can create up to 20 option groups.
    public func createOptionGroup(_ input: CreateOptionGroupMessage) -> EventLoopFuture<CreateOptionGroupResult> {
        return client.execute(operation: "CreateOptionGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteCustomAvailabilityZone(_ input: DeleteCustomAvailabilityZoneMessage) -> EventLoopFuture<DeleteCustomAvailabilityZoneResult> {
        return client.execute(operation: "DeleteCustomAvailabilityZone", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDBClusterEndpoint(_ input: DeleteDBClusterEndpointMessage) -> EventLoopFuture<DBClusterEndpoint> {
        return client.execute(operation: "DeleteDBClusterEndpoint", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDBInstanceAutomatedBackup(_ input: DeleteDBInstanceAutomatedBackupMessage) -> EventLoopFuture<DeleteDBInstanceAutomatedBackupResult> {
        return client.execute(operation: "DeleteDBInstanceAutomatedBackup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteDBParameterGroup(_ input: DeleteDBParameterGroupMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDBParameterGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes an existing proxy.
    public func deleteDBProxy(_ input: DeleteDBProxyRequest) -> EventLoopFuture<DeleteDBProxyResponse> {
        return client.execute(operation: "DeleteDBProxy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes a DB security group.  The specified DB security group must not be associated with any DB instances. 
    @discardableResult public func deleteDBSecurityGroup(_ input: DeleteDBSecurityGroupMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDBSecurityGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDBSnapshot(_ input: DeleteDBSnapshotMessage) -> EventLoopFuture<DeleteDBSnapshotResult> {
        return client.execute(operation: "DeleteDBSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteGlobalCluster(_ input: DeleteGlobalClusterMessage) -> EventLoopFuture<DeleteGlobalClusterResult> {
        return client.execute(operation: "DeleteGlobalCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the installation medium for a DB engine that requires an on-premises customer provided license, such as Microsoft SQL Server.
    public func deleteInstallationMedia(_ input: DeleteInstallationMediaMessage) -> EventLoopFuture<InstallationMedia> {
        return client.execute(operation: "DeleteInstallationMedia", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes an existing option group.
    @discardableResult public func deleteOptionGroup(_ input: DeleteOptionGroupMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteOptionGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deregisterDBProxyTargets(_ input: DeregisterDBProxyTargetsRequest) -> EventLoopFuture<DeregisterDBProxyTargetsResponse> {
        return client.execute(operation: "DeregisterDBProxyTargets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAccountAttributes(_ input: DescribeAccountAttributesMessage) -> EventLoopFuture<AccountAttributesMessage> {
    ...
    public func describeCustomAvailabilityZones(_ input: DescribeCustomAvailabilityZonesMessage) -> EventLoopFuture<CustomAvailabilityZoneMessage> {
        return client.execute(operation: "DescribeCustomAvailabilityZones", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBClusterBacktracks(_ input: DescribeDBClusterBacktracksMessage) -> EventLoopFuture<DBClusterBacktrackMessage> {
        return client.execute(operation: "DescribeDBClusterBacktracks", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBClusterEndpoints(_ input: DescribeDBClusterEndpointsMessage) -> EventLoopFuture<DBClusterEndpointMessage> {
        return client.execute(operation: "DescribeDBClusterEndpoints", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBInstanceAutomatedBackups(_ input: DescribeDBInstanceAutomatedBackupsMessage) -> EventLoopFuture<DBInstanceAutomatedBackupMessage> {
        return client.execute(operation: "DescribeDBInstanceAutomatedBackups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBLogFiles(_ input: DescribeDBLogFilesMessage) -> EventLoopFuture<DescribeDBLogFilesResponse> {
        return client.execute(operation: "DescribeDBLogFiles", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBParameterGroups(_ input: DescribeDBParameterGroupsMessage) -> EventLoopFuture<DBParameterGroupsMessage> {
        return client.execute(operation: "DescribeDBParameterGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBParameters(_ input: DescribeDBParametersMessage) -> EventLoopFuture<DBParameterGroupDetails> {
        return client.execute(operation: "DescribeDBParameters", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns information about DB proxies.
    public func describeDBProxies(_ input: DescribeDBProxiesRequest) -> EventLoopFuture<DescribeDBProxiesResponse> {
        return client.execute(operation: "DescribeDBProxies", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBProxyTargetGroups(_ input: DescribeDBProxyTargetGroupsRequest) -> EventLoopFuture<DescribeDBProxyTargetGroupsResponse> {
        return client.execute(operation: "DescribeDBProxyTargetGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBProxyTargets(_ input: DescribeDBProxyTargetsRequest) -> EventLoopFuture<DescribeDBProxyTargetsResponse> {
        return client.execute(operation: "DescribeDBProxyTargets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///   Returns a list of DBSecurityGroup descriptions. If a DBSecurityGroupName is specified, the list will contain only the descriptions of the specified DB security group. 
    public func describeDBSecurityGroups(_ input: DescribeDBSecurityGroupsMessage) -> EventLoopFuture<DBSecurityGroupMessage> {
        return client.execute(operation: "DescribeDBSecurityGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDBSnapshotAttributes(_ input: DescribeDBSnapshotAttributesMessage) -> EventLoopFuture<DescribeDBSnapshotAttributesResult> {
        return client.execute(operation: "DescribeDBSnapshotAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns information about DB snapshots. This API action supports pagination.
    public func describeDBSnapshots(_ input: DescribeDBSnapshotsMessage) -> EventLoopFuture<DBSnapshotMessage> {
        return client.execute(operation: "DescribeDBSnapshots", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeExportTasks(_ input: DescribeExportTasksMessage) -> EventLoopFuture<ExportTasksMessage> {
    ...
    public func describeGlobalClusters(_ input: DescribeGlobalClustersMessage) -> EventLoopFuture<GlobalClustersMessage> {
        return client.execute(operation: "DescribeGlobalClusters", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes the available installation media for a DB engine that requires an on-premises customer provided license, such as Microsoft SQL Server.
    public func describeInstallationMedia(_ input: DescribeInstallationMediaMessage) -> EventLoopFuture<InstallationMediaMessage> {
        return client.execute(operation: "DescribeInstallationMedia", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes all available options.
    public func describeOptionGroupOptions(_ input: DescribeOptionGroupOptionsMessage) -> EventLoopFuture<OptionGroupOptionsMessage> {
        return client.execute(operation: "DescribeOptionGroupOptions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes the available option groups.
    public func describeOptionGroups(_ input: DescribeOptionGroupsMessage) -> EventLoopFuture<OptionGroups> {
        return client.execute(operation: "DescribeOptionGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeReservedDBInstances(_ input: DescribeReservedDBInstancesMessage) -> EventLoopFuture<ReservedDBInstanceMessage> {
        return client.execute(operation: "DescribeReservedDBInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists available reserved DB instance offerings.
    public func describeReservedDBInstancesOfferings(_ input: DescribeReservedDBInstancesOfferingsMessage) -> EventLoopFuture<ReservedDBInstancesOfferingMessage> {
        return client.execute(operation: "DescribeReservedDBInstancesOfferings", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeSourceRegions(_ input: DescribeSourceRegionsMessage) -> EventLoopFuture<SourceRegionMessage> {
        return client.execute(operation: "DescribeSourceRegions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeValidDBInstanceModifications(_ input: DescribeValidDBInstanceModificationsMessage) -> EventLoopFuture<DescribeValidDBInstanceModificationsResult> {
        return client.execute(operation: "DescribeValidDBInstanceModifications", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Downloads all or a portion of the specified log file, up to 1 MB in size.
    public func downloadDBLogFilePortion(_ input: DownloadDBLogFilePortionMessage) -> EventLoopFuture<DownloadDBLogFilePortionDetails> {
        return client.execute(operation: "DownloadDBLogFilePortion", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func importInstallationMedia(_ input: ImportInstallationMediaMessage) -> EventLoopFuture<InstallationMedia> {
        return client.execute(operation: "ImportInstallationMedia", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyCertificates(_ input: ModifyCertificatesMessage) -> EventLoopFuture<ModifyCertificatesResult> {
        return client.execute(operation: "ModifyCertificates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyCurrentDBClusterCapacity(_ input: ModifyCurrentDBClusterCapacityMessage) -> EventLoopFuture<DBClusterCapacityInfo> {
        return client.execute(operation: "ModifyCurrentDBClusterCapacity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyDBClusterEndpoint(_ input: ModifyDBClusterEndpointMessage) -> EventLoopFuture<DBClusterEndpoint> {
        return client.execute(operation: "ModifyDBClusterEndpoint", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyDBParameterGroup(_ input: ModifyDBParameterGroupMessage) -> EventLoopFuture<DBParameterGroupNameMessage> {
        return client.execute(operation: "ModifyDBParameterGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Changes the settings for an existing DB proxy.
    public func modifyDBProxy(_ input: ModifyDBProxyRequest) -> EventLoopFuture<ModifyDBProxyResponse> {
        return client.execute(operation: "ModifyDBProxy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyDBProxyTargetGroup(_ input: ModifyDBProxyTargetGroupRequest) -> EventLoopFuture<ModifyDBProxyTargetGroupResponse> {
        return client.execute(operation: "ModifyDBProxyTargetGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyDBSnapshot(_ input: ModifyDBSnapshotMessage) -> EventLoopFuture<ModifyDBSnapshotResult> {
        return client.execute(operation: "ModifyDBSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyDBSnapshotAttribute(_ input: ModifyDBSnapshotAttributeMessage) -> EventLoopFuture<ModifyDBSnapshotAttributeResult> {
        return client.execute(operation: "ModifyDBSnapshotAttribute", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyGlobalCluster(_ input: ModifyGlobalClusterMessage) -> EventLoopFuture<ModifyGlobalClusterResult> {
        return client.execute(operation: "ModifyGlobalCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Modifies an existing option group.
    public func modifyOptionGroup(_ input: ModifyOptionGroupMessage) -> EventLoopFuture<ModifyOptionGroupResult> {
        return client.execute(operation: "ModifyOptionGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func promoteReadReplica(_ input: PromoteReadReplicaMessage) -> EventLoopFuture<PromoteReadReplicaResult> {
        return client.execute(operation: "PromoteReadReplica", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func promoteReadReplicaDBCluster(_ input: PromoteReadReplicaDBClusterMessage) -> EventLoopFuture<PromoteReadReplicaDBClusterResult> {
        return client.execute(operation: "PromoteReadReplicaDBCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Purchases a reserved DB instance offering.
    public func purchaseReservedDBInstancesOffering(_ input: PurchaseReservedDBInstancesOfferingMessage) -> EventLoopFuture<PurchaseReservedDBInstancesOfferingResult> {
        return client.execute(operation: "PurchaseReservedDBInstancesOffering", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerDBProxyTargets(_ input: RegisterDBProxyTargetsRequest) -> EventLoopFuture<RegisterDBProxyTargetsResponse> {
        return client.execute(operation: "RegisterDBProxyTargets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func removeFromGlobalCluster(_ input: RemoveFromGlobalClusterMessage) -> EventLoopFuture<RemoveFromGlobalClusterResult> {
        return client.execute(operation: "RemoveFromGlobalCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func removeRoleFromDBCluster(_ input: RemoveRoleFromDBClusterMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveRoleFromDBCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Disassociates an AWS Identity and Access Management (IAM) role from a DB instance.
    @discardableResult public func removeRoleFromDBInstance(_ input: RemoveRoleFromDBInstanceMessage) -> EventLoopFuture<Void> {
        return client.execute(operation: "RemoveRoleFromDBInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func removeSourceIdentifierFromSubscription(_ input: RemoveSourceIdentifierFromSubscriptionMessage) -> EventLoopFuture<RemoveSourceIdentifierFromSubscriptionResult> {
        return client.execute(operation: "RemoveSourceIdentifierFromSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func resetDBParameterGroup(_ input: ResetDBParameterGroupMessage) -> EventLoopFuture<DBParameterGroupNameMessage> {
        return client.execute(operation: "ResetDBParameterGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func restoreDBClusterFromS3(_ input: RestoreDBClusterFromS3Message) -> EventLoopFuture<RestoreDBClusterFromS3Result> {
        return client.execute(operation: "RestoreDBClusterFromS3", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func restoreDBInstanceFromDBSnapshot(_ input: RestoreDBInstanceFromDBSnapshotMessage) -> EventLoopFuture<RestoreDBInstanceFromDBSnapshotResult> {
        return client.execute(operation: "RestoreDBInstanceFromDBSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Amazon Relational Database Service (Amazon RDS) supports importing MySQL databases by using backup files. You can create a backup of your on-premises database, store it on Amazon Simple Storage Service (Amazon S3), and then restore the backup file onto a new Amazon RDS DB instance running MySQL. For more information, see Importing Data into an Amazon RDS MySQL DB Instance in the Amazon RDS User Guide. 
    public func restoreDBInstanceFromS3(_ input: RestoreDBInstanceFromS3Message) -> EventLoopFuture<RestoreDBInstanceFromS3Result> {
        return client.execute(operation: "RestoreDBInstanceFromS3", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func restoreDBInstanceToPointInTime(_ input: RestoreDBInstanceToPointInTimeMessage) -> EventLoopFuture<RestoreDBInstanceToPointInTimeResult> {
        return client.execute(operation: "RestoreDBInstanceToPointInTime", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Revokes ingress from a DBSecurityGroup for previously authorized IP ranges or EC2 or VPC Security Groups. Required parameters for this API are one of CIDRIP, EC2SecurityGroupId for VPC, or (EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId).
    public func revokeDBSecurityGroupIngress(_ input: RevokeDBSecurityGroupIngressMessage) -> EventLoopFuture<RevokeDBSecurityGroupIngressResult> {
        return client.execute(operation: "RevokeDBSecurityGroupIngress", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startActivityStream(_ input: StartActivityStreamRequest) -> EventLoopFuture<StartActivityStreamResponse> {
        return client.execute(operation: "StartActivityStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startDBInstance(_ input: StartDBInstanceMessage) -> EventLoopFuture<StartDBInstanceResult> {
        return client.execute(operation: "StartDBInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Starts an export of a snapshot to Amazon S3. The provided IAM role must have access to the S3 bucket. 
    public func startExportTask(_ input: StartExportTaskMessage) -> EventLoopFuture<ExportTask> {
    ...
    public func stopActivityStream(_ input: StopActivityStreamRequest) -> EventLoopFuture<StopActivityStreamResponse> {
        return client.execute(operation: "StopActivityStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func stopDBInstance(_ input: StopDBInstanceMessage) -> EventLoopFuture<StopDBInstanceResult> {
        return client.execute(operation: "StopDBInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
