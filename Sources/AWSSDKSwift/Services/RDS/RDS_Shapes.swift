...
extension RDS {
    ...
    public struct RestoreDBClusterFromSnapshotMessage: AWSShape {
        ...
        public init(databaseName: String? = nil, dBClusterParameterGroupName: String? = nil, optionGroupName: String? = nil, enableCloudwatchLogsExports: [String]? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, engineVersion: String? = nil, engine: String, scalingConfiguration: ScalingConfiguration? = nil, engineMode: String? = nil, tags: TagList? = nil, dBClusterIdentifier: String, port: Int32? = nil, kmsKeyId: String? = nil, enableIAMDatabaseAuthentication: Bool? = nil, backtrackWindow: Int64? = nil, deletionProtection: Bool? = nil, availabilityZones: AvailabilityZones? = nil, snapshotIdentifier: String, dBSubnetGroupName: String? = nil) {
    ...
    public struct DescribeDBSnapshotsMessage: AWSShape {
        ...
        public init(marker: String? = nil, snapshotType: String? = nil, includeShared: Bool? = nil, maxRecords: Int32? = nil, dBSnapshotIdentifier: String? = nil, filters: FilterList? = nil, includePublic: Bool? = nil, dBInstanceIdentifier: String? = nil, dbiResourceId: String? = nil) {
            self.marker = marker
    ...
    public struct PendingModifiedValues: AWSShape {
        ...
        public init(masterUserPassword: String? = nil, engineVersion: String? = nil, allocatedStorage: Int32? = nil, backupRetentionPeriod: Int32? = nil, dBInstanceClass: String? = nil, cACertificateIdentifier: String? = nil, iops: Int32? = nil, port: Int32? = nil, dBInstanceIdentifier: String? = nil, storageType: String? = nil, processorFeatures: ProcessorFeatureList? = nil, licenseModel: String? = nil, multiAZ: Bool? = nil, dBSubnetGroupName: String? = nil, pendingCloudwatchLogsExports: PendingCloudwatchLogsExports? = nil) {
    ...
    public struct ModifyDBInstanceMessage: AWSShape {
        ...
        public init(performanceInsightsKMSKeyId: String? = nil, iops: Int32? = nil, preferredMaintenanceWindow: String? = nil, dBInstanceIdentifier: String, dBSubnetGroupName: String? = nil, dBParameterGroupName: String? = nil, domain: String? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, backupRetentionPeriod: Int32? = nil, optionGroupName: String? = nil, autoMinorVersionUpgrade: Bool? = nil, allowMajorVersionUpgrade: Bool? = nil, promotionTier: Int32? = nil, copyTagsToSnapshot: Bool? = nil, multiAZ: Bool? = nil, tdeCredentialPassword: String? = nil, dBPortNumber: Int32? = nil, useDefaultProcessorFeatures: Bool? = nil, enableIAMDatabaseAuthentication: Bool? = nil, tdeCredentialArn: String? = nil, engineVersion: String? = nil, cloudwatchLogsExportConfiguration: CloudwatchLogsExportConfiguration? = nil, processorFeatures: ProcessorFeatureList? = nil, licenseModel: String? = nil, newDBInstanceIdentifier: String? = nil, enablePerformanceInsights: Bool? = nil, preferredBackupWindow: String? = nil, cACertificateIdentifier: String? = nil, domainIAMRoleName: String? = nil, publiclyAccessible: Bool? = nil, allocatedStorage: Int32? = nil, deletionProtection: Bool? = nil, dBSecurityGroups: DBSecurityGroupNameList? = nil, storageType: String? = nil, masterUserPassword: String? = nil, dBInstanceClass: String? = nil, performanceInsightsRetentionPeriod: Int32? = nil, applyImmediately: Bool? = nil, monitoringInterval: Int32? = nil, monitoringRoleArn: String? = nil) {
    ...
    public struct CreateDBClusterMessage: AWSShape {
        ...
        public init(globalClusterIdentifier: String? = nil, port: Int32? = nil, preferredMaintenanceWindow: String? = nil, dBSubnetGroupName: String? = nil, characterSetName: String? = nil, engine: String, preSignedUrl: String? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, backupRetentionPeriod: Int32? = nil, optionGroupName: String? = nil, databaseName: String? = nil, dBClusterParameterGroupName: String? = nil, masterUsername: String? = nil, enableCloudwatchLogsExports: [String]? = nil, enableIAMDatabaseAuthentication: Bool? = nil, engineVersion: String? = nil, preferredBackupWindow: String? = nil, dBClusterIdentifier: String, backtrackWindow: Int64? = nil, replicationSourceIdentifier: String? = nil, kmsKeyId: String? = nil, deletionProtection: Bool? = nil, availabilityZones: AvailabilityZones? = nil, masterUserPassword: String? = nil, scalingConfiguration: ScalingConfiguration? = nil, storageEncrypted: Bool? = nil, engineMode: String? = nil, tags: TagList? = nil) {
    ...
    public struct DescribeReservedDBInstancesMessage: AWSShape {
        ...
        public init(marker: String? = nil, dBInstanceClass: String? = nil, duration: String? = nil, reservedDBInstancesOfferingId: String? = nil, multiAZ: Bool? = nil, reservedDBInstanceId: String? = nil, productDescription: String? = nil, maxRecords: Int32? = nil, offeringType: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.dBInstanceClass = dBInstanceClass
    ...
    public struct DBCluster: AWSShape {
        ...
        public init(port: Int32? = nil, readReplicaIdentifiers: ReadReplicaIdentifierList? = nil, endpoint: String? = nil, percentProgress: String? = nil, readerEndpoint: String? = nil, preferredMaintenanceWindow: String? = nil, dBSubnetGroup: String? = nil, enabledCloudwatchLogsExports: [String]? = nil, characterSetName: String? = nil, dBClusterArn: String? = nil, status: String? = nil, engine: String? = nil, dbClusterResourceId: String? = nil, backupRetentionPeriod: Int32? = nil, hostedZoneId: String? = nil, backtrackConsumedChangeRecords: Int64? = nil, databaseName: String? = nil, associatedRoles: DBClusterRoles? = nil, masterUsername: String? = nil, earliestRestorableTime: TimeStamp? = nil, vpcSecurityGroups: VpcSecurityGroupMembershipList? = nil, dBClusterMembers: DBClusterMemberList? = nil, cloneGroupId: String? = nil, multiAZ: Bool? = nil, dBClusterParameterGroup: String? = nil, clusterCreateTime: TimeStamp? = nil, engineVersion: String? = nil, dBClusterOptionGroupMemberships: DBClusterOptionGroupMemberships? = nil, customEndpoints: [String]? = nil, preferredBackupWindow: String? = nil, earliestBacktrackTime: TimeStamp? = nil, backtrackWindow: Int64? = nil, replicationSourceIdentifier: String? = nil, latestRestorableTime: TimeStamp? = nil, iAMDatabaseAuthenticationEnabled: Bool? = nil, kmsKeyId: String? = nil, allocatedStorage: Int32? = nil, dBClusterIdentifier: String? = nil, capacity: Int32? = nil, availabilityZones: AvailabilityZones? = nil, scalingConfigurationInfo: ScalingConfigurationInfo? = nil, httpEndpointEnabled: Bool? = nil, deletionProtection: Bool? = nil, storageEncrypted: Bool? = nil, engineMode: String? = nil) {
            self.port = port
    ...
    public struct CreateDBInstanceReadReplicaMessage: AWSShape {
        ...
        public init(port: Int32? = nil, tags: TagList? = nil, performanceInsightsKMSKeyId: String? = nil, iops: Int32? = nil, dBInstanceIdentifier: String, dBSubnetGroupName: String? = nil, preSignedUrl: String? = nil, availabilityZone: String? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, sourceDBInstanceIdentifier: String, optionGroupName: String? = nil, autoMinorVersionUpgrade: Bool? = nil, copyTagsToSnapshot: Bool? = nil, multiAZ: Bool? = nil, enableCloudwatchLogsExports: [String]? = nil, useDefaultProcessorFeatures: Bool? = nil, enableIAMDatabaseAuthentication: Bool? = nil, processorFeatures: ProcessorFeatureList? = nil, enablePerformanceInsights: Bool? = nil, publiclyAccessible: Bool? = nil, kmsKeyId: String? = nil, deletionProtection: Bool? = nil, storageType: String? = nil, dBInstanceClass: String? = nil, performanceInsightsRetentionPeriod: Int32? = nil, monitoringInterval: Int32? = nil, monitoringRoleArn: String? = nil) {
            self.port = port
            self.tags = tags
            self.performanceInsightsKMSKeyId = performanceInsightsKMSKeyId
            self.iops = iops
    ...
    public struct RestoreDBInstanceFromDBSnapshotMessage: AWSShape {
        ...
        public init(port: Int32? = nil, iops: Int32? = nil, dBInstanceIdentifier: String, dBSubnetGroupName: String? = nil, dBSnapshotIdentifier: String, engine: String? = nil, dBParameterGroupName: String? = nil, availabilityZone: String? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, domain: String? = nil, optionGroupName: String? = nil, autoMinorVersionUpgrade: Bool? = nil, copyTagsToSnapshot: Bool? = nil, multiAZ: Bool? = nil, tdeCredentialPassword: String? = nil, enableCloudwatchLogsExports: [String]? = nil, useDefaultProcessorFeatures: Bool? = nil, enableIAMDatabaseAuthentication: Bool? = nil, tdeCredentialArn: String? = nil, dBName: String? = nil, processorFeatures: ProcessorFeatureList? = nil, licenseModel: String? = nil, domainIAMRoleName: String? = nil, publiclyAccessible: Bool? = nil, deletionProtection: Bool? = nil, storageType: String? = nil, dBInstanceClass: String? = nil, tags: TagList? = nil) {
            self.port = port
            self.iops = iops
            self.dBInstanceIdentifier = dBInstanceIdentifier
            self.dBSubnetGroupName = dBSubnetGroupName
    ...
    public struct DBClusterBacktrack: AWSShape {
        ...
        public init(backtrackedFrom: TimeStamp? = nil, status: String? = nil, dBClusterIdentifier: String? = nil, backtrackRequestCreationTime: TimeStamp? = nil, backtrackTo: TimeStamp? = nil, backtrackIdentifier: String? = nil) {
    ...
    public struct ScalingConfiguration: AWSShape {
        ...
        public init(minCapacity: Int32? = nil, secondsUntilAutoPause: Int32? = nil, maxCapacity: Int32? = nil, autoPause: Bool? = nil) {
    ...
    public struct DownloadDBLogFilePortionMessage: AWSShape {
        ...
        public init(marker: String? = nil, logFileName: String, dBInstanceIdentifier: String, numberOfLines: Int32? = nil) {
            self.marker = marker
    ...
    public struct CreateDBSecurityGroupMessage: AWSShape {
        ...
        public init(dBSecurityGroupName: String, dBSecurityGroupDescription: String, tags: TagList? = nil) {
            self.dBSecurityGroupName = dBSecurityGroupName
    ...
    public struct OptionGroupOptionSetting: AWSShape {
        ...
        public init(applyType: String? = nil, defaultValue: String? = nil, settingDescription: String? = nil, minimumEngineVersionPerAllowedValue: MinimumEngineVersionPerAllowedValueList? = nil, allowedValues: String? = nil, isRequired: Bool? = nil, isModifiable: Bool? = nil, settingName: String? = nil) {
    ...
    public struct RestoreDBInstanceToPointInTimeMessage: AWSShape {
        ...
        public init(port: Int32? = nil, iops: Int32? = nil, dBSubnetGroupName: String? = nil, engine: String? = nil, dBParameterGroupName: String? = nil, availabilityZone: String? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, domain: String? = nil, optionGroupName: String? = nil, targetDBInstanceIdentifier: String, sourceDBInstanceIdentifier: String? = nil, autoMinorVersionUpgrade: Bool? = nil, copyTagsToSnapshot: Bool? = nil, multiAZ: Bool? = nil, tdeCredentialPassword: String? = nil, enableCloudwatchLogsExports: [String]? = nil, useDefaultProcessorFeatures: Bool? = nil, sourceDbiResourceId: String? = nil, useLatestRestorableTime: Bool? = nil, enableIAMDatabaseAuthentication: Bool? = nil, dBName: String? = nil, tdeCredentialArn: String? = nil, processorFeatures: ProcessorFeatureList? = nil, licenseModel: String? = nil, domainIAMRoleName: String? = nil, publiclyAccessible: Bool? = nil, deletionProtection: Bool? = nil, storageType: String? = nil, dBInstanceClass: String? = nil, restoreTime: TimeStamp? = nil, tags: TagList? = nil) {
            self.port = port
            self.iops = iops
            self.dBSubnetGroupName = dBSubnetGroupName
            self.engine = engine
    ...
    public struct CopyOptionGroupMessage: AWSShape {
        ...
        public init(targetOptionGroupDescription: String, targetOptionGroupIdentifier: String, sourceOptionGroupIdentifier: String, tags: TagList? = nil) {
    ...
    public struct DescribeDBLogFilesMessage: AWSShape {
        ...
        public init(filenameContains: String? = nil, marker: String? = nil, maxRecords: Int32? = nil, fileLastWritten: Int64? = nil, fileSize: Int64? = nil, filters: FilterList? = nil, dBInstanceIdentifier: String) {
    ...
    public struct ModifyOptionGroupMessage: AWSShape {
        ...
        public init(optionGroupName: String, applyImmediately: Bool? = nil, optionsToRemove: [String]? = nil, optionsToInclude: OptionConfigurationList? = nil) {
            self.optionGroupName = optionGroupName
            self.applyImmediately = applyImmediately
    ...
    public struct ReservedDBInstancesOffering: AWSShape {
        ...
        public init(currencyCode: String? = nil, dBInstanceClass: String? = nil, duration: Int32? = nil, reservedDBInstancesOfferingId: String? = nil, multiAZ: Bool? = nil, fixedPrice: Double? = nil, productDescription: String? = nil, usagePrice: Double? = nil, offeringType: String? = nil, recurringCharges: RecurringChargeList? = nil) {
    ...
    public struct AuthorizeDBSecurityGroupIngressMessage: AWSShape {
        ...
        public init(cidrip: String? = nil, eC2SecurityGroupName: String? = nil, eC2SecurityGroupOwnerId: String? = nil, dBSecurityGroupName: String, eC2SecurityGroupId: String? = nil) {
            self.cidrip = cidrip
    ...
    public struct Parameter: AWSShape {
        ...
        public init(applyType: String? = nil, supportedEngineModes: [String]? = nil, minimumEngineVersion: String? = nil, source: String? = nil, allowedValues: String? = nil, parameterName: String? = nil, description: String? = nil, isModifiable: Bool? = nil, applyMethod: ApplyMethod? = nil, parameterValue: String? = nil, dataType: String? = nil) {
            self.applyType = applyType
    ...
    public struct Option: AWSShape {
        ...
        public init(optionDescription: String? = nil, dBSecurityGroupMemberships: DBSecurityGroupMembershipList? = nil, port: Int32? = nil, optionSettings: OptionSettingConfigurationList? = nil, permanent: Bool? = nil, persistent: Bool? = nil, optionVersion: String? = nil, vpcSecurityGroupMemberships: VpcSecurityGroupMembershipList? = nil, optionName: String? = nil) {
    ...
    public struct ModifyDBClusterMessage: AWSShape {
        ...
        public init(masterUserPassword: String? = nil, dBClusterParameterGroupName: String? = nil, optionGroupName: String? = nil, dBClusterIdentifier: String, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, engineVersion: String? = nil, preferredMaintenanceWindow: String? = nil, scalingConfiguration: ScalingConfiguration? = nil, backupRetentionPeriod: Int32? = nil, newDBClusterIdentifier: String? = nil, applyImmediately: Bool? = nil, port: Int32? = nil, backtrackWindow: Int64? = nil, enableIAMDatabaseAuthentication: Bool? = nil, enableHttpEndpoint: Bool? = nil, deletionProtection: Bool? = nil, cloudwatchLogsExportConfiguration: CloudwatchLogsExportConfiguration? = nil, preferredBackupWindow: String? = nil) {
            self.masterUserPassword = masterUserPassword
            self.dBClusterParameterGroupName = dBClusterParameterGroupName
            self.optionGroupName = optionGroupName
            self.dBClusterIdentifier = dBClusterIdentifier
    ...
    public struct ModifyCurrentDBClusterCapacityMessage: AWSShape {
        ...
        public init(timeoutAction: String? = nil, capacity: Int32? = nil, dBClusterIdentifier: String, secondsBeforeTimeout: Int32? = nil) {
    ...
    public struct DBSecurityGroup: AWSShape {
        ...
        public init(ownerId: String? = nil, dBSecurityGroupArn: String? = nil, eC2SecurityGroups: EC2SecurityGroupList? = nil, iPRanges: IPRangeList? = nil, vpcId: String? = nil, dBSecurityGroupDescription: String? = nil, dBSecurityGroupName: String? = nil) {
    ...
    public struct RestoreDBClusterToPointInTimeMessage: AWSShape {
        ...
        public init(dBClusterIdentifier: String, optionGroupName: String? = nil, enableCloudwatchLogsExports: [String]? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, restoreToTime: TimeStamp? = nil, dBClusterParameterGroupName: String? = nil, restoreType: String? = nil, tags: TagList? = nil, useLatestRestorableTime: Bool? = nil, sourceDBClusterIdentifier: String, port: Int32? = nil, kmsKeyId: String? = nil, enableIAMDatabaseAuthentication: Bool? = nil, backtrackWindow: Int64? = nil, deletionProtection: Bool? = nil, dBSubnetGroupName: String? = nil) {
            self.dBClusterIdentifier = dBClusterIdentifier
            self.optionGroupName = optionGroupName
            self.enableCloudwatchLogsExports = enableCloudwatchLogsExports
            self.vpcSecurityGroupIds = vpcSecurityGroupIds
    ...
    public struct DescribeOptionGroupsMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, optionGroupName: String? = nil, engineName: String? = nil, majorEngineVersion: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.optionGroupName = optionGroupName
    ...
    public struct DescribeGlobalClustersMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, globalClusterIdentifier: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.globalClusterIdentifier = globalClusterIdentifier
            self.filters = filters
    ...
    public struct DBSnapshot: AWSShape {
        ...
        public init(port: Int32? = nil, percentProgress: Int32? = nil, iops: Int32? = nil, dBInstanceIdentifier: String? = nil, sourceDBSnapshotIdentifier: String? = nil, dBSnapshotIdentifier: String? = nil, status: String? = nil, engine: String? = nil, availabilityZone: String? = nil, optionGroupName: String? = nil, masterUsername: String? = nil, dbiResourceId: String? = nil, vpcId: String? = nil, tdeCredentialArn: String? = nil, snapshotType: String? = nil, engineVersion: String? = nil, snapshotCreateTime: TimeStamp? = nil, timezone: String? = nil, licenseModel: String? = nil, processorFeatures: ProcessorFeatureList? = nil, instanceCreateTime: TimeStamp? = nil, sourceRegion: String? = nil, iAMDatabaseAuthenticationEnabled: Bool? = nil, kmsKeyId: String? = nil, allocatedStorage: Int32? = nil, storageType: String? = nil, encrypted: Bool? = nil, dBSnapshotArn: String? = nil) {
            self.port = port
            self.percentProgress = percentProgress
            self.iops = iops
            self.dBInstanceIdentifier = dBInstanceIdentifier
    ...
    public struct CopyDBSnapshotMessage: AWSShape {
        ...
        public init(optionGroupName: String? = nil, copyTags: Bool? = nil, preSignedUrl: String? = nil, targetDBSnapshotIdentifier: String, kmsKeyId: String? = nil, tags: TagList? = nil, sourceDBSnapshotIdentifier: String) {
            self.optionGroupName = optionGroupName
    ...
    public struct DescribeDBClusterBacktracksMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, dBClusterIdentifier: String, backtrackIdentifier: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.dBClusterIdentifier = dBClusterIdentifier
            self.backtrackIdentifier = backtrackIdentifier
    ...
    public struct OptionSetting: AWSShape {
        ...
        public init(applyType: String? = nil, defaultValue: String? = nil, allowedValues: String? = nil, value: String? = nil, description: String? = nil, isModifiable: Bool? = nil, isCollection: Bool? = nil, name: String? = nil, dataType: String? = nil) {
            self.applyType = applyType
            self.defaultValue = defaultValue
            self.allowedValues = allowedValues
            self.value = value
    ...
    public struct DescribeDBInstanceAutomatedBackupsMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, dbiResourceId: String? = nil, dBInstanceIdentifier: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.dbiResourceId = dbiResourceId
            self.dBInstanceIdentifier = dBInstanceIdentifier
    ...
    public struct ModifyDBSnapshotAttributeMessage: AWSShape {
        ...
        public init(dBSnapshotIdentifier: String, valuesToRemove: AttributeValueList? = nil, attributeName: String, valuesToAdd: AttributeValueList? = nil) {
            self.dBSnapshotIdentifier = dBSnapshotIdentifier
            self.valuesToRemove = valuesToRemove
            self.attributeName = attributeName
            self.valuesToAdd = valuesToAdd
    ...
    public struct Certificate: AWSShape {
        ...
        public init(thumbprint: String? = nil, certificateType: String? = nil, certificateArn: String? = nil, validFrom: TimeStamp? = nil, validTill: TimeStamp? = nil, certificateIdentifier: String? = nil) {
    ...
    public struct CreateOptionGroupMessage: AWSShape {
        ...
        public init(engineName: String, optionGroupDescription: String, optionGroupName: String, majorEngineVersion: String, tags: TagList? = nil) {
            self.engineName = engineName
    ...
    public struct GlobalCluster: AWSShape {
        ...
        public init(globalClusterIdentifier: String? = nil, status: String? = nil, globalClusterMembers: GlobalClusterMemberList? = nil, deletionProtection: Bool? = nil, engineVersion: String? = nil, storageEncrypted: Bool? = nil, engine: String? = nil, globalClusterResourceId: String? = nil, globalClusterArn: String? = nil, databaseName: String? = nil) {
            self.globalClusterIdentifier = globalClusterIdentifier
            self.status = status
    ...
    public struct EC2SecurityGroup: AWSShape {
        ...
        public init(eC2SecurityGroupName: String? = nil, eC2SecurityGroupOwnerId: String? = nil, status: String? = nil, eC2SecurityGroupId: String? = nil) {
            self.eC2SecurityGroupName = eC2SecurityGroupName
            self.eC2SecurityGroupOwnerId = eC2SecurityGroupOwnerId
            self.status = status
            self.eC2SecurityGroupId = eC2SecurityGroupId
    ...
    public struct DescribeOptionGroupOptionsMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, engineName: String, majorEngineVersion: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.engineName = engineName
            self.majorEngineVersion = majorEngineVersion
    ...
    public struct OrderableDBInstanceOption: AWSShape {
        ...
        public init(minStorageSize: Int32? = nil, engine: String? = nil, maxIopsPerGib: Double? = nil, maxIopsPerDbInstance: Int32? = nil, multiAZCapable: Bool? = nil, engineVersion: String? = nil, supportedEngineModes: [String]? = nil, vpc: Bool? = nil, supportsIops: Bool? = nil, dBInstanceClass: String? = nil, supportsPerformanceInsights: Bool? = nil, supportsEnhancedMonitoring: Bool? = nil, minIopsPerDbInstance: Int32? = nil, storageType: String? = nil, readReplicaCapable: Bool? = nil, minIopsPerGib: Double? = nil, supportsIAMDatabaseAuthentication: Bool? = nil, licenseModel: String? = nil, availabilityZones: AvailabilityZoneList? = nil, supportsStorageEncryption: Bool? = nil, maxStorageSize: Int32? = nil, availableProcessorFeatures: AvailableProcessorFeatureList? = nil) {
    ...
    public struct DescribeReservedDBInstancesOfferingsMessage: AWSShape {
        ...
        public init(marker: String? = nil, dBInstanceClass: String? = nil, duration: String? = nil, reservedDBInstancesOfferingId: String? = nil, multiAZ: Bool? = nil, productDescription: String? = nil, maxRecords: Int32? = nil, offeringType: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.dBInstanceClass = dBInstanceClass
            self.duration = duration
            self.reservedDBInstancesOfferingId = reservedDBInstancesOfferingId
    ...
    public struct BacktrackDBClusterMessage: AWSShape {
        ...
        public init(useEarliestTimeOnPointInTimeUnavailable: Bool? = nil, dBClusterIdentifier: String, force: Bool? = nil, backtrackTo: TimeStamp) {
    ...
    public struct RestoreDBInstanceFromS3Message: AWSShape {
        ...
        public init(port: Int32? = nil, tags: TagList? = nil, performanceInsightsKMSKeyId: String? = nil, iops: Int32? = nil, preferredMaintenanceWindow: String? = nil, dBInstanceIdentifier: String, dBSubnetGroupName: String? = nil, engine: String, dBParameterGroupName: String? = nil, availabilityZone: String? = nil, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, backupRetentionPeriod: Int32? = nil, optionGroupName: String? = nil, sourceEngineVersion: String, autoMinorVersionUpgrade: Bool? = nil, copyTagsToSnapshot: Bool? = nil, multiAZ: Bool? = nil, masterUsername: String? = nil, useDefaultProcessorFeatures: Bool? = nil, s3IngestionRoleArn: String, enableCloudwatchLogsExports: [String]? = nil, enableIAMDatabaseAuthentication: Bool? = nil, sourceEngine: String, dBName: String? = nil, engineVersion: String? = nil, processorFeatures: ProcessorFeatureList? = nil, licenseModel: String? = nil, s3Prefix: String? = nil, enablePerformanceInsights: Bool? = nil, preferredBackupWindow: String? = nil, publiclyAccessible: Bool? = nil, kmsKeyId: String? = nil, allocatedStorage: Int32? = nil, deletionProtection: Bool? = nil, dBSecurityGroups: DBSecurityGroupNameList? = nil, storageType: String? = nil, masterUserPassword: String? = nil, dBInstanceClass: String, performanceInsightsRetentionPeriod: Int32? = nil, monitoringInterval: Int32? = nil, storageEncrypted: Bool? = nil, s3BucketName: String, monitoringRoleArn: String? = nil) {
            self.port = port
            self.tags = tags
            self.performanceInsightsKMSKeyId = performanceInsightsKMSKeyId
            self.iops = iops
    ...
    public struct CreateGlobalClusterMessage: AWSShape {
        ...
        public init(globalClusterIdentifier: String? = nil, sourceDBClusterIdentifier: String? = nil, engineVersion: String? = nil, deletionProtection: Bool? = nil, storageEncrypted: Bool? = nil, engine: String? = nil, databaseName: String? = nil) {
            self.globalClusterIdentifier = globalClusterIdentifier
            self.sourceDBClusterIdentifier = sourceDBClusterIdentifier
            self.engineVersion = engineVersion
            self.deletionProtection = deletionProtection
    ...
    public struct OptionGroup: AWSShape {
        ...
        public init(engineName: String? = nil, optionGroupDescription: String? = nil, optionGroupName: String? = nil, allowsVpcAndNonVpcInstanceMemberships: Bool? = nil, vpcId: String? = nil, options: OptionsList? = nil, optionGroupArn: String? = nil, majorEngineVersion: String? = nil) {
            self.engineName = engineName
            self.optionGroupDescription = optionGroupDescription
            self.optionGroupName = optionGroupName
    ...
    public struct DownloadDBLogFilePortionDetails: AWSShape {
        ...
        public init(marker: String? = nil, additionalDataPending: Bool? = nil, logFileData: String? = nil) {
            self.marker = marker
    ...
    public struct DescribeDBSecurityGroupsMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, dBSecurityGroupName: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.dBSecurityGroupName = dBSecurityGroupName
            self.filters = filters
    ...
    public struct ReservedDBInstance: AWSShape {
        ...
        public init(reservedDBInstanceArn: String? = nil, usagePrice: Double? = nil, recurringCharges: RecurringChargeList? = nil, currencyCode: String? = nil, state: String? = nil, dBInstanceCount: Int32? = nil, fixedPrice: Double? = nil, dBInstanceClass: String? = nil, reservedDBInstancesOfferingId: String? = nil, startTime: TimeStamp? = nil, productDescription: String? = nil, reservedDBInstanceId: String? = nil, duration: Int32? = nil, multiAZ: Bool? = nil, offeringType: String? = nil) {
    ...
    public struct DescribeDBClusterEndpointsMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, dBClusterIdentifier: String? = nil, dBClusterEndpointIdentifier: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.dBClusterIdentifier = dBClusterIdentifier
            self.dBClusterEndpointIdentifier = dBClusterEndpointIdentifier
    ...
    public struct RestoreDBClusterFromS3Message: AWSShape {
        ...
        public init(port: Int32? = nil, preferredMaintenanceWindow: String? = nil, dBSubnetGroupName: String? = nil, characterSetName: String? = nil, engine: String, vpcSecurityGroupIds: VpcSecurityGroupIdList? = nil, backupRetentionPeriod: Int32? = nil, sourceEngineVersion: String, optionGroupName: String? = nil, databaseName: String? = nil, dBClusterParameterGroupName: String? = nil, masterUsername: String, enableCloudwatchLogsExports: [String]? = nil, s3IngestionRoleArn: String, enableIAMDatabaseAuthentication: Bool? = nil, sourceEngine: String, engineVersion: String? = nil, s3Prefix: String? = nil, preferredBackupWindow: String? = nil, dBClusterIdentifier: String, backtrackWindow: Int64? = nil, kmsKeyId: String? = nil, deletionProtection: Bool? = nil, availabilityZones: AvailabilityZones? = nil, masterUserPassword: String, storageEncrypted: Bool? = nil, s3BucketName: String, tags: TagList? = nil) {
            self.port = port
            self.preferredMaintenanceWindow = preferredMaintenanceWindow
            self.dBSubnetGroupName = dBSubnetGroupName
            self.characterSetName = characterSetName
    ...
    public struct DescribeCertificatesMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, filters: FilterList? = nil, certificateIdentifier: String? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.filters = filters
            self.certificateIdentifier = certificateIdentifier
    ...
    public struct DBClusterEndpoint: AWSShape {
        ...
        public init(dBClusterEndpointArn: String? = nil, excludedMembers: [String]? = nil, dBClusterEndpointIdentifier: String? = nil, endpoint: String? = nil, status: String? = nil, staticMembers: [String]? = nil, endpointType: String? = nil, dBClusterEndpointResourceIdentifier: String? = nil, dBClusterIdentifier: String? = nil, customEndpointType: String? = nil) {
    ...
    public struct ModifyGlobalClusterMessage: AWSShape {
        ...
        public init(newGlobalClusterIdentifier: String? = nil, deletionProtection: Bool? = nil, globalClusterIdentifier: String? = nil) {
    ...
    public struct CreateDBClusterEndpointMessage: AWSShape {
        ...
        public init(staticMembers: [String]? = nil, excludedMembers: [String]? = nil, dBClusterIdentifier: String, dBClusterEndpointIdentifier: String, endpointType: String) {
            self.staticMembers = staticMembers
            self.excludedMembers = excludedMembers
            self.dBClusterIdentifier = dBClusterIdentifier
            self.dBClusterEndpointIdentifier = dBClusterEndpointIdentifier
    ...
    public struct DBEngineVersion: AWSShape {
        ...
        public init(exportableLogTypes: [String]? = nil, engine: String? = nil, engineVersion: String? = nil, defaultCharacterSet: CharacterSet? = nil, supportedEngineModes: [String]? = nil, supportsLogExportsToCloudwatchLogs: Bool? = nil, dBEngineDescription: String? = nil, supportsReadReplica: Bool? = nil, dBParameterGroupFamily: String? = nil, supportedCharacterSets: SupportedCharacterSetsList? = nil, supportedTimezones: SupportedTimezonesList? = nil, validUpgradeTarget: ValidUpgradeTargetList? = nil, dBEngineVersionDescription: String? = nil) {
    ...
    public struct DescribeSourceRegionsMessage: AWSShape {
        ...
        public init(marker: String? = nil, maxRecords: Int32? = nil, regionName: String? = nil, filters: FilterList? = nil) {
            self.marker = marker
            self.maxRecords = maxRecords
            self.regionName = regionName
            self.filters = filters
    ...
    public struct DBInstance: AWSShape {
        ...
        public init(masterUsername: String? = nil, readReplicaDBClusterIdentifiers: ReadReplicaDBClusterIdentifierList? = nil, dBInstanceClass: String? = nil, dBInstanceIdentifier: String? = nil, engine: String? = nil, dBName: String? = nil, performanceInsightsKMSKeyId: String? = nil, publiclyAccessible: Bool? = nil, multiAZ: Bool? = nil, kmsKeyId: String? = nil, readReplicaDBInstanceIdentifiers: ReadReplicaDBInstanceIdentifierList? = nil, autoMinorVersionUpgrade: Bool? = nil, readReplicaSourceDBInstanceIdentifier: String? = nil, monitoringInterval: Int32? = nil, dbInstancePort: Int32? = nil, dBParameterGroups: DBParameterGroupStatusList? = nil, monitoringRoleArn: String? = nil, domainMemberships: DomainMembershipList? = nil, endpoint: Endpoint? = nil, dBSubnetGroup: DBSubnetGroup? = nil, optionGroupMemberships: OptionGroupMembershipList? = nil, storageType: String? = nil, availabilityZone: String? = nil, vpcSecurityGroups: VpcSecurityGroupMembershipList? = nil, tdeCredentialArn: String? = nil, dBSecurityGroups: DBSecurityGroupMembershipList? = nil, preferredMaintenanceWindow: String? = nil, timezone: String? = nil, performanceInsightsRetentionPeriod: Int32? = nil, licenseModel: String? = nil, engineVersion: String? = nil, dBInstanceArn: String? = nil, dBClusterIdentifier: String? = nil, dBInstanceStatus: String? = nil, cACertificateIdentifier: String? = nil, latestRestorableTime: TimeStamp? = nil, enabledCloudwatchLogsExports: [String]? = nil, instanceCreateTime: TimeStamp? = nil, iAMDatabaseAuthenticationEnabled: Bool? = nil, promotionTier: Int32? = nil, processorFeatures: ProcessorFeatureList? = nil, deletionProtection: Bool? = nil, performanceInsightsEnabled: Bool? = nil, characterSetName: String? = nil, statusInfos: DBInstanceStatusInfoList? = nil, allocatedStorage: Int32? = nil, pendingModifiedValues: PendingModifiedValues? = nil, secondaryAvailabilityZone: String? = nil, storageEncrypted: Bool? = nil, backupRetentionPeriod: Int32? = nil, enhancedMonitoringResourceArn: String? = nil, dbiResourceId: String? = nil, copyTagsToSnapshot: Bool? = nil, preferredBackupWindow: String? = nil, listenerEndpoint: Endpoint? = nil, iops: Int32? = nil) {
            self.masterUsername = masterUsername
    ...
    public struct OptionGroupOption: AWSShape {
        ...
        public init(requiresAutoMinorEngineVersionUpgrade: Bool? = nil, majorEngineVersion: String? = nil, engineName: String? = nil, minimumRequiredMinorEngineVersion: String? = nil, defaultPort: Int32? = nil, persistent: Bool? = nil, optionsDependedOn: OptionsDependedOn? = nil, optionsConflictsWith: OptionsConflictsWith? = nil, optionGroupOptionSettings: OptionGroupOptionSettingsList? = nil, permanent: Bool? = nil, description: String? = nil, vpcOnly: Bool? = nil, name: String? = nil, portRequired: Bool? = nil, supportsOptionVersionDowngrade: Bool? = nil, optionGroupOptionVersions: OptionGroupOptionVersionsList? = nil) {
    ...
    public struct DBClusterCapacityInfo: AWSShape {
        ...
        public init(timeoutAction: String? = nil, currentCapacity: Int32? = nil, dBClusterIdentifier: String? = nil, pendingCapacity: Int32? = nil, secondsBeforeTimeout: Int32? = nil) {
            self.timeoutAction = timeoutAction
    ...
    public struct DBInstanceAutomatedBackup: AWSShape {
        ...
        public init(encrypted: Bool? = nil, engine: String? = nil, optionGroupName: String? = nil, availabilityZone: String? = nil, engineVersion: String? = nil, instanceCreateTime: TimeStamp? = nil, timezone: String? = nil, allocatedStorage: Int32? = nil, region: String? = nil, dBInstanceArn: String? = nil, masterUsername: String? = nil, dbiResourceId: String? = nil, iops: Int32? = nil, port: Int32? = nil, vpcId: String? = nil, restoreWindow: RestoreWindow? = nil, dBInstanceIdentifier: String? = nil, storageType: String? = nil, kmsKeyId: String? = nil, status: String? = nil, tdeCredentialArn: String? = nil, licenseModel: String? = nil, iAMDatabaseAuthenticationEnabled: Bool? = nil) {
            self.encrypted = encrypted
            self.engine = engine
            self.optionGroupName = optionGroupName
            self.availabilityZone = availabilityZone
    ...
    public struct OptionConfiguration: AWSShape {
        ...
        public init(port: Int32? = nil, optionSettings: OptionSettingsList? = nil, optionVersion: String? = nil, vpcSecurityGroupMemberships: VpcSecurityGroupIdList? = nil, dBSecurityGroupMemberships: DBSecurityGroupNameList? = nil, optionName: String) {
            self.port = port
            self.optionSettings = optionSettings
            self.optionVersion = optionVersion
            self.vpcSecurityGroupMemberships = vpcSecurityGroupMemberships
    ...
    public struct DeleteDBInstanceMessage: AWSShape {
        ...
        public init(dBInstanceIdentifier: String, finalDBSnapshotIdentifier: String? = nil, deleteAutomatedBackups: Bool? = nil, skipFinalSnapshot: Bool? = nil) {
            self.dBInstanceIdentifier = dBInstanceIdentifier
            self.finalDBSnapshotIdentifier = finalDBSnapshotIdentifier
