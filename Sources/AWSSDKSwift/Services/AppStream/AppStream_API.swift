...
public struct AppStream {
    ...
    public func batchAssociateUserStack(_ input: BatchAssociateUserStackRequest) throws -> BatchAssociateUserStackResult {
        return try client.send(operation: "BatchAssociateUserStack", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified users from the specified stacks.
    public func batchDisassociateUserStack(_ input: BatchDisassociateUserStackRequest) throws -> BatchDisassociateUserStackResult {
    ...
    public func createUser(_ input: CreateUserRequest) throws -> CreateUserResult {
    ...
    public func deleteUser(_ input: DeleteUserRequest) throws -> DeleteUserResult {
    ...
    public func describeUserStackAssociations(_ input: DescribeUserStackAssociationsRequest) throws -> DescribeUserStackAssociationsResult {
    ...
    public func describeUsers(_ input: DescribeUsersRequest) throws -> DescribeUsersResult {
        return try client.send(operation: "DescribeUsers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables the specified user in the user pool. Users can't sign in to AppStream 2.0 until they are re-enabled. This action does not delete the user. 
    public func disableUser(_ input: DisableUserRequest) throws -> DisableUserResult {
    ...
    public func enableUser(_ input: EnableUserRequest) throws -> EnableUserResult {
