...
public struct AppStream {
    ...
    public func updateImagePermissions(_ input: UpdateImagePermissionsRequest) throws -> EventLoopFuture<UpdateImagePermissionsResult> {
    ...
    public func deleteStack(_ input: DeleteStackRequest) throws -> EventLoopFuture<DeleteStackResult> {
        return try client.send(operation: "DeleteStack", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops the specified image builder.
    public func stopImageBuilder(_ input: StopImageBuilderRequest) throws -> EventLoopFuture<StopImageBuilderResult> {
    ...
    public func expireSession(_ input: ExpireSessionRequest) throws -> EventLoopFuture<ExpireSessionResult> {
        return try client.send(operation: "ExpireSession", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a URL to start an image builder streaming session.
    public func createImageBuilderStreamingURL(_ input: CreateImageBuilderStreamingURLRequest) throws -> EventLoopFuture<CreateImageBuilderStreamingURLResult> {
    ...
    public func deleteImagePermissions(_ input: DeleteImagePermissionsRequest) throws -> EventLoopFuture<DeleteImagePermissionsResult> {
    ...
    public func describeSessions(_ input: DescribeSessionsRequest) throws -> EventLoopFuture<DescribeSessionsResult> {
        return try client.send(operation: "DescribeSessions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables a user in the user pool. After being enabled, users can sign in to AppStream 2.0 and open applications from the stacks to which they are assigned.
    public func enableUser(_ input: EnableUserRequest) throws -> EventLoopFuture<EnableUserResult> {
        return try client.send(operation: "EnableUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes one or more specified stacks, if the stack names are provided. Otherwise, all stacks in the account are described.
    public func describeStacks(_ input: DescribeStacksRequest) throws -> EventLoopFuture<DescribeStacksResult> {
    ...
    public func describeDirectoryConfigs(_ input: DescribeDirectoryConfigsRequest) throws -> EventLoopFuture<DescribeDirectoryConfigsResult> {
        return try client.send(operation: "DescribeDirectoryConfigs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified users from the specified stacks.
    public func batchDisassociateUserStack(_ input: BatchDisassociateUserStackRequest) throws -> EventLoopFuture<BatchDisassociateUserStackResult> {
        return try client.send(operation: "BatchDisassociateUserStack", path: "/", httpMethod: "POST", input: input)
    }

    ///  Starts the specified image builder.
    public func startImageBuilder(_ input: StartImageBuilderRequest) throws -> EventLoopFuture<StartImageBuilderResult> {
        return try client.send(operation: "StartImageBuilder", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the name of the fleet that is associated with the specified stack.
    public func listAssociatedFleets(_ input: ListAssociatedFleetsRequest) throws -> EventLoopFuture<ListAssociatedFleetsResult> {
        return try client.send(operation: "ListAssociatedFleets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops the specified fleet.
    public func stopFleet(_ input: StopFleetRequest) throws -> EventLoopFuture<StopFleetResult> {
    ...
    public func createImageBuilder(_ input: CreateImageBuilderRequest) throws -> EventLoopFuture<CreateImageBuilderResult> {
    ...
    public func deleteImage(_ input: DeleteImageRequest) throws -> EventLoopFuture<DeleteImageResult> {
        return try client.send(operation: "DeleteImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the specified fields for the specified stack.
    public func updateStack(_ input: UpdateStackRequest) throws -> EventLoopFuture<UpdateStackResult> {
    ...
    public func deleteImageBuilder(_ input: DeleteImageBuilderRequest) throws -> EventLoopFuture<DeleteImageBuilderResult> {
    ...
    public func describeUserStackAssociations(_ input: DescribeUserStackAssociationsRequest) throws -> EventLoopFuture<DescribeUserStackAssociationsResult> {
    ...
    public func disableUser(_ input: DisableUserRequest) throws -> EventLoopFuture<DisableUserResult> {
        return try client.send(operation: "DisableUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified fleet with the specified stack.
    public func associateFleet(_ input: AssociateFleetRequest) throws -> EventLoopFuture<AssociateFleetResult> {
        return try client.send(operation: "AssociateFleet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified fleet.
    public func deleteFleet(_ input: DeleteFleetRequest) throws -> EventLoopFuture<DeleteFleetResult> {
        return try client.send(operation: "DeleteFleet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a temporary URL to start an AppStream 2.0 streaming session for the specified user. A streaming URL enables application streaming to be tested without user setup. 
    public func createStreamingURL(_ input: CreateStreamingURLRequest) throws -> EventLoopFuture<CreateStreamingURLResult> {
        return try client.send(operation: "CreateStreamingURL", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the name of the stack with which the specified fleet is associated.
    public func listAssociatedStacks(_ input: ListAssociatedStacksRequest) throws -> EventLoopFuture<ListAssociatedStacksResult> {
        return try client.send(operation: "ListAssociatedStacks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes the permissions for shared AWS account IDs on a private image that you own. 
    public func describeImagePermissions(_ input: DescribeImagePermissionsRequest) throws -> EventLoopFuture<DescribeImagePermissionsResult> {
    ...
    public func updateFleet(_ input: UpdateFleetRequest) throws -> EventLoopFuture<UpdateFleetResult> {
        return try client.send(operation: "UpdateFleet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list that describes one or more specified image builders, if the image builder names are provided. Otherwise, all image builders in the account are described.
    public func describeImageBuilders(_ input: DescribeImageBuildersRequest) throws -> EventLoopFuture<DescribeImageBuildersResult> {
    ...
    public func updateDirectoryConfig(_ input: UpdateDirectoryConfigRequest) throws -> EventLoopFuture<UpdateDirectoryConfigResult> {
    ...
    public func createDirectoryConfig(_ input: CreateDirectoryConfigRequest) throws -> EventLoopFuture<CreateDirectoryConfigResult> {
        return try client.send(operation: "CreateDirectoryConfig", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified users with the specified stacks. Users in a user pool cannot be assigned to stacks with fleets that are joined to an Active Directory domain.
    public func batchAssociateUserStack(_ input: BatchAssociateUserStackRequest) throws -> EventLoopFuture<BatchAssociateUserStackResult> {
    ...
    public func describeUsers(_ input: DescribeUsersRequest) throws -> EventLoopFuture<DescribeUsersResult> {
        return try client.send(operation: "DescribeUsers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified Directory Config object from AppStream 2.0. This object includes the information required to join streaming instances to an Active Directory domain.
    public func deleteDirectoryConfig(_ input: DeleteDirectoryConfigRequest) throws -> EventLoopFuture<DeleteDirectoryConfigResult> {
        return try client.send(operation: "DeleteDirectoryConfig", path: "/", httpMethod: "POST", input: input)
    }

    ///  Starts the specified fleet.
    public func startFleet(_ input: StartFleetRequest) throws -> EventLoopFuture<StartFleetResult> {
        return try client.send(operation: "StartFleet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a user from the user pool.
    public func deleteUser(_ input: DeleteUserRequest) throws -> EventLoopFuture<DeleteUserResult> {
        return try client.send(operation: "DeleteUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new user in the user pool.
    public func createUser(_ input: CreateUserRequest) throws -> EventLoopFuture<CreateUserResult> {
        return try client.send(operation: "CreateUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Copies the image within the same region or to a new region within the same AWS account. Note that any tags you added to the image will not be copied.
    public func copyImage(_ input: CopyImageRequest) throws -> EventLoopFuture<CopyImageResponse> {
        return try client.send(operation: "CopyImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a stack to start streaming applications to users. A stack consists of an associated fleet, user access policies, and storage configurations. 
    public func createStack(_ input: CreateStackRequest) throws -> EventLoopFuture<CreateStackResult> {
        return try client.send(operation: "CreateStack", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified fleet from the specified stack.
    public func disassociateFleet(_ input: DisassociateFleetRequest) throws -> EventLoopFuture<DisassociateFleetResult> {
