...
public struct AppStream: AWSService {
    ...
    public func associateFleet(_ input: AssociateFleetRequest) -> EventLoopFuture<AssociateFleetResult> {
        return client.execute(operation: "AssociateFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchAssociateUserStack(_ input: BatchAssociateUserStackRequest) -> EventLoopFuture<BatchAssociateUserStackResult> {
        return client.execute(operation: "BatchAssociateUserStack", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func batchDisassociateUserStack(_ input: BatchDisassociateUserStackRequest) -> EventLoopFuture<BatchDisassociateUserStackResult> {
        return client.execute(operation: "BatchDisassociateUserStack", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDirectoryConfig(_ input: CreateDirectoryConfigRequest) -> EventLoopFuture<CreateDirectoryConfigResult> {
        return client.execute(operation: "CreateDirectoryConfig", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createImageBuilder(_ input: CreateImageBuilderRequest) -> EventLoopFuture<CreateImageBuilderResult> {
        return client.execute(operation: "CreateImageBuilder", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createImageBuilderStreamingURL(_ input: CreateImageBuilderStreamingURLRequest) -> EventLoopFuture<CreateImageBuilderStreamingURLResult> {
        return client.execute(operation: "CreateImageBuilderStreamingURL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createStreamingURL(_ input: CreateStreamingURLRequest) -> EventLoopFuture<CreateStreamingURLResult> {
        return client.execute(operation: "CreateStreamingURL", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createUsageReportSubscription(_ input: CreateUsageReportSubscriptionRequest) -> EventLoopFuture<CreateUsageReportSubscriptionResult> {
        return client.execute(operation: "CreateUsageReportSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDirectoryConfig(_ input: DeleteDirectoryConfigRequest) -> EventLoopFuture<DeleteDirectoryConfigResult> {
        return client.execute(operation: "DeleteDirectoryConfig", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified fleet.
    public func deleteFleet(_ input: DeleteFleetRequest) -> EventLoopFuture<DeleteFleetResult> {
        return client.execute(operation: "DeleteFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified image. You cannot delete an image when it is in use. After you delete an image, you cannot provision new capacity using the image.
    public func deleteImage(_ input: DeleteImageRequest) -> EventLoopFuture<DeleteImageResult> {
        return client.execute(operation: "DeleteImage", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified image builder and releases the capacity.
    public func deleteImageBuilder(_ input: DeleteImageBuilderRequest) -> EventLoopFuture<DeleteImageBuilderResult> {
        return client.execute(operation: "DeleteImageBuilder", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteImagePermissions(_ input: DeleteImagePermissionsRequest) -> EventLoopFuture<DeleteImagePermissionsResult> {
        return client.execute(operation: "DeleteImagePermissions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteUsageReportSubscription(_ input: DeleteUsageReportSubscriptionRequest) -> EventLoopFuture<DeleteUsageReportSubscriptionResult> {
        return client.execute(operation: "DeleteUsageReportSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDirectoryConfigs(_ input: DescribeDirectoryConfigsRequest) -> EventLoopFuture<DescribeDirectoryConfigsResult> {
        return client.execute(operation: "DescribeDirectoryConfigs", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeImageBuilders(_ input: DescribeImageBuildersRequest) -> EventLoopFuture<DescribeImageBuildersResult> {
        return client.execute(operation: "DescribeImageBuilders", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeImagePermissions(_ input: DescribeImagePermissionsRequest) -> EventLoopFuture<DescribeImagePermissionsResult> {
        return client.execute(operation: "DescribeImagePermissions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeUsageReportSubscriptions(_ input: DescribeUsageReportSubscriptionsRequest) -> EventLoopFuture<DescribeUsageReportSubscriptionsResult> {
        return client.execute(operation: "DescribeUsageReportSubscriptions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeUserStackAssociations(_ input: DescribeUserStackAssociationsRequest) -> EventLoopFuture<DescribeUserStackAssociationsResult> {
        return client.execute(operation: "DescribeUserStackAssociations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves a list that describes one or more specified users in the user pool.
    public func describeUsers(_ input: DescribeUsersRequest) -> EventLoopFuture<DescribeUsersResult> {
        return client.execute(operation: "DescribeUsers", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Disables the specified user in the user pool. Users can't sign in to AppStream 2.0 until they are re-enabled. This action does not delete the user. 
    public func disableUser(_ input: DisableUserRequest) -> EventLoopFuture<DisableUserResult> {
        return client.execute(operation: "DisableUser", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Disassociates the specified fleet from the specified stack.
    public func disassociateFleet(_ input: DisassociateFleetRequest) -> EventLoopFuture<DisassociateFleetResult> {
        return client.execute(operation: "DisassociateFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Enables a user in the user pool. After being enabled, users can sign in to AppStream 2.0 and open applications from the stacks to which they are assigned.
    public func enableUser(_ input: EnableUserRequest) -> EventLoopFuture<EnableUserResult> {
        return client.execute(operation: "EnableUser", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Immediately stops the specified streaming session.
    public func expireSession(_ input: ExpireSessionRequest) -> EventLoopFuture<ExpireSessionResult> {
        return client.execute(operation: "ExpireSession", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAssociatedFleets(_ input: ListAssociatedFleetsRequest) -> EventLoopFuture<ListAssociatedFleetsResult> {
        return client.execute(operation: "ListAssociatedFleets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAssociatedStacks(_ input: ListAssociatedStacksRequest) -> EventLoopFuture<ListAssociatedStacksResult> {
        return client.execute(operation: "ListAssociatedStacks", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startFleet(_ input: StartFleetRequest) -> EventLoopFuture<StartFleetResult> {
        return client.execute(operation: "StartFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Starts the specified image builder.
    public func startImageBuilder(_ input: StartImageBuilderRequest) -> EventLoopFuture<StartImageBuilderResult> {
        return client.execute(operation: "StartImageBuilder", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Stops the specified fleet.
    public func stopFleet(_ input: StopFleetRequest) -> EventLoopFuture<StopFleetResult> {
        return client.execute(operation: "StopFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Stops the specified image builder.
    public func stopImageBuilder(_ input: StopImageBuilderRequest) -> EventLoopFuture<StopImageBuilderResult> {
        return client.execute(operation: "StopImageBuilder", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateDirectoryConfig(_ input: UpdateDirectoryConfigRequest) -> EventLoopFuture<UpdateDirectoryConfigResult> {
        return client.execute(operation: "UpdateDirectoryConfig", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateFleet(_ input: UpdateFleetRequest) -> EventLoopFuture<UpdateFleetResult> {
        return client.execute(operation: "UpdateFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateImagePermissions(_ input: UpdateImagePermissionsRequest) -> EventLoopFuture<UpdateImagePermissionsResult> {
        return client.execute(operation: "UpdateImagePermissions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
