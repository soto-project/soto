...
extension DatabaseMigrationService {
    ...
    public struct IBMDb2Settings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "CurrentLsn", required: false, type: .string), 
            AWSShapeMember(label: "DatabaseName", required: false, type: .string), 
            AWSShapeMember(label: "MaxKBytesPerRead", required: false, type: .integer), 
            AWSShapeMember(label: "Password", required: false, type: .string), 
            AWSShapeMember(label: "Port", required: false, type: .integer), 
            AWSShapeMember(label: "ServerName", required: false, type: .string), 
            AWSShapeMember(label: "SetDataCaptureChanges", required: false, type: .boolean), 
            AWSShapeMember(label: "Username", required: false, type: .string)
        ]
    ...
    public struct MicrosoftSQLServerSettings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "BcpPacketSize", required: false, type: .integer), 
            AWSShapeMember(label: "ControlTablesFileGroup", required: false, type: .string), 
            AWSShapeMember(label: "DatabaseName", required: false, type: .string), 
            AWSShapeMember(label: "Password", required: false, type: .string), 
            AWSShapeMember(label: "Port", required: false, type: .integer), 
            AWSShapeMember(label: "ReadBackupOnly", required: false, type: .boolean), 
            AWSShapeMember(label: "SafeguardPolicy", required: false, type: .enum), 
            AWSShapeMember(label: "ServerName", required: false, type: .string), 
            AWSShapeMember(label: "UseBcpFullLoad", required: false, type: .boolean), 
            AWSShapeMember(label: "Username", required: false, type: .string)
        ]
    ...
    public struct MySQLSettings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "DatabaseName", required: false, type: .string), 
            AWSShapeMember(label: "EventsPollInterval", required: false, type: .integer), 
            AWSShapeMember(label: "MaxFileSize", required: false, type: .integer), 
            AWSShapeMember(label: "ParallelLoadThreads", required: false, type: .integer), 
            AWSShapeMember(label: "Password", required: false, type: .string), 
            AWSShapeMember(label: "Port", required: false, type: .integer), 
            AWSShapeMember(label: "ServerName", required: false, type: .string), 
            AWSShapeMember(label: "ServerTimezone", required: false, type: .string), 
            AWSShapeMember(label: "TargetDbType", required: false, type: .enum), 
            AWSShapeMember(label: "Username", required: false, type: .string)
        ]
    ...
    public struct OracleSettings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "AccessAlternateDirectly", required: false, type: .boolean), 
            AWSShapeMember(label: "AdditionalArchivedLogDestId", required: false, type: .integer), 
            AWSShapeMember(label: "AddSupplementalLogging", required: false, type: .boolean), 
            AWSShapeMember(label: "AllowSelectNestedTables", required: false, type: .boolean), 
            AWSShapeMember(label: "ArchivedLogDestId", required: false, type: .integer), 
            AWSShapeMember(label: "ArchivedLogsOnly", required: false, type: .boolean), 
            ...
            AWSShapeMember(label: "CharLengthSemantics", required: false, type: .enum), 
            AWSShapeMember(label: "DatabaseName", required: false, type: .string), 
            AWSShapeMember(label: "DirectPathNoLog", required: false, type: .boolean), 
            AWSShapeMember(label: "DirectPathParallelLoad", required: false, type: .boolean), 
            AWSShapeMember(label: "EnableHomogenousTablespace", required: false, type: .boolean), 
            AWSShapeMember(label: "FailTasksOnLobTruncation", required: false, type: .boolean), 
            AWSShapeMember(label: "NumberDatatypeScale", required: false, type: .integer), 
            AWSShapeMember(label: "OraclePathPrefix", required: false, type: .string), 
            AWSShapeMember(label: "ParallelAsmReadThreads", required: false, type: .integer), 
            AWSShapeMember(label: "Password", required: false, type: .string), 
            AWSShapeMember(label: "Port", required: false, type: .integer), 
            AWSShapeMember(label: "ReadAheadBlocks", required: false, type: .integer), 
            AWSShapeMember(label: "ReadTableSpaceName", required: false, type: .boolean), 
            AWSShapeMember(label: "ReplacePathPrefix", required: false, type: .boolean), 
            AWSShapeMember(label: "RetryInterval", required: false, type: .integer), 
            ...
            AWSShapeMember(label: "ServerName", required: false, type: .string), 
            AWSShapeMember(label: "UseAlternateFolderForOnline", required: false, type: .boolean), 
            AWSShapeMember(label: "UsePathPrefix", required: false, type: .string), 
            AWSShapeMember(label: "Username", required: false, type: .string)
        ]
    ...
    public struct PostgreSQLSettings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "AfterConnectScript", required: false, type: .string), 
            AWSShapeMember(label: "CaptureDdls", required: false, type: .boolean), 
            AWSShapeMember(label: "DatabaseName", required: false, type: .string), 
            AWSShapeMember(label: "DdlArtifactsSchema", required: false, type: .string), 
            AWSShapeMember(label: "ExecuteTimeout", required: false, type: .integer), 
            AWSShapeMember(label: "FailTasksOnLobTruncation", required: false, type: .boolean), 
            AWSShapeMember(label: "MaxFileSize", required: false, type: .integer), 
            AWSShapeMember(label: "Password", required: false, type: .string), 
            AWSShapeMember(label: "Port", required: false, type: .integer), 
            AWSShapeMember(label: "ServerName", required: false, type: .string), 
            AWSShapeMember(label: "SlotName", required: false, type: .string), 
            AWSShapeMember(label: "Username", required: false, type: .string)
        ]
    ...
    public struct RedshiftSettings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "BucketName", required: false, type: .string), 
            AWSShapeMember(label: "CaseSensitiveNames", required: false, type: .boolean), 
            AWSShapeMember(label: "CompUpdate", required: false, type: .boolean), 
            ...
            AWSShapeMember(label: "ExplicitIds", required: false, type: .boolean), 
    ...
    public struct S3Settings: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "DatePartitionDelimiter", required: false, type: .enum), 
            AWSShapeMember(label: "DatePartitionEnabled", required: false, type: .boolean), 
            AWSShapeMember(label: "DatePartitionSequence", required: false, type: .enum), 
