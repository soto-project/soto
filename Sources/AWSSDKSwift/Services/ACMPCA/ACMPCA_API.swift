...
public struct ACMPCA {
    ...
    public func listCertificateAuthorities(_ input: ListCertificateAuthoritiesRequest) throws -> EventLoopFuture<ListCertificateAuthoritiesResponse> {
    ...
    public func createCertificateAuthority(_ input: CreateCertificateAuthorityRequest) throws -> EventLoopFuture<CreateCertificateAuthorityResponse> {
    ...
    public func getCertificateAuthorityCsr(_ input: GetCertificateAuthorityCsrRequest) throws -> EventLoopFuture<GetCertificateAuthorityCsrResponse> {
    ...
    public func issueCertificate(_ input: IssueCertificateRequest) throws -> EventLoopFuture<IssueCertificateResponse> {
    ...
    public func getCertificateAuthorityCertificate(_ input: GetCertificateAuthorityCertificateRequest) throws -> EventLoopFuture<GetCertificateAuthorityCertificateResponse> {
    ...
    public func describeCertificateAuthority(_ input: DescribeCertificateAuthorityRequest) throws -> EventLoopFuture<DescribeCertificateAuthorityResponse> {
    ...
    public func createCertificateAuthorityAuditReport(_ input: CreateCertificateAuthorityAuditReportRequest) throws -> EventLoopFuture<CreateCertificateAuthorityAuditReportResponse> {
    ...
    public func describeCertificateAuthorityAuditReport(_ input: DescribeCertificateAuthorityAuditReportRequest) throws -> EventLoopFuture<DescribeCertificateAuthorityAuditReportResponse> {
