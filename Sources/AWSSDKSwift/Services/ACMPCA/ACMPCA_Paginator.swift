...
extension ACMPCA {
    ...
    public func listCertificateAuthoritiesPaginator(_ input: ListCertificateAuthoritiesRequest) -> EventLoopFuture<[CertificateAuthority]> {
        return client.paginate(input: input, command: listCertificateAuthorities, resultKey: \ListCertificateAuthoritiesResponse.certificateAuthorities, tokenKey: \ListCertificateAuthoritiesResponse.nextToken)
    }
    ...
    public func listPermissionsPaginator(_ input: ListPermissionsRequest) -> EventLoopFuture<[Permission]> {
        return client.paginate(input: input, command: listPermissions, resultKey: \ListPermissionsResponse.permissions, tokenKey: \ListPermissionsResponse.nextToken)
    }
