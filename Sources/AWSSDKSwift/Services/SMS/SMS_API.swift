...
public struct SMS {
    ...
    public func generateChangeSet(_ input: GenerateChangeSetRequest) throws -> EventLoopFuture<GenerateChangeSetResponse> {
        return try client.send(operation: "GenerateChangeSet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the connectors registered with the AWS SMS.
    public func getConnectors(_ input: GetConnectorsRequest) throws -> EventLoopFuture<GetConnectorsResponse> {
        return try client.send(operation: "GetConnectors", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the servers in your server catalog. Before you can describe your servers, you must import them using ImportServerCatalog.
    public func getServers(_ input: GetServersRequest) throws -> EventLoopFuture<GetServersResponse> {
        return try client.send(operation: "GetServers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves an application replication configuration associatd with an application.
    public func getAppReplicationConfiguration(_ input: GetAppReplicationConfigurationRequest) throws -> EventLoopFuture<GetAppReplicationConfigurationResponse> {
    ...
    public func putAppLaunchConfiguration(_ input: PutAppLaunchConfigurationRequest) throws -> EventLoopFuture<PutAppLaunchConfigurationResponse> {
        return try client.send(operation: "PutAppLaunchConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Starts replicating an application.
    public func startAppReplication(_ input: StartAppReplicationRequest) throws -> EventLoopFuture<StartAppReplicationResponse> {
        return try client.send(operation: "StartAppReplication", path: "/", httpMethod: "POST", input: input)
    }

    ///  Generates an Amazon CloudFormation template based on the current launch configuration and writes it to an Amazon S3 object in the customer’s Amazon S3 bucket.
    public func generateTemplate(_ input: GenerateTemplateRequest) throws -> EventLoopFuture<GenerateTemplateResponse> {
        return try client.send(operation: "GenerateTemplate", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes existing replication configuration for an application.
    public func deleteAppReplicationConfiguration(_ input: DeleteAppReplicationConfigurationRequest) throws -> EventLoopFuture<DeleteAppReplicationConfigurationResponse> {
        return try client.send(operation: "DeleteAppReplicationConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates an application.
    public func updateApp(_ input: UpdateAppRequest) throws -> EventLoopFuture<UpdateAppResponse> {
        return try client.send(operation: "UpdateApp", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates or updates a replication configuration for an application.
    public func putAppReplicationConfiguration(_ input: PutAppReplicationConfigurationRequest) throws -> EventLoopFuture<PutAppReplicationConfigurationResponse> {
    ...
    public func startOnDemandReplicationRun(_ input: StartOnDemandReplicationRunRequest) throws -> EventLoopFuture<StartOnDemandReplicationRunResponse> {
        return try client.send(operation: "StartOnDemandReplicationRun", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes all servers from your server catalog.
    public func deleteServerCatalog(_ input: DeleteServerCatalogRequest) throws -> EventLoopFuture<DeleteServerCatalogResponse> {
        return try client.send(operation: "DeleteServerCatalog", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes existing launch configuration for an application.
    public func deleteAppLaunchConfiguration(_ input: DeleteAppLaunchConfigurationRequest) throws -> EventLoopFuture<DeleteAppLaunchConfigurationResponse> {
        return try client.send(operation: "DeleteAppLaunchConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Launches an application stack.
    public func launchApp(_ input: LaunchAppRequest) throws -> EventLoopFuture<LaunchAppResponse> {
    ...
    public func deleteReplicationJob(_ input: DeleteReplicationJobRequest) throws -> EventLoopFuture<DeleteReplicationJobResponse> {
        return try client.send(operation: "DeleteReplicationJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified replication job or all of your replication jobs.
    public func getReplicationJobs(_ input: GetReplicationJobsRequest) throws -> EventLoopFuture<GetReplicationJobsResponse> {
        return try client.send(operation: "GetReplicationJobs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops replicating an application.
    public func stopAppReplication(_ input: StopAppReplicationRequest) throws -> EventLoopFuture<StopAppReplicationResponse> {
        return try client.send(operation: "StopAppReplication", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the specified settings for the specified replication job.
    public func updateReplicationJob(_ input: UpdateReplicationJobRequest) throws -> EventLoopFuture<UpdateReplicationJobResponse> {
        return try client.send(operation: "UpdateReplicationJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of summaries for all applications.
    public func listApps(_ input: ListAppsRequest) throws -> EventLoopFuture<ListAppsResponse> {
    ...
    public func importServerCatalog(_ input: ImportServerCatalogRequest) throws -> EventLoopFuture<ImportServerCatalogResponse> {
    ...
    public func disassociateConnector(_ input: DisassociateConnectorRequest) throws -> EventLoopFuture<DisassociateConnectorResponse> {
    ...
    public func createReplicationJob(_ input: CreateReplicationJobRequest) throws -> EventLoopFuture<CreateReplicationJobResponse> {
        return try client.send(operation: "CreateReplicationJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the replication runs for the specified replication job.
    public func getReplicationRuns(_ input: GetReplicationRunsRequest) throws -> EventLoopFuture<GetReplicationRunsResponse> {
    ...
    public func getAppLaunchConfiguration(_ input: GetAppLaunchConfigurationRequest) throws -> EventLoopFuture<GetAppLaunchConfigurationResponse> {
        return try client.send(operation: "GetAppLaunchConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Terminates the stack for an application.
    public func terminateApp(_ input: TerminateAppRequest) throws -> EventLoopFuture<TerminateAppResponse> {
