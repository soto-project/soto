...
public struct ConnectParticipant: AWSService {
    ...
    /// return new `ConnectParticipant` with new timeout value
    ...
    /// return new `ConnectParticipant` logging to specified Logger
    ...
    public func createParticipantConnection(_ input: CreateParticipantConnectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateParticipantConnectionResponse> {
        return client.execute(operation: "CreateParticipantConnection", path: "/participant/connection", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func disconnectParticipant(_ input: DisconnectParticipantRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisconnectParticipantResponse> {
        return client.execute(operation: "DisconnectParticipant", path: "/participant/disconnect", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getTranscript(_ input: GetTranscriptRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTranscriptResponse> {
        return client.execute(operation: "GetTranscript", path: "/participant/transcript", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func sendEvent(_ input: SendEventRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendEventResponse> {
        return client.execute(operation: "SendEvent", path: "/participant/event", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func sendMessage(_ input: SendMessageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendMessageResponse> {
        return client.execute(operation: "SendMessage", path: "/participant/message", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
