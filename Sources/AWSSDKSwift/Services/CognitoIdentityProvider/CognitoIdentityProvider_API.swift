...
public struct CognitoIdentityProvider {
    ...
    public func listUserImportJobs(_ input: ListUserImportJobsRequest) throws -> EventLoopFuture<ListUserImportJobsResponse> {
    ...
    public func adminListUserAuthEvents(_ input: AdminListUserAuthEventsRequest) throws -> EventLoopFuture<AdminListUserAuthEventsResponse> {
    ...
    public func getUICustomization(_ input: GetUICustomizationRequest) throws -> EventLoopFuture<GetUICustomizationResponse> {
        return try client.send(operation: "GetUICustomization", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the configuration information and metadata of the specified user pool.
    public func describeUserPool(_ input: DescribeUserPoolRequest) throws -> EventLoopFuture<DescribeUserPoolResponse> {
        return try client.send(operation: "DescribeUserPool", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the clients that have been created for the specified user pool.
    public func listUserPoolClients(_ input: ListUserPoolClientsRequest) throws -> EventLoopFuture<ListUserPoolClientsResponse> {
        return try client.send(operation: "ListUserPoolClients", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes a resource server.
    public func describeResourceServer(_ input: DescribeResourceServerRequest) throws -> EventLoopFuture<DescribeResourceServerResponse> {
    ...
    public func forgotPassword(_ input: ForgotPasswordRequest) throws -> EventLoopFuture<ForgotPasswordResponse> {
    ...
    public func adminUpdateAuthEventFeedback(_ input: AdminUpdateAuthEventFeedbackRequest) throws -> EventLoopFuture<AdminUpdateAuthEventFeedbackResponse> {
    ...
    public func associateSoftwareToken(_ input: AssociateSoftwareTokenRequest) throws -> EventLoopFuture<AssociateSoftwareTokenResponse> {
        return try client.send(operation: "AssociateSoftwareToken", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the user pools associated with an AWS account.
    public func listUserPools(_ input: ListUserPoolsRequest) throws -> EventLoopFuture<ListUserPoolsResponse> {
        return try client.send(operation: "ListUserPools", path: "/", httpMethod: "POST", input: input)
    }

    ///  Changes the password for a specified user in a user pool.
    public func changePassword(_ input: ChangePasswordRequest) throws -> EventLoopFuture<ChangePasswordResponse> {
    ...
    public func listUsersInGroup(_ input: ListUsersInGroupRequest) throws -> EventLoopFuture<ListUsersInGroupResponse> {
    ...
    public func adminUpdateUserAttributes(_ input: AdminUpdateUserAttributesRequest) throws -> EventLoopFuture<AdminUpdateUserAttributesResponse> {
    ...
    public func adminCreateUser(_ input: AdminCreateUserRequest) throws -> EventLoopFuture<AdminCreateUserResponse> {
    ...
    public func adminDeleteUserAttributes(_ input: AdminDeleteUserAttributesRequest) throws -> EventLoopFuture<AdminDeleteUserAttributesResponse> {
    ...
    public func updateUserPool(_ input: UpdateUserPoolRequest) throws -> EventLoopFuture<UpdateUserPoolResponse> {
    ...
    public func setUserSettings(_ input: SetUserSettingsRequest) throws -> EventLoopFuture<SetUserSettingsResponse> {
        return try client.send(operation: "SetUserSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Confirms tracking of the device. This API call is the call that begins device tracking.
    public func confirmDevice(_ input: ConfirmDeviceRequest) throws -> EventLoopFuture<ConfirmDeviceResponse> {
        return try client.send(operation: "ConfirmDevice", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the header information for the .csv file to be used as input for the user import job.
    public func getCSVHeader(_ input: GetCSVHeaderRequest) throws -> EventLoopFuture<GetCSVHeaderResponse> {
        return try client.send(operation: "GetCSVHeader", path: "/", httpMethod: "POST", input: input)
    }

    ///  Signs out users from all devices.
    public func globalSignOut(_ input: GlobalSignOutRequest) throws -> EventLoopFuture<GlobalSignOutResponse> {
    ...
    public func setUICustomization(_ input: SetUICustomizationRequest) throws -> EventLoopFuture<SetUICustomizationResponse> {
        return try client.send(operation: "SetUICustomization", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the device.
    public func getDevice(_ input: GetDeviceRequest) throws -> EventLoopFuture<GetDeviceResponse> {
        return try client.send(operation: "GetDevice", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new OAuth2.0 resource server and defines custom scopes in it.
    public func createResourceServer(_ input: CreateResourceServerRequest) throws -> EventLoopFuture<CreateResourceServerResponse> {
    ...
    public func adminRespondToAuthChallenge(_ input: AdminRespondToAuthChallengeRequest) throws -> EventLoopFuture<AdminRespondToAuthChallengeResponse> {
        return try client.send(operation: "AdminRespondToAuthChallenge", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allows a user to update a specific attribute (one at a time).
    public func updateUserAttributes(_ input: UpdateUserAttributesRequest) throws -> EventLoopFuture<UpdateUserAttributesResponse> {
    ...
    public func adminDisableProviderForUser(_ input: AdminDisableProviderForUserRequest) throws -> EventLoopFuture<AdminDisableProviderForUserResponse> {
        return try client.send(operation: "AdminDisableProviderForUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Starts the user import.
    public func startUserImportJob(_ input: StartUserImportJobRequest) throws -> EventLoopFuture<StartUserImportJobResponse> {
    ...
    public func describeIdentityProvider(_ input: DescribeIdentityProviderRequest) throws -> EventLoopFuture<DescribeIdentityProviderResponse> {
        return try client.send(operation: "DescribeIdentityProvider", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the attributes for a user.
    public func deleteUserAttributes(_ input: DeleteUserAttributesRequest) throws -> EventLoopFuture<DeleteUserAttributesResponse> {
        return try client.send(operation: "DeleteUserAttributes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the name and scopes of resource server. All other fields are read-only.
    public func updateResourceServer(_ input: UpdateResourceServerRequest) throws -> EventLoopFuture<UpdateResourceServerResponse> {
        return try client.send(operation: "UpdateResourceServer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new Amazon Cognito user pool and sets the password policy for the pool.
    public func createUserPool(_ input: CreateUserPoolRequest) throws -> EventLoopFuture<CreateUserPoolResponse> {
        return try client.send(operation: "CreateUserPool", path: "/", httpMethod: "POST", input: input)
    }

    ///  Confirms registration of a user and handles the existing alias from a previous user.
    public func confirmSignUp(_ input: ConfirmSignUpRequest) throws -> EventLoopFuture<ConfirmSignUpResponse> {
    ...
    public func adminEnableUser(_ input: AdminEnableUserRequest) throws -> EventLoopFuture<AdminEnableUserResponse> {
        return try client.send(operation: "AdminEnableUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new domain for a user pool.
    public func createUserPoolDomain(_ input: CreateUserPoolDomainRequest) throws -> EventLoopFuture<CreateUserPoolDomainResponse> {
        return try client.send(operation: "CreateUserPoolDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  Verifies the specified user attributes in the user pool.
    public func verifyUserAttribute(_ input: VerifyUserAttributeRequest) throws -> EventLoopFuture<VerifyUserAttributeResponse> {
    ...
    public func updateAuthEventFeedback(_ input: UpdateAuthEventFeedbackRequest) throws -> EventLoopFuture<UpdateAuthEventFeedbackResponse> {
    ...
    public func adminConfirmSignUp(_ input: AdminConfirmSignUpRequest) throws -> EventLoopFuture<AdminConfirmSignUpResponse> {
        return try client.send(operation: "AdminConfirmSignUp", path: "/", httpMethod: "POST", input: input)
    }

    ///  Sets the user's multi-factor authentication (MFA) preference.
    public func adminSetUserMFAPreference(_ input: AdminSetUserMFAPreferenceRequest) throws -> EventLoopFuture<AdminSetUserMFAPreferenceResponse> {
    ...
    public func resendConfirmationCode(_ input: ResendConfirmationCodeRequest) throws -> EventLoopFuture<ResendConfirmationCodeResponse> {
        return try client.send(operation: "ResendConfirmationCode", path: "/", httpMethod: "POST", input: input)
    }

    ///  Initiates the authentication flow.
    public func initiateAuth(_ input: InitiateAuthRequest) throws -> EventLoopFuture<InitiateAuthResponse> {
    ...
    public func adminLinkProviderForUser(_ input: AdminLinkProviderForUserRequest) throws -> EventLoopFuture<AdminLinkProviderForUserResponse> {
    ...
    public func stopUserImportJob(_ input: StopUserImportJobRequest) throws -> EventLoopFuture<StopUserImportJobResponse> {
    ...
    public func verifySoftwareToken(_ input: VerifySoftwareTokenRequest) throws -> EventLoopFuture<VerifySoftwareTokenResponse> {
    ...
    public func updateIdentityProvider(_ input: UpdateIdentityProviderRequest) throws -> EventLoopFuture<UpdateIdentityProviderResponse> {
    ...
    public func adminGetUser(_ input: AdminGetUserRequest) throws -> EventLoopFuture<AdminGetUserResponse> {
        return try client.send(operation: "AdminGetUser", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allows a user to enter a confirmation code to reset a forgotten password.
    public func confirmForgotPassword(_ input: ConfirmForgotPasswordRequest) throws -> EventLoopFuture<ConfirmForgotPasswordResponse> {
        return try client.send(operation: "ConfirmForgotPassword", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds additional user attributes to the user pool schema.
    public func addCustomAttributes(_ input: AddCustomAttributesRequest) throws -> EventLoopFuture<AddCustomAttributesResponse> {
    ...
    public func setRiskConfiguration(_ input: SetRiskConfigurationRequest) throws -> EventLoopFuture<SetRiskConfigurationResponse> {
    ...
    public func describeUserImportJob(_ input: DescribeUserImportJobRequest) throws -> EventLoopFuture<DescribeUserImportJobResponse> {
        return try client.send(operation: "DescribeUserImportJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the user attribute verification code for the specified attribute name.
    public func getUserAttributeVerificationCode(_ input: GetUserAttributeVerificationCodeRequest) throws -> EventLoopFuture<GetUserAttributeVerificationCodeResponse> {
        return try client.send(operation: "GetUserAttributeVerificationCode", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists information about all identity providers for a user pool.
    public func listIdentityProviders(_ input: ListIdentityProvidersRequest) throws -> EventLoopFuture<ListIdentityProvidersResponse> {
        return try client.send(operation: "ListIdentityProviders", path: "/", httpMethod: "POST", input: input)
    }

    ///  Registers the user in the specified user pool and creates a user name, password, and user attributes.
    public func signUp(_ input: SignUpRequest) throws -> EventLoopFuture<SignUpResponse> {
        return try client.send(operation: "SignUp", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a domain for a user pool.
    public func deleteUserPoolDomain(_ input: DeleteUserPoolDomainRequest) throws -> EventLoopFuture<DeleteUserPoolDomainResponse> {
    ...
    public func adminResetUserPassword(_ input: AdminResetUserPasswordRequest) throws -> EventLoopFuture<AdminResetUserPasswordResponse> {
        return try client.send(operation: "AdminResetUserPassword", path: "/", httpMethod: "POST", input: input)
    }

    ///  Set the user's multi-factor authentication (MFA) method preference.
    public func setUserMFAPreference(_ input: SetUserMFAPreferenceRequest) throws -> EventLoopFuture<SetUserMFAPreferenceResponse> {
        return try client.send(operation: "SetUserMFAPreference", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the risk configuration.
    public func describeRiskConfiguration(_ input: DescribeRiskConfigurationRequest) throws -> EventLoopFuture<DescribeRiskConfigurationResponse> {
    ...
    public func updateUserPoolClient(_ input: UpdateUserPoolClientRequest) throws -> EventLoopFuture<UpdateUserPoolClientResponse> {
    ...
    public func adminListDevices(_ input: AdminListDevicesRequest) throws -> EventLoopFuture<AdminListDevicesResponse> {
        return try client.send(operation: "AdminListDevices", path: "/", httpMethod: "POST", input: input)
    }

    ///  This method takes a user pool ID, and returns the signing certificate.
    public func getSigningCertificate(_ input: GetSigningCertificateRequest) throws -> EventLoopFuture<GetSigningCertificateResponse> {
        return try client.send(operation: "GetSigningCertificate", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates the user import job.
    public func createUserImportJob(_ input: CreateUserImportJobRequest) throws -> EventLoopFuture<CreateUserImportJobResponse> {
        return try client.send(operation: "CreateUserImportJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the user pool multi-factor authentication (MFA) configuration.
    public func getUserPoolMfaConfig(_ input: GetUserPoolMfaConfigRequest) throws -> EventLoopFuture<GetUserPoolMfaConfigResponse> {
    ...
    public func adminSetUserSettings(_ input: AdminSetUserSettingsRequest) throws -> EventLoopFuture<AdminSetUserSettingsResponse> {
    ...
    public func adminUpdateDeviceStatus(_ input: AdminUpdateDeviceStatusRequest) throws -> EventLoopFuture<AdminUpdateDeviceStatusResponse> {
    ...
    public func getIdentityProviderByIdentifier(_ input: GetIdentityProviderByIdentifierRequest) throws -> EventLoopFuture<GetIdentityProviderByIdentifierResponse> {
        return try client.send(operation: "GetIdentityProviderByIdentifier", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about a domain.
    public func describeUserPoolDomain(_ input: DescribeUserPoolDomainRequest) throws -> EventLoopFuture<DescribeUserPoolDomainResponse> {
    ...
    public func adminUserGlobalSignOut(_ input: AdminUserGlobalSignOutRequest) throws -> EventLoopFuture<AdminUserGlobalSignOutResponse> {
    ...
    public func adminDisableUser(_ input: AdminDisableUserRequest) throws -> EventLoopFuture<AdminDisableUserResponse> {
    ...
    public func adminInitiateAuth(_ input: AdminInitiateAuthRequest) throws -> EventLoopFuture<AdminInitiateAuthResponse> {
        return try client.send(operation: "AdminInitiateAuth", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates an identity provider for a user pool.
    public func createIdentityProvider(_ input: CreateIdentityProviderRequest) throws -> EventLoopFuture<CreateIdentityProviderResponse> {
    ...
    public func createUserPoolClient(_ input: CreateUserPoolClientRequest) throws -> EventLoopFuture<CreateUserPoolClientResponse> {
        return try client.send(operation: "CreateUserPoolClient", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the resource servers for a user pool.
    public func listResourceServers(_ input: ListResourceServersRequest) throws -> EventLoopFuture<ListResourceServersResponse> {
        return try client.send(operation: "ListResourceServers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Client method for returning the configuration information and metadata of the specified user pool app client.
    public func describeUserPoolClient(_ input: DescribeUserPoolClientRequest) throws -> EventLoopFuture<DescribeUserPoolClientResponse> {
    ...
    public func respondToAuthChallenge(_ input: RespondToAuthChallengeRequest) throws -> EventLoopFuture<RespondToAuthChallengeResponse> {
        return try client.send(operation: "RespondToAuthChallenge", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the device status.
    public func updateDeviceStatus(_ input: UpdateDeviceStatusRequest) throws -> EventLoopFuture<UpdateDeviceStatusResponse> {
    ...
    public func adminGetDevice(_ input: AdminGetDeviceRequest) throws -> EventLoopFuture<AdminGetDeviceResponse> {
        return try client.send(operation: "AdminGetDevice", path: "/", httpMethod: "POST", input: input)
    }

    ///  Set the user pool MFA configuration.
    public func setUserPoolMfaConfig(_ input: SetUserPoolMfaConfigRequest) throws -> EventLoopFuture<SetUserPoolMfaConfigResponse> {
    ...
    public func adminListGroupsForUser(_ input: AdminListGroupsForUserRequest) throws -> EventLoopFuture<AdminListGroupsForUserResponse> {
