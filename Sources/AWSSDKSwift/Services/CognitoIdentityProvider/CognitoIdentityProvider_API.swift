...
public struct CognitoIdentityProvider {
    ...
    public func adminDisableProviderForUser(_ input: AdminDisableProviderForUserRequest) throws -> AdminDisableProviderForUserResponse {
    ...
    public func adminLinkProviderForUser(_ input: AdminLinkProviderForUserRequest) throws -> AdminLinkProviderForUserResponse {
    ...
    public func adminListUserAuthEvents(_ input: AdminListUserAuthEventsRequest) throws -> AdminListUserAuthEventsResponse {
    ...
    public func adminSetUserMFAPreference(_ input: AdminSetUserMFAPreferenceRequest) throws -> AdminSetUserMFAPreferenceResponse {
    ...
    public func adminUpdateAuthEventFeedback(_ input: AdminUpdateAuthEventFeedbackRequest) throws -> AdminUpdateAuthEventFeedbackResponse {
    ...
    public func associateSoftwareToken(_ input: AssociateSoftwareTokenRequest) throws -> AssociateSoftwareTokenResponse {
    ...
    public func createResourceServer(_ input: CreateResourceServerRequest) throws -> CreateResourceServerResponse {
    ...
    public func describeResourceServer(_ input: DescribeResourceServerRequest) throws -> DescribeResourceServerResponse {
        return try client.send(operation: "DescribeResourceServer", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the risk configuration.
    public func describeRiskConfiguration(_ input: DescribeRiskConfigurationRequest) throws -> DescribeRiskConfigurationResponse {
    ...
    public func getUserPoolMfaConfig(_ input: GetUserPoolMfaConfigRequest) throws -> GetUserPoolMfaConfigResponse {
    ...
    public func listResourceServers(_ input: ListResourceServersRequest) throws -> ListResourceServersResponse {
    ...
    public func setRiskConfiguration(_ input: SetRiskConfigurationRequest) throws -> SetRiskConfigurationResponse {
    ...
    public func setUICustomization(_ input: SetUICustomizationRequest) throws -> SetUICustomizationResponse {
        return try client.send(operation: "SetUICustomization", path: "/", httpMethod: "POST", input: input)
    }

    ///  Set the user's multi-factor authentication (MFA) method preference.
    public func setUserMFAPreference(_ input: SetUserMFAPreferenceRequest) throws -> SetUserMFAPreferenceResponse {
        return try client.send(operation: "SetUserMFAPreference", path: "/", httpMethod: "POST", input: input)
    }

    ///  Set the user pool MFA configuration.
    public func setUserPoolMfaConfig(_ input: SetUserPoolMfaConfigRequest) throws -> SetUserPoolMfaConfigResponse {
    ...
    public func updateAuthEventFeedback(_ input: UpdateAuthEventFeedbackRequest) throws -> UpdateAuthEventFeedbackResponse {
    ...
    public func updateResourceServer(_ input: UpdateResourceServerRequest) throws -> UpdateResourceServerResponse {
