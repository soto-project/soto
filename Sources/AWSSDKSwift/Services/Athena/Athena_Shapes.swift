...
extension Athena {
    ...
    public struct QueryExecution: AWSShape {
        ...
        public init(resultConfiguration: ResultConfiguration? = nil, queryExecutionId: String? = nil, statistics: QueryExecutionStatistics? = nil, query: String? = nil, status: QueryExecutionStatus? = nil, queryExecutionContext: QueryExecutionContext? = nil) {
    ...
    public struct ColumnInfo: AWSShape {
        ...
        public init(precision: Int32? = nil, nullable: ColumnNullable? = nil, catalogName: String? = nil, type: String, scale: Int32? = nil, tableName: String? = nil, label: String? = nil, schemaName: String? = nil, caseSensitive: Bool? = nil, name: String) {
    ...
    public struct BatchGetQueryExecutionOutput: AWSShape {
        ...
        public init(unprocessedQueryExecutionIds: [UnprocessedQueryExecutionId]? = nil, queryExecutions: [QueryExecution]? = nil) {
    ...
    public struct NamedQuery: AWSShape {
        ...
        public init(name: String, queryString: String, database: String, namedQueryId: String? = nil, description: String? = nil) {
            self.name = name
    ...
    public struct CreateNamedQueryInput: AWSShape {
        ...
        public init(name: String, clientRequestToken: String? = nil, database: String, queryString: String, description: String? = nil) {
            self.name = name
            self.clientRequestToken = clientRequestToken
            self.database = database
            self.queryString = queryString
