...
public struct Shield {
    ...
    public func deleteSubscription(_ input: DeleteSubscriptionRequest) throws -> EventLoopFuture<DeleteSubscriptionResponse> {
    ...
    public func createSubscription(_ input: CreateSubscriptionRequest) throws -> EventLoopFuture<CreateSubscriptionResponse> {
        return try client.send(operation: "CreateSubscription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the details of a Protection object.
    public func describeProtection(_ input: DescribeProtectionRequest) throws -> EventLoopFuture<DescribeProtectionResponse> {
    ...
    public func disassociateDRTLogBucket(_ input: DisassociateDRTLogBucketRequest) throws -> EventLoopFuture<DisassociateDRTLogBucketResponse> {
    ...
    public func describeDRTAccess(_ input: DescribeDRTAccessRequest) throws -> EventLoopFuture<DescribeDRTAccessResponse> {
    ...
    public func disassociateDRTRole(_ input: DisassociateDRTRoleRequest) throws -> EventLoopFuture<DisassociateDRTRoleResponse> {
        return try client.send(operation: "DisassociateDRTRole", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all Protection objects for the account.
    public func listProtections(_ input: ListProtectionsRequest) throws -> EventLoopFuture<ListProtectionsResponse> {
        return try client.send(operation: "ListProtections", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the details of an existing subscription. Only enter values for parameters you want to change. Empty parameters are not updated.
    public func updateSubscription(_ input: UpdateSubscriptionRequest) throws -> EventLoopFuture<UpdateSubscriptionResponse> {
        return try client.send(operation: "UpdateSubscription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides details about the AWS Shield Advanced subscription for an account.
    public func describeSubscription(_ input: DescribeSubscriptionRequest) throws -> EventLoopFuture<DescribeSubscriptionResponse> {
        return try client.send(operation: "DescribeSubscription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the details of the list of email addresses that the DRT can use to contact you during a suspected attack.
    public func updateEmergencyContactSettings(_ input: UpdateEmergencyContactSettingsRequest) throws -> EventLoopFuture<UpdateEmergencyContactSettingsResponse> {
    ...
    public func createProtection(_ input: CreateProtectionRequest) throws -> EventLoopFuture<CreateProtectionResponse> {
        return try client.send(operation: "CreateProtection", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the details of a DDoS attack. 
    public func describeAttack(_ input: DescribeAttackRequest) throws -> EventLoopFuture<DescribeAttackResponse> {
    ...
    public func associateDRTRole(_ input: AssociateDRTRoleRequest) throws -> EventLoopFuture<AssociateDRTRoleResponse> {
    ...
    public func associateDRTLogBucket(_ input: AssociateDRTLogBucketRequest) throws -> EventLoopFuture<AssociateDRTLogBucketResponse> {
        return try client.send(operation: "AssociateDRTLogBucket", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the SubscriptionState, either Active or Inactive.
    public func getSubscriptionState(_ input: GetSubscriptionStateRequest) throws -> EventLoopFuture<GetSubscriptionStateResponse> {
        return try client.send(operation: "GetSubscriptionState", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an AWS Shield Advanced Protection.
    public func deleteProtection(_ input: DeleteProtectionRequest) throws -> EventLoopFuture<DeleteProtectionResponse> {
        return try client.send(operation: "DeleteProtection", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the email addresses that the DRT can use to contact you during a suspected attack.
    public func describeEmergencyContactSettings(_ input: DescribeEmergencyContactSettingsRequest) throws -> EventLoopFuture<DescribeEmergencyContactSettingsResponse> {
        return try client.send(operation: "DescribeEmergencyContactSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns all ongoing DDoS attacks or all DDoS attacks during a specified time period.
    public func listAttacks(_ input: ListAttacksRequest) throws -> EventLoopFuture<ListAttacksResponse> {
