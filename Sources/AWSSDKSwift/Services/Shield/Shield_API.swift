...
public struct Shield: AWSService {
    ...
    public func associateDRTLogBucket(_ input: AssociateDRTLogBucketRequest) -> EventLoopFuture<AssociateDRTLogBucketResponse> {
        return client.execute(operation: "AssociateDRTLogBucket", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func associateDRTRole(_ input: AssociateDRTRoleRequest) -> EventLoopFuture<AssociateDRTRoleResponse> {
        return client.execute(operation: "AssociateDRTRole", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func associateHealthCheck(_ input: AssociateHealthCheckRequest) -> EventLoopFuture<AssociateHealthCheckResponse> {
        return client.execute(operation: "AssociateHealthCheck", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func associateProactiveEngagementDetails(_ input: AssociateProactiveEngagementDetailsRequest) -> EventLoopFuture<AssociateProactiveEngagementDetailsResponse> {
        return client.execute(operation: "AssociateProactiveEngagementDetails", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createProtection(_ input: CreateProtectionRequest) -> EventLoopFuture<CreateProtectionResponse> {
        return client.execute(operation: "CreateProtection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createSubscription(_ input: CreateSubscriptionRequest) -> EventLoopFuture<CreateSubscriptionResponse> {
        return client.execute(operation: "CreateSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes an AWS Shield Advanced Protection.
    public func deleteProtection(_ input: DeleteProtectionRequest) -> EventLoopFuture<DeleteProtectionResponse> {
        return client.execute(operation: "DeleteProtection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteSubscription(_ input: DeleteSubscriptionRequest) -> EventLoopFuture<DeleteSubscriptionResponse> {
        return client.execute(operation: "DeleteSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes the details of a DDoS attack. 
    public func describeAttack(_ input: DescribeAttackRequest) -> EventLoopFuture<DescribeAttackResponse> {
        return client.execute(operation: "DescribeAttack", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDRTAccess(_ input: DescribeDRTAccessRequest) -> EventLoopFuture<DescribeDRTAccessResponse> {
        return client.execute(operation: "DescribeDRTAccess", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeEmergencyContactSettings(_ input: DescribeEmergencyContactSettingsRequest) -> EventLoopFuture<DescribeEmergencyContactSettingsResponse> {
        return client.execute(operation: "DescribeEmergencyContactSettings", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the details of a Protection object.
    public func describeProtection(_ input: DescribeProtectionRequest) -> EventLoopFuture<DescribeProtectionResponse> {
        return client.execute(operation: "DescribeProtection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeSubscription(_ input: DescribeSubscriptionRequest) -> EventLoopFuture<DescribeSubscriptionResponse> {
        return client.execute(operation: "DescribeSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disableProactiveEngagement(_ input: DisableProactiveEngagementRequest) -> EventLoopFuture<DisableProactiveEngagementResponse> {
        return client.execute(operation: "DisableProactiveEngagement", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disassociateDRTLogBucket(_ input: DisassociateDRTLogBucketRequest) -> EventLoopFuture<DisassociateDRTLogBucketResponse> {
        return client.execute(operation: "DisassociateDRTLogBucket", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disassociateDRTRole(_ input: DisassociateDRTRoleRequest) -> EventLoopFuture<DisassociateDRTRoleResponse> {
        return client.execute(operation: "DisassociateDRTRole", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disassociateHealthCheck(_ input: DisassociateHealthCheckRequest) -> EventLoopFuture<DisassociateHealthCheckResponse> {
        return client.execute(operation: "DisassociateHealthCheck", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func enableProactiveEngagement(_ input: EnableProactiveEngagementRequest) -> EventLoopFuture<EnableProactiveEngagementResponse> {
        return client.execute(operation: "EnableProactiveEngagement", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSubscriptionState(_ input: GetSubscriptionStateRequest) -> EventLoopFuture<GetSubscriptionStateResponse> {
        return client.execute(operation: "GetSubscriptionState", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns all ongoing DDoS attacks or all DDoS attacks during a specified time period.
    public func listAttacks(_ input: ListAttacksRequest) -> EventLoopFuture<ListAttacksResponse> {
        return client.execute(operation: "ListAttacks", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists all Protection objects for the account.
    public func listProtections(_ input: ListProtectionsRequest) -> EventLoopFuture<ListProtectionsResponse> {
        return client.execute(operation: "ListProtections", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateEmergencyContactSettings(_ input: UpdateEmergencyContactSettingsRequest) -> EventLoopFuture<UpdateEmergencyContactSettingsResponse> {
        return client.execute(operation: "UpdateEmergencyContactSettings", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateSubscription(_ input: UpdateSubscriptionRequest) -> EventLoopFuture<UpdateSubscriptionResponse> {
        return client.execute(operation: "UpdateSubscription", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
