...
extension Shield {
    ...
    public struct SubResourceSummary: AWSShape {
        ...
        public init(type: SubResourceType? = nil, id: String? = nil, counters: [SummarizedCounter]? = nil, attackVectors: [SummarizedAttackVector]? = nil) {
            self.`type` = `type`
            self.id = id
    ...
    public struct SummarizedCounter: AWSShape {
        ...
        public init(unit: String? = nil, sum: Double? = nil, max: Double? = nil, n: Int32? = nil, name: String? = nil, average: Double? = nil) {
            self.unit = unit
            self.sum = sum
            self.max = max
            self.n = n
    ...
    public struct Subscription: AWSShape {
        ...
        public init(endTime: TimeStamp? = nil, timeCommitmentInSeconds: Int64? = nil, limits: [Limit]? = nil, autoRenew: AutoRenew? = nil, startTime: TimeStamp? = nil) {
    ...
    public struct AttackSummary: AWSShape {
        ...
        public init(endTime: TimeStamp? = nil, startTime: TimeStamp? = nil, attackVectors: [AttackVectorDescription]? = nil, attackId: String? = nil, resourceArn: String? = nil) {
            self.endTime = endTime
            self.startTime = startTime
            self.attackVectors = attackVectors
            self.attackId = attackId
    ...
    public struct AttackDetail: AWSShape {
        ...
        public init(attackId: String? = nil, resourceArn: String? = nil, mitigations: [Mitigation]? = nil, attackProperties: [AttackProperty]? = nil, attackCounters: [SummarizedCounter]? = nil, subResources: [SubResourceSummary]? = nil, endTime: TimeStamp? = nil, startTime: TimeStamp? = nil) {
            self.attackId = attackId
            self.resourceArn = resourceArn
    ...
    public struct ListAttacksRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: Int32? = nil, startTime: TimeRange? = nil, resourceArns: [String]? = nil, endTime: TimeRange? = nil) {
            self.nextToken = nextToken
            self.maxResults = maxResults
            self.startTime = startTime
    ...
    public struct AttackProperty: AWSShape {
        ...
        public init(topContributors: [Contributor]? = nil, attackPropertyIdentifier: AttackPropertyIdentifier? = nil, attackLayer: AttackLayer? = nil, total: Int64? = nil, unit: Unit? = nil) {
