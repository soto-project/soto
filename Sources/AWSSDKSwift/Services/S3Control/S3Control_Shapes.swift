...
extension S3Control {
    ...
    public struct CreateAccessPointResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "AccessPointArn", required: false, type: .string)
        ]
    ...
    public struct CreateBucketRequest: AWSShape {
        ...
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "Bucket", location: .uri(locationName: "name"), required: true, type: .string), 
            ...
            AWSShapeMember(label: "OutpostId", location: .header(locationName: "x-amz-outpost-id"), required: false, type: .string)
        ]
        ...
        public func validate(name: String) throws {
            try validate(self.bucket, name:"bucket", parent: name, max: 255)
            try validate(self.bucket, name:"bucket", parent: name, min: 3)
            try validate(self.outpostId, name:"outpostId", parent: name, max: 64)
        ...
        private enum CodingKeys: String, CodingKey {
            ...
            case outpostId = "x-amz-outpost-id"
        }
    }

    public struct CreateBucketResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
    ...
    public struct DeleteBucketLifecycleConfigurationRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "AccountId", location: .header(locationName: "x-amz-account-id"), required: true, type: .string), 
            AWSShapeMember(label: "Bucket", location: .uri(locationName: "name"), required: true, type: .string)
        ]
    ...
    public struct GetBucketLifecycleConfigurationResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Rules", required: false, type: .list, encoding: .list(member:"Rule"))
        ]
    ...
    public struct GetBucketPolicyResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Policy", required: false, type: .string)
        ]
    ...
    public struct GetBucketRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "AccountId", location: .header(locationName: "x-amz-account-id"), required: true, type: .string), 
            AWSShapeMember(label: "Bucket", location: .uri(locationName: "name"), required: true, type: .string)
        ]
    ...
    public struct GetBucketResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Bucket", required: false, type: .string), 
            AWSShapeMember(label: "CreationDate", required: false, type: .timestamp), 
            AWSShapeMember(label: "PublicAccessBlockEnabled", required: false, type: .boolean)
        ]
        ...
        public init(bucket: String? = nil, creationDate: TimeStamp? = nil, publicAccessBlockEnabled: Bool? = nil) {
            self.bucket = bucket
            self.creationDate = creationDate
    ...
    public struct GetBucketTaggingResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "TagSet", required: true, type: .list, encoding: .list(member:"member"))
        ]
    ...
    public struct JobOperation: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "S3PutObjectLegalHold", required: false, type: .structure), 
            AWSShapeMember(label: "S3PutObjectRetention", required: false, type: .structure), 
    ...
    public struct LifecycleRule: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "NoncurrentVersionTransitions", required: false, type: .list, encoding: .list(member:"NoncurrentVersionTransition")), 
            AWSShapeMember(label: "Status", required: true, type: .enum), 
            AWSShapeMember(label: "Transitions", required: false, type: .list, encoding: .list(member:"Transition"))
        ]
    ...
    public struct ListRegionalBucketsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "AccountId", location: .header(locationName: "x-amz-account-id"), required: true, type: .string), 
            AWSShapeMember(label: "MaxResults", location: .querystring(locationName: "maxResults"), required: false, type: .integer), 
            AWSShapeMember(label: "NextToken", location: .querystring(locationName: "nextToken"), required: false, type: .string), 
    ...
    public struct ListRegionalBucketsResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "NextToken", required: false, type: .string), 
            AWSShapeMember(label: "RegionalBucketList", required: false, type: .list, encoding: .list(member:"RegionalBucket"))
        ]
    ...
    public struct RegionalBucket: AWSShape {
        ...
        public init(bucket: String, bucketArn: String? = nil, creationDate: TimeStamp, outpostId: String? = nil, publicAccessBlockEnabled: Bool) {
            self.bucket = bucket
            self.bucketArn = bucketArn
            self.creationDate = creationDate
            self.outpostId = outpostId
    ...
    public struct S3SetObjectLegalHoldOperation: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "LegalHold", required: true, type: .structure)
        ]
    ...
    public struct S3SetObjectRetentionOperation: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "Retention", required: true, type: .structure)
        ]
