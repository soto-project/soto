...
public struct S3Control {
    ...
    @discardableResult public func createAccessPoint(_ input: CreateAccessPointRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateAccessPoint", path: "/v20180820/accesspoint/{name}", httpMethod: "PUT", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createJob(_ input: CreateJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateJobResult> {
        return client.execute(operation: "CreateJob", path: "/v20180820/jobs", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteAccessPoint(_ input: DeleteAccessPointRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAccessPoint", path: "/v20180820/accesspoint/{name}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteAccessPointPolicy(_ input: DeleteAccessPointPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAccessPointPolicy", path: "/v20180820/accesspoint/{name}/policy", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteJobTagging(_ input: DeleteJobTaggingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteJobTaggingResult> {
        return client.execute(operation: "DeleteJobTagging", path: "/v20180820/jobs/{id}/tagging", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deletePublicAccessBlock(_ input: DeletePublicAccessBlockRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeletePublicAccessBlock", path: "/v20180820/configuration/publicAccessBlock", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeJob(_ input: DescribeJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeJobResult> {
        return client.execute(operation: "DescribeJob", path: "/v20180820/jobs/{id}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getAccessPoint(_ input: GetAccessPointRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAccessPointResult> {
        return client.execute(operation: "GetAccessPoint", path: "/v20180820/accesspoint/{name}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getAccessPointPolicy(_ input: GetAccessPointPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAccessPointPolicyResult> {
        return client.execute(operation: "GetAccessPointPolicy", path: "/v20180820/accesspoint/{name}/policy", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getAccessPointPolicyStatus(_ input: GetAccessPointPolicyStatusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAccessPointPolicyStatusResult> {
        return client.execute(operation: "GetAccessPointPolicyStatus", path: "/v20180820/accesspoint/{name}/policyStatus", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getJobTagging(_ input: GetJobTaggingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetJobTaggingResult> {
        return client.execute(operation: "GetJobTagging", path: "/v20180820/jobs/{id}/tagging", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getPublicAccessBlock(_ input: GetPublicAccessBlockRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPublicAccessBlockOutput> {
        return client.execute(operation: "GetPublicAccessBlock", path: "/v20180820/configuration/publicAccessBlock", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listAccessPoints(_ input: ListAccessPointsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAccessPointsResult> {
        return client.execute(operation: "ListAccessPoints", path: "/v20180820/accesspoint", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listJobs(_ input: ListJobsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJobsResult> {
        return client.execute(operation: "ListJobs", path: "/v20180820/jobs", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putAccessPointPolicy(_ input: PutAccessPointPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutAccessPointPolicy", path: "/v20180820/accesspoint/{name}/policy", httpMethod: "PUT", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putJobTagging(_ input: PutJobTaggingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutJobTaggingResult> {
        return client.execute(operation: "PutJobTagging", path: "/v20180820/jobs/{id}/tagging", httpMethod: "PUT", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putPublicAccessBlock(_ input: PutPublicAccessBlockRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutPublicAccessBlock", path: "/v20180820/configuration/publicAccessBlock", httpMethod: "PUT", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateJobPriority(_ input: UpdateJobPriorityRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateJobPriorityResult> {
        return client.execute(operation: "UpdateJobPriority", path: "/v20180820/jobs/{id}/priority", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateJobStatus(_ input: UpdateJobStatusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateJobStatusResult> {
        return client.execute(operation: "UpdateJobStatus", path: "/v20180820/jobs/{id}/status", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
