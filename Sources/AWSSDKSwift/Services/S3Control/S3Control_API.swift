...
public struct S3Control: AWSService {
    ...
    @discardableResult public func createAccessPoint(_ input: CreateAccessPointRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateAccessPoint", path: "/v20180820/accesspoint/{name}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func createJob(_ input: CreateJobRequest) -> EventLoopFuture<CreateJobResult> {
        return client.execute(operation: "CreateJob", path: "/v20180820/jobs", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Deletes the specified access point.
    @discardableResult public func deleteAccessPoint(_ input: DeleteAccessPointRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAccessPoint", path: "/v20180820/accesspoint/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteAccessPointPolicy(_ input: DeleteAccessPointPolicyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAccessPointPolicy", path: "/v20180820/accesspoint/{name}/policy", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteJobTagging(_ input: DeleteJobTaggingRequest) -> EventLoopFuture<DeleteJobTaggingResult> {
        return client.execute(operation: "DeleteJobTagging", path: "/v20180820/jobs/{id}/tagging", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deletePublicAccessBlock(_ input: DeletePublicAccessBlockRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeletePublicAccessBlock", path: "/v20180820/configuration/publicAccessBlock", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeJob(_ input: DescribeJobRequest) -> EventLoopFuture<DescribeJobResult> {
        return client.execute(operation: "DescribeJob", path: "/v20180820/jobs/{id}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Returns configuration information about the specified access point.
    public func getAccessPoint(_ input: GetAccessPointRequest) -> EventLoopFuture<GetAccessPointResult> {
        return client.execute(operation: "GetAccessPoint", path: "/v20180820/accesspoint/{name}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getAccessPointPolicy(_ input: GetAccessPointPolicyRequest) -> EventLoopFuture<GetAccessPointPolicyResult> {
        return client.execute(operation: "GetAccessPointPolicy", path: "/v20180820/accesspoint/{name}/policy", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getAccessPointPolicyStatus(_ input: GetAccessPointPolicyStatusRequest) -> EventLoopFuture<GetAccessPointPolicyStatusResult> {
        return client.execute(operation: "GetAccessPointPolicyStatus", path: "/v20180820/accesspoint/{name}/policyStatus", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getJobTagging(_ input: GetJobTaggingRequest) -> EventLoopFuture<GetJobTaggingResult> {
        return client.execute(operation: "GetJobTagging", path: "/v20180820/jobs/{id}/tagging", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getPublicAccessBlock(_ input: GetPublicAccessBlockRequest) -> EventLoopFuture<GetPublicAccessBlockOutput> {
        return client.execute(operation: "GetPublicAccessBlock", path: "/v20180820/configuration/publicAccessBlock", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAccessPoints(_ input: ListAccessPointsRequest) -> EventLoopFuture<ListAccessPointsResult> {
        return client.execute(operation: "ListAccessPoints", path: "/v20180820/accesspoint", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listJobs(_ input: ListJobsRequest) -> EventLoopFuture<ListJobsResult> {
        return client.execute(operation: "ListJobs", path: "/v20180820/jobs", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putAccessPointPolicy(_ input: PutAccessPointPolicyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutAccessPointPolicy", path: "/v20180820/accesspoint/{name}/policy", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putJobTagging(_ input: PutJobTaggingRequest) -> EventLoopFuture<PutJobTaggingResult> {
        return client.execute(operation: "PutJobTagging", path: "/v20180820/jobs/{id}/tagging", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putPublicAccessBlock(_ input: PutPublicAccessBlockRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutPublicAccessBlock", path: "/v20180820/configuration/publicAccessBlock", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateJobPriority(_ input: UpdateJobPriorityRequest) -> EventLoopFuture<UpdateJobPriorityResult> {
        return client.execute(operation: "UpdateJobPriority", path: "/v20180820/jobs/{id}/priority", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateJobStatus(_ input: UpdateJobStatusRequest) -> EventLoopFuture<UpdateJobStatusResult> {
        return client.execute(operation: "UpdateJobStatus", path: "/v20180820/jobs/{id}/status", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
