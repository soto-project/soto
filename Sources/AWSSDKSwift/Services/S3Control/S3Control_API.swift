...
public struct S3Control {
    ...
    public func createAccessPoint(_ input: CreateAccessPointRequest) -> EventLoopFuture<CreateAccessPointResult> {
    ...
    public func createBucket(_ input: CreateBucketRequest) -> EventLoopFuture<CreateBucketResult> {
        return client.send(operation: "CreateBucket", path: "/v20180820/bucket/{name}", httpMethod: "PUT", input: input)
    }
    ...
    @discardableResult public func deleteBucket(_ input: DeleteBucketRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBucket", path: "/v20180820/bucket/{name}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteBucketLifecycleConfiguration(_ input: DeleteBucketLifecycleConfigurationRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBucketLifecycleConfiguration", path: "/v20180820/bucket/{name}/lifecycleconfiguration", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteBucketPolicy(_ input: DeleteBucketPolicyRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBucketPolicy", path: "/v20180820/bucket/{name}/policy", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteBucketTagging(_ input: DeleteBucketTaggingRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBucketTagging", path: "/v20180820/bucket/{name}/tagging", httpMethod: "DELETE", input: input)
    }
    ...
    public func getBucket(_ input: GetBucketRequest) -> EventLoopFuture<GetBucketResult> {
        return client.send(operation: "GetBucket", path: "/v20180820/bucket/{name}", httpMethod: "GET", input: input)
    }
    ...
    public func getBucketLifecycleConfiguration(_ input: GetBucketLifecycleConfigurationRequest) -> EventLoopFuture<GetBucketLifecycleConfigurationResult> {
        return client.send(operation: "GetBucketLifecycleConfiguration", path: "/v20180820/bucket/{name}/lifecycleconfiguration", httpMethod: "GET", input: input)
    }
    ...
    public func getBucketPolicy(_ input: GetBucketPolicyRequest) -> EventLoopFuture<GetBucketPolicyResult> {
        return client.send(operation: "GetBucketPolicy", path: "/v20180820/bucket/{name}/policy", httpMethod: "GET", input: input)
    }
    ...
    public func getBucketTagging(_ input: GetBucketTaggingRequest) -> EventLoopFuture<GetBucketTaggingResult> {
        return client.send(operation: "GetBucketTagging", path: "/v20180820/bucket/{name}/tagging", httpMethod: "GET", input: input)
    }
    ...
    public func listRegionalBuckets(_ input: ListRegionalBucketsRequest) -> EventLoopFuture<ListRegionalBucketsResult> {
        return client.send(operation: "ListRegionalBuckets", path: "/v20180820/bucket", httpMethod: "GET", input: input)
    }
    ...
    @discardableResult public func putBucketLifecycleConfiguration(_ input: PutBucketLifecycleConfigurationRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "PutBucketLifecycleConfiguration", path: "/v20180820/bucket/{name}/lifecycleconfiguration", httpMethod: "PUT", input: input)
    }
    ...
    @discardableResult public func putBucketPolicy(_ input: PutBucketPolicyRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "PutBucketPolicy", path: "/v20180820/bucket/{name}/policy", httpMethod: "PUT", input: input)
    }
    ...
    @discardableResult public func putBucketTagging(_ input: PutBucketTaggingRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "PutBucketTagging", path: "/v20180820/bucket/{name}/tagging", httpMethod: "PUT", input: input)
    }
