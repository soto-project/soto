...
extension DeviceFarm {
    ...
    public struct CreateDevicePoolRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.projectArn, name:"projectArn", parent: name, pattern: "^arn:.+")
        }
    ...
    public struct CreateRemoteAccessSessionRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.deviceArn, name:"deviceArn", parent: name, pattern: "^arn:.+")
            ...
            try validate(self.instanceArn, name:"instanceArn", parent: name, pattern: "^arn:.+")
            try validate(self.name, name:"name", parent: name, max: 256)
            try validate(self.name, name:"name", parent: name, min: 0)
            try validate(self.projectArn, name:"projectArn", parent: name, max: 1011)
            try validate(self.projectArn, name:"projectArn", parent: name, min: 32)
            ...
            try validate(self.remoteRecordAppArn, name:"remoteRecordAppArn", parent: name, pattern: "^arn:.+")
    ...
    public struct CreateTestGridProjectResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "testGridProject", required: false, type: .structure)
        ]
    ...
    public struct CreateTestGridUrlRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "expiresInSeconds", required: true, type: .integer), 
            AWSShapeMember(label: "projectArn", required: true, type: .string)
        ]
        ...
        public func validate(name: String) throws {
            try validate(self.expiresInSeconds, name:"expiresInSeconds", parent: name, max: 86400)
            try validate(self.expiresInSeconds, name:"expiresInSeconds", parent: name, min: 60)
            try validate(self.projectArn, name:"projectArn", parent: name, max: 1011)
            try validate(self.projectArn, name:"projectArn", parent: name, min: 32)
            try validate(self.projectArn, name:"projectArn", parent: name, pattern: "^arn:aws:devicefarm:.+")
        }
    ...
    public struct GetDevicePoolCompatibilityRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.appArn, name:"appArn", parent: name, pattern: "^arn:.+")
            try self.configuration?.validate(name: "\(name).configuration")
            ...
            try validate(self.devicePoolArn, name:"devicePoolArn", parent: name, pattern: "^arn:.+")
    ...
    public struct GetTestGridSessionRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "sessionArn", required: false, type: .string), 
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.projectArn, name:"projectArn", parent: name, min: 32)
            try validate(self.projectArn, name:"projectArn", parent: name, pattern: "^arn:aws:devicefarm:.+")
            try validate(self.sessionArn, name:"sessionArn", parent: name, max: 1011)
            try validate(self.sessionArn, name:"sessionArn", parent: name, min: 32)
            try validate(self.sessionArn, name:"sessionArn", parent: name, pattern: "^arn:aws:devicefarm:.+")
            try validate(self.sessionId, name:"sessionId", parent: name, max: 128)
            try validate(self.sessionId, name:"sessionId", parent: name, min: 1)
            try validate(self.sessionId, name:"sessionId", parent: name, pattern: ".*\\S.*")
        }
    ...
    public struct GetTestGridSessionResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "testGridSession", required: false, type: .structure)
        ]
    ...
    public struct InstallToRemoteAccessSessionRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.remoteAccessSessionArn, name:"remoteAccessSessionArn", parent: name, pattern: "^arn:.+")
        }
    ...
    public struct ListTagsForResourceRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.resourceARN, name:"resourceARN", parent: name, pattern: "^arn:aws:devicefarm:.+")
        }
    ...
    public struct ListTestGridProjectsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "maxResult", required: false, type: .integer), 
            AWSShapeMember(label: "nextToken", required: false, type: .string)
        ]
        ...
        public func validate(name: String) throws {
            try validate(self.maxResult, name:"maxResult", parent: name, max: 1000)
            try validate(self.maxResult, name:"maxResult", parent: name, min: 1)
            try validate(self.nextToken, name:"nextToken", parent: name, max: 1024)
            try validate(self.nextToken, name:"nextToken", parent: name, min: 4)
        }
    ...
    public struct ListTestGridProjectsResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "nextToken", required: false, type: .string), 
            AWSShapeMember(label: "testGridProjects", required: false, type: .list)
        ]
    ...
    public struct ListTestGridSessionActionsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "maxResult", required: false, type: .integer), 
            AWSShapeMember(label: "nextToken", required: false, type: .string), 
            AWSShapeMember(label: "sessionArn", required: true, type: .string)
        ]
    ...
    public struct ListTestGridSessionsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "endTimeAfter", required: false, type: .timestamp), 
            AWSShapeMember(label: "endTimeBefore", required: false, type: .timestamp), 
            AWSShapeMember(label: "maxResult", required: false, type: .integer), 
            AWSShapeMember(label: "nextToken", required: false, type: .string), 
            AWSShapeMember(label: "projectArn", required: true, type: .string), 
            AWSShapeMember(label: "status", required: false, type: .enum)
    ...
    public struct ListTestGridSessionsResult: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "nextToken", required: false, type: .string), 
            AWSShapeMember(label: "testGridSessions", required: false, type: .list)
        ]
    ...
    public struct ScheduleRunConfiguration: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.extraDataPackageArn, name:"extraDataPackageArn", parent: name, pattern: "^arn:.+")
            ...
            try validate(self.networkProfileArn, name:"networkProfileArn", parent: name, pattern: "^arn:.+")
            try self.vpceConfigurationArns?.forEach {
                try validate($0, name: "vpceConfigurationArns[]", parent: name, max: 1011)
                try validate($0, name: "vpceConfigurationArns[]", parent: name, min: 32)
                try validate($0, name: "vpceConfigurationArns[]", parent: name, pattern: "^arn:.+")
    ...
    public struct ScheduleRunTest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.testPackageArn, name:"testPackageArn", parent: name, pattern: "^arn:.+")
            ...
            try validate(self.testSpecArn, name:"testSpecArn", parent: name, pattern: "^arn:.+")
        }
    ...
    public struct TestGridSession: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "arn", required: false, type: .string), 
            AWSShapeMember(label: "billingMinutes", required: false, type: .double), 
            AWSShapeMember(label: "created", required: false, type: .timestamp), 
            AWSShapeMember(label: "ended", required: false, type: .timestamp), 
            AWSShapeMember(label: "seleniumProperties", required: false, type: .string), 
            AWSShapeMember(label: "status", required: false, type: .enum)
        ]
    ...
    public struct TestGridSessionAction: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "requestMethod", required: false, type: .string), 
            AWSShapeMember(label: "started", required: false, type: .timestamp), 
    ...
    public struct UpdateDeviceInstanceRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.profileArn, name:"profileArn", parent: name, pattern: "^arn:.+")
        }
