...
extension Iot1clickDevices {
    ...
    public struct InvokeDeviceMethodRequest: AWSShape {
        ...
        public init(deviceMethod: DeviceMethod? = nil, deviceId: String, deviceMethodParameters: String? = nil) {
    ...
    public struct ListDeviceEventsRequest: AWSShape {
        ...
        public init(toTimeStamp: TimeStamp, deviceId: String, nextToken: String? = nil, fromTimeStamp: TimeStamp, maxResults: Int32? = nil) {
    ...
    public struct DeviceDescription: AWSShape {
        ...
        public init(remainingLife: Double? = nil, attributes: [String: String]? = nil, deviceId: String? = nil, type: String? = nil, enabled: Bool? = nil) {
