...
public struct MediaConvert {
    ...
    public func deleteJobTemplate(_ input: DeleteJobTemplateRequest) throws -> EventLoopFuture<DeleteJobTemplateResponse> {
    ...
    public func listPresets(_ input: ListPresetsRequest) throws -> EventLoopFuture<ListPresetsResponse> {
        return try client.send(operation: "ListPresets", path: "/2017-08-29/presets", httpMethod: "GET", input: input)
    }

    ///  Associates an AWS Certificate Manager (ACM) Amazon Resource Name (ARN) with AWS Elemental MediaConvert.
    public func associateCertificate(_ input: AssociateCertificateRequest) throws -> EventLoopFuture<AssociateCertificateResponse> {
        return try client.send(operation: "AssociateCertificate", path: "/2017-08-29/certificates", httpMethod: "POST", input: input)
    }

    ///  Retrieve the JSON for a specific queue.
    public func getQueue(_ input: GetQueueRequest) throws -> EventLoopFuture<GetQueueResponse> {
    ...
    public func getJobTemplate(_ input: GetJobTemplateRequest) throws -> EventLoopFuture<GetJobTemplateResponse> {
    ...
    public func disassociateCertificate(_ input: DisassociateCertificateRequest) throws -> EventLoopFuture<DisassociateCertificateResponse> {
    ...
    public func deletePreset(_ input: DeletePresetRequest) throws -> EventLoopFuture<DeletePresetResponse> {
        return try client.send(operation: "DeletePreset", path: "/2017-08-29/presets/{name}", httpMethod: "DELETE", input: input)
    }

    ///  Modify one of your existing presets.
    public func updatePreset(_ input: UpdatePresetRequest) throws -> EventLoopFuture<UpdatePresetResponse> {
        return try client.send(operation: "UpdatePreset", path: "/2017-08-29/presets/{name}", httpMethod: "PUT", input: input)
    }

    ///  Modify one of your existing queues.
    public func updateQueue(_ input: UpdateQueueRequest) throws -> EventLoopFuture<UpdateQueueResponse> {
        return try client.send(operation: "UpdateQueue", path: "/2017-08-29/queues/{name}", httpMethod: "PUT", input: input)
    }

    ///  Permanently delete a queue you have created.
    public func deleteQueue(_ input: DeleteQueueRequest) throws -> EventLoopFuture<DeleteQueueResponse> {
    ...
    public func updateJobTemplate(_ input: UpdateJobTemplateRequest) throws -> EventLoopFuture<UpdateJobTemplateResponse> {
    ...
    public func listQueues(_ input: ListQueuesRequest) throws -> EventLoopFuture<ListQueuesResponse> {
    ...
    public func createPreset(_ input: CreatePresetRequest) throws -> EventLoopFuture<CreatePresetResponse> {
    ...
    public func listJobTemplates(_ input: ListJobTemplatesRequest) throws -> EventLoopFuture<ListJobTemplatesResponse> {
    ...
    public func createJobTemplate(_ input: CreateJobTemplateRequest) throws -> EventLoopFuture<CreateJobTemplateResponse> {
    ...
    public func createQueue(_ input: CreateQueueRequest) throws -> EventLoopFuture<CreateQueueResponse> {
        return try client.send(operation: "CreateQueue", path: "/2017-08-29/queues", httpMethod: "POST", input: input)
    }

    ///  Retrieve the JSON for a specific preset.
    public func getPreset(_ input: GetPresetRequest) throws -> EventLoopFuture<GetPresetResponse> {
        return try client.send(operation: "GetPreset", path: "/2017-08-29/presets/{name}", httpMethod: "GET", input: input)
    }

    ///  Send an request with an empty body to the regional API endpoint to get your account API endpoint.
    public func describeEndpoints(_ input: DescribeEndpointsRequest) throws -> EventLoopFuture<DescribeEndpointsResponse> {
