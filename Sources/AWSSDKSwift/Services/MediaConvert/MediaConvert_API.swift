...
public struct MediaConvert {
    ...
    public func getPreset(_ input: GetPresetRequest) throws -> GetPresetResponse {
    ...
    public func listQueues(_ input: ListQueuesRequest) throws -> ListQueuesResponse {
    ...
    public func disassociateCertificate(_ input: DisassociateCertificateRequest) throws -> DisassociateCertificateResponse {
    ...
    public func listJobTemplates(_ input: ListJobTemplatesRequest) throws -> ListJobTemplatesResponse {
    ...
    public func describeEndpoints(_ input: DescribeEndpointsRequest) throws -> DescribeEndpointsResponse {
        return try client.send(operation: "DescribeEndpoints", path: "/2017-08-29/endpoints", httpMethod: "POST", input: input)
    }

    ///  Permanently delete a queue you have created.
    public func deleteQueue(_ input: DeleteQueueRequest) throws -> DeleteQueueResponse {
    ...
    public func updateJobTemplate(_ input: UpdateJobTemplateRequest) throws -> UpdateJobTemplateResponse {
    ...
    public func updatePreset(_ input: UpdatePresetRequest) throws -> UpdatePresetResponse {
    ...
    public func deleteJobTemplate(_ input: DeleteJobTemplateRequest) throws -> DeleteJobTemplateResponse {
    ...
    public func createJobTemplate(_ input: CreateJobTemplateRequest) throws -> CreateJobTemplateResponse {
    ...
    public func associateCertificate(_ input: AssociateCertificateRequest) throws -> AssociateCertificateResponse {
