...
public struct MobileAnalytics {
    ...
    @discardableResult public func putEvents(_ input: PutEventsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
