...
public struct MarketplaceMetering: AWSService {
    ...
    public func batchMeterUsage(_ input: BatchMeterUsageRequest) -> EventLoopFuture<BatchMeterUsageResult> {
        return client.execute(operation: "BatchMeterUsage", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func meterUsage(_ input: MeterUsageRequest) -> EventLoopFuture<MeterUsageResult> {
        return client.execute(operation: "MeterUsage", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerUsage(_ input: RegisterUsageRequest) -> EventLoopFuture<RegisterUsageResult> {
        return client.execute(operation: "RegisterUsage", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func resolveCustomer(_ input: ResolveCustomerRequest) -> EventLoopFuture<ResolveCustomerResult> {
        return client.execute(operation: "ResolveCustomer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
