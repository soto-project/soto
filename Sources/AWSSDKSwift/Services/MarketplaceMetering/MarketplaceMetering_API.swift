...
public struct MarketplaceMetering {
    ...
    public func resolveCustomer(_ input: ResolveCustomerRequest) throws -> EventLoopFuture<ResolveCustomerResult> {
    ...
    public func meterUsage(_ input: MeterUsageRequest) throws -> EventLoopFuture<MeterUsageResult> {
    ...
    public func batchMeterUsage(_ input: BatchMeterUsageRequest) throws -> EventLoopFuture<BatchMeterUsageResult> {
    ...
    public func registerUsage(_ input: RegisterUsageRequest) throws -> EventLoopFuture<RegisterUsageResult> {
