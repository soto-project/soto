...
extension KinesisVideo {
    ...
    public struct CreateStreamInput: AWSShape {
        ...
        public init(deviceName: String? = nil, mediaType: String? = nil, dataRetentionInHours: Int32? = nil, kmsKeyId: String? = nil, streamName: String) {
    ...
    public struct UpdateStreamInput: AWSShape {
        ...
        public init(deviceName: String? = nil, mediaType: String? = nil, currentVersion: String, streamARN: String? = nil, streamName: String? = nil) {
            self.deviceName = deviceName
            self.mediaType = mediaType
            self.currentVersion = currentVersion
            self.streamARN = streamARN
    ...
    public struct GetDataEndpointInput: AWSShape {
        ...
        public init(streamName: String? = nil, aPIName: APIName, streamARN: String? = nil) {
            self.streamName = streamName
    ...
    public struct ListStreamsInput: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: Int32? = nil, streamNameCondition: StreamNameCondition? = nil) {
            self.nextToken = nextToken
    ...
    public struct StreamInfo: AWSShape {
        ...
        public init(mediaType: String? = nil, streamName: String? = nil, deviceName: String? = nil, status: Status? = nil, streamARN: String? = nil, kmsKeyId: String? = nil, dataRetentionInHours: Int32? = nil, creationTime: TimeStamp? = nil, version: String? = nil) {
            self.mediaType = mediaType
            self.streamName = streamName
            self.deviceName = deviceName
            self.status = status
    ...
    public struct UpdateDataRetentionInput: AWSShape {
        ...
        public init(dataRetentionChangeInHours: Int32, operation: UpdateDataRetentionOperation, currentVersion: String, streamARN: String? = nil, streamName: String? = nil) {
