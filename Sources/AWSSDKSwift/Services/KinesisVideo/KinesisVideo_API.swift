...
public struct KinesisVideo: AWSService {
    ...
    public func createSignalingChannel(_ input: CreateSignalingChannelInput) -> EventLoopFuture<CreateSignalingChannelOutput> {
        return client.execute(operation: "CreateSignalingChannel", path: "/createSignalingChannel", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createStream(_ input: CreateStreamInput) -> EventLoopFuture<CreateStreamOutput> {
        return client.execute(operation: "CreateStream", path: "/createStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteSignalingChannel(_ input: DeleteSignalingChannelInput) -> EventLoopFuture<DeleteSignalingChannelOutput> {
        return client.execute(operation: "DeleteSignalingChannel", path: "/deleteSignalingChannel", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteStream(_ input: DeleteStreamInput) -> EventLoopFuture<DeleteStreamOutput> {
        return client.execute(operation: "DeleteStream", path: "/deleteStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeSignalingChannel(_ input: DescribeSignalingChannelInput) -> EventLoopFuture<DescribeSignalingChannelOutput> {
        return client.execute(operation: "DescribeSignalingChannel", path: "/describeSignalingChannel", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the most current information about the specified stream. You must specify either the StreamName or the StreamARN. 
    public func describeStream(_ input: DescribeStreamInput) -> EventLoopFuture<DescribeStreamOutput> {
        return client.execute(operation: "DescribeStream", path: "/describeStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDataEndpoint(_ input: GetDataEndpointInput) -> EventLoopFuture<GetDataEndpointOutput> {
        return client.execute(operation: "GetDataEndpoint", path: "/getDataEndpoint", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSignalingChannelEndpoint(_ input: GetSignalingChannelEndpointInput) -> EventLoopFuture<GetSignalingChannelEndpointOutput> {
        return client.execute(operation: "GetSignalingChannelEndpoint", path: "/getSignalingChannelEndpoint", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listSignalingChannels(_ input: ListSignalingChannelsInput) -> EventLoopFuture<ListSignalingChannelsOutput> {
        return client.execute(operation: "ListSignalingChannels", path: "/listSignalingChannels", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTagsForStream(_ input: ListTagsForStreamInput) -> EventLoopFuture<ListTagsForStreamOutput> {
        return client.execute(operation: "ListTagsForStream", path: "/listTagsForStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func tagStream(_ input: TagStreamInput) -> EventLoopFuture<TagStreamOutput> {
        return client.execute(operation: "TagStream", path: "/tagStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func untagStream(_ input: UntagStreamInput) -> EventLoopFuture<UntagStreamOutput> {
        return client.execute(operation: "UntagStream", path: "/untagStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateDataRetention(_ input: UpdateDataRetentionInput) -> EventLoopFuture<UpdateDataRetentionOutput> {
        return client.execute(operation: "UpdateDataRetention", path: "/updateDataRetention", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateSignalingChannel(_ input: UpdateSignalingChannelInput) -> EventLoopFuture<UpdateSignalingChannelOutput> {
        return client.execute(operation: "UpdateSignalingChannel", path: "/updateSignalingChannel", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateStream(_ input: UpdateStreamInput) -> EventLoopFuture<UpdateStreamOutput> {
        return client.execute(operation: "UpdateStream", path: "/updateStream", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
