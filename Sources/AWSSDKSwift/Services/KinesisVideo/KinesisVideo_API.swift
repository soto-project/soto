...
public struct KinesisVideo {
    ...
    public func listStreams(_ input: ListStreamsInput) throws -> EventLoopFuture<ListStreamsOutput> {
    ...
    public func updateStream(_ input: UpdateStreamInput) throws -> EventLoopFuture<UpdateStreamOutput> {
    ...
    public func tagStream(_ input: TagStreamInput) throws -> EventLoopFuture<TagStreamOutput> {
        return try client.send(operation: "TagStream", path: "/tagStream", httpMethod: "POST", input: input)
    }

    ///  Returns the most current information about the specified stream. You must specify either the StreamName or the StreamARN. 
    public func describeStream(_ input: DescribeStreamInput) throws -> EventLoopFuture<DescribeStreamOutput> {
    ...
    public func updateDataRetention(_ input: UpdateDataRetentionInput) throws -> EventLoopFuture<UpdateDataRetentionOutput> {
    ...
    public func deleteStream(_ input: DeleteStreamInput) throws -> EventLoopFuture<DeleteStreamOutput> {
    ...
    public func createStream(_ input: CreateStreamInput) throws -> EventLoopFuture<CreateStreamOutput> {
    ...
    public func listTagsForStream(_ input: ListTagsForStreamInput) throws -> EventLoopFuture<ListTagsForStreamOutput> {
    ...
    public func untagStream(_ input: UntagStreamInput) throws -> EventLoopFuture<UntagStreamOutput> {
    ...
    public func getDataEndpoint(_ input: GetDataEndpointInput) throws -> EventLoopFuture<GetDataEndpointOutput> {
