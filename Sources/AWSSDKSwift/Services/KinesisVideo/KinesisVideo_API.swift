...
public struct KinesisVideo {
    ...
    public func createSignalingChannel(_ input: CreateSignalingChannelInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateSignalingChannelOutput> {
        return client.execute(operation: "CreateSignalingChannel", path: "/createSignalingChannel", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createStream(_ input: CreateStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateStreamOutput> {
        return client.execute(operation: "CreateStream", path: "/createStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteSignalingChannel(_ input: DeleteSignalingChannelInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteSignalingChannelOutput> {
        return client.execute(operation: "DeleteSignalingChannel", path: "/deleteSignalingChannel", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteStream(_ input: DeleteStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteStreamOutput> {
        return client.execute(operation: "DeleteStream", path: "/deleteStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeSignalingChannel(_ input: DescribeSignalingChannelInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSignalingChannelOutput> {
        return client.execute(operation: "DescribeSignalingChannel", path: "/describeSignalingChannel", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeStream(_ input: DescribeStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStreamOutput> {
        return client.execute(operation: "DescribeStream", path: "/describeStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getDataEndpoint(_ input: GetDataEndpointInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDataEndpointOutput> {
        return client.execute(operation: "GetDataEndpoint", path: "/getDataEndpoint", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getSignalingChannelEndpoint(_ input: GetSignalingChannelEndpointInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSignalingChannelEndpointOutput> {
        return client.execute(operation: "GetSignalingChannelEndpoint", path: "/getSignalingChannelEndpoint", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listSignalingChannels(_ input: ListSignalingChannelsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSignalingChannelsOutput> {
        return client.execute(operation: "ListSignalingChannels", path: "/listSignalingChannels", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listStreams(_ input: ListStreamsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStreamsOutput> {
        return client.execute(operation: "ListStreams", path: "/listStreams", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTagsForStream(_ input: ListTagsForStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForStreamOutput> {
        return client.execute(operation: "ListTagsForStream", path: "/listTagsForStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func tagStream(_ input: TagStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagStreamOutput> {
        return client.execute(operation: "TagStream", path: "/tagStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func untagStream(_ input: UntagStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagStreamOutput> {
        return client.execute(operation: "UntagStream", path: "/untagStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateDataRetention(_ input: UpdateDataRetentionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDataRetentionOutput> {
        return client.execute(operation: "UpdateDataRetention", path: "/updateDataRetention", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateSignalingChannel(_ input: UpdateSignalingChannelInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateSignalingChannelOutput> {
        return client.execute(operation: "UpdateSignalingChannel", path: "/updateSignalingChannel", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateStream(_ input: UpdateStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateStreamOutput> {
        return client.execute(operation: "UpdateStream", path: "/updateStream", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
