...
public struct ServiceDiscovery {
    ...
    public func createHttpNamespace(_ input: CreateHttpNamespaceRequest) throws -> CreateHttpNamespaceResponse {
    ...
    public func discoverInstances(_ input: DiscoverInstancesRequest) throws -> DiscoverInstancesResponse {
