...
public struct ServiceDiscovery {
    ...
    public func createHttpNamespace(_ input: CreateHttpNamespaceRequest) -> Future<CreateHttpNamespaceResponse> {
    ...
    public func createPrivateDnsNamespace(_ input: CreatePrivateDnsNamespaceRequest) -> Future<CreatePrivateDnsNamespaceResponse> {
    ...
    public func createPublicDnsNamespace(_ input: CreatePublicDnsNamespaceRequest) -> Future<CreatePublicDnsNamespaceResponse> {
    ...
    public func createService(_ input: CreateServiceRequest) -> Future<CreateServiceResponse> {
    ...
    public func deleteService(_ input: DeleteServiceRequest) -> Future<DeleteServiceResponse> {
        return client.send(operation: "DeleteService", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the Amazon Route 53 DNS records and health check, if any, that AWS Cloud Map created for the specified instance.
    public func deregisterInstance(_ input: DeregisterInstanceRequest) -> Future<DeregisterInstanceResponse> {
        return client.send(operation: "DeregisterInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Discovers registered instances for a specified namespace and service.
    public func discoverInstances(_ input: DiscoverInstancesRequest) -> Future<DiscoverInstancesResponse> {
        return client.send(operation: "DiscoverInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about a specified instance.
    public func getInstance(_ input: GetInstanceRequest) -> Future<GetInstanceResponse> {
    ...
    public func getInstancesHealthStatus(_ input: GetInstancesHealthStatusRequest) -> Future<GetInstancesHealthStatusResponse> {
        return client.send(operation: "GetInstancesHealthStatus", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about a namespace.
    public func getNamespace(_ input: GetNamespaceRequest) -> Future<GetNamespaceResponse> {
        return client.send(operation: "GetNamespace", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getOperation(_ input: GetOperationRequest) -> Future<GetOperationResponse> {
        return client.send(operation: "GetOperation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the settings for a specified service.
    public func getService(_ input: GetServiceRequest) -> Future<GetServiceResponse> {
        return client.send(operation: "GetService", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists summary information about the instances that you registered by using a specified service.
    public func listInstances(_ input: ListInstancesRequest) -> Future<ListInstancesResponse> {
        return client.send(operation: "ListInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists summary information about the namespaces that were created by the current AWS account.
    public func listNamespaces(_ input: ListNamespacesRequest) -> Future<ListNamespacesResponse> {
        return client.send(operation: "ListNamespaces", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists operations that match the criteria that you specify.
    public func listOperations(_ input: ListOperationsRequest) -> Future<ListOperationsResponse> {
        return client.send(operation: "ListOperations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists summary information for all the services that are associated with one or more specified namespaces.
    public func listServices(_ input: ListServicesRequest) -> Future<ListServicesResponse> {
    ...
    public func registerInstance(_ input: RegisterInstanceRequest) -> Future<RegisterInstanceResponse> {
    ...
    @discardableResult public func updateInstanceCustomHealthStatus(_ input: UpdateInstanceCustomHealthStatusRequest) -> Future<Void> {
    ...
    public func updateService(_ input: UpdateServiceRequest) -> Future<UpdateServiceResponse> {
        return client.send(operation: "UpdateService", path: "/", httpMethod: "POST", input: input)
    }
}
