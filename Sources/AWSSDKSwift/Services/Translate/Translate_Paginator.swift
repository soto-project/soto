...
extension Translate {
    ...
    public func listTerminologiesPaginator(_ input: ListTerminologiesRequest) -> EventLoopFuture<[TerminologyProperties]> {
        return client.paginate(input: input, command: listTerminologies, resultKey: \ListTerminologiesResponse.terminologyPropertiesList, tokenKey: \ListTerminologiesResponse.nextToken)
    }
    ...
    public func listTextTranslationJobsPaginator(_ input: ListTextTranslationJobsRequest) -> EventLoopFuture<[TextTranslationJobProperties]> {
        return client.paginate(input: input, command: listTextTranslationJobs, resultKey: \ListTextTranslationJobsResponse.textTranslationJobPropertiesList, tokenKey: \ListTextTranslationJobsResponse.nextToken)
    }
