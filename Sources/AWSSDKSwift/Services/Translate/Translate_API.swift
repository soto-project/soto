...
public struct Translate {
    ...
    public init(accessKeyId: String? = nil, secretAccessKey: String? = nil, region: AWSSDKSwiftCore.Region? = nil, endpoint: String? = nil) {
        self.client = AWSClient(
            ...
            endpoint: endpoint,
            serviceEndpoints: ["us-east-2-fips": "translate-fips.us-east-2.amazonaws.com", "us-east-1-fips": "translate-fips.us-east-1.amazonaws.com", "us-west-2-fips": "translate-fips.us-west-2.amazonaws.com"],
            middlewares: [],
    ...
    public func getTerminology(_ input: GetTerminologyRequest) throws -> GetTerminologyResponse {
    ...
    public func importTerminology(_ input: ImportTerminologyRequest) throws -> ImportTerminologyResponse {
