...
public struct SESV2 {
    ...
    public func createConfigurationSet(_ input: CreateConfigurationSetRequest) -> Future<CreateConfigurationSetResponse> {
        return client.send(operation: "CreateConfigurationSet", path: "/v2/email/configuration-sets", httpMethod: "POST", input: input)
    }
    ...
    public func createDedicatedIpPool(_ input: CreateDedicatedIpPoolRequest) -> Future<CreateDedicatedIpPoolResponse> {
    ...
    public func createDeliverabilityTestReport(_ input: CreateDeliverabilityTestReportRequest) -> Future<CreateDeliverabilityTestReportResponse> {
        return client.send(operation: "CreateDeliverabilityTestReport", path: "/v2/email/deliverability-dashboard/test", httpMethod: "POST", input: input)
    }
    ...
    public func createEmailIdentity(_ input: CreateEmailIdentityRequest) -> Future<CreateEmailIdentityResponse> {
    ...
    public func deleteDedicatedIpPool(_ input: DeleteDedicatedIpPoolRequest) -> Future<DeleteDedicatedIpPoolResponse> {
    ...
    public func deleteEmailIdentity(_ input: DeleteEmailIdentityRequest) -> Future<DeleteEmailIdentityResponse> {
    ...
    public func deleteSuppressedDestination(_ input: DeleteSuppressedDestinationRequest) -> Future<DeleteSuppressedDestinationResponse> {
        return client.send(operation: "DeleteSuppressedDestination", path: "/v2/email/suppression/addresses/{EmailAddress}", httpMethod: "DELETE", input: input)
    }

    ///  Obtain information about the email-sending status and capabilities of your Amazon SES account in the current AWS Region.
    public func getAccount(_ input: GetAccountRequest) -> Future<GetAccountResponse> {
        return client.send(operation: "GetAccount", path: "/v2/email/account", httpMethod: "GET", input: input)
    }

    ///  Retrieve a list of the blacklists that your dedicated IP addresses appear on.
    public func getBlacklistReports(_ input: GetBlacklistReportsRequest) -> Future<GetBlacklistReportsResponse> {
        return client.send(operation: "GetBlacklistReports", path: "/v2/email/deliverability-dashboard/blacklist-report", httpMethod: "GET", input: input)
    }
    ...
    public func getConfigurationSet(_ input: GetConfigurationSetRequest) -> Future<GetConfigurationSetResponse> {
        return client.send(operation: "GetConfigurationSet", path: "/v2/email/configuration-sets/{ConfigurationSetName}", httpMethod: "GET", input: input)
    }
    ...
    public func getDedicatedIp(_ input: GetDedicatedIpRequest) -> Future<GetDedicatedIpResponse> {
        return client.send(operation: "GetDedicatedIp", path: "/v2/email/dedicated-ips/{IP}", httpMethod: "GET", input: input)
    }

    ///  List the dedicated IP addresses that are associated with your AWS account.
    public func getDedicatedIps(_ input: GetDedicatedIpsRequest) -> Future<GetDedicatedIpsResponse> {
        return client.send(operation: "GetDedicatedIps", path: "/v2/email/dedicated-ips", httpMethod: "GET", input: input)
    }
    ...
    public func getDeliverabilityDashboardOptions(_ input: GetDeliverabilityDashboardOptionsRequest) -> Future<GetDeliverabilityDashboardOptionsResponse> {
        return client.send(operation: "GetDeliverabilityDashboardOptions", path: "/v2/email/deliverability-dashboard", httpMethod: "GET", input: input)
    }

    ///  Retrieve the results of a predictive inbox placement test.
    public func getDeliverabilityTestReport(_ input: GetDeliverabilityTestReportRequest) -> Future<GetDeliverabilityTestReportResponse> {
        return client.send(operation: "GetDeliverabilityTestReport", path: "/v2/email/deliverability-dashboard/test-reports/{ReportId}", httpMethod: "GET", input: input)
    }

    ///  Retrieve all the deliverability data for a specific campaign. This data is available for a campaign only if the campaign sent email by using a domain that the Deliverability dashboard is enabled for.
    public func getDomainDeliverabilityCampaign(_ input: GetDomainDeliverabilityCampaignRequest) -> Future<GetDomainDeliverabilityCampaignResponse> {
        return client.send(operation: "GetDomainDeliverabilityCampaign", path: "/v2/email/deliverability-dashboard/campaigns/{CampaignId}", httpMethod: "GET", input: input)
    }

    ///  Retrieve inbox placement and engagement rates for the domains that you use to send email.
    public func getDomainStatisticsReport(_ input: GetDomainStatisticsReportRequest) -> Future<GetDomainStatisticsReportResponse> {
    ...
    public func getEmailIdentity(_ input: GetEmailIdentityRequest) -> Future<GetEmailIdentityResponse> {
    ...
    public func getSuppressedDestination(_ input: GetSuppressedDestinationRequest) -> Future<GetSuppressedDestinationResponse> {
        return client.send(operation: "GetSuppressedDestination", path: "/v2/email/suppression/addresses/{EmailAddress}", httpMethod: "GET", input: input)
    }
    ...
    public func listDedicatedIpPools(_ input: ListDedicatedIpPoolsRequest) -> Future<ListDedicatedIpPoolsResponse> {
        return client.send(operation: "ListDedicatedIpPools", path: "/v2/email/dedicated-ip-pools", httpMethod: "GET", input: input)
    }

    ///  Show a list of the predictive inbox placement tests that you've performed, regardless of their statuses. For predictive inbox placement tests that are complete, you can use the GetDeliverabilityTestReport operation to view the results.
    public func listDeliverabilityTestReports(_ input: ListDeliverabilityTestReportsRequest) -> Future<ListDeliverabilityTestReportsResponse> {
        return client.send(operation: "ListDeliverabilityTestReports", path: "/v2/email/deliverability-dashboard/test-reports", httpMethod: "GET", input: input)
    }

    ///  Retrieve deliverability data for all the campaigns that used a specific domain to send email during a specified time range. This data is available for a domain only if you enabled the Deliverability dashboard for the domain.
    public func listDomainDeliverabilityCampaigns(_ input: ListDomainDeliverabilityCampaignsRequest) -> Future<ListDomainDeliverabilityCampaignsResponse> {
        return client.send(operation: "ListDomainDeliverabilityCampaigns", path: "/v2/email/deliverability-dashboard/domains/{SubscribedDomain}/campaigns", httpMethod: "GET", input: input)
    }

    ///  Returns a list of all of the email identities that are associated with your AWS account. An identity can be either an email address or a domain. This operation returns identities that are verified as well as those that aren't. This operation returns identities that are associated with Amazon SES and Amazon Pinpoint.
    public func listEmailIdentities(_ input: ListEmailIdentitiesRequest) -> Future<ListEmailIdentitiesResponse> {
        return client.send(operation: "ListEmailIdentities", path: "/v2/email/identities", httpMethod: "GET", input: input)
    }

    ///  Retrieves a list of email addresses that are on the suppression list for your account.
    public func listSuppressedDestinations(_ input: ListSuppressedDestinationsRequest) -> Future<ListSuppressedDestinationsResponse> {
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest) -> Future<ListTagsForResourceResponse> {
        return client.send(operation: "ListTagsForResource", path: "/v2/email/tags", httpMethod: "GET", input: input)
    }

    ///  Enable or disable the automatic warm-up feature for dedicated IP addresses.
    public func putAccountDedicatedIpWarmupAttributes(_ input: PutAccountDedicatedIpWarmupAttributesRequest) -> Future<PutAccountDedicatedIpWarmupAttributesResponse> {
    ...
    public func putAccountSendingAttributes(_ input: PutAccountSendingAttributesRequest) -> Future<PutAccountSendingAttributesResponse> {
        return client.send(operation: "PutAccountSendingAttributes", path: "/v2/email/account/sending", httpMethod: "PUT", input: input)
    }

    ///  Change the settings for the account-level suppression list.
    public func putAccountSuppressionAttributes(_ input: PutAccountSuppressionAttributesRequest) -> Future<PutAccountSuppressionAttributesResponse> {
        return client.send(operation: "PutAccountSuppressionAttributes", path: "/v2/email/account/suppression", httpMethod: "PUT", input: input)
    }
    ...
    public func putConfigurationSetDeliveryOptions(_ input: PutConfigurationSetDeliveryOptionsRequest) -> Future<PutConfigurationSetDeliveryOptionsResponse> {
        return client.send(operation: "PutConfigurationSetDeliveryOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/delivery-options", httpMethod: "PUT", input: input)
    }

    ///  Enable or disable collection of reputation metrics for emails that you send using a particular configuration set in a specific AWS Region.
    public func putConfigurationSetReputationOptions(_ input: PutConfigurationSetReputationOptionsRequest) -> Future<PutConfigurationSetReputationOptionsResponse> {
        return client.send(operation: "PutConfigurationSetReputationOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/reputation-options", httpMethod: "PUT", input: input)
    }

    ///  Enable or disable email sending for messages that use a particular configuration set in a specific AWS Region.
    public func putConfigurationSetSendingOptions(_ input: PutConfigurationSetSendingOptionsRequest) -> Future<PutConfigurationSetSendingOptionsResponse> {
        return client.send(operation: "PutConfigurationSetSendingOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/sending", httpMethod: "PUT", input: input)
    }

    ///  Specify the account suppression list preferences for a configuration set.
    public func putConfigurationSetSuppressionOptions(_ input: PutConfigurationSetSuppressionOptionsRequest) -> Future<PutConfigurationSetSuppressionOptionsResponse> {
        return client.send(operation: "PutConfigurationSetSuppressionOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/suppression-options", httpMethod: "PUT", input: input)
    }

    ///  Specify a custom domain to use for open and click tracking elements in email that you send.
    public func putConfigurationSetTrackingOptions(_ input: PutConfigurationSetTrackingOptionsRequest) -> Future<PutConfigurationSetTrackingOptionsResponse> {
        return client.send(operation: "PutConfigurationSetTrackingOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/tracking-options", httpMethod: "PUT", input: input)
    }
    ...
    public func putDedicatedIpInPool(_ input: PutDedicatedIpInPoolRequest) -> Future<PutDedicatedIpInPoolResponse> {
        return client.send(operation: "PutDedicatedIpInPool", path: "/v2/email/dedicated-ips/{IP}/pool", httpMethod: "PUT", input: input)
    }

    public func putDedicatedIpWarmupAttributes(_ input: PutDedicatedIpWarmupAttributesRequest) -> Future<PutDedicatedIpWarmupAttributesResponse> {
        return client.send(operation: "PutDedicatedIpWarmupAttributes", path: "/v2/email/dedicated-ips/{IP}/warmup", httpMethod: "PUT", input: input)
    }
    ...
    public func putDeliverabilityDashboardOption(_ input: PutDeliverabilityDashboardOptionRequest) -> Future<PutDeliverabilityDashboardOptionResponse> {
        return client.send(operation: "PutDeliverabilityDashboardOption", path: "/v2/email/deliverability-dashboard", httpMethod: "PUT", input: input)
    }

    ///  Used to enable or disable DKIM authentication for an email identity.
    public func putEmailIdentityDkimAttributes(_ input: PutEmailIdentityDkimAttributesRequest) -> Future<PutEmailIdentityDkimAttributesResponse> {
        return client.send(operation: "PutEmailIdentityDkimAttributes", path: "/v2/email/identities/{EmailIdentity}/dkim", httpMethod: "PUT", input: input)
    }
    ...
    public func putEmailIdentityDkimSigningAttributes(_ input: PutEmailIdentityDkimSigningAttributesRequest) -> Future<PutEmailIdentityDkimSigningAttributesResponse> {
        return client.send(operation: "PutEmailIdentityDkimSigningAttributes", path: "/v1/email/identities/{EmailIdentity}/dkim/signing", httpMethod: "PUT", input: input)
    }
    ...
    public func putEmailIdentityFeedbackAttributes(_ input: PutEmailIdentityFeedbackAttributesRequest) -> Future<PutEmailIdentityFeedbackAttributesResponse> {
        return client.send(operation: "PutEmailIdentityFeedbackAttributes", path: "/v2/email/identities/{EmailIdentity}/feedback", httpMethod: "PUT", input: input)
    }

    ///  Used to enable or disable the custom Mail-From domain configuration for an email identity.
    public func putEmailIdentityMailFromAttributes(_ input: PutEmailIdentityMailFromAttributesRequest) -> Future<PutEmailIdentityMailFromAttributesResponse> {
        return client.send(operation: "PutEmailIdentityMailFromAttributes", path: "/v2/email/identities/{EmailIdentity}/mail-from", httpMethod: "PUT", input: input)
    }

    ///  Adds an email address to the suppression list for your account.
    public func putSuppressedDestination(_ input: PutSuppressedDestinationRequest) -> Future<PutSuppressedDestinationResponse> {
    ...
    public func untagResource(_ input: UntagResourceRequest) -> Future<UntagResourceResponse> {
        return client.send(operation: "UntagResource", path: "/v2/email/tags", httpMethod: "DELETE", input: input)
    }
