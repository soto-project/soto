...
public struct SESV2: AWSService {
    ...
    public func createConfigurationSet(_ input: CreateConfigurationSetRequest) -> EventLoopFuture<CreateConfigurationSetResponse> {
        return client.execute(operation: "CreateConfigurationSet", path: "/v2/email/configuration-sets", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createConfigurationSetEventDestination(_ input: CreateConfigurationSetEventDestinationRequest) -> EventLoopFuture<CreateConfigurationSetEventDestinationResponse> {
        return client.execute(operation: "CreateConfigurationSetEventDestination", path: "/v2/email/configuration-sets/{ConfigurationSetName}/event-destinations", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createCustomVerificationEmailTemplate(_ input: CreateCustomVerificationEmailTemplateRequest) -> EventLoopFuture<CreateCustomVerificationEmailTemplateResponse> {
        return client.execute(operation: "CreateCustomVerificationEmailTemplate", path: "/v2/email/custom-verification-email-templates", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDedicatedIpPool(_ input: CreateDedicatedIpPoolRequest) -> EventLoopFuture<CreateDedicatedIpPoolResponse> {
        return client.execute(operation: "CreateDedicatedIpPool", path: "/v2/email/dedicated-ip-pools", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDeliverabilityTestReport(_ input: CreateDeliverabilityTestReportRequest) -> EventLoopFuture<CreateDeliverabilityTestReportResponse> {
        return client.execute(operation: "CreateDeliverabilityTestReport", path: "/v2/email/deliverability-dashboard/test", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createEmailIdentity(_ input: CreateEmailIdentityRequest) -> EventLoopFuture<CreateEmailIdentityResponse> {
        return client.execute(operation: "CreateEmailIdentity", path: "/v2/email/identities", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createEmailIdentityPolicy(_ input: CreateEmailIdentityPolicyRequest) -> EventLoopFuture<CreateEmailIdentityPolicyResponse> {
        return client.execute(operation: "CreateEmailIdentityPolicy", path: "/v2/email/identities/{EmailIdentity}/policies/{PolicyName}", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createEmailTemplate(_ input: CreateEmailTemplateRequest) -> EventLoopFuture<CreateEmailTemplateResponse> {
        return client.execute(operation: "CreateEmailTemplate", path: "/v2/email/templates", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteConfigurationSet(_ input: DeleteConfigurationSetRequest) -> EventLoopFuture<DeleteConfigurationSetResponse> {
        return client.execute(operation: "DeleteConfigurationSet", path: "/v2/email/configuration-sets/{ConfigurationSetName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteConfigurationSetEventDestination(_ input: DeleteConfigurationSetEventDestinationRequest) -> EventLoopFuture<DeleteConfigurationSetEventDestinationResponse> {
        return client.execute(operation: "DeleteConfigurationSetEventDestination", path: "/v2/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteCustomVerificationEmailTemplate(_ input: DeleteCustomVerificationEmailTemplateRequest) -> EventLoopFuture<DeleteCustomVerificationEmailTemplateResponse> {
        return client.execute(operation: "DeleteCustomVerificationEmailTemplate", path: "/v2/email/custom-verification-email-templates/{TemplateName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDedicatedIpPool(_ input: DeleteDedicatedIpPoolRequest) -> EventLoopFuture<DeleteDedicatedIpPoolResponse> {
        return client.execute(operation: "DeleteDedicatedIpPool", path: "/v2/email/dedicated-ip-pools/{PoolName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteEmailIdentity(_ input: DeleteEmailIdentityRequest) -> EventLoopFuture<DeleteEmailIdentityResponse> {
        return client.execute(operation: "DeleteEmailIdentity", path: "/v2/email/identities/{EmailIdentity}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteEmailIdentityPolicy(_ input: DeleteEmailIdentityPolicyRequest) -> EventLoopFuture<DeleteEmailIdentityPolicyResponse> {
        return client.execute(operation: "DeleteEmailIdentityPolicy", path: "/v2/email/identities/{EmailIdentity}/policies/{PolicyName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteEmailTemplate(_ input: DeleteEmailTemplateRequest) -> EventLoopFuture<DeleteEmailTemplateResponse> {
        return client.execute(operation: "DeleteEmailTemplate", path: "/v2/email/templates/{TemplateName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Removes an email address from the suppression list for your account.
    public func deleteSuppressedDestination(_ input: DeleteSuppressedDestinationRequest) -> EventLoopFuture<DeleteSuppressedDestinationResponse> {
        return client.execute(operation: "DeleteSuppressedDestination", path: "/v2/email/suppression/addresses/{EmailAddress}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Obtain information about the email-sending status and capabilities of your Amazon SES account in the current AWS Region.
    public func getAccount(_ input: GetAccountRequest) -> EventLoopFuture<GetAccountResponse> {
        return client.execute(operation: "GetAccount", path: "/v2/email/account", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBlacklistReports(_ input: GetBlacklistReportsRequest) -> EventLoopFuture<GetBlacklistReportsResponse> {
        return client.execute(operation: "GetBlacklistReports", path: "/v2/email/deliverability-dashboard/blacklist-report", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getConfigurationSet(_ input: GetConfigurationSetRequest) -> EventLoopFuture<GetConfigurationSetResponse> {
        return client.execute(operation: "GetConfigurationSet", path: "/v2/email/configuration-sets/{ConfigurationSetName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getConfigurationSetEventDestinations(_ input: GetConfigurationSetEventDestinationsRequest) -> EventLoopFuture<GetConfigurationSetEventDestinationsResponse> {
        return client.execute(operation: "GetConfigurationSetEventDestinations", path: "/v2/email/configuration-sets/{ConfigurationSetName}/event-destinations", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getCustomVerificationEmailTemplate(_ input: GetCustomVerificationEmailTemplateRequest) -> EventLoopFuture<GetCustomVerificationEmailTemplateResponse> {
        return client.execute(operation: "GetCustomVerificationEmailTemplate", path: "/v2/email/custom-verification-email-templates/{TemplateName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDedicatedIp(_ input: GetDedicatedIpRequest) -> EventLoopFuture<GetDedicatedIpResponse> {
        return client.execute(operation: "GetDedicatedIp", path: "/v2/email/dedicated-ips/{IP}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  List the dedicated IP addresses that are associated with your AWS account.
    public func getDedicatedIps(_ input: GetDedicatedIpsRequest) -> EventLoopFuture<GetDedicatedIpsResponse> {
        return client.execute(operation: "GetDedicatedIps", path: "/v2/email/dedicated-ips", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDeliverabilityDashboardOptions(_ input: GetDeliverabilityDashboardOptionsRequest) -> EventLoopFuture<GetDeliverabilityDashboardOptionsResponse> {
        return client.execute(operation: "GetDeliverabilityDashboardOptions", path: "/v2/email/deliverability-dashboard", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDeliverabilityTestReport(_ input: GetDeliverabilityTestReportRequest) -> EventLoopFuture<GetDeliverabilityTestReportResponse> {
        return client.execute(operation: "GetDeliverabilityTestReport", path: "/v2/email/deliverability-dashboard/test-reports/{ReportId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDomainDeliverabilityCampaign(_ input: GetDomainDeliverabilityCampaignRequest) -> EventLoopFuture<GetDomainDeliverabilityCampaignResponse> {
        return client.execute(operation: "GetDomainDeliverabilityCampaign", path: "/v2/email/deliverability-dashboard/campaigns/{CampaignId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDomainStatisticsReport(_ input: GetDomainStatisticsReportRequest) -> EventLoopFuture<GetDomainStatisticsReportResponse> {
        return client.execute(operation: "GetDomainStatisticsReport", path: "/v2/email/deliverability-dashboard/statistics-report/{Domain}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getEmailIdentity(_ input: GetEmailIdentityRequest) -> EventLoopFuture<GetEmailIdentityResponse> {
        return client.execute(operation: "GetEmailIdentity", path: "/v2/email/identities/{EmailIdentity}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getEmailIdentityPolicies(_ input: GetEmailIdentityPoliciesRequest) -> EventLoopFuture<GetEmailIdentityPoliciesResponse> {
        return client.execute(operation: "GetEmailIdentityPolicies", path: "/v2/email/identities/{EmailIdentity}/policies", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getEmailTemplate(_ input: GetEmailTemplateRequest) -> EventLoopFuture<GetEmailTemplateResponse> {
        return client.execute(operation: "GetEmailTemplate", path: "/v2/email/templates/{TemplateName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves information about a specific email address that's on the suppression list for your account.
    public func getSuppressedDestination(_ input: GetSuppressedDestinationRequest) -> EventLoopFuture<GetSuppressedDestinationResponse> {
        return client.execute(operation: "GetSuppressedDestination", path: "/v2/email/suppression/addresses/{EmailAddress}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listConfigurationSets(_ input: ListConfigurationSetsRequest) -> EventLoopFuture<ListConfigurationSetsResponse> {
        return client.execute(operation: "ListConfigurationSets", path: "/v2/email/configuration-sets", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listCustomVerificationEmailTemplates(_ input: ListCustomVerificationEmailTemplatesRequest) -> EventLoopFuture<ListCustomVerificationEmailTemplatesResponse> {
        return client.execute(operation: "ListCustomVerificationEmailTemplates", path: "/v2/email/custom-verification-email-templates", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDedicatedIpPools(_ input: ListDedicatedIpPoolsRequest) -> EventLoopFuture<ListDedicatedIpPoolsResponse> {
        return client.execute(operation: "ListDedicatedIpPools", path: "/v2/email/dedicated-ip-pools", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDeliverabilityTestReports(_ input: ListDeliverabilityTestReportsRequest) -> EventLoopFuture<ListDeliverabilityTestReportsResponse> {
        return client.execute(operation: "ListDeliverabilityTestReports", path: "/v2/email/deliverability-dashboard/test-reports", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDomainDeliverabilityCampaigns(_ input: ListDomainDeliverabilityCampaignsRequest) -> EventLoopFuture<ListDomainDeliverabilityCampaignsResponse> {
        return client.execute(operation: "ListDomainDeliverabilityCampaigns", path: "/v2/email/deliverability-dashboard/domains/{SubscribedDomain}/campaigns", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listEmailIdentities(_ input: ListEmailIdentitiesRequest) -> EventLoopFuture<ListEmailIdentitiesResponse> {
        return client.execute(operation: "ListEmailIdentities", path: "/v2/email/identities", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listEmailTemplates(_ input: ListEmailTemplatesRequest) -> EventLoopFuture<ListEmailTemplatesResponse> {
        return client.execute(operation: "ListEmailTemplates", path: "/v2/email/templates", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listSuppressedDestinations(_ input: ListSuppressedDestinationsRequest) -> EventLoopFuture<ListSuppressedDestinationsResponse> {
        return client.execute(operation: "ListSuppressedDestinations", path: "/v2/email/suppression/addresses", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieve a list of the tags (keys and values) that are associated with a specified resource. A tag is a label that you optionally define and associate with a resource. Each tag consists of a required tag key and an optional associated tag value. A tag key is a general label that acts as a category for more specific tag values. A tag value acts as a descriptor within a tag key.
    public func listTagsForResource(_ input: ListTagsForResourceRequest) -> EventLoopFuture<ListTagsForResourceResponse> {
        return client.execute(operation: "ListTagsForResource", path: "/v2/email/tags", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func putAccountDedicatedIpWarmupAttributes(_ input: PutAccountDedicatedIpWarmupAttributesRequest) -> EventLoopFuture<PutAccountDedicatedIpWarmupAttributesResponse> {
        return client.execute(operation: "PutAccountDedicatedIpWarmupAttributes", path: "/v2/email/account/dedicated-ips/warmup", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Update your Amazon SES account details.
    public func putAccountDetails(_ input: PutAccountDetailsRequest) -> EventLoopFuture<PutAccountDetailsResponse> {
        return client.execute(operation: "PutAccountDetails", path: "/v2/email/account/details", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putAccountSendingAttributes(_ input: PutAccountSendingAttributesRequest) -> EventLoopFuture<PutAccountSendingAttributesResponse> {
        return client.execute(operation: "PutAccountSendingAttributes", path: "/v2/email/account/sending", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Change the settings for the account-level suppression list.
    public func putAccountSuppressionAttributes(_ input: PutAccountSuppressionAttributesRequest) -> EventLoopFuture<PutAccountSuppressionAttributesResponse> {
        return client.execute(operation: "PutAccountSuppressionAttributes", path: "/v2/email/account/suppression", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetDeliveryOptions(_ input: PutConfigurationSetDeliveryOptionsRequest) -> EventLoopFuture<PutConfigurationSetDeliveryOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetDeliveryOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/delivery-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetReputationOptions(_ input: PutConfigurationSetReputationOptionsRequest) -> EventLoopFuture<PutConfigurationSetReputationOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetReputationOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/reputation-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetSendingOptions(_ input: PutConfigurationSetSendingOptionsRequest) -> EventLoopFuture<PutConfigurationSetSendingOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetSendingOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/sending", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Specify the account suppression list preferences for a configuration set.
    public func putConfigurationSetSuppressionOptions(_ input: PutConfigurationSetSuppressionOptionsRequest) -> EventLoopFuture<PutConfigurationSetSuppressionOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetSuppressionOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/suppression-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetTrackingOptions(_ input: PutConfigurationSetTrackingOptionsRequest) -> EventLoopFuture<PutConfigurationSetTrackingOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetTrackingOptions", path: "/v2/email/configuration-sets/{ConfigurationSetName}/tracking-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDedicatedIpInPool(_ input: PutDedicatedIpInPoolRequest) -> EventLoopFuture<PutDedicatedIpInPoolResponse> {
        return client.execute(operation: "PutDedicatedIpInPool", path: "/v2/email/dedicated-ips/{IP}/pool", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDedicatedIpWarmupAttributes(_ input: PutDedicatedIpWarmupAttributesRequest) -> EventLoopFuture<PutDedicatedIpWarmupAttributesResponse> {
        return client.execute(operation: "PutDedicatedIpWarmupAttributes", path: "/v2/email/dedicated-ips/{IP}/warmup", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDeliverabilityDashboardOption(_ input: PutDeliverabilityDashboardOptionRequest) -> EventLoopFuture<PutDeliverabilityDashboardOptionResponse> {
        return client.execute(operation: "PutDeliverabilityDashboardOption", path: "/v2/email/deliverability-dashboard", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityDkimAttributes(_ input: PutEmailIdentityDkimAttributesRequest) -> EventLoopFuture<PutEmailIdentityDkimAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityDkimAttributes", path: "/v2/email/identities/{EmailIdentity}/dkim", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityDkimSigningAttributes(_ input: PutEmailIdentityDkimSigningAttributesRequest) -> EventLoopFuture<PutEmailIdentityDkimSigningAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityDkimSigningAttributes", path: "/v1/email/identities/{EmailIdentity}/dkim/signing", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityFeedbackAttributes(_ input: PutEmailIdentityFeedbackAttributesRequest) -> EventLoopFuture<PutEmailIdentityFeedbackAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityFeedbackAttributes", path: "/v2/email/identities/{EmailIdentity}/feedback", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityMailFromAttributes(_ input: PutEmailIdentityMailFromAttributesRequest) -> EventLoopFuture<PutEmailIdentityMailFromAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityMailFromAttributes", path: "/v2/email/identities/{EmailIdentity}/mail-from", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Adds an email address to the suppression list for your account.
    public func putSuppressedDestination(_ input: PutSuppressedDestinationRequest) -> EventLoopFuture<PutSuppressedDestinationResponse> {
        return client.execute(operation: "PutSuppressedDestination", path: "/v2/email/suppression/addresses", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Composes an email message to multiple destinations.
    public func sendBulkEmail(_ input: SendBulkEmailRequest) -> EventLoopFuture<SendBulkEmailResponse> {
        return client.execute(operation: "SendBulkEmail", path: "/v2/email/outbound-bulk-emails", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func sendCustomVerificationEmail(_ input: SendCustomVerificationEmailRequest) -> EventLoopFuture<SendCustomVerificationEmailResponse> {
        return client.execute(operation: "SendCustomVerificationEmail", path: "/v2/email/outbound-custom-verification-emails", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func sendEmail(_ input: SendEmailRequest) -> EventLoopFuture<SendEmailResponse> {
        return client.execute(operation: "SendEmail", path: "/v2/email/outbound-emails", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func tagResource(_ input: TagResourceRequest) -> EventLoopFuture<TagResourceResponse> {
        return client.execute(operation: "TagResource", path: "/v2/email/tags", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func testRenderEmailTemplate(_ input: TestRenderEmailTemplateRequest) -> EventLoopFuture<TestRenderEmailTemplateResponse> {
        return client.execute(operation: "TestRenderEmailTemplate", path: "/v2/email/templates/{TemplateName}/render", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Remove one or more tags (keys and values) from a specified resource.
    public func untagResource(_ input: UntagResourceRequest) -> EventLoopFuture<UntagResourceResponse> {
        return client.execute(operation: "UntagResource", path: "/v2/email/tags", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateConfigurationSetEventDestination(_ input: UpdateConfigurationSetEventDestinationRequest) -> EventLoopFuture<UpdateConfigurationSetEventDestinationResponse> {
        return client.execute(operation: "UpdateConfigurationSetEventDestination", path: "/v2/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateCustomVerificationEmailTemplate(_ input: UpdateCustomVerificationEmailTemplateRequest) -> EventLoopFuture<UpdateCustomVerificationEmailTemplateResponse> {
        return client.execute(operation: "UpdateCustomVerificationEmailTemplate", path: "/v2/email/custom-verification-email-templates/{TemplateName}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateEmailIdentityPolicy(_ input: UpdateEmailIdentityPolicyRequest) -> EventLoopFuture<UpdateEmailIdentityPolicyResponse> {
        return client.execute(operation: "UpdateEmailIdentityPolicy", path: "/v2/email/identities/{EmailIdentity}/policies/{PolicyName}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateEmailTemplate(_ input: UpdateEmailTemplateRequest) -> EventLoopFuture<UpdateEmailTemplateResponse> {
        return client.execute(operation: "UpdateEmailTemplate", path: "/v2/email/templates/{TemplateName}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
}
