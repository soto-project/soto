...
public struct SESV2 {
    ...
    public func deleteSuppressedDestination(_ input: DeleteSuppressedDestinationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteSuppressedDestinationResponse> {
    ...
    public func getSuppressedDestination(_ input: GetSuppressedDestinationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetSuppressedDestinationResponse> {
    ...
    public func listSuppressedDestinations(_ input: ListSuppressedDestinationsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListSuppressedDestinationsResponse> {
    ...
    public func putAccountSuppressionAttributes(_ input: PutAccountSuppressionAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutAccountSuppressionAttributesResponse> {
    ...
    public func putConfigurationSetSuppressionOptions(_ input: PutConfigurationSetSuppressionOptionsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutConfigurationSetSuppressionOptionsResponse> {
    ...
    public func putEmailIdentityDkimSigningAttributes(_ input: PutEmailIdentityDkimSigningAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutEmailIdentityDkimSigningAttributesResponse> {
    ...
    public func putSuppressedDestination(_ input: PutSuppressedDestinationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<PutSuppressedDestinationResponse> {
