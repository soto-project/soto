...
public struct Batch: AWSService {
    ...
    public func cancelJob(_ input: CancelJobRequest) -> EventLoopFuture<CancelJobResponse> {
        return client.execute(operation: "CancelJob", path: "/v1/canceljob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createComputeEnvironment(_ input: CreateComputeEnvironmentRequest) -> EventLoopFuture<CreateComputeEnvironmentResponse> {
        return client.execute(operation: "CreateComputeEnvironment", path: "/v1/createcomputeenvironment", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createJobQueue(_ input: CreateJobQueueRequest) -> EventLoopFuture<CreateJobQueueResponse> {
        return client.execute(operation: "CreateJobQueue", path: "/v1/createjobqueue", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteComputeEnvironment(_ input: DeleteComputeEnvironmentRequest) -> EventLoopFuture<DeleteComputeEnvironmentResponse> {
        return client.execute(operation: "DeleteComputeEnvironment", path: "/v1/deletecomputeenvironment", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteJobQueue(_ input: DeleteJobQueueRequest) -> EventLoopFuture<DeleteJobQueueResponse> {
        return client.execute(operation: "DeleteJobQueue", path: "/v1/deletejobqueue", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deregisterJobDefinition(_ input: DeregisterJobDefinitionRequest) -> EventLoopFuture<DeregisterJobDefinitionResponse> {
        return client.execute(operation: "DeregisterJobDefinition", path: "/v1/deregisterjobdefinition", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeComputeEnvironments(_ input: DescribeComputeEnvironmentsRequest) -> EventLoopFuture<DescribeComputeEnvironmentsResponse> {
        return client.execute(operation: "DescribeComputeEnvironments", path: "/v1/describecomputeenvironments", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeJobDefinitions(_ input: DescribeJobDefinitionsRequest) -> EventLoopFuture<DescribeJobDefinitionsResponse> {
        return client.execute(operation: "DescribeJobDefinitions", path: "/v1/describejobdefinitions", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes one or more of your job queues.
    public func describeJobQueues(_ input: DescribeJobQueuesRequest) -> EventLoopFuture<DescribeJobQueuesResponse> {
        return client.execute(operation: "DescribeJobQueues", path: "/v1/describejobqueues", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes a list of AWS Batch jobs.
    public func describeJobs(_ input: DescribeJobsRequest) -> EventLoopFuture<DescribeJobsResponse> {
        return client.execute(operation: "DescribeJobs", path: "/v1/describejobs", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listJobs(_ input: ListJobsRequest) -> EventLoopFuture<ListJobsResponse> {
        return client.execute(operation: "ListJobs", path: "/v1/listjobs", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerJobDefinition(_ input: RegisterJobDefinitionRequest) -> EventLoopFuture<RegisterJobDefinitionResponse> {
        return client.execute(operation: "RegisterJobDefinition", path: "/v1/registerjobdefinition", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Submits an AWS Batch job from a job definition. Parameters specified during SubmitJob override parameters defined in the job definition.
    public func submitJob(_ input: SubmitJobRequest) -> EventLoopFuture<SubmitJobResponse> {
        return client.execute(operation: "SubmitJob", path: "/v1/submitjob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func terminateJob(_ input: TerminateJobRequest) -> EventLoopFuture<TerminateJobResponse> {
        return client.execute(operation: "TerminateJob", path: "/v1/terminatejob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateComputeEnvironment(_ input: UpdateComputeEnvironmentRequest) -> EventLoopFuture<UpdateComputeEnvironmentResponse> {
        return client.execute(operation: "UpdateComputeEnvironment", path: "/v1/updatecomputeenvironment", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Updates a job queue.
    public func updateJobQueue(_ input: UpdateJobQueueRequest) -> EventLoopFuture<UpdateJobQueueResponse> {
        return client.execute(operation: "UpdateJobQueue", path: "/v1/updatejobqueue", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
