...
public struct Batch {
    ...
    public func describeComputeEnvironments(_ input: DescribeComputeEnvironmentsRequest) throws -> EventLoopFuture<DescribeComputeEnvironmentsResponse> {
    ...
    public func terminateJob(_ input: TerminateJobRequest) throws -> EventLoopFuture<TerminateJobResponse> {
    ...
    public func deleteJobQueue(_ input: DeleteJobQueueRequest) throws -> EventLoopFuture<DeleteJobQueueResponse> {
        return try client.send(operation: "DeleteJobQueue", path: "/v1/deletejobqueue", httpMethod: "POST", input: input)
    }

    ///  Deregisters an AWS Batch job definition.
    public func deregisterJobDefinition(_ input: DeregisterJobDefinitionRequest) throws -> EventLoopFuture<DeregisterJobDefinitionResponse> {
    ...
    public func submitJob(_ input: SubmitJobRequest) throws -> EventLoopFuture<SubmitJobResponse> {
        return try client.send(operation: "SubmitJob", path: "/v1/submitjob", httpMethod: "POST", input: input)
    }

    ///  Describes a list of job definitions. You can specify a status (such as ACTIVE) to only return job definitions that match that status.
    public func describeJobDefinitions(_ input: DescribeJobDefinitionsRequest) throws -> EventLoopFuture<DescribeJobDefinitionsResponse> {
    ...
    public func registerJobDefinition(_ input: RegisterJobDefinitionRequest) throws -> EventLoopFuture<RegisterJobDefinitionResponse> {
        return try client.send(operation: "RegisterJobDefinition", path: "/v1/registerjobdefinition", httpMethod: "POST", input: input)
    }

    ///  Describes a list of AWS Batch jobs.
    public func describeJobs(_ input: DescribeJobsRequest) throws -> EventLoopFuture<DescribeJobsResponse> {
        return try client.send(operation: "DescribeJobs", path: "/v1/describejobs", httpMethod: "POST", input: input)
    }

    ///  Updates an AWS Batch compute environment.
    public func updateComputeEnvironment(_ input: UpdateComputeEnvironmentRequest) throws -> EventLoopFuture<UpdateComputeEnvironmentResponse> {
    ...
    public func createJobQueue(_ input: CreateJobQueueRequest) throws -> EventLoopFuture<CreateJobQueueResponse> {
        return try client.send(operation: "CreateJobQueue", path: "/v1/createjobqueue", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your job queues.
    public func describeJobQueues(_ input: DescribeJobQueuesRequest) throws -> EventLoopFuture<DescribeJobQueuesResponse> {
    ...
    public func createComputeEnvironment(_ input: CreateComputeEnvironmentRequest) throws -> EventLoopFuture<CreateComputeEnvironmentResponse> {
    ...
    public func deleteComputeEnvironment(_ input: DeleteComputeEnvironmentRequest) throws -> EventLoopFuture<DeleteComputeEnvironmentResponse> {
        return try client.send(operation: "DeleteComputeEnvironment", path: "/v1/deletecomputeenvironment", httpMethod: "POST", input: input)
    }

    ///  Updates a job queue.
    public func updateJobQueue(_ input: UpdateJobQueueRequest) throws -> EventLoopFuture<UpdateJobQueueResponse> {
