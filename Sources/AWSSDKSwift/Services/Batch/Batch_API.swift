...
public struct Batch {
    ...
    public func createComputeEnvironment(_ input: CreateComputeEnvironmentRequest) -> Future<CreateComputeEnvironmentResponse> {
    ...
    public func createJobQueue(_ input: CreateJobQueueRequest) -> Future<CreateJobQueueResponse> {
    ...
    public func deleteComputeEnvironment(_ input: DeleteComputeEnvironmentRequest) -> Future<DeleteComputeEnvironmentResponse> {
    ...
    public func deregisterJobDefinition(_ input: DeregisterJobDefinitionRequest) -> Future<DeregisterJobDefinitionResponse> {
    ...
    public func describeComputeEnvironments(_ input: DescribeComputeEnvironmentsRequest) -> Future<DescribeComputeEnvironmentsResponse> {
    ...
    public func describeJobDefinitions(_ input: DescribeJobDefinitionsRequest) -> Future<DescribeJobDefinitionsResponse> {
        return client.send(operation: "DescribeJobDefinitions", path: "/v1/describejobdefinitions", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your job queues.
    public func describeJobQueues(_ input: DescribeJobQueuesRequest) -> Future<DescribeJobQueuesResponse> {
        return client.send(operation: "DescribeJobQueues", path: "/v1/describejobqueues", httpMethod: "POST", input: input)
    }

    ///  Describes a list of AWS Batch jobs.
    public func describeJobs(_ input: DescribeJobsRequest) -> Future<DescribeJobsResponse> {
    ...
    public func terminateJob(_ input: TerminateJobRequest) -> Future<TerminateJobResponse> {
        return client.send(operation: "TerminateJob", path: "/v1/terminatejob", httpMethod: "POST", input: input)
    }

    ///  Updates an AWS Batch compute environment.
    public func updateComputeEnvironment(_ input: UpdateComputeEnvironmentRequest) -> Future<UpdateComputeEnvironmentResponse> {
        return client.send(operation: "UpdateComputeEnvironment", path: "/v1/updatecomputeenvironment", httpMethod: "POST", input: input)
    }

    ///  Updates a job queue.
    public func updateJobQueue(_ input: UpdateJobQueueRequest) -> Future<UpdateJobQueueResponse> {
