...
public struct Batch {
    ...
    public func cancelJob(_ input: CancelJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelJobResponse> {
        return client.execute(operation: "CancelJob", path: "/v1/canceljob", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createComputeEnvironment(_ input: CreateComputeEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateComputeEnvironmentResponse> {
        return client.execute(operation: "CreateComputeEnvironment", path: "/v1/createcomputeenvironment", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createJobQueue(_ input: CreateJobQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateJobQueueResponse> {
        return client.execute(operation: "CreateJobQueue", path: "/v1/createjobqueue", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteComputeEnvironment(_ input: DeleteComputeEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteComputeEnvironmentResponse> {
        return client.execute(operation: "DeleteComputeEnvironment", path: "/v1/deletecomputeenvironment", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteJobQueue(_ input: DeleteJobQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteJobQueueResponse> {
        return client.execute(operation: "DeleteJobQueue", path: "/v1/deletejobqueue", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deregisterJobDefinition(_ input: DeregisterJobDefinitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterJobDefinitionResponse> {
        return client.execute(operation: "DeregisterJobDefinition", path: "/v1/deregisterjobdefinition", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeComputeEnvironments(_ input: DescribeComputeEnvironmentsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeComputeEnvironmentsResponse> {
        return client.execute(operation: "DescribeComputeEnvironments", path: "/v1/describecomputeenvironments", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeJobDefinitions(_ input: DescribeJobDefinitionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeJobDefinitionsResponse> {
        return client.execute(operation: "DescribeJobDefinitions", path: "/v1/describejobdefinitions", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeJobQueues(_ input: DescribeJobQueuesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeJobQueuesResponse> {
        return client.execute(operation: "DescribeJobQueues", path: "/v1/describejobqueues", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeJobs(_ input: DescribeJobsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeJobsResponse> {
        return client.execute(operation: "DescribeJobs", path: "/v1/describejobs", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listJobs(_ input: ListJobsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJobsResponse> {
        return client.execute(operation: "ListJobs", path: "/v1/listjobs", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func registerJobDefinition(_ input: RegisterJobDefinitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterJobDefinitionResponse> {
        return client.execute(operation: "RegisterJobDefinition", path: "/v1/registerjobdefinition", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func submitJob(_ input: SubmitJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubmitJobResponse> {
        return client.execute(operation: "SubmitJob", path: "/v1/submitjob", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func terminateJob(_ input: TerminateJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TerminateJobResponse> {
        return client.execute(operation: "TerminateJob", path: "/v1/terminatejob", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateComputeEnvironment(_ input: UpdateComputeEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateComputeEnvironmentResponse> {
        return client.execute(operation: "UpdateComputeEnvironment", path: "/v1/updatecomputeenvironment", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateJobQueue(_ input: UpdateJobQueueRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateJobQueueResponse> {
        return client.execute(operation: "UpdateJobQueue", path: "/v1/updatejobqueue", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
