...
extension Batch {
    ...
    public func describeComputeEnvironmentsPaginator(_ input: DescribeComputeEnvironmentsRequest, onPage: @escaping ([ComputeEnvironmentDetail], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeComputeEnvironments, resultKey: \DescribeComputeEnvironmentsResponse.computeEnvironments, tokenKey: \DescribeComputeEnvironmentsResponse.nextToken, onPage: onPage)
    }
    
    ///  Describes a list of job definitions. You can specify a status (such as ACTIVE) to only return job definitions that match that status.
    public func describeJobDefinitionsPaginator(_ input: DescribeJobDefinitionsRequest, onPage: @escaping ([JobDefinition], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeJobDefinitions, resultKey: \DescribeJobDefinitionsResponse.jobDefinitions, tokenKey: \DescribeJobDefinitionsResponse.nextToken, onPage: onPage)
    }
    
    ///  Describes one or more of your job queues.
    public func describeJobQueuesPaginator(_ input: DescribeJobQueuesRequest, onPage: @escaping ([JobQueueDetail], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeJobQueues, resultKey: \DescribeJobQueuesResponse.jobQueues, tokenKey: \DescribeJobQueuesResponse.nextToken, onPage: onPage)
    }
    ...
    public func listJobsPaginator(_ input: ListJobsRequest, onPage: @escaping ([JobSummary], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listJobs, resultKey: \ListJobsResponse.jobSummaryList, tokenKey: \ListJobsResponse.nextToken, onPage: onPage)
    }
