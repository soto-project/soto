...
extension Batch {
    ...
    public func describeComputeEnvironmentsPaginator(_ input: DescribeComputeEnvironmentsRequest) -> EventLoopFuture<[ComputeEnvironmentDetail]> {
        return client.paginate(input: input, command: describeComputeEnvironments, resultKey: \DescribeComputeEnvironmentsResponse.computeEnvironments, tokenKey: \DescribeComputeEnvironmentsResponse.nextToken)
    }
    ...
    public func describeJobDefinitionsPaginator(_ input: DescribeJobDefinitionsRequest) -> EventLoopFuture<[JobDefinition]> {
        return client.paginate(input: input, command: describeJobDefinitions, resultKey: \DescribeJobDefinitionsResponse.jobDefinitions, tokenKey: \DescribeJobDefinitionsResponse.nextToken)
    }
    
    ///  Describes one or more of your job queues.
    public func describeJobQueuesPaginator(_ input: DescribeJobQueuesRequest) -> EventLoopFuture<[JobQueueDetail]> {
        return client.paginate(input: input, command: describeJobQueues, resultKey: \DescribeJobQueuesResponse.jobQueues, tokenKey: \DescribeJobQueuesResponse.nextToken)
    }
    ...
    public func listJobsPaginator(_ input: ListJobsRequest) -> EventLoopFuture<[JobSummary]> {
        return client.paginate(input: input, command: listJobs, resultKey: \ListJobsResponse.jobSummaryList, tokenKey: \ListJobsResponse.nextToken)
    }
