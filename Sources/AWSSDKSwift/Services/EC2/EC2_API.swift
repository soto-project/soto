...
public struct EC2 {
    ...
    public func describeTransitGateways(_ input: DescribeTransitGatewaysRequest) throws -> EventLoopFuture<DescribeTransitGatewaysResult> {
        return try client.send(operation: "DescribeTransitGateways", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the VPC endpoint connections to your VPC endpoint services, including any endpoints that are pending your acceptance.
    public func describeVpcEndpointConnections(_ input: DescribeVpcEndpointConnectionsRequest) throws -> EventLoopFuture<DescribeVpcEndpointConnectionsResult> {
    ...
    public func updateSecurityGroupRuleDescriptionsIngress(_ input: UpdateSecurityGroupRuleDescriptionsIngressRequest) throws -> EventLoopFuture<UpdateSecurityGroupRuleDescriptionsIngressResult> {
    ...
    public func getTransitGatewayRouteTableAssociations(_ input: GetTransitGatewayRouteTableAssociationsRequest) throws -> EventLoopFuture<GetTransitGatewayRouteTableAssociationsResult> {
    ...
    public func getPasswordData(_ input: GetPasswordDataRequest) throws -> EventLoopFuture<GetPasswordDataResult> {
    ...
    public func copySnapshot(_ input: CopySnapshotRequest) throws -> EventLoopFuture<CopySnapshotResult> {
    ...
    public func createRoute(_ input: CreateRouteRequest) throws -> EventLoopFuture<CreateRouteResult> {
    ...
    public func describePrefixLists(_ input: DescribePrefixListsRequest) throws -> EventLoopFuture<DescribePrefixListsResult> {
    ...
    public func createSubnet(_ input: CreateSubnetRequest) throws -> EventLoopFuture<CreateSubnetResult> {
    ...
    public func describeSpotFleetRequests(_ input: DescribeSpotFleetRequestsRequest) throws -> EventLoopFuture<DescribeSpotFleetRequestsResponse> {
    ...
    public func createEgressOnlyInternetGateway(_ input: CreateEgressOnlyInternetGatewayRequest) throws -> EventLoopFuture<CreateEgressOnlyInternetGatewayResult> {
    ...
    public func associateRouteTable(_ input: AssociateRouteTableRequest) throws -> EventLoopFuture<AssociateRouteTableResult> {
    ...
    public func deleteLaunchTemplate(_ input: DeleteLaunchTemplateRequest) throws -> EventLoopFuture<DeleteLaunchTemplateResult> {
    ...
    public func deleteNatGateway(_ input: DeleteNatGatewayRequest) throws -> EventLoopFuture<DeleteNatGatewayResult> {
    ...
    public func purchaseReservedInstancesOffering(_ input: PurchaseReservedInstancesOfferingRequest) throws -> EventLoopFuture<PurchaseReservedInstancesOfferingResult> {
    ...
    public func getReservedInstancesExchangeQuote(_ input: GetReservedInstancesExchangeQuoteRequest) throws -> EventLoopFuture<GetReservedInstancesExchangeQuoteResult> {
    ...
    public func modifyFleet(_ input: ModifyFleetRequest) throws -> EventLoopFuture<ModifyFleetResult> {
    ...
    public func modifySpotFleetRequest(_ input: ModifySpotFleetRequestRequest) throws -> EventLoopFuture<ModifySpotFleetRequestResponse> {
    ...
    public func withdrawByoipCidr(_ input: WithdrawByoipCidrRequest) throws -> EventLoopFuture<WithdrawByoipCidrResult> {
        return try client.send(operation: "WithdrawByoipCidr", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your VPCs.
    public func describeVpcs(_ input: DescribeVpcsRequest) throws -> EventLoopFuture<DescribeVpcsResult> {
        return try client.send(operation: "DescribeVpcs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the ClassicLink status of one or more VPCs.
    public func describeVpcClassicLink(_ input: DescribeVpcClassicLinkRequest) throws -> EventLoopFuture<DescribeVpcClassicLinkResult> {
    ...
    public func createTransitGatewayRouteTable(_ input: CreateTransitGatewayRouteTableRequest) throws -> EventLoopFuture<CreateTransitGatewayRouteTableResult> {
    ...
    public func createLaunchTemplateVersion(_ input: CreateLaunchTemplateVersionRequest) throws -> EventLoopFuture<CreateLaunchTemplateVersionResult> {
    ...
    public func terminateInstances(_ input: TerminateInstancesRequest) throws -> EventLoopFuture<TerminateInstancesResult> {
        return try client.send(operation: "TerminateInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables the specified attachment to propagate routes to the specified propagation route table.
    public func enableTransitGatewayRouteTablePropagation(_ input: EnableTransitGatewayRouteTablePropagationRequest) throws -> EventLoopFuture<EnableTransitGatewayRouteTablePropagationResult> {
    ...
    public func describeImages(_ input: DescribeImagesRequest) throws -> EventLoopFuture<DescribeImagesResult> {
    ...
    public func replaceRouteTableAssociation(_ input: ReplaceRouteTableAssociationRequest) throws -> EventLoopFuture<ReplaceRouteTableAssociationResult> {
    ...
    public func advertiseByoipCidr(_ input: AdvertiseByoipCidrRequest) throws -> EventLoopFuture<AdvertiseByoipCidrResult> {
        return try client.send(operation: "AdvertiseByoipCidr", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the route table propagations for the specified transit gateway route table.
    public func getTransitGatewayRouteTablePropagations(_ input: GetTransitGatewayRouteTablePropagationsRequest) throws -> EventLoopFuture<GetTransitGatewayRouteTablePropagationsResult> {
    ...
    public func deleteEgressOnlyInternetGateway(_ input: DeleteEgressOnlyInternetGatewayRequest) throws -> EventLoopFuture<DeleteEgressOnlyInternetGatewayResult> {
    ...
    public func replaceIamInstanceProfileAssociation(_ input: ReplaceIamInstanceProfileAssociationRequest) throws -> EventLoopFuture<ReplaceIamInstanceProfileAssociationResult> {
    ...
    public func describeNetworkInterfaceAttribute(_ input: DescribeNetworkInterfaceAttributeRequest) throws -> EventLoopFuture<DescribeNetworkInterfaceAttributeResult> {
    ...
    public func deleteVpcPeeringConnection(_ input: DeleteVpcPeeringConnectionRequest) throws -> EventLoopFuture<DeleteVpcPeeringConnectionResult> {
    ...
    public func describeSecurityGroups(_ input: DescribeSecurityGroupsRequest) throws -> EventLoopFuture<DescribeSecurityGroupsResult> {
        return try client.send(operation: "DescribeSecurityGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates a CIDR block with your subnet. You can only associate a single IPv6 CIDR block with your subnet. An IPv6 CIDR block must have a prefix length of /64.
    public func associateSubnetCidrBlock(_ input: AssociateSubnetCidrBlockRequest) throws -> EventLoopFuture<AssociateSubnetCidrBlockResult> {
        return try client.send(operation: "AssociateSubnetCidrBlock", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels an in-process import virtual machine or import snapshot task.
    public func cancelImportTask(_ input: CancelImportTaskRequest) throws -> EventLoopFuture<CancelImportTaskResult> {
    ...
    public func createNatGateway(_ input: CreateNatGatewayRequest) throws -> EventLoopFuture<CreateNatGatewayResult> {
    ...
    public func modifyVpcPeeringConnectionOptions(_ input: ModifyVpcPeeringConnectionOptionsRequest) throws -> EventLoopFuture<ModifyVpcPeeringConnectionOptionsResult> {
    ...
    public func runScheduledInstances(_ input: RunScheduledInstancesRequest) throws -> EventLoopFuture<RunScheduledInstancesResult> {
    ...
    public func createCustomerGateway(_ input: CreateCustomerGatewayRequest) throws -> EventLoopFuture<CreateCustomerGatewayResult> {
    ...
    public func describeClassicLinkInstances(_ input: DescribeClassicLinkInstancesRequest) throws -> EventLoopFuture<DescribeClassicLinkInstancesResult> {
    ...
    public func attachVpnGateway(_ input: AttachVpnGatewayRequest) throws -> EventLoopFuture<AttachVpnGatewayResult> {
    ...
    public func describeVolumesModifications(_ input: DescribeVolumesModificationsRequest) throws -> EventLoopFuture<DescribeVolumesModificationsResult> {
    ...
    public func purchaseHostReservation(_ input: PurchaseHostReservationRequest) throws -> EventLoopFuture<PurchaseHostReservationResult> {
    ...
    public func replaceNetworkAclAssociation(_ input: ReplaceNetworkAclAssociationRequest) throws -> EventLoopFuture<ReplaceNetworkAclAssociationResult> {
        return try client.send(operation: "ReplaceNetworkAclAssociation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the running instances for the specified Spot Fleet.
    public func describeSpotFleetInstances(_ input: DescribeSpotFleetInstancesRequest) throws -> EventLoopFuture<DescribeSpotFleetInstancesResponse> {
    ...
    public func describeFpgaImages(_ input: DescribeFpgaImagesRequest) throws -> EventLoopFuture<DescribeFpgaImagesResult> {
        return try client.send(operation: "DescribeFpgaImages", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables detailed monitoring for a running instance. For more information, see Monitoring Your Instances and Volumes in the Amazon Elastic Compute Cloud User Guide.
    public func unmonitorInstances(_ input: UnmonitorInstancesRequest) throws -> EventLoopFuture<UnmonitorInstancesResult> {
    ...
    public func requestSpotInstances(_ input: RequestSpotInstancesRequest) throws -> EventLoopFuture<RequestSpotInstancesResult> {
    ...
    public func modifyReservedInstances(_ input: ModifyReservedInstancesRequest) throws -> EventLoopFuture<ModifyReservedInstancesResult> {
    ...
    public func createInstanceExportTask(_ input: CreateInstanceExportTaskRequest) throws -> EventLoopFuture<CreateInstanceExportTaskResult> {
    ...
    public func searchTransitGatewayRoutes(_ input: SearchTransitGatewayRoutesRequest) throws -> EventLoopFuture<SearchTransitGatewayRoutesResult> {
    ...
    public func createRouteTable(_ input: CreateRouteTableRequest) throws -> EventLoopFuture<CreateRouteTableResult> {
    ...
    public func describeInstanceAttribute(_ input: DescribeInstanceAttributeRequest) throws -> EventLoopFuture<InstanceAttribute> {
    ...
    public func describeAccountAttributes(_ input: DescribeAccountAttributesRequest) throws -> EventLoopFuture<DescribeAccountAttributesResult> {
    ...
    public func describeFleets(_ input: DescribeFleetsRequest) throws -> EventLoopFuture<DescribeFleetsResult> {
    ...
    public func deleteLaunchTemplateVersions(_ input: DeleteLaunchTemplateVersionsRequest) throws -> EventLoopFuture<DeleteLaunchTemplateVersionsResult> {
    ...
    public func importImage(_ input: ImportImageRequest) throws -> EventLoopFuture<ImportImageResult> {
    ...
    public func createNetworkInterfacePermission(_ input: CreateNetworkInterfacePermissionRequest) throws -> EventLoopFuture<CreateNetworkInterfacePermissionResult> {
    ...
    public func createSpotDatafeedSubscription(_ input: CreateSpotDatafeedSubscriptionRequest) throws -> EventLoopFuture<CreateSpotDatafeedSubscriptionResult> {
        return try client.send(operation: "CreateSpotDatafeedSubscription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Rejects one or more VPC endpoint connection requests to your VPC endpoint service.
    public func rejectVpcEndpointConnections(_ input: RejectVpcEndpointConnectionsRequest) throws -> EventLoopFuture<RejectVpcEndpointConnectionsResult> {
    ...
    public func deleteTransitGateway(_ input: DeleteTransitGatewayRequest) throws -> EventLoopFuture<DeleteTransitGatewayResult> {
    ...
    public func describeReservedInstancesListings(_ input: DescribeReservedInstancesListingsRequest) throws -> EventLoopFuture<DescribeReservedInstancesListingsResult> {
        return try client.send(operation: "DescribeReservedInstancesListings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Copies the specified Amazon FPGA Image (AFI) to the current region.
    public func copyFpgaImage(_ input: CopyFpgaImageRequest) throws -> EventLoopFuture<CopyFpgaImageResult> {
        return try client.send(operation: "CopyFpgaImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a connection notification for VPC endpoint or VPC endpoint service. You can change the SNS topic for the notification, or the events for which to be notified. 
    public func modifyVpcEndpointConnectionNotification(_ input: ModifyVpcEndpointConnectionNotificationRequest) throws -> EventLoopFuture<ModifyVpcEndpointConnectionNotificationResult> {
    ...
    public func runInstances(_ input: RunInstancesRequest) throws -> EventLoopFuture<Reservation> {
    ...
    public func deleteNetworkInterfacePermission(_ input: DeleteNetworkInterfacePermissionRequest) throws -> EventLoopFuture<DeleteNetworkInterfacePermissionResult> {
    ...
    public func deleteFlowLogs(_ input: DeleteFlowLogsRequest) throws -> EventLoopFuture<DeleteFlowLogsResult> {
    ...
    public func describeHosts(_ input: DescribeHostsRequest) throws -> EventLoopFuture<DescribeHostsResult> {
    ...
    public func copyImage(_ input: CopyImageRequest) throws -> EventLoopFuture<CopyImageResult> {
    ...
    public func createLaunchTemplate(_ input: CreateLaunchTemplateRequest) throws -> EventLoopFuture<CreateLaunchTemplateResult> {
    ...
    public func bundleInstance(_ input: BundleInstanceRequest) throws -> EventLoopFuture<BundleInstanceResult> {
        return try client.send(operation: "BundleInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes your import snapshot tasks.
    public func describeImportSnapshotTasks(_ input: DescribeImportSnapshotTasksRequest) throws -> EventLoopFuture<DescribeImportSnapshotTasksResult> {
    ...
    public func importInstance(_ input: ImportInstanceRequest) throws -> EventLoopFuture<ImportInstanceResult> {
        return try client.send(operation: "ImportInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the principals (service consumers) that are permitted to discover your VPC endpoint service.
    public func describeVpcEndpointServicePermissions(_ input: DescribeVpcEndpointServicePermissionsRequest) throws -> EventLoopFuture<DescribeVpcEndpointServicePermissionsResult> {
    ...
    public func modifyCapacityReservation(_ input: ModifyCapacityReservationRequest) throws -> EventLoopFuture<ModifyCapacityReservationResult> {
        return try client.send(operation: "ModifyCapacityReservation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your export tasks.
    public func describeExportTasks(_ input: DescribeExportTasksRequest) throws -> EventLoopFuture<DescribeExportTasksResult> {
    ...
    public func startInstances(_ input: StartInstancesRequest) throws -> EventLoopFuture<StartInstancesResult> {
        return try client.send(operation: "StartInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes reservations that are associated with Dedicated Hosts in your account.
    public func describeHostReservations(_ input: DescribeHostReservationsRequest) throws -> EventLoopFuture<DescribeHostReservationsResult> {
    ...
    public func describeVpcPeeringConnections(_ input: DescribeVpcPeeringConnectionsRequest) throws -> EventLoopFuture<DescribeVpcPeeringConnectionsResult> {
    ...
    public func assignIpv6Addresses(_ input: AssignIpv6AddressesRequest) throws -> EventLoopFuture<AssignIpv6AddressesResult> {
    ...
    public func getConsoleScreenshot(_ input: GetConsoleScreenshotRequest) throws -> EventLoopFuture<GetConsoleScreenshotResult> {
        return try client.send(operation: "GetConsoleScreenshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the route tables to which the specified resource attachment propagates routes.
    public func getTransitGatewayAttachmentPropagations(_ input: GetTransitGatewayAttachmentPropagationsRequest) throws -> EventLoopFuture<GetTransitGatewayAttachmentPropagationsResult> {
    ...
    public func describeSpotFleetRequestHistory(_ input: DescribeSpotFleetRequestHistoryRequest) throws -> EventLoopFuture<DescribeSpotFleetRequestHistoryResponse> {
    ...
    public func associateIamInstanceProfile(_ input: AssociateIamInstanceProfileRequest) throws -> EventLoopFuture<AssociateIamInstanceProfileResult> {
    ...
    public func describeMovingAddresses(_ input: DescribeMovingAddressesRequest) throws -> EventLoopFuture<DescribeMovingAddressesResult> {
    ...
    public func confirmProductInstance(_ input: ConfirmProductInstanceRequest) throws -> EventLoopFuture<ConfirmProductInstanceResult> {
        return try client.send(operation: "ConfirmProductInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your network interfaces.
    public func describeNetworkInterfaces(_ input: DescribeNetworkInterfacesRequest) throws -> EventLoopFuture<DescribeNetworkInterfacesResult> {
        return try client.send(operation: "DescribeNetworkInterfaces", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more launch templates.
    public func describeLaunchTemplates(_ input: DescribeLaunchTemplatesRequest) throws -> EventLoopFuture<DescribeLaunchTemplatesResult> {
    ...
    public func describeFlowLogs(_ input: DescribeFlowLogsRequest) throws -> EventLoopFuture<DescribeFlowLogsResult> {
    ...
    public func createFpgaImage(_ input: CreateFpgaImageRequest) throws -> EventLoopFuture<CreateFpgaImageResult> {
    ...
    public func createVpcEndpointConnectionNotification(_ input: CreateVpcEndpointConnectionNotificationRequest) throws -> EventLoopFuture<CreateVpcEndpointConnectionNotificationResult> {
    ...
    public func deleteTransitGatewayRouteTable(_ input: DeleteTransitGatewayRouteTableRequest) throws -> EventLoopFuture<DeleteTransitGatewayRouteTableResult> {
    ...
    public func importVolume(_ input: ImportVolumeRequest) throws -> EventLoopFuture<ImportVolumeResult> {
    ...
    public func describeIdFormat(_ input: DescribeIdFormatRequest) throws -> EventLoopFuture<DescribeIdFormatResult> {
    ...
    public func modifyVpcTenancy(_ input: ModifyVpcTenancyRequest) throws -> EventLoopFuture<ModifyVpcTenancyResult> {
        return try client.send(operation: "ModifyVpcTenancy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the permissions for your network interfaces. 
    public func describeNetworkInterfacePermissions(_ input: DescribeNetworkInterfacePermissionsRequest) throws -> EventLoopFuture<DescribeNetworkInterfacePermissionsResult> {
    ...
    public func associateVpcCidrBlock(_ input: AssociateVpcCidrBlockRequest) throws -> EventLoopFuture<AssociateVpcCidrBlockResult> {
    ...
    public func createInternetGateway(_ input: CreateInternetGatewayRequest) throws -> EventLoopFuture<CreateInternetGatewayResult> {
    ...
    public func describeAggregateIdFormat(_ input: DescribeAggregateIdFormatRequest) throws -> EventLoopFuture<DescribeAggregateIdFormatResult> {
    ...
    public func describeReservedInstancesModifications(_ input: DescribeReservedInstancesModificationsRequest) throws -> EventLoopFuture<DescribeReservedInstancesModificationsResult> {
    ...
    public func describeScheduledInstanceAvailability(_ input: DescribeScheduledInstanceAvailabilityRequest) throws -> EventLoopFuture<DescribeScheduledInstanceAvailabilityResult> {
    ...
    public func createDefaultSubnet(_ input: CreateDefaultSubnetRequest) throws -> EventLoopFuture<CreateDefaultSubnetResult> {
    ...
    public func attachClassicLinkVpc(_ input: AttachClassicLinkVpcRequest) throws -> EventLoopFuture<AttachClassicLinkVpcResult> {
        return try client.send(operation: "AttachClassicLinkVpc", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels a bundling operation for an instance store-backed Windows instance.
    public func cancelBundleTask(_ input: CancelBundleTaskRequest) throws -> EventLoopFuture<CancelBundleTaskResult> {
    ...
    public func describeCustomerGateways(_ input: DescribeCustomerGatewaysRequest) throws -> EventLoopFuture<DescribeCustomerGatewaysResult> {
    ...
    public func cancelReservedInstancesListing(_ input: CancelReservedInstancesListingRequest) throws -> EventLoopFuture<CancelReservedInstancesListingResult> {
    ...
    public func createDhcpOptions(_ input: CreateDhcpOptionsRequest) throws -> EventLoopFuture<CreateDhcpOptionsResult> {
        return try client.send(operation: "CreateDhcpOptions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Resets the specified attribute of the specified Amazon FPGA Image (AFI) to its default value. You can only reset the load permission attribute.
    public func resetFpgaImageAttribute(_ input: ResetFpgaImageAttributeRequest) throws -> EventLoopFuture<ResetFpgaImageAttributeResult> {
    ...
    public func rejectTransitGatewayVpcAttachment(_ input: RejectTransitGatewayVpcAttachmentRequest) throws -> EventLoopFuture<RejectTransitGatewayVpcAttachmentResult> {
    ...
    public func getHostReservationPurchasePreview(_ input: GetHostReservationPurchasePreviewRequest) throws -> EventLoopFuture<GetHostReservationPurchasePreviewResult> {
    ...
    public func enableVpcClassicLinkDnsSupport(_ input: EnableVpcClassicLinkDnsSupportRequest) throws -> EventLoopFuture<EnableVpcClassicLinkDnsSupportResult> {
    ...
    public func acceptTransitGatewayVpcAttachment(_ input: AcceptTransitGatewayVpcAttachmentRequest) throws -> EventLoopFuture<AcceptTransitGatewayVpcAttachmentResult> {
    ...
    public func purchaseScheduledInstances(_ input: PurchaseScheduledInstancesRequest) throws -> EventLoopFuture<PurchaseScheduledInstancesResult> {
    ...
    public func createVpnGateway(_ input: CreateVpnGatewayRequest) throws -> EventLoopFuture<CreateVpnGatewayResult> {
    ...
    public func describeRouteTables(_ input: DescribeRouteTablesRequest) throws -> EventLoopFuture<DescribeRouteTablesResult> {
        return try client.send(operation: "DescribeRouteTables", path: "/", httpMethod: "POST", input: input)
    }

    ///  Imports a disk into an EBS snapshot.
    public func importSnapshot(_ input: ImportSnapshotRequest) throws -> EventLoopFuture<ImportSnapshotResult> {
    ...
    public func modifyVolume(_ input: ModifyVolumeRequest) throws -> EventLoopFuture<ModifyVolumeResult> {
    ...
    public func disassociateIamInstanceProfile(_ input: DisassociateIamInstanceProfileRequest) throws -> EventLoopFuture<DisassociateIamInstanceProfileResult> {
    ...
    public func createVolume(_ input: CreateVolumeRequest) throws -> EventLoopFuture<Volume> {
    ...
    public func describeVpcEndpointConnectionNotifications(_ input: DescribeVpcEndpointConnectionNotificationsRequest) throws -> EventLoopFuture<DescribeVpcEndpointConnectionNotificationsResult> {
    ...
    public func describeRegions(_ input: DescribeRegionsRequest) throws -> EventLoopFuture<DescribeRegionsResult> {
        return try client.send(operation: "DescribeRegions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes one or more VPC endpoint connection notifications.
    public func deleteVpcEndpointConnectionNotifications(_ input: DeleteVpcEndpointConnectionNotificationsRequest) throws -> EventLoopFuture<DeleteVpcEndpointConnectionNotificationsResult> {
    ...
    public func createFleet(_ input: CreateFleetRequest) throws -> EventLoopFuture<CreateFleetResult> {
    ...
    public func createVpcEndpointServiceConfiguration(_ input: CreateVpcEndpointServiceConfigurationRequest) throws -> EventLoopFuture<CreateVpcEndpointServiceConfigurationResult> {
    ...
    public func describePrincipalIdFormat(_ input: DescribePrincipalIdFormatRequest) throws -> EventLoopFuture<DescribePrincipalIdFormatResult> {
    ...
    public func releaseHosts(_ input: ReleaseHostsRequest) throws -> EventLoopFuture<ReleaseHostsResult> {
    ...
    public func createCapacityReservation(_ input: CreateCapacityReservationRequest) throws -> EventLoopFuture<CreateCapacityReservationResult> {
    ...
    public func createVpnConnection(_ input: CreateVpnConnectionRequest) throws -> EventLoopFuture<CreateVpnConnectionResult> {
        return try client.send(operation: "CreateVpnConnection", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified attribute of the specified VPC. You can specify only one attribute at a time.
    public func describeVpcAttribute(_ input: DescribeVpcAttributeRequest) throws -> EventLoopFuture<DescribeVpcAttributeResult> {
    ...
    public func modifyInstancePlacement(_ input: ModifyInstancePlacementRequest) throws -> EventLoopFuture<ModifyInstancePlacementResult> {
        return try client.send(operation: "ModifyInstancePlacement", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the running instances for the specified EC2 Fleet.
    public func describeFleetInstances(_ input: DescribeFleetInstancesRequest) throws -> EventLoopFuture<DescribeFleetInstancesResult> {
    ...
    public func describeVpnGateways(_ input: DescribeVpnGatewaysRequest) throws -> EventLoopFuture<DescribeVpnGatewaysResult> {
    ...
    public func modifyLaunchTemplate(_ input: ModifyLaunchTemplateRequest) throws -> EventLoopFuture<ModifyLaunchTemplateResult> {
    ...
    public func associateAddress(_ input: AssociateAddressRequest) throws -> EventLoopFuture<AssociateAddressResult> {
        return try client.send(operation: "AssociateAddress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the data feed for Spot Instances. For more information, see Spot Instance Data Feed in the Amazon EC2 User Guide for Linux Instances.
    public func describeSpotDatafeedSubscription(_ input: DescribeSpotDatafeedSubscriptionRequest) throws -> EventLoopFuture<DescribeSpotDatafeedSubscriptionResult> {
    ...
    public func attachVolume(_ input: AttachVolumeRequest) throws -> EventLoopFuture<VolumeAttachment> {
        return try client.send(operation: "AttachVolume", path: "/", httpMethod: "POST", input: input)
    }

    ///  Accepts the Convertible Reserved Instance exchange quote described in the GetReservedInstancesExchangeQuote call.
    public func acceptReservedInstancesExchangeQuote(_ input: AcceptReservedInstancesExchangeQuoteRequest) throws -> EventLoopFuture<AcceptReservedInstancesExchangeQuoteResult> {
    ...
    public func disableVpcClassicLink(_ input: DisableVpcClassicLinkRequest) throws -> EventLoopFuture<DisableVpcClassicLinkResult> {
        return try client.send(operation: "DisableVpcClassicLink", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified attribute of the specified AMI. You can specify only one attribute at a time.
    public func describeImageAttribute(_ input: DescribeImageAttributeRequest) throws -> EventLoopFuture<ImageAttribute> {
    ...
    public func describeHostReservationOfferings(_ input: DescribeHostReservationOfferingsRequest) throws -> EventLoopFuture<DescribeHostReservationOfferingsResult> {
    ...
    public func describeElasticGpus(_ input: DescribeElasticGpusRequest) throws -> EventLoopFuture<DescribeElasticGpusResult> {
    ...
    public func updateSecurityGroupRuleDescriptionsEgress(_ input: UpdateSecurityGroupRuleDescriptionsEgressRequest) throws -> EventLoopFuture<UpdateSecurityGroupRuleDescriptionsEgressResult> {
    ...
    public func describeSecurityGroupReferences(_ input: DescribeSecurityGroupReferencesRequest) throws -> EventLoopFuture<DescribeSecurityGroupReferencesResult> {
    ...
    public func exportTransitGatewayRoutes(_ input: ExportTransitGatewayRoutesRequest) throws -> EventLoopFuture<ExportTransitGatewayRoutesResult> {
        return try client.send(operation: "ExportTransitGatewayRoutes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes available services to which you can create a VPC endpoint.
    public func describeVpcEndpointServices(_ input: DescribeVpcEndpointServicesRequest) throws -> EventLoopFuture<DescribeVpcEndpointServicesResult> {
    ...
    public func describeInstances(_ input: DescribeInstancesRequest) throws -> EventLoopFuture<DescribeInstancesResult> {
        return try client.send(operation: "DescribeInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your Scheduled Instances.
    public func describeScheduledInstances(_ input: DescribeScheduledInstancesRequest) throws -> EventLoopFuture<DescribeScheduledInstancesResult> {
    ...
    public func createTransitGatewayVpcAttachment(_ input: CreateTransitGatewayVpcAttachmentRequest) throws -> EventLoopFuture<CreateTransitGatewayVpcAttachmentResult> {
    ...
    public func enableVpcClassicLink(_ input: EnableVpcClassicLinkRequest) throws -> EventLoopFuture<EnableVpcClassicLinkResult> {
        return try client.send(operation: "EnableVpcClassicLink", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a static route for the specified transit gateway route table.
    public func createTransitGatewayRoute(_ input: CreateTransitGatewayRouteRequest) throws -> EventLoopFuture<CreateTransitGatewayRouteResult> {
    ...
    public func cancelCapacityReservation(_ input: CancelCapacityReservationRequest) throws -> EventLoopFuture<CancelCapacityReservationResult> {
    ...
    public func describeReservedInstancesOfferings(_ input: DescribeReservedInstancesOfferingsRequest) throws -> EventLoopFuture<DescribeReservedInstancesOfferingsResult> {
        return try client.send(operation: "DescribeReservedInstancesOfferings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your internet gateways.
    public func describeInternetGateways(_ input: DescribeInternetGatewaysRequest) throws -> EventLoopFuture<DescribeInternetGatewaysResult> {
        return try client.send(operation: "DescribeInternetGateways", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the VPC endpoint service configurations in your account (your services).
    public func describeVpcEndpointServiceConfigurations(_ input: DescribeVpcEndpointServiceConfigurationsRequest) throws -> EventLoopFuture<DescribeVpcEndpointServiceConfigurationsResult> {
        return try client.send(operation: "DescribeVpcEndpointServiceConfigurations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified Amazon FPGA Image (AFI).
    public func deleteFpgaImage(_ input: DeleteFpgaImageRequest) throws -> EventLoopFuture<DeleteFpgaImageResult> {
    ...
    public func describeDhcpOptions(_ input: DescribeDhcpOptionsRequest) throws -> EventLoopFuture<DescribeDhcpOptionsResult> {
    ...
    public func describeSpotPriceHistory(_ input: DescribeSpotPriceHistoryRequest) throws -> EventLoopFuture<DescribeSpotPriceHistoryResult> {
        return try client.send(operation: "DescribeSpotPriceHistory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the events for the specified EC2 Fleet during the specified time.
    public func describeFleetHistory(_ input: DescribeFleetHistoryRequest) throws -> EventLoopFuture<DescribeFleetHistoryResult> {
    ...
    public func describeCapacityReservations(_ input: DescribeCapacityReservationsRequest) throws -> EventLoopFuture<DescribeCapacityReservationsResult> {
    ...
    public func detachClassicLinkVpc(_ input: DetachClassicLinkVpcRequest) throws -> EventLoopFuture<DetachClassicLinkVpcResult> {
    ...
    public func describeSubnets(_ input: DescribeSubnetsRequest) throws -> EventLoopFuture<DescribeSubnetsResult> {
        return try client.send(operation: "DescribeSubnets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified route from the specified transit gateway route table.
    public func deleteTransitGatewayRoute(_ input: DeleteTransitGatewayRouteRequest) throws -> EventLoopFuture<DeleteTransitGatewayRouteResult> {
    ...
    public func allocateAddress(_ input: AllocateAddressRequest) throws -> EventLoopFuture<AllocateAddressResult> {
    ...
    public func describeVolumeAttribute(_ input: DescribeVolumeAttributeRequest) throws -> EventLoopFuture<DescribeVolumeAttributeResult> {
    ...
    public func describeTransitGatewayRouteTables(_ input: DescribeTransitGatewayRouteTablesRequest) throws -> EventLoopFuture<DescribeTransitGatewayRouteTablesResult> {
    ...
    public func createSnapshot(_ input: CreateSnapshotRequest) throws -> EventLoopFuture<Snapshot> {
        return try client.send(operation: "CreateSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified VPC attachment.
    public func modifyTransitGatewayVpcAttachment(_ input: ModifyTransitGatewayVpcAttachmentRequest) throws -> EventLoopFuture<ModifyTransitGatewayVpcAttachmentResult> {
    ...
    public func describeAvailabilityZones(_ input: DescribeAvailabilityZonesRequest) throws -> EventLoopFuture<DescribeAvailabilityZonesResult> {
        return try client.send(operation: "DescribeAvailabilityZones", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified attribute of the specified Amazon FPGA Image (AFI).
    public func describeFpgaImageAttribute(_ input: DescribeFpgaImageAttributeRequest) throws -> EventLoopFuture<DescribeFpgaImageAttributeResult> {
    ...
    public func describeIamInstanceProfileAssociations(_ input: DescribeIamInstanceProfileAssociationsRequest) throws -> EventLoopFuture<DescribeIamInstanceProfileAssociationsResult> {
    ...
    public func modifyInstanceCapacityReservationAttributes(_ input: ModifyInstanceCapacityReservationAttributesRequest) throws -> EventLoopFuture<ModifyInstanceCapacityReservationAttributesResult> {
    ...
    public func describeKeyPairs(_ input: DescribeKeyPairsRequest) throws -> EventLoopFuture<DescribeKeyPairsResult> {
    ...
    public func disableVpcClassicLinkDnsSupport(_ input: DisableVpcClassicLinkDnsSupportRequest) throws -> EventLoopFuture<DisableVpcClassicLinkDnsSupportResult> {
    ...
    public func describeStaleSecurityGroups(_ input: DescribeStaleSecurityGroupsRequest) throws -> EventLoopFuture<DescribeStaleSecurityGroupsResult> {
    ...
    public func modifyVpcEndpointServiceConfiguration(_ input: ModifyVpcEndpointServiceConfigurationRequest) throws -> EventLoopFuture<ModifyVpcEndpointServiceConfigurationResult> {
    ...
    public func describeLaunchTemplateVersions(_ input: DescribeLaunchTemplateVersionsRequest) throws -> EventLoopFuture<DescribeLaunchTemplateVersionsResult> {
    ...
    public func createVpcPeeringConnection(_ input: CreateVpcPeeringConnectionRequest) throws -> EventLoopFuture<CreateVpcPeeringConnectionResult> {
    ...
    public func createFlowLogs(_ input: CreateFlowLogsRequest) throws -> EventLoopFuture<CreateFlowLogsResult> {
    ...
    public func deleteVpcEndpoints(_ input: DeleteVpcEndpointsRequest) throws -> EventLoopFuture<DeleteVpcEndpointsResult> {
    ...
    public func describeConversionTasks(_ input: DescribeConversionTasksRequest) throws -> EventLoopFuture<DescribeConversionTasksResult> {
    ...
    public func describeSnapshotAttribute(_ input: DescribeSnapshotAttributeRequest) throws -> EventLoopFuture<DescribeSnapshotAttributeResult> {
    ...
    public func restoreAddressToClassic(_ input: RestoreAddressToClassicRequest) throws -> EventLoopFuture<RestoreAddressToClassicResult> {
    ...
    public func describeBundleTasks(_ input: DescribeBundleTasksRequest) throws -> EventLoopFuture<DescribeBundleTasksResult> {
    ...
    public func deprovisionByoipCidr(_ input: DeprovisionByoipCidrRequest) throws -> EventLoopFuture<DeprovisionByoipCidrResult> {
    ...
    public func createVpcEndpoint(_ input: CreateVpcEndpointRequest) throws -> EventLoopFuture<CreateVpcEndpointResult> {
    ...
    public func describeInstanceCreditSpecifications(_ input: DescribeInstanceCreditSpecificationsRequest) throws -> EventLoopFuture<DescribeInstanceCreditSpecificationsResult> {
    ...
    public func registerImage(_ input: RegisterImageRequest) throws -> EventLoopFuture<RegisterImageResult> {
    ...
    public func cancelSpotFleetRequests(_ input: CancelSpotFleetRequestsRequest) throws -> EventLoopFuture<CancelSpotFleetRequestsResponse> {
    ...
    public func createVpc(_ input: CreateVpcRequest) throws -> EventLoopFuture<CreateVpcResult> {
        return try client.send(operation: "CreateVpc", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates a resource attachment from a transit gateway route table.
    public func disassociateTransitGatewayRouteTable(_ input: DisassociateTransitGatewayRouteTableRequest) throws -> EventLoopFuture<DisassociateTransitGatewayRouteTableResult> {
    ...
    public func getLaunchTemplateData(_ input: GetLaunchTemplateDataRequest) throws -> EventLoopFuture<GetLaunchTemplateDataResult> {
    ...
    public func createReservedInstancesListing(_ input: CreateReservedInstancesListingRequest) throws -> EventLoopFuture<CreateReservedInstancesListingResult> {
    ...
    public func acceptVpcPeeringConnection(_ input: AcceptVpcPeeringConnectionRequest) throws -> EventLoopFuture<AcceptVpcPeeringConnectionResult> {
    ...
    public func describeVolumes(_ input: DescribeVolumesRequest) throws -> EventLoopFuture<DescribeVolumesResult> {
    ...
    public func replaceTransitGatewayRoute(_ input: ReplaceTransitGatewayRouteRequest) throws -> EventLoopFuture<ReplaceTransitGatewayRouteResult> {
    ...
    public func disableTransitGatewayRouteTablePropagation(_ input: DisableTransitGatewayRouteTablePropagationRequest) throws -> EventLoopFuture<DisableTransitGatewayRouteTablePropagationResult> {
    ...
    public func acceptVpcEndpointConnections(_ input: AcceptVpcEndpointConnectionsRequest) throws -> EventLoopFuture<AcceptVpcEndpointConnectionsResult> {
        return try client.send(operation: "AcceptVpcEndpointConnections", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your egress-only internet gateways.
    public func describeEgressOnlyInternetGateways(_ input: DescribeEgressOnlyInternetGatewaysRequest) throws -> EventLoopFuture<DescribeEgressOnlyInternetGatewaysResult> {
    ...
    public func describeTransitGatewayVpcAttachments(_ input: DescribeTransitGatewayVpcAttachmentsRequest) throws -> EventLoopFuture<DescribeTransitGatewayVpcAttachmentsResult> {
    ...
    public func describePlacementGroups(_ input: DescribePlacementGroupsRequest) throws -> EventLoopFuture<DescribePlacementGroupsResult> {
    ...
    public func stopInstances(_ input: StopInstancesRequest) throws -> EventLoopFuture<StopInstancesResult> {
    ...
    public func describeIdentityIdFormat(_ input: DescribeIdentityIdFormatRequest) throws -> EventLoopFuture<DescribeIdentityIdFormatResult> {
    ...
    public func allocateHosts(_ input: AllocateHostsRequest) throws -> EventLoopFuture<AllocateHostsResult> {
    ...
    public func createSecurityGroup(_ input: CreateSecurityGroupRequest) throws -> EventLoopFuture<CreateSecurityGroupResult> {
    ...
    public func detachVolume(_ input: DetachVolumeRequest) throws -> EventLoopFuture<VolumeAttachment> {
    ...
    public func importKeyPair(_ input: ImportKeyPairRequest) throws -> EventLoopFuture<ImportKeyPairResult> {
        return try client.send(operation: "ImportKeyPair", path: "/", httpMethod: "POST", input: input)
    }

    ///  Attaches a network interface to an instance.
    public func attachNetworkInterface(_ input: AttachNetworkInterfaceRequest) throws -> EventLoopFuture<AttachNetworkInterfaceResult> {
    ...
    public func describeSpotInstanceRequests(_ input: DescribeSpotInstanceRequestsRequest) throws -> EventLoopFuture<DescribeSpotInstanceRequestsResult> {
    ...
    public func describeVolumeStatus(_ input: DescribeVolumeStatusRequest) throws -> EventLoopFuture<DescribeVolumeStatusResult> {
    ...
    public func cancelSpotInstanceRequests(_ input: CancelSpotInstanceRequestsRequest) throws -> EventLoopFuture<CancelSpotInstanceRequestsResult> {
    ...
    public func describeNatGateways(_ input: DescribeNatGatewaysRequest) throws -> EventLoopFuture<DescribeNatGatewaysResult> {
    ...
    public func describeByoipCidrs(_ input: DescribeByoipCidrsRequest) throws -> EventLoopFuture<DescribeByoipCidrsResult> {
    ...
    public func rejectVpcPeeringConnection(_ input: RejectVpcPeeringConnectionRequest) throws -> EventLoopFuture<RejectVpcPeeringConnectionResult> {
    ...
    public func modifyHosts(_ input: ModifyHostsRequest) throws -> EventLoopFuture<ModifyHostsResult> {
    ...
    public func modifyVpcEndpoint(_ input: ModifyVpcEndpointRequest) throws -> EventLoopFuture<ModifyVpcEndpointResult> {
    ...
    public func createNetworkAcl(_ input: CreateNetworkAclRequest) throws -> EventLoopFuture<CreateNetworkAclResult> {
    ...
    public func createKeyPair(_ input: CreateKeyPairRequest) throws -> EventLoopFuture<KeyPair> {
        return try client.send(operation: "CreateKeyPair", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your VPC endpoints.
    public func describeVpcEndpoints(_ input: DescribeVpcEndpointsRequest) throws -> EventLoopFuture<DescribeVpcEndpointsResult> {
    ...
    public func describeInstanceStatus(_ input: DescribeInstanceStatusRequest) throws -> EventLoopFuture<DescribeInstanceStatusResult> {
    ...
    public func disassociateSubnetCidrBlock(_ input: DisassociateSubnetCidrBlockRequest) throws -> EventLoopFuture<DisassociateSubnetCidrBlockResult> {
        return try client.send(operation: "DisassociateSubnetCidrBlock", path: "/", httpMethod: "POST", input: input)
    }

    ///  Displays details about an import virtual machine or import snapshot tasks that are already created.
    public func describeImportImageTasks(_ input: DescribeImportImageTasksRequest) throws -> EventLoopFuture<DescribeImportImageTasksResult> {
    ...
    public func moveAddressToVpc(_ input: MoveAddressToVpcRequest) throws -> EventLoopFuture<MoveAddressToVpcResult> {
    ...
    public func createTransitGateway(_ input: CreateTransitGatewayRequest) throws -> EventLoopFuture<CreateTransitGatewayResult> {
    ...
    public func monitorInstances(_ input: MonitorInstancesRequest) throws -> EventLoopFuture<MonitorInstancesResult> {
    ...
    public func disassociateVpcCidrBlock(_ input: DisassociateVpcCidrBlockRequest) throws -> EventLoopFuture<DisassociateVpcCidrBlockResult> {
        return try client.send(operation: "DisassociateVpcCidrBlock", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified attribute of the specified Amazon FPGA Image (AFI).
    public func modifyFpgaImageAttribute(_ input: ModifyFpgaImageAttributeRequest) throws -> EventLoopFuture<ModifyFpgaImageAttributeResult> {
    ...
    public func provisionByoipCidr(_ input: ProvisionByoipCidrRequest) throws -> EventLoopFuture<ProvisionByoipCidrResult> {
    ...
    public func createImage(_ input: CreateImageRequest) throws -> EventLoopFuture<CreateImageResult> {
    ...
    public func getConsoleOutput(_ input: GetConsoleOutputRequest) throws -> EventLoopFuture<GetConsoleOutputResult> {
    ...
    public func requestSpotFleet(_ input: RequestSpotFleetRequest) throws -> EventLoopFuture<RequestSpotFleetResponse> {
    ...
    public func createNetworkInterface(_ input: CreateNetworkInterfaceRequest) throws -> EventLoopFuture<CreateNetworkInterfaceResult> {
    ...
    public func describePublicIpv4Pools(_ input: DescribePublicIpv4PoolsRequest) throws -> EventLoopFuture<DescribePublicIpv4PoolsResult> {
        return try client.send(operation: "DescribePublicIpv4Pools", path: "/", httpMethod: "POST", input: input)
    }

    ///  Unassigns one or more IPv6 addresses from a network interface.
    public func unassignIpv6Addresses(_ input: UnassignIpv6AddressesRequest) throws -> EventLoopFuture<UnassignIpv6AddressesResult> {
    ...
    public func deleteFleets(_ input: DeleteFleetsRequest) throws -> EventLoopFuture<DeleteFleetsResult> {
    ...
    public func describeNetworkAcls(_ input: DescribeNetworkAclsRequest) throws -> EventLoopFuture<DescribeNetworkAclsResult> {
    ...
    public func describeVpnConnections(_ input: DescribeVpnConnectionsRequest) throws -> EventLoopFuture<DescribeVpnConnectionsResult> {
    ...
    public func deleteVpcEndpointServiceConfigurations(_ input: DeleteVpcEndpointServiceConfigurationsRequest) throws -> EventLoopFuture<DeleteVpcEndpointServiceConfigurationsResult> {
        return try client.send(operation: "DeleteVpcEndpointServiceConfigurations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified VPC attachment.
    public func deleteTransitGatewayVpcAttachment(_ input: DeleteTransitGatewayVpcAttachmentRequest) throws -> EventLoopFuture<DeleteTransitGatewayVpcAttachmentResult> {
    ...
    public func createDefaultVpc(_ input: CreateDefaultVpcRequest) throws -> EventLoopFuture<CreateDefaultVpcResult> {
    ...
    public func describeTransitGatewayAttachments(_ input: DescribeTransitGatewayAttachmentsRequest) throws -> EventLoopFuture<DescribeTransitGatewayAttachmentsResult> {
    ...
    public func describeVpcClassicLinkDnsSupport(_ input: DescribeVpcClassicLinkDnsSupportRequest) throws -> EventLoopFuture<DescribeVpcClassicLinkDnsSupportResult> {
    ...
    public func associateTransitGatewayRouteTable(_ input: AssociateTransitGatewayRouteTableRequest) throws -> EventLoopFuture<AssociateTransitGatewayRouteTableResult> {
    ...
    public func describeReservedInstances(_ input: DescribeReservedInstancesRequest) throws -> EventLoopFuture<DescribeReservedInstancesResult> {
    ...
    public func modifyVpcEndpointServicePermissions(_ input: ModifyVpcEndpointServicePermissionsRequest) throws -> EventLoopFuture<ModifyVpcEndpointServicePermissionsResult> {
    ...
    public func modifyInstanceCreditSpecification(_ input: ModifyInstanceCreditSpecificationRequest) throws -> EventLoopFuture<ModifyInstanceCreditSpecificationResult> {
