...
public struct Redshift {
    ...
    public func enableLogging(_ input: EnableLoggingMessage) throws -> EventLoopFuture<LoggingStatus> {
    ...
    public func describeDefaultClusterParameters(_ input: DescribeDefaultClusterParametersMessage) throws -> EventLoopFuture<DescribeDefaultClusterParametersResult> {
    ...
    public func createHsmClientCertificate(_ input: CreateHsmClientCertificateMessage) throws -> EventLoopFuture<CreateHsmClientCertificateResult> {
    ...
    public func describeClusterSnapshots(_ input: DescribeClusterSnapshotsMessage) throws -> EventLoopFuture<SnapshotMessage> {
        return try client.send(operation: "DescribeClusterSnapshots", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the database revision of a cluster. The database revision is a unique revision of the database running in a cluster.
    public func modifyClusterDbRevision(_ input: ModifyClusterDbRevisionMessage) throws -> EventLoopFuture<ModifyClusterDbRevisionResult> {
    ...
    public func createSnapshotSchedule(_ input: CreateSnapshotScheduleMessage) throws -> EventLoopFuture<SnapshotSchedule> {
    ...
    public func deleteCluster(_ input: DeleteClusterMessage) throws -> EventLoopFuture<DeleteClusterResult> {
    ...
    public func describeClusterParameters(_ input: DescribeClusterParametersMessage) throws -> EventLoopFuture<ClusterParameterGroupDetails> {
    ...
    public func describeClusterDbRevisions(_ input: DescribeClusterDbRevisionsMessage) throws -> EventLoopFuture<ClusterDbRevisionsMessage> {
    ...
    public func createClusterSecurityGroup(_ input: CreateClusterSecurityGroupMessage) throws -> EventLoopFuture<CreateClusterSecurityGroupResult> {
    ...
    public func modifyClusterIamRoles(_ input: ModifyClusterIamRolesMessage) throws -> EventLoopFuture<ModifyClusterIamRolesResult> {
    ...
    public func getClusterCredentials(_ input: GetClusterCredentialsMessage) throws -> EventLoopFuture<ClusterCredentials> {
    ...
    public func rebootCluster(_ input: RebootClusterMessage) throws -> EventLoopFuture<RebootClusterResult> {
    ...
    public func describeHsmClientCertificates(_ input: DescribeHsmClientCertificatesMessage) throws -> EventLoopFuture<HsmClientCertificateMessage> {
    ...
    public func authorizeSnapshotAccess(_ input: AuthorizeSnapshotAccessMessage) throws -> EventLoopFuture<AuthorizeSnapshotAccessResult> {
    ...
    public func describeClusterSecurityGroups(_ input: DescribeClusterSecurityGroupsMessage) throws -> EventLoopFuture<ClusterSecurityGroupMessage> {
    ...
    public func revokeSnapshotAccess(_ input: RevokeSnapshotAccessMessage) throws -> EventLoopFuture<RevokeSnapshotAccessResult> {
        return try client.send(operation: "RevokeSnapshotAccess", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the descriptions of the reserved nodes.
    public func describeReservedNodes(_ input: DescribeReservedNodesMessage) throws -> EventLoopFuture<ReservedNodesMessage> {
    ...
    public func modifyClusterMaintenance(_ input: ModifyClusterMaintenanceMessage) throws -> EventLoopFuture<ModifyClusterMaintenanceResult> {
    ...
    public func describeClusterSubnetGroups(_ input: DescribeClusterSubnetGroupsMessage) throws -> EventLoopFuture<ClusterSubnetGroupMessage> {
        return try client.send(operation: "DescribeClusterSubnetGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes whether information, such as queries and connection attempts, is being logged for the specified Amazon Redshift cluster.
    public func describeLoggingStatus(_ input: DescribeLoggingStatusMessage) throws -> EventLoopFuture<LoggingStatus> {
    ...
    public func authorizeClusterSecurityGroupIngress(_ input: AuthorizeClusterSecurityGroupIngressMessage) throws -> EventLoopFuture<AuthorizeClusterSecurityGroupIngressResult> {
    ...
    public func describeClusters(_ input: DescribeClustersMessage) throws -> EventLoopFuture<ClustersMessage> {
    ...
    public func describeReservedNodeOfferings(_ input: DescribeReservedNodeOfferingsMessage) throws -> EventLoopFuture<ReservedNodeOfferingsMessage> {
    ...
    public func describeResize(_ input: DescribeResizeMessage) throws -> EventLoopFuture<ResizeProgressMessage> {
    ...
    public func resetClusterParameterGroup(_ input: ResetClusterParameterGroupMessage) throws -> EventLoopFuture<ClusterParameterGroupNameMessage> {
    ...
    public func createSnapshotCopyGrant(_ input: CreateSnapshotCopyGrantMessage) throws -> EventLoopFuture<CreateSnapshotCopyGrantResult> {
        return try client.send(operation: "CreateSnapshotCopyGrant", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the settings for a snapshot.
    public func modifyClusterSnapshot(_ input: ModifyClusterSnapshotMessage) throws -> EventLoopFuture<ModifyClusterSnapshotResult> {
        return try client.send(operation: "ModifyClusterSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels a resize operation.
    public func cancelResize(_ input: CancelResizeMessage) throws -> EventLoopFuture<ResizeProgressMessage> {
    ...
    public func describeOrderableClusterOptions(_ input: DescribeOrderableClusterOptionsMessage) throws -> EventLoopFuture<OrderableClusterOptionsMessage> {
    ...
    public func deleteClusterSnapshot(_ input: DeleteClusterSnapshotMessage) throws -> EventLoopFuture<DeleteClusterSnapshotResult> {
        return try client.send(operation: "DeleteClusterSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops logging information, such as queries and connection attempts, for the specified Amazon Redshift cluster.
    public func disableLogging(_ input: DisableLoggingMessage) throws -> EventLoopFuture<LoggingStatus> {
    ...
    public func describeStorage() throws -> EventLoopFuture<CustomerStorageMessage> {
    ...
    public func revokeClusterSecurityGroupIngress(_ input: RevokeClusterSecurityGroupIngressMessage) throws -> EventLoopFuture<RevokeClusterSecurityGroupIngressResult> {
    ...
    public func describeTableRestoreStatus(_ input: DescribeTableRestoreStatusMessage) throws -> EventLoopFuture<TableRestoreStatusMessage> {
    ...
    public func createClusterSnapshot(_ input: CreateClusterSnapshotMessage) throws -> EventLoopFuture<CreateClusterSnapshotResult> {
    ...
    public func modifyClusterParameterGroup(_ input: ModifyClusterParameterGroupMessage) throws -> EventLoopFuture<ClusterParameterGroupNameMessage> {
    ...
    public func describeClusterParameterGroups(_ input: DescribeClusterParameterGroupsMessage) throws -> EventLoopFuture<ClusterParameterGroupsMessage> {
        return try client.send(operation: "DescribeClusterParameterGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a set of cluster snapshots.
    public func batchDeleteClusterSnapshots(_ input: BatchDeleteClusterSnapshotsRequest) throws -> EventLoopFuture<BatchDeleteClusterSnapshotsResult> {
    ...
    public func restoreTableFromClusterSnapshot(_ input: RestoreTableFromClusterSnapshotMessage) throws -> EventLoopFuture<RestoreTableFromClusterSnapshotResult> {
    ...
    public func getReservedNodeExchangeOfferings(_ input: GetReservedNodeExchangeOfferingsInputMessage) throws -> EventLoopFuture<GetReservedNodeExchangeOfferingsOutputMessage> {
        return try client.send(operation: "GetReservedNodeExchangeOfferings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of all the available maintenance tracks.
    public func describeClusterTracks(_ input: DescribeClusterTracksMessage) throws -> EventLoopFuture<TrackListMessage> {
    ...
    public func describeHsmConfigurations(_ input: DescribeHsmConfigurationsMessage) throws -> EventLoopFuture<HsmConfigurationMessage> {
    ...
    public func purchaseReservedNodeOffering(_ input: PurchaseReservedNodeOfferingMessage) throws -> EventLoopFuture<PurchaseReservedNodeOfferingResult> {
    ...
    public func describeTags(_ input: DescribeTagsMessage) throws -> EventLoopFuture<TaggedResourceListMessage> {
    ...
    public func disableSnapshotCopy(_ input: DisableSnapshotCopyMessage) throws -> EventLoopFuture<DisableSnapshotCopyResult> {
    ...
    public func modifySnapshotCopyRetentionPeriod(_ input: ModifySnapshotCopyRetentionPeriodMessage) throws -> EventLoopFuture<ModifySnapshotCopyRetentionPeriodResult> {
    ...
    public func createCluster(_ input: CreateClusterMessage) throws -> EventLoopFuture<CreateClusterResult> {
    ...
    public func restoreFromClusterSnapshot(_ input: RestoreFromClusterSnapshotMessage) throws -> EventLoopFuture<RestoreFromClusterSnapshotResult> {
    ...
    public func modifyClusterSubnetGroup(_ input: ModifyClusterSubnetGroupMessage) throws -> EventLoopFuture<ModifyClusterSubnetGroupResult> {
        return try client.send(operation: "ModifyClusterSubnetGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the settings for a list of snapshots.
    public func batchModifyClusterSnapshots(_ input: BatchModifyClusterSnapshotsMessage) throws -> EventLoopFuture<BatchModifyClusterSnapshotsOutputMessage> {
    ...
    public func enableSnapshotCopy(_ input: EnableSnapshotCopyMessage) throws -> EventLoopFuture<EnableSnapshotCopyResult> {
    ...
    public func modifyCluster(_ input: ModifyClusterMessage) throws -> EventLoopFuture<ModifyClusterResult> {
    ...
    public func describeClusterVersions(_ input: DescribeClusterVersionsMessage) throws -> EventLoopFuture<ClusterVersionsMessage> {
    ...
    public func copyClusterSnapshot(_ input: CopyClusterSnapshotMessage) throws -> EventLoopFuture<CopyClusterSnapshotResult> {
    ...
    public func resizeCluster(_ input: ResizeClusterMessage) throws -> EventLoopFuture<ResizeClusterResult> {
        return try client.send(operation: "ResizeCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a snapshot schedule. Any schedule associated with a cluster is modified asynchronously.
    public func modifySnapshotSchedule(_ input: ModifySnapshotScheduleMessage) throws -> EventLoopFuture<SnapshotSchedule> {
        return try client.send(operation: "ModifySnapshotSchedule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Exchanges a DC1 Reserved Node for a DC2 Reserved Node with no changes to the configuration (term, payment type, or number of nodes) and no additional costs. 
    public func acceptReservedNodeExchange(_ input: AcceptReservedNodeExchangeInputMessage) throws -> EventLoopFuture<AcceptReservedNodeExchangeOutputMessage> {
    ...
    public func describeSnapshotCopyGrants(_ input: DescribeSnapshotCopyGrantsMessage) throws -> EventLoopFuture<SnapshotCopyGrantMessage> {
    ...
    public func createClusterSubnetGroup(_ input: CreateClusterSubnetGroupMessage) throws -> EventLoopFuture<CreateClusterSubnetGroupResult> {
    ...
    public func createHsmConfiguration(_ input: CreateHsmConfigurationMessage) throws -> EventLoopFuture<CreateHsmConfigurationResult> {
    ...
    public func createClusterParameterGroup(_ input: CreateClusterParameterGroupMessage) throws -> EventLoopFuture<CreateClusterParameterGroupResult> {
    ...
    public func describeAccountAttributes(_ input: DescribeAccountAttributesMessage) throws -> EventLoopFuture<AccountAttributeList> {
        return try client.send(operation: "DescribeAccountAttributes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of snapshot schedules. 
    public func describeSnapshotSchedules(_ input: DescribeSnapshotSchedulesMessage) throws -> EventLoopFuture<DescribeSnapshotSchedulesOutputMessage> {
        return try client.send(operation: "DescribeSnapshotSchedules", path: "/", httpMethod: "POST", input: input)
    }

    ///  Rotates the encryption keys for a cluster.
    public func rotateEncryptionKey(_ input: RotateEncryptionKeyMessage) throws -> EventLoopFuture<RotateEncryptionKeyResult> {
