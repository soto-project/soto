...
extension Redshift {
    ...
    public func describeClusterParameterGroupsPaginator(_ input: DescribeClusterParameterGroupsMessage) -> EventLoopFuture<[ClusterParameterGroup]> {
        return client.paginate(input: input, command: describeClusterParameterGroups, resultKey: \ClusterParameterGroupsMessage.parameterGroups, tokenKey: \ClusterParameterGroupsMessage.marker)
    }
    ...
    public func describeClusterParametersPaginator(_ input: DescribeClusterParametersMessage) -> EventLoopFuture<[Parameter]> {
        return client.paginate(input: input, command: describeClusterParameters, resultKey: \ClusterParameterGroupDetails.parameters, tokenKey: \ClusterParameterGroupDetails.marker)
    }
    ...
    public func describeClusterSecurityGroupsPaginator(_ input: DescribeClusterSecurityGroupsMessage) -> EventLoopFuture<[ClusterSecurityGroup]> {
        return client.paginate(input: input, command: describeClusterSecurityGroups, resultKey: \ClusterSecurityGroupMessage.clusterSecurityGroups, tokenKey: \ClusterSecurityGroupMessage.marker)
    }
    ...
    public func describeClusterSnapshotsPaginator(_ input: DescribeClusterSnapshotsMessage) -> EventLoopFuture<[Snapshot]> {
        return client.paginate(input: input, command: describeClusterSnapshots, resultKey: \SnapshotMessage.snapshots, tokenKey: \SnapshotMessage.marker)
    }
    ...
    public func describeClusterSubnetGroupsPaginator(_ input: DescribeClusterSubnetGroupsMessage) -> EventLoopFuture<[ClusterSubnetGroup]> {
        return client.paginate(input: input, command: describeClusterSubnetGroups, resultKey: \ClusterSubnetGroupMessage.clusterSubnetGroups, tokenKey: \ClusterSubnetGroupMessage.marker)
    }
    
    ///  Returns descriptions of the available Amazon Redshift cluster versions. You can call this operation even before creating any clusters to learn more about the Amazon Redshift versions. For more information about managing clusters, go to Amazon Redshift Clusters in the Amazon Redshift Cluster Management Guide.
    public func describeClusterVersionsPaginator(_ input: DescribeClusterVersionsMessage) -> EventLoopFuture<[ClusterVersion]> {
        return client.paginate(input: input, command: describeClusterVersions, resultKey: \ClusterVersionsMessage.clusterVersions, tokenKey: \ClusterVersionsMessage.marker)
    }
    ...
    public func describeClustersPaginator(_ input: DescribeClustersMessage) -> EventLoopFuture<[Cluster]> {
        return client.paginate(input: input, command: describeClusters, resultKey: \ClustersMessage.clusters, tokenKey: \ClustersMessage.marker)
    }
    ...
    public func describeHsmClientCertificatesPaginator(_ input: DescribeHsmClientCertificatesMessage) -> EventLoopFuture<[HsmClientCertificate]> {
        return client.paginate(input: input, command: describeHsmClientCertificates, resultKey: \HsmClientCertificateMessage.hsmClientCertificates, tokenKey: \HsmClientCertificateMessage.marker)
    }
    ...
    public func describeHsmConfigurationsPaginator(_ input: DescribeHsmConfigurationsMessage) -> EventLoopFuture<[HsmConfiguration]> {
        return client.paginate(input: input, command: describeHsmConfigurations, resultKey: \HsmConfigurationMessage.hsmConfigurations, tokenKey: \HsmConfigurationMessage.marker)
    }
    
    ///  Returns properties of possible node configurations such as node type, number of nodes, and disk usage for the specified action type.
    public func describeNodeConfigurationOptionsPaginator(_ input: DescribeNodeConfigurationOptionsMessage) -> EventLoopFuture<[NodeConfigurationOption]> {
        return client.paginate(input: input, command: describeNodeConfigurationOptions, resultKey: \NodeConfigurationOptionsMessage.nodeConfigurationOptionList, tokenKey: \NodeConfigurationOptionsMessage.marker)
    }
    
    ///  Returns a list of orderable cluster options. Before you create a new cluster you can use this operation to find what options are available, such as the EC2 Availability Zones (AZ) in the specific AWS Region that you can specify, and the node types you can request. The node types differ by available storage, memory, CPU and price. With the cost involved you might want to obtain a list of cluster options in the specific region and specify values when creating a cluster. For more information about managing clusters, go to Amazon Redshift Clusters in the Amazon Redshift Cluster Management Guide.
    public func describeOrderableClusterOptionsPaginator(_ input: DescribeOrderableClusterOptionsMessage) -> EventLoopFuture<[OrderableClusterOption]> {
        return client.paginate(input: input, command: describeOrderableClusterOptions, resultKey: \OrderableClusterOptionsMessage.orderableClusterOptions, tokenKey: \OrderableClusterOptionsMessage.marker)
    }
    ...
    public func describeReservedNodeOfferingsPaginator(_ input: DescribeReservedNodeOfferingsMessage) -> EventLoopFuture<[ReservedNodeOffering]> {
        return client.paginate(input: input, command: describeReservedNodeOfferings, resultKey: \ReservedNodeOfferingsMessage.reservedNodeOfferings, tokenKey: \ReservedNodeOfferingsMessage.marker)
    }
    
    ///  Returns the descriptions of the reserved nodes.
    public func describeReservedNodesPaginator(_ input: DescribeReservedNodesMessage) -> EventLoopFuture<[ReservedNode]> {
        return client.paginate(input: input, command: describeReservedNodes, resultKey: \ReservedNodesMessage.reservedNodes, tokenKey: \ReservedNodesMessage.marker)
    }
    
    ///  Describes properties of scheduled actions. 
    public func describeScheduledActionsPaginator(_ input: DescribeScheduledActionsMessage) -> EventLoopFuture<[ScheduledAction]> {
        return client.paginate(input: input, command: describeScheduledActions, resultKey: \ScheduledActionsMessage.scheduledActions, tokenKey: \ScheduledActionsMessage.marker)
    }
