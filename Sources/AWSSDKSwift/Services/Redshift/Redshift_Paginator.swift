...
extension Redshift {
    ...
    public func describeClusterParameterGroupsPaginator(_ input: DescribeClusterParameterGroupsMessage, onPage: @escaping (ClusterParameterGroupsMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeClusterParametersPaginator(_ input: DescribeClusterParametersMessage, onPage: @escaping (ClusterParameterGroupDetails, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeClusterSecurityGroupsPaginator(_ input: DescribeClusterSecurityGroupsMessage, onPage: @escaping (ClusterSecurityGroupMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeClusterSnapshotsPaginator(_ input: DescribeClusterSnapshotsMessage, onPage: @escaping (SnapshotMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeClusterSubnetGroupsPaginator(_ input: DescribeClusterSubnetGroupsMessage, onPage: @escaping (ClusterSubnetGroupMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeClusterVersionsPaginator(_ input: DescribeClusterVersionsMessage, onPage: @escaping (ClusterVersionsMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeHsmClientCertificatesPaginator(_ input: DescribeHsmClientCertificatesMessage, onPage: @escaping (HsmClientCertificateMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeHsmConfigurationsPaginator(_ input: DescribeHsmConfigurationsMessage, onPage: @escaping (HsmConfigurationMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeNodeConfigurationOptionsPaginator(_ input: DescribeNodeConfigurationOptionsMessage, onPage: @escaping (NodeConfigurationOptionsMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeOrderableClusterOptionsPaginator(_ input: DescribeOrderableClusterOptionsMessage, onPage: @escaping (OrderableClusterOptionsMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeReservedNodeOfferingsPaginator(_ input: DescribeReservedNodeOfferingsMessage, onPage: @escaping (ReservedNodeOfferingsMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeReservedNodesPaginator(_ input: DescribeReservedNodesMessage, onPage: @escaping (ReservedNodesMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func describeScheduledActionsPaginator(_ input: DescribeScheduledActionsMessage, onPage: @escaping (ScheduledActionsMessage, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
