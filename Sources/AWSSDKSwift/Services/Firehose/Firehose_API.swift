...
public struct Firehose: AWSService {
    ...
    public func createDeliveryStream(_ input: CreateDeliveryStreamInput) -> EventLoopFuture<CreateDeliveryStreamOutput> {
        return client.execute(operation: "CreateDeliveryStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDeliveryStream(_ input: DeleteDeliveryStreamInput) -> EventLoopFuture<DeleteDeliveryStreamOutput> {
        return client.execute(operation: "DeleteDeliveryStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDeliveryStream(_ input: DescribeDeliveryStreamInput) -> EventLoopFuture<DescribeDeliveryStreamOutput> {
        return client.execute(operation: "DescribeDeliveryStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDeliveryStreams(_ input: ListDeliveryStreamsInput) -> EventLoopFuture<ListDeliveryStreamsOutput> {
        return client.execute(operation: "ListDeliveryStreams", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTagsForDeliveryStream(_ input: ListTagsForDeliveryStreamInput) -> EventLoopFuture<ListTagsForDeliveryStreamOutput> {
        return client.execute(operation: "ListTagsForDeliveryStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putRecordBatch(_ input: PutRecordBatchInput) -> EventLoopFuture<PutRecordBatchOutput> {
        return client.execute(operation: "PutRecordBatch", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startDeliveryStreamEncryption(_ input: StartDeliveryStreamEncryptionInput) -> EventLoopFuture<StartDeliveryStreamEncryptionOutput> {
        return client.execute(operation: "StartDeliveryStreamEncryption", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func stopDeliveryStreamEncryption(_ input: StopDeliveryStreamEncryptionInput) -> EventLoopFuture<StopDeliveryStreamEncryptionOutput> {
        return client.execute(operation: "StopDeliveryStreamEncryption", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func tagDeliveryStream(_ input: TagDeliveryStreamInput) -> EventLoopFuture<TagDeliveryStreamOutput> {
        return client.execute(operation: "TagDeliveryStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func untagDeliveryStream(_ input: UntagDeliveryStreamInput) -> EventLoopFuture<UntagDeliveryStreamOutput> {
        return client.execute(operation: "UntagDeliveryStream", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateDestination(_ input: UpdateDestinationInput) -> EventLoopFuture<UpdateDestinationOutput> {
        return client.execute(operation: "UpdateDestination", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
