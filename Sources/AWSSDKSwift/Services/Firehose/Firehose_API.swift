...
public struct Firehose: AWSService {
    ...
    /// return new `Firehose` with new timeout value
    ...
    /// return new `Firehose` logging to specified Logger
    ...
    public func createDeliveryStream(_ input: CreateDeliveryStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDeliveryStreamOutput> {
        return client.execute(operation: "CreateDeliveryStream", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteDeliveryStream(_ input: DeleteDeliveryStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDeliveryStreamOutput> {
        return client.execute(operation: "DeleteDeliveryStream", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeDeliveryStream(_ input: DescribeDeliveryStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDeliveryStreamOutput> {
        return client.execute(operation: "DescribeDeliveryStream", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listDeliveryStreams(_ input: ListDeliveryStreamsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDeliveryStreamsOutput> {
        return client.execute(operation: "ListDeliveryStreams", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Lists the tags for the specified delivery stream. This operation has a limit of five transactions per second per account. 
    public func listTagsForDeliveryStream(_ input: ListTagsForDeliveryStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForDeliveryStreamOutput> {
        return client.execute(operation: "ListTagsForDeliveryStream", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putRecordBatch(_ input: PutRecordBatchInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutRecordBatchOutput> {
        return client.execute(operation: "PutRecordBatch", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startDeliveryStreamEncryption(_ input: StartDeliveryStreamEncryptionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartDeliveryStreamEncryptionOutput> {
        return client.execute(operation: "StartDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func stopDeliveryStreamEncryption(_ input: StopDeliveryStreamEncryptionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopDeliveryStreamEncryptionOutput> {
        return client.execute(operation: "StopDeliveryStreamEncryption", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func tagDeliveryStream(_ input: TagDeliveryStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagDeliveryStreamOutput> {
        return client.execute(operation: "TagDeliveryStream", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func untagDeliveryStream(_ input: UntagDeliveryStreamInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagDeliveryStreamOutput> {
        return client.execute(operation: "UntagDeliveryStream", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateDestination(_ input: UpdateDestinationInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDestinationOutput> {
        return client.execute(operation: "UpdateDestination", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
