...
public struct IoTAnalytics {
    ...
    public func createDatasetContent(_ input: CreateDatasetContentRequest) throws -> CreateDatasetContentResponse {
    ...
    public func listDatasetContents(_ input: ListDatasetContentsRequest) throws -> ListDatasetContentsResponse {
