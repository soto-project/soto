...
extension Macie {
    ...
    public struct FailedS3Resource: AWSShape {
        ...
        public init(errorMessage: String? = nil, errorCode: String? = nil, failedItem: S3Resource? = nil) {
    ...
    public struct S3ResourceClassification: AWSShape {
        ...
        public init(classificationType: ClassificationType, bucketName: String, prefix: String? = nil) {
