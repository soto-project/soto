...
extension Macie {
    ...
    public struct S3ResourceClassification: AWSShape {
        ...
        public init(prefix: String? = nil, classificationType: ClassificationType, bucketName: String) {
            self.prefix = prefix
    ...
    public struct S3ResourceClassificationUpdate: AWSShape {
        ...
        public init(prefix: String? = nil, classificationTypeUpdate: ClassificationTypeUpdate, bucketName: String) {
            self.prefix = prefix
    ...
    public struct FailedS3Resource: AWSShape {
        ...
        public init(errorCode: String? = nil, failedItem: S3Resource? = nil, errorMessage: String? = nil) {
