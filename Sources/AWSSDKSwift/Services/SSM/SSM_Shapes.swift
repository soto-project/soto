...
extension SSM {
    ...
    public struct MaintenanceWindowRunCommandParameters: AWSShape {
        ...
        public init(documentHash: String? = nil, notificationConfig: NotificationConfig? = nil, outputS3KeyPrefix: String? = nil, timeoutSeconds: Int32? = nil, comment: String? = nil, serviceRoleArn: String? = nil, documentHashType: DocumentHashType? = nil, outputS3BucketName: String? = nil, parameters: [String: [String]]? = nil) {
    ...
    public struct UpdateMaintenanceWindowTaskResult: AWSShape {
        ...
        public init(windowId: String? = nil, priority: Int32? = nil, windowTaskId: String? = nil, taskArn: String? = nil, maxErrors: String? = nil, description: String? = nil, name: String? = nil, taskInvocationParameters: MaintenanceWindowTaskInvocationParameters? = nil, targets: [Target]? = nil, serviceRoleArn: String? = nil, maxConcurrency: String? = nil, taskParameters: [String: MaintenanceWindowTaskParameterValueExpression]? = nil, loggingInfo: LoggingInfo? = nil) {
    ...
    public struct DocumentDescription: AWSShape {
        ...
        public init(createdDate: TimeStamp? = nil, versionName: String? = nil, parameters: [DocumentParameter]? = nil, statusInformation: String? = nil, targetType: String? = nil, documentVersion: String? = nil, owner: String? = nil, schemaVersion: String? = nil, platformTypes: [PlatformType]? = nil, documentFormat: DocumentFormat? = nil, hashType: DocumentHashType? = nil, defaultVersion: String? = nil, description: String? = nil, name: String? = nil, latestVersion: String? = nil, hash: String? = nil, sha1: String? = nil, documentType: DocumentType? = nil, attachmentsInformation: [AttachmentInformation]? = nil, status: DocumentStatus? = nil, tags: [Tag]? = nil) {
    ...
    public struct InstanceAssociationStatusInfo: AWSShape {
        ...
        public init(name: String? = nil, associationVersion: String? = nil, executionSummary: String? = nil, instanceId: String? = nil, documentVersion: String? = nil, associationId: String? = nil, status: String? = nil, detailedStatus: String? = nil, executionDate: TimeStamp? = nil, associationName: String? = nil, errorCode: String? = nil, outputUrl: InstanceAssociationOutputUrl? = nil) {
            self.name = name
    ...
    public struct GetMaintenanceWindowResult: AWSShape {
        ...
        public init(schedule: String? = nil, windowId: String? = nil, modifiedDate: TimeStamp? = nil, cutoff: Int32? = nil, enabled: Bool? = nil, scheduleTimezone: String? = nil, description: String? = nil, nextExecutionTime: String? = nil, name: String? = nil, startDate: String? = nil, endDate: String? = nil, duration: Int32? = nil, allowUnassociatedTargets: Bool? = nil, createdDate: TimeStamp? = nil) {
    ...
    public struct InventoryDeletionSummaryItem: AWSShape {
        ...
        public init(remainingCount: Int32? = nil, version: String? = nil, count: Int32? = nil) {
            self.remainingCount = remainingCount
    ...
    public struct AssociationVersionInfo: AWSShape {
        ...
        public init(associationName: String? = nil, parameters: [String: [String]]? = nil, documentVersion: String? = nil, complianceSeverity: AssociationComplianceSeverity? = nil, maxErrors: String? = nil, scheduleExpression: String? = nil, name: String? = nil, outputLocation: InstanceAssociationOutputLocation? = nil, associationVersion: String? = nil, targets: [Target]? = nil, associationId: String? = nil, maxConcurrency: String? = nil, createdDate: TimeStamp? = nil) {
            self.associationName = associationName
            self.parameters = parameters
            self.documentVersion = documentVersion
    ...
    public struct PutParameterRequest: AWSShape {
        ...
        public init(name: String, overwrite: Bool? = nil, keyId: String? = nil, type: ParameterType, value: String, allowedPattern: String? = nil, description: String? = nil) {
            self.name = name
    ...
    public struct DeleteInventoryResult: AWSShape {
        ...
        public init(deletionId: String? = nil, typeName: String? = nil, deletionSummary: InventoryDeletionSummary? = nil) {
    ...
    public struct CreateMaintenanceWindowRequest: AWSShape {
        ...
        public init(name: String, clientToken: String? = nil, scheduleTimezone: String? = nil, cutoff: Int32, schedule: String, endDate: String? = nil, duration: Int32, allowUnassociatedTargets: Bool, startDate: String? = nil, description: String? = nil) {
            self.name = name
    ...
    public struct GetParametersByPathRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, path: String, nextToken: String? = nil, withDecryption: Bool? = nil, parameterFilters: [ParameterStringFilter]? = nil, recursive: Bool? = nil) {
    ...
    public struct UpdateMaintenanceWindowResult: AWSShape {
        ...
        public init(name: String? = nil, windowId: String? = nil, scheduleTimezone: String? = nil, cutoff: Int32? = nil, schedule: String? = nil, allowUnassociatedTargets: Bool? = nil, duration: Int32? = nil, endDate: String? = nil, description: String? = nil, enabled: Bool? = nil, startDate: String? = nil) {
            self.name = name
            self.windowId = windowId
            self.scheduleTimezone = scheduleTimezone
            self.cutoff = cutoff
    ...
    public struct MaintenanceWindowExecutionTaskInvocationIdentity: AWSShape {
        ...
        public init(status: MaintenanceWindowExecutionStatus? = nil, windowExecutionId: String? = nil, invocationId: String? = nil, windowTargetId: String? = nil, taskExecutionId: String? = nil, endTime: TimeStamp? = nil, taskType: MaintenanceWindowTaskType? = nil, startTime: TimeStamp? = nil, ownerInformation: String? = nil, parameters: String? = nil, statusDetails: String? = nil, executionId: String? = nil) {
            self.status = status
            self.windowExecutionId = windowExecutionId
    ...
    public struct RegisterTaskWithMaintenanceWindowRequest: AWSShape {
        ...
        public init(taskType: MaintenanceWindowTaskType, windowId: String, priority: Int32? = nil, taskArn: String, clientToken: String? = nil, maxErrors: String, description: String? = nil, name: String? = nil, taskInvocationParameters: MaintenanceWindowTaskInvocationParameters? = nil, maxConcurrency: String, serviceRoleArn: String? = nil, targets: [Target], loggingInfo: LoggingInfo? = nil, taskParameters: [String: MaintenanceWindowTaskParameterValueExpression]? = nil) {
            self.taskType = taskType
            self.windowId = windowId
            self.priority = priority
            self.taskArn = taskArn
    ...
    public struct DescribeParametersRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, filters: [ParametersFilter]? = nil, nextToken: String? = nil, parameterFilters: [ParameterStringFilter]? = nil) {
            self.maxResults = maxResults
            self.filters = filters
            self.nextToken = nextToken
            self.parameterFilters = parameterFilters
    ...
    public struct UpdatePatchBaselineRequest: AWSShape {
        ...
        public init(name: String? = nil, baselineId: String, approvedPatches: [String]? = nil, approvedPatchesComplianceLevel: PatchComplianceLevel? = nil, replace: Bool? = nil, rejectedPatches: [String]? = nil, rejectedPatchesAction: PatchAction? = nil, approvedPatchesEnableNonSecurity: Bool? = nil, sources: [PatchSource]? = nil, description: String? = nil, approvalRules: PatchRuleGroup? = nil, globalFilters: PatchFilterGroup? = nil) {
            self.name = name
            self.baselineId = baselineId
    ...
    public struct ResourceComplianceSummaryItem: AWSShape {
        ...
        public init(nonCompliantSummary: NonCompliantSummary? = nil, executionSummary: ComplianceExecutionSummary? = nil, status: ComplianceStatus? = nil, compliantSummary: CompliantSummary? = nil, resourceType: String? = nil, complianceType: String? = nil, overallSeverity: ComplianceSeverity? = nil, resourceId: String? = nil) {
    ...
    public struct DocumentParameter: AWSShape {
        ...
        public init(type: DocumentParameterType? = nil, name: String? = nil, description: String? = nil, defaultValue: String? = nil) {
            self.`type` = `type`
            self.name = name
            self.description = description
    ...
    public struct PutComplianceItemsRequest: AWSShape {
        ...
        public init(resourceType: String, executionSummary: ComplianceExecutionSummary, complianceType: String, resourceId: String, items: [ComplianceItemEntry], itemContentHash: String? = nil) {
            self.resourceType = resourceType
            self.executionSummary = executionSummary
            self.complianceType = complianceType
            self.resourceId = resourceId
    ...
    public struct InventoryItemSchema: AWSShape {
        ...
        public init(displayName: String? = nil, attributes: [InventoryItemAttribute], version: String? = nil, typeName: String) {
    ...
    public struct ProgressCounters: AWSShape {
        ...
        public init(totalSteps: Int32? = nil, successSteps: Int32? = nil, cancelledSteps: Int32? = nil, failedSteps: Int32? = nil, timedOutSteps: Int32? = nil) {
    ...
    public struct ParameterHistory: AWSShape {
        ...
        public init(name: String? = nil, lastModifiedDate: TimeStamp? = nil, version: Int64? = nil, keyId: String? = nil, labels: [String]? = nil, type: ParameterType? = nil, lastModifiedUser: String? = nil, value: String? = nil, allowedPattern: String? = nil, description: String? = nil) {
            self.name = name
    ...
    public struct ListInventoryEntriesResult: AWSShape {
        ...
        public init(nextToken: String? = nil, schemaVersion: String? = nil, entries: [[String: String]]? = nil, instanceId: String? = nil, captureTime: String? = nil, typeName: String? = nil) {
            self.nextToken = nextToken
            self.schemaVersion = schemaVersion
            self.entries = entries
            self.instanceId = instanceId
    ...
    public struct UpdateMaintenanceWindowTargetResult: AWSShape {
        ...
        public init(name: String? = nil, windowId: String? = nil, windowTargetId: String? = nil, description: String? = nil, ownerInformation: String? = nil, targets: [Target]? = nil) {
            self.name = name
            self.windowId = windowId
            self.windowTargetId = windowTargetId
            self.description = description
    ...
    public struct GetMaintenanceWindowExecutionTaskResult: AWSShape {
        ...
        public init(windowExecutionId: String? = nil, taskExecutionId: String? = nil, priority: Int32? = nil, taskArn: String? = nil, maxErrors: String? = nil, startTime: TimeStamp? = nil, statusDetails: String? = nil, type: MaintenanceWindowTaskType? = nil, maxConcurrency: String? = nil, endTime: TimeStamp? = nil, taskParameters: [[String: MaintenanceWindowTaskParameterValueExpression]]? = nil, serviceRole: String? = nil, status: MaintenanceWindowExecutionStatus? = nil) {
            self.windowExecutionId = windowExecutionId
            self.taskExecutionId = taskExecutionId
            self.priority = priority
            self.taskArn = taskArn
    ...
    public struct MaintenanceWindowIdentity: AWSShape {
        ...
        public init(name: String? = nil, nextExecutionTime: String? = nil, scheduleTimezone: String? = nil, cutoff: Int32? = nil, schedule: String? = nil, endDate: String? = nil, duration: Int32? = nil, windowId: String? = nil, startDate: String? = nil, enabled: Bool? = nil, description: String? = nil) {
            self.name = name
            self.nextExecutionTime = nextExecutionTime
            self.scheduleTimezone = scheduleTimezone
            self.cutoff = cutoff
    ...
    public struct MaintenanceWindowTarget: AWSShape {
        ...
        public init(name: String? = nil, windowTargetId: String? = nil, resourceType: MaintenanceWindowResourceType? = nil, ownerInformation: String? = nil, targets: [Target]? = nil, windowId: String? = nil, description: String? = nil) {
            self.name = name
            self.windowTargetId = windowTargetId
            self.resourceType = resourceType
            self.ownerInformation = ownerInformation
    ...
    public struct GetCommandInvocationRequest: AWSShape {
        ...
        public init(pluginName: String? = nil, commandId: String, instanceId: String) {
    ...
    public struct PatchComplianceData: AWSShape {
        ...
        public init(state: PatchComplianceDataState, severity: String, title: String, kBId: String, classification: String, installedTime: TimeStamp) {
            self.state = state
    ...
    public struct ListAssociationVersionsRequest: AWSShape {
        ...
        public init(associationId: String, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.associationId = associationId
            self.nextToken = nextToken
            self.maxResults = maxResults
        }
    ...
    public struct DescribeSessionsRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, filters: [SessionFilter]? = nil, nextToken: String? = nil, state: SessionState) {
            self.maxResults = maxResults
            self.filters = filters
            self.nextToken = nextToken
            self.state = state
    ...
    public struct GetMaintenanceWindowTaskResult: AWSShape {
        ...
        public init(taskType: MaintenanceWindowTaskType? = nil, windowId: String? = nil, priority: Int32? = nil, windowTaskId: String? = nil, taskArn: String? = nil, maxErrors: String? = nil, description: String? = nil, name: String? = nil, taskInvocationParameters: MaintenanceWindowTaskInvocationParameters? = nil, maxConcurrency: String? = nil, serviceRoleArn: String? = nil, targets: [Target]? = nil, taskParameters: [String: MaintenanceWindowTaskParameterValueExpression]? = nil, loggingInfo: LoggingInfo? = nil) {
            self.taskType = taskType
            self.windowId = windowId
            self.priority = priority
            self.windowTaskId = windowTaskId
    ...
    public struct UpdateDocumentRequest: AWSShape {
        ...
        public init(name: String, documentVersion: String? = nil, versionName: String? = nil, targetType: String? = nil, attachments: [AttachmentsSource]? = nil, content: String, documentFormat: DocumentFormat? = nil) {
            self.name = name
            self.documentVersion = documentVersion
            self.versionName = versionName
            self.targetType = targetType
    ...
    public struct CreateDocumentRequest: AWSShape {
        ...
        public init(name: String, documentType: DocumentType? = nil, versionName: String? = nil, targetType: String? = nil, attachments: [AttachmentsSource]? = nil, content: String, documentFormat: DocumentFormat? = nil) {
            self.name = name
            self.documentType = documentType
            self.versionName = versionName
            self.targetType = targetType
    ...
    public struct ListCommandInvocationsRequest: AWSShape {
        ...
        public init(details: Bool? = nil, filters: [CommandFilter]? = nil, instanceId: String? = nil, maxResults: Int32? = nil, commandId: String? = nil, nextToken: String? = nil) {
    ...
    public struct ComplianceItemEntry: AWSShape {
        ...
        public init(details: [String: String]? = nil, id: String? = nil, status: ComplianceStatus, severity: ComplianceSeverity, title: String? = nil) {
            self.details = details
            self.id = id
            self.status = status
            self.severity = severity
    ...
    public struct NotificationConfig: AWSShape {
        ...
        public init(notificationEvents: [NotificationEvent]? = nil, notificationType: NotificationType? = nil, notificationArn: String? = nil) {
    ...
    public struct CreateAssociationRequest: AWSShape {
        ...
        public init(name: String, documentVersion: String? = nil, instanceId: String? = nil, complianceSeverity: AssociationComplianceSeverity? = nil, maxErrors: String? = nil, targets: [Target]? = nil, maxConcurrency: String? = nil, scheduleExpression: String? = nil, outputLocation: InstanceAssociationOutputLocation? = nil, associationName: String? = nil, parameters: [String: [String]]? = nil) {
            self.name = name
            self.documentVersion = documentVersion
            self.instanceId = instanceId
            self.complianceSeverity = complianceSeverity
    ...
    public struct GetPatchBaselineResult: AWSShape {
        ...
        public init(rejectedPatchesAction: PatchAction? = nil, sources: [PatchSource]? = nil, rejectedPatches: [String]? = nil, modifiedDate: TimeStamp? = nil, operatingSystem: OperatingSystem? = nil, patchGroups: [String]? = nil, globalFilters: PatchFilterGroup? = nil, approvedPatchesEnableNonSecurity: Bool? = nil, description: String? = nil, name: String? = nil, baselineId: String? = nil, approvalRules: PatchRuleGroup? = nil, approvedPatches: [String]? = nil, approvedPatchesComplianceLevel: PatchComplianceLevel? = nil, createdDate: TimeStamp? = nil) {
            self.rejectedPatchesAction = rejectedPatchesAction
            self.sources = sources
            self.rejectedPatches = rejectedPatches
            self.modifiedDate = modifiedDate
    ...
    public struct GetDeployablePatchSnapshotForInstanceResult: AWSShape {
        ...
        public init(snapshotDownloadUrl: String? = nil, instanceId: String? = nil, product: String? = nil, snapshotId: String? = nil) {
    ...
    public struct TargetLocation: AWSShape {
        ...
        public init(targetLocationMaxErrors: String? = nil, executionRoleName: String? = nil, accounts: [String]? = nil, targetLocationMaxConcurrency: String? = nil, regions: [String]? = nil) {
    ...
    public struct AutomationExecution: AWSShape {
        ...
        public init(target: String? = nil, outputs: [String: [String]]? = nil, currentStepName: String? = nil, targetParameterName: String? = nil, resolvedTargets: ResolvedTargets? = nil, executionEndTime: TimeStamp? = nil, parameters: [String: [String]]? = nil, automationExecutionStatus: AutomationExecutionStatus? = nil, failureMessage: String? = nil, executedBy: String? = nil, targetLocations: [TargetLocation]? = nil, maxConcurrency: String? = nil, automationExecutionId: String? = nil, stepExecutionsTruncated: Bool? = nil, parentAutomationExecutionId: String? = nil, documentVersion: String? = nil, stepExecutions: [StepExecution]? = nil, maxErrors: String? = nil, currentAction: String? = nil, targets: [Target]? = nil, targetMaps: [[String: [String]]]? = nil, documentName: String? = nil, progressCounters: ProgressCounters? = nil, mode: ExecutionMode? = nil, executionStartTime: TimeStamp? = nil) {
            self.target = target
    ...
    public struct CommandPlugin: AWSShape {
        ...
        public init(name: String? = nil, responseFinishDateTime: TimeStamp? = nil, status: CommandPluginStatus? = nil, responseStartDateTime: TimeStamp? = nil, output: String? = nil, standardOutputUrl: String? = nil, standardErrorUrl: String? = nil, outputS3KeyPrefix: String? = nil, outputS3Region: String? = nil, statusDetails: String? = nil, responseCode: Int32? = nil, outputS3BucketName: String? = nil) {
            self.name = name
    ...
    public struct SendCommandRequest: AWSShape {
        ...
        public init(instanceIds: [String]? = nil, cloudWatchOutputConfig: CloudWatchOutputConfig? = nil, outputS3BucketName: String? = nil, documentHash: String? = nil, outputS3KeyPrefix: String? = nil, parameters: [String: [String]]? = nil, documentVersion: String? = nil, timeoutSeconds: Int32? = nil, comment: String? = nil, maxErrors: String? = nil, outputS3Region: String? = nil, documentHashType: DocumentHashType? = nil, notificationConfig: NotificationConfig? = nil, targets: [Target]? = nil, documentName: String, serviceRoleArn: String? = nil, maxConcurrency: String? = nil) {
    ...
    public struct UpdateMaintenanceWindowTaskRequest: AWSShape {
        ...
        public init(windowId: String, priority: Int32? = nil, windowTaskId: String, taskArn: String? = nil, maxErrors: String? = nil, description: String? = nil, name: String? = nil, taskInvocationParameters: MaintenanceWindowTaskInvocationParameters? = nil, replace: Bool? = nil, targets: [Target]? = nil, serviceRoleArn: String? = nil, maxConcurrency: String? = nil, taskParameters: [String: MaintenanceWindowTaskParameterValueExpression]? = nil, loggingInfo: LoggingInfo? = nil) {
            self.windowId = windowId
            self.priority = priority
            self.windowTaskId = windowTaskId
            self.taskArn = taskArn
    ...
    public struct AssociationExecution: AWSShape {
        ...
        public init(associationVersion: String? = nil, associationId: String? = nil, status: String? = nil, lastExecutionDate: TimeStamp? = nil, createdTime: TimeStamp? = nil, detailedStatus: String? = nil, resourceCountByStatus: String? = nil, executionId: String? = nil) {
            self.associationVersion = associationVersion
            self.associationId = associationId
            self.status = status
    ...
    public struct UpdateMaintenanceWindowTargetRequest: AWSShape {
        ...
        public init(name: String? = nil, replace: Bool? = nil, windowTargetId: String, ownerInformation: String? = nil, targets: [Target]? = nil, windowId: String, description: String? = nil) {
            self.name = name
            self.replace = replace
            self.windowTargetId = windowTargetId
            self.ownerInformation = ownerInformation
    ...
    public struct ListComplianceItemsRequest: AWSShape {
        ...
        public init(resourceIds: [String]? = nil, filters: [ComplianceStringFilter]? = nil, nextToken: String? = nil, maxResults: Int32? = nil, resourceTypes: [String]? = nil) {
    ...
    public struct Association: AWSShape {
        ...
        public init(name: String? = nil, documentVersion: String? = nil, instanceId: String? = nil, associationId: String? = nil, lastExecutionDate: TimeStamp? = nil, overview: AssociationOverview? = nil, associationVersion: String? = nil, associationName: String? = nil, targets: [Target]? = nil, scheduleExpression: String? = nil) {
            self.name = name
            self.documentVersion = documentVersion
            self.instanceId = instanceId
            self.associationId = associationId
    ...
    public struct AddTagsToResourceRequest: AWSShape {
        ...
        public init(tags: [Tag], resourceType: ResourceTypeForTagging, resourceId: String) {
            self.tags = tags
            self.resourceType = resourceType
            self.resourceId = resourceId
        }
    ...
    public struct MaintenanceWindowExecutionTaskIdentity: AWSShape {
        ...
        public init(status: MaintenanceWindowExecutionStatus? = nil, windowExecutionId: String? = nil, taskExecutionId: String? = nil, endTime: TimeStamp? = nil, taskType: MaintenanceWindowTaskType? = nil, startTime: TimeStamp? = nil, statusDetails: String? = nil, taskArn: String? = nil) {
            self.status = status
            self.windowExecutionId = windowExecutionId
            self.taskExecutionId = taskExecutionId
            self.endTime = endTime
    ...
    public struct Command: AWSShape {
        ...
        public init(instanceIds: [String]? = nil, cloudWatchOutputConfig: CloudWatchOutputConfig? = nil, outputS3BucketName: String? = nil, documentName: String? = nil, outputS3KeyPrefix: String? = nil, parameters: [String: [String]]? = nil, documentVersion: String? = nil, commandId: String? = nil, comment: String? = nil, maxErrors: String? = nil, errorCount: Int32? = nil, completedCount: Int32? = nil, outputS3Region: String? = nil, deliveryTimedOutCount: Int32? = nil, targetCount: Int32? = nil, notificationConfig: NotificationConfig? = nil, expiresAfter: TimeStamp? = nil, maxConcurrency: String? = nil, targets: [Target]? = nil, statusDetails: String? = nil, serviceRole: String? = nil, requestedDateTime: TimeStamp? = nil, status: CommandStatus? = nil) {
            self.instanceIds = instanceIds
            self.cloudWatchOutputConfig = cloudWatchOutputConfig
            self.outputS3BucketName = outputS3BucketName
            self.documentName = documentName
    ...
    public struct DescribeDocumentRequest: AWSShape {
        ...
        public init(documentVersion: String? = nil, versionName: String? = nil, name: String) {
            self.documentVersion = documentVersion
            self.versionName = versionName
            self.name = name
        }
    ...
    public struct GetMaintenanceWindowExecutionResult: AWSShape {
        ...
        public init(taskIds: [String]? = nil, windowExecutionId: String? = nil, startTime: TimeStamp? = nil, status: MaintenanceWindowExecutionStatus? = nil, endTime: TimeStamp? = nil, statusDetails: String? = nil) {
    ...
    public struct UpdatePatchBaselineResult: AWSShape {
        ...
        public init(rejectedPatchesAction: PatchAction? = nil, sources: [PatchSource]? = nil, rejectedPatches: [String]? = nil, modifiedDate: TimeStamp? = nil, operatingSystem: OperatingSystem? = nil, globalFilters: PatchFilterGroup? = nil, approvedPatchesEnableNonSecurity: Bool? = nil, description: String? = nil, name: String? = nil, baselineId: String? = nil, approvedPatches: [String]? = nil, approvalRules: PatchRuleGroup? = nil, approvedPatchesComplianceLevel: PatchComplianceLevel? = nil, createdDate: TimeStamp? = nil) {
            self.rejectedPatchesAction = rejectedPatchesAction
            self.sources = sources
            self.rejectedPatches = rejectedPatches
            self.modifiedDate = modifiedDate
    ...
    public struct InstanceInformation: AWSShape {
        ...
        public init(platformName: String? = nil, associationOverview: InstanceAggregatedAssociationOverview? = nil, isLatestVersion: Bool? = nil, activationId: String? = nil, agentVersion: String? = nil, platformVersion: String? = nil, iamRole: String? = nil, associationStatus: String? = nil, lastAssociationExecutionDate: TimeStamp? = nil, pingStatus: PingStatus? = nil, computerName: String? = nil, resourceType: ResourceType? = nil, lastPingDateTime: TimeStamp? = nil, registrationDate: TimeStamp? = nil, name: String? = nil, platformType: PlatformType? = nil, lastSuccessfulAssociationExecutionDate: TimeStamp? = nil, iPAddress: String? = nil, instanceId: String? = nil) {
    ...
    public struct InventoryDeletionStatusItem: AWSShape {
        ...
        public init(deletionId: String? = nil, lastStatusUpdateTime: TimeStamp? = nil, deletionStartTime: TimeStamp? = nil, typeName: String? = nil, deletionSummary: InventoryDeletionSummary? = nil, lastStatusMessage: String? = nil, lastStatus: InventoryDeletionStatus? = nil) {
            self.deletionId = deletionId
    ...
    public struct Activation: AWSShape {
        ...
        public init(defaultInstanceName: String? = nil, createdDate: TimeStamp? = nil, iamRole: String? = nil, expired: Bool? = nil, registrationsCount: Int32? = nil, registrationLimit: Int32? = nil, expirationDate: TimeStamp? = nil, activationId: String? = nil, description: String? = nil) {
    ...
    public struct AttachmentContent: AWSShape {
        ...
        public init(name: String? = nil, url: String? = nil, size: Int64? = nil, hash: String? = nil, hashType: AttachmentHashType? = nil) {
            self.name = name
            self.url = url
            self.size = size
            self.hash = hash
    ...
    public struct InstanceAssociation: AWSShape {
        ...
        public init(instanceId: String? = nil, associationVersion: String? = nil, associationId: String? = nil, content: String? = nil) {
            self.instanceId = instanceId
            self.associationVersion = associationVersion
            self.associationId = associationId
            self.content = content
    ...
    public struct ListCommandsRequest: AWSShape {
        ...
        public init(filters: [CommandFilter]? = nil, maxResults: Int32? = nil, instanceId: String? = nil, nextToken: String? = nil, commandId: String? = nil) {
            self.filters = filters
            self.maxResults = maxResults
            self.instanceId = instanceId
            self.nextToken = nextToken
    ...
    public struct LabelParameterVersionRequest: AWSShape {
        ...
        public init(labels: [String], parameterVersion: Int64? = nil, name: String) {
            self.labels = labels
    ...
    public struct ResourceDataSyncItem: AWSShape {
        ...
        public init(syncCreatedTime: TimeStamp? = nil, lastSyncStatusMessage: String? = nil, s3Destination: ResourceDataSyncS3Destination? = nil, lastSyncTime: TimeStamp? = nil, syncName: String? = nil, lastSuccessfulSyncTime: TimeStamp? = nil, lastStatus: LastResourceDataSyncStatus? = nil) {
    ...
    public struct AssociationOverview: AWSShape {
        ...
        public init(status: String? = nil, detailedStatus: String? = nil, associationStatusAggregatedCount: [String: Int32]? = nil) {
            self.status = status
            self.detailedStatus = detailedStatus
    ...
    public struct RegisterTargetWithMaintenanceWindowRequest: AWSShape {
        ...
        public init(name: String? = nil, clientToken: String? = nil, resourceType: MaintenanceWindowResourceType, ownerInformation: String? = nil, targets: [Target], windowId: String, description: String? = nil) {
            self.name = name
            self.clientToken = clientToken
            self.resourceType = resourceType
            self.ownerInformation = ownerInformation
    ...
    public struct GetCommandInvocationResult: AWSShape {
        ...
        public init(standardOutputContent: String? = nil, cloudWatchOutputConfig: CloudWatchOutputConfig? = nil, executionEndDateTime: String? = nil, standardErrorContent: String? = nil, documentVersion: String? = nil, pluginName: String? = nil, commandId: String? = nil, executionElapsedTime: String? = nil, executionStartDateTime: String? = nil, comment: String? = nil, standardErrorUrl: String? = nil, responseCode: Int32? = nil, statusDetails: String? = nil, standardOutputUrl: String? = nil, documentName: String? = nil, instanceId: String? = nil, status: CommandInvocationStatus? = nil) {
    ...
    public struct MaintenanceWindowExecution: AWSShape {
        ...
        public init(windowId: String? = nil, windowExecutionId: String? = nil, startTime: TimeStamp? = nil, status: MaintenanceWindowExecutionStatus? = nil, endTime: TimeStamp? = nil, statusDetails: String? = nil) {
            self.windowId = windowId
            self.windowExecutionId = windowExecutionId
            self.startTime = startTime
            self.status = status
    ...
    public struct DescribeAssociationExecutionsRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, filters: [AssociationExecutionFilter]? = nil, nextToken: String? = nil, associationId: String) {
            self.maxResults = maxResults
            self.filters = filters
            self.nextToken = nextToken
            self.associationId = associationId
    ...
    public struct CreateActivationRequest: AWSShape {
        ...
        public init(defaultInstanceName: String? = nil, expirationDate: TimeStamp? = nil, iamRole: String, description: String? = nil, registrationLimit: Int32? = nil) {
            self.defaultInstanceName = defaultInstanceName
            self.expirationDate = expirationDate
            self.iamRole = iamRole
            self.description = description
    ...
    public struct PatchBaselineIdentity: AWSShape {
        ...
        public init(defaultBaseline: Bool? = nil, baselineDescription: String? = nil, baselineName: String? = nil, operatingSystem: OperatingSystem? = nil, baselineId: String? = nil) {
    ...
    public struct Parameter: AWSShape {
        ...
        public init(name: String? = nil, sourceResult: String? = nil, lastModifiedDate: TimeStamp? = nil, version: Int64? = nil, selector: String? = nil, type: ParameterType? = nil, value: String? = nil, arn: String? = nil) {
            self.name = name
    ...
    public struct SendAutomationSignalRequest: AWSShape {
        ...
        public init(automationExecutionId: String, signalType: SignalType, payload: [String: [String]]? = nil) {
            self.automationExecutionId = automationExecutionId
    ...
    public struct ResourceDataSyncS3Destination: AWSShape {
        ...
        public init(prefix: String? = nil, aWSKMSKeyARN: String? = nil, bucketName: String, region: String, syncFormat: ResourceDataSyncS3Format) {
            self.prefix = prefix
    ...
    public struct DescribeMaintenanceWindowExecutionTaskInvocationsRequest: AWSShape {
        ...
        public init(filters: [MaintenanceWindowFilter]? = nil, nextToken: String? = nil, taskId: String, windowExecutionId: String, maxResults: Int32? = nil) {
            self.filters = filters
            self.nextToken = nextToken
            self.taskId = taskId
            self.windowExecutionId = windowExecutionId
    ...
    public struct DocumentIdentifier: AWSShape {
        ...
        public init(name: String? = nil, documentVersion: String? = nil, owner: String? = nil, platformTypes: [PlatformType]? = nil, tags: [Tag]? = nil, targetType: String? = nil, versionName: String? = nil, documentType: DocumentType? = nil, schemaVersion: String? = nil, documentFormat: DocumentFormat? = nil) {
            self.name = name
            self.documentVersion = documentVersion
            self.owner = owner
            self.platformTypes = platformTypes
    ...
    public struct DescribePatchGroupStateResult: AWSShape {
        ...
        public init(instances: Int32? = nil, instancesWithNotApplicablePatches: Int32? = nil, instancesWithFailedPatches: Int32? = nil, instancesWithInstalledRejectedPatches: Int32? = nil, instancesWithInstalledPatches: Int32? = nil, instancesWithMissingPatches: Int32? = nil, instancesWithInstalledOtherPatches: Int32? = nil) {
    ...
    public struct AssociationDescription: AWSShape {
        ...
        public init(associationName: String? = nil, parameters: [String: [String]]? = nil, overview: AssociationOverview? = nil, documentVersion: String? = nil, complianceSeverity: AssociationComplianceSeverity? = nil, lastSuccessfulExecutionDate: TimeStamp? = nil, date: TimeStamp? = nil, lastExecutionDate: TimeStamp? = nil, name: String? = nil, scheduleExpression: String? = nil, outputLocation: InstanceAssociationOutputLocation? = nil, maxErrors: String? = nil, lastUpdateAssociationDate: TimeStamp? = nil, associationVersion: String? = nil, targets: [Target]? = nil, associationId: String? = nil, instanceId: String? = nil, maxConcurrency: String? = nil, status: AssociationStatus? = nil) {
            self.associationName = associationName
            self.parameters = parameters
            self.overview = overview
            self.documentVersion = documentVersion
    ...
    public struct InventoryItem: AWSShape {
        ...
        public init(typeName: String, schemaVersion: String, captureTime: String, contentHash: String? = nil, context: [String: String]? = nil, content: [[String: String]]? = nil) {
            self.typeName = typeName
            self.schemaVersion = schemaVersion
            self.captureTime = captureTime
    ...
    public struct DescribeMaintenanceWindowExecutionTasksRequest: AWSShape {
        ...
        public init(filters: [MaintenanceWindowFilter]? = nil, windowExecutionId: String, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.filters = filters
            self.windowExecutionId = windowExecutionId
            self.nextToken = nextToken
            self.maxResults = maxResults
    ...
    public struct ModifyDocumentPermissionRequest: AWSShape {
        ...
        public init(name: String, accountIdsToAdd: [String]? = nil, accountIdsToRemove: [String]? = nil, permissionType: DocumentPermissionType) {
            self.name = name
    ...
    public struct CreatePatchBaselineRequest: AWSShape {
        ...
        public init(name: String, clientToken: String? = nil, approvedPatches: [String]? = nil, operatingSystem: OperatingSystem? = nil, approvedPatchesComplianceLevel: PatchComplianceLevel? = nil, rejectedPatches: [String]? = nil, rejectedPatchesAction: PatchAction? = nil, approvedPatchesEnableNonSecurity: Bool? = nil, sources: [PatchSource]? = nil, description: String? = nil, approvalRules: PatchRuleGroup? = nil, globalFilters: PatchFilterGroup? = nil) {
            self.name = name
            self.clientToken = clientToken
            self.approvedPatches = approvedPatches
            self.operatingSystem = operatingSystem
    ...
    public struct ComplianceItem: AWSShape {
        ...
        public init(severity: ComplianceSeverity? = nil, title: String? = nil, executionSummary: ComplianceExecutionSummary? = nil, status: ComplianceStatus? = nil, resourceType: String? = nil, id: String? = nil, complianceType: String? = nil, details: [String: String]? = nil, resourceId: String? = nil) {
            self.severity = severity
            self.title = title
            self.executionSummary = executionSummary
            self.status = status
    ...
    public struct UpdateMaintenanceWindowRequest: AWSShape {
        ...
        public init(name: String? = nil, enabled: Bool? = nil, replace: Bool? = nil, scheduleTimezone: String? = nil, cutoff: Int32? = nil, schedule: String? = nil, allowUnassociatedTargets: Bool? = nil, endDate: String? = nil, duration: Int32? = nil, windowId: String, description: String? = nil, startDate: String? = nil) {
            self.name = name
            self.enabled = enabled
            self.replace = replace
            self.scheduleTimezone = scheduleTimezone
    ...
    public struct GetDocumentResult: AWSShape {
        ...
        public init(name: String? = nil, statusInformation: String? = nil, status: DocumentStatus? = nil, documentVersion: String? = nil, versionName: String? = nil, documentType: DocumentType? = nil, attachmentsContent: [AttachmentContent]? = nil, content: String? = nil, documentFormat: DocumentFormat? = nil) {
            self.name = name
            self.statusInformation = statusInformation
            self.status = status
            self.documentVersion = documentVersion
    ...
    public struct DescribeMaintenanceWindowScheduleRequest: AWSShape {
        ...
        public init(resourceType: MaintenanceWindowResourceType? = nil, filters: [PatchOrchestratorFilter]? = nil, windowId: String? = nil, maxResults: Int32? = nil, nextToken: String? = nil, targets: [Target]? = nil) {
            self.resourceType = resourceType
            self.filters = filters
            self.windowId = windowId
            self.maxResults = maxResults
    ...
    public struct AssociationExecutionTarget: AWSShape {
        ...
        public init(associationVersion: String? = nil, associationId: String? = nil, status: String? = nil, lastExecutionDate: TimeStamp? = nil, outputSource: OutputSource? = nil, resourceType: String? = nil, detailedStatus: String? = nil, executionId: String? = nil, resourceId: String? = nil) {
            self.associationVersion = associationVersion
            self.associationId = associationId
            self.status = status
            self.lastExecutionDate = lastExecutionDate
    ...
    public struct ScheduledWindowExecution: AWSShape {
        ...
        public init(windowId: String? = nil, name: String? = nil, executionTime: String? = nil) {
            self.windowId = windowId
            self.name = name
            self.executionTime = executionTime
        }
    ...
    public struct InventoryResultItem: AWSShape {
        ...
        public init(typeName: String, schemaVersion: String, captureTime: String? = nil, contentHash: String? = nil, content: [[String: String]]) {
            self.typeName = typeName
            self.schemaVersion = schemaVersion
            self.captureTime = captureTime
            self.contentHash = contentHash
    ...
    public struct ListDocumentsRequest: AWSShape {
        ...
        public init(filters: [DocumentKeyValuesFilter]? = nil, documentFilterList: [DocumentFilter]? = nil, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.filters = filters
    ...
    public struct GetInventorySchemaRequest: AWSShape {
        ...
        public init(maxResults: Int32? = nil, subType: Bool? = nil, nextToken: String? = nil, aggregator: Bool? = nil, typeName: String? = nil) {
            self.maxResults = maxResults
    ...
    public struct MaintenanceWindowTask: AWSShape {
        ...
        public init(windowId: String? = nil, priority: Int32? = nil, windowTaskId: String? = nil, taskArn: String? = nil, maxErrors: String? = nil, description: String? = nil, name: String? = nil, type: MaintenanceWindowTaskType? = nil, serviceRoleArn: String? = nil, targets: [Target]? = nil, taskParameters: [String: MaintenanceWindowTaskParameterValueExpression]? = nil, loggingInfo: LoggingInfo? = nil, maxConcurrency: String? = nil) {
            self.windowId = windowId
            self.priority = priority
            self.windowTaskId = windowTaskId
            self.taskArn = taskArn
    ...
    public struct ResumeSessionResponse: AWSShape {
        ...
        public init(streamUrl: String? = nil, tokenValue: String? = nil, sessionId: String? = nil) {
    ...
    public struct GetDocumentRequest: AWSShape {
        ...
        public init(versionName: String? = nil, name: String, documentFormat: DocumentFormat? = nil, documentVersion: String? = nil) {
            self.versionName = versionName
            self.name = name
            self.documentFormat = documentFormat
            self.documentVersion = documentVersion
    ...
    public struct SeveritySummary: AWSShape {
        ...
        public init(lowCount: Int32? = nil, mediumCount: Int32? = nil, unspecifiedCount: Int32? = nil, criticalCount: Int32? = nil, highCount: Int32? = nil, informationalCount: Int32? = nil) {
    ...
    public struct ParameterMetadata: AWSShape {
        ...
        public init(name: String? = nil, lastModifiedDate: TimeStamp? = nil, version: Int64? = nil, keyId: String? = nil, type: ParameterType? = nil, lastModifiedUser: String? = nil, allowedPattern: String? = nil, description: String? = nil) {
            self.name = name
            self.lastModifiedDate = lastModifiedDate
            self.version = version
            self.keyId = keyId
    ...
    public struct DescribeAssociationRequest: AWSShape {
        ...
        public init(name: String? = nil, instanceId: String? = nil, associationVersion: String? = nil, associationId: String? = nil) {
            self.name = name
            self.instanceId = instanceId
            self.associationVersion = associationVersion
            self.associationId = associationId
    ...
    public class InventoryAggregator: AWSShape {
        ...
        public init(groups: [InventoryGroup]? = nil, aggregators: [InventoryAggregator]? = nil, expression: String? = nil) {
            self.groups = groups
    ...
    public struct AutomationExecutionMetadata: AWSShape {
        ...
        public init(failureMessage: String? = nil, automationExecutionId: String? = nil, parentAutomationExecutionId: String? = nil, resolvedTargets: ResolvedTargets? = nil, documentVersion: String? = nil, currentAction: String? = nil, executedBy: String? = nil, automationExecutionStatus: AutomationExecutionStatus? = nil, currentStepName: String? = nil, mode: ExecutionMode? = nil, maxErrors: String? = nil, executionEndTime: TimeStamp? = nil, automationType: AutomationType? = nil, targetParameterName: String? = nil, outputs: [String: [String]]? = nil, documentName: String? = nil, executionStartTime: TimeStamp? = nil, maxConcurrency: String? = nil, targets: [Target]? = nil, targetMaps: [[String: [String]]]? = nil, logFile: String? = nil, target: String? = nil) {
            self.failureMessage = failureMessage
            self.automationExecutionId = automationExecutionId
            self.parentAutomationExecutionId = parentAutomationExecutionId
            self.resolvedTargets = resolvedTargets
    ...
    public struct GetInventoryRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, filters: [InventoryFilter]? = nil, aggregators: [InventoryAggregator]? = nil, maxResults: Int32? = nil, resultAttributes: [ResultAttribute]? = nil) {
            self.nextToken = nextToken
            self.filters = filters
            self.aggregators = aggregators
            self.maxResults = maxResults
    ...
    public struct Session: AWSShape {
        ...
        public init(owner: String? = nil, status: SessionStatus? = nil, details: String? = nil, endDate: TimeStamp? = nil, sessionId: String? = nil, target: String? = nil, documentName: String? = nil, outputUrl: SessionManagerOutputUrl? = nil, startDate: TimeStamp? = nil) {
            self.owner = owner
            self.status = status
            self.details = details
            self.endDate = endDate
    ...
    public struct DocumentVersionInfo: AWSShape {
        ...
        public init(name: String? = nil, statusInformation: String? = nil, status: DocumentStatus? = nil, documentVersion: String? = nil, versionName: String? = nil, createdDate: TimeStamp? = nil, isDefaultVersion: Bool? = nil, documentFormat: DocumentFormat? = nil) {
            self.name = name
            self.statusInformation = statusInformation
            self.status = status
            self.documentVersion = documentVersion
    ...
    public struct CommandInvocation: AWSShape {
        ...
        public init(cloudWatchOutputConfig: CloudWatchOutputConfig? = nil, commandPlugins: [CommandPlugin]? = nil, documentVersion: String? = nil, commandId: String? = nil, comment: String? = nil, standardErrorUrl: String? = nil, notificationConfig: NotificationConfig? = nil, statusDetails: String? = nil, standardOutputUrl: String? = nil, requestedDateTime: TimeStamp? = nil, documentName: String? = nil, traceOutput: String? = nil, serviceRole: String? = nil, instanceId: String? = nil, status: CommandInvocationStatus? = nil, instanceName: String? = nil) {
            self.cloudWatchOutputConfig = cloudWatchOutputConfig
    ...
    public struct MaintenanceWindowTaskInvocationParameters: AWSShape {
        ...
        public init(runCommand: MaintenanceWindowRunCommandParameters? = nil, automation: MaintenanceWindowAutomationParameters? = nil, stepFunctions: MaintenanceWindowStepFunctionsParameters? = nil, lambda: MaintenanceWindowLambdaParameters? = nil) {
    ...
    public struct Patch: AWSShape {
        ...
        public init(product: String? = nil, msrcSeverity: String? = nil, releaseDate: TimeStamp? = nil, title: String? = nil, classification: String? = nil, msrcNumber: String? = nil, productFamily: String? = nil, contentUrl: String? = nil, vendor: String? = nil, description: String? = nil, language: String? = nil, id: String? = nil, kbNumber: String? = nil) {
            self.product = product
    ...
    public struct StartAutomationExecutionRequest: AWSShape {
        ...
        public init(documentVersion: String? = nil, clientToken: String? = nil, targetLocations: [TargetLocation]? = nil, targetParameterName: String? = nil, maxErrors: String? = nil, targets: [Target]? = nil, targetMaps: [[String: [String]]]? = nil, maxConcurrency: String? = nil, documentName: String, parameters: [String: [String]]? = nil, mode: ExecutionMode? = nil) {
            self.documentVersion = documentVersion
            self.clientToken = clientToken
            self.targetLocations = targetLocations
            self.targetParameterName = targetParameterName
    ...
    public struct StepExecution: AWSShape {
        ...
        public init(failureDetails: FailureDetails? = nil, failureMessage: String? = nil, validNextSteps: [String]? = nil, isCritical: Bool? = nil, onFailure: String? = nil, timeoutSeconds: Int64? = nil, stepExecutionId: String? = nil, stepStatus: AutomationExecutionStatus? = nil, action: String? = nil, targetLocation: TargetLocation? = nil, isEnd: Bool? = nil, response: String? = nil, responseCode: String? = nil, inputs: [String: String]? = nil, outputs: [String: [String]]? = nil, executionStartTime: TimeStamp? = nil, executionEndTime: TimeStamp? = nil, targets: [Target]? = nil, nextStep: String? = nil, overriddenParameters: [String: [String]]? = nil, maxAttempts: Int32? = nil, stepName: String? = nil) {
    ...
    public struct InstancePatchState: AWSShape {
        ...
        public init(snapshotId: String? = nil, installedCount: Int32? = nil, notApplicableCount: Int32? = nil, operationEndTime: TimeStamp, installedRejectedCount: Int32? = nil, installOverrideList: String? = nil, baselineId: String, missingCount: Int32? = nil, ownerInformation: String? = nil, failedCount: Int32? = nil, patchGroup: String, installedOtherCount: Int32? = nil, operationStartTime: TimeStamp, instanceId: String, operation: PatchOperationType) {
            self.snapshotId = snapshotId
    ...
    public struct ListInventoryEntriesRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: Int32? = nil, instanceId: String, filters: [InventoryFilter]? = nil, typeName: String) {
            self.nextToken = nextToken
            self.maxResults = maxResults
            self.instanceId = instanceId
            self.filters = filters
    ...
    public struct UpdateAssociationRequest: AWSShape {
        ...
        public init(name: String? = nil, associationVersion: String? = nil, documentVersion: String? = nil, associationId: String, complianceSeverity: AssociationComplianceSeverity? = nil, associationName: String? = nil, targets: [Target]? = nil, scheduleExpression: String? = nil, parameters: [String: [String]]? = nil, maxErrors: String? = nil, outputLocation: InstanceAssociationOutputLocation? = nil, maxConcurrency: String? = nil) {
            self.name = name
            self.associationVersion = associationVersion
            self.documentVersion = documentVersion
            self.associationId = associationId
