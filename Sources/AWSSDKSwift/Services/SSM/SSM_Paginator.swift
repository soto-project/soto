...
extension SSM {
    ...
    public func describeActivationsPaginator(_ input: DescribeActivationsRequest) -> EventLoopFuture<[Activation]> {
        return client.paginate(input: input, command: describeActivations, resultKey: \DescribeActivationsResult.activationList, tokenKey: \DescribeActivationsResult.nextToken)
    }
    ...
    public func describeInstanceInformationPaginator(_ input: DescribeInstanceInformationRequest) -> EventLoopFuture<[InstanceInformation]> {
        return client.paginate(input: input, command: describeInstanceInformation, resultKey: \DescribeInstanceInformationResult.instanceInformationList, tokenKey: \DescribeInstanceInformationResult.nextToken)
    }
    ...
    public func describeParametersPaginator(_ input: DescribeParametersRequest) -> EventLoopFuture<[ParameterMetadata]> {
        return client.paginate(input: input, command: describeParameters, resultKey: \DescribeParametersResult.parameters, tokenKey: \DescribeParametersResult.nextToken)
    }
    
    ///  Query a list of all parameters used by the AWS account.
    public func getParameterHistoryPaginator(_ input: GetParameterHistoryRequest) -> EventLoopFuture<[ParameterHistory]> {
        return client.paginate(input: input, command: getParameterHistory, resultKey: \GetParameterHistoryResult.parameters, tokenKey: \GetParameterHistoryResult.nextToken)
    }
    ...
    public func getParametersByPathPaginator(_ input: GetParametersByPathRequest) -> EventLoopFuture<[Parameter]> {
        return client.paginate(input: input, command: getParametersByPath, resultKey: \GetParametersByPathResult.parameters, tokenKey: \GetParametersByPathResult.nextToken)
    }
    ...
    public func listAssociationsPaginator(_ input: ListAssociationsRequest) -> EventLoopFuture<[Association]> {
        return client.paginate(input: input, command: listAssociations, resultKey: \ListAssociationsResult.associations, tokenKey: \ListAssociationsResult.nextToken)
    }
    ...
    public func listCommandInvocationsPaginator(_ input: ListCommandInvocationsRequest) -> EventLoopFuture<[CommandInvocation]> {
        return client.paginate(input: input, command: listCommandInvocations, resultKey: \ListCommandInvocationsResult.commandInvocations, tokenKey: \ListCommandInvocationsResult.nextToken)
    }
    
    ///  Lists the commands requested by users of the AWS account.
    public func listCommandsPaginator(_ input: ListCommandsRequest) -> EventLoopFuture<[Command]> {
        return client.paginate(input: input, command: listCommands, resultKey: \ListCommandsResult.commands, tokenKey: \ListCommandsResult.nextToken)
    }
    ...
    public func listDocumentsPaginator(_ input: ListDocumentsRequest) -> EventLoopFuture<[DocumentIdentifier]> {
        return client.paginate(input: input, command: listDocuments, resultKey: \ListDocumentsResult.documentIdentifiers, tokenKey: \ListDocumentsResult.nextToken)
    }
