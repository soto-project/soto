...
extension ELBV2 {
    ...
    public func describeListenersPaginator(_ input: DescribeListenersInput) -> EventLoopFuture<[Listener]> {
        return client.paginate(input: input, command: describeListeners, resultKey: \DescribeListenersOutput.listeners, tokenKey: \DescribeListenersOutput.nextMarker)
    }
    ...
    public func describeLoadBalancersPaginator(_ input: DescribeLoadBalancersInput) -> EventLoopFuture<[LoadBalancer]> {
        return client.paginate(input: input, command: describeLoadBalancers, resultKey: \DescribeLoadBalancersOutput.loadBalancers, tokenKey: \DescribeLoadBalancersOutput.nextMarker)
    }
    ...
    public func describeTargetGroupsPaginator(_ input: DescribeTargetGroupsInput) -> EventLoopFuture<[TargetGroup]> {
        return client.paginate(input: input, command: describeTargetGroups, resultKey: \DescribeTargetGroupsOutput.targetGroups, tokenKey: \DescribeTargetGroupsOutput.nextMarker)
    }
