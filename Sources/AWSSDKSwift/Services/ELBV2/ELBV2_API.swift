...
public struct ELBV2 {
    ...
    public func describeLoadBalancers(_ input: DescribeLoadBalancersInput) throws -> EventLoopFuture<DescribeLoadBalancersOutput> {
    ...
    public func modifyTargetGroup(_ input: ModifyTargetGroupInput) throws -> EventLoopFuture<ModifyTargetGroupOutput> {
        return try client.send(operation: "ModifyTargetGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified attributes of the specified target group.
    public func modifyTargetGroupAttributes(_ input: ModifyTargetGroupAttributesInput) throws -> EventLoopFuture<ModifyTargetGroupAttributesOutput> {
    ...
    public func describeListeners(_ input: DescribeListenersInput) throws -> EventLoopFuture<DescribeListenersOutput> {
    ...
    public func deleteTargetGroup(_ input: DeleteTargetGroupInput) throws -> EventLoopFuture<DeleteTargetGroupOutput> {
    ...
    public func createTargetGroup(_ input: CreateTargetGroupInput) throws -> EventLoopFuture<CreateTargetGroupOutput> {
    ...
    public func setSecurityGroups(_ input: SetSecurityGroupsInput) throws -> EventLoopFuture<SetSecurityGroupsOutput> {
    ...
    public func addListenerCertificates(_ input: AddListenerCertificatesInput) throws -> EventLoopFuture<AddListenerCertificatesOutput> {
    ...
    public func modifyRule(_ input: ModifyRuleInput) throws -> EventLoopFuture<ModifyRuleOutput> {
    ...
    public func registerTargets(_ input: RegisterTargetsInput) throws -> EventLoopFuture<RegisterTargetsOutput> {
        return try client.send(operation: "RegisterTargets", path: "/", httpMethod: "POST", input: input)
    }

    public func modifyProvisionedCapacity(_ input: ModifyProvisionedCapacityInput) throws -> EventLoopFuture<ModifyProvisionedCapacityOutput> {
    ...
    public func createLoadBalancer(_ input: CreateLoadBalancerInput) throws -> EventLoopFuture<CreateLoadBalancerOutput> {
    ...
    public func describeTargetGroups(_ input: DescribeTargetGroupsInput) throws -> EventLoopFuture<DescribeTargetGroupsOutput> {
        return try client.send(operation: "DescribeTargetGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deregisters the specified targets from the specified target group. After the targets are deregistered, they no longer receive traffic from the load balancer.
    public func deregisterTargets(_ input: DeregisterTargetsInput) throws -> EventLoopFuture<DeregisterTargetsOutput> {
    ...
    public func describeSSLPolicies(_ input: DescribeSSLPoliciesInput) throws -> EventLoopFuture<DescribeSSLPoliciesOutput> {
        return try client.send(operation: "DescribeSSLPolicies", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified rule.
    public func deleteRule(_ input: DeleteRuleInput) throws -> EventLoopFuture<DeleteRuleOutput> {
    ...
    public func setIpAddressType(_ input: SetIpAddressTypeInput) throws -> EventLoopFuture<SetIpAddressTypeOutput> {
    ...
    public func deleteListener(_ input: DeleteListenerInput) throws -> EventLoopFuture<DeleteListenerOutput> {
    ...
    public func setSubnets(_ input: SetSubnetsInput) throws -> EventLoopFuture<SetSubnetsOutput> {
        return try client.send(operation: "SetSubnets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the certificates for the specified secure listener.
    public func describeListenerCertificates(_ input: DescribeListenerCertificatesInput) throws -> EventLoopFuture<DescribeListenerCertificatesOutput> {
    ...
    public func deleteLoadBalancer(_ input: DeleteLoadBalancerInput) throws -> EventLoopFuture<DeleteLoadBalancerOutput> {
    ...
    public func describeTargetHealth(_ input: DescribeTargetHealthInput) throws -> EventLoopFuture<DescribeTargetHealthOutput> {
    ...
    public func setRulePriorities(_ input: SetRulePrioritiesInput) throws -> EventLoopFuture<SetRulePrioritiesOutput> {
    ...
    public func describeTargetGroupAttributes(_ input: DescribeTargetGroupAttributesInput) throws -> EventLoopFuture<DescribeTargetGroupAttributesOutput> {
    ...
    public func createListener(_ input: CreateListenerInput) throws -> EventLoopFuture<CreateListenerOutput> {
    ...
    public func removeListenerCertificates(_ input: RemoveListenerCertificatesInput) throws -> EventLoopFuture<RemoveListenerCertificatesOutput> {
        return try client.send(operation: "RemoveListenerCertificates", path: "/", httpMethod: "POST", input: input)
    }

    public func describeProvisionedCapacity(_ input: DescribeProvisionedCapacityInput) throws -> EventLoopFuture<DescribeProvisionedCapacityOutput> {
    ...
    public func modifyListener(_ input: ModifyListenerInput) throws -> EventLoopFuture<ModifyListenerOutput> {
    ...
    public func createRule(_ input: CreateRuleInput) throws -> EventLoopFuture<CreateRuleOutput> {
        return try client.send(operation: "CreateRule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified rules or the rules for the specified listener. You must specify either a listener or one or more rules.
    public func describeRules(_ input: DescribeRulesInput) throws -> EventLoopFuture<DescribeRulesOutput> {
