...
public struct ELBV2: AWSService {
    ...
    public func addListenerCertificates(_ input: AddListenerCertificatesInput) -> EventLoopFuture<AddListenerCertificatesOutput> {
        return client.execute(operation: "AddListenerCertificates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createTargetGroup(_ input: CreateTargetGroupInput) -> EventLoopFuture<CreateTargetGroupOutput> {
        return client.execute(operation: "CreateTargetGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteTargetGroup(_ input: DeleteTargetGroupInput) -> EventLoopFuture<DeleteTargetGroupOutput> {
        return client.execute(operation: "DeleteTargetGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deregisterTargets(_ input: DeregisterTargetsInput) -> EventLoopFuture<DeregisterTargetsOutput> {
        return client.execute(operation: "DeregisterTargets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeListenerCertificates(_ input: DescribeListenerCertificatesInput) -> EventLoopFuture<DescribeListenerCertificatesOutput> {
        return client.execute(operation: "DescribeListenerCertificates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeListeners(_ input: DescribeListenersInput) -> EventLoopFuture<DescribeListenersOutput> {
        return client.execute(operation: "DescribeListeners", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeRules(_ input: DescribeRulesInput) -> EventLoopFuture<DescribeRulesOutput> {
        return client.execute(operation: "DescribeRules", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeSSLPolicies(_ input: DescribeSSLPoliciesInput) -> EventLoopFuture<DescribeSSLPoliciesOutput> {
        return client.execute(operation: "DescribeSSLPolicies", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTargetGroupAttributes(_ input: DescribeTargetGroupAttributesInput) -> EventLoopFuture<DescribeTargetGroupAttributesOutput> {
        return client.execute(operation: "DescribeTargetGroupAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTargetGroups(_ input: DescribeTargetGroupsInput) -> EventLoopFuture<DescribeTargetGroupsOutput> {
        return client.execute(operation: "DescribeTargetGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTargetHealth(_ input: DescribeTargetHealthInput) -> EventLoopFuture<DescribeTargetHealthOutput> {
        return client.execute(operation: "DescribeTargetHealth", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyListener(_ input: ModifyListenerInput) -> EventLoopFuture<ModifyListenerOutput> {
        return client.execute(operation: "ModifyListener", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyRule(_ input: ModifyRuleInput) -> EventLoopFuture<ModifyRuleOutput> {
        return client.execute(operation: "ModifyRule", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyTargetGroup(_ input: ModifyTargetGroupInput) -> EventLoopFuture<ModifyTargetGroupOutput> {
        return client.execute(operation: "ModifyTargetGroup", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyTargetGroupAttributes(_ input: ModifyTargetGroupAttributesInput) -> EventLoopFuture<ModifyTargetGroupAttributesOutput> {
        return client.execute(operation: "ModifyTargetGroupAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerTargets(_ input: RegisterTargetsInput) -> EventLoopFuture<RegisterTargetsOutput> {
        return client.execute(operation: "RegisterTargets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func removeListenerCertificates(_ input: RemoveListenerCertificatesInput) -> EventLoopFuture<RemoveListenerCertificatesOutput> {
        return client.execute(operation: "RemoveListenerCertificates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setIpAddressType(_ input: SetIpAddressTypeInput) -> EventLoopFuture<SetIpAddressTypeOutput> {
        return client.execute(operation: "SetIpAddressType", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setRulePriorities(_ input: SetRulePrioritiesInput) -> EventLoopFuture<SetRulePrioritiesOutput> {
        return client.execute(operation: "SetRulePriorities", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setSecurityGroups(_ input: SetSecurityGroupsInput) -> EventLoopFuture<SetSecurityGroupsOutput> {
        return client.execute(operation: "SetSecurityGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setSubnets(_ input: SetSubnetsInput) -> EventLoopFuture<SetSubnetsOutput> {
        return client.execute(operation: "SetSubnets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
