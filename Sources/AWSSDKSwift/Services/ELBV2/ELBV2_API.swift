...
public struct ELBV2 {
    ...
    public func addListenerCertificates(_ input: AddListenerCertificatesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AddListenerCertificatesOutput> {
        return client.execute(operation: "AddListenerCertificates", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createListener(_ input: CreateListenerInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateListenerOutput> {
        return client.execute(operation: "CreateListener", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createLoadBalancer(_ input: CreateLoadBalancerInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateLoadBalancerOutput> {
    ...
    public func createRule(_ input: CreateRuleInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateRuleOutput> {
    ...
    public func createTargetGroup(_ input: CreateTargetGroupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateTargetGroupOutput> {
        return client.execute(operation: "CreateTargetGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteListener(_ input: DeleteListenerInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteListenerOutput> {
        return client.execute(operation: "DeleteListener", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteLoadBalancer(_ input: DeleteLoadBalancerInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteLoadBalancerOutput> {
    ...
    public func deleteRule(_ input: DeleteRuleInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteRuleOutput> {
    ...
    public func deleteTargetGroup(_ input: DeleteTargetGroupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteTargetGroupOutput> {
        return client.execute(operation: "DeleteTargetGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Deregisters the specified targets from the specified target group. After the targets are deregistered, they no longer receive traffic from the load balancer.
    public func deregisterTargets(_ input: DeregisterTargetsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeregisterTargetsOutput> {
        return client.execute(operation: "DeregisterTargets", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeListenerCertificates(_ input: DescribeListenerCertificatesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeListenerCertificatesOutput> {
        return client.execute(operation: "DescribeListenerCertificates", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeListeners(_ input: DescribeListenersInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeListenersOutput> {
        return client.execute(operation: "DescribeListeners", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeLoadBalancers(_ input: DescribeLoadBalancersInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeLoadBalancersOutput> {
    ...
    public func describeRules(_ input: DescribeRulesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeRulesOutput> {
        return client.execute(operation: "DescribeRules", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeSSLPolicies(_ input: DescribeSSLPoliciesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeSSLPoliciesOutput> {
        return client.execute(operation: "DescribeSSLPolicies", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTargetGroupAttributes(_ input: DescribeTargetGroupAttributesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTargetGroupAttributesOutput> {
        return client.execute(operation: "DescribeTargetGroupAttributes", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTargetGroups(_ input: DescribeTargetGroupsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTargetGroupsOutput> {
        return client.execute(operation: "DescribeTargetGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Describes the health of the specified targets or all of your targets.
    public func describeTargetHealth(_ input: DescribeTargetHealthInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTargetHealthOutput> {
        return client.execute(operation: "DescribeTargetHealth", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func modifyListener(_ input: ModifyListenerInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ModifyListenerOutput> {
        return client.execute(operation: "ModifyListener", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func modifyRule(_ input: ModifyRuleInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ModifyRuleOutput> {
        return client.execute(operation: "ModifyRule", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func modifyTargetGroup(_ input: ModifyTargetGroupInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ModifyTargetGroupOutput> {
        return client.execute(operation: "ModifyTargetGroup", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Modifies the specified attributes of the specified target group.
    public func modifyTargetGroupAttributes(_ input: ModifyTargetGroupAttributesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ModifyTargetGroupAttributesOutput> {
        return client.execute(operation: "ModifyTargetGroupAttributes", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func registerTargets(_ input: RegisterTargetsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RegisterTargetsOutput> {
        return client.execute(operation: "RegisterTargets", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func removeListenerCertificates(_ input: RemoveListenerCertificatesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RemoveListenerCertificatesOutput> {
        return client.execute(operation: "RemoveListenerCertificates", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func setIpAddressType(_ input: SetIpAddressTypeInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SetIpAddressTypeOutput> {
        return client.execute(operation: "SetIpAddressType", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func setRulePriorities(_ input: SetRulePrioritiesInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SetRulePrioritiesOutput> {
        return client.execute(operation: "SetRulePriorities", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func setSecurityGroups(_ input: SetSecurityGroupsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SetSecurityGroupsOutput> {
        return client.execute(operation: "SetSecurityGroups", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func setSubnets(_ input: SetSubnetsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<SetSubnetsOutput> {
        return client.execute(operation: "SetSubnets", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
