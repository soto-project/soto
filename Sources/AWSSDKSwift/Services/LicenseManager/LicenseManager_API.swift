...
public struct LicenseManager {
    ...
    public func listUsageForLicenseConfiguration(_ input: ListUsageForLicenseConfigurationRequest) throws -> EventLoopFuture<ListUsageForLicenseConfigurationResponse> {
    ...
    public func getServiceSettings(_ input: GetServiceSettingsRequest) throws -> EventLoopFuture<GetServiceSettingsResponse> {
        return try client.send(operation: "GetServiceSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the license configuration for a resource.
    public func listLicenseSpecificationsForResource(_ input: ListLicenseSpecificationsForResourceRequest) throws -> EventLoopFuture<ListLicenseSpecificationsForResourceResponse> {
    ...
    public func updateLicenseConfiguration(_ input: UpdateLicenseConfigurationRequest) throws -> EventLoopFuture<UpdateLicenseConfigurationResponse> {
    ...
    public func listLicenseConfigurations(_ input: ListLicenseConfigurationsRequest) throws -> EventLoopFuture<ListLicenseConfigurationsResponse> {
        return try client.send(operation: "ListLicenseConfigurations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a detailed description of a license configuration.
    public func getLicenseConfiguration(_ input: GetLicenseConfigurationRequest) throws -> EventLoopFuture<GetLicenseConfigurationResponse> {
        return try client.send(operation: "GetLicenseConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a detailed list of resources.
    public func listResourceInventory(_ input: ListResourceInventoryRequest) throws -> EventLoopFuture<ListResourceInventoryResponse> {
    ...
    public func updateLicenseSpecificationsForResource(_ input: UpdateLicenseSpecificationsForResourceRequest) throws -> EventLoopFuture<UpdateLicenseSpecificationsForResourceResponse> {
    ...
    public func createLicenseConfiguration(_ input: CreateLicenseConfigurationRequest) throws -> EventLoopFuture<CreateLicenseConfigurationResponse> {
    ...
    public func listAssociationsForLicenseConfiguration(_ input: ListAssociationsForLicenseConfigurationRequest) throws -> EventLoopFuture<ListAssociationsForLicenseConfigurationResponse> {
    ...
    public func deleteLicenseConfiguration(_ input: DeleteLicenseConfigurationRequest) throws -> EventLoopFuture<DeleteLicenseConfigurationResponse> {
        return try client.send(operation: "DeleteLicenseConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates License Manager service settings.
    public func updateServiceSettings(_ input: UpdateServiceSettingsRequest) throws -> EventLoopFuture<UpdateServiceSettingsResponse> {
