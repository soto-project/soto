...
public struct PinpointEmail: AWSService {
    ...
    public func createConfigurationSet(_ input: CreateConfigurationSetRequest) -> EventLoopFuture<CreateConfigurationSetResponse> {
        return client.execute(operation: "CreateConfigurationSet", path: "/v1/email/configuration-sets", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createConfigurationSetEventDestination(_ input: CreateConfigurationSetEventDestinationRequest) -> EventLoopFuture<CreateConfigurationSetEventDestinationResponse> {
        return client.execute(operation: "CreateConfigurationSetEventDestination", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDedicatedIpPool(_ input: CreateDedicatedIpPoolRequest) -> EventLoopFuture<CreateDedicatedIpPoolResponse> {
        return client.execute(operation: "CreateDedicatedIpPool", path: "/v1/email/dedicated-ip-pools", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createDeliverabilityTestReport(_ input: CreateDeliverabilityTestReportRequest) -> EventLoopFuture<CreateDeliverabilityTestReportResponse> {
        return client.execute(operation: "CreateDeliverabilityTestReport", path: "/v1/email/deliverability-dashboard/test", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createEmailIdentity(_ input: CreateEmailIdentityRequest) -> EventLoopFuture<CreateEmailIdentityResponse> {
        return client.execute(operation: "CreateEmailIdentity", path: "/v1/email/identities", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteConfigurationSet(_ input: DeleteConfigurationSetRequest) -> EventLoopFuture<DeleteConfigurationSetResponse> {
        return client.execute(operation: "DeleteConfigurationSet", path: "/v1/email/configuration-sets/{ConfigurationSetName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteConfigurationSetEventDestination(_ input: DeleteConfigurationSetEventDestinationRequest) -> EventLoopFuture<DeleteConfigurationSetEventDestinationResponse> {
        return client.execute(operation: "DeleteConfigurationSetEventDestination", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDedicatedIpPool(_ input: DeleteDedicatedIpPoolRequest) -> EventLoopFuture<DeleteDedicatedIpPoolResponse> {
        return client.execute(operation: "DeleteDedicatedIpPool", path: "/v1/email/dedicated-ip-pools/{PoolName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteEmailIdentity(_ input: DeleteEmailIdentityRequest) -> EventLoopFuture<DeleteEmailIdentityResponse> {
        return client.execute(operation: "DeleteEmailIdentity", path: "/v1/email/identities/{EmailIdentity}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Obtain information about the email-sending status and capabilities of your Amazon Pinpoint account in the current AWS Region.
    public func getAccount(_ input: GetAccountRequest) -> EventLoopFuture<GetAccountResponse> {
        return client.execute(operation: "GetAccount", path: "/v1/email/account", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBlacklistReports(_ input: GetBlacklistReportsRequest) -> EventLoopFuture<GetBlacklistReportsResponse> {
        return client.execute(operation: "GetBlacklistReports", path: "/v1/email/deliverability-dashboard/blacklist-report", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getConfigurationSet(_ input: GetConfigurationSetRequest) -> EventLoopFuture<GetConfigurationSetResponse> {
        return client.execute(operation: "GetConfigurationSet", path: "/v1/email/configuration-sets/{ConfigurationSetName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getConfigurationSetEventDestinations(_ input: GetConfigurationSetEventDestinationsRequest) -> EventLoopFuture<GetConfigurationSetEventDestinationsResponse> {
        return client.execute(operation: "GetConfigurationSetEventDestinations", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDedicatedIp(_ input: GetDedicatedIpRequest) -> EventLoopFuture<GetDedicatedIpResponse> {
        return client.execute(operation: "GetDedicatedIp", path: "/v1/email/dedicated-ips/{IP}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  List the dedicated IP addresses that are associated with your Amazon Pinpoint account.
    public func getDedicatedIps(_ input: GetDedicatedIpsRequest) -> EventLoopFuture<GetDedicatedIpsResponse> {
        return client.execute(operation: "GetDedicatedIps", path: "/v1/email/dedicated-ips", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDeliverabilityDashboardOptions(_ input: GetDeliverabilityDashboardOptionsRequest) -> EventLoopFuture<GetDeliverabilityDashboardOptionsResponse> {
        return client.execute(operation: "GetDeliverabilityDashboardOptions", path: "/v1/email/deliverability-dashboard", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDeliverabilityTestReport(_ input: GetDeliverabilityTestReportRequest) -> EventLoopFuture<GetDeliverabilityTestReportResponse> {
        return client.execute(operation: "GetDeliverabilityTestReport", path: "/v1/email/deliverability-dashboard/test-reports/{ReportId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDomainDeliverabilityCampaign(_ input: GetDomainDeliverabilityCampaignRequest) -> EventLoopFuture<GetDomainDeliverabilityCampaignResponse> {
        return client.execute(operation: "GetDomainDeliverabilityCampaign", path: "/v1/email/deliverability-dashboard/campaigns/{CampaignId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDomainStatisticsReport(_ input: GetDomainStatisticsReportRequest) -> EventLoopFuture<GetDomainStatisticsReportResponse> {
        return client.execute(operation: "GetDomainStatisticsReport", path: "/v1/email/deliverability-dashboard/statistics-report/{Domain}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getEmailIdentity(_ input: GetEmailIdentityRequest) -> EventLoopFuture<GetEmailIdentityResponse> {
        return client.execute(operation: "GetEmailIdentity", path: "/v1/email/identities/{EmailIdentity}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listConfigurationSets(_ input: ListConfigurationSetsRequest) -> EventLoopFuture<ListConfigurationSetsResponse> {
        return client.execute(operation: "ListConfigurationSets", path: "/v1/email/configuration-sets", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDedicatedIpPools(_ input: ListDedicatedIpPoolsRequest) -> EventLoopFuture<ListDedicatedIpPoolsResponse> {
        return client.execute(operation: "ListDedicatedIpPools", path: "/v1/email/dedicated-ip-pools", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDeliverabilityTestReports(_ input: ListDeliverabilityTestReportsRequest) -> EventLoopFuture<ListDeliverabilityTestReportsResponse> {
        return client.execute(operation: "ListDeliverabilityTestReports", path: "/v1/email/deliverability-dashboard/test-reports", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDomainDeliverabilityCampaigns(_ input: ListDomainDeliverabilityCampaignsRequest) -> EventLoopFuture<ListDomainDeliverabilityCampaignsResponse> {
        return client.execute(operation: "ListDomainDeliverabilityCampaigns", path: "/v1/email/deliverability-dashboard/domains/{SubscribedDomain}/campaigns", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listEmailIdentities(_ input: ListEmailIdentitiesRequest) -> EventLoopFuture<ListEmailIdentitiesResponse> {
        return client.execute(operation: "ListEmailIdentities", path: "/v1/email/identities", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest) -> EventLoopFuture<ListTagsForResourceResponse> {
        return client.execute(operation: "ListTagsForResource", path: "/v1/email/tags", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func putAccountDedicatedIpWarmupAttributes(_ input: PutAccountDedicatedIpWarmupAttributesRequest) -> EventLoopFuture<PutAccountDedicatedIpWarmupAttributesResponse> {
        return client.execute(operation: "PutAccountDedicatedIpWarmupAttributes", path: "/v1/email/account/dedicated-ips/warmup", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putAccountSendingAttributes(_ input: PutAccountSendingAttributesRequest) -> EventLoopFuture<PutAccountSendingAttributesResponse> {
        return client.execute(operation: "PutAccountSendingAttributes", path: "/v1/email/account/sending", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetDeliveryOptions(_ input: PutConfigurationSetDeliveryOptionsRequest) -> EventLoopFuture<PutConfigurationSetDeliveryOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetDeliveryOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/delivery-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetReputationOptions(_ input: PutConfigurationSetReputationOptionsRequest) -> EventLoopFuture<PutConfigurationSetReputationOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetReputationOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/reputation-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetSendingOptions(_ input: PutConfigurationSetSendingOptionsRequest) -> EventLoopFuture<PutConfigurationSetSendingOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetSendingOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/sending", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putConfigurationSetTrackingOptions(_ input: PutConfigurationSetTrackingOptionsRequest) -> EventLoopFuture<PutConfigurationSetTrackingOptionsResponse> {
        return client.execute(operation: "PutConfigurationSetTrackingOptions", path: "/v1/email/configuration-sets/{ConfigurationSetName}/tracking-options", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDedicatedIpInPool(_ input: PutDedicatedIpInPoolRequest) -> EventLoopFuture<PutDedicatedIpInPoolResponse> {
        return client.execute(operation: "PutDedicatedIpInPool", path: "/v1/email/dedicated-ips/{IP}/pool", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDedicatedIpWarmupAttributes(_ input: PutDedicatedIpWarmupAttributesRequest) -> EventLoopFuture<PutDedicatedIpWarmupAttributesResponse> {
        return client.execute(operation: "PutDedicatedIpWarmupAttributes", path: "/v1/email/dedicated-ips/{IP}/warmup", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDeliverabilityDashboardOption(_ input: PutDeliverabilityDashboardOptionRequest) -> EventLoopFuture<PutDeliverabilityDashboardOptionResponse> {
        return client.execute(operation: "PutDeliverabilityDashboardOption", path: "/v1/email/deliverability-dashboard", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityDkimAttributes(_ input: PutEmailIdentityDkimAttributesRequest) -> EventLoopFuture<PutEmailIdentityDkimAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityDkimAttributes", path: "/v1/email/identities/{EmailIdentity}/dkim", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityFeedbackAttributes(_ input: PutEmailIdentityFeedbackAttributesRequest) -> EventLoopFuture<PutEmailIdentityFeedbackAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityFeedbackAttributes", path: "/v1/email/identities/{EmailIdentity}/feedback", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEmailIdentityMailFromAttributes(_ input: PutEmailIdentityMailFromAttributesRequest) -> EventLoopFuture<PutEmailIdentityMailFromAttributesResponse> {
        return client.execute(operation: "PutEmailIdentityMailFromAttributes", path: "/v1/email/identities/{EmailIdentity}/mail-from", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func sendEmail(_ input: SendEmailRequest) -> EventLoopFuture<SendEmailResponse> {
        return client.execute(operation: "SendEmail", path: "/v1/email/outbound-emails", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func tagResource(_ input: TagResourceRequest) -> EventLoopFuture<TagResourceResponse> {
        return client.execute(operation: "TagResource", path: "/v1/email/tags", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Remove one or more tags (keys and values) from a specified resource.
    public func untagResource(_ input: UntagResourceRequest) -> EventLoopFuture<UntagResourceResponse> {
        return client.execute(operation: "UntagResource", path: "/v1/email/tags", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateConfigurationSetEventDestination(_ input: UpdateConfigurationSetEventDestinationRequest) -> EventLoopFuture<UpdateConfigurationSetEventDestinationResponse> {
        return client.execute(operation: "UpdateConfigurationSetEventDestination", path: "/v1/email/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
}
