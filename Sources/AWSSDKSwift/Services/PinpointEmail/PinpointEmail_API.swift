...
public struct PinpointEmail {
    ...
    public func createDedicatedIpPool(_ input: CreateDedicatedIpPoolRequest) throws -> CreateDedicatedIpPoolResponse {
    ...
    public func createEmailIdentity(_ input: CreateEmailIdentityRequest) throws -> CreateEmailIdentityResponse {
    ...
    public func deleteDedicatedIpPool(_ input: DeleteDedicatedIpPoolRequest) throws -> DeleteDedicatedIpPoolResponse {
    ...
    public func deleteEmailIdentity(_ input: DeleteEmailIdentityRequest) throws -> DeleteEmailIdentityResponse {
    ...
    public func getConfigurationSet(_ input: GetConfigurationSetRequest) throws -> GetConfigurationSetResponse {
    ...
    public func getDedicatedIp(_ input: GetDedicatedIpRequest) throws -> GetDedicatedIpResponse {
    ...
    public func getDedicatedIps(_ input: GetDedicatedIpsRequest) throws -> GetDedicatedIpsResponse {
    ...
    public func getEmailIdentity(_ input: GetEmailIdentityRequest) throws -> GetEmailIdentityResponse {
    ...
    public func listDedicatedIpPools(_ input: ListDedicatedIpPoolsRequest) throws -> ListDedicatedIpPoolsResponse {
    ...
    public func listEmailIdentities(_ input: ListEmailIdentitiesRequest) throws -> ListEmailIdentitiesResponse {
        return try client.send(operation: "ListEmailIdentities", path: "/v1/email/identities", httpMethod: "GET", input: input)
    }

    ///  Enable or disable the automatic warm-up feature for dedicated IP addresses.
    public func putAccountDedicatedIpWarmupAttributes(_ input: PutAccountDedicatedIpWarmupAttributesRequest) throws -> PutAccountDedicatedIpWarmupAttributesResponse {
    ...
    public func putAccountSendingAttributes(_ input: PutAccountSendingAttributesRequest) throws -> PutAccountSendingAttributesResponse {
    ...
    public func putConfigurationSetDeliveryOptions(_ input: PutConfigurationSetDeliveryOptionsRequest) throws -> PutConfigurationSetDeliveryOptionsResponse {
    ...
    public func putConfigurationSetReputationOptions(_ input: PutConfigurationSetReputationOptionsRequest) throws -> PutConfigurationSetReputationOptionsResponse {
    ...
    public func putConfigurationSetSendingOptions(_ input: PutConfigurationSetSendingOptionsRequest) throws -> PutConfigurationSetSendingOptionsResponse {
    ...
    public func putConfigurationSetTrackingOptions(_ input: PutConfigurationSetTrackingOptionsRequest) throws -> PutConfigurationSetTrackingOptionsResponse {
    ...
    public func putDedicatedIpInPool(_ input: PutDedicatedIpInPoolRequest) throws -> PutDedicatedIpInPoolResponse {
        return try client.send(operation: "PutDedicatedIpInPool", path: "/v1/email/dedicated-ips/{IP}/pool", httpMethod: "PUT", input: input)
    }

    public func putDedicatedIpWarmupAttributes(_ input: PutDedicatedIpWarmupAttributesRequest) throws -> PutDedicatedIpWarmupAttributesResponse {
    ...
    public func putEmailIdentityDkimAttributes(_ input: PutEmailIdentityDkimAttributesRequest) throws -> PutEmailIdentityDkimAttributesResponse {
    ...
    public func putEmailIdentityFeedbackAttributes(_ input: PutEmailIdentityFeedbackAttributesRequest) throws -> PutEmailIdentityFeedbackAttributesResponse {
    ...
    public func putEmailIdentityMailFromAttributes(_ input: PutEmailIdentityMailFromAttributesRequest) throws -> PutEmailIdentityMailFromAttributesResponse {
