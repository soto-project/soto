...
public struct PinpointEmail {
    ...
    public func putDedicatedIpInPool(_ input: PutDedicatedIpInPoolRequest) throws -> EventLoopFuture<PutDedicatedIpInPoolResponse> {
    ...
    public func getDedicatedIps(_ input: GetDedicatedIpsRequest) throws -> EventLoopFuture<GetDedicatedIpsResponse> {
    ...
    public func getConfigurationSet(_ input: GetConfigurationSetRequest) throws -> EventLoopFuture<GetConfigurationSetResponse> {
    ...
    public func putAccountDedicatedIpWarmupAttributes(_ input: PutAccountDedicatedIpWarmupAttributesRequest) throws -> EventLoopFuture<PutAccountDedicatedIpWarmupAttributesResponse> {
    ...
    public func putConfigurationSetDeliveryOptions(_ input: PutConfigurationSetDeliveryOptionsRequest) throws -> EventLoopFuture<PutConfigurationSetDeliveryOptionsResponse> {
    ...
    public func putConfigurationSetSendingOptions(_ input: PutConfigurationSetSendingOptionsRequest) throws -> EventLoopFuture<PutConfigurationSetSendingOptionsResponse> {
    ...
    public func getDedicatedIp(_ input: GetDedicatedIpRequest) throws -> EventLoopFuture<GetDedicatedIpResponse> {
    ...
    public func putConfigurationSetReputationOptions(_ input: PutConfigurationSetReputationOptionsRequest) throws -> EventLoopFuture<PutConfigurationSetReputationOptionsResponse> {
    ...
    public func listDedicatedIpPools(_ input: ListDedicatedIpPoolsRequest) throws -> EventLoopFuture<ListDedicatedIpPoolsResponse> {
        return try client.send(operation: "ListDedicatedIpPools", path: "/v1/email/dedicated-ip-pools", httpMethod: "GET", input: input)
    }

    public func putDedicatedIpWarmupAttributes(_ input: PutDedicatedIpWarmupAttributesRequest) throws -> EventLoopFuture<PutDedicatedIpWarmupAttributesResponse> {
    ...
    public func createEmailIdentity(_ input: CreateEmailIdentityRequest) throws -> EventLoopFuture<CreateEmailIdentityResponse> {
    ...
    public func deleteEmailIdentity(_ input: DeleteEmailIdentityRequest) throws -> EventLoopFuture<DeleteEmailIdentityResponse> {
    ...
    public func putEmailIdentityDkimAttributes(_ input: PutEmailIdentityDkimAttributesRequest) throws -> EventLoopFuture<PutEmailIdentityDkimAttributesResponse> {
    ...
    public func putEmailIdentityMailFromAttributes(_ input: PutEmailIdentityMailFromAttributesRequest) throws -> EventLoopFuture<PutEmailIdentityMailFromAttributesResponse> {
    ...
    public func putEmailIdentityFeedbackAttributes(_ input: PutEmailIdentityFeedbackAttributesRequest) throws -> EventLoopFuture<PutEmailIdentityFeedbackAttributesResponse> {
    ...
    public func putConfigurationSetTrackingOptions(_ input: PutConfigurationSetTrackingOptionsRequest) throws -> EventLoopFuture<PutConfigurationSetTrackingOptionsResponse> {
    ...
    public func createDedicatedIpPool(_ input: CreateDedicatedIpPoolRequest) throws -> EventLoopFuture<CreateDedicatedIpPoolResponse> {
    ...
    public func putAccountSendingAttributes(_ input: PutAccountSendingAttributesRequest) throws -> EventLoopFuture<PutAccountSendingAttributesResponse> {
    ...
    public func deleteDedicatedIpPool(_ input: DeleteDedicatedIpPoolRequest) throws -> EventLoopFuture<DeleteDedicatedIpPoolResponse> {
    ...
    public func getEmailIdentity(_ input: GetEmailIdentityRequest) throws -> EventLoopFuture<GetEmailIdentityResponse> {
    ...
    public func listEmailIdentities(_ input: ListEmailIdentitiesRequest) throws -> EventLoopFuture<ListEmailIdentitiesResponse> {
