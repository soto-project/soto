...
extension PinpointEmail {
    ...
    public struct UpdateConfigurationSetEventDestinationRequest: AWSShape {
        ...
        public init(eventDestination: EventDestinationDefinition, configurationSetName: String, eventDestinationName: String) {
    ...
    public struct SendQuota: AWSShape {
        ...
        public init(sentLast24Hours: Double? = nil, maxSendRate: Double? = nil, max24HourSend: Double? = nil) {
    ...
    public struct EventDestination: AWSShape {
        ...
        public init(name: String, cloudWatchDestination: CloudWatchDestination? = nil, matchingEventTypes: [EventType], pinpointDestination: PinpointDestination? = nil, enabled: Bool? = nil, snsDestination: SnsDestination? = nil, kinesisFirehoseDestination: KinesisFirehoseDestination? = nil) {
            self.name = name
    ...
    public struct PutDedicatedIpWarmupAttributesRequest: AWSShape {
        ...
        public init(warmupPercentage: Int32, ip: String) {
    ...
    public struct EventDestinationDefinition: AWSShape {
        ...
        public init(cloudWatchDestination: CloudWatchDestination? = nil, enabled: Bool? = nil, kinesisFirehoseDestination: KinesisFirehoseDestination? = nil, matchingEventTypes: [EventType]? = nil, snsDestination: SnsDestination? = nil, pinpointDestination: PinpointDestination? = nil) {
            self.cloudWatchDestination = cloudWatchDestination
            self.enabled = enabled
            self.kinesisFirehoseDestination = kinesisFirehoseDestination
            self.matchingEventTypes = matchingEventTypes
    ...
    public struct GetEmailIdentityResponse: AWSShape {
        ...
        public init(identityType: IdentityType? = nil, feedbackForwardingStatus: Bool? = nil, dkimAttributes: DkimAttributes? = nil, verifiedForSendingStatus: Bool? = nil, mailFromAttributes: MailFromAttributes? = nil) {
    ...
    public struct GetConfigurationSetResponse: AWSShape {
        ...
        public init(sendingOptions: SendingOptions? = nil, reputationOptions: ReputationOptions? = nil, configurationSetName: String? = nil, trackingOptions: TrackingOptions? = nil, deliveryOptions: DeliveryOptions? = nil) {
    ...
    public struct IdentityInfo: AWSShape {
        ...
        public init(identityName: String? = nil, sendingEnabled: Bool? = nil, identityType: IdentityType? = nil) {
    ...
    public struct GetDedicatedIpsRequest: AWSShape {
        ...
        public init(pageSize: Int32? = nil, poolName: String? = nil, nextToken: String? = nil) {
            self.pageSize = pageSize
    ...
    public struct SendEmailRequest: AWSShape {
        ...
        public init(destination: Destination, replyToAddresses: [String]? = nil, configurationSetName: String? = nil, fromEmailAddress: String? = nil, emailTags: [MessageTag]? = nil, content: EmailContent, feedbackForwardingEmailAddress: String? = nil) {
    ...
    public struct GetAccountResponse: AWSShape {
        ...
        public init(enforcementStatus: String? = nil, productionAccessEnabled: Bool? = nil, sendQuota: SendQuota? = nil, sendingEnabled: Bool? = nil, dedicatedIpAutoWarmupEnabled: Bool? = nil) {
    ...
    public struct CreateEmailIdentityResponse: AWSShape {
        ...
        public init(dkimAttributes: DkimAttributes? = nil, verifiedForSendingStatus: Bool? = nil, identityType: IdentityType? = nil) {
            self.dkimAttributes = dkimAttributes
            self.verifiedForSendingStatus = verifiedForSendingStatus
            self.identityType = identityType
        }
    ...
    public struct PutEmailIdentityMailFromAttributesRequest: AWSShape {
        ...
        public init(behaviorOnMxFailure: BehaviorOnMxFailure? = nil, mailFromDomain: String? = nil, emailIdentity: String) {
            self.behaviorOnMxFailure = behaviorOnMxFailure
            self.mailFromDomain = mailFromDomain
            self.emailIdentity = emailIdentity
        }
