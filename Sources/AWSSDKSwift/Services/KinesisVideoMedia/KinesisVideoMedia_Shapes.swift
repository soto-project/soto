...
extension KinesisVideoMedia {
    ...
    public struct GetMediaInput: AWSShape {
        ...
        public init(streamName: String? = nil, startSelector: StartSelector, streamARN: String? = nil) {
    ...
    public struct StartSelector: AWSShape {
        ...
        public init(startSelectorType: StartSelectorType, afterFragmentNumber: String? = nil, startTimestamp: TimeStamp? = nil, continuationToken: String? = nil) {
