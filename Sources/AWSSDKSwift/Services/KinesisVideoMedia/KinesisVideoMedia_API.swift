...
public struct KinesisVideoMedia: AWSService {
    ...
    public func getMedia(_ input: GetMediaInput) -> EventLoopFuture<GetMediaOutput> {
        return client.execute(operation: "GetMedia", path: "/getMedia", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getMediaStreaming(_ input: GetMediaInput, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<GetMediaOutput> {
        return client.execute(operation: "GetMedia", path: "/getMedia", httpMethod: .POST, input: input, config: self.config, context: self.context, stream: stream)
    }
}
