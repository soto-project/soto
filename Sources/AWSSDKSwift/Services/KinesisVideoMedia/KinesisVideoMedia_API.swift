...
public struct KinesisVideoMedia {
    ...
    public func getMedia(_ input: GetMediaInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetMediaOutput> {
        return self.client.execute(operation: "GetMedia", path: "/getMedia", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getMediaStreaming(_ input: GetMediaInput, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<GetMediaOutput> {
        return self.client.execute(operation: "GetMedia", path: "/getMedia", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger, stream: stream)
    }
}
