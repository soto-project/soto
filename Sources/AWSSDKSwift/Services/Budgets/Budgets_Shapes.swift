...
extension Budgets {
    ...
    public struct CostTypes: AWSShape {
        ...
        public init(useBlended: Bool? = nil, includeUpfront: Bool? = nil, includeDiscount: Bool? = nil, includeRefund: Bool? = nil, includeTax: Bool? = nil, includeOtherSubscription: Bool? = nil, includeSupport: Bool? = nil, includeRecurring: Bool? = nil, includeSubscription: Bool? = nil, useAmortized: Bool? = nil, includeCredit: Bool? = nil) {
    ...
    public struct DescribeNotificationsForBudgetRequest: AWSShape {
        ...
        public init(accountId: String, nextToken: String? = nil, maxResults: Int32? = nil, budgetName: String) {
    ...
    public struct CreateNotificationRequest: AWSShape {
        ...
        public init(accountId: String, subscribers: [Subscriber], notification: Notification, budgetName: String) {
            self.accountId = accountId
    ...
    public struct UpdateNotificationRequest: AWSShape {
        ...
        public init(accountId: String, newNotification: Notification, oldNotification: Notification, budgetName: String) {
            self.accountId = accountId
    ...
    public struct Notification: AWSShape {
        ...
        public init(notificationState: NotificationState? = nil, comparisonOperator: ComparisonOperator, threshold: Double, notificationType: NotificationType, thresholdType: ThresholdType? = nil) {
    ...
    public struct DescribeBudgetPerformanceHistoryRequest: AWSShape {
        ...
        public init(accountId: String, nextToken: String? = nil, timePeriod: TimePeriod? = nil, maxResults: Int32? = nil, budgetName: String) {
            self.accountId = accountId
            self.nextToken = nextToken
    ...
    public struct DeleteNotificationRequest: AWSShape {
        ...
        public init(notification: Notification, budgetName: String, accountId: String) {
            self.notification = notification
            self.budgetName = budgetName
            self.accountId = accountId
        }
    ...
    public struct UpdateSubscriberRequest: AWSShape {
        ...
        public init(oldSubscriber: Subscriber, newSubscriber: Subscriber, accountId: String, notification: Notification, budgetName: String) {
    ...
    public struct BudgetedAndActualAmounts: AWSShape {
        ...
        public init(timePeriod: TimePeriod? = nil, actualAmount: Spend? = nil, budgetedAmount: Spend? = nil) {
            self.timePeriod = timePeriod
    ...
    public struct BudgetPerformanceHistory: AWSShape {
        ...
        public init(costFilters: [String: [String]]? = nil, timeUnit: TimeUnit? = nil, costTypes: CostTypes? = nil, budgetedAndActualAmountsList: [BudgetedAndActualAmounts]? = nil, budgetType: BudgetType? = nil, budgetName: String? = nil) {
    ...
    public struct DescribeSubscribersForNotificationRequest: AWSShape {
        ...
        public init(accountId: String, nextToken: String? = nil, notification: Notification, maxResults: Int32? = nil, budgetName: String) {
            self.accountId = accountId
            self.nextToken = nextToken
            self.notification = notification
            self.maxResults = maxResults
    ...
    public struct CreateBudgetRequest: AWSShape {
        ...
        public init(budget: Budget, notificationsWithSubscribers: [NotificationWithSubscribers]? = nil, accountId: String) {
            self.budget = budget
    ...
    public struct Budget: AWSShape {
        ...
        public init(costFilters: [String: [String]]? = nil, budgetLimit: Spend? = nil, timeUnit: TimeUnit, budgetType: BudgetType, calculatedSpend: CalculatedSpend? = nil, costTypes: CostTypes? = nil, budgetName: String, lastUpdatedTime: TimeStamp? = nil, timePeriod: TimePeriod? = nil) {
            self.costFilters = costFilters
