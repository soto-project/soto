...
public struct CognitoIdentity: AWSService {
    ...
    public func createIdentityPool(_ input: CreateIdentityPoolInput) -> EventLoopFuture<IdentityPool> {
        return client.execute(operation: "CreateIdentityPool", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteIdentities(_ input: DeleteIdentitiesInput) -> EventLoopFuture<DeleteIdentitiesResponse> {
        return client.execute(operation: "DeleteIdentities", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteIdentityPool(_ input: DeleteIdentityPoolInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteIdentityPool", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeIdentity(_ input: DescribeIdentityInput) -> EventLoopFuture<IdentityDescription> {
        return client.execute(operation: "DescribeIdentity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeIdentityPool(_ input: DescribeIdentityPoolInput) -> EventLoopFuture<IdentityPool> {
        return client.execute(operation: "DescribeIdentityPool", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getCredentialsForIdentity(_ input: GetCredentialsForIdentityInput) -> EventLoopFuture<GetCredentialsForIdentityResponse> {
        return client.execute(operation: "GetCredentialsForIdentity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getId(_ input: GetIdInput) -> EventLoopFuture<GetIdResponse> {
        return client.execute(operation: "GetId", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getIdentityPoolRoles(_ input: GetIdentityPoolRolesInput) -> EventLoopFuture<GetIdentityPoolRolesResponse> {
        return client.execute(operation: "GetIdentityPoolRoles", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getOpenIdToken(_ input: GetOpenIdTokenInput) -> EventLoopFuture<GetOpenIdTokenResponse> {
        return client.execute(operation: "GetOpenIdToken", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getOpenIdTokenForDeveloperIdentity(_ input: GetOpenIdTokenForDeveloperIdentityInput) -> EventLoopFuture<GetOpenIdTokenForDeveloperIdentityResponse> {
        return client.execute(operation: "GetOpenIdTokenForDeveloperIdentity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listIdentityPools(_ input: ListIdentityPoolsInput) -> EventLoopFuture<ListIdentityPoolsResponse> {
        return client.execute(operation: "ListIdentityPools", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func lookupDeveloperIdentity(_ input: LookupDeveloperIdentityInput) -> EventLoopFuture<LookupDeveloperIdentityResponse> {
        return client.execute(operation: "LookupDeveloperIdentity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func mergeDeveloperIdentities(_ input: MergeDeveloperIdentitiesInput) -> EventLoopFuture<MergeDeveloperIdentitiesResponse> {
        return client.execute(operation: "MergeDeveloperIdentities", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setIdentityPoolRoles(_ input: SetIdentityPoolRolesInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetIdentityPoolRoles", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func unlinkDeveloperIdentity(_ input: UnlinkDeveloperIdentityInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "UnlinkDeveloperIdentity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func unlinkIdentity(_ input: UnlinkIdentityInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "UnlinkIdentity", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateIdentityPool(_ input: IdentityPool) -> EventLoopFuture<IdentityPool> {
        return client.execute(operation: "UpdateIdentityPool", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
