...
public struct RoboMaker: AWSService {
    ...
    public func batchDeleteWorlds(_ input: BatchDeleteWorldsRequest) -> EventLoopFuture<BatchDeleteWorldsResponse> {
        return client.execute(operation: "BatchDeleteWorlds", path: "/batchDeleteWorlds", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func cancelWorldExportJob(_ input: CancelWorldExportJobRequest) -> EventLoopFuture<CancelWorldExportJobResponse> {
        return client.execute(operation: "CancelWorldExportJob", path: "/cancelWorldExportJob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func cancelWorldGenerationJob(_ input: CancelWorldGenerationJobRequest) -> EventLoopFuture<CancelWorldGenerationJobResponse> {
        return client.execute(operation: "CancelWorldGenerationJob", path: "/cancelWorldGenerationJob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createWorldExportJob(_ input: CreateWorldExportJobRequest) -> EventLoopFuture<CreateWorldExportJobResponse> {
        return client.execute(operation: "CreateWorldExportJob", path: "/createWorldExportJob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createWorldGenerationJob(_ input: CreateWorldGenerationJobRequest) -> EventLoopFuture<CreateWorldGenerationJobResponse> {
        return client.execute(operation: "CreateWorldGenerationJob", path: "/createWorldGenerationJob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Creates a world template.
    public func createWorldTemplate(_ input: CreateWorldTemplateRequest) -> EventLoopFuture<CreateWorldTemplateResponse> {
        return client.execute(operation: "CreateWorldTemplate", path: "/createWorldTemplate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteWorldTemplate(_ input: DeleteWorldTemplateRequest) -> EventLoopFuture<DeleteWorldTemplateResponse> {
        return client.execute(operation: "DeleteWorldTemplate", path: "/deleteWorldTemplate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeWorld(_ input: DescribeWorldRequest) -> EventLoopFuture<DescribeWorldResponse> {
        return client.execute(operation: "DescribeWorld", path: "/describeWorld", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeWorldExportJob(_ input: DescribeWorldExportJobRequest) -> EventLoopFuture<DescribeWorldExportJobResponse> {
        return client.execute(operation: "DescribeWorldExportJob", path: "/describeWorldExportJob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeWorldGenerationJob(_ input: DescribeWorldGenerationJobRequest) -> EventLoopFuture<DescribeWorldGenerationJobResponse> {
        return client.execute(operation: "DescribeWorldGenerationJob", path: "/describeWorldGenerationJob", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeWorldTemplate(_ input: DescribeWorldTemplateRequest) -> EventLoopFuture<DescribeWorldTemplateResponse> {
        return client.execute(operation: "DescribeWorldTemplate", path: "/describeWorldTemplate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets the world template body.
    public func getWorldTemplateBody(_ input: GetWorldTemplateBodyRequest) -> EventLoopFuture<GetWorldTemplateBodyResponse> {
        return client.execute(operation: "GetWorldTemplateBody", path: "/getWorldTemplateBody", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listWorldExportJobs(_ input: ListWorldExportJobsRequest) -> EventLoopFuture<ListWorldExportJobsResponse> {
        return client.execute(operation: "ListWorldExportJobs", path: "/listWorldExportJobs", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listWorldGenerationJobs(_ input: ListWorldGenerationJobsRequest) -> EventLoopFuture<ListWorldGenerationJobsResponse> {
        return client.execute(operation: "ListWorldGenerationJobs", path: "/listWorldGenerationJobs", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists world templates.
    public func listWorldTemplates(_ input: ListWorldTemplatesRequest) -> EventLoopFuture<ListWorldTemplatesResponse> {
        return client.execute(operation: "ListWorldTemplates", path: "/listWorldTemplates", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists worlds.
    public func listWorlds(_ input: ListWorldsRequest) -> EventLoopFuture<ListWorldsResponse> {
        return client.execute(operation: "ListWorlds", path: "/listWorlds", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateWorldTemplate(_ input: UpdateWorldTemplateRequest) -> EventLoopFuture<UpdateWorldTemplateResponse> {
        return client.execute(operation: "UpdateWorldTemplate", path: "/updateWorldTemplate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
