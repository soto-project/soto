...
public struct DirectoryService {
    ...
    public func deleteLogSubscription(_ input: DeleteLogSubscriptionRequest) throws -> EventLoopFuture<DeleteLogSubscriptionResult> {
    ...
    public func createAlias(_ input: CreateAliasRequest) throws -> EventLoopFuture<CreateAliasResult> {
        return try client.send(operation: "CreateAlias", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the Remote Authentication Dial In User Service (RADIUS) server information for an AD Connector or Microsoft AD directory.
    public func updateRadius(_ input: UpdateRadiusRequest) throws -> EventLoopFuture<UpdateRadiusResult> {
    ...
    public func describeEventTopics(_ input: DescribeEventTopicsRequest) throws -> EventLoopFuture<DescribeEventTopicsResult> {
        return try client.send(operation: "DescribeEventTopics", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes IP address blocks from a directory.
    public func removeIpRoutes(_ input: RemoveIpRoutesRequest) throws -> EventLoopFuture<RemoveIpRoutesResult> {
    ...
    public func describeConditionalForwarders(_ input: DescribeConditionalForwardersRequest) throws -> EventLoopFuture<DescribeConditionalForwardersResult> {
        return try client.send(operation: "DescribeConditionalForwarders", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the active log subscriptions for the AWS account.
    public func listLogSubscriptions(_ input: ListLogSubscriptionsRequest) throws -> EventLoopFuture<ListLogSubscriptionsResult> {
    ...
    public func createLogSubscription(_ input: CreateLogSubscriptionRequest) throws -> EventLoopFuture<CreateLogSubscriptionResult> {
    ...
    public func shareDirectory(_ input: ShareDirectoryRequest) throws -> EventLoopFuture<ShareDirectoryResult> {
        return try client.send(operation: "ShareDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables multi-factor authentication (MFA) with the Remote Authentication Dial In User Service (RADIUS) server for an AD Connector or Microsoft AD directory.
    public func disableRadius(_ input: DisableRadiusRequest) throws -> EventLoopFuture<DisableRadiusResult> {
        return try client.send(operation: "DisableRadius", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a computer account in the specified directory, and joins the computer to the directory.
    public func createComputer(_ input: CreateComputerRequest) throws -> EventLoopFuture<CreateComputerResult> {
    ...
    public func describeSnapshots(_ input: DescribeSnapshotsRequest) throws -> EventLoopFuture<DescribeSnapshotsResult> {
        return try client.send(operation: "DescribeSnapshots", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the trust that has been set up between your AWS Managed Microsoft AD directory and an on-premises Active Directory.
    public func updateTrust(_ input: UpdateTrustRequest) throws -> EventLoopFuture<UpdateTrustResult> {
    ...
    public func updateNumberOfDomainControllers(_ input: UpdateNumberOfDomainControllersRequest) throws -> EventLoopFuture<UpdateNumberOfDomainControllersResult> {
        return try client.send(operation: "UpdateNumberOfDomainControllers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the address blocks that you have added to a directory.
    public func listIpRoutes(_ input: ListIpRoutesRequest) throws -> EventLoopFuture<ListIpRoutesResult> {
        return try client.send(operation: "ListIpRoutes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a conditional forwarder that has been set up for your AWS directory.
    public func deleteConditionalForwarder(_ input: DeleteConditionalForwarderRequest) throws -> EventLoopFuture<DeleteConditionalForwarderResult> {
        return try client.send(operation: "DeleteConditionalForwarder", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables single sign-on for a directory.
    public func enableSso(_ input: EnableSsoRequest) throws -> EventLoopFuture<EnableSsoResult> {
    ...
    public func deleteDirectory(_ input: DeleteDirectoryRequest) throws -> EventLoopFuture<DeleteDirectoryResult> {
    ...
    public func createSnapshot(_ input: CreateSnapshotRequest) throws -> EventLoopFuture<CreateSnapshotResult> {
    ...
    public func cancelSchemaExtension(_ input: CancelSchemaExtensionRequest) throws -> EventLoopFuture<CancelSchemaExtensionResult> {
    ...
    public func restoreFromSnapshot(_ input: RestoreFromSnapshotRequest) throws -> EventLoopFuture<RestoreFromSnapshotResult> {
        return try client.send(operation: "RestoreFromSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides information about any domain controllers in your directory.
    public func describeDomainControllers(_ input: DescribeDomainControllersRequest) throws -> EventLoopFuture<DescribeDomainControllersResult> {
    ...
    public func createTrust(_ input: CreateTrustRequest) throws -> EventLoopFuture<CreateTrustResult> {
        return try client.send(operation: "CreateTrust", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops the directory sharing between the directory owner and consumer accounts. 
    public func unshareDirectory(_ input: UnshareDirectoryRequest) throws -> EventLoopFuture<UnshareDirectoryResult> {
        return try client.send(operation: "UnshareDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables multi-factor authentication (MFA) with the Remote Authentication Dial In User Service (RADIUS) server for an AD Connector or Microsoft AD directory.
    public func enableRadius(_ input: EnableRadiusRequest) throws -> EventLoopFuture<EnableRadiusResult> {
        return try client.send(operation: "EnableRadius", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists all schema extensions applied to a Microsoft AD Directory.
    public func listSchemaExtensions(_ input: ListSchemaExtensionsRequest) throws -> EventLoopFuture<ListSchemaExtensionsResult> {
        return try client.send(operation: "ListSchemaExtensions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an existing trust relationship between your AWS Managed Microsoft AD directory and an external domain.
    public func deleteTrust(_ input: DeleteTrustRequest) throws -> EventLoopFuture<DeleteTrustResult> {
    ...
    public func addIpRoutes(_ input: AddIpRoutesRequest) throws -> EventLoopFuture<AddIpRoutesResult> {
        return try client.send(operation: "AddIpRoutes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a conditional forwarder associated with your AWS directory. Conditional forwarders are required in order to set up a trust relationship with another domain. The conditional forwarder points to the trusted domain.
    public func createConditionalForwarder(_ input: CreateConditionalForwarderRequest) throws -> EventLoopFuture<CreateConditionalForwarderResult> {
        return try client.send(operation: "CreateConditionalForwarder", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes the specified directory as a publisher to the specified SNS topic.
    public func deregisterEventTopic(_ input: DeregisterEventTopicRequest) throws -> EventLoopFuture<DeregisterEventTopicResult> {
        return try client.send(operation: "DeregisterEventTopic", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the shared directories in your account. 
    public func describeSharedDirectories(_ input: DescribeSharedDirectoriesRequest) throws -> EventLoopFuture<DescribeSharedDirectoriesResult> {
        return try client.send(operation: "DescribeSharedDirectories", path: "/", httpMethod: "POST", input: input)
    }

    ///  Obtains the manual snapshot limits for a directory.
    public func getSnapshotLimits(_ input: GetSnapshotLimitsRequest) throws -> EventLoopFuture<GetSnapshotLimitsResult> {
        return try client.send(operation: "GetSnapshotLimits", path: "/", httpMethod: "POST", input: input)
    }

    ///  Rejects a directory sharing request that was sent from the directory owner account.
    public func rejectSharedDirectory(_ input: RejectSharedDirectoryRequest) throws -> EventLoopFuture<RejectSharedDirectoryResult> {
        return try client.send(operation: "RejectSharedDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables single-sign on for a directory.
    public func disableSso(_ input: DisableSsoRequest) throws -> EventLoopFuture<DisableSsoResult> {
    ...
    public func verifyTrust(_ input: VerifyTrustRequest) throws -> EventLoopFuture<VerifyTrustResult> {
    ...
    public func createDirectory(_ input: CreateDirectoryRequest) throws -> EventLoopFuture<CreateDirectoryResult> {
    ...
    public func describeDirectories(_ input: DescribeDirectoriesRequest) throws -> EventLoopFuture<DescribeDirectoriesResult> {
    ...
    public func createMicrosoftAD(_ input: CreateMicrosoftADRequest) throws -> EventLoopFuture<CreateMicrosoftADResult> {
    ...
    public func connectDirectory(_ input: ConnectDirectoryRequest) throws -> EventLoopFuture<ConnectDirectoryResult> {
        return try client.send(operation: "ConnectDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates a conditional forwarder that has been set up for your AWS directory.
    public func updateConditionalForwarder(_ input: UpdateConditionalForwarderRequest) throws -> EventLoopFuture<UpdateConditionalForwarderResult> {
        return try client.send(operation: "UpdateConditionalForwarder", path: "/", httpMethod: "POST", input: input)
    }

    ///  Applies a schema extension to a Microsoft AD directory.
    public func startSchemaExtension(_ input: StartSchemaExtensionRequest) throws -> EventLoopFuture<StartSchemaExtensionResult> {
    ...
    public func describeTrusts(_ input: DescribeTrustsRequest) throws -> EventLoopFuture<DescribeTrustsResult> {
        return try client.send(operation: "DescribeTrusts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Resets the password for any user in your AWS Managed Microsoft AD or Simple AD directory.
    public func resetUserPassword(_ input: ResetUserPasswordRequest) throws -> EventLoopFuture<ResetUserPasswordResult> {
        return try client.send(operation: "ResetUserPassword", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a directory snapshot.
    public func deleteSnapshot(_ input: DeleteSnapshotRequest) throws -> EventLoopFuture<DeleteSnapshotResult> {
    ...
    public func registerEventTopic(_ input: RegisterEventTopicRequest) throws -> EventLoopFuture<RegisterEventTopicResult> {
        return try client.send(operation: "RegisterEventTopic", path: "/", httpMethod: "POST", input: input)
    }

    ///  Accepts a directory sharing request that was sent from the directory owner account.
    public func acceptSharedDirectory(_ input: AcceptSharedDirectoryRequest) throws -> EventLoopFuture<AcceptSharedDirectoryResult> {
        return try client.send(operation: "AcceptSharedDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Obtains directory limit information for the current region.
    public func getDirectoryLimits(_ input: GetDirectoryLimitsRequest) throws -> EventLoopFuture<GetDirectoryLimitsResult> {
