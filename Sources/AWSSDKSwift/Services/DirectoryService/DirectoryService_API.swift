...
public struct DirectoryService {
    ...
    public func unshareDirectory(_ input: UnshareDirectoryRequest) throws -> UnshareDirectoryResult {
        return try client.send(operation: "UnshareDirectory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the shared directories in your account. 
    public func describeSharedDirectories(_ input: DescribeSharedDirectoriesRequest) throws -> DescribeSharedDirectoriesResult {
    ...
    public func createLogSubscription(_ input: CreateLogSubscriptionRequest) throws -> CreateLogSubscriptionResult {
    ...
    public func listLogSubscriptions(_ input: ListLogSubscriptionsRequest) throws -> ListLogSubscriptionsResult {
    ...
    public func shareDirectory(_ input: ShareDirectoryRequest) throws -> ShareDirectoryResult {
    ...
    public func updateTrust(_ input: UpdateTrustRequest) throws -> UpdateTrustResult {
    ...
    public func deleteLogSubscription(_ input: DeleteLogSubscriptionRequest) throws -> DeleteLogSubscriptionResult {
    ...
    public func rejectSharedDirectory(_ input: RejectSharedDirectoryRequest) throws -> RejectSharedDirectoryResult {
    ...
    public func acceptSharedDirectory(_ input: AcceptSharedDirectoryRequest) throws -> AcceptSharedDirectoryResult {
