...
public struct Kendra {
    ...
    public func batchDeleteDocument(_ input: BatchDeleteDocumentRequest) -> Future<BatchDeleteDocumentResponse> {
    ...
    public func batchPutDocument(_ input: BatchPutDocumentRequest) -> Future<BatchPutDocumentResponse> {
    ...
    public func createFaq(_ input: CreateFaqRequest) -> Future<CreateFaqResponse> {
    ...
    @discardableResult public func deleteFaq(_ input: DeleteFaqRequest) -> Future<Void> {
        return client.send(operation: "DeleteFaq", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an existing Amazon Kendra index. An exception is not thrown if the index is already being deleted. While the index is being deleted, the Status field returned by a call to the DescribeIndex operation is set to DELETING.
    @discardableResult public func deleteIndex(_ input: DeleteIndexRequest) -> Future<Void> {
    ...
    public func describeFaq(_ input: DescribeFaqRequest) -> Future<DescribeFaqResponse> {
    ...
    public func listDataSourceSyncJobs(_ input: ListDataSourceSyncJobsRequest) -> Future<ListDataSourceSyncJobsResponse> {
    ...
    public func listFaqs(_ input: ListFaqsRequest) -> Future<ListFaqsResponse> {
    ...
    public func query(_ input: QueryRequest) -> Future<QueryResult> {
        return client.send(operation: "Query", path: "/", httpMethod: "POST", input: input)
    }

    ///  Starts a synchronization job for a data source. If a synchronization job is already in progress, Amazon Kendra returns a ResourceInUseException exception.
    public func startDataSourceSyncJob(_ input: StartDataSourceSyncJobRequest) -> Future<StartDataSourceSyncJobResponse> {
        return client.send(operation: "StartDataSourceSyncJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops a running synchronization job. You can't stop a scheduled synchronization job.
    @discardableResult public func stopDataSourceSyncJob(_ input: StopDataSourceSyncJobRequest) -> Future<Void> {
        return client.send(operation: "StopDataSourceSyncJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables you to provide feedback to Amazon Kendra to improve the performance of the service. 
    @discardableResult public func submitFeedback(_ input: SubmitFeedbackRequest) -> Future<Void> {
        return client.send(operation: "SubmitFeedback", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates an existing Amazon Kendra data source.
    @discardableResult public func updateDataSource(_ input: UpdateDataSourceRequest) -> Future<Void> {
        return client.send(operation: "UpdateDataSource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates an existing Amazon Kendra index.
    @discardableResult public func updateIndex(_ input: UpdateIndexRequest) -> Future<Void> {
