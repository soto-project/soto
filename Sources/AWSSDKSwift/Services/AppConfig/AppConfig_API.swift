...
public struct AppConfig {
    ...
    public func createApplication(_ input: CreateApplicationRequest) -> Future<Application> {
    ...
    public func createConfigurationProfile(_ input: CreateConfigurationProfileRequest) -> Future<ConfigurationProfile> {
    ...
    public func createDeploymentStrategy(_ input: CreateDeploymentStrategyRequest) -> Future<DeploymentStrategy> {
    ...
    public func createEnvironment(_ input: CreateEnvironmentRequest) -> Future<Environment> {
    ...
    @discardableResult public func deleteConfigurationProfile(_ input: DeleteConfigurationProfileRequest) -> Future<Void> {
    ...
    @discardableResult public func deleteDeploymentStrategy(_ input: DeleteDeploymentStrategyRequest) -> Future<Void> {
    ...
    @discardableResult public func deleteEnvironment(_ input: DeleteEnvironmentRequest) -> Future<Void> {
    ...
    public func getApplication(_ input: GetApplicationRequest) -> Future<Application> {
    ...
    public func getConfiguration(_ input: GetConfigurationRequest) -> Future<Configuration> {
    ...
    public func getConfigurationProfile(_ input: GetConfigurationProfileRequest) -> Future<ConfigurationProfile> {
    ...
    public func getDeploymentStrategy(_ input: GetDeploymentStrategyRequest) -> Future<DeploymentStrategy> {
    ...
    public func getEnvironment(_ input: GetEnvironmentRequest) -> Future<Environment> {
    ...
    public func listApplications(_ input: ListApplicationsRequest) -> Future<Applications> {
        return client.send(operation: "ListApplications", path: "/applications", httpMethod: "GET", input: input)
    }

    ///  Lists the configuration profiles for an application.
    public func listConfigurationProfiles(_ input: ListConfigurationProfilesRequest) -> Future<ConfigurationProfiles> {
    ...
    public func listDeploymentStrategies(_ input: ListDeploymentStrategiesRequest) -> Future<DeploymentStrategies> {
        return client.send(operation: "ListDeploymentStrategies", path: "/deploymentstrategies", httpMethod: "GET", input: input)
    }

    ///  Lists the deployments for an environment.
    public func listDeployments(_ input: ListDeploymentsRequest) -> Future<Deployments> {
    ...
    public func listEnvironments(_ input: ListEnvironmentsRequest) -> Future<Environments> {
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest) -> Future<ResourceTags> {
        return client.send(operation: "ListTagsForResource", path: "/tags/{ResourceArn}", httpMethod: "GET", input: input)
    }

    ///  Starts a deployment.
    public func startDeployment(_ input: StartDeploymentRequest) -> Future<Deployment> {
    ...
    public func stopDeployment(_ input: StopDeploymentRequest) -> Future<Deployment> {
    ...
    public func updateApplication(_ input: UpdateApplicationRequest) -> Future<Application> {
        return client.send(operation: "UpdateApplication", path: "/applications/{ApplicationId}", httpMethod: "PATCH", input: input)
    }

    ///  Updates a configuration profile.
    public func updateConfigurationProfile(_ input: UpdateConfigurationProfileRequest) -> Future<ConfigurationProfile> {
    ...
    public func updateDeploymentStrategy(_ input: UpdateDeploymentStrategyRequest) -> Future<DeploymentStrategy> {
    ...
    public func updateEnvironment(_ input: UpdateEnvironmentRequest) -> Future<Environment> {
    ...
    @discardableResult public func validateConfiguration(_ input: ValidateConfigurationRequest) -> Future<Void> {
