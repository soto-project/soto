...
public struct AppConfig {
    ...
    public func createConfigurationProfile(_ input: CreateConfigurationProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfigurationProfile> {
        return client.send(operation: "CreateConfigurationProfile", path: "/applications/{ApplicationId}/configurationprofiles", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createDeploymentStrategy(_ input: CreateDeploymentStrategyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeploymentStrategy> {
        return client.send(operation: "CreateDeploymentStrategy", path: "/deploymentstrategies", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createEnvironment(_ input: CreateEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Environment> {
        return client.send(operation: "CreateEnvironment", path: "/applications/{ApplicationId}/environments", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteConfigurationProfile(_ input: DeleteConfigurationProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteConfigurationProfile", path: "/applications/{ApplicationId}/configurationprofiles/{ConfigurationProfileId}", httpMethod: "DELETE", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteDeploymentStrategy(_ input: DeleteDeploymentStrategyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteDeploymentStrategy", path: "/deployementstrategies/{DeploymentStrategyId}", httpMethod: "DELETE", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteEnvironment(_ input: DeleteEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteEnvironment", path: "/applications/{ApplicationId}/environments/{EnvironmentId}", httpMethod: "DELETE", input: input, on: eventLoop)
    }
    ...
    public func getConfigurationProfile(_ input: GetConfigurationProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfigurationProfile> {
        return client.send(operation: "GetConfigurationProfile", path: "/applications/{ApplicationId}/configurationprofiles/{ConfigurationProfileId}", httpMethod: "GET", input: input, on: eventLoop)
    }

    ///  Retrieve information about a configuration deployment.
    public func getDeployment(_ input: GetDeploymentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Deployment> {
        return client.send(operation: "GetDeployment", path: "/applications/{ApplicationId}/environments/{EnvironmentId}/deployments/{DeploymentNumber}", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func getDeploymentStrategy(_ input: GetDeploymentStrategyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeploymentStrategy> {
        return client.send(operation: "GetDeploymentStrategy", path: "/deploymentstrategies/{DeploymentStrategyId}", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func getEnvironment(_ input: GetEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Environment> {
        return client.send(operation: "GetEnvironment", path: "/applications/{ApplicationId}/environments/{EnvironmentId}", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listConfigurationProfiles(_ input: ListConfigurationProfilesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfigurationProfiles> {
        return client.send(operation: "ListConfigurationProfiles", path: "/applications/{ApplicationId}/configurationprofiles", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listDeploymentStrategies(_ input: ListDeploymentStrategiesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeploymentStrategies> {
        return client.send(operation: "ListDeploymentStrategies", path: "/deploymentstrategies", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listDeployments(_ input: ListDeploymentsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Deployments> {
        return client.send(operation: "ListDeployments", path: "/applications/{ApplicationId}/environments/{EnvironmentId}/deployments", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func listEnvironments(_ input: ListEnvironmentsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Environments> {
        return client.send(operation: "ListEnvironments", path: "/applications/{ApplicationId}/environments", httpMethod: "GET", input: input, on: eventLoop)
    }
    ...
    public func startDeployment(_ input: StartDeploymentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Deployment> {
        return client.send(operation: "StartDeployment", path: "/applications/{ApplicationId}/environments/{EnvironmentId}/deployments", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func stopDeployment(_ input: StopDeploymentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Deployment> {
        return client.send(operation: "StopDeployment", path: "/applications/{ApplicationId}/environments/{EnvironmentId}/deployments/{DeploymentNumber}", httpMethod: "DELETE", input: input, on: eventLoop)
    }
    ...
    public func updateConfigurationProfile(_ input: UpdateConfigurationProfileRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ConfigurationProfile> {
        return client.send(operation: "UpdateConfigurationProfile", path: "/applications/{ApplicationId}/configurationprofiles/{ConfigurationProfileId}", httpMethod: "PATCH", input: input, on: eventLoop)
    }
    ...
    public func updateDeploymentStrategy(_ input: UpdateDeploymentStrategyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeploymentStrategy> {
        return client.send(operation: "UpdateDeploymentStrategy", path: "/deploymentstrategies/{DeploymentStrategyId}", httpMethod: "PATCH", input: input, on: eventLoop)
    }
    ...
    public func updateEnvironment(_ input: UpdateEnvironmentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Environment> {
        return client.send(operation: "UpdateEnvironment", path: "/applications/{ApplicationId}/environments/{EnvironmentId}", httpMethod: "PATCH", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func validateConfiguration(_ input: ValidateConfigurationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "ValidateConfiguration", path: "/applications/{ApplicationId}/configurationprofiles/{ConfigurationProfileId}/validators", httpMethod: "POST", input: input, on: eventLoop)
    }
}
