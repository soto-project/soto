...
public struct Amplify {
    ...
    public func createBranch(_ input: CreateBranchRequest) throws -> CreateBranchResult {
    ...
    public func deleteApp(_ input: DeleteAppRequest) throws -> DeleteAppResult {
    ...
    public func listDomainAssociations(_ input: ListDomainAssociationsRequest) throws -> ListDomainAssociationsResult {
    ...
    ///   Create a new DomainAssociation on an App 
    public func updateDomainAssociation(_ input: UpdateDomainAssociationRequest) throws -> UpdateDomainAssociationResult {
