...
extension Amplify {
    ...
    public struct App: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "enableBranchAutoDeletion", required: false, type: .boolean), 
    ...
    public struct CreateDomainAssociationRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "appId", location: .uri(locationName: "appId"), required: true, type: .string), 
            AWSShapeMember(label: "autoSubDomainCreationPatterns", required: false, type: .list), 
            AWSShapeMember(label: "autoSubDomainIAMRole", required: false, type: .string), 
    ...
    public struct ListBackendEnvironmentsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "appId", location: .uri(locationName: "appId"), required: true, type: .string), 
            AWSShapeMember(label: "environmentName", location: .querystring(locationName: "environmentName"), required: false, type: .string), 
            AWSShapeMember(label: "maxResults", location: .querystring(locationName: "maxResults"), required: false, type: .integer), 
            AWSShapeMember(label: "nextToken", location: .querystring(locationName: "nextToken"), required: false, type: .string)
        ]
