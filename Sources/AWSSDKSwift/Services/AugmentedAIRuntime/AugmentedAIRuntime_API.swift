...
public struct AugmentedAIRuntime: AWSService {
    ...
    /// return new `AugmentedAIRuntime` with new timeout value
    ...
    /// return new `AugmentedAIRuntime` logging to specified Logger
    ...
    public func deleteHumanLoop(_ input: DeleteHumanLoopRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteHumanLoopResponse> {
        return client.execute(operation: "DeleteHumanLoop", path: "/human-loops/{HumanLoopName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeHumanLoop(_ input: DescribeHumanLoopRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeHumanLoopResponse> {
        return client.execute(operation: "DescribeHumanLoop", path: "/human-loops/{HumanLoopName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listHumanLoops(_ input: ListHumanLoopsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHumanLoopsResponse> {
        return client.execute(operation: "ListHumanLoops", path: "/human-loops", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startHumanLoop(_ input: StartHumanLoopRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartHumanLoopResponse> {
        return client.execute(operation: "StartHumanLoop", path: "/human-loops", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func stopHumanLoop(_ input: StopHumanLoopRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopHumanLoopResponse> {
        return client.execute(operation: "StopHumanLoop", path: "/human-loops/stop", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
