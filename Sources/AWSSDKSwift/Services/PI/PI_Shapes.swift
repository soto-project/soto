...
extension PI {
    ...
    public struct DescribeDimensionKeysResponse: AWSShape {
        ...
        public init(alignedEndTime: TimeStamp? = nil, keys: [DimensionKeyDescription]? = nil, partitionKeys: [ResponsePartitionKey]? = nil, alignedStartTime: TimeStamp? = nil, nextToken: String? = nil) {
    ...
    public struct GetResourceMetricsResponse: AWSShape {
        ...
        public init(nextToken: String? = nil, identifier: String? = nil, metricList: [MetricKeyDataPoints]? = nil, alignedStartTime: TimeStamp? = nil, alignedEndTime: TimeStamp? = nil) {
            self.nextToken = nextToken
    ...
    public struct DimensionGroup: AWSShape {
        ...
        public init(limit: Int32? = nil, group: String, dimensions: [String]? = nil) {
            self.limit = limit
            self.group = group
    ...
    public struct DescribeDimensionKeysRequest: AWSShape {
        ...
        public init(endTime: TimeStamp, filter: [String: String]? = nil, partitionBy: DimensionGroup? = nil, identifier: String, groupBy: DimensionGroup, maxResults: Int32? = nil, nextToken: String? = nil, metric: String, periodInSeconds: Int32? = nil, startTime: TimeStamp, serviceType: ServiceType) {
    ...
    public struct GetResourceMetricsRequest: AWSShape {
        ...
        public init(endTime: TimeStamp, metricQueries: [MetricQuery], identifier: String, nextToken: String? = nil, periodInSeconds: Int32? = nil, maxResults: Int32? = nil, startTime: TimeStamp, serviceType: ServiceType) {
            self.endTime = endTime
