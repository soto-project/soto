...
public struct PI: AWSService {
    ...
    /// return new `PI` with new timeout value
    ...
    /// return new `PI` logging to specified Logger
    ...
    public func describeDimensionKeys(_ input: DescribeDimensionKeysRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDimensionKeysResponse> {
        return client.execute(operation: "DescribeDimensionKeys", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getResourceMetrics(_ input: GetResourceMetricsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetResourceMetricsResponse> {
        return client.execute(operation: "GetResourceMetrics", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
