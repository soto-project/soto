...
extension TranscribeService {
    ...
    public struct UpdateVocabularyResponse: AWSShape {
        ...
        public init(lastModifiedTime: TimeStamp? = nil, vocabularyState: VocabularyState? = nil, vocabularyName: String? = nil, languageCode: LanguageCode? = nil) {
    ...
    public struct TranscriptionJobSummary: AWSShape {
        ...
        public init(outputLocationType: OutputLocationType? = nil, transcriptionJobStatus: TranscriptionJobStatus? = nil, completionTime: TimeStamp? = nil, failureReason: String? = nil, languageCode: LanguageCode? = nil, creationTime: TimeStamp? = nil, transcriptionJobName: String? = nil) {
    ...
    public struct StartTranscriptionJobRequest: AWSShape {
        ...
        public init(media: Media, settings: Settings? = nil, mediaSampleRateHertz: Int32? = nil, languageCode: LanguageCode, mediaFormat: MediaFormat, outputBucketName: String? = nil, transcriptionJobName: String) {
            self.media = media
    ...
    public struct ListTranscriptionJobsRequest: AWSShape {
        ...
        public init(status: TranscriptionJobStatus? = nil, nextToken: String? = nil, maxResults: Int32? = nil, jobNameContains: String? = nil) {
            self.status = status
    ...
    public struct Settings: AWSShape {
        ...
        public init(showSpeakerLabels: Bool? = nil, channelIdentification: Bool? = nil, vocabularyName: String? = nil, maxSpeakerLabels: Int32? = nil) {
    ...
    public struct ListVocabulariesRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, nameContains: String? = nil, maxResults: Int32? = nil, stateEquals: VocabularyState? = nil) {
            self.nextToken = nextToken
    ...
    public struct TranscriptionJob: AWSShape {
        ...
        public init(completionTime: TimeStamp? = nil, settings: Settings? = nil, mediaSampleRateHertz: Int32? = nil, mediaFormat: MediaFormat? = nil, transcriptionJobStatus: TranscriptionJobStatus? = nil, languageCode: LanguageCode? = nil, media: Media? = nil, failureReason: String? = nil, transcript: Transcript? = nil, transcriptionJobName: String? = nil, creationTime: TimeStamp? = nil) {
            self.completionTime = completionTime
            self.settings = settings
            self.mediaSampleRateHertz = mediaSampleRateHertz
            self.mediaFormat = mediaFormat
    ...
    public struct ListVocabulariesResponse: AWSShape {
        ...
        public init(status: TranscriptionJobStatus? = nil, vocabularies: [VocabularyInfo]? = nil, nextToken: String? = nil) {
            self.status = status
    ...
    public struct GetVocabularyResponse: AWSShape {
        ...
        public init(vocabularyName: String? = nil, lastModifiedTime: TimeStamp? = nil, vocabularyState: VocabularyState? = nil, languageCode: LanguageCode? = nil, failureReason: String? = nil, downloadUri: String? = nil) {
            self.vocabularyName = vocabularyName
            self.lastModifiedTime = lastModifiedTime
            self.vocabularyState = vocabularyState
            self.languageCode = languageCode
    ...
    public struct CreateVocabularyResponse: AWSShape {
        ...
        public init(vocabularyName: String? = nil, languageCode: LanguageCode? = nil, failureReason: String? = nil, vocabularyState: VocabularyState? = nil, lastModifiedTime: TimeStamp? = nil) {
            self.vocabularyName = vocabularyName
            self.languageCode = languageCode
            self.failureReason = failureReason
            self.vocabularyState = vocabularyState
