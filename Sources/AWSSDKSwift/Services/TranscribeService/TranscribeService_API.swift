...
public struct TranscribeService: AWSService {
    ...
    public func createLanguageModel(_ input: CreateLanguageModelRequest) -> EventLoopFuture<CreateLanguageModelResponse> {
        return client.execute(operation: "CreateLanguageModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteLanguageModel(_ input: DeleteLanguageModelRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteLanguageModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLanguageModel(_ input: DescribeLanguageModelRequest) -> EventLoopFuture<DescribeLanguageModelResponse> {
        return client.execute(operation: "DescribeLanguageModel", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listLanguageModels(_ input: ListLanguageModelsRequest) -> EventLoopFuture<ListLanguageModelsResponse> {
        return client.execute(operation: "ListLanguageModels", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
