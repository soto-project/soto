...
extension CognitoSync {
    ...
    public struct GetBulkPublishDetailsResponse: AWSShape {
        ...
        public init(failureMessage: String? = nil, identityPoolId: String? = nil, bulkPublishStatus: BulkPublishStatus? = nil, bulkPublishCompleteTime: TimeStamp? = nil, bulkPublishStartTime: TimeStamp? = nil) {
    ...
    public struct Dataset: AWSShape {
        ...
        public init(datasetName: String? = nil, numRecords: Int64? = nil, creationDate: TimeStamp? = nil, lastModifiedDate: TimeStamp? = nil, dataStorage: Int64? = nil, identityId: String? = nil, lastModifiedBy: String? = nil) {
    ...
    public struct UpdateRecordsRequest: AWSShape {
        ...
        public init(identityPoolId: String, identityId: String, recordPatches: [RecordPatch]? = nil, clientContext: String? = nil, datasetName: String, syncSessionToken: String, deviceId: String? = nil) {
            self.identityPoolId = identityPoolId
            self.identityId = identityId
    ...
    public struct GetIdentityPoolConfigurationResponse: AWSShape {
        ...
        public init(pushSync: PushSync? = nil, cognitoStreams: CognitoStreams? = nil, identityPoolId: String? = nil) {
    ...
    public struct UnsubscribeFromDatasetRequest: AWSShape {
        ...
        public init(identityPoolId: String, identityId: String, datasetName: String, deviceId: String) {
            self.identityPoolId = identityPoolId
            self.identityId = identityId
            self.datasetName = datasetName
            self.deviceId = deviceId
    ...
    public struct RegisterDeviceRequest: AWSShape {
        ...
        public init(platform: Platform, identityPoolId: String, identityId: String, token: String) {
    ...
    public struct IdentityUsage: AWSShape {
        ...
        public init(identityPoolId: String? = nil, dataStorage: Int64? = nil, identityId: String? = nil, datasetCount: Int32? = nil, lastModifiedDate: TimeStamp? = nil) {
            self.identityPoolId = identityPoolId
            self.dataStorage = dataStorage
            self.identityId = identityId
    ...
    public struct CognitoStreams: AWSShape {
        ...
        public init(streamingStatus: StreamingStatus? = nil, streamName: String? = nil, roleArn: String? = nil) {
    ...
    public struct Record: AWSShape {
        ...
        public init(syncCount: Int64? = nil, value: String? = nil, lastModifiedDate: TimeStamp? = nil, key: String? = nil, deviceLastModifiedDate: TimeStamp? = nil, lastModifiedBy: String? = nil) {
    ...
    public struct ListRecordsRequest: AWSShape {
        ...
        public init(identityId: String, maxResults: Int32? = nil, datasetName: String, syncSessionToken: String? = nil, nextToken: String? = nil, identityPoolId: String, lastSyncCount: Int64? = nil) {
            self.identityId = identityId
    ...
    public struct SubscribeToDatasetRequest: AWSShape {
        ...
        public init(identityId: String, identityPoolId: String, datasetName: String, deviceId: String) {
            self.identityId = identityId
            self.identityPoolId = identityPoolId
            self.datasetName = datasetName
            self.deviceId = deviceId
    ...
    public struct ListIdentityPoolUsageResponse: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: Int32? = nil, identityPoolUsages: [IdentityPoolUsage]? = nil, count: Int32? = nil) {
            self.nextToken = nextToken
            self.maxResults = maxResults
    ...
    public struct RecordPatch: AWSShape {
        ...
        public init(op: Operation, value: String? = nil, deviceLastModifiedDate: TimeStamp? = nil, syncCount: Int64, key: String) {
            self.op = op
            self.value = value
            self.deviceLastModifiedDate = deviceLastModifiedDate
            self.syncCount = syncCount
    ...
    public struct ListRecordsResponse: AWSShape {
        ...
        public init(datasetExists: Bool? = nil, datasetDeletedAfterRequestedSyncCount: Bool? = nil, mergedDatasetNames: [String]? = nil, nextToken: String? = nil, records: [Record]? = nil, syncSessionToken: String? = nil, lastModifiedBy: String? = nil, datasetSyncCount: Int64? = nil, count: Int32? = nil) {
    ...
    public struct IdentityPoolUsage: AWSShape {
        ...
        public init(lastModifiedDate: TimeStamp? = nil, dataStorage: Int64? = nil, syncSessionsCount: Int64? = nil, identityPoolId: String? = nil) {
            self.lastModifiedDate = lastModifiedDate
            self.dataStorage = dataStorage
