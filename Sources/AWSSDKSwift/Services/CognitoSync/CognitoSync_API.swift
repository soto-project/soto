...
public struct CognitoSync: AWSService {
    ...
    public func bulkPublish(_ input: BulkPublishRequest) -> EventLoopFuture<BulkPublishResponse> {
        return client.execute(operation: "BulkPublish", path: "/identitypools/{IdentityPoolId}/bulkpublish", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDataset(_ input: DeleteDatasetRequest) -> EventLoopFuture<DeleteDatasetResponse> {
        return client.execute(operation: "DeleteDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeDataset(_ input: DescribeDatasetRequest) -> EventLoopFuture<DescribeDatasetResponse> {
        return client.execute(operation: "DescribeDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeIdentityPoolUsage(_ input: DescribeIdentityPoolUsageRequest) -> EventLoopFuture<DescribeIdentityPoolUsageResponse> {
        return client.execute(operation: "DescribeIdentityPoolUsage", path: "/identitypools/{IdentityPoolId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeIdentityUsage(_ input: DescribeIdentityUsageRequest) -> EventLoopFuture<DescribeIdentityUsageResponse> {
        return client.execute(operation: "DescribeIdentityUsage", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBulkPublishDetails(_ input: GetBulkPublishDetailsRequest) -> EventLoopFuture<GetBulkPublishDetailsResponse> {
        return client.execute(operation: "GetBulkPublishDetails", path: "/identitypools/{IdentityPoolId}/getBulkPublishDetails", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getCognitoEvents(_ input: GetCognitoEventsRequest) -> EventLoopFuture<GetCognitoEventsResponse> {
        return client.execute(operation: "GetCognitoEvents", path: "/identitypools/{IdentityPoolId}/events", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func getIdentityPoolConfiguration(_ input: GetIdentityPoolConfigurationRequest) -> EventLoopFuture<GetIdentityPoolConfigurationResponse> {
        return client.execute(operation: "GetIdentityPoolConfiguration", path: "/identitypools/{IdentityPoolId}/configuration", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDatasets(_ input: ListDatasetsRequest) -> EventLoopFuture<ListDatasetsResponse> {
        return client.execute(operation: "ListDatasets", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listIdentityPoolUsage(_ input: ListIdentityPoolUsageRequest) -> EventLoopFuture<ListIdentityPoolUsageResponse> {
        return client.execute(operation: "ListIdentityPoolUsage", path: "/identitypools", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listRecords(_ input: ListRecordsRequest) -> EventLoopFuture<ListRecordsResponse> {
        return client.execute(operation: "ListRecords", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/records", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func registerDevice(_ input: RegisterDeviceRequest) -> EventLoopFuture<RegisterDeviceResponse> {
        return client.execute(operation: "RegisterDevice", path: "/identitypools/{IdentityPoolId}/identity/{IdentityId}/device", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setCognitoEvents(_ input: SetCognitoEventsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetCognitoEvents", path: "/identitypools/{IdentityPoolId}/events", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func setIdentityPoolConfiguration(_ input: SetIdentityPoolConfigurationRequest) -> EventLoopFuture<SetIdentityPoolConfigurationResponse> {
        return client.execute(operation: "SetIdentityPoolConfiguration", path: "/identitypools/{IdentityPoolId}/configuration", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func subscribeToDataset(_ input: SubscribeToDatasetRequest) -> EventLoopFuture<SubscribeToDatasetResponse> {
        return client.execute(operation: "SubscribeToDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func unsubscribeFromDataset(_ input: UnsubscribeFromDatasetRequest) -> EventLoopFuture<UnsubscribeFromDatasetResponse> {
        return client.execute(operation: "UnsubscribeFromDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateRecords(_ input: UpdateRecordsRequest) -> EventLoopFuture<UpdateRecordsResponse> {
        return client.execute(operation: "UpdateRecords", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
