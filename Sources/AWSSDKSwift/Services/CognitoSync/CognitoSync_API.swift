...
public struct CognitoSync: AWSService {
    ...
    /// return new `CognitoSync` with new timeout value
    ...
    /// return new `CognitoSync` logging to specified Logger
    ...
    public func bulkPublish(_ input: BulkPublishRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BulkPublishResponse> {
        return client.execute(operation: "BulkPublish", path: "/identitypools/{IdentityPoolId}/bulkpublish", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteDataset(_ input: DeleteDatasetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDatasetResponse> {
        return client.execute(operation: "DeleteDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeDataset(_ input: DescribeDatasetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDatasetResponse> {
        return client.execute(operation: "DescribeDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeIdentityPoolUsage(_ input: DescribeIdentityPoolUsageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeIdentityPoolUsageResponse> {
        return client.execute(operation: "DescribeIdentityPoolUsage", path: "/identitypools/{IdentityPoolId}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeIdentityUsage(_ input: DescribeIdentityUsageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeIdentityUsageResponse> {
        return client.execute(operation: "DescribeIdentityUsage", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getBulkPublishDetails(_ input: GetBulkPublishDetailsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetBulkPublishDetailsResponse> {
        return client.execute(operation: "GetBulkPublishDetails", path: "/identitypools/{IdentityPoolId}/getBulkPublishDetails", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getCognitoEvents(_ input: GetCognitoEventsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCognitoEventsResponse> {
        return client.execute(operation: "GetCognitoEvents", path: "/identitypools/{IdentityPoolId}/events", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getIdentityPoolConfiguration(_ input: GetIdentityPoolConfigurationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetIdentityPoolConfigurationResponse> {
        return client.execute(operation: "GetIdentityPoolConfiguration", path: "/identitypools/{IdentityPoolId}/configuration", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listDatasets(_ input: ListDatasetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDatasetsResponse> {
        return client.execute(operation: "ListDatasets", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listIdentityPoolUsage(_ input: ListIdentityPoolUsageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListIdentityPoolUsageResponse> {
        return client.execute(operation: "ListIdentityPoolUsage", path: "/identitypools", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listRecords(_ input: ListRecordsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListRecordsResponse> {
        return client.execute(operation: "ListRecords", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/records", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func registerDevice(_ input: RegisterDeviceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterDeviceResponse> {
        return client.execute(operation: "RegisterDevice", path: "/identitypools/{IdentityPoolId}/identity/{IdentityId}/device", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func setCognitoEvents(_ input: SetCognitoEventsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetCognitoEvents", path: "/identitypools/{IdentityPoolId}/events", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func setIdentityPoolConfiguration(_ input: SetIdentityPoolConfigurationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SetIdentityPoolConfigurationResponse> {
        return client.execute(operation: "SetIdentityPoolConfiguration", path: "/identitypools/{IdentityPoolId}/configuration", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func subscribeToDataset(_ input: SubscribeToDatasetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubscribeToDatasetResponse> {
        return client.execute(operation: "SubscribeToDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func unsubscribeFromDataset(_ input: UnsubscribeFromDatasetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UnsubscribeFromDatasetResponse> {
        return client.execute(operation: "UnsubscribeFromDataset", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}/subscriptions/{DeviceId}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateRecords(_ input: UpdateRecordsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateRecordsResponse> {
        return client.execute(operation: "UpdateRecords", path: "/identitypools/{IdentityPoolId}/identities/{IdentityId}/datasets/{DatasetName}", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
