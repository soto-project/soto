...
extension SimpleDB {
    ...
    public func listDomainsPaginator(_ input: ListDomainsRequest, onPage: @escaping ([String], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listDomains, resultKey: \ListDomainsResult.domainNames, tokenKey: \ListDomainsResult.nextToken, onPage: onPage)
    }
    ...
    public func selectPaginator(_ input: SelectRequest, onPage: @escaping ([Item], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: select, resultKey: \SelectResult.items, tokenKey: \SelectResult.nextToken, onPage: onPage)
    }
