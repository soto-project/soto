...
public struct SimpleDB: AWSService {
    ...
    /// return new `SimpleDB` with new timeout value
    ...
    /// return new `SimpleDB` logging to specified Logger
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "BatchDeleteAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "BatchPutAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteAttributes(_ input: DeleteAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func domainMetadata(_ input: DomainMetadataRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DomainMetadataResult> {
        return client.execute(operation: "DomainMetadata", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getAttributes(_ input: GetAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAttributesResult> {
        return client.execute(operation: "GetAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putAttributes(_ input: PutAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func select(_ input: SelectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SelectResult> {
        return client.execute(operation: "Select", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
