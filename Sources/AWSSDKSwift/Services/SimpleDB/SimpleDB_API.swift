...
public struct SimpleDB {
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "BatchDeleteAttributes", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "BatchPutAttributes", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteAttributes(_ input: DeleteAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteAttributes", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func domainMetadata(_ input: DomainMetadataRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DomainMetadataResult> {
        return client.send(operation: "DomainMetadata", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getAttributes(_ input: GetAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAttributesResult> {
        return client.send(operation: "GetAttributes", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putAttributes(_ input: PutAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.send(operation: "PutAttributes", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func select(_ input: SelectRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SelectResult> {
        return client.send(operation: "Select", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
}
