...
public struct SimpleDB: AWSService {
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "BatchDeleteAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "BatchPutAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createDomain(_ input: CreateDomainRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteAttributes(_ input: DeleteAttributesRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func domainMetadata(_ input: DomainMetadataRequest) -> EventLoopFuture<DomainMetadataResult> {
        return client.execute(operation: "DomainMetadata", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getAttributes(_ input: GetAttributesRequest) -> EventLoopFuture<GetAttributesResult> {
        return client.execute(operation: "GetAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putAttributes(_ input: PutAttributesRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func select(_ input: SelectRequest) -> EventLoopFuture<SelectResult> {
        return client.execute(operation: "Select", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
