...
public struct SimpleDB {
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "BatchDeleteAttributes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "BatchPutAttributes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func domainMetadata(_ input: DomainMetadataRequest) -> EventLoopFuture<DomainMetadataResult> {
        return client.send(operation: "DomainMetadata", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getAttributes(_ input: GetAttributesRequest) -> EventLoopFuture<GetAttributesResult> {
        return client.send(operation: "GetAttributes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func select(_ input: SelectRequest) -> EventLoopFuture<SelectResult> {
        return client.send(operation: "Select", path: "/", httpMethod: "POST", input: input)
    }
}
