...
public struct SimpleDB {
    ...
    public func domainMetadata(_ input: DomainMetadataRequest) throws -> EventLoopFuture<DomainMetadataResult> {
    ...
    public func select(_ input: SelectRequest) throws -> EventLoopFuture<SelectResult> {
    ...
    public func getAttributes(_ input: GetAttributesRequest) throws -> EventLoopFuture<GetAttributesResult> {
    ...
    public func listDomains(_ input: ListDomainsRequest) throws -> EventLoopFuture<ListDomainsResult> {
