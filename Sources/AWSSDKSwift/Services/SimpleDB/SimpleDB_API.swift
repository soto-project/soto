...
public struct SimpleDB {
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest) -> Future<Void> {
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest) -> Future<Void> {
    ...
    @discardableResult public func createDomain(_ input: CreateDomainRequest) -> Future<Void> {
    ...
    @discardableResult public func deleteAttributes(_ input: DeleteAttributesRequest) -> Future<Void> {
    ...
    public func domainMetadata(_ input: DomainMetadataRequest) -> Future<DomainMetadataResult> {
    ...
    public func getAttributes(_ input: GetAttributesRequest) -> Future<GetAttributesResult> {
    ...
    public func listDomains(_ input: ListDomainsRequest) -> Future<ListDomainsResult> {
    ...
    @discardableResult public func putAttributes(_ input: PutAttributesRequest) -> Future<Void> {
    ...
    public func select(_ input: SelectRequest) -> Future<SelectResult> {
