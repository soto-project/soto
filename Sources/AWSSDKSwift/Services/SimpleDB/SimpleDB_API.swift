...
public struct SimpleDB {
    ...
    @discardableResult public func batchDeleteAttributes(_ input: BatchDeleteAttributesRequest) throws -> Future<Void> {
        return try client.send(operation: "BatchDeleteAttributes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func batchPutAttributes(_ input: BatchPutAttributesRequest) throws -> Future<Void> {
        return try client.send(operation: "BatchPutAttributes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func createDomain(_ input: CreateDomainRequest) throws -> Future<Void> {
    ...
    @discardableResult public func deleteAttributes(_ input: DeleteAttributesRequest) throws -> Future<Void> {
    ...
    @discardableResult public func deleteDomain(_ input: DeleteDomainRequest) throws -> Future<Void> {
    ...
    @discardableResult public func putAttributes(_ input: PutAttributesRequest) throws -> Future<Void> {
