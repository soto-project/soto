...
extension Snowball {
    ...
    public func describeAddressesPaginator(_ input: DescribeAddressesRequest) -> EventLoopFuture<[Address]> {
        return client.paginate(input: input, command: describeAddresses, resultKey: \DescribeAddressesResult.addresses, tokenKey: \DescribeAddressesResult.nextToken)
    }
    ...
    public func listJobsPaginator(_ input: ListJobsRequest) -> EventLoopFuture<[JobListEntry]> {
        return client.paginate(input: input, command: listJobs, resultKey: \ListJobsResult.jobListEntries, tokenKey: \ListJobsResult.nextToken)
    }
