...
extension Snowball {
    ...
    public func describeAddressesPaginator(_ input: DescribeAddressesRequest, onPage: @escaping (DescribeAddressesResult, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
