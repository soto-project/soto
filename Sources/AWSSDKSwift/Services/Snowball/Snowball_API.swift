...
public struct Snowball {
    ...
    public func createCluster(_ input: CreateClusterRequest) throws -> EventLoopFuture<CreateClusterResult> {
        return try client.send(operation: "CreateCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific cluster including shipping information, cluster status, and other important metadata.
    public func describeCluster(_ input: DescribeClusterRequest) throws -> EventLoopFuture<DescribeClusterResult> {
    ...
    public func cancelJob(_ input: CancelJobRequest) throws -> EventLoopFuture<CancelJobResult> {
    ...
    public func getSnowballUsage(_ input: GetSnowballUsageRequest) throws -> EventLoopFuture<GetSnowballUsageResult> {
        return try client.send(operation: "GetSnowballUsage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns an array of ClusterListEntry objects of the specified length. Each ClusterListEntry object contains a cluster's state, a cluster's ID, and other important status information.
    public func listClusters(_ input: ListClustersRequest) throws -> EventLoopFuture<ListClustersResult> {
    ...
    public func listCompatibleImages(_ input: ListCompatibleImagesRequest) throws -> EventLoopFuture<ListCompatibleImagesResult> {
        return try client.send(operation: "ListCompatibleImages", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels a cluster job. You can only cancel a cluster job while it's in the AwaitingQuorum status. You'll have at least an hour after creating a cluster job to cancel it.
    public func cancelCluster(_ input: CancelClusterRequest) throws -> EventLoopFuture<CancelClusterResult> {
        return try client.send(operation: "CancelCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns an array of JobListEntry objects of the specified length. Each JobListEntry object is for a job in the specified cluster and contains a job's state, a job's ID, and other information.
    public func listClusterJobs(_ input: ListClusterJobsRequest) throws -> EventLoopFuture<ListClusterJobsResult> {
    ...
    public func updateJob(_ input: UpdateJobRequest) throws -> EventLoopFuture<UpdateJobResult> {
        return try client.send(operation: "UpdateJob", path: "/", httpMethod: "POST", input: input)
    }

    ///  Takes an AddressId and returns specific details about that address in the form of an Address object.
    public func describeAddress(_ input: DescribeAddressRequest) throws -> EventLoopFuture<DescribeAddressResult> {
        return try client.send(operation: "DescribeAddress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a specific job including shipping information, job status, and other important metadata. 
    public func describeJob(_ input: DescribeJobRequest) throws -> EventLoopFuture<DescribeJobResult> {
    ...
    public func createAddress(_ input: CreateAddressRequest) throws -> EventLoopFuture<CreateAddressResult> {
    ...
    public func getJobManifest(_ input: GetJobManifestRequest) throws -> EventLoopFuture<GetJobManifestResult> {
    ...
    public func getJobUnlockCode(_ input: GetJobUnlockCodeRequest) throws -> EventLoopFuture<GetJobUnlockCodeResult> {
    ...
    public func updateCluster(_ input: UpdateClusterRequest) throws -> EventLoopFuture<UpdateClusterResult> {
        return try client.send(operation: "UpdateCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a specified number of ADDRESS objects. Calling this API in one of the US regions will return addresses from the list of all addresses associated with this account in all US regions.
    public func describeAddresses(_ input: DescribeAddressesRequest) throws -> EventLoopFuture<DescribeAddressesResult> {
    ...
    public func createJob(_ input: CreateJobRequest) throws -> EventLoopFuture<CreateJobResult> {
