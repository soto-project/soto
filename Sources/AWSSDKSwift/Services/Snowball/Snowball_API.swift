...
public struct Snowball {
    ...
    public func cancelCluster(_ input: CancelClusterRequest) -> Future<CancelClusterResult> {
        return client.send(operation: "CancelCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels the specified job. You can only cancel a job before its JobState value changes to PreparingAppliance. Requesting the ListJobs or DescribeJob action returns a job's JobState as part of the response element data returned.
    public func cancelJob(_ input: CancelJobRequest) -> Future<CancelJobResult> {
    ...
    public func createAddress(_ input: CreateAddressRequest) -> Future<CreateAddressResult> {
        return client.send(operation: "CreateAddress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates an empty cluster. Each cluster supports five nodes. You use the CreateJob action separately to create the jobs for each of these nodes. The cluster does not ship until these five node jobs have been created.
    public func createCluster(_ input: CreateClusterRequest) -> Future<CreateClusterResult> {
    ...
    public func describeAddress(_ input: DescribeAddressRequest) -> Future<DescribeAddressResult> {
    ...
    public func describeCluster(_ input: DescribeClusterRequest) -> Future<DescribeClusterResult> {
    ...
    public func getJobManifest(_ input: GetJobManifestRequest) -> Future<GetJobManifestResult> {
    ...
    public func getJobUnlockCode(_ input: GetJobUnlockCodeRequest) -> Future<GetJobUnlockCodeResult> {
    ...
    public func getSnowballUsage(_ input: GetSnowballUsageRequest) -> Future<GetSnowballUsageResult> {
    ...
    public func listClusters(_ input: ListClustersRequest) -> Future<ListClustersResult> {
    ...
    public func updateCluster(_ input: UpdateClusterRequest) -> Future<UpdateClusterResult> {
        return client.send(operation: "UpdateCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  While a job's JobState value is New, you can update some of the information associated with a job. Once the job changes to a different job state, usually within 60 minutes of the job being created, this action is no longer available.
    public func updateJob(_ input: UpdateJobRequest) -> Future<UpdateJobResult> {
