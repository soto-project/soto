...
public struct Snowball: AWSService {
    ...
    public func cancelCluster(_ input: CancelClusterRequest) -> EventLoopFuture<CancelClusterResult> {
        return client.execute(operation: "CancelCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func cancelJob(_ input: CancelJobRequest) -> EventLoopFuture<CancelJobResult> {
        return client.execute(operation: "CancelJob", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createAddress(_ input: CreateAddressRequest) -> EventLoopFuture<CreateAddressResult> {
        return client.execute(operation: "CreateAddress", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAddress(_ input: DescribeAddressRequest) -> EventLoopFuture<DescribeAddressResult> {
        return client.execute(operation: "DescribeAddress", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAddresses(_ input: DescribeAddressesRequest) -> EventLoopFuture<DescribeAddressesResult> {
        return client.execute(operation: "DescribeAddresses", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeJob(_ input: DescribeJobRequest) -> EventLoopFuture<DescribeJobResult> {
        return client.execute(operation: "DescribeJob", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getJobManifest(_ input: GetJobManifestRequest) -> EventLoopFuture<GetJobManifestResult> {
        return client.execute(operation: "GetJobManifest", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getJobUnlockCode(_ input: GetJobUnlockCodeRequest) -> EventLoopFuture<GetJobUnlockCodeResult> {
        return client.execute(operation: "GetJobUnlockCode", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSnowballUsage(_ input: GetSnowballUsageRequest) -> EventLoopFuture<GetSnowballUsageResult> {
        return client.execute(operation: "GetSnowballUsage", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSoftwareUpdates(_ input: GetSoftwareUpdatesRequest) -> EventLoopFuture<GetSoftwareUpdatesResult> {
        return client.execute(operation: "GetSoftwareUpdates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listClusterJobs(_ input: ListClusterJobsRequest) -> EventLoopFuture<ListClusterJobsResult> {
        return client.execute(operation: "ListClusterJobs", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listCompatibleImages(_ input: ListCompatibleImagesRequest) -> EventLoopFuture<ListCompatibleImagesResult> {
        return client.execute(operation: "ListCompatibleImages", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
