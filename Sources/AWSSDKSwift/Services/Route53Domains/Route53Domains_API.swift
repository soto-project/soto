...
public struct Route53Domains {
    ...
    public func acceptDomainTransferFromAnotherAwsAccount(_ input: AcceptDomainTransferFromAnotherAwsAccountRequest) -> EventLoopFuture<AcceptDomainTransferFromAnotherAwsAccountResponse> {
        return client.send(operation: "AcceptDomainTransferFromAnotherAwsAccount", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func cancelDomainTransferToAnotherAwsAccount(_ input: CancelDomainTransferToAnotherAwsAccountRequest) -> EventLoopFuture<CancelDomainTransferToAnotherAwsAccountResponse> {
        return client.send(operation: "CancelDomainTransferToAnotherAwsAccount", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func rejectDomainTransferFromAnotherAwsAccount(_ input: RejectDomainTransferFromAnotherAwsAccountRequest) -> EventLoopFuture<RejectDomainTransferFromAnotherAwsAccountResponse> {
        return client.send(operation: "RejectDomainTransferFromAnotherAwsAccount", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func transferDomainToAnotherAwsAccount(_ input: TransferDomainToAnotherAwsAccountRequest) -> EventLoopFuture<TransferDomainToAnotherAwsAccountResponse> {
        return client.send(operation: "TransferDomainToAnotherAwsAccount", path: "/", httpMethod: "POST", input: input)
    }
