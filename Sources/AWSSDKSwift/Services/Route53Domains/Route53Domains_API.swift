...
public struct Route53Domains {
    ...
    public func getDomainDetail(_ input: GetDomainDetailRequest) throws -> EventLoopFuture<GetDomainDetailResponse> {
    ...
    public func registerDomain(_ input: RegisterDomainRequest) throws -> EventLoopFuture<RegisterDomainResponse> {
        return try client.send(operation: "RegisterDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  This operation disables automatic renewal of domain registration for the specified domain.
    public func disableDomainAutoRenew(_ input: DisableDomainAutoRenewRequest) throws -> EventLoopFuture<DisableDomainAutoRenewResponse> {
    ...
    public func updateDomainContact(_ input: UpdateDomainContactRequest) throws -> EventLoopFuture<UpdateDomainContactResponse> {
    ...
    public func updateDomainNameservers(_ input: UpdateDomainNameserversRequest) throws -> EventLoopFuture<UpdateDomainNameserversResponse> {
        return try client.send(operation: "UpdateDomainNameservers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns all the domain-related billing records for the current AWS account for a specified period
    public func viewBilling(_ input: ViewBillingRequest) throws -> EventLoopFuture<ViewBillingResponse> {
        return try client.send(operation: "ViewBilling", path: "/", httpMethod: "POST", input: input)
    }

    ///  Checks whether a domain name can be transferred to Amazon Route 53. 
    public func checkDomainTransferability(_ input: CheckDomainTransferabilityRequest) throws -> EventLoopFuture<CheckDomainTransferabilityResponse> {
    ...
    public func updateDomainContactPrivacy(_ input: UpdateDomainContactPrivacyRequest) throws -> EventLoopFuture<UpdateDomainContactPrivacyResponse> {
        return try client.send(operation: "UpdateDomainContactPrivacy", path: "/", httpMethod: "POST", input: input)
    }

    ///  This operation returns all the domain names registered with Amazon Route 53 for the current AWS account.
    public func listDomains(_ input: ListDomainsRequest) throws -> EventLoopFuture<ListDomainsResponse> {
    ...
    public func resendContactReachabilityEmail(_ input: ResendContactReachabilityEmailRequest) throws -> EventLoopFuture<ResendContactReachabilityEmailResponse> {
    ...
    public func updateTagsForDomain(_ input: UpdateTagsForDomainRequest) throws -> EventLoopFuture<UpdateTagsForDomainResponse> {
    ...
    public func checkDomainAvailability(_ input: CheckDomainAvailabilityRequest) throws -> EventLoopFuture<CheckDomainAvailabilityResponse> {
    ...
    public func renewDomain(_ input: RenewDomainRequest) throws -> EventLoopFuture<RenewDomainResponse> {
        return try client.send(operation: "RenewDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  This operation returns the current status of an operation that is not completed.
    public func getOperationDetail(_ input: GetOperationDetailRequest) throws -> EventLoopFuture<GetOperationDetailResponse> {
    ...
    public func listTagsForDomain(_ input: ListTagsForDomainRequest) throws -> EventLoopFuture<ListTagsForDomainResponse> {
    ...
    public func transferDomain(_ input: TransferDomainRequest) throws -> EventLoopFuture<TransferDomainResponse> {
        return try client.send(operation: "TransferDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  This operation returns the AuthCode for the domain. To transfer a domain to another registrar, you provide this value to the new registrar.
    public func retrieveDomainAuthCode(_ input: RetrieveDomainAuthCodeRequest) throws -> EventLoopFuture<RetrieveDomainAuthCodeResponse> {
    ...
    public func disableDomainTransferLock(_ input: DisableDomainTransferLockRequest) throws -> EventLoopFuture<DisableDomainTransferLockResponse> {
    ...
    public func enableDomainTransferLock(_ input: EnableDomainTransferLockRequest) throws -> EventLoopFuture<EnableDomainTransferLockResponse> {
    ...
    public func getContactReachabilityStatus(_ input: GetContactReachabilityStatusRequest) throws -> EventLoopFuture<GetContactReachabilityStatusResponse> {
    ...
    public func deleteTagsForDomain(_ input: DeleteTagsForDomainRequest) throws -> EventLoopFuture<DeleteTagsForDomainResponse> {
        return try client.send(operation: "DeleteTagsForDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  The GetDomainSuggestions operation returns a list of suggested domain names given a string, which can either be a domain name or simply a word or phrase (without spaces).
    public func getDomainSuggestions(_ input: GetDomainSuggestionsRequest) throws -> EventLoopFuture<GetDomainSuggestionsResponse> {
    ...
    public func enableDomainAutoRenew(_ input: EnableDomainAutoRenewRequest) throws -> EventLoopFuture<EnableDomainAutoRenewResponse> {
