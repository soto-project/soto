...
extension OpsWorks {
    ...
    public func describeEcsClustersPaginator(_ input: DescribeEcsClustersRequest, onPage: @escaping ([EcsCluster], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeEcsClusters, resultKey: \DescribeEcsClustersResult.ecsClusters, tokenKey: \DescribeEcsClustersResult.nextToken, onPage: onPage)
    }
