...
public struct KinesisAnalyticsV2 {
    ...
    public func createApplicationSnapshot(_ input: CreateApplicationSnapshotRequest) throws -> EventLoopFuture<CreateApplicationSnapshotResponse> {
    ...
    public func deleteApplicationSnapshot(_ input: DeleteApplicationSnapshotRequest) throws -> EventLoopFuture<DeleteApplicationSnapshotResponse> {
    ...
    public func describeApplicationSnapshot(_ input: DescribeApplicationSnapshotRequest) throws -> EventLoopFuture<DescribeApplicationSnapshotResponse> {
    ...
    public func listApplicationSnapshots(_ input: ListApplicationSnapshotsRequest) throws -> EventLoopFuture<ListApplicationSnapshotsResponse> {
