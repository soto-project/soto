...
public struct KinesisAnalyticsV2: AWSService {
    ...
    public func addApplicationVpcConfiguration(_ input: AddApplicationVpcConfigurationRequest) -> EventLoopFuture<AddApplicationVpcConfigurationResponse> {
        return client.execute(operation: "AddApplicationVpcConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createApplicationSnapshot(_ input: CreateApplicationSnapshotRequest) -> EventLoopFuture<CreateApplicationSnapshotResponse> {
        return client.execute(operation: "CreateApplicationSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteApplicationSnapshot(_ input: DeleteApplicationSnapshotRequest) -> EventLoopFuture<DeleteApplicationSnapshotResponse> {
        return client.execute(operation: "DeleteApplicationSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteApplicationVpcConfiguration(_ input: DeleteApplicationVpcConfigurationRequest) -> EventLoopFuture<DeleteApplicationVpcConfigurationResponse> {
        return client.execute(operation: "DeleteApplicationVpcConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeApplicationSnapshot(_ input: DescribeApplicationSnapshotRequest) -> EventLoopFuture<DescribeApplicationSnapshotResponse> {
        return client.execute(operation: "DescribeApplicationSnapshot", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listApplicationSnapshots(_ input: ListApplicationSnapshotsRequest) -> EventLoopFuture<ListApplicationSnapshotsResponse> {
        return client.execute(operation: "ListApplicationSnapshots", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
