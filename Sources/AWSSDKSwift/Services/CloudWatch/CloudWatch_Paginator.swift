...
extension CloudWatch {
    ...
    public func describeAlarmHistoryPaginator(_ input: DescribeAlarmHistoryInput) -> Future<[AlarmHistoryItem]> {
    ...
    public func describeAlarmsPaginator(_ input: DescribeAlarmsInput) -> Future<[MetricAlarm]> {
    ...
    public func getMetricDataPaginator(_ input: GetMetricDataInput) -> Future<[MetricDataResult]> {
    ...
    public func listDashboardsPaginator(_ input: ListDashboardsInput) -> Future<[DashboardEntry]> {
    ...
    public func listMetricsPaginator(_ input: ListMetricsInput) -> Future<[Metric]> {
