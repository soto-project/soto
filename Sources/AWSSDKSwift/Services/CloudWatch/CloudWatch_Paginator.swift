...
extension CloudWatch {
    ...
    public func describeAlarmHistoryPaginator(_ input: DescribeAlarmHistoryInput, onPage: @escaping ([AlarmHistoryItem], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeAlarmHistory, resultKey: \DescribeAlarmHistoryOutput.alarmHistoryItems, tokenKey: \DescribeAlarmHistoryOutput.nextToken, onPage: onPage)
    }
    
    ///  Retrieves the specified alarms. If no alarms are specified, all alarms are returned. Alarms can be retrieved by using only a prefix for the alarm name, the alarm state, or a prefix for any action.
    public func describeAlarmsPaginator(_ input: DescribeAlarmsInput, onPage: @escaping ([MetricAlarm], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeAlarms, resultKey: \DescribeAlarmsOutput.metricAlarms, tokenKey: \DescribeAlarmsOutput.nextToken, onPage: onPage)
    }
    ...
    public func describeInsightRulesPaginator(_ input: DescribeInsightRulesInput, onPage: @escaping ([InsightRule], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeInsightRules, resultKey: \DescribeInsightRulesOutput.insightRules, tokenKey: \DescribeInsightRulesOutput.nextToken, onPage: onPage)
    }
    ...
    public func getMetricDataPaginator(_ input: GetMetricDataInput, onPage: @escaping ([MetricDataResult], [MessageData], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getMetricData, resultKey1: \GetMetricDataOutput.metricDataResults, resultKey2: \GetMetricDataOutput.messages, tokenKey: \GetMetricDataOutput.nextToken, onPage: onPage)
    }
    ...
    public func listDashboardsPaginator(_ input: ListDashboardsInput, onPage: @escaping ([DashboardEntry], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listDashboards, resultKey: \ListDashboardsOutput.dashboardEntries, tokenKey: \ListDashboardsOutput.nextToken, onPage: onPage)
    }
    ...
    public func listMetricsPaginator(_ input: ListMetricsInput, onPage: @escaping ([Metric], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listMetrics, resultKey: \ListMetricsOutput.metrics, tokenKey: \ListMetricsOutput.nextToken, onPage: onPage)
    }
