...
extension CloudWatch {
    ...
    public func describeAlarmHistoryPaginator(_ input: DescribeAlarmHistoryInput) -> EventLoopFuture<[AlarmHistoryItem]> {
        return client.paginate(input: input, command: describeAlarmHistory, resultKey: \DescribeAlarmHistoryOutput.alarmHistoryItems, tokenKey: \DescribeAlarmHistoryOutput.nextToken)
    }
    ...
    public func describeAlarmsPaginator(_ input: DescribeAlarmsInput) -> EventLoopFuture<[MetricAlarm]> {
        return client.paginate(input: input, command: describeAlarms, resultKey: \DescribeAlarmsOutput.metricAlarms, tokenKey: \DescribeAlarmsOutput.nextToken)
    }
    ...
    public func describeInsightRulesPaginator(_ input: DescribeInsightRulesInput) -> EventLoopFuture<[InsightRule]> {
        return client.paginate(input: input, command: describeInsightRules, resultKey: \DescribeInsightRulesOutput.insightRules, tokenKey: \DescribeInsightRulesOutput.nextToken)
    }
    ...
    public struct getMetricDataPaginatedResult {
        let metricDataResults: [MetricDataResult]
        let messages: [MessageData]
    }
    public func getMetricDataPaginator(_ input: GetMetricDataInput) -> EventLoopFuture<getMetricDataPaginatedResult> {
        return client.paginate(input: input, command: getMetricData, resultKey1: \GetMetricDataOutput.metricDataResults, resultKey2: \GetMetricDataOutput.messages, tokenKey: \GetMetricDataOutput.nextToken).map {
            return getMetricDataPaginatedResult(metricDataResults: $0, messages: $1)
        }
    }
    ...
    public func listDashboardsPaginator(_ input: ListDashboardsInput) -> EventLoopFuture<[DashboardEntry]> {
        return client.paginate(input: input, command: listDashboards, resultKey: \ListDashboardsOutput.dashboardEntries, tokenKey: \ListDashboardsOutput.nextToken)
    }
    ...
    public func listMetricsPaginator(_ input: ListMetricsInput) -> EventLoopFuture<[Metric]> {
        return client.paginate(input: input, command: listMetrics, resultKey: \ListMetricsOutput.metrics, tokenKey: \ListMetricsOutput.nextToken)
    }
