...
public struct CloudWatch {
    ...
    public func getMetricWidgetImage(_ input: GetMetricWidgetImageInput) throws -> GetMetricWidgetImageOutput {
    ...
    public func getMetricData(_ input: GetMetricDataInput) throws -> GetMetricDataOutput {
