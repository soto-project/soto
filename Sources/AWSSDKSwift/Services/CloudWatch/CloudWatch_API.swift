...
public struct CloudWatch {
    ...
    public func deleteAnomalyDetector(_ input: DeleteAnomalyDetectorInput) throws -> Future<DeleteAnomalyDetectorOutput> {
        return try client.send(operation: "DeleteAnomalyDetector", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeAnomalyDetectors(_ input: DescribeAnomalyDetectorsInput) throws -> Future<DescribeAnomalyDetectorsOutput> {
        return try client.send(operation: "DescribeAnomalyDetectors", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func putAnomalyDetector(_ input: PutAnomalyDetectorInput) throws -> Future<PutAnomalyDetectorOutput> {
        return try client.send(operation: "PutAnomalyDetector", path: "/", httpMethod: "POST", input: input)
    }
