...
public struct CloudWatch {
    ...
    @discardableResult public func deleteAlarms(_ input: DeleteAlarmsInput) -> Future<Void> {
        return client.send(operation: "DeleteAlarms", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified anomaly detection model from your account.
    public func deleteAnomalyDetector(_ input: DeleteAnomalyDetectorInput) -> Future<DeleteAnomalyDetectorOutput> {
        return client.send(operation: "DeleteAnomalyDetector", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If there is an error during this call, no dashboards are deleted.
    public func deleteDashboards(_ input: DeleteDashboardsInput) -> Future<DeleteDashboardsOutput> {
    ...
    public func deleteInsightRules(_ input: DeleteInsightRulesInput) -> Future<DeleteInsightRulesOutput> {
    ...
    public func describeAlarmHistory(_ input: DescribeAlarmHistoryInput) -> Future<DescribeAlarmHistoryOutput> {
        return client.send(operation: "DescribeAlarmHistory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the specified alarms. If no alarms are specified, all alarms are returned. Alarms can be retrieved by using only a prefix for the alarm name, the alarm state, or a prefix for any action.
    public func describeAlarms(_ input: DescribeAlarmsInput) -> Future<DescribeAlarmsOutput> {
        return client.send(operation: "DescribeAlarms", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the alarms for the specified metric. To filter the results, specify a statistic, period, or unit.
    public func describeAlarmsForMetric(_ input: DescribeAlarmsForMetricInput) -> Future<DescribeAlarmsForMetricOutput> {
    ...
    public func describeAnomalyDetectors(_ input: DescribeAnomalyDetectorsInput) -> Future<DescribeAnomalyDetectorsOutput> {
    ...
    public func describeInsightRules(_ input: DescribeInsightRulesInput) -> Future<DescribeInsightRulesOutput> {
        return client.send(operation: "DescribeInsightRules", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables the actions for the specified alarms. When an alarm's actions are disabled, the alarm actions do not execute when the alarm state changes.
    @discardableResult public func disableAlarmActions(_ input: DisableAlarmActionsInput) -> Future<Void> {
        return client.send(operation: "DisableAlarmActions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do not incur costs.
    public func disableInsightRules(_ input: DisableInsightRulesInput) -> Future<DisableInsightRulesOutput> {
        return client.send(operation: "DisableInsightRules", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables the actions for the specified alarms.
    @discardableResult public func enableAlarmActions(_ input: EnableAlarmActionsInput) -> Future<Void> {
        return client.send(operation: "EnableAlarmActions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.
    public func enableInsightRules(_ input: EnableInsightRulesInput) -> Future<EnableInsightRulesOutput> {
    ...
    public func getDashboard(_ input: GetDashboardInput) -> Future<GetDashboardOutput> {
    ...
    public func getInsightRuleReport(_ input: GetInsightRuleReportInput) -> Future<GetInsightRuleReportOutput> {
    ...
    public func getMetricData(_ input: GetMetricDataInput) -> Future<GetMetricDataOutput> {
    ...
    public func getMetricStatistics(_ input: GetMetricStatisticsInput) -> Future<GetMetricStatisticsOutput> {
    ...
    public func getMetricWidgetImage(_ input: GetMetricWidgetImageInput) -> Future<GetMetricWidgetImageOutput> {
    ...
    public func listDashboards(_ input: ListDashboardsInput) -> Future<ListDashboardsOutput> {
    ...
    public func listMetrics(_ input: ListMetricsInput) -> Future<ListMetricsOutput> {
    ...
    public func putAnomalyDetector(_ input: PutAnomalyDetectorInput) -> Future<PutAnomalyDetectorOutput> {
    ...
    public func putDashboard(_ input: PutDashboardInput) -> Future<PutDashboardOutput> {
    ...
    public func putInsightRule(_ input: PutInsightRuleInput) -> Future<PutInsightRuleOutput> {
    ...
    @discardableResult public func putMetricAlarm(_ input: PutMetricAlarmInput) -> Future<Void> {
    ...
    @discardableResult public func putMetricData(_ input: PutMetricDataInput) -> Future<Void> {
    ...
    @discardableResult public func setAlarmState(_ input: SetAlarmStateInput) -> Future<Void> {
