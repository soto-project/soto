...
public struct CloudWatch: AWSService {
    ...
    @discardableResult public func deleteAlarms(_ input: DeleteAlarmsInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAlarms", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteAnomalyDetector(_ input: DeleteAnomalyDetectorInput) -> EventLoopFuture<DeleteAnomalyDetectorOutput> {
        return client.execute(operation: "DeleteAnomalyDetector", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteDashboards(_ input: DeleteDashboardsInput) -> EventLoopFuture<DeleteDashboardsOutput> {
        return client.execute(operation: "DeleteDashboards", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteInsightRules(_ input: DeleteInsightRulesInput) -> EventLoopFuture<DeleteInsightRulesOutput> {
        return client.execute(operation: "DeleteInsightRules", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAlarmHistory(_ input: DescribeAlarmHistoryInput) -> EventLoopFuture<DescribeAlarmHistoryOutput> {
        return client.execute(operation: "DescribeAlarmHistory", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAlarms(_ input: DescribeAlarmsInput) -> EventLoopFuture<DescribeAlarmsOutput> {
        return client.execute(operation: "DescribeAlarms", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAlarmsForMetric(_ input: DescribeAlarmsForMetricInput) -> EventLoopFuture<DescribeAlarmsForMetricOutput> {
        return client.execute(operation: "DescribeAlarmsForMetric", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAnomalyDetectors(_ input: DescribeAnomalyDetectorsInput) -> EventLoopFuture<DescribeAnomalyDetectorsOutput> {
        return client.execute(operation: "DescribeAnomalyDetectors", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeInsightRules(_ input: DescribeInsightRulesInput) -> EventLoopFuture<DescribeInsightRulesOutput> {
        return client.execute(operation: "DescribeInsightRules", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disableAlarmActions(_ input: DisableAlarmActionsInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisableAlarmActions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disableInsightRules(_ input: DisableInsightRulesInput) -> EventLoopFuture<DisableInsightRulesOutput> {
        return client.execute(operation: "DisableInsightRules", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Enables the actions for the specified alarms.
    @discardableResult public func enableAlarmActions(_ input: EnableAlarmActionsInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "EnableAlarmActions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func enableInsightRules(_ input: EnableInsightRulesInput) -> EventLoopFuture<EnableInsightRulesOutput> {
        return client.execute(operation: "EnableInsightRules", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getDashboard(_ input: GetDashboardInput) -> EventLoopFuture<GetDashboardOutput> {
        return client.execute(operation: "GetDashboard", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getInsightRuleReport(_ input: GetInsightRuleReportInput) -> EventLoopFuture<GetInsightRuleReportOutput> {
        return client.execute(operation: "GetInsightRuleReport", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getMetricData(_ input: GetMetricDataInput) -> EventLoopFuture<GetMetricDataOutput> {
        return client.execute(operation: "GetMetricData", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getMetricStatistics(_ input: GetMetricStatisticsInput) -> EventLoopFuture<GetMetricStatisticsOutput> {
        return client.execute(operation: "GetMetricStatistics", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getMetricWidgetImage(_ input: GetMetricWidgetImageInput) -> EventLoopFuture<GetMetricWidgetImageOutput> {
        return client.execute(operation: "GetMetricWidgetImage", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listDashboards(_ input: ListDashboardsInput) -> EventLoopFuture<ListDashboardsOutput> {
        return client.execute(operation: "ListDashboards", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listMetrics(_ input: ListMetricsInput) -> EventLoopFuture<ListMetricsOutput> {
        return client.execute(operation: "ListMetrics", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putAnomalyDetector(_ input: PutAnomalyDetectorInput) -> EventLoopFuture<PutAnomalyDetectorOutput> {
        return client.execute(operation: "PutAnomalyDetector", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putCompositeAlarm(_ input: PutCompositeAlarmInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutCompositeAlarm", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putDashboard(_ input: PutDashboardInput) -> EventLoopFuture<PutDashboardOutput> {
        return client.execute(operation: "PutDashboard", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putInsightRule(_ input: PutInsightRuleInput) -> EventLoopFuture<PutInsightRuleOutput> {
        return client.execute(operation: "PutInsightRule", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putMetricAlarm(_ input: PutMetricAlarmInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutMetricAlarm", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func putMetricData(_ input: PutMetricDataInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutMetricData", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setAlarmState(_ input: SetAlarmStateInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetAlarmState", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
