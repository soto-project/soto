...
public struct CloudWatch {
    ...
    @discardableResult public func deleteAlarms(_ input: DeleteAlarmsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAlarms", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes the specified anomaly detection model from your account.
    public func deleteAnomalyDetector(_ input: DeleteAnomalyDetectorInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteAnomalyDetectorOutput> {
        return client.execute(operation: "DeleteAnomalyDetector", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If there is an error during this call, no dashboards are deleted.
    public func deleteDashboards(_ input: DeleteDashboardsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteDashboardsOutput> {
        return client.execute(operation: "DeleteDashboards", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteInsightRules(_ input: DeleteInsightRulesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteInsightRulesOutput> {
        return client.execute(operation: "DeleteInsightRules", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeAlarmHistory(_ input: DescribeAlarmHistoryInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmHistoryOutput> {
        return client.execute(operation: "DescribeAlarmHistory", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeAlarms(_ input: DescribeAlarmsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmsOutput> {
        return client.execute(operation: "DescribeAlarms", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Retrieves the alarms for the specified metric. To filter the results, specify a statistic, period, or unit.
    public func describeAlarmsForMetric(_ input: DescribeAlarmsForMetricInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmsForMetricOutput> {
        return client.execute(operation: "DescribeAlarmsForMetric", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Lists the anomaly detection models that you have created in your account. You can list all models in your account or filter the results to only the models that are related to a certain namespace, metric name, or metric dimension.
    public func describeAnomalyDetectors(_ input: DescribeAnomalyDetectorsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAnomalyDetectorsOutput> {
        return client.execute(operation: "DescribeAnomalyDetectors", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeInsightRules(_ input: DescribeInsightRulesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeInsightRulesOutput> {
        return client.execute(operation: "DescribeInsightRules", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Disables the actions for the specified alarms. When an alarm's actions are disabled, the alarm actions do not execute when the alarm state changes.
    @discardableResult public func disableAlarmActions(_ input: DisableAlarmActionsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisableAlarmActions", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do not incur costs.
    public func disableInsightRules(_ input: DisableInsightRulesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisableInsightRulesOutput> {
        return client.execute(operation: "DisableInsightRules", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Enables the actions for the specified alarms.
    @discardableResult public func enableAlarmActions(_ input: EnableAlarmActionsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "EnableAlarmActions", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.
    public func enableInsightRules(_ input: EnableInsightRulesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EnableInsightRulesOutput> {
        return client.execute(operation: "EnableInsightRules", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getDashboard(_ input: GetDashboardInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDashboardOutput> {
        return client.execute(operation: "GetDashboard", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getInsightRuleReport(_ input: GetInsightRuleReportInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetInsightRuleReportOutput> {
        return client.execute(operation: "GetInsightRuleReport", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getMetricData(_ input: GetMetricDataInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricDataOutput> {
        return client.execute(operation: "GetMetricData", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getMetricStatistics(_ input: GetMetricStatisticsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricStatisticsOutput> {
        return client.execute(operation: "GetMetricStatistics", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getMetricWidgetImage(_ input: GetMetricWidgetImageInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetMetricWidgetImageOutput> {
        return client.execute(operation: "GetMetricWidgetImage", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listDashboards(_ input: ListDashboardsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDashboardsOutput> {
        return client.execute(operation: "ListDashboards", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listMetrics(_ input: ListMetricsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListMetricsOutput> {
        return client.execute(operation: "ListMetrics", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putAnomalyDetector(_ input: PutAnomalyDetectorInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutAnomalyDetectorOutput> {
        return client.execute(operation: "PutAnomalyDetector", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putCompositeAlarm(_ input: PutCompositeAlarmInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutCompositeAlarm", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putDashboard(_ input: PutDashboardInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutDashboardOutput> {
        return client.execute(operation: "PutDashboard", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func putInsightRule(_ input: PutInsightRuleInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutInsightRuleOutput> {
        return client.execute(operation: "PutInsightRule", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putMetricAlarm(_ input: PutMetricAlarmInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutMetricAlarm", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func putMetricData(_ input: PutMetricDataInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "PutMetricData", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func setAlarmState(_ input: SetAlarmStateInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetAlarmState", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
