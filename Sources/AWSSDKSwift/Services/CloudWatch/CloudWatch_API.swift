...
public struct CloudWatch {
    ...
    public func describeAlarmHistory(_ input: DescribeAlarmHistoryInput) throws -> EventLoopFuture<DescribeAlarmHistoryOutput> {
    ...
    public func getMetricStatistics(_ input: GetMetricStatisticsInput) throws -> EventLoopFuture<GetMetricStatisticsOutput> {
    ...
    public func getMetricWidgetImage(_ input: GetMetricWidgetImageInput) throws -> EventLoopFuture<GetMetricWidgetImageOutput> {
        return try client.send(operation: "GetMetricWidgetImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the alarms for the specified metric. To filter the results, specify a statistic, period, or unit.
    public func describeAlarmsForMetric(_ input: DescribeAlarmsForMetricInput) throws -> EventLoopFuture<DescribeAlarmsForMetricOutput> {
    ...
    public func listDashboards(_ input: ListDashboardsInput) throws -> EventLoopFuture<ListDashboardsOutput> {
    ...
    public func listMetrics(_ input: ListMetricsInput) throws -> EventLoopFuture<ListMetricsOutput> {
    ...
    public func putDashboard(_ input: PutDashboardInput) throws -> EventLoopFuture<PutDashboardOutput> {
        return try client.send(operation: "PutDashboard", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If there is an error during this call, no dashboards are deleted.
    public func deleteDashboards(_ input: DeleteDashboardsInput) throws -> EventLoopFuture<DeleteDashboardsOutput> {
    ...
    public func getDashboard(_ input: GetDashboardInput) throws -> EventLoopFuture<GetDashboardOutput> {
    ...
    public func getMetricData(_ input: GetMetricDataInput) throws -> EventLoopFuture<GetMetricDataOutput> {
    ...
    public func describeAlarms(_ input: DescribeAlarmsInput) throws -> EventLoopFuture<DescribeAlarmsOutput> {
