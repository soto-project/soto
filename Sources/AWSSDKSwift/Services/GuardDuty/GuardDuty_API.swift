...
public struct GuardDuty {
    ...
    public func updateFindingsFeedback(_ input: UpdateFindingsFeedbackRequest) throws -> EventLoopFuture<UpdateFindingsFeedbackResponse> {
    ...
    public func updateThreatIntelSet(_ input: UpdateThreatIntelSetRequest) throws -> EventLoopFuture<UpdateThreatIntelSetResponse> {
    ...
    public func getFilter(_ input: GetFilterRequest) throws -> EventLoopFuture<GetFilterResponse> {
    ...
    public func getDetector(_ input: GetDetectorRequest) throws -> EventLoopFuture<GetDetectorResponse> {
        return try client.send(operation: "GetDetector", path: "/detector/{detectorId}", httpMethod: "GET", input: input)
    }

    ///  Deletes a Amazon GuardDuty detector specified by the detector ID.
    public func deleteDetector(_ input: DeleteDetectorRequest) throws -> EventLoopFuture<DeleteDetectorResponse> {
        return try client.send(operation: "DeleteDetector", path: "/detector/{detectorId}", httpMethod: "DELETE", input: input)
    }

    ///  Deletes ThreatIntelSet specified by the ThreatIntelSet ID.
    public func deleteThreatIntelSet(_ input: DeleteThreatIntelSetRequest) throws -> EventLoopFuture<DeleteThreatIntelSetResponse> {
    ...
    public func getFindings(_ input: GetFindingsRequest) throws -> EventLoopFuture<GetFindingsResponse> {
    ...
    public func archiveFindings(_ input: ArchiveFindingsRequest) throws -> EventLoopFuture<ArchiveFindingsResponse> {
    ...
    public func deleteInvitations(_ input: DeleteInvitationsRequest) throws -> EventLoopFuture<DeleteInvitationsResponse> {
    ...
    public func disassociateMembers(_ input: DisassociateMembersRequest) throws -> EventLoopFuture<DisassociateMembersResponse> {
    ...
    public func getInvitationsCount(_ input: GetInvitationsCountRequest) throws -> EventLoopFuture<GetInvitationsCountResponse> {
    ...
    public func inviteMembers(_ input: InviteMembersRequest) throws -> EventLoopFuture<InviteMembersResponse> {
    ...
    public func listDetectors(_ input: ListDetectorsRequest) throws -> EventLoopFuture<ListDetectorsResponse> {
        return try client.send(operation: "ListDetectors", path: "/detector", httpMethod: "GET", input: input)
    }

    ///  Lists details about all member accounts for the current GuardDuty master account.
    public func listMembers(_ input: ListMembersRequest) throws -> EventLoopFuture<ListMembersResponse> {
    ...
    public func getThreatIntelSet(_ input: GetThreatIntelSetRequest) throws -> EventLoopFuture<GetThreatIntelSetResponse> {
    ...
    public func deleteMembers(_ input: DeleteMembersRequest) throws -> EventLoopFuture<DeleteMembersResponse> {
    ...
    public func listInvitations(_ input: ListInvitationsRequest) throws -> EventLoopFuture<ListInvitationsResponse> {
    ...
    public func createDetector(_ input: CreateDetectorRequest) throws -> EventLoopFuture<CreateDetectorResponse> {
        return try client.send(operation: "CreateDetector", path: "/detector", httpMethod: "POST", input: input)
    }

    ///  Accepts the invitation to be monitored by a master GuardDuty account.
    public func acceptInvitation(_ input: AcceptInvitationRequest) throws -> EventLoopFuture<AcceptInvitationResponse> {
    ...
    public func createMembers(_ input: CreateMembersRequest) throws -> EventLoopFuture<CreateMembersResponse> {
    ...
    public func getMembers(_ input: GetMembersRequest) throws -> EventLoopFuture<GetMembersResponse> {
    ...
    public func createSampleFindings(_ input: CreateSampleFindingsRequest) throws -> EventLoopFuture<CreateSampleFindingsResponse> {
    ...
    public func getFindingsStatistics(_ input: GetFindingsStatisticsRequest) throws -> EventLoopFuture<GetFindingsStatisticsResponse> {
    ...
    public func deleteFilter(_ input: DeleteFilterRequest) throws -> EventLoopFuture<DeleteFilterResponse> {
    ...
    public func listThreatIntelSets(_ input: ListThreatIntelSetsRequest) throws -> EventLoopFuture<ListThreatIntelSetsResponse> {
    ...
    public func declineInvitations(_ input: DeclineInvitationsRequest) throws -> EventLoopFuture<DeclineInvitationsResponse> {
    ...
    public func createThreatIntelSet(_ input: CreateThreatIntelSetRequest) throws -> EventLoopFuture<CreateThreatIntelSetResponse> {
    ...
    public func updateDetector(_ input: UpdateDetectorRequest) throws -> EventLoopFuture<UpdateDetectorResponse> {
    ...
    public func listFilters(_ input: ListFiltersRequest) throws -> EventLoopFuture<ListFiltersResponse> {
    ...
    public func getMasterAccount(_ input: GetMasterAccountRequest) throws -> EventLoopFuture<GetMasterAccountResponse> {
    ...
    public func disassociateFromMasterAccount(_ input: DisassociateFromMasterAccountRequest) throws -> EventLoopFuture<DisassociateFromMasterAccountResponse> {
    ...
    public func updateFilter(_ input: UpdateFilterRequest) throws -> EventLoopFuture<UpdateFilterResponse> {
    ...
    public func unarchiveFindings(_ input: UnarchiveFindingsRequest) throws -> EventLoopFuture<UnarchiveFindingsResponse> {
    ...
    public func createFilter(_ input: CreateFilterRequest) throws -> EventLoopFuture<CreateFilterResponse> {
    ...
    public func startMonitoringMembers(_ input: StartMonitoringMembersRequest) throws -> EventLoopFuture<StartMonitoringMembersResponse> {
    ...
    public func stopMonitoringMembers(_ input: StopMonitoringMembersRequest) throws -> EventLoopFuture<StopMonitoringMembersResponse> {
