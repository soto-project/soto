...
public struct ApplicationAutoScaling: AWSService {
    ...
    /// return new `ApplicationAutoScaling` with new timeout value
    ...
    /// return new `ApplicationAutoScaling` logging to specified Logger
    ...
    public func deleteScalingPolicy(_ input: DeleteScalingPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteScalingPolicyResponse> {
        return client.execute(operation: "DeleteScalingPolicy", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deregisterScalableTarget(_ input: DeregisterScalableTargetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeregisterScalableTargetResponse> {
        return client.execute(operation: "DeregisterScalableTarget", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeScalableTargets(_ input: DescribeScalableTargetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScalableTargetsResponse> {
        return client.execute(operation: "DescribeScalableTargets", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeScalingPolicies(_ input: DescribeScalingPoliciesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeScalingPoliciesResponse> {
        return client.execute(operation: "DescribeScalingPolicies", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putScheduledAction(_ input: PutScheduledActionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutScheduledActionResponse> {
        return client.execute(operation: "PutScheduledAction", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func registerScalableTarget(_ input: RegisterScalableTargetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RegisterScalableTargetResponse> {
        return client.execute(operation: "RegisterScalableTarget", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
