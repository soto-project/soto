...
extension ApplicationAutoScaling {
    ...
    public struct DeleteScheduledActionRequest: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, resourceId: String, scalableDimension: ScalableDimension? = nil, scheduledActionName: String) {
    ...
    public struct DescribeScalingPoliciesRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, serviceNamespace: ServiceNamespace, scalableDimension: ScalableDimension? = nil, policyNames: [String]? = nil, maxResults: Int32? = nil, resourceId: String? = nil) {
            self.nextToken = nextToken
            self.serviceNamespace = serviceNamespace
            self.scalableDimension = scalableDimension
    ...
    public struct ScalableTarget: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, roleARN: String, scalableDimension: ScalableDimension, maxCapacity: Int32, minCapacity: Int32, resourceId: String, creationTime: TimeStamp) {
            self.serviceNamespace = serviceNamespace
    ...
    public struct ScheduledAction: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, scalableDimension: ScalableDimension? = nil, startTime: TimeStamp? = nil, endTime: TimeStamp? = nil, scalableTargetAction: ScalableTargetAction? = nil, scheduledActionARN: String, resourceId: String, creationTime: TimeStamp, schedule: String, scheduledActionName: String) {
            self.serviceNamespace = serviceNamespace
            self.scalableDimension = scalableDimension
    ...
    public struct DeleteScalingPolicyRequest: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, resourceId: String, scalableDimension: ScalableDimension, policyName: String) {
            self.serviceNamespace = serviceNamespace
            self.resourceId = resourceId
            self.scalableDimension = scalableDimension
    ...
    public struct DescribeScalableTargetsRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, serviceNamespace: ServiceNamespace, scalableDimension: ScalableDimension? = nil, maxResults: Int32? = nil, resourceIds: [String]? = nil) {
            self.nextToken = nextToken
            self.serviceNamespace = serviceNamespace
            self.scalableDimension = scalableDimension
            self.maxResults = maxResults
    ...
    public struct RegisterScalableTargetRequest: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, minCapacity: Int32? = nil, maxCapacity: Int32? = nil, resourceId: String, scalableDimension: ScalableDimension, roleARN: String? = nil) {
            self.serviceNamespace = serviceNamespace
            self.minCapacity = minCapacity
            self.maxCapacity = maxCapacity
            self.resourceId = resourceId
    ...
    public struct DescribeScheduledActionsRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, serviceNamespace: ServiceNamespace, resourceId: String? = nil, scalableDimension: ScalableDimension? = nil, scheduledActionNames: [String]? = nil, maxResults: Int32? = nil) {
            self.nextToken = nextToken
            self.serviceNamespace = serviceNamespace
            self.resourceId = resourceId
            self.scalableDimension = scalableDimension
    ...
    public struct PutScheduledActionRequest: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, scalableDimension: ScalableDimension? = nil, startTime: TimeStamp? = nil, endTime: TimeStamp? = nil, scalableTargetAction: ScalableTargetAction? = nil, resourceId: String, schedule: String? = nil, scheduledActionName: String) {
            self.serviceNamespace = serviceNamespace
            self.scalableDimension = scalableDimension
            self.startTime = startTime
            self.endTime = endTime
    ...
    public struct ScalingActivity: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, statusCode: ScalingActivityStatusCode, activityId: String, scalableDimension: ScalableDimension, startTime: TimeStamp, endTime: TimeStamp? = nil, cause: String, resourceId: String, statusMessage: String? = nil, details: String? = nil, description: String) {
            self.serviceNamespace = serviceNamespace
    ...
    public struct StepScalingPolicyConfiguration: AWSShape {
        ...
        public init(cooldown: Int32? = nil, minAdjustmentMagnitude: Int32? = nil, adjustmentType: AdjustmentType? = nil, stepAdjustments: [StepAdjustment]? = nil, metricAggregationType: MetricAggregationType? = nil) {
    ...
    public struct PutScalingPolicyRequest: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, targetTrackingScalingPolicyConfiguration: TargetTrackingScalingPolicyConfiguration? = nil, stepScalingPolicyConfiguration: StepScalingPolicyConfiguration? = nil, scalableDimension: ScalableDimension, policyType: PolicyType? = nil, resourceId: String, policyName: String) {
            self.serviceNamespace = serviceNamespace
    ...
    public struct ScalingPolicy: AWSShape {
        ...
        public init(serviceNamespace: ServiceNamespace, targetTrackingScalingPolicyConfiguration: TargetTrackingScalingPolicyConfiguration? = nil, stepScalingPolicyConfiguration: StepScalingPolicyConfiguration? = nil, scalableDimension: ScalableDimension, alarms: [Alarm]? = nil, policyARN: String, policyType: PolicyType, resourceId: String, creationTime: TimeStamp, policyName: String) {
            self.serviceNamespace = serviceNamespace
            self.targetTrackingScalingPolicyConfiguration = targetTrackingScalingPolicyConfiguration
            self.stepScalingPolicyConfiguration = stepScalingPolicyConfiguration
            self.scalableDimension = scalableDimension
    ...
    public struct DescribeScalingActivitiesRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, serviceNamespace: ServiceNamespace, resourceId: String? = nil, scalableDimension: ScalableDimension? = nil, maxResults: Int32? = nil) {
            self.nextToken = nextToken
            self.serviceNamespace = serviceNamespace
            self.resourceId = resourceId
            self.scalableDimension = scalableDimension
    ...
    public struct TargetTrackingScalingPolicyConfiguration: AWSShape {
        ...
        public init(scaleOutCooldown: Int32? = nil, disableScaleIn: Bool? = nil, predefinedMetricSpecification: PredefinedMetricSpecification? = nil, targetValue: Double, customizedMetricSpecification: CustomizedMetricSpecification? = nil, scaleInCooldown: Int32? = nil) {
