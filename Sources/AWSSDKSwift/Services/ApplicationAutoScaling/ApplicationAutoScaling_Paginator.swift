...
extension ApplicationAutoScaling {
    ...
    public func describeScalableTargetsPaginator(_ input: DescribeScalableTargetsRequest) -> Future<[ScalableTarget]> {
    ...
    public func describeScalingActivitiesPaginator(_ input: DescribeScalingActivitiesRequest) -> Future<[ScalingActivity]> {
    ...
    public func describeScalingPoliciesPaginator(_ input: DescribeScalingPoliciesRequest) -> Future<[ScalingPolicy]> {
    ...
    public func describeScheduledActionsPaginator(_ input: DescribeScheduledActionsRequest) -> Future<[ScheduledAction]> {
