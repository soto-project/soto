...
extension ApplicationAutoScaling {
    ...
    public func describeScalableTargetsPaginator(_ input: DescribeScalableTargetsRequest, onPage: @escaping ([ScalableTarget], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeScalableTargets, resultKey: \DescribeScalableTargetsResponse.scalableTargets, tokenKey: \DescribeScalableTargetsResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeScalingActivitiesPaginator(_ input: DescribeScalingActivitiesRequest, onPage: @escaping ([ScalingActivity], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeScalingActivities, resultKey: \DescribeScalingActivitiesResponse.scalingActivities, tokenKey: \DescribeScalingActivitiesResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeScalingPoliciesPaginator(_ input: DescribeScalingPoliciesRequest, onPage: @escaping ([ScalingPolicy], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeScalingPolicies, resultKey: \DescribeScalingPoliciesResponse.scalingPolicies, tokenKey: \DescribeScalingPoliciesResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeScheduledActionsPaginator(_ input: DescribeScheduledActionsRequest, onPage: @escaping ([ScheduledAction], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeScheduledActions, resultKey: \DescribeScheduledActionsResponse.scheduledActions, tokenKey: \DescribeScheduledActionsResponse.nextToken, onPage: onPage)
    }
