...
extension ApplicationAutoScaling {
    ...
    public func describeScalableTargetsPaginator(_ input: DescribeScalableTargetsRequest) -> EventLoopFuture<[ScalableTarget]> {
        return client.paginate(input: input, command: describeScalableTargets, resultKey: \DescribeScalableTargetsResponse.scalableTargets, tokenKey: \DescribeScalableTargetsResponse.nextToken)
    }
    ...
    public func describeScalingActivitiesPaginator(_ input: DescribeScalingActivitiesRequest) -> EventLoopFuture<[ScalingActivity]> {
        return client.paginate(input: input, command: describeScalingActivities, resultKey: \DescribeScalingActivitiesResponse.scalingActivities, tokenKey: \DescribeScalingActivitiesResponse.nextToken)
    }
    ...
    public func describeScalingPoliciesPaginator(_ input: DescribeScalingPoliciesRequest) -> EventLoopFuture<[ScalingPolicy]> {
        return client.paginate(input: input, command: describeScalingPolicies, resultKey: \DescribeScalingPoliciesResponse.scalingPolicies, tokenKey: \DescribeScalingPoliciesResponse.nextToken)
    }
    ...
    public func describeScheduledActionsPaginator(_ input: DescribeScheduledActionsRequest) -> EventLoopFuture<[ScheduledAction]> {
        return client.paginate(input: input, command: describeScheduledActions, resultKey: \DescribeScheduledActionsResponse.scheduledActions, tokenKey: \DescribeScheduledActionsResponse.nextToken)
    }
