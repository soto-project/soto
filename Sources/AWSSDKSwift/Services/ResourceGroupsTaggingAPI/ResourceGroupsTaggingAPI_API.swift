...
public struct ResourceGroupsTaggingAPI {
    ...
    public func tagResources(_ input: TagResourcesInput) throws -> EventLoopFuture<TagResourcesOutput> {
    ...
    public func getResources(_ input: GetResourcesInput) throws -> EventLoopFuture<GetResourcesOutput> {
        return try client.send(operation: "GetResources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns all tag values for the specified key in the specified region for the AWS account.
    public func getTagValues(_ input: GetTagValuesInput) throws -> EventLoopFuture<GetTagValuesOutput> {
    ...
    public func untagResources(_ input: UntagResourcesInput) throws -> EventLoopFuture<UntagResourcesOutput> {
        return try client.send(operation: "UntagResources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns all tag keys in the specified region for the AWS account.
    public func getTagKeys(_ input: GetTagKeysInput) throws -> EventLoopFuture<GetTagKeysOutput> {
