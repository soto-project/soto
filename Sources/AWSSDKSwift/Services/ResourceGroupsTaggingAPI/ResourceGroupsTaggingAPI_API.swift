...
public struct ResourceGroupsTaggingAPI: AWSService {
    ...
    /// return new `ResourceGroupsTaggingAPI` with new timeout value
    ...
    /// return new `ResourceGroupsTaggingAPI` logging to specified Logger
    ...
    public func describeReportCreation(_ input: DescribeReportCreationInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeReportCreationOutput> {
        return client.execute(operation: "DescribeReportCreation", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getComplianceSummary(_ input: GetComplianceSummaryInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetComplianceSummaryOutput> {
        return client.execute(operation: "GetComplianceSummary", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getResources(_ input: GetResourcesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetResourcesOutput> {
        return client.execute(operation: "GetResources", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Returns all tag keys in the specified Region for the AWS account.
    public func getTagKeys(_ input: GetTagKeysInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTagKeysOutput> {
        return client.execute(operation: "GetTagKeys", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getTagValues(_ input: GetTagValuesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTagValuesOutput> {
        return client.execute(operation: "GetTagValues", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startReportCreation(_ input: StartReportCreationInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartReportCreationOutput> {
        return client.execute(operation: "StartReportCreation", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func tagResources(_ input: TagResourcesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TagResourcesOutput> {
        return client.execute(operation: "TagResources", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func untagResources(_ input: UntagResourcesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UntagResourcesOutput> {
        return client.execute(operation: "UntagResources", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
