...
extension ResourceGroupsTaggingAPI {
    ...
    public struct FailureInfo: AWSShape {
        ...
        public init(errorCode: ErrorCode? = nil, statusCode: Int32? = nil, errorMessage: String? = nil) {
    ...
    public struct GetResourcesInput: AWSShape {
        ...
        public init(paginationToken: String? = nil, resourceTypeFilters: [String]? = nil, tagFilters: [TagFilter]? = nil, resourcesPerPage: Int32? = nil, tagsPerPage: Int32? = nil) {
            self.paginationToken = paginationToken
