...
extension ResourceGroupsTaggingAPI {
    ...
    public func getComplianceSummaryPaginator(_ input: GetComplianceSummaryInput) -> Future<[Summary]> {
    ...
    public func getResourcesPaginator(_ input: GetResourcesInput) -> Future<[ResourceTagMapping]> {
    ...
    public func getTagKeysPaginator(_ input: GetTagKeysInput) -> Future<[String]> {
        return client.paginate(input: input, command: getTagKeys, resultKey: "tagKeys", tokenKey: "paginationToken")
    }
    
    ///  Returns all tag values for the specified key in the specified Region for the AWS account.
    public func getTagValuesPaginator(_ input: GetTagValuesInput) -> Future<[String]> {
