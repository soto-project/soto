...
extension ResourceGroupsTaggingAPI {
    ...
    public func getComplianceSummaryPaginator(_ input: GetComplianceSummaryInput, onPage: @escaping ([Summary], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getComplianceSummary, resultKey: \GetComplianceSummaryOutput.summaryList, tokenKey: \GetComplianceSummaryOutput.paginationToken, onPage: onPage)
    }
    ...
    public func getResourcesPaginator(_ input: GetResourcesInput, onPage: @escaping ([ResourceTagMapping], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getResources, resultKey: \GetResourcesOutput.resourceTagMappingList, tokenKey: \GetResourcesOutput.paginationToken, onPage: onPage)
    }
    
    ///  Returns all tag keys in the specified Region for the AWS account.
    public func getTagKeysPaginator(_ input: GetTagKeysInput, onPage: @escaping ([String], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getTagKeys, resultKey: \GetTagKeysOutput.tagKeys, tokenKey: \GetTagKeysOutput.paginationToken, onPage: onPage)
    }
    
    ///  Returns all tag values for the specified key in the specified Region for the AWS account.
    public func getTagValuesPaginator(_ input: GetTagValuesInput, onPage: @escaping ([String], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getTagValues, resultKey: \GetTagValuesOutput.tagValues, tokenKey: \GetTagValuesOutput.paginationToken, onPage: onPage)
    }
