...
extension ResourceGroupsTaggingAPI {
    ...
    public func getComplianceSummaryPaginator(_ input: GetComplianceSummaryInput) -> EventLoopFuture<[Summary]> {
        return client.paginate(input: input, command: getComplianceSummary, resultKey: "summaryList", tokenKey: "paginationToken")
    }
    ...
    public func getResourcesPaginator(_ input: GetResourcesInput) -> EventLoopFuture<[ResourceTagMapping]> {
        return client.paginate(input: input, command: getResources, resultKey: "resourceTagMappingList", tokenKey: "paginationToken")
    }
    
    ///  Returns all tag keys in the specified Region for the AWS account.
    public func getTagKeysPaginator(_ input: GetTagKeysInput) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: getTagKeys, resultKey: "tagKeys", tokenKey: "paginationToken")
    }
    
    ///  Returns all tag values for the specified key in the specified Region for the AWS account.
    public func getTagValuesPaginator(_ input: GetTagValuesInput) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: getTagValues, resultKey: "tagValues", tokenKey: "paginationToken")
    }
