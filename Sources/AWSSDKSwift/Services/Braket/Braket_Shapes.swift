...
extension Braket {
    ...
    public struct CancelQuantumTaskRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "clientToken", required: true, type: .string), 
            AWSShapeMember(label: "quantumTaskArn", location: .uri(locationName: "quantumTaskArn"), required: true, type: .string)
        ]
    ...
    public struct CancelQuantumTaskResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "cancellationStatus", required: true, type: .enum), 
            AWSShapeMember(label: "quantumTaskArn", required: true, type: .string)
        ]
    ...
    public struct CreateQuantumTaskRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "deviceParameters", required: false, type: .string), 
            AWSShapeMember(label: "outputS3Bucket", required: true, type: .string), 
            AWSShapeMember(label: "outputS3KeyPrefix", required: true, type: .string), 
            AWSShapeMember(label: "shots", required: true, type: .long)
        ]
    ...
    public struct CreateQuantumTaskResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "quantumTaskArn", required: true, type: .string)
        ]
    ...
    public struct DeviceSummary: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "deviceStatus", required: true, type: .enum), 
            AWSShapeMember(label: "deviceType", required: true, type: .enum), 
    ...
    public struct GetDeviceRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "deviceArn", location: .uri(locationName: "deviceArn"), required: true, type: .string)
        ]
    ...
    public struct GetDeviceResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "deviceArn", required: true, type: .string), 
            AWSShapeMember(label: "deviceCapabilities", required: true, type: .string), 
            AWSShapeMember(label: "deviceName", required: true, type: .string), 
            AWSShapeMember(label: "deviceStatus", required: true, type: .enum), 
            AWSShapeMember(label: "deviceType", required: true, type: .enum), 
            AWSShapeMember(label: "providerName", required: true, type: .string)
    ...
    public struct GetQuantumTaskRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "quantumTaskArn", location: .uri(locationName: "quantumTaskArn"), required: true, type: .string)
        ]
    ...
    public struct GetQuantumTaskResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "deviceArn", required: true, type: .string), 
            AWSShapeMember(label: "deviceParameters", required: true, type: .string), 
            AWSShapeMember(label: "endedAt", required: false, type: .timestamp), 
            AWSShapeMember(label: "failureReason", required: false, type: .string), 
            AWSShapeMember(label: "outputS3Bucket", required: true, type: .string), 
            AWSShapeMember(label: "outputS3Directory", required: true, type: .string), 
            AWSShapeMember(label: "quantumTaskArn", required: true, type: .string), 
            AWSShapeMember(label: "shots", required: true, type: .long), 
    ...
    public struct SearchDevicesFilter: AWSShape {
        public static var _members: [AWSShapeMember] = [
    ...
    public struct SearchDevicesResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "devices", required: true, type: .list), 
            AWSShapeMember(label: "nextToken", required: false, type: .string)
        ]
    ...
    public struct SearchQuantumTasksFilter: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "name", required: true, type: .string), 
    ...
    public struct SearchQuantumTasksResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "nextToken", required: false, type: .string), 
            AWSShapeMember(label: "quantumTasks", required: true, type: .list)
        ]
