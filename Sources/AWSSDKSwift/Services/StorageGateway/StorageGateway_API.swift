...
public struct StorageGateway {
    ...
    public func describeTapeRecoveryPoints(_ input: DescribeTapeRecoveryPointsInput) throws -> EventLoopFuture<DescribeTapeRecoveryPointsOutput> {
    ...
    public func listVolumeRecoveryPoints(_ input: ListVolumeRecoveryPointsInput) throws -> EventLoopFuture<ListVolumeRecoveryPointsOutput> {
    ...
    public func describeCache(_ input: DescribeCacheInput) throws -> EventLoopFuture<DescribeCacheOutput> {
    ...
    public func notifyWhenUploaded(_ input: NotifyWhenUploadedInput) throws -> EventLoopFuture<NotifyWhenUploadedOutput> {
    ...
    public func addUploadBuffer(_ input: AddUploadBufferInput) throws -> EventLoopFuture<AddUploadBufferOutput> {
    ...
    public func addWorkingStorage(_ input: AddWorkingStorageInput) throws -> EventLoopFuture<AddWorkingStorageOutput> {
        return try client.send(operation: "AddWorkingStorage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels archiving of a virtual tape to the virtual tape shelf (VTS) after the archiving process is initiated. This operation is only supported in the tape gateway type.
    public func cancelArchival(_ input: CancelArchivalInput) throws -> EventLoopFuture<CancelArchivalOutput> {
    ...
    public func listTagsForResource(_ input: ListTagsForResourceInput) throws -> EventLoopFuture<ListTagsForResourceOutput> {
        return try client.send(operation: "ListTagsForResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns your gateway's weekly maintenance start time including the day and time of the week. Note that values are in terms of the gateway's time zone.
    public func describeMaintenanceStartTime(_ input: DescribeMaintenanceStartTimeInput) throws -> EventLoopFuture<DescribeMaintenanceStartTimeOutput> {
    ...
    public func listFileShares(_ input: ListFileSharesInput) throws -> EventLoopFuture<ListFileSharesOutput> {
    ...
    public func describeStorediSCSIVolumes(_ input: DescribeStorediSCSIVolumesInput) throws -> EventLoopFuture<DescribeStorediSCSIVolumesOutput> {
    ...
    public func updateGatewayInformation(_ input: UpdateGatewayInformationInput) throws -> EventLoopFuture<UpdateGatewayInformationOutput> {
    ...
    public func shutdownGateway(_ input: ShutdownGatewayInput) throws -> EventLoopFuture<ShutdownGatewayOutput> {
    ...
    public func listGateways(_ input: ListGatewaysInput) throws -> EventLoopFuture<ListGatewaysOutput> {
    ...
    public func updateBandwidthRateLimit(_ input: UpdateBandwidthRateLimitInput) throws -> EventLoopFuture<UpdateBandwidthRateLimitOutput> {
    ...
    public func deleteBandwidthRateLimit(_ input: DeleteBandwidthRateLimitInput) throws -> EventLoopFuture<DeleteBandwidthRateLimitOutput> {
    ...
    public func addCache(_ input: AddCacheInput) throws -> EventLoopFuture<AddCacheOutput> {
    ...
    public func retrieveTapeRecoveryPoint(_ input: RetrieveTapeRecoveryPointInput) throws -> EventLoopFuture<RetrieveTapeRecoveryPointOutput> {
    ...
    public func describeWorkingStorage(_ input: DescribeWorkingStorageInput) throws -> EventLoopFuture<DescribeWorkingStorageOutput> {
    ...
    public func startGateway(_ input: StartGatewayInput) throws -> EventLoopFuture<StartGatewayOutput> {
    ...
    public func updateSnapshotSchedule(_ input: UpdateSnapshotScheduleInput) throws -> EventLoopFuture<UpdateSnapshotScheduleOutput> {
        return try client.send(operation: "UpdateSnapshotSchedule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified virtual tape. This operation is only supported in the tape gateway type.
    public func deleteTape(_ input: DeleteTapeInput) throws -> EventLoopFuture<DeleteTapeOutput> {
    ...
    public func createTapeWithBarcode(_ input: CreateTapeWithBarcodeInput) throws -> EventLoopFuture<CreateTapeWithBarcodeOutput> {
    ...
    public func retrieveTapeArchive(_ input: RetrieveTapeArchiveInput) throws -> EventLoopFuture<RetrieveTapeArchiveOutput> {
    ...
    public func deleteSnapshotSchedule(_ input: DeleteSnapshotScheduleInput) throws -> EventLoopFuture<DeleteSnapshotScheduleOutput> {
        return try client.send(operation: "DeleteSnapshotSchedule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a file share from a file gateway. This operation is only supported for file gateways.
    public func deleteFileShare(_ input: DeleteFileShareInput) throws -> EventLoopFuture<DeleteFileShareOutput> {
    ...
    public func createStorediSCSIVolume(_ input: CreateStorediSCSIVolumeInput) throws -> EventLoopFuture<CreateStorediSCSIVolumeOutput> {
    ...
    public func listVolumes(_ input: ListVolumesInput) throws -> EventLoopFuture<ListVolumesOutput> {
    ...
    public func createSnapshotFromVolumeRecoveryPoint(_ input: CreateSnapshotFromVolumeRecoveryPointInput) throws -> EventLoopFuture<CreateSnapshotFromVolumeRecoveryPointOutput> {
    ...
    public func describeChapCredentials(_ input: DescribeChapCredentialsInput) throws -> EventLoopFuture<DescribeChapCredentialsOutput> {
    ...
    public func createSMBFileShare(_ input: CreateSMBFileShareInput) throws -> EventLoopFuture<CreateSMBFileShareOutput> {
        return try client.send(operation: "CreateSMBFileShare", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a description for one or more Server Message Block (SMB) file shares from a file gateway. This operation is only supported for file gateways.
    public func describeSMBFileShares(_ input: DescribeSMBFileSharesInput) throws -> EventLoopFuture<DescribeSMBFileSharesOutput> {
        return try client.send(operation: "DescribeSMBFileShares", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a description for one or more Network File System (NFS) file shares from a file gateway. This operation is only supported for file gateways.
    public func describeNFSFileShares(_ input: DescribeNFSFileSharesInput) throws -> EventLoopFuture<DescribeNFSFileSharesOutput> {
    ...
    public func createCachediSCSIVolume(_ input: CreateCachediSCSIVolumeInput) throws -> EventLoopFuture<CreateCachediSCSIVolumeOutput> {
    ...
    public func refreshCache(_ input: RefreshCacheInput) throws -> EventLoopFuture<RefreshCacheOutput> {
    ...
    public func updateVTLDeviceType(_ input: UpdateVTLDeviceTypeInput) throws -> EventLoopFuture<UpdateVTLDeviceTypeOutput> {
        return try client.send(operation: "UpdateVTLDeviceType", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates a gateway's weekly maintenance start time information, including day and time of the week. The maintenance time is the time in your gateway's time zone.
    public func updateMaintenanceStartTime(_ input: UpdateMaintenanceStartTimeInput) throws -> EventLoopFuture<UpdateMaintenanceStartTimeOutput> {
        return try client.send(operation: "UpdateMaintenanceStartTime", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a description of a Server Message Block (SMB) file share settings from a file gateway. This operation is only supported for file gateways.
    public func describeSMBSettings(_ input: DescribeSMBSettingsInput) throws -> EventLoopFuture<DescribeSMBSettingsOutput> {
    ...
    public func listLocalDisks(_ input: ListLocalDisksInput) throws -> EventLoopFuture<ListLocalDisksOutput> {
        return try client.send(operation: "ListLocalDisks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds a file gateway to an Active Directory domain. This operation is only supported for file gateways that support the SMB file protocol.
    public func joinDomain(_ input: JoinDomainInput) throws -> EventLoopFuture<JoinDomainOutput> {
    ...
    public func listTapes(_ input: ListTapesInput) throws -> EventLoopFuture<ListTapesOutput> {
    ...
    public func updateChapCredentials(_ input: UpdateChapCredentialsInput) throws -> EventLoopFuture<UpdateChapCredentialsOutput> {
    ...
    public func cancelRetrieval(_ input: CancelRetrievalInput) throws -> EventLoopFuture<CancelRetrievalOutput> {
    ...
    public func disableGateway(_ input: DisableGatewayInput) throws -> EventLoopFuture<DisableGatewayOutput> {
    ...
    public func describeUploadBuffer(_ input: DescribeUploadBufferInput) throws -> EventLoopFuture<DescribeUploadBufferOutput> {
    ...
    public func deleteVolume(_ input: DeleteVolumeInput) throws -> EventLoopFuture<DeleteVolumeOutput> {
    ...
    public func deleteGateway(_ input: DeleteGatewayInput) throws -> EventLoopFuture<DeleteGatewayOutput> {
    ...
    public func removeTagsFromResource(_ input: RemoveTagsFromResourceInput) throws -> EventLoopFuture<RemoveTagsFromResourceOutput> {
    ...
    public func describeCachediSCSIVolumes(_ input: DescribeCachediSCSIVolumesInput) throws -> EventLoopFuture<DescribeCachediSCSIVolumesOutput> {
    ...
    public func createTapes(_ input: CreateTapesInput) throws -> EventLoopFuture<CreateTapesOutput> {
    ...
    public func updateGatewaySoftwareNow(_ input: UpdateGatewaySoftwareNowInput) throws -> EventLoopFuture<UpdateGatewaySoftwareNowOutput> {
    ...
    public func describeGatewayInformation(_ input: DescribeGatewayInformationInput) throws -> EventLoopFuture<DescribeGatewayInformationOutput> {
    ...
    public func createSnapshot(_ input: CreateSnapshotInput) throws -> EventLoopFuture<CreateSnapshotOutput> {
        return try client.send(operation: "CreateSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified virtual tape from the virtual tape shelf (VTS). This operation is only supported in the tape gateway type.
    public func deleteTapeArchive(_ input: DeleteTapeArchiveInput) throws -> EventLoopFuture<DeleteTapeArchiveOutput> {
    ...
    public func addTagsToResource(_ input: AddTagsToResourceInput) throws -> EventLoopFuture<AddTagsToResourceOutput> {
    ...
    public func updateNFSFileShare(_ input: UpdateNFSFileShareInput) throws -> EventLoopFuture<UpdateNFSFileShareOutput> {
    ...
    public func listVolumeInitiators(_ input: ListVolumeInitiatorsInput) throws -> EventLoopFuture<ListVolumeInitiatorsOutput> {
    ...
    public func setSMBGuestPassword(_ input: SetSMBGuestPasswordInput) throws -> EventLoopFuture<SetSMBGuestPasswordOutput> {
    ...
    public func setLocalConsolePassword(_ input: SetLocalConsolePasswordInput) throws -> EventLoopFuture<SetLocalConsolePasswordOutput> {
    ...
    public func activateGateway(_ input: ActivateGatewayInput) throws -> EventLoopFuture<ActivateGatewayOutput> {
        return try client.send(operation: "ActivateGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes Challenge-Handshake Authentication Protocol (CHAP) credentials for a specified iSCSI target and initiator pair.
    public func deleteChapCredentials(_ input: DeleteChapCredentialsInput) throws -> EventLoopFuture<DeleteChapCredentialsOutput> {
    ...
    public func describeTapeArchives(_ input: DescribeTapeArchivesInput) throws -> EventLoopFuture<DescribeTapeArchivesOutput> {
    ...
    public func createNFSFileShare(_ input: CreateNFSFileShareInput) throws -> EventLoopFuture<CreateNFSFileShareOutput> {
    ...
    public func describeSnapshotSchedule(_ input: DescribeSnapshotScheduleInput) throws -> EventLoopFuture<DescribeSnapshotScheduleOutput> {
    ...
    public func describeTapes(_ input: DescribeTapesInput) throws -> EventLoopFuture<DescribeTapesOutput> {
    ...
    public func describeBandwidthRateLimit(_ input: DescribeBandwidthRateLimitInput) throws -> EventLoopFuture<DescribeBandwidthRateLimitOutput> {
    ...
    public func resetCache(_ input: ResetCacheInput) throws -> EventLoopFuture<ResetCacheOutput> {
    ...
    public func updateSMBFileShare(_ input: UpdateSMBFileShareInput) throws -> EventLoopFuture<UpdateSMBFileShareOutput> {
    ...
    public func describeVTLDevices(_ input: DescribeVTLDevicesInput) throws -> EventLoopFuture<DescribeVTLDevicesOutput> {
