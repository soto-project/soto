...
public struct StorageGateway {
    ...
    public func assignTapePool(_ input: AssignTapePoolInput) throws -> Future<AssignTapePoolOutput> {
        return try client.send(operation: "AssignTapePool", path: "/", httpMethod: "POST", input: input)
    }

    ///  Connects a volume to an iSCSI connection and then attaches the volume to the specified gateway. Detaching and attaching a volume enables you to recover your data from one gateway to a different gateway without creating a snapshot. It also makes it easier to move your volumes from an on-premises gateway to a gateway hosted on an Amazon EC2 instance.
    public func attachVolume(_ input: AttachVolumeInput) throws -> Future<AttachVolumeOutput> {
    ...
    public func detachVolume(_ input: DetachVolumeInput) throws -> Future<DetachVolumeOutput> {
    ...
    public func updateSMBSecurityStrategy(_ input: UpdateSMBSecurityStrategyInput) throws -> Future<UpdateSMBSecurityStrategyOutput> {
        return try client.send(operation: "UpdateSMBSecurityStrategy", path: "/", httpMethod: "POST", input: input)
    }
