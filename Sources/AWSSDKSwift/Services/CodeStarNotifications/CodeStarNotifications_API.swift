...
public struct CodeStarNotifications: AWSService {
    ...
    /// return new `CodeStarNotifications` with new timeout value
    ...
    /// return new `CodeStarNotifications` logging to specified Logger
    ...
    public func createNotificationRule(_ input: CreateNotificationRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateNotificationRuleResult> {
        return client.execute(operation: "CreateNotificationRule", path: "/createNotificationRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteNotificationRule(_ input: DeleteNotificationRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteNotificationRuleResult> {
        return client.execute(operation: "DeleteNotificationRule", path: "/deleteNotificationRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteTarget(_ input: DeleteTargetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTargetResult> {
        return client.execute(operation: "DeleteTarget", path: "/deleteTarget", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeNotificationRule(_ input: DescribeNotificationRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeNotificationRuleResult> {
        return client.execute(operation: "DescribeNotificationRule", path: "/describeNotificationRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listEventTypes(_ input: ListEventTypesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListEventTypesResult> {
        return client.execute(operation: "ListEventTypes", path: "/listEventTypes", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listNotificationRules(_ input: ListNotificationRulesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListNotificationRulesResult> {
        return client.execute(operation: "ListNotificationRules", path: "/listNotificationRules", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listTargets(_ input: ListTargetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTargetsResult> {
        return client.execute(operation: "ListTargets", path: "/listTargets", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func subscribe(_ input: SubscribeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SubscribeResult> {
        return client.execute(operation: "Subscribe", path: "/subscribe", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func unsubscribe(_ input: UnsubscribeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UnsubscribeResult> {
        return client.execute(operation: "Unsubscribe", path: "/unsubscribe", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateNotificationRule(_ input: UpdateNotificationRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateNotificationRuleResult> {
        return client.execute(operation: "UpdateNotificationRule", path: "/updateNotificationRule", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
