...
public struct Lambda {
    ...
    @discardableResult public func deleteFunctionEventInvokeConfig(_ input: DeleteFunctionEventInvokeConfigRequest) -> Future<Void> {
    ...
    @discardableResult public func deleteProvisionedConcurrencyConfig(_ input: DeleteProvisionedConcurrencyConfigRequest) -> Future<Void> {
    ...
    public func getFunctionConcurrency(_ input: GetFunctionConcurrencyRequest) -> Future<GetFunctionConcurrencyResponse> {
    ...
    public func getFunctionEventInvokeConfig(_ input: GetFunctionEventInvokeConfigRequest) -> Future<FunctionEventInvokeConfig> {
    ...
    public func getProvisionedConcurrencyConfig(_ input: GetProvisionedConcurrencyConfigRequest) -> Future<GetProvisionedConcurrencyConfigResponse> {
    ...
    public func listFunctionEventInvokeConfigs(_ input: ListFunctionEventInvokeConfigsRequest) -> Future<ListFunctionEventInvokeConfigsResponse> {
    ...
    public func listProvisionedConcurrencyConfigs(_ input: ListProvisionedConcurrencyConfigsRequest) -> Future<ListProvisionedConcurrencyConfigsResponse> {
    ...
    public func putFunctionEventInvokeConfig(_ input: PutFunctionEventInvokeConfigRequest) -> Future<FunctionEventInvokeConfig> {
    ...
    public func putProvisionedConcurrencyConfig(_ input: PutProvisionedConcurrencyConfigRequest) -> Future<PutProvisionedConcurrencyConfigResponse> {
    ...
    public func updateFunctionEventInvokeConfig(_ input: UpdateFunctionEventInvokeConfigRequest) -> Future<FunctionEventInvokeConfig> {
