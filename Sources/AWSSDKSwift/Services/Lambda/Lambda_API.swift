...
public struct Lambda {
    ...
    public func getLayerVersion(_ input: GetLayerVersionRequest) throws -> GetLayerVersionResponse {
    ...
    public func listLayers(_ input: ListLayersRequest) throws -> ListLayersResponse {
    ...
    public func getLayerVersionPolicy(_ input: GetLayerVersionPolicyRequest) throws -> GetLayerVersionPolicyResponse {
    ...
    public func listLayerVersions(_ input: ListLayerVersionsRequest) throws -> ListLayerVersionsResponse {
    ...
    public func addLayerVersionPermission(_ input: AddLayerVersionPermissionRequest) throws -> AddLayerVersionPermissionResponse {
    ...
    public func publishLayerVersion(_ input: PublishLayerVersionRequest) throws -> PublishLayerVersionResponse {
