...
public struct ECR {
    ...
    public func getAuthorizationToken(_ input: GetAuthorizationTokenRequest) throws -> EventLoopFuture<GetAuthorizationTokenResponse> {
        return try client.send(operation: "GetAuthorizationToken", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates or updates a lifecycle policy. For information about lifecycle policy syntax, see Lifecycle Policy Template.
    public func putLifecyclePolicy(_ input: PutLifecyclePolicyRequest) throws -> EventLoopFuture<PutLifecyclePolicyResponse> {
        return try client.send(operation: "PutLifecyclePolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified lifecycle policy.
    public func deleteLifecyclePolicy(_ input: DeleteLifecyclePolicyRequest) throws -> EventLoopFuture<DeleteLifecyclePolicyResponse> {
        return try client.send(operation: "DeleteLifecyclePolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the repository policy from a specified repository.
    public func deleteRepositoryPolicy(_ input: DeleteRepositoryPolicyRequest) throws -> EventLoopFuture<DeleteRepositoryPolicyResponse> {
        return try client.send(operation: "DeleteRepositoryPolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the results of the specified lifecycle policy preview request.
    public func getLifecyclePolicyPreview(_ input: GetLifecyclePolicyPreviewRequest) throws -> EventLoopFuture<GetLifecyclePolicyPreviewResponse> {
    ...
    public func putImage(_ input: PutImageRequest) throws -> EventLoopFuture<PutImageResponse> {
        return try client.send(operation: "PutImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an existing image repository. If a repository contains images, you must use the force option to delete it.
    public func deleteRepository(_ input: DeleteRepositoryRequest) throws -> EventLoopFuture<DeleteRepositoryResponse> {
        return try client.send(operation: "DeleteRepository", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the repository policy for a specified repository.
    public func getRepositoryPolicy(_ input: GetRepositoryPolicyRequest) throws -> EventLoopFuture<GetRepositoryPolicyResponse> {
        return try client.send(operation: "GetRepositoryPolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the specified lifecycle policy.
    public func getLifecyclePolicy(_ input: GetLifecyclePolicyRequest) throws -> EventLoopFuture<GetLifecyclePolicyResponse> {
    ...
    public func describeImages(_ input: DescribeImagesRequest) throws -> EventLoopFuture<DescribeImagesResponse> {
        return try client.send(operation: "DescribeImages", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes image repositories in a registry.
    public func describeRepositories(_ input: DescribeRepositoriesRequest) throws -> EventLoopFuture<DescribeRepositoriesResponse> {
    ...
    public func completeLayerUpload(_ input: CompleteLayerUploadRequest) throws -> EventLoopFuture<CompleteLayerUploadResponse> {
        return try client.send(operation: "CompleteLayerUpload", path: "/", httpMethod: "POST", input: input)
    }

    ///  Starts a preview of the specified lifecycle policy. This allows you to see the results before creating the lifecycle policy.
    public func startLifecyclePolicyPreview(_ input: StartLifecyclePolicyPreviewRequest) throws -> EventLoopFuture<StartLifecyclePolicyPreviewResponse> {
    ...
    public func listImages(_ input: ListImagesRequest) throws -> EventLoopFuture<ListImagesResponse> {
    ...
    public func batchDeleteImage(_ input: BatchDeleteImageRequest) throws -> EventLoopFuture<BatchDeleteImageResponse> {
        return try client.send(operation: "BatchDeleteImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets detailed information for specified images within a specified repository. Images are specified with either imageTag or imageDigest.
    public func batchGetImage(_ input: BatchGetImageRequest) throws -> EventLoopFuture<BatchGetImageResponse> {
        return try client.send(operation: "BatchGetImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Applies a repository policy on a specified repository to control access permissions.
    public func setRepositoryPolicy(_ input: SetRepositoryPolicyRequest) throws -> EventLoopFuture<SetRepositoryPolicyResponse> {
    ...
    public func initiateLayerUpload(_ input: InitiateLayerUploadRequest) throws -> EventLoopFuture<InitiateLayerUploadResponse> {
    ...
    public func getDownloadUrlForLayer(_ input: GetDownloadUrlForLayerRequest) throws -> EventLoopFuture<GetDownloadUrlForLayerResponse> {
    ...
    public func uploadLayerPart(_ input: UploadLayerPartRequest) throws -> EventLoopFuture<UploadLayerPartResponse> {
        return try client.send(operation: "UploadLayerPart", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates an image repository.
    public func createRepository(_ input: CreateRepositoryRequest) throws -> EventLoopFuture<CreateRepositoryResponse> {
    ...
    public func batchCheckLayerAvailability(_ input: BatchCheckLayerAvailabilityRequest) throws -> EventLoopFuture<BatchCheckLayerAvailabilityResponse> {
