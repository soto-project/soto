...
public struct DynamoDBStreams {
    ...
    public func getShardIterator(_ input: GetShardIteratorInput) throws -> EventLoopFuture<GetShardIteratorOutput> {
    ...
    public func getRecords(_ input: GetRecordsInput) throws -> EventLoopFuture<GetRecordsOutput> {
