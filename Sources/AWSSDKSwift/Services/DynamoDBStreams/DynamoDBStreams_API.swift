...
public struct DynamoDBStreams {
    ...
    public func getRecords(_ input: GetRecordsInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetRecordsOutput> {
    ...
    public func getShardIterator(_ input: GetShardIteratorInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetShardIteratorOutput> {
