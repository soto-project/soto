...
public struct DynamoDBStreams {
    ...
    public func getRecords(_ input: GetRecordsInput) -> Future<GetRecordsOutput> {
    ...
    public func getShardIterator(_ input: GetShardIteratorInput) -> Future<GetShardIteratorOutput> {
