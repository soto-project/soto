...
extension Connect {
    ...
    public struct User: AWSShape {
        ...
        public init(securityProfileIds: [String]? = nil, phoneConfig: UserPhoneConfig? = nil, arn: String? = nil, id: String? = nil, username: String? = nil, hierarchyGroupId: String? = nil, identityInfo: UserIdentityInfo? = nil, routingProfileId: String? = nil, directoryUserId: String? = nil) {
    ...
    public struct HistoricalMetric: AWSShape {
        ...
        public init(unit: Unit? = nil, name: HistoricalMetricName? = nil, threshold: Threshold? = nil, statistic: Statistic? = nil) {
            self.unit = unit
            self.name = name
    ...
    public struct UpdateUserRoutingProfileRequest: AWSShape {
        ...
        public init(routingProfileId: String, instanceId: String, userId: String) {
            self.routingProfileId = routingProfileId
            self.instanceId = instanceId
            self.userId = userId
        }
    ...
    public struct SecurityProfileSummary: AWSShape {
        ...
        public init(id: String? = nil, name: String? = nil, arn: String? = nil) {
            self.id = id
            self.name = name
            self.arn = arn
        }
    ...
    public struct HierarchyGroup: AWSShape {
        ...
        public init(arn: String? = nil, id: String? = nil, name: String? = nil, hierarchyPath: HierarchyPath? = nil, levelId: String? = nil) {
            self.arn = arn
            self.id = id
            self.name = name
    ...
    public struct CreateUserRequest: AWSShape {
        ...
        public init(routingProfileId: String, instanceId: String, identityInfo: UserIdentityInfo? = nil, password: String? = nil, securityProfileIds: [String], username: String, directoryUserId: String? = nil, hierarchyGroupId: String? = nil, phoneConfig: UserPhoneConfig) {
            self.routingProfileId = routingProfileId
            self.instanceId = instanceId
            self.identityInfo = identityInfo
    ...
    public struct StartOutboundVoiceContactRequest: AWSShape {
        ...
        public init(instanceId: String, attributes: [String: String]? = nil, queueId: String? = nil, contactFlowId: String, destinationPhoneNumber: String, clientToken: String? = nil, sourcePhoneNumber: String? = nil) {
            self.instanceId = instanceId
    ...
    public struct HierarchyLevel: AWSShape {
        ...
        public init(name: String? = nil, id: String? = nil, arn: String? = nil) {
            self.name = name
            self.id = id
            self.arn = arn
        }
    ...
    public struct GetCurrentMetricDataRequest: AWSShape {
        ...
        public init(instanceId: String, groupings: [Grouping]? = nil, currentMetrics: [CurrentMetric], filters: Filters, nextToken: String? = nil, maxResults: Int32? = nil) {
            self.instanceId = instanceId
    ...
    public struct HierarchyStructure: AWSShape {
        ...
        public init(levelFive: HierarchyLevel? = nil, levelOne: HierarchyLevel? = nil, levelFour: HierarchyLevel? = nil, levelTwo: HierarchyLevel? = nil, levelThree: HierarchyLevel? = nil) {
    ...
    public struct UserIdentityInfo: AWSShape {
        ...
        public init(firstName: String? = nil, email: String? = nil, lastName: String? = nil) {
    ...
    public struct UpdateUserIdentityInfoRequest: AWSShape {
        ...
        public init(userId: String, instanceId: String, identityInfo: UserIdentityInfo) {
            self.userId = userId
            self.instanceId = instanceId
            self.identityInfo = identityInfo
        }
    ...
    public struct HierarchyPath: AWSShape {
        ...
        public init(levelFive: HierarchyGroupSummary? = nil, levelOne: HierarchyGroupSummary? = nil, levelThree: HierarchyGroupSummary? = nil, levelFour: HierarchyGroupSummary? = nil, levelTwo: HierarchyGroupSummary? = nil) {
            self.levelFive = levelFive
            self.levelOne = levelOne
            self.levelThree = levelThree
            self.levelFour = levelFour
    ...
    public struct Credentials: AWSShape {
        ...
        public init(accessTokenExpiration: TimeStamp? = nil, accessToken: String? = nil, refreshToken: String? = nil, refreshTokenExpiration: TimeStamp? = nil) {
    ...
    public struct GetMetricDataRequest: AWSShape {
        ...
        public init(startTime: TimeStamp, groupings: [Grouping]? = nil, filters: Filters, historicalMetrics: [HistoricalMetric], nextToken: String? = nil, endTime: TimeStamp, instanceId: String, maxResults: Int32? = nil) {
    ...
    public struct UpdateContactAttributesRequest: AWSShape {
        ...
        public init(instanceId: String, attributes: [String: String], initialContactId: String) {
            self.instanceId = instanceId
            self.attributes = attributes
    ...
    public struct UserPhoneConfig: AWSShape {
        ...
        public init(deskPhoneNumber: String? = nil, autoAccept: Bool? = nil, phoneType: PhoneType, afterContactWorkTimeLimit: Int32? = nil) {
    ...
    public struct Threshold: AWSShape {
        ...
        public init(thresholdValue: Double? = nil, comparison: Comparison? = nil) {
