...
public struct Connect {
    ...
    public func updateContactAttributes(_ input: UpdateContactAttributesRequest) throws -> EventLoopFuture<UpdateContactAttributesResponse> {
    ...
    public func describeUserHierarchyStructure(_ input: DescribeUserHierarchyStructureRequest) throws -> EventLoopFuture<DescribeUserHierarchyStructureResponse> {
    ...
    public func startOutboundVoiceContact(_ input: StartOutboundVoiceContactRequest) throws -> EventLoopFuture<StartOutboundVoiceContactResponse> {
    ...
    public func getMetricData(_ input: GetMetricDataRequest) throws -> EventLoopFuture<GetMetricDataResponse> {
    ...
    public func getCurrentMetricData(_ input: GetCurrentMetricDataRequest) throws -> EventLoopFuture<GetCurrentMetricDataResponse> {
    ...
    public func listUserHierarchyGroups(_ input: ListUserHierarchyGroupsRequest) throws -> EventLoopFuture<ListUserHierarchyGroupsResponse> {
    ...
    public func describeUserHierarchyGroup(_ input: DescribeUserHierarchyGroupRequest) throws -> EventLoopFuture<DescribeUserHierarchyGroupResponse> {
    ...
    public func getFederationToken(_ input: GetFederationTokenRequest) throws -> EventLoopFuture<GetFederationTokenResponse> {
    ...
    public func listRoutingProfiles(_ input: ListRoutingProfilesRequest) throws -> EventLoopFuture<ListRoutingProfilesResponse> {
    ...
    public func stopContact(_ input: StopContactRequest) throws -> EventLoopFuture<StopContactResponse> {
