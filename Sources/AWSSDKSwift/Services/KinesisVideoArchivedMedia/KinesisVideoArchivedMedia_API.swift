...
public struct KinesisVideoArchivedMedia {
    ...
    public func getHLSStreamingSessionURL(_ input: GetHLSStreamingSessionURLInput) throws -> EventLoopFuture<GetHLSStreamingSessionURLOutput> {
    ...
    public func listFragments(_ input: ListFragmentsInput) throws -> EventLoopFuture<ListFragmentsOutput> {
    ...
    public func getMediaForFragmentList(_ input: GetMediaForFragmentListInput) throws -> EventLoopFuture<GetMediaForFragmentListOutput> {
