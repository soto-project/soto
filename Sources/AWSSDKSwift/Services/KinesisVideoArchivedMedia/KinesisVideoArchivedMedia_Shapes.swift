...
extension KinesisVideoArchivedMedia {
    ...
    public struct Fragment: AWSShape {
        ...
        public init(fragmentNumber: String? = nil, serverTimestamp: TimeStamp? = nil, producerTimestamp: TimeStamp? = nil, fragmentSizeInBytes: Int64? = nil, fragmentLengthInMilliseconds: Int64? = nil) {
    ...
    public struct GetHLSStreamingSessionURLInput: AWSShape {
        ...
        public init(streamName: String? = nil, discontinuityMode: DiscontinuityMode? = nil, streamARN: String? = nil, playbackMode: PlaybackMode? = nil, maxMediaPlaylistFragmentResults: Int64? = nil, hLSFragmentSelector: HLSFragmentSelector? = nil, expires: Int32? = nil) {
    ...
    public struct ListFragmentsInput: AWSShape {
        ...
        public init(maxResults: Int64? = nil, nextToken: String? = nil, fragmentSelector: FragmentSelector? = nil, streamName: String) {
