...
extension KinesisVideoArchivedMedia {
    ...
    public func listFragmentsPaginator(_ input: ListFragmentsInput) -> EventLoopFuture<[Fragment]> {
        return client.paginate(input: input, command: listFragments, resultKey: \ListFragmentsOutput.fragments, tokenKey: \ListFragmentsOutput.nextToken)
    }
