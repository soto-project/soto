...
extension KinesisVideoArchivedMedia {
    ...
    public func listFragmentsPaginator(_ input: ListFragmentsInput, onPage: @escaping (ListFragmentsOutput, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listFragments, tokenKey: \ListFragmentsOutput.nextToken, onPage: onPage)
    }
