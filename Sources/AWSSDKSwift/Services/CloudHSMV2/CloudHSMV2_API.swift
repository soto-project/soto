...
public struct CloudHSMV2 {
    ...
    public func restoreBackup(_ input: RestoreBackupRequest) throws -> EventLoopFuture<RestoreBackupResponse> {
        return try client.send(operation: "RestoreBackup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Copy an AWS CloudHSM cluster backup to a different region.
    public func copyBackupToRegion(_ input: CopyBackupToRegionRequest) throws -> EventLoopFuture<CopyBackupToRegionResponse> {
    ...
    public func initializeCluster(_ input: InitializeClusterRequest) throws -> EventLoopFuture<InitializeClusterResponse> {
