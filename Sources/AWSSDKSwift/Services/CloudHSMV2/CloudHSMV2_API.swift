...
public struct CloudHSMV2: AWSService {
    ...
    /// return new `CloudHSMV2` with new timeout value
    ...
    /// return new `CloudHSMV2` logging to specified Logger
    ...
    public func copyBackupToRegion(_ input: CopyBackupToRegionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CopyBackupToRegionResponse> {
        return client.execute(operation: "CopyBackupToRegion", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteCluster(_ input: DeleteClusterRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteClusterResponse> {
        return client.execute(operation: "DeleteCluster", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeClusters(_ input: DescribeClustersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeClustersResponse> {
        return client.execute(operation: "DescribeClusters", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func initializeCluster(_ input: InitializeClusterRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InitializeClusterResponse> {
        return client.execute(operation: "InitializeCluster", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func restoreBackup(_ input: RestoreBackupRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreBackupResponse> {
        return client.execute(operation: "RestoreBackup", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
