...
extension CloudHSMV2 {
    ...
    public func describeBackupsPaginator(_ input: DescribeBackupsRequest, onPage: @escaping ([Backup], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeBackups, resultKey: \DescribeBackupsResponse.backups, tokenKey: \DescribeBackupsResponse.nextToken, onPage: onPage)
    }
    
    ///  Gets information about AWS CloudHSM clusters. This is a paginated operation, which means that each response might contain only a subset of all the clusters. When the response contains only a subset of clusters, it includes a NextToken value. Use this value in a subsequent DescribeClusters request to get more clusters. When you receive a response with no NextToken (or an empty or null value), that means there are no more clusters to get.
    public func describeClustersPaginator(_ input: DescribeClustersRequest, onPage: @escaping ([Cluster], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeClusters, resultKey: \DescribeClustersResponse.clusters, tokenKey: \DescribeClustersResponse.nextToken, onPage: onPage)
    }
    ...
    public func listTagsPaginator(_ input: ListTagsRequest, onPage: @escaping ([Tag], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listTags, resultKey: \ListTagsResponse.tagList, tokenKey: \ListTagsResponse.nextToken, onPage: onPage)
    }
