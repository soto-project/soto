...
extension CloudHSMV2 {
    ...
    public func describeBackupsPaginator(_ input: DescribeBackupsRequest) -> EventLoopFuture<[Backup]> {
        return client.paginate(input: input, command: describeBackups, resultKey: \DescribeBackupsResponse.backups, tokenKey: \DescribeBackupsResponse.nextToken)
    }
    ...
    public func describeClustersPaginator(_ input: DescribeClustersRequest) -> EventLoopFuture<[Cluster]> {
        return client.paginate(input: input, command: describeClusters, resultKey: \DescribeClustersResponse.clusters, tokenKey: \DescribeClustersResponse.nextToken)
    }
    ...
    public func listTagsPaginator(_ input: ListTagsRequest) -> EventLoopFuture<[Tag]> {
        return client.paginate(input: input, command: listTags, resultKey: \ListTagsResponse.tagList, tokenKey: \ListTagsResponse.nextToken)
    }
