...
public struct Synthetics: AWSService {
    ...
    public func createCanary(_ input: CreateCanaryRequest) -> EventLoopFuture<CreateCanaryResponse> {
        return client.execute(operation: "CreateCanary", path: "/canary", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteCanary(_ input: DeleteCanaryRequest) -> EventLoopFuture<DeleteCanaryResponse> {
        return client.execute(operation: "DeleteCanary", path: "/canary/{name}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeCanaries(_ input: DescribeCanariesRequest) -> EventLoopFuture<DescribeCanariesResponse> {
        return client.execute(operation: "DescribeCanaries", path: "/canaries", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Use this operation to see information from the most recent run of each canary that you have created.
    public func describeCanariesLastRun(_ input: DescribeCanariesLastRunRequest) -> EventLoopFuture<DescribeCanariesLastRunResponse> {
        return client.execute(operation: "DescribeCanariesLastRun", path: "/canaries/last-run", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns a list of Synthetics canary runtime versions. For more information, see  Canary Runtime Versions.
    public func describeRuntimeVersions(_ input: DescribeRuntimeVersionsRequest) -> EventLoopFuture<DescribeRuntimeVersionsResponse> {
        return client.execute(operation: "DescribeRuntimeVersions", path: "/runtime-versions", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves complete information about one canary. You must specify the name of the canary that you want. To get a list of canaries and their names, use DescribeCanaries.
    public func getCanary(_ input: GetCanaryRequest) -> EventLoopFuture<GetCanaryResponse> {
        return client.execute(operation: "GetCanary", path: "/canary/{name}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves a list of runs for a specified canary.
    public func getCanaryRuns(_ input: GetCanaryRunsRequest) -> EventLoopFuture<GetCanaryRunsResponse> {
        return client.execute(operation: "GetCanaryRuns", path: "/canary/{name}/runs", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startCanary(_ input: StartCanaryRequest) -> EventLoopFuture<StartCanaryResponse> {
        return client.execute(operation: "StartCanary", path: "/canary/{name}/start", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func stopCanary(_ input: StopCanaryRequest) -> EventLoopFuture<StopCanaryResponse> {
        return client.execute(operation: "StopCanary", path: "/canary/{name}/stop", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateCanary(_ input: UpdateCanaryRequest) -> EventLoopFuture<UpdateCanaryResponse> {
        return client.execute(operation: "UpdateCanary", path: "/canary/{name}", httpMethod: .PATCH, input: input, config: self.config, context: self.context)
    }
}
