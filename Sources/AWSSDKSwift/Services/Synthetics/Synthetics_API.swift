...
public struct Synthetics {
    ...
    public func createCanary(_ input: CreateCanaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCanaryResponse> {
        return client.execute(operation: "CreateCanary", path: "/canary", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteCanary(_ input: DeleteCanaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCanaryResponse> {
        return client.execute(operation: "DeleteCanary", path: "/canary/{name}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeCanaries(_ input: DescribeCanariesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCanariesResponse> {
        return client.execute(operation: "DescribeCanaries", path: "/canaries", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeCanariesLastRun(_ input: DescribeCanariesLastRunRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCanariesLastRunResponse> {
        return client.execute(operation: "DescribeCanariesLastRun", path: "/canaries/last-run", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeRuntimeVersions(_ input: DescribeRuntimeVersionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRuntimeVersionsResponse> {
        return client.execute(operation: "DescribeRuntimeVersions", path: "/runtime-versions", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getCanary(_ input: GetCanaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCanaryResponse> {
        return client.execute(operation: "GetCanary", path: "/canary/{name}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getCanaryRuns(_ input: GetCanaryRunsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCanaryRunsResponse> {
        return client.execute(operation: "GetCanaryRuns", path: "/canary/{name}/runs", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startCanary(_ input: StartCanaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartCanaryResponse> {
        return client.execute(operation: "StartCanary", path: "/canary/{name}/start", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func stopCanary(_ input: StopCanaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopCanaryResponse> {
        return client.execute(operation: "StopCanary", path: "/canary/{name}/stop", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateCanary(_ input: UpdateCanaryRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateCanaryResponse> {
        return client.execute(operation: "UpdateCanary", path: "/canary/{name}", httpMethod: "PATCH", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
