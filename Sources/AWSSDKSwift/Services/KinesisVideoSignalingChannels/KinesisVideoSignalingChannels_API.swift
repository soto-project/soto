...
public struct KinesisVideoSignalingChannels {
    ...
    public func getIceServerConfig(_ input: GetIceServerConfigRequest) -> Future<GetIceServerConfigResponse> {
    ...
    public func sendAlexaOfferToMaster(_ input: SendAlexaOfferToMasterRequest) -> Future<SendAlexaOfferToMasterResponse> {
