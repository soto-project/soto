...
public struct KinesisVideoSignalingChannels {
    ...
    public func getIceServerConfig(_ input: GetIceServerConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetIceServerConfigResponse> {
        return client.execute(operation: "GetIceServerConfig", path: "/v1/get-ice-server-config", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func sendAlexaOfferToMaster(_ input: SendAlexaOfferToMasterRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendAlexaOfferToMasterResponse> {
        return client.execute(operation: "SendAlexaOfferToMaster", path: "/v1/send-alexa-offer-to-master", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
