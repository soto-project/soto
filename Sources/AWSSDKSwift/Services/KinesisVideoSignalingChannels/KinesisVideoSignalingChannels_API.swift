...
public struct KinesisVideoSignalingChannels: AWSService {
    ...
    public func getIceServerConfig(_ input: GetIceServerConfigRequest) -> EventLoopFuture<GetIceServerConfigResponse> {
        return client.execute(operation: "GetIceServerConfig", path: "/v1/get-ice-server-config", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func sendAlexaOfferToMaster(_ input: SendAlexaOfferToMasterRequest) -> EventLoopFuture<SendAlexaOfferToMasterResponse> {
        return client.execute(operation: "SendAlexaOfferToMaster", path: "/v1/send-alexa-offer-to-master", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
