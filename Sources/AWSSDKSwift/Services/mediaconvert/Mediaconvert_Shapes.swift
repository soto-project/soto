...
extension Mediaconvert {
    ...
    public struct RemixSettings: AWSShape {
        ...
        public init(channelsOut: Int32, channelMapping: ChannelMapping, channelsIn: Int32) {
    ...
    public struct HlsEncryptionSettings: AWSShape {
        ...
        public init(initializationVectorInManifest: HlsInitializationVectorInManifest? = nil, staticKeyProvider: StaticKeyProvider? = nil, constantInitializationVector: String? = nil, encryptionMethod: HlsEncryptionType? = nil, spekeKeyProvider: SpekeKeyProvider? = nil, type: HlsKeyProviderType) {
    ...
    public struct CreateQueueRequest: AWSShape {
        ...
        public init(tags: [String: String]? = nil, name: String, description: String? = nil) {
            self.tags = tags
            self.name = name
    ...
    public struct DashIsoGroupSettings: AWSShape {
        ...
        public init(destination: String? = nil, fragmentLength: Int32, minBufferTime: Int32? = nil, hbbtvCompliance: DashIsoHbbtvCompliance? = nil, encryption: DashIsoEncryptionSettings? = nil, baseUrl: String? = nil, segmentControl: DashIsoSegmentControl? = nil, segmentLength: Int32) {
    ...
    public struct InsertableImage: AWSShape {
        ...
        public init(height: Int32? = nil, startTime: String? = nil, imageX: Int32, imageY: Int32, opacity: Int32, fadeIn: Int32? = nil, fadeOut: Int32? = nil, imageInserterInput: String, duration: Int32? = nil, layer: Int32, width: Int32? = nil) {
            self.height = height
    ...
    public struct CreateJobRequest: AWSShape {
        ...
        public init(role: String, settings: JobSettings, clientRequestToken: String? = nil, jobTemplate: String? = nil, queue: String? = nil, userMetadata: [String: String]? = nil) {
            self.role = role
    ...
    public struct Rectangle: AWSShape {
        ...
        public init(x: Int32, height: Int32, width: Int32, y: Int32) {
            self.x = x
            self.height = height
            self.width = width
            self.y = y
    ...
    public struct CaptionSourceSettings: AWSShape {
        ...
        public init(fileSourceSettings: FileSourceSettings? = nil, dvbSubSourceSettings: DvbSubSourceSettings? = nil, ancillarySourceSettings: AncillarySourceSettings? = nil, teletextSourceSettings: TeletextSourceSettings? = nil, sourceType: CaptionSourceType, embeddedSourceSettings: EmbeddedSourceSettings? = nil) {
    ...
    public struct NoiseReducer: AWSShape {
        ...
        public init(filterSettings: NoiseReducerFilterSettings? = nil, spatialFilterSettings: NoiseReducerSpatialFilterSettings? = nil, filter: NoiseReducerFilter) {
    ...
    public struct AudioSelector: AWSShape {
        ...
        public init(selectorType: AudioSelectorType? = nil, tracks: [Int32]? = nil, externalAudioFileInput: String? = nil, languageCode: LanguageCode? = nil, programSelection: Int32? = nil, offset: Int32? = nil, customLanguageCode: String? = nil, pids: [Int32]? = nil, remixSettings: RemixSettings? = nil, defaultSelection: AudioDefaultSelection? = nil) {
    ...
    public struct Preset: AWSShape {
        ...
        public init(createdAt: TimeStamp? = nil, arn: String? = nil, name: String, category: String? = nil, lastUpdated: TimeStamp? = nil, settings: PresetSettings, type: `Type`? = nil, description: String? = nil) {
    ...
    public struct TimecodeConfig: AWSShape {
        ...
        public init(anchor: String? = nil, start: String? = nil, source: TimecodeSource? = nil, timestampOffset: String? = nil) {
            self.anchor = anchor
            self.start = start
            self.source = source
    ...
    public struct Hdr10Metadata: AWSShape {
        ...
        public init(bluePrimaryX: Int32? = nil, whitePointX: Int32? = nil, whitePointY: Int32? = nil, redPrimaryY: Int32? = nil, greenPrimaryY: Int32? = nil, maxLuminance: Int32? = nil, maxFrameAverageLightLevel: Int32, redPrimaryX: Int32? = nil, minLuminance: Int32? = nil, maxContentLightLevel: Int32, bluePrimaryY: Int32? = nil, greenPrimaryX: Int32? = nil) {
    ...
    public struct CreateJobTemplateRequest: AWSShape {
        ...
        public init(category: String? = nil, description: String? = nil, settings: JobTemplateSettings, tags: [String: String]? = nil, name: String, queue: String? = nil) {
            self.category = category
            self.description = description
            self.settings = settings
            self.tags = tags
    ...
    public struct OutputGroupSettings: AWSShape {
        ...
        public init(fileGroupSettings: FileGroupSettings? = nil, msSmoothGroupSettings: MsSmoothGroupSettings? = nil, cmafGroupSettings: CmafGroupSettings? = nil, type: OutputGroupType, hlsGroupSettings: HlsGroupSettings? = nil, dashIsoGroupSettings: DashIsoGroupSettings? = nil) {
    ...
    public struct CmafEncryptionSettings: AWSShape {
        ...
        public init(initializationVectorInManifest: CmafInitializationVectorInManifest? = nil, staticKeyProvider: StaticKeyProvider? = nil, constantInitializationVector: String? = nil, encryptionMethod: CmafEncryptionType? = nil, type: CmafKeyProviderType) {
            self.initializationVectorInManifest = initializationVectorInManifest
            self.staticKeyProvider = staticKeyProvider
            self.constantInitializationVector = constantInitializationVector
            self.encryptionMethod = encryptionMethod
    ...
    public struct FileSourceSettings: AWSShape {
        ...
        public init(sourceFile: String, timeDelta: Int32? = nil, convert608To708: FileSourceConvert608To708? = nil) {
    ...
    public struct HlsGroupSettings: AWSShape {
        ...
        public init(outputSelection: HlsOutputSelection? = nil, destination: String? = nil, streamInfResolution: HlsStreamInfResolution? = nil, manifestCompression: HlsManifestCompression? = nil, directoryStructure: HlsDirectoryStructure? = nil, adMarkers: [HlsAdMarkers]? = nil, baseUrl: String? = nil, clientCache: HlsClientCache? = nil, segmentControl: HlsSegmentControl? = nil, programDateTimePeriod: Int32? = nil, timestampDeltaMilliseconds: Int32? = nil, captionLanguageSetting: HlsCaptionLanguageSetting? = nil, encryption: HlsEncryptionSettings? = nil, manifestDurationFormat: HlsManifestDurationFormat? = nil, captionLanguageMappings: [HlsCaptionLanguageMapping]? = nil, timedMetadataId3Period: Int32? = nil, programDateTime: HlsProgramDateTime? = nil, codecSpecification: HlsCodecSpecification? = nil, segmentsPerSubdirectory: Int32? = nil, timedMetadataId3Frame: HlsTimedMetadataId3Frame? = nil, minSegmentLength: Int32, segmentLength: Int32) {
    ...
    public struct AudioDescription: AWSShape {
        ...
        public init(audioNormalizationSettings: AudioNormalizationSettings? = nil, languageCode: LanguageCode? = nil, languageCodeControl: AudioLanguageCodeControl? = nil, customLanguageCode: String? = nil, audioType: Int32? = nil, audioTypeControl: AudioTypeControl? = nil, streamName: String? = nil, remixSettings: RemixSettings? = nil, audioSourceName: String? = nil, codecSettings: AudioCodecSettings) {
    ...
    public struct OutputGroup: AWSShape {
        ...
        public init(customName: String? = nil, outputGroupSettings: OutputGroupSettings, outputs: [Output], name: String? = nil) {
    ...
    public struct VideoCodecSettings: AWSShape {
        ...
        public init(h264Settings: H264Settings? = nil, proresSettings: ProresSettings? = nil, h265Settings: H265Settings? = nil, codec: VideoCodec, frameCaptureSettings: FrameCaptureSettings? = nil, mpeg2Settings: Mpeg2Settings? = nil) {
    ...
    public struct CaptionSelector: AWSShape {
        ...
        public init(languageCode: LanguageCode? = nil, sourceSettings: CaptionSourceSettings, customLanguageCode: String? = nil) {
            self.languageCode = languageCode
    ...
    public struct MsSmoothGroupSettings: AWSShape {
        ...
        public init(destination: String? = nil, fragmentLength: Int32, encryption: MsSmoothEncryptionSettings? = nil, manifestEncoding: MsSmoothManifestEncoding? = nil, audioDeduplication: MsSmoothAudioDeduplication? = nil) {
            self.destination = destination
            self.fragmentLength = fragmentLength
            self.encryption = encryption
    ...
    public struct CaptionDestinationSettings: AWSShape {
        ...
        public init(burninDestinationSettings: BurninDestinationSettings? = nil, teletextDestinationSettings: TeletextDestinationSettings? = nil, destinationType: CaptionDestinationType, dvbSubDestinationSettings: DvbSubDestinationSettings? = nil, sccDestinationSettings: SccDestinationSettings? = nil, ttmlDestinationSettings: TtmlDestinationSettings? = nil) {
    ...
    public struct HlsCaptionLanguageMapping: AWSShape {
        ...
        public init(customLanguageCode: String? = nil, languageDescription: String? = nil, languageCode: LanguageCode? = nil, captionChannel: Int32? = nil) {
            self.customLanguageCode = customLanguageCode
    ...
    public struct DvbNitSettings: AWSShape {
        ...
        public init(nitInterval: Int32, networkId: Int32, networkName: String) {
    ...
    public struct JobTemplateSettings: AWSShape {
        ...
        public init(timedMetadataInsertion: TimedMetadataInsertion? = nil, outputGroups: [OutputGroup], nielsenConfiguration: NielsenConfiguration? = nil, inputs: [InputTemplate]? = nil, adAvailOffset: Int32? = nil, availBlanking: AvailBlanking? = nil, timecodeConfig: TimecodeConfig? = nil) {
    ...
    public struct ContainerSettings: AWSShape {
        ...
        public init(m2tsSettings: M2tsSettings? = nil, movSettings: MovSettings? = nil, mp4Settings: Mp4Settings? = nil, f4vSettings: F4vSettings? = nil, container: ContainerType, m3u8Settings: M3u8Settings? = nil) {
    ...
    public struct SpekeKeyProvider: AWSShape {
        ...
        public init(resourceId: String, url: String, systemIds: [String]) {
    ...
    public struct CaptionDescriptionPreset: AWSShape {
        ...
        public init(customLanguageCode: String? = nil, languageDescription: String? = nil, languageCode: LanguageCode? = nil, destinationSettings: CaptionDestinationSettings) {
            self.customLanguageCode = customLanguageCode
            self.languageDescription = languageDescription
            self.languageCode = languageCode
    ...
    public struct CreatePresetRequest: AWSShape {
        ...
        public init(category: String? = nil, settings: PresetSettings, name: String, tags: [String: String]? = nil, description: String? = nil) {
            self.category = category
            self.settings = settings
            self.name = name
            self.tags = tags
    ...
    public struct JobSettings: AWSShape {
        ...
        public init(timedMetadataInsertion: TimedMetadataInsertion? = nil, outputGroups: [OutputGroup], nielsenConfiguration: NielsenConfiguration? = nil, inputs: [Input], adAvailOffset: Int32? = nil, availBlanking: AvailBlanking? = nil, timecodeConfig: TimecodeConfig? = nil) {
            self.timedMetadataInsertion = timedMetadataInsertion
            self.outputGroups = outputGroups
            self.nielsenConfiguration = nielsenConfiguration
            self.inputs = inputs
    ...
    public struct CaptionDescription: AWSShape {
        ...
        public init(captionSelectorName: String, languageDescription: String? = nil, customLanguageCode: String? = nil, languageCode: LanguageCode? = nil, destinationSettings: CaptionDestinationSettings) {
    ...
    public struct JobTemplate: AWSShape {
        ...
        public init(createdAt: TimeStamp? = nil, arn: String? = nil, name: String, category: String? = nil, lastUpdated: TimeStamp? = nil, settings: JobTemplateSettings, type: `Type`? = nil, queue: String? = nil, description: String? = nil) {
            self.createdAt = createdAt
            self.arn = arn
            self.name = name
            self.category = category
    ...
    public struct StaticKeyProvider: AWSShape {
        ...
        public init(staticKeyValue: String, keyFormatVersions: String? = nil, keyFormat: String? = nil, url: String) {
    ...
    public struct AudioCodecSettings: AWSShape {
        ...
        public init(eac3Settings: Eac3Settings? = nil, aiffSettings: AiffSettings? = nil, codec: AudioCodec, ac3Settings: Ac3Settings? = nil, wavSettings: WavSettings? = nil, mp2Settings: Mp2Settings? = nil, aacSettings: AacSettings? = nil) {
    ...
    public struct Queue: AWSShape {
        ...
        public init(status: QueueStatus? = nil, createdAt: TimeStamp? = nil, arn: String? = nil, name: String, submittedJobsCount: Int32? = nil, progressingJobsCount: Int32? = nil, lastUpdated: TimeStamp? = nil, type: `Type`? = nil, description: String? = nil) {
            self.status = status
            self.createdAt = createdAt
            self.arn = arn
            self.name = name
    ...
    public struct Job: AWSShape {
        ...
        public init(userMetadata: [String: String]? = nil, arn: String? = nil, outputGroupDetails: [OutputGroupDetail]? = nil, settings: JobSettings, errorMessage: String? = nil, jobTemplate: String? = nil, errorCode: Int32? = nil, id: String? = nil, status: JobStatus? = nil, createdAt: TimeStamp? = nil, role: String, queue: String? = nil, timing: Timing? = nil) {
            self.userMetadata = userMetadata
            self.arn = arn
