...
public struct PersonalizeRuntime: AWSService {
    ...
    /// return new `PersonalizeRuntime` with new timeout value
    ...
    /// return new `PersonalizeRuntime` logging to specified Logger
    ...
    public func getPersonalizedRanking(_ input: GetPersonalizedRankingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPersonalizedRankingResponse> {
        return client.execute(operation: "GetPersonalizedRanking", path: "/personalize-ranking", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getRecommendations(_ input: GetRecommendationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRecommendationsResponse> {
        return client.execute(operation: "GetRecommendations", path: "/recommendations", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
