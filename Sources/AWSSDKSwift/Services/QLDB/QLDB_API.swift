...
public struct QLDB {
    ...
    public func cancelJournalKinesisStream(_ input: CancelJournalKinesisStreamRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CancelJournalKinesisStreamResponse> {
        return client.execute(operation: "CancelJournalKinesisStream", path: "/ledgers/{name}/journal-kinesis-streams/{streamId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createLedger(_ input: CreateLedgerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateLedgerResponse> {
        return client.execute(operation: "CreateLedger", path: "/ledgers", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteLedger(_ input: DeleteLedgerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteLedger", path: "/ledgers/{name}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeJournalKinesisStream(_ input: DescribeJournalKinesisStreamRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeJournalKinesisStreamResponse> {
        return client.execute(operation: "DescribeJournalKinesisStream", path: "/ledgers/{name}/journal-kinesis-streams/{streamId}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeJournalS3Export(_ input: DescribeJournalS3ExportRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeJournalS3ExportResponse> {
        return client.execute(operation: "DescribeJournalS3Export", path: "/ledgers/{name}/journal-s3-exports/{exportId}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func describeLedger(_ input: DescribeLedgerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeLedgerResponse> {
        return client.execute(operation: "DescribeLedger", path: "/ledgers/{name}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getDigest(_ input: GetDigestRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDigestResponse> {
        return client.execute(operation: "GetDigest", path: "/ledgers/{name}/digest", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getRevision(_ input: GetRevisionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRevisionResponse> {
        return client.execute(operation: "GetRevision", path: "/ledgers/{name}/revision", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listJournalKinesisStreamsForLedger(_ input: ListJournalKinesisStreamsForLedgerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJournalKinesisStreamsForLedgerResponse> {
        return client.execute(operation: "ListJournalKinesisStreamsForLedger", path: "/ledgers/{name}/journal-kinesis-streams", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listJournalS3Exports(_ input: ListJournalS3ExportsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJournalS3ExportsResponse> {
        return client.execute(operation: "ListJournalS3Exports", path: "/journal-s3-exports", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listJournalS3ExportsForLedger(_ input: ListJournalS3ExportsForLedgerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJournalS3ExportsForLedgerResponse> {
        return client.execute(operation: "ListJournalS3ExportsForLedger", path: "/ledgers/{name}/journal-s3-exports", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listLedgers(_ input: ListLedgersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListLedgersResponse> {
        return client.execute(operation: "ListLedgers", path: "/ledgers", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateLedger(_ input: UpdateLedgerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateLedgerResponse> {
        return client.execute(operation: "UpdateLedger", path: "/ledgers/{name}", httpMethod: .PATCH, serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
