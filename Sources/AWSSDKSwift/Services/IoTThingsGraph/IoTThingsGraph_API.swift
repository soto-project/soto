...
public struct IoTThingsGraph: AWSService {
    ...
    public func associateEntityToThing(_ input: AssociateEntityToThingRequest) -> EventLoopFuture<AssociateEntityToThingResponse> {
        return client.execute(operation: "AssociateEntityToThing", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createFlowTemplate(_ input: CreateFlowTemplateRequest) -> EventLoopFuture<CreateFlowTemplateResponse> {
        return client.execute(operation: "CreateFlowTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createSystemInstance(_ input: CreateSystemInstanceRequest) -> EventLoopFuture<CreateSystemInstanceResponse> {
        return client.execute(operation: "CreateSystemInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createSystemTemplate(_ input: CreateSystemTemplateRequest) -> EventLoopFuture<CreateSystemTemplateResponse> {
        return client.execute(operation: "CreateSystemTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteFlowTemplate(_ input: DeleteFlowTemplateRequest) -> EventLoopFuture<DeleteFlowTemplateResponse> {
        return client.execute(operation: "DeleteFlowTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteSystemInstance(_ input: DeleteSystemInstanceRequest) -> EventLoopFuture<DeleteSystemInstanceResponse> {
        return client.execute(operation: "DeleteSystemInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteSystemTemplate(_ input: DeleteSystemTemplateRequest) -> EventLoopFuture<DeleteSystemTemplateResponse> {
        return client.execute(operation: "DeleteSystemTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deploySystemInstance(_ input: DeploySystemInstanceRequest) -> EventLoopFuture<DeploySystemInstanceResponse> {
        return client.execute(operation: "DeploySystemInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deprecateFlowTemplate(_ input: DeprecateFlowTemplateRequest) -> EventLoopFuture<DeprecateFlowTemplateResponse> {
        return client.execute(operation: "DeprecateFlowTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deprecateSystemTemplate(_ input: DeprecateSystemTemplateRequest) -> EventLoopFuture<DeprecateSystemTemplateResponse> {
        return client.execute(operation: "DeprecateSystemTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeNamespace(_ input: DescribeNamespaceRequest) -> EventLoopFuture<DescribeNamespaceResponse> {
        return client.execute(operation: "DescribeNamespace", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func dissociateEntityFromThing(_ input: DissociateEntityFromThingRequest) -> EventLoopFuture<DissociateEntityFromThingResponse> {
        return client.execute(operation: "DissociateEntityFromThing", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getEntities(_ input: GetEntitiesRequest) -> EventLoopFuture<GetEntitiesResponse> {
        return client.execute(operation: "GetEntities", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets the latest version of the DefinitionDocument and FlowTemplateSummary for the specified workflow.
    public func getFlowTemplate(_ input: GetFlowTemplateRequest) -> EventLoopFuture<GetFlowTemplateResponse> {
        return client.execute(operation: "GetFlowTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getFlowTemplateRevisions(_ input: GetFlowTemplateRevisionsRequest) -> EventLoopFuture<GetFlowTemplateRevisionsResponse> {
        return client.execute(operation: "GetFlowTemplateRevisions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getNamespaceDeletionStatus(_ input: GetNamespaceDeletionStatusRequest) -> EventLoopFuture<GetNamespaceDeletionStatusResponse> {
        return client.execute(operation: "GetNamespaceDeletionStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets a system instance.
    public func getSystemInstance(_ input: GetSystemInstanceRequest) -> EventLoopFuture<GetSystemInstanceResponse> {
        return client.execute(operation: "GetSystemInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets a system.
    public func getSystemTemplate(_ input: GetSystemTemplateRequest) -> EventLoopFuture<GetSystemTemplateResponse> {
        return client.execute(operation: "GetSystemTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getSystemTemplateRevisions(_ input: GetSystemTemplateRevisionsRequest) -> EventLoopFuture<GetSystemTemplateRevisionsResponse> {
        return client.execute(operation: "GetSystemTemplateRevisions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Gets the status of the specified upload.
    public func getUploadStatus(_ input: GetUploadStatusRequest) -> EventLoopFuture<GetUploadStatusResponse> {
        return client.execute(operation: "GetUploadStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listFlowExecutionMessages(_ input: ListFlowExecutionMessagesRequest) -> EventLoopFuture<ListFlowExecutionMessagesResponse> {
        return client.execute(operation: "ListFlowExecutionMessages", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func searchEntities(_ input: SearchEntitiesRequest) -> EventLoopFuture<SearchEntitiesResponse> {
        return client.execute(operation: "SearchEntities", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func searchFlowExecutions(_ input: SearchFlowExecutionsRequest) -> EventLoopFuture<SearchFlowExecutionsResponse> {
        return client.execute(operation: "SearchFlowExecutions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Searches for summary information about workflows.
    public func searchFlowTemplates(_ input: SearchFlowTemplatesRequest) -> EventLoopFuture<SearchFlowTemplatesResponse> {
        return client.execute(operation: "SearchFlowTemplates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func searchSystemInstances(_ input: SearchSystemInstancesRequest) -> EventLoopFuture<SearchSystemInstancesResponse> {
        return client.execute(operation: "SearchSystemInstances", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func searchSystemTemplates(_ input: SearchSystemTemplatesRequest) -> EventLoopFuture<SearchSystemTemplatesResponse> {
        return client.execute(operation: "SearchSystemTemplates", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func searchThings(_ input: SearchThingsRequest) -> EventLoopFuture<SearchThingsResponse> {
        return client.execute(operation: "SearchThings", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func undeploySystemInstance(_ input: UndeploySystemInstanceRequest) -> EventLoopFuture<UndeploySystemInstanceResponse> {
        return client.execute(operation: "UndeploySystemInstance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateFlowTemplate(_ input: UpdateFlowTemplateRequest) -> EventLoopFuture<UpdateFlowTemplateResponse> {
        return client.execute(operation: "UpdateFlowTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateSystemTemplate(_ input: UpdateSystemTemplateRequest) -> EventLoopFuture<UpdateSystemTemplateResponse> {
        return client.execute(operation: "UpdateSystemTemplate", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func uploadEntityDefinitions(_ input: UploadEntityDefinitionsRequest) -> EventLoopFuture<UploadEntityDefinitionsResponse> {
        return client.execute(operation: "UploadEntityDefinitions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
