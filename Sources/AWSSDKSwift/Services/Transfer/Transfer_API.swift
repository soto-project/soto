...
public struct Transfer {
    ...
    public func importSshPublicKey(_ input: ImportSshPublicKeyRequest) throws -> EventLoopFuture<ImportSshPublicKeyResponse> {
        return try client.send(operation: "ImportSshPublicKey", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the Secure File Transfer Protocol (SFTP) servers that are associated with your AWS account.
    public func listServers(_ input: ListServersRequest) throws -> EventLoopFuture<ListServersResponse> {
    ...
    public func createServer(_ input: CreateServerRequest) throws -> EventLoopFuture<CreateServerResponse> {
    ...
    public func updateServer(_ input: UpdateServerRequest) throws -> EventLoopFuture<UpdateServerResponse> {
    ...
    public func testIdentityProvider(_ input: TestIdentityProviderRequest) throws -> EventLoopFuture<TestIdentityProviderResponse> {
    ...
    public func describeServer(_ input: DescribeServerRequest) throws -> EventLoopFuture<DescribeServerResponse> {
