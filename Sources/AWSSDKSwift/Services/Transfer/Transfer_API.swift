...
public struct Transfer: AWSService {
    ...
    /// return new `Transfer` with new timeout value
    ...
    /// return new `Transfer` logging to specified Logger
    ...
    public func createServer(_ input: CreateServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateServerResponse> {
        return client.execute(operation: "CreateServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteServer(_ input: DeleteServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeServer(_ input: DescribeServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeServerResponse> {
        return client.execute(operation: "DescribeServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeUser(_ input: DescribeUserRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeUserResponse> {
        return client.execute(operation: "DescribeUser", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func importSshPublicKey(_ input: ImportSshPublicKeyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ImportSshPublicKeyResponse> {
        return client.execute(operation: "ImportSshPublicKey", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listServers(_ input: ListServersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListServersResponse> {
        return client.execute(operation: "ListServers", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func startServer(_ input: StartServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "StartServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func stopServer(_ input: StopServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "StopServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func testIdentityProvider(_ input: TestIdentityProviderRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TestIdentityProviderResponse> {
        return client.execute(operation: "TestIdentityProvider", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateServer(_ input: UpdateServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServerResponse> {
        return client.execute(operation: "UpdateServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
