...
extension Glue {
    ...
    public func getClassifiersPaginator(
        ...
        onPage: @escaping (GetClassifiersResponse,
    ...
    public func getConnectionsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetConnectionsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getCrawlerMetricsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetCrawlerMetricsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getCrawlersPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetCrawlersResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getDatabasesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetDatabasesResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getDevEndpointsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetDevEndpointsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getJobRunsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetJobRunsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getJobsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetJobsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getMLTaskRunsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetMLTaskRunsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getMLTransformsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetMLTransformsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getPartitionsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetPartitionsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getSecurityConfigurationsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetSecurityConfigurationsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getTableVersionsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetTableVersionsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getTablesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetTablesResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getTriggersPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetTriggersResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getUserDefinedFunctionsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetUserDefinedFunctionsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func getWorkflowRunsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (GetWorkflowRunsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listCrawlersPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListCrawlersResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listDevEndpointsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListDevEndpointsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listMLTransformsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListMLTransformsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listTriggersPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListTriggersResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listWorkflowsPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (ListWorkflowsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func searchTablesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (SearchTablesResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
