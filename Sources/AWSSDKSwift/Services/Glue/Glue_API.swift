...
public struct Glue {
    ...
    public func deleteResourcePolicy(_ input: DeleteResourcePolicyRequest) throws -> DeleteResourcePolicyResponse {
    ...
    public func createSecurityConfiguration(_ input: CreateSecurityConfigurationRequest) throws -> CreateSecurityConfigurationResponse {
        return try client.send(operation: "CreateSecurityConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the security configuration for a specified catalog.
    public func getDataCatalogEncryptionSettings(_ input: GetDataCatalogEncryptionSettingsRequest) throws -> GetDataCatalogEncryptionSettingsResponse {
    ...
    public func putDataCatalogEncryptionSettings(_ input: PutDataCatalogEncryptionSettingsRequest) throws -> PutDataCatalogEncryptionSettingsResponse {
    ...
    public func getResourcePolicy(_ input: GetResourcePolicyRequest) throws -> GetResourcePolicyResponse {
        return try client.send(operation: "GetResourcePolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list of all security configurations.
    public func getSecurityConfigurations(_ input: GetSecurityConfigurationsRequest) throws -> GetSecurityConfigurationsResponse {
    ...
    public func getSecurityConfiguration(_ input: GetSecurityConfigurationRequest) throws -> GetSecurityConfigurationResponse {
    ...
    public func deleteSecurityConfiguration(_ input: DeleteSecurityConfigurationRequest) throws -> DeleteSecurityConfigurationResponse {
