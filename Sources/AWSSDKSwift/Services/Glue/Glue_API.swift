...
public struct Glue {
    ...
    public func batchUpdatePartition(_ input: BatchUpdatePartitionRequest) -> EventLoopFuture<BatchUpdatePartitionResponse> {
        return client.send(operation: "BatchUpdatePartition", path: "/", httpMethod: "POST", input: input)
    }
