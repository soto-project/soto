...
/**
Client object for interacting with AWS Rekognition service.
...
public struct Rekognition {
    ...
    public func compareFaces(_ input: CompareFacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CompareFacesResponse> {
        return client.send(operation: "CompareFaces", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createCollection(_ input: CreateCollectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCollectionResponse> {
        return client.send(operation: "CreateCollection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createProjectVersion(_ input: CreateProjectVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateProjectVersionResponse> {
        return client.send(operation: "CreateProjectVersion", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func createStreamProcessor(_ input: CreateStreamProcessorRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateStreamProcessorResponse> {
        return client.send(operation: "CreateStreamProcessor", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func deleteCollection(_ input: DeleteCollectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteCollectionResponse> {
        return client.send(operation: "DeleteCollection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func deleteFaces(_ input: DeleteFacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteFacesResponse> {
        return client.send(operation: "DeleteFaces", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func deleteProjectVersion(_ input: DeleteProjectVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteProjectVersionResponse> {
        return client.send(operation: "DeleteProjectVersion", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Deletes the stream processor identified by Name. You assign the value for Name when you create the stream processor with CreateStreamProcessor. You might not be able to use the same name for a stream processor for a few seconds after calling DeleteStreamProcessor.
    public func deleteStreamProcessor(_ input: DeleteStreamProcessorRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteStreamProcessorResponse> {
        return client.send(operation: "DeleteStreamProcessor", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func describeCollection(_ input: DescribeCollectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCollectionResponse> {
        return client.send(operation: "DescribeCollection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func describeProjectVersions(_ input: DescribeProjectVersionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeProjectVersionsResponse> {
        return client.send(operation: "DescribeProjectVersions", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func describeProjects(_ input: DescribeProjectsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeProjectsResponse> {
        return client.send(operation: "DescribeProjects", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Provides information about a stream processor created by CreateStreamProcessor. You can get information about the input and output streams, the input parameters for the face recognition being performed, and the current status of the stream processor.
    public func describeStreamProcessor(_ input: DescribeStreamProcessorRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStreamProcessorResponse> {
        return client.send(operation: "DescribeStreamProcessor", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func detectCustomLabels(_ input: DetectCustomLabelsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectCustomLabelsResponse> {
        return client.send(operation: "DetectCustomLabels", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func detectFaces(_ input: DetectFacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectFacesResponse> {
        return client.send(operation: "DetectFaces", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func detectLabels(_ input: DetectLabelsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectLabelsResponse> {
        return client.send(operation: "DetectLabels", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func detectModerationLabels(_ input: DetectModerationLabelsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectModerationLabelsResponse> {
        return client.send(operation: "DetectModerationLabels", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func detectText(_ input: DetectTextRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DetectTextResponse> {
        return client.send(operation: "DetectText", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getCelebrityInfo(_ input: GetCelebrityInfoRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCelebrityInfoResponse> {
        return client.send(operation: "GetCelebrityInfo", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getCelebrityRecognition(_ input: GetCelebrityRecognitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCelebrityRecognitionResponse> {
        return client.send(operation: "GetCelebrityRecognition", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getContentModeration(_ input: GetContentModerationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetContentModerationResponse> {
        return client.send(operation: "GetContentModeration", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getFaceDetection(_ input: GetFaceDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetFaceDetectionResponse> {
        return client.send(operation: "GetFaceDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getFaceSearch(_ input: GetFaceSearchRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetFaceSearchResponse> {
        return client.send(operation: "GetFaceSearch", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getLabelDetection(_ input: GetLabelDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetLabelDetectionResponse> {
        return client.send(operation: "GetLabelDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getPersonTracking(_ input: GetPersonTrackingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetPersonTrackingResponse> {
        return client.send(operation: "GetPersonTracking", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func getTextDetection(_ input: GetTextDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTextDetectionResponse> {
        return client.send(operation: "GetTextDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func indexFaces(_ input: IndexFacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<IndexFacesResponse> {
        return client.send(operation: "IndexFaces", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func listCollections(_ input: ListCollectionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListCollectionsResponse> {
        return client.send(operation: "ListCollections", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func listFaces(_ input: ListFacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListFacesResponse> {
        return client.send(operation: "ListFaces", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Gets a list of stream processors that you have created with CreateStreamProcessor. 
    public func listStreamProcessors(_ input: ListStreamProcessorsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStreamProcessorsResponse> {
        return client.send(operation: "ListStreamProcessors", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func recognizeCelebrities(_ input: RecognizeCelebritiesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RecognizeCelebritiesResponse> {
        return client.send(operation: "RecognizeCelebrities", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func searchFaces(_ input: SearchFacesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchFacesResponse> {
        return client.send(operation: "SearchFaces", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func searchFacesByImage(_ input: SearchFacesByImageRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SearchFacesByImageResponse> {
        return client.send(operation: "SearchFacesByImage", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startCelebrityRecognition(_ input: StartCelebrityRecognitionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartCelebrityRecognitionResponse> {
        return client.send(operation: "StartCelebrityRecognition", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startContentModeration(_ input: StartContentModerationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartContentModerationResponse> {
        return client.send(operation: "StartContentModeration", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startFaceDetection(_ input: StartFaceDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartFaceDetectionResponse> {
        return client.send(operation: "StartFaceDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startFaceSearch(_ input: StartFaceSearchRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartFaceSearchResponse> {
        return client.send(operation: "StartFaceSearch", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startLabelDetection(_ input: StartLabelDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartLabelDetectionResponse> {
        return client.send(operation: "StartLabelDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startPersonTracking(_ input: StartPersonTrackingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartPersonTrackingResponse> {
        return client.send(operation: "StartPersonTracking", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startProjectVersion(_ input: StartProjectVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartProjectVersionResponse> {
        return client.send(operation: "StartProjectVersion", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Starts processing a stream processor. You create a stream processor by calling CreateStreamProcessor. To tell StartStreamProcessor which stream processor to start, use the value of the Name field specified in the call to CreateStreamProcessor.
    public func startStreamProcessor(_ input: StartStreamProcessorRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartStreamProcessorResponse> {
        return client.send(operation: "StartStreamProcessor", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
    ...
    public func startTextDetection(_ input: StartTextDetectionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartTextDetectionResponse> {
        return client.send(operation: "StartTextDetection", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Stops a running model. The operation might take a while to complete. To check the current status, call DescribeProjectVersions. 
    public func stopProjectVersion(_ input: StopProjectVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopProjectVersionResponse> {
        return client.send(operation: "StopProjectVersion", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }

    ///  Stops a running stream processor that was created by CreateStreamProcessor.
    public func stopStreamProcessor(_ input: StopStreamProcessorRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopStreamProcessorResponse> {
        return client.send(operation: "StopStreamProcessor", path: "/", httpMethod: "POST", input: input, on: eventLoop)
    }
}
