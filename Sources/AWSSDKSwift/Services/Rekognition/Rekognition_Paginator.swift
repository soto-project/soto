...
extension Rekognition {
    ...
    public func describeProjectVersionsPaginator(_ input: DescribeProjectVersionsRequest) -> EventLoopFuture<[ProjectVersionDescription]> {
        return client.paginate(input: input, command: describeProjectVersions, resultKey: \DescribeProjectVersionsResponse.projectVersionDescriptions, tokenKey: \DescribeProjectVersionsResponse.nextToken)
    }
    ...
    public func describeProjectsPaginator(_ input: DescribeProjectsRequest) -> EventLoopFuture<[ProjectDescription]> {
        return client.paginate(input: input, command: describeProjects, resultKey: \DescribeProjectsResponse.projectDescriptions, tokenKey: \DescribeProjectsResponse.nextToken)
    }
    ...
    public func getCelebrityRecognitionPaginator(_ input: GetCelebrityRecognitionRequest) -> EventLoopFuture<[CelebrityRecognition]> {
        return client.paginate(input: input, command: getCelebrityRecognition, resultKey: \GetCelebrityRecognitionResponse.celebrities, tokenKey: \GetCelebrityRecognitionResponse.nextToken)
    }
    ...
    public func getContentModerationPaginator(_ input: GetContentModerationRequest) -> EventLoopFuture<[ContentModerationDetection]> {
        return client.paginate(input: input, command: getContentModeration, resultKey: \GetContentModerationResponse.moderationLabels, tokenKey: \GetContentModerationResponse.nextToken)
    }
    ...
    public func getFaceDetectionPaginator(_ input: GetFaceDetectionRequest) -> EventLoopFuture<[FaceDetection]> {
        return client.paginate(input: input, command: getFaceDetection, resultKey: \GetFaceDetectionResponse.faces, tokenKey: \GetFaceDetectionResponse.nextToken)
    }
    ...
    public func getFaceSearchPaginator(_ input: GetFaceSearchRequest) -> EventLoopFuture<[PersonMatch]> {
        return client.paginate(input: input, command: getFaceSearch, resultKey: \GetFaceSearchResponse.persons, tokenKey: \GetFaceSearchResponse.nextToken)
    }
    ...
    public func getLabelDetectionPaginator(_ input: GetLabelDetectionRequest) -> EventLoopFuture<[LabelDetection]> {
        return client.paginate(input: input, command: getLabelDetection, resultKey: \GetLabelDetectionResponse.labels, tokenKey: \GetLabelDetectionResponse.nextToken)
    }
    ...
    public func getPersonTrackingPaginator(_ input: GetPersonTrackingRequest) -> EventLoopFuture<[PersonDetection]> {
        return client.paginate(input: input, command: getPersonTracking, resultKey: \GetPersonTrackingResponse.persons, tokenKey: \GetPersonTrackingResponse.nextToken)
    }
    ...
    public func listCollectionsPaginator(_ input: ListCollectionsRequest) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: listCollections, resultKey: \ListCollectionsResponse.collectionIds, tokenKey: \ListCollectionsResponse.nextToken)
    }
    ...
    public func listFacesPaginator(_ input: ListFacesRequest) -> EventLoopFuture<[Face]> {
        return client.paginate(input: input, command: listFaces, resultKey: \ListFacesResponse.faces, tokenKey: \ListFacesResponse.nextToken)
    }
    ...
    public func listStreamProcessorsPaginator(_ input: ListStreamProcessorsRequest) -> EventLoopFuture<[StreamProcessor]> {
        return client.paginate(input: input, command: listStreamProcessors, resultKey: \ListStreamProcessorsResponse.streamProcessors, tokenKey: \ListStreamProcessorsResponse.nextToken)
    }
