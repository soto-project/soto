...
extension Rekognition {
    ...
    public func describeProjectVersionsPaginator(_ input: DescribeProjectVersionsRequest, onPage: @escaping ([ProjectVersionDescription], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeProjectVersions, resultKey: \DescribeProjectVersionsResponse.projectVersionDescriptions, tokenKey: \DescribeProjectVersionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeProjectsPaginator(_ input: DescribeProjectsRequest, onPage: @escaping ([ProjectDescription], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeProjects, resultKey: \DescribeProjectsResponse.projectDescriptions, tokenKey: \DescribeProjectsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getCelebrityRecognitionPaginator(_ input: GetCelebrityRecognitionRequest, onPage: @escaping ([CelebrityRecognition], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getCelebrityRecognition, resultKey: \GetCelebrityRecognitionResponse.celebrities, tokenKey: \GetCelebrityRecognitionResponse.nextToken, onPage: onPage)
    }
    ...
    public func getContentModerationPaginator(_ input: GetContentModerationRequest, onPage: @escaping ([ContentModerationDetection], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getContentModeration, resultKey: \GetContentModerationResponse.moderationLabels, tokenKey: \GetContentModerationResponse.nextToken, onPage: onPage)
    }
    ...
    public func getFaceDetectionPaginator(_ input: GetFaceDetectionRequest, onPage: @escaping ([FaceDetection], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getFaceDetection, resultKey: \GetFaceDetectionResponse.faces, tokenKey: \GetFaceDetectionResponse.nextToken, onPage: onPage)
    }
    ...
    public func getFaceSearchPaginator(_ input: GetFaceSearchRequest, onPage: @escaping ([PersonMatch], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getFaceSearch, resultKey: \GetFaceSearchResponse.persons, tokenKey: \GetFaceSearchResponse.nextToken, onPage: onPage)
    }
    ...
    public func getLabelDetectionPaginator(_ input: GetLabelDetectionRequest, onPage: @escaping ([LabelDetection], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getLabelDetection, resultKey: \GetLabelDetectionResponse.labels, tokenKey: \GetLabelDetectionResponse.nextToken, onPage: onPage)
    }
    ...
    public func getPersonTrackingPaginator(_ input: GetPersonTrackingRequest, onPage: @escaping ([PersonDetection], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getPersonTracking, resultKey: \GetPersonTrackingResponse.persons, tokenKey: \GetPersonTrackingResponse.nextToken, onPage: onPage)
    }
    ...
    public func listCollectionsPaginator(_ input: ListCollectionsRequest, onPage: @escaping ([String], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listCollections, resultKey: \ListCollectionsResponse.collectionIds, tokenKey: \ListCollectionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func listFacesPaginator(_ input: ListFacesRequest, onPage: @escaping ([Face], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listFaces, resultKey: \ListFacesResponse.faces, tokenKey: \ListFacesResponse.nextToken, onPage: onPage)
    }
    
    ///  Gets a list of stream processors that you have created with CreateStreamProcessor. 
    public func listStreamProcessorsPaginator(_ input: ListStreamProcessorsRequest, onPage: @escaping ([StreamProcessor], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listStreamProcessors, resultKey: \ListStreamProcessorsResponse.streamProcessors, tokenKey: \ListStreamProcessorsResponse.nextToken, onPage: onPage)
    }
