...
extension Rekognition {
    ...
    public func describeProjectVersionsPaginator(_ input: DescribeProjectVersionsRequest, onPage: @escaping (DescribeProjectVersionsResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeProjectVersions, tokenKey: \DescribeProjectVersionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeProjectsPaginator(_ input: DescribeProjectsRequest, onPage: @escaping (DescribeProjectsResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeProjects, tokenKey: \DescribeProjectsResponse.nextToken, onPage: onPage)
    }
    ...
    public func getCelebrityRecognitionPaginator(_ input: GetCelebrityRecognitionRequest, onPage: @escaping (GetCelebrityRecognitionResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getCelebrityRecognition, tokenKey: \GetCelebrityRecognitionResponse.nextToken, onPage: onPage)
    }
    ...
    public func getContentModerationPaginator(_ input: GetContentModerationRequest, onPage: @escaping (GetContentModerationResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getContentModeration, tokenKey: \GetContentModerationResponse.nextToken, onPage: onPage)
    }
    ...
    public func getFaceDetectionPaginator(_ input: GetFaceDetectionRequest, onPage: @escaping (GetFaceDetectionResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getFaceDetection, tokenKey: \GetFaceDetectionResponse.nextToken, onPage: onPage)
    }
    ...
    public func getFaceSearchPaginator(_ input: GetFaceSearchRequest, onPage: @escaping (GetFaceSearchResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getFaceSearch, tokenKey: \GetFaceSearchResponse.nextToken, onPage: onPage)
    }
    ...
    public func getLabelDetectionPaginator(_ input: GetLabelDetectionRequest, onPage: @escaping (GetLabelDetectionResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getLabelDetection, tokenKey: \GetLabelDetectionResponse.nextToken, onPage: onPage)
    }
    ...
    public func getPersonTrackingPaginator(_ input: GetPersonTrackingRequest, onPage: @escaping (GetPersonTrackingResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
    ...
    public func getSegmentDetectionPaginator(_ input: GetSegmentDetectionRequest, onPage: @escaping (GetSegmentDetectionResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: getSegmentDetection, tokenKey: \GetSegmentDetectionResponse.nextToken, onPage: onPage)
    }
    ...
    public func listFacesPaginator(_ input: ListFacesRequest, onPage: @escaping (ListFacesResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listFaces, tokenKey: \ListFacesResponse.nextToken, onPage: onPage)
    }

    ///  Gets a list of stream processors that you have created with CreateStreamProcessor. 
    public func listStreamProcessorsPaginator(_ input: ListStreamProcessorsRequest, onPage: @escaping (ListStreamProcessorsResponse, EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listStreamProcessors, tokenKey: \ListStreamProcessorsResponse.nextToken, onPage: onPage)
    }
...
extension Rekognition.GetSegmentDetectionRequest: AWSPaginateStringToken {
