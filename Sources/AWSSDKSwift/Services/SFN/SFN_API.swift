...
public struct SFN: AWSService {
    ...
    /// return new `SFN` with new timeout value
    ...
    /// return new `SFN` logging to specified Logger
    ...
    public func createActivity(_ input: CreateActivityInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateActivityOutput> {
        return client.execute(operation: "CreateActivity", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func createStateMachine(_ input: CreateStateMachineInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateStateMachineOutput> {
        return client.execute(operation: "CreateStateMachine", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Deletes an activity.
    public func deleteActivity(_ input: DeleteActivityInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteActivityOutput> {
        return client.execute(operation: "DeleteActivity", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func deleteStateMachine(_ input: DeleteStateMachineInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteStateMachineOutput> {
        return client.execute(operation: "DeleteStateMachine", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeActivity(_ input: DescribeActivityInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeActivityOutput> {
        return client.execute(operation: "DescribeActivity", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeExecution(_ input: DescribeExecutionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeExecutionOutput> {
        return client.execute(operation: "DescribeExecution", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeStateMachine(_ input: DescribeStateMachineInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStateMachineOutput> {
        return client.execute(operation: "DescribeStateMachine", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeStateMachineForExecution(_ input: DescribeStateMachineForExecutionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeStateMachineForExecutionOutput> {
        return client.execute(operation: "DescribeStateMachineForExecution", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getActivityTask(_ input: GetActivityTaskInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetActivityTaskOutput> {
        return client.execute(operation: "GetActivityTask", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getExecutionHistory(_ input: GetExecutionHistoryInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetExecutionHistoryOutput> {
        return client.execute(operation: "GetExecutionHistory", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listActivities(_ input: ListActivitiesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListActivitiesOutput> {
        return client.execute(operation: "ListActivities", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listExecutions(_ input: ListExecutionsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListExecutionsOutput> {
        return client.execute(operation: "ListExecutions", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listStateMachines(_ input: ListStateMachinesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListStateMachinesOutput> {
        return client.execute(operation: "ListStateMachines", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func sendTaskFailure(_ input: SendTaskFailureInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendTaskFailureOutput> {
        return client.execute(operation: "SendTaskFailure", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func sendTaskHeartbeat(_ input: SendTaskHeartbeatInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendTaskHeartbeatOutput> {
        return client.execute(operation: "SendTaskHeartbeat", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func sendTaskSuccess(_ input: SendTaskSuccessInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SendTaskSuccessOutput> {
        return client.execute(operation: "SendTaskSuccess", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startExecution(_ input: StartExecutionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartExecutionOutput> {
        return client.execute(operation: "StartExecution", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func stopExecution(_ input: StopExecutionInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopExecutionOutput> {
        return client.execute(operation: "StopExecution", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateStateMachine(_ input: UpdateStateMachineInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateStateMachineOutput> {
        return client.execute(operation: "UpdateStateMachine", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
