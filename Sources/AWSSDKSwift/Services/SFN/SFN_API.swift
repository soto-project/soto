...
public struct SFN {
    ...
    public func sendTaskSuccess(_ input: SendTaskSuccessInput) throws -> EventLoopFuture<SendTaskSuccessOutput> {
    ...
    public func deleteStateMachine(_ input: DeleteStateMachineInput) throws -> EventLoopFuture<DeleteStateMachineOutput> {
    ...
    public func updateStateMachine(_ input: UpdateStateMachineInput) throws -> EventLoopFuture<UpdateStateMachineOutput> {
    ...
    public func getActivityTask(_ input: GetActivityTaskInput) throws -> EventLoopFuture<GetActivityTaskOutput> {
    ...
    public func describeStateMachineForExecution(_ input: DescribeStateMachineForExecutionInput) throws -> EventLoopFuture<DescribeStateMachineForExecutionOutput> {
    ...
    public func createActivity(_ input: CreateActivityInput) throws -> EventLoopFuture<CreateActivityOutput> {
        return try client.send(operation: "CreateActivity", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an activity.
    public func deleteActivity(_ input: DeleteActivityInput) throws -> EventLoopFuture<DeleteActivityOutput> {
        return try client.send(operation: "DeleteActivity", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stops an execution.
    public func stopExecution(_ input: StopExecutionInput) throws -> EventLoopFuture<StopExecutionOutput> {
    ...
    public func listActivities(_ input: ListActivitiesInput) throws -> EventLoopFuture<ListActivitiesOutput> {
    ...
    public func startExecution(_ input: StartExecutionInput) throws -> EventLoopFuture<StartExecutionOutput> {
    ...
    public func createStateMachine(_ input: CreateStateMachineInput) throws -> EventLoopFuture<CreateStateMachineOutput> {
        return try client.send(operation: "CreateStateMachine", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the existing state machines. If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 60 seconds. Using an expired pagination token will return an HTTP 400 InvalidToken error.  This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes. 
    public func listStateMachines(_ input: ListStateMachinesInput) throws -> EventLoopFuture<ListStateMachinesOutput> {
    ...
    public func listExecutions(_ input: ListExecutionsInput) throws -> EventLoopFuture<ListExecutionsOutput> {
    ...
    public func describeActivity(_ input: DescribeActivityInput) throws -> EventLoopFuture<DescribeActivityOutput> {
    ...
    public func describeStateMachine(_ input: DescribeStateMachineInput) throws -> EventLoopFuture<DescribeStateMachineOutput> {
    ...
    public func sendTaskHeartbeat(_ input: SendTaskHeartbeatInput) throws -> EventLoopFuture<SendTaskHeartbeatOutput> {
    ...
    public func describeExecution(_ input: DescribeExecutionInput) throws -> EventLoopFuture<DescribeExecutionOutput> {
        return try client.send(operation: "DescribeExecution", path: "/", httpMethod: "POST", input: input)
    }

    ///  Used by workers to report that the task identified by the taskToken failed.
    public func sendTaskFailure(_ input: SendTaskFailureInput) throws -> EventLoopFuture<SendTaskFailureOutput> {
    ...
    public func getExecutionHistory(_ input: GetExecutionHistoryInput) throws -> EventLoopFuture<GetExecutionHistoryOutput> {
