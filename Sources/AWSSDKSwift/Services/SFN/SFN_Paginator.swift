...
extension SFN {
    ...
    public func getExecutionHistoryPaginator(
        ...
        onPage: @escaping (GetExecutionHistoryOutput,
    ...
    public func listActivitiesPaginator(
        ...
        onPage: @escaping (ListActivitiesOutput,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listExecutionsPaginator(
        ...
        onPage: @escaping (ListExecutionsOutput,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listStateMachinesPaginator(
        ...
        onPage: @escaping (ListStateMachinesOutput,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
