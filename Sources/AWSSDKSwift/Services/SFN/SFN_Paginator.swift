...
extension SFN {
    ...
    public func getExecutionHistoryPaginator(_ input: GetExecutionHistoryInput) -> Future<[HistoryEvent]> {
    ...
    public func listActivitiesPaginator(_ input: ListActivitiesInput) -> Future<[ActivityListItem]> {
    ...
    public func listExecutionsPaginator(_ input: ListExecutionsInput) -> Future<[ExecutionListItem]> {
    ...
    public func listStateMachinesPaginator(_ input: ListStateMachinesInput) -> Future<[StateMachineListItem]> {
