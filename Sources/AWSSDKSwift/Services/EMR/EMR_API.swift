...
public struct EMR {
    ...
    public func addInstanceFleet(_ input: AddInstanceFleetInput) -> Future<AddInstanceFleetOutput> {
        return client.send(operation: "AddInstanceFleet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds one or more instance groups to a running cluster.
    public func addInstanceGroups(_ input: AddInstanceGroupsInput) -> Future<AddInstanceGroupsOutput> {
    ...
    public func addJobFlowSteps(_ input: AddJobFlowStepsInput) -> Future<AddJobFlowStepsOutput> {
    ...
    public func cancelSteps(_ input: CancelStepsInput) -> Future<CancelStepsOutput> {
        return client.send(operation: "CancelSteps", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a security configuration, which is stored in the service and can be specified when a cluster is created.
    public func createSecurityConfiguration(_ input: CreateSecurityConfigurationInput) -> Future<CreateSecurityConfigurationOutput> {
        return client.send(operation: "CreateSecurityConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a security configuration.
    public func deleteSecurityConfiguration(_ input: DeleteSecurityConfigurationInput) -> Future<DeleteSecurityConfigurationOutput> {
        return client.send(operation: "DeleteSecurityConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides cluster-level details including status, hardware and software configuration, VPC settings, and so on. 
    public func describeCluster(_ input: DescribeClusterInput) -> Future<DescribeClusterOutput> {
    ...
    public func describeJobFlows(_ input: DescribeJobFlowsInput) -> Future<DescribeJobFlowsOutput> {
        return client.send(operation: "DescribeJobFlows", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides the details of a security configuration by returning the configuration JSON.
    public func describeSecurityConfiguration(_ input: DescribeSecurityConfigurationInput) -> Future<DescribeSecurityConfigurationOutput> {
        return client.send(operation: "DescribeSecurityConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides more detail about the cluster step.
    public func describeStep(_ input: DescribeStepInput) -> Future<DescribeStepOutput> {
    ...
    public func listClusters(_ input: ListClustersInput) -> Future<ListClustersOutput> {
    ...
    public func listInstanceFleets(_ input: ListInstanceFleetsInput) -> Future<ListInstanceFleetsOutput> {
        return client.send(operation: "ListInstanceFleets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Provides all available details about the instance groups in a cluster.
    public func listInstanceGroups(_ input: ListInstanceGroupsInput) -> Future<ListInstanceGroupsOutput> {
    ...
    public func listInstances(_ input: ListInstancesInput) -> Future<ListInstancesOutput> {
    ...
    public func listSecurityConfigurations(_ input: ListSecurityConfigurationsInput) -> Future<ListSecurityConfigurationsOutput> {
    ...
    @discardableResult public func modifyInstanceFleet(_ input: ModifyInstanceFleetInput) -> Future<Void> {
    ...
    @discardableResult public func modifyInstanceGroups(_ input: ModifyInstanceGroupsInput) -> Future<Void> {
    ...
    public func putAutoScalingPolicy(_ input: PutAutoScalingPolicyInput) -> Future<PutAutoScalingPolicyOutput> {
    ...
    public func runJobFlow(_ input: RunJobFlowInput) -> Future<RunJobFlowOutput> {
    ...
    @discardableResult public func setTerminationProtection(_ input: SetTerminationProtectionInput) -> Future<Void> {
    ...
    @discardableResult public func terminateJobFlows(_ input: TerminateJobFlowsInput) -> Future<Void> {
