...
public struct EMR: AWSService {
    ...
    public func addInstanceFleet(_ input: AddInstanceFleetInput) -> EventLoopFuture<AddInstanceFleetOutput> {
        return client.execute(operation: "AddInstanceFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Adds one or more instance groups to a running cluster.
    public func addInstanceGroups(_ input: AddInstanceGroupsInput) -> EventLoopFuture<AddInstanceGroupsOutput> {
        return client.execute(operation: "AddInstanceGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func addJobFlowSteps(_ input: AddJobFlowStepsInput) -> EventLoopFuture<AddJobFlowStepsOutput> {
        return client.execute(operation: "AddJobFlowSteps", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func cancelSteps(_ input: CancelStepsInput) -> EventLoopFuture<CancelStepsOutput> {
        return client.execute(operation: "CancelSteps", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeCluster(_ input: DescribeClusterInput) -> EventLoopFuture<DescribeClusterOutput> {
        return client.execute(operation: "DescribeCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeJobFlows(_ input: DescribeJobFlowsInput) -> EventLoopFuture<DescribeJobFlowsOutput> {
        return client.execute(operation: "DescribeJobFlows", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeSecurityConfiguration(_ input: DescribeSecurityConfigurationInput) -> EventLoopFuture<DescribeSecurityConfigurationOutput> {
        return client.execute(operation: "DescribeSecurityConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Provides more detail about the cluster step.
    public func describeStep(_ input: DescribeStepInput) -> EventLoopFuture<DescribeStepOutput> {
        return client.execute(operation: "DescribeStep", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getBlockPublicAccessConfiguration(_ input: GetBlockPublicAccessConfigurationInput) -> EventLoopFuture<GetBlockPublicAccessConfigurationOutput> {
        return client.execute(operation: "GetBlockPublicAccessConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getManagedScalingPolicy(_ input: GetManagedScalingPolicyInput) -> EventLoopFuture<GetManagedScalingPolicyOutput> {
        return client.execute(operation: "GetManagedScalingPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listBootstrapActions(_ input: ListBootstrapActionsInput) -> EventLoopFuture<ListBootstrapActionsOutput> {
        return client.execute(operation: "ListBootstrapActions", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listClusters(_ input: ListClustersInput) -> EventLoopFuture<ListClustersOutput> {
        return client.execute(operation: "ListClusters", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listInstanceFleets(_ input: ListInstanceFleetsInput) -> EventLoopFuture<ListInstanceFleetsOutput> {
        return client.execute(operation: "ListInstanceFleets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Provides all available details about the instance groups in a cluster.
    public func listInstanceGroups(_ input: ListInstanceGroupsInput) -> EventLoopFuture<ListInstanceGroupsOutput> {
        return client.execute(operation: "ListInstanceGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listSecurityConfigurations(_ input: ListSecurityConfigurationsInput) -> EventLoopFuture<ListSecurityConfigurationsOutput> {
        return client.execute(operation: "ListSecurityConfigurations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listSteps(_ input: ListStepsInput) -> EventLoopFuture<ListStepsOutput> {
        return client.execute(operation: "ListSteps", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Modifies the number of steps that can be executed concurrently for the cluster specified using ClusterID.
    public func modifyCluster(_ input: ModifyClusterInput) -> EventLoopFuture<ModifyClusterOutput> {
        return client.execute(operation: "ModifyCluster", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func modifyInstanceFleet(_ input: ModifyInstanceFleetInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "ModifyInstanceFleet", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func modifyInstanceGroups(_ input: ModifyInstanceGroupsInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "ModifyInstanceGroups", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putAutoScalingPolicy(_ input: PutAutoScalingPolicyInput) -> EventLoopFuture<PutAutoScalingPolicyOutput> {
        return client.execute(operation: "PutAutoScalingPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putBlockPublicAccessConfiguration(_ input: PutBlockPublicAccessConfigurationInput) -> EventLoopFuture<PutBlockPublicAccessConfigurationOutput> {
        return client.execute(operation: "PutBlockPublicAccessConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putManagedScalingPolicy(_ input: PutManagedScalingPolicyInput) -> EventLoopFuture<PutManagedScalingPolicyOutput> {
        return client.execute(operation: "PutManagedScalingPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func removeAutoScalingPolicy(_ input: RemoveAutoScalingPolicyInput) -> EventLoopFuture<RemoveAutoScalingPolicyOutput> {
        return client.execute(operation: "RemoveAutoScalingPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func removeManagedScalingPolicy(_ input: RemoveManagedScalingPolicyInput) -> EventLoopFuture<RemoveManagedScalingPolicyOutput> {
        return client.execute(operation: "RemoveManagedScalingPolicy", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func runJobFlow(_ input: RunJobFlowInput) -> EventLoopFuture<RunJobFlowOutput> {
        return client.execute(operation: "RunJobFlow", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setTerminationProtection(_ input: SetTerminationProtectionInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetTerminationProtection", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func setVisibleToAllUsers(_ input: SetVisibleToAllUsersInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "SetVisibleToAllUsers", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func terminateJobFlows(_ input: TerminateJobFlowsInput) -> EventLoopFuture<Void> {
        return client.execute(operation: "TerminateJobFlows", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
