...
extension Sns {
    ...
    public struct SubscribeInput: AWSShape {
        ...
        public init(topicArn: String, attributes: [String: String]? = nil, returnSubscriptionArn: Bool? = nil, endpoint: String? = nil, protocol: String) {
            self.topicArn = topicArn
            self.attributes = attributes
    ...
    public struct PublishInput: AWSShape {
        ...
        public init(subject: String? = nil, phoneNumber: String? = nil, message: String, targetArn: String? = nil, messageStructure: String? = nil, topicArn: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil) {
