...
public struct SES {
    ...
    public func getTemplate(_ input: GetTemplateRequest) throws -> EventLoopFuture<GetTemplateResponse> {
    ...
    public func listReceiptRuleSets(_ input: ListReceiptRuleSetsRequest) throws -> EventLoopFuture<ListReceiptRuleSetsResponse> {
    ...
    public func verifyDomainIdentity(_ input: VerifyDomainIdentityRequest) throws -> EventLoopFuture<VerifyDomainIdentityResponse> {
    ...
    public func deleteConfigurationSetTrackingOptions(_ input: DeleteConfigurationSetTrackingOptionsRequest) throws -> EventLoopFuture<DeleteConfigurationSetTrackingOptionsResponse> {
    ...
    public func listConfigurationSets(_ input: ListConfigurationSetsRequest) throws -> EventLoopFuture<ListConfigurationSetsResponse> {
    ...
    public func getSendQuota() throws -> EventLoopFuture<GetSendQuotaResponse> {
    ...
    public func deleteReceiptRuleSet(_ input: DeleteReceiptRuleSetRequest) throws -> EventLoopFuture<DeleteReceiptRuleSetResponse> {
    ...
    public func createReceiptRuleSet(_ input: CreateReceiptRuleSetRequest) throws -> EventLoopFuture<CreateReceiptRuleSetResponse> {
    ...
    public func deleteConfigurationSet(_ input: DeleteConfigurationSetRequest) throws -> EventLoopFuture<DeleteConfigurationSetResponse> {
    ...
    public func createTemplate(_ input: CreateTemplateRequest) throws -> EventLoopFuture<CreateTemplateResponse> {
    ...
    public func getAccountSendingEnabled() throws -> EventLoopFuture<GetAccountSendingEnabledResponse> {
    ...
    public func updateConfigurationSetEventDestination(_ input: UpdateConfigurationSetEventDestinationRequest) throws -> EventLoopFuture<UpdateConfigurationSetEventDestinationResponse> {
    ...
    public func sendBounce(_ input: SendBounceRequest) throws -> EventLoopFuture<SendBounceResponse> {
    ...
    public func updateConfigurationSetTrackingOptions(_ input: UpdateConfigurationSetTrackingOptionsRequest) throws -> EventLoopFuture<UpdateConfigurationSetTrackingOptionsResponse> {
    ...
    public func setIdentityMailFromDomain(_ input: SetIdentityMailFromDomainRequest) throws -> EventLoopFuture<SetIdentityMailFromDomainResponse> {
    ...
    public func reorderReceiptRuleSet(_ input: ReorderReceiptRuleSetRequest) throws -> EventLoopFuture<ReorderReceiptRuleSetResponse> {
    ...
    public func deleteReceiptRule(_ input: DeleteReceiptRuleRequest) throws -> EventLoopFuture<DeleteReceiptRuleResponse> {
    ...
    public func getIdentityVerificationAttributes(_ input: GetIdentityVerificationAttributesRequest) throws -> EventLoopFuture<GetIdentityVerificationAttributesResponse> {
    ...
    public func setIdentityHeadersInNotificationsEnabled(_ input: SetIdentityHeadersInNotificationsEnabledRequest) throws -> EventLoopFuture<SetIdentityHeadersInNotificationsEnabledResponse> {
    ...
    public func cloneReceiptRuleSet(_ input: CloneReceiptRuleSetRequest) throws -> EventLoopFuture<CloneReceiptRuleSetResponse> {
    ...
    public func updateReceiptRule(_ input: UpdateReceiptRuleRequest) throws -> EventLoopFuture<UpdateReceiptRuleResponse> {
    ...
    public func createConfigurationSetTrackingOptions(_ input: CreateConfigurationSetTrackingOptionsRequest) throws -> EventLoopFuture<CreateConfigurationSetTrackingOptionsResponse> {
    ...
    public func setIdentityNotificationTopic(_ input: SetIdentityNotificationTopicRequest) throws -> EventLoopFuture<SetIdentityNotificationTopicResponse> {
    ...
    public func getIdentityPolicies(_ input: GetIdentityPoliciesRequest) throws -> EventLoopFuture<GetIdentityPoliciesResponse> {
    ...
    public func getSendStatistics() throws -> EventLoopFuture<GetSendStatisticsResponse> {
    ...
    public func describeConfigurationSet(_ input: DescribeConfigurationSetRequest) throws -> EventLoopFuture<DescribeConfigurationSetResponse> {
    ...
    public func setReceiptRulePosition(_ input: SetReceiptRulePositionRequest) throws -> EventLoopFuture<SetReceiptRulePositionResponse> {
    ...
    public func sendCustomVerificationEmail(_ input: SendCustomVerificationEmailRequest) throws -> EventLoopFuture<SendCustomVerificationEmailResponse> {
    ...
    public func sendRawEmail(_ input: SendRawEmailRequest) throws -> EventLoopFuture<SendRawEmailResponse> {
    ...
    public func getIdentityMailFromDomainAttributes(_ input: GetIdentityMailFromDomainAttributesRequest) throws -> EventLoopFuture<GetIdentityMailFromDomainAttributesResponse> {
    ...
    public func deleteIdentity(_ input: DeleteIdentityRequest) throws -> EventLoopFuture<DeleteIdentityResponse> {
    ...
    public func setIdentityDkimEnabled(_ input: SetIdentityDkimEnabledRequest) throws -> EventLoopFuture<SetIdentityDkimEnabledResponse> {
    ...
    public func listIdentityPolicies(_ input: ListIdentityPoliciesRequest) throws -> EventLoopFuture<ListIdentityPoliciesResponse> {
    ...
    public func describeActiveReceiptRuleSet(_ input: DescribeActiveReceiptRuleSetRequest) throws -> EventLoopFuture<DescribeActiveReceiptRuleSetResponse> {
    ...
    public func listTemplates(_ input: ListTemplatesRequest) throws -> EventLoopFuture<ListTemplatesResponse> {
    ...
    public func verifyDomainDkim(_ input: VerifyDomainDkimRequest) throws -> EventLoopFuture<VerifyDomainDkimResponse> {
        return try client.send(operation: "VerifyDomainDkim", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deprecated. Use the ListIdentities operation to list the email addresses and domains associated with your account.
    public func listVerifiedEmailAddresses() throws -> EventLoopFuture<ListVerifiedEmailAddressesResponse> {
    ...
    public func sendEmail(_ input: SendEmailRequest) throws -> EventLoopFuture<SendEmailResponse> {
    ...
    public func deleteConfigurationSetEventDestination(_ input: DeleteConfigurationSetEventDestinationRequest) throws -> EventLoopFuture<DeleteConfigurationSetEventDestinationResponse> {
    ...
    public func setIdentityFeedbackForwardingEnabled(_ input: SetIdentityFeedbackForwardingEnabledRequest) throws -> EventLoopFuture<SetIdentityFeedbackForwardingEnabledResponse> {
    ...
    public func sendTemplatedEmail(_ input: SendTemplatedEmailRequest) throws -> EventLoopFuture<SendTemplatedEmailResponse> {
    ...
    public func getCustomVerificationEmailTemplate(_ input: GetCustomVerificationEmailTemplateRequest) throws -> EventLoopFuture<GetCustomVerificationEmailTemplateResponse> {
    ...
    public func getIdentityDkimAttributes(_ input: GetIdentityDkimAttributesRequest) throws -> EventLoopFuture<GetIdentityDkimAttributesResponse> {
    ...
    public func listIdentities(_ input: ListIdentitiesRequest) throws -> EventLoopFuture<ListIdentitiesResponse> {
    ...
    public func listReceiptFilters(_ input: ListReceiptFiltersRequest) throws -> EventLoopFuture<ListReceiptFiltersResponse> {
    ...
    public func updateTemplate(_ input: UpdateTemplateRequest) throws -> EventLoopFuture<UpdateTemplateResponse> {
    ...
    public func createConfigurationSetEventDestination(_ input: CreateConfigurationSetEventDestinationRequest) throws -> EventLoopFuture<CreateConfigurationSetEventDestinationResponse> {
    ...
    public func testRenderTemplate(_ input: TestRenderTemplateRequest) throws -> EventLoopFuture<TestRenderTemplateResponse> {
    ...
    public func deleteIdentityPolicy(_ input: DeleteIdentityPolicyRequest) throws -> EventLoopFuture<DeleteIdentityPolicyResponse> {
    ...
    public func listCustomVerificationEmailTemplates(_ input: ListCustomVerificationEmailTemplatesRequest) throws -> EventLoopFuture<ListCustomVerificationEmailTemplatesResponse> {
    ...
    public func getIdentityNotificationAttributes(_ input: GetIdentityNotificationAttributesRequest) throws -> EventLoopFuture<GetIdentityNotificationAttributesResponse> {
    ...
    public func sendBulkTemplatedEmail(_ input: SendBulkTemplatedEmailRequest) throws -> EventLoopFuture<SendBulkTemplatedEmailResponse> {
    ...
    public func deleteTemplate(_ input: DeleteTemplateRequest) throws -> EventLoopFuture<DeleteTemplateResponse> {
    ...
    public func verifyEmailIdentity(_ input: VerifyEmailIdentityRequest) throws -> EventLoopFuture<VerifyEmailIdentityResponse> {
    ...
    public func setActiveReceiptRuleSet(_ input: SetActiveReceiptRuleSetRequest) throws -> EventLoopFuture<SetActiveReceiptRuleSetResponse> {
    ...
    public func deleteReceiptFilter(_ input: DeleteReceiptFilterRequest) throws -> EventLoopFuture<DeleteReceiptFilterResponse> {
    ...
    public func describeReceiptRuleSet(_ input: DescribeReceiptRuleSetRequest) throws -> EventLoopFuture<DescribeReceiptRuleSetResponse> {
    ...
    public func createConfigurationSet(_ input: CreateConfigurationSetRequest) throws -> EventLoopFuture<CreateConfigurationSetResponse> {
    ...
    public func createReceiptRule(_ input: CreateReceiptRuleRequest) throws -> EventLoopFuture<CreateReceiptRuleResponse> {
    ...
    public func describeReceiptRule(_ input: DescribeReceiptRuleRequest) throws -> EventLoopFuture<DescribeReceiptRuleResponse> {
    ...
    public func putIdentityPolicy(_ input: PutIdentityPolicyRequest) throws -> EventLoopFuture<PutIdentityPolicyResponse> {
    ...
    public func createReceiptFilter(_ input: CreateReceiptFilterRequest) throws -> EventLoopFuture<CreateReceiptFilterResponse> {
