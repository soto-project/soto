...
public struct Chime {
    ...
    public func batchUpdateUser(_ input: BatchUpdateUserRequest) throws -> BatchUpdateUserResponse {
    ...
    public func inviteUsers(_ input: InviteUsersRequest) throws -> InviteUsersResponse {
