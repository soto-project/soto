...
extension Chime {
    ...
    public func listAttendeesPaginator(_ input: ListAttendeesRequest) -> EventLoopFuture<[Attendee]> {
        return client.paginate(input: input, command: listAttendees, resultKey: \ListAttendeesResponse.attendees, tokenKey: \ListAttendeesResponse.nextToken)
    }
    
    ///  Lists the bots associated with the administrator's Amazon Chime Enterprise account ID.
    public func listBotsPaginator(_ input: ListBotsRequest) -> EventLoopFuture<[Bot]> {
        return client.paginate(input: input, command: listBots, resultKey: \ListBotsResponse.bots, tokenKey: \ListBotsResponse.nextToken)
    }
    
    ///  Lists up to 100 active Amazon Chime SDK meetings. For more information about the Amazon Chime SDK, see Using the Amazon Chime SDK in the Amazon Chime Developer Guide.
    public func listMeetingsPaginator(_ input: ListMeetingsRequest) -> EventLoopFuture<[Meeting]> {
        return client.paginate(input: input, command: listMeetings, resultKey: \ListMeetingsResponse.meetings, tokenKey: \ListMeetingsResponse.nextToken)
    }
    ...
    public func listPhoneNumberOrdersPaginator(_ input: ListPhoneNumberOrdersRequest) -> EventLoopFuture<[PhoneNumberOrder]> {
        return client.paginate(input: input, command: listPhoneNumberOrders, resultKey: \ListPhoneNumberOrdersResponse.phoneNumberOrders, tokenKey: \ListPhoneNumberOrdersResponse.nextToken)
    }
    ...
    public func listPhoneNumbersPaginator(_ input: ListPhoneNumbersRequest) -> EventLoopFuture<[PhoneNumber]> {
        return client.paginate(input: input, command: listPhoneNumbers, resultKey: \ListPhoneNumbersResponse.phoneNumbers, tokenKey: \ListPhoneNumbersResponse.nextToken)
    }
    ...
    public func listRoomMembershipsPaginator(_ input: ListRoomMembershipsRequest) -> EventLoopFuture<[RoomMembership]> {
        return client.paginate(input: input, command: listRoomMemberships, resultKey: \ListRoomMembershipsResponse.roomMemberships, tokenKey: \ListRoomMembershipsResponse.nextToken)
    }
    ...
    public func listRoomsPaginator(_ input: ListRoomsRequest) -> EventLoopFuture<[Room]> {
        return client.paginate(input: input, command: listRooms, resultKey: \ListRoomsResponse.rooms, tokenKey: \ListRoomsResponse.nextToken)
    }
    ...
    public func listVoiceConnectorGroupsPaginator(_ input: ListVoiceConnectorGroupsRequest) -> EventLoopFuture<[VoiceConnectorGroup]> {
        return client.paginate(input: input, command: listVoiceConnectorGroups, resultKey: \ListVoiceConnectorGroupsResponse.voiceConnectorGroups, tokenKey: \ListVoiceConnectorGroupsResponse.nextToken)
    }
    ...
    public func listVoiceConnectorsPaginator(_ input: ListVoiceConnectorsRequest) -> EventLoopFuture<[VoiceConnector]> {
        return client.paginate(input: input, command: listVoiceConnectors, resultKey: \ListVoiceConnectorsResponse.voiceConnectors, tokenKey: \ListVoiceConnectorsResponse.nextToken)
    }
