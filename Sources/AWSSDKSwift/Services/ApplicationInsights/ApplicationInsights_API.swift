...
public struct ApplicationInsights: AWSService {
    ...
    public func createComponent(_ input: CreateComponentRequest) -> EventLoopFuture<CreateComponentResponse> {
        return client.execute(operation: "CreateComponent", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Adds an log pattern to a LogPatternSet.
    public func createLogPattern(_ input: CreateLogPatternRequest) -> EventLoopFuture<CreateLogPatternResponse> {
        return client.execute(operation: "CreateLogPattern", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteComponent(_ input: DeleteComponentRequest) -> EventLoopFuture<DeleteComponentResponse> {
        return client.execute(operation: "DeleteComponent", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Removes the specified log pattern from a LogPatternSet.
    public func deleteLogPattern(_ input: DeleteLogPatternRequest) -> EventLoopFuture<DeleteLogPatternResponse> {
        return client.execute(operation: "DeleteLogPattern", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeComponent(_ input: DescribeComponentRequest) -> EventLoopFuture<DescribeComponentResponse> {
        return client.execute(operation: "DescribeComponent", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeComponentConfiguration(_ input: DescribeComponentConfigurationRequest) -> EventLoopFuture<DescribeComponentConfigurationResponse> {
        return client.execute(operation: "DescribeComponentConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeComponentConfigurationRecommendation(_ input: DescribeComponentConfigurationRecommendationRequest) -> EventLoopFuture<DescribeComponentConfigurationRecommendationResponse> {
        return client.execute(operation: "DescribeComponentConfigurationRecommendation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describe a specific log pattern from a LogPatternSet.
    public func describeLogPattern(_ input: DescribeLogPatternRequest) -> EventLoopFuture<DescribeLogPatternResponse> {
        return client.execute(operation: "DescribeLogPattern", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes an anomaly or error with the application.
    public func describeObservation(_ input: DescribeObservationRequest) -> EventLoopFuture<DescribeObservationResponse> {
        return client.execute(operation: "DescribeObservation", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Describes an application problem.
    public func describeProblem(_ input: DescribeProblemRequest) -> EventLoopFuture<DescribeProblemResponse> {
        return client.execute(operation: "DescribeProblem", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeProblemObservations(_ input: DescribeProblemObservationsRequest) -> EventLoopFuture<DescribeProblemObservationsResponse> {
        return client.execute(operation: "DescribeProblemObservations", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listComponents(_ input: ListComponentsRequest) -> EventLoopFuture<ListComponentsResponse> {
        return client.execute(operation: "ListComponents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listConfigurationHistory(_ input: ListConfigurationHistoryRequest) -> EventLoopFuture<ListConfigurationHistoryResponse> {
        return client.execute(operation: "ListConfigurationHistory", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the log pattern sets in the specific application.
    public func listLogPatternSets(_ input: ListLogPatternSetsRequest) -> EventLoopFuture<ListLogPatternSetsResponse> {
        return client.execute(operation: "ListLogPatternSets", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the log patterns in the specific log LogPatternSet.
    public func listLogPatterns(_ input: ListLogPatternsRequest) -> EventLoopFuture<ListLogPatternsResponse> {
        return client.execute(operation: "ListLogPatterns", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Lists the problems with your application.
    public func listProblems(_ input: ListProblemsRequest) -> EventLoopFuture<ListProblemsResponse> {
        return client.execute(operation: "ListProblems", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateComponent(_ input: UpdateComponentRequest) -> EventLoopFuture<UpdateComponentResponse> {
        return client.execute(operation: "UpdateComponent", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateComponentConfiguration(_ input: UpdateComponentConfigurationRequest) -> EventLoopFuture<UpdateComponentConfigurationResponse> {
        return client.execute(operation: "UpdateComponentConfiguration", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Adds a log pattern to a LogPatternSet.
    public func updateLogPattern(_ input: UpdateLogPatternRequest) -> EventLoopFuture<UpdateLogPatternResponse> {
        return client.execute(operation: "UpdateLogPattern", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
