...
extension Detective {
    ...
    public struct MemberDetail: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "DisabledReason", required: false, type: .enum), 
            ...
            AWSShapeMember(label: "PercentOfGraphUtilization", required: false, type: .double), 
            AWSShapeMember(label: "PercentOfGraphUtilizationUpdatedTime", required: false, type: .timestamp), 
