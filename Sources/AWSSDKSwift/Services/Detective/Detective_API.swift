...
public struct Detective: AWSService {
    ...
    @discardableResult public func acceptInvitation(_ input: AcceptInvitationRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "AcceptInvitation", path: "/invitation", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func createGraph() -> EventLoopFuture<CreateGraphResponse> {
        return client.execute(operation: "CreateGraph", path: "/graph", httpMethod: .POST, config: self.config, context: self.context)
    }
    ...
    public func createMembers(_ input: CreateMembersRequest) -> EventLoopFuture<CreateMembersResponse> {
        return client.execute(operation: "CreateMembers", path: "/graph/members", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteGraph(_ input: DeleteGraphRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteGraph", path: "/graph/removal", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteMembers(_ input: DeleteMembersRequest) -> EventLoopFuture<DeleteMembersResponse> {
        return client.execute(operation: "DeleteMembers", path: "/graph/members/removal", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func disassociateMembership(_ input: DisassociateMembershipRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DisassociateMembership", path: "/membership/removal", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns the membership details for specified member accounts for a behavior graph.
    public func getMembers(_ input: GetMembersRequest) -> EventLoopFuture<GetMembersResponse> {
        return client.execute(operation: "GetMembers", path: "/graph/members/get", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listGraphs(_ input: ListGraphsRequest) -> EventLoopFuture<ListGraphsResponse> {
        return client.execute(operation: "ListGraphs", path: "/graphs/list", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listInvitations(_ input: ListInvitationsRequest) -> EventLoopFuture<ListInvitationsResponse> {
        return client.execute(operation: "ListInvitations", path: "/invitations/list", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves the list of member accounts for a behavior graph. Does not return member accounts that were removed from the behavior graph.
    public func listMembers(_ input: ListMembersRequest) -> EventLoopFuture<ListMembersResponse> {
        return client.execute(operation: "ListMembers", path: "/graph/members/list", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func rejectInvitation(_ input: RejectInvitationRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "RejectInvitation", path: "/invitation/removal", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func startMonitoringMember(_ input: StartMonitoringMemberRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "StartMonitoringMember", path: "/graph/member/monitoringstate", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
