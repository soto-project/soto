...
extension Support {
    ...
    public func describeCasesPaginator(_ input: DescribeCasesRequest) -> Future<[CaseDetails]> {
    ...
    public func describeCommunicationsPaginator(_ input: DescribeCommunicationsRequest) -> Future<[Communication]> {
