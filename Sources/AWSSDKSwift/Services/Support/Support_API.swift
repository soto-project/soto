...
public struct Support {
    ...
    public func describeTrustedAdvisorCheckSummaries(_ input: DescribeTrustedAdvisorCheckSummariesRequest) throws -> EventLoopFuture<DescribeTrustedAdvisorCheckSummariesResponse> {
    ...
    public func createCase(_ input: CreateCaseRequest) throws -> EventLoopFuture<CreateCaseResponse> {
        return try client.send(operation: "CreateCase", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the list of severity levels that you can assign to an AWS Support case. The severity level for a case is also a field in the CaseDetails data type included in any CreateCase request. 
    public func describeSeverityLevels(_ input: DescribeSeverityLevelsRequest) throws -> EventLoopFuture<DescribeSeverityLevelsResponse> {
    ...
    public func describeAttachment(_ input: DescribeAttachmentRequest) throws -> EventLoopFuture<DescribeAttachmentResponse> {
    ...
    public func addCommunicationToCase(_ input: AddCommunicationToCaseRequest) throws -> EventLoopFuture<AddCommunicationToCaseResponse> {
    ...
    public func refreshTrustedAdvisorCheck(_ input: RefreshTrustedAdvisorCheckRequest) throws -> EventLoopFuture<RefreshTrustedAdvisorCheckResponse> {
        return try client.send(operation: "RefreshTrustedAdvisorCheck", path: "/", httpMethod: "POST", input: input)
    }

    ///  Takes a caseId and returns the initial state of the case along with the state of the case after the call to ResolveCase completed.
    public func resolveCase(_ input: ResolveCaseRequest) throws -> EventLoopFuture<ResolveCaseResponse> {
    ...
    public func addAttachmentsToSet(_ input: AddAttachmentsToSetRequest) throws -> EventLoopFuture<AddAttachmentsToSetResponse> {
    ...
    public func describeTrustedAdvisorCheckResult(_ input: DescribeTrustedAdvisorCheckResultRequest) throws -> EventLoopFuture<DescribeTrustedAdvisorCheckResultResponse> {
    ...
    public func describeCommunications(_ input: DescribeCommunicationsRequest) throws -> EventLoopFuture<DescribeCommunicationsResponse> {
    ...
    public func describeCases(_ input: DescribeCasesRequest) throws -> EventLoopFuture<DescribeCasesResponse> {
    ...
    public func describeTrustedAdvisorChecks(_ input: DescribeTrustedAdvisorChecksRequest) throws -> EventLoopFuture<DescribeTrustedAdvisorChecksResponse> {
    ...
    public func describeTrustedAdvisorCheckRefreshStatuses(_ input: DescribeTrustedAdvisorCheckRefreshStatusesRequest) throws -> EventLoopFuture<DescribeTrustedAdvisorCheckRefreshStatusesResponse> {
