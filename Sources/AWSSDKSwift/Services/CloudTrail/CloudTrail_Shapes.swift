...
extension CloudTrail {
    ...
    public struct CreateTrailRequest: AWSShape {
        ...
        public init(s3KeyPrefix: String? = nil, snsTopicName: String? = nil, s3BucketName: String, cloudWatchLogsRoleArn: String? = nil, includeGlobalServiceEvents: Bool? = nil, enableLogFileValidation: Bool? = nil, isMultiRegionTrail: Bool? = nil, isOrganizationTrail: Bool? = nil, cloudWatchLogsLogGroupArn: String? = nil, name: String, kmsKeyId: String? = nil) {
    ...
    public struct LookupEventsRequest: AWSShape {
        ...
        public init(startTime: TimeStamp? = nil, nextToken: String? = nil, endTime: TimeStamp? = nil, maxResults: Int32? = nil, lookupAttributes: [LookupAttribute]? = nil) {
    ...
    public struct UpdateTrailResponse: AWSShape {
        ...
        public init(snsTopicARN: String? = nil, cloudWatchLogsRoleArn: String? = nil, includeGlobalServiceEvents: Bool? = nil, isMultiRegionTrail: Bool? = nil, cloudWatchLogsLogGroupArn: String? = nil, snsTopicName: String? = nil, kmsKeyId: String? = nil, name: String? = nil, s3BucketName: String? = nil, isOrganizationTrail: Bool? = nil, s3KeyPrefix: String? = nil, logFileValidationEnabled: Bool? = nil, trailARN: String? = nil) {
    ...
    public struct PublicKey: AWSShape {
        ...
        public init(fingerprint: String? = nil, validityEndTime: TimeStamp? = nil, value: Data? = nil, validityStartTime: TimeStamp? = nil) {
    ...
    public struct Trail: AWSShape {
        ...
        public init(s3BucketName: String? = nil, trailARN: String? = nil, includeGlobalServiceEvents: Bool? = nil, s3KeyPrefix: String? = nil, cloudWatchLogsRoleArn: String? = nil, snsTopicName: String? = nil, isOrganizationTrail: Bool? = nil, hasCustomEventSelectors: Bool? = nil, snsTopicARN: String? = nil, kmsKeyId: String? = nil, logFileValidationEnabled: Bool? = nil, homeRegion: String? = nil, isMultiRegionTrail: Bool? = nil, cloudWatchLogsLogGroupArn: String? = nil, name: String? = nil) {
            self.s3BucketName = s3BucketName
            self.trailARN = trailARN
            self.includeGlobalServiceEvents = includeGlobalServiceEvents
            self.s3KeyPrefix = s3KeyPrefix
    ...
    public struct UpdateTrailRequest: AWSShape {
        ...
        public init(s3KeyPrefix: String? = nil, isMultiRegionTrail: Bool? = nil, kmsKeyId: String? = nil, includeGlobalServiceEvents: Bool? = nil, s3BucketName: String? = nil, isOrganizationTrail: Bool? = nil, snsTopicName: String? = nil, cloudWatchLogsRoleArn: String? = nil, name: String, enableLogFileValidation: Bool? = nil, cloudWatchLogsLogGroupArn: String? = nil) {
            self.s3KeyPrefix = s3KeyPrefix
            self.isMultiRegionTrail = isMultiRegionTrail
            self.kmsKeyId = kmsKeyId
            self.includeGlobalServiceEvents = includeGlobalServiceEvents
    ...
    public struct GetTrailStatusResponse: AWSShape {
        ...
        public init(latestNotificationAttemptTime: String? = nil, latestDeliveryAttemptSucceeded: String? = nil, latestNotificationTime: TimeStamp? = nil, latestNotificationError: String? = nil, latestDigestDeliveryTime: TimeStamp? = nil, latestNotificationAttemptSucceeded: String? = nil, latestCloudWatchLogsDeliveryTime: TimeStamp? = nil, latestDeliveryTime: TimeStamp? = nil, latestDeliveryError: String? = nil, timeLoggingStopped: String? = nil, timeLoggingStarted: String? = nil, stopLoggingTime: TimeStamp? = nil, latestDeliveryAttemptTime: String? = nil, latestDigestDeliveryError: String? = nil, isLogging: Bool? = nil, startLoggingTime: TimeStamp? = nil, latestCloudWatchLogsDeliveryError: String? = nil) {
    ...
    public struct Event: AWSShape {
        ...
        public init(username: String? = nil, eventTime: TimeStamp? = nil, resources: [Resource]? = nil, cloudTrailEvent: String? = nil, accessKeyId: String? = nil, eventName: String? = nil, eventSource: String? = nil, readOnly: String? = nil, eventId: String? = nil) {
    ...
    public struct CreateTrailResponse: AWSShape {
        ...
        public init(snsTopicName: String? = nil, s3KeyPrefix: String? = nil, isMultiRegionTrail: Bool? = nil, logFileValidationEnabled: Bool? = nil, isOrganizationTrail: Bool? = nil, cloudWatchLogsRoleArn: String? = nil, cloudWatchLogsLogGroupArn: String? = nil, s3BucketName: String? = nil, kmsKeyId: String? = nil, includeGlobalServiceEvents: Bool? = nil, snsTopicARN: String? = nil, name: String? = nil, trailARN: String? = nil) {
            self.snsTopicName = snsTopicName
            self.s3KeyPrefix = s3KeyPrefix
            self.isMultiRegionTrail = isMultiRegionTrail
            self.logFileValidationEnabled = logFileValidationEnabled
