...
public struct CloudTrail {
    ...
    public func startLogging(_ input: StartLoggingRequest) throws -> EventLoopFuture<StartLoggingResponse> {
    ...
    public func updateTrail(_ input: UpdateTrailRequest) throws -> EventLoopFuture<UpdateTrailResponse> {
    ...
    public func listPublicKeys(_ input: ListPublicKeysRequest) throws -> EventLoopFuture<ListPublicKeysResponse> {
        return try client.send(operation: "ListPublicKeys", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a trail that specifies the settings for delivery of log data to an Amazon S3 bucket. A maximum of five trails can exist in a region, irrespective of the region in which they were created.
    public func createTrail(_ input: CreateTrailRequest) throws -> EventLoopFuture<CreateTrailResponse> {
        return try client.send(operation: "CreateTrail", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves settings for the trail associated with the current region for your account.
    public func describeTrails(_ input: DescribeTrailsRequest) throws -> EventLoopFuture<DescribeTrailsResponse> {
    ...
    public func getEventSelectors(_ input: GetEventSelectorsRequest) throws -> EventLoopFuture<GetEventSelectorsResponse> {
    ...
    public func addTags(_ input: AddTagsRequest) throws -> EventLoopFuture<AddTagsResponse> {
        return try client.send(operation: "AddTags", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a trail. This operation must be called from the region in which the trail was created. DeleteTrail cannot be called on the shadow trails (replicated trails in other regions) of a trail that is enabled in all regions.
    public func deleteTrail(_ input: DeleteTrailRequest) throws -> EventLoopFuture<DeleteTrailResponse> {
    ...
    public func putEventSelectors(_ input: PutEventSelectorsRequest) throws -> EventLoopFuture<PutEventSelectorsResponse> {
        return try client.send(operation: "PutEventSelectors", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes the specified tags from a trail.
    public func removeTags(_ input: RemoveTagsRequest) throws -> EventLoopFuture<RemoveTagsResponse> {
    ...
    public func stopLogging(_ input: StopLoggingRequest) throws -> EventLoopFuture<StopLoggingResponse> {
    ...
    public func lookupEvents(_ input: LookupEventsRequest) throws -> EventLoopFuture<LookupEventsResponse> {
    ...
    public func getTrailStatus(_ input: GetTrailStatusRequest) throws -> EventLoopFuture<GetTrailStatusResponse> {
