...
public struct CloudTrail {
    ...
    public func deleteTrail(_ input: DeleteTrailRequest) -> Future<DeleteTrailResponse> {
    ...
    public func getTrailStatus(_ input: GetTrailStatusRequest) -> Future<GetTrailStatusResponse> {
    ...
    public func listPublicKeys(_ input: ListPublicKeysRequest) -> Future<ListPublicKeysResponse> {
    ...
    public func removeTags(_ input: RemoveTagsRequest) -> Future<RemoveTagsResponse> {
    ...
    public func startLogging(_ input: StartLoggingRequest) -> Future<StartLoggingResponse> {
    ...
    public func stopLogging(_ input: StopLoggingRequest) -> Future<StopLoggingResponse> {
    ...
    public func updateTrail(_ input: UpdateTrailRequest) -> Future<UpdateTrailResponse> {
