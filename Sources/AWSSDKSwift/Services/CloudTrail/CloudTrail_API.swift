...
public struct CloudTrail: AWSService {
    ...
    public func createTrail(_ input: CreateTrailRequest) -> EventLoopFuture<CreateTrailResponse> {
        return client.execute(operation: "CreateTrail", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteTrail(_ input: DeleteTrailRequest) -> EventLoopFuture<DeleteTrailResponse> {
        return client.execute(operation: "DeleteTrail", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Retrieves settings for one or more trails associated with the current region for your account.
    public func describeTrails(_ input: DescribeTrailsRequest) -> EventLoopFuture<DescribeTrailsResponse> {
        return client.execute(operation: "DescribeTrails", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getEventSelectors(_ input: GetEventSelectorsRequest) -> EventLoopFuture<GetEventSelectorsResponse> {
        return client.execute(operation: "GetEventSelectors", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getInsightSelectors(_ input: GetInsightSelectorsRequest) -> EventLoopFuture<GetInsightSelectorsResponse> {
        return client.execute(operation: "GetInsightSelectors", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  Returns settings information for a specified trail.
    public func getTrail(_ input: GetTrailRequest) -> EventLoopFuture<GetTrailResponse> {
        return client.execute(operation: "GetTrail", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getTrailStatus(_ input: GetTrailStatusRequest) -> EventLoopFuture<GetTrailStatusResponse> {
        return client.execute(operation: "GetTrailStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listPublicKeys(_ input: ListPublicKeysRequest) -> EventLoopFuture<ListPublicKeysResponse> {
        return client.execute(operation: "ListPublicKeys", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTrails(_ input: ListTrailsRequest) -> EventLoopFuture<ListTrailsResponse> {
        return client.execute(operation: "ListTrails", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func lookupEvents(_ input: LookupEventsRequest) -> EventLoopFuture<LookupEventsResponse> {
        return client.execute(operation: "LookupEvents", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putEventSelectors(_ input: PutEventSelectorsRequest) -> EventLoopFuture<PutEventSelectorsResponse> {
        return client.execute(operation: "PutEventSelectors", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func putInsightSelectors(_ input: PutInsightSelectorsRequest) -> EventLoopFuture<PutInsightSelectorsResponse> {
        return client.execute(operation: "PutInsightSelectors", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startLogging(_ input: StartLoggingRequest) -> EventLoopFuture<StartLoggingResponse> {
        return client.execute(operation: "StartLogging", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func stopLogging(_ input: StopLoggingRequest) -> EventLoopFuture<StopLoggingResponse> {
        return client.execute(operation: "StopLogging", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateTrail(_ input: UpdateTrailRequest) -> EventLoopFuture<UpdateTrailResponse> {
        return client.execute(operation: "UpdateTrail", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
