...
extension CloudTrail {
    ...
    public func listPublicKeysPaginator(_ input: ListPublicKeysRequest) -> Future<[PublicKey]> {
        return client.paginate(input: input, command: listPublicKeys, resultKey: "publicKeyList", tokenKey: "nextToken")
    }
    
    ///  Lists the tags for the trail in the current region.
    public func listTagsPaginator(_ input: ListTagsRequest) -> Future<[ResourceTag]> {
        return client.paginate(input: input, command: listTags, resultKey: "resourceTagList", tokenKey: "nextToken")
    }
    
    ///  Lists trails that are in the current account.
    public func listTrailsPaginator(_ input: ListTrailsRequest) -> Future<[TrailInfo]> {
    ...
    public func lookupEventsPaginator(_ input: LookupEventsRequest) -> Future<[Event]> {
