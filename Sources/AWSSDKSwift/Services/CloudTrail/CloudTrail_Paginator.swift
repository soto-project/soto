...
extension CloudTrail {
    ...
    public func listPublicKeysPaginator(_ input: ListPublicKeysRequest) -> EventLoopFuture<[PublicKey]> {
        return client.paginate(input: input, command: listPublicKeys, resultKey: \ListPublicKeysResponse.publicKeyList, tokenKey: \ListPublicKeysResponse.nextToken)
    }
    
    ///  Lists the tags for the trail in the current region.
    public func listTagsPaginator(_ input: ListTagsRequest) -> EventLoopFuture<[ResourceTag]> {
        return client.paginate(input: input, command: listTags, resultKey: \ListTagsResponse.resourceTagList, tokenKey: \ListTagsResponse.nextToken)
    }
    
    ///  Lists trails that are in the current account.
    public func listTrailsPaginator(_ input: ListTrailsRequest) -> EventLoopFuture<[TrailInfo]> {
        return client.paginate(input: input, command: listTrails, resultKey: \ListTrailsResponse.trails, tokenKey: \ListTrailsResponse.nextToken)
    }
    ...
    public func lookupEventsPaginator(_ input: LookupEventsRequest) -> EventLoopFuture<[Event]> {
        return client.paginate(input: input, command: lookupEvents, resultKey: \LookupEventsResponse.events, tokenKey: \LookupEventsResponse.nextToken)
    }
