...
public struct SecurityHub {
    ...
    public init(accessKeyId: String? = nil, secretAccessKey: String? = nil, sessionToken: String? = nil, region: AWSSDKSwiftCore.Region? = nil, endpoint: String? = nil, middlewares: [AWSServiceMiddleware] = [], eventLoopGroupProvider: AWSClient.EventLoopGroupProvider = .useAWSClientShared) {
        self.client = AWSClient(
            ...
            endpoint: endpoint,
            serviceEndpoints: ["fips-us-east-1": "securityhub-fips.us-east-1.amazonaws.com", "fips-us-east-2": "securityhub-fips.us-east-2.amazonaws.com", "fips-us-west-1": "securityhub-fips.us-west-1.amazonaws.com", "fips-us-west-2": "securityhub-fips.us-west-2.amazonaws.com"],
    ...
    public func updateSecurityHubConfiguration(_ input: UpdateSecurityHubConfigurationRequest) -> EventLoopFuture<UpdateSecurityHubConfigurationResponse> {
        return client.send(operation: "UpdateSecurityHubConfiguration", path: "/accounts", httpMethod: "PATCH", input: input)
    }
