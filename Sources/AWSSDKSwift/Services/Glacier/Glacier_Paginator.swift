...
extension Glacier {
    ...
    public func listJobsPaginator(_ input: ListJobsInput) -> EventLoopFuture<[GlacierJobDescription]> {
        return client.paginate(input: input, command: listJobs, resultKey: "jobList", tokenKey: "marker")
    }
    ...
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsInput) -> EventLoopFuture<[UploadListElement]> {
        return client.paginate(input: input, command: listMultipartUploads, resultKey: "uploadsList", tokenKey: "marker")
    }
    ...
    public func listPartsPaginator(_ input: ListPartsInput) -> EventLoopFuture<[PartListElement]> {
        return client.paginate(input: input, command: listParts, resultKey: "parts", tokenKey: "marker")
    }
    ...
    public func listVaultsPaginator(_ input: ListVaultsInput) -> EventLoopFuture<[DescribeVaultOutput]> {
        return client.paginate(input: input, command: listVaults, resultKey: "vaultList", tokenKey: "marker")
    }
