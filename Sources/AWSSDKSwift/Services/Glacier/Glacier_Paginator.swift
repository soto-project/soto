...
extension Glacier {
    ...
    public func listJobsPaginator(_ input: ListJobsInput) -> EventLoopFuture<[GlacierJobDescription]> {
        return client.paginate(input: input, command: listJobs, resultKey: \ListJobsOutput.jobList, tokenKey: \ListJobsOutput.marker)
    }
    ...
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsInput) -> EventLoopFuture<[UploadListElement]> {
        return client.paginate(input: input, command: listMultipartUploads, resultKey: \ListMultipartUploadsOutput.uploadsList, tokenKey: \ListMultipartUploadsOutput.marker)
    }
    ...
    public func listPartsPaginator(_ input: ListPartsInput) -> EventLoopFuture<[PartListElement]> {
        return client.paginate(input: input, command: listParts, resultKey: \ListPartsOutput.parts, tokenKey: \ListPartsOutput.marker)
    }
    ...
    public func listVaultsPaginator(_ input: ListVaultsInput) -> EventLoopFuture<[DescribeVaultOutput]> {
        return client.paginate(input: input, command: listVaults, resultKey: \ListVaultsOutput.vaultList, tokenKey: \ListVaultsOutput.marker)
    }
