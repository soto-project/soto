...
extension Glacier {
    ...
    public func listJobsPaginator(_ input: ListJobsInput) -> Future<[GlacierJobDescription]> {
    ...
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsInput) -> Future<[UploadListElement]> {
    ...
    public func listPartsPaginator(_ input: ListPartsInput) -> Future<[PartListElement]> {
    ...
    public func listVaultsPaginator(_ input: ListVaultsInput) -> Future<[DescribeVaultOutput]> {
