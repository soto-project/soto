...
extension Glacier {
    ...
    public func listJobsPaginator(_ input: ListJobsInput, onPage: @escaping ([GlacierJobDescription], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listJobs, resultKey: \ListJobsOutput.jobList, tokenKey: \ListJobsOutput.marker, onPage: onPage)
    }
    ...
    public func listMultipartUploadsPaginator(_ input: ListMultipartUploadsInput, onPage: @escaping ([UploadListElement], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listMultipartUploads, resultKey: \ListMultipartUploadsOutput.uploadsList, tokenKey: \ListMultipartUploadsOutput.marker, onPage: onPage)
    }
    ...
    public func listPartsPaginator(_ input: ListPartsInput, onPage: @escaping ([PartListElement], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listParts, resultKey: \ListPartsOutput.parts, tokenKey: \ListPartsOutput.marker, onPage: onPage)
    }
    ...
    public func listVaultsPaginator(_ input: ListVaultsInput, onPage: @escaping ([DescribeVaultOutput], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listVaults, resultKey: \ListVaultsOutput.vaultList, tokenKey: \ListVaultsOutput.marker, onPage: onPage)
    }
