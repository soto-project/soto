...
extension Polly {
    ...
    public struct SynthesizeSpeechInput: AWSShape {
        ...
        public init(sampleRate: String? = nil, textType: TextType? = nil, lexiconNames: [String]? = nil, text: String, speechMarkTypes: [SpeechMarkType]? = nil, voiceId: VoiceId, languageCode: LanguageCode? = nil, outputFormat: OutputFormat) {
    ...
    public struct Voice: AWSShape {
        ...
        public init(name: String? = nil, languageName: String? = nil, gender: Gender? = nil, id: VoiceId? = nil, additionalLanguageCodes: [LanguageCode]? = nil, languageCode: LanguageCode? = nil) {
            self.name = name
    ...
    public struct StartSpeechSynthesisTaskInput: AWSShape {
        ...
        public init(sampleRate: String? = nil, textType: TextType? = nil, outputS3KeyPrefix: String? = nil, lexiconNames: [String]? = nil, text: String, speechMarkTypes: [SpeechMarkType]? = nil, snsTopicArn: String? = nil, outputS3BucketName: String, voiceId: VoiceId, languageCode: LanguageCode? = nil, outputFormat: OutputFormat) {
            self.sampleRate = sampleRate
            self.textType = textType
    ...
    public struct SynthesisTask: AWSShape {
        ...
        public init(taskStatusReason: String? = nil, taskId: String? = nil, languageCode: LanguageCode? = nil, sampleRate: String? = nil, speechMarkTypes: [SpeechMarkType]? = nil, outputFormat: OutputFormat? = nil, outputUri: String? = nil, voiceId: VoiceId? = nil, creationTime: TimeStamp? = nil, lexiconNames: [String]? = nil, requestCharacters: Int32? = nil, taskStatus: TaskStatus? = nil, snsTopicArn: String? = nil, textType: TextType? = nil) {
    ...
    public struct ListSpeechSynthesisTasksInput: AWSShape {
        ...
        public init(maxResults: Int32? = nil, status: TaskStatus? = nil, nextToken: String? = nil) {
    ...
    public struct LexiconAttributes: AWSShape {
        ...
        public init(lexemesCount: Int32? = nil, lexiconArn: String? = nil, lastModified: TimeStamp? = nil, size: Int32? = nil, alphabet: String? = nil, languageCode: LanguageCode? = nil) {
