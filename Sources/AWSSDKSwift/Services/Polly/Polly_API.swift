...
public struct Polly {
    ...
    public func describeVoices(_ input: DescribeVoicesInput) throws -> EventLoopFuture<DescribeVoicesOutput> {
    ...
    public func putLexicon(_ input: PutLexiconInput) throws -> EventLoopFuture<PutLexiconOutput> {
    ...
    public func listSpeechSynthesisTasks(_ input: ListSpeechSynthesisTasksInput) throws -> EventLoopFuture<ListSpeechSynthesisTasksOutput> {
    ...
    public func listLexicons(_ input: ListLexiconsInput) throws -> EventLoopFuture<ListLexiconsOutput> {
    ...
    public func synthesizeSpeech(_ input: SynthesizeSpeechInput) throws -> EventLoopFuture<SynthesizeSpeechOutput> {
        return try client.send(operation: "SynthesizeSpeech", path: "/v1/speech", httpMethod: "POST", input: input)
    }

    ///  Returns the content of the specified pronunciation lexicon stored in an AWS Region. For more information, see Managing Lexicons.
    public func getLexicon(_ input: GetLexiconInput) throws -> EventLoopFuture<GetLexiconOutput> {
    ...
    public func deleteLexicon(_ input: DeleteLexiconInput) throws -> EventLoopFuture<DeleteLexiconOutput> {
    ...
    public func startSpeechSynthesisTask(_ input: StartSpeechSynthesisTaskInput) throws -> EventLoopFuture<StartSpeechSynthesisTaskOutput> {
    ...
    public func getSpeechSynthesisTask(_ input: GetSpeechSynthesisTaskInput) throws -> EventLoopFuture<GetSpeechSynthesisTaskOutput> {
