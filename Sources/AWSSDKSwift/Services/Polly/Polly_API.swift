...
public struct Polly: AWSService {
    ...
    /// return new `Polly` with new timeout value
    ...
    /// return new `Polly` logging to specified Logger
    ...
    public func deleteLexicon(_ input: DeleteLexiconInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteLexiconOutput> {
        return client.execute(operation: "DeleteLexicon", path: "/v1/lexicons/{LexiconName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeVoices(_ input: DescribeVoicesInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeVoicesOutput> {
        return client.execute(operation: "DescribeVoices", path: "/v1/voices", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getLexicon(_ input: GetLexiconInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetLexiconOutput> {
        return client.execute(operation: "GetLexicon", path: "/v1/lexicons/{LexiconName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getSpeechSynthesisTask(_ input: GetSpeechSynthesisTaskInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetSpeechSynthesisTaskOutput> {
        return client.execute(operation: "GetSpeechSynthesisTask", path: "/v1/synthesisTasks/{TaskId}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listLexicons(_ input: ListLexiconsInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListLexiconsOutput> {
        return client.execute(operation: "ListLexicons", path: "/v1/lexicons", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listSpeechSynthesisTasks(_ input: ListSpeechSynthesisTasksInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListSpeechSynthesisTasksOutput> {
        return client.execute(operation: "ListSpeechSynthesisTasks", path: "/v1/synthesisTasks", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func putLexicon(_ input: PutLexiconInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PutLexiconOutput> {
        return client.execute(operation: "PutLexicon", path: "/v1/lexicons/{LexiconName}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startSpeechSynthesisTask(_ input: StartSpeechSynthesisTaskInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartSpeechSynthesisTaskOutput> {
        return client.execute(operation: "StartSpeechSynthesisTask", path: "/v1/synthesisTasks", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func synthesizeSpeech(_ input: SynthesizeSpeechInput, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SynthesizeSpeechOutput> {
        return client.execute(operation: "SynthesizeSpeech", path: "/v1/speech", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func synthesizeSpeechStreaming(_ input: SynthesizeSpeechInput, on eventLoop: EventLoop? = nil, _ stream: @escaping (ByteBuffer, EventLoop)->EventLoopFuture<Void>) -> EventLoopFuture<SynthesizeSpeechOutput> {
        return client.execute(operation: "SynthesizeSpeech", path: "/v1/speech", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop, stream: stream)
    }
}
