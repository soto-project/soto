...
extension KMS {
    ...
    public struct EncryptRequest: AWSShape {
        ...
        public init(encryptionContext: [String: String]? = nil, grantTokens: [String]? = nil, plaintext: Data, keyId: String) {
    ...
    public struct GetParametersForImportRequest: AWSShape {
        ...
        public init(wrappingKeySpec: WrappingKeySpec, keyId: String, wrappingAlgorithm: AlgorithmSpec) {
    ...
    public struct GrantListEntry: AWSShape {
        ...
        public init(constraints: GrantConstraints? = nil, operations: [GrantOperation]? = nil, keyId: String? = nil, creationDate: TimeStamp? = nil, granteePrincipal: String? = nil, grantId: String? = nil, issuingAccount: String? = nil, retiringPrincipal: String? = nil, name: String? = nil) {
    ...
    public struct AliasListEntry: AWSShape {
        ...
        public init(aliasName: String? = nil, targetKeyId: String? = nil, aliasArn: String? = nil) {
    ...
    public struct ReEncryptRequest: AWSShape {
        ...
        public init(destinationKeyId: String, destinationEncryptionContext: [String: String]? = nil, sourceEncryptionContext: [String: String]? = nil, grantTokens: [String]? = nil, ciphertextBlob: Data) {
    ...
    public struct CreateGrantRequest: AWSShape {
        ...
        public init(constraints: GrantConstraints? = nil, operations: [GrantOperation], grantTokens: [String]? = nil, keyId: String, granteePrincipal: String, retiringPrincipal: String? = nil, name: String? = nil) {
            self.constraints = constraints
            self.operations = operations
            self.grantTokens = grantTokens
            self.keyId = keyId
    ...
    public struct KeyMetadata: AWSShape {
        ...
        public init(arn: String? = nil, keyState: KeyState? = nil, keyManager: KeyManagerType? = nil, enabled: Bool? = nil, validTo: TimeStamp? = nil, creationDate: TimeStamp? = nil, keyId: String, expirationModel: ExpirationModelType? = nil, aWSAccountId: String? = nil, keyUsage: KeyUsageType? = nil, description: String? = nil, deletionDate: TimeStamp? = nil, origin: OriginType? = nil) {
            self.arn = arn
    ...
    public struct CreateKeyRequest: AWSShape {
        ...
        public init(policy: String? = nil, keyUsage: KeyUsageType? = nil, tags: [Tag]? = nil, bypassPolicyLockoutSafetyCheck: Bool? = nil, description: String? = nil, origin: OriginType? = nil) {
            self.policy = policy
            self.keyUsage = keyUsage
            self.tags = tags
    ...
    public struct ListGrantsResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, truncated: Bool? = nil, grants: [GrantListEntry]? = nil) {
            self.nextMarker = nextMarker
            self.truncated = truncated
            self.grants = grants
        }
    ...
    public struct ReEncryptResponse: AWSShape {
        ...
        public init(sourceKeyId: String? = nil, ciphertextBlob: Data? = nil, keyId: String? = nil) {
    ...
    public struct ImportKeyMaterialRequest: AWSShape {
        ...
        public init(importToken: Data, expirationModel: ExpirationModelType? = nil, encryptedKeyMaterial: Data, keyId: String, validTo: TimeStamp? = nil) {
    ...
    public struct GetParametersForImportResponse: AWSShape {
        ...
        public init(parametersValidTo: TimeStamp? = nil, importToken: Data? = nil, keyId: String? = nil, publicKey: Data? = nil) {
    ...
    public struct PutKeyPolicyRequest: AWSShape {
        ...
        public init(policy: String, bypassPolicyLockoutSafetyCheck: Bool? = nil, keyId: String, policyName: String) {
            self.policy = policy
            self.bypassPolicyLockoutSafetyCheck = bypassPolicyLockoutSafetyCheck
            self.keyId = keyId
            self.policyName = policyName
    ...
    public struct ListResourceTagsResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, truncated: Bool? = nil, tags: [Tag]? = nil) {
            self.nextMarker = nextMarker
            self.truncated = truncated
            self.tags = tags
        }
    ...
    public struct ListKeyPoliciesResponse: AWSShape {
        ...
        public init(policyNames: [String]? = nil, nextMarker: String? = nil, truncated: Bool? = nil) {
