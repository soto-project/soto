...
extension KMS {
    ...
    public struct CreateKeyRequest: AWSShape {
        ...
        public init(bypassPolicyLockoutSafetyCheck: Bool? = nil, keyUsage: KeyUsageType? = nil, origin: OriginType? = nil, customKeyStoreId: String? = nil, description: String? = nil, policy: String? = nil, tags: [Tag]? = nil) {
    ...
    public struct RetireGrantRequest: AWSShape {
        ...
        public init(grantId: String? = nil, keyId: String? = nil, grantToken: String? = nil) {
    ...
    public struct KeyMetadata: AWSShape {
        ...
        public init(deletionDate: TimeStamp? = nil, enabled: Bool? = nil, arn: String? = nil, expirationModel: ExpirationModelType? = nil, origin: OriginType? = nil, validTo: TimeStamp? = nil, cloudHsmClusterId: String? = nil, creationDate: TimeStamp? = nil, keyUsage: KeyUsageType? = nil, description: String? = nil, customKeyStoreId: String? = nil, keyId: String, keyManager: KeyManagerType? = nil, aWSAccountId: String? = nil, keyState: KeyState? = nil) {
    ...
    public struct CreateGrantRequest: AWSShape {
        ...
        public init(retiringPrincipal: String? = nil, grantTokens: [String]? = nil, constraints: GrantConstraints? = nil, keyId: String, operations: [GrantOperation], name: String? = nil, granteePrincipal: String) {
    ...
    public struct GrantListEntry: AWSShape {
        ...
        public init(creationDate: TimeStamp? = nil, retiringPrincipal: String? = nil, constraints: GrantConstraints? = nil, keyId: String? = nil, operations: [GrantOperation]? = nil, issuingAccount: String? = nil, grantId: String? = nil, name: String? = nil, granteePrincipal: String? = nil) {
            self.creationDate = creationDate
            self.retiringPrincipal = retiringPrincipal
            self.constraints = constraints
            self.keyId = keyId
    ...
    public struct PutKeyPolicyRequest: AWSShape {
        ...
        public init(keyId: String, policyName: String, policy: String, bypassPolicyLockoutSafetyCheck: Bool? = nil) {
            self.keyId = keyId
            self.policyName = policyName
            self.policy = policy
            self.bypassPolicyLockoutSafetyCheck = bypassPolicyLockoutSafetyCheck
    ...
    public struct CreateCustomKeyStoreRequest: AWSShape {
        ...
        public init(keyStorePassword: String, customKeyStoreName: String, cloudHsmClusterId: String, trustAnchorCertificate: String) {
    ...
    public struct DecryptRequest: AWSShape {
        ...
        public init(ciphertextBlob: Data, grantTokens: [String]? = nil, encryptionContext: [String: String]? = nil) {
            self.ciphertextBlob = ciphertextBlob
            self.grantTokens = grantTokens
    ...
    public struct GenerateRandomRequest: AWSShape {
        ...
        public init(numberOfBytes: Int32? = nil, customKeyStoreId: String? = nil) {
    ...
    public struct GetParametersForImportRequest: AWSShape {
        ...
        public init(wrappingAlgorithm: AlgorithmSpec, keyId: String, wrappingKeySpec: WrappingKeySpec) {
    ...
    public struct DescribeCustomKeyStoresRequest: AWSShape {
        ...
        public init(marker: String? = nil, limit: Int32? = nil, customKeyStoreName: String? = nil, customKeyStoreId: String? = nil) {
            self.marker = marker
            self.limit = limit
            self.customKeyStoreName = customKeyStoreName
            self.customKeyStoreId = customKeyStoreId
    ...
    public struct ListAliasesRequest: AWSShape {
        ...
        public init(limit: Int32? = nil, marker: String? = nil, keyId: String? = nil) {
            self.limit = limit
            self.marker = marker
            self.keyId = keyId
        }
    ...
    public struct GenerateDataKeyWithoutPlaintextRequest: AWSShape {
        ...
        public init(numberOfBytes: Int32? = nil, keyId: String, keySpec: DataKeySpec? = nil, grantTokens: [String]? = nil, encryptionContext: [String: String]? = nil) {
            self.numberOfBytes = numberOfBytes
            self.keyId = keyId
    ...
    public struct GetParametersForImportResponse: AWSShape {
        ...
        public init(parametersValidTo: TimeStamp? = nil, keyId: String? = nil, publicKey: Data? = nil, importToken: Data? = nil) {
    ...
    public struct UpdateAliasRequest: AWSShape {
        ...
        public init(targetKeyId: String, aliasName: String) {
    ...
    public struct ImportKeyMaterialRequest: AWSShape {
        ...
        public init(encryptedKeyMaterial: Data, expirationModel: ExpirationModelType? = nil, keyId: String, importToken: Data, validTo: TimeStamp? = nil) {
    ...
    public struct ListAliasesResponse: AWSShape {
        ...
        public init(truncated: Bool? = nil, aliases: [AliasListEntry]? = nil, nextMarker: String? = nil) {
            self.truncated = truncated
    ...
    public struct ReEncryptRequest: AWSShape {
        ...
        public init(sourceEncryptionContext: [String: String]? = nil, ciphertextBlob: Data, destinationEncryptionContext: [String: String]? = nil, grantTokens: [String]? = nil, destinationKeyId: String) {
    ...
    public struct DescribeCustomKeyStoresResponse: AWSShape {
        ...
        public init(truncated: Bool? = nil, customKeyStores: [CustomKeyStoresListEntry]? = nil, nextMarker: String? = nil) {
            self.truncated = truncated
    ...
    public struct EncryptRequest: AWSShape {
        ...
        public init(keyId: String, plaintext: Data, encryptionContext: [String: String]? = nil, grantTokens: [String]? = nil) {
            self.keyId = keyId
            self.plaintext = plaintext
            self.encryptionContext = encryptionContext
            self.grantTokens = grantTokens
    ...
    public struct UpdateCustomKeyStoreRequest: AWSShape {
        ...
        public init(keyStorePassword: String? = nil, newCustomKeyStoreName: String? = nil, cloudHsmClusterId: String? = nil, customKeyStoreId: String) {
            self.keyStorePassword = keyStorePassword
    ...
    public struct CustomKeyStoresListEntry: AWSShape {
        ...
        public init(creationDate: TimeStamp? = nil, cloudHsmClusterId: String? = nil, trustAnchorCertificate: String? = nil, customKeyStoreId: String? = nil, connectionState: ConnectionStateType? = nil, customKeyStoreName: String? = nil, connectionErrorCode: ConnectionErrorCodeType? = nil) {
            self.creationDate = creationDate
            self.cloudHsmClusterId = cloudHsmClusterId
            self.trustAnchorCertificate = trustAnchorCertificate
            self.customKeyStoreId = customKeyStoreId
