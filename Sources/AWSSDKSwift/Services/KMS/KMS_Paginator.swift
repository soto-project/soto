...
extension KMS {
    ...
    public func listAliasesPaginator(_ input: ListAliasesRequest) -> Future<[AliasListEntry]> {
    ...
    public func listGrantsPaginator(_ input: ListGrantsRequest) -> Future<[GrantListEntry]> {
    ...
    public func listKeyPoliciesPaginator(_ input: ListKeyPoliciesRequest) -> Future<[String]> {
        return client.paginate(input: input, command: listKeyPolicies, resultKey: "policyNames", tokenKey: "nextMarker")
    }
    
    ///  Gets a list of all customer master keys (CMKs) in the caller's AWS account and Region.
    public func listKeysPaginator(_ input: ListKeysRequest) -> Future<[KeyListEntry]> {
