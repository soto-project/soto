...
extension KMS {
    ...
    public func listGrantsPaginator(_ input: ListGrantsRequest) -> EventLoopFuture<[GrantListEntry]> {
        return client.paginate(input: input, command: listGrants, resultKey: \ListGrantsResponse.grants, tokenKey: \ListGrantsResponse.nextMarker)
    }
    ...
    public func listKeyPoliciesPaginator(_ input: ListKeyPoliciesRequest) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: listKeyPolicies, resultKey: \ListKeyPoliciesResponse.policyNames, tokenKey: \ListKeyPoliciesResponse.nextMarker)
    }
    
    ///  Gets a list of all customer master keys (CMKs) in the caller's AWS account and Region.
    public func listKeysPaginator(_ input: ListKeysRequest) -> EventLoopFuture<[KeyListEntry]> {
        return client.paginate(input: input, command: listKeys, resultKey: \ListKeysResponse.keys, tokenKey: \ListKeysResponse.nextMarker)
    }
