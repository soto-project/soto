...
public struct AutoScalingPlans {
    ...
    public func createScalingPlan(_ input: CreateScalingPlanRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateScalingPlanResponse> {
    ...
    public func deleteScalingPlan(_ input: DeleteScalingPlanRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteScalingPlanResponse> {
    ...
    public func describeScalingPlanResources(_ input: DescribeScalingPlanResourcesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeScalingPlanResourcesResponse> {
    ...
    public func describeScalingPlans(_ input: DescribeScalingPlansRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeScalingPlansResponse> {
    ...
    public func getScalingPlanResourceForecastData(_ input: GetScalingPlanResourceForecastDataRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetScalingPlanResourceForecastDataResponse> {
    ...
    public func updateScalingPlan(_ input: UpdateScalingPlanRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateScalingPlanResponse> {
