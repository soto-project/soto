...
public struct AutoScalingPlans {
    ...
    public func updateScalingPlan(_ input: UpdateScalingPlanRequest) throws -> EventLoopFuture<UpdateScalingPlanResponse> {
        return try client.send(operation: "UpdateScalingPlan", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the scalable resources in the specified scaling plan.
    public func describeScalingPlanResources(_ input: DescribeScalingPlanResourcesRequest) throws -> EventLoopFuture<DescribeScalingPlanResourcesResponse> {
        return try client.send(operation: "DescribeScalingPlanResources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a scaling plan.
    public func createScalingPlan(_ input: CreateScalingPlanRequest) throws -> EventLoopFuture<CreateScalingPlanResponse> {
    ...
    public func deleteScalingPlan(_ input: DeleteScalingPlanRequest) throws -> EventLoopFuture<DeleteScalingPlanResponse> {
    ...
    public func getScalingPlanResourceForecastData(_ input: GetScalingPlanResourceForecastDataRequest) throws -> EventLoopFuture<GetScalingPlanResourceForecastDataResponse> {
        return try client.send(operation: "GetScalingPlanResourceForecastData", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your scaling plans.
    public func describeScalingPlans(_ input: DescribeScalingPlansRequest) throws -> EventLoopFuture<DescribeScalingPlansResponse> {
