...
public struct AutoScalingPlans {
    ...
    public func createScalingPlan(_ input: CreateScalingPlanRequest) -> Future<CreateScalingPlanResponse> {
    ...
    public func deleteScalingPlan(_ input: DeleteScalingPlanRequest) -> Future<DeleteScalingPlanResponse> {
        return client.send(operation: "DeleteScalingPlan", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the scalable resources in the specified scaling plan.
    public func describeScalingPlanResources(_ input: DescribeScalingPlanResourcesRequest) -> Future<DescribeScalingPlanResourcesResponse> {
        return client.send(operation: "DescribeScalingPlanResources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your scaling plans.
    public func describeScalingPlans(_ input: DescribeScalingPlansRequest) -> Future<DescribeScalingPlansResponse> {
    ...
    public func getScalingPlanResourceForecastData(_ input: GetScalingPlanResourceForecastDataRequest) -> Future<GetScalingPlanResourceForecastDataResponse> {
    ...
    public func updateScalingPlan(_ input: UpdateScalingPlanRequest) -> Future<UpdateScalingPlanResponse> {
