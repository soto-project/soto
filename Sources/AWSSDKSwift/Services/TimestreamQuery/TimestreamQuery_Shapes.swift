...
extension TimestreamQuery {
    ...
    public struct CancelQueryRequest: AWSShape {
        ...
        public func validate(name: String) throws {
            try validate(self.queryId, name:"queryId", parent: name, max: 64)
            try validate(self.queryId, name:"queryId", parent: name, min: 1)
            try validate(self.queryId, name:"queryId", parent: name, pattern: "[a-zA-Z0-9]+")
        }
    ...
    public struct CancelQueryResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "CancellationMessage", required: false, type: .string)
        ]
    ...
    public class ColumnInfo: AWSShape {
        public static var _members: [AWSShapeMember] = [
    ...
    public class Datum: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ArrayValue", required: false, type: .list), 
            AWSShapeMember(label: "NullValue", required: false, type: .boolean), 
            AWSShapeMember(label: "RowValue", required: false, type: .structure), 
            AWSShapeMember(label: "ScalarValue", required: false, type: .string), 
            AWSShapeMember(label: "TimeSeriesValue", required: false, type: .list)
        ]
    ...
    public struct QueryRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "MaxRows", required: false, type: .integer), 
        ...
        public func validate(name: String) throws {
            ...
            try validate(self.clientToken, name:"clientToken", parent: name, min: 32)
            try validate(self.maxRows, name:"maxRows", parent: name, max: 1000)
    ...
    public struct QueryResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ColumnInfo", required: true, type: .list), 
            AWSShapeMember(label: "NextToken", required: false, type: .string), 
            AWSShapeMember(label: "QueryId", required: true, type: .string), 
    ...
    public struct Row: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Data", required: true, type: .list)
        ]
    ...
    public class TimeSeriesDataPoint: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "Time", required: true, type: .string), 
    ...
    public class `Type`: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "ArrayColumnInfo", required: false, type: .structure), 
            AWSShapeMember(label: "RowColumnInfo", required: false, type: .list), 
            AWSShapeMember(label: "ScalarType", required: false, type: .enum), 
            AWSShapeMember(label: "TimeSeriesMeasureValueColumnInfo", required: false, type: .structure)
        ]
