...
public struct DataPipeline {
    ...
    public func deactivatePipeline(_ input: DeactivatePipelineInput) throws -> EventLoopFuture<DeactivatePipelineOutput> {
    ...
    public func reportTaskRunnerHeartbeat(_ input: ReportTaskRunnerHeartbeatInput) throws -> EventLoopFuture<ReportTaskRunnerHeartbeatOutput> {
        return try client.send(operation: "ReportTaskRunnerHeartbeat", path: "/", httpMethod: "POST", input: input)
    }

    ///  Validates the specified pipeline definition to ensure that it is well formed and can be run without error.
    public func validatePipelineDefinition(_ input: ValidatePipelineDefinitionInput) throws -> EventLoopFuture<ValidatePipelineDefinitionOutput> {
    ...
    public func reportTaskProgress(_ input: ReportTaskProgressInput) throws -> EventLoopFuture<ReportTaskProgressOutput> {
        return try client.send(operation: "ReportTaskProgress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the object definitions for a set of objects associated with the pipeline. Object definitions are composed of a set of fields that define the properties of the object.
    public func describeObjects(_ input: DescribeObjectsInput) throws -> EventLoopFuture<DescribeObjectsOutput> {
        return try client.send(operation: "DescribeObjects", path: "/", httpMethod: "POST", input: input)
    }

    ///  Task runners call EvaluateExpression to evaluate a string in the context of the specified object. For example, a task runner can evaluate SQL queries stored in Amazon S3.
    public func evaluateExpression(_ input: EvaluateExpressionInput) throws -> EventLoopFuture<EvaluateExpressionOutput> {
        return try client.send(operation: "EvaluateExpression", path: "/", httpMethod: "POST", input: input)
    }

    ///  Queries the specified pipeline for the names of objects that match the specified set of conditions.
    public func queryObjects(_ input: QueryObjectsInput) throws -> EventLoopFuture<QueryObjectsOutput> {
    ...
    public func setTaskStatus(_ input: SetTaskStatusInput) throws -> EventLoopFuture<SetTaskStatusOutput> {
    ...
    public func activatePipeline(_ input: ActivatePipelineInput) throws -> EventLoopFuture<ActivatePipelineOutput> {
    ...
    public func pollForTask(_ input: PollForTaskInput) throws -> EventLoopFuture<PollForTaskOutput> {
    ...
    public func putPipelineDefinition(_ input: PutPipelineDefinitionInput) throws -> EventLoopFuture<PutPipelineDefinitionOutput> {
        return try client.send(operation: "PutPipelineDefinition", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the definition of the specified pipeline. You can call GetPipelineDefinition to retrieve the pipeline definition that you provided using PutPipelineDefinition.
    public func getPipelineDefinition(_ input: GetPipelineDefinitionInput) throws -> EventLoopFuture<GetPipelineDefinitionOutput> {
    ...
    public func describePipelines(_ input: DescribePipelinesInput) throws -> EventLoopFuture<DescribePipelinesOutput> {
        return try client.send(operation: "DescribePipelines", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes existing tags from the specified pipeline.
    public func removeTags(_ input: RemoveTagsInput) throws -> EventLoopFuture<RemoveTagsOutput> {
