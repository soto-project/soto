...
extension DataPipeline {
    ...
    public struct PipelineDescription: AWSShape {
        ...
        public init(description: String? = nil, pipelineId: String, name: String, tags: [Tag]? = nil, fields: [Field]) {
    ...
    public struct PollForTaskInput: AWSShape {
        ...
        public init(instanceIdentity: InstanceIdentity? = nil, hostname: String? = nil, workerGroup: String) {
    ...
    public struct ValidatePipelineDefinitionInput: AWSShape {
        ...
        public init(pipelineId: String, parameterValues: [ParameterValue]? = nil, pipelineObjects: [PipelineObject], parameterObjects: [ParameterObject]? = nil) {
            self.pipelineId = pipelineId
            self.parameterValues = parameterValues
            self.pipelineObjects = pipelineObjects
            self.parameterObjects = parameterObjects
    ...
    public struct QueryObjectsOutput: AWSShape {
        ...
        public init(hasMoreResults: Bool? = nil, marker: String? = nil, ids: [String]? = nil) {
            self.hasMoreResults = hasMoreResults
            self.marker = marker
            self.ids = ids
        }
    ...
    public struct ListPipelinesOutput: AWSShape {
        ...
        public init(hasMoreResults: Bool? = nil, pipelineIdList: [PipelineIdName], marker: String? = nil) {
            self.hasMoreResults = hasMoreResults
    ...
    public struct QueryObjectsInput: AWSShape {
        ...
        public init(pipelineId: String, query: Query? = nil, limit: Int32? = nil, sphere: String, marker: String? = nil) {
            self.pipelineId = pipelineId
            self.query = query
            self.limit = limit
            self.sphere = sphere
    ...
    public struct PipelineObject: AWSShape {
        ...
        public init(id: String, fields: [Field], name: String) {
            self.id = id
            self.fields = fields
            self.name = name
        }
    ...
    public struct Field: AWSShape {
        ...
        public init(stringValue: String? = nil, refValue: String? = nil, key: String) {
    ...
    public struct ParameterAttribute: AWSShape {
        ...
        public init(stringValue: String, key: String) {
            self.stringValue = stringValue
            self.key = key
        }
    ...
    public struct ReportTaskRunnerHeartbeatInput: AWSShape {
        ...
        public init(taskrunnerId: String, hostname: String? = nil, workerGroup: String? = nil) {
    ...
    public struct CreatePipelineInput: AWSShape {
        ...
        public init(description: String? = nil, uniqueId: String, name: String, tags: [Tag]? = nil) {
            self.description = description
    ...
    public struct SetTaskStatusInput: AWSShape {
        ...
        public init(errorMessage: String? = nil, errorStackTrace: String? = nil, taskStatus: TaskStatus, errorId: String? = nil, taskId: String) {
