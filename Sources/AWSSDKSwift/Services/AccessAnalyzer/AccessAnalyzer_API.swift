...
public struct AccessAnalyzer {
    ...
    @discardableResult public func applyArchiveRule(_ input: ApplyArchiveRuleRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "ApplyArchiveRule", path: "/archive-rule", httpMethod: "PUT", input: input)
    }
