...
public struct AccessAnalyzer {
    ...
    public func createAnalyzer(_ input: CreateAnalyzerRequest) -> Future<CreateAnalyzerResponse> {
    ...
    @discardableResult public func createArchiveRule(_ input: CreateArchiveRuleRequest) -> Future<Void> {
    ...
    @discardableResult public func deleteAnalyzer(_ input: DeleteAnalyzerRequest) -> Future<Void> {
        return client.send(operation: "DeleteAnalyzer", path: "/analyzer/{analyzerName}", httpMethod: "DELETE", input: input)
    }

    ///  Deletes the specified archive rule.
    @discardableResult public func deleteArchiveRule(_ input: DeleteArchiveRuleRequest) -> Future<Void> {
    ...
    public func getAnalyzedResource(_ input: GetAnalyzedResourceRequest) -> Future<GetAnalyzedResourceResponse> {
        return client.send(operation: "GetAnalyzedResource", path: "/analyzed-resource", httpMethod: "GET", input: input)
    }

    ///  Retrieves information about the specified analyzer.
    public func getAnalyzer(_ input: GetAnalyzerRequest) -> Future<GetAnalyzerResponse> {
        return client.send(operation: "GetAnalyzer", path: "/analyzer/{analyzerName}", httpMethod: "GET", input: input)
    }

    ///  Retrieves information about an archive rule.
    public func getArchiveRule(_ input: GetArchiveRuleRequest) -> Future<GetArchiveRuleResponse> {
    ...
    public func getFinding(_ input: GetFindingRequest) -> Future<GetFindingResponse> {
        return client.send(operation: "GetFinding", path: "/finding/{id}", httpMethod: "GET", input: input)
    }

    ///  Retrieves a list of resources of the specified type that have been analyzed by the specified analyzer..
    public func listAnalyzedResources(_ input: ListAnalyzedResourcesRequest) -> Future<ListAnalyzedResourcesResponse> {
        return client.send(operation: "ListAnalyzedResources", path: "/analyzed-resource", httpMethod: "POST", input: input)
    }

    ///  Retrieves a list of analyzers.
    public func listAnalyzers(_ input: ListAnalyzersRequest) -> Future<ListAnalyzersResponse> {
        return client.send(operation: "ListAnalyzers", path: "/analyzer", httpMethod: "GET", input: input)
    }

    ///  Retrieves a list of archive rules created for the specified analyzer.
    public func listArchiveRules(_ input: ListArchiveRulesRequest) -> Future<ListArchiveRulesResponse> {
    ...
    @discardableResult public func startResourceScan(_ input: StartResourceScanRequest) -> Future<Void> {
    ...
    @discardableResult public func updateArchiveRule(_ input: UpdateArchiveRuleRequest) -> Future<Void> {
    ...
    @discardableResult public func updateFindings(_ input: UpdateFindingsRequest) -> Future<Void> {
