...
public struct AccessAnalyzer: AWSService {
    ...
    /// return new `AccessAnalyzer` with new timeout value
    ...
    /// return new `AccessAnalyzer` logging to specified Logger
    ...
    public func createAnalyzer(_ input: CreateAnalyzerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateAnalyzerResponse> {
        return client.execute(operation: "CreateAnalyzer", path: "/analyzer", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func createArchiveRule(_ input: CreateArchiveRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateArchiveRule", path: "/analyzer/{analyzerName}/archive-rule", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteAnalyzer(_ input: DeleteAnalyzerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAnalyzer", path: "/analyzer/{analyzerName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteArchiveRule(_ input: DeleteArchiveRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteArchiveRule", path: "/analyzer/{analyzerName}/archive-rule/{ruleName}", httpMethod: .DELETE, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getAnalyzedResource(_ input: GetAnalyzedResourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAnalyzedResourceResponse> {
        return client.execute(operation: "GetAnalyzedResource", path: "/analyzed-resource", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getAnalyzer(_ input: GetAnalyzerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAnalyzerResponse> {
        return client.execute(operation: "GetAnalyzer", path: "/analyzer/{analyzerName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func getArchiveRule(_ input: GetArchiveRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetArchiveRuleResponse> {
        return client.execute(operation: "GetArchiveRule", path: "/analyzer/{analyzerName}/archive-rule/{ruleName}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }

    ///  Retrieves information about the specified finding.
    public func getFinding(_ input: GetFindingRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetFindingResponse> {
        return client.execute(operation: "GetFinding", path: "/finding/{id}", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listAnalyzedResources(_ input: ListAnalyzedResourcesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAnalyzedResourcesResponse> {
        return client.execute(operation: "ListAnalyzedResources", path: "/analyzed-resource", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listAnalyzers(_ input: ListAnalyzersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListAnalyzersResponse> {
        return client.execute(operation: "ListAnalyzers", path: "/analyzer", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listArchiveRules(_ input: ListArchiveRulesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListArchiveRulesResponse> {
        return client.execute(operation: "ListArchiveRules", path: "/analyzer/{analyzerName}/archive-rule", httpMethod: .GET, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func listFindings(_ input: ListFindingsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListFindingsResponse> {
        return client.execute(operation: "ListFindings", path: "/finding", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func startResourceScan(_ input: StartResourceScanRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "StartResourceScan", path: "/resource/scan", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func updateArchiveRule(_ input: UpdateArchiveRuleRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateArchiveRule", path: "/analyzer/{analyzerName}/archive-rule/{ruleName}", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func updateFindings(_ input: UpdateFindingsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "UpdateFindings", path: "/finding", httpMethod: .PUT, serviceContext: context, input: input, on: eventLoop)
    }
}
