...
extension Kinesisvideo {
    ...
    public struct CreateStreamInput: AWSShape {
        ...
        public init(dataRetentionInHours: Int32? = nil, mediaType: String? = nil, streamName: String, deviceName: String? = nil, kmsKeyId: String? = nil) {
    ...
    public struct UpdateStreamInput: AWSShape {
        ...
        public init(streamARN: String? = nil, mediaType: String? = nil, streamName: String? = nil, deviceName: String? = nil, currentVersion: String) {
            self.streamARN = streamARN
            self.mediaType = mediaType
            self.streamName = streamName
            self.deviceName = deviceName
    ...
    public struct StreamInfo: AWSShape {
        ...
        public init(dataRetentionInHours: Int32? = nil, status: Status? = nil, streamARN: String? = nil, version: String? = nil, creationTime: TimeStamp? = nil, streamName: String? = nil, mediaType: String? = nil, deviceName: String? = nil, kmsKeyId: String? = nil) {
            self.dataRetentionInHours = dataRetentionInHours
            self.status = status
            self.streamARN = streamARN
    ...
    public struct UpdateDataRetentionInput: AWSShape {
        ...
        public init(dataRetentionChangeInHours: Int32, streamARN: String? = nil, streamName: String? = nil, operation: UpdateDataRetentionOperation, currentVersion: String) {
    ...
    public struct ListStreamsInput: AWSShape {
        ...
        public init(streamNameCondition: StreamNameCondition? = nil, nextToken: String? = nil, maxResults: Int32? = nil) {
