...
extension Swf {
    ...
    public struct WorkflowExecutionInfo: AWSShape {
        ...
        public init(execution: WorkflowExecution, startTimestamp: TimeStamp, parent: WorkflowExecution? = nil, tagList: [String]? = nil, cancelRequested: Bool? = nil, closeTimestamp: TimeStamp? = nil, closeStatus: CloseStatus? = nil, workflowType: WorkflowType, executionStatus: ExecutionStatus) {
    ...
    public struct LambdaFunctionScheduledEventAttributes: AWSShape {
        ...
        public init(name: String, input: String? = nil, startToCloseTimeout: String? = nil, id: String, decisionTaskCompletedEventId: Int64, control: String? = nil) {
            self.name = name
            self.input = input
            self.startToCloseTimeout = startToCloseTimeout
            self.id = id
    ...
    public struct ScheduleLambdaFunctionDecisionAttributes: AWSShape {
        ...
        public init(name: String, input: String? = nil, startToCloseTimeout: String? = nil, id: String, control: String? = nil) {
            self.name = name
            self.input = input
            self.startToCloseTimeout = startToCloseTimeout
            self.id = id
    ...
    public struct WorkflowExecutionDetail: AWSShape {
        ...
        public init(openCounts: WorkflowExecutionOpenCounts, executionInfo: WorkflowExecutionInfo, latestActivityTaskTimestamp: TimeStamp? = nil, executionConfiguration: WorkflowExecutionConfiguration, latestExecutionContext: String? = nil) {
