...
extension CloudFront {
    ...
    public struct Distribution: AWSShape {
        ...
        public init(id: String, lastModifiedTime: TimeStamp, status: String, distributionConfig: DistributionConfig, inProgressInvalidationBatches: Int32, domainName: String, arn: String, activeTrustedSigners: ActiveTrustedSigners) {
            self.id = id
    ...
    public struct InvalidationSummary: AWSShape {
        ...
        public init(status: String, id: String, createTime: TimeStamp) {
            self.status = status
            self.id = id
    ...
    public struct StreamingDistributionConfig: AWSShape {
        ...
        public init(comment: String, callerReference: String, s3Origin: S3Origin, aliases: Aliases? = nil, logging: StreamingLoggingConfig? = nil, priceClass: PriceClass? = nil, enabled: Bool, trustedSigners: TrustedSigners) {
    ...
    public struct FieldLevelEncryptionConfig: AWSShape {
        ...
        public init(callerReference: String, contentTypeProfileConfig: ContentTypeProfileConfig? = nil, comment: String? = nil, queryArgProfileConfig: QueryArgProfileConfig? = nil) {
            self.callerReference = callerReference
    ...
    public struct DistributionSummary: AWSShape {
        ...
        public init(enabled: Bool, defaultCacheBehavior: DefaultCacheBehavior, restrictions: Restrictions, aliases: Aliases, lastModifiedTime: TimeStamp, id: String, isIPV6Enabled: Bool, cacheBehaviors: CacheBehaviors, domainName: String, viewerCertificate: ViewerCertificate, priceClass: PriceClass, customErrorResponses: CustomErrorResponses, originGroups: OriginGroups? = nil, status: String, origins: Origins, comment: String, httpVersion: HttpVersion, arn: String, webACLId: String) {
            self.enabled = enabled
    ...
    public struct CustomOriginConfig: AWSShape {
        ...
        public init(originSslProtocols: OriginSslProtocols? = nil, hTTPSPort: Int32, originReadTimeout: Int32? = nil, originKeepaliveTimeout: Int32? = nil, originProtocolPolicy: OriginProtocolPolicy, hTTPPort: Int32) {
    ...
    public struct StreamingDistributionList: AWSShape {
        ...
        public init(marker: String, quantity: Int32, isTruncated: Bool, maxItems: Int32, nextMarker: String? = nil, items: StreamingDistributionSummaryList? = nil) {
            self.marker = marker
            self.quantity = quantity
    ...
    public struct FieldLevelEncryptionProfileConfig: AWSShape {
        ...
        public init(callerReference: String, encryptionEntities: EncryptionEntities, name: String, comment: String? = nil) {
            self.callerReference = callerReference
    ...
    public struct DistributionList: AWSShape {
        ...
        public init(marker: String, quantity: Int32, isTruncated: Bool, maxItems: Int32, nextMarker: String? = nil, items: DistributionSummaryList? = nil) {
            self.marker = marker
            self.quantity = quantity
            self.isTruncated = isTruncated
            self.maxItems = maxItems
    ...
    public struct GeoRestriction: AWSShape {
        ...
        public init(restrictionType: GeoRestrictionType, items: LocationList? = nil, quantity: Int32) {
    ...
    public struct ListDistributionsByWebACLIdRequest: AWSShape {
        ...
        public init(marker: String? = nil, webACLId: String, maxItems: String? = nil) {
            self.marker = marker
            self.webACLId = webACLId
            self.maxItems = maxItems
        }
    ...
    public struct DistributionConfig: AWSShape {
        ...
        public init(enabled: Bool, defaultRootObject: String? = nil, defaultCacheBehavior: DefaultCacheBehavior, logging: LoggingConfig? = nil, aliases: Aliases? = nil, restrictions: Restrictions? = nil, cacheBehaviors: CacheBehaviors? = nil, isIPV6Enabled: Bool? = nil, viewerCertificate: ViewerCertificate? = nil, priceClass: PriceClass? = nil, customErrorResponses: CustomErrorResponses? = nil, originGroups: OriginGroups? = nil, httpVersion: HttpVersion? = nil, origins: Origins, comment: String, callerReference: String, webACLId: String? = nil) {
            self.enabled = enabled
    ...
    public struct UpdateDistributionRequest: AWSShape {
        ...
        public init(ifMatch: String? = nil, distributionConfig: DistributionConfig, id: String) {
            self.ifMatch = ifMatch
            self.distributionConfig = distributionConfig
            self.id = id
        }
    ...
    public struct LambdaFunctionAssociation: AWSShape {
        ...
        public init(lambdaFunctionARN: String, includeBody: Bool? = nil, eventType: EventType) {
    ...
    public struct FieldLevelEncryptionList: AWSShape {
        ...
        public init(quantity: Int32, maxItems: Int32, nextMarker: String? = nil, items: FieldLevelEncryptionSummaryList? = nil) {
            self.quantity = quantity
            self.maxItems = maxItems
            self.nextMarker = nextMarker
            self.items = items
    ...
    public struct PublicKeyList: AWSShape {
        ...
        public init(quantity: Int32, maxItems: Int32, nextMarker: String? = nil, items: PublicKeySummaryList? = nil) {
            self.quantity = quantity
            self.maxItems = maxItems
            self.nextMarker = nextMarker
            self.items = items
    ...
    public struct LoggingConfig: AWSShape {
        ...
        public init(includeCookies: Bool, prefix: String, bucket: String, enabled: Bool) {
    ...
    public struct PublicKeySummary: AWSShape {
        ...
        public init(encodedKey: String, id: String, name: String, comment: String? = nil, createdTime: TimeStamp) {
    ...
    public struct CacheBehavior: AWSShape {
        ...
        public init(minTTL: Int64, compress: Bool? = nil, defaultTTL: Int64? = nil, pathPattern: String, forwardedValues: ForwardedValues, trustedSigners: TrustedSigners, viewerProtocolPolicy: ViewerProtocolPolicy, smoothStreaming: Bool? = nil, lambdaFunctionAssociations: LambdaFunctionAssociations? = nil, fieldLevelEncryptionId: String? = nil, allowedMethods: AllowedMethods? = nil, targetOriginId: String, maxTTL: Int64? = nil) {
            self.minTTL = minTTL
    ...
    public struct StreamingDistributionSummary: AWSShape {
        ...
        public init(comment: String, aliases: Aliases, s3Origin: S3Origin, id: String, status: String, lastModifiedTime: TimeStamp, trustedSigners: TrustedSigners, priceClass: PriceClass, domainName: String, arn: String, enabled: Bool) {
            self.comment = comment
            self.aliases = aliases
            self.s3Origin = s3Origin
            self.id = id
    ...
    public struct PublicKeyConfig: AWSShape {
        ...
        public init(encodedKey: String, callerReference: String, name: String, comment: String? = nil) {
            self.encodedKey = encodedKey
            self.callerReference = callerReference
            self.name = name
            self.comment = comment
    ...
    public struct DefaultCacheBehavior: AWSShape {
        ...
        public init(defaultTTL: Int64? = nil, fieldLevelEncryptionId: String? = nil, minTTL: Int64, targetOriginId: String, compress: Bool? = nil, smoothStreaming: Bool? = nil, lambdaFunctionAssociations: LambdaFunctionAssociations? = nil, maxTTL: Int64? = nil, trustedSigners: TrustedSigners, viewerProtocolPolicy: ViewerProtocolPolicy, forwardedValues: ForwardedValues, allowedMethods: AllowedMethods? = nil) {
            self.defaultTTL = defaultTTL
            self.fieldLevelEncryptionId = fieldLevelEncryptionId
            self.minTTL = minTTL
            self.targetOriginId = targetOriginId
    ...
    public struct Origin: AWSShape {
        ...
        public init(customHeaders: CustomHeaders? = nil, s3OriginConfig: S3OriginConfig? = nil, domainName: String, originPath: String? = nil, customOriginConfig: CustomOriginConfig? = nil, id: String) {
    ...
    public struct StreamingDistribution: AWSShape {
        ...
        public init(id: String, lastModifiedTime: TimeStamp? = nil, status: String, streamingDistributionConfig: StreamingDistributionConfig, domainName: String, arn: String, activeTrustedSigners: ActiveTrustedSigners) {
            self.id = id
            self.lastModifiedTime = lastModifiedTime
            self.status = status
    ...
    public struct CloudFrontOriginAccessIdentity: AWSShape {
        ...
        public init(s3CanonicalUserId: String, id: String, cloudFrontOriginAccessIdentityConfig: CloudFrontOriginAccessIdentityConfig? = nil) {
    ...
    public struct FieldLevelEncryptionProfileSummary: AWSShape {
        ...
        public init(id: String, encryptionEntities: EncryptionEntities, name: String, lastModifiedTime: TimeStamp, comment: String? = nil) {
            self.id = id
            self.encryptionEntities = encryptionEntities
            self.name = name
            self.lastModifiedTime = lastModifiedTime
    ...
    public struct UpdatePublicKeyRequest: AWSShape {
        ...
        public init(ifMatch: String? = nil, publicKeyConfig: PublicKeyConfig, id: String) {
            self.ifMatch = ifMatch
            self.publicKeyConfig = publicKeyConfig
            self.id = id
        }
    ...
    public struct OriginGroup: AWSShape {
        ...
        public init(failoverCriteria: OriginGroupFailoverCriteria, members: OriginGroupMembers, id: String) {
    ...
    public struct ViewerCertificate: AWSShape {
        ...
        public init(certificate: String? = nil, aCMCertificateArn: String? = nil, cloudFrontDefaultCertificate: Bool? = nil, sSLSupportMethod: SSLSupportMethod? = nil, certificateSource: CertificateSource? = nil, iAMCertificateId: String? = nil, minimumProtocolVersion: MinimumProtocolVersion? = nil) {
    ...
    public struct FieldLevelEncryption: AWSShape {
        ...
        public init(lastModifiedTime: TimeStamp, id: String, fieldLevelEncryptionConfig: FieldLevelEncryptionConfig) {
            self.lastModifiedTime = lastModifiedTime
            self.id = id
            self.fieldLevelEncryptionConfig = fieldLevelEncryptionConfig
        }
    ...
    public struct CloudFrontOriginAccessIdentitySummary: AWSShape {
        ...
        public init(s3CanonicalUserId: String, comment: String, id: String) {
            self.s3CanonicalUserId = s3CanonicalUserId
            self.comment = comment
            self.id = id
        }
    ...
    public struct ActiveTrustedSigners: AWSShape {
        ...
        public init(items: SignerList? = nil, quantity: Int32, enabled: Bool) {
            self.items = items
            self.quantity = quantity
            self.enabled = enabled
        }
    ...
    public struct AllowedMethods: AWSShape {
        ...
        public init(items: MethodsList, quantity: Int32, cachedMethods: CachedMethods? = nil) {
            self.items = items
            self.quantity = quantity
    ...
    public struct PublicKey: AWSShape {
        ...
        public init(publicKeyConfig: PublicKeyConfig, id: String, createdTime: TimeStamp) {
            self.publicKeyConfig = publicKeyConfig
            self.id = id
            self.createdTime = createdTime
        }
    ...
    public struct InvalidationList: AWSShape {
        ...
        public init(marker: String, quantity: Int32, isTruncated: Bool, maxItems: Int32, nextMarker: String? = nil, items: InvalidationSummaryList? = nil) {
            self.marker = marker
            self.quantity = quantity
            self.isTruncated = isTruncated
            self.maxItems = maxItems
    ...
    public struct CloudFrontOriginAccessIdentityList: AWSShape {
        ...
        public init(marker: String, quantity: Int32, isTruncated: Bool, maxItems: Int32, nextMarker: String? = nil, items: CloudFrontOriginAccessIdentitySummaryList? = nil) {
            self.marker = marker
            self.quantity = quantity
            self.isTruncated = isTruncated
            self.maxItems = maxItems
    ...
    public struct FieldLevelEncryptionSummary: AWSShape {
        ...
        public init(id: String, contentTypeProfileConfig: ContentTypeProfileConfig? = nil, comment: String? = nil, queryArgProfileConfig: QueryArgProfileConfig? = nil, lastModifiedTime: TimeStamp) {
            self.id = id
            self.contentTypeProfileConfig = contentTypeProfileConfig
            self.comment = comment
            self.queryArgProfileConfig = queryArgProfileConfig
    ...
    public struct UpdateCloudFrontOriginAccessIdentityRequest: AWSShape {
        ...
        public init(ifMatch: String? = nil, cloudFrontOriginAccessIdentityConfig: CloudFrontOriginAccessIdentityConfig, id: String) {
            self.ifMatch = ifMatch
            self.cloudFrontOriginAccessIdentityConfig = cloudFrontOriginAccessIdentityConfig
            self.id = id
        }
    ...
    public struct UntagResourceRequest: AWSShape {
        ...
        public init(tagKeys: TagKeys, resource: String) {
    ...
    public struct FieldLevelEncryptionProfileList: AWSShape {
        ...
        public init(quantity: Int32, maxItems: Int32, nextMarker: String? = nil, items: FieldLevelEncryptionProfileSummaryList? = nil) {
            self.quantity = quantity
            self.maxItems = maxItems
            self.nextMarker = nextMarker
            self.items = items
    ...
    public struct CustomErrorResponse: AWSShape {
        ...
        public init(responseCode: String? = nil, errorCode: Int32, errorCachingMinTTL: Int64? = nil, responsePagePath: String? = nil) {
    ...
    public struct ContentTypeProfile: AWSShape {
        ...
        public init(profileId: String? = nil, format: Format, contentType: String) {
            self.profileId = profileId
            self.format = format
    ...
    public struct ForwardedValues: AWSShape {
        ...
        public init(queryString: Bool, headers: Headers? = nil, queryStringCacheKeys: QueryStringCacheKeys? = nil, cookies: CookiePreference) {
