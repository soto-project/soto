...
public struct QuickSight {
    ...
    public func getDashboardEmbedUrl(_ input: GetDashboardEmbedUrlRequest) throws -> EventLoopFuture<GetDashboardEmbedUrlResponse> {
    ...
    public func deleteGroupMembership(_ input: DeleteGroupMembershipRequest) throws -> EventLoopFuture<DeleteGroupMembershipResponse> {
    ...
    public func registerUser(_ input: RegisterUserRequest) throws -> EventLoopFuture<RegisterUserResponse> {
    ...
    public func createGroupMembership(_ input: CreateGroupMembershipRequest) throws -> EventLoopFuture<CreateGroupMembershipResponse> {
    ...
    public func listUserGroups(_ input: ListUserGroupsRequest) throws -> EventLoopFuture<ListUserGroupsResponse> {
    ...
    public func listGroupMemberships(_ input: ListGroupMembershipsRequest) throws -> EventLoopFuture<ListGroupMembershipsResponse> {
