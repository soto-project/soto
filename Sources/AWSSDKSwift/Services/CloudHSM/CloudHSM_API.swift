...
public struct CloudHSM {
    ...
    public func listAvailableZones(_ input: ListAvailableZonesRequest) throws -> EventLoopFuture<ListAvailableZonesResponse> {
    ...
    public func deleteHsm(_ input: DeleteHsmRequest) throws -> EventLoopFuture<DeleteHsmResponse> {
    ...
    public func modifyHsm(_ input: ModifyHsmRequest) throws -> EventLoopFuture<ModifyHsmResponse> {
    ...
    public func deleteLunaClient(_ input: DeleteLunaClientRequest) throws -> EventLoopFuture<DeleteLunaClientResponse> {
    ...
    public func listHapgs(_ input: ListHapgsRequest) throws -> EventLoopFuture<ListHapgsResponse> {
    ...
    public func listHsms(_ input: ListHsmsRequest) throws -> EventLoopFuture<ListHsmsResponse> {
    ...
    public func addTagsToResource(_ input: AddTagsToResourceRequest) throws -> EventLoopFuture<AddTagsToResourceResponse> {
    ...
    public func createHapg(_ input: CreateHapgRequest) throws -> EventLoopFuture<CreateHapgResponse> {
    ...
    public func removeTagsFromResource(_ input: RemoveTagsFromResourceRequest) throws -> EventLoopFuture<RemoveTagsFromResourceResponse> {
    ...
    public func describeHsm(_ input: DescribeHsmRequest) throws -> EventLoopFuture<DescribeHsmResponse> {
    ...
    public func listLunaClients(_ input: ListLunaClientsRequest) throws -> EventLoopFuture<ListLunaClientsResponse> {
    ...
    public func createLunaClient(_ input: CreateLunaClientRequest) throws -> EventLoopFuture<CreateLunaClientResponse> {
        return try client.send(operation: "CreateLunaClient", path: "/", httpMethod: "POST", input: input)
    }

    ///  This is documentation for AWS CloudHSM Classic. For more information, see AWS CloudHSM Classic FAQs, the AWS CloudHSM Classic User Guide, and the AWS CloudHSM Classic API Reference.  For information about the current version of AWS CloudHSM, see AWS CloudHSM, the AWS CloudHSM User Guide, and the AWS CloudHSM API Reference. Retrieves information about an HSM client.
    public func describeLunaClient(_ input: DescribeLunaClientRequest) throws -> EventLoopFuture<DescribeLunaClientResponse> {
    ...
    public func modifyHapg(_ input: ModifyHapgRequest) throws -> EventLoopFuture<ModifyHapgResponse> {
    ...
    public func createHsm(_ input: CreateHsmRequest) throws -> EventLoopFuture<CreateHsmResponse> {
    ...
    public func deleteHapg(_ input: DeleteHapgRequest) throws -> EventLoopFuture<DeleteHapgResponse> {
        return try client.send(operation: "DeleteHapg", path: "/", httpMethod: "POST", input: input)
    }

    ///  This is documentation for AWS CloudHSM Classic. For more information, see AWS CloudHSM Classic FAQs, the AWS CloudHSM Classic User Guide, and the AWS CloudHSM Classic API Reference.  For information about the current version of AWS CloudHSM, see AWS CloudHSM, the AWS CloudHSM User Guide, and the AWS CloudHSM API Reference. Retrieves information about a high-availability partition group.
    public func describeHapg(_ input: DescribeHapgRequest) throws -> EventLoopFuture<DescribeHapgResponse> {
    ...
    public func modifyLunaClient(_ input: ModifyLunaClientRequest) throws -> EventLoopFuture<ModifyLunaClientResponse> {
    ...
    public func getConfig(_ input: GetConfigRequest) throws -> EventLoopFuture<GetConfigResponse> {
