...
public struct CloudHSM: AWSService {
    ...
    public func createHapg(_ input: CreateHapgRequest) -> EventLoopFuture<CreateHapgResponse> {
        return client.execute(operation: "CreateHapg", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createLunaClient(_ input: CreateLunaClientRequest) -> EventLoopFuture<CreateLunaClientResponse> {
        return client.execute(operation: "CreateLunaClient", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteHapg(_ input: DeleteHapgRequest) -> EventLoopFuture<DeleteHapgResponse> {
        return client.execute(operation: "DeleteHapg", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func deleteLunaClient(_ input: DeleteLunaClientRequest) -> EventLoopFuture<DeleteLunaClientResponse> {
        return client.execute(operation: "DeleteLunaClient", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeHapg(_ input: DescribeHapgRequest) -> EventLoopFuture<DescribeHapgResponse> {
        return client.execute(operation: "DescribeHapg", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeHsm(_ input: DescribeHsmRequest) -> EventLoopFuture<DescribeHsmResponse> {
        return client.execute(operation: "DescribeHsm", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }

    ///  This is documentation for AWS CloudHSM Classic. For more information, see AWS CloudHSM Classic FAQs, the AWS CloudHSM Classic User Guide, and the AWS CloudHSM Classic API Reference.  For information about the current version of AWS CloudHSM, see AWS CloudHSM, the AWS CloudHSM User Guide, and the AWS CloudHSM API Reference. Retrieves information about an HSM client.
    public func describeLunaClient(_ input: DescribeLunaClientRequest) -> EventLoopFuture<DescribeLunaClientResponse> {
        return client.execute(operation: "DescribeLunaClient", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func getConfig(_ input: GetConfigRequest) -> EventLoopFuture<GetConfigResponse> {
        return client.execute(operation: "GetConfig", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listAvailableZones(_ input: ListAvailableZonesRequest) -> EventLoopFuture<ListAvailableZonesResponse> {
        return client.execute(operation: "ListAvailableZones", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listHapgs(_ input: ListHapgsRequest) -> EventLoopFuture<ListHapgsResponse> {
        return client.execute(operation: "ListHapgs", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listHsms(_ input: ListHsmsRequest) -> EventLoopFuture<ListHsmsResponse> {
        return client.execute(operation: "ListHsms", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func listLunaClients(_ input: ListLunaClientsRequest) -> EventLoopFuture<ListLunaClientsResponse> {
        return client.execute(operation: "ListLunaClients", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyHapg(_ input: ModifyHapgRequest) -> EventLoopFuture<ModifyHapgResponse> {
        return client.execute(operation: "ModifyHapg", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyHsm(_ input: ModifyHsmRequest) -> EventLoopFuture<ModifyHsmResponse> {
        return client.execute(operation: "ModifyHsm", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func modifyLunaClient(_ input: ModifyLunaClientRequest) -> EventLoopFuture<ModifyLunaClientResponse> {
        return client.execute(operation: "ModifyLunaClient", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
