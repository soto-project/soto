...
extension CloudHSM {
    ...
    public struct CreateHsmRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "EniIp", location: .body(locationName: "EniIp")), 
            AWSShapeMember(label: "ExternalId", location: .body(locationName: "ExternalId")), 
            AWSShapeMember(label: "IamRoleArn", location: .body(locationName: "IamRoleArn")), 
            AWSShapeMember(label: "SshKey", location: .body(locationName: "SshKey")), 
            AWSShapeMember(label: "SubnetId", location: .body(locationName: "SubnetId")), 
            AWSShapeMember(label: "SubscriptionType", location: .body(locationName: "SubscriptionType")), 
            AWSShapeMember(label: "SyslogIp", location: .body(locationName: "SyslogIp"))
        ]
    ...
    public struct DeleteHsmRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "HsmArn", location: .body(locationName: "HsmArn"))
        ]
