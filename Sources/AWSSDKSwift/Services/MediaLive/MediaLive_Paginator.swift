...
extension MediaLive {
    ...
    public func describeSchedulePaginator(_ input: DescribeScheduleRequest) -> Future<[ScheduleAction]> {
        return client.paginate(input: input, command: describeSchedule, resultKey: "scheduleActions", tokenKey: "nextToken")
    }
    
    ///  Produces list of channels that have been created
    public func listChannelsPaginator(_ input: ListChannelsRequest) -> Future<[ChannelSummary]> {
        return client.paginate(input: input, command: listChannels, resultKey: "channels", tokenKey: "nextToken")
    }
    
    ///  Produces a list of Input Security Groups for an account
    public func listInputSecurityGroupsPaginator(_ input: ListInputSecurityGroupsRequest) -> Future<[InputSecurityGroup]> {
    ...
    public func listInputsPaginator(_ input: ListInputsRequest) -> Future<[Input]> {
        return client.paginate(input: input, command: listInputs, resultKey: "inputs", tokenKey: "nextToken")
    }
    
    ///  List the programs that currently exist for a specific multiplex.
    public func listMultiplexProgramsPaginator(_ input: ListMultiplexProgramsRequest) -> Future<[MultiplexProgramSummary]> {
        return client.paginate(input: input, command: listMultiplexPrograms, resultKey: "multiplexPrograms", tokenKey: "nextToken")
    }
    
    ///  Retrieve a list of the existing multiplexes.
    public func listMultiplexesPaginator(_ input: ListMultiplexesRequest) -> Future<[MultiplexSummary]> {
    ...
    public func listReservationsPaginator(_ input: ListReservationsRequest) -> Future<[Reservation]> {
