...
public struct MediaLive {
    ...
    public func updateInputSecurityGroup(_ input: UpdateInputSecurityGroupRequest) throws -> EventLoopFuture<UpdateInputSecurityGroupResponse> {
    ...
    public func deleteInput(_ input: DeleteInputRequest) throws -> EventLoopFuture<DeleteInputResponse> {
        return try client.send(operation: "DeleteInput", path: "/prod/inputs/{inputId}", httpMethod: "DELETE", input: input)
    }

    ///  Get a channel schedule
    public func describeSchedule(_ input: DescribeScheduleRequest) throws -> EventLoopFuture<DescribeScheduleResponse> {
        return try client.send(operation: "DescribeSchedule", path: "/prod/channels/{channelId}/schedule", httpMethod: "GET", input: input)
    }

    ///  Get details for an offering.
    public func describeOffering(_ input: DescribeOfferingRequest) throws -> EventLoopFuture<DescribeOfferingResponse> {
        return try client.send(operation: "DescribeOffering", path: "/prod/offerings/{offeringId}", httpMethod: "GET", input: input)
    }

    ///  List purchased reservations.
    public func listReservations(_ input: ListReservationsRequest) throws -> EventLoopFuture<ListReservationsResponse> {
        return try client.send(operation: "ListReservations", path: "/prod/reservations", httpMethod: "GET", input: input)
    }

    ///  List offerings available for purchase.
    public func listOfferings(_ input: ListOfferingsRequest) throws -> EventLoopFuture<ListOfferingsResponse> {
        return try client.send(operation: "ListOfferings", path: "/prod/offerings", httpMethod: "GET", input: input)
    }

    ///  Update a channel schedule
    public func batchUpdateSchedule(_ input: BatchUpdateScheduleRequest) throws -> EventLoopFuture<BatchUpdateScheduleResponse> {
    ...
    public func purchaseOffering(_ input: PurchaseOfferingRequest) throws -> EventLoopFuture<PurchaseOfferingResponse> {
    ...
    public func describeInput(_ input: DescribeInputRequest) throws -> EventLoopFuture<DescribeInputResponse> {
        return try client.send(operation: "DescribeInput", path: "/prod/inputs/{inputId}", httpMethod: "GET", input: input)
    }

    ///  Produces list of inputs that have been created
    public func listInputs(_ input: ListInputsRequest) throws -> EventLoopFuture<ListInputsResponse> {
        return try client.send(operation: "ListInputs", path: "/prod/inputs", httpMethod: "GET", input: input)
    }

    ///  Get details for a reservation.
    public func describeReservation(_ input: DescribeReservationRequest) throws -> EventLoopFuture<DescribeReservationResponse> {
    ...
    public func listInputSecurityGroups(_ input: ListInputSecurityGroupsRequest) throws -> EventLoopFuture<ListInputSecurityGroupsResponse> {
        return try client.send(operation: "ListInputSecurityGroups", path: "/prod/inputSecurityGroups", httpMethod: "GET", input: input)
    }

    ///  Create an input
    public func createInput(_ input: CreateInputRequest) throws -> EventLoopFuture<CreateInputResponse> {
        return try client.send(operation: "CreateInput", path: "/prod/inputs", httpMethod: "POST", input: input)
    }

    ///  Deletes an Input Security Group
    public func deleteInputSecurityGroup(_ input: DeleteInputSecurityGroupRequest) throws -> EventLoopFuture<DeleteInputSecurityGroupResponse> {
    ...
    public func deleteReservation(_ input: DeleteReservationRequest) throws -> EventLoopFuture<DeleteReservationResponse> {
    ...
    public func startChannel(_ input: StartChannelRequest) throws -> EventLoopFuture<StartChannelResponse> {
        return try client.send(operation: "StartChannel", path: "/prod/channels/{channelId}/start", httpMethod: "POST", input: input)
    }

    ///  Produces a summary of an Input Security Group
    public func describeInputSecurityGroup(_ input: DescribeInputSecurityGroupRequest) throws -> EventLoopFuture<DescribeInputSecurityGroupResponse> {
    ...
    public func createInputSecurityGroup(_ input: CreateInputSecurityGroupRequest) throws -> EventLoopFuture<CreateInputSecurityGroupResponse> {
    ...
    public func stopChannel(_ input: StopChannelRequest) throws -> EventLoopFuture<StopChannelResponse> {
        return try client.send(operation: "StopChannel", path: "/prod/channels/{channelId}/stop", httpMethod: "POST", input: input)
    }

    ///  Updates an input.
    public func updateInput(_ input: UpdateInputRequest) throws -> EventLoopFuture<UpdateInputResponse> {
