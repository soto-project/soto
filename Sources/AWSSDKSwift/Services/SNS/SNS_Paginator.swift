...
extension SNS {
    ...
    public func listEndpointsByPlatformApplicationPaginator(
        ...
        onPage: @escaping (ListEndpointsByPlatformApplicationResponse,
    ...
    public func listPlatformApplicationsPaginator(
        ...
        onPage: @escaping (ListPlatformApplicationsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listSubscriptionsPaginator(
        ...
        onPage: @escaping (ListSubscriptionsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listSubscriptionsByTopicPaginator(
        ...
        onPage: @escaping (ListSubscriptionsByTopicResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func listTopicsPaginator(
        ...
        onPage: @escaping (ListTopicsResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
