...
extension SNS {
    ...
    public func listEndpointsByPlatformApplicationPaginator(_ input: ListEndpointsByPlatformApplicationInput, onPage: @escaping ([Endpoint], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listEndpointsByPlatformApplication, resultKey: \ListEndpointsByPlatformApplicationResponse.endpoints, tokenKey: \ListEndpointsByPlatformApplicationResponse.nextToken, onPage: onPage)
    }
    ...
    public func listPlatformApplicationsPaginator(_ input: ListPlatformApplicationsInput, onPage: @escaping ([PlatformApplication], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listPlatformApplications, resultKey: \ListPlatformApplicationsResponse.platformApplications, tokenKey: \ListPlatformApplicationsResponse.nextToken, onPage: onPage)
    }
    ...
    public func listSubscriptionsPaginator(_ input: ListSubscriptionsInput, onPage: @escaping ([Subscription], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listSubscriptions, resultKey: \ListSubscriptionsResponse.subscriptions, tokenKey: \ListSubscriptionsResponse.nextToken, onPage: onPage)
    }
    ...
    public func listSubscriptionsByTopicPaginator(_ input: ListSubscriptionsByTopicInput, onPage: @escaping ([Subscription], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listSubscriptionsByTopic, resultKey: \ListSubscriptionsByTopicResponse.subscriptions, tokenKey: \ListSubscriptionsByTopicResponse.nextToken, onPage: onPage)
    }
    ...
    public func listTopicsPaginator(_ input: ListTopicsInput, onPage: @escaping ([Topic], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listTopics, resultKey: \ListTopicsResponse.topics, tokenKey: \ListTopicsResponse.nextToken, onPage: onPage)
    }
