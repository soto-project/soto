...
extension SNS {
    ...
    public func listEndpointsByPlatformApplicationPaginator(_ input: ListEndpointsByPlatformApplicationInput) -> Future<[Endpoint]> {
    ...
    public func listPlatformApplicationsPaginator(_ input: ListPlatformApplicationsInput) -> Future<[PlatformApplication]> {
    ...
    public func listSubscriptionsPaginator(_ input: ListSubscriptionsInput) -> Future<[Subscription]> {
    ...
    public func listSubscriptionsByTopicPaginator(_ input: ListSubscriptionsByTopicInput) -> Future<[Subscription]> {
    ...
    public func listTopicsPaginator(_ input: ListTopicsInput) -> Future<[Topic]> {
