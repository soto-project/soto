...
extension SNS {
    ...
    public struct AddPermissionInput: AWSShape {
        ...
        public init(actionName: [String], aWSAccountId: [String], topicArn: String, label: String) {
    ...
    public struct PublishInput: AWSShape {
        ...
        public init(phoneNumber: String? = nil, targetArn: String? = nil, messageStructure: String? = nil, message: String, subject: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, topicArn: String? = nil) {
    ...
    public struct SetSubscriptionAttributesInput: AWSShape {
        ...
        public init(subscriptionArn: String, attributeName: String, attributeValue: String? = nil) {
    ...
    public struct Subscription: AWSShape {
        ...
        public init(subscriptionArn: String? = nil, owner: String? = nil, endpoint: String? = nil, protocol: String? = nil, topicArn: String? = nil) {
            self.subscriptionArn = subscriptionArn
            self.owner = owner
    ...
    public struct CreatePlatformEndpointInput: AWSShape {
        ...
        public init(token: String, platformApplicationArn: String, attributes: [String: String]? = nil, customUserData: String? = nil) {
            self.token = token
            self.platformApplicationArn = platformApplicationArn
            self.attributes = attributes
    ...
    public struct SubscribeInput: AWSShape {
        ...
        public init(returnSubscriptionArn: Bool? = nil, endpoint: String? = nil, protocol: String, topicArn: String, attributes: [String: String]? = nil) {
