...
extension SNS {
    ...
    public struct ConfirmSubscriptionInput: AWSShape {
        ...
        public init(token: String, topicArn: String, authenticateOnUnsubscribe: String? = nil) {
            self.token = token
            self.topicArn = topicArn
    ...
    public struct CreatePlatformEndpointInput: AWSShape {
        ...
        public init(attributes: [String: String]? = nil, token: String, platformApplicationArn: String, customUserData: String? = nil) {
            self.attributes = attributes
            self.token = token
            self.platformApplicationArn = platformApplicationArn
    ...
    public struct SubscribeInput: AWSShape {
        ...
        public init(protocol: String, attributes: [String: String]? = nil, endpoint: String? = nil, topicArn: String, returnSubscriptionArn: Bool? = nil) {
    ...
    public struct PublishInput: AWSShape {
        ...
        public init(messageAttributes: [String: MessageAttributeValue]? = nil, message: String, phoneNumber: String? = nil, messageStructure: String? = nil, subject: String? = nil, topicArn: String? = nil, targetArn: String? = nil) {
    ...
    public struct Subscription: AWSShape {
        ...
        public init(protocol: String? = nil, endpoint: String? = nil, topicArn: String? = nil, subscriptionArn: String? = nil, owner: String? = nil) {
            self.`protocol` = `protocol`
            self.endpoint = endpoint
            self.topicArn = topicArn
            self.subscriptionArn = subscriptionArn
    ...
    public struct AddPermissionInput: AWSShape {
        ...
        public init(label: String, aWSAccountId: [String], topicArn: String, actionName: [String]) {
            self.label = label
