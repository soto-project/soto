...
extension SNS {
    ...
    public struct SetTopicAttributesInput: AWSShape {
        ...
        public init(attributeValue: String? = nil, attributeName: String, topicArn: String) {
    ...
    public struct AddPermissionInput: AWSShape {
        ...
        public init(label: String, actionName: [String], topicArn: String, aWSAccountId: [String]) {
            self.label = label
    ...
    public struct PublishInput: AWSShape {
        ...
        public init(subject: String? = nil, targetArn: String? = nil, topicArn: String? = nil, messageAttributes: [String: MessageAttributeValue]? = nil, message: String, phoneNumber: String? = nil, messageStructure: String? = nil) {
    ...
    public struct Subscription: AWSShape {
        ...
        public init(subscriptionArn: String? = nil, topicArn: String? = nil, protocol: String? = nil, owner: String? = nil, endpoint: String? = nil) {
            self.subscriptionArn = subscriptionArn
            self.topicArn = topicArn
    ...
    public struct ListEndpointsByPlatformApplicationInput: AWSShape {
        ...
        public init(platformApplicationArn: String, nextToken: String? = nil) {
            self.platformApplicationArn = platformApplicationArn
            self.nextToken = nextToken
        }
    ...
    public struct CreatePlatformEndpointInput: AWSShape {
        ...
        public init(token: String, attributes: [String: String]? = nil, customUserData: String? = nil, platformApplicationArn: String) {
            self.token = token
            self.attributes = attributes
    ...
    public struct SubscribeInput: AWSShape {
        ...
        public init(returnSubscriptionArn: Bool? = nil, protocol: String, attributes: [String: String]? = nil, topicArn: String, endpoint: String? = nil) {
    ...
    public struct SetSubscriptionAttributesInput: AWSShape {
        ...
        public init(subscriptionArn: String, attributeValue: String? = nil, attributeName: String) {
            self.subscriptionArn = subscriptionArn
            self.attributeValue = attributeValue
            self.attributeName = attributeName
        }
