...
extension Route53 {
    ...
    public func listHealthChecksPaginator(_ input: ListHealthChecksRequest) -> Future<[HealthCheck]> {
    ...
    public func listHostedZonesPaginator(_ input: ListHostedZonesRequest) -> Future<[HostedZone]> {
    ...
    public func listResourceRecordSetsPaginator(_ input: ListResourceRecordSetsRequest) -> Future<[ResourceRecordSet]> {
