...
extension Route53 {
    ...
    public func listHealthChecksPaginator(_ input: ListHealthChecksRequest, onPage: @escaping ([HealthCheck], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listHealthChecks, resultKey: \ListHealthChecksResponse.healthChecks, tokenKey: \ListHealthChecksResponse.nextMarker, onPage: onPage)
    }
    ...
    public func listHostedZonesPaginator(_ input: ListHostedZonesRequest, onPage: @escaping ([HostedZone], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listHostedZones, resultKey: \ListHostedZonesResponse.hostedZones, tokenKey: \ListHostedZonesResponse.nextMarker, onPage: onPage)
    }
    ...
    public func listResourceRecordSetsPaginator(_ input: ListResourceRecordSetsRequest, onPage: @escaping ([ResourceRecordSet], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: listResourceRecordSets, resultKey: \ListResourceRecordSetsResponse.resourceRecordSets, tokenKey: \ListResourceRecordSetsResponse.nextRecordName, onPage: onPage)
    }
