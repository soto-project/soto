...
public struct Route53 {
    ...
    public func associateVPCWithHostedZone(_ input: AssociateVPCWithHostedZoneRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateVPCWithHostedZoneResponse> {
        return client.execute(operation: "AssociateVPCWithHostedZone", path: "/2013-04-01/hostedzone/{Id}/associatevpc", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func changeResourceRecordSets(_ input: ChangeResourceRecordSetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeResourceRecordSetsResponse> {
        return client.execute(operation: "ChangeResourceRecordSets", path: "/2013-04-01/hostedzone/{Id}/rrset/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func changeTagsForResource(_ input: ChangeTagsForResourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ChangeTagsForResourceResponse> {
        return client.execute(operation: "ChangeTagsForResource", path: "/2013-04-01/tags/{ResourceType}/{ResourceId}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createHealthCheck(_ input: CreateHealthCheckRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateHealthCheckResponse> {
        return client.execute(operation: "CreateHealthCheck", path: "/2013-04-01/healthcheck", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createHostedZone(_ input: CreateHostedZoneRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateHostedZoneResponse> {
        return client.execute(operation: "CreateHostedZone", path: "/2013-04-01/hostedzone", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createQueryLoggingConfig(_ input: CreateQueryLoggingConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateQueryLoggingConfigResponse> {
        return client.execute(operation: "CreateQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createReusableDelegationSet(_ input: CreateReusableDelegationSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateReusableDelegationSetResponse> {
        return client.execute(operation: "CreateReusableDelegationSet", path: "/2013-04-01/delegationset", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Creates a traffic policy, which you use to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com).
    public func createTrafficPolicy(_ input: CreateTrafficPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrafficPolicyResponse> {
        return client.execute(operation: "CreateTrafficPolicy", path: "/2013-04-01/trafficpolicy", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Creates resource record sets in a specified hosted zone based on the settings in a specified traffic policy version. In addition, CreateTrafficPolicyInstance associates the resource record sets with a specified domain name (such as example.com) or subdomain name (such as www.example.com). Amazon Route 53 responds to DNS queries for the domain or subdomain name by using the resource record sets that CreateTrafficPolicyInstance created.
    public func createTrafficPolicyInstance(_ input: CreateTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrafficPolicyInstanceResponse> {
        return client.execute(operation: "CreateTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Creates a new version of an existing traffic policy. When you create a new version of a traffic policy, you specify the ID of the traffic policy that you want to update and a JSON-formatted document that describes the new version. You use traffic policies to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com). You can create a maximum of 1000 versions of a traffic policy. If you reach the limit and need to create another version, you'll need to start a new traffic policy.
    public func createTrafficPolicyVersion(_ input: CreateTrafficPolicyVersionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrafficPolicyVersionResponse> {
        return client.execute(operation: "CreateTrafficPolicyVersion", path: "/2013-04-01/trafficpolicy/{Id}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createVPCAssociationAuthorization(_ input: CreateVPCAssociationAuthorizationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateVPCAssociationAuthorizationResponse> {
        return client.execute(operation: "CreateVPCAssociationAuthorization", path: "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteHealthCheck(_ input: DeleteHealthCheckRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteHealthCheckResponse> {
        return client.execute(operation: "DeleteHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteHostedZone(_ input: DeleteHostedZoneRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteHostedZoneResponse> {
        return client.execute(operation: "DeleteHostedZone", path: "/2013-04-01/hostedzone/{Id}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteQueryLoggingConfig(_ input: DeleteQueryLoggingConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteQueryLoggingConfigResponse> {
        return client.execute(operation: "DeleteQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig/{Id}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteReusableDelegationSet(_ input: DeleteReusableDelegationSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteReusableDelegationSetResponse> {
        return client.execute(operation: "DeleteReusableDelegationSet", path: "/2013-04-01/delegationset/{Id}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Deletes a traffic policy.
    public func deleteTrafficPolicy(_ input: DeleteTrafficPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTrafficPolicyResponse> {
        return client.execute(operation: "DeleteTrafficPolicy", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteTrafficPolicyInstance(_ input: DeleteTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteTrafficPolicyInstanceResponse> {
        return client.execute(operation: "DeleteTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func deleteVPCAssociationAuthorization(_ input: DeleteVPCAssociationAuthorizationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteVPCAssociationAuthorizationResponse> {
        return client.execute(operation: "DeleteVPCAssociationAuthorization", path: "/2013-04-01/hostedzone/{Id}/deauthorizevpcassociation", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func disassociateVPCFromHostedZone(_ input: DisassociateVPCFromHostedZoneRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateVPCFromHostedZoneResponse> {
        return client.execute(operation: "DisassociateVPCFromHostedZone", path: "/2013-04-01/hostedzone/{Id}/disassociatevpc", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getAccountLimit(_ input: GetAccountLimitRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAccountLimitResponse> {
        return client.execute(operation: "GetAccountLimit", path: "/2013-04-01/accountlimit/{Type}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getChange(_ input: GetChangeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetChangeResponse> {
        return client.execute(operation: "GetChange", path: "/2013-04-01/change/{Id}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getCheckerIpRanges(_ input: GetCheckerIpRangesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetCheckerIpRangesResponse> {
        return client.execute(operation: "GetCheckerIpRanges", path: "/2013-04-01/checkeripranges", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getGeoLocation(_ input: GetGeoLocationRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetGeoLocationResponse> {
        return client.execute(operation: "GetGeoLocation", path: "/2013-04-01/geolocation", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets information about a specified health check.
    public func getHealthCheck(_ input: GetHealthCheckRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckResponse> {
        return client.execute(operation: "GetHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Retrieves the number of health checks that are associated with the current AWS account.
    public func getHealthCheckCount(_ input: GetHealthCheckCountRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckCountResponse> {
        return client.execute(operation: "GetHealthCheckCount", path: "/2013-04-01/healthcheckcount", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets the reason that a specified health check failed most recently.
    public func getHealthCheckLastFailureReason(_ input: GetHealthCheckLastFailureReasonRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckLastFailureReasonResponse> {
        return client.execute(operation: "GetHealthCheckLastFailureReason", path: "/2013-04-01/healthcheck/{HealthCheckId}/lastfailurereason", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets status of a specified health check. 
    public func getHealthCheckStatus(_ input: GetHealthCheckStatusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHealthCheckStatusResponse> {
        return client.execute(operation: "GetHealthCheckStatus", path: "/2013-04-01/healthcheck/{HealthCheckId}/status", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets information about a specified hosted zone including the four name servers assigned to the hosted zone.
    public func getHostedZone(_ input: GetHostedZoneRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostedZoneResponse> {
        return client.execute(operation: "GetHostedZone", path: "/2013-04-01/hostedzone/{Id}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Retrieves the number of hosted zones that are associated with the current AWS account.
    public func getHostedZoneCount(_ input: GetHostedZoneCountRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostedZoneCountResponse> {
        return client.execute(operation: "GetHostedZoneCount", path: "/2013-04-01/hostedzonecount", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getHostedZoneLimit(_ input: GetHostedZoneLimitRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetHostedZoneLimitResponse> {
        return client.execute(operation: "GetHostedZoneLimit", path: "/2013-04-01/hostedzonelimit/{Id}/{Type}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getQueryLoggingConfig(_ input: GetQueryLoggingConfigRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetQueryLoggingConfigResponse> {
        return client.execute(operation: "GetQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig/{Id}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Retrieves information about a specified reusable delegation set, including the four name servers that are assigned to the delegation set.
    public func getReusableDelegationSet(_ input: GetReusableDelegationSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetReusableDelegationSetResponse> {
        return client.execute(operation: "GetReusableDelegationSet", path: "/2013-04-01/delegationset/{Id}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getReusableDelegationSetLimit(_ input: GetReusableDelegationSetLimitRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetReusableDelegationSetLimitResponse> {
        return client.execute(operation: "GetReusableDelegationSetLimit", path: "/2013-04-01/reusabledelegationsetlimit/{Id}/{Type}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets information about a specific traffic policy version.
    public func getTrafficPolicy(_ input: GetTrafficPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTrafficPolicyResponse> {
        return client.execute(operation: "GetTrafficPolicy", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getTrafficPolicyInstance(_ input: GetTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTrafficPolicyInstanceResponse> {
        return client.execute(operation: "GetTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets the number of traffic policy instances that are associated with the current AWS account.
    public func getTrafficPolicyInstanceCount(_ input: GetTrafficPolicyInstanceCountRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetTrafficPolicyInstanceCountResponse> {
        return client.execute(operation: "GetTrafficPolicyInstanceCount", path: "/2013-04-01/trafficpolicyinstancecount", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listGeoLocations(_ input: ListGeoLocationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListGeoLocationsResponse> {
        return client.execute(operation: "ListGeoLocations", path: "/2013-04-01/geolocations", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Retrieve a list of the health checks that are associated with the current AWS account. 
    public func listHealthChecks(_ input: ListHealthChecksRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHealthChecksResponse> {
        return client.execute(operation: "ListHealthChecks", path: "/2013-04-01/healthcheck", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listHostedZones(_ input: ListHostedZonesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostedZonesResponse> {
        return client.execute(operation: "ListHostedZones", path: "/2013-04-01/hostedzone", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listHostedZonesByName(_ input: ListHostedZonesByNameRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostedZonesByNameResponse> {
        return client.execute(operation: "ListHostedZonesByName", path: "/2013-04-01/hostedzonesbyname", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listHostedZonesByVPC(_ input: ListHostedZonesByVPCRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListHostedZonesByVPCResponse> {
        return client.execute(operation: "ListHostedZonesByVPC", path: "/2013-04-01/hostedzonesbyvpc", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listQueryLoggingConfigs(_ input: ListQueryLoggingConfigsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListQueryLoggingConfigsResponse> {
        return client.execute(operation: "ListQueryLoggingConfigs", path: "/2013-04-01/queryloggingconfig", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listResourceRecordSets(_ input: ListResourceRecordSetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListResourceRecordSetsResponse> {
        return client.execute(operation: "ListResourceRecordSets", path: "/2013-04-01/hostedzone/{Id}/rrset", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Retrieves a list of the reusable delegation sets that are associated with the current AWS account.
    public func listReusableDelegationSets(_ input: ListReusableDelegationSetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListReusableDelegationSetsResponse> {
        return client.execute(operation: "ListReusableDelegationSets", path: "/2013-04-01/delegationset", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForResourceResponse> {
        return client.execute(operation: "ListTagsForResource", path: "/2013-04-01/tags/{ResourceType}/{ResourceId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTagsForResources(_ input: ListTagsForResourcesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTagsForResourcesResponse> {
        return client.execute(operation: "ListTagsForResources", path: "/2013-04-01/tags/{ResourceType}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets information about the latest version for every traffic policy that is associated with the current AWS account. Policies are listed in the order that they were created in. 
    public func listTrafficPolicies(_ input: ListTrafficPoliciesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPoliciesResponse> {
        return client.execute(operation: "ListTrafficPolicies", path: "/2013-04-01/trafficpolicies", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTrafficPolicyInstances(_ input: ListTrafficPolicyInstancesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyInstancesResponse> {
        return client.execute(operation: "ListTrafficPolicyInstances", path: "/2013-04-01/trafficpolicyinstances", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTrafficPolicyInstancesByHostedZone(_ input: ListTrafficPolicyInstancesByHostedZoneRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyInstancesByHostedZoneResponse> {
        return client.execute(operation: "ListTrafficPolicyInstancesByHostedZone", path: "/2013-04-01/trafficpolicyinstances/hostedzone", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTrafficPolicyInstancesByPolicy(_ input: ListTrafficPolicyInstancesByPolicyRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyInstancesByPolicyResponse> {
        return client.execute(operation: "ListTrafficPolicyInstancesByPolicy", path: "/2013-04-01/trafficpolicyinstances/trafficpolicy", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listTrafficPolicyVersions(_ input: ListTrafficPolicyVersionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListTrafficPolicyVersionsResponse> {
        return client.execute(operation: "ListTrafficPolicyVersions", path: "/2013-04-01/trafficpolicies/{Id}/versions", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listVPCAssociationAuthorizations(_ input: ListVPCAssociationAuthorizationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListVPCAssociationAuthorizationsResponse> {
        return client.execute(operation: "ListVPCAssociationAuthorizations", path: "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Gets the value that Amazon Route 53 returns in response to a DNS request for a specified record name and type. You can optionally specify the IP address of a DNS resolver, an EDNS0 client subnet IP address, and a subnet mask. 
    public func testDNSAnswer(_ input: TestDNSAnswerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<TestDNSAnswerResponse> {
        return client.execute(operation: "TestDNSAnswer", path: "/2013-04-01/testdnsanswer", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateHealthCheck(_ input: UpdateHealthCheckRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateHealthCheckResponse> {
        return client.execute(operation: "UpdateHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Updates the comment for a specified hosted zone.
    public func updateHostedZoneComment(_ input: UpdateHostedZoneCommentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateHostedZoneCommentResponse> {
        return client.execute(operation: "UpdateHostedZoneComment", path: "/2013-04-01/hostedzone/{Id}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  Updates the comment for a specified traffic policy version.
    public func updateTrafficPolicyComment(_ input: UpdateTrafficPolicyCommentRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTrafficPolicyCommentResponse> {
        return client.execute(operation: "UpdateTrafficPolicyComment", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateTrafficPolicyInstance(_ input: UpdateTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateTrafficPolicyInstanceResponse> {
        return client.execute(operation: "UpdateTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
