...
public struct Route53 {
    ...
    public func associateVPCWithHostedZone(_ input: AssociateVPCWithHostedZoneRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AssociateVPCWithHostedZoneResponse> {
        return self.client.execute(operation: "AssociateVPCWithHostedZone", path: "/2013-04-01/hostedzone/{Id}/associatevpc", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func changeResourceRecordSets(_ input: ChangeResourceRecordSetsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ChangeResourceRecordSetsResponse> {
        return self.client.execute(operation: "ChangeResourceRecordSets", path: "/2013-04-01/hostedzone/{Id}/rrset/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func changeTagsForResource(_ input: ChangeTagsForResourceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ChangeTagsForResourceResponse> {
        return self.client.execute(operation: "ChangeTagsForResource", path: "/2013-04-01/tags/{ResourceType}/{ResourceId}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createHealthCheck(_ input: CreateHealthCheckRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateHealthCheckResponse> {
        return self.client.execute(operation: "CreateHealthCheck", path: "/2013-04-01/healthcheck", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createHostedZone(_ input: CreateHostedZoneRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateHostedZoneResponse> {
        return self.client.execute(operation: "CreateHostedZone", path: "/2013-04-01/hostedzone", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createQueryLoggingConfig(_ input: CreateQueryLoggingConfigRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateQueryLoggingConfigResponse> {
        return self.client.execute(operation: "CreateQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createReusableDelegationSet(_ input: CreateReusableDelegationSetRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateReusableDelegationSetResponse> {
        return self.client.execute(operation: "CreateReusableDelegationSet", path: "/2013-04-01/delegationset", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Creates a traffic policy, which you use to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com).
    public func createTrafficPolicy(_ input: CreateTrafficPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateTrafficPolicyResponse> {
        return self.client.execute(operation: "CreateTrafficPolicy", path: "/2013-04-01/trafficpolicy", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Creates resource record sets in a specified hosted zone based on the settings in a specified traffic policy version. In addition, CreateTrafficPolicyInstance associates the resource record sets with a specified domain name (such as example.com) or subdomain name (such as www.example.com). Amazon Route 53 responds to DNS queries for the domain or subdomain name by using the resource record sets that CreateTrafficPolicyInstance created.
    public func createTrafficPolicyInstance(_ input: CreateTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "CreateTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Creates a new version of an existing traffic policy. When you create a new version of a traffic policy, you specify the ID of the traffic policy that you want to update and a JSON-formatted document that describes the new version. You use traffic policies to create multiple DNS resource record sets for one domain name (such as example.com) or one subdomain name (such as www.example.com). You can create a maximum of 1000 versions of a traffic policy. If you reach the limit and need to create another version, you'll need to start a new traffic policy.
    public func createTrafficPolicyVersion(_ input: CreateTrafficPolicyVersionRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateTrafficPolicyVersionResponse> {
        return self.client.execute(operation: "CreateTrafficPolicyVersion", path: "/2013-04-01/trafficpolicy/{Id}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createVPCAssociationAuthorization(_ input: CreateVPCAssociationAuthorizationRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<CreateVPCAssociationAuthorizationResponse> {
        return self.client.execute(operation: "CreateVPCAssociationAuthorization", path: "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteHealthCheck(_ input: DeleteHealthCheckRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteHealthCheckResponse> {
        return self.client.execute(operation: "DeleteHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteHostedZone(_ input: DeleteHostedZoneRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteHostedZoneResponse> {
        return self.client.execute(operation: "DeleteHostedZone", path: "/2013-04-01/hostedzone/{Id}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteQueryLoggingConfig(_ input: DeleteQueryLoggingConfigRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteQueryLoggingConfigResponse> {
        return self.client.execute(operation: "DeleteQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig/{Id}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteReusableDelegationSet(_ input: DeleteReusableDelegationSetRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteReusableDelegationSetResponse> {
        return self.client.execute(operation: "DeleteReusableDelegationSet", path: "/2013-04-01/delegationset/{Id}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteTrafficPolicy(_ input: DeleteTrafficPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteTrafficPolicyResponse> {
        return self.client.execute(operation: "DeleteTrafficPolicy", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteTrafficPolicyInstance(_ input: DeleteTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "DeleteTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteVPCAssociationAuthorization(_ input: DeleteVPCAssociationAuthorizationRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteVPCAssociationAuthorizationResponse> {
        return self.client.execute(operation: "DeleteVPCAssociationAuthorization", path: "/2013-04-01/hostedzone/{Id}/deauthorizevpcassociation", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func disassociateVPCFromHostedZone(_ input: DisassociateVPCFromHostedZoneRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DisassociateVPCFromHostedZoneResponse> {
        return self.client.execute(operation: "DisassociateVPCFromHostedZone", path: "/2013-04-01/hostedzone/{Id}/disassociatevpc", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getAccountLimit(_ input: GetAccountLimitRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetAccountLimitResponse> {
        return self.client.execute(operation: "GetAccountLimit", path: "/2013-04-01/accountlimit/{Type}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getChange(_ input: GetChangeRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetChangeResponse> {
        return self.client.execute(operation: "GetChange", path: "/2013-04-01/change/{Id}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getCheckerIpRanges(_ input: GetCheckerIpRangesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetCheckerIpRangesResponse> {
        return self.client.execute(operation: "GetCheckerIpRanges", path: "/2013-04-01/checkeripranges", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getGeoLocation(_ input: GetGeoLocationRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetGeoLocationResponse> {
        return self.client.execute(operation: "GetGeoLocation", path: "/2013-04-01/geolocation", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets information about a specified health check.
    public func getHealthCheck(_ input: GetHealthCheckRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHealthCheckResponse> {
        return self.client.execute(operation: "GetHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Retrieves the number of health checks that are associated with the current AWS account.
    public func getHealthCheckCount(_ input: GetHealthCheckCountRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHealthCheckCountResponse> {
        return self.client.execute(operation: "GetHealthCheckCount", path: "/2013-04-01/healthcheckcount", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets the reason that a specified health check failed most recently.
    public func getHealthCheckLastFailureReason(_ input: GetHealthCheckLastFailureReasonRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHealthCheckLastFailureReasonResponse> {
        return self.client.execute(operation: "GetHealthCheckLastFailureReason", path: "/2013-04-01/healthcheck/{HealthCheckId}/lastfailurereason", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets status of a specified health check. 
    public func getHealthCheckStatus(_ input: GetHealthCheckStatusRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHealthCheckStatusResponse> {
        return self.client.execute(operation: "GetHealthCheckStatus", path: "/2013-04-01/healthcheck/{HealthCheckId}/status", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets information about a specified hosted zone including the four name servers assigned to the hosted zone.
    public func getHostedZone(_ input: GetHostedZoneRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHostedZoneResponse> {
        return self.client.execute(operation: "GetHostedZone", path: "/2013-04-01/hostedzone/{Id}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Retrieves the number of hosted zones that are associated with the current AWS account.
    public func getHostedZoneCount(_ input: GetHostedZoneCountRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHostedZoneCountResponse> {
        return self.client.execute(operation: "GetHostedZoneCount", path: "/2013-04-01/hostedzonecount", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getHostedZoneLimit(_ input: GetHostedZoneLimitRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetHostedZoneLimitResponse> {
        return self.client.execute(operation: "GetHostedZoneLimit", path: "/2013-04-01/hostedzonelimit/{Id}/{Type}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getQueryLoggingConfig(_ input: GetQueryLoggingConfigRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetQueryLoggingConfigResponse> {
        return self.client.execute(operation: "GetQueryLoggingConfig", path: "/2013-04-01/queryloggingconfig/{Id}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Retrieves information about a specified reusable delegation set, including the four name servers that are assigned to the delegation set.
    public func getReusableDelegationSet(_ input: GetReusableDelegationSetRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetReusableDelegationSetResponse> {
        return self.client.execute(operation: "GetReusableDelegationSet", path: "/2013-04-01/delegationset/{Id}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getReusableDelegationSetLimit(_ input: GetReusableDelegationSetLimitRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetReusableDelegationSetLimitResponse> {
        return self.client.execute(operation: "GetReusableDelegationSetLimit", path: "/2013-04-01/reusabledelegationsetlimit/{Id}/{Type}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getTrafficPolicy(_ input: GetTrafficPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetTrafficPolicyResponse> {
        return self.client.execute(operation: "GetTrafficPolicy", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func getTrafficPolicyInstance(_ input: GetTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "GetTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets the number of traffic policy instances that are associated with the current AWS account.
    public func getTrafficPolicyInstanceCount(_ input: GetTrafficPolicyInstanceCountRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<GetTrafficPolicyInstanceCountResponse> {
        return self.client.execute(operation: "GetTrafficPolicyInstanceCount", path: "/2013-04-01/trafficpolicyinstancecount", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listGeoLocations(_ input: ListGeoLocationsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListGeoLocationsResponse> {
        return self.client.execute(operation: "ListGeoLocations", path: "/2013-04-01/geolocations", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Retrieve a list of the health checks that are associated with the current AWS account. 
    public func listHealthChecks(_ input: ListHealthChecksRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListHealthChecksResponse> {
        return self.client.execute(operation: "ListHealthChecks", path: "/2013-04-01/healthcheck", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listHostedZones(_ input: ListHostedZonesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListHostedZonesResponse> {
        return self.client.execute(operation: "ListHostedZones", path: "/2013-04-01/hostedzone", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listHostedZonesByName(_ input: ListHostedZonesByNameRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListHostedZonesByNameResponse> {
        return self.client.execute(operation: "ListHostedZonesByName", path: "/2013-04-01/hostedzonesbyname", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listHostedZonesByVPC(_ input: ListHostedZonesByVPCRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListHostedZonesByVPCResponse> {
        return self.client.execute(operation: "ListHostedZonesByVPC", path: "/2013-04-01/hostedzonesbyvpc", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listQueryLoggingConfigs(_ input: ListQueryLoggingConfigsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListQueryLoggingConfigsResponse> {
        return self.client.execute(operation: "ListQueryLoggingConfigs", path: "/2013-04-01/queryloggingconfig", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listResourceRecordSets(_ input: ListResourceRecordSetsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListResourceRecordSetsResponse> {
        return self.client.execute(operation: "ListResourceRecordSets", path: "/2013-04-01/hostedzone/{Id}/rrset", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Retrieves a list of the reusable delegation sets that are associated with the current AWS account.
    public func listReusableDelegationSets(_ input: ListReusableDelegationSetsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListReusableDelegationSetsResponse> {
        return self.client.execute(operation: "ListReusableDelegationSets", path: "/2013-04-01/delegationset", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTagsForResourceResponse> {
        return self.client.execute(operation: "ListTagsForResource", path: "/2013-04-01/tags/{ResourceType}/{ResourceId}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTagsForResources(_ input: ListTagsForResourcesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTagsForResourcesResponse> {
        return self.client.execute(operation: "ListTagsForResources", path: "/2013-04-01/tags/{ResourceType}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTrafficPolicies(_ input: ListTrafficPoliciesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTrafficPoliciesResponse> {
        return self.client.execute(operation: "ListTrafficPolicies", path: "/2013-04-01/trafficpolicies", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTrafficPolicyInstances(_ input: ListTrafficPolicyInstancesRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTrafficPolicyInstancesResponse> {
        return self.client.execute(operation: "ListTrafficPolicyInstances", path: "/2013-04-01/trafficpolicyinstances", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTrafficPolicyInstancesByHostedZone(_ input: ListTrafficPolicyInstancesByHostedZoneRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTrafficPolicyInstancesByHostedZoneResponse> {
        return self.client.execute(operation: "ListTrafficPolicyInstancesByHostedZone", path: "/2013-04-01/trafficpolicyinstances/hostedzone", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTrafficPolicyInstancesByPolicy(_ input: ListTrafficPolicyInstancesByPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTrafficPolicyInstancesByPolicyResponse> {
        return self.client.execute(operation: "ListTrafficPolicyInstancesByPolicy", path: "/2013-04-01/trafficpolicyinstances/trafficpolicy", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTrafficPolicyVersions(_ input: ListTrafficPolicyVersionsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTrafficPolicyVersionsResponse> {
        return self.client.execute(operation: "ListTrafficPolicyVersions", path: "/2013-04-01/trafficpolicies/{Id}/versions", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listVPCAssociationAuthorizations(_ input: ListVPCAssociationAuthorizationsRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListVPCAssociationAuthorizationsResponse> {
        return self.client.execute(operation: "ListVPCAssociationAuthorizations", path: "/2013-04-01/hostedzone/{Id}/authorizevpcassociation", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Gets the value that Amazon Route 53 returns in response to a DNS request for a specified record name and type. You can optionally specify the IP address of a DNS resolver, an EDNS0 client subnet IP address, and a subnet mask. 
    public func testDNSAnswer(_ input: TestDNSAnswerRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<TestDNSAnswerResponse> {
        return self.client.execute(operation: "TestDNSAnswer", path: "/2013-04-01/testdnsanswer", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateHealthCheck(_ input: UpdateHealthCheckRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateHealthCheckResponse> {
        return self.client.execute(operation: "UpdateHealthCheck", path: "/2013-04-01/healthcheck/{HealthCheckId}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Updates the comment for a specified hosted zone.
    public func updateHostedZoneComment(_ input: UpdateHostedZoneCommentRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateHostedZoneCommentResponse> {
        return self.client.execute(operation: "UpdateHostedZoneComment", path: "/2013-04-01/hostedzone/{Id}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Updates the comment for a specified traffic policy version.
    public func updateTrafficPolicyComment(_ input: UpdateTrafficPolicyCommentRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTrafficPolicyCommentResponse> {
        return self.client.execute(operation: "UpdateTrafficPolicyComment", path: "/2013-04-01/trafficpolicy/{Id}/{Version}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateTrafficPolicyInstance(_ input: UpdateTrafficPolicyInstanceRequest, on eventLoop: EventLoop? = nil, logger: Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateTrafficPolicyInstanceResponse> {
        return self.client.execute(operation: "UpdateTrafficPolicyInstance", path: "/2013-04-01/trafficpolicyinstance/{Id}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
