...
public struct Route53 {
    ...
    public func getReusableDelegationSetLimit(_ input: GetReusableDelegationSetLimitRequest) throws -> GetReusableDelegationSetLimitResponse {
    ...
    public func getAccountLimit(_ input: GetAccountLimitRequest) throws -> GetAccountLimitResponse {
    ...
    public func listQueryLoggingConfigs(_ input: ListQueryLoggingConfigsRequest) throws -> ListQueryLoggingConfigsResponse {
    ...
    public func createQueryLoggingConfig(_ input: CreateQueryLoggingConfigRequest) throws -> CreateQueryLoggingConfigResponse {
    ...
    public func getHostedZoneLimit(_ input: GetHostedZoneLimitRequest) throws -> GetHostedZoneLimitResponse {
    ...
    public func getQueryLoggingConfig(_ input: GetQueryLoggingConfigRequest) throws -> GetQueryLoggingConfigResponse {
    ...
    public func deleteQueryLoggingConfig(_ input: DeleteQueryLoggingConfigRequest) throws -> DeleteQueryLoggingConfigResponse {
