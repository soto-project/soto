...
public struct Route53 {
    ...
    public func listHostedZonesByName(_ input: ListHostedZonesByNameRequest) throws -> EventLoopFuture<ListHostedZonesByNameResponse> {
    ...
    public func getCheckerIpRanges(_ input: GetCheckerIpRangesRequest) throws -> EventLoopFuture<GetCheckerIpRangesResponse> {
    ...
    public func createTrafficPolicy(_ input: CreateTrafficPolicyRequest) throws -> EventLoopFuture<CreateTrafficPolicyResponse> {
    ...
    public func listHealthChecks(_ input: ListHealthChecksRequest) throws -> EventLoopFuture<ListHealthChecksResponse> {
    ...
    public func updateHostedZoneComment(_ input: UpdateHostedZoneCommentRequest) throws -> EventLoopFuture<UpdateHostedZoneCommentResponse> {
    ...
    public func listTrafficPolicies(_ input: ListTrafficPoliciesRequest) throws -> EventLoopFuture<ListTrafficPoliciesResponse> {
    ...
    public func changeTagsForResource(_ input: ChangeTagsForResourceRequest) throws -> EventLoopFuture<ChangeTagsForResourceResponse> {
    ...
    public func createReusableDelegationSet(_ input: CreateReusableDelegationSetRequest) throws -> EventLoopFuture<CreateReusableDelegationSetResponse> {
    ...
    public func listVPCAssociationAuthorizations(_ input: ListVPCAssociationAuthorizationsRequest) throws -> EventLoopFuture<ListVPCAssociationAuthorizationsResponse> {
    ...
    public func getHostedZoneCount(_ input: GetHostedZoneCountRequest) throws -> EventLoopFuture<GetHostedZoneCountResponse> {
    ...
    public func associateVPCWithHostedZone(_ input: AssociateVPCWithHostedZoneRequest) throws -> EventLoopFuture<AssociateVPCWithHostedZoneResponse> {
    ...
    public func listTrafficPolicyInstancesByHostedZone(_ input: ListTrafficPolicyInstancesByHostedZoneRequest) throws -> EventLoopFuture<ListTrafficPolicyInstancesByHostedZoneResponse> {
    ...
    public func updateTrafficPolicyComment(_ input: UpdateTrafficPolicyCommentRequest) throws -> EventLoopFuture<UpdateTrafficPolicyCommentResponse> {
    ...
    public func deleteReusableDelegationSet(_ input: DeleteReusableDelegationSetRequest) throws -> EventLoopFuture<DeleteReusableDelegationSetResponse> {
    ...
    public func updateTrafficPolicyInstance(_ input: UpdateTrafficPolicyInstanceRequest) throws -> EventLoopFuture<UpdateTrafficPolicyInstanceResponse> {
    ...
    public func changeResourceRecordSets(_ input: ChangeResourceRecordSetsRequest) throws -> EventLoopFuture<ChangeResourceRecordSetsResponse> {
    ...
    public func createVPCAssociationAuthorization(_ input: CreateVPCAssociationAuthorizationRequest) throws -> EventLoopFuture<CreateVPCAssociationAuthorizationResponse> {
    ...
    public func getQueryLoggingConfig(_ input: GetQueryLoggingConfigRequest) throws -> EventLoopFuture<GetQueryLoggingConfigResponse> {
    ...
    public func getReusableDelegationSetLimit(_ input: GetReusableDelegationSetLimitRequest) throws -> EventLoopFuture<GetReusableDelegationSetLimitResponse> {
    ...
    public func createHostedZone(_ input: CreateHostedZoneRequest) throws -> EventLoopFuture<CreateHostedZoneResponse> {
    ...
    public func getReusableDelegationSet(_ input: GetReusableDelegationSetRequest) throws -> EventLoopFuture<GetReusableDelegationSetResponse> {
    ...
    public func createHealthCheck(_ input: CreateHealthCheckRequest) throws -> EventLoopFuture<CreateHealthCheckResponse> {
    ...
    public func deleteHealthCheck(_ input: DeleteHealthCheckRequest) throws -> EventLoopFuture<DeleteHealthCheckResponse> {
    ...
    public func createTrafficPolicyInstance(_ input: CreateTrafficPolicyInstanceRequest) throws -> EventLoopFuture<CreateTrafficPolicyInstanceResponse> {
    ...
    public func updateHealthCheck(_ input: UpdateHealthCheckRequest) throws -> EventLoopFuture<UpdateHealthCheckResponse> {
    ...
    public func disassociateVPCFromHostedZone(_ input: DisassociateVPCFromHostedZoneRequest) throws -> EventLoopFuture<DisassociateVPCFromHostedZoneResponse> {
    ...
    public func deleteVPCAssociationAuthorization(_ input: DeleteVPCAssociationAuthorizationRequest) throws -> EventLoopFuture<DeleteVPCAssociationAuthorizationResponse> {
    ...
    public func listQueryLoggingConfigs(_ input: ListQueryLoggingConfigsRequest) throws -> EventLoopFuture<ListQueryLoggingConfigsResponse> {
    ...
    public func listTrafficPolicyInstances(_ input: ListTrafficPolicyInstancesRequest) throws -> EventLoopFuture<ListTrafficPolicyInstancesResponse> {
    ...
    public func getHealthCheckCount(_ input: GetHealthCheckCountRequest) throws -> EventLoopFuture<GetHealthCheckCountResponse> {
        return try client.send(operation: "GetHealthCheckCount", path: "/2013-04-01/healthcheckcount", httpMethod: "GET", input: input)
    }

    ///  Gets status of a specified health check. 
    public func getHealthCheckStatus(_ input: GetHealthCheckStatusRequest) throws -> EventLoopFuture<GetHealthCheckStatusResponse> {
    ...
    public func createQueryLoggingConfig(_ input: CreateQueryLoggingConfigRequest) throws -> EventLoopFuture<CreateQueryLoggingConfigResponse> {
    ...
    public func listTrafficPolicyVersions(_ input: ListTrafficPolicyVersionsRequest) throws -> EventLoopFuture<ListTrafficPolicyVersionsResponse> {
    ...
    public func getHealthCheckLastFailureReason(_ input: GetHealthCheckLastFailureReasonRequest) throws -> EventLoopFuture<GetHealthCheckLastFailureReasonResponse> {
    ...
    public func getTrafficPolicy(_ input: GetTrafficPolicyRequest) throws -> EventLoopFuture<GetTrafficPolicyResponse> {
    ...
    public func getHostedZone(_ input: GetHostedZoneRequest) throws -> EventLoopFuture<GetHostedZoneResponse> {
    ...
    public func listResourceRecordSets(_ input: ListResourceRecordSetsRequest) throws -> EventLoopFuture<ListResourceRecordSetsResponse> {
    ...
    public func deleteHostedZone(_ input: DeleteHostedZoneRequest) throws -> EventLoopFuture<DeleteHostedZoneResponse> {
    ...
    public func getGeoLocation(_ input: GetGeoLocationRequest) throws -> EventLoopFuture<GetGeoLocationResponse> {
    ...
    public func createTrafficPolicyVersion(_ input: CreateTrafficPolicyVersionRequest) throws -> EventLoopFuture<CreateTrafficPolicyVersionResponse> {
    ...
    public func deleteQueryLoggingConfig(_ input: DeleteQueryLoggingConfigRequest) throws -> EventLoopFuture<DeleteQueryLoggingConfigResponse> {
    ...
    public func deleteTrafficPolicy(_ input: DeleteTrafficPolicyRequest) throws -> EventLoopFuture<DeleteTrafficPolicyResponse> {
    ...
    public func getTrafficPolicyInstanceCount(_ input: GetTrafficPolicyInstanceCountRequest) throws -> EventLoopFuture<GetTrafficPolicyInstanceCountResponse> {
    ...
    public func testDNSAnswer(_ input: TestDNSAnswerRequest) throws -> EventLoopFuture<TestDNSAnswerResponse> {
    ...
    public func listReusableDelegationSets(_ input: ListReusableDelegationSetsRequest) throws -> EventLoopFuture<ListReusableDelegationSetsResponse> {
    ...
    public func listTrafficPolicyInstancesByPolicy(_ input: ListTrafficPolicyInstancesByPolicyRequest) throws -> EventLoopFuture<ListTrafficPolicyInstancesByPolicyResponse> {
    ...
    public func getHealthCheck(_ input: GetHealthCheckRequest) throws -> EventLoopFuture<GetHealthCheckResponse> {
    ...
    public func getTrafficPolicyInstance(_ input: GetTrafficPolicyInstanceRequest) throws -> EventLoopFuture<GetTrafficPolicyInstanceResponse> {
    ...
    public func listTagsForResources(_ input: ListTagsForResourcesRequest) throws -> EventLoopFuture<ListTagsForResourcesResponse> {
    ...
    public func deleteTrafficPolicyInstance(_ input: DeleteTrafficPolicyInstanceRequest) throws -> EventLoopFuture<DeleteTrafficPolicyInstanceResponse> {
    ...
    public func listGeoLocations(_ input: ListGeoLocationsRequest) throws -> EventLoopFuture<ListGeoLocationsResponse> {
    ...
    public func getChange(_ input: GetChangeRequest) throws -> EventLoopFuture<GetChangeResponse> {
    ...
    public func listHostedZones(_ input: ListHostedZonesRequest) throws -> EventLoopFuture<ListHostedZonesResponse> {
    ...
    public func getHostedZoneLimit(_ input: GetHostedZoneLimitRequest) throws -> EventLoopFuture<GetHostedZoneLimitResponse> {
    ...
    public func getAccountLimit(_ input: GetAccountLimitRequest) throws -> EventLoopFuture<GetAccountLimitResponse> {
