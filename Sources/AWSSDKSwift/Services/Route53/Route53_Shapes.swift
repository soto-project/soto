...
extension Route53 {
    ...
    public struct ListTrafficPolicyInstancesRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil) {
    ...
    public struct ListReusableDelegationSetsResponse: AWSShape {
        ...
        public init(isTruncated: Bool, maxItems: String, delegationSets: DelegationSets, marker: String, nextMarker: String? = nil) {
    ...
    public struct CloudWatchAlarmConfiguration: AWSShape {
        ...
        public init(metricName: String, period: Int32, namespace: String, comparisonOperator: ComparisonOperator, statistic: Statistic, threshold: Double, dimensions: DimensionList? = nil, evaluationPeriods: Int32) {
    ...
    public struct CreateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(name: String, ttl: Int64, trafficPolicyId: String, trafficPolicyVersion: Int32, hostedZoneId: String) {
            self.name = name
            self.ttl = ttl
    ...
    public struct TrafficPolicyInstance: AWSShape {
        ...
        public init(name: String, trafficPolicyType: RRType, ttl: Int64, trafficPolicyId: String, id: String, state: String, hostedZoneId: String, trafficPolicyVersion: Int32, message: String) {
            self.name = name
    ...
    public struct TrafficPolicy: AWSShape {
        ...
        public init(type: RRType, name: String, comment: String? = nil, id: String, document: String, version: Int32) {
            self.`type` = `type`
            self.name = name
            self.comment = comment
            self.id = id
    ...
    public struct ListResourceRecordSetsResponse: AWSShape {
        ...
        public init(isTruncated: Bool, nextRecordType: RRType? = nil, maxItems: String, nextRecordName: String? = nil, resourceRecordSets: ResourceRecordSets, nextRecordIdentifier: String? = nil) {
            self.isTruncated = isTruncated
    ...
    public struct CreateQueryLoggingConfigRequest: AWSShape {
        ...
        public init(hostedZoneId: String, cloudWatchLogsLogGroupArn: String) {
            self.hostedZoneId = hostedZoneId
    ...
    public struct ListQueryLoggingConfigsRequest: AWSShape {
        ...
        public init(maxResults: String? = nil, hostedZoneId: String? = nil, nextToken: String? = nil) {
    ...
    public struct ListHostedZonesResponse: AWSShape {
        ...
        public init(isTruncated: Bool, maxItems: String, marker: String, nextMarker: String? = nil, hostedZones: HostedZones) {
            self.isTruncated = isTruncated
            self.maxItems = maxItems
            self.marker = marker
            self.nextMarker = nextMarker
    ...
    public struct ResourceTagSet: AWSShape {
        ...
        public init(tags: TagList? = nil, resourceType: TagResourceType? = nil, resourceId: String? = nil) {
            self.tags = tags
    ...
    public struct HealthCheckConfig: AWSShape {
        ...
        public init(childHealthChecks: ChildHealthCheckList? = nil, disabled: Bool? = nil, inverted: Bool? = nil, healthThreshold: Int32? = nil, measureLatency: Bool? = nil, failureThreshold: Int32? = nil, alarmIdentifier: AlarmIdentifier? = nil, insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, fullyQualifiedDomainName: String? = nil, resourcePath: String? = nil, regions: HealthCheckRegionList? = nil, requestInterval: Int32? = nil, searchString: String? = nil, port: Int32? = nil, iPAddress: String? = nil, type: HealthCheckType, enableSNI: Bool? = nil) {
    ...
    public struct ListGeoLocationsResponse: AWSShape {
        ...
        public init(isTruncated: Bool, maxItems: String, nextCountryCode: String? = nil, nextSubdivisionCode: String? = nil, nextContinentCode: String? = nil, geoLocationDetailsList: GeoLocationDetailsList) {
            self.isTruncated = isTruncated
            self.maxItems = maxItems
    ...
    public struct ResourceRecordSet: AWSShape {
        ...
        public init(trafficPolicyInstanceId: String? = nil, weight: Int64? = nil, setIdentifier: String? = nil, failover: ResourceRecordSetFailover? = nil, resourceRecords: ResourceRecords? = nil, name: String, ttl: Int64? = nil, aliasTarget: AliasTarget? = nil, geoLocation: GeoLocation? = nil, region: ResourceRecordSetRegion? = nil, type: RRType, healthCheckId: String? = nil, multiValueAnswer: Bool? = nil) {
    ...
    public struct CreateHostedZoneResponse: AWSShape {
        ...
        public init(hostedZone: HostedZone, changeInfo: ChangeInfo, delegationSet: DelegationSet, location: String, vpc: VPC? = nil) {
            self.hostedZone = hostedZone
            self.changeInfo = changeInfo
    ...
    public struct CreateHostedZoneRequest: AWSShape {
        ...
        public init(hostedZoneConfig: HostedZoneConfig? = nil, callerReference: String, name: String, delegationSetId: String? = nil, vpc: VPC? = nil) {
    ...
    public struct ListHostedZonesByNameResponse: AWSShape {
        ...
        public init(dNSName: String? = nil, nextDNSName: String? = nil, isTruncated: Bool, nextHostedZoneId: String? = nil, hostedZones: HostedZones, maxItems: String, hostedZoneId: String? = nil) {
            self.dNSName = dNSName
    ...
    public struct ListGeoLocationsRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, startSubdivisionCode: String? = nil, startContinentCode: String? = nil, startCountryCode: String? = nil) {
            self.maxItems = maxItems
    ...
    public struct TestDNSAnswerResponse: AWSShape {
        ...
        public init(recordData: RecordData, recordName: String, protocol: String, responseCode: String, recordType: RRType, nameserver: String) {
    ...
    public struct ListTrafficPolicyInstancesByPolicyResponse: AWSShape {
        ...
        public init(isTruncated: Bool, maxItems: String, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, trafficPolicyInstances: TrafficPolicyInstances) {
            self.isTruncated = isTruncated
            self.maxItems = maxItems
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
    ...
    public struct HostedZone: AWSShape {
        ...
        public init(resourceRecordSetCount: Int64? = nil, callerReference: String, name: String, id: String, linkedService: LinkedService? = nil, config: HostedZoneConfig? = nil) {
    ...
    public struct CreateTrafficPolicyRequest: AWSShape {
        ...
        public init(document: String, comment: String? = nil, name: String) {
            self.document = document
            self.comment = comment
            self.name = name
        }
    ...
    public struct TrafficPolicySummary: AWSShape {
        ...
        public init(type: RRType, name: String, id: String, latestVersion: Int32, trafficPolicyCount: Int32) {
            self.`type` = `type`
            self.name = name
            self.id = id
    ...
    public struct UpdateHealthCheckRequest: AWSShape {
        ...
        public init(disabled: Bool? = nil, inverted: Bool? = nil, healthThreshold: Int32? = nil, resetElements: ResettableElementNameList? = nil, healthCheckVersion: Int64? = nil, failureThreshold: Int32? = nil, alarmIdentifier: AlarmIdentifier? = nil, insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, fullyQualifiedDomainName: String? = nil, resourcePath: String? = nil, regions: HealthCheckRegionList? = nil, searchString: String? = nil, port: Int32? = nil, iPAddress: String? = nil, healthCheckId: String, enableSNI: Bool? = nil, childHealthChecks: ChildHealthCheckList? = nil) {
            self.disabled = disabled
            self.inverted = inverted
            self.healthThreshold = healthThreshold
    ...
    public struct HealthCheck: AWSShape {
        ...
        public init(healthCheckVersion: Int64, callerReference: String, id: String, linkedService: LinkedService? = nil, healthCheckConfig: HealthCheckConfig, cloudWatchAlarmConfiguration: CloudWatchAlarmConfiguration? = nil) {
            self.healthCheckVersion = healthCheckVersion
            self.callerReference = callerReference
            self.id = id
            self.linkedService = linkedService
    ...
    public struct TestDNSAnswerRequest: AWSShape {
        ...
        public init(resolverIP: String? = nil, eDNS0ClientSubnetMask: String? = nil, recordName: String, recordType: RRType, eDNS0ClientSubnetIP: String? = nil, hostedZoneId: String) {
    ...
    public struct ListTrafficPolicyInstancesByPolicyRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, trafficPolicyId: String, hostedZoneIdMarker: String? = nil, trafficPolicyVersion: Int32, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil) {
            self.maxItems = maxItems
            self.trafficPolicyId = trafficPolicyId
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.trafficPolicyVersion = trafficPolicyVersion
    ...
    public struct UpdateTrafficPolicyCommentRequest: AWSShape {
        ...
        public init(id: String, comment: String, version: Int32) {
            self.id = id
            self.comment = comment
            self.version = version
        }
    ...
    public struct UpdateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(trafficPolicyId: String, ttl: Int64, id: String, trafficPolicyVersion: Int32) {
            self.trafficPolicyId = trafficPolicyId
            self.ttl = ttl
            self.id = id
            self.trafficPolicyVersion = trafficPolicyVersion
    ...
    public struct ListVPCAssociationAuthorizationsRequest: AWSShape {
        ...
        public init(maxResults: String? = nil, hostedZoneId: String, nextToken: String? = nil) {
            self.maxResults = maxResults
            self.hostedZoneId = hostedZoneId
            self.nextToken = nextToken
        }
    ...
    public struct ChangeTagsForResourceRequest: AWSShape {
        ...
        public init(resourceType: TagResourceType, removeTagKeys: TagKeyList? = nil, resourceId: String, addTags: TagList? = nil) {
            self.resourceType = resourceType
    ...
    public struct ListHealthChecksResponse: AWSShape {
        ...
        public init(isTruncated: Bool, maxItems: String, healthChecks: HealthChecks, marker: String, nextMarker: String? = nil) {
            self.isTruncated = isTruncated
            self.maxItems = maxItems
    ...
    public struct ListResourceRecordSetsRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, startRecordType: RRType? = nil, startRecordIdentifier: String? = nil, hostedZoneId: String, startRecordName: String? = nil) {
            self.maxItems = maxItems
    ...
    public struct DelegationSet: AWSShape {
        ...
        public init(callerReference: String? = nil, nameServers: DelegationSetNameServers, id: String? = nil) {
            self.callerReference = callerReference
    ...
    public struct ListTrafficPoliciesResponse: AWSShape {
        ...
        public init(isTruncated: Bool, trafficPolicyIdMarker: String, maxItems: String, trafficPolicySummaries: TrafficPolicySummaries) {
            self.isTruncated = isTruncated
            self.trafficPolicyIdMarker = trafficPolicyIdMarker
            self.maxItems = maxItems
    ...
    public struct GeoLocationDetails: AWSShape {
        ...
        public init(subdivisionCode: String? = nil, subdivisionName: String? = nil, countryName: String? = nil, countryCode: String? = nil, continentName: String? = nil, continentCode: String? = nil) {
            self.subdivisionCode = subdivisionCode
