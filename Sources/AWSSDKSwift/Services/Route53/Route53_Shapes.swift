...
extension Route53 {
    ...
    public struct CreateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(hostedZoneId: String, trafficPolicyId: String, ttl: Int64, trafficPolicyVersion: Int32, name: String) {
    ...
    public struct CreateHostedZoneResponse: AWSShape {
        ...
        public init(delegationSet: DelegationSet, vpc: VPC? = nil, changeInfo: ChangeInfo, hostedZone: HostedZone, location: String) {
            self.delegationSet = delegationSet
            self.vpc = vpc
    ...
    public struct TrafficPolicy: AWSShape {
        ...
        public init(type: RRType, document: String, name: String, comment: String? = nil, id: String, version: Int32) {
            self.`type` = `type`
    ...
    public struct ListHostedZonesResponse: AWSShape {
        ...
        public init(marker: String, hostedZones: HostedZones, isTruncated: Bool, maxItems: String, nextMarker: String? = nil) {
            self.marker = marker
    ...
    public struct UpdateHealthCheckRequest: AWSShape {
        ...
        public init(iPAddress: String? = nil, healthCheckId: String, insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, resourcePath: String? = nil, enableSNI: Bool? = nil, disabled: Bool? = nil, port: Int32? = nil, alarmIdentifier: AlarmIdentifier? = nil, inverted: Bool? = nil, childHealthChecks: ChildHealthCheckList? = nil, healthCheckVersion: Int64? = nil, searchString: String? = nil, resetElements: ResettableElementNameList? = nil, healthThreshold: Int32? = nil, fullyQualifiedDomainName: String? = nil, regions: HealthCheckRegionList? = nil, failureThreshold: Int32? = nil) {
    ...
    public struct CreateTrafficPolicyVersionRequest: AWSShape {
        ...
        public init(comment: String? = nil, id: String, document: String) {
            self.comment = comment
            self.id = id
            self.document = document
        }
    ...
    public struct TrafficPolicySummary: AWSShape {
        ...
        public init(type: RRType, latestVersion: Int32, trafficPolicyCount: Int32, id: String, name: String) {
            self.`type` = `type`
    ...
    public struct ListGeoLocationsResponse: AWSShape {
        ...
        public init(nextContinentCode: String? = nil, nextSubdivisionCode: String? = nil, isTruncated: Bool, maxItems: String, nextCountryCode: String? = nil, geoLocationDetailsList: GeoLocationDetailsList) {
    ...
    public struct CreateVPCAssociationAuthorizationRequest: AWSShape {
        ...
        public init(vpc: VPC, hostedZoneId: String) {
            self.vpc = vpc
            self.hostedZoneId = hostedZoneId
        }
    ...
    public struct CreateHealthCheckResponse: AWSShape {
        ...
        public init(location: String, healthCheck: HealthCheck) {
            self.location = location
            self.healthCheck = healthCheck
        }
    ...
    public struct ListTrafficPolicyVersionsResponse: AWSShape {
        ...
        public init(trafficPolicies: TrafficPolicies, isTruncated: Bool, trafficPolicyVersionMarker: String, maxItems: String) {
    ...
    public struct HostedZone: AWSShape {
        ...
        public init(callerReference: String, linkedService: LinkedService? = nil, resourceRecordSetCount: Int64? = nil, name: String, config: HostedZoneConfig? = nil, id: String) {
    ...
    public struct UpdateTrafficPolicyCommentRequest: AWSShape {
        ...
        public init(version: Int32, id: String, comment: String) {
            self.version = version
            self.id = id
            self.comment = comment
        }
    ...
    public struct ChangeInfo: AWSShape {
        ...
        public init(status: ChangeStatus, id: String, submittedAt: TimeStamp, comment: String? = nil) {
            self.status = status
            self.id = id
    ...
    public struct DisassociateVPCFromHostedZoneRequest: AWSShape {
        ...
        public init(vpc: VPC, comment: String? = nil, hostedZoneId: String) {
            self.vpc = vpc
            self.comment = comment
            self.hostedZoneId = hostedZoneId
        }
    ...
    public struct HealthCheckObservation: AWSShape {
        ...
        public init(statusReport: StatusReport? = nil, region: HealthCheckRegion? = nil, iPAddress: String? = nil) {
    ...
    public struct ListHostedZonesByNameResponse: AWSShape {
        ...
        public init(hostedZones: HostedZones, dNSName: String? = nil, maxItems: String, isTruncated: Bool, hostedZoneId: String? = nil, nextHostedZoneId: String? = nil, nextDNSName: String? = nil) {
            self.hostedZones = hostedZones
    ...
    public struct TrafficPolicyInstance: AWSShape {
        ...
        public init(ttl: Int64, id: String, trafficPolicyId: String, trafficPolicyType: RRType, hostedZoneId: String, message: String, state: String, trafficPolicyVersion: Int32, name: String) {
            self.ttl = ttl
            self.id = id
            self.trafficPolicyId = trafficPolicyId
    ...
    public struct GeoLocationDetails: AWSShape {
        ...
        public init(countryCode: String? = nil, continentCode: String? = nil, subdivisionName: String? = nil, continentName: String? = nil, countryName: String? = nil, subdivisionCode: String? = nil) {
            self.countryCode = countryCode
            self.continentCode = continentCode
    ...
    public struct TestDNSAnswerResponse: AWSShape {
        ...
        public init(nameserver: String, recordData: RecordData, responseCode: String, recordType: RRType, protocol: String, recordName: String) {
    ...
    public struct GetHostedZoneResponse: AWSShape {
        ...
        public init(hostedZone: HostedZone, delegationSet: DelegationSet? = nil, vPCs: VPCs? = nil) {
            self.hostedZone = hostedZone
            self.delegationSet = delegationSet
            self.vPCs = vPCs
        }
    ...
    public struct ListTrafficPolicyInstancesByPolicyResponse: AWSShape {
        ...
        public init(trafficPolicyInstances: TrafficPolicyInstances, isTruncated: Bool, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceNameMarker: String? = nil, maxItems: String, trafficPolicyInstanceTypeMarker: RRType? = nil) {
    ...
    public struct ListResourceRecordSetsRequest: AWSShape {
        ...
        public init(hostedZoneId: String, startRecordType: RRType? = nil, startRecordName: String? = nil, startRecordIdentifier: String? = nil, maxItems: String? = nil) {
            self.hostedZoneId = hostedZoneId
    ...
    public struct ListResourceRecordSetsResponse: AWSShape {
        ...
        public init(nextRecordName: String? = nil, nextRecordIdentifier: String? = nil, isTruncated: Bool, maxItems: String, resourceRecordSets: ResourceRecordSets, nextRecordType: RRType? = nil) {
    ...
    public struct ListTrafficPolicyInstancesRequest: AWSShape {
        ...
        public init(trafficPolicyInstanceNameMarker: String? = nil, maxItems: String? = nil, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil) {
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.maxItems = maxItems
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
    ...
    public struct ListReusableDelegationSetsResponse: AWSShape {
        ...
        public init(marker: String, delegationSets: DelegationSets, isTruncated: Bool, maxItems: String, nextMarker: String? = nil) {
            self.marker = marker
    ...
    public struct ChangeTagsForResourceRequest: AWSShape {
        ...
        public init(resourceId: String, resourceType: TagResourceType, addTags: TagList? = nil, removeTagKeys: TagKeyList? = nil) {
            self.resourceId = resourceId
            self.resourceType = resourceType
    ...
    public struct ListHealthChecksResponse: AWSShape {
        ...
        public init(marker: String, isTruncated: Bool, healthChecks: HealthChecks, maxItems: String, nextMarker: String? = nil) {
            self.marker = marker
            self.isTruncated = isTruncated
    ...
    public struct HealthCheck: AWSShape {
        ...
        public init(healthCheckVersion: Int64, callerReference: String, linkedService: LinkedService? = nil, healthCheckConfig: HealthCheckConfig, cloudWatchAlarmConfiguration: CloudWatchAlarmConfiguration? = nil, id: String) {
            self.healthCheckVersion = healthCheckVersion
            self.callerReference = callerReference
            self.linkedService = linkedService
            self.healthCheckConfig = healthCheckConfig
    ...
    public struct ListQueryLoggingConfigsResponse: AWSShape {
        ...
        public init(queryLoggingConfigs: QueryLoggingConfigs, nextToken: String? = nil) {
    ...
    public struct ListTrafficPolicyInstancesByHostedZoneResponse: AWSShape {
        ...
        public init(trafficPolicyInstances: TrafficPolicyInstances, isTruncated: Bool, trafficPolicyInstanceNameMarker: String? = nil, maxItems: String, trafficPolicyInstanceTypeMarker: RRType? = nil) {
            self.trafficPolicyInstances = trafficPolicyInstances
            self.isTruncated = isTruncated
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.maxItems = maxItems
    ...
    public struct CreateTrafficPolicyInstanceResponse: AWSShape {
        ...
        public init(trafficPolicyInstance: TrafficPolicyInstance, location: String) {
            self.trafficPolicyInstance = trafficPolicyInstance
            self.location = location
        }
    ...
    public struct UpdateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(trafficPolicyId: String, ttl: Int64, trafficPolicyVersion: Int32, id: String) {
            self.trafficPolicyId = trafficPolicyId
            self.ttl = ttl
            self.trafficPolicyVersion = trafficPolicyVersion
            self.id = id
    ...
    public struct ResourceRecordSet: AWSShape {
        ...
        public init(healthCheckId: String? = nil, setIdentifier: String? = nil, resourceRecords: ResourceRecords? = nil, region: ResourceRecordSetRegion? = nil, type: RRType, ttl: Int64? = nil, failover: ResourceRecordSetFailover? = nil, geoLocation: GeoLocation? = nil, weight: Int64? = nil, multiValueAnswer: Bool? = nil, trafficPolicyInstanceId: String? = nil, name: String, aliasTarget: AliasTarget? = nil) {
            self.healthCheckId = healthCheckId
    ...
    public struct CloudWatchAlarmConfiguration: AWSShape {
        ...
        public init(comparisonOperator: ComparisonOperator, dimensions: DimensionList? = nil, period: Int32, metricName: String, evaluationPeriods: Int32, threshold: Double, namespace: String, statistic: Statistic) {
    ...
    public struct ListTagsForResourcesRequest: AWSShape {
        ...
        public init(resourceType: TagResourceType, resourceIds: TagResourceIdList) {
            self.resourceType = resourceType
    ...
    public struct AccountLimit: AWSShape {
        ...
        public init(value: Int64, type: AccountLimitType) {
            self.value = value
            self.`type` = `type`
        }
    ...
    public struct ListTrafficPoliciesResponse: AWSShape {
        ...
        public init(trafficPolicyIdMarker: String, isTruncated: Bool, trafficPolicySummaries: TrafficPolicySummaries, maxItems: String) {
    ...
    public struct ListTrafficPolicyInstancesByHostedZoneRequest: AWSShape {
        ...
        public init(hostedZoneId: String, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, maxItems: String? = nil) {
            self.hostedZoneId = hostedZoneId
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.maxItems = maxItems
    ...
    public struct ListTrafficPolicyVersionsRequest: AWSShape {
        ...
        public init(trafficPolicyVersionMarker: String? = nil, id: String, maxItems: String? = nil) {
            self.trafficPolicyVersionMarker = trafficPolicyVersionMarker
            self.id = id
            self.maxItems = maxItems
        }
    ...
    public struct CreateHostedZoneRequest: AWSShape {
        ...
        public init(callerReference: String, hostedZoneConfig: HostedZoneConfig? = nil, name: String, delegationSetId: String? = nil, vpc: VPC? = nil) {
            self.callerReference = callerReference
    ...
    public struct ListTrafficPolicyInstancesByPolicyRequest: AWSShape {
        ...
        public init(trafficPolicyId: String, trafficPolicyVersion: Int32, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, maxItems: String? = nil) {
            self.trafficPolicyId = trafficPolicyId
            self.trafficPolicyVersion = trafficPolicyVersion
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
    ...
    public struct CreateTrafficPolicyRequest: AWSShape {
        ...
        public init(comment: String? = nil, name: String, document: String) {
            self.comment = comment
            self.name = name
            self.document = document
        }
    ...
    public struct HealthCheckConfig: AWSShape {
        ...
        public init(measureLatency: Bool? = nil, iPAddress: String? = nil, insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, resourcePath: String? = nil, enableSNI: Bool? = nil, requestInterval: Int32? = nil, disabled: Bool? = nil, type: HealthCheckType, port: Int32? = nil, alarmIdentifier: AlarmIdentifier? = nil, inverted: Bool? = nil, childHealthChecks: ChildHealthCheckList? = nil, searchString: String? = nil, healthThreshold: Int32? = nil, fullyQualifiedDomainName: String? = nil, regions: HealthCheckRegionList? = nil, failureThreshold: Int32? = nil) {
    ...
    public struct TestDNSAnswerRequest: AWSShape {
        ...
        public init(hostedZoneId: String, recordName: String, eDNS0ClientSubnetMask: String? = nil, recordType: RRType, eDNS0ClientSubnetIP: String? = nil, resolverIP: String? = nil) {
            self.hostedZoneId = hostedZoneId
            self.recordName = recordName
    ...
    public struct QueryLoggingConfig: AWSShape {
        ...
        public init(cloudWatchLogsLogGroupArn: String, id: String, hostedZoneId: String) {
            self.cloudWatchLogsLogGroupArn = cloudWatchLogsLogGroupArn
            self.id = id
            self.hostedZoneId = hostedZoneId
        }
