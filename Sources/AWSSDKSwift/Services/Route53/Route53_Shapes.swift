...
extension Route53 {
    ...
    public struct ListHostedZonesRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, delegationSetId: String? = nil, marker: String? = nil) {
            self.maxItems = maxItems
    ...
    public struct ListVPCAssociationAuthorizationsRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: String? = nil, hostedZoneId: String) {
            self.nextToken = nextToken
    ...
    public struct ListTrafficPolicyInstancesResponse: AWSShape {
        ...
        public init(trafficPolicyInstanceNameMarker: String? = nil, hostedZoneIdMarker: String? = nil, trafficPolicyInstances: TrafficPolicyInstances, isTruncated: Bool, trafficPolicyInstanceTypeMarker: RRType? = nil, maxItems: String) {
    ...
    public struct ChangeInfo: AWSShape {
        ...
        public init(submittedAt: TimeStamp, comment: String? = nil, status: ChangeStatus, id: String) {
    ...
    public struct TestDNSAnswerRequest: AWSShape {
        ...
        public init(eDNS0ClientSubnetMask: String? = nil, recordName: String, recordType: RRType, hostedZoneId: String, resolverIP: String? = nil, eDNS0ClientSubnetIP: String? = nil) {
    ...
    public struct ListTrafficPolicyInstancesRequest: AWSShape {
        ...
        public init(trafficPolicyInstanceNameMarker: String? = nil, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, maxItems: String? = nil) {
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.maxItems = maxItems
    ...
    public struct ListVPCAssociationAuthorizationsResponse: AWSShape {
        ...
        public init(nextToken: String? = nil, hostedZoneId: String, vPCs: VPCs) {
            self.nextToken = nextToken
            self.hostedZoneId = hostedZoneId
            self.vPCs = vPCs
        }
    ...
    public struct HealthCheck: AWSShape {
        ...
        public init(callerReference: String, healthCheckConfig: HealthCheckConfig, linkedService: LinkedService? = nil, healthCheckVersion: Int64, id: String, cloudWatchAlarmConfiguration: CloudWatchAlarmConfiguration? = nil) {
    ...
    public struct ResourceRecordSet: AWSShape {
        ...
        public init(name: String, weight: Int64? = nil, region: ResourceRecordSetRegion? = nil, healthCheckId: String? = nil, multiValueAnswer: Bool? = nil, geoLocation: GeoLocation? = nil, resourceRecords: ResourceRecords? = nil, aliasTarget: AliasTarget? = nil, trafficPolicyInstanceId: String? = nil, ttl: Int64? = nil, type: RRType, setIdentifier: String? = nil, failover: ResourceRecordSetFailover? = nil) {
            self.name = name
            self.weight = weight
            self.region = region
    ...
    public struct HealthCheckObservation: AWSShape {
        ...
        public init(region: HealthCheckRegion? = nil, iPAddress: String? = nil, statusReport: StatusReport? = nil) {
            self.region = region
    ...
    public struct ListHostedZonesByNameResponse: AWSShape {
        ...
        public init(nextHostedZoneId: String? = nil, hostedZones: HostedZones, dNSName: String? = nil, nextDNSName: String? = nil, hostedZoneId: String? = nil, isTruncated: Bool, maxItems: String) {
    ...
    public struct ListResourceRecordSetsResponse: AWSShape {
        ...
        public init(nextRecordType: RRType? = nil, nextRecordIdentifier: String? = nil, resourceRecordSets: ResourceRecordSets, nextRecordName: String? = nil, isTruncated: Bool, maxItems: String) {
    ...
    public struct CreateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(trafficPolicyId: String, name: String, ttl: Int64, trafficPolicyVersion: Int32, hostedZoneId: String) {
    ...
    public struct CreateHostedZoneRequest: AWSShape {
        ...
        public init(name: String, delegationSetId: String? = nil, hostedZoneConfig: HostedZoneConfig? = nil, callerReference: String, vpc: VPC? = nil) {
            self.name = name
            self.delegationSetId = delegationSetId
    ...
    public struct GeoLocationDetails: AWSShape {
        ...
        public init(continentName: String? = nil, countryCode: String? = nil, countryName: String? = nil, subdivisionCode: String? = nil, continentCode: String? = nil, subdivisionName: String? = nil) {
    ...
    public struct TestDNSAnswerResponse: AWSShape {
        ...
        public init(recordData: RecordData, protocol: String, responseCode: String, recordName: String, recordType: RRType, nameserver: String) {
    ...
    public struct DelegationSet: AWSShape {
        ...
        public init(id: String? = nil, nameServers: DelegationSetNameServers, callerReference: String? = nil) {
            self.id = id
    ...
    public struct AssociateVPCWithHostedZoneRequest: AWSShape {
        ...
        public init(comment: String? = nil, vpc: VPC, hostedZoneId: String) {
            self.comment = comment
            self.vpc = vpc
            self.hostedZoneId = hostedZoneId
        }
    ...
    public struct ListGeoLocationsRequest: AWSShape {
        ...
        public init(startContinentCode: String? = nil, startSubdivisionCode: String? = nil, startCountryCode: String? = nil, maxItems: String? = nil) {
    ...
    public struct ListQueryLoggingConfigsRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: String? = nil, hostedZoneId: String? = nil) {
            self.nextToken = nextToken
            self.maxResults = maxResults
            self.hostedZoneId = hostedZoneId
        }
    ...
    public struct ListTrafficPolicyInstancesByHostedZoneResponse: AWSShape {
        ...
        public init(trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, isTruncated: Bool, trafficPolicyInstances: TrafficPolicyInstances, maxItems: String) {
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.isTruncated = isTruncated
            self.trafficPolicyInstances = trafficPolicyInstances
    ...
    public struct ListTrafficPolicyInstancesByPolicyRequest: AWSShape {
        ...
        public init(trafficPolicyId: String, trafficPolicyInstanceNameMarker: String? = nil, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, trafficPolicyVersion: Int32, maxItems: String? = nil) {
            self.trafficPolicyId = trafficPolicyId
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
    ...
    public struct UpdateTrafficPolicyCommentRequest: AWSShape {
        ...
        public init(id: String, version: Int32, comment: String) {
            self.id = id
            self.version = version
            self.comment = comment
        }
    ...
    public struct TrafficPolicy: AWSShape {
        ...
        public init(document: String, name: String, type: RRType, comment: String? = nil, version: Int32, id: String) {
            self.document = document
            self.name = name
            self.`type` = `type`
            self.comment = comment
    ...
    public struct ListTrafficPoliciesResponse: AWSShape {
        ...
        public init(isTruncated: Bool, trafficPolicyIdMarker: String, trafficPolicySummaries: TrafficPolicySummaries, maxItems: String) {
            self.isTruncated = isTruncated
            self.trafficPolicyIdMarker = trafficPolicyIdMarker
    ...
    public struct HostedZone: AWSShape {
        ...
        public init(name: String, linkedService: LinkedService? = nil, resourceRecordSetCount: Int64? = nil, config: HostedZoneConfig? = nil, callerReference: String, id: String) {
            self.name = name
            self.linkedService = linkedService
    ...
    public struct ListHealthChecksResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, isTruncated: Bool, healthChecks: HealthChecks, marker: String, maxItems: String) {
    ...
    public struct TrafficPolicySummary: AWSShape {
        ...
        public init(name: String, latestVersion: Int32, type: RRType, trafficPolicyCount: Int32, id: String) {
            self.name = name
    ...
    public struct TrafficPolicyInstance: AWSShape {
        ...
        public init(trafficPolicyType: RRType, state: String, trafficPolicyId: String, message: String, trafficPolicyVersion: Int32, ttl: Int64, hostedZoneId: String, id: String, name: String) {
    ...
    public struct ChangeTagsForResourceRequest: AWSShape {
        ...
        public init(resourceType: TagResourceType, resourceId: String, addTags: TagList? = nil, removeTagKeys: TagKeyList? = nil) {
    ...
    public struct ResourceTagSet: AWSShape {
        ...
        public init(resourceType: TagResourceType? = nil, resourceId: String? = nil, tags: TagList? = nil) {
            self.resourceType = resourceType
            self.resourceId = resourceId
            self.tags = tags
        }
    ...
    public struct HealthCheckConfig: AWSShape {
        ...
        public init(insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, iPAddress: String? = nil, measureLatency: Bool? = nil, regions: HealthCheckRegionList? = nil, enableSNI: Bool? = nil, alarmIdentifier: AlarmIdentifier? = nil, resourcePath: String? = nil, requestInterval: Int32? = nil, fullyQualifiedDomainName: String? = nil, childHealthChecks: ChildHealthCheckList? = nil, type: HealthCheckType, failureThreshold: Int32? = nil, searchString: String? = nil, port: Int32? = nil, healthThreshold: Int32? = nil, inverted: Bool? = nil) {
    ...
    public struct UpdateHealthCheckRequest: AWSShape {
        ...
        public init(insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, iPAddress: String? = nil, healthCheckId: String, enableSNI: Bool? = nil, regions: HealthCheckRegionList? = nil, healthCheckVersion: Int64? = nil, alarmIdentifier: AlarmIdentifier? = nil, resourcePath: String? = nil, fullyQualifiedDomainName: String? = nil, resetElements: ResettableElementNameList? = nil, childHealthChecks: ChildHealthCheckList? = nil, failureThreshold: Int32? = nil, searchString: String? = nil, port: Int32? = nil, healthThreshold: Int32? = nil, inverted: Bool? = nil) {
            self.insufficientDataHealthStatus = insufficientDataHealthStatus
            self.iPAddress = iPAddress
            self.healthCheckId = healthCheckId
            self.enableSNI = enableSNI
    ...
    public struct ListResourceRecordSetsRequest: AWSShape {
        ...
        public init(startRecordIdentifier: String? = nil, startRecordName: String? = nil, hostedZoneId: String, startRecordType: RRType? = nil, maxItems: String? = nil) {
    ...
    public struct ListGeoLocationsResponse: AWSShape {
        ...
        public init(nextCountryCode: String? = nil, nextSubdivisionCode: String? = nil, geoLocationDetailsList: GeoLocationDetailsList, isTruncated: Bool, nextContinentCode: String? = nil, maxItems: String) {
    ...
    public struct ListHostedZonesResponse: AWSShape {
        ...
        public init(hostedZones: HostedZones, isTruncated: Bool, marker: String, nextMarker: String? = nil, maxItems: String) {
            self.hostedZones = hostedZones
            self.isTruncated = isTruncated
            self.marker = marker
            self.nextMarker = nextMarker
    ...
    public struct ListTrafficPolicyVersionsRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, id: String, trafficPolicyVersionMarker: String? = nil) {
            self.maxItems = maxItems
            self.id = id
    ...
    public struct CloudWatchAlarmConfiguration: AWSShape {
        ...
        public init(dimensions: DimensionList? = nil, comparisonOperator: ComparisonOperator, period: Int32, evaluationPeriods: Int32, metricName: String, threshold: Double, namespace: String, statistic: Statistic) {
    ...
    public struct ListTrafficPolicyVersionsResponse: AWSShape {
        ...
        public init(trafficPolicies: TrafficPolicies, trafficPolicyVersionMarker: String, isTruncated: Bool, maxItems: String) {
    ...
    public struct CreateHostedZoneResponse: AWSShape {
        ...
        public init(vpc: VPC? = nil, delegationSet: DelegationSet, changeInfo: ChangeInfo, location: String, hostedZone: HostedZone) {
            self.vpc = vpc
            self.delegationSet = delegationSet
            self.changeInfo = changeInfo
            self.location = location
    ...
    public struct ListTrafficPolicyInstancesByHostedZoneRequest: AWSShape {
        ...
        public init(trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, hostedZoneId: String, maxItems: String? = nil) {
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.hostedZoneId = hostedZoneId
            self.maxItems = maxItems
    ...
    public struct ListReusableDelegationSetsResponse: AWSShape {
        ...
        public init(delegationSets: DelegationSets, isTruncated: Bool, marker: String, nextMarker: String? = nil, maxItems: String) {
