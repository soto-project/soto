...
extension Route53 {
    ...
    public struct UpdateHealthCheckRequest: AWSShape {
        ...
        public init(regions: HealthCheckRegionList? = nil, alarmIdentifier: AlarmIdentifier? = nil, healthCheckVersion: Int64? = nil, healthThreshold: Int32? = nil, inverted: Bool? = nil, enableSNI: Bool? = nil, port: Int32? = nil, searchString: String? = nil, insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, fullyQualifiedDomainName: String? = nil, childHealthChecks: ChildHealthCheckList? = nil, iPAddress: String? = nil, failureThreshold: Int32? = nil, healthCheckId: String, resetElements: ResettableElementNameList? = nil, resourcePath: String? = nil, disabled: Bool? = nil) {
    ...
    public struct AlarmIdentifier: AWSShape {
        ...
        public init(region: CloudWatchRegion, name: String) {
            self.region = region
            self.name = name
        }
    ...
    public struct TrafficPolicy: AWSShape {
        ...
        public init(comment: String? = nil, id: String, document: String, version: Int32, type: RRType, name: String) {
    ...
    public struct ChangeResourceRecordSetsRequest: AWSShape {
        ...
        public init(hostedZoneId: String, changeBatch: ChangeBatch) {
            self.hostedZoneId = hostedZoneId
    ...
    public struct ListQueryLoggingConfigsRequest: AWSShape {
        ...
        public init(maxResults: String? = nil, nextToken: String? = nil, hostedZoneId: String? = nil) {
            self.maxResults = maxResults
            self.nextToken = nextToken
            self.hostedZoneId = hostedZoneId
        }
    ...
    public struct TestDNSAnswerResponse: AWSShape {
        ...
        public init(recordName: String, recordType: RRType, nameserver: String, responseCode: String, recordData: RecordData, protocol: String) {
    ...
    public struct CreateHostedZoneRequest: AWSShape {
        ...
        public init(name: String, hostedZoneConfig: HostedZoneConfig? = nil, vpc: VPC? = nil, delegationSetId: String? = nil, callerReference: String) {
            self.name = name
    ...
    public struct HealthCheck: AWSShape {
        ...
        public init(linkedService: LinkedService? = nil, id: String, callerReference: String, healthCheckConfig: HealthCheckConfig, healthCheckVersion: Int64, cloudWatchAlarmConfiguration: CloudWatchAlarmConfiguration? = nil) {
    ...
    public struct ListReusableDelegationSetsResponse: AWSShape {
        ...
        public init(marker: String, isTruncated: Bool, delegationSets: DelegationSets, maxItems: String, nextMarker: String? = nil) {
            self.marker = marker
    ...
    public struct UpdateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(id: String, ttl: Int64, trafficPolicyId: String, trafficPolicyVersion: Int32) {
            self.id = id
            self.ttl = ttl
    ...
    public struct ListGeoLocationsRequest: AWSShape {
        ...
        public init(startSubdivisionCode: String? = nil, startCountryCode: String? = nil, startContinentCode: String? = nil, maxItems: String? = nil) {
    ...
    public struct ListTrafficPolicyInstancesByHostedZoneResponse: AWSShape {
        ...
        public init(isTruncated: Bool, trafficPolicyInstanceTypeMarker: RRType? = nil, trafficPolicyInstanceNameMarker: String? = nil, maxItems: String, trafficPolicyInstances: TrafficPolicyInstances) {
            self.isTruncated = isTruncated
    ...
    public struct CreateTrafficPolicyVersionResponse: AWSShape {
        ...
        public init(trafficPolicy: TrafficPolicy, location: String) {
            self.trafficPolicy = trafficPolicy
    ...
    public struct ListResourceRecordSetsRequest: AWSShape {
        ...
        public init(startRecordName: String? = nil, maxItems: String? = nil, hostedZoneId: String, startRecordType: RRType? = nil, startRecordIdentifier: String? = nil) {
    ...
    public struct TrafficPolicySummary: AWSShape {
        ...
        public init(name: String, latestVersion: Int32, type: RRType, id: String, trafficPolicyCount: Int32) {
            self.name = name
    ...
    public struct ListTrafficPolicyInstancesByPolicyRequest: AWSShape {
        ...
        public init(trafficPolicyInstanceTypeMarker: RRType? = nil, trafficPolicyVersion: Int32, hostedZoneIdMarker: String? = nil, maxItems: String? = nil, trafficPolicyId: String, trafficPolicyInstanceNameMarker: String? = nil) {
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.trafficPolicyVersion = trafficPolicyVersion
    ...
    public struct ListTrafficPolicyVersionsResponse: AWSShape {
        ...
        public init(trafficPolicyVersionMarker: String, isTruncated: Bool, trafficPolicies: TrafficPolicies, maxItems: String) {
    ...
    public struct CreateTrafficPolicyRequest: AWSShape {
        ...
        public init(name: String, document: String, comment: String? = nil) {
            self.name = name
            self.document = document
            self.comment = comment
        }
    ...
    public struct TestDNSAnswerRequest: AWSShape {
        ...
        public init(eDNS0ClientSubnetMask: String? = nil, resolverIP: String? = nil, recordName: String, recordType: RRType, hostedZoneId: String, eDNS0ClientSubnetIP: String? = nil) {
    ...
    public struct CloudWatchAlarmConfiguration: AWSShape {
        ...
        public init(dimensions: DimensionList? = nil, threshold: Double, statistic: Statistic, period: Int32, namespace: String, comparisonOperator: ComparisonOperator, evaluationPeriods: Int32, metricName: String) {
    ...
    public struct TrafficPolicyInstance: AWSShape {
        ...
        public init(name: String, hostedZoneId: String, message: String, trafficPolicyId: String, ttl: Int64, state: String, id: String, trafficPolicyVersion: Int32, trafficPolicyType: RRType) {
            self.name = name
            self.hostedZoneId = hostedZoneId
    ...
    public struct AliasTarget: AWSShape {
        ...
        public init(hostedZoneId: String, dNSName: String, evaluateTargetHealth: Bool) {
            self.hostedZoneId = hostedZoneId
    ...
    public struct HostedZone: AWSShape {
        ...
        public init(id: String, config: HostedZoneConfig? = nil, name: String, callerReference: String, resourceRecordSetCount: Int64? = nil, linkedService: LinkedService? = nil) {
            self.id = id
            self.config = config
            self.name = name
            self.callerReference = callerReference
    ...
    public struct ListGeoLocationsResponse: AWSShape {
        ...
        public init(geoLocationDetailsList: GeoLocationDetailsList, isTruncated: Bool, nextSubdivisionCode: String? = nil, nextContinentCode: String? = nil, maxItems: String, nextCountryCode: String? = nil) {
    ...
    public struct ListTrafficPoliciesResponse: AWSShape {
        ...
        public init(trafficPolicyIdMarker: String, isTruncated: Bool, maxItems: String, trafficPolicySummaries: TrafficPolicySummaries) {
            self.trafficPolicyIdMarker = trafficPolicyIdMarker
            self.isTruncated = isTruncated
            self.maxItems = maxItems
    ...
    public struct UpdateHostedZoneCommentRequest: AWSShape {
        ...
        public init(id: String, comment: String? = nil) {
            self.id = id
            self.comment = comment
        }
    ...
    public struct ChangeBatch: AWSShape {
        ...
        public init(comment: String? = nil, changes: Changes) {
            self.comment = comment
    ...
    public struct HealthCheckConfig: AWSShape {
        ...
        public init(type: HealthCheckType, inverted: Bool? = nil, failureThreshold: Int32? = nil, fullyQualifiedDomainName: String? = nil, enableSNI: Bool? = nil, resourcePath: String? = nil, regions: HealthCheckRegionList? = nil, port: Int32? = nil, disabled: Bool? = nil, alarmIdentifier: AlarmIdentifier? = nil, measureLatency: Bool? = nil, healthThreshold: Int32? = nil, insufficientDataHealthStatus: InsufficientDataHealthStatus? = nil, iPAddress: String? = nil, requestInterval: Int32? = nil, childHealthChecks: ChildHealthCheckList? = nil, searchString: String? = nil) {
            self.`type` = `type`
            self.inverted = inverted
            self.failureThreshold = failureThreshold
            self.fullyQualifiedDomainName = fullyQualifiedDomainName
    ...
    public struct GetGeoLocationRequest: AWSShape {
        ...
        public init(subdivisionCode: String? = nil, continentCode: String? = nil, countryCode: String? = nil) {
    ...
    public struct DelegationSet: AWSShape {
        ...
        public init(id: String? = nil, callerReference: String? = nil, nameServers: DelegationSetNameServers) {
            self.id = id
            self.callerReference = callerReference
    ...
    public struct ListHostedZonesByNameRequest: AWSShape {
        ...
        public init(dNSName: String? = nil, maxItems: String? = nil, hostedZoneId: String? = nil) {
            self.dNSName = dNSName
            self.maxItems = maxItems
            self.hostedZoneId = hostedZoneId
        }
    ...
    public struct ListHostedZonesResponse: AWSShape {
        ...
        public init(isTruncated: Bool, hostedZones: HostedZones, marker: String, maxItems: String, nextMarker: String? = nil) {
            self.isTruncated = isTruncated
    ...
    public struct ResourceRecordSet: AWSShape {
        ...
        public init(ttl: Int64? = nil, setIdentifier: String? = nil, region: ResourceRecordSetRegion? = nil, geoLocation: GeoLocation? = nil, type: RRType, trafficPolicyInstanceId: String? = nil, aliasTarget: AliasTarget? = nil, name: String, resourceRecords: ResourceRecords? = nil, healthCheckId: String? = nil, multiValueAnswer: Bool? = nil, failover: ResourceRecordSetFailover? = nil, weight: Int64? = nil) {
            self.ttl = ttl
    ...
    public struct ListTrafficPolicyInstancesRequest: AWSShape {
        ...
        public init(hostedZoneIdMarker: String? = nil, maxItems: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil, trafficPolicyInstanceNameMarker: String? = nil) {
            self.hostedZoneIdMarker = hostedZoneIdMarker
            self.maxItems = maxItems
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
    ...
    public struct CreateHostedZoneResponse: AWSShape {
        ...
        public init(changeInfo: ChangeInfo, location: String, hostedZone: HostedZone, vpc: VPC? = nil, delegationSet: DelegationSet) {
            self.changeInfo = changeInfo
            self.location = location
            self.hostedZone = hostedZone
            self.vpc = vpc
    ...
    public struct ListVPCAssociationAuthorizationsResponse: AWSShape {
        ...
        public init(hostedZoneId: String, vPCs: VPCs, nextToken: String? = nil) {
            self.hostedZoneId = hostedZoneId
            self.vPCs = vPCs
            self.nextToken = nextToken
        }
    ...
    public struct GeoLocation: AWSShape {
        ...
        public init(countryCode: String? = nil, subdivisionCode: String? = nil, continentCode: String? = nil) {
            self.countryCode = countryCode
            self.subdivisionCode = subdivisionCode
            self.continentCode = continentCode
        }
    ...
    public struct ChangeInfo: AWSShape {
        ...
        public init(comment: String? = nil, status: ChangeStatus, submittedAt: TimeStamp, id: String) {
            self.comment = comment
            self.status = status
    ...
    public struct ListTagsForResourceRequest: AWSShape {
        ...
        public init(resourceType: TagResourceType, resourceId: String) {
            self.resourceType = resourceType
    ...
    public struct HostedZoneLimit: AWSShape {
        ...
        public init(value: Int64, type: HostedZoneLimitType) {
            self.value = value
            self.`type` = `type`
        }
    ...
    public struct VPC: AWSShape {
        ...
        public init(vPCRegion: VPCRegion? = nil, vPCId: String? = nil) {
    ...
    public struct ResourceTagSet: AWSShape {
        ...
        public init(tags: TagList? = nil, resourceId: String? = nil, resourceType: TagResourceType? = nil) {
            self.tags = tags
            self.resourceId = resourceId
            self.resourceType = resourceType
        }
    ...
    public struct QueryLoggingConfig: AWSShape {
        ...
        public init(hostedZoneId: String, id: String, cloudWatchLogsLogGroupArn: String) {
            self.hostedZoneId = hostedZoneId
            self.id = id
    ...
    public struct AssociateVPCWithHostedZoneRequest: AWSShape {
        ...
        public init(hostedZoneId: String, vpc: VPC, comment: String? = nil) {
            self.hostedZoneId = hostedZoneId
            self.vpc = vpc
            self.comment = comment
        }
    ...
    public struct CreateReusableDelegationSetRequest: AWSShape {
        ...
        public init(hostedZoneId: String? = nil, callerReference: String) {
            self.hostedZoneId = hostedZoneId
            self.callerReference = callerReference
        }
    ...
    public struct ListHealthChecksResponse: AWSShape {
        ...
        public init(nextMarker: String? = nil, healthChecks: HealthChecks, isTruncated: Bool, marker: String, maxItems: String) {
            self.nextMarker = nextMarker
    ...
    public struct ReusableDelegationSetLimit: AWSShape {
        ...
        public init(value: Int64, type: ReusableDelegationSetLimitType) {
            self.value = value
            self.`type` = `type`
        }
    ...
    public struct ListTrafficPolicyInstancesByHostedZoneRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, hostedZoneId: String, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstanceTypeMarker: RRType? = nil) {
            self.maxItems = maxItems
            self.hostedZoneId = hostedZoneId
            self.trafficPolicyInstanceNameMarker = trafficPolicyInstanceNameMarker
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
    ...
    public struct ListTrafficPolicyInstancesResponse: AWSShape {
        ...
        public init(maxItems: String, trafficPolicyInstanceTypeMarker: RRType? = nil, isTruncated: Bool, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceNameMarker: String? = nil, trafficPolicyInstances: TrafficPolicyInstances) {
            self.maxItems = maxItems
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.isTruncated = isTruncated
            self.hostedZoneIdMarker = hostedZoneIdMarker
    ...
    public struct StatusReport: AWSShape {
        ...
        public init(status: String? = nil, checkedTime: TimeStamp? = nil) {
            self.status = status
    ...
    public struct GeoLocationDetails: AWSShape {
        ...
        public init(countryCode: String? = nil, subdivisionCode: String? = nil, continentName: String? = nil, countryName: String? = nil, subdivisionName: String? = nil, continentCode: String? = nil) {
            self.countryCode = countryCode
            self.subdivisionCode = subdivisionCode
    ...
    public struct GetHostedZoneResponse: AWSShape {
        ...
        public init(vPCs: VPCs? = nil, delegationSet: DelegationSet? = nil, hostedZone: HostedZone) {
            self.vPCs = vPCs
            self.delegationSet = delegationSet
            self.hostedZone = hostedZone
        }
    ...
    public struct ChangeTagsForResourceRequest: AWSShape {
        ...
        public init(resourceId: String, addTags: TagList? = nil, removeTagKeys: TagKeyList? = nil, resourceType: TagResourceType) {
            self.resourceId = resourceId
    ...
    public struct CreateTrafficPolicyInstanceRequest: AWSShape {
        ...
        public init(name: String, trafficPolicyVersion: Int32, ttl: Int64, hostedZoneId: String, trafficPolicyId: String) {
            self.name = name
            self.trafficPolicyVersion = trafficPolicyVersion
            self.ttl = ttl
            self.hostedZoneId = hostedZoneId
    ...
    public struct ListHostedZonesByNameResponse: AWSShape {
        ...
        public init(hostedZones: HostedZones, nextHostedZoneId: String? = nil, hostedZoneId: String? = nil, isTruncated: Bool, maxItems: String, nextDNSName: String? = nil, dNSName: String? = nil) {
            self.hostedZones = hostedZones
    ...
    public struct ListTrafficPolicyVersionsRequest: AWSShape {
        ...
        public init(maxItems: String? = nil, trafficPolicyVersionMarker: String? = nil, id: String) {
            self.maxItems = maxItems
            self.trafficPolicyVersionMarker = trafficPolicyVersionMarker
            self.id = id
        }
    ...
    public struct ListResourceRecordSetsResponse: AWSShape {
        ...
        public init(nextRecordName: String? = nil, nextRecordIdentifier: String? = nil, nextRecordType: RRType? = nil, isTruncated: Bool, resourceRecordSets: ResourceRecordSets, maxItems: String) {
    ...
    public struct ListTrafficPolicyInstancesByPolicyResponse: AWSShape {
        ...
        public init(trafficPolicyInstanceTypeMarker: RRType? = nil, isTruncated: Bool, trafficPolicyInstances: TrafficPolicyInstances, hostedZoneIdMarker: String? = nil, trafficPolicyInstanceNameMarker: String? = nil, maxItems: String) {
            self.trafficPolicyInstanceTypeMarker = trafficPolicyInstanceTypeMarker
            self.isTruncated = isTruncated
            self.trafficPolicyInstances = trafficPolicyInstances
            self.hostedZoneIdMarker = hostedZoneIdMarker
