...
public struct DataExchange {
    ...
    @discardableResult public func cancelJob(_ input: CancelJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "CancelJob", path: "/v1/jobs/{JobId}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createDataSet(_ input: CreateDataSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateDataSetResponse> {
        return client.execute(operation: "CreateDataSet", path: "/v1/data-sets", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  This operation creates a job.
    public func createJob(_ input: CreateJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateJobResponse> {
        return client.execute(operation: "CreateJob", path: "/v1/jobs", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func createRevision(_ input: CreateRevisionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateRevisionResponse> {
        return client.execute(operation: "CreateRevision", path: "/v1/data-sets/{DataSetId}/revisions", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteAsset(_ input: DeleteAssetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAsset", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}/assets/{AssetId}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteDataSet(_ input: DeleteDataSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteDataSet", path: "/v1/data-sets/{DataSetId}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    @discardableResult public func deleteRevision(_ input: DeleteRevisionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteRevision", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}", httpMethod: "DELETE", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  This operation returns information about an asset.
    public func getAsset(_ input: GetAssetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetAssetResponse> {
        return client.execute(operation: "GetAsset", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}/assets/{AssetId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  This operation returns information about a data set.
    public func getDataSet(_ input: GetDataSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetDataSetResponse> {
        return client.execute(operation: "GetDataSet", path: "/v1/data-sets/{DataSetId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  This operation returns information about a job.
    public func getJob(_ input: GetJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetJobResponse> {
        return client.execute(operation: "GetJob", path: "/v1/jobs/{JobId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func getRevision(_ input: GetRevisionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetRevisionResponse> {
        return client.execute(operation: "GetRevision", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listDataSetRevisions(_ input: ListDataSetRevisionsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDataSetRevisionsResponse> {
        return client.execute(operation: "ListDataSetRevisions", path: "/v1/data-sets/{DataSetId}/revisions", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listDataSets(_ input: ListDataSetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListDataSetsResponse> {
        return client.execute(operation: "ListDataSets", path: "/v1/data-sets", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }

    ///  This operation lists your jobs sorted by CreatedAt in descending order.
    public func listJobs(_ input: ListJobsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListJobsResponse> {
        return client.execute(operation: "ListJobs", path: "/v1/jobs", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func listRevisionAssets(_ input: ListRevisionAssetsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ListRevisionAssetsResponse> {
        return client.execute(operation: "ListRevisionAssets", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}/assets", httpMethod: "GET", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func startJob(_ input: StartJobRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartJobResponse> {
        return client.execute(operation: "StartJob", path: "/v1/jobs/{JobId}", httpMethod: "PATCH", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateAsset(_ input: UpdateAssetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateAssetResponse> {
        return client.execute(operation: "UpdateAsset", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}/assets/{AssetId}", httpMethod: "PATCH", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateDataSet(_ input: UpdateDataSetRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateDataSetResponse> {
        return client.execute(operation: "UpdateDataSet", path: "/v1/data-sets/{DataSetId}", httpMethod: "PATCH", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func updateRevision(_ input: UpdateRevisionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateRevisionResponse> {
        return client.execute(operation: "UpdateRevision", path: "/v1/data-sets/{DataSetId}/revisions/{RevisionId}", httpMethod: "PATCH", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
}
