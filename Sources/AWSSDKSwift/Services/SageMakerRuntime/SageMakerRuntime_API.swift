...
public struct SageMakerRuntime {
    ...
    public func invokeEndpoint(_ input: InvokeEndpointInput, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<InvokeEndpointOutput> {
