...
public struct Greengrass {
    ...
    public func deleteConnectorDefinition(_ input: DeleteConnectorDefinitionRequest) throws -> DeleteConnectorDefinitionResponse {
    ...
    public func getConnectorDefinitionVersion(_ input: GetConnectorDefinitionVersionRequest) throws -> GetConnectorDefinitionVersionResponse {
    ...
    public func getBulkDeploymentStatus(_ input: GetBulkDeploymentStatusRequest) throws -> GetBulkDeploymentStatusResponse {
    ...
    public func listConnectorDefinitionVersions(_ input: ListConnectorDefinitionVersionsRequest) throws -> ListConnectorDefinitionVersionsResponse {
    ...
    public func listBulkDeploymentDetailedReports(_ input: ListBulkDeploymentDetailedReportsRequest) throws -> ListBulkDeploymentDetailedReportsResponse {
    ...
    public func listBulkDeployments(_ input: ListBulkDeploymentsRequest) throws -> ListBulkDeploymentsResponse {
    ...
    public func listConnectorDefinitions(_ input: ListConnectorDefinitionsRequest) throws -> ListConnectorDefinitionsResponse {
    ...
    public func stopBulkDeployment(_ input: StopBulkDeploymentRequest) throws -> StopBulkDeploymentResponse {
    ...
    public func startBulkDeployment(_ input: StartBulkDeploymentRequest) throws -> StartBulkDeploymentResponse {
    ...
    public func getConnectorDefinition(_ input: GetConnectorDefinitionRequest) throws -> GetConnectorDefinitionResponse {
    ...
    public func createConnectorDefinition(_ input: CreateConnectorDefinitionRequest) throws -> CreateConnectorDefinitionResponse {
    ...
    public func createConnectorDefinitionVersion(_ input: CreateConnectorDefinitionVersionRequest) throws -> CreateConnectorDefinitionVersionResponse {
    ...
    public func updateConnectorDefinition(_ input: UpdateConnectorDefinitionRequest) throws -> UpdateConnectorDefinitionResponse {
