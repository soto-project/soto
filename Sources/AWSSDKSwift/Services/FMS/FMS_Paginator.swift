...
extension FMS {
    ...
    public func listComplianceStatusPaginator(_ input: ListComplianceStatusRequest) -> Future<[PolicyComplianceStatus]> {
    ...
    public func listMemberAccountsPaginator(_ input: ListMemberAccountsRequest) -> Future<[String]> {
        return client.paginate(input: input, command: listMemberAccounts, resultKey: "memberAccounts", tokenKey: "nextToken")
    }
    
    ///  Returns an array of PolicySummary objects in the response.
    public func listPoliciesPaginator(_ input: ListPoliciesRequest) -> Future<[PolicySummary]> {
