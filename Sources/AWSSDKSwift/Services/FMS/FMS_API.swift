...
public struct FMS {
    ...
    public func putPolicy(_ input: PutPolicyRequest) throws -> EventLoopFuture<PutPolicyResponse> {
        return try client.send(operation: "PutPolicy", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns an array of PolicyComplianceStatus objects in the response. Use PolicyComplianceStatus to get a summary of which member accounts are protected by the specified policy. 
    public func listComplianceStatus(_ input: ListComplianceStatusRequest) throws -> EventLoopFuture<ListComplianceStatusResponse> {
    ...
    public func getAdminAccount(_ input: GetAdminAccountRequest) throws -> EventLoopFuture<GetAdminAccountResponse> {
        return try client.send(operation: "GetAdminAccount", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about the Amazon Simple Notification Service (SNS) topic that is used to record AWS Firewall Manager SNS logs.
    public func getNotificationChannel(_ input: GetNotificationChannelRequest) throws -> EventLoopFuture<GetNotificationChannelResponse> {
    ...
    public func listMemberAccounts(_ input: ListMemberAccountsRequest) throws -> EventLoopFuture<ListMemberAccountsResponse> {
    ...
    public func getComplianceDetail(_ input: GetComplianceDetailRequest) throws -> EventLoopFuture<GetComplianceDetailResponse> {
