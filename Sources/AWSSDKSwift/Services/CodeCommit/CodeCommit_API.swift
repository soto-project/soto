...
public struct CodeCommit {
    ...
    public func batchGetRepositories(_ input: BatchGetRepositoriesInput) throws -> EventLoopFuture<BatchGetRepositoriesOutput> {
        return try client.send(operation: "BatchGetRepositories", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the base-64 encoded contents of a specified file and its metadata.
    public func getFile(_ input: GetFileInput) throws -> EventLoopFuture<GetFileOutput> {
    ...
    public func mergePullRequestByFastForward(_ input: MergePullRequestByFastForwardInput) throws -> EventLoopFuture<MergePullRequestByFastForwardOutput> {
    ...
    public func listPullRequests(_ input: ListPullRequestsInput) throws -> EventLoopFuture<ListPullRequestsOutput> {
    ...
    public func deleteRepository(_ input: DeleteRepositoryInput) throws -> EventLoopFuture<DeleteRepositoryOutput> {
    ...
    public func getDifferences(_ input: GetDifferencesInput) throws -> EventLoopFuture<GetDifferencesOutput> {
        return try client.send(operation: "GetDifferences", path: "/", httpMethod: "POST", input: input)
    }

    ///  Replaces the contents of a comment.
    public func updateComment(_ input: UpdateCommentInput) throws -> EventLoopFuture<UpdateCommentOutput> {
    ...
    public func testRepositoryTriggers(_ input: TestRepositoryTriggersInput) throws -> EventLoopFuture<TestRepositoryTriggersOutput> {
        return try client.send(operation: "TestRepositoryTriggers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the contents of a specified folder in a repository.
    public func getFolder(_ input: GetFolderInput) throws -> EventLoopFuture<GetFolderOutput> {
        return try client.send(operation: "GetFolder", path: "/", httpMethod: "POST", input: input)
    }

    ///  Posts a comment on the comparison between two commits.
    public func postCommentForComparedCommit(_ input: PostCommentForComparedCommitInput) throws -> EventLoopFuture<PostCommentForComparedCommitOutput> {
        return try client.send(operation: "PostCommentForComparedCommit", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the base-64 encoded content of an individual blob within a repository.
    public func getBlob(_ input: GetBlobInput) throws -> EventLoopFuture<GetBlobOutput> {
    ...
    public func deleteFile(_ input: DeleteFileInput) throws -> EventLoopFuture<DeleteFileOutput> {
    ...
    public func getCommentsForComparedCommit(_ input: GetCommentsForComparedCommitInput) throws -> EventLoopFuture<GetCommentsForComparedCommitOutput> {
        return try client.send(operation: "GetCommentsForComparedCommit", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about one or more pull request events.
    public func describePullRequestEvents(_ input: DescribePullRequestEventsInput) throws -> EventLoopFuture<DescribePullRequestEventsOutput> {
        return try client.send(operation: "DescribePullRequestEvents", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a repository branch, including its name and the last commit ID.
    public func getBranch(_ input: GetBranchInput) throws -> EventLoopFuture<GetBranchOutput> {
        return try client.send(operation: "GetBranch", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about one or more branches in a repository.
    public func listBranches(_ input: ListBranchesInput) throws -> EventLoopFuture<ListBranchesOutput> {
        return try client.send(operation: "ListBranches", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about a commit, including commit message and committer information.
    public func getCommit(_ input: GetCommitInput) throws -> EventLoopFuture<GetCommitOutput> {
        return try client.send(operation: "GetCommit", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the status of a pull request. 
    public func updatePullRequestStatus(_ input: UpdatePullRequestStatusInput) throws -> EventLoopFuture<UpdatePullRequestStatusOutput> {
    ...
    public func updatePullRequestTitle(_ input: UpdatePullRequestTitleInput) throws -> EventLoopFuture<UpdatePullRequestTitleOutput> {
        return try client.send(operation: "UpdatePullRequestTitle", path: "/", httpMethod: "POST", input: input)
    }

    ///  Replaces the contents of the description of a pull request.
    public func updatePullRequestDescription(_ input: UpdatePullRequestDescriptionInput) throws -> EventLoopFuture<UpdatePullRequestDescriptionOutput> {
        return try client.send(operation: "UpdatePullRequestDescription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about a pull request in a specified repository.
    public func getPullRequest(_ input: GetPullRequestInput) throws -> EventLoopFuture<GetPullRequestOutput> {
        return try client.send(operation: "GetPullRequest", path: "/", httpMethod: "POST", input: input)
    }

    ///  Replaces all triggers for a repository. This can be used to create or delete triggers.
    public func putRepositoryTriggers(_ input: PutRepositoryTriggersInput) throws -> EventLoopFuture<PutRepositoryTriggersOutput> {
        return try client.send(operation: "PutRepositoryTriggers", path: "/", httpMethod: "POST", input: input)
    }

    ///  Posts a comment in reply to an existing comment on a comparison between commits or a pull request.
    public func postCommentReply(_ input: PostCommentReplyInput) throws -> EventLoopFuture<PostCommentReplyOutput> {
        return try client.send(operation: "PostCommentReply", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds or updates a file in a branch in an AWS CodeCommit repository, and generates a commit for the addition in the specified branch.
    public func putFile(_ input: PutFileInput) throws -> EventLoopFuture<PutFileOutput> {
        return try client.send(operation: "PutFile", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a new, empty repository.
    public func createRepository(_ input: CreateRepositoryInput) throws -> EventLoopFuture<CreateRepositoryOutput> {
    ...
    public func getRepository(_ input: GetRepositoryInput) throws -> EventLoopFuture<GetRepositoryOutput> {
        return try client.send(operation: "GetRepository", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the content of a comment made on a change, file, or commit in a repository.
    public func deleteCommentContent(_ input: DeleteCommentContentInput) throws -> EventLoopFuture<DeleteCommentContentOutput> {
        return try client.send(operation: "DeleteCommentContent", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a pull request in the specified repository.
    public func createPullRequest(_ input: CreatePullRequestInput) throws -> EventLoopFuture<CreatePullRequestOutput> {
        return try client.send(operation: "CreatePullRequest", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a branch from a repository, unless that branch is the default branch for the repository. 
    public func deleteBranch(_ input: DeleteBranchInput) throws -> EventLoopFuture<DeleteBranchOutput> {
        return try client.send(operation: "DeleteBranch", path: "/", httpMethod: "POST", input: input)
    }

    ///  Posts a comment on a pull request.
    public func postCommentForPullRequest(_ input: PostCommentForPullRequestInput) throws -> EventLoopFuture<PostCommentForPullRequestOutput> {
        return try client.send(operation: "PostCommentForPullRequest", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about merge conflicts between the before and after commit IDs for a pull request in a repository.
    public func getMergeConflicts(_ input: GetMergeConflictsInput) throws -> EventLoopFuture<GetMergeConflictsOutput> {
        return try client.send(operation: "GetMergeConflicts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about one or more repositories.
    public func listRepositories(_ input: ListRepositoriesInput) throws -> EventLoopFuture<ListRepositoriesOutput> {
        return try client.send(operation: "ListRepositories", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns comments made on a pull request.
    public func getCommentsForPullRequest(_ input: GetCommentsForPullRequestInput) throws -> EventLoopFuture<GetCommentsForPullRequestOutput> {
        return try client.send(operation: "GetCommentsForPullRequest", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the content of a comment made on a change, file, or commit in a repository.
    public func getComment(_ input: GetCommentInput) throws -> EventLoopFuture<GetCommentOutput> {
    ...
    public func getRepositoryTriggers(_ input: GetRepositoryTriggersInput) throws -> EventLoopFuture<GetRepositoryTriggersOutput> {
