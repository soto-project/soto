...
extension ElastiCache {
    ...
    public struct DecreaseNodeGroupsInGlobalReplicationGroupMessage: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_GlobalNodeGroupsToRemoveEncoding, String>> public var globalNodeGroupsToRemove: [String]?
        /// If the value of NodeGroupCount is less than the current number of node groups (shards), then either NodeGroupsToRemove or NodeGroupsToRetain is required. NodeGroupsToRemove is a list of NodeGroupIds to remove from the cluster. ElastiCache for Redis will attempt to remove all node groups listed by NodeGroupsToRemove from the cluster. 
        @OptionalCoding<ArrayCoder<_GlobalNodeGroupsToRetainEncoding, String>> public var globalNodeGroupsToRetain: [String]?
        /// The name of the Global Datastore
        public let globalReplicationGroupId: String
    ...
    public struct DescribeGlobalReplicationGroupsResult: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_GlobalReplicationGroupsEncoding, GlobalReplicationGroup>> public var globalReplicationGroups: [GlobalReplicationGroup]?
        /// An optional marker returned from a prior request. Use this marker for pagination of results from this operation. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by MaxRecords. &gt;
        public let marker: String?
    ...
    public struct GlobalReplicationGroup: AWSShape {
        ...
        public let engineVersion: String?
        /// Indicates the slot configuration and global identifier for each slice group.
        @OptionalCoding<ArrayCoder<_GlobalNodeGroupsEncoding, GlobalNodeGroup>> public var globalNodeGroups: [GlobalNodeGroup]?
        /// The optional description of the Global Datastore
        public let globalReplicationGroupDescription: String?
        /// The name of the Global Datastore
        public let globalReplicationGroupId: String?
        /// The replication groups that comprise the Global Datastore.
        @OptionalCoding<ArrayCoder<_MembersEncoding, GlobalReplicationGroupMember>> public var members: [GlobalReplicationGroupMember]?
    ...
    public struct IncreaseNodeGroupsInGlobalReplicationGroupMessage: AWSShape {
        ...
        @OptionalCoding<ArrayCoder<_RegionalConfigurationsEncoding, RegionalConfiguration>> public var regionalConfigurations: [RegionalConfiguration]?
    ...
    public struct RegionalConfiguration: AWSShape {
        ...
        @Coding<ArrayCoder<_ReshardingConfigurationEncoding, ReshardingConfiguration>> public var reshardingConfiguration: [ReshardingConfiguration]
