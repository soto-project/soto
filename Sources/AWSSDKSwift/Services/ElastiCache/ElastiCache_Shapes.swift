...
extension ElastiCache {
    ...
    public struct NodeGroupMember: AWSShape {
        ...
        public init(cacheNodeId: String? = nil, preferredAvailabilityZone: String? = nil, currentRole: String? = nil, cacheClusterId: String? = nil, readEndpoint: Endpoint? = nil) {
    ...
    public struct CacheNode: AWSShape {
        ...
        public init(customerAvailabilityZone: String? = nil, cacheNodeStatus: String? = nil, endpoint: Endpoint? = nil, parameterGroupStatus: String? = nil, cacheNodeId: String? = nil, cacheNodeCreateTime: TimeStamp? = nil, sourceCacheNodeId: String? = nil) {
    ...
    public struct CacheNodeTypeSpecificParameter: AWSShape {
        ...
        public init(dataType: String? = nil, source: String? = nil, isModifiable: Bool? = nil, parameterName: String? = nil, changeType: ChangeType? = nil, cacheNodeTypeSpecificValues: CacheNodeTypeSpecificValueList? = nil, allowedValues: String? = nil, minimumEngineVersion: String? = nil, description: String? = nil) {
    ...
    public struct PendingModifiedValues: AWSShape {
        ...
        public init(numCacheNodes: Int32? = nil, engineVersion: String? = nil, cacheNodeIdsToRemove: CacheNodeIdsList? = nil, cacheNodeType: String? = nil) {
    ...
    public struct CreateReplicationGroupMessage: AWSShape {
        ...
        public init(engineVersion: String? = nil, cacheParameterGroupName: String? = nil, replicationGroupDescription: String, cacheSubnetGroupName: String? = nil, numNodeGroups: Int32? = nil, primaryClusterId: String? = nil, transitEncryptionEnabled: Bool? = nil, nodeGroupConfiguration: NodeGroupConfigurationList? = nil, snapshotArns: SnapshotArnsList? = nil, preferredMaintenanceWindow: String? = nil, cacheSecurityGroupNames: CacheSecurityGroupNameList? = nil, engine: String? = nil, atRestEncryptionEnabled: Bool? = nil, preferredCacheClusterAZs: AvailabilityZonesList? = nil, notificationTopicArn: String? = nil, replicasPerNodeGroup: Int32? = nil, snapshotWindow: String? = nil, securityGroupIds: SecurityGroupIdsList? = nil, snapshotName: String? = nil, authToken: String? = nil, replicationGroupId: String, snapshotRetentionLimit: Int32? = nil, automaticFailoverEnabled: Bool? = nil, tags: TagList? = nil, numCacheClusters: Int32? = nil, cacheNodeType: String? = nil, autoMinorVersionUpgrade: Bool? = nil, port: Int32? = nil) {
            self.engineVersion = engineVersion
            self.cacheParameterGroupName = cacheParameterGroupName
    ...
    public struct DescribeReservedCacheNodesMessage: AWSShape {
        ...
        public init(duration: String? = nil, reservedCacheNodesOfferingId: String? = nil, cacheNodeType: String? = nil, offeringType: String? = nil, marker: String? = nil, reservedCacheNodeId: String? = nil, productDescription: String? = nil, maxRecords: Int32? = nil) {
    ...
    public struct DescribeReservedCacheNodesOfferingsMessage: AWSShape {
        ...
        public init(duration: String? = nil, reservedCacheNodesOfferingId: String? = nil, cacheNodeType: String? = nil, offeringType: String? = nil, marker: String? = nil, productDescription: String? = nil, maxRecords: Int32? = nil) {
            self.duration = duration
            self.reservedCacheNodesOfferingId = reservedCacheNodesOfferingId
            self.cacheNodeType = cacheNodeType
            self.offeringType = offeringType
    ...
    public struct Snapshot: AWSShape {
        ...
        public init(cacheClusterId: String? = nil, automaticFailover: AutomaticFailoverStatus? = nil, cacheClusterCreateTime: TimeStamp? = nil, snapshotWindow: String? = nil, snapshotSource: String? = nil, vpcId: String? = nil, numCacheNodes: Int32? = nil, replicationGroupDescription: String? = nil, preferredAvailabilityZone: String? = nil, autoMinorVersionUpgrade: Bool? = nil, cacheNodeType: String? = nil, engine: String? = nil, topicArn: String? = nil, replicationGroupId: String? = nil, cacheParameterGroupName: String? = nil, engineVersion: String? = nil, cacheSubnetGroupName: String? = nil, numNodeGroups: Int32? = nil, snapshotStatus: String? = nil, preferredMaintenanceWindow: String? = nil, nodeSnapshots: NodeSnapshotList? = nil, snapshotRetentionLimit: Int32? = nil, snapshotName: String? = nil, port: Int32? = nil) {
            self.cacheClusterId = cacheClusterId
    ...
    public struct CacheCluster: AWSShape {
        ...
        public init(cacheClusterId: String? = nil, cacheNodes: CacheNodeList? = nil, cacheSubnetGroupName: String? = nil, authTokenEnabled: Bool? = nil, cacheClusterStatus: String? = nil, transitEncryptionEnabled: Bool? = nil, preferredMaintenanceWindow: String? = nil, configurationEndpoint: Endpoint? = nil, engine: String? = nil, atRestEncryptionEnabled: Bool? = nil, cacheParameterGroup: CacheParameterGroupStatus? = nil, securityGroups: [SecurityGroupMembership]? = nil, preferredAvailabilityZone: String? = nil, snapshotWindow: String? = nil, clientDownloadLandingPage: String? = nil, cacheClusterCreateTime: TimeStamp? = nil, cacheSecurityGroups: CacheSecurityGroupMembershipList? = nil, pendingModifiedValues: PendingModifiedValues? = nil, replicationGroupId: String? = nil, numCacheNodes: Int32? = nil, snapshotRetentionLimit: Int32? = nil, notificationConfiguration: NotificationConfiguration? = nil, cacheNodeType: String? = nil, autoMinorVersionUpgrade: Bool? = nil, engineVersion: String? = nil) {
            self.cacheClusterId = cacheClusterId
    ...
    public struct CacheEngineVersion: AWSShape {
        ...
        public init(cacheParameterGroupFamily: String? = nil, engineVersion: String? = nil, cacheEngineDescription: String? = nil, cacheEngineVersionDescription: String? = nil, engine: String? = nil) {
            self.cacheParameterGroupFamily = cacheParameterGroupFamily
            self.engineVersion = engineVersion
    ...
    public struct Parameter: AWSShape {
        ...
        public init(parameterValue: String? = nil, dataType: String? = nil, source: String? = nil, isModifiable: Bool? = nil, parameterName: String? = nil, changeType: ChangeType? = nil, allowedValues: String? = nil, minimumEngineVersion: String? = nil, description: String? = nil) {
    ...
    public struct ModifyReplicationGroupShardConfigurationMessage: AWSShape {
        ...
        public init(nodeGroupsToRemove: NodeGroupsToRemoveList? = nil, reshardingConfiguration: ReshardingConfigurationList? = nil, applyImmediately: Bool, nodeGroupCount: Int32, replicationGroupId: String) {
    ...
    public struct NodeGroupConfiguration: AWSShape {
        ...
        public init(replicaCount: Int32? = nil, primaryAvailabilityZone: String? = nil, slots: String? = nil, replicaAvailabilityZones: AvailabilityZonesList? = nil) {
    ...
    public struct ModifyCacheClusterMessage: AWSShape {
        ...
        public init(cacheNodeIdsToRemove: CacheNodeIdsList? = nil, applyImmediately: Bool? = nil, notificationTopicArn: String? = nil, numCacheNodes: Int32? = nil, notificationTopicStatus: String? = nil, cacheSecurityGroupNames: CacheSecurityGroupNameList? = nil, autoMinorVersionUpgrade: Bool? = nil, cacheNodeType: String? = nil, securityGroupIds: SecurityGroupIdsList? = nil, cacheParameterGroupName: String? = nil, cacheClusterId: String, preferredMaintenanceWindow: String? = nil, newAvailabilityZones: PreferredAvailabilityZoneList? = nil, engineVersion: String? = nil, aZMode: AZMode? = nil, snapshotRetentionLimit: Int32? = nil, snapshotWindow: String? = nil) {
            self.cacheNodeIdsToRemove = cacheNodeIdsToRemove
            self.applyImmediately = applyImmediately
            self.notificationTopicArn = notificationTopicArn
            self.numCacheNodes = numCacheNodes
    ...
    public struct Event: AWSShape {
        ...
        public init(sourceType: SourceType? = nil, message: String? = nil, date: TimeStamp? = nil, sourceIdentifier: String? = nil) {
    ...
    public struct NodeGroup: AWSShape {
        ...
        public init(nodeGroupMembers: NodeGroupMemberList? = nil, slots: String? = nil, status: String? = nil, primaryEndpoint: Endpoint? = nil, nodeGroupId: String? = nil) {
    ...
    public struct CacheParameterGroupDetails: AWSShape {
        ...
        public init(parameters: ParametersList? = nil, cacheNodeTypeSpecificParameters: CacheNodeTypeSpecificParametersList? = nil, marker: String? = nil) {
            self.parameters = parameters
            self.cacheNodeTypeSpecificParameters = cacheNodeTypeSpecificParameters
            self.marker = marker
        }
    ...
    public struct DescribeCacheParameterGroupsMessage: AWSShape {
        ...
        public init(maxRecords: Int32? = nil, cacheParameterGroupName: String? = nil, marker: String? = nil) {
            self.maxRecords = maxRecords
            self.cacheParameterGroupName = cacheParameterGroupName
            self.marker = marker
        }
    ...
    public struct ModifyReplicationGroupMessage: AWSShape {
        ...
        public init(applyImmediately: Bool? = nil, notificationTopicArn: String? = nil, notificationTopicStatus: String? = nil, replicationGroupDescription: String? = nil, snapshottingClusterId: String? = nil, primaryClusterId: String? = nil, autoMinorVersionUpgrade: Bool? = nil, cacheNodeType: String? = nil, cacheSecurityGroupNames: CacheSecurityGroupNameList? = nil, securityGroupIds: SecurityGroupIdsList? = nil, automaticFailoverEnabled: Bool? = nil, nodeGroupId: String? = nil, replicationGroupId: String, engineVersion: String? = nil, cacheParameterGroupName: String? = nil, preferredMaintenanceWindow: String? = nil, snapshotRetentionLimit: Int32? = nil, snapshotWindow: String? = nil) {
            self.applyImmediately = applyImmediately
            self.notificationTopicArn = notificationTopicArn
            self.notificationTopicStatus = notificationTopicStatus
            self.replicationGroupDescription = replicationGroupDescription
    ...
    public struct ReservedCacheNode: AWSShape {
        ...
        public init(fixedPrice: Double? = nil, reservedCacheNodesOfferingId: String? = nil, cacheNodeType: String? = nil, offeringType: String? = nil, state: String? = nil, startTime: TimeStamp? = nil, recurringCharges: RecurringChargeList? = nil, cacheNodeCount: Int32? = nil, usagePrice: Double? = nil, duration: Int32? = nil, reservedCacheNodeId: String? = nil, productDescription: String? = nil) {
    ...
    public struct NodeSnapshot: AWSShape {
        ...
        public init(snapshotCreateTime: TimeStamp? = nil, cacheClusterId: String? = nil, cacheNodeId: String? = nil, cacheSize: String? = nil, cacheNodeCreateTime: TimeStamp? = nil, nodeGroupId: String? = nil, nodeGroupConfiguration: NodeGroupConfiguration? = nil) {
    ...
    public struct DescribeCacheClustersMessage: AWSShape {
        ...
        public init(maxRecords: Int32? = nil, showCacheNodeInfo: Bool? = nil, marker: String? = nil, cacheClusterId: String? = nil, showCacheClustersNotInReplicationGroups: Bool? = nil) {
            self.maxRecords = maxRecords
    ...
    public struct DescribeCacheEngineVersionsMessage: AWSShape {
        ...
        public init(defaultOnly: Bool? = nil, maxRecords: Int32? = nil, cacheParameterGroupFamily: String? = nil, engineVersion: String? = nil, marker: String? = nil, engine: String? = nil) {
    ...
    public struct CacheSubnetGroup: AWSShape {
        ...
        public init(subnets: SubnetList? = nil, vpcId: String? = nil, cacheSubnetGroupName: String? = nil, cacheSubnetGroupDescription: String? = nil) {
    ...
    public struct CacheSecurityGroup: AWSShape {
        ...
        public init(ownerId: String? = nil, cacheSecurityGroupName: String? = nil, eC2SecurityGroups: EC2SecurityGroupList? = nil, description: String? = nil) {
    ...
    public struct DescribeCacheSubnetGroupsMessage: AWSShape {
        ...
        public init(maxRecords: Int32? = nil, marker: String? = nil, cacheSubnetGroupName: String? = nil) {
            self.maxRecords = maxRecords
            self.marker = marker
            self.cacheSubnetGroupName = cacheSubnetGroupName
        }
    ...
    public struct ReshardingConfiguration: AWSShape {
        ...
        public init(preferredAvailabilityZones: AvailabilityZonesList? = nil) {
    ...
    public struct CreateSnapshotMessage: AWSShape {
        ...
        public init(snapshotName: String, replicationGroupId: String? = nil, cacheClusterId: String? = nil) {
            self.snapshotName = snapshotName
            self.replicationGroupId = replicationGroupId
            self.cacheClusterId = cacheClusterId
        }
    ...
    public struct ReplicationGroup: AWSShape {
        ...
        public init(memberClusters: ClusterIdList? = nil, snapshottingClusterId: String? = nil, cacheNodeType: String? = nil, nodeGroups: NodeGroupList? = nil, transitEncryptionEnabled: Bool? = nil, pendingModifiedValues: ReplicationGroupPendingModifiedValues? = nil, replicationGroupId: String? = nil, atRestEncryptionEnabled: Bool? = nil, authTokenEnabled: Bool? = nil, description: String? = nil, status: String? = nil, snapshotRetentionLimit: Int32? = nil, configurationEndpoint: Endpoint? = nil, clusterEnabled: Bool? = nil, automaticFailover: AutomaticFailoverStatus? = nil, snapshotWindow: String? = nil) {
    ...
    public struct ReservedCacheNodesOffering: AWSShape {
        ...
        public init(duration: Int32? = nil, fixedPrice: Double? = nil, recurringCharges: RecurringChargeList? = nil, cacheNodeType: String? = nil, offeringType: String? = nil, reservedCacheNodesOfferingId: String? = nil, usagePrice: Double? = nil, productDescription: String? = nil) {
            self.duration = duration
            self.fixedPrice = fixedPrice
            self.recurringCharges = recurringCharges
            self.cacheNodeType = cacheNodeType
    ...
    public struct DescribeSnapshotsMessage: AWSShape {
        ...
        public init(snapshotName: String? = nil, showNodeGroupConfig: Bool? = nil, marker: String? = nil, cacheClusterId: String? = nil, replicationGroupId: String? = nil, snapshotSource: String? = nil, maxRecords: Int32? = nil) {
            self.snapshotName = snapshotName
    ...
    public struct CreateCacheClusterMessage: AWSShape {
        ...
        public init(preferredAvailabilityZones: PreferredAvailabilityZoneList? = nil, snapshotWindow: String? = nil, authToken: String? = nil, notificationTopicArn: String? = nil, numCacheNodes: Int32? = nil, tags: TagList? = nil, preferredAvailabilityZone: String? = nil, cacheSecurityGroupNames: CacheSecurityGroupNameList? = nil, autoMinorVersionUpgrade: Bool? = nil, cacheNodeType: String? = nil, engine: String? = nil, securityGroupIds: SecurityGroupIdsList? = nil, replicationGroupId: String? = nil, cacheParameterGroupName: String? = nil, engineVersion: String? = nil, cacheSubnetGroupName: String? = nil, preferredMaintenanceWindow: String? = nil, snapshotArns: SnapshotArnsList? = nil, snapshotRetentionLimit: Int32? = nil, aZMode: AZMode? = nil, port: Int32? = nil, snapshotName: String? = nil, cacheClusterId: String) {
            self.preferredAvailabilityZones = preferredAvailabilityZones
            self.snapshotWindow = snapshotWindow
            self.authToken = authToken
            self.notificationTopicArn = notificationTopicArn
