...
public struct ElastiCache {
    ...
    public func deleteSnapshot(_ input: DeleteSnapshotMessage) throws -> EventLoopFuture<DeleteSnapshotResult> {
        return try client.send(operation: "DeleteSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies an existing cache subnet group.
    public func modifyCacheSubnetGroup(_ input: ModifyCacheSubnetGroupMessage) throws -> EventLoopFuture<ModifyCacheSubnetGroupResult> {
    ...
    public func describeSnapshots(_ input: DescribeSnapshotsMessage) throws -> EventLoopFuture<DescribeSnapshotsListMessage> {
    ...
    public func deleteCacheCluster(_ input: DeleteCacheClusterMessage) throws -> EventLoopFuture<DeleteCacheClusterResult> {
        return try client.send(operation: "DeleteCacheCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about reserved cache nodes for this account, or about a specified reserved cache node.
    public func describeReservedCacheNodes(_ input: DescribeReservedCacheNodesMessage) throws -> EventLoopFuture<ReservedCacheNodeMessage> {
    ...
    public func resetCacheParameterGroup(_ input: ResetCacheParameterGroupMessage) throws -> EventLoopFuture<CacheParameterGroupNameMessage> {
        return try client.send(operation: "ResetCacheParameterGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Revokes ingress from a cache security group. Use this operation to disallow access from an Amazon EC2 security group that had been previously authorized.
    public func revokeCacheSecurityGroupIngress(_ input: RevokeCacheSecurityGroupIngressMessage) throws -> EventLoopFuture<RevokeCacheSecurityGroupIngressResult> {
    ...
    public func modifyCacheCluster(_ input: ModifyCacheClusterMessage) throws -> EventLoopFuture<ModifyCacheClusterResult> {
        return try client.send(operation: "ModifyCacheCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of the available cache engines and their versions.
    public func describeCacheEngineVersions(_ input: DescribeCacheEngineVersionsMessage) throws -> EventLoopFuture<CacheEngineVersionMessage> {
    ...
    public func decreaseReplicaCount(_ input: DecreaseReplicaCountMessage) throws -> EventLoopFuture<DecreaseReplicaCountResult> {
    ...
    public func describeCacheClusters(_ input: DescribeCacheClustersMessage) throws -> EventLoopFuture<CacheClusterMessage> {
    ...
    public func listAllowedNodeTypeModifications(_ input: ListAllowedNodeTypeModificationsMessage) throws -> EventLoopFuture<AllowedNodeTypeModificationsMessage> {
    ...
    public func deleteReplicationGroup(_ input: DeleteReplicationGroupMessage) throws -> EventLoopFuture<DeleteReplicationGroupResult> {
        return try client.send(operation: "DeleteReplicationGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of cache security group descriptions. If a cache security group name is specified, the list contains only the description of that group.
    public func describeCacheSecurityGroups(_ input: DescribeCacheSecurityGroupsMessage) throws -> EventLoopFuture<CacheSecurityGroupMessage> {
    ...
    public func modifyCacheParameterGroup(_ input: ModifyCacheParameterGroupMessage) throws -> EventLoopFuture<CacheParameterGroupNameMessage> {
    ...
    public func describeCacheParameterGroups(_ input: DescribeCacheParameterGroupsMessage) throws -> EventLoopFuture<CacheParameterGroupsMessage> {
    ...
    public func copySnapshot(_ input: CopySnapshotMessage) throws -> EventLoopFuture<CopySnapshotResult> {
    ...
    public func createReplicationGroup(_ input: CreateReplicationGroupMessage) throws -> EventLoopFuture<CreateReplicationGroupResult> {
        return try client.send(operation: "CreateReplicationGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists available reserved cache node offerings.
    public func describeReservedCacheNodesOfferings(_ input: DescribeReservedCacheNodesOfferingsMessage) throws -> EventLoopFuture<ReservedCacheNodesOfferingMessage> {
    ...
    public func modifyReplicationGroupShardConfiguration(_ input: ModifyReplicationGroupShardConfigurationMessage) throws -> EventLoopFuture<ModifyReplicationGroupShardConfigurationResult> {
    ...
    public func increaseReplicaCount(_ input: IncreaseReplicaCountMessage) throws -> EventLoopFuture<IncreaseReplicaCountResult> {
    ...
    public func modifyReplicationGroup(_ input: ModifyReplicationGroupMessage) throws -> EventLoopFuture<ModifyReplicationGroupResult> {
    ...
    public func createCacheSecurityGroup(_ input: CreateCacheSecurityGroupMessage) throws -> EventLoopFuture<CreateCacheSecurityGroupResult> {
    ...
    public func describeReplicationGroups(_ input: DescribeReplicationGroupsMessage) throws -> EventLoopFuture<ReplicationGroupMessage> {
        return try client.send(operation: "DescribeReplicationGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the detailed parameter list for a particular cache parameter group.
    public func describeCacheParameters(_ input: DescribeCacheParametersMessage) throws -> EventLoopFuture<CacheParameterGroupDetails> {
    ...
    public func testFailover(_ input: TestFailoverMessage) throws -> EventLoopFuture<TestFailoverResult> {
    ...
    public func addTagsToResource(_ input: AddTagsToResourceMessage) throws -> EventLoopFuture<TagListMessage> {
    ...
    public func rebootCacheCluster(_ input: RebootCacheClusterMessage) throws -> EventLoopFuture<RebootCacheClusterResult> {
    ...
    public func createSnapshot(_ input: CreateSnapshotMessage) throws -> EventLoopFuture<CreateSnapshotResult> {
    ...
    public func createCacheCluster(_ input: CreateCacheClusterMessage) throws -> EventLoopFuture<CreateCacheClusterResult> {
    ...
    public func authorizeCacheSecurityGroupIngress(_ input: AuthorizeCacheSecurityGroupIngressMessage) throws -> EventLoopFuture<AuthorizeCacheSecurityGroupIngressResult> {
        return try client.send(operation: "AuthorizeCacheSecurityGroupIngress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes the tags identified by the TagKeys list from the named resource.
    public func removeTagsFromResource(_ input: RemoveTagsFromResourceMessage) throws -> EventLoopFuture<TagListMessage> {
    ...
    public func createCacheSubnetGroup(_ input: CreateCacheSubnetGroupMessage) throws -> EventLoopFuture<CreateCacheSubnetGroupResult> {
    ...
    public func createCacheParameterGroup(_ input: CreateCacheParameterGroupMessage) throws -> EventLoopFuture<CreateCacheParameterGroupResult> {
    ...
    public func describeCacheSubnetGroups(_ input: DescribeCacheSubnetGroupsMessage) throws -> EventLoopFuture<CacheSubnetGroupMessage> {
        return try client.send(operation: "DescribeCacheSubnetGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allows you to purchase a reserved cache node offering.
    public func purchaseReservedCacheNodesOffering(_ input: PurchaseReservedCacheNodesOfferingMessage) throws -> EventLoopFuture<PurchaseReservedCacheNodesOfferingResult> {
