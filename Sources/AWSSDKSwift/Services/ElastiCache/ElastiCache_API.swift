...
public struct ElastiCache {
    ...
    public func addTagsToResource(_ input: AddTagsToResourceMessage) -> Future<TagListMessage> {
    ...
    public func authorizeCacheSecurityGroupIngress(_ input: AuthorizeCacheSecurityGroupIngressMessage) -> Future<AuthorizeCacheSecurityGroupIngressResult> {
        return client.send(operation: "AuthorizeCacheSecurityGroupIngress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Apply the service update. For more information on service updates and applying them, see Applying Service Updates.
    public func batchApplyUpdateAction(_ input: BatchApplyUpdateActionMessage) -> Future<UpdateActionResultsMessage> {
        return client.send(operation: "BatchApplyUpdateAction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Stop the service update. For more information on service updates and stopping them, see Stopping Service Updates.
    public func batchStopUpdateAction(_ input: BatchStopUpdateActionMessage) -> Future<UpdateActionResultsMessage> {
        return client.send(operation: "BatchStopUpdateAction", path: "/", httpMethod: "POST", input: input)
    }

    ///  Complete the migration of data.
    public func completeMigration(_ input: CompleteMigrationMessage) -> Future<CompleteMigrationResponse> {
    ...
    public func copySnapshot(_ input: CopySnapshotMessage) -> Future<CopySnapshotResult> {
    ...
    public func createCacheCluster(_ input: CreateCacheClusterMessage) -> Future<CreateCacheClusterResult> {
    ...
    public func createCacheParameterGroup(_ input: CreateCacheParameterGroupMessage) -> Future<CreateCacheParameterGroupResult> {
    ...
    public func createCacheSecurityGroup(_ input: CreateCacheSecurityGroupMessage) -> Future<CreateCacheSecurityGroupResult> {
    ...
    public func createCacheSubnetGroup(_ input: CreateCacheSubnetGroupMessage) -> Future<CreateCacheSubnetGroupResult> {
    ...
    public func createReplicationGroup(_ input: CreateReplicationGroupMessage) -> Future<CreateReplicationGroupResult> {
    ...
    public func createSnapshot(_ input: CreateSnapshotMessage) -> Future<CreateSnapshotResult> {
    ...
    public func decreaseReplicaCount(_ input: DecreaseReplicaCountMessage) -> Future<DecreaseReplicaCountResult> {
    ...
    public func deleteCacheCluster(_ input: DeleteCacheClusterMessage) -> Future<DeleteCacheClusterResult> {
        return client.send(operation: "DeleteCacheCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified cache parameter group. You cannot delete a cache parameter group if it is associated with any cache clusters.
    @discardableResult public func deleteCacheParameterGroup(_ input: DeleteCacheParameterGroupMessage) -> Future<Void> {
    ...
    @discardableResult public func deleteCacheSecurityGroup(_ input: DeleteCacheSecurityGroupMessage) -> Future<Void> {
    ...
    @discardableResult public func deleteCacheSubnetGroup(_ input: DeleteCacheSubnetGroupMessage) -> Future<Void> {
    ...
    public func deleteReplicationGroup(_ input: DeleteReplicationGroupMessage) -> Future<DeleteReplicationGroupResult> {
    ...
    public func deleteSnapshot(_ input: DeleteSnapshotMessage) -> Future<DeleteSnapshotResult> {
    ...
    public func describeCacheClusters(_ input: DescribeCacheClustersMessage) -> Future<CacheClusterMessage> {
        return client.send(operation: "DescribeCacheClusters", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of the available cache engines and their versions.
    public func describeCacheEngineVersions(_ input: DescribeCacheEngineVersionsMessage) -> Future<CacheEngineVersionMessage> {
        return client.send(operation: "DescribeCacheEngineVersions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of cache parameter group descriptions. If a cache parameter group name is specified, the list contains only the descriptions for that group.
    public func describeCacheParameterGroups(_ input: DescribeCacheParameterGroupsMessage) -> Future<CacheParameterGroupsMessage> {
        return client.send(operation: "DescribeCacheParameterGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the detailed parameter list for a particular cache parameter group.
    public func describeCacheParameters(_ input: DescribeCacheParametersMessage) -> Future<CacheParameterGroupDetails> {
    ...
    public func describeCacheSecurityGroups(_ input: DescribeCacheSecurityGroupsMessage) -> Future<CacheSecurityGroupMessage> {
    ...
    public func describeCacheSubnetGroups(_ input: DescribeCacheSubnetGroupsMessage) -> Future<CacheSubnetGroupMessage> {
    ...
    public func describeReplicationGroups(_ input: DescribeReplicationGroupsMessage) -> Future<ReplicationGroupMessage> {
        return client.send(operation: "DescribeReplicationGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about reserved cache nodes for this account, or about a specified reserved cache node.
    public func describeReservedCacheNodes(_ input: DescribeReservedCacheNodesMessage) -> Future<ReservedCacheNodeMessage> {
        return client.send(operation: "DescribeReservedCacheNodes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists available reserved cache node offerings.
    public func describeReservedCacheNodesOfferings(_ input: DescribeReservedCacheNodesOfferingsMessage) -> Future<ReservedCacheNodesOfferingMessage> {
        return client.send(operation: "DescribeReservedCacheNodesOfferings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns details of the service updates
    public func describeServiceUpdates(_ input: DescribeServiceUpdatesMessage) -> Future<ServiceUpdatesMessage> {
    ...
    public func describeSnapshots(_ input: DescribeSnapshotsMessage) -> Future<DescribeSnapshotsListMessage> {
        return client.send(operation: "DescribeSnapshots", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns details of the update actions 
    public func describeUpdateActions(_ input: DescribeUpdateActionsMessage) -> Future<UpdateActionsMessage> {
    ...
    public func increaseReplicaCount(_ input: IncreaseReplicaCountMessage) -> Future<IncreaseReplicaCountResult> {
    ...
    public func listAllowedNodeTypeModifications(_ input: ListAllowedNodeTypeModificationsMessage) -> Future<AllowedNodeTypeModificationsMessage> {
    ...
    public func modifyCacheCluster(_ input: ModifyCacheClusterMessage) -> Future<ModifyCacheClusterResult> {
        return client.send(operation: "ModifyCacheCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the parameters of a cache parameter group. You can modify up to 20 parameters in a single request by submitting a list parameter name and value pairs.
    public func modifyCacheParameterGroup(_ input: ModifyCacheParameterGroupMessage) -> Future<CacheParameterGroupNameMessage> {
        return client.send(operation: "ModifyCacheParameterGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies an existing cache subnet group.
    public func modifyCacheSubnetGroup(_ input: ModifyCacheSubnetGroupMessage) -> Future<ModifyCacheSubnetGroupResult> {
    ...
    public func modifyReplicationGroup(_ input: ModifyReplicationGroupMessage) -> Future<ModifyReplicationGroupResult> {
        return client.send(operation: "ModifyReplicationGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a replication group's shards (node groups) by allowing you to add shards, remove shards, or rebalance the keyspaces among exisiting shards.
    public func modifyReplicationGroupShardConfiguration(_ input: ModifyReplicationGroupShardConfigurationMessage) -> Future<ModifyReplicationGroupShardConfigurationResult> {
        return client.send(operation: "ModifyReplicationGroupShardConfiguration", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allows you to purchase a reserved cache node offering.
    public func purchaseReservedCacheNodesOffering(_ input: PurchaseReservedCacheNodesOfferingMessage) -> Future<PurchaseReservedCacheNodesOfferingResult> {
    ...
    public func rebootCacheCluster(_ input: RebootCacheClusterMessage) -> Future<RebootCacheClusterResult> {
        return client.send(operation: "RebootCacheCluster", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes the tags identified by the TagKeys list from the named resource.
    public func removeTagsFromResource(_ input: RemoveTagsFromResourceMessage) -> Future<TagListMessage> {
    ...
    public func resetCacheParameterGroup(_ input: ResetCacheParameterGroupMessage) -> Future<CacheParameterGroupNameMessage> {
        return client.send(operation: "ResetCacheParameterGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Revokes ingress from a cache security group. Use this operation to disallow access from an Amazon EC2 security group that had been previously authorized.
    public func revokeCacheSecurityGroupIngress(_ input: RevokeCacheSecurityGroupIngressMessage) -> Future<RevokeCacheSecurityGroupIngressResult> {
        return client.send(operation: "RevokeCacheSecurityGroupIngress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Start the migration of data.
    public func startMigration(_ input: StartMigrationMessage) -> Future<StartMigrationResponse> {
    ...
    public func testFailover(_ input: TestFailoverMessage) -> Future<TestFailoverResult> {
