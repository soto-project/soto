...
public struct OpsWorksCM {
    ...
    public func associateNode(_ input: AssociateNodeRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AssociateNodeResponse> {
        return client.execute(operation: "AssociateNode", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func deleteServer(_ input: DeleteServerRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DeleteServerResponse> {
    ...
    public func describeAccountAttributes(_ input: DescribeAccountAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeAccountAttributesResponse> {
    ...
    public func describeNodeAssociationStatus(_ input: DescribeNodeAssociationStatusRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeNodeAssociationStatusResponse> {
        return client.execute(operation: "DescribeNodeAssociationStatus", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeServers(_ input: DescribeServersRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeServersResponse> {
        return client.execute(operation: "DescribeServers", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func disassociateNode(_ input: DisassociateNodeRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DisassociateNodeResponse> {
        return client.execute(operation: "DisassociateNode", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func exportServerEngineAttribute(_ input: ExportServerEngineAttributeRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ExportServerEngineAttributeResponse> {
        return client.execute(operation: "ExportServerEngineAttribute", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func restoreServer(_ input: RestoreServerRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<RestoreServerResponse> {
        return client.execute(operation: "RestoreServer", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func startMaintenance(_ input: StartMaintenanceRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<StartMaintenanceResponse> {
        return client.execute(operation: "StartMaintenance", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func updateServerEngineAttributes(_ input: UpdateServerEngineAttributesRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<UpdateServerEngineAttributesResponse> {
        return client.execute(operation: "UpdateServerEngineAttributes", path: "/", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
