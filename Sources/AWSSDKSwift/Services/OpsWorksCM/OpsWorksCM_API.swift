...
public struct OpsWorksCM: AWSService {
    ...
    /// return new `OpsWorksCM` with new timeout value
    ...
    /// return new `OpsWorksCM` logging to specified Logger
    ...
    public func associateNode(_ input: AssociateNodeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssociateNodeResponse> {
        return client.execute(operation: "AssociateNode", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeNodeAssociationStatus(_ input: DescribeNodeAssociationStatusRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeNodeAssociationStatusResponse> {
        return client.execute(operation: "DescribeNodeAssociationStatus", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func describeServers(_ input: DescribeServersRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeServersResponse> {
        return client.execute(operation: "DescribeServers", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func disassociateNode(_ input: DisassociateNodeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DisassociateNodeResponse> {
        return client.execute(operation: "DisassociateNode", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func exportServerEngineAttribute(_ input: ExportServerEngineAttributeRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportServerEngineAttributeResponse> {
        return client.execute(operation: "ExportServerEngineAttribute", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func restoreServer(_ input: RestoreServerRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RestoreServerResponse> {
        return client.execute(operation: "RestoreServer", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func startMaintenance(_ input: StartMaintenanceRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StartMaintenanceResponse> {
        return client.execute(operation: "StartMaintenance", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func updateServerEngineAttributes(_ input: UpdateServerEngineAttributesRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<UpdateServerEngineAttributesResponse> {
        return client.execute(operation: "UpdateServerEngineAttributes", path: "/", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
