...
public struct OpsWorksCM: AWSService {
    ...
    public func associateNode(_ input: AssociateNodeRequest) -> EventLoopFuture<AssociateNodeResponse> {
        return client.execute(operation: "AssociateNode", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeNodeAssociationStatus(_ input: DescribeNodeAssociationStatusRequest) -> EventLoopFuture<DescribeNodeAssociationStatusResponse> {
        return client.execute(operation: "DescribeNodeAssociationStatus", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeServers(_ input: DescribeServersRequest) -> EventLoopFuture<DescribeServersResponse> {
        return client.execute(operation: "DescribeServers", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func disassociateNode(_ input: DisassociateNodeRequest) -> EventLoopFuture<DisassociateNodeResponse> {
        return client.execute(operation: "DisassociateNode", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func exportServerEngineAttribute(_ input: ExportServerEngineAttributeRequest) -> EventLoopFuture<ExportServerEngineAttributeResponse> {
        return client.execute(operation: "ExportServerEngineAttribute", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func restoreServer(_ input: RestoreServerRequest) -> EventLoopFuture<RestoreServerResponse> {
        return client.execute(operation: "RestoreServer", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func startMaintenance(_ input: StartMaintenanceRequest) -> EventLoopFuture<StartMaintenanceResponse> {
        return client.execute(operation: "StartMaintenance", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func updateServerEngineAttributes(_ input: UpdateServerEngineAttributesRequest) -> EventLoopFuture<UpdateServerEngineAttributesResponse> {
        return client.execute(operation: "UpdateServerEngineAttributes", path: "/", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
}
