...
public struct Elasticloadbalancing {
    ...
    public func describeLoadBalancers(_ input: DescribeAccessPointsInput) throws -> DescribeAccessPointsOutput {
    ...
    public func deleteLoadBalancerListeners(_ input: DeleteLoadBalancerListenerInput) throws -> DeleteLoadBalancerListenerOutput {
        return try client.send(operation: "DeleteLoadBalancerListeners", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified policies. If you specify a load balancer name, the action returns the descriptions of all policies created for the load balancer. If you specify a policy name associated with your load balancer, the action returns the description of that policy. If you don't specify a load balancer name, the action returns descriptions of the specified sample policies, or descriptions of all sample policies. The names of the sample policies have the ELBSample- prefix.
    public func describeLoadBalancerPolicies(_ input: DescribeLoadBalancerPoliciesInput) throws -> DescribeLoadBalancerPoliciesOutput {
    ...
    public func deleteLoadBalancerPolicy(_ input: DeleteLoadBalancerPolicyInput) throws -> DeleteLoadBalancerPolicyOutput {
    ...
    public func createLoadBalancerPolicy(_ input: CreateLoadBalancerPolicyInput) throws -> CreateLoadBalancerPolicyOutput {
        return try client.send(operation: "CreateLoadBalancerPolicy", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func deleteLoadBalancer(_ input: DeleteAccessPointInput) throws -> DeleteAccessPointOutput {
    ...
    public func detachLoadBalancerFromSubnets(_ input: DetachLoadBalancerFromSubnetsInput) throws -> DetachLoadBalancerFromSubnetsOutput {
    ...
    public func describeInstanceHealth(_ input: DescribeEndPointStateInput) throws -> DescribeEndPointStateOutput {
