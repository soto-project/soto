...
extension Health {
    ...
    public func describeAffectedAccountsForOrganizationPaginator(_ input: DescribeAffectedAccountsForOrganizationRequest, onPage: @escaping ([String], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeAffectedAccountsForOrganization, resultKey: \DescribeAffectedAccountsForOrganizationResponse.affectedAccounts, tokenKey: \DescribeAffectedAccountsForOrganizationResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeAffectedEntitiesPaginator(_ input: DescribeAffectedEntitiesRequest, onPage: @escaping ([AffectedEntity], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeAffectedEntities, resultKey: \DescribeAffectedEntitiesResponse.entities, tokenKey: \DescribeAffectedEntitiesResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeAffectedEntitiesForOrganizationPaginator(_ input: DescribeAffectedEntitiesForOrganizationRequest, onPage: @escaping ([AffectedEntity], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeAffectedEntitiesForOrganization, resultKey: \DescribeAffectedEntitiesForOrganizationResponse.entities, tokenKey: \DescribeAffectedEntitiesForOrganizationResponse.nextToken, onPage: onPage)
    }
    
    ///  Returns the number of events of each event type (issue, scheduled change, and account notification). If no filter is specified, the counts of all events in each category are returned.
    public func describeEventAggregatesPaginator(_ input: DescribeEventAggregatesRequest, onPage: @escaping ([EventAggregate], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeEventAggregates, resultKey: \DescribeEventAggregatesResponse.eventAggregates, tokenKey: \DescribeEventAggregatesResponse.nextToken, onPage: onPage)
    }
    
    ///  Returns the event types that meet the specified filter criteria. If no filter criteria are specified, all event types are returned, in no particular order.
    public func describeEventTypesPaginator(_ input: DescribeEventTypesRequest, onPage: @escaping ([EventType], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeEventTypes, resultKey: \DescribeEventTypesResponse.eventTypes, tokenKey: \DescribeEventTypesResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeEventsPaginator(_ input: DescribeEventsRequest, onPage: @escaping ([Event], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeEvents, resultKey: \DescribeEventsResponse.events, tokenKey: \DescribeEventsResponse.nextToken, onPage: onPage)
    }
    ...
    public func describeEventsForOrganizationPaginator(_ input: DescribeEventsForOrganizationRequest, onPage: @escaping ([OrganizationEvent], EventLoop)->EventLoopFuture<Bool>) -> EventLoopFuture<Void> {
        return client.paginate(input: input, command: describeEventsForOrganization, resultKey: \DescribeEventsForOrganizationResponse.events, tokenKey: \DescribeEventsForOrganizationResponse.nextToken, onPage: onPage)
    }
