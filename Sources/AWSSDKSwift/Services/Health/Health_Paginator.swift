...
extension Health {
    ...
    public func describeAffectedAccountsForOrganizationPaginator(_ input: DescribeAffectedAccountsForOrganizationRequest) -> Future<[String]> {
    ...
    public func describeAffectedEntitiesPaginator(_ input: DescribeAffectedEntitiesRequest) -> Future<[AffectedEntity]> {
    ...
    public func describeAffectedEntitiesForOrganizationPaginator(_ input: DescribeAffectedEntitiesForOrganizationRequest) -> Future<[AffectedEntity]> {
    ...
    public func describeEventAggregatesPaginator(_ input: DescribeEventAggregatesRequest) -> Future<[EventAggregate]> {
    ...
    public func describeEventTypesPaginator(_ input: DescribeEventTypesRequest) -> Future<[EventType]> {
    ...
    public func describeEventsPaginator(_ input: DescribeEventsRequest) -> Future<[Event]> {
    ...
    public func describeEventsForOrganizationPaginator(_ input: DescribeEventsForOrganizationRequest) -> Future<[OrganizationEvent]> {
