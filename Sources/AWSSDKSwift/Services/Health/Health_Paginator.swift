...
extension Health {
    ...
    public func describeAffectedAccountsForOrganizationPaginator(_ input: DescribeAffectedAccountsForOrganizationRequest) -> EventLoopFuture<[String]> {
        return client.paginate(input: input, command: describeAffectedAccountsForOrganization, resultKey: \DescribeAffectedAccountsForOrganizationResponse.affectedAccounts, tokenKey: \DescribeAffectedAccountsForOrganizationResponse.nextToken)
    }
    ...
    public func describeAffectedEntitiesPaginator(_ input: DescribeAffectedEntitiesRequest) -> EventLoopFuture<[AffectedEntity]> {
        return client.paginate(input: input, command: describeAffectedEntities, resultKey: \DescribeAffectedEntitiesResponse.entities, tokenKey: \DescribeAffectedEntitiesResponse.nextToken)
    }
    ...
    public func describeAffectedEntitiesForOrganizationPaginator(_ input: DescribeAffectedEntitiesForOrganizationRequest) -> EventLoopFuture<[AffectedEntity]> {
        return client.paginate(input: input, command: describeAffectedEntitiesForOrganization, resultKey: \DescribeAffectedEntitiesForOrganizationResponse.entities, tokenKey: \DescribeAffectedEntitiesForOrganizationResponse.nextToken)
    }
    ...
    public func describeEventAggregatesPaginator(_ input: DescribeEventAggregatesRequest) -> EventLoopFuture<[EventAggregate]> {
        return client.paginate(input: input, command: describeEventAggregates, resultKey: \DescribeEventAggregatesResponse.eventAggregates, tokenKey: \DescribeEventAggregatesResponse.nextToken)
    }
    ...
    public func describeEventTypesPaginator(_ input: DescribeEventTypesRequest) -> EventLoopFuture<[EventType]> {
        return client.paginate(input: input, command: describeEventTypes, resultKey: \DescribeEventTypesResponse.eventTypes, tokenKey: \DescribeEventTypesResponse.nextToken)
    }
    ...
    public func describeEventsPaginator(_ input: DescribeEventsRequest) -> EventLoopFuture<[Event]> {
        return client.paginate(input: input, command: describeEvents, resultKey: \DescribeEventsResponse.events, tokenKey: \DescribeEventsResponse.nextToken)
    }
    ...
    public func describeEventsForOrganizationPaginator(_ input: DescribeEventsForOrganizationRequest) -> EventLoopFuture<[OrganizationEvent]> {
        return client.paginate(input: input, command: describeEventsForOrganization, resultKey: \DescribeEventsForOrganizationResponse.events, tokenKey: \DescribeEventsForOrganizationResponse.nextToken)
    }
