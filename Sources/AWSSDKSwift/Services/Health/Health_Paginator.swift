...
extension Health {
    ...
    public func describeAffectedAccountsForOrganizationPaginator(
        ...
        onPage: @escaping (DescribeAffectedAccountsForOrganizationResponse,
    ...
    public func describeAffectedEntitiesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (DescribeAffectedEntitiesResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func describeAffectedEntitiesForOrganizationPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (DescribeAffectedEntitiesForOrganizationResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func describeEventAggregatesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (DescribeEventAggregatesResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func describeEventTypesPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (DescribeEventTypesResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
    ...
    public func describeEventsForOrganizationPaginator(
        ...
        on eventLoop: EventLoop? = nil,
        onPage: @escaping (DescribeEventsForOrganizationResponse,
        EventLoop) -> EventLoopFuture<Bool>
    ) -> EventLoopFuture<Void> {
