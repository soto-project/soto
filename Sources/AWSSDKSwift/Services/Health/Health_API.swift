...
public struct Health {
    ...
    public func describeEntityAggregates(_ input: DescribeEntityAggregatesRequest) throws -> EventLoopFuture<DescribeEntityAggregatesResponse> {
        return try client.send(operation: "DescribeEntityAggregates", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the event types that meet the specified filter criteria. If no filter criteria are specified, all event types are returned, in no particular order.
    public func describeEventTypes(_ input: DescribeEventTypesRequest) throws -> EventLoopFuture<DescribeEventTypesResponse> {
    ...
    public func describeAffectedEntities(_ input: DescribeAffectedEntitiesRequest) throws -> EventLoopFuture<DescribeAffectedEntitiesResponse> {
    ...
    public func describeEventDetails(_ input: DescribeEventDetailsRequest) throws -> EventLoopFuture<DescribeEventDetailsResponse> {
    ...
    public func describeEventAggregates(_ input: DescribeEventAggregatesRequest) throws -> EventLoopFuture<DescribeEventAggregatesResponse> {
