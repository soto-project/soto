...
public struct ComputeOptimizer {
    ...
    public func getAutoScalingGroupRecommendations(_ input: GetAutoScalingGroupRecommendationsRequest) -> Future<GetAutoScalingGroupRecommendationsResponse> {
    ...
    public func getEC2InstanceRecommendations(_ input: GetEC2InstanceRecommendationsRequest) -> Future<GetEC2InstanceRecommendationsResponse> {
        return client.send(operation: "GetEC2InstanceRecommendations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the projected utilization metrics of Amazon EC2 instance recommendations.
    public func getEC2RecommendationProjectedMetrics(_ input: GetEC2RecommendationProjectedMetricsRequest) -> Future<GetEC2RecommendationProjectedMetricsResponse> {
    ...
    public func getEnrollmentStatus(_ input: GetEnrollmentStatusRequest) -> Future<GetEnrollmentStatusResponse> {
    ...
    public func getRecommendationSummaries(_ input: GetRecommendationSummariesRequest) -> Future<GetRecommendationSummariesResponse> {
    ...
    public func updateEnrollmentStatus(_ input: UpdateEnrollmentStatusRequest) -> Future<UpdateEnrollmentStatusResponse> {
