...
public struct ComputeOptimizer {
    ...
    public func describeRecommendationExportJobs(_ input: DescribeRecommendationExportJobsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRecommendationExportJobsResponse> {
        return client.execute(operation: "DescribeRecommendationExportJobs", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func exportAutoScalingGroupRecommendations(_ input: ExportAutoScalingGroupRecommendationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportAutoScalingGroupRecommendationsResponse> {
        return client.execute(operation: "ExportAutoScalingGroupRecommendations", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
    ...
    public func exportEC2InstanceRecommendations(_ input: ExportEC2InstanceRecommendationsRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExportEC2InstanceRecommendationsResponse> {
        return client.execute(operation: "ExportEC2InstanceRecommendations", path: "/", httpMethod: "POST", serviceConfig: serviceConfig, input: input, on: eventLoop)
    }
