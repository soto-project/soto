...
extension ComputeOptimizer {
    ...
    public struct DescribeRecommendationExportJobsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "jobIds", required: false, type: .list), 
    ...
    public struct DescribeRecommendationExportJobsResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "nextToken", required: false, type: .string), 
            AWSShapeMember(label: "recommendationExportJobs", required: false, type: .list)
        ]
    ...
    public struct ExportAutoScalingGroupRecommendationsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "accountIds", required: false, type: .list), 
            AWSShapeMember(label: "fieldsToExport", required: false, type: .list), 
            ...
            AWSShapeMember(label: "s3DestinationConfig", required: true, type: .structure)
        ]
    ...
    public struct ExportAutoScalingGroupRecommendationsResponse: AWSShape {
        public static var _members: [AWSShapeMember] = [
    ...
    public struct ExportEC2InstanceRecommendationsRequest: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "accountIds", required: false, type: .list), 
            AWSShapeMember(label: "fieldsToExport", required: false, type: .list), 
            AWSShapeMember(label: "fileFormat", required: false, type: .enum), 
    ...
    public struct JobFilter: AWSShape {
        public static var _members: [AWSShapeMember] = [
            AWSShapeMember(label: "name", required: false, type: .enum), 
            AWSShapeMember(label: "values", required: false, type: .list)
        ]
    ...
    public struct S3Destination: AWSShape {
        public static var _members: [AWSShapeMember] = [
            ...
            AWSShapeMember(label: "metadataKey", required: false, type: .string)
        ]
