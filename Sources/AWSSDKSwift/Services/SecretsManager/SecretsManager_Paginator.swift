...
extension SecretsManager {
    ...
    public func listSecretVersionIdsPaginator(_ input: ListSecretVersionIdsRequest) -> EventLoopFuture<[SecretVersionsListEntry]> {
        return client.paginate(input: input, command: listSecretVersionIds, resultKey: \ListSecretVersionIdsResponse.versions, tokenKey: \ListSecretVersionIdsResponse.nextToken)
    }
    ...
    public func listSecretsPaginator(_ input: ListSecretsRequest) -> EventLoopFuture<[SecretListEntry]> {
        return client.paginate(input: input, command: listSecrets, resultKey: \ListSecretsResponse.secretList, tokenKey: \ListSecretsResponse.nextToken)
    }
