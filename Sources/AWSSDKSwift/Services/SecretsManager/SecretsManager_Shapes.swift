...
extension SecretsManager {
    ...
    public struct GetSecretValueResponse: AWSShape {
        ...
        public init(secretBinary: Data? = nil, secretString: String? = nil, versionId: String? = nil, versionStages: [String]? = nil, name: String? = nil, arn: String? = nil, createdDate: TimeStamp? = nil) {
    ...
    public struct RotateSecretRequest: AWSShape {
        ...
        public init(rotationLambdaARN: String? = nil, clientRequestToken: String? = nil, rotationRules: RotationRulesType? = nil, secretId: String) {
    ...
    public struct PutSecretValueRequest: AWSShape {
        ...
        public init(secretString: String? = nil, versionStages: [String]? = nil, clientRequestToken: String? = nil, secretBinary: Data? = nil, secretId: String) {
            self.secretString = secretString
            self.versionStages = versionStages
            self.clientRequestToken = clientRequestToken
            self.secretBinary = secretBinary
    ...
    public struct PutSecretValueResponse: AWSShape {
        ...
        public init(name: String? = nil, versionId: String? = nil, versionStages: [String]? = nil, arn: String? = nil) {
            self.name = name
            self.versionId = versionId
            self.versionStages = versionStages
            self.arn = arn
    ...
    public struct ListSecretVersionIdsResponse: AWSShape {
        ...
        public init(nextToken: String? = nil, name: String? = nil, arn: String? = nil, versions: [SecretVersionsListEntry]? = nil) {
            self.nextToken = nextToken
            self.name = name
            self.arn = arn
    ...
    public struct UpdateSecretRequest: AWSShape {
        ...
        public init(secretId: String, clientRequestToken: String? = nil, secretBinary: Data? = nil, kmsKeyId: String? = nil, description: String? = nil, secretString: String? = nil) {
            self.secretId = secretId
            self.clientRequestToken = clientRequestToken
            self.secretBinary = secretBinary
    ...
    public struct CreateSecretRequest: AWSShape {
        ...
        public init(secretBinary: Data? = nil, secretString: String? = nil, clientRequestToken: String? = nil, kmsKeyId: String? = nil, name: String, tags: [Tag]? = nil, description: String? = nil) {
            self.secretBinary = secretBinary
            self.secretString = secretString
            self.clientRequestToken = clientRequestToken
            self.kmsKeyId = kmsKeyId
    ...
    public struct SecretListEntry: AWSShape {
        ...
        public init(lastAccessedDate: TimeStamp? = nil, name: String? = nil, secretVersionsToStages: [String: [String]]? = nil, kmsKeyId: String? = nil, lastChangedDate: TimeStamp? = nil, arn: String? = nil, tags: [Tag]? = nil, rotationLambdaARN: String? = nil, lastRotatedDate: TimeStamp? = nil, rotationEnabled: Bool? = nil, deletedDate: TimeStamp? = nil, rotationRules: RotationRulesType? = nil, description: String? = nil) {
            self.lastAccessedDate = lastAccessedDate
            self.name = name
    ...
    public struct GetRandomPasswordRequest: AWSShape {
        ...
        public init(excludeUppercase: Bool? = nil, includeSpace: Bool? = nil, excludePunctuation: Bool? = nil, requireEachIncludedType: Bool? = nil, excludeNumbers: Bool? = nil, excludeCharacters: String? = nil, excludeLowercase: Bool? = nil, passwordLength: Int64? = nil) {
    ...
    public struct DescribeSecretResponse: AWSShape {
        ...
        public init(lastAccessedDate: TimeStamp? = nil, versionIdsToStages: [String: [String]]? = nil, name: String? = nil, kmsKeyId: String? = nil, lastChangedDate: TimeStamp? = nil, arn: String? = nil, rotationLambdaARN: String? = nil, lastRotatedDate: TimeStamp? = nil, tags: [Tag]? = nil, rotationEnabled: Bool? = nil, deletedDate: TimeStamp? = nil, rotationRules: RotationRulesType? = nil, description: String? = nil) {
            self.lastAccessedDate = lastAccessedDate
