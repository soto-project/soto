...
extension SecretsManager {
    ...
    public struct GetRandomPasswordRequest: AWSShape {
        ...
        public init(excludeCharacters: String? = nil, excludeNumbers: Bool? = nil, passwordLength: Int64? = nil, includeSpace: Bool? = nil, excludePunctuation: Bool? = nil, excludeUppercase: Bool? = nil, excludeLowercase: Bool? = nil, requireEachIncludedType: Bool? = nil) {
    ...
    public struct GetSecretValueResponse: AWSShape {
        ...
        public init(name: String? = nil, versionStages: [String]? = nil, createdDate: TimeStamp? = nil, secretString: String? = nil, secretBinary: Data? = nil, arn: String? = nil, versionId: String? = nil) {
            self.name = name
    ...
    public struct UpdateSecretVersionStageRequest: AWSShape {
        ...
        public init(moveToVersionId: String? = nil, versionStage: String, secretId: String, removeFromVersionId: String? = nil) {
    ...
    public struct ListSecretVersionIdsRequest: AWSShape {
        ...
        public init(nextToken: String? = nil, maxResults: Int32? = nil, secretId: String, includeDeprecated: Bool? = nil) {
            self.nextToken = nextToken
            self.maxResults = maxResults
            self.secretId = secretId
    ...
    public struct DescribeSecretResponse: AWSShape {
        ...
        public init(kmsKeyId: String? = nil, lastAccessedDate: TimeStamp? = nil, versionIdsToStages: [String: [String]]? = nil, rotationLambdaARN: String? = nil, lastChangedDate: TimeStamp? = nil, deletedDate: TimeStamp? = nil, rotationRules: RotationRulesType? = nil, description: String? = nil, name: String? = nil, lastRotatedDate: TimeStamp? = nil, rotationEnabled: Bool? = nil, arn: String? = nil, tags: [Tag]? = nil) {
    ...
    public struct DeleteSecretRequest: AWSShape {
        ...
        public init(forceDeleteWithoutRecovery: Bool? = nil, secretId: String, recoveryWindowInDays: Int64? = nil) {
    ...
    public struct RotateSecretRequest: AWSShape {
        ...
        public init(clientRequestToken: String? = nil, rotationRules: RotationRulesType? = nil, secretId: String, rotationLambdaARN: String? = nil) {
    ...
    public struct ListSecretVersionIdsResponse: AWSShape {
        ...
        public init(name: String? = nil, versions: [SecretVersionsListEntry]? = nil, nextToken: String? = nil, arn: String? = nil) {
            self.name = name
    ...
    public struct SecretVersionsListEntry: AWSShape {
        ...
        public init(versionStages: [String]? = nil, lastAccessedDate: TimeStamp? = nil, createdDate: TimeStamp? = nil, versionId: String? = nil) {
            self.versionStages = versionStages
            self.lastAccessedDate = lastAccessedDate
            self.createdDate = createdDate
            self.versionId = versionId
    ...
    public struct SecretListEntry: AWSShape {
        ...
        public init(kmsKeyId: String? = nil, lastAccessedDate: TimeStamp? = nil, rotationLambdaARN: String? = nil, lastChangedDate: TimeStamp? = nil, deletedDate: TimeStamp? = nil, rotationRules: RotationRulesType? = nil, description: String? = nil, name: String? = nil, lastRotatedDate: TimeStamp? = nil, rotationEnabled: Bool? = nil, arn: String? = nil, secretVersionsToStages: [String: [String]]? = nil, tags: [Tag]? = nil) {
            self.kmsKeyId = kmsKeyId
            self.lastAccessedDate = lastAccessedDate
            self.rotationLambdaARN = rotationLambdaARN
            self.lastChangedDate = lastChangedDate
    ...
    public struct UpdateSecretRequest: AWSShape {
        ...
        public init(clientRequestToken: String? = nil, secretString: String? = nil, description: String? = nil, kmsKeyId: String? = nil, secretBinary: Data? = nil, secretId: String) {
            self.clientRequestToken = clientRequestToken
            self.secretString = secretString
            self.description = description
            self.kmsKeyId = kmsKeyId
    ...
    public struct PutSecretValueResponse: AWSShape {
        ...
        public init(name: String? = nil, versionId: String? = nil, arn: String? = nil, versionStages: [String]? = nil) {
            self.name = name
            self.versionId = versionId
            self.arn = arn
            self.versionStages = versionStages
    ...
    public struct PutSecretValueRequest: AWSShape {
        ...
        public init(clientRequestToken: String? = nil, secretId: String, secretString: String? = nil, secretBinary: Data? = nil, versionStages: [String]? = nil) {
            self.clientRequestToken = clientRequestToken
            self.secretId = secretId
            self.secretString = secretString
            self.secretBinary = secretBinary
    ...
    public struct CreateSecretRequest: AWSShape {
        ...
        public init(name: String, clientRequestToken: String? = nil, kmsKeyId: String? = nil, tags: [Tag]? = nil, secretString: String? = nil, secretBinary: Data? = nil, description: String? = nil) {
            self.name = name
            self.clientRequestToken = clientRequestToken
            self.kmsKeyId = kmsKeyId
            self.tags = tags
