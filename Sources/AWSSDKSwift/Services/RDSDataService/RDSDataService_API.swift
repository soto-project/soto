...
public struct RDSDataService: AWSService {
    ...
    /// return new `RDSDataService` with new timeout value
    ...
    /// return new `RDSDataService` logging to specified Logger
    ...
    public func batchExecuteStatement(_ input: BatchExecuteStatementRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchExecuteStatementResponse> {
        return client.execute(operation: "BatchExecuteStatement", path: "/BatchExecute", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func beginTransaction(_ input: BeginTransactionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BeginTransactionResponse> {
        return client.execute(operation: "BeginTransaction", path: "/BeginTransaction", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func commitTransaction(_ input: CommitTransactionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CommitTransactionResponse> {
        return client.execute(operation: "CommitTransaction", path: "/CommitTransaction", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func executeSql(_ input: ExecuteSqlRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExecuteSqlResponse> {
        return client.execute(operation: "ExecuteSql", path: "/ExecuteSql", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func executeStatement(_ input: ExecuteStatementRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ExecuteStatementResponse> {
        return client.execute(operation: "ExecuteStatement", path: "/Execute", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
    ...
    public func rollbackTransaction(_ input: RollbackTransactionRequest, on eventLoop: EventLoop? = nil) -> EventLoopFuture<RollbackTransactionResponse> {
        return client.execute(operation: "RollbackTransaction", path: "/RollbackTransaction", httpMethod: .POST, serviceContext: context, input: input, on: eventLoop)
    }
}
