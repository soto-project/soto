...
public struct WorkDocs {
    ...
    public func getDocumentPath(_ input: GetDocumentPathRequest) throws -> EventLoopFuture<GetDocumentPathResponse> {
    ...
    public func createComment(_ input: CreateCommentRequest) throws -> EventLoopFuture<CreateCommentResponse> {
    ...
    public func addResourcePermissions(_ input: AddResourcePermissionsRequest) throws -> EventLoopFuture<AddResourcePermissionsResponse> {
    ...
    public func describeComments(_ input: DescribeCommentsRequest) throws -> EventLoopFuture<DescribeCommentsResponse> {
    ...
    public func activateUser(_ input: ActivateUserRequest) throws -> EventLoopFuture<ActivateUserResponse> {
    ...
    public func describeRootFolders(_ input: DescribeRootFoldersRequest) throws -> EventLoopFuture<DescribeRootFoldersResponse> {
    ...
    public func describeDocumentVersions(_ input: DescribeDocumentVersionsRequest) throws -> EventLoopFuture<DescribeDocumentVersionsResponse> {
    ...
    public func createCustomMetadata(_ input: CreateCustomMetadataRequest) throws -> EventLoopFuture<CreateCustomMetadataResponse> {
    ...
    public func deleteLabels(_ input: DeleteLabelsRequest) throws -> EventLoopFuture<DeleteLabelsResponse> {
    ...
    public func getFolderPath(_ input: GetFolderPathRequest) throws -> EventLoopFuture<GetFolderPathResponse> {
        return try client.send(operation: "GetFolderPath", path: "/api/v1/folders/{FolderId}/path", httpMethod: "GET", input: input)
    }

    ///  Describes the user activities in a specified time period.
    public func describeActivities(_ input: DescribeActivitiesRequest) throws -> EventLoopFuture<DescribeActivitiesResponse> {
    ...
    public func getResources(_ input: GetResourcesRequest) throws -> EventLoopFuture<GetResourcesResponse> {
    ...
    public func initiateDocumentVersionUpload(_ input: InitiateDocumentVersionUploadRequest) throws -> EventLoopFuture<InitiateDocumentVersionUploadResponse> {
    ...
    public func deleteCustomMetadata(_ input: DeleteCustomMetadataRequest) throws -> EventLoopFuture<DeleteCustomMetadataResponse> {
    ...
    public func describeGroups(_ input: DescribeGroupsRequest) throws -> EventLoopFuture<DescribeGroupsResponse> {
        return try client.send(operation: "DescribeGroups", path: "/api/v1/groups", httpMethod: "GET", input: input)
    }

    ///  Creates a folder with the specified name and parent folder.
    public func createFolder(_ input: CreateFolderRequest) throws -> EventLoopFuture<CreateFolderResponse> {
        return try client.send(operation: "CreateFolder", path: "/api/v1/folders", httpMethod: "POST", input: input)
    }

    ///  Retrieves details of a document.
    public func getDocument(_ input: GetDocumentRequest) throws -> EventLoopFuture<GetDocumentResponse> {
    ...
    public func getDocumentVersion(_ input: GetDocumentVersionRequest) throws -> EventLoopFuture<GetDocumentVersionResponse> {
    ...
    public func describeUsers(_ input: DescribeUsersRequest) throws -> EventLoopFuture<DescribeUsersResponse> {
    ...
    public func getCurrentUser(_ input: GetCurrentUserRequest) throws -> EventLoopFuture<GetCurrentUserResponse> {
        return try client.send(operation: "GetCurrentUser", path: "/api/v1/me", httpMethod: "GET", input: input)
    }

    ///  Lists the specified notification subscriptions.
    public func describeNotificationSubscriptions(_ input: DescribeNotificationSubscriptionsRequest) throws -> EventLoopFuture<DescribeNotificationSubscriptionsResponse> {
    ...
    public func createNotificationSubscription(_ input: CreateNotificationSubscriptionRequest) throws -> EventLoopFuture<CreateNotificationSubscriptionResponse> {
    ...
    public func createLabels(_ input: CreateLabelsRequest) throws -> EventLoopFuture<CreateLabelsResponse> {
    ...
    public func describeResourcePermissions(_ input: DescribeResourcePermissionsRequest) throws -> EventLoopFuture<DescribeResourcePermissionsResponse> {
    ...
    public func getFolder(_ input: GetFolderRequest) throws -> EventLoopFuture<GetFolderResponse> {
    ...
    public func describeFolderContents(_ input: DescribeFolderContentsRequest) throws -> EventLoopFuture<DescribeFolderContentsResponse> {
