...
public struct EFS {
    ...
    public func createAccessPoint(_ input: CreateAccessPointRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<AccessPointDescription> {
        return client.execute(operation: "CreateAccessPoint", path: "/2015-02-01/access-points", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<FileSystemDescription> {
        return client.execute(operation: "CreateFileSystem", path: "/2015-02-01/file-systems", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func createMountTarget(_ input: CreateMountTargetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<MountTargetDescription> {
        return client.execute(operation: "CreateMountTarget", path: "/2015-02-01/mount-targets", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func createTags(_ input: CreateTagsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateTags", path: "/2015-02-01/create-tags/{FileSystemId}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteAccessPoint(_ input: DeleteAccessPointRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAccessPoint", path: "/2015-02-01/access-points/{AccessPointId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteFileSystem(_ input: DeleteFileSystemRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteFileSystem", path: "/2015-02-01/file-systems/{FileSystemId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteFileSystemPolicy(_ input: DeleteFileSystemPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteFileSystemPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/policy", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteMountTarget(_ input: DeleteMountTargetRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteMountTarget", path: "/2015-02-01/mount-targets/{MountTargetId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func deleteTags(_ input: DeleteTagsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteTags", path: "/2015-02-01/delete-tags/{FileSystemId}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeAccessPoints(_ input: DescribeAccessPointsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeAccessPointsResponse> {
    ...
    public func describeFileSystemPolicy(_ input: DescribeFileSystemPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<FileSystemPolicyDescription> {
    ...
    public func describeFileSystems(_ input: DescribeFileSystemsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeFileSystemsResponse> {
        return client.execute(operation: "DescribeFileSystems", path: "/2015-02-01/file-systems", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeLifecycleConfiguration(_ input: DescribeLifecycleConfigurationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<LifecycleConfigurationDescription> {
        return client.execute(operation: "DescribeLifecycleConfiguration", path: "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeMountTargetSecurityGroups(_ input: DescribeMountTargetSecurityGroupsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeMountTargetSecurityGroupsResponse> {
        return client.execute(operation: "DescribeMountTargetSecurityGroups", path: "/2015-02-01/mount-targets/{MountTargetId}/security-groups", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeMountTargets(_ input: DescribeMountTargetsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeMountTargetsResponse> {
        return client.execute(operation: "DescribeMountTargets", path: "/2015-02-01/mount-targets", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func describeTags(_ input: DescribeTagsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<DescribeTagsResponse> {
        return client.execute(operation: "DescribeTags", path: "/2015-02-01/tags/{FileSystemId}/", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<ListTagsForResourceResponse> {
        return client.execute(operation: "ListTagsForResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: .GET, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func modifyMountTargetSecurityGroups(_ input: ModifyMountTargetSecurityGroupsRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
    ...
    public func putFileSystemPolicy(_ input: PutFileSystemPolicyRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<FileSystemPolicyDescription> {
        return client.execute(operation: "PutFileSystemPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/policy", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    public func putLifecycleConfiguration(_ input: PutLifecycleConfigurationRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<LifecycleConfigurationDescription> {
        return client.execute(operation: "PutLifecycleConfiguration", path: "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func tagResource(_ input: TagResourceRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "TagResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: .POST, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
    ...
    @discardableResult public func untagResource(_ input: UntagResourceRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<Void> {
        return client.execute(operation: "UntagResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: .DELETE, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }

    ///  Updates the throughput mode or the amount of provisioned throughput of an existing file system.
    public func updateFileSystem(_ input: UpdateFileSystemRequest, on eventLoop: EventLoop? = nil, logger: Logging.Logger = AWSClient.loggingDisabled) -> EventLoopFuture<FileSystemDescription> {
        return client.execute(operation: "UpdateFileSystem", path: "/2015-02-01/file-systems/{FileSystemId}", httpMethod: .PUT, serviceConfig: serviceConfig, input: input, on: eventLoop, logger: logger)
    }
}
