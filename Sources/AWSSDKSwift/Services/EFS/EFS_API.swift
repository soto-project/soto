...
public struct EFS: AWSService {
    ...
    public func createAccessPoint(_ input: CreateAccessPointRequest) -> EventLoopFuture<AccessPointDescription> {
        return client.execute(operation: "CreateAccessPoint", path: "/2015-02-01/access-points", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest) -> EventLoopFuture<FileSystemDescription> {
        return client.execute(operation: "CreateFileSystem", path: "/2015-02-01/file-systems", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func createMountTarget(_ input: CreateMountTargetRequest) -> EventLoopFuture<MountTargetDescription> {
        return client.execute(operation: "CreateMountTarget", path: "/2015-02-01/mount-targets", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func createTags(_ input: CreateTagsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "CreateTags", path: "/2015-02-01/create-tags/{FileSystemId}", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteAccessPoint(_ input: DeleteAccessPointRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteAccessPoint", path: "/2015-02-01/access-points/{AccessPointId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteFileSystem(_ input: DeleteFileSystemRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteFileSystem", path: "/2015-02-01/file-systems/{FileSystemId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteFileSystemPolicy(_ input: DeleteFileSystemPolicyRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteFileSystemPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/policy", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteMountTarget(_ input: DeleteMountTargetRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteMountTarget", path: "/2015-02-01/mount-targets/{MountTargetId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func deleteTags(_ input: DeleteTagsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "DeleteTags", path: "/2015-02-01/delete-tags/{FileSystemId}", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeAccessPoints(_ input: DescribeAccessPointsRequest) -> EventLoopFuture<DescribeAccessPointsResponse> {
        return client.execute(operation: "DescribeAccessPoints", path: "/2015-02-01/access-points", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }

    ///  Returns the backup policy for the specified EFS file system.
    public func describeBackupPolicy(_ input: DescribeBackupPolicyRequest) -> EventLoopFuture<BackupPolicyDescription> {
        return client.execute(operation: "DescribeBackupPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/backup-policy", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeFileSystemPolicy(_ input: DescribeFileSystemPolicyRequest) -> EventLoopFuture<FileSystemPolicyDescription> {
        return client.execute(operation: "DescribeFileSystemPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/policy", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeFileSystems(_ input: DescribeFileSystemsRequest) -> EventLoopFuture<DescribeFileSystemsResponse> {
        return client.execute(operation: "DescribeFileSystems", path: "/2015-02-01/file-systems", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeLifecycleConfiguration(_ input: DescribeLifecycleConfigurationRequest) -> EventLoopFuture<LifecycleConfigurationDescription> {
        return client.execute(operation: "DescribeLifecycleConfiguration", path: "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeMountTargetSecurityGroups(_ input: DescribeMountTargetSecurityGroupsRequest) -> EventLoopFuture<DescribeMountTargetSecurityGroupsResponse> {
        return client.execute(operation: "DescribeMountTargetSecurityGroups", path: "/2015-02-01/mount-targets/{MountTargetId}/security-groups", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeMountTargets(_ input: DescribeMountTargetsRequest) -> EventLoopFuture<DescribeMountTargetsResponse> {
        return client.execute(operation: "DescribeMountTargets", path: "/2015-02-01/mount-targets", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func describeTags(_ input: DescribeTagsRequest) -> EventLoopFuture<DescribeTagsResponse> {
        return client.execute(operation: "DescribeTags", path: "/2015-02-01/tags/{FileSystemId}/", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest) -> EventLoopFuture<ListTagsForResourceResponse> {
        return client.execute(operation: "ListTagsForResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: .GET, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func modifyMountTargetSecurityGroups(_ input: ModifyMountTargetSecurityGroupsRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "ModifyMountTargetSecurityGroups", path: "/2015-02-01/mount-targets/{MountTargetId}/security-groups", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }

    ///  Updates the file system's backup policy. Use this action to start or stop automatic backups of the file system. 
    public func putBackupPolicy(_ input: PutBackupPolicyRequest) -> EventLoopFuture<BackupPolicyDescription> {
        return client.execute(operation: "PutBackupPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/backup-policy", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putFileSystemPolicy(_ input: PutFileSystemPolicyRequest) -> EventLoopFuture<FileSystemPolicyDescription> {
        return client.execute(operation: "PutFileSystemPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/policy", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    public func putLifecycleConfiguration(_ input: PutLifecycleConfigurationRequest) -> EventLoopFuture<LifecycleConfigurationDescription> {
        return client.execute(operation: "PutLifecycleConfiguration", path: "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func tagResource(_ input: TagResourceRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "TagResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: .POST, input: input, config: self.config, context: self.context)
    }
    ...
    @discardableResult public func untagResource(_ input: UntagResourceRequest) -> EventLoopFuture<Void> {
        return client.execute(operation: "UntagResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: .DELETE, input: input, config: self.config, context: self.context)
    }

    ///  Updates the throughput mode or the amount of provisioned throughput of an existing file system.
    public func updateFileSystem(_ input: UpdateFileSystemRequest) -> EventLoopFuture<FileSystemDescription> {
        return client.execute(operation: "UpdateFileSystem", path: "/2015-02-01/file-systems/{FileSystemId}", httpMethod: .PUT, input: input, config: self.config, context: self.context)
    }
}
