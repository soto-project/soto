...
public struct EFS {
    ...
    public func createAccessPoint(_ input: CreateAccessPointRequest) -> Future<AccessPointDescription> {
        return client.send(operation: "CreateAccessPoint", path: "/2015-02-01/access-points", httpMethod: "POST", input: input)
    }
    ...
    public func createFileSystem(_ input: CreateFileSystemRequest) -> Future<FileSystemDescription> {
        return client.send(operation: "CreateFileSystem", path: "/2015-02-01/file-systems", httpMethod: "POST", input: input)
    }
    ...
    public func createMountTarget(_ input: CreateMountTargetRequest) -> Future<MountTargetDescription> {
        return client.send(operation: "CreateMountTarget", path: "/2015-02-01/mount-targets", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func createTags(_ input: CreateTagsRequest) -> Future<Void> {
        return client.send(operation: "CreateTags", path: "/2015-02-01/create-tags/{FileSystemId}", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func deleteAccessPoint(_ input: DeleteAccessPointRequest) -> Future<Void> {
        return client.send(operation: "DeleteAccessPoint", path: "/2015-02-01/access-points/{AccessPointId}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteFileSystem(_ input: DeleteFileSystemRequest) -> Future<Void> {
        return client.send(operation: "DeleteFileSystem", path: "/2015-02-01/file-systems/{FileSystemId}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteFileSystemPolicy(_ input: DeleteFileSystemPolicyRequest) -> Future<Void> {
        return client.send(operation: "DeleteFileSystemPolicy", path: "/2015-02-01/file-systems/{FileSystemId}/policy", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteMountTarget(_ input: DeleteMountTargetRequest) -> Future<Void> {
        return client.send(operation: "DeleteMountTarget", path: "/2015-02-01/mount-targets/{MountTargetId}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteTags(_ input: DeleteTagsRequest) -> Future<Void> {
        return client.send(operation: "DeleteTags", path: "/2015-02-01/delete-tags/{FileSystemId}", httpMethod: "POST", input: input)
    }
    ...
    public func describeAccessPoints(_ input: DescribeAccessPointsRequest) -> Future<DescribeAccessPointsResponse> {
    ...
    public func describeFileSystemPolicy(_ input: DescribeFileSystemPolicyRequest) -> Future<FileSystemPolicyDescription> {
    ...
    public func describeFileSystems(_ input: DescribeFileSystemsRequest) -> Future<DescribeFileSystemsResponse> {
        return client.send(operation: "DescribeFileSystems", path: "/2015-02-01/file-systems", httpMethod: "GET", input: input)
    }
    ...
    public func describeLifecycleConfiguration(_ input: DescribeLifecycleConfigurationRequest) -> Future<LifecycleConfigurationDescription> {
        return client.send(operation: "DescribeLifecycleConfiguration", path: "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", httpMethod: "GET", input: input)
    }
    ...
    public func describeMountTargetSecurityGroups(_ input: DescribeMountTargetSecurityGroupsRequest) -> Future<DescribeMountTargetSecurityGroupsResponse> {
        return client.send(operation: "DescribeMountTargetSecurityGroups", path: "/2015-02-01/mount-targets/{MountTargetId}/security-groups", httpMethod: "GET", input: input)
    }
    ...
    public func describeMountTargets(_ input: DescribeMountTargetsRequest) -> Future<DescribeMountTargetsResponse> {
        return client.send(operation: "DescribeMountTargets", path: "/2015-02-01/mount-targets", httpMethod: "GET", input: input)
    }
    ...
    public func describeTags(_ input: DescribeTagsRequest) -> Future<DescribeTagsResponse> {
        return client.send(operation: "DescribeTags", path: "/2015-02-01/tags/{FileSystemId}/", httpMethod: "GET", input: input)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceRequest) -> Future<ListTagsForResourceResponse> {
        return client.send(operation: "ListTagsForResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: "GET", input: input)
    }
    ...
    @discardableResult public func modifyMountTargetSecurityGroups(_ input: ModifyMountTargetSecurityGroupsRequest) -> Future<Void> {
    ...
    public func putFileSystemPolicy(_ input: PutFileSystemPolicyRequest) -> Future<FileSystemPolicyDescription> {
    ...
    public func putLifecycleConfiguration(_ input: PutLifecycleConfigurationRequest) -> Future<LifecycleConfigurationDescription> {
        return client.send(operation: "PutLifecycleConfiguration", path: "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", httpMethod: "PUT", input: input)
    }
    ...
    @discardableResult public func tagResource(_ input: TagResourceRequest) -> Future<Void> {
        return client.send(operation: "TagResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func untagResource(_ input: UntagResourceRequest) -> Future<Void> {
        return client.send(operation: "UntagResource", path: "/2015-02-01/resource-tags/{ResourceId}", httpMethod: "DELETE", input: input)
    }

    ///  Updates the throughput mode or the amount of provisioned throughput of an existing file system.
    public func updateFileSystem(_ input: UpdateFileSystemRequest) -> Future<FileSystemDescription> {
        return client.send(operation: "UpdateFileSystem", path: "/2015-02-01/file-systems/{FileSystemId}", httpMethod: "PUT", input: input)
    }
}
