...
public struct CodeBuild {
    ...
    public init(accessKeyId: String? = nil, secretAccessKey: String? = nil, region: AWSSDKSwiftCore.Region? = nil, endpoint: String? = nil) {
        self.client = AWSClient(
            ...
            endpoint: endpoint,
            serviceEndpoints: ["us-east-1-fips": "codebuild-fips.us-east-1.amazonaws.com", "us-west-2-fips": "codebuild-fips.us-west-2.amazonaws.com", "us-west-1-fips": "codebuild-fips.us-west-1.amazonaws.com", "us-east-2-fips": "codebuild-fips.us-east-2.amazonaws.com"],
            middlewares: [],
