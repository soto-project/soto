...
public enum ResponseBuilderError: Error {
    case couldNotParseResponseJSON
}

public enum AWSServerError: Error {
...
public enum AWSClientError: Error {
    ...
    ///
    case raw(type: String, message: String?)
}
...
extension AWSClientError {
    public init(errorCode: String, message: String?) {
        ...
        default:
            self = .raw(type: errorCode, message: message)
        }
    }
}
